...
class CreatePaymentIntentUseCase(private val paymentRepository: PaymentRepository) {

    suspend operator fun invoke(citaId: Long): Result<PaymentIntentResponseDTO> =
        paymentRepository.createPaymentIntent(citaId)
}
