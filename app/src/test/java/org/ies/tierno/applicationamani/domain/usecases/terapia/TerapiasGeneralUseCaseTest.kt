...
class TerapiasGeneralUseCaseTest {
    ...
    @Test
    fun `crearTerapia should return result from repository`() = runTest {
    ...
    @Test
    fun `actualizarTerapia should return result from repository`() = runTest {
        val id = 1L
        val request = mockk<TerapiaRequest>()
        val expected = Result.success(mockk<TerapiaResponseDTO>())
    ...
    @Test
    fun `eliminarTerapia should return result from repository`() = runTest {
        val id = 1L
