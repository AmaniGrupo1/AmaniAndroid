...
class CitasRepositoryTest {
    ...
    private fun agendaItem(id: Long = 1L, estado: String = "PENDIENTE") = AgendaItemDTO(
        id = id,
        idPaciente = 1L,
    ...
    @Test
    fun `getAgendaPaciente should return success with list`() = runTest {
    ...
    @Test
    fun `getAgendaPaciente should return failure on exception`() = runTest {
    ...
    @Test
    fun `getAgendaPsicologo should return success with list`() = runTest {
        val list = listOf(agendaItem())
    ...
    @Test
    fun `getDuracion should return success`() = runTest {
    ...
    @Test
    fun `getDisponibilidadDia should return success`() = runTest {
        val response = DisponibilidadDiaResponse(
            fecha = LocalDate.of(2024, 1, 1),
            diaCompleto = false,
    ...
    @Test
    fun `crearCita should return success`() = runTest {
        val dto = agendaItem()
    ...
    @Test
    fun `cancelarCita should return success`() = runTest {
    ...
    @Test
    fun `editarCita should return success when response is successful`() = runTest {
        val dto = agendaItem()
    ...
    @Test
    fun `editarCita should return failure when response is not successful`() = runTest {
    ...
    @Test
    fun `getPacientesDelPsicologo should return patients for matching psychologist`() = runTest {
    ...
    @Test
    fun `getPacientesDelPsicologo should return empty list when psychologist not found`() = runTest {
    ...
    @Test
    fun `actualizarHorario should return success`() = runTest {
    ...
    @Test
    fun `actualizarDuracion should return success`() = runTest {
        coEvery { citasApi.actualizarDuracion(1L, 45) } returns Unit
    ...
    @Test
    fun `bloquearDiaNoDisponible should return success`() = runTest {
    ...
    @Test
    fun `quitarDiaNoDisponible should return success`() = runTest {
    ...
    @Test
    fun `getTerapias should return success`() = runTest {
    ...
    @Test
    fun `getHorarioActual should return success`() = runTest {
    ...
    @Test
    fun `getMisCitas should return list`() = runTest {
        val list = listOf(
    ...
    @Test
    fun `cambiarEstadoCita should return success when response is successful`() = runTest {
    ...
    @Test
    fun `cambiarEstadoCita should return failure when response is not successful`() = runTest {
        val errorBody = "error".toResponseBody("application/json".toMediaTypeOrNull())
