...
class SituacionRepositoryTest {
    ...
    @Test
    fun `getSituaciones should emit list when api succeeds`() =
        runTest {
    ...
    @Test
    fun `getSituaciones should emit empty list when api fails`() =
        runTest {
    ...
    @Test
    fun `getSituacionById should return success when api succeeds`() =
        runTest {
            val dto = SituacionDTO(1L, "N", "C", "D")
    ...
    @Test
    fun `createSituacion should return success when api succeeds`() =
        runTest {
    ...
    @Test
    fun `updateSituacion should return success when api succeeds`() =
        runTest {
            val request = SituacionRequest("N", "C", "D")
            val dto = SituacionDTO(1L, "N", "C", "D")
    ...
    @Test
    fun `deleteSituacion should return success when api succeeds`() =
        runTest {
