...
class NotificacionViewModelTest {
    ...
    @Test
    fun `toggle activates notifications`() =
        runTest {
    ...
    @Test
    fun `toggle deactivates notifications`() =
        runTest {
    ...
    @Test
    fun `toggle when useCase throws does not crash`() =
        runTest {
    ...
    @Test
    fun `boundary toggle with id 0 calls useCase`() =
        runTest {
