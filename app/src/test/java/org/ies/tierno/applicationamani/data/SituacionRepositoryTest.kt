...
class SituacionRepositoryTest {
    ...
    @Test
    fun `getSituaciones should emit mapped list when successful`() =
        runTest {
    ...
    @Test
    fun `getSituaciones should emit empty list on exception`() =
        runTest {
    ...
    @Test
    fun `getSituacionById should return failure when api returns error`() =
        runTest {
