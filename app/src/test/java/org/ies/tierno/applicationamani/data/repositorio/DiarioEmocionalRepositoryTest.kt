...
class DiarioEmocionalRepositoryTest {
    ...
    @Test
    fun `observeEntradas should map entities to domain`() = runTest {
        val entity = EntradaDiarioEntity(
            id = 1L,
            titulo = "T",
            contenido = "C",
            emocion = "Feliz",
    ...
    @Test
    fun `guardarEntrada should insert new entity when id is null`() = runTest {
    ...
    @Test
    fun `guardarEntrada should update existing entity when id is not null`() = runTest {
        val existing = EntradaDiarioEntity(
            id = 1L,
            titulo = "Old",
            contenido = "Old",
            emocion = "Triste",
    ...
    @Test
    fun `eliminarEntrada should update sync status to PENDING_DELETE`() = runTest {
