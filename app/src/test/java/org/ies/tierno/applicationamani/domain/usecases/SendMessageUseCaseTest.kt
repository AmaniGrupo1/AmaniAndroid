...
class SendMessageUseCaseTest {
    ...
    @Test
    fun `when send message succeeds, it should return success and not save offline`() =
        runTest {
            // Given
            coEvery {
    ...
    @Test
    fun `when send message fails, it should save it offline and return failure`() =
        runTest {
            // Given
    ...
    @Test
    fun `when send message fails with specific error, it propagates it correctly`() =
        runTest {
            // Given
