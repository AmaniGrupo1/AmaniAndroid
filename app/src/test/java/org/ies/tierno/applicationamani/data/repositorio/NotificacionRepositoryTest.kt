...
class NotificacionRepositoryTest {
    ...
    @Test
    fun `toggleNotificaciones should call api`() =
        runTest {
    ...
    @Test
    fun `getEstadoNotificaciones should return api response body`() =
        runTest {
    ...
    @Test
    fun `getNotificaciones should return api response`() =
        runTest {
    ...
    @Test
    fun `marcarLeida should call api`() =
        runTest {
    ...
    @Test
    fun `marcarTodasLeidas should call api`() =
        runTest {
    ...
    @Test
    fun `contarNoLeidas should return count`() =
        runTest {
