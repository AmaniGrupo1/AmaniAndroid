...
class LoginViewModelTest {
    ...
    @Test
    fun `login flow - Success should save session and update result`() = runTest {
    ...
    @Test
    fun `login validation - invalid email format should set error`() = runTest {
    ...
    @Test
    fun `psychologist validation - underage should fail`() = runTest {
    ...
    @Test
    fun `login with 401 error should show specific error message`() = runTest {
