...
.method private static castingIdentity()Ljava/util/function/Function;
    ...
    .line 391
    new-instance v0, Lj$/util/stream/DesugarCollectors$15;

    invoke-direct {v0}, Lj$/util/stream/DesugarCollectors$15;-><init>()V

    return-object v0
.end method

.method public static filtering(Ljava/util/function/Predicate;Ljava/util/stream/Collector;)Ljava/util/stream/Collector;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    .local p1, "downstream":Ljava/util/stream/Collector;, "Ljava/util/stream/Collector<-TT;TA;TR;>;"
    ...
    new-instance v3, Lj$/util/stream/DesugarCollectors$14;

    invoke-direct {v3, p0, v0}, Lj$/util/stream/DesugarCollectors$14;-><init>(Ljava/util/function/Predicate;Ljava/util/function/BiConsumer;)V
...
.method public static flatMapping(Ljava/util/function/Function;Ljava/util/stream/Collector;)Ljava/util/stream/Collector;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    new-instance v3, Lj$/util/stream/DesugarCollectors$10;

    invoke-direct {v3, p0, v0}, Lj$/util/stream/DesugarCollectors$10;-><init>(Ljava/util/function/Function;Ljava/util/function/BiConsumer;)V
...
.method static synthetic lambda$flatMapping$2(Ljava/util/function/Function;Ljava/util/function/BiConsumer;Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    .line 189
    .local v0, "result":Ljava/util/stream/Stream;, "Ljava/util/stream/Stream<+TU;>;"
    if-eqz v0, :cond_1
    ...
    new-instance v2, Lj$/util/stream/DesugarCollectors$9;

    invoke-direct {v2, p1, p2}, Lj$/util/stream/DesugarCollectors$9;-><init>(Ljava/util/function/BiConsumer;Ljava/lang/Object;)V
    ...
    .line 192
    .end local v0    # "result":Ljava/util/stream/Stream;, "Ljava/util/stream/Stream<+TU;>;"
    :cond_2
    return-void
.end method
...
.method static synthetic lambda$toUnmodifiableSet$8(Ljava/util/Set;)Ljava/util/Set;
    ...
    invoke-static {v0}, Lj$/util/stream/DesugarCollectors$0;->m([Ljava/lang/Object;)Ljava/util/Set;
...
.method public static toUnmodifiableList()Ljava/util/stream/Collector;
    ...
    new-instance v1, Lj$/util/stream/DesugarCollectors$1;

    invoke-direct {v1}, Lj$/util/stream/DesugarCollectors$1;-><init>()V

    new-instance v2, Lj$/util/stream/DesugarCollectors$2;

    invoke-direct {v2}, Lj$/util/stream/DesugarCollectors$2;-><init>()V

    new-instance v3, Lj$/util/stream/DesugarCollectors$3;

    invoke-direct {v3}, Lj$/util/stream/DesugarCollectors$3;-><init>()V

    new-instance v4, Lj$/util/stream/DesugarCollectors$4;

    invoke-direct {v4}, Lj$/util/stream/DesugarCollectors$4;-><init>()V
...
.method public static toUnmodifiableMap(Ljava/util/function/Function;Ljava/util/function/Function;)Ljava/util/stream/Collector;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    new-instance v1, Lj$/util/stream/DesugarCollectors$11;

    invoke-direct {v1}, Lj$/util/stream/DesugarCollectors$11;-><init>()V
...
.method public static toUnmodifiableMap(Ljava/util/function/Function;Ljava/util/function/Function;Ljava/util/function/BinaryOperator;)Ljava/util/stream/Collector;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    .line 296
    new-instance v0, Lj$/util/stream/DesugarCollectors$12;

    invoke-direct {v0}, Lj$/util/stream/DesugarCollectors$12;-><init>()V
    ...
    new-instance v1, Lj$/util/stream/DesugarCollectors$13;

    invoke-direct {v1}, Lj$/util/stream/DesugarCollectors$13;-><init>()V
...
.method public static toUnmodifiableSet()Ljava/util/stream/Collector;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    new-instance v1, Lj$/util/stream/DesugarCollectors$5;

    invoke-direct {v1}, Lj$/util/stream/DesugarCollectors$5;-><init>()V

    new-instance v2, Lj$/util/stream/DesugarCollectors$6;

    invoke-direct {v2}, Lj$/util/stream/DesugarCollectors$6;-><init>()V

    new-instance v3, Lj$/util/stream/DesugarCollectors$7;

    invoke-direct {v3}, Lj$/util/stream/DesugarCollectors$7;-><init>()V

    new-instance v4, Lj$/util/stream/DesugarCollectors$8;

    invoke-direct {v4}, Lj$/util/stream/DesugarCollectors$8;-><init>()V
