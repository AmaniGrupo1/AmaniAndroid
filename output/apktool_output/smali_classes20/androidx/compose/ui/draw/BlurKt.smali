...
.method public static final blur-1fqS-gw(Landroidx/compose/ui/Modifier;FFLandroidx/compose/ui/graphics/Shape;)Landroidx/compose/ui/Modifier;
    ...
    .param p1, "$v$c$androidx-compose-ui-unit-Dp$-radiusX$0"    # F
    .param p2, "$v$c$androidx-compose-ui-unit-Dp$-radiusY$0"    # F
    .param p3, "$v$c$androidx-compose-ui-draw-BlurredEdgeTreatment$-edgeTreatment$0"    # Landroidx/compose/ui/graphics/Shape;
    ...
    .end local p1    # "$v$c$androidx-compose-ui-unit-Dp$-radiusX$0":F
    .end local p2    # "$v$c$androidx-compose-ui-unit-Dp$-radiusY$0":F
    .end local p3    # "$v$c$androidx-compose-ui-draw-BlurredEdgeTreatment$-edgeTreatment$0":Landroidx/compose/ui/graphics/Shape;
    .local v3, "$v$c$androidx-compose-ui-unit-Dp$-radiusX$0":F
    .local v4, "$v$c$androidx-compose-ui-unit-Dp$-radiusY$0":F
    .local v6, "$v$c$androidx-compose-ui-draw-BlurredEdgeTreatment$-edgeTreatment$0":Landroidx/compose/ui/graphics/Shape;
    ...
    .line 122
    .end local v3    # "$v$c$androidx-compose-ui-unit-Dp$-radiusX$0":F
    .end local v4    # "$v$c$androidx-compose-ui-unit-Dp$-radiusY$0":F
    .end local v6    # "$v$c$androidx-compose-ui-draw-BlurredEdgeTreatment$-edgeTreatment$0":Landroidx/compose/ui/graphics/Shape;
    .restart local p1    # "$v$c$androidx-compose-ui-unit-Dp$-radiusX$0":F
    .restart local p2    # "$v$c$androidx-compose-ui-unit-Dp$-radiusY$0":F
    .restart local p3    # "$v$c$androidx-compose-ui-draw-BlurredEdgeTreatment$-edgeTreatment$0":Landroidx/compose/ui/graphics/Shape;
    :cond_3
    move v3, p1
    ...
    .end local p2    # "$v$c$androidx-compose-ui-unit-Dp$-radiusY$0":F
    .end local p3    # "$v$c$androidx-compose-ui-draw-BlurredEdgeTreatment$-edgeTreatment$0":Landroidx/compose/ui/graphics/Shape;
    .restart local v3    # "$v$c$androidx-compose-ui-unit-Dp$-radiusX$0":F
    .restart local v4    # "$v$c$androidx-compose-ui-unit-Dp$-radiusY$0":F
    .restart local v6    # "$v$c$androidx-compose-ui-draw-BlurredEdgeTreatment$-edgeTreatment$0":Landroidx/compose/ui/graphics/Shape;
    move-object p1, p0
...
.method public static final blur-F8QBwvs(Landroidx/compose/ui/Modifier;FLandroidx/compose/ui/graphics/Shape;)Landroidx/compose/ui/Modifier;
    ...
    .param p1, "$v$c$androidx-compose-ui-unit-Dp$-radius$0"    # F
    .param p2, "$v$c$androidx-compose-ui-draw-BlurredEdgeTreatment$-edgeTreatment$0"    # Landroidx/compose/ui/graphics/Shape;
