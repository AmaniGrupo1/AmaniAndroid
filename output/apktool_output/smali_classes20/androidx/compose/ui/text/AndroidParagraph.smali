...
.method private constructor <init>(Landroidx/compose/ui/text/platform/AndroidParagraphIntrinsics;IIJ)V
    ...
    .line 153
    invoke-virtual {v6}, Landroidx/compose/ui/text/platform/AndroidParagraphIntrinsics;->getCharSequence$ui_text()Ljava/lang/CharSequence;
    ...
    invoke-virtual {v3}, Landroidx/compose/ui/text/TextStyle;->getParagraphStyle$ui_text()Landroidx/compose/ui/text/ParagraphStyle;
    ...
    .local v25, "alignment":I
    .local v26, "justificationMode":I
    int-to-long v1, v12
    ...
    .line 259
    .local v9, "shaderBrushSpan":Landroidx/compose/ui/text/platform/style/ShaderBrushSpan;
    invoke-virtual {v0}, Landroidx/compose/ui/text/AndroidParagraph;->getWidth()F

    move-result v10

    .restart local v10    # "width$iv":F
    invoke-virtual {v0}, Landroidx/compose/ui/text/AndroidParagraph;->getHeight()F

    move-result v11

    .restart local v11    # "height$iv":F
    const/16 v17, 0x0

    .line 723
    .restart local v17    # "$i$f$Size":I
    move/from16 v20, v11

    .restart local v20    # "val2$iv$iv":F
    move/from16 v22, v10

    .restart local v22    # "val1$iv$iv":F
    const/16 v23, 0x0

    .line 724
    .restart local v23    # "$i$f$packFloats":I
    move/from16 v27, v12
    ...
    .local v28, "shaderBrushSpans":[Landroidx/compose/ui/text/platform/style/ShaderBrushSpan;
    int-to-long v1, v12
    ...
    .end local v1    # "v1$iv$iv":J
    .local v33, "v1$iv$iv":J
    int-to-long v1, v12

    .line 726
    .local v1, "v2$iv$iv":J
    shl-long v35, v33, v27
    ...
    .end local v11    # "height$iv":F
    .end local v17    # "$i$f$Size":I
    invoke-virtual {v9, v1, v2}, Landroidx/compose/ui/text/platform/style/ShaderBrushSpan;->setSize-uvyYCjk(J)V

    .line 258
    .end local v9    # "shaderBrushSpan":Landroidx/compose/ui/text/platform/style/ShaderBrushSpan;
    ...
    .end local v28    # "shaderBrushSpans":[Landroidx/compose/ui/text/platform/style/ShaderBrushSpan;
    .local v1, "shaderBrushSpans":[Landroidx/compose/ui/text/platform/style/ShaderBrushSpan;
    :cond_11
    move-object/from16 v28, v1

    .end local v1    # "shaderBrushSpans":[Landroidx/compose/ui/text/platform/style/ShaderBrushSpan;
    .restart local v28    # "shaderBrushSpans":[Landroidx/compose/ui/text/platform/style/ShaderBrushSpan;
    goto :goto_c
    ...
    .end local v25    # "alignment":I
    .end local v26    # "justificationMode":I
    :goto_c
    nop
    ...
    .local v1, "$this$placeholderRects_u24lambda_u240":Ljava/lang/CharSequence;
    const/4 v2, 0x0
    ...
    .end local v1    # "$this$placeholderRects_u24lambda_u240":Ljava/lang/CharSequence;
    .local v18, "$this$placeholderRects_u24lambda_u240":Ljava/lang/CharSequence;
    ...
    .local v23, "isPlaceholderSpanEllipsized":Z
    iget-object v3, v0, Landroidx/compose/ui/text/AndroidParagraph;->layout:Landroidx/compose/ui/text/android/TextLayout;
    ...
    .local v3, "$this$placeholderRects_u24lambda_u240_u240_u240":Landroidx/compose/ui/text/android/TextLayout;
    const/16 v29, 0x0
    ...
    .local v4, "$this$placeholderRects_u24lambda_u240_u240_u240_u240":Landroid/graphics/Paint$FontMetricsInt;
    const/16 v31, 0x0
    ...
    .line 339
    .end local v4    # "$this$placeholderRects_u24lambda_u240_u240_u240_u240":Landroid/graphics/Paint$FontMetricsInt;
    ...
    .line 326
    .end local v3    # "$this$placeholderRects_u24lambda_u240_u240_u240":Landroidx/compose/ui/text/android/TextLayout;
    ...
    .end local v23    # "isPlaceholderSpanEllipsized":Z
    .end local v26    # "end":I
    .end local v28    # "isPlaceholderSpanTruncated":Z
    .end local v31    # "line":I
    :goto_14
    ...
    .line 730
    .end local v18    # "$this$placeholderRects_u24lambda_u240":Ljava/lang/CharSequence;
    ...
    .restart local v18    # "$this$placeholderRects_u24lambda_u240":Ljava/lang/CharSequence;
...
.method static final getRangeForRect_8_6BmAI$lambda$0(Landroidx/compose/ui/text/TextInclusionStrategy;Landroid/graphics/RectF;Landroid/graphics/RectF;)Z
    .locals 2
    .param p0, "$inclusionStrategy"    # Landroidx/compose/ui/text/TextInclusionStrategy;
    ...
    .line 375
    invoke-interface {p0, v0, v1}, Landroidx/compose/ui/text/TextInclusionStrategy;->isIncluded(Landroidx/compose/ui/geometry/Rect;Landroidx/compose/ui/geometry/Rect;)Z
...
.method public getBoundingBox(I)Landroidx/compose/ui/geometry/Rect;
    ...
    .line 741
    .local v1, "$this$getBoundingBox_u24lambda_u241":Landroid/graphics/RectF;
    const/4 v2, 0x0
    ...
    .end local v1    # "$this$getBoundingBox_u24lambda_u241":Landroid/graphics/RectF;
...
.method public getOffsetForPosition-k-4lQ0M(J)I
    ...
    invoke-virtual {v1, v0, v8}, Landroidx/compose/ui/text/android/TextLayout;->getOffsetForHorizontal(IF)I
...
.method public getRangeForRect-8-6BmAI(Landroidx/compose/ui/geometry/Rect;ILandroidx/compose/ui/text/TextInclusionStrategy;)J
    ...
    .line 371
    new-instance v3, Landroidx/compose/ui/text/AndroidParagraph$$ExternalSyntheticLambda0;

    invoke-direct {v3, p3}, Landroidx/compose/ui/text/AndroidParagraph$$ExternalSyntheticLambda0;-><init>(Landroidx/compose/ui/text/TextInclusionStrategy;)V
...
.method public paint-LG529CI(Landroidx/compose/ui/graphics/Canvas;JLandroidx/compose/ui/graphics/Shadow;Landroidx/compose/ui/text/style/TextDecoration;Landroidx/compose/ui/graphics/drawscope/DrawStyle;I)V
    ...
    .local v1, "$this$paint_LG529CI_u24lambda_u240":Landroidx/compose/ui/text/platform/AndroidTextPaint;
    const/4 v2, 0x0
    ...
    .line 545
    .end local v1    # "$this$paint_LG529CI_u24lambda_u240":Landroidx/compose/ui/text/platform/AndroidTextPaint;
...
.method public paint-RPmYEkk(Landroidx/compose/ui/graphics/Canvas;JLandroidx/compose/ui/graphics/Shadow;Landroidx/compose/ui/text/style/TextDecoration;)V
    ...
    .local v0, "$this$paint_RPmYEkk_u24lambda_u240":Landroidx/compose/ui/text/platform/AndroidTextPaint;
    const/4 v1, 0x0
    ...
    .line 527
    .end local v0    # "$this$paint_RPmYEkk_u24lambda_u240":Landroidx/compose/ui/text/platform/AndroidTextPaint;
...
.method public paint-hn5TExg(Landroidx/compose/ui/graphics/Canvas;Landroidx/compose/ui/graphics/Brush;FLandroidx/compose/ui/graphics/Shadow;Landroidx/compose/ui/text/style/TextDecoration;Landroidx/compose/ui/graphics/drawscope/DrawStyle;I)V
    ...
    .local v1, "$this$paint_hn5TExg_u24lambda_u240":Landroidx/compose/ui/text/platform/AndroidTextPaint;
    const/4 v2, 0x0
    ...
    .line 568
    .end local v1    # "$this$paint_hn5TExg_u24lambda_u240":Landroidx/compose/ui/text/platform/AndroidTextPaint;
