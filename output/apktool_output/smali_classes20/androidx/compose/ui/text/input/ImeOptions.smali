...
.method public final synthetic copy-YTHSh70(ZIZIILandroidx/compose/ui/text/input/PlatformImeOptions;)Landroidx/compose/ui/text/input/ImeOptions;
    .locals 9
    .param p1, "singleLine"    # Z
    .param p2, "$v$c$androidx-compose-ui-text-input-KeyboardCapitalization$-capitalization$0"    # I
    .param p3, "autoCorrect"    # Z
    .param p4, "$v$c$androidx-compose-ui-text-input-KeyboardType$-keyboardType$0"    # I
    .param p5, "$v$c$androidx-compose-ui-text-input-ImeAction$-imeAction$0"    # I
    .param p6, "platformImeOptions"    # Landroidx/compose/ui/text/input/PlatformImeOptions;
    .annotation runtime Lkotlin/Deprecated;
        level = .enum Lkotlin/DeprecationLevel;->HIDDEN:Lkotlin/DeprecationLevel;
    ...
    .end local p1    # "singleLine":Z
    .end local p2    # "$v$c$androidx-compose-ui-text-input-KeyboardCapitalization$-capitalization$0":I
    .end local p3    # "autoCorrect":Z
    .end local p4    # "$v$c$androidx-compose-ui-text-input-KeyboardType$-keyboardType$0":I
    .end local p5    # "$v$c$androidx-compose-ui-text-input-ImeAction$-imeAction$0":I
    .end local p6    # "platformImeOptions":Landroidx/compose/ui/text/input/PlatformImeOptions;
    .local v1, "singleLine":Z
    .local v2, "$v$c$androidx-compose-ui-text-input-KeyboardCapitalization$-capitalization$0":I
    .local v3, "autoCorrect":Z
    .local v4, "$v$c$androidx-compose-ui-text-input-KeyboardType$-keyboardType$0":I
    .local v5, "$v$c$androidx-compose-ui-text-input-ImeAction$-imeAction$0":I
