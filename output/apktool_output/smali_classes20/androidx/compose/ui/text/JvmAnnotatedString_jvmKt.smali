...
.method private static final collectRangeTransitions(Ljava/util/List;Ljava/util/SortedSet;)V
    ...
    .local v14, "$this$collectRangeTransitions_u24lambda_u240_u240":Ljava/util/SortedSet;
    const/4 v15, 0x0
    ...
    .line 57
    .end local v14    # "$this$collectRangeTransitions_u24lambda_u240_u240":Ljava/util/SortedSet;
    ...
    .restart local v0    # "initial$iv":Ljava/lang/Object;
    :cond_0
    move-object/from16 v17, v0
...
.method public static final transform(Landroidx/compose/ui/text/AnnotatedString;Lkotlin/jvm/functions/Function3;)Landroidx/compose/ui/text/AnnotatedString;
    ...
    invoke-direct {v8, v3, v11, v1, v0}, Landroidx/compose/ui/text/JvmAnnotatedString_jvmKt$$ExternalSyntheticLambda0;-><init>(Lkotlin/jvm/internal/Ref$ObjectRef;Lkotlin/jvm/functions/Function3;Landroidx/compose/ui/text/AnnotatedString;Ljava/util/Map;)V
    ...
    .line 44
    invoke-virtual {v1}, Landroidx/compose/ui/text/AnnotatedString;->getAnnotations$ui_text()Ljava/util/List;
    ...
    invoke-direct {v1, v2, v4, v5}, Landroidx/compose/ui/text/AnnotatedString$Range;-><init>(Ljava/lang/Object;II)V
    ...
    .line 46
    .local v1, "newAnnotations":Ljava/util/List;
    ...
    invoke-direct {v2, v1, v4}, Landroidx/compose/ui/text/AnnotatedString;-><init>(Ljava/util/List;Ljava/lang/String;)V

    return-object v2
.end method

.method static final transform$lambda$0(Lkotlin/jvm/internal/Ref$ObjectRef;Lkotlin/jvm/functions/Function3;Landroidx/compose/ui/text/AnnotatedString;Ljava/util/Map;Ljava/util/List;)Ljava/lang/Integer;
    .locals 5
