...
.method static constructor <clinit>()V
    ...
    sput v0, Landroidx/compose/ui/text/font/AndroidFontLoader;->$stable:I
...
.method public awaitLoad(Landroidx/compose/ui/text/font/Font;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    :goto_0
    iget-object v1, v0, Landroidx/compose/ui/text/font/AndroidFontLoader$awaitLoad$1;->result:Ljava/lang/Object;
    ...
    .line 53
    iget v3, v0, Landroidx/compose/ui/text/font/AndroidFontLoader$awaitLoad$1;->label:I
    ...
    .local p1, "this":Landroidx/compose/ui/text/font/AndroidFontLoader;
    iget-object v2, v0, Landroidx/compose/ui/text/font/AndroidFontLoader$awaitLoad$1;->L$0:Ljava/lang/Object;
    ...
    .end local p1    # "this":Landroidx/compose/ui/text/font/AndroidFontLoader;
    :pswitch_1
    invoke-static {v1}, Lkotlin/ResultKt;->throwOnFailure(Ljava/lang/Object;)V
    ...
    .line 54
    .local v3, "this":Landroidx/compose/ui/text/font/AndroidFontLoader;
    ...
    iget-object v5, v3, Landroidx/compose/ui/text/font/AndroidFontLoader;->context:Landroid/content/Context;

    move-object v6, p1

    check-cast v6, Landroidx/compose/ui/text/font/AndroidFont;

    const/4 v7, 0x1

    iput v7, v0, Landroidx/compose/ui/text/font/AndroidFontLoader$awaitLoad$1;->label:I

    invoke-interface {v4, v5, v6, v0}, Landroidx/compose/ui/text/font/AndroidFont$TypefaceLoader;->awaitLoad(Landroid/content/Context;Landroidx/compose/ui/text/font/AndroidFont;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;

    move-result-object p1

    .end local v3    # "this":Landroidx/compose/ui/text/font/AndroidFontLoader;
    ...
    .line 56
    .restart local v3    # "this":Landroidx/compose/ui/text/font/AndroidFontLoader;
    ...
    iput v6, v0, Landroidx/compose/ui/text/font/AndroidFontLoader$awaitLoad$1;->label:I

    invoke-static {v4, v5, v0}, Landroidx/compose/ui/text/font/AndroidFontLoader_androidKt;->access$loadAsync(Landroidx/compose/ui/text/font/ResourceFont;Landroid/content/Context;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    invoke-virtual {v3}, Landroidx/compose/ui/text/font/ResourceFont;->getVariationSettings()Landroidx/compose/ui/text/font/FontVariation$Settings;

    move-result-object v3

    iget-object v5, p1, Landroidx/compose/ui/text/font/AndroidFontLoader;->context:Landroid/content/Context;

    invoke-static {v4, v3, v5}, Landroidx/compose/ui/text/font/PlatformTypefaces_androidKt;->setFontVariationSettings(Landroid/graphics/Typeface;Landroidx/compose/ui/text/font/FontVariation$Settings;Landroid/content/Context;)Landroid/graphics/Typeface;
    ...
    const-string v5, "Unknown font type: "
...
.method public loadBlocking(Landroidx/compose/ui/text/font/Font;)Landroid/graphics/Typeface;
    ...
    .line 41
    .local v2, "$i$a$-runCatching-AndroidFontLoader$loadBlocking$1":I
    move-object v3, p1

    check-cast v3, Landroidx/compose/ui/text/font/ResourceFont;

    iget-object v4, v0, Landroidx/compose/ui/text/font/AndroidFontLoader;->context:Landroid/content/Context;

    invoke-static {v3, v4}, Landroidx/compose/ui/text/font/AndroidFontLoader_androidKt;->access$load(Landroidx/compose/ui/text/font/ResourceFont;Landroid/content/Context;)Landroid/graphics/Typeface;

    move-result-object v3

    .end local v0    # "$this$loadBlocking_u24lambda_u240":Landroidx/compose/ui/text/font/AndroidFontLoader;
    .end local v2    # "$i$a$-runCatching-AndroidFontLoader$loadBlocking$1":I
    ...
    invoke-virtual {v1}, Landroidx/compose/ui/text/font/ResourceFont;->getVariationSettings()Landroidx/compose/ui/text/font/FontVariation$Settings;

    move-result-object v1

    iget-object v2, p0, Landroidx/compose/ui/text/font/AndroidFontLoader;->context:Landroid/content/Context;

    invoke-static {v0, v1, v2}, Landroidx/compose/ui/text/font/PlatformTypefaces_androidKt;->setFontVariationSettings(Landroid/graphics/Typeface;Landroidx/compose/ui/text/font/FontVariation$Settings;Landroid/content/Context;)Landroid/graphics/Typeface;
    ...
    invoke-virtual {v2}, Landroidx/compose/ui/text/font/ResourceFont;->getLoadingStrategy-PKNRLFQ()I
