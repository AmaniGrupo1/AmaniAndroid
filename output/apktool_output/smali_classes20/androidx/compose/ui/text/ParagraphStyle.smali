...
.method private constructor <init>(IIJLandroidx/compose/ui/text/style/TextIndent;Landroidx/compose/ui/text/PlatformParagraphStyle;Landroidx/compose/ui/text/style/LineHeightStyle;IILandroidx/compose/ui/text/style/TextMotion;)V
    ...
    iput v1, v0, Landroidx/compose/ui/text/ParagraphStyle;->textAlign:I

    .line 68
    move/from16 v2, p2

    iput v2, v0, Landroidx/compose/ui/text/ParagraphStyle;->textDirection:I

    .line 69
    move-wide/from16 v3, p3

    iput-wide v3, v0, Landroidx/compose/ui/text/ParagraphStyle;->lineHeight:J

    .line 70
    move-object/from16 v5, p5

    iput-object v5, v0, Landroidx/compose/ui/text/ParagraphStyle;->textIndent:Landroidx/compose/ui/text/style/TextIndent;

    .line 71
    move-object/from16 v6, p6

    iput-object v6, v0, Landroidx/compose/ui/text/ParagraphStyle;->platformStyle:Landroidx/compose/ui/text/PlatformParagraphStyle;

    .line 72
    move-object/from16 v7, p7

    iput-object v7, v0, Landroidx/compose/ui/text/ParagraphStyle;->lineHeightStyle:Landroidx/compose/ui/text/style/LineHeightStyle;

    .line 73
    move/from16 v8, p8

    iput v8, v0, Landroidx/compose/ui/text/ParagraphStyle;->lineBreak:I

    .line 74
    move/from16 v9, p9

    iput v9, v0, Landroidx/compose/ui/text/ParagraphStyle;->hyphens:I

    .line 75
    move-object/from16 v10, p10

    iput-object v10, v0, Landroidx/compose/ui/text/ParagraphStyle;->textMotion:Landroidx/compose/ui/text/style/TextMotion;
    ...
    .line 209
    .local v13, "$i$a$-checkPrecondition-ParagraphStyle$1":I
    new-instance v14, Ljava/lang/StringBuilder;

    invoke-direct {v14}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v15, "lineHeight can\'t be negative ("

    invoke-virtual {v14, v15}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v14

    iget-wide v1, v0, Landroidx/compose/ui/text/ParagraphStyle;->lineHeight:J
    ...
    .line 533
    .end local v13    # "$i$a$-checkPrecondition-ParagraphStyle$1":I
...
.method public final synthetic copy-Elsmlbk(Landroidx/compose/ui/text/style/TextAlign;Landroidx/compose/ui/text/style/TextDirection;JLandroidx/compose/ui/text/style/TextIndent;)Landroidx/compose/ui/text/ParagraphStyle;
    ...
    .param p1, "textAlign"    # Landroidx/compose/ui/text/style/TextAlign;
    .param p2, "textDirection"    # Landroidx/compose/ui/text/style/TextDirection;
    .param p3, "$v$c$androidx-compose-ui-unit-TextUnit$-lineHeight$0"    # J
    .param p5, "textIndent"    # Landroidx/compose/ui/text/style/TextIndent;
    .annotation runtime Lkotlin/Deprecated;
        level = .enum Lkotlin/DeprecationLevel;->HIDDEN:Lkotlin/DeprecationLevel;
...
.method public final copy-ykzQM6k(IIJLandroidx/compose/ui/text/style/TextIndent;Landroidx/compose/ui/text/PlatformParagraphStyle;Landroidx/compose/ui/text/style/LineHeightStyle;IILandroidx/compose/ui/text/style/TextMotion;)Landroidx/compose/ui/text/ParagraphStyle;
    .locals 12
    .param p1, "$v$c$androidx-compose-ui-text-style-TextAlign$-textAlign$0"    # I
    .param p2, "$v$c$androidx-compose-ui-text-style-TextDirection$-textDirection$0"    # I
    .param p3, "$v$c$androidx-compose-ui-unit-TextUnit$-lineHeight$0"    # J
    .param p5, "textIndent"    # Landroidx/compose/ui/text/style/TextIndent;
    .param p6, "platformStyle"    # Landroidx/compose/ui/text/PlatformParagraphStyle;
    .param p7, "lineHeightStyle"    # Landroidx/compose/ui/text/style/LineHeightStyle;
    .param p8, "$v$c$androidx-compose-ui-text-style-LineBreak$-lineBreak$0"    # I
    .param p9, "$v$c$androidx-compose-ui-text-style-Hyphens$-hyphens$0"    # I
    .param p10, "textMotion"    # Landroidx/compose/ui/text/style/TextMotion;
