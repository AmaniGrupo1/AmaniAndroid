...
.method public static final getAllUncoveredSemanticsNodesToIntObjectMap(Landroidx/compose/ui/semantics/SemanticsOwner;ILkotlin/jvm/functions/Function1;)Landroidx/collection/IntObjectMap;
    ...
    .param p2, "shouldIgnoreNode"    # Lkotlin/jvm/functions/Function1;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Landroidx/compose/ui/semantics/SemanticsOwner;",
    ...
    invoke-virtual {v5}, Landroidx/compose/ui/semantics/SemanticsNode;->getLayoutNode$ui()Landroidx/compose/ui/node/LayoutNode;
    ...
    .end local v8    # "shouldIgnoreNode":Lkotlin/jvm/functions/Function1;
    ...
    .restart local p2    # "shouldIgnoreNode":Lkotlin/jvm/functions/Function1;
    :cond_1
    move v6, p1
    ...
    .restart local v8    # "shouldIgnoreNode":Lkotlin/jvm/functions/Function1;
    :goto_1
    :try_start_2
...
.method private static final getAllUncoveredSemanticsNodesToIntObjectMap$lambda$0$findAllSemanticNodesRecursive(Landroidx/compose/ui/semantics/SemanticsRegion;Landroidx/compose/ui/semantics/SemanticsNode;ILandroidx/collection/MutableIntObjectMap;Lkotlin/jvm/functions/Function1;Landroidx/compose/ui/semantics/SemanticsNode;Landroidx/compose/ui/semantics/SemanticsRegion;)V
    ...
    .param p4, "$shouldIgnoreNode"    # Lkotlin/jvm/functions/Function1;
    .param p5, "currentNode"    # Landroidx/compose/ui/semantics/SemanticsNode;
    .param p6, "region"    # Landroidx/compose/ui/semantics/SemanticsRegion;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 176
    .local v8, "notAttachedOrPlaced":Z
    nop
    ...
    .line 184
    .local v9, "touchBoundsInRoot":Landroidx/compose/ui/unit/IntRect;
    invoke-interface {v6, v9}, Landroidx/compose/ui/semantics/SemanticsRegion;->set(Landroidx/compose/ui/unit/IntRect;)V
    ...
    invoke-direct {v0, v7, v1}, Landroidx/compose/ui/semantics/SemanticsNodeWithAdjustedBounds;-><init>(Landroidx/compose/ui/semantics/SemanticsNode;Landroidx/compose/ui/unit/IntRect;)V

    invoke-virtual {v3, v10, v0}, Landroidx/collection/MutableIntObjectMap;->set(ILjava/lang/Object;)V
    ...
    .line 207
    invoke-interface {p0, v9}, Landroidx/compose/ui/semantics/SemanticsRegion;->difference(Landroidx/compose/ui/unit/IntRect;)Z
    ...
    .line 214
    .local v5, "parentNode":Landroidx/compose/ui/semantics/SemanticsNode;
    if-eqz v5, :cond_9
    ...
    .line 220
    invoke-direct {v2, v7, v6}, Landroidx/compose/ui/semantics/SemanticsNodeWithAdjustedBounds;-><init>(Landroidx/compose/ui/semantics/SemanticsNode;Landroidx/compose/ui/unit/IntRect;)V

    .line 219
    invoke-virtual {v4, v10, v2}, Landroidx/collection/MutableIntObjectMap;->set(ILjava/lang/Object;)V

    .end local v1    # "boundsForFakeNode":Landroidx/compose/ui/geometry/Rect;
    .end local v5    # "parentNode":Landroidx/compose/ui/semantics/SemanticsNode;
    goto :goto_6
    ...
    .line 233
    invoke-virtual {v4, v10, v1}, Landroidx/collection/MutableIntObjectMap;->set(ILjava/lang/Object;)V
...
.method public static final isImportantForAccessibility(Landroidx/compose/ui/semantics/SemanticsNode;)Z
    ...
    invoke-virtual {v0}, Landroidx/compose/ui/semantics/SemanticsConfiguration;->containsImportantForAccessibility$ui()Z
