...
.method static constructor <clinit>()V
    ...
    sput v0, Landroidx/compose/ui/tooling/animation/AnimationSearch$AnimatedContentSearch;->$stable:I
...
.method private final toAnimationGroup(Landroidx/compose/ui/tooling/data/Group;)Landroidx/compose/ui/tooling/data/Group;
    ...
    .line 443
    .local v1, "$i$a$-takeIf-AnimationSearch$AnimatedContentSearch$toAnimationGroup$1":I
    ...
    .end local v1    # "$i$a$-takeIf-AnimationSearch$AnimatedContentSearch$toAnimationGroup$1":I
    :goto_0
    const/4 v0, 0x0
    ...
    .line 445
    .local v2, "$i$a$-let-AnimationSearch$AnimatedContentSearch$toAnimationGroup$2":I
    ...
    .line 446
    .local v8, "$i$a$-firstOrNull-AnimationSearch$AnimatedContentSearch$toAnimationGroup$2$1":I
    ...
    .end local v8    # "$i$a$-firstOrNull-AnimationSearch$AnimatedContentSearch$toAnimationGroup$2$1":I
    if-eqz v7, :cond_2
    ...
    .end local v2    # "$i$a$-let-AnimationSearch$AnimatedContentSearch$toAnimationGroup$2":I
    :cond_4
    nop
...
.method public addAnimations(Ljava/util/Collection;)V
    ...
    .line 437
    invoke-virtual/range {p0 .. p0}, Landroidx/compose/ui/tooling/animation/AnimationSearch$AnimatedContentSearch;->getAnimations()Ljava/util/Set;
    ...
    .line 437
    .local v13, "$i$a$-mapNotNull-AnimationSearch$AnimatedContentSearch$addAnimations$1":I
    move-object/from16 v14, p0

    invoke-direct {v14, v12}, Landroidx/compose/ui/tooling/animation/AnimationSearch$AnimatedContentSearch;->toAnimationGroup(Landroidx/compose/ui/tooling/data/Group;)Landroidx/compose/ui/tooling/data/Group;

    move-result-object v12

    .line 461
    .end local v12    # "it":Landroidx/compose/ui/tooling/data/Group;
    .end local v13    # "$i$a$-mapNotNull-AnimationSearch$AnimatedContentSearch$addAnimations$1":I
    if-eqz v12, :cond_0
