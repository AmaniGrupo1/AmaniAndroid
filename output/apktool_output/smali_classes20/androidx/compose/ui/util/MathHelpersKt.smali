...
.method public static final fastCoerceIn(DDD)D
    ...
    .local v1, "minimumValue$iv":D
    move-wide v3, p0

    .local v3, "$this$fastCoerceAtLeast$iv":D
    const/4 v5, 0x0
    ...
    .line 83
    .end local v1    # "minimumValue$iv":D
    .end local v3    # "$this$fastCoerceAtLeast$iv":D
    .end local v5    # "$i$f$fastCoerceAtLeast":I
    :goto_0
    move-wide v3, p4

    .local v1, "$this$fastCoerceAtMost$iv":D
    .local v3, "maximumValue$iv":D
    const/4 v5, 0x0
    ...
    .end local v3    # "maximumValue$iv":D
...
.method public static final fastCoerceIn(FFF)F
    ...
    .local v2, "$this$fastCoerceAtMost$iv":F
    const/4 v3, 0x0
    ...
    .end local v2    # "$this$fastCoerceAtMost$iv":F
...
.method public static final fastCoerceIn(III)I
    ...
    .local v2, "$this$fastCoerceAtMost$iv":I
    const/4 v3, 0x0
    ...
    .end local v2    # "$this$fastCoerceAtMost$iv":I
    .end local v3    # "$i$f$fastCoerceAtMost":I
    :cond_1
    return v2
.end method
...
.method public static final fastCoerceIn(JJJ)J
    ...
    .line 119
    .end local v1    # "minimumValue$iv":J
    ...
    .end local v3    # "maximumValue$iv":J
    .end local v5    # "$i$f$fastCoerceAtMost":I
    :goto_1
    return-wide v3
.end method
