...
.method public final calculateOcclusions()Ljava/util/List;
    ...
    .local v6, "$this$calculateOcclusions_u24lambda_u240":Ljava/util/List;
    const/4 v7, 0x0
    ...
    .local v9, "this_$iv":Landroidx/compose/ui/spatial/RectList;
    const/4 v10, 0x0

    .line 331
    .local v10, "$i$f$forEachIntersectingRectWithValueAt":I
    iget-object v11, v9, Landroidx/compose/ui/spatial/RectList;->items:[J

    .line 332
    .local v11, "items$iv":[J
    iget v12, v9, Landroidx/compose/ui/spatial/RectList;->itemsSize:I
    ...
    .line 335
    .local v13, "destTopLeft$iv":J
    add-int/lit8 v15, v8, 0x1

    aget-wide v15, v11, v15

    .line 337
    .local v15, "destBottomRight$iv":J
    const/16 v17, 0x0
    ...
    .local v17, "rectList":Landroidx/compose/ui/spatial/RectList;
    array-length v3, v11
    ...
    .local v22, "destRB$iv$iv":J
    move-wide/from16 v24, v20

    .local v24, "srcRB$iv$iv":J
    move-wide/from16 v26, v13

    .local v26, "destLT$iv$iv":J
    move-wide/from16 v28, v18

    .local v28, "srcLT$iv$iv":J
    const/4 v3, 0x0

    .line 347
    .local v3, "$i$f$rectIntersectsRect":I
    sub-long v30, v22, v28

    const-wide v32, 0x100000001L

    sub-long v30, v30, v32

    sub-long v34, v24, v26
    ...
    .line 348
    .local v30, "a$iv$iv":J
    const-wide v32, -0x7fffffff80000000L    # -1.0609978955E-314
    ...
    .line 346
    .end local v3    # "$i$f$rectIntersectsRect":I
    .end local v22    # "destRB$iv$iv":J
    .end local v24    # "srcRB$iv$iv":J
    .end local v26    # "destLT$iv$iv":J
    .end local v28    # "srcLT$iv$iv":J
    .end local v30    # "a$iv$iv":J
    :goto_1
    if-eqz v32, :cond_4
    ...
    .local v22, "xy$iv$iv":J
    const/4 v3, 0x0

    .line 351
    .local v3, "$i$f$unpackX":I
    const/16 v24, 0x20
    ...
    .end local v3    # "$i$f$unpackX":I
    .end local v4    # "idIndex":I
    .local v25, "idIndex":I
    .local v26, "$i$f$unpackX":I
    shr-long v3, v22, v24

    long-to-int v3, v3

    .line 352
    .end local v22    # "xy$iv$iv":J
    .end local v26    # "$i$f$unpackX":I
    nop

    .restart local v22    # "xy$iv$iv":J
    const/4 v4, 0x0
    ...
    .end local v22    # "xy$iv$iv":J
    .local v3, "xy$iv$iv":J
    .local v27, "$i$f$unpackY":I
    long-to-int v3, v3

    .line 354
    .end local v3    # "xy$iv$iv":J
    .end local v27    # "$i$f$unpackY":I
    ...
    .end local v4    # "$i$f$unpackY":I
    .end local v22    # "xy$iv$iv":J
    .restart local v3    # "xy$iv$iv":J
    .local v28, "$i$f$unpackY":I
    long-to-int v3, v3

    .line 358
    .end local v3    # "xy$iv$iv":J
    .end local v28    # "$i$f$unpackY":I
    ...
    .line 359
    .local v23, "$i$f$unpackMetaValue":I
    move/from16 v28, v0
    ...
    .end local v23    # "$i$f$unpackMetaValue":I
    nop
    ...
    .line 175
    .local v24, "$i$a$-forEachIntersectingRectWithValueAt-RelativeLayoutBounds$calculateOcclusions$1$1":I
    invoke-virtual {v1, v2, v0}, Landroidx/compose/ui/spatial/RectManager;->isTargetDrawnFirst$ui(II)Z
    ...
    .local v2, "r":I
    .local v22, "id":I
    .local v27, "rectManager":Landroidx/compose/ui/spatial/RectManager;
    invoke-direct {v0, v1, v4, v2, v3}, Landroidx/compose/ui/unit/IntRect;-><init>(IIII)V
    ...
    .line 175
    .end local v26    # "intersectingId":I
    .end local v27    # "rectManager":Landroidx/compose/ui/spatial/RectManager;
    ...
    .local v2, "r":I
    .local v22, "id":I
    .restart local v26    # "intersectingId":I
    .restart local v27    # "rectManager":Landroidx/compose/ui/spatial/RectManager;
    :goto_2
    nop
    ...
    .end local v3    # "b":I
    .end local v4    # "t":I
    .end local v24    # "$i$a$-forEachIntersectingRectWithValueAt-RelativeLayoutBounds$calculateOcclusions$1$1":I
    .end local v26    # "intersectingId":I
    goto :goto_3
    ...
    .line 360
    .end local v0    # "i$iv":I
    .end local v1    # "rectManager":Landroidx/compose/ui/spatial/RectManager;
    .end local v2    # "id":I
    .end local v4    # "idIndex":I
    .restart local v22    # "id":I
    .restart local v25    # "idIndex":I
    .restart local v27    # "rectManager":Landroidx/compose/ui/spatial/RectManager;
    .restart local v28    # "i$iv":I
    :goto_3
    nop

    .end local v18    # "topLeft$iv":J
    ...
    .end local v25    # "idIndex":I
    .end local v27    # "rectManager":Landroidx/compose/ui/spatial/RectManager;
    .restart local v1    # "rectManager":Landroidx/compose/ui/spatial/RectManager;
    ...
    .end local v9    # "this_$iv":Landroidx/compose/ui/spatial/RectList;
    .end local v10    # "$i$f$forEachIntersectingRectWithValueAt":I
    .end local v11    # "items$iv":[J
    .end local v12    # "size$iv":I
    .end local v13    # "destTopLeft$iv":J
    .end local v15    # "destBottomRight$iv":J
    .end local v28    # "i$iv":I
    nop

    .line 173
    .end local v6    # "$this$calculateOcclusions_u24lambda_u240":Ljava/util/List;
...
.method public final fractionVisibleIn(Landroidx/compose/ui/spatial/RelativeLayoutBounds;)F
    ...
    .line 364
    .local v8, "$i$f$unpackY":I
    long-to-int v5, v5

    .line 199
    .end local v5    # "xy$iv":J
    .end local v8    # "$i$f$unpackY":I
    move-wide v8, v2
    ...
    .line 365
    .restart local v6    # "$i$f$unpackX":I
    shr-long v10, v8, v7
    ...
    .line 366
    .local v9, "$i$f$unpackY":I
    long-to-int v7, v7

    .line 196
    .end local v7    # "xy$iv":J
    .end local v9    # "$i$f$unpackY":I
...
.method public final fractionVisibleInWindowWithInsets-E1MhUcY(JJ)F
    .locals 11
    .param p1, "$v$c$androidx-compose-ui-unit-IntOffset$-topLeftInset$0"    # J
    .param p3, "$v$c$androidx-compose-ui-unit-IntOffset$-bottomRightInset$0"    # J
...
.method public final getPositionInScreen-nOcc-ac()J
    ...
    iget-wide v1, v0, Landroidx/compose/ui/spatial/RelativeLayoutBounds;->screenOffset:J
    ...
    .line 67
    .local v1, "x":I
    iget-wide v2, v0, Landroidx/compose/ui/spatial/RelativeLayoutBounds;->screenOffset:J
    ...
    .line 68
    .local v2, "y":I
    iget-wide v3, v0, Landroidx/compose/ui/spatial/RelativeLayoutBounds;->topLeft:J

    .local v3, "xy$iv":J
    const/4 v5, 0x0

    .line 311
    .local v5, "$i$f$unpackX":I
    const/16 v6, 0x20
    ...
    .line 68
    .end local v3    # "xy$iv":J
    .end local v5    # "$i$f$unpackX":I
    nop

    .line 69
    .local v3, "l":I
    iget-wide v4, v0, Landroidx/compose/ui/spatial/RelativeLayoutBounds;->topLeft:J
...
.method public final getPositionInWindow-nOcc-ac()J
    ...
    iget-wide v2, v0, Landroidx/compose/ui/spatial/RelativeLayoutBounds;->windowOffset:J
    ...
    iget-wide v3, v0, Landroidx/compose/ui/spatial/RelativeLayoutBounds;->windowOffset:J
