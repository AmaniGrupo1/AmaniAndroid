...
.method public static final constrain-4WqzIAM(JJ)J
    .locals 14
    .param p0, "$v$c$androidx-compose-ui-unit-Constraints$-$this$constrain$0"    # J
    ...
    .end local v2    # "$i$f$fastCoerceIn":I
...
.method public static final constrain-N9IONVI(JJ)J
    .locals 14
    .param p0, "$v$c$androidx-compose-ui-unit-Constraints$-$this$constrain$0"    # J
    .param p2, "$v$c$androidx-compose-ui-unit-Constraints$-otherConstraints$0"    # J
    ...
    .restart local v5    # "maximumValue$iv":I
    move v6, v0

    .restart local v6    # "minimumValue$iv":I
    const/4 v7, 0x0
    ...
    .local v8, "maximumValue$iv$iv":I
    .local v10, "$this$fastCoerceAtMost$iv$iv":I
    const/4 v11, 0x0
    ...
    .line 651
    .end local v8    # "maximumValue$iv$iv":I
    .end local v10    # "$this$fastCoerceAtMost$iv$iv":I
    ...
    .local v8, "maximumValue$iv$iv":I
    .local v11, "$this$fastCoerceAtMost$iv$iv":I
    const/4 v12, 0x0
    ...
    .line 661
    .end local v8    # "maximumValue$iv$iv":I
    .end local v11    # "$this$fastCoerceAtMost$iv$iv":I
    ...
    .end local v6    # "minimumValue$iv":I
    .end local v7    # "$i$f$fastCoerceIn":I
    invoke-static {v9, v10, v11, v12}, Landroidx/compose/ui/unit/ConstraintsKt;->Constraints(IIII)J
...
.method public static final constrainHeight-K40F9xA(JI)I
    .locals 7
    .param p0, "$v$c$androidx-compose-ui-unit-Constraints$-$this$constrainHeight$0"    # J
    .param p2, "height"    # I
...
.method public static final constrainWidth-K40F9xA(JI)I
    .locals 7
    .param p0, "$v$c$androidx-compose-ui-unit-Constraints$-$this$constrainWidth$0"    # J
    .param p2, "width"    # I
...
.method public static final createConstraints(IIII)J
    ...
    .line 635
    .local v10, "$i$f$bitOffsetToIndex":I
    ...
    .end local v10    # "$i$f$bitOffsetToIndex":I
    nop
    ...
    .local v9, "bitOffset$iv":I
    const/4 v10, 0x0

    .line 636
    .local v10, "$i$f$minHeightOffsets":I
    add-int/lit8 v9, v9, 0xf

    .line 442
    .end local v9    # "bitOffset$iv":I
    .end local v10    # "$i$f$minHeightOffsets":I
    nop
...
.method public static final isSatisfiedBy-4WqzIAM(JJ)Z
    .locals 12
    .param p0, "$v$c$androidx-compose-ui-unit-Constraints$-$this$isSatisfiedBy$0"    # J
    .param p2, "$v$c$androidx-compose-ui-unit-IntSize$-size$0"    # J
...
.method public static final offset-NN6Ew-U(JII)J
    .locals 9
    .param p0, "$v$c$androidx-compose-ui-unit-Constraints$-$this$offset$0"    # J
    ...
    .line 732
    .local v3, "$i$f$addMaxWithMinimum":I
    const v4, 0x7fffffff
    ...
    .end local v3    # "$i$f$addMaxWithMinimum":I
    invoke-static {p0, p1}, Landroidx/compose/ui/unit/Constraints;->getMinHeight-impl(J)I
    ...
    .line 738
    .local v6, "$i$f$addMaxWithMinimum":I
    if-ne v2, v4, :cond_4
    ...
    .end local v6    # "$i$f$addMaxWithMinimum":I
    invoke-static {v0, v5, v1, v4}, Landroidx/compose/ui/unit/ConstraintsKt;->Constraints(IIII)J
