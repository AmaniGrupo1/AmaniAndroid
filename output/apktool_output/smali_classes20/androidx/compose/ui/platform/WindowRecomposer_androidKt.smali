...
.method public static final createLifecycleAwareWindowRecomposer(Landroid/view/View;Lkotlin/coroutines/CoroutineContext;Landroidx/lifecycle/Lifecycle;)Landroidx/compose/runtime/Recomposer;
    ...
    .line 450
    .local v5, "$this$createLifecycleAwareWindowRecomposer_u24lambda_u240_u240":Landroidx/compose/runtime/PausableMonotonicFrameClock;
    const/4 v6, 0x0
    ...
    .end local v5    # "$this$createLifecycleAwareWindowRecomposer_u24lambda_u240_u240":Landroidx/compose/runtime/PausableMonotonicFrameClock;
...
.method public static final findViewTreeCompositionContext(Landroid/view/View;)Landroidx/compose/runtime/CompositionContext;
    ...
    invoke-static {v2}, Landroidx/core/viewtree/ViewTree;->getParentOrViewTreeDisjointParent(Landroid/view/View;)Landroid/view/ViewParent;
...
.method private static final getAnimationScaleFlowFor(Landroid/content/Context;)Lkotlinx/coroutines/flow/StateFlow;
    ...
    :try_start_0
    sget-object v3, Landroidx/compose/ui/platform/WindowRecomposer_androidKt;->animationScale:Ljava/util/Map;
    ...
    .line 100
    .local v7, "$i$a$-getOrPut-WindowRecomposer_androidKt$getAnimationScaleFlowFor$1$1":I
    ...
    .line 103
    .local v11, "animationScaleUri":Landroid/net/Uri;
    const/4 v8, -0x1
    ...
    invoke-static {v8, v12, v12, v9, v12}, Lkotlinx/coroutines/channels/ChannelKt;->Channel$default(ILkotlinx/coroutines/channels/BufferOverflow;Lkotlin/jvm/functions/Function1;ILjava/lang/Object;)Lkotlinx/coroutines/channels/Channel;
    ...
    new-instance v12, Landroidx/compose/ui/platform/WindowRecomposer_androidKt$getAnimationScaleFlowFor$1$1$contentObserver$1;

    invoke-direct {v12, v13, v8}, Landroidx/compose/ui/platform/WindowRecomposer_androidKt$getAnimationScaleFlowFor$1$1$contentObserver$1;-><init>(Lkotlinx/coroutines/channels/Channel;Landroid/os/Handler;)V

    .line 104
    nop

    .line 112
    .local v12, "contentObserver":Landroidx/compose/ui/platform/WindowRecomposer_androidKt$getAnimationScaleFlowFor$1$1$contentObserver$1;
    new-instance v9, Landroidx/compose/ui/platform/WindowRecomposer_androidKt$getAnimationScaleFlowFor$1$1$1;

    const/4 v15, 0x0

    move-object/from16 v14, p0

    invoke-direct/range {v9 .. v15}, Landroidx/compose/ui/platform/WindowRecomposer_androidKt$getAnimationScaleFlowFor$1$1$1;-><init>(Landroid/content/ContentResolver;Landroid/net/Uri;Landroidx/compose/ui/platform/WindowRecomposer_androidKt$getAnimationScaleFlowFor$1$1$contentObserver$1;Lkotlinx/coroutines/channels/Channel;Landroid/content/Context;Lkotlin/coroutines/Continuation;)V
    ...
    :try_start_1
    invoke-static {v15, v0, v2}, Landroid/provider/Settings$Global;->getFloat(Landroid/content/ContentResolver;Ljava/lang/String;F)F
    ...
    .line 128
    invoke-static {v8, v9, v14, v0}, Lkotlinx/coroutines/flow/FlowKt;->stateIn(Lkotlinx/coroutines/flow/Flow;Lkotlinx/coroutines/CoroutineScope;Lkotlinx/coroutines/flow/SharingStarted;Ljava/lang/Object;)Lkotlinx/coroutines/flow/StateFlow;
    ...
    .line 441
    .end local v7    # "$i$a$-getOrPut-WindowRecomposer_androidKt$getAnimationScaleFlowFor$1$1":I
    .end local v10    # "resolver":Landroid/content/ContentResolver;
    .end local v11    # "animationScaleUri":Landroid/net/Uri;
    .end local v12    # "contentObserver":Landroidx/compose/ui/platform/WindowRecomposer_androidKt$getAnimationScaleFlowFor$1$1$contentObserver$1;
...
.method public static final getWindowRecomposer(Landroid/view/View;)Landroidx/compose/runtime/Recomposer;
    ...
    invoke-virtual {v2, v0}, Landroidx/compose/ui/platform/WindowRecomposerPolicy;->createAndInstallWindowRecomposer$ui(Landroid/view/View;)Landroidx/compose/runtime/Recomposer;
