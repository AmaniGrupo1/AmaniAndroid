...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v1, p0, Landroidx/compose/ui/platform/AndroidPlatformTextInputSession$startInputMethod$3;->L$1:Ljava/lang/Object;

    check-cast v1, Landroidx/compose/ui/platform/AndroidPlatformTextInputSession;

    iget-object v1, p0, Landroidx/compose/ui/platform/AndroidPlatformTextInputSession$startInputMethod$3;->L$0:Ljava/lang/Object;
    ...
    .line 80
    .local v1, "methodSession":Landroidx/compose/ui/platform/InputMethodSession;
    iget-object v2, p0, Landroidx/compose/ui/platform/AndroidPlatformTextInputSession$startInputMethod$3;->this$0:Landroidx/compose/ui/platform/AndroidPlatformTextInputSession;

    const/4 v3, 0x0

    .line 184
    .local v3, "$i$f$suspendCancellableCoroutine":I
    iput-object v1, p0, Landroidx/compose/ui/platform/AndroidPlatformTextInputSession$startInputMethod$3;->L$0:Ljava/lang/Object;

    iput-object v2, p0, Landroidx/compose/ui/platform/AndroidPlatformTextInputSession$startInputMethod$3;->L$1:Ljava/lang/Object;

    const/4 v4, 0x1

    iput v4, p0, Landroidx/compose/ui/platform/AndroidPlatformTextInputSession$startInputMethod$3;->label:I
    ...
    .line 82
    .local v8, "$i$a$-suspendCancellableCoroutine-AndroidPlatformTextInputSession$startInputMethod$3$1":I
    invoke-static {v2}, Landroidx/compose/ui/platform/AndroidPlatformTextInputSession;->access$getTextInputService$p(Landroidx/compose/ui/platform/AndroidPlatformTextInputSession;)Landroidx/compose/ui/text/input/TextInputService;

    move-result-object v9

    invoke-virtual {v9}, Landroidx/compose/ui/text/input/TextInputService;->startInput()V

    .line 89
    new-instance v9, Landroidx/compose/ui/platform/AndroidPlatformTextInputSession$startInputMethod$3$1$1;

    invoke-direct {v9, v1, v2}, Landroidx/compose/ui/platform/AndroidPlatformTextInputSession$startInputMethod$3$1$1;-><init>(Landroidx/compose/ui/platform/InputMethodSession;Landroidx/compose/ui/platform/AndroidPlatformTextInputSession;)V
    ...
    .line 96
    .end local v1    # "methodSession":Landroidx/compose/ui/platform/InputMethodSession;
    nop

    .line 192
    .end local v4    # "continuation":Lkotlinx/coroutines/CancellableContinuation;
    .end local v8    # "$i$a$-suspendCancellableCoroutine-AndroidPlatformTextInputSession$startInputMethod$3$1":I
    nop
