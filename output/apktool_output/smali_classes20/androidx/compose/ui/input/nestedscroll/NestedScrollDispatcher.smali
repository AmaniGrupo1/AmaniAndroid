...
.method public final dispatchPostFling-RZ2iAVY(JJLkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    iget-object v0, v6, Landroidx/compose/ui/input/nestedscroll/NestedScrollDispatcher$dispatchPostFling$1;->result:Ljava/lang/Object;
    ...
    .local v2, "$v$c$androidx-compose-ui-unit-Velocity$-consumed$0":J
    move-wide v4, p3

    .line 221
    .local v4, "$v$c$androidx-compose-ui-unit-Velocity$-available$0":J
    invoke-virtual {v1}, Landroidx/compose/ui/input/nestedscroll/NestedScrollDispatcher;->getParent$ui()Landroidx/compose/ui/input/nestedscroll/NestedScrollConnection;
    ...
    .line 222
    iget-object v1, v1, Landroidx/compose/ui/input/nestedscroll/NestedScrollDispatcher;->lastKnownParentNode:Landroidx/compose/ui/input/nestedscroll/NestedScrollNode;
    ...
    .end local v2    # "$v$c$androidx-compose-ui-unit-Velocity$-consumed$0":J
    ...
    .line 224
    .restart local v1    # "this":Landroidx/compose/ui/input/nestedscroll/NestedScrollDispatcher;
    .restart local v2    # "$v$c$androidx-compose-ui-unit-Velocity$-consumed$0":J
    .restart local v4    # "$v$c$androidx-compose-ui-unit-Velocity$-available$0":J
    :cond_3
    invoke-virtual {v1}, Landroidx/compose/ui/input/nestedscroll/NestedScrollDispatcher;->getParent$ui()Landroidx/compose/ui/input/nestedscroll/NestedScrollConnection;
...
.method public final dispatchPostScroll-DzOQY0M(JJI)J
    ...
    .end local p1    # "$v$c$androidx-compose-ui-geometry-Offset$-consumed$0":J
    .end local p3    # "$v$c$androidx-compose-ui-geometry-Offset$-available$0":J
    .end local p5    # "$v$c$androidx-compose-ui-input-nestedscroll-NestedScrollSource$-source$0":I
    .local v1, "$v$c$androidx-compose-ui-geometry-Offset$-consumed$0":J
    .local v3, "$v$c$androidx-compose-ui-geometry-Offset$-available$0":J
    .local v5, "$v$c$androidx-compose-ui-input-nestedscroll-NestedScrollSource$-source$0":I
    ...
    .end local v1    # "$v$c$androidx-compose-ui-geometry-Offset$-consumed$0":J
    .end local v3    # "$v$c$androidx-compose-ui-geometry-Offset$-available$0":J
    .end local v5    # "$v$c$androidx-compose-ui-input-nestedscroll-NestedScrollSource$-source$0":I
    .restart local p1    # "$v$c$androidx-compose-ui-geometry-Offset$-consumed$0":J
    .restart local p3    # "$v$c$androidx-compose-ui-geometry-Offset$-available$0":J
    .restart local p5    # "$v$c$androidx-compose-ui-input-nestedscroll-NestedScrollSource$-source$0":I
    :cond_0
    move-wide v1, p1
    ...
    .end local p3    # "$v$c$androidx-compose-ui-geometry-Offset$-available$0":J
    .end local p5    # "$v$c$androidx-compose-ui-input-nestedscroll-NestedScrollSource$-source$0":I
    .restart local v1    # "$v$c$androidx-compose-ui-geometry-Offset$-consumed$0":J
    .restart local v3    # "$v$c$androidx-compose-ui-geometry-Offset$-available$0":J
    .restart local v5    # "$v$c$androidx-compose-ui-input-nestedscroll-NestedScrollSource$-source$0":I
...
.method public final dispatchPreFling-QWom1Mo(JLkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    :goto_0
    iget-object v1, v0, Landroidx/compose/ui/input/nestedscroll/NestedScrollDispatcher$dispatchPreFling$1;->result:Ljava/lang/Object;
    ...
    .line 198
    iget v3, v0, Landroidx/compose/ui/input/nestedscroll/NestedScrollDispatcher$dispatchPreFling$1;->label:I
    ...
    .line 199
    .local v3, "this":Landroidx/compose/ui/input/nestedscroll/NestedScrollDispatcher;
    .local p1, "$v$c$androidx-compose-ui-unit-Velocity$-available$0":J
    invoke-virtual {v3}, Landroidx/compose/ui/input/nestedscroll/NestedScrollDispatcher;->getParent$ui()Landroidx/compose/ui/input/nestedscroll/NestedScrollConnection;

    move-result-object v3

    .end local v3    # "this":Landroidx/compose/ui/input/nestedscroll/NestedScrollDispatcher;
    if-eqz v3, :cond_2
