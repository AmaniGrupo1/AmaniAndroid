...
.method public constructor <init>(Ljava/util/List;Landroidx/compose/ui/input/pointer/InternalPointerEvent;)V
    ...
    .line 92
    :goto_0
    iput v0, p0, Landroidx/compose/ui/input/pointer/PointerEvent;->classification:I
...
.method public final copy(Ljava/util/List;Landroid/view/MotionEvent;)Landroidx/compose/ui/input/pointer/PointerEvent;
    ...
    .line 146
    .local v3, "changesArray":Landroidx/collection/LongSparseArray;
    ...
    invoke-virtual {v3, v12, v13, v10}, Landroidx/collection/LongSparseArray;->put(JLjava/lang/Object;)V
    ...
    .local v33, "pointerEventData":Ljava/util/ArrayList;
    iget-object v4, v0, Landroidx/compose/ui/input/pointer/PointerEvent;->internalPointerEvent:Landroidx/compose/ui/input/pointer/InternalPointerEvent;
    ...
    .local v35, "$i$f$fastForEach":I
    invoke-virtual {v10}, Landroidx/compose/ui/input/pointer/PointerInputChange;->getId-J3iCeTQ()J

    move-result-wide v5

    invoke-virtual {v4, v5, v6}, Landroidx/compose/ui/input/pointer/InternalPointerEvent;->activeHoverEvent-0FcD4WY(J)Z
    ...
    .end local v35    # "$i$f$fastForEach":I
    ...
    .restart local v35    # "$i$f$fastForEach":I
    :cond_3
    :goto_1
    const/16 v31, 0x700
    ...
    invoke-direct/range {v13 .. v32}, Landroidx/compose/ui/input/pointer/PointerInputEventData;-><init>(JJJJZFIZLjava/util/List;JJILkotlin/jvm/internal/DefaultConstructorMarker;)V
    ...
    .end local v33    # "pointerEventData":Ljava/util/ArrayList;
    .end local v34    # "$this$fastForEach$iv":Ljava/util/List;
    .end local v35    # "$i$f$fastForEach":I
    .restart local v4    # "pointerEventData":Ljava/util/ArrayList;
    .restart local v5    # "$this$fastForEach$iv":Ljava/util/List;
    .restart local v6    # "$i$f$fastForEach":I
    :cond_4
    move-object/from16 v33, v4
    ...
    .restart local v33    # "pointerEventData":Ljava/util/ArrayList;
    .restart local v34    # "$this$fastForEach$iv":Ljava/util/List;
    .restart local v35    # "$i$f$fastForEach":I
    nop
    ...
    new-instance v5, Landroidx/compose/ui/input/pointer/InternalPointerEvent;

    invoke-direct {v5, v3, v4}, Landroidx/compose/ui/input/pointer/InternalPointerEvent;-><init>(Landroidx/collection/LongSparseArray;Landroidx/compose/ui/input/pointer/PointerInputEvent;)V

    .line 165
    .local v5, "event":Landroidx/compose/ui/input/pointer/InternalPointerEvent;
    new-instance v6, Landroidx/compose/ui/input/pointer/PointerEvent;

    invoke-direct {v6, v1, v5}, Landroidx/compose/ui/input/pointer/PointerEvent;-><init>(Ljava/util/List;Landroidx/compose/ui/input/pointer/InternalPointerEvent;)V

    move-object v3, v6

    .line 167
    .end local v3    # "changesArray":Landroidx/collection/LongSparseArray;
    .end local v4    # "pointerInputEvent":Landroidx/compose/ui/input/pointer/PointerInputEvent;
    .end local v5    # "event":Landroidx/compose/ui/input/pointer/InternalPointerEvent;
    .end local v33    # "pointerEventData":Ljava/util/ArrayList;
    :goto_2
    return-object v3
.end method
...
.method public final setType-EhbLWgg$ui(I)V
    .locals 0
    .param p1, "$v$c$androidx-compose-ui-input-pointer-PointerEventType$-<set-?>$0"    # I
