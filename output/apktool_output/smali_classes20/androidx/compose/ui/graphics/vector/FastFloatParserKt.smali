...
.method public static final getFloatValue(J)F
    .locals 3
    .param p0, "$this$floatValue"    # J

    const/4 v0, 0x0

    .line 43
    .local v0, "$i$f$getFloatValue":I
    const-wide v1, 0xffffffffL
...
.method public static final nextFloat(Ljava/lang/String;II)J
    ...
    .line 56
    .end local v6    # "value$iv":F
    .end local v7    # "index$iv":I
    .end local v8    # "$i$f$pack":I
    return-wide v3
    ...
    .line 65
    .end local v8    # "value$iv":F
    .end local v9    # "index$iv":I
    .end local v10    # "$i$f$pack":I
    return-wide v3
    ...
    .local v14, "$this$isDigit$iv":C
    const/4 v15, 0x0

    .line 934
    .local v15, "$i$f$isDigit":I
    ...
    .line 69
    .end local v14    # "$this$isDigit$iv":C
    .end local v15    # "$i$f$isDigit":I
    :goto_1
    if-nez v3, :cond_5
    ...
    .line 78
    .end local v20    # "$this$isDigit$iv":C
    ...
    .line 85
    .local v5, "significandEndIndex":I
    sub-int v9, v6, v14

    .line 87
    .local v9, "digitCount":I
    const/4 v10, 0x0
    ...
    .line 89
    .local v23, "exponentStartIndex":I
    move/from16 v24, v6

    .line 92
    .local v24, "exponentEndIndex":I
    const/16 v25, 0x10
    ...
    .local v8, "offset$iv":I
    move-object/from16 v12, p0

    .local v12, "str$iv":Ljava/lang/String;
    const/16 v31, 0x0

    .line 939
    .local v31, "$i$f$parseFourDigits":I
    ...
    .line 951
    .local v37, "predicate$iv":J
    const-wide v39, -0x7f007f007f0080L
    ...
    .line 954
    :cond_a
    const-wide v39, 0x3e80064000a0001L
    ...
    .line 97
    .end local v8    # "offset$iv":I
    .end local v12    # "str$iv":Ljava/lang/String;
    .end local v31    # "$i$f$parseFourDigits":I
    .end local v35    # "base$iv":J
    .end local v37    # "predicate$iv":J
    .end local v41    # "v$iv":J
    nop
    ...
    .line 104
    .end local v33    # "significand":J
    .restart local v3    # "significand":J
    :goto_8
    if-eq v6, v2, :cond_10

    move v8, v7

    .local v8, "$this$isDigit$iv":C
    const/4 v12, 0x0

    .line 955
    .local v12, "$i$f$isDigit":I
    ...
    .line 104
    .end local v8    # "$this$isDigit$iv":C
    .end local v12    # "$i$f$isDigit":I
    :goto_9
    if-eqz v3, :cond_11
    ...
    .end local v24    # "exponentEndIndex":I
    .local v8, "exponentEndIndex":I
    :goto_b
    if-nez v9, :cond_13
    ...
    .line 161
    .end local v33    # "significand":J
    .local v29, "significand":J
    move v12, v14

    .line 162
    .end local v13    # "retryIndex":I
    ...
    .end local v3    # "exponentNumber":I
    .local v24, "exponentNumber":I
    ...
    .end local v4    # "tooManyDigits":Z
    .end local v5    # "significandEndIndex":I
    .local v31, "significandEndIndex":I
    .local v32, "tooManyDigits":Z
    ...
    .line 165
    .end local v31    # "significandEndIndex":I
    .end local v32    # "tooManyDigits":Z
    .restart local v4    # "tooManyDigits":Z
    .restart local v5    # "significandEndIndex":I
    :cond_24
    move/from16 v32, v4
    ...
    .end local v4    # "tooManyDigits":Z
    .end local v5    # "significandEndIndex":I
    .restart local v31    # "significandEndIndex":I
    .restart local v32    # "tooManyDigits":Z
    :cond_25
    invoke-static/range {v29 .. v30}, Lkotlin/ULong;->constructor-impl(J)J
    ...
    invoke-static {v12, v13, v2, v3}, Landroidx/collection/MutableFloatFloatMap$$ExternalSyntheticBackport0;->m(JJ)I
    ...
    .line 157
    .end local v24    # "exponentNumber":I
    .end local v29    # "significand":J
    .end local v31    # "significandEndIndex":I
    .end local v32    # "tooManyDigits":Z
    .restart local v3    # "exponentNumber":I
    .local v4, "tooManyDigits":Z
    .restart local v5    # "significandEndIndex":I
    .restart local v13    # "retryIndex":I
    .restart local v33    # "significand":J
    :cond_29
    move/from16 v24, v3
    ...
    .end local v3    # "exponentNumber":I
    .end local v5    # "significandEndIndex":I
    .restart local v24    # "exponentNumber":I
    .restart local v31    # "significandEndIndex":I
    move/from16 v32, v4
    ...
    .end local v7    # "c":C
    .end local v8    # "exponentEndIndex":I
    .local v2, "exponentEndIndex":I
    .local v5, "c":C
    invoke-static/range {v18 .. v19}, Lkotlin/ULong;->constructor-impl(J)J

    move-result-wide v7

    invoke-static {v12, v13, v7, v8}, Landroidx/collection/MutableFloatFloatMap$$ExternalSyntheticBackport0;->m(JJ)I
    ...
    .line 198
    sget-object v8, Landroidx/compose/ui/graphics/vector/FastFloatParserKt;->PowersOfTen:[F
    ...
    .line 958
    .local v13, "$i$f$pack":I
    move-wide/from16 v18, v3

    move v4, v2

    .end local v2    # "exponentEndIndex":I
    .end local v3    # "significand":J
    .local v4, "exponentEndIndex":I
    .local v18, "significand":J
    int-to-long v2, v12
    ...
    .end local v13    # "$i$f$pack":I
    return-wide v2

    .line 194
    .end local v4    # "exponentEndIndex":I
    .end local v7    # "f":F
    .end local v18    # "significand":J
    .restart local v2    # "exponentEndIndex":I
    .restart local v3    # "significand":J
    :cond_2e
    move-wide/from16 v18, v3
    ...
    .end local v2    # "exponentEndIndex":I
    .end local v3    # "significand":J
    .restart local v4    # "exponentEndIndex":I
    .restart local v18    # "significand":J
    goto :goto_1c
    ...
    .restart local v8    # "exponentEndIndex":I
    :cond_30
    move-wide/from16 v18, v3
    ...
    .line 210
    .end local v7    # "$i$f$pack":I
    .end local v20    # "index$iv":I
    .end local v21    # "value$iv":F
    return-wide v2
    ...
    .line 214
    .end local v7    # "$i$f$pack":I
    .end local v20    # "value$iv":F
    .end local v21    # "index$iv":I
    return-wide v2

    .line 217
    :cond_34
    sget-object v3, Landroidx/compose/ui/graphics/vector/FastFloatParserKt;->Mantissa64:[J
    ...
    .line 961
    .local v20, "$i$f$fullMultiplicationHighBits":I
    and-long v33, v29, v16

    .line 962
    .local v33, "xLo$iv":J
    ushr-long v35, v29, v22

    .line 963
    .local v35, "xHi$iv":J
    and-long v37, v18, v16

    .line 964
    .local v37, "yLo$iv":J
    ushr-long v39, v18, v22

    .line 966
    .local v39, "yHi$iv":J
    mul-long v41, v35, v39

    .line 967
    .local v41, "xTimesYHi$iv":J
    mul-long v43, v33, v39

    .line 968
    .local v43, "xTimesYMid$iv":J
    mul-long v45, v35, v37

    .line 969
    .local v45, "yTimesXMid$iv":J
    mul-long v47, v33, v37

    .line 971
    .local v47, "xTimesYLo$iv":J
    ushr-long v49, v47, v22

    add-long v49, v45, v49

    and-long v51, v43, v16

    add-long v49, v49, v51

    .line 973
    .local v49, "carry$iv":J
    ushr-long v51, v49, v22

    add-long v51, v41, v51

    ushr-long v53, v43, v22

    add-long v51, v51, v53

    .line 221
    .end local v18    # "y$iv":J
    .end local v20    # "$i$f$fullMultiplicationHighBits":I
    .end local v29    # "x$iv":J
    .end local v33    # "xLo$iv":J
    .end local v35    # "xHi$iv":J
    .end local v37    # "yLo$iv":J
    .end local v39    # "yHi$iv":J
    .end local v41    # "xTimesYHi$iv":J
    .end local v43    # "xTimesYMid$iv":J
    .end local v45    # "yTimesXMid$iv":J
    .end local v47    # "xTimesYLo$iv":J
    .end local v49    # "carry$iv":J
    nop
    ...
    .end local v4    # "exponentEndIndex":I
    .local v19, "exponentEndIndex":I
    ushr-long v3, v51, v20
    ...
    .end local v18    # "lz":I
    .local v4, "lz":I
    const-wide/16 v33, 0x1ff

    and-long v35, v51, v33

    cmp-long v18, v35, v33

    if-eqz v18, :cond_3a

    and-long v33, v51, v33

    cmp-long v18, v33, v26
    ...
    .line 231
    ushr-long v29, v29, v21

    .line 233
    const-wide/high16 v35, 0x20000000000000L

    cmp-long v18, v29, v35
    ...
    .line 238
    :cond_36
    const-wide v35, -0x10000000000001L

    and-long v29, v29, v35

    .line 240
    const-wide/32 v35, 0x3526a

    move-wide/from16 v37, v7

    .end local v7    # "significandFactor":J
    .local v37, "significandFactor":J
    int-to-long v7, v10
    ...
    .end local v3    # "upperBit":I
    .local v18, "upperBit":I
    int-to-long v7, v3
    ...
    .line 241
    .local v7, "adjustedExponent":J
    move-wide/from16 v20, v7

    .end local v7    # "adjustedExponent":J
    .local v20, "adjustedExponent":J
    int-to-long v7, v4

    sub-long v7, v20, v7

    .line 242
    .local v7, "realExponent":J
    cmp-long v3, v7, v33
    ...
    .line 976
    .local v27, "$i$f$doubleFromBits":I
    ...
    .line 249
    .end local v25    # "bits$iv":J
    .end local v27    # "$i$f$doubleFromBits":I
    ...
    .end local v4    # "$i$f$pack":I
    .restart local v25    # "$i$f$pack":I
    int-to-long v4, v3
    ...
    .line 226
    .end local v18    # "upperBit":I
    .end local v20    # "adjustedExponent":J
    .end local v26    # "c":C
    .end local v27    # "lz":I
    .end local v37    # "significandFactor":J
    .local v3, "upperBit":I
    .local v4, "lz":I
    .restart local v5    # "c":C
    .local v7, "significandFactor":J
    ...
    .end local v5    # "c":C
    .end local v7    # "significandFactor":J
    .restart local v18    # "upperBit":I
    .restart local v26    # "c":C
    .restart local v37    # "significandFactor":J
    :goto_20
    invoke-virtual {v0, v1, v6}, Ljava/lang/String;->substring(II)Ljava/lang/String;
