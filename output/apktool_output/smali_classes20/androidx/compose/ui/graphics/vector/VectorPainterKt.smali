...
.method public static final RenderVectorGroup(Landroidx/compose/ui/graphics/vector/VectorGroup;Ljava/util/Map;Landroidx/compose/runtime/Composer;II)V
    ...
    const-string v7, "427@16156L1298"
    ...
    const-string v4, "462@18450L88,450@17593L945"
...
.method public static final configureVectorPainter-T4PVSW8(Landroidx/compose/ui/graphics/vector/VectorPainter;JJLjava/lang/String;Landroidx/compose/ui/graphics/ColorFilter;Z)Landroidx/compose/ui/graphics/vector/VectorPainter;
    ...
    .param p1, "$v$c$androidx-compose-ui-geometry-Size$-defaultSize$0"    # J
    .param p3, "$v$c$androidx-compose-ui-geometry-Size$-viewportSize$0"    # J
    ...
    .local v0, "$this$configureVectorPainter_T4PVSW8_u24lambda_u240":Landroidx/compose/ui/graphics/vector/VectorPainter;
    const/4 v1, 0x0

    .line 343
    .local v1, "$i$a$-apply-VectorPainterKt$configureVectorPainter$1":I
    invoke-virtual {v0, p1, p2}, Landroidx/compose/ui/graphics/vector/VectorPainter;->setSize-uvyYCjk$ui(J)V

    .line 344
    invoke-virtual {v0, p7}, Landroidx/compose/ui/graphics/vector/VectorPainter;->setAutoMirror$ui(Z)V

    .line 345
    invoke-virtual {v0, p6}, Landroidx/compose/ui/graphics/vector/VectorPainter;->setIntrinsicColorFilter$ui(Landroidx/compose/ui/graphics/ColorFilter;)V

    .line 346
    invoke-virtual {v0, p3, p4}, Landroidx/compose/ui/graphics/vector/VectorPainter;->setViewportSize-uvyYCjk$ui(J)V

    .line 347
    invoke-virtual {v0, p5}, Landroidx/compose/ui/graphics/vector/VectorPainter;->setName$ui(Ljava/lang/String;)V

    .line 348
    nop

    .line 342
    .end local v0    # "$this$configureVectorPainter_T4PVSW8_u24lambda_u240":Landroidx/compose/ui/graphics/vector/VectorPainter;
...
.method private static final createColorFilter-xETnrds(JI)Landroidx/compose/ui/graphics/ColorFilter;
    .locals 5
    .param p0, "$v$c$androidx-compose-ui-graphics-Color$-tintColor$0"    # J
    .param p2, "$v$c$androidx-compose-ui-graphics-BlendMode$-tintBlendMode$0"    # I
...
.method public static final createGroupComponent(Landroidx/compose/ui/graphics/vector/GroupComponent;Landroidx/compose/ui/graphics/vector/VectorGroup;)Landroidx/compose/ui/graphics/vector/GroupComponent;
    ...
    .local v4, "$this$createGroupComponent_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathComponent;
    const/4 v5, 0x0
    ...
    .line 379
    .end local v4    # "$this$createGroupComponent_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathComponent;
    ...
    .local v4, "$this$createGroupComponent_u24lambda_u241":Landroidx/compose/ui/graphics/vector/GroupComponent;
    const/4 v5, 0x0
    ...
    .line 398
    .end local v4    # "$this$createGroupComponent_u24lambda_u241":Landroidx/compose/ui/graphics/vector/GroupComponent;
...
.method private static final mirror(Landroidx/compose/ui/graphics/drawscope/DrawScope;Lkotlin/jvm/functions/Function1;)V
    ...
    .local v10, "$this$withTransform_u24lambda_u240$iv$iv":Landroidx/compose/ui/graphics/drawscope/DrawContext;
    const/4 v11, 0x0
    ...
    .line 512
    .end local v10    # "$this$withTransform_u24lambda_u240$iv$iv":Landroidx/compose/ui/graphics/drawscope/DrawContext;
    ...
    .restart local v5    # "$v$c$androidx-compose-ui-geometry-Offset$-pivot$0$iv":J
    ...
    .restart local v10    # "$this$withTransform_u24lambda_u240$iv$iv":Landroidx/compose/ui/graphics/drawscope/DrawContext;
...
.method private static final obtainSizePx-VpY3zN4(Landroidx/compose/ui/unit/Density;FF)J
    ...
    .param p1, "$v$c$androidx-compose-ui-unit-Dp$-defaultWidth$0"    # F
    .param p2, "$v$c$androidx-compose-ui-unit-Dp$-defaultHeight$0"    # F

    .line 312
    invoke-interface/range {p0 .. p1}, Landroidx/compose/ui/unit/Density;->toPx-0680j_4(F)F
...
.method private static final obtainViewportSize-Pq9zytI(JFF)J
    .locals 15
    .param p0, "$v$c$androidx-compose-ui-geometry-Size$-defaultSize$0"    # J
...
.method public static final rememberVectorPainter(Landroidx/compose/ui/graphics/vector/ImageVector;Landroidx/compose/runtime/Composer;I)Landroidx/compose/ui/graphics/vector/VectorPainter;
    ...
    const-string v1, "C(rememberVectorPainter)170@7434L7,172@7518L188:VectorPainter.kt#huu6hf"
    ...
    .local v10, "$this$rememberVectorPainter_u24lambda_u240_u240":Landroidx/compose/ui/graphics/vector/GroupComponent;
    const/4 v11, 0x0
    ...
    .line 174
    .end local v10    # "$this$rememberVectorPainter_u24lambda_u240_u240":Landroidx/compose/ui/graphics/vector/GroupComponent;
...
.method public static final rememberVectorPainter-mlNsNFs(FFFFLjava/lang/String;JILkotlin/jvm/functions/Function4;Landroidx/compose/runtime/Composer;II)Landroidx/compose/ui/graphics/vector/VectorPainter;
    .locals 16
    .param p0, "$v$c$androidx-compose-ui-unit-Dp$-defaultWidth$0"    # F
    .param p1, "$v$c$androidx-compose-ui-unit-Dp$-defaultHeight$0"    # F
    .param p2, "viewportWidth"    # F
    .param p3, "viewportHeight"    # F
    .param p4, "name"    # Ljava/lang/String;
    .param p5, "$v$c$androidx-compose-ui-graphics-Color$-tintColor$0"    # J
    .param p7, "$v$c$androidx-compose-ui-graphics-BlendMode$-tintBlendMode$0"    # I
    ...
    const-string v2, "C(rememberVectorPainter)P(2:c#ui.unit.Dp,1:c#ui.unit.Dp,7,6,3,5:c#ui.graphics.Color,4:c#ui.graphics.BlendMode)85@3806L208:VectorPainter.kt#huu6hf"
    ...
    .end local p5    # "$v$c$androidx-compose-ui-graphics-Color$-tintColor$0":J
    .local v2, "$v$c$androidx-compose-ui-graphics-Color$-tintColor$0":J
    goto :goto_3

    .line 81
    .end local v2    # "$v$c$androidx-compose-ui-graphics-Color$-tintColor$0":J
    .restart local p5    # "$v$c$androidx-compose-ui-graphics-Color$-tintColor$0":J
    :cond_3
    move-wide/from16 v8, p5

    .line 82
    .end local p5    # "$v$c$androidx-compose-ui-graphics-Color$-tintColor$0":J
    .local v8, "$v$c$androidx-compose-ui-graphics-Color$-tintColor$0":J
    :goto_3
    ...
    .end local p7    # "$v$c$androidx-compose-ui-graphics-BlendMode$-tintBlendMode$0":I
    .local v2, "$v$c$androidx-compose-ui-graphics-BlendMode$-tintBlendMode$0":I
    goto :goto_4

    .line 82
    .end local v2    # "$v$c$androidx-compose-ui-graphics-BlendMode$-tintBlendMode$0":I
    .restart local p7    # "$v$c$androidx-compose-ui-graphics-BlendMode$-tintBlendMode$0":I
    :cond_4
    move/from16 v10, p7

    .line 83
    .end local p7    # "$v$c$androidx-compose-ui-graphics-BlendMode$-tintBlendMode$0":I
    .local v10, "$v$c$androidx-compose-ui-graphics-BlendMode$-tintBlendMode$0":I
    :goto_4
    invoke-static {}, Landroidx/compose/runtime/ComposerKt;->isTraceInProgress()Z
...
.method public static final rememberVectorPainter-vIP8VLU(FFFFLjava/lang/String;JIZLkotlin/jvm/functions/Function4;Landroidx/compose/runtime/Composer;II)Landroidx/compose/ui/graphics/vector/VectorPainter;
    ...
    const-string v5, "C(rememberVectorPainter)P(3:c#ui.unit.Dp,2:c#ui.unit.Dp,8,7,4,6:c#ui.graphics.Color,5:c#ui.graphics.BlendMode)130@5714L7,134@5915L82,135@6009L28:VectorPainter.kt#huu6hf"
    ...
    .end local p5    # "$v$c$androidx-compose-ui-graphics-Color$-tintColor$0":J
    .local v7, "$v$c$androidx-compose-ui-graphics-Color$-tintColor$0":J
    goto :goto_3

    .line 125
    .end local v7    # "$v$c$androidx-compose-ui-graphics-Color$-tintColor$0":J
    .restart local p5    # "$v$c$androidx-compose-ui-graphics-Color$-tintColor$0":J
    :cond_3
    ...
    .line 126
    .end local p5    # "$v$c$androidx-compose-ui-graphics-Color$-tintColor$0":J
    .restart local v7    # "$v$c$androidx-compose-ui-graphics-Color$-tintColor$0":J
    :goto_3
    ...
    .end local p7    # "$v$c$androidx-compose-ui-graphics-BlendMode$-tintBlendMode$0":I
    .local v9, "$v$c$androidx-compose-ui-graphics-BlendMode$-tintBlendMode$0":I
    goto :goto_4

    .line 126
    .end local v9    # "$v$c$androidx-compose-ui-graphics-BlendMode$-tintBlendMode$0":I
    .restart local p7    # "$v$c$androidx-compose-ui-graphics-BlendMode$-tintBlendMode$0":I
    :cond_4
    move/from16 v9, p7
    ...
    .line 127
    .end local p7    # "$v$c$androidx-compose-ui-graphics-BlendMode$-tintBlendMode$0":I
    .restart local v9    # "$v$c$androidx-compose-ui-graphics-BlendMode$-tintBlendMode$0":I
    :goto_4
    ...
    const-string v0, "*144@6357L28,146@6432L513,158@7024L39,158@7001L62"
    ...
    .end local v7    # "$v$c$androidx-compose-ui-graphics-Color$-tintColor$0":J
    .local v18, "$v$c$androidx-compose-ui-graphics-Color$-tintColor$0":J
    invoke-virtual/range {v17 .. v17}, Landroidx/compose/runtime/Composer$Companion;->getEmpty()Ljava/lang/Object;
    ...
    .local v8, "$this$rememberVectorPainter_vIP8VLU_u24lambda_u242":Landroidx/compose/ui/graphics/vector/VectorPainter;
    const/4 v4, 0x0
    ...
    .local v7, "$v$c$androidx-compose-ui-graphics-BlendMode$-tintBlendMode$0":I
    ...
    .end local v7    # "$v$c$androidx-compose-ui-graphics-BlendMode$-tintBlendMode$0":I
    .local p7, "$v$c$androidx-compose-ui-graphics-BlendMode$-tintBlendMode$0":I
    const/16 v7, 0x100
    ...
    invoke-virtual {v8}, Landroidx/compose/ui/graphics/vector/VectorPainter;->getComposition$ui()Landroidx/compose/runtime/Composition;
    ...
    invoke-virtual {v8}, Landroidx/compose/ui/graphics/vector/VectorPainter;->getVector$ui()Landroidx/compose/ui/graphics/vector/VectorComponent;
    ...
    invoke-virtual {v8, v0}, Landroidx/compose/ui/graphics/vector/VectorPainter;->setComposition$ui(Landroidx/compose/runtime/Composition;)V
    ...
    .end local v8    # "$this$rememberVectorPainter_vIP8VLU_u24lambda_u242":Landroidx/compose/ui/graphics/vector/VectorPainter;
