...
.method public static final PathData(Lkotlin/jvm/functions/Function1;)Ljava/util/List;
    ...
    .line 73
    .local v0, "$i$f$PathData":I
    new-instance v1, Landroidx/compose/ui/graphics/vector/PathBuilder;

    invoke-direct {v1}, Landroidx/compose/ui/graphics/vector/PathBuilder;-><init>()V

    .local v1, "$this$PathData_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/4 v2, 0x0

    .line 74
    .local v2, "$i$a$-with-VectorKt$PathData$1":I
    ...
    .line 73
    .end local v1    # "$this$PathData_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v2    # "$i$a$-with-VectorKt$PathData$1":I
    nop
...
.method public static final rgbEqual--OWjLjI(JJ)Z
    .locals 4
    .param p0, "$v$c$androidx-compose-ui-graphics-Color$-$this$rgbEqual$0"    # J
    .param p2, "$v$c$androidx-compose-ui-graphics-Color$-other$0"    # J
...
.method public static final tintableWithAlphaMask(Landroidx/compose/ui/graphics/ColorFilter;)Z
    .locals 4
    .param p0, "$this$tintableWithAlphaMask"    # Landroidx/compose/ui/graphics/ColorFilter;
    ...
    invoke-virtual {v0}, Landroidx/compose/ui/graphics/BlendModeColorFilter;->getBlendMode-0nO6VwU()I
...
.method public static final toOpaque-8_81llA(J)J
    .locals 9
    .param p0, "$v$c$androidx-compose-ui-graphics-Color$-$this$toOpaque$0"    # J
    ...
    .end local p0    # "$v$c$androidx-compose-ui-graphics-Color$-$this$toOpaque$0":J
    .local v1, "$v$c$androidx-compose-ui-graphics-Color$-$this$toOpaque$0":J
    ...
    .end local v1    # "$v$c$androidx-compose-ui-graphics-Color$-$this$toOpaque$0":J
    .restart local p0    # "$v$c$androidx-compose-ui-graphics-Color$-$this$toOpaque$0":J
    :cond_1
    move-wide v1, p0

    .end local p0    # "$v$c$androidx-compose-ui-graphics-Color$-$this$toOpaque$0":J
    .restart local v1    # "$v$c$androidx-compose-ui-graphics-Color$-$this$toOpaque$0":J
    :goto_1
    return-wide p0
.end method
