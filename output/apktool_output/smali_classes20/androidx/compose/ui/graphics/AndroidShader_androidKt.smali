...
.method public static final ActualImageShader-F49vj9s(Landroidx/compose/ui/graphics/ImageBitmap;II)Landroid/graphics/Shader;
    ...
    .param p1, "$v$c$androidx-compose-ui-graphics-TileMode$-tileModeX$0"    # I
    .param p2, "$v$c$androidx-compose-ui-graphics-TileMode$-tileModeY$0"    # I
...
.method public static final ActualLinearGradientShader-VjE6UOU(JJLjava/util/List;Ljava/util/List;I)Landroid/graphics/Shader;
    .locals 16
    .param p0, "$v$c$androidx-compose-ui-geometry-Offset$-from$0"    # J
    .param p2, "$v$c$androidx-compose-ui-geometry-Offset$-to$0"    # J
    .param p4, "colors"    # Ljava/util/List;
    .param p5, "colorStops"    # Ljava/util/List;
    .param p6, "$v$c$androidx-compose-ui-graphics-TileMode$-tileMode$0"    # I
    ...
    invoke-static {v12, v0, v1}, Landroidx/compose/ui/graphics/AndroidShader_androidKt;->makeTransparentStops(Ljava/util/List;Ljava/util/List;I)[F
...
.method public static final ActualRadialGradientShader-8uybcMk(JFLjava/util/List;Ljava/util/List;I)Landroid/graphics/Shader;
    ...
    .param p5, "$v$c$androidx-compose-ui-graphics-TileMode$-tileMode$0"    # I
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(JF",
            "Ljava/util/List<",
    ...
    .line 58
    invoke-static/range {p3 .. p4}, Landroidx/compose/ui/graphics/AndroidShader_androidKt;->validateColorStops(Ljava/util/List;Ljava/util/List;)V
    ...
    .line 66
    invoke-static/range {p5 .. p5}, Landroidx/compose/ui/graphics/AndroidTileMode_androidKt;->toAndroidTileMode-0vamqd0(I)Landroid/graphics/Shader$TileMode;
