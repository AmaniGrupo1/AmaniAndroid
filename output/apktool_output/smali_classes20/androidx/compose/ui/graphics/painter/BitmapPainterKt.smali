...
.method public static final BitmapPainter-QZhYCtY(Landroidx/compose/ui/graphics/ImageBitmap;JJI)Landroidx/compose/ui/graphics/painter/BitmapPainter;
    ...
    .param p1, "$v$c$androidx-compose-ui-unit-IntOffset$-srcOffset$0"    # J
    .param p3, "$v$c$androidx-compose-ui-unit-IntSize$-srcSize$0"    # J
    .param p5, "$v$c$androidx-compose-ui-graphics-FilterQuality$-filterQuality$0"    # I
    ...
    .end local p1    # "$v$c$androidx-compose-ui-unit-IntOffset$-srcOffset$0":J
    .end local p3    # "$v$c$androidx-compose-ui-unit-IntSize$-srcSize$0":J
    .local v1, "image":Landroidx/compose/ui/graphics/ImageBitmap;
    .local v2, "$v$c$androidx-compose-ui-unit-IntOffset$-srcOffset$0":J
    .local v4, "$v$c$androidx-compose-ui-unit-IntSize$-srcSize$0":J
    ...
    invoke-virtual {p0, p5}, Landroidx/compose/ui/graphics/painter/BitmapPainter;->setFilterQuality-vDHp3xo$ui_graphics(I)V
...
.method public static synthetic BitmapPainter-QZhYCtY$default(Landroidx/compose/ui/graphics/ImageBitmap;JJIILjava/lang/Object;)Landroidx/compose/ui/graphics/painter/BitmapPainter;
    ...
    .line 50
    sget-object v4, Landroidx/compose/ui/graphics/FilterQuality;->Companion:Landroidx/compose/ui/graphics/FilterQuality$Companion;

    invoke-virtual {v4}, Landroidx/compose/ui/graphics/FilterQuality$Companion;->getLow-f-v9h1I()I
    ...
    invoke-static/range {p1 .. p6}, Landroidx/compose/ui/graphics/painter/BitmapPainterKt;->BitmapPainter-QZhYCtY(Landroidx/compose/ui/graphics/ImageBitmap;JJI)Landroidx/compose/ui/graphics/painter/BitmapPainter;
