...
.method private constructor <init>(Landroidx/compose/ui/graphics/colorspace/ColorSpace;Landroidx/compose/ui/graphics/colorspace/ColorSpace;I)V
    ...
    .end local p1    # "source":Landroidx/compose/ui/graphics/colorspace/ColorSpace;
    .end local p2    # "destination":Landroidx/compose/ui/graphics/colorspace/ColorSpace;
    .end local p3    # "intent":I
    .local v4, "source":Landroidx/compose/ui/graphics/colorspace/ColorSpace;
    .local v5, "destination":Landroidx/compose/ui/graphics/colorspace/ColorSpace;
    .local v8, "intent":I
...
.method public transform([F)[F
    ...
    iget-object v3, p0, Landroidx/compose/ui/graphics/colorspace/Connector;->transform:[F
...
.method public transformToColor-l2rxGTc$ui_graphics(J)J
    ...
    .local v0, "$v$c$androidx-compose-ui-graphics-Color$-this$0$iv":J
    const/4 v2, 0x0
    ...
    .line 147
    .end local v0    # "$v$c$androidx-compose-ui-graphics-Color$-this$0$iv":J
    ...
    .line 148
    .local v8, "a":F
    iget-object v3, p0, Landroidx/compose/ui/graphics/colorspace/Connector;->transformSource:Landroidx/compose/ui/graphics/colorspace/ColorSpace;

    invoke-virtual {v3, v0, v1, v2}, Landroidx/compose/ui/graphics/colorspace/ColorSpace;->toXy$ui_graphics(FFF)J
    ...
    invoke-virtual {v3, v0, v1, v2}, Landroidx/compose/ui/graphics/colorspace/ColorSpace;->toZ$ui_graphics(FFF)F

    move-result v3

    .line 152
    .local v3, "z":F
    iget-object v4, p0, Landroidx/compose/ui/graphics/colorspace/Connector;->transform:[F
    ...
    invoke-virtual/range {v4 .. v9}, Landroidx/compose/ui/graphics/colorspace/ColorSpace;->xyzaToColor-JlNiLsg$ui_graphics(FFFFLandroidx/compose/ui/graphics/colorspace/ColorSpace;)J
