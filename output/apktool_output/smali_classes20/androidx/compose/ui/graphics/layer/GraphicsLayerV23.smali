...
.method private final applyCompositingStrategy-Wpw9cng(I)V
    ...
    .local v0, "$this$applyCompositingStrategy_Wpw9cng_u24lambda_u240":Landroid/view/RenderNode;
    const/4 v1, 0x0
    ...
    .line 114
    .end local v0    # "$this$applyCompositingStrategy_Wpw9cng_u24lambda_u240":Landroid/view/RenderNode;
...
.method public record(Landroidx/compose/ui/unit/Density;Landroidx/compose/ui/unit/LayoutDirection;Landroidx/compose/ui/graphics/layer/GraphicsLayer;Lkotlin/jvm/functions/Function1;)V
    ...
    .local v3, "targetCanvas$iv":Landroid/graphics/Canvas;
    move-object v4, v0

    .local v4, "this_$iv":Landroidx/compose/ui/graphics/CanvasHolder;
    const/4 v5, 0x0

    .line 451
    .local v5, "$i$f$drawInto":I
    invoke-virtual {v4}, Landroidx/compose/ui/graphics/CanvasHolder;->getAndroidCanvas()Landroidx/compose/ui/graphics/AndroidCanvas;
    ...
    .line 452
    .local v6, "previousCanvas$iv":Landroid/graphics/Canvas;
    invoke-virtual {v4}, Landroidx/compose/ui/graphics/CanvasHolder;->getAndroidCanvas()Landroidx/compose/ui/graphics/AndroidCanvas;
    ...
    .local v7, "$this$record_u24lambda_u240":Landroidx/compose/ui/graphics/Canvas;
    const/4 v8, 0x0

    .line 330
    .local v8, "$i$a$-drawInto-GraphicsLayerV23$record$1":I
    ...
    .local v12, "canvas$iv":Landroidx/compose/ui/graphics/Canvas;
    move-object/from16 v13, p2

    .local v13, "layoutDirection$iv":Landroidx/compose/ui/unit/LayoutDirection;
    move-object v14, v0

    .local v14, "$this$draw_u2dymL40Pk$iv":Landroidx/compose/ui/graphics/drawscope/DrawScope;
    move-object/from16 v15, p1

    .local v9, "$v$c$androidx-compose-ui-geometry-Size$-size$0$iv":J
    .local v15, "density$iv":Landroidx/compose/ui/unit/Density;
    const/16 v16, 0x0
    ...
    .line 456
    .local v18, "prevLayoutDirection$iv":Landroidx/compose/ui/unit/LayoutDirection;
    invoke-interface {v14}, Landroidx/compose/ui/graphics/drawscope/DrawScope;->getDrawContext()Landroidx/compose/ui/graphics/drawscope/DrawContext;
    ...
    .line 459
    .local v20, "prevLayer$iv":Landroidx/compose/ui/graphics/layer/GraphicsLayer;
    invoke-interface {v14}, Landroidx/compose/ui/graphics/drawscope/DrawScope;->getDrawContext()Landroidx/compose/ui/graphics/drawscope/DrawContext;
    ...
    .end local v3    # "targetCanvas$iv":Landroid/graphics/Canvas;
    .local v21, "targetCanvas$iv":Landroid/graphics/Canvas;
    :try_start_1
    ...
    .line 472
    .local v24, "$i$a$-apply-DrawScopeKt$draw$2$iv":I
    move-object/from16 v3, v17

    .end local v17    # "prevDensity$iv":Landroidx/compose/ui/unit/Density;
    ...
    .end local v18    # "prevLayoutDirection$iv":Landroidx/compose/ui/unit/LayoutDirection;
    ...
    .end local v8    # "$i$a$-drawInto-GraphicsLayerV23$record$1":I
    .end local v22    # "prevSize$iv":J
    .local v7, "prevSize$iv":J
    .local v19, "$this$record_u24lambda_u240":Landroidx/compose/ui/graphics/Canvas;
    .local v25, "$i$a$-drawInto-GraphicsLayerV23$record$1":I
    ...
    .end local v20    # "prevLayer$iv":Landroidx/compose/ui/graphics/layer/GraphicsLayer;
    .local v9, "prevLayer$iv":Landroidx/compose/ui/graphics/layer/GraphicsLayer;
    .local v22, "$v$c$androidx-compose-ui-geometry-Size$-size$0$iv":J
    ...
    .end local v24    # "$i$a$-apply-DrawScopeKt$draw$2$iv":I
    nop
    ...
    .end local v9    # "prevLayer$iv":Landroidx/compose/ui/graphics/layer/GraphicsLayer;
    .end local v11    # "graphicsLayer$iv":Landroidx/compose/ui/graphics/layer/GraphicsLayer;
    .end local v12    # "canvas$iv":Landroidx/compose/ui/graphics/Canvas;
    .end local v13    # "layoutDirection$iv":Landroidx/compose/ui/unit/LayoutDirection;
    .end local v14    # "$this$draw_u2dymL40Pk$iv":Landroidx/compose/ui/graphics/drawscope/DrawScope;
    .end local v15    # "density$iv":Landroidx/compose/ui/unit/Density;
    .end local v16    # "$i$f$draw-ymL40Pk":I
    .end local v22    # "$v$c$androidx-compose-ui-geometry-Size$-size$0$iv":J
    nop

    .line 453
    .end local v19    # "$this$record_u24lambda_u240":Landroidx/compose/ui/graphics/Canvas;
    .end local v25    # "$i$a$-drawInto-GraphicsLayerV23$record$1":I
    nop
    ...
    .line 333
    .end local v6    # "previousCanvas$iv":Landroid/graphics/Canvas;
    .end local v17    # "this_$iv":Landroidx/compose/ui/graphics/CanvasHolder;
    .end local v18    # "$i$f$drawInto":I
    .end local v21    # "targetCanvas$iv":Landroid/graphics/Canvas;
    iget-object v0, v1, Landroidx/compose/ui/graphics/layer/GraphicsLayerV23;->renderNode:Landroid/view/RenderNode;
    ...
    .local v4, "this_$iv":Landroidx/compose/ui/graphics/CanvasHolder;
    .local v5, "$i$f$drawInto":I
    .restart local v6    # "previousCanvas$iv":Landroid/graphics/Canvas;
    .local v7, "$this$record_u24lambda_u240":Landroidx/compose/ui/graphics/Canvas;
    .restart local v8    # "$i$a$-drawInto-GraphicsLayerV23$record$1":I
    .local v9, "$v$c$androidx-compose-ui-geometry-Size$-size$0$iv":J
    .restart local v11    # "graphicsLayer$iv":Landroidx/compose/ui/graphics/layer/GraphicsLayer;
    .restart local v12    # "canvas$iv":Landroidx/compose/ui/graphics/Canvas;
    .restart local v13    # "layoutDirection$iv":Landroidx/compose/ui/unit/LayoutDirection;
    .restart local v14    # "$this$draw_u2dymL40Pk$iv":Landroidx/compose/ui/graphics/drawscope/DrawScope;
    .restart local v15    # "density$iv":Landroidx/compose/ui/unit/Density;
    .restart local v16    # "$i$f$draw-ymL40Pk":I
    .local v17, "prevDensity$iv":Landroidx/compose/ui/unit/Density;
    .local v18, "prevLayoutDirection$iv":Landroidx/compose/ui/unit/LayoutDirection;
    .local v19, "prevCanvas$iv":Landroidx/compose/ui/graphics/Canvas;
    .restart local v20    # "prevLayer$iv":Landroidx/compose/ui/graphics/layer/GraphicsLayer;
    .restart local v21    # "targetCanvas$iv":Landroid/graphics/Canvas;
    .local v22, "prevSize$iv":J
    :catchall_0
    move-exception v0
    ...
    .local v19, "$this$record_u24lambda_u240":Landroidx/compose/ui/graphics/Canvas;
    .local v22, "$v$c$androidx-compose-ui-geometry-Size$-size$0$iv":J
    .restart local v25    # "$i$a$-drawInto-GraphicsLayerV23$record$1":I
    :try_start_3
    invoke-interface {v12}, Landroidx/compose/ui/graphics/Canvas;->restore()V
    ...
    .local v10, "$this$draw_ymL40Pk_u24lambda_u241$iv":Landroidx/compose/ui/graphics/drawscope/DrawContext;
    const/16 v20, 0x0

    .line 472
    .local v20, "$i$a$-apply-DrawScopeKt$draw$2$iv":I
    invoke-interface {v10, v3}, Landroidx/compose/ui/graphics/drawscope/DrawContext;->setDensity(Landroidx/compose/ui/unit/Density;)V

    .line 473
    invoke-interface {v10, v4}, Landroidx/compose/ui/graphics/drawscope/DrawContext;->setLayoutDirection(Landroidx/compose/ui/unit/LayoutDirection;)V

    .line 474
    invoke-interface {v10, v5}, Landroidx/compose/ui/graphics/drawscope/DrawContext;->setCanvas(Landroidx/compose/ui/graphics/Canvas;)V

    .line 475
    invoke-interface {v10, v7, v8}, Landroidx/compose/ui/graphics/drawscope/DrawContext;->setSize-uvyYCjk(J)V

    .line 476
    invoke-interface {v10, v9}, Landroidx/compose/ui/graphics/drawscope/DrawContext;->setGraphicsLayer(Landroidx/compose/ui/graphics/layer/GraphicsLayer;)V

    .line 477
    nop

    .line 471
    .end local v10    # "$this$draw_ymL40Pk_u24lambda_u241$iv":Landroidx/compose/ui/graphics/drawscope/DrawContext;
...
.method public setColorFilter(Landroidx/compose/ui/graphics/ColorFilter;)V
    ...
    .local v2, "$this$_set_colorFilter__u24lambda_u240":Landroid/graphics/Paint;
    const/4 v3, 0x0
    ...
    .line 162
    .end local v2    # "$this$_set_colorFilter__u24lambda_u240":Landroid/graphics/Paint;
...
.method public setPosition-H0pRuoY(IIJ)V
    ...
    iget-object v5, v0, Landroidx/compose/ui/graphics/layer/GraphicsLayerV23;->renderNode:Landroid/view/RenderNode;
    ...
    invoke-virtual {v5, v1, v2, v6, v7}, Landroid/view/RenderNode;->setLeftTopRightBottom(IIII)Z

    .line 296
    iget-wide v5, v0, Landroidx/compose/ui/graphics/layer/GraphicsLayerV23;->size:J
    ...
    .line 297
    iget-boolean v5, v0, Landroidx/compose/ui/graphics/layer/GraphicsLayerV23;->shouldManuallySetCenterPivot:Z
    ...
    invoke-virtual {v5, v6}, Landroid/view/RenderNode;->setPivotX(F)Z
    ...
    invoke-virtual {v5, v6}, Landroid/view/RenderNode;->setPivotY(F)Z

    .line 301
    :cond_0
    iput-wide v3, v0, Landroidx/compose/ui/graphics/layer/GraphicsLayerV23;->size:J
