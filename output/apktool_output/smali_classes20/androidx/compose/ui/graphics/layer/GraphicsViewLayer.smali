...
.method private final applyCompositingLayer-Wpw9cng(I)V
    .locals 5
    .param p1, "$v$c$androidx-compose-ui-graphics-layer-CompositingStrategy$-compositingStrategy$0"    # I
    ...
    .line 221
    :goto_0
    invoke-virtual {v0, v2}, Landroidx/compose/ui/graphics/layer/ViewLayer;->setCanUseCompositingLayer$ui_graphics(Z)V
...
.method private final recordDrawingOperations()V
    ...
    .local v4, "$this$recordDrawingOperations_u24lambda_u240":Landroidx/compose/ui/graphics/Canvas;
    const/4 v5, 0x0
    ...
    invoke-virtual {v6, v4, v7, v8, v9}, Landroidx/compose/ui/graphics/layer/view/DrawChildContainer;->drawChild$ui_graphics(Landroidx/compose/ui/graphics/Canvas;Landroid/view/View;J)V

    .line 462
    nop

    .line 641
    .end local v4    # "$this$recordDrawingOperations_u24lambda_u240":Landroidx/compose/ui/graphics/Canvas;
...
.method private final updateClipBounds()V
    ...
    .local v2, "$this$updateClipBounds_u24lambda_u240":Landroid/graphics/Rect;
    const/4 v3, 0x0
    ...
    .line 486
    .end local v2    # "$this$updateClipBounds_u24lambda_u240":Landroid/graphics/Rect;
...
.method public draw(Landroidx/compose/ui/graphics/Canvas;)V
    ...
    invoke-virtual {v1, p1, v2, v3, v4}, Landroidx/compose/ui/graphics/layer/view/DrawChildContainer;->drawChild$ui_graphics(Landroidx/compose/ui/graphics/Canvas;Landroid/view/View;J)V
...
.method public record(Landroidx/compose/ui/unit/Density;Landroidx/compose/ui/unit/LayoutDirection;Landroidx/compose/ui/graphics/layer/GraphicsLayer;Lkotlin/jvm/functions/Function1;)V
    ...
    iget-object v3, v1, Landroidx/compose/ui/graphics/layer/GraphicsViewLayer;->viewLayer:Landroidx/compose/ui/graphics/layer/ViewLayer;

    check-cast v3, Landroid/view/View;

    invoke-virtual {v0, v3}, Landroidx/compose/ui/graphics/layer/view/DrawChildContainer;->addView(Landroid/view/View;)V
    ...
    invoke-virtual {v0, v3, v4, v5, v2}, Landroidx/compose/ui/graphics/layer/ViewLayer;->setDrawParams(Landroidx/compose/ui/unit/Density;Landroidx/compose/ui/unit/LayoutDirection;Landroidx/compose/ui/graphics/layer/GraphicsLayer;Lkotlin/jvm/functions/Function1;)V
    ...
    .local v9, "targetCanvas$iv":Landroid/graphics/Canvas;
    move-object v10, v0

    .local v10, "this_$iv":Landroidx/compose/ui/graphics/CanvasHolder;
    const/4 v11, 0x0

    .line 608
    .local v11, "$i$f$drawInto":I
    invoke-virtual {v10}, Landroidx/compose/ui/graphics/CanvasHolder;->getAndroidCanvas()Landroidx/compose/ui/graphics/AndroidCanvas;
    ...
    .line 609
    .local v12, "previousCanvas$iv":Landroid/graphics/Canvas;
    invoke-virtual {v10}, Landroidx/compose/ui/graphics/CanvasHolder;->getAndroidCanvas()Landroidx/compose/ui/graphics/AndroidCanvas;

    move-result-object v0

    invoke-virtual {v0, v9}, Landroidx/compose/ui/graphics/AndroidCanvas;->setInternalCanvas(Landroid/graphics/Canvas;)V
    ...
    .local v13, "$this$record_u24lambda_u240_u240":Landroidx/compose/ui/graphics/Canvas;
    const/4 v14, 0x0

    .line 440
    .local v14, "$i$a$-drawInto-GraphicsViewLayer$record$1$1":I
    ...
    .line 444
    iget-wide v3, v1, Landroidx/compose/ui/graphics/layer/GraphicsViewLayer;->size:J
    ...
    .local v15, "graphicsLayer$iv":Landroidx/compose/ui/graphics/layer/GraphicsLayer;
    ...
    .local v17, "$this$draw_u2dymL40Pk$iv":Landroidx/compose/ui/graphics/drawscope/DrawScope;
    move-object/from16 v18, v13

    .local v18, "canvas$iv":Landroidx/compose/ui/graphics/Canvas;
    ...
    .line 612
    .local v21, "prevDensity$iv":Landroidx/compose/ui/unit/Density;
    invoke-interface/range {v17 .. v17}, Landroidx/compose/ui/graphics/drawscope/DrawScope;->getDrawContext()Landroidx/compose/ui/graphics/drawscope/DrawContext;
    ...
    .line 616
    .local v24, "prevLayer$iv":Landroidx/compose/ui/graphics/layer/GraphicsLayer;
    invoke-interface/range {v17 .. v17}, Landroidx/compose/ui/graphics/drawscope/DrawScope;->getDrawContext()Landroidx/compose/ui/graphics/drawscope/DrawContext;
    ...
    .line 617
    .local v25, "$i$a$-apply-DrawScopeKt$draw$1$iv":I
    ...
    .end local v18    # "canvas$iv":Landroidx/compose/ui/graphics/Canvas;
    .local v1, "canvas$iv":Landroidx/compose/ui/graphics/Canvas;
    .restart local v19    # "layoutDirection$iv":Landroidx/compose/ui/unit/LayoutDirection;
    ...
    .end local v25    # "$i$a$-apply-DrawScopeKt$draw$1$iv":I
    nop
    ...
    .end local v17    # "$this$draw_u2dymL40Pk$iv":Landroidx/compose/ui/graphics/drawscope/DrawScope;
    .local v1, "$this$draw_u2dymL40Pk$iv":Landroidx/compose/ui/graphics/drawscope/DrawScope;
    .restart local v18    # "canvas$iv":Landroidx/compose/ui/graphics/Canvas;
    :try_start_1
    ...
    .line 627
    :try_start_2
    invoke-interface/range {v18 .. v18}, Landroidx/compose/ui/graphics/Canvas;->restore()V
    ...
    .end local v21    # "prevDensity$iv":Landroidx/compose/ui/unit/Density;
    .local v1, "prevDensity$iv":Landroidx/compose/ui/unit/Density;
    .local v25, "$this$draw_u2dymL40Pk$iv":Landroidx/compose/ui/graphics/drawscope/DrawScope;
    invoke-interface {v0, v1}, Landroidx/compose/ui/graphics/drawscope/DrawContext;->setDensity(Landroidx/compose/ui/unit/Density;)V

    .line 630
    move-object/from16 v2, v22

    .end local v22    # "prevLayoutDirection$iv":Landroidx/compose/ui/unit/LayoutDirection;
    ...
    .end local v23    # "prevCanvas$iv":Landroidx/compose/ui/graphics/Canvas;
    .local v3, "prevCanvas$iv":Landroidx/compose/ui/graphics/Canvas;
    .local v21, "$v$c$androidx-compose-ui-geometry-Size$-size$0$iv":J
    ...
    .end local v24    # "prevLayer$iv":Landroidx/compose/ui/graphics/layer/GraphicsLayer;
    .local v6, "prevLayer$iv":Landroidx/compose/ui/graphics/layer/GraphicsLayer;
    .local v23, "p":Landroid/graphics/Picture;
    :try_start_3
    ...
    .end local v15    # "graphicsLayer$iv":Landroidx/compose/ui/graphics/layer/GraphicsLayer;
    .end local v16    # "density$iv":Landroidx/compose/ui/unit/Density;
    .end local v18    # "canvas$iv":Landroidx/compose/ui/graphics/Canvas;
    .end local v19    # "layoutDirection$iv":Landroidx/compose/ui/unit/LayoutDirection;
    .end local v20    # "$i$f$draw-ymL40Pk":I
    .end local v21    # "$v$c$androidx-compose-ui-geometry-Size$-size$0$iv":J
    .end local v25    # "$this$draw_u2dymL40Pk$iv":Landroidx/compose/ui/graphics/drawscope/DrawScope;
    goto :goto_0
    ...
    .local v3, "$v$c$androidx-compose-ui-geometry-Size$-size$0$iv":J
    .local v6, "p":Landroid/graphics/Picture;
    .restart local v15    # "graphicsLayer$iv":Landroidx/compose/ui/graphics/layer/GraphicsLayer;
    .restart local v16    # "density$iv":Landroidx/compose/ui/unit/Density;
    .restart local v18    # "canvas$iv":Landroidx/compose/ui/graphics/Canvas;
    .restart local v19    # "layoutDirection$iv":Landroidx/compose/ui/unit/LayoutDirection;
    .restart local v20    # "$i$f$draw-ymL40Pk":I
    .local v21, "prevDensity$iv":Landroidx/compose/ui/unit/Density;
    .restart local v22    # "prevLayoutDirection$iv":Landroidx/compose/ui/unit/LayoutDirection;
    .local v23, "prevCanvas$iv":Landroidx/compose/ui/graphics/Canvas;
    .restart local v24    # "prevLayer$iv":Landroidx/compose/ui/graphics/layer/GraphicsLayer;
    .restart local v26    # "prevSize$iv":J
    :catchall_0
    move-exception v0
    ...
    .local v21, "$v$c$androidx-compose-ui-geometry-Size$-size$0$iv":J
    .local v23, "p":Landroid/graphics/Picture;
    .restart local v25    # "$this$draw_u2dymL40Pk$iv":Landroidx/compose/ui/graphics/drawscope/DrawScope;
    invoke-interface/range {v18 .. v18}, Landroidx/compose/ui/graphics/Canvas;->restore()V
    ...
    .local v24, "$this$draw_ymL40Pk_u24lambda_u241$iv":Landroidx/compose/ui/graphics/drawscope/DrawContext;
    const/16 v17, 0x0

    .line 629
    .restart local v17    # "$i$a$-apply-DrawScopeKt$draw$2$iv":I
    move-object/from16 v26, v0

    move-object/from16 v0, v24

    .end local v24    # "$this$draw_ymL40Pk_u24lambda_u241$iv":Landroidx/compose/ui/graphics/drawscope/DrawContext;
    ...
    .end local v23    # "p":Landroid/graphics/Picture;
    ...
    .restart local v23    # "p":Landroid/graphics/Picture;
    :goto_0
    nop

    .line 610
    .end local v13    # "$this$record_u24lambda_u240_u240":Landroidx/compose/ui/graphics/Canvas;
    .end local v14    # "$i$a$-drawInto-GraphicsViewLayer$record$1$1":I
    nop
    ...
    invoke-virtual {v0, v12}, Landroidx/compose/ui/graphics/AndroidCanvas;->setInternalCanvas(Landroid/graphics/Canvas;)V

    .line 638
    nop

    .end local v9    # "targetCanvas$iv":Landroid/graphics/Canvas;
    .end local v10    # "this_$iv":Landroidx/compose/ui/graphics/CanvasHolder;
    .end local v11    # "$i$f$drawInto":I
    .end local v12    # "previousCanvas$iv":Landroid/graphics/Canvas;
    ...
    .restart local v23    # "p":Landroid/graphics/Picture;
    :goto_1
    invoke-virtual/range {v23 .. v23}, Landroid/graphics/Picture;->endRecording()V
...
.method public setColorFilter(Landroidx/compose/ui/graphics/ColorFilter;)V
    ...
    .line 584
    .local v0, "$this$_set_colorFilter__u24lambda_u240":Landroid/graphics/Paint;
    const/4 v1, 0x0
    ...
    .line 211
    .end local v0    # "$this$_set_colorFilter__u24lambda_u240":Landroid/graphics/Paint;
...
.method public setOutline-O0kMr_c(Landroid/graphics/Outline;J)V
    ...
    .param p2, "$v$c$androidx-compose-ui-unit-IntSize$-outlineSize$0"    # J
...
.method public setPosition-H0pRuoY(IIJ)V
    ...
    iget-wide v5, v0, Landroidx/compose/ui/graphics/layer/GraphicsViewLayer;->size:J
    ...
    .line 374
    invoke-virtual {v0}, Landroidx/compose/ui/graphics/layer/GraphicsViewLayer;->getClip()Z
    ...
    iput-boolean v5, v0, Landroidx/compose/ui/graphics/layer/GraphicsViewLayer;->clipBoundsInvalidated:Z
    ...
    invoke-virtual {v5, v1, v2, v6, v7}, Landroidx/compose/ui/graphics/layer/ViewLayer;->layout(IIII)V

    .line 378
    iput-wide v3, v0, Landroidx/compose/ui/graphics/layer/GraphicsViewLayer;->size:J

    .line 379
    iget-boolean v5, v0, Landroidx/compose/ui/graphics/layer/GraphicsViewLayer;->shouldManuallySetCenterPivot:Z
    ...
    .line 600
    .restart local v8    # "$i$f$getWidth-impl":I
    move-wide v9, v6
    ...
    .line 601
    .restart local v11    # "$i$f$unpackInt1":I
    shr-long v12, v9, v16
    ...
    invoke-virtual {v5, v6}, Landroidx/compose/ui/graphics/layer/ViewLayer;->setPivotX(F)V
    ...
    invoke-virtual {v5, v6}, Landroidx/compose/ui/graphics/layer/ViewLayer;->setPivotY(F)V

    goto :goto_0

    .line 384
    :cond_1
    iget v5, v0, Landroidx/compose/ui/graphics/layer/GraphicsViewLayer;->x:I
    ...
    iget v6, v0, Landroidx/compose/ui/graphics/layer/GraphicsViewLayer;->x:I

    sub-int v6, v1, v6

    invoke-virtual {v5, v6}, Landroidx/compose/ui/graphics/layer/ViewLayer;->offsetLeftAndRight(I)V

    .line 387
    :cond_2
    iget v5, v0, Landroidx/compose/ui/graphics/layer/GraphicsViewLayer;->y:I
    ...
    iget v6, v0, Landroidx/compose/ui/graphics/layer/GraphicsViewLayer;->y:I

    sub-int v6, v2, v6

    invoke-virtual {v5, v6}, Landroidx/compose/ui/graphics/layer/ViewLayer;->offsetTopAndBottom(I)V

    .line 391
    :cond_3
    :goto_0
    iput v1, v0, Landroidx/compose/ui/graphics/layer/GraphicsViewLayer;->x:I

    .line 392
    iput v2, v0, Landroidx/compose/ui/graphics/layer/GraphicsViewLayer;->y:I
