...
.method public final invoke(Landroidx/compose/ui/graphics/drawscope/DrawScope;)V
    ...
    .local v2, "path$iv":Landroidx/compose/ui/graphics/Path;
    move-object v3, p1

    .line 1011
    .local v3, "$this$clipPath_u2dKD09W0M_u24default$iv":Landroidx/compose/ui/graphics/drawscope/DrawScope;
    nop
    ...
    .line 1011
    .local v4, "$v$c$androidx-compose-ui-graphics-ClipOp$-clipOp$0$iv":I
    const/4 v5, 0x0

    .line 1015
    .local v5, "$i$f$clipPath-KD09W0M":I
    move-object v6, v3

    .local v6, "$this$withTransform$iv$iv":Landroidx/compose/ui/graphics/drawscope/DrawScope;
    const/4 v7, 0x0
    ...
    .local v12, "$this$clipPath_KD09W0M_u24lambda_u240$iv":Landroidx/compose/ui/graphics/drawscope/DrawTransform;
    const/4 v13, 0x0

    .line 1015
    .local v13, "$i$a$-withTransform-DrawScopeKt$clipPath$1$iv":I
    invoke-interface {v12, v2, v4}, Landroidx/compose/ui/graphics/drawscope/DrawTransform;->clipPath-mtrdD-E(Landroidx/compose/ui/graphics/Path;I)V

    .line 1023
    .end local v12    # "$this$clipPath_KD09W0M_u24lambda_u240$iv":Landroidx/compose/ui/graphics/drawscope/DrawTransform;
    .end local v13    # "$i$a$-withTransform-DrawScopeKt$clipPath$1$iv":I
    nop
    ...
    .line 66
    .local v13, "$i$a$-clipPath-KD09W0M$default-GraphicsLayer$clipDrawBlock$1$1":I
    invoke-static {v1, v12}, Landroidx/compose/ui/graphics/layer/GraphicsLayer;->access$drawWithChildTracking(Landroidx/compose/ui/graphics/layer/GraphicsLayer;Landroidx/compose/ui/graphics/drawscope/DrawScope;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    .line 1024
    .end local v12    # "$this$invoke_u24lambda_u240":Landroidx/compose/ui/graphics/drawscope/DrawScope;
    .end local v13    # "$i$a$-clipPath-KD09W0M$default-GraphicsLayer$clipDrawBlock$1$1":I
    nop
    ...
    .line 1015
    .end local v6    # "$this$withTransform$iv$iv":Landroidx/compose/ui/graphics/drawscope/DrawScope;
    .end local v7    # "$i$f$withTransform":I
    nop

    .end local v2    # "path$iv":Landroidx/compose/ui/graphics/Path;
    .end local v3    # "$this$clipPath_u2dKD09W0M_u24default$iv":Landroidx/compose/ui/graphics/drawscope/DrawScope;
    .end local v4    # "$v$c$androidx-compose-ui-graphics-ClipOp$-clipOp$0$iv":I
    .end local v5    # "$i$f$clipPath-KD09W0M":I
    goto :goto_0

    .line 1026
    .restart local v2    # "path$iv":Landroidx/compose/ui/graphics/Path;
    .restart local v3    # "$this$clipPath_u2dKD09W0M_u24default$iv":Landroidx/compose/ui/graphics/drawscope/DrawScope;
    .restart local v4    # "$v$c$androidx-compose-ui-graphics-ClipOp$-clipOp$0$iv":I
    .restart local v5    # "$i$f$clipPath-KD09W0M":I
    .restart local v6    # "$this$withTransform$iv$iv":Landroidx/compose/ui/graphics/drawscope/DrawScope;
    .restart local v7    # "$i$f$withTransform":I
    .restart local v8    # "$this$withTransform_u24lambda_u240$iv$iv":Landroidx/compose/ui/graphics/drawscope/DrawContext;
