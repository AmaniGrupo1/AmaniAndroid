...
.method protected dispatchDraw(Landroid/graphics/Canvas;)V
    ...
    .local v18, "targetCanvas$iv":Landroid/graphics/Canvas;
    int-to-long v2, v0
    ...
    .local v2, "$v$c$androidx-compose-ui-geometry-Size$-size$0$iv":J
    .local v9, "layoutDirection$iv":Landroidx/compose/ui/unit/LayoutDirection;
    .local v13, "canvas$iv":Landroidx/compose/ui/graphics/Canvas;
    const/4 v14, 0x0

    .line 591
    .local v14, "$i$f$draw-ymL40Pk":I
    ...
    .local v19, "$this$dispatchDraw_u24lambda_u240":Landroidx/compose/ui/graphics/Canvas;
    ...
    .local v22, "$i$a$-drawInto-ViewLayer$dispatchDraw$1":I
    ...
    .line 597
    .local v23, "$i$a$-apply-DrawScopeKt$draw$1$iv":I
    ...
    .end local v23    # "$i$a$-apply-DrawScopeKt$draw$1$iv":I
    nop
    ...
    .local v24, "$v$c$androidx-compose-ui-geometry-Size$-size$0$iv":J
    ...
    .end local v13    # "canvas$iv":Landroidx/compose/ui/graphics/Canvas;
    .end local v14    # "$i$f$draw-ymL40Pk":I
    .end local v15    # "prevDensity$iv":Landroidx/compose/ui/unit/Density;
    .end local v24    # "$v$c$androidx-compose-ui-geometry-Size$-size$0$iv":J
    nop

    .line 586
    .end local v19    # "$this$dispatchDraw_u24lambda_u240":Landroidx/compose/ui/graphics/Canvas;
    .end local v22    # "$i$a$-drawInto-ViewLayer$dispatchDraw$1":I
    nop
    ...
    .end local v18    # "targetCanvas$iv":Landroid/graphics/Canvas;
    const/4 v0, 0x0
    ...
    .line 607
    .local v2, "$v$c$androidx-compose-ui-geometry-Size$-size$0$iv":J
    .restart local v4    # "prevLayoutDirection$iv":Landroidx/compose/ui/unit/LayoutDirection;
    .restart local v5    # "prevSize$iv":J
    ...
    .restart local v13    # "canvas$iv":Landroidx/compose/ui/graphics/Canvas;
    .restart local v14    # "$i$f$draw-ymL40Pk":I
    .restart local v15    # "prevDensity$iv":Landroidx/compose/ui/unit/Density;
    .restart local v16    # "$i$f$drawInto":I
    .restart local v17    # "this_$iv":Landroidx/compose/ui/graphics/CanvasHolder;
    .restart local v18    # "targetCanvas$iv":Landroid/graphics/Canvas;
    .restart local v19    # "$this$dispatchDraw_u24lambda_u240":Landroidx/compose/ui/graphics/Canvas;
    .restart local v20    # "previousCanvas$iv":Landroid/graphics/Canvas;
    .restart local v21    # "prevCanvas$iv":Landroidx/compose/ui/graphics/Canvas;
    .restart local v22    # "$i$a$-drawInto-ViewLayer$dispatchDraw$1":I
    :catchall_0
    move-exception v0
    ...
    .restart local v24    # "$v$c$androidx-compose-ui-geometry-Size$-size$0$iv":J
    invoke-interface {v13}, Landroidx/compose/ui/graphics/Canvas;->restore()V
