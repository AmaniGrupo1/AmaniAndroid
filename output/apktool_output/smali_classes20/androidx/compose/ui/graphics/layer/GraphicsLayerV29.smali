...
.method static constructor <clinit>()V
    ...
    sput v0, Landroidx/compose/ui/graphics/layer/GraphicsLayerV29;->$stable:I
...
.method private final applyCompositingStrategy-Z1X6vPc(Landroid/graphics/RenderNode;I)V
    ...
    .param p2, "$v$c$androidx-compose-ui-graphics-layer-CompositingStrategy$-compositingStrategy$0"    # I
    ...
    .line 207
    iget-object v2, p0, Landroidx/compose/ui/graphics/layer/GraphicsLayerV29;->layerPaint:Landroid/graphics/Paint;
...
.method public record(Landroidx/compose/ui/unit/Density;Landroidx/compose/ui/unit/LayoutDirection;Landroidx/compose/ui/graphics/layer/GraphicsLayer;Lkotlin/jvm/functions/Function1;)V
    ...
    .local v2, "targetCanvas$iv":Landroid/graphics/Canvas;
    const/4 v3, 0x0
    ...
    invoke-virtual {v5, v2}, Landroidx/compose/ui/graphics/AndroidCanvas;->setInternalCanvas(Landroid/graphics/Canvas;)V
    ...
    .local v5, "$this$record_u24lambda_u240":Landroidx/compose/ui/graphics/Canvas;
    const/4 v6, 0x0

    .line 244
    .local v6, "$i$a$-drawInto-GraphicsLayerV29$record$1":I
    iget-object v7, p0, Landroidx/compose/ui/graphics/layer/GraphicsLayerV29;->canvasDrawScope:Landroidx/compose/ui/graphics/drawscope/CanvasDrawScope;

    invoke-virtual {v7}, Landroidx/compose/ui/graphics/drawscope/CanvasDrawScope;->getDrawContext()Landroidx/compose/ui/graphics/drawscope/DrawContext;

    move-result-object v7

    .local v7, "it":Landroidx/compose/ui/graphics/drawscope/DrawContext;
    const/4 v8, 0x0

    .line 245
    .local v8, "$i$a$-also-GraphicsLayerV29$record$1$1":I
    invoke-interface {v7, p1}, Landroidx/compose/ui/graphics/drawscope/DrawContext;->setDensity(Landroidx/compose/ui/unit/Density;)V

    .line 246
    invoke-interface {v7, p2}, Landroidx/compose/ui/graphics/drawscope/DrawContext;->setLayoutDirection(Landroidx/compose/ui/unit/LayoutDirection;)V

    .line 247
    invoke-interface {v7, p3}, Landroidx/compose/ui/graphics/drawscope/DrawContext;->setGraphicsLayer(Landroidx/compose/ui/graphics/layer/GraphicsLayer;)V

    .line 248
    iget-wide v9, p0, Landroidx/compose/ui/graphics/layer/GraphicsLayerV29;->size:J

    invoke-interface {v7, v9, v10}, Landroidx/compose/ui/graphics/drawscope/DrawContext;->setSize-uvyYCjk(J)V

    .line 249
    invoke-interface {v7, v5}, Landroidx/compose/ui/graphics/drawscope/DrawContext;->setCanvas(Landroidx/compose/ui/graphics/Canvas;)V

    .line 250
    nop

    .line 244
    .end local v7    # "it":Landroidx/compose/ui/graphics/drawscope/DrawContext;
    .end local v8    # "$i$a$-also-GraphicsLayerV29$record$1$1":I
    nop
    ...
    .line 313
    .end local v5    # "$this$record_u24lambda_u240":Landroidx/compose/ui/graphics/Canvas;
    .end local v6    # "$i$a$-drawInto-GraphicsLayerV29$record$1":I
    nop
    ...
    .end local v2    # "targetCanvas$iv":Landroid/graphics/Canvas;
...
.method public setPivotOffset-k-4lQ0M(J)V
    ...
    invoke-virtual {v0, v7}, Landroid/graphics/RenderNode;->setPivotX(F)Z
    ...
    invoke-virtual {v0, v7}, Landroid/graphics/RenderNode;->setPivotY(F)Z
...
.method public setPosition-H0pRuoY(IIJ)V
    ...
    invoke-virtual {v0, p1, p2, v4, v5}, Landroid/graphics/RenderNode;->setPosition(IIII)Z
