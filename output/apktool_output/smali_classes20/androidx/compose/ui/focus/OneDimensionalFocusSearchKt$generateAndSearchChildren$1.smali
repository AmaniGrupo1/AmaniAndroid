...
.method public final invoke(Landroidx/compose/ui/layout/BeyondBoundsLayout$BeyondBoundsScope;)Ljava/lang/Boolean;
    ...
    iget-object v4, p0, Landroidx/compose/ui/focus/OneDimensionalFocusSearchKt$generateAndSearchChildren$1;->$onFound:Lkotlin/jvm/functions/Function1;

    invoke-static {v0, v1, v3, v4}, Landroidx/compose/ui/focus/OneDimensionalFocusSearchKt;->access$searchChildren-4C6V_qg(Landroidx/compose/ui/focus/FocusTargetNode;Landroidx/compose/ui/focus/FocusTargetNode;ILkotlin/jvm/functions/Function1;)Z
    ...
    .line 126
    .local v3, "$i$a$-takeIf-OneDimensionalFocusSearchKt$generateAndSearchChildren$1$1":I
    if-nez v1, :cond_2
    ...
    .end local v3    # "$i$a$-takeIf-OneDimensionalFocusSearchKt$generateAndSearchChildren$1$1":I
    :cond_2
    :goto_0
    if-eqz v2, :cond_3
