...
.method public removeAll(Ljava/util/Collection;)Z
    ...
    .line 417
    .local v3, "$i$f$removeIf$runtime":I
    const/4 v0, 0x0
    ...
    .local v16, "$this$mutate_u24lambda_u240_u240$iv$iv":Landroidx/compose/runtime/snapshots/SnapshotStateMap$StateMapStateRecord;
    const/16 v17, 0x0
    ...
    .line 427
    .end local v16    # "$this$mutate_u24lambda_u240_u240$iv$iv":Landroidx/compose/runtime/snapshots/SnapshotStateMap$StateMapStateRecord;
    ...
    invoke-virtual/range {v16 .. v16}, Landroidx/compose/runtime/snapshots/SnapshotStateMap$StateMapStateRecord;->getMap$runtime()Landroidx/compose/runtime/external/kotlinx/collections/immutable/PersistentMap;
    ...
    .line 429
    invoke-virtual/range {v16 .. v16}, Landroidx/compose/runtime/snapshots/SnapshotStateMap$StateMapStateRecord;->getModification$runtime()I
    ...
    .line 299
    .local v15, "$i$a$-removeIf$runtime-SnapshotMapValueSet$removeAll$1":I
    ...
    .end local v15    # "$i$a$-removeIf$runtime-SnapshotMapValueSet$removeAll$1":I
    if-eqz v2, :cond_0
    ...
    .local v14, "state$iv$iv$iv$iv":Landroidx/compose/runtime/snapshots/StateObject;
    const/4 v15, 0x0
    ...
    .local v22, "$this$mutate_u24lambda_u241$iv$iv":Landroidx/compose/runtime/snapshots/SnapshotStateMap$StateMapStateRecord;
    const/16 v17, 0x0

    .line 441
    .local v17, "$i$a$-writable-SnapshotStateMap$mutate$2$iv$iv":I
    move/from16 v23, v0

    move-object/from16 v0, v22

    .end local v22    # "$this$mutate_u24lambda_u241$iv$iv":Landroidx/compose/runtime/snapshots/SnapshotStateMap$StateMapStateRecord;
    .local v0, "$this$mutate_u24lambda_u241$iv$iv":Landroidx/compose/runtime/snapshots/SnapshotStateMap$StateMapStateRecord;
    .local v23, "$i$a$-sync-SnapshotKt$writable$3$iv$iv$iv$iv":I
    invoke-static {v4, v0, v9, v2}, Landroidx/compose/runtime/snapshots/SnapshotStateMap;->access$attemptUpdate(Landroidx/compose/runtime/snapshots/SnapshotStateMap;Landroidx/compose/runtime/snapshots/SnapshotStateMap$StateMapStateRecord;ILandroidx/compose/runtime/external/kotlinx/collections/immutable/PersistentMap;)Z
    ...
    .line 447
    .end local v0    # "$this$mutate_u24lambda_u241$iv$iv":Landroidx/compose/runtime/snapshots/SnapshotStateMap$StateMapStateRecord;
    .end local v17    # "$i$a$-writable-SnapshotStateMap$mutate$2$iv$iv":I
    nop
    ...
    .end local v14    # "state$iv$iv$iv$iv":Landroidx/compose/runtime/snapshots/StateObject;
    ...
    .restart local v14    # "state$iv$iv$iv$iv":Landroidx/compose/runtime/snapshots/StateObject;
    ...
    .line 299
    .end local v3    # "$i$f$removeIf$runtime":I
    ...
    .restart local v1    # "set":Ljava/util/Set;
    .local v2, "this_$iv":Landroidx/compose/runtime/snapshots/SnapshotStateMap;
    .restart local v3    # "$i$f$removeIf$runtime":I
...
.method public retainAll(Ljava/util/Collection;)Z
    ...
    .line 304
    .local v15, "$i$a$-removeIf$runtime-SnapshotMapValueSet$retainAll$1":I
    move-object/from16 v16, v2
    ...
    .line 470
    .end local v14    # "it":Ljava/util/Map$Entry;
    .end local v15    # "$i$a$-removeIf$runtime-SnapshotMapValueSet$retainAll$1":I
    if-nez v2, :cond_0
