...
.method static final addAll$lambda$0(ILjava/util/Collection;Ljava/util/List;)Z
    .locals 1
    .param p0, "$index"    # I
...
.method static final retainAll$lambda$0(Ljava/util/Collection;Ljava/util/List;)Z
    .locals 1
...
.method public add(ILjava/lang/Object;)V
    ...
    .local v7, "$this$conditionalUpdate_u24lambda_u240$iv$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    const/4 v8, 0x0

    .line 237
    .local v8, "$i$a$-run-SnapshotStateListKt$conditionalUpdate$1$iv$iv":I
    const/4 v9, 0x0
    ...
    .local v14, "$this$withCurrent$iv$iv$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    const/4 v15, 0x0
    ...
    .local v17, "$this$update_u24default$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    :try_start_1
    ...
    .local v18, "$this$conditionalUpdate_u24lambda_u240_u240_u240$iv$iv":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    const/16 v19, 0x0

    .line 243
    .local v19, "$i$a$-withCurrent-SnapshotStateListKt$conditionalUpdate$1$1$current$1$iv$iv":I
    nop

    .line 245
    .end local v18    # "$this$conditionalUpdate_u24lambda_u240_u240_u240$iv$iv":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    .end local v19    # "$i$a$-withCurrent-SnapshotStateListKt$conditionalUpdate$1$1$current$1$iv$iv":I
    nop
    ...
    .line 243
    .end local v14    # "$this$withCurrent$iv$iv$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    .end local v15    # "$i$f$withCurrent":I
    nop

    .line 246
    .local v18, "current$iv$iv":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    invoke-virtual/range {v18 .. v18}, Landroidx/compose/runtime/snapshots/StateListStateRecord;->getModification$runtime()I
    ...
    .line 247
    invoke-virtual/range {v18 .. v18}, Landroidx/compose/runtime/snapshots/StateListStateRecord;->getList$runtime()Landroidx/compose/runtime/external/kotlinx/collections/immutable/PersistentList;
    ...
    .end local v18    # "current$iv$iv":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    ...
    .line 109
    .local v1, "$i$a$-update$default-SnapshotStateList$add$2":I
    move/from16 v14, p1

    move-object/from16 v15, p2

    invoke-interface {v0, v14, v15}, Landroidx/compose/runtime/external/kotlinx/collections/immutable/PersistentList;->add(ILjava/lang/Object;)Landroidx/compose/runtime/external/kotlinx/collections/immutable/PersistentList;

    move-result-object v0

    .line 249
    .end local v0    # "it":Landroidx/compose/runtime/external/kotlinx/collections/immutable/PersistentList;
    .end local v1    # "$i$a$-update$default-SnapshotStateList$add$2":I
    move-object v1, v0
    ...
    .local v0, "state$iv$iv$iv$iv":Landroidx/compose/runtime/snapshots/StateObject;
    move-object/from16 v18, v0

    .end local v0    # "state$iv$iv$iv$iv":Landroidx/compose/runtime/snapshots/StateObject;
    .local v18, "state$iv$iv$iv$iv":Landroidx/compose/runtime/snapshots/StateObject;
    const/16 v19, 0x0
    ...
    .local v3, "state$iv$iv$iv$iv":Landroidx/compose/runtime/snapshots/StateObject;
    .local v4, "snapshot$iv$iv$iv$iv":Ljava/lang/Object;
    .local v18, "$this$conditionalUpdate$iv$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    ...
    .local v25, "$this$conditionalUpdate_u24lambda_u240_u241$iv$iv":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    const/16 v20, 0x0
    ...
    .end local v25    # "$this$conditionalUpdate_u24lambda_u240_u241$iv$iv":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    .local v0, "$this$conditionalUpdate_u24lambda_u240_u241$iv$iv":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    .local v26, "$i$a$-sync-SnapshotKt$writable$3$iv$iv$iv$iv":I
    invoke-static {v0, v11, v1, v5}, Landroidx/compose/runtime/snapshots/SnapshotStateListKt;->attemptUpdate(Landroidx/compose/runtime/snapshots/StateListStateRecord;ILandroidx/compose/runtime/external/kotlinx/collections/immutable/PersistentList;Z)Z
    ...
    .line 260
    .end local v0    # "$this$conditionalUpdate_u24lambda_u240_u241$iv$iv":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    .end local v20    # "$i$a$-writable-SnapshotStateListKt$conditionalUpdate$1$2$iv$iv":I
    nop

    .line 242
    .end local v26    # "$i$a$-sync-SnapshotKt$writable$3$iv$iv$iv$iv":I
    monitor-exit v22
    ...
    .end local v3    # "state$iv$iv$iv$iv":Landroidx/compose/runtime/snapshots/StateObject;
    ...
    .line 236
    .end local v0    # "result$iv$iv":Z
    .end local v7    # "$this$conditionalUpdate_u24lambda_u240$iv$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    .end local v8    # "$i$a$-run-SnapshotStateListKt$conditionalUpdate$1$iv$iv":I
    nop
    ...
    .line 270
    .end local v5    # "structural$iv$iv":Z
    .end local v6    # "$i$f$conditionalUpdate":I
    .end local v18    # "$this$conditionalUpdate$iv$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    nop

    .line 109
    .end local v16    # "structural$iv":Z
    .end local v17    # "$this$update_u24default$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    ...
    .restart local v5    # "structural$iv$iv":Z
    .restart local v6    # "$i$f$conditionalUpdate":I
    .restart local v7    # "$this$conditionalUpdate_u24lambda_u240$iv$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    .restart local v8    # "$i$a$-run-SnapshotStateListKt$conditionalUpdate$1$iv$iv":I
    .restart local v9    # "result$iv$iv":Z
    ...
    .restart local v17    # "$this$update_u24default$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    .restart local v18    # "$this$conditionalUpdate$iv$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    ...
    .restart local v3    # "state$iv$iv$iv$iv":Landroidx/compose/runtime/snapshots/StateObject;
    ...
    .restart local v19    # "$i$f$writable":I
...
.method public add(Ljava/lang/Object;)Z
    ...
    .local v4, "$this$conditionalUpdate_u24lambda_u240$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    const/4 v5, 0x0
    ...
    .local v15, "$this$conditionalUpdate_u24lambda_u240_u240_u240$iv":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    const/16 v16, 0x0
    ...
    .line 206
    .end local v15    # "$this$conditionalUpdate_u24lambda_u240_u240_u240$iv":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    ...
    .local v14, "state$iv$iv$iv":Landroidx/compose/runtime/snapshots/StateObject;
    const/4 v15, 0x0
    ...
    .local v20, "$this$conditionalUpdate_u24default$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    :try_start_2
    invoke-static {v13, v14, v1}, Landroidx/compose/runtime/snapshots/SnapshotKt;->writableRecord(Landroidx/compose/runtime/snapshots/StateRecord;Landroidx/compose/runtime/snapshots/StateObject;Landroidx/compose/runtime/snapshots/Snapshot;)Landroidx/compose/runtime/snapshots/StateRecord;
    ...
    .local v21, "$this$conditionalUpdate_u24lambda_u240_u241$iv":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    const/16 v16, 0x0

    .line 215
    .local v16, "$i$a$-writable-SnapshotStateListKt$conditionalUpdate$1$2$iv":I
    move/from16 v22, v0

    move-object/from16 v0, v21

    .end local v21    # "$this$conditionalUpdate_u24lambda_u240_u241$iv":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    .local v0, "$this$conditionalUpdate_u24lambda_u240_u241$iv":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    .local v22, "$i$a$-sync-SnapshotKt$writable$3$iv$iv$iv":I
    ...
    .end local v16    # "$i$a$-writable-SnapshotStateListKt$conditionalUpdate$1$2$iv":I
    nop

    .line 203
    .end local v22    # "$i$a$-sync-SnapshotKt$writable$3$iv$iv$iv":I
    monitor-exit v18
    ...
    invoke-static {v1, v14}, Landroidx/compose/runtime/snapshots/SnapshotKt;->notifyWrite(Landroidx/compose/runtime/snapshots/Snapshot;Landroidx/compose/runtime/snapshots/StateObject;)V
    ...
    .end local v14    # "state$iv$iv$iv":Landroidx/compose/runtime/snapshots/StateObject;
    ...
    .line 197
    .end local v0    # "result$iv":Z
    .end local v4    # "$this$conditionalUpdate_u24lambda_u240$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    ...
    .end local v20    # "$this$conditionalUpdate_u24default$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    return v0

    .line 215
    .restart local v2    # "structural$iv":Z
    .restart local v3    # "$i$f$conditionalUpdate":I
    .restart local v4    # "$this$conditionalUpdate_u24lambda_u240$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    ...
    .restart local v20    # "$this$conditionalUpdate_u24default$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    :cond_1
    ...
    .restart local v14    # "state$iv$iv$iv":Landroidx/compose/runtime/snapshots/StateObject;
...
.method public clear()V
    ...
    .local v6, "state$iv$iv$iv":Landroidx/compose/runtime/snapshots/StateObject;
    const/4 v7, 0x0

    .line 310
    .local v7, "$i$f$writable":I
    const/4 v8, 0x0

    .line 311
    .local v8, "snapshot$iv$iv$iv":Ljava/lang/Object;
    const/4 v9, 0x0
    ...
    .local v10, "lock$iv$iv$iv$iv$iv":Ljava/lang/Object;
    const/4 v11, 0x0
    ...
    .line 314
    .local v12, "$i$a$-sync-SnapshotKt$writable$3$iv$iv$iv":I
    :try_start_0
    ...
    .line 315
    invoke-static {v5, v6, v8}, Landroidx/compose/runtime/snapshots/SnapshotKt;->writableRecord(Landroidx/compose/runtime/snapshots/StateRecord;Landroidx/compose/runtime/snapshots/StateObject;Landroidx/compose/runtime/snapshots/Snapshot;)Landroidx/compose/runtime/snapshots/StateRecord;
    ...
    .local v13, "$this$clearImpl_u24lambda_u240$iv":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    const/4 v14, 0x0

    .line 316
    .local v14, "$i$a$-writable-SnapshotStateListKt$clearImpl$1$iv":I
    invoke-static {}, Landroidx/compose/runtime/snapshots/SnapshotStateListKt;->access$getSync$p()Ljava/lang/Object;
    ...
    .local v15, "lock$iv$iv":Ljava/lang/Object;
    const/16 v16, 0x0
    ...
    .local v17, "$i$a$-synchronized-SnapshotStateListKt$clearImpl$1$1$iv":I
    :try_start_1
    invoke-static {}, Landroidx/compose/runtime/external/kotlinx/collections/immutable/ExtensionsKt;->persistentListOf()Landroidx/compose/runtime/external/kotlinx/collections/immutable/PersistentList;

    move-result-object v0

    invoke-virtual {v13, v0}, Landroidx/compose/runtime/snapshots/StateListStateRecord;->setList$runtime(Landroidx/compose/runtime/external/kotlinx/collections/immutable/PersistentList;)V
    ...
    invoke-virtual {v13, v0}, Landroidx/compose/runtime/snapshots/StateListStateRecord;->setModification$runtime(I)V

    .line 319
    invoke-virtual {v13}, Landroidx/compose/runtime/snapshots/StateListStateRecord;->getStructuralChange$runtime()I
    ...
    invoke-virtual {v13, v0}, Landroidx/compose/runtime/snapshots/StateListStateRecord;->setStructuralChange$runtime(I)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0

    .line 313
    .end local v17    # "$i$a$-synchronized-SnapshotStateListKt$clearImpl$1$1$iv":I
    :try_start_2
    monitor-exit v15
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_1
    ...
    .line 320
    .end local v15    # "lock$iv$iv":Ljava/lang/Object;
    .end local v16    # "$i$f$synchronized":I
    nop

    .line 315
    .end local v13    # "$this$clearImpl_u24lambda_u240$iv":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    .end local v14    # "$i$a$-writable-SnapshotStateListKt$clearImpl$1$iv":I
    nop

    .line 313
    .end local v12    # "$i$a$-sync-SnapshotKt$writable$3$iv$iv$iv":I
    monitor-exit v10

    .line 312
    .end local v10    # "lock$iv$iv$iv$iv$iv":Ljava/lang/Object;
    ...
    .line 322
    .local v18, "it$iv$iv$iv":I
    const/4 v0, 0x0

    .line 321
    .local v0, "$i$a$-also-SnapshotKt$writable$4$iv$iv$iv":I
    invoke-static {v8, v6}, Landroidx/compose/runtime/snapshots/SnapshotKt;->notifyWrite(Landroidx/compose/runtime/snapshots/Snapshot;Landroidx/compose/runtime/snapshots/StateObject;)V

    .line 311
    .end local v0    # "$i$a$-also-SnapshotKt$writable$4$iv$iv$iv":I
    .end local v18    # "it$iv$iv$iv":I
    nop

    .line 309
    .end local v5    # "$this$writable$iv$iv$iv":Landroidx/compose/runtime/snapshots/StateRecord;
    .end local v6    # "state$iv$iv$iv":Landroidx/compose/runtime/snapshots/StateObject;
    .end local v7    # "$i$f$writable":I
    .end local v8    # "snapshot$iv$iv$iv":Ljava/lang/Object;
    nop
    ...
    .restart local v6    # "state$iv$iv$iv":Landroidx/compose/runtime/snapshots/StateObject;
    .restart local v7    # "$i$f$writable":I
    .restart local v8    # "snapshot$iv$iv$iv":Ljava/lang/Object;
    .restart local v9    # "$i$f$sync":I
    .restart local v10    # "lock$iv$iv$iv$iv$iv":Ljava/lang/Object;
    .restart local v11    # "$i$f$synchronized":I
    .restart local v12    # "$i$a$-sync-SnapshotKt$writable$3$iv$iv$iv":I
    .restart local v13    # "$this$clearImpl_u24lambda_u240$iv":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    .restart local v14    # "$i$a$-writable-SnapshotStateListKt$clearImpl$1$iv":I
    .restart local v15    # "lock$iv$iv":Ljava/lang/Object;
...
.method public final getDebuggerDisplayValue()Ljava/util/List;
    ...
    .local v4, "$this$_get_debuggerDisplayValue__u24lambda_u240":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    const/4 v5, 0x0
    ...
    .line 537
    .end local v4    # "$this$_get_debuggerDisplayValue__u24lambda_u240":Landroidx/compose/runtime/snapshots/StateListStateRecord;
...
.method public removeAt(I)Ljava/lang/Object;
    ...
    .local v6, "structural$iv$iv":Z
    move-object v7, v3

    .local v7, "$this$conditionalUpdate$iv$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    const/4 v8, 0x0

    .line 404
    .local v8, "$i$f$conditionalUpdate":I
    move-object v9, v7

    check-cast v9, Landroidx/compose/runtime/snapshots/SnapshotStateList;

    .local v9, "$this$conditionalUpdate_u24lambda_u240$iv$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    const/4 v10, 0x0

    .line 405
    .local v10, "$i$a$-run-SnapshotStateListKt$conditionalUpdate$1$iv$iv":I
    const/4 v11, 0x0

    .line 406
    .local v11, "result$iv$iv":Z
    :goto_0
    nop
    ...
    .line 408
    .local v12, "oldList$iv$iv":Ljava/lang/Object;
    const/4 v13, 0x0

    .line 409
    .local v13, "currentModification$iv$iv":I
    invoke-static {}, Landroidx/compose/runtime/snapshots/SnapshotStateListKt;->access$getSync$p()Ljava/lang/Object;

    move-result-object v14

    .local v14, "lock$iv$iv$iv":Ljava/lang/Object;
    const/4 v15, 0x0
    ...
    .local v17, "$this$withCurrent$iv$iv$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    const/16 v18, 0x0

    .line 412
    .local v18, "$i$f$withCurrent":I
    move-object/from16 v19, v0

    :try_start_0
    invoke-virtual/range {v17 .. v17}, Landroidx/compose/runtime/snapshots/SnapshotStateList;->getFirstStateRecord()Landroidx/compose/runtime/snapshots/StateRecord;
    ...
    check-cast v21, Landroidx/compose/runtime/snapshots/StateListStateRecord;

    .local v21, "$this$conditionalUpdate_u24lambda_u240_u240_u240$iv$iv":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    const/16 v22, 0x0

    .line 411
    .local v22, "$i$a$-withCurrent-SnapshotStateListKt$conditionalUpdate$1$1$current$1$iv$iv":I
    nop

    .line 413
    .end local v21    # "$this$conditionalUpdate_u24lambda_u240_u240_u240$iv$iv":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    .end local v22    # "$i$a$-withCurrent-SnapshotStateListKt$conditionalUpdate$1$1$current$1$iv$iv":I
    nop
    ...
    .line 411
    .end local v17    # "$this$withCurrent$iv$iv$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    .end local v18    # "$i$f$withCurrent":I
    nop

    .line 414
    .local v21, "current$iv$iv":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    invoke-virtual/range {v21 .. v21}, Landroidx/compose/runtime/snapshots/StateListStateRecord;->getModification$runtime()I
    ...
    .line 415
    invoke-virtual/range {v21 .. v21}, Landroidx/compose/runtime/snapshots/StateListStateRecord;->getList$runtime()Landroidx/compose/runtime/external/kotlinx/collections/immutable/PersistentList;
    ...
    .end local v16    # "$i$a$-synchronized-SnapshotStateListKt$conditionalUpdate$1$1$iv$iv":I
    .end local v21    # "current$iv$iv":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    sget-object v0, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_2
    ...
    .line 417
    .end local v14    # "lock$iv$iv$iv":Ljava/lang/Object;
    ...
    .line 422
    .end local v0    # "result$iv$iv":Z
    .restart local v11    # "result$iv$iv":Z
    :cond_0
    move-object v15, v9

    .local v15, "$this$writable$iv$iv$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    const/16 v16, 0x0
    ...
    .local v17, "$i$a$-also-SnapshotStateList$removeAt$1":I
    const-string/jumbo v2, "null cannot be cast to non-null type androidx.compose.runtime.snapshots.StateListStateRecord<T of androidx.compose.runtime.snapshots.SnapshotStateListKt.writable>"
    ...
    .line 424
    .local v21, "$i$f$writable":I
    const/16 v22, 0x0

    .line 425
    .local v22, "snapshot$iv$iv$iv$iv":Ljava/lang/Object;
    const/16 v23, 0x0

    .line 426
    .local v23, "$i$f$sync":I
    invoke-static {}, Landroidx/compose/runtime/snapshots/SnapshotKt;->getLock()Ljava/lang/Object;

    move-result-object v24

    .local v24, "lock$iv$iv$iv$iv$iv$iv":Ljava/lang/Object;
    const/16 v25, 0x0
    ...
    .local v0, "$i$a$-sync-SnapshotKt$writable$3$iv$iv$iv$iv":I
    :try_start_2
    sget-object v26, Landroidx/compose/runtime/snapshots/Snapshot;->Companion:Landroidx/compose/runtime/snapshots/Snapshot$Companion;

    invoke-virtual/range {v26 .. v26}, Landroidx/compose/runtime/snapshots/Snapshot$Companion;->getCurrent()Landroidx/compose/runtime/snapshots/Snapshot;
    ...
    .end local v22    # "snapshot$iv$iv$iv$iv":Ljava/lang/Object;
    .local v3, "state$iv$iv$iv$iv":Landroidx/compose/runtime/snapshots/StateObject;
    .local v4, "snapshot$iv$iv$iv$iv":Ljava/lang/Object;
    .local v18, "structural$iv":Z
    .local v26, "$this$update_u24default$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    :try_start_3
    invoke-static {v2, v3, v4}, Landroidx/compose/runtime/snapshots/SnapshotKt;->writableRecord(Landroidx/compose/runtime/snapshots/StateRecord;Landroidx/compose/runtime/snapshots/StateObject;Landroidx/compose/runtime/snapshots/Snapshot;)Landroidx/compose/runtime/snapshots/StateRecord;

    move-result-object v22

    check-cast v22, Landroidx/compose/runtime/snapshots/StateListStateRecord;

    move-object/from16 v27, v22

    .local v27, "$this$conditionalUpdate_u24lambda_u240_u241$iv$iv":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    const/16 v22, 0x0

    .line 422
    .local v22, "$i$a$-writable-SnapshotStateListKt$conditionalUpdate$1$2$iv$iv":I
    move/from16 v28, v0

    move-object/from16 v0, v27

    .end local v27    # "$this$conditionalUpdate_u24lambda_u240_u241$iv$iv":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    .local v0, "$this$conditionalUpdate_u24lambda_u240_u241$iv$iv":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    .local v28, "$i$a$-sync-SnapshotKt$writable$3$iv$iv$iv$iv":I
    invoke-static {v0, v13, v1, v6}, Landroidx/compose/runtime/snapshots/SnapshotStateListKt;->attemptUpdate(Landroidx/compose/runtime/snapshots/StateListStateRecord;ILandroidx/compose/runtime/external/kotlinx/collections/immutable/PersistentList;Z)Z
    ...
    .line 428
    .end local v0    # "$this$conditionalUpdate_u24lambda_u240_u241$iv$iv":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    .end local v22    # "$i$a$-writable-SnapshotStateListKt$conditionalUpdate$1$2$iv$iv":I
    nop

    .line 410
    .end local v28    # "$i$a$-sync-SnapshotKt$writable$3$iv$iv$iv$iv":I
    monitor-exit v24

    .line 426
    .end local v24    # "lock$iv$iv$iv$iv$iv$iv":Ljava/lang/Object;
    .end local v25    # "$i$f$synchronized":I
    nop

    .line 430
    .end local v23    # "$i$f$sync":I
    move/from16 v0, v27
    ...
    .line 430
    .local v22, "$i$a$-also-SnapshotKt$writable$4$iv$iv$iv$iv":I
    invoke-static {v4, v3}, Landroidx/compose/runtime/snapshots/SnapshotKt;->notifyWrite(Landroidx/compose/runtime/snapshots/Snapshot;Landroidx/compose/runtime/snapshots/StateObject;)V

    .line 425
    .end local v0    # "it$iv$iv$iv$iv":Z
    .end local v22    # "$i$a$-also-SnapshotKt$writable$4$iv$iv$iv$iv":I
    nop
    ...
    .end local v3    # "state$iv$iv$iv$iv":Landroidx/compose/runtime/snapshots/StateObject;
    .end local v4    # "snapshot$iv$iv$iv$iv":Ljava/lang/Object;
    .end local v21    # "$i$f$writable":I
    nop

    .line 422
    .end local v15    # "$this$writable$iv$iv$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    ...
    .line 436
    .end local v1    # "newList$iv$iv":Landroidx/compose/runtime/external/kotlinx/collections/immutable/PersistentList;
    .end local v12    # "oldList$iv$iv":Ljava/lang/Object;
    .end local v13    # "currentModification$iv$iv":I
    :goto_1
    nop

    .line 404
    .end local v0    # "result$iv$iv":Z
    .end local v9    # "$this$conditionalUpdate_u24lambda_u240$iv$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    .end local v10    # "$i$a$-run-SnapshotStateListKt$conditionalUpdate$1$iv$iv":I
    nop
    ...
    .line 438
    .end local v6    # "structural$iv$iv":Z
    .end local v7    # "$this$conditionalUpdate$iv$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    .end local v8    # "$i$f$conditionalUpdate":I
    nop

    .line 127
    .end local v5    # "$i$f$update":I
    .end local v18    # "structural$iv":Z
    .end local v26    # "$this$update_u24default$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    nop

    .end local v17    # "$i$a$-also-SnapshotStateList$removeAt$1":I
    ...
    .restart local v6    # "structural$iv$iv":Z
    .restart local v7    # "$this$conditionalUpdate$iv$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    .restart local v8    # "$i$f$conditionalUpdate":I
    .restart local v9    # "$this$conditionalUpdate_u24lambda_u240$iv$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    .restart local v10    # "$i$a$-run-SnapshotStateListKt$conditionalUpdate$1$iv$iv":I
    .restart local v11    # "result$iv$iv":Z
    .restart local v12    # "oldList$iv$iv":Ljava/lang/Object;
    .restart local v13    # "currentModification$iv$iv":I
    .restart local v17    # "$i$a$-also-SnapshotStateList$removeAt$1":I
    .restart local v18    # "structural$iv":Z
    .restart local v20    # "it":Ljava/lang/Object;
    .restart local v26    # "$this$update_u24default$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    :cond_1
    move/from16 v2, v17
    ...
    .restart local v3    # "state$iv$iv$iv$iv":Landroidx/compose/runtime/snapshots/StateObject;
    .restart local v4    # "snapshot$iv$iv$iv$iv":Ljava/lang/Object;
    .restart local v15    # "$this$writable$iv$iv$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    .restart local v16    # "$i$f$writable":I
    .restart local v21    # "$i$f$writable":I
    .restart local v23    # "$i$f$sync":I
    .restart local v24    # "lock$iv$iv$iv$iv$iv$iv":Ljava/lang/Object;
    ...
    .restart local v14    # "lock$iv$iv$iv":Ljava/lang/Object;
    .local v15, "$i$f$synchronized":I
    :catchall_2
    move-exception v0
...
.method public final removeRange(II)V
    ...
    .local v13, "state$iv$iv$iv":Landroidx/compose/runtime/snapshots/StateObject;
    const/4 v14, 0x0
    ...
    .local v20, "$this$mutate_u24lambda_u241$iv":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    const/16 v19, 0x0
    ...
    .end local v20    # "$this$mutate_u24lambda_u241$iv":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    ...
    .end local v13    # "state$iv$iv$iv":Landroidx/compose/runtime/snapshots/StateObject;
    ...
    .restart local v13    # "state$iv$iv$iv":Landroidx/compose/runtime/snapshots/StateObject;
...
.method public final retainAllInRange$runtime(Ljava/util/Collection;II)I
    ...
    .local v13, "$this$mutate_u24lambda_u240_u240$iv":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    const/4 v14, 0x0
    ...
    .line 514
    .end local v13    # "$this$mutate_u24lambda_u240_u240$iv":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    ...
    .local v22, "$this$mutate_u24lambda_u241$iv":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    const/16 v17, 0x0

    .line 523
    .local v17, "$i$a$-writable-SnapshotStateListKt$mutate$2$iv":I
    move/from16 v23, v0
    ...
    .end local v22    # "$this$mutate_u24lambda_u241$iv":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    .local v2, "$this$mutate_u24lambda_u241$iv":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    .local v24, "$this$mutate$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    :try_start_3
    invoke-static {v2, v6, v8, v0}, Landroidx/compose/runtime/snapshots/SnapshotStateListKt;->attemptUpdate(Landroidx/compose/runtime/snapshots/StateListStateRecord;ILandroidx/compose/runtime/external/kotlinx/collections/immutable/PersistentList;Z)Z
    ...
    .line 529
    .end local v2    # "$this$mutate_u24lambda_u241$iv":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    .end local v17    # "$i$a$-writable-SnapshotStateListKt$mutate$2$iv":I
    nop
    ...
    .end local v24    # "$this$mutate$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    .local v2, "$this$mutate$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    :catchall_1
    move-exception v0
    ...
    .restart local v24    # "$this$mutate$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    goto :goto_1
...
.method public set(ILjava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-interface {v0, v14, v15}, Landroidx/compose/runtime/external/kotlinx/collections/immutable/PersistentList;->set(ILjava/lang/Object;)Landroidx/compose/runtime/external/kotlinx/collections/immutable/PersistentList;
    ...
    .local v16, "$this$writable$iv$iv$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    const/16 v17, 0x0
    ...
    .line 461
    .local v22, "$i$f$writable":I
    const/16 v23, 0x0

    .line 462
    .local v23, "snapshot$iv$iv$iv$iv":Ljava/lang/Object;
    const/16 v24, 0x0

    .line 463
    .local v24, "$i$f$sync":I
    invoke-static {}, Landroidx/compose/runtime/snapshots/SnapshotKt;->getLock()Ljava/lang/Object;

    move-result-object v25

    .local v25, "lock$iv$iv$iv$iv$iv$iv":Ljava/lang/Object;
    const/16 v26, 0x0
    ...
    .local v0, "$i$a$-sync-SnapshotKt$writable$3$iv$iv$iv$iv":I
    :try_start_2
    sget-object v27, Landroidx/compose/runtime/snapshots/Snapshot;->Companion:Landroidx/compose/runtime/snapshots/Snapshot$Companion;

    invoke-virtual/range {v27 .. v27}, Landroidx/compose/runtime/snapshots/Snapshot$Companion;->getCurrent()Landroidx/compose/runtime/snapshots/Snapshot;
    ...
    .end local v23    # "snapshot$iv$iv$iv$iv":Ljava/lang/Object;
    .local v4, "snapshot$iv$iv$iv$iv":Ljava/lang/Object;
    .local v27, "$this$update$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    :try_start_3
    invoke-static {v2, v3, v4}, Landroidx/compose/runtime/snapshots/SnapshotKt;->writableRecord(Landroidx/compose/runtime/snapshots/StateRecord;Landroidx/compose/runtime/snapshots/StateObject;Landroidx/compose/runtime/snapshots/Snapshot;)Landroidx/compose/runtime/snapshots/StateRecord;

    move-result-object v23

    check-cast v23, Landroidx/compose/runtime/snapshots/StateListStateRecord;

    move-object/from16 v28, v23

    .local v28, "$this$conditionalUpdate_u24lambda_u240_u241$iv$iv":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    const/16 v23, 0x0

    .line 459
    .local v23, "$i$a$-writable-SnapshotStateListKt$conditionalUpdate$1$2$iv$iv":I
    move/from16 v29, v0

    move-object/from16 v0, v28

    .end local v28    # "$this$conditionalUpdate_u24lambda_u240_u241$iv$iv":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    .local v0, "$this$conditionalUpdate_u24lambda_u240_u241$iv$iv":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    .local v29, "$i$a$-sync-SnapshotKt$writable$3$iv$iv$iv$iv":I
    invoke-static {v0, v13, v1, v6}, Landroidx/compose/runtime/snapshots/SnapshotStateListKt;->attemptUpdate(Landroidx/compose/runtime/snapshots/StateListStateRecord;ILandroidx/compose/runtime/external/kotlinx/collections/immutable/PersistentList;Z)Z
    ...
    .line 465
    .end local v0    # "$this$conditionalUpdate_u24lambda_u240_u241$iv$iv":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    .end local v23    # "$i$a$-writable-SnapshotStateListKt$conditionalUpdate$1$2$iv$iv":I
    nop

    .line 447
    .end local v29    # "$i$a$-sync-SnapshotKt$writable$3$iv$iv$iv$iv":I
    monitor-exit v25

    .line 463
    .end local v25    # "lock$iv$iv$iv$iv$iv$iv":Ljava/lang/Object;
    .end local v26    # "$i$f$synchronized":I
    nop

    .line 467
    .end local v24    # "$i$f$sync":I
    move/from16 v0, v28
    ...
    .line 467
    .local v23, "$i$a$-also-SnapshotKt$writable$4$iv$iv$iv$iv":I
    invoke-static {v4, v3}, Landroidx/compose/runtime/snapshots/SnapshotKt;->notifyWrite(Landroidx/compose/runtime/snapshots/Snapshot;Landroidx/compose/runtime/snapshots/StateObject;)V

    .line 462
    .end local v0    # "it$iv$iv$iv$iv":Z
    .end local v23    # "$i$a$-also-SnapshotKt$writable$4$iv$iv$iv$iv":I
    nop
    ...
    .end local v3    # "state$iv$iv$iv$iv":Landroidx/compose/runtime/snapshots/StateObject;
    .end local v4    # "snapshot$iv$iv$iv$iv":Ljava/lang/Object;
    .end local v22    # "$i$f$writable":I
    nop

    .line 459
    .end local v16    # "$this$writable$iv$iv$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    ...
    .line 134
    .end local v5    # "$i$f$update":I
    .end local v21    # "structural$iv":Z
    .end local v27    # "$this$update$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    nop
    ...
    .restart local v20    # "it":Ljava/lang/Object;
    .restart local v21    # "structural$iv":Z
    .restart local v27    # "$this$update$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    :cond_1
    move/from16 v2, v18
    ...
    .restart local v3    # "state$iv$iv$iv$iv":Landroidx/compose/runtime/snapshots/StateObject;
    .restart local v4    # "snapshot$iv$iv$iv$iv":Ljava/lang/Object;
    .restart local v16    # "$this$writable$iv$iv$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    .restart local v17    # "$i$f$writable":I
    .restart local v22    # "$i$f$writable":I
    .restart local v24    # "$i$f$sync":I
    .restart local v25    # "lock$iv$iv$iv$iv$iv$iv":Ljava/lang/Object;
