...
.method public final isReadIn-h_f27i8$runtime(I)Z
    .locals 4
    .param p1, "$v$c$androidx-compose-runtime-snapshots-ReaderKind$-reader$0"    # I
    ...
    .local v0, "$v$c$androidx-compose-runtime-snapshots-ReaderKind$-this$0$iv":I
    move v1, p1

    .local v1, "$v$c$androidx-compose-runtime-snapshots-ReaderKind$-reader$0$iv":I
    const/4 v2, 0x0

    .line 66
    .local v2, "$i$f$isReadIn-h_f27i8":I
    and-int v3, v0, v1
    ...
    .line 41
    .end local v0    # "$v$c$androidx-compose-runtime-snapshots-ReaderKind$-this$0$iv":I
    .end local v1    # "$v$c$androidx-compose-runtime-snapshots-ReaderKind$-reader$0$iv":I
    .end local v2    # "$i$f$isReadIn-h_f27i8":I
    :goto_0
    return v3
.end method
...
.method public final recordReadIn-h_f27i8$runtime(I)V
    ...
    .local v2, "$v$c$androidx-compose-runtime-snapshots-ReaderKind$-this$0$iv":I
    const/4 v3, 0x0

    .line 64
    .local v3, "$i$f$isReadIn-h_f27i8":I
    and-int v4, v2, v1
    ...
    .line 34
    .end local v1    # "$v$c$androidx-compose-runtime-snapshots-ReaderKind$-reader$0$iv":I
    .end local v2    # "$v$c$androidx-compose-runtime-snapshots-ReaderKind$-this$0$iv":I
    .end local v3    # "$i$f$isReadIn-h_f27i8":I
    :goto_0
    if-eqz v4, :cond_2
    ...
    .restart local v1    # "$v$c$androidx-compose-runtime-snapshots-ReaderKind$-reader$0$iv":I
    move v2, v0

    .restart local v2    # "$v$c$androidx-compose-runtime-snapshots-ReaderKind$-this$0$iv":I
    const/4 v3, 0x0

    .line 65
    .local v3, "$i$f$withReadIn-3QSx2Dw":I
    or-int v4, v2, v1
    ...
    .end local v1    # "$v$c$androidx-compose-runtime-snapshots-ReaderKind$-reader$0$iv":I
    .end local v2    # "$v$c$androidx-compose-runtime-snapshots-ReaderKind$-this$0$iv":I
    .end local v3    # "$i$f$withReadIn-3QSx2Dw":I
    nop
