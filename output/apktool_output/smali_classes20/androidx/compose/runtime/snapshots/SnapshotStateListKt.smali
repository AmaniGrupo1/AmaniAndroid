...
.method public static final attemptUpdate(Landroidx/compose/runtime/snapshots/StateListStateRecord;ILandroidx/compose/runtime/external/kotlinx/collections/immutable/PersistentList;Z)Z
    .locals 5
    .param p0, "$this$attemptUpdate"    # Landroidx/compose/runtime/snapshots/StateListStateRecord;
    .param p1, "currentModification"    # I
    .param p2, "newList"    # Landroidx/compose/runtime/external/kotlinx/collections/immutable/PersistentList;
    .param p3, "structural"    # Z
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
            "Ljava/lang/Object;",
    ...
    .line 193
    .local v2, "$i$a$-synchronized-SnapshotStateListKt$attemptUpdate$1":I
    :try_start_0
    ...
    invoke-virtual {p0, v4}, Landroidx/compose/runtime/snapshots/StateListStateRecord;->setStructuralChange$runtime(I)V
    ...
    invoke-virtual {p0, v4}, Landroidx/compose/runtime/snapshots/StateListStateRecord;->setModification$runtime(I)V
    :try_end_0
    ...
    .line 666
    .end local v2    # "$i$a$-synchronized-SnapshotStateListKt$attemptUpdate$1":I
    :goto_0
    monitor-exit v0
...
.method public static final clearImpl(Landroidx/compose/runtime/snapshots/SnapshotStateList;)V
    .locals 18
    .param p0, "$this$clearImpl"    # Landroidx/compose/runtime/snapshots/SnapshotStateList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
            "Ljava/lang/Object;",
    ...
    .line 151
    .local v1, "$i$f$clearImpl":I
    move-object/from16 v2, p0

    .local v2, "$this$writable$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    const/4 v3, 0x0
    ...
    const-string/jumbo v4, "null cannot be cast to non-null type androidx.compose.runtime.snapshots.StateListStateRecord<T of androidx.compose.runtime.snapshots.SnapshotStateListKt.writable>"
    ...
    .local v4, "$this$writable$iv$iv":Landroidx/compose/runtime/snapshots/StateRecord;
    move-object v0, v2

    check-cast v0, Landroidx/compose/runtime/snapshots/StateObject;

    .local v0, "state$iv$iv":Landroidx/compose/runtime/snapshots/StateObject;
    move-object v5, v0

    .end local v0    # "state$iv$iv":Landroidx/compose/runtime/snapshots/StateObject;
    .local v5, "state$iv$iv":Landroidx/compose/runtime/snapshots/StateObject;
    const/4 v6, 0x0
    ...
    .line 633
    .local v7, "snapshot$iv$iv":Ljava/lang/Object;
    const/4 v8, 0x0
    ...
    .local v9, "lock$iv$iv$iv$iv":Ljava/lang/Object;
    const/4 v10, 0x0
    ...
    .line 636
    .local v11, "$i$a$-sync-SnapshotKt$writable$3$iv$iv":I
    :try_start_0
    ...
    .line 637
    invoke-static {v4, v5, v7}, Landroidx/compose/runtime/snapshots/SnapshotKt;->writableRecord(Landroidx/compose/runtime/snapshots/StateRecord;Landroidx/compose/runtime/snapshots/StateObject;Landroidx/compose/runtime/snapshots/Snapshot;)Landroidx/compose/runtime/snapshots/StateRecord;
    ...
    .local v12, "$this$clearImpl_u24lambda_u240":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    const/4 v13, 0x0

    .line 152
    .local v13, "$i$a$-writable-SnapshotStateListKt$clearImpl$1":I
    ...
    .line 153
    .local v0, "$i$a$-synchronized-SnapshotStateListKt$clearImpl$1$1":I
    move/from16 v16, v0

    .end local v0    # "$i$a$-synchronized-SnapshotStateListKt$clearImpl$1$1":I
    .local v16, "$i$a$-synchronized-SnapshotStateListKt$clearImpl$1$1":I
    :try_start_1
    invoke-static {}, Landroidx/compose/runtime/external/kotlinx/collections/immutable/ExtensionsKt;->persistentListOf()Landroidx/compose/runtime/external/kotlinx/collections/immutable/PersistentList;
    ...
    .line 638
    .end local v16    # "$i$a$-synchronized-SnapshotStateListKt$clearImpl$1$1":I
    :try_start_2
    monitor-exit v14
    :try_end_2
    ...
    .line 637
    .end local v12    # "$this$clearImpl_u24lambda_u240":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    .end local v13    # "$i$a$-writable-SnapshotStateListKt$clearImpl$1":I
    nop

    .line 635
    .end local v11    # "$i$a$-sync-SnapshotKt$writable$3$iv$iv":I
    monitor-exit v9

    .line 634
    .end local v9    # "lock$iv$iv$iv$iv":Ljava/lang/Object;
    ...
    .line 640
    .local v17, "it$iv$iv":I
    const/4 v0, 0x0

    .line 639
    .local v0, "$i$a$-also-SnapshotKt$writable$4$iv$iv":I
    invoke-static {v7, v5}, Landroidx/compose/runtime/snapshots/SnapshotKt;->notifyWrite(Landroidx/compose/runtime/snapshots/Snapshot;Landroidx/compose/runtime/snapshots/StateObject;)V

    .line 633
    .end local v0    # "$i$a$-also-SnapshotKt$writable$4$iv$iv":I
    .end local v17    # "it$iv$iv":I
    nop

    .line 631
    .end local v4    # "$this$writable$iv$iv":Landroidx/compose/runtime/snapshots/StateRecord;
    .end local v5    # "state$iv$iv":Landroidx/compose/runtime/snapshots/StateObject;
    .end local v6    # "$i$f$writable":I
    .end local v7    # "snapshot$iv$iv":Ljava/lang/Object;
    nop

    .line 158
    .end local v2    # "$this$writable$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    .end local v3    # "$i$f$writable":I
    return-void

    .line 638
    .restart local v2    # "$this$writable$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    .restart local v3    # "$i$f$writable":I
    .restart local v4    # "$this$writable$iv$iv":Landroidx/compose/runtime/snapshots/StateRecord;
    .restart local v5    # "state$iv$iv":Landroidx/compose/runtime/snapshots/StateObject;
    .restart local v6    # "$i$f$writable":I
    .restart local v7    # "snapshot$iv$iv":Ljava/lang/Object;
    .restart local v8    # "$i$f$sync":I
    .restart local v9    # "lock$iv$iv$iv$iv":Ljava/lang/Object;
    .restart local v10    # "$i$f$synchronized":I
    .restart local v11    # "$i$a$-sync-SnapshotKt$writable$3$iv$iv":I
    .restart local v12    # "$this$clearImpl_u24lambda_u240":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    .restart local v13    # "$i$a$-writable-SnapshotStateListKt$clearImpl$1":I
    ...
    .end local v9    # "lock$iv$iv$iv$iv":Ljava/lang/Object;
    .end local v10    # "$i$f$synchronized":I
    .end local p0    # "$this$clearImpl":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    throw v0
    :try_end_3
    ...
    .end local v14    # "lock$iv":Ljava/lang/Object;
    .end local v15    # "$i$f$synchronized":I
    .restart local v1    # "$i$f$clearImpl":I
    .restart local v2    # "$this$writable$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    .restart local v3    # "$i$f$writable":I
    .restart local v4    # "$this$writable$iv$iv":Landroidx/compose/runtime/snapshots/StateRecord;
    .restart local v5    # "state$iv$iv":Landroidx/compose/runtime/snapshots/StateObject;
    ...
    .restart local v9    # "lock$iv$iv$iv$iv":Ljava/lang/Object;
    .restart local v10    # "$i$f$synchronized":I
    .restart local p0    # "$this$clearImpl":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    :catchall_1
    move-exception v0
...
.method public static final conditionalUpdate(Landroidx/compose/runtime/snapshots/SnapshotStateList;ZLkotlin/jvm/functions/Function1;)Z
    .locals 22
    .param p0, "$this$conditionalUpdate"    # Landroidx/compose/runtime/snapshots/SnapshotStateList;
    ...
    .local v2, "$this$conditionalUpdate_u24lambda_u240":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    const/4 v3, 0x0

    .line 164
    .local v3, "$i$a$-run-SnapshotStateListKt$conditionalUpdate$1":I
    const/4 v4, 0x0
    ...
    .line 169
    .local v0, "$i$a$-synchronized-SnapshotStateListKt$conditionalUpdate$1$1":I
    move-object v9, v2

    .local v9, "$this$withCurrent$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    const/4 v10, 0x0
    ...
    .local v13, "$this$conditionalUpdate_u24lambda_u240_u240_u240":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    const/4 v14, 0x0

    .line 169
    .local v14, "$i$a$-withCurrent-SnapshotStateListKt$conditionalUpdate$1$1$current$1":I
    nop

    .line 643
    .end local v13    # "$this$conditionalUpdate_u24lambda_u240_u240_u240":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    .end local v14    # "$i$a$-withCurrent-SnapshotStateListKt$conditionalUpdate$1$1$current$1":I
    nop
    ...
    .line 169
    .end local v9    # "$this$withCurrent$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    .end local v10    # "$i$f$withCurrent":I
    nop

    .line 170
    .local v13, "current":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    ...
    .end local v0    # "$i$a$-synchronized-SnapshotStateListKt$conditionalUpdate$1$1":I
    .end local v13    # "current":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    ...
    .local v8, "$this$writable$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    const/4 v10, 0x0
    ...
    const-string/jumbo v11, "null cannot be cast to non-null type androidx.compose.runtime.snapshots.StateListStateRecord<T of androidx.compose.runtime.snapshots.SnapshotStateListKt.writable>"
    ...
    .end local v0    # "state$iv$iv":Landroidx/compose/runtime/snapshots/StateObject;
    .local v12, "state$iv$iv":Landroidx/compose/runtime/snapshots/StateObject;
    const/4 v13, 0x0
    ...
    .line 650
    invoke-static {v11, v12, v14}, Landroidx/compose/runtime/snapshots/SnapshotKt;->writableRecord(Landroidx/compose/runtime/snapshots/StateRecord;Landroidx/compose/runtime/snapshots/StateObject;Landroidx/compose/runtime/snapshots/Snapshot;)Landroidx/compose/runtime/snapshots/StateRecord;

    move-result-object v18

    check-cast v18, Landroidx/compose/runtime/snapshots/StateListStateRecord;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_1

    move-object/from16 v19, v18

    .local v19, "$this$conditionalUpdate_u24lambda_u240_u241":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    const/16 v18, 0x0

    .line 178
    .local v18, "$i$a$-writable-SnapshotStateListKt$conditionalUpdate$1$2":I
    ...
    .local v0, "$this$conditionalUpdate_u24lambda_u240_u241":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    .local v19, "$i$a$-sync-SnapshotKt$writable$3$iv$iv":I
    .local v20, "$i$f$conditionalUpdate":I
    :try_start_2
    invoke-static {v0, v6, v7, v1}, Landroidx/compose/runtime/snapshots/SnapshotStateListKt;->attemptUpdate(Landroidx/compose/runtime/snapshots/StateListStateRecord;ILandroidx/compose/runtime/external/kotlinx/collections/immutable/PersistentList;Z)Z
    ...
    .line 650
    .end local v0    # "$this$conditionalUpdate_u24lambda_u240_u241":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    .end local v18    # "$i$a$-writable-SnapshotStateListKt$conditionalUpdate$1$2":I
    nop
    ...
    invoke-static {v14, v12}, Landroidx/compose/runtime/snapshots/SnapshotKt;->notifyWrite(Landroidx/compose/runtime/snapshots/Snapshot;Landroidx/compose/runtime/snapshots/StateObject;)V
    ...
    .end local v12    # "state$iv$iv":Landroidx/compose/runtime/snapshots/StateObject;
    .end local v13    # "$i$f$writable":I
    .end local v14    # "snapshot$iv$iv":Ljava/lang/Object;
    nop

    .line 178
    .end local v8    # "$this$writable$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    ...
    .line 163
    .end local v0    # "result":Z
    .end local v2    # "$this$conditionalUpdate_u24lambda_u240":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    .end local v3    # "$i$a$-run-SnapshotStateListKt$conditionalUpdate$1":I
    nop
    ...
    .line 178
    .restart local v2    # "$this$conditionalUpdate_u24lambda_u240":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    .restart local v3    # "$i$a$-run-SnapshotStateListKt$conditionalUpdate$1":I
    .restart local v4    # "result":Z
    ...
    .line 648
    .restart local v8    # "$this$writable$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    .restart local v10    # "$i$f$writable":I
    .restart local v11    # "$this$writable$iv$iv":Landroidx/compose/runtime/snapshots/StateRecord;
    .restart local v12    # "state$iv$iv":Landroidx/compose/runtime/snapshots/StateObject;
    ...
    .end local v20    # "$i$f$conditionalUpdate":I
    ...
    .end local v1    # "$i$f$conditionalUpdate":I
    .restart local v20    # "$i$f$conditionalUpdate":I
    :goto_2
    monitor-exit v16
...
.method public static synthetic conditionalUpdate$default(Landroidx/compose/runtime/snapshots/SnapshotStateList;ZLkotlin/jvm/functions/Function1;ILjava/lang/Object;)Z
    .locals 21
    .param p0, "$this$conditionalUpdate_u24default"    # Landroidx/compose/runtime/snapshots/SnapshotStateList;
    .param p1, "structural"    # Z
    .param p2, "block"    # Lkotlin/jvm/functions/Function1;
    ...
    .local v3, "$this$conditionalUpdate_u24lambda_u240":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    const/4 v4, 0x0

    .line 164
    .local v4, "$i$a$-run-SnapshotStateListKt$conditionalUpdate$1":I
    const/4 v5, 0x0
    ...
    .local v10, "$this$withCurrent$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    const/4 v11, 0x0
    ...
    const-string/jumbo v13, "null cannot be cast to non-null type androidx.compose.runtime.snapshots.StateListStateRecord<T of androidx.compose.runtime.snapshots.SnapshotStateListKt.withCurrent>"
    ...
    check-cast v14, Landroidx/compose/runtime/snapshots/StateListStateRecord;

    .local v14, "$this$conditionalUpdate_u24lambda_u240_u240_u240":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    const/4 v15, 0x0

    .line 169
    .local v15, "$i$a$-withCurrent-SnapshotStateListKt$conditionalUpdate$1$1$current$1":I
    nop

    .line 656
    .end local v14    # "$this$conditionalUpdate_u24lambda_u240_u240_u240":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    .end local v15    # "$i$a$-withCurrent-SnapshotStateListKt$conditionalUpdate$1$1$current$1":I
    nop
    ...
    .line 169
    .end local v10    # "$this$withCurrent$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    .end local v11    # "$i$f$withCurrent":I
    nop

    .line 170
    .local v14, "current":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    invoke-virtual {v14}, Landroidx/compose/runtime/snapshots/StateListStateRecord;->getModification$runtime()I
    ...
    .line 171
    invoke-virtual {v14}, Landroidx/compose/runtime/snapshots/StateListStateRecord;->getList$runtime()Landroidx/compose/runtime/external/kotlinx/collections/immutable/PersistentList;
    ...
    .end local v0    # "$i$a$-synchronized-SnapshotStateListKt$conditionalUpdate$1$1":I
    .end local v14    # "current":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    sget-object v0, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_1
    ...
    .local v9, "$this$writable$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    const/4 v11, 0x0
    ...
    .local v13, "state$iv$iv":Landroidx/compose/runtime/snapshots/StateObject;
    const/4 v14, 0x0
    ...
    .line 663
    invoke-static {v12, v13, v15}, Landroidx/compose/runtime/snapshots/SnapshotKt;->writableRecord(Landroidx/compose/runtime/snapshots/StateRecord;Landroidx/compose/runtime/snapshots/StateObject;Landroidx/compose/runtime/snapshots/Snapshot;)Landroidx/compose/runtime/snapshots/StateRecord;

    move-result-object v19

    check-cast v19, Landroidx/compose/runtime/snapshots/StateListStateRecord;

    move-object/from16 p1, v19

    .local p1, "$this$conditionalUpdate_u24lambda_u240_u241":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    const/16 v19, 0x0

    .line 178
    .local v19, "$i$a$-writable-SnapshotStateListKt$conditionalUpdate$1$2":I
    move/from16 p3, v0

    move-object/from16 v0, p1

    .end local p1    # "$this$conditionalUpdate_u24lambda_u240_u241":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    .local v0, "$this$conditionalUpdate_u24lambda_u240_u241":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    .local p3, "$i$a$-sync-SnapshotKt$writable$3$iv$iv":I
    invoke-static {v0, v7, v8, v1}, Landroidx/compose/runtime/snapshots/SnapshotStateListKt;->attemptUpdate(Landroidx/compose/runtime/snapshots/StateListStateRecord;ILandroidx/compose/runtime/external/kotlinx/collections/immutable/PersistentList;Z)Z
    ...
    .line 663
    .end local v0    # "$this$conditionalUpdate_u24lambda_u240_u241":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    .end local v19    # "$i$a$-writable-SnapshotStateListKt$conditionalUpdate$1$2":I
    nop

    .line 661
    .end local p3    # "$i$a$-sync-SnapshotKt$writable$3$iv$iv":I
    monitor-exit v17
    ...
    invoke-static {v15, v13}, Landroidx/compose/runtime/snapshots/SnapshotKt;->notifyWrite(Landroidx/compose/runtime/snapshots/Snapshot;Landroidx/compose/runtime/snapshots/StateObject;)V
    ...
    .end local v13    # "state$iv$iv":Landroidx/compose/runtime/snapshots/StateObject;
    .end local v14    # "$i$f$writable":I
    .end local v15    # "snapshot$iv$iv":Ljava/lang/Object;
    nop

    .line 178
    .end local v9    # "$this$writable$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    ...
    .line 163
    .end local v0    # "result":Z
    .end local v3    # "$this$conditionalUpdate_u24lambda_u240":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    .end local v4    # "$i$a$-run-SnapshotStateListKt$conditionalUpdate$1":I
    nop
    ...
    .line 661
    .restart local v3    # "$this$conditionalUpdate_u24lambda_u240":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    .restart local v4    # "$i$a$-run-SnapshotStateListKt$conditionalUpdate$1":I
    .restart local v5    # "result":Z
    ...
    .restart local v9    # "$this$writable$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    .restart local v11    # "$i$f$writable":I
    .restart local v12    # "$this$writable$iv$iv":Landroidx/compose/runtime/snapshots/StateRecord;
    .restart local v13    # "state$iv$iv":Landroidx/compose/runtime/snapshots/StateObject;
...
.method public static final getReadable(Landroidx/compose/runtime/snapshots/SnapshotStateList;)Landroidx/compose/runtime/snapshots/StateListStateRecord;
    .locals 2
    .param p0, "$this$readable"    # Landroidx/compose/runtime/snapshots/SnapshotStateList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
            "Ljava/lang/Object;",
    ...
    const-string/jumbo v1, "null cannot be cast to non-null type androidx.compose.runtime.snapshots.StateListStateRecord<T of androidx.compose.runtime.snapshots.SnapshotStateListKt.<get-readable>>"
...
.method public static final getStructure(Landroidx/compose/runtime/snapshots/SnapshotStateList;)I
    .locals 6
    .param p0, "$this$structure"    # Landroidx/compose/runtime/snapshots/SnapshotStateList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
            "Ljava/lang/Object;",
    ...
    .local v4, "$this$_get_structure__u24lambda_u240":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    const/4 v5, 0x0

    .line 211
    .local v5, "$i$a$-withCurrent-SnapshotStateListKt$structure$1":I
    invoke-virtual {v4}, Landroidx/compose/runtime/snapshots/StateListStateRecord;->getStructuralChange$runtime()I

    move-result v4

    .line 668
    .end local v4    # "$this$_get_structure__u24lambda_u240":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    .end local v5    # "$i$a$-withCurrent-SnapshotStateListKt$structure$1":I
    nop
...
.method public static final mutate(Landroidx/compose/runtime/snapshots/SnapshotStateList;Lkotlin/jvm/functions/Function1;)Ljava/lang/Object;
    .locals 21
    .param p0, "$this$mutate"    # Landroidx/compose/runtime/snapshots/SnapshotStateList;
    ...
    .line 126
    .local v0, "$i$a$-synchronized-SnapshotStateListKt$mutate$1":I
    move-object/from16 v7, p0

    .local v7, "$this$withCurrent$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    const/4 v8, 0x0
    ...
    const-string/jumbo v10, "null cannot be cast to non-null type androidx.compose.runtime.snapshots.StateListStateRecord<T of androidx.compose.runtime.snapshots.SnapshotStateListKt.withCurrent>"

    invoke-static {v9, v10}, Lkotlin/jvm/internal/Intrinsics;->checkNotNull(Ljava/lang/Object;Ljava/lang/String;)V

    check-cast v9, Landroidx/compose/runtime/snapshots/StateListStateRecord;
    ...
    .local v11, "$this$mutate_u24lambda_u240_u240":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    const/4 v12, 0x0

    .line 126
    .local v12, "$i$a$-withCurrent-SnapshotStateListKt$mutate$1$current$1":I
    nop

    .line 554
    .end local v11    # "$this$mutate_u24lambda_u240_u240":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    .end local v12    # "$i$a$-withCurrent-SnapshotStateListKt$mutate$1$current$1":I
    nop
    ...
    .line 126
    .end local v7    # "$this$withCurrent$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    .end local v8    # "$i$f$withCurrent":I
    nop

    .line 127
    .local v11, "current":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    invoke-virtual {v11}, Landroidx/compose/runtime/snapshots/StateListStateRecord;->getModification$runtime()I
    ...
    .line 128
    invoke-virtual {v11}, Landroidx/compose/runtime/snapshots/StateListStateRecord;->getList$runtime()Landroidx/compose/runtime/external/kotlinx/collections/immutable/PersistentList;
    ...
    .end local v0    # "$i$a$-synchronized-SnapshotStateListKt$mutate$1":I
    .end local v11    # "current":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    sget-object v0, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_2
    ...
    const-string/jumbo v10, "null cannot be cast to non-null type androidx.compose.runtime.snapshots.StateListStateRecord<T of androidx.compose.runtime.snapshots.SnapshotStateListKt.writable>"
    ...
    .local v11, "state$iv$iv":Landroidx/compose/runtime/snapshots/StateObject;
    const/4 v12, 0x0
    ...
    .line 561
    invoke-static {v10, v11, v13}, Landroidx/compose/runtime/snapshots/SnapshotKt;->writableRecord(Landroidx/compose/runtime/snapshots/StateRecord;Landroidx/compose/runtime/snapshots/StateObject;Landroidx/compose/runtime/snapshots/Snapshot;)Landroidx/compose/runtime/snapshots/StateRecord;
    ...
    .local v18, "$this$mutate_u24lambda_u241":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    const/16 v17, 0x0

    .line 135
    .local v17, "$i$a$-writable-SnapshotStateListKt$mutate$2":I
    move/from16 v19, v0
    ...
    .end local v18    # "$this$mutate_u24lambda_u241":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    .local v1, "$this$mutate_u24lambda_u241":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    .local v20, "$i$f$mutate":I
    :try_start_2
    invoke-static {v1, v4, v6, v0}, Landroidx/compose/runtime/snapshots/SnapshotStateListKt;->attemptUpdate(Landroidx/compose/runtime/snapshots/StateListStateRecord;ILandroidx/compose/runtime/external/kotlinx/collections/immutable/PersistentList;Z)Z
    ...
    .line 561
    .end local v1    # "$this$mutate_u24lambda_u241":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    .end local v17    # "$i$a$-writable-SnapshotStateListKt$mutate$2":I
    nop
    ...
    invoke-static {v13, v11}, Landroidx/compose/runtime/snapshots/SnapshotKt;->notifyWrite(Landroidx/compose/runtime/snapshots/Snapshot;Landroidx/compose/runtime/snapshots/StateObject;)V
    ...
    .end local v11    # "state$iv$iv":Landroidx/compose/runtime/snapshots/StateObject;
    ...
    .restart local v11    # "state$iv$iv":Landroidx/compose/runtime/snapshots/StateObject;
...
.method public static final mutateBoolean(Landroidx/compose/runtime/snapshots/SnapshotStateList;Lkotlin/jvm/functions/Function1;)Z
    .locals 22
    .param p0, "$this$mutateBoolean"    # Landroidx/compose/runtime/snapshots/SnapshotStateList;
    .param p1, "block"    # Lkotlin/jvm/functions/Function1;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    .local v12, "$this$mutate_u24lambda_u240_u240$iv":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    const/4 v13, 0x0
    ...
    .line 530
    .end local v12    # "$this$mutate_u24lambda_u240_u240$iv":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    ...
    .local v9, "$this$writable$iv$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    const/4 v10, 0x0
    ...
    .local v12, "state$iv$iv$iv":Landroidx/compose/runtime/snapshots/StateObject;
    const/4 v13, 0x0
    ...
    .local v19, "$this$mutate_u24lambda_u241$iv":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    const/16 v18, 0x0

    .line 539
    .local v18, "$i$a$-writable-SnapshotStateListKt$mutate$2$iv":I
    move/from16 v20, v0
    ...
    .end local v19    # "$this$mutate_u24lambda_u241$iv":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    .local v1, "$this$mutate_u24lambda_u241$iv":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    .local v21, "$this$mutate$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    :try_start_2
    invoke-static {v1, v5, v7, v0}, Landroidx/compose/runtime/snapshots/SnapshotStateListKt;->attemptUpdate(Landroidx/compose/runtime/snapshots/StateListStateRecord;ILandroidx/compose/runtime/external/kotlinx/collections/immutable/PersistentList;Z)Z
    ...
    .line 545
    .end local v1    # "$this$mutate_u24lambda_u241$iv":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    .end local v18    # "$i$a$-writable-SnapshotStateListKt$mutate$2$iv":I
    nop
    ...
    .end local v12    # "state$iv$iv$iv":Landroidx/compose/runtime/snapshots/StateObject;
    .end local v13    # "$i$f$writable":I
    .end local v14    # "snapshot$iv$iv$iv":Ljava/lang/Object;
    nop

    .line 539
    .end local v9    # "$this$writable$iv$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    .end local v10    # "$i$f$writable":I
    if-eqz v0, :cond_0
    ...
    .line 527
    .restart local v9    # "$this$writable$iv$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    .restart local v10    # "$i$f$writable":I
    .restart local v11    # "$this$writable$iv$iv$iv":Landroidx/compose/runtime/snapshots/StateRecord;
    .restart local v12    # "state$iv$iv$iv":Landroidx/compose/runtime/snapshots/StateObject;
    .restart local v13    # "$i$f$writable":I
    ...
    .end local v21    # "$this$mutate$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    .local v1, "$this$mutate$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    :catchall_1
    move-exception v0
    ...
    .restart local v21    # "$this$mutate$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    :goto_1
    monitor-exit v16
...
.method public static final stateRecordWith(Landroidx/compose/runtime/snapshots/SnapshotStateList;Landroidx/compose/runtime/external/kotlinx/collections/immutable/PersistentList;)Landroidx/compose/runtime/snapshots/StateRecord;
    .locals 7
    .param p0, "$this$stateRecordWith"    # Landroidx/compose/runtime/snapshots/SnapshotStateList;
    ...
    .line 204
    .local v3, "$i$a$-also-SnapshotStateListKt$stateRecordWith$1":I
    instance-of v4, v0, Landroidx/compose/runtime/snapshots/GlobalSnapshot;

    if-nez v4, :cond_0

    .line 205
    new-instance v4, Landroidx/compose/runtime/snapshots/StateListStateRecord;
    ...
    invoke-direct {v4, v5, v6, p1}, Landroidx/compose/runtime/snapshots/StateListStateRecord;-><init>(JLandroidx/compose/runtime/external/kotlinx/collections/immutable/PersistentList;)V

    check-cast v4, Landroidx/compose/runtime/snapshots/StateRecord;

    invoke-virtual {v2, v4}, Landroidx/compose/runtime/snapshots/StateListStateRecord;->setNext$runtime(Landroidx/compose/runtime/snapshots/StateRecord;)V
    ...
    .end local v3    # "$i$a$-also-SnapshotStateListKt$stateRecordWith$1":I
...
.method public static final update(Landroidx/compose/runtime/snapshots/SnapshotStateList;ZLkotlin/jvm/functions/Function1;)V
    .locals 24
    .param p0, "$this$update"    # Landroidx/compose/runtime/snapshots/SnapshotStateList;
    .param p1, "structural"    # Z
    .param p2, "block"    # Lkotlin/jvm/functions/Function1;
    .annotation system Ldalvik/annotation/Signature;
        value = {
    ...
    .local v0, "structural$iv":Z
    move-object/from16 v2, p0

    .local v2, "$this$conditionalUpdate$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    move v3, v0

    .end local v0    # "structural$iv":Z
    ...
    .local v5, "$this$conditionalUpdate_u24lambda_u240$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    const/4 v6, 0x0

    .line 566
    .local v6, "$i$a$-run-SnapshotStateListKt$conditionalUpdate$1$iv":I
    const/4 v7, 0x0
    ...
    .local v12, "$this$withCurrent$iv$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    const/4 v13, 0x0
    ...
    const-string/jumbo v15, "null cannot be cast to non-null type androidx.compose.runtime.snapshots.StateListStateRecord<T of androidx.compose.runtime.snapshots.SnapshotStateListKt.withCurrent>"
    ...
    check-cast v16, Landroidx/compose/runtime/snapshots/StateListStateRecord;

    .local v16, "$this$conditionalUpdate_u24lambda_u240_u240_u240$iv":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    const/16 v17, 0x0

    .line 572
    .local v17, "$i$a$-withCurrent-SnapshotStateListKt$conditionalUpdate$1$1$current$1$iv":I
    nop

    .line 574
    .end local v16    # "$this$conditionalUpdate_u24lambda_u240_u240_u240$iv":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    .end local v17    # "$i$a$-withCurrent-SnapshotStateListKt$conditionalUpdate$1$1$current$1$iv":I
    nop
    ...
    .line 572
    .end local v12    # "$this$withCurrent$iv$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    .end local v13    # "$i$f$withCurrent":I
    nop

    .line 575
    .local v16, "current$iv":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    invoke-virtual/range {v16 .. v16}, Landroidx/compose/runtime/snapshots/StateListStateRecord;->getModification$runtime()I
    ...
    .line 576
    invoke-virtual/range {v16 .. v16}, Landroidx/compose/runtime/snapshots/StateListStateRecord;->getList$runtime()Landroidx/compose/runtime/external/kotlinx/collections/immutable/PersistentList;
    ...
    .end local v16    # "current$iv":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    sget-object v0, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_2
    ...
    .local v0, "state$iv$iv$iv":Landroidx/compose/runtime/snapshots/StateObject;
    move-object v15, v0

    .end local v0    # "state$iv$iv$iv":Landroidx/compose/runtime/snapshots/StateObject;
    .local v15, "state$iv$iv$iv":Landroidx/compose/runtime/snapshots/StateObject;
    const/16 v16, 0x0
    ...
    .line 586
    .local v17, "snapshot$iv$iv$iv":Ljava/lang/Object;
    const/16 v18, 0x0
    ...
    .local v19, "lock$iv$iv$iv$iv$iv":Ljava/lang/Object;
    const/16 v20, 0x0
    ...
    .end local v17    # "snapshot$iv$iv$iv":Ljava/lang/Object;
    .local v1, "snapshot$iv$iv$iv":Ljava/lang/Object;
    .local v21, "$i$f$update":I
    :try_start_2
    invoke-static {v14, v15, v1}, Landroidx/compose/runtime/snapshots/SnapshotKt;->writableRecord(Landroidx/compose/runtime/snapshots/StateRecord;Landroidx/compose/runtime/snapshots/StateObject;Landroidx/compose/runtime/snapshots/Snapshot;)Landroidx/compose/runtime/snapshots/StateRecord;
    ...
    .local v22, "$this$conditionalUpdate_u24lambda_u240_u241$iv":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    const/16 v17, 0x0

    .line 583
    .local v17, "$i$a$-writable-SnapshotStateListKt$conditionalUpdate$1$2$iv":I
    move/from16 v23, v0

    move-object/from16 v0, v22

    .end local v22    # "$this$conditionalUpdate_u24lambda_u240_u241$iv":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    .local v0, "$this$conditionalUpdate_u24lambda_u240_u241$iv":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    .local v23, "$i$a$-sync-SnapshotKt$writable$3$iv$iv$iv":I
    invoke-static {v0, v9, v10, v3}, Landroidx/compose/runtime/snapshots/SnapshotStateListKt;->attemptUpdate(Landroidx/compose/runtime/snapshots/StateListStateRecord;ILandroidx/compose/runtime/external/kotlinx/collections/immutable/PersistentList;Z)Z
    ...
    .line 589
    .end local v0    # "$this$conditionalUpdate_u24lambda_u240_u241$iv":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    .end local v17    # "$i$a$-writable-SnapshotStateListKt$conditionalUpdate$1$2$iv":I
    nop

    .line 571
    .end local v23    # "$i$a$-sync-SnapshotKt$writable$3$iv$iv$iv":I
    monitor-exit v19

    .line 587
    .end local v19    # "lock$iv$iv$iv$iv$iv":Ljava/lang/Object;
    ...
    .line 591
    .local v17, "$i$a$-also-SnapshotKt$writable$4$iv$iv$iv":I
    invoke-static {v1, v15}, Landroidx/compose/runtime/snapshots/SnapshotKt;->notifyWrite(Landroidx/compose/runtime/snapshots/Snapshot;Landroidx/compose/runtime/snapshots/StateObject;)V

    .line 586
    .end local v0    # "it$iv$iv$iv":Z
    .end local v17    # "$i$a$-also-SnapshotKt$writable$4$iv$iv$iv":I
    nop
    ...
    .end local v15    # "state$iv$iv$iv":Landroidx/compose/runtime/snapshots/StateObject;
    ...
    .line 565
    .end local v0    # "result$iv":Z
    .end local v5    # "$this$conditionalUpdate_u24lambda_u240$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    .end local v6    # "$i$a$-run-SnapshotStateListKt$conditionalUpdate$1$iv":I
    nop
    ...
    .line 147
    .end local v2    # "$this$conditionalUpdate$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    .end local v3    # "structural$iv":Z
    .end local v4    # "$i$f$conditionalUpdate":I
    return-void

    .line 583
    .restart local v2    # "$this$conditionalUpdate$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    .restart local v3    # "structural$iv":Z
    .restart local v4    # "$i$f$conditionalUpdate":I
    .restart local v5    # "$this$conditionalUpdate_u24lambda_u240$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    .restart local v6    # "$i$a$-run-SnapshotStateListKt$conditionalUpdate$1$iv":I
    .restart local v7    # "result$iv":Z
    ...
    .restart local v15    # "state$iv$iv$iv":Landroidx/compose/runtime/snapshots/StateObject;
    .restart local v16    # "$i$f$writable":I
    .restart local v18    # "$i$f$sync":I
    .restart local v19    # "lock$iv$iv$iv$iv$iv":Ljava/lang/Object;
...
.method public static synthetic update$default(Landroidx/compose/runtime/snapshots/SnapshotStateList;ZLkotlin/jvm/functions/Function1;ILjava/lang/Object;)V
    .locals 23
    .param p0, "$this$update_u24default"    # Landroidx/compose/runtime/snapshots/SnapshotStateList;
    .param p1, "structural"    # Z
    .param p2, "block"    # Lkotlin/jvm/functions/Function1;
    ...
    .local v3, "$this$conditionalUpdate$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    move v4, v0
    ...
    .local v6, "$this$conditionalUpdate_u24lambda_u240$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    const/4 v7, 0x0

    .line 600
    .local v7, "$i$a$-run-SnapshotStateListKt$conditionalUpdate$1$iv":I
    const/4 v8, 0x0
    ...
    .local v13, "$this$withCurrent$iv$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    const/4 v14, 0x0
    ...
    .end local v0    # "$i$a$-synchronized-SnapshotStateListKt$conditionalUpdate$1$1$iv":I
    .local p1, "$i$a$-synchronized-SnapshotStateListKt$conditionalUpdate$1$1$iv":I
    ...
    .line 605
    .end local v13    # "$this$withCurrent$iv$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    ...
    .end local v16    # "current$iv":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    .end local p1    # "$i$a$-synchronized-SnapshotStateListKt$conditionalUpdate$1$1$iv":I
    sget-object v0, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_2
    ...
    .local v12, "$this$writable$iv$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    const/4 v14, 0x0
    ...
    const-string/jumbo v15, "null cannot be cast to non-null type androidx.compose.runtime.snapshots.StateListStateRecord<T of androidx.compose.runtime.snapshots.SnapshotStateListKt.writable>"
    ...
    .local v15, "$this$writable$iv$iv$iv":Landroidx/compose/runtime/snapshots/StateRecord;
    move-object v0, v12
    ...
    .end local v0    # "state$iv$iv$iv":Landroidx/compose/runtime/snapshots/StateObject;
    .local p1, "state$iv$iv$iv":Landroidx/compose/runtime/snapshots/StateObject;
    const/16 v16, 0x0
    ...
    .line 622
    .end local v17    # "snapshot$iv$iv$iv":Ljava/lang/Object;
    .local p3, "snapshot$iv$iv$iv":Ljava/lang/Object;
    move/from16 p4, v1
    ...
    .end local p3    # "snapshot$iv$iv$iv":Ljava/lang/Object;
    .local v1, "state$iv$iv$iv":Landroidx/compose/runtime/snapshots/StateObject;
    .local v2, "snapshot$iv$iv$iv":Ljava/lang/Object;
    .local p1, "$i$f$update":I
    .local p4, "structural":Z
    :try_start_2
    invoke-static {v15, v1, v2}, Landroidx/compose/runtime/snapshots/SnapshotKt;->writableRecord(Landroidx/compose/runtime/snapshots/StateRecord;Landroidx/compose/runtime/snapshots/StateObject;Landroidx/compose/runtime/snapshots/Snapshot;)Landroidx/compose/runtime/snapshots/StateRecord;
    ...
    .local p3, "$this$conditionalUpdate_u24lambda_u240_u241$iv":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    const/16 v17, 0x0
    ...
    .end local p3    # "$this$conditionalUpdate_u24lambda_u240_u241$iv":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    .local v0, "$this$conditionalUpdate_u24lambda_u240_u241$iv":Landroidx/compose/runtime/snapshots/StateListStateRecord;
    .local v21, "$i$a$-sync-SnapshotKt$writable$3$iv$iv$iv":I
    invoke-static {v0, v10, v11, v4}, Landroidx/compose/runtime/snapshots/SnapshotStateListKt;->attemptUpdate(Landroidx/compose/runtime/snapshots/StateListStateRecord;ILandroidx/compose/runtime/external/kotlinx/collections/immutable/PersistentList;Z)Z
    ...
    .line 571
    .end local v21    # "$i$a$-sync-SnapshotKt$writable$3$iv$iv$iv":I
    monitor-exit v19
    ...
    .line 624
    .local v17, "$i$a$-also-SnapshotKt$writable$4$iv$iv$iv":I
    invoke-static {v2, v1}, Landroidx/compose/runtime/snapshots/SnapshotKt;->notifyWrite(Landroidx/compose/runtime/snapshots/Snapshot;Landroidx/compose/runtime/snapshots/StateObject;)V
    ...
    .line 617
    .end local v1    # "state$iv$iv$iv":Landroidx/compose/runtime/snapshots/StateObject;
    .end local v2    # "snapshot$iv$iv$iv":Ljava/lang/Object;
    .end local v15    # "$this$writable$iv$iv$iv":Landroidx/compose/runtime/snapshots/StateRecord;
    .end local v16    # "$i$f$writable":I
    nop

    .line 616
    .end local v12    # "$this$writable$iv$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    .end local v14    # "$i$f$writable":I
    if-eqz v22, :cond_2
    ...
    .line 599
    .end local v0    # "result$iv":Z
    .end local v6    # "$this$conditionalUpdate_u24lambda_u240$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    .end local v7    # "$i$a$-run-SnapshotStateListKt$conditionalUpdate$1$iv":I
    nop
    ...
    .line 147
    .end local v3    # "$this$conditionalUpdate$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    .end local v4    # "structural$iv":Z
    .end local v5    # "$i$f$conditionalUpdate":I
    return-void

    .line 616
    .restart local v3    # "$this$conditionalUpdate$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    .restart local v4    # "structural$iv":Z
    .restart local v5    # "$i$f$conditionalUpdate":I
    .restart local v6    # "$this$conditionalUpdate_u24lambda_u240$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    .restart local v7    # "$i$a$-run-SnapshotStateListKt$conditionalUpdate$1$iv":I
    .restart local v8    # "result$iv":Z
    ...
    .line 571
    .restart local v1    # "state$iv$iv$iv":Landroidx/compose/runtime/snapshots/StateObject;
    .restart local v2    # "snapshot$iv$iv$iv":Ljava/lang/Object;
    .restart local v12    # "$this$writable$iv$iv":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    .restart local v14    # "$i$f$writable":I
    .restart local v15    # "$this$writable$iv$iv$iv":Landroidx/compose/runtime/snapshots/StateRecord;
    .restart local v16    # "$i$f$writable":I
    .restart local v18    # "$i$f$sync":I
    .restart local v19    # "lock$iv$iv$iv$iv$iv":Ljava/lang/Object;
    .restart local v20    # "$i$f$synchronized":I
...
.method public static final withCurrent(Landroidx/compose/runtime/snapshots/SnapshotStateList;Lkotlin/jvm/functions/Function1;)Ljava/lang/Object;
    .locals 4
    .param p0, "$this$withCurrent"    # Landroidx/compose/runtime/snapshots/SnapshotStateList;
    .param p1, "block"    # Lkotlin/jvm/functions/Function1;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<R:",
    ...
    const-string/jumbo v2, "null cannot be cast to non-null type androidx.compose.runtime.snapshots.StateListStateRecord<T of androidx.compose.runtime.snapshots.SnapshotStateListKt.withCurrent>"
...
.method public static final writable(Landroidx/compose/runtime/snapshots/SnapshotStateList;Lkotlin/jvm/functions/Function1;)Ljava/lang/Object;
    .locals 10
    .param p0, "$this$writable"    # Landroidx/compose/runtime/snapshots/SnapshotStateList;
    .param p1, "block"    # Lkotlin/jvm/functions/Function1;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<R:",
    ...
    .local v2, "state$iv":Landroidx/compose/runtime/snapshots/StateObject;
    const/4 v3, 0x0
    ...
    .line 513
    .local v4, "snapshot$iv":Ljava/lang/Object;
    const/4 v5, 0x0
    ...
    .line 516
    .local v8, "$i$a$-sync-SnapshotKt$writable$3$iv":I
    :try_start_0
    ...
    .line 515
    .end local v8    # "$i$a$-sync-SnapshotKt$writable$3$iv":I
    monitor-exit v6
    ...
    .line 519
    .local v6, "$i$a$-also-SnapshotKt$writable$4$iv":I
    ...
    .end local v6    # "$i$a$-also-SnapshotKt$writable$4$iv":I
    nop

    .line 111
    .end local v1    # "$this$writable$iv":Landroidx/compose/runtime/snapshots/StateRecord;
    .end local v2    # "state$iv":Landroidx/compose/runtime/snapshots/StateObject;
    .end local v3    # "$i$f$writable":I
    .end local v4    # "snapshot$iv":Ljava/lang/Object;
    return-object v9

    .line 515
    .restart local v1    # "$this$writable$iv":Landroidx/compose/runtime/snapshots/StateRecord;
    .restart local v2    # "state$iv":Landroidx/compose/runtime/snapshots/StateObject;
    .restart local v3    # "$i$f$writable":I
    .restart local v4    # "snapshot$iv":Ljava/lang/Object;
    .local v5, "$i$f$sync":I
    .local v6, "lock$iv$iv$iv":Ljava/lang/Object;
