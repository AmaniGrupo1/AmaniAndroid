...
.method public retainAll(Ljava/util/Collection;)Z
    ...
    .line 423
    .local v2, "$i$f$removeIf$runtime":I
    const/4 v0, 0x0
    ...
    .line 249
    .local v15, "$i$a$-removeIf$runtime-SnapshotMapEntrySet$retainAll$1":I
    ...
    .end local v2    # "$i$f$removeIf$runtime":I
    .local v17, "$i$f$removeIf$runtime":I
    ...
    .end local v17    # "$i$f$removeIf$runtime":I
    .restart local v2    # "$i$f$removeIf$runtime":I
    :cond_2
    move/from16 v17, v2

    .end local v2    # "$i$f$removeIf$runtime":I
    .restart local v17    # "$i$f$removeIf$runtime":I
    :goto_3
    const/4 v1, 0x1

    .line 440
    .end local v14    # "it":Ljava/util/Map$Entry;
    .end local v15    # "$i$a$-removeIf$runtime-SnapshotMapEntrySet$retainAll$1":I
    :goto_4
    if-eqz v1, :cond_3
    ...
    .local v13, "state$iv$iv$iv$iv":Landroidx/compose/runtime/snapshots/StateObject;
    const/4 v14, 0x0
    ...
    check-cast v21, Landroidx/compose/runtime/snapshots/SnapshotStateMap$StateMapStateRecord;
    ...
    .end local v13    # "state$iv$iv$iv$iv":Landroidx/compose/runtime/snapshots/StateObject;
    ...
    .restart local v13    # "state$iv$iv$iv$iv":Landroidx/compose/runtime/snapshots/StateObject;
