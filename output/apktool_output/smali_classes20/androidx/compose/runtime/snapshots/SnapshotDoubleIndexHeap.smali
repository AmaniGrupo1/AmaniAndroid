...
.method private final ensure(I)V
    ...
    invoke-static/range {v5 .. v11}, Lkotlin/collections/ArraysKt;->copyInto$default([J[JIIIILjava/lang/Object;)[J

    .line 228
    nop

    .line 172
    .end local v3    # "$i$f$copyInto":I
    .end local v5    # "$this$copyInto$iv":[J
...
.method private final shiftDown(I)V
    ...
    .local v5, "$this$compareTo$iv":J
    .local v7, "other$iv":J
    const/4 v9, 0x0

    .line 213
    .local v9, "$i$f$compareTo":I
    invoke-static {v5, v6, v7, v8}, Lkotlin/jvm/internal/Intrinsics;->compare(JJ)I

    move-result v5

    .line 132
    .end local v5    # "$this$compareTo$iv":J
    .end local v7    # "other$iv":J
    .end local v9    # "$i$f$compareTo":I
    if-gez v5, :cond_1
    ...
    .restart local v6    # "$this$get$iv":[J
    const/4 v7, 0x0
    ...
    .restart local v8    # "$this$get$iv":[J
    const/4 v9, 0x0
...
.method private final swap(II)V
    ...
    .end local v7    # "$this$set$iv":[J
    .end local v8    # "index$iv":I
    .end local v9    # "$i$f$set":I
    move-wide v5, v3

    .restart local v5    # "value$iv":J
    .restart local v7    # "$this$set$iv":[J
    move v8, p2
...
.method public final validate()V
    ...
    .line 92
    .end local v3    # "$this$get$iv":[J
    .end local v4    # "index$iv":I
    .end local v5    # "$i$f$get":I
    iget-object v3, p0, Landroidx/compose/runtime/snapshots/SnapshotDoubleIndexHeap;->values:[J

    .restart local v3    # "$this$get$iv":[J
    move v6, v0
...
.method public final validateHandle(IJ)V
    ...
    const-string v2, " but was supposed to be "
