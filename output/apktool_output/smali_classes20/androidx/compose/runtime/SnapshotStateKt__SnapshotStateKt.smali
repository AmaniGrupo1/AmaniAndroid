...
.method public static final varargs mutableStateListOf([Ljava/lang/Object;)Landroidx/compose/runtime/snapshots/SnapshotStateList;
    ...
    .line 343
    .local v1, "it":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    const/4 v2, 0x0

    .line 251
    .local v2, "$i$a$-also-SnapshotStateKt__SnapshotStateKt$mutableStateListOf$1":I
    ...
    .end local v1    # "it":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    .end local v2    # "$i$a$-also-SnapshotStateKt__SnapshotStateKt$mutableStateListOf$1":I
    return-object v0
.end method
...
.method public static final varargs mutableStateMapOf([Lkotlin/Pair;)Landroidx/compose/runtime/snapshots/SnapshotStateMap;
    ...
    .line 343
    .local v1, "$this$mutableStateMapOf_u24lambda_u240":Landroidx/compose/runtime/snapshots/SnapshotStateMap;
    const/4 v2, 0x0

    .line 281
    .local v2, "$i$a$-apply-SnapshotStateKt__SnapshotStateKt$mutableStateMapOf$1":I
    invoke-static {p0}, Lkotlin/collections/MapsKt;->toMap([Lkotlin/Pair;)Ljava/util/Map;

    move-result-object v3

    invoke-virtual {v1, v3}, Landroidx/compose/runtime/snapshots/SnapshotStateMap;->putAll(Ljava/util/Map;)V

    .end local v1    # "$this$mutableStateMapOf_u24lambda_u240":Landroidx/compose/runtime/snapshots/SnapshotStateMap;
    .end local v2    # "$i$a$-apply-SnapshotStateKt__SnapshotStateKt$mutableStateMapOf$1":I
    return-object v0
.end method
...
.method public static final varargs mutableStateSetOf([Ljava/lang/Object;)Landroidx/compose/runtime/snapshots/SnapshotStateSet;
    ...
    .line 343
    .local v1, "it":Landroidx/compose/runtime/snapshots/SnapshotStateSet;
    const/4 v2, 0x0

    .line 316
    .local v2, "$i$a$-also-SnapshotStateKt__SnapshotStateKt$mutableStateSetOf$1":I
    ...
    invoke-virtual {v1, v3}, Landroidx/compose/runtime/snapshots/SnapshotStateSet;->addAll(Ljava/util/Collection;)Z

    .end local v1    # "it":Landroidx/compose/runtime/snapshots/SnapshotStateSet;
    .end local v2    # "$i$a$-also-SnapshotStateKt__SnapshotStateKt$mutableStateSetOf$1":I
    return-object v0
.end method
...
.method public static final rememberUpdatedState(Ljava/lang/Object;Landroidx/compose/runtime/Composer;I)Landroidx/compose/runtime/State;
    ...
    const-string v1, "C(rememberUpdatedState)N(newValue)340@11995L37:SnapshotState.kt#9igjgp"
    ...
    const-string v2, "androidx.compose.runtime.rememberUpdatedState (SnapshotState.kt:340)"
    ...
    .line 341
    .local v5, "$i$a$-cache-SnapshotStateKt__SnapshotStateKt$rememberUpdatedState$1":I
    const/4 v6, 0x2
    ...
    .line 346
    .end local v5    # "$i$a$-cache-SnapshotStateKt__SnapshotStateKt$rememberUpdatedState$1":I
    nop
    ...
    .line 343
    .local v0, "$this$rememberUpdatedState_u24lambda_u241":Landroidx/compose/runtime/MutableState;
    const/4 v1, 0x0
    ...
    .end local v0    # "$this$rememberUpdatedState_u24lambda_u241":Landroidx/compose/runtime/MutableState;
...
.method public static final toMutableStateList(Ljava/util/Collection;)Landroidx/compose/runtime/snapshots/SnapshotStateList;
    ...
    .line 257
    .local v2, "$i$a$-also-SnapshotStateKt__SnapshotStateKt$toMutableStateList$1":I
    invoke-virtual {v1, p0}, Landroidx/compose/runtime/snapshots/SnapshotStateList;->addAll(Ljava/util/Collection;)Z

    .end local v1    # "it":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    .end local v2    # "$i$a$-also-SnapshotStateKt__SnapshotStateKt$toMutableStateList$1":I
    return-object v0
.end method
...
.method public static final toMutableStateMap(Ljava/lang/Iterable;)Landroidx/compose/runtime/snapshots/SnapshotStateMap;
    ...
    .line 343
    .local v1, "it":Landroidx/compose/runtime/snapshots/SnapshotStateMap;
    const/4 v2, 0x0

    .line 289
    .local v2, "$i$a$-also-SnapshotStateKt__SnapshotStateKt$toMutableStateMap$1":I
    ...
    .end local v1    # "it":Landroidx/compose/runtime/snapshots/SnapshotStateMap;
    .end local v2    # "$i$a$-also-SnapshotStateKt__SnapshotStateKt$toMutableStateMap$1":I
    return-object v0
.end method
