...
.method public static final add-impl(Landroidx/collection/MutableScatterMap;Ljava/lang/Object;Ljava/lang/Object;)V
    .locals 11
    .param p0, "$v$c$androidx-compose-runtime-collection-ScopeMap$-this$0"    # Landroidx/collection/MutableScatterMap;
    ...
    .line 37
    .local v9, "$i$a$-compute-ScopeMap$add$1":I
    nop
    ...
    .line 39
    :cond_2
    instance-of v10, v8, Landroidx/collection/MutableScatterSet;
    ...
    invoke-direct {v10, v5, v4, v7}, Landroidx/collection/MutableScatterSet;-><init>(IILkotlin/jvm/internal/DefaultConstructorMarker;)V

    .line 46
    .local v10, "set":Landroidx/collection/MutableScatterSet;
    const-string/jumbo v4, "null cannot be cast to non-null type Scope of androidx.compose.runtime.collection.ScopeMap"

    invoke-static {v8, v4}, Lkotlin/jvm/internal/Intrinsics;->checkNotNull(Ljava/lang/Object;Ljava/lang/String;)V

    invoke-virtual {v10, v8}, Landroidx/collection/MutableScatterSet;->add(Ljava/lang/Object;)Z

    .line 47
    invoke-virtual {v10, p2}, Landroidx/collection/MutableScatterSet;->add(Ljava/lang/Object;)Z

    .line 48
    nop

    .end local v10    # "set":Landroidx/collection/MutableScatterSet;
    goto :goto_3
    ...
    .end local v9    # "$i$a$-compute-ScopeMap$add$1":I
    nop

    .line 201
    .local v10, "computedValue$iv":Ljava/lang/Object;
    if-eqz v6, :cond_5
    ...
    iget-object v5, v1, Landroidx/collection/MutableScatterMap;->keys:[Ljava/lang/Object;
    ...
    .end local v6    # "inserting$iv":Z
    .end local v10    # "computedValue$iv":Ljava/lang/Object;
    return-void
.end method
...
.method public static final anyScopeOf-impl(Landroidx/collection/MutableScatterMap;Ljava/lang/Object;Lkotlin/jvm/functions/Function1;)Z
    ...
    .local v3, "$v$c$androidx-compose-runtime-collection-ScopeMap$-this$0$iv":Landroidx/collection/MutableScatterMap;
    const/4 v4, 0x0

    .line 234
    .local v4, "$i$f$forEachScopeOf-impl":I
    ...
    .line 81
    .local v25, "$i$a$-forEachScopeOf-impl-ScopeMap$anyScopeOf$1":I
    ...
    .end local v25    # "$i$a$-forEachScopeOf-impl-ScopeMap$anyScopeOf$1":I
    :cond_1
    nop
    ...
    .line 81
    .local v7, "$i$a$-forEachScopeOf-impl-ScopeMap$anyScopeOf$1":I
    ...
    .end local v7    # "$i$a$-forEachScopeOf-impl-ScopeMap$anyScopeOf$1":I
    :cond_9
    goto :goto_4
    ...
    .end local v3    # "$v$c$androidx-compose-runtime-collection-ScopeMap$-this$0$iv":Landroidx/collection/MutableScatterMap;
    .end local v4    # "$i$f$forEachScopeOf-impl":I
    return v21
.end method
...
.method public static final removeIf-impl(Landroidx/collection/MutableScatterMap;Lkotlin/jvm/functions/Function2;)V
    ...
    .local v15, "scopes":Ljava/lang/Object;
    const/16 v24, 0x0

    .line 140
    .local v24, "$i$a$-removeIf-ScopeMap$removeIf$1":I
    move/from16 v29, v12

    const-string/jumbo v12, "null cannot be cast to non-null type Key of androidx.compose.runtime.collection.ScopeMap"
    ...
    .local v12, "this_$iv":Landroidx/collection/MutableScatterSet;
    const/16 v30, 0x0
    ...
    .end local v1    # "$i$f$removeIf-impl":I
    .local v31, "$i$f$removeIf-impl":I
    ...
    .local v42, "this_$iv$iv":Landroidx/collection/ScatterMap;
    ...
    .line 144
    .local v45, "$i$a$-removeIf-ScopeMap$removeIf$1$1":I
    invoke-interface {v0, v14, v5}, Lkotlin/jvm/functions/Function2;->invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .end local v45    # "$i$a$-removeIf-ScopeMap$removeIf$1$1":I
    if-eqz v5, :cond_2

    .line 353
    invoke-virtual {v12, v10}, Landroidx/collection/MutableScatterSet;->removeElementAt(I)V
    ...
    .end local v42    # "this_$iv$iv":Landroidx/collection/ScatterMap;
    ...
    .restart local v42    # "this_$iv$iv":Landroidx/collection/ScatterMap;
    ...
    .line 145
    .end local v12    # "this_$iv":Landroidx/collection/MutableScatterSet;
    ...
    .line 148
    .end local v31    # "$i$f$removeIf-impl":I
    ...
    .end local v5    # "$i$f$forEachIndexed":I
    .end local v9    # "slot$iv$iv":J
    .restart local v31    # "$i$f$removeIf-impl":I
    ...
    .end local v15    # "scopes":Ljava/lang/Object;
    .end local v24    # "$i$a$-removeIf-ScopeMap$removeIf$1":I
    if-eqz v1, :cond_a
    ...
    .end local v42    # "this_$iv$iv":Landroidx/collection/ScatterMap;
    .end local v43    # "$i$f$forEachIndexed":I
    .restart local v1    # "$i$f$removeIf-impl":I
    .restart local v3    # "$i$f$removeIf":I
    .restart local v4    # "this_$iv$iv":Landroidx/collection/ScatterMap;
    .restart local v5    # "$i$f$forEachIndexed":I
    :cond_c
