...
.method public final readableHash(Landroidx/compose/runtime/DerivedState;Landroidx/compose/runtime/snapshots/Snapshot;)I
    ...
    .line 138
    .local v6, "dependencies":Landroidx/collection/ObjectIntMap;
    invoke-virtual {v6}, Landroidx/collection/ObjectIntMap;->isNotEmpty()Z
    ...
    .local v3, "derivedState$iv":Landroidx/compose/runtime/DerivedState;
    const/4 v4, 0x0
    ...
    invoke-interface {v11, v3}, Landroidx/compose/runtime/DerivedStateObserver;->start(Landroidx/compose/runtime/DerivedState;)V
    ...
    .end local v6    # "dependencies":Landroidx/collection/ObjectIntMap;
    .end local v7    # "this_$iv":Landroidx/collection/ObjectIntMap;
    .local v4, "$this$maskEmptyOrDeleted$iv$iv$iv":J
    .local v18, "dependencies":Landroidx/collection/ObjectIntMap;
    .local v19, "this_$iv":Landroidx/collection/ObjectIntMap;
    .local v21, "$i$f$notifyObservers":I
    .local v22, "observers$iv":Landroidx/compose/runtime/collection/MutableVector;
    not-long v6, v4
    ...
    .local v24, "stateObject":Landroidx/compose/runtime/snapshots/StateObject;
    move/from16 v27, v26

    .local v27, "readLevel":I
    move-object/from16 v26, v24

    .end local v24    # "stateObject":Landroidx/compose/runtime/snapshots/StateObject;
    .local v26, "stateObject":Landroidx/compose/runtime/snapshots/StateObject;
    const/16 v24, 0x0

    .line 141
    .local v24, "$i$a$-forEach-DerivedSnapshotState$ResultRecord$readableHash$1$1":I
    move/from16 v28, v0

    move/from16 v0, v27

    .end local v27    # "readLevel":I
    ...
    invoke-virtual {v0, v1}, Landroidx/compose/runtime/DerivedSnapshotState;->current(Landroidx/compose/runtime/snapshots/Snapshot;)Landroidx/compose/runtime/snapshots/StateRecord;
    ...
    .end local v24    # "$i$a$-forEach-DerivedSnapshotState$ResultRecord$readableHash$1$1":I
    .end local v26    # "readLevel":I
    ...
    .end local v18    # "dependencies":Landroidx/collection/ObjectIntMap;
    .end local v19    # "this_$iv":Landroidx/collection/ObjectIntMap;
    .end local v21    # "$i$f$notifyObservers":I
    .end local v22    # "observers$iv":Landroidx/compose/runtime/collection/MutableVector;
    .end local v28    # "$i$a$-notifyObservers-DerivedSnapshotState$ResultRecord$readableHash$1":I
    .restart local v0    # "$i$a$-notifyObservers-DerivedSnapshotState$ResultRecord$readableHash$1":I
    .local v4, "$i$f$notifyObservers":I
    .local v5, "observers$iv":Landroidx/compose/runtime/collection/MutableVector;
    ...
    .restart local v18    # "dependencies":Landroidx/collection/ObjectIntMap;
    .restart local v19    # "this_$iv":Landroidx/collection/ObjectIntMap;
    .restart local v21    # "$i$f$notifyObservers":I
    .restart local v22    # "observers$iv":Landroidx/compose/runtime/collection/MutableVector;
    .restart local v28    # "$i$a$-notifyObservers-DerivedSnapshotState$ResultRecord$readableHash$1":I
    :cond_8
    nop
    ...
    invoke-interface {v8, v3}, Landroidx/compose/runtime/DerivedStateObserver;->done(Landroidx/compose/runtime/DerivedState;)V
    ...
    invoke-interface {v9, v3}, Landroidx/compose/runtime/DerivedStateObserver;->done(Landroidx/compose/runtime/DerivedState;)V
    ...
    .line 138
    .end local v3    # "derivedState$iv":Landroidx/compose/runtime/DerivedState;
    .end local v18    # "dependencies":Landroidx/collection/ObjectIntMap;
    .end local v21    # "$i$f$notifyObservers":I
    .end local v22    # "observers$iv":Landroidx/compose/runtime/collection/MutableVector;
    .local v6, "dependencies":Landroidx/collection/ObjectIntMap;
