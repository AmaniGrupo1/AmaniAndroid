...
.method protected execute(Landroidx/compose/runtime/changelist/OperationArgContainer;Landroidx/compose/runtime/Applier;Landroidx/compose/runtime/SlotWriter;Landroidx/compose/runtime/RememberManager;Landroidx/compose/runtime/changelist/OperationErrorContext;)V
    ...
    .local v0, "this_$iv":Landroidx/compose/runtime/changelist/Operation$CopySlotTableToAnchorLocation;
    const/4 v1, 0x0

    .line 1159
    .local v1, "$i$f$getFrom-HpuvwBQ":I
    const/4 v2, 0x2
    ...
    .line 899
    .end local v0    # "this_$iv":Landroidx/compose/runtime/changelist/Operation$CopySlotTableToAnchorLocation;
    .end local v1    # "$i$f$getFrom-HpuvwBQ":I
    ...
    .line 900
    .local v0, "from":Landroidx/compose/runtime/MovableContentStateReference;
    move-object v1, p0

    .local v1, "this_$iv":Landroidx/compose/runtime/changelist/Operation$CopySlotTableToAnchorLocation;
    const/4 v3, 0x0

    .line 1160
    .local v3, "$i$f$getTo-HpuvwBQ":I
    const/4 v4, 0x3
    ...
    .line 900
    .end local v1    # "this_$iv":Landroidx/compose/runtime/changelist/Operation$CopySlotTableToAnchorLocation;
    .end local v3    # "$i$f$getTo-HpuvwBQ":I
    ...
    .local v3, "this_$iv":Landroidx/compose/runtime/changelist/Operation$CopySlotTableToAnchorLocation;
    const/4 v4, 0x0

    .line 1161
    .local v4, "$i$f$getParentCompositionContext-HpuvwBQ":I
    const/4 v5, 0x1
    ...
    .line 901
    .end local v3    # "this_$iv":Landroidx/compose/runtime/changelist/Operation$CopySlotTableToAnchorLocation;
    .end local v4    # "$i$f$getParentCompositionContext-HpuvwBQ":I
    ...
    .line 904
    .local v3, "parentCompositionContext":Landroidx/compose/runtime/CompositionContext;
    move-object v4, p0
    ...
    .line 1162
    .local v6, "$i$f$getResolvedState-HpuvwBQ":I
    const/4 v7, 0x0
    ...
    .end local v6    # "$i$f$getResolvedState-HpuvwBQ":I
    ...
    .line 905
    invoke-virtual {v3, v0}, Landroidx/compose/runtime/CompositionContext;->movableContentStateResolve$runtime(Landroidx/compose/runtime/MovableContentStateReference;)Landroidx/compose/runtime/MovableContentState;
    ...
    .line 913
    .local v4, "resolvedState":Landroidx/compose/runtime/MovableContentState;
    invoke-virtual {v4}, Landroidx/compose/runtime/MovableContentState;->getSlotTable$runtime()Landroidx/compose/runtime/SlotTable;

    move-result-object v6

    invoke-virtual {p3, v5, v6, v2}, Landroidx/compose/runtime/SlotWriter;->moveIntoGroupFrom(ILandroidx/compose/runtime/SlotTable;I)Ljava/util/List;

    move-result-object v2

    .line 917
    .local v2, "anchors":Ljava/util/List;
    sget-object v5, Landroidx/compose/runtime/RecomposeScopeImpl;->Companion:Landroidx/compose/runtime/RecomposeScopeImpl$Companion;
    ...
    check-cast v6, Landroidx/compose/runtime/RecomposeScopeOwner;

    .line 917
    invoke-virtual {v5, p3, v2, v6}, Landroidx/compose/runtime/RecomposeScopeImpl$Companion;->adoptAnchoredScopes$runtime(Landroidx/compose/runtime/SlotWriter;Ljava/util/List;Landroidx/compose/runtime/RecomposeScopeOwner;)V
...
.method public final getFrom-HpuvwBQ()I
    ...
    .line 879
    .local v0, "$i$f$getFrom-HpuvwBQ":I
    const/4 v1, 0x2
...
.method public final getResolvedState-HpuvwBQ()I
    ...
    .line 873
    .local v0, "$i$f$getResolvedState-HpuvwBQ":I
    const/4 v1, 0x0
...
.method public objectParamName-31yXWZQ(I)Ljava/lang/String;
    ...
    .line 1155
    .local v1, "$i$f$getResolvedState-HpuvwBQ":I
    const/4 v2, 0x0
    ...
    .line 886
    .end local v0    # "this_$iv":Landroidx/compose/runtime/changelist/Operation$CopySlotTableToAnchorLocation;
    .end local v1    # "$i$f$getResolvedState-HpuvwBQ":I
    ...
    .restart local v0    # "this_$iv":Landroidx/compose/runtime/changelist/Operation$CopySlotTableToAnchorLocation;
    const/4 v1, 0x0
    ...
    .line 889
    .end local v0    # "this_$iv":Landroidx/compose/runtime/changelist/Operation$CopySlotTableToAnchorLocation;
    .end local v1    # "$i$f$getTo-HpuvwBQ":I
    invoke-static {p1, v0}, Landroidx/compose/runtime/changelist/Operation$ObjectParameter;->equals-impl0(II)Z
