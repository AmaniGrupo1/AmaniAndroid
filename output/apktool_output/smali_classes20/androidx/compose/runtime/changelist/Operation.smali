...
.method public final executeWithComposeStackTrace(Landroidx/compose/runtime/changelist/OperationArgContainer;Landroidx/compose/runtime/Applier;Landroidx/compose/runtime/SlotWriter;Landroidx/compose/runtime/RememberManager;Landroidx/compose/runtime/changelist/OperationErrorContext;)V
    .locals 6
    .param p1, "$this$executeWithComposeStackTrace"    # Landroidx/compose/runtime/changelist/OperationArgContainer;
    ...
    .local v0, "location$iv":Landroidx/compose/runtime/Anchor;
    move-object v1, p5

    .local v1, "errorContext$iv":Landroidx/compose/runtime/changelist/OperationErrorContext;
    move-object v2, v0

    .end local v0    # "location$iv":Landroidx/compose/runtime/Anchor;
    .local v2, "location$iv":Landroidx/compose/runtime/Anchor;
    move-object v3, p3
    ...
    .line 1155
    .local v4, "$i$f$withCurrentStackTrace":I
    nop
    ...
    .line 63
    .local v0, "$i$a$-withCurrentStackTrace-Operation$executeWithComposeStackTrace$1":I
    :try_start_0
    ...
    .line 1156
    .end local v0    # "$i$a$-withCurrentStackTrace-Operation$executeWithComposeStackTrace$1":I
    nop
    ...
    .line 65
    .end local v1    # "errorContext$iv":Landroidx/compose/runtime/changelist/OperationErrorContext;
    .end local v2    # "location$iv":Landroidx/compose/runtime/Anchor;
    .end local v3    # "writer$iv":Landroidx/compose/runtime/SlotWriter;
    .end local v4    # "$i$f$withCurrentStackTrace":I
    return-void

    .line 1157
    .restart local v1    # "errorContext$iv":Landroidx/compose/runtime/changelist/OperationErrorContext;
    .restart local v2    # "location$iv":Landroidx/compose/runtime/Anchor;
    .restart local v3    # "writer$iv":Landroidx/compose/runtime/SlotWriter;
    .restart local v4    # "$i$f$withCurrentStackTrace":I
    :catchall_0
    move-exception v0

    .line 1158
    .local v0, "e$iv":Ljava/lang/Throwable;
    invoke-static {v0, v1, v3, v2}, Landroidx/compose/runtime/changelist/OperationKt;->access$attachComposeStackTrace(Ljava/lang/Throwable;Landroidx/compose/runtime/changelist/OperationErrorContext;Landroidx/compose/runtime/SlotWriter;Landroidx/compose/runtime/Anchor;)Ljava/lang/Throwable;
