...
.method public add(ILjava/lang/Object;)Landroidx/compose/runtime/external/kotlinx/collections/immutable/PersistentList;
    ...
    .line 110
    .local p1, "root":[Ljava/lang/Object;
    iget-object v0, p0, Landroidx/compose/runtime/external/kotlinx/collections/immutable/implementations/immutableList/SmallPersistentVector;->buffer:[Ljava/lang/Object;
    ...
    invoke-direct {v1, p1, v0, v2, v3}, Landroidx/compose/runtime/external/kotlinx/collections/immutable/implementations/immutableList/PersistentVector;-><init>([Ljava/lang/Object;[Ljava/lang/Object;II)V
...
.method public addAll(ILjava/util/Collection;)Landroidx/compose/runtime/external/kotlinx/collections/immutable/PersistentList;
    ...
    .local p1, "$this$mutate$iv":Landroidx/compose/runtime/external/kotlinx/collections/immutable/PersistentList;
    const/4 v0, 0x0
    ...
    .line 91
    .local v3, "$i$a$-mutate-SmallPersistentVector$addAll$2":I
    invoke-interface {v2, v5, p2}, Ljava/util/List;->addAll(ILjava/util/Collection;)Z

    .line 163
    .end local v2    # "it":Ljava/util/List;
    .end local v3    # "$i$a$-mutate-SmallPersistentVector$addAll$2":I
    ...
    .line 91
    .end local v0    # "$i$f$mutate":I
    .end local p1    # "$this$mutate$iv":Landroidx/compose/runtime/external/kotlinx/collections/immutable/PersistentList;
    return-object p1
.end method
...
.method public removeAll(Lkotlin/jvm/functions/Function1;)Landroidx/compose/runtime/external/kotlinx/collections/immutable/PersistentList;
    ...
    .line 64
    .end local v0    # "newBuffer":[Ljava/lang/Object;
    .local v6, "newBuffer":[Ljava/lang/Object;
    move v0, v3
    ...
    .end local v2    # "anyRemoved":Z
    .local v1, "anyRemoved":Z
    goto :goto_1

    .line 68
    .end local v6    # "newBuffer":[Ljava/lang/Object;
    .local v0, "newBuffer":[Ljava/lang/Object;
    .local v1, "newSize":I
    .restart local v2    # "anyRemoved":Z
    :cond_0
    if-eqz v2, :cond_1
