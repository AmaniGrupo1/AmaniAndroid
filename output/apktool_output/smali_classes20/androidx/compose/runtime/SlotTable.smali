...
.method private final emitGroup(Ljava/lang/StringBuilder;II)I
    ...
    .restart local v4    # "address$iv":I
    const/4 v5, 0x0

    .line 4221
    .local v5, "$i$f$hasMark":I
    mul-int/lit8 v6, v4, 0x5
    ...
    .end local v4    # "address$iv":I
    .end local v5    # "$i$f$containsMark":I
    :goto_2
    if-eqz v3, :cond_7
    ...
    .local v7, "address$iv":I
    const/4 v8, 0x0

    .line 4223
    .local v8, "$i$f$hasObjectKey":I
    ...
    .end local v7    # "address$iv":I
    .end local v8    # "$i$f$hasObjectKey":I
    :goto_4
    if-eqz v5, :cond_a
    ...
    .restart local v7    # "address$iv":I
    const/4 v8, 0x0

    .line 4224
    .local v8, "$i$f$isNode":I
    mul-int/lit8 v9, v7, 0x5
    ...
    .local v9, "address$iv":I
    const/4 v10, 0x0

    .line 4225
    .local v10, "$i$f$nodeIndex":I
    ...
    .end local v9    # "address$iv":I
    .end local v10    # "$i$f$nodeIndex":I
    aget-object v7, v7, v8
...
.method private static final verifyWellFormed$validateGroup(Lkotlin/jvm/internal/Ref$IntRef;Landroidx/compose/runtime/SlotTable;II)I
    ...
    .local v5, "address$iv":I
    const/4 v6, 0x0

    .line 4230
    .local v6, "$i$f$parentAnchor":I
    ...
    .end local v5    # "address$iv":I
    .end local v6    # "$i$f$parentAnchor":I
    nop
    ...
    .local v10, "address$iv":I
    const/4 v11, 0x0

    .line 4243
    .local v11, "$i$f$dataAnchor":I
    ...
    .end local v10    # "address$iv":I
    .end local v11    # "$i$f$dataAnchor":I
    nop
    ...
    .end local v14    # "$i$f$hasObjectKey":I
    :goto_8
    nop
    ...
    .restart local v13    # "address$iv":I
    const/4 v14, 0x0

    .line 4259
    .local v14, "$i$f$hasAux":I
    mul-int/lit8 v16, v13, 0x5
    ...
    const-string v15, "Not enough slots added for group "
    ...
    .local v14, "address$iv":I
    const/4 v15, 0x0

    .line 4265
    .local v15, "$i$f$nodeIndex":I
    ...
    .end local v14    # "address$iv":I
    .end local v15    # "$i$f$nodeIndex":I
    ...
    .line 4279
    .local v5, "$i$f$containsAnyMark":I
    mul-int/lit8 v6, v4, 0x5
    ...
    .end local v4    # "address$iv":I
    .end local v5    # "$i$f$containsAnyMark":I
    :goto_15
    if-eqz v0, :cond_20
...
.method public final invalidateGroupsWithKey$runtime(I)Ljava/util/List;
    ...
    :try_start_0
    invoke-static/range {v2 .. v7}, Landroidx/compose/runtime/SlotTable;->invalidateGroupsWithKey$lambda$2$scanGroup(Landroidx/compose/runtime/SlotReader;Landroidx/collection/MutableIntSet;Ljava/util/List;Lkotlin/jvm/internal/Ref$BooleanRef;Landroidx/compose/runtime/SlotTable;Ljava/util/List;)V
