...
.method public static final varargs getDeclaredComposableMethod(Ljava/lang/Class;Ljava/lang/String;[Ljava/lang/Class;)Landroidx/compose/runtime/reflect/ComposableMethod;
    ...
    .local v10, "$this$map$iv$iv":Ljava/lang/Iterable;
    const/4 v11, 0x0
    ...
    .end local v10    # "$this$map$iv$iv":Ljava/lang/Iterable;
    ...
    .local v12, "$this$toTypedArray$iv$iv":Ljava/util/Collection;
    const/4 v10, 0x0
    ...
    .end local v12    # "$this$toTypedArray$iv$iv":Ljava/util/Collection;
    nop

    .line 187
    .end local v7    # "$this$dup$iv":Ljava/lang/Object;
    .end local v8    # "count$iv":I
    .end local v9    # "$i$f$dup":I
    nop

    .line 185
    invoke-virtual {v0, v13}, Lkotlin/jvm/internal/SpreadBuilder;->addSpread(Ljava/lang/Object;)V
    ...
    .local v12, "$this$map$iv$iv":Ljava/lang/Iterable;
    const/4 v13, 0x0
    ...
    .local v15, "$this$mapTo$iv$iv$iv":Ljava/lang/Iterable;
    const/16 v16, 0x0
    ...
    .line 226
    .local v20, "$i$a$-map-ComposableMethodKt$dup$1$iv":I
    nop

    .line 229
    .end local v19    # "it$iv":I
    .end local v20    # "$i$a$-map-ComposableMethodKt$dup$1$iv":I
    invoke-interface {v14, v9}, Ljava/util/Collection;->add(Ljava/lang/Object;)Z

    goto :goto_1

    .line 230
    .end local v18    # "item$iv$iv$iv":I
    :cond_1
    nop

    .end local v14    # "destination$iv$iv$iv":Ljava/util/Collection;
    .end local v15    # "$this$mapTo$iv$iv$iv":Ljava/lang/Iterable;
    ...
    .end local v12    # "$this$map$iv$iv":Ljava/lang/Iterable;
    ...
    .local v14, "$this$toTypedArray$iv$iv":Ljava/util/Collection;
    const/4 v12, 0x0
    ...
    .end local v14    # "$this$toTypedArray$iv$iv":Ljava/util/Collection;
    nop

    .line 196
    .end local v9    # "$this$dup$iv":Ljava/lang/Object;
    .end local v10    # "count$iv":I
    .end local v11    # "$i$f$dup":I
    nop

    .line 194
    invoke-virtual {v0, v15}, Lkotlin/jvm/internal/SpreadBuilder;->addSpread(Ljava/lang/Object;)V
    ...
    .restart local v10    # "count$iv":I
    const/4 v11, 0x0

    .line 233
    .restart local v11    # "$i$f$dup":I
    invoke-static {v4, v10}, Lkotlin/ranges/RangesKt;->until(II)Lkotlin/ranges/IntRange;
