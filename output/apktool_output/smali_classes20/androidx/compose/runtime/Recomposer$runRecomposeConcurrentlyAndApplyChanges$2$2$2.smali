...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {v0, v1, v2}, Landroidx/compose/runtime/Recomposer;->access$performRecompose(Landroidx/compose/runtime/Recomposer;Landroidx/compose/runtime/ControlledComposition;Landroidx/collection/MutableScatterSet;)Landroidx/compose/runtime/ControlledComposition;

    move-result-object v0

    .line 1023
    .local v0, "changedComposition":Landroidx/compose/runtime/ControlledComposition;
    nop
    ...
    iget-object v2, p0, Landroidx/compose/runtime/Recomposer$runRecomposeConcurrentlyAndApplyChanges$2$2$2;->this$0:Landroidx/compose/runtime/Recomposer;
    ...
    .line 1019
    .local v4, "$i$a$-synchronized-Recomposer$runRecomposeConcurrentlyAndApplyChanges$2$2$2$1":I
    if-eqz v0, :cond_0
    ...
    .line 1019
    .local v5, "$i$a$-let-Recomposer$runRecomposeConcurrentlyAndApplyChanges$2$2$2$1$1":I
    :try_start_0
    invoke-static {v2}, Landroidx/compose/runtime/Recomposer;->access$getCompositionsAwaitingApply$p(Landroidx/compose/runtime/Recomposer;)Ljava/util/List;
    ...
    .end local v5    # "$i$a$-let-Recomposer$runRecomposeConcurrentlyAndApplyChanges$2$2$2$1$1":I
    goto :goto_0

    .line 1945
    .end local v4    # "$i$a$-synchronized-Recomposer$runRecomposeConcurrentlyAndApplyChanges$2$2$2$1":I
    :catchall_0
    move-exception v0
    ...
    .line 1020
    .restart local v4    # "$i$a$-synchronized-Recomposer$runRecomposeConcurrentlyAndApplyChanges$2$2$2$1":I
    :cond_0
    :goto_0
    invoke-static {v2}, Landroidx/compose/runtime/Recomposer;->access$getConcurrentCompositionsOutstanding$p(Landroidx/compose/runtime/Recomposer;)I

    move-result v0

    add-int/lit8 v0, v0, -0x1

    invoke-static {v2, v0}, Landroidx/compose/runtime/Recomposer;->access$setConcurrentCompositionsOutstanding$p(Landroidx/compose/runtime/Recomposer;I)V
