...
.method static constructor <clinit>()V
    ...
    sput v0, Landroidx/compose/foundation/gestures/Scrollable2DNode;->$stable:I
...
.method public constructor <init>(Landroidx/compose/foundation/gestures/Scrollable2DState;Landroidx/compose/foundation/OverscrollEffect;Landroidx/compose/foundation/gestures/FlingBehavior;ZLandroidx/compose/foundation/interaction/MutableInteractionSource;)V
    ...
    iput-object v0, p0, Landroidx/compose/foundation/gestures/Scrollable2DNode;->nestedScrollDispatcher:Landroidx/compose/ui/input/nestedscroll/NestedScrollDispatcher;

    .line 161
    new-instance v0, Landroidx/compose/foundation/gestures/ScrollableContainerNode;

    invoke-direct {v0, p4}, Landroidx/compose/foundation/gestures/ScrollableContainerNode;-><init>(Z)V

    check-cast v0, Landroidx/compose/ui/node/DelegatableNode;

    invoke-virtual {p0, v0}, Landroidx/compose/foundation/gestures/Scrollable2DNode;->delegate(Landroidx/compose/ui/node/DelegatableNode;)Landroidx/compose/ui/node/DelegatableNode;

    move-result-object v0

    check-cast v0, Landroidx/compose/foundation/gestures/ScrollableContainerNode;

    iput-object v0, p0, Landroidx/compose/foundation/gestures/Scrollable2DNode;->scrollableContainerNode:Landroidx/compose/foundation/gestures/ScrollableContainerNode;
    ...
    invoke-direct {v0, v2, v1, v3, v1}, Landroidx/compose/foundation/gestures/DefaultFlingBehavior;-><init>(Landroidx/compose/animation/core/DecayAnimationSpec;Landroidx/compose/ui/MotionDurationScale;ILkotlin/jvm/internal/DefaultConstructorMarker;)V

    iput-object v0, p0, Landroidx/compose/foundation/gestures/Scrollable2DNode;->defaultFlingBehavior:Landroidx/compose/foundation/gestures/DefaultFlingBehavior;

    .line 167
    new-instance v4, Landroidx/compose/foundation/gestures/ScrollingLogic2D;

    .line 168
    nop

    .line 169
    iget-object v6, p0, Landroidx/compose/foundation/gestures/Scrollable2DNode;->overscrollEffect:Landroidx/compose/foundation/OverscrollEffect;

    .line 170
    iget-object v0, p0, Landroidx/compose/foundation/gestures/Scrollable2DNode;->flingBehavior:Landroidx/compose/foundation/gestures/FlingBehavior;

    if-nez v0, :cond_0

    iget-object v0, p0, Landroidx/compose/foundation/gestures/Scrollable2DNode;->defaultFlingBehavior:Landroidx/compose/foundation/gestures/DefaultFlingBehavior;
    ...
    .line 171
    iget-object v8, p0, Landroidx/compose/foundation/gestures/Scrollable2DNode;->nestedScrollDispatcher:Landroidx/compose/ui/input/nestedscroll/NestedScrollDispatcher;

    .line 172
    new-instance v9, Landroidx/compose/foundation/gestures/Scrollable2DNode$$ExternalSyntheticLambda1;

    invoke-direct {v9, p0}, Landroidx/compose/foundation/gestures/Scrollable2DNode$$ExternalSyntheticLambda1;-><init>(Landroidx/compose/foundation/gestures/Scrollable2DNode;)V

    .line 167
    move-object v5, p1

    .end local p1    # "state":Landroidx/compose/foundation/gestures/Scrollable2DState;
    .local v5, "state":Landroidx/compose/foundation/gestures/Scrollable2DState;
    invoke-direct/range {v4 .. v9}, Landroidx/compose/foundation/gestures/ScrollingLogic2D;-><init>(Landroidx/compose/foundation/gestures/Scrollable2DState;Landroidx/compose/foundation/OverscrollEffect;Landroidx/compose/foundation/gestures/FlingBehavior;Landroidx/compose/ui/input/nestedscroll/NestedScrollDispatcher;Lkotlin/jvm/functions/Function0;)V

    iput-object v4, p0, Landroidx/compose/foundation/gestures/Scrollable2DNode;->scrollingLogic:Landroidx/compose/foundation/gestures/ScrollingLogic2D;

    .line 176
    iget-object p1, p0, Landroidx/compose/foundation/gestures/Scrollable2DNode;->scrollingLogic:Landroidx/compose/foundation/gestures/ScrollingLogic2D;

    new-instance v0, Landroidx/compose/foundation/gestures/ScrollableNestedScrollConnection;

    check-cast p1, Landroidx/compose/foundation/gestures/ScrollLogic;

    invoke-direct {v0, p1, p4}, Landroidx/compose/foundation/gestures/ScrollableNestedScrollConnection;-><init>(Landroidx/compose/foundation/gestures/ScrollLogic;Z)V

    iput-object v0, p0, Landroidx/compose/foundation/gestures/Scrollable2DNode;->nestedScrollConnection:Landroidx/compose/foundation/gestures/ScrollableNestedScrollConnection;

    .line 181
    nop

    .line 183
    iget-object p1, p0, Landroidx/compose/foundation/gestures/Scrollable2DNode;->nestedScrollConnection:Landroidx/compose/foundation/gestures/ScrollableNestedScrollConnection;
    ...
    invoke-static {p1, v0}, Landroidx/compose/ui/input/nestedscroll/NestedScrollNodeKt;->nestedScrollModifierNode(Landroidx/compose/ui/input/nestedscroll/NestedScrollConnection;Landroidx/compose/ui/input/nestedscroll/NestedScrollDispatcher;)Landroidx/compose/ui/node/DelegatableNode;
...
.method public static final synthetic access$getScrollingLogic$p(Landroidx/compose/foundation/gestures/Scrollable2DNode;)Landroidx/compose/foundation/gestures/ScrollingLogic2D;
    .locals 1
    .param p0, "$this"    # Landroidx/compose/foundation/gestures/Scrollable2DNode;
...
.method static final scrollingLogic$lambda$0(Landroidx/compose/foundation/gestures/Scrollable2DNode;)Z
    .locals 1
    .param p0, "this$0"    # Landroidx/compose/foundation/gestures/Scrollable2DNode;
...
.method public applySemantics(Landroidx/compose/ui/semantics/SemanticsPropertyReceiver;)V
    ...
    .line 278
    .local v1, "$i$a$-let-Scrollable2DNode$applySemantics$1":I
    const/4 v2, 0x1
    ...
    .end local v1    # "$i$a$-let-Scrollable2DNode$applySemantics$1":I
    :cond_2
    iget-object v0, p0, Landroidx/compose/foundation/gestures/Scrollable2DNode;->scrollByOffsetAction:Lkotlin/jvm/functions/Function2;
    ...
    .line 280
    .local v1, "$i$a$-let-Scrollable2DNode$applySemantics$2":I
    ...
    .line 281
    .end local v0    # "it":Lkotlin/jvm/functions/Function2;
    .end local v1    # "$i$a$-let-Scrollable2DNode$applySemantics$2":I
    :cond_3
    return-void
.end method
...
.method public drag(Lkotlin/jvm/functions/Function2;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    .local v0, "$this$drag_u24lambda_u240":Landroidx/compose/foundation/gestures/ScrollingLogic2D;
    const/4 v1, 0x0

    .line 190
    .local v1, "$i$a$-with-Scrollable2DNode$drag$2":I
    sget-object v2, Landroidx/compose/foundation/MutatePriority;->UserInput:Landroidx/compose/foundation/MutatePriority;

    new-instance v3, Landroidx/compose/foundation/gestures/Scrollable2DNode$drag$2$1;

    const/4 v4, 0x0

    invoke-direct {v3, p1, v4}, Landroidx/compose/foundation/gestures/Scrollable2DNode$drag$2$1;-><init>(Lkotlin/jvm/functions/Function2;Lkotlin/coroutines/Continuation;)V

    check-cast v3, Lkotlin/jvm/functions/Function2;

    invoke-virtual {v0, v2, v3, p2}, Landroidx/compose/foundation/gestures/ScrollingLogic2D;->scroll(Landroidx/compose/foundation/MutatePriority;Lkotlin/jvm/functions/Function2;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    .line 189
    .end local v0    # "$this$drag_u24lambda_u240":Landroidx/compose/foundation/gestures/ScrollingLogic2D;
    .end local v1    # "$i$a$-with-Scrollable2DNode$drag$2":I
    nop
...
.method public onPointerEvent-H0pRuoY(Landroidx/compose/ui/input/pointer/PointerEvent;Landroidx/compose/ui/input/pointer/PointerEventPass;J)V
    ...
    .line 268
    .local v10, "$i$a$-fastAny-Scrollable2DNode$onPointerEvent$1":I
    ...
    invoke-static {v12}, Landroidx/compose/ui/input/pointer/PointerType;->box-impl(I)Landroidx/compose/ui/input/pointer/PointerType;
    ...
    .end local v10    # "$i$a$-fastAny-Scrollable2DNode$onPointerEvent$1":I
    if-eqz v9, :cond_0
...
.method public final update(Landroidx/compose/foundation/gestures/Scrollable2DState;Landroidx/compose/foundation/OverscrollEffect;ZLandroidx/compose/foundation/gestures/FlingBehavior;Landroidx/compose/foundation/interaction/MutableInteractionSource;)V
    ...
    .line 216
    .local v1, "shouldInvalidateSemantics":Z
    invoke-virtual {p0}, Landroidx/compose/foundation/gestures/Scrollable2DNode;->getEnabled()Z
    ...
    .line 217
    iget-object v2, p0, Landroidx/compose/foundation/gestures/Scrollable2DNode;->nestedScrollConnection:Landroidx/compose/foundation/gestures/ScrollableNestedScrollConnection;

    invoke-virtual {v2, p3}, Landroidx/compose/foundation/gestures/ScrollableNestedScrollConnection;->setEnabled(Z)V

    .line 218
    iget-object v2, p0, Landroidx/compose/foundation/gestures/Scrollable2DNode;->scrollableContainerNode:Landroidx/compose/foundation/gestures/ScrollableContainerNode;

    invoke-virtual {v2, p3}, Landroidx/compose/foundation/gestures/ScrollableContainerNode;->update(Z)V
    ...
    iget-object v2, p0, Landroidx/compose/foundation/gestures/Scrollable2DNode;->defaultFlingBehavior:Landroidx/compose/foundation/gestures/DefaultFlingBehavior;
    ...
    .line 225
    .local v2, "resolvedFlingBehavior":Landroidx/compose/foundation/gestures/FlingBehavior;
    :goto_0
    iget-object v3, p0, Landroidx/compose/foundation/gestures/Scrollable2DNode;->scrollingLogic:Landroidx/compose/foundation/gestures/ScrollingLogic2D;
    ...
    .line 229
    iget-object v4, p0, Landroidx/compose/foundation/gestures/Scrollable2DNode;->nestedScrollDispatcher:Landroidx/compose/ui/input/nestedscroll/NestedScrollDispatcher;

    .line 225
    invoke-virtual {v3, p1, p2, v2, v4}, Landroidx/compose/foundation/gestures/ScrollingLogic2D;->update(Landroidx/compose/foundation/gestures/Scrollable2DState;Landroidx/compose/foundation/OverscrollEffect;Landroidx/compose/foundation/gestures/FlingBehavior;Landroidx/compose/ui/input/nestedscroll/NestedScrollDispatcher;)Z
    ...
    .line 232
    iput-object v0, p0, Landroidx/compose/foundation/gestures/Scrollable2DNode;->flingBehavior:Landroidx/compose/foundation/gestures/FlingBehavior;
    ...
    invoke-static/range {v4 .. v11}, Landroidx/compose/foundation/gestures/DragGestureNode;->update$default(Landroidx/compose/foundation/gestures/DragGestureNode;Lkotlin/jvm/functions/Function1;ZLandroidx/compose/foundation/interaction/MutableInteractionSource;Landroidx/compose/foundation/gestures/Orientation;ZILjava/lang/Object;)V
    ...
    invoke-static {v3}, Landroidx/compose/ui/node/SemanticsModifierNodeKt;->invalidateSemantics(Landroidx/compose/ui/node/SemanticsModifierNode;)V
