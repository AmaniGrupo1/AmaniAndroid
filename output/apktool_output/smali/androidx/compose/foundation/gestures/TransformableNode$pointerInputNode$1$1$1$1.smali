...
.method public final invoke(Landroidx/compose/foundation/gestures/TransformScope;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    check-cast v0, Landroidx/compose/foundation/gestures/TransformableNode$pointerInputNode$1$1$1$1;

    sget-object v1, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;

    invoke-virtual {v0, v1}, Landroidx/compose/foundation/gestures/TransformableNode$pointerInputNode$1$1$1$1;->invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .end local p0    # "this":Landroidx/compose/foundation/gestures/TransformableNode$pointerInputNode$1$1$1$1;
    ...
    .restart local p0    # "this":Landroidx/compose/foundation/gestures/TransformableNode$pointerInputNode$1$1$1$1;
    ...
    .local v2, "$this$transform":Landroidx/compose/foundation/gestures/TransformScope;
    ...
    .end local v2    # "$this$transform":Landroidx/compose/foundation/gestures/TransformScope;
    .end local p1    # "$result":Ljava/lang/Object;
    :pswitch_1
    invoke-static {p1}, Lkotlin/ResultKt;->throwOnFailure(Ljava/lang/Object;)V

    .restart local p1    # "$result":Ljava/lang/Object;
    iget-object v1, p0, Landroidx/compose/foundation/gestures/TransformableNode$pointerInputNode$1$1$1$1;->L$0:Ljava/lang/Object;
    ...
    .line 179
    .end local p0    # "this":Landroidx/compose/foundation/gestures/TransformableNode$pointerInputNode$1$1$1$1;
    .local v1, "this":Landroidx/compose/foundation/gestures/TransformableNode$pointerInputNode$1$1$1$1;
    .restart local v2    # "$this$transform":Landroidx/compose/foundation/gestures/TransformScope;
    :goto_0
    iget-object v3, v1, Landroidx/compose/foundation/gestures/TransformableNode$pointerInputNode$1$1$1$1;->$event:Lkotlin/jvm/internal/Ref$ObjectRef;

    iget-object v3, v3, Lkotlin/jvm/internal/Ref$ObjectRef;->element:Ljava/lang/Object;

    instance-of v3, v3, Landroidx/compose/foundation/gestures/TransformEvent$TransformStopped;
    ...
    instance-of v4, v3, Landroidx/compose/foundation/gestures/TransformEvent$TransformDelta;

    if-eqz v4, :cond_0

    check-cast v3, Landroidx/compose/foundation/gestures/TransformEvent$TransformDelta;
    ...
    .local v3, "it":Landroidx/compose/foundation/gestures/TransformEvent$TransformDelta;
    const/4 v4, 0x0

    .line 181
    .local v4, "$i$a$-let-TransformableNode$pointerInputNode$1$1$1$1$1":I
    nop

    .line 182
    invoke-virtual {v3}, Landroidx/compose/foundation/gestures/TransformEvent$TransformDelta;->getZoomChange()F

    move-result v5

    .line 183
    invoke-virtual {v3}, Landroidx/compose/foundation/gestures/TransformEvent$TransformDelta;->getPanChange-F1C5BW0()J

    move-result-wide v6

    .line 184
    invoke-virtual {v3}, Landroidx/compose/foundation/gestures/TransformEvent$TransformDelta;->getRotationChange()F

    move-result v8

    .line 181
    invoke-interface {v2, v5, v6, v7, v8}, Landroidx/compose/foundation/gestures/TransformScope;->transformBy-d-4ec7I(FJF)V

    .line 186
    nop

    .line 180
    .end local v3    # "it":Landroidx/compose/foundation/gestures/TransformEvent$TransformDelta;
    .end local v4    # "$i$a$-let-TransformableNode$pointerInputNode$1$1$1$1$1":I
    nop
    ...
    iget-object v4, v1, Landroidx/compose/foundation/gestures/TransformableNode$pointerInputNode$1$1$1$1;->this$0:Landroidx/compose/foundation/gestures/TransformableNode;
    ...
    iput-object v2, v1, Landroidx/compose/foundation/gestures/TransformableNode$pointerInputNode$1$1$1$1;->L$0:Ljava/lang/Object;

    iput-object v3, v1, Landroidx/compose/foundation/gestures/TransformableNode$pointerInputNode$1$1$1$1;->L$1:Ljava/lang/Object;

    const/4 v6, 0x1

    iput v6, v1, Landroidx/compose/foundation/gestures/TransformableNode$pointerInputNode$1$1$1$1;->label:I
    ...
    .end local v1    # "this":Landroidx/compose/foundation/gestures/TransformableNode$pointerInputNode$1$1$1$1;
    .end local p1    # "$result":Ljava/lang/Object;
    .local v0, "$result":Ljava/lang/Object;
    .local v2, "this":Landroidx/compose/foundation/gestures/TransformableNode$pointerInputNode$1$1$1$1;
    ...
    .restart local v1    # "this":Landroidx/compose/foundation/gestures/TransformableNode$pointerInputNode$1$1$1$1;
    .local v2, "$this$transform":Landroidx/compose/foundation/gestures/TransformScope;
    .restart local p1    # "$result":Ljava/lang/Object;
    :cond_3
