...
.method public constructor <init>(Landroidx/compose/foundation/gestures/ScrollableState;Landroidx/compose/foundation/OverscrollEffect;Landroidx/compose/foundation/gestures/FlingBehavior;Landroidx/compose/foundation/gestures/Orientation;ZLandroidx/compose/ui/input/nestedscroll/NestedScrollDispatcher;Landroidx/compose/foundation/gestures/OnScrollChangedDispatcher;Lkotlin/jvm/functions/Function0;)V
    ...
    .param p7, "onScrollChangedDispatcher"    # Landroidx/compose/foundation/gestures/OnScrollChangedDispatcher;
    .param p8, "isScrollableNodeAttached"    # Lkotlin/jvm/functions/Function0;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Landroidx/compose/foundation/gestures/ScrollableState;",
    ...
    .line 778
    new-instance v0, Landroidx/compose/foundation/gestures/ScrollingLogic$$ExternalSyntheticLambda0;

    invoke-direct {v0, p0}, Landroidx/compose/foundation/gestures/ScrollingLogic$$ExternalSyntheticLambda0;-><init>(Landroidx/compose/foundation/gestures/ScrollingLogic;)V
...
.method private final performScroll-3eAAhYA(Landroidx/compose/foundation/gestures/ScrollScope;JI)J
    ...
    iget-object v4, v0, Landroidx/compose/foundation/gestures/ScrollingLogic;->onScrollChangedDispatcher:Landroidx/compose/foundation/gestures/OnScrollChangedDispatcher;

    invoke-interface {v4, v5, v6}, Landroidx/compose/foundation/gestures/OnScrollChangedDispatcher;->dispatchScrollDeltaInfo-k-4lQ0M(J)V
...
.method static final performScrollForOverscroll$lambda$0(Landroidx/compose/foundation/gestures/ScrollingLogic;Landroidx/compose/ui/geometry/Offset;)Landroidx/compose/ui/geometry/Offset;
    .locals 5
    .param p0, "this$0"    # Landroidx/compose/foundation/gestures/ScrollingLogic;
    ...
    .line 1164
    .local v0, "$this$performScrollForOverscroll_u24lambda_u240_u240":Landroidx/compose/foundation/gestures/ScrollScope;
    const/4 v1, 0x0

    .line 779
    .local v1, "$i$a$-with-ScrollingLogic$performScrollForOverscroll$1$1":I
    invoke-virtual {p1}, Landroidx/compose/ui/geometry/Offset;->unbox-impl()J

    move-result-wide v2

    iget v4, p0, Landroidx/compose/foundation/gestures/ScrollingLogic;->latestScrollSource:I

    invoke-direct {p0, v0, v2, v3, v4}, Landroidx/compose/foundation/gestures/ScrollingLogic;->performScroll-3eAAhYA(Landroidx/compose/foundation/gestures/ScrollScope;JI)J

    move-result-wide v0

    .end local v0    # "$this$performScrollForOverscroll_u24lambda_u240_u240":Landroidx/compose/foundation/gestures/ScrollScope;
    .end local v1    # "$i$a$-with-ScrollingLogic$performScrollForOverscroll$1$1":I
...
.method private final singleAxisVelocity-AH228Gc(J)J
    .locals 8
    .param p1, "$v$c$androidx-compose-ui-unit-Velocity$-$this$singleAxisVelocity$0"    # J
    ...
    .end local p1    # "$v$c$androidx-compose-ui-unit-Velocity$-$this$singleAxisVelocity$0":J
    .local v2, "$v$c$androidx-compose-ui-unit-Velocity$-$this$singleAxisVelocity$0":J
    ...
    .end local v2    # "$v$c$androidx-compose-ui-unit-Velocity$-$this$singleAxisVelocity$0":J
    .local v0, "$v$c$androidx-compose-ui-unit-Velocity$-$this$singleAxisVelocity$0":J
    goto :goto_0

    .end local v0    # "$v$c$androidx-compose-ui-unit-Velocity$-$this$singleAxisVelocity$0":J
    .restart local p1    # "$v$c$androidx-compose-ui-unit-Velocity$-$this$singleAxisVelocity$0":J
    :cond_0
    move-wide v0, p1

    .end local p1    # "$v$c$androidx-compose-ui-unit-Velocity$-$this$singleAxisVelocity$0":J
    .restart local v0    # "$v$c$androidx-compose-ui-unit-Velocity$-$this$singleAxisVelocity$0":J
    const/4 v4, 0x2
...
.method private final toFloat-TH1AsA0(J)F
    .locals 2
    .param p1, "$v$c$androidx-compose-ui-unit-Velocity$-$this$toFloat$0"    # J
...
.method private final update-QWom1Mo(JF)J
    .locals 8
    .param p1, "$v$c$androidx-compose-ui-unit-Velocity$-$this$update$0"    # J
    .param p3, "newValue"    # F
    ...
    .end local p1    # "$v$c$androidx-compose-ui-unit-Velocity$-$this$update$0":J
    .end local p3    # "newValue":F
    .local v2, "$v$c$androidx-compose-ui-unit-Velocity$-$this$update$0":J
    .local v4, "newValue":F
    invoke-static/range {v2 .. v7}, Landroidx/compose/ui/unit/Velocity;->copy-OhffZ5M$default(JFFILjava/lang/Object;)J
    ...
    .end local v2    # "$v$c$androidx-compose-ui-unit-Velocity$-$this$update$0":J
    .end local v4    # "newValue":F
    .local v0, "$v$c$androidx-compose-ui-unit-Velocity$-$this$update$0":J
    .local v3, "newValue":F
    goto :goto_0

    .end local v0    # "$v$c$androidx-compose-ui-unit-Velocity$-$this$update$0":J
    .end local v3    # "newValue":F
    .restart local p1    # "$v$c$androidx-compose-ui-unit-Velocity$-$this$update$0":J
    ...
    .end local p1    # "$v$c$androidx-compose-ui-unit-Velocity$-$this$update$0":J
    .end local p3    # "newValue":F
    .restart local v0    # "$v$c$androidx-compose-ui-unit-Velocity$-$this$update$0":J
...
.method public doFlingAnimation-QWom1Mo(JLkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    iget-object v2, v1, Landroidx/compose/foundation/gestures/ScrollingLogic$doFlingAnimation$1;->result:Ljava/lang/Object;
    ...
    .line 853
    iget v3, v1, Landroidx/compose/foundation/gestures/ScrollingLogic$doFlingAnimation$1;->label:I
    ...
    iget-object p2, v1, Landroidx/compose/foundation/gestures/ScrollingLogic$doFlingAnimation$1;->L$0:Ljava/lang/Object;
    ...
    .local v6, "this":Landroidx/compose/foundation/gestures/ScrollingLogic;
    move-wide v8, p1

    .line 854
    .local v8, "$v$c$androidx-compose-ui-unit-Velocity$-available$0":J
    new-instance v7, Lkotlin/jvm/internal/Ref$LongRef;

    invoke-direct {v7}, Lkotlin/jvm/internal/Ref$LongRef;-><init>()V

    .local v7, "result":Lkotlin/jvm/internal/Ref$LongRef;
    iput-wide v8, v7, Lkotlin/jvm/internal/Ref$LongRef;->element:J

    .line 855
    const/4 p1, 0x1

    iput-boolean p1, v6, Landroidx/compose/foundation/gestures/ScrollingLogic;->isFlinging:Z
    ...
    iput-object v7, v1, Landroidx/compose/foundation/gestures/ScrollingLogic$doFlingAnimation$1;->L$0:Ljava/lang/Object;

    iput p1, v1, Landroidx/compose/foundation/gestures/ScrollingLogic$doFlingAnimation$1;->label:I

    invoke-virtual {v6, p2, v5, v1}, Landroidx/compose/foundation/gestures/ScrollingLogic;->scroll(Landroidx/compose/foundation/MutatePriority;Lkotlin/jvm/functions/Function2;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;

    move-result-object p1
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_1

    .end local v8    # "$v$c$androidx-compose-ui-unit-Velocity$-available$0":J
    if-ne p1, v0, :cond_1

    .line 853
    .end local v6    # "this":Landroidx/compose/foundation/gestures/ScrollingLogic;
    return-object v0

    .line 857
    .restart local v6    # "this":Landroidx/compose/foundation/gestures/ScrollingLogic;
    :cond_1
    move-object p1, v6
    ...
    .line 897
    .end local v6    # "this":Landroidx/compose/foundation/gestures/ScrollingLogic;
    .end local v7    # "result":Lkotlin/jvm/internal/Ref$LongRef;
    ...
    :goto_1
    iput-boolean v4, p1, Landroidx/compose/foundation/gestures/ScrollingLogic;->isFlinging:Z
...
.method public final reverseIfNeeded-MK-Hz9U(J)J
    .locals 2
    .param p1, "$v$c$androidx-compose-ui-geometry-Offset$-$this$reverseIfNeeded$0"    # J
...
.method public final singleAxisOffset-MK-Hz9U(J)J
    .locals 8
    .param p1, "$v$c$androidx-compose-ui-geometry-Offset$-$this$singleAxisOffset$0"    # J
    ...
    .end local p1    # "$v$c$androidx-compose-ui-geometry-Offset$-$this$singleAxisOffset$0":J
    .local v2, "$v$c$androidx-compose-ui-geometry-Offset$-$this$singleAxisOffset$0":J
    ...
    .end local v2    # "$v$c$androidx-compose-ui-geometry-Offset$-$this$singleAxisOffset$0":J
    .local v0, "$v$c$androidx-compose-ui-geometry-Offset$-$this$singleAxisOffset$0":J
    goto :goto_0

    .end local v0    # "$v$c$androidx-compose-ui-geometry-Offset$-$this$singleAxisOffset$0":J
    .restart local p1    # "$v$c$androidx-compose-ui-geometry-Offset$-$this$singleAxisOffset$0":J
    :cond_0
    move-wide v0, p1

    .end local p1    # "$v$c$androidx-compose-ui-geometry-Offset$-$this$singleAxisOffset$0":J
    .restart local v0    # "$v$c$androidx-compose-ui-geometry-Offset$-$this$singleAxisOffset$0":J
    const/4 v4, 0x2
...
.method public final toOffset-tuRUvjQ(F)J
    ...
    iget-object v1, v0, Landroidx/compose/foundation/gestures/ScrollingLogic;->orientation:Landroidx/compose/foundation/gestures/Orientation;
...
.method public final toSingleAxisDeltaFromAngle-k-4lQ0M(J)F
    .locals 12
    .param p1, "$v$c$androidx-compose-ui-geometry-Offset$-$this$toSingleAxisDeltaFromAngle$0"    # J
