...
.method public scrollBy(F)F
    ...
    .line 442
    :cond_0
    new-instance v2, Landroidx/compose/foundation/gestures/FlingCancellationException;

    invoke-direct {v2}, Landroidx/compose/foundation/gestures/FlingCancellationException;-><init>()V
    ...
    :cond_1
    :goto_0
    iget-object v2, p0, Landroidx/compose/foundation/gestures/ScrollingLogic2D$doFlingAnimation$2$flingScope$1;->$nestedScrollScope:Landroidx/compose/foundation/gestures/NestedScrollScope;
    ...
    invoke-virtual {v3}, Landroidx/compose/ui/input/nestedscroll/NestedScrollSource$Companion;->getSideEffect-WNlRxjI()I

    move-result v3

    .line 446
    invoke-interface {v2, v0, v1, v3}, Landroidx/compose/foundation/gestures/NestedScrollScope;->scrollByWithOverscroll-OzD1aCk(JI)J
    ...
    .line 451
    .local v2, "consumedOffset":J
    invoke-static {v2, v3}, Landroidx/compose/foundation/gestures/ScrollingLogic2D;->access$doFlingAnimation_QWom1Mo$toMagnitudeFloat(J)F
