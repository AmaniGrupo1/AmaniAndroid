...
.method private static final SkippableItem-JVlU9Rs(Landroidx/compose/foundation/lazy/layout/LazyLayoutItemProvider;Ljava/lang/Object;ILjava/lang/Object;Landroidx/compose/runtime/Composer;I)V
    ...
    .param p1, "$v$c$androidx-compose-foundation-lazy-layout-StableValue$-saveableStateHolder$0"    # Ljava/lang/Object;
    .param p2, "index"    # I
    .param p3, "$v$c$androidx-compose-foundation-lazy-layout-StableValue$-key$0"    # Ljava/lang/Object;
    ...
    new-instance v2, Landroidx/compose/foundation/lazy/layout/LazyLayoutItemContentFactoryKt$$ExternalSyntheticLambda0;

    invoke-direct {v2, p0, p2, p3}, Landroidx/compose/foundation/lazy/layout/LazyLayoutItemContentFactoryKt$$ExternalSyntheticLambda0;-><init>(Landroidx/compose/foundation/lazy/layout/LazyLayoutItemProvider;ILjava/lang/Object;)V
    ...
    new-instance v2, Landroidx/compose/foundation/lazy/layout/LazyLayoutItemContentFactoryKt$$ExternalSyntheticLambda1;
    ...
    .end local p1    # "$v$c$androidx-compose-foundation-lazy-layout-StableValue$-saveableStateHolder$0":Ljava/lang/Object;
    .end local p2    # "index":I
    .end local p3    # "$v$c$androidx-compose-foundation-lazy-layout-StableValue$-key$0":Ljava/lang/Object;
    .end local p5    # "$changed":I
    .local v3, "itemProvider":Landroidx/compose/foundation/lazy/layout/LazyLayoutItemProvider;
    .local v4, "$v$c$androidx-compose-foundation-lazy-layout-StableValue$-saveableStateHolder$0":Ljava/lang/Object;
    .local v5, "index":I
    .local v6, "$v$c$androidx-compose-foundation-lazy-layout-StableValue$-key$0":Ljava/lang/Object;
    .local v7, "$changed":I
    invoke-direct/range {v2 .. v7}, Landroidx/compose/foundation/lazy/layout/LazyLayoutItemContentFactoryKt$$ExternalSyntheticLambda1;-><init>(Landroidx/compose/foundation/lazy/layout/LazyLayoutItemProvider;Ljava/lang/Object;ILjava/lang/Object;I)V
    ...
    .end local v4    # "$v$c$androidx-compose-foundation-lazy-layout-StableValue$-saveableStateHolder$0":Ljava/lang/Object;
    .end local v5    # "index":I
    .end local v6    # "$v$c$androidx-compose-foundation-lazy-layout-StableValue$-key$0":Ljava/lang/Object;
    .end local v7    # "$changed":I
    .restart local p0    # "itemProvider":Landroidx/compose/foundation/lazy/layout/LazyLayoutItemProvider;
    .restart local p1    # "$v$c$androidx-compose-foundation-lazy-layout-StableValue$-saveableStateHolder$0":Ljava/lang/Object;
    .restart local p2    # "index":I
    .restart local p3    # "$v$c$androidx-compose-foundation-lazy-layout-StableValue$-key$0":Ljava/lang/Object;
    ...
    .restart local v4    # "$v$c$androidx-compose-foundation-lazy-layout-StableValue$-saveableStateHolder$0":Ljava/lang/Object;
    .restart local v5    # "index":I
    .restart local v6    # "$v$c$androidx-compose-foundation-lazy-layout-StableValue$-key$0":Ljava/lang/Object;
    .restart local v7    # "$changed":I
    :goto_6
    return-void
.end method

.method static final SkippableItem_JVlU9Rs$lambda$0(Landroidx/compose/foundation/lazy/layout/LazyLayoutItemProvider;ILjava/lang/Object;Landroidx/compose/runtime/Composer;I)Lkotlin/Unit;
    .locals 4
    .param p0, "$itemProvider"    # Landroidx/compose/foundation/lazy/layout/LazyLayoutItemProvider;
    .param p1, "$index"    # I
    .param p2, "$$v$c$androidx-compose-foundation-lazy-layout-StableValue$-key$0"    # Ljava/lang/Object;
...
.method static final SkippableItem_JVlU9Rs$lambda$1(Landroidx/compose/foundation/lazy/layout/LazyLayoutItemProvider;Ljava/lang/Object;ILjava/lang/Object;ILandroidx/compose/runtime/Composer;I)Lkotlin/Unit;
    .locals 7
    ...
    invoke-static/range {v1 .. v6}, Landroidx/compose/foundation/lazy/layout/LazyLayoutItemContentFactoryKt;->SkippableItem-JVlU9Rs(Landroidx/compose/foundation/lazy/layout/LazyLayoutItemProvider;Ljava/lang/Object;ILjava/lang/Object;Landroidx/compose/runtime/Composer;I)V
