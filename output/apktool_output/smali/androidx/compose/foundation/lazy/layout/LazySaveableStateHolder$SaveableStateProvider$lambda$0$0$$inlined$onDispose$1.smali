...
.method public dispose()V
    ...
    .line 604
    .local v0, "$i$a$-onDispose-LazySaveableStateHolder$SaveableStateProvider$1$1$1":I
    iget-object v1, p0, Landroidx/compose/foundation/lazy/layout/LazySaveableStateHolder$SaveableStateProvider$lambda$0$0$$inlined$onDispose$1;->this$0:Landroidx/compose/foundation/lazy/layout/LazySaveableStateHolder;

    invoke-static {v1}, Landroidx/compose/foundation/lazy/layout/LazySaveableStateHolder;->access$getPreviouslyComposedKeys$p(Landroidx/compose/foundation/lazy/layout/LazySaveableStateHolder;)Landroidx/collection/MutableScatterSet;

    move-result-object v1

    iget-object v2, p0, Landroidx/compose/foundation/lazy/layout/LazySaveableStateHolder$SaveableStateProvider$lambda$0$0$$inlined$onDispose$1;->$key$inlined:Ljava/lang/Object;

    invoke-virtual {v1, v2}, Landroidx/collection/MutableScatterSet;->plusAssign(Ljava/lang/Object;)V

    .line 68
    .end local v0    # "$i$a$-onDispose-LazySaveableStateHolder$SaveableStateProvider$1$1$1":I
    nop
