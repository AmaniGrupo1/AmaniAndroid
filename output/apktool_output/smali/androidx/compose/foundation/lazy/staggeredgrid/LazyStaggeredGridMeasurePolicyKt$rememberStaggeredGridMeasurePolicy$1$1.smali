...
.method public final measure-0kLqBqw(Landroidx/compose/foundation/lazy/layout/LazyLayoutMeasureScope;J)Landroidx/compose/ui/layout/MeasureResult;
    ...
    .line 82
    .local v22, "maxMainAxisSize":I
    sub-int v4, v22, v14

    sub-int v13, v4, v15

    .line 84
    .local v13, "mainAxisAvailableSize":I
    if-eqz v11, :cond_4
    ...
    .local v4, "$this$measure_0kLqBqw_u24lambda_u240":Landroidx/compose/foundation/layout/PaddingValues;
    const/4 v5, 0x0
    ...
    .local v6, "$v$c$androidx-compose-ui-unit-Dp$-this$0$iv":F
    .local v7, "$v$c$androidx-compose-ui-unit-Dp$-other$0$iv":F
    const/4 v8, 0x0
    ...
    .line 94
    .end local v6    # "$v$c$androidx-compose-ui-unit-Dp$-this$0$iv":F
    .end local v7    # "$v$c$androidx-compose-ui-unit-Dp$-other$0$iv":F
    .end local v8    # "$i$f$plus-5rwHm24":I
    nop

    .line 92
    .end local v4    # "$this$measure_0kLqBqw_u24lambda_u240":Landroidx/compose/foundation/layout/PaddingValues;
    ...
    .local v5, "$this$measure_0kLqBqw_u24lambda_u241":Landroidx/compose/foundation/layout/PaddingValues;
    const/4 v6, 0x0
    ...
    .local v7, "$v$c$androidx-compose-ui-unit-Dp$-this$0$iv":F
    invoke-interface {v5}, Landroidx/compose/foundation/layout/PaddingValues;->calculateBottomPadding-D9Ej5fM()F

    move-result v8

    .local v8, "$v$c$androidx-compose-ui-unit-Dp$-other$0$iv":F
    const/4 v9, 0x0
    ...
    .line 98
    .end local v7    # "$v$c$androidx-compose-ui-unit-Dp$-this$0$iv":F
    .end local v8    # "$v$c$androidx-compose-ui-unit-Dp$-other$0$iv":F
    .end local v9    # "$i$f$plus-5rwHm24":I
    nop

    .end local v5    # "$this$measure_0kLqBqw_u24lambda_u241":Landroidx/compose/foundation/layout/PaddingValues;
    ...
    invoke-virtual {v7}, Landroidx/compose/foundation/lazy/staggeredgrid/LazyStaggeredGridState;->getPinnedItems$foundation()Landroidx/compose/foundation/lazy/layout/LazyLayoutPinnedItemList;
    ...
    invoke-virtual {v8}, Landroidx/compose/foundation/lazy/staggeredgrid/LazyStaggeredGridState;->getBeyondBoundsInfo$foundation()Landroidx/compose/foundation/lazy/layout/LazyLayoutBeyondBoundsInfo;
    ...
    .line 114
    .local v16, "pinnedItems":Ljava/util/List;
    nop
    ...
    .line 118
    iget v2, v0, Landroidx/compose/foundation/lazy/staggeredgrid/LazyStaggeredGridMeasurePolicyKt$rememberStaggeredGridMeasurePolicy$1$1;->$$v$c$androidx-compose-ui-unit-Dp$-mainAxisSpacing$0:F
    ...
    .end local v13    # "mainAxisAvailableSize":I
    ...
    .end local v16    # "pinnedItems":Ljava/util/List;
    ...
    invoke-static/range {v25 .. v30}, Landroidx/compose/foundation/lazy/staggeredgrid/LazyStaggeredGridState;->applyMeasureResult$foundation$default(Landroidx/compose/foundation/lazy/staggeredgrid/LazyStaggeredGridState;Landroidx/compose/foundation/lazy/staggeredgrid/LazyStaggeredGridMeasureResult;ZZILjava/lang/Object;)V
