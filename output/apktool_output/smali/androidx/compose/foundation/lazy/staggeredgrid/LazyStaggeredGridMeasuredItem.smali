...
.method private constructor <init>(ILjava/lang/Object;Ljava/util/List;ZIIIIILjava/lang/Object;Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimator;J)V
    ...
    .end local v2    # "val1$iv$iv":I
    .local v5, "width$iv":I
    .restart local v16    # "val1$iv$iv":I
    int-to-long v1, v15
    ...
    .line 1347
    .end local v15    # "width$iv":I
    .end local v16    # "$i$f$IntSize":I
...
.method public final place(Landroidx/compose/ui/layout/Placeable$PlacementScope;Landroidx/compose/foundation/lazy/staggeredgrid/LazyStaggeredGridMeasureContext;Z)V
    ...
    .local v1, "$this$place_u24lambda_u240":Landroidx/compose/foundation/lazy/staggeredgrid/LazyStaggeredGridMeasureContext;
    const/4 v2, 0x0
    ...
    .local v6, "$this$place_u24lambda_u240_u241":Landroidx/compose/ui/layout/Placeable$PlacementScope;
    const/4 v3, 0x0
    ...
    .end local v1    # "$this$place_u24lambda_u240":Landroidx/compose/foundation/lazy/staggeredgrid/LazyStaggeredGridMeasureContext;
    .local v18, "$this$place_u24lambda_u240":Landroidx/compose/foundation/lazy/staggeredgrid/LazyStaggeredGridMeasureContext;
    invoke-virtual {v0}, Landroidx/compose/foundation/lazy/staggeredgrid/LazyStaggeredGridMeasuredItem;->getKey()Ljava/lang/Object;
    ...
    .local v3, "$v$c$androidx-compose-ui-unit-IntOffset$-$this$copy$0$iv":J
    ...
    .line 1519
    .local v24, "$i$f$IntOffset":I
    move/from16 v26, v2

    .local v26, "val2$iv$iv$iv":I
    move/from16 v27, v21

    .local v27, "val1$iv$iv$iv":I
    move/from16 v28, v26

    .end local v26    # "val2$iv$iv$iv":I
    .local v28, "val2$iv$iv$iv":I
    const/16 v26, 0x0
    ...
    .end local v3    # "$v$c$androidx-compose-ui-unit-IntOffset$-$this$copy$0$iv":J
    .end local v27    # "val1$iv$iv$iv":I
    .local v0, "val1$iv$iv$iv":I
    .local v4, "y$iv$iv":I
    .local v29, "$v$c$androidx-compose-ui-unit-IntOffset$-$this$copy$0$iv":J
    int-to-long v2, v0
    ...
    .end local v28    # "val2$iv$iv$iv":I
    .local v0, "val2$iv$iv$iv":I
    .restart local v27    # "val1$iv$iv$iv":I
    int-to-long v2, v0
    ...
    .line 1517
    .end local v4    # "y$iv$iv":I
    .end local v21    # "x$iv$iv":I
    .end local v24    # "$i$f$IntOffset":I
    nop
    ...
    .end local v29    # "$v$c$androidx-compose-ui-unit-IntOffset$-$this$copy$0$iv":J
    move-wide v11, v2
    ...
    .end local v18    # "$this$place_u24lambda_u240":Landroidx/compose/foundation/lazy/staggeredgrid/LazyStaggeredGridMeasureContext;
    .end local v19    # "$i$a$-with-LazyStaggeredGridMeasuredItem$place$1":I
    .end local v20    # "$i$a$-with-LazyStaggeredGridMeasuredItem$place$1$2":I
    .end local v22    # "$this$fastForEachIndexed$iv":Ljava/util/List;
    .end local v23    # "$i$f$fastForEachIndexed":I
    ...
    .line 1388
    .end local v3    # "$i$a$-with-LazyStaggeredGridMeasuredItem$place$1$2":I
    .end local v6    # "$this$place_u24lambda_u240_u241":Landroidx/compose/ui/layout/Placeable$PlacementScope;
    nop
...
.method public final position(III)V
    ...
    iput v0, p0, Landroidx/compose/foundation/lazy/staggeredgrid/LazyStaggeredGridMeasuredItem;->mainAxisLayoutSize:I

    .line 1359
    iget v1, p0, Landroidx/compose/foundation/lazy/staggeredgrid/LazyStaggeredGridMeasuredItem;->beforeContentPadding:I

    neg-int v1, v1

    iput v1, p0, Landroidx/compose/foundation/lazy/staggeredgrid/LazyStaggeredGridMeasuredItem;->minMainAxisOffset:I

    .line 1360
    iget v1, p0, Landroidx/compose/foundation/lazy/staggeredgrid/LazyStaggeredGridMeasuredItem;->afterContentPadding:I

    add-int/2addr v1, v0

    iput v1, p0, Landroidx/compose/foundation/lazy/staggeredgrid/LazyStaggeredGridMeasuredItem;->maxMainAxisOffset:I
    ...
    .restart local v1    # "y$iv":I
    move v5, p1

    .restart local v5    # "x$iv":I
    const/4 v6, 0x0
    ...
    .restart local v7    # "val2$iv$iv":I
    move v8, v5

    .restart local v8    # "val1$iv$iv":I
    const/4 v9, 0x0

    .line 1508
    .restart local v9    # "$i$f$packInts":I
    int-to-long v10, v8
    ...
    .end local v6    # "$i$f$IntOffset":I
    :goto_0
    iput-wide v1, p0, Landroidx/compose/foundation/lazy/staggeredgrid/LazyStaggeredGridMeasuredItem;->offset:J
