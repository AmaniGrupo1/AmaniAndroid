...
.method private constructor <init>(Landroidx/compose/foundation/lazy/staggeredgrid/LazyStaggeredGridState;Ljava/util/List;Landroidx/compose/foundation/lazy/staggeredgrid/LazyStaggeredGridItemProvider;Landroidx/compose/foundation/lazy/staggeredgrid/LazyStaggeredGridSlots;JZLandroidx/compose/foundation/lazy/layout/LazyLayoutMeasureScope;IJIIZILkotlinx/coroutines/CoroutineScope;ZZLandroidx/compose/foundation/lazy/staggeredgrid/LazyStaggeredGridLayoutInfo;Landroidx/compose/ui/graphics/GraphicsContext;)V
    ...
    invoke-virtual {v0}, Landroidx/compose/foundation/lazy/staggeredgrid/LazyStaggeredGridState;->getLaneInfo$foundation()Landroidx/compose/foundation/lazy/staggeredgrid/LazyStaggeredGridLaneInfo;
...
.method public final getLaneInfo-SZVOQXA(J)I
    .locals 19
    .param p1, "$v$c$androidx-compose-foundation-lazy-staggeredgrid-SpanRange$-$this$laneInfo$0"    # J
    ...
    .local v1, "$v$c$androidx-compose-foundation-lazy-staggeredgrid-SpanRange$-$this$isFullSpan$0$iv":J
    ...
    .local v5, "$v$c$androidx-compose-foundation-lazy-staggeredgrid-SpanRange$-this$0$iv$iv":J
    const/4 v7, 0x0
    ...
    .local v8, "$v$c$androidx-compose-foundation-lazy-staggeredgrid-SpanRange$-this$0$iv$iv$iv":J
    const/4 v10, 0x0

    .line 1494
    .local v10, "$i$f$getEnd-impl":I
    move-wide v11, v8
    ...
    .line 1493
    .end local v8    # "$v$c$androidx-compose-foundation-lazy-staggeredgrid-SpanRange$-this$0$iv$iv$iv":J
    .end local v10    # "$i$f$getEnd-impl":I
    nop

    .restart local v8    # "$v$c$androidx-compose-foundation-lazy-staggeredgrid-SpanRange$-this$0$iv$iv$iv":J
    const/4 v10, 0x0

    .line 1496
    .local v10, "$i$f$getStart-impl":I
    move-wide v12, v8
    ...
    .end local v0    # "$i$f$getLaneInfo-SZVOQXA":I
    .end local v1    # "$v$c$androidx-compose-foundation-lazy-staggeredgrid-SpanRange$-$this$isFullSpan$0$iv":J
    .local v16, "$i$f$getLaneInfo-SZVOQXA":I
    .local v17, "$v$c$androidx-compose-foundation-lazy-staggeredgrid-SpanRange$-$this$isFullSpan$0$iv":J
    shr-long v0, v12, v15
    ...
    .line 1493
    .end local v8    # "$v$c$androidx-compose-foundation-lazy-staggeredgrid-SpanRange$-this$0$iv$iv$iv":J
    .end local v10    # "$i$f$getStart-impl":I
    sub-int/2addr v11, v0

    .line 1492
    .end local v5    # "$v$c$androidx-compose-foundation-lazy-staggeredgrid-SpanRange$-this$0$iv$iv":J
    ...
    .end local v17    # "$v$c$androidx-compose-foundation-lazy-staggeredgrid-SpanRange$-$this$isFullSpan$0$iv":J
    :goto_0
    if-eqz v0, :cond_1
    ...
    .local v0, "$v$c$androidx-compose-foundation-lazy-staggeredgrid-SpanRange$-this$0$iv":J
    const/4 v2, 0x0
    ...
    .line 265
    .end local v0    # "$v$c$androidx-compose-foundation-lazy-staggeredgrid-SpanRange$-this$0$iv":J
...
.method public final isFullSpan-SZVOQXA(J)Z
    .locals 13
    .param p1, "$v$c$androidx-compose-foundation-lazy-staggeredgrid-SpanRange$-$this$isFullSpan$0"    # J
    ...
    .local v4, "$v$c$androidx-compose-foundation-lazy-staggeredgrid-SpanRange$-this$0$iv$iv":J
    const/4 v6, 0x0
    ...
    .line 1487
    .end local v4    # "$v$c$androidx-compose-foundation-lazy-staggeredgrid-SpanRange$-this$0$iv$iv":J
    .end local v6    # "$i$f$getEnd-impl":I
    nop

    .restart local v4    # "$v$c$androidx-compose-foundation-lazy-staggeredgrid-SpanRange$-this$0$iv$iv":J
    const/4 v6, 0x0
