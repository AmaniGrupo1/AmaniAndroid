...
.method public static final synthetic access$alignmentLineOffsetMeasure-tjqqzMA(Landroidx/compose/ui/layout/MeasureScope;Landroidx/compose/ui/layout/AlignmentLine;FFLandroidx/compose/ui/layout/Measurable;J)Landroidx/compose/ui/layout/MeasureResult;
    ...
    .param p2, "$v$c$androidx-compose-ui-unit-Dp$-before$0"    # F
    .param p3, "$v$c$androidx-compose-ui-unit-Dp$-after$0"    # F
    .param p4, "measurable"    # Landroidx/compose/ui/layout/Measurable;
    .param p5, "$v$c$androidx-compose-ui-unit-Constraints$-constraints$0"    # J
...
.method private static final alignmentLineOffsetMeasure-tjqqzMA(Landroidx/compose/ui/layout/MeasureScope;Landroidx/compose/ui/layout/AlignmentLine;FFLandroidx/compose/ui/layout/Measurable;J)Landroidx/compose/ui/layout/MeasureResult;
    ...
    invoke-virtual {v14, v9}, Landroidx/compose/ui/layout/Placeable;->get(Landroidx/compose/ui/layout/AlignmentLine;)I
    ...
    .line 318
    .local v2, "$i$a$-let-AlignmentLineKt$alignmentLineOffsetMeasure$linePosition$1":I
    ...
    .line 317
    .end local v1    # "it":I
    .end local v2    # "$i$a$-let-AlignmentLineKt$alignmentLineOffsetMeasure$linePosition$1":I
    :goto_1
    move/from16 v16, v1

    .line 319
    .local v16, "linePosition":I
    invoke-static {v9}, Landroidx/compose/foundation/layout/AlignmentLineKt;->getHorizontal(Landroidx/compose/ui/layout/AlignmentLine;)Z
    ...
    .local v1, "$v$c$androidx-compose-ui-unit-Dp$-$this$isSpecified$0$iv":F
    const/4 v2, 0x0
    ...
    .line 323
    .end local v1    # "$v$c$androidx-compose-ui-unit-Dp$-$this$isSpecified$0$iv":F
    ...
    .line 328
    .local v11, "paddingBefore":I
    move/from16 v1, p3

    .restart local v1    # "$v$c$androidx-compose-ui-unit-Dp$-$this$isSpecified$0$iv":F
    const/4 v2, 0x0

    .line 373
    .restart local v2    # "$i$f$isSpecified-0680j_4":I
    invoke-static {v1}, Ljava/lang/Float;->isNaN(F)Z
    ...
    .line 345
    .local v15, "height":I
    new-instance v4, Landroidx/compose/foundation/layout/AlignmentLineKt$$ExternalSyntheticLambda0;

    move-object v8, v4

    invoke-direct/range {v8 .. v15}, Landroidx/compose/foundation/layout/AlignmentLineKt$$ExternalSyntheticLambda0;-><init>(Landroidx/compose/ui/layout/AlignmentLine;FIIILandroidx/compose/ui/layout/Placeable;I)V
...
.method static final alignmentLineOffsetMeasure_tjqqzMA$lambda$1(Landroidx/compose/ui/layout/AlignmentLine;FIIILandroidx/compose/ui/layout/Placeable;ILandroidx/compose/ui/layout/Placeable$PlacementScope;)Lkotlin/Unit;
    .locals 9
    .param p0, "$alignmentLine"    # Landroidx/compose/ui/layout/AlignmentLine;
    .param p1, "$$v$c$androidx-compose-ui-unit-Dp$-before$0"    # F
    .param p2, "$paddingBefore"    # I
    .param p3, "$width"    # I
    .param p4, "$paddingAfter"    # I
    .param p5, "$placeable"    # Landroidx/compose/ui/layout/Placeable;
    .param p6, "$height"    # I
...
.method public static final paddingFrom-4j6BHR0(Landroidx/compose/ui/Modifier;Landroidx/compose/ui/layout/AlignmentLine;FF)Landroidx/compose/ui/Modifier;
    ...
    .end local p1    # "alignmentLine":Landroidx/compose/ui/layout/AlignmentLine;
    .end local p2    # "$v$c$androidx-compose-ui-unit-Dp$-before$0":F
    .end local p3    # "$v$c$androidx-compose-ui-unit-Dp$-after$0":F
    .local v1, "alignmentLine":Landroidx/compose/ui/layout/AlignmentLine;
    .local v2, "$v$c$androidx-compose-ui-unit-Dp$-before$0":F
    .local v3, "$v$c$androidx-compose-ui-unit-Dp$-after$0":F
...
.method public static final paddingFrom-Y_r0B1c(Landroidx/compose/ui/Modifier;Landroidx/compose/ui/layout/AlignmentLine;JJ)Landroidx/compose/ui/Modifier;
    ...
    .param p1, "alignmentLine"    # Landroidx/compose/ui/layout/AlignmentLine;
    .param p2, "$v$c$androidx-compose-ui-unit-TextUnit$-before$0"    # J
    .param p4, "$v$c$androidx-compose-ui-unit-TextUnit$-after$0"    # J
    ...
    new-instance v3, Landroidx/compose/foundation/layout/AlignmentLineKt$paddingFrom-Y_r0B1c$$inlined$debugInspectorInfo$1;
    ...
    .end local p1    # "alignmentLine":Landroidx/compose/ui/layout/AlignmentLine;
    .end local p2    # "$v$c$androidx-compose-ui-unit-TextUnit$-before$0":J
    .end local p4    # "$v$c$androidx-compose-ui-unit-TextUnit$-after$0":J
    .local v4, "alignmentLine":Landroidx/compose/ui/layout/AlignmentLine;
    .local v5, "$v$c$androidx-compose-ui-unit-TextUnit$-before$0":J
    .local v7, "$v$c$androidx-compose-ui-unit-TextUnit$-after$0":J
    ...
    .end local v5    # "$v$c$androidx-compose-ui-unit-TextUnit$-before$0":J
    .local v2, "$v$c$androidx-compose-ui-unit-TextUnit$-before$0":J
    check-cast p1, Lkotlin/jvm/functions/Function1;

    goto :goto_0

    .end local v2    # "$v$c$androidx-compose-ui-unit-TextUnit$-before$0":J
    .end local v4    # "alignmentLine":Landroidx/compose/ui/layout/AlignmentLine;
    .end local v7    # "$v$c$androidx-compose-ui-unit-TextUnit$-after$0":J
    .restart local p1    # "alignmentLine":Landroidx/compose/ui/layout/AlignmentLine;
    .restart local p2    # "$v$c$androidx-compose-ui-unit-TextUnit$-before$0":J
    .restart local p4    # "$v$c$androidx-compose-ui-unit-TextUnit$-after$0":J
    :cond_0
    move-object v4, p1
    ...
    .end local p2    # "$v$c$androidx-compose-ui-unit-TextUnit$-before$0":J
    .end local p4    # "$v$c$androidx-compose-ui-unit-TextUnit$-after$0":J
    .restart local v2    # "$v$c$androidx-compose-ui-unit-TextUnit$-before$0":J
    .restart local v4    # "alignmentLine":Landroidx/compose/ui/layout/AlignmentLine;
    .restart local v7    # "$v$c$androidx-compose-ui-unit-TextUnit$-after$0":J
    invoke-static {}, Landroidx/compose/ui/platform/InspectableValueKt;->getNoInspectorInfo()Lkotlin/jvm/functions/Function1;
    ...
    .end local v7    # "$v$c$androidx-compose-ui-unit-TextUnit$-after$0":J
    .local v1, "alignmentLine":Landroidx/compose/ui/layout/AlignmentLine;
    .local v4, "$v$c$androidx-compose-ui-unit-TextUnit$-after$0":J
    const/4 v7, 0x0
...
.method public static final paddingFromBaseline-VpY3zN4(Landroidx/compose/ui/Modifier;FF)Landroidx/compose/ui/Modifier;
    ...
    .param p2, "$v$c$androidx-compose-ui-unit-Dp$-bottom$0"    # F
    ...
    .local v0, "$v$c$androidx-compose-ui-unit-Dp$-$this$isSpecified$0$iv":F
    const/4 v1, 0x0
    ...
    .line 146
    .end local v0    # "$v$c$androidx-compose-ui-unit-Dp$-$this$isSpecified$0$iv":F
    ...
    .local v3, "$v$c$androidx-compose-ui-unit-Dp$-top$0":F
    ...
    .line 149
    .end local v3    # "$v$c$androidx-compose-ui-unit-Dp$-top$0":F
    .restart local p1    # "$v$c$androidx-compose-ui-unit-Dp$-top$0":F
    :cond_0
    move v3, p1

    .end local p1    # "$v$c$androidx-compose-ui-unit-Dp$-top$0":F
    .restart local v3    # "$v$c$androidx-compose-ui-unit-Dp$-top$0":F
    ...
    .restart local v0    # "$v$c$androidx-compose-ui-unit-Dp$-$this$isSpecified$0$iv":F
    const/4 v1, 0x0

    .line 368
    .restart local v1    # "$i$f$isSpecified-0680j_4":I
    invoke-static {v0}, Ljava/lang/Float;->isNaN(F)Z
    ...
    .end local p2    # "$v$c$androidx-compose-ui-unit-Dp$-bottom$0":F
    .local v7, "$v$c$androidx-compose-ui-unit-Dp$-bottom$0":F
    invoke-static/range {v4 .. v9}, Landroidx/compose/foundation/layout/AlignmentLineKt;->paddingFrom-4j6BHR0$default(Landroidx/compose/ui/Modifier;Landroidx/compose/ui/layout/AlignmentLine;FFILjava/lang/Object;)Landroidx/compose/ui/Modifier;
    ...
    .line 156
    .end local v7    # "$v$c$androidx-compose-ui-unit-Dp$-bottom$0":F
    .restart local p2    # "$v$c$androidx-compose-ui-unit-Dp$-bottom$0":F
    :cond_1
    move v7, p2

    .end local p2    # "$v$c$androidx-compose-ui-unit-Dp$-bottom$0":F
    .restart local v7    # "$v$c$androidx-compose-ui-unit-Dp$-bottom$0":F
...
.method public static final paddingFromBaseline-wCyjxdI(Landroidx/compose/ui/Modifier;JJ)Landroidx/compose/ui/Modifier;
    ...
    .param p1, "$v$c$androidx-compose-ui-unit-TextUnit$-top$0"    # J
    .param p3, "$v$c$androidx-compose-ui-unit-TextUnit$-bottom$0"    # J
    ...
    invoke-static/range {v8 .. v15}, Landroidx/compose/foundation/layout/AlignmentLineKt;->paddingFrom-Y_r0B1c$default(Landroidx/compose/ui/Modifier;Landroidx/compose/ui/layout/AlignmentLine;JJILjava/lang/Object;)Landroidx/compose/ui/Modifier;
    ...
    .local v2, "$v$c$androidx-compose-ui-unit-TextUnit$-$this$isUnspecified$0$iv":J
    const/4 v8, 0x0

    .line 370
    .local v8, "$i$f$isUnspecified--R2X_6o":I
    ...
    .line 184
    .end local v2    # "$v$c$androidx-compose-ui-unit-TextUnit$-$this$isUnspecified$0$iv":J
    .end local v8    # "$i$f$isUnspecified--R2X_6o":I
    :goto_2
    if-nez v4, :cond_3
    ...
    invoke-static/range {v3 .. v10}, Landroidx/compose/foundation/layout/AlignmentLineKt;->paddingFrom-Y_r0B1c$default(Landroidx/compose/ui/Modifier;Landroidx/compose/ui/layout/AlignmentLine;JJILjava/lang/Object;)Landroidx/compose/ui/Modifier;
