...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget-wide v5, v1, Landroidx/compose/foundation/layout/BoxWithConstraintsScopeImpl;->constraints:J
...
.method public getMaxHeight-D9Ej5fM()F
    ...
    .local v0, "$this$getMaxHeight_D9Ej5fM_u24lambda_u240":Landroidx/compose/ui/unit/Density;
    const/4 v1, 0x0

    .line 126
    .local v1, "$i$a$-with-BoxWithConstraintsScopeImpl$maxHeight$1":I
    invoke-virtual {p0}, Landroidx/compose/foundation/layout/BoxWithConstraintsScopeImpl;->getConstraints-msEJaDk()J

    move-result-wide v2

    invoke-static {v2, v3}, Landroidx/compose/ui/unit/Constraints;->getHasBoundedHeight-impl(J)Z
    ...
    .line 125
    .end local v0    # "$this$getMaxHeight_D9Ej5fM_u24lambda_u240":Landroidx/compose/ui/unit/Density;
    .end local v1    # "$i$a$-with-BoxWithConstraintsScopeImpl$maxHeight$1":I
    :goto_0
    nop
...
.method public getMaxWidth-D9Ej5fM()F
    ...
    .local v0, "$this$getMaxWidth_D9Ej5fM_u24lambda_u240":Landroidx/compose/ui/unit/Density;
    const/4 v1, 0x0

    .line 117
    .local v1, "$i$a$-with-BoxWithConstraintsScopeImpl$maxWidth$1":I
    invoke-virtual {p0}, Landroidx/compose/foundation/layout/BoxWithConstraintsScopeImpl;->getConstraints-msEJaDk()J
    ...
    .line 116
    .end local v0    # "$this$getMaxWidth_D9Ej5fM_u24lambda_u240":Landroidx/compose/ui/unit/Density;
    .end local v1    # "$i$a$-with-BoxWithConstraintsScopeImpl$maxWidth$1":I
    :goto_0
    nop
...
.method public getMinHeight-D9Ej5fM()F
    ...
    .line 130
    .local v0, "$this$getMinHeight_D9Ej5fM_u24lambda_u240":Landroidx/compose/ui/unit/Density;
    const/4 v1, 0x0

    .line 121
    .local v1, "$i$a$-with-BoxWithConstraintsScopeImpl$minHeight$1":I
    invoke-virtual {p0}, Landroidx/compose/foundation/layout/BoxWithConstraintsScopeImpl;->getConstraints-msEJaDk()J
    ...
    .end local v0    # "$this$getMinHeight_D9Ej5fM_u24lambda_u240":Landroidx/compose/ui/unit/Density;
    .end local v1    # "$i$a$-with-BoxWithConstraintsScopeImpl$minHeight$1":I
    return v0
.end method
...
.method public getMinWidth-D9Ej5fM()F
    ...
    .line 130
    .local v0, "$this$getMinWidth_D9Ej5fM_u24lambda_u240":Landroidx/compose/ui/unit/Density;
    const/4 v1, 0x0

    .line 112
    .local v1, "$i$a$-with-BoxWithConstraintsScopeImpl$minWidth$1":I
    invoke-virtual {p0}, Landroidx/compose/foundation/layout/BoxWithConstraintsScopeImpl;->getConstraints-msEJaDk()J
    ...
    .end local v0    # "$this$getMinWidth_D9Ej5fM_u24lambda_u240":Landroidx/compose/ui/unit/Density;
    .end local v1    # "$i$a$-with-BoxWithConstraintsScopeImpl$minWidth$1":I
    return v0
.end method
