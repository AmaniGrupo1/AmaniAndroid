...
.method private final drawOutline(Landroidx/compose/ui/graphics/drawscope/ContentDrawScope;)V
    ...
    .line 215
    .local v2, "it":Landroidx/compose/ui/graphics/Brush;
    const/4 v9, 0x0

    .line 189
    .local v9, "$i$a$-let-BackgroundNode$drawOutline$1":I
    move-object v0, p1
    ...
    .line 190
    .end local v2    # "it":Landroidx/compose/ui/graphics/Brush;
    .end local v9    # "$i$a$-let-BackgroundNode$drawOutline$1":I
    :cond_1
    return-void
.end method
...
.method private final drawRect(Landroidx/compose/ui/graphics/drawscope/ContentDrawScope;)V
    ...
    .line 183
    .local v0, "$i$a$-let-BackgroundNode$drawRect$1":I
    move-object v1, p1

    check-cast v1, Landroidx/compose/ui/graphics/drawscope/DrawScope;

    iget v7, p0, Landroidx/compose/foundation/BackgroundNode;->alpha:F
    ...
    .line 184
    .end local v0    # "$i$a$-let-BackgroundNode$drawRect$1":I
    .end local v2    # "it":Landroidx/compose/ui/graphics/Brush;
    :cond_1
    return-void
.end method
...
.method private final getOutline(Landroidx/compose/ui/graphics/drawscope/ContentDrawScope;)Landroidx/compose/ui/graphics/Outline;
    .locals 5
    .param p1, "$this$getOutline"    # Landroidx/compose/ui/graphics/drawscope/ContentDrawScope;
    ...
    .restart local v0    # "outline":Landroidx/compose/ui/graphics/Outline;
    :cond_0
    move-object v1, p0

    check-cast v1, Landroidx/compose/ui/Modifier$Node;

    new-instance v2, Landroidx/compose/foundation/BackgroundNode$$ExternalSyntheticLambda0;

    invoke-direct {v2, p0, p1}, Landroidx/compose/foundation/BackgroundNode$$ExternalSyntheticLambda0;-><init>(Landroidx/compose/foundation/BackgroundNode;Landroidx/compose/ui/graphics/drawscope/ContentDrawScope;)V
    ...
    .line 200
    iget-object v1, p0, Landroidx/compose/foundation/BackgroundNode;->tmpOutline:Landroidx/compose/ui/graphics/Outline;
    ...
    iput-object v0, p0, Landroidx/compose/foundation/BackgroundNode;->tmpOutline:Landroidx/compose/ui/graphics/Outline;
...
.method static final getOutline$lambda$0(Landroidx/compose/foundation/BackgroundNode;Landroidx/compose/ui/graphics/drawscope/ContentDrawScope;)Lkotlin/Unit;
    .locals 5
    .param p0, "this$0"    # Landroidx/compose/foundation/BackgroundNode;
    .param p1, "$this_getOutline"    # Landroidx/compose/ui/graphics/drawscope/ContentDrawScope;
