...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "translateDecorationToInnerCoordinates-MK-Hz9U$foundation",
        "(J)J",
        "translateInnerToDecorationCoordinates",
        "translateInnerToDecorationCoordinates-MK-Hz9U$foundation",
...
.method static constructor <clinit>()V
    ...
    sput v0, Landroidx/compose/foundation/text/TextLayoutResultProxy;->$stable:I
...
.method public constructor <init>(Landroidx/compose/ui/text/TextLayoutResult;Landroidx/compose/ui/layout/LayoutCoordinates;Landroidx/compose/ui/layout/LayoutCoordinates;)V
    ...
    .param p2, "innerTextFieldCoordinates"    # Landroidx/compose/ui/layout/LayoutCoordinates;
    .param p3, "decorationBoxCoordinates"    # Landroidx/compose/ui/layout/LayoutCoordinates;
...
.method private final coercedInVisibleBoundsOfInputText-MK-Hz9U(J)J
    .locals 6
    .param p1, "$v$c$androidx-compose-ui-geometry-Offset$-$this$coercedInVisibleBoundsOfInputText$0"    # J
    ...
    invoke-static {p1, p2, v3}, Landroidx/compose/foundation/text/TextLayoutResultProxyKt;->access$coerceIn-3MmeM6k(JLandroidx/compose/ui/geometry/Rect;)J
...
.method public final getLineForVerticalPosition(F)I
    ...
    invoke-direct {v0, v1, v2}, Landroidx/compose/foundation/text/TextLayoutResultProxy;->coercedInVisibleBoundsOfInputText-MK-Hz9U(J)J

    move-result-wide v1

    .line 61
    .local v1, "coercedPosition":J
    invoke-virtual {v0, v1, v2}, Landroidx/compose/foundation/text/TextLayoutResultProxy;->translateDecorationToInnerCoordinates-MK-Hz9U$foundation(J)J
    ...
    .line 62
    .local v9, "relativeVertical":F
    iget-object v3, v0, Landroidx/compose/foundation/text/TextLayoutResultProxy;->value:Landroidx/compose/ui/text/TextLayoutResult;

    invoke-virtual {v3, v9}, Landroidx/compose/ui/text/TextLayoutResult;->getLineForVerticalPosition(F)I
...
.method public final getOffsetForPosition-3MmeM6k(JZ)I
    ...
    invoke-virtual {v4, v2, v3}, Landroidx/compose/ui/text/TextLayoutResult;->getOffsetForPosition-k-4lQ0M(J)I
...
.method public final isPositionOnText-k-4lQ0M(J)Z
    ...
    .line 73
    invoke-direct/range {p0 .. p2}, Landroidx/compose/foundation/text/TextLayoutResultProxy;->coercedInVisibleBoundsOfInputText-MK-Hz9U(J)J

    move-result-wide v0

    .line 74
    .local v0, "visibleOffset":J
    invoke-virtual {p0, v0, v1}, Landroidx/compose/foundation/text/TextLayoutResultProxy;->translateDecorationToInnerCoordinates-MK-Hz9U$foundation(J)J
    ...
    invoke-virtual {v4, v11}, Landroidx/compose/ui/text/TextLayoutResult;->getLineForVerticalPosition(F)I
    ...
    iget-object v5, p0, Landroidx/compose/foundation/text/TextLayoutResultProxy;->value:Landroidx/compose/ui/text/TextLayoutResult;
    ...
    invoke-virtual {v5, v4}, Landroidx/compose/ui/text/TextLayoutResult;->getLineRight(I)F
...
.method public final translateDecorationToInnerCoordinates-MK-Hz9U$foundation(J)J
    ...
    .line 85
    .local v2, "$i$a$-takeIf-TextLayoutResultProxy$translateDecorationToInnerCoordinates$innerCoords$1":I
    invoke-interface {v1}, Landroidx/compose/ui/layout/LayoutCoordinates;->isAttached()Z

    move-result v1

    .end local v1    # "it":Landroidx/compose/ui/layout/LayoutCoordinates;
    .end local v2    # "$i$a$-takeIf-TextLayoutResultProxy$translateDecorationToInnerCoordinates$innerCoords$1":I
    const/4 v2, 0x0
    ...
    .line 86
    .local v0, "innerCoords":Landroidx/compose/ui/layout/LayoutCoordinates;
    :cond_1
    ...
    .line 86
    .local v4, "$i$a$-takeIf-TextLayoutResultProxy$translateDecorationToInnerCoordinates$decorationCoords$1":I
    ...
    .end local v4    # "$i$a$-takeIf-TextLayoutResultProxy$translateDecorationToInnerCoordinates$decorationCoords$1":I
    if-eqz v3, :cond_2
    ...
    .line 87
    .local v2, "decorationCoords":Landroidx/compose/ui/layout/LayoutCoordinates;
    :cond_3
    ...
    .line 86
    .end local v2    # "decorationCoords":Landroidx/compose/ui/layout/LayoutCoordinates;
    :cond_4
    :goto_1
    return-wide p1

    .line 85
    .end local v0    # "innerCoords":Landroidx/compose/ui/layout/LayoutCoordinates;
    :cond_5
    :goto_2
    return-wide p1
.end method
...
.method public final translateInnerToDecorationCoordinates-MK-Hz9U$foundation(J)J
    ...
    .line 95
    .local v2, "$i$a$-takeIf-TextLayoutResultProxy$translateInnerToDecorationCoordinates$innerCoords$1":I
    invoke-interface {v1}, Landroidx/compose/ui/layout/LayoutCoordinates;->isAttached()Z

    move-result v1

    .end local v1    # "it":Landroidx/compose/ui/layout/LayoutCoordinates;
    .end local v2    # "$i$a$-takeIf-TextLayoutResultProxy$translateInnerToDecorationCoordinates$innerCoords$1":I
    const/4 v2, 0x0
    ...
    .line 96
    .local v4, "$i$a$-takeIf-TextLayoutResultProxy$translateInnerToDecorationCoordinates$decorationCoords$1":I
    invoke-interface {v3}, Landroidx/compose/ui/layout/LayoutCoordinates;->isAttached()Z

    move-result v3

    .end local v3    # "it":Landroidx/compose/ui/layout/LayoutCoordinates;
    .end local v4    # "$i$a$-takeIf-TextLayoutResultProxy$translateInnerToDecorationCoordinates$decorationCoords$1":I
    if-eqz v3, :cond_2
