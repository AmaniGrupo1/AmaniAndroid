...
.method private static final anchorOnBoundary(Landroidx/compose/foundation/text/selection/SelectableInfo;ZZILandroidx/compose/foundation/text/selection/BoundaryFunction;)Landroidx/compose/foundation/text/selection/Selection$AnchorInfo;
    ...
    .line 418
    .local v1, "$this$anchorOnBoundary_u24lambda_u240":Landroidx/compose/foundation/text/selection/BoundaryFunction;
    const/4 v2, 0x0
...
.method private static final updateSelectionBoundary(Landroidx/compose/foundation/text/selection/SelectionLayout;Landroidx/compose/foundation/text/selection/SelectableInfo;Landroidx/compose/foundation/text/selection/Selection$AnchorInfo;)Landroidx/compose/foundation/text/selection/Selection$AnchorInfo;
    ...
    new-instance v2, Landroidx/compose/foundation/text/selection/SelectionAdjustmentKt$$ExternalSyntheticLambda0;

    invoke-direct {v2, p1, v3}, Landroidx/compose/foundation/text/selection/SelectionAdjustmentKt$$ExternalSyntheticLambda0;-><init>(Landroidx/compose/foundation/text/selection/SelectableInfo;I)V
...
.method static final updateSelectionBoundary$lambda$0(Landroidx/compose/foundation/text/selection/SelectableInfo;I)I
    .locals 1
    .param p0, "$info"    # Landroidx/compose/foundation/text/selection/SelectableInfo;
    .param p1, "$currentRawOffset"    # I
...
.method static final updateSelectionBoundary$lambda$2(Landroidx/compose/foundation/text/selection/SelectableInfo;IILandroidx/compose/foundation/text/selection/SelectionLayout;Lkotlin/Lazy;)Landroidx/compose/foundation/text/selection/Selection$AnchorInfo;
    .locals 6
    .param p0, "$info"    # Landroidx/compose/foundation/text/selection/SelectableInfo;
    .param p1, "$currentRawOffset"    # I
    .param p2, "$otherRawOffset"    # I
    .param p3, "$this_updateSelectionBoundary"    # Landroidx/compose/foundation/text/selection/SelectionLayout;
    .param p4, "$currentRawLine$delegate"    # Lkotlin/Lazy;
    ...
    .end local p0    # "$info":Landroidx/compose/foundation/text/selection/SelectableInfo;
    .end local p1    # "$currentRawOffset":I
    .end local p2    # "$otherRawOffset":I
    .local v0, "$info":Landroidx/compose/foundation/text/selection/SelectableInfo;
    .local v2, "$currentRawOffset":I
    .local v3, "$otherRawOffset":I
