...
.method public dispose()V
    ...
    .line 604
    .local v0, "$i$a$-onDispose-BasicSecureTextField_androidKt$platformAllowsRevealLastTyped$1$1$1":I
    iget-object v1, p0, Landroidx/compose/foundation/text/BasicSecureTextField_androidKt$platformAllowsRevealLastTyped$lambda$5$0$$inlined$onDispose$1;->$resolver$inlined:Landroidx/compose/foundation/text/ContentResolverForSecureTextField;

    iget-object v2, p0, Landroidx/compose/foundation/text/BasicSecureTextField_androidKt$platformAllowsRevealLastTyped$lambda$5$0$$inlined$onDispose$1;->$settingsObserver$inlined:Landroidx/compose/foundation/text/BasicSecureTextField_androidKt$platformAllowsRevealLastTyped$settingsObserver$1$1;

    check-cast v2, Landroid/database/ContentObserver;

    invoke-interface {v1, v2}, Landroidx/compose/foundation/text/ContentResolverForSecureTextField;->unregisterContentObserver(Landroid/database/ContentObserver;)V

    .line 68
    .end local v0    # "$i$a$-onDispose-BasicSecureTextField_androidKt$platformAllowsRevealLastTyped$1$1$1":I
    nop
