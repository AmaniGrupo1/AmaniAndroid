...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .local v0, "interaction":Landroidx/compose/foundation/interaction/PressInteraction$Press;
    invoke-static {p1}, Lkotlin/ResultKt;->throwOnFailure(Ljava/lang/Object;)V

    goto :goto_1

    .end local v0    # "interaction":Landroidx/compose/foundation/interaction/PressInteraction$Press;
    :pswitch_1
    const/4 v1, 0x0

    .local v1, "$i$a$-let-TextFieldPressGestureFilterKt$tapPressTextFieldModifier$1$2$1$1$1$1":I
    iget-object v3, p0, Landroidx/compose/foundation/text/TextFieldPressGestureFilterKt$tapPressTextFieldModifier$1$2$1$1$1;->L$0:Ljava/lang/Object;
    ...
    .end local v1    # "$i$a$-let-TextFieldPressGestureFilterKt$tapPressTextFieldModifier$1$2$1$1$1$1":I
    ...
    iget-object v3, p0, Landroidx/compose/foundation/text/TextFieldPressGestureFilterKt$tapPressTextFieldModifier$1$2$1$1$1;->$interactionSource:Landroidx/compose/foundation/interaction/MutableInteractionSource;
    ...
    .line 59
    .local v5, "$i$a$-let-TextFieldPressGestureFilterKt$tapPressTextFieldModifier$1$2$1$1$1$1":I
    ...
    iput v7, p0, Landroidx/compose/foundation/text/TextFieldPressGestureFilterKt$tapPressTextFieldModifier$1$2$1$1$1;->label:I
    ...
    .end local v5    # "$i$a$-let-TextFieldPressGestureFilterKt$tapPressTextFieldModifier$1$2$1$1$1$1":I
    .local v1, "$i$a$-let-TextFieldPressGestureFilterKt$tapPressTextFieldModifier$1$2$1$1$1$1":I
    :goto_0
    move v5, v1
    ...
    .line 61
    .end local v1    # "$i$a$-let-TextFieldPressGestureFilterKt$tapPressTextFieldModifier$1$2$1$1$1$1":I
    .restart local v5    # "$i$a$-let-TextFieldPressGestureFilterKt$tapPressTextFieldModifier$1$2$1$1$1$1":I
    :cond_1
    ...
    iget-object v2, p0, Landroidx/compose/foundation/text/TextFieldPressGestureFilterKt$tapPressTextFieldModifier$1$2$1$1$1;->$interactionSource:Landroidx/compose/foundation/interaction/MutableInteractionSource;
    ...
    iput-object v1, p0, Landroidx/compose/foundation/text/TextFieldPressGestureFilterKt$tapPressTextFieldModifier$1$2$1$1$1;->L$0:Ljava/lang/Object;

    const/4 v5, 0x2

    iput v5, p0, Landroidx/compose/foundation/text/TextFieldPressGestureFilterKt$tapPressTextFieldModifier$1$2$1$1$1;->label:I
    ...
    .restart local v0    # "interaction":Landroidx/compose/foundation/interaction/PressInteraction$Press;
    :goto_1
    move-object v1, v0

    .line 65
    .end local v0    # "interaction":Landroidx/compose/foundation/interaction/PressInteraction$Press;
    .restart local v1    # "interaction":Landroidx/compose/foundation/interaction/PressInteraction$Press;
    :cond_4
