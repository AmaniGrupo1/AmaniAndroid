...
.method public final synthetic copy-3m2b7yw(IZII)Landroidx/compose/foundation/text/KeyboardOptions;
    .locals 9
    .param p1, "$v$c$androidx-compose-ui-text-input-KeyboardCapitalization$-capitalization$0"    # I
    .param p2, "autoCorrect"    # Z
    .param p3, "$v$c$androidx-compose-ui-text-input-KeyboardType$-keyboardType$0"    # I
    .param p4, "$v$c$androidx-compose-ui-text-input-ImeAction$-imeAction$0"    # I
    .annotation runtime Lkotlin/Deprecated;
        level = .enum Lkotlin/DeprecationLevel;->HIDDEN:Lkotlin/DeprecationLevel;
    ...
    .end local p1    # "$v$c$androidx-compose-ui-text-input-KeyboardCapitalization$-capitalization$0":I
    .end local p3    # "$v$c$androidx-compose-ui-text-input-KeyboardType$-keyboardType$0":I
    .end local p4    # "$v$c$androidx-compose-ui-text-input-ImeAction$-imeAction$0":I
    .local v1, "$v$c$androidx-compose-ui-text-input-KeyboardCapitalization$-capitalization$0":I
    .local v3, "$v$c$androidx-compose-ui-text-input-KeyboardType$-keyboardType$0":I
    .local v4, "$v$c$androidx-compose-ui-text-input-ImeAction$-imeAction$0":I
    invoke-direct/range {v0 .. v8}, Landroidx/compose/foundation/text/KeyboardOptions;-><init>(ILjava/lang/Boolean;IILandroidx/compose/ui/text/input/PlatformImeOptions;Ljava/lang/Boolean;Landroidx/compose/ui/text/intl/LocaleList;Lkotlin/jvm/internal/DefaultConstructorMarker;)V
