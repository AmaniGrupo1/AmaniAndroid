...
.method constructor <init>(Landroidx/compose/foundation/text/ContentResolverForSecureTextField;Landroidx/compose/runtime/MutableState;Landroid/os/Handler;)V
    .locals 0
    .param p1, "$resolver"    # Landroidx/compose/foundation/text/ContentResolverForSecureTextField;
    .param p2, "$state$delegate"    # Landroidx/compose/runtime/MutableState;
...
.method public onChange(Z)V
    ...
    .line 50
    iget-object v0, p0, Landroidx/compose/foundation/text/BasicSecureTextField_androidKt$platformAllowsRevealLastTyped$settingsObserver$1$1;->$state$delegate:Landroidx/compose/runtime/MutableState;

    iget-object v1, p0, Landroidx/compose/foundation/text/BasicSecureTextField_androidKt$platformAllowsRevealLastTyped$settingsObserver$1$1;->$resolver:Landroidx/compose/foundation/text/ContentResolverForSecureTextField;

    invoke-interface {v1}, Landroidx/compose/foundation/text/ContentResolverForSecureTextField;->getShowPassword()Z

    move-result v1

    invoke-static {v0, v1}, Landroidx/compose/foundation/text/BasicSecureTextField_androidKt;->access$platformAllowsRevealLastTyped$lambda$3(Landroidx/compose/runtime/MutableState;Z)V
