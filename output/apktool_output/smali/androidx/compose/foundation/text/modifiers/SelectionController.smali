...
.method private constructor <init>(JLandroidx/compose/foundation/text/selection/SelectionRegistrar;JLandroidx/compose/foundation/text/modifiers/StaticTextSelectionParams;)V
    ...
    .line 81
    new-instance v3, Landroidx/compose/foundation/text/modifiers/SelectionController$$ExternalSyntheticLambda2;

    invoke-direct {v3, p0}, Landroidx/compose/foundation/text/modifiers/SelectionController$$ExternalSyntheticLambda2;-><init>(Landroidx/compose/foundation/text/modifiers/SelectionController;)V

    invoke-static {v0, v1, v2, v3}, Landroidx/compose/foundation/text/modifiers/SelectionController_androidKt;->makeSelectionModifier(Landroidx/compose/foundation/text/selection/SelectionRegistrar;JLkotlin/jvm/functions/Function0;)Landroidx/compose/ui/Modifier;
    ...
    invoke-virtual {v1}, Landroidx/compose/ui/input/pointer/PointerIcon$Companion;->getText()Landroidx/compose/ui/input/pointer/PointerIcon;
...
.method static final modifier$lambda$0(Landroidx/compose/foundation/text/modifiers/SelectionController;)Landroidx/compose/ui/layout/LayoutCoordinates;
    .locals 1
    .param p0, "this$0"    # Landroidx/compose/foundation/text/modifiers/SelectionController;
...
.method public final draw(Landroidx/compose/ui/graphics/drawscope/DrawScope;)V
    ...
    .local v18, "$this$draw_u24lambda_u240":Landroidx/compose/ui/graphics/drawscope/DrawScope;
    const/16 v19, 0x0
    ...
    .local v13, "$v$c$androidx-compose-ui-geometry-Size$-this$0$iv$iv":J
    const/4 v0, 0x0
    ...
    .end local v13    # "$v$c$androidx-compose-ui-geometry-Size$-this$0$iv$iv":J
    move v13, v2
    ...
    .local v2, "$v$c$androidx-compose-ui-geometry-Size$-this$0$iv$iv":J
    const/4 v0, 0x0
    ...
    .end local v2    # "$v$c$androidx-compose-ui-geometry-Size$-this$0$iv$iv":J
    .local v23, "$v$c$androidx-compose-ui-geometry-Size$-this$0$iv$iv":J
    and-long v2, v14, v16
    ...
    .end local v23    # "$v$c$androidx-compose-ui-geometry-Size$-this$0$iv$iv":J
    move v14, v2
    ...
    .line 366
    .local v15, "$v$c$androidx-compose-ui-graphics-ClipOp$-clipOp$0$iv":I
    const/4 v2, 0x0
    ...
    .local v8, "$this$withTransform_u24lambda_u240$iv$iv":Landroidx/compose/ui/graphics/drawscope/DrawContext;
    const/16 v24, 0x0
    ...
    .local v10, "$this$clipRect_rOu3jXo_u24lambda_u240$iv":Landroidx/compose/ui/graphics/drawscope/DrawTransform;
    const/4 v0, 0x0
    ...
    .end local v10    # "$this$clipRect_rOu3jXo_u24lambda_u240$iv":Landroidx/compose/ui/graphics/drawscope/DrawTransform;
    .end local v11    # "left$iv":F
    .end local v12    # "top$iv":F
    .end local v13    # "right$iv":F
    .end local v14    # "bottom$iv":F
    .end local v15    # "$v$c$androidx-compose-ui-graphics-ClipOp$-clipOp$0$iv":I
    .local v27, "left$iv":F
    .local v28, "top$iv":F
    .local v29, "right$iv":F
    .local v30, "bottom$iv":F
    .local v31, "$v$c$androidx-compose-ui-graphics-ClipOp$-clipOp$0$iv":I
    nop

    .line 387
    move-object v10, v8

    .end local v8    # "$this$withTransform_u24lambda_u240$iv$iv":Landroidx/compose/ui/graphics/drawscope/DrawContext;
    .local v10, "$this$withTransform_u24lambda_u240$iv$iv":Landroidx/compose/ui/graphics/drawscope/DrawContext;
    move-object/from16 v8, v26

    .local v8, "$this$draw_u24lambda_u240_u240":Landroidx/compose/ui/graphics/drawscope/DrawScope;
    const/4 v0, 0x0
    ...
    .local v12, "$this$withTransform_u24lambda_u240$iv$iv":Landroidx/compose/ui/graphics/drawscope/DrawContext;
    :try_start_1
    ...
    .end local v12    # "$this$withTransform_u24lambda_u240$iv$iv":Landroidx/compose/ui/graphics/drawscope/DrawContext;
    .local v13, "$this$withTransform_u24lambda_u240$iv$iv":Landroidx/compose/ui/graphics/drawscope/DrawContext;
    const/4 v12, 0x0

    move-object v14, v13

    .end local v13    # "$this$withTransform_u24lambda_u240$iv$iv":Landroidx/compose/ui/graphics/drawscope/DrawContext;
    .local v14, "$this$withTransform_u24lambda_u240$iv$iv":Landroidx/compose/ui/graphics/drawscope/DrawContext;
    const/4 v13, 0x0

    move-object v15, v14

    .end local v14    # "$this$withTransform_u24lambda_u240$iv$iv":Landroidx/compose/ui/graphics/drawscope/DrawContext;
    ...
    .local v32, "$this$withTransform_u24lambda_u240$iv$iv":Landroidx/compose/ui/graphics/drawscope/DrawContext;
    const/4 v15, 0x0

    move-object/from16 v33, v32

    .end local v32    # "$this$withTransform_u24lambda_u240$iv$iv":Landroidx/compose/ui/graphics/drawscope/DrawContext;
    .local v33, "$this$withTransform_u24lambda_u240$iv$iv":Landroidx/compose/ui/graphics/drawscope/DrawContext;
    :try_start_2
    ...
    .end local v8    # "$this$draw_u24lambda_u240_u240":Landroidx/compose/ui/graphics/drawscope/DrawScope;
    nop
    ...
    .end local v33    # "$this$withTransform_u24lambda_u240$iv$iv":Landroidx/compose/ui/graphics/drawscope/DrawContext;
    .restart local v14    # "$this$withTransform_u24lambda_u240$iv$iv":Landroidx/compose/ui/graphics/drawscope/DrawContext;
    ...
    .end local v31    # "$v$c$androidx-compose-ui-graphics-ClipOp$-clipOp$0$iv":I
    goto :goto_4
    ...
    .restart local v31    # "$v$c$androidx-compose-ui-graphics-ClipOp$-clipOp$0$iv":I
    .restart local v33    # "$this$withTransform_u24lambda_u240$iv$iv":Landroidx/compose/ui/graphics/drawscope/DrawContext;
    :catchall_0
    move-exception v0
    ...
    .end local v14    # "$this$withTransform_u24lambda_u240$iv$iv":Landroidx/compose/ui/graphics/drawscope/DrawContext;
    .restart local v12    # "$this$withTransform_u24lambda_u240$iv$iv":Landroidx/compose/ui/graphics/drawscope/DrawContext;
    :catchall_1
    move-exception v0
    ...
    .end local v18    # "$this$draw_u24lambda_u240":Landroidx/compose/ui/graphics/drawscope/DrawScope;
    .local v8, "$this$draw_u24lambda_u240":Landroidx/compose/ui/graphics/drawscope/DrawScope;
    invoke-static/range {v8 .. v17}, Landroidx/compose/ui/graphics/drawscope/DrawScope;->drawPath-LG529CI$default(Landroidx/compose/ui/graphics/drawscope/DrawScope;Landroidx/compose/ui/graphics/Path;JFLandroidx/compose/ui/graphics/drawscope/DrawStyle;Landroidx/compose/ui/graphics/ColorFilter;IILjava/lang/Object;)V
    ...
    .line 158
    .end local v8    # "$this$draw_u24lambda_u240":Landroidx/compose/ui/graphics/drawscope/DrawScope;
