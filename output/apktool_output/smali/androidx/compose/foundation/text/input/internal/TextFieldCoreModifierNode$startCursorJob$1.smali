...
.method static final invokeSuspend$lambda$0(Landroidx/compose/foundation/text/input/internal/TextFieldCoreModifierNode;Lkotlin/jvm/internal/Ref$IntRef;)I
    .locals 5
    .param p0, "this$0"    # Landroidx/compose/foundation/text/input/internal/TextFieldCoreModifierNode;
    .param p1, "$sign"    # Lkotlin/jvm/internal/Ref$IntRef;
    ...
    .line 615
    invoke-virtual {p0}, Landroidx/compose/foundation/text/input/internal/TextFieldCoreModifierNode;->isAttached()Z
    ...
    .line 617
    .local v3, "$i$a$-also-TextFieldCoreModifierNode$startCursorJob$1$1$1":I
    ...
    .end local v2    # "it":I
    .end local v3    # "$i$a$-also-TextFieldCoreModifierNode$startCursorJob$1$1$1":I
    return v1
.end method
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .local v1, "sign":Lkotlin/jvm/internal/Ref$IntRef;
    const/4 v2, 0x1
    ...
    new-instance v4, Landroidx/compose/foundation/text/input/internal/TextFieldCoreModifierNode$startCursorJob$1$$ExternalSyntheticLambda0;

    invoke-direct {v4, v3, v1}, Landroidx/compose/foundation/text/input/internal/TextFieldCoreModifierNode$startCursorJob$1$$ExternalSyntheticLambda0;-><init>(Landroidx/compose/foundation/text/input/internal/TextFieldCoreModifierNode;Lkotlin/jvm/internal/Ref$IntRef;)V
    ...
    .line 619
    .end local v1    # "sign":Lkotlin/jvm/internal/Ref$IntRef;
    new-instance v3, Landroidx/compose/foundation/text/input/internal/TextFieldCoreModifierNode$startCursorJob$1$2;

    iget-object v4, p0, Landroidx/compose/foundation/text/input/internal/TextFieldCoreModifierNode$startCursorJob$1;->this$0:Landroidx/compose/foundation/text/input/internal/TextFieldCoreModifierNode;

    const/4 v5, 0x0

    invoke-direct {v3, v4, v5}, Landroidx/compose/foundation/text/input/internal/TextFieldCoreModifierNode$startCursorJob$1$2;-><init>(Landroidx/compose/foundation/text/input/internal/TextFieldCoreModifierNode;Lkotlin/coroutines/Continuation;)V
    ...
    invoke-static {v1, v3, v4}, Lkotlinx/coroutines/flow/FlowKt;->collectLatest(Lkotlinx/coroutines/flow/Flow;Lkotlin/jvm/functions/Function2;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
