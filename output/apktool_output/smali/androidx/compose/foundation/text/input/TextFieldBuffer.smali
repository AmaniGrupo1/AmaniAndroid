...
.method public constructor <init>(Landroidx/compose/foundation/text/input/TextFieldCharSequence;Landroidx/compose/foundation/text/input/internal/ChangeTracker;Landroidx/compose/foundation/text/input/TextFieldCharSequence;Landroidx/compose/foundation/text/input/internal/OffsetMappingCalculator;)V
    ...
    .local v0, "size$iv":I
    new-instance v1, Landroidx/compose/foundation/text/input/TextFieldBuffer$$ExternalSyntheticLambda0;

    invoke-direct {v1, p1}, Landroidx/compose/foundation/text/input/TextFieldBuffer$$ExternalSyntheticLambda0;-><init>(Landroidx/compose/foundation/text/input/TextFieldCharSequence;)V
    ...
    new-array v5, v0, [Landroidx/compose/ui/text/AnnotatedString$Range;
    ...
    .line 773
    .local v5, "arr$iv":[Ljava/lang/Object;
    :cond_3
    new-instance v6, Landroidx/compose/runtime/collection/MutableVector;

    invoke-direct {v6, v5, v0}, Landroidx/compose/runtime/collection/MutableVector;-><init>([Ljava/lang/Object;I)V
    ...
    .end local v5    # "arr$iv":[Ljava/lang/Object;
    goto :goto_4
    ...
    :cond_5
    iput-boolean v2, p0, Landroidx/compose/foundation/text/input/TextFieldBuffer;->canCallAddStyle:Z
...
.method static final composingAnnotations$lambda$0(Landroidx/compose/foundation/text/input/TextFieldCharSequence;I)Landroidx/compose/ui/text/AnnotatedString$Range;
    .locals 1
    .param p0, "$initialValue"    # Landroidx/compose/foundation/text/input/TextFieldCharSequence;
    .param p1, "it"    # I
...
.method public static synthetic toTextFieldCharSequence-wFTz33Y$foundation$default(Landroidx/compose/foundation/text/input/TextFieldBuffer;JLandroidx/compose/ui/text/TextRange;Ljava/util/List;Ljava/util/List;ILjava/lang/Object;)Landroidx/compose/foundation/text/input/TextFieldCharSequence;
    ...
    .line 771
    .local p3, "it":Ljava/util/List;
    const/4 p4, 0x0

    .line 454
    .local p4, "$i$a$-takeIf-TextFieldBuffer$toTextFieldCharSequence$1":I
    move-object p7, p3
    ...
    .end local p3    # "it":Ljava/util/List;
    .end local p4    # "$i$a$-takeIf-TextFieldBuffer$toTextFieldCharSequence$1":I
    if-nez p7, :cond_2
...
.method public final addAnnotation$foundation(Landroidx/compose/ui/text/AnnotatedString$Annotation;II)V
    .locals 3
    .param p1, "annotation"    # Landroidx/compose/ui/text/AnnotatedString$Annotation;
    .param p2, "start"    # I
    .param p3, "end"    # I
    ...
    .line 486
    .local v2, "$i$a$-checkPrecondition-TextFieldBuffer$addAnnotation$1":I
    nop

    .line 844
    .end local v2    # "$i$a$-checkPrecondition-TextFieldBuffer$addAnnotation$1":I
    const-string/jumbo v2, "You can add styling to a [TextFieldBuffer] only from an [OutputTransformation]."
...
.method public final addStyle(Landroidx/compose/ui/text/ParagraphStyle;II)V
    ...
    invoke-virtual {p0, v0, p2, p3}, Landroidx/compose/foundation/text/input/TextFieldBuffer;->addAnnotation$foundation(Landroidx/compose/ui/text/AnnotatedString$Annotation;II)V
...
.method public append(C)Ljava/lang/Appendable;
    ...
    .local v0, "$this$append_u24lambda_u242":Landroidx/compose/foundation/text/input/TextFieldBuffer;
    const/4 v1, 0x0
    ...
    .line 350
    .end local v0    # "$this$append_u24lambda_u242":Landroidx/compose/foundation/text/input/TextFieldBuffer;
...
.method public append(Ljava/lang/CharSequence;)Ljava/lang/Appendable;
    ...
    .local v0, "$this$append_u24lambda_u240":Landroidx/compose/foundation/text/input/TextFieldBuffer;
    const/4 v1, 0x0
    ...
    .line 332
    .end local v0    # "$this$append_u24lambda_u240":Landroidx/compose/foundation/text/input/TextFieldBuffer;
...
.method public append(Ljava/lang/CharSequence;II)Ljava/lang/Appendable;
    ...
    .local v0, "$this$append_u24lambda_u241":Landroidx/compose/foundation/text/input/TextFieldBuffer;
    const/4 v1, 0x0
    ...
    .line 341
    .end local v0    # "$this$append_u24lambda_u241":Landroidx/compose/foundation/text/input/TextFieldBuffer;
...
.method public final setSelection-5zc-tL8(J)V
    .locals 1
    .param p1, "$v$c$androidx-compose-ui-text-TextRange$-value$0"    # J
...
.method public final setTextIfChanged$foundation(Ljava/lang/CharSequence;)V
    ...
    .local v1, "b$iv":Ljava/lang/CharSequence;
    const/4 v2, 0x0

    .line 790
    .local v2, "$i$f$findCommonPrefixAndSuffix":I
    const/4 v3, 0x0

    .line 791
    .local v3, "aStart$iv":I
    ...
    .line 798
    .local v7, "prefixFound$iv":Z
    const/4 v8, 0x0

    .line 801
    .local v8, "suffixFound$iv":Z
    :cond_2
    if-nez v7, :cond_4
    ...
    .line 829
    .end local v7    # "prefixFound$iv":Z
    .end local v8    # "suffixFound$iv":Z
    :cond_7
    if-lt v3, v4, :cond_8
    ...
    .line 325
    .local v13, "$i$a$-findCommonPrefixAndSuffix-TextFieldBuffer$setTextIfChanged$1":I
    move-object v7, p0
    ...
    .end local v13    # "$i$a$-findCommonPrefixAndSuffix-TextFieldBuffer$setTextIfChanged$1":I
    nop
    ...
    .end local v1    # "b$iv":Ljava/lang/CharSequence;
    .end local v2    # "$i$f$findCommonPrefixAndSuffix":I
    .end local v3    # "aStart$iv":I
    .end local v4    # "aEnd$iv":I
    .end local v5    # "bStart$iv":I
    .end local v6    # "bEnd$iv":I
    :goto_3
    return-void
.end method
...
.method public final toTextFieldCharSequence-wFTz33Y$foundation(JLandroidx/compose/ui/text/TextRange;Ljava/util/List;Ljava/util/List;)Landroidx/compose/foundation/text/input/TextFieldCharSequence;
    .locals 10
    .param p1, "$v$c$androidx-compose-ui-text-TextRange$-selection$0"    # J
    .param p3, "composition"    # Landroidx/compose/ui/text/TextRange;
    .param p4, "composingAnnotations"    # Ljava/util/List;
    .param p5, "outputAnnotations"    # Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(J",
            "Landroidx/compose/ui/text/TextRange;",
    ...
    .end local p1    # "$v$c$androidx-compose-ui-text-TextRange$-selection$0":J
    .end local p3    # "composition":Landroidx/compose/ui/text/TextRange;
    .end local p4    # "composingAnnotations":Ljava/util/List;
    .end local p5    # "outputAnnotations":Ljava/util/List;
    ...
    .local v7, "outputAnnotations":Ljava/util/List;
