...
.method static constructor <clinit>()V
    ...
    sput v0, Landroidx/compose/foundation/text/input/internal/AndroidLegacyPlatformTextInputServiceAdapter;->$stable:I
...
.method public static final synthetic access$getStylusHandwritingTrigger(Landroidx/compose/foundation/text/input/internal/AndroidLegacyPlatformTextInputServiceAdapter;)Lkotlinx/coroutines/flow/MutableSharedFlow;
    .locals 1
    .param p0, "$this"    # Landroidx/compose/foundation/text/input/internal/AndroidLegacyPlatformTextInputServiceAdapter;
...
.method public static final synthetic access$setCurrentRequest$p(Landroidx/compose/foundation/text/input/internal/AndroidLegacyPlatformTextInputServiceAdapter;Landroidx/compose/foundation/text/input/internal/LegacyTextInputMethodRequest;)V
    .locals 0
    .param p0, "$this"    # Landroidx/compose/foundation/text/input/internal/AndroidLegacyPlatformTextInputServiceAdapter;
    .param p1, "<set-?>"    # Landroidx/compose/foundation/text/input/internal/LegacyTextInputMethodRequest;
...
.method public static final synthetic access$startInput$localToScreen(Landroidx/compose/foundation/text/input/internal/LegacyPlatformTextInputServiceAdapter$LegacyPlatformTextInputNode;[F)V
    .locals 0
    .param p0, "node"    # Landroidx/compose/foundation/text/input/internal/LegacyPlatformTextInputServiceAdapter$LegacyPlatformTextInputNode;
    .param p1, "matrix"    # [F
...
.method private final getStylusHandwritingTrigger()Lkotlinx/coroutines/flow/MutableSharedFlow;
    ...
    .line 82
    .local v3, "$i$a$-also-AndroidLegacyPlatformTextInputServiceAdapter$stylusHandwritingTrigger$1":I
    iput-object v2, p0, Landroidx/compose/foundation/text/input/internal/AndroidLegacyPlatformTextInputServiceAdapter;->backingStylusHandwritingTrigger:Lkotlinx/coroutines/flow/MutableSharedFlow;

    .line 78
    .end local v2    # "it":Lkotlinx/coroutines/flow/MutableSharedFlow;
    .end local v3    # "$i$a$-also-AndroidLegacyPlatformTextInputServiceAdapter$stylusHandwritingTrigger$1":I
    return-object v1
.end method

.method private final startInput(Lkotlin/jvm/functions/Function1;)V
    .locals 3
    .param p1, "initializeRequest"    # Lkotlin/jvm/functions/Function1;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 114
    invoke-virtual {p0}, Landroidx/compose/foundation/text/input/internal/AndroidLegacyPlatformTextInputServiceAdapter;->getTextInputModifierNode()Landroidx/compose/foundation/text/input/internal/LegacyPlatformTextInputServiceAdapter$LegacyPlatformTextInputNode;
    ...
    .line 123
    .local v0, "node":Landroidx/compose/foundation/text/input/internal/LegacyPlatformTextInputServiceAdapter$LegacyPlatformTextInputNode;
    :cond_0
    nop
...
.method static final startInput$lambda$0(Landroidx/compose/ui/text/input/TextFieldValue;Landroidx/compose/foundation/text/input/internal/AndroidLegacyPlatformTextInputServiceAdapter;Landroidx/compose/ui/text/input/ImeOptions;Lkotlin/jvm/functions/Function1;Lkotlin/jvm/functions/Function1;Landroidx/compose/foundation/text/input/internal/LegacyTextInputMethodRequest;)Lkotlin/Unit;
    ...
    .param p5, "it"    # Landroidx/compose/foundation/text/input/internal/LegacyTextInputMethodRequest;
    ...
    .line 94
    invoke-virtual {p1}, Landroidx/compose/foundation/text/input/internal/AndroidLegacyPlatformTextInputServiceAdapter;->getTextInputModifierNode()Landroidx/compose/foundation/text/input/internal/LegacyPlatformTextInputServiceAdapter$LegacyPlatformTextInputNode;
    ...
    .end local p2    # "$imeOptions":Landroidx/compose/ui/text/input/ImeOptions;
    .end local p3    # "$onEditCommand":Lkotlin/jvm/functions/Function1;
    .end local p4    # "$onImeActionPerformed":Lkotlin/jvm/functions/Function1;
    .end local p5    # "it":Landroidx/compose/foundation/text/input/internal/LegacyTextInputMethodRequest;
    .local v0, "it":Landroidx/compose/foundation/text/input/internal/LegacyTextInputMethodRequest;
    ...
    .local v4, "$onEditCommand":Lkotlin/jvm/functions/Function1;
    .local v5, "$onImeActionPerformed":Lkotlin/jvm/functions/Function1;
...
.method private static final startInput$localToScreen(Landroidx/compose/foundation/text/input/internal/LegacyPlatformTextInputServiceAdapter$LegacyPlatformTextInputNode;[F)V
    ...
    .line 117
    .local v2, "$i$a$-takeIf-AndroidLegacyPlatformTextInputServiceAdapter$startInput$localToScreen$coordinates$1":I
    invoke-interface {v1}, Landroidx/compose/ui/layout/LayoutCoordinates;->isAttached()Z

    move-result v1

    .end local v1    # "it":Landroidx/compose/ui/layout/LayoutCoordinates;
    .end local v2    # "$i$a$-takeIf-AndroidLegacyPlatformTextInputServiceAdapter$startInput$localToScreen$coordinates$1":I
    if-eqz v1, :cond_0
...
.method public updateTextLayoutResult(Landroidx/compose/ui/text/input/TextFieldValue;Landroidx/compose/ui/text/input/OffsetMapping;Landroidx/compose/ui/text/TextLayoutResult;Lkotlin/jvm/functions/Function1;Landroidx/compose/ui/geometry/Rect;Landroidx/compose/ui/geometry/Rect;)V
    ...
    .end local v1    # "textFieldValue":Landroidx/compose/ui/text/input/TextFieldValue;
    .end local v2    # "offsetMapping":Landroidx/compose/ui/text/input/OffsetMapping;
    .end local v3    # "textLayoutResult":Landroidx/compose/ui/text/TextLayoutResult;
    .end local v4    # "innerTextFieldBounds":Landroidx/compose/ui/geometry/Rect;
    .end local v5    # "decorationBoxBounds":Landroidx/compose/ui/geometry/Rect;
    .restart local p1    # "textFieldValue":Landroidx/compose/ui/text/input/TextFieldValue;
    .restart local p2    # "offsetMapping":Landroidx/compose/ui/text/input/OffsetMapping;
    .restart local p3    # "textLayoutResult":Landroidx/compose/ui/text/TextLayoutResult;
    .restart local p5    # "innerTextFieldBounds":Landroidx/compose/ui/geometry/Rect;
    .restart local p6    # "decorationBoxBounds":Landroidx/compose/ui/geometry/Rect;
    :cond_0
    move-object v1, p1
    ...
    .end local p5    # "innerTextFieldBounds":Landroidx/compose/ui/geometry/Rect;
    .end local p6    # "decorationBoxBounds":Landroidx/compose/ui/geometry/Rect;
    .restart local v1    # "textFieldValue":Landroidx/compose/ui/text/input/TextFieldValue;
    .restart local v2    # "offsetMapping":Landroidx/compose/ui/text/input/OffsetMapping;
    .restart local v3    # "textLayoutResult":Landroidx/compose/ui/text/TextLayoutResult;
    .restart local v4    # "innerTextFieldBounds":Landroidx/compose/ui/geometry/Rect;
    .restart local v5    # "decorationBoxBounds":Landroidx/compose/ui/geometry/Rect;
    :goto_0
    return-void
.end method
