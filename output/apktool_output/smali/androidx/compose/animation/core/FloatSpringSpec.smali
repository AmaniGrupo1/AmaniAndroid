...
.method public getValueFromNanos(JFFF)F
    ...
    invoke-virtual {v2, p3, p5, v0, v1}, Landroidx/compose/animation/core/SpringSimulation;->updateValues-IJZedt4$animation_core(FFJ)J

    move-result-wide v2

    .local v2, "$v$c$androidx-compose-animation-core-Motion$-this$0$iv":J
    const/4 v4, 0x0

    .line 261
    .local v4, "$i$f$getValue-impl":I
    move-wide v5, v2
    ...
    .line 154
    .end local v2    # "$v$c$androidx-compose-animation-core-Motion$-this$0$iv":J
    .end local v4    # "$i$f$getValue-impl":I
    return v8
.end method
...
.method public getVelocityFromNanos(JFFF)F
    ...
    .line 264
    .local v4, "$i$f$getVelocity-impl":I
    move-wide v5, v2
    ...
    .line 166
    .end local v2    # "$v$c$androidx-compose-animation-core-Motion$-this$0$iv":J
    .end local v4    # "$i$f$getVelocity-impl":I
    return v8
.end method
