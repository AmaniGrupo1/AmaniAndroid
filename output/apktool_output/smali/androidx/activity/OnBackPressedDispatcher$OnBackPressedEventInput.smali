...
.method public constructor <init>(Landroidx/activity/OnBackPressedDispatcher;)V
    ...
    iget-object v1, p0, Landroidx/activity/OnBackPressedDispatcher$OnBackPressedEventInput;->this$0:Landroidx/activity/OnBackPressedDispatcher;

    new-instance v2, Landroidx/activity/OnBackPressedDispatcher$OnBackPressedEventInput$$ExternalSyntheticLambda0;

    invoke-direct {v2, v1}, Landroidx/activity/OnBackPressedDispatcher$OnBackPressedEventInput$$ExternalSyntheticLambda0;-><init>(Landroidx/activity/OnBackPressedDispatcher;)V

    invoke-direct {v0, v2}, Landroidx/navigationevent/NavigationEventDispatcher;-><init>(Landroidx/navigationevent/OnBackCompletedFallback;)V

    .line 346
    move-object v1, v0

    .local v1, "it":Landroidx/navigationevent/NavigationEventDispatcher;
    const/4 v2, 0x0

    .line 271
    .local v2, "$i$a$-also-OnBackPressedDispatcher$OnBackPressedEventInput$dispatcher$2":I
    move-object v3, p0

    check-cast v3, Landroidx/navigationevent/NavigationEventInput;

    invoke-virtual {v1, v3}, Landroidx/navigationevent/NavigationEventDispatcher;->addInput(Landroidx/navigationevent/NavigationEventInput;)V

    .end local v1    # "it":Landroidx/navigationevent/NavigationEventDispatcher;
    .end local v2    # "$i$a$-also-OnBackPressedDispatcher$OnBackPressedEventInput$dispatcher$2":I
