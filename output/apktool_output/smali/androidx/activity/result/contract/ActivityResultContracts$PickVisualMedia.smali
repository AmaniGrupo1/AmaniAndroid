...
.method public createIntent(Landroid/content/Context;Landroidx/activity/result/PickVisualMediaRequest;)Landroid/content/Intent;
    ...
    invoke-virtual {v3, v4}, Landroidx/activity/result/contract/ActivityResultContracts$PickVisualMedia$Companion;->getVisualMimeType$activity(Landroidx/activity/result/contract/ActivityResultContracts$PickVisualMedia$VisualMediaType;)Ljava/lang/String;
    ...
    const-string/jumbo v4, "android.provider.extra.PICK_IMAGES_LAUNCH_TAB"
    ...
    .line 887
    const-string/jumbo v3, "android.provider.extra.PICK_IMAGES_ACCENT_COLOR"
    ...
    .local v3, "capabilities":Landroidx/activity/result/contract/ActivityResultContracts$PickVisualMedia$MediaCapabilities;
    const/4 v4, 0x0

    .line 892
    .local v4, "$i$a$-let-ActivityResultContracts$PickVisualMedia$createIntent$1$1":I
    nop
    ...
    .line 894
    invoke-virtual {v3}, Landroidx/activity/result/contract/ActivityResultContracts$PickVisualMedia$MediaCapabilities;->toApplicationMediaCapabilities$activity()Landroid/media/ApplicationMediaCapabilities;
    ...
    .line 892
    const-string/jumbo v6, "android.provider.extra.MEDIA_CAPABILITIES"
    ...
    .line 891
    .end local v3    # "capabilities":Landroidx/activity/result/contract/ActivityResultContracts$PickVisualMedia$MediaCapabilities;
    .end local v4    # "$i$a$-let-ActivityResultContracts$PickVisualMedia$createIntent$1$1":I
    nop
    ...
    const-string/jumbo v5, "androidx.activity.result.contract.extra.PICK_IMAGES_LAUNCH_TAB"
    ...
    .line 907
    const-string/jumbo v4, "androidx.activity.result.contract.extra.PICK_IMAGES_ACCENT_COLOR"
...
.method public final parseResult(ILandroid/content/Intent;)Landroid/net/Uri;
    ...
    .local v1, "$this$parseResult_u24lambda_u241":Landroid/content/Intent;
    const/4 v0, 0x0
    ...
    invoke-virtual {v2, v1}, Landroidx/activity/result/contract/ActivityResultContracts$GetMultipleContents$Companion;->getClipDataUris$activity(Landroid/content/Intent;)Ljava/util/List;
    ...
    .end local v1    # "$this$parseResult_u24lambda_u241":Landroid/content/Intent;
    :cond_3
    nop
