...
.method public dispose()V
    ...
    .line 70
    .local v0, "$i$a$-onDispose-BackHandlerKt$BackHandler$3$1$1":I
    iget-object v1, p0, Landroidx/activity/compose/BackHandlerKt$BackHandler$lambda$4$0$$inlined$onDispose$1;->$dispatcher$inlined:Landroidx/activity/compose/internal/BackHandlerDispatcherCompat;

    iget-object v2, p0, Landroidx/activity/compose/BackHandlerKt$BackHandler$lambda$4$0$$inlined$onDispose$1;->$handler$inlined:Landroidx/activity/compose/ComposeBackHandler;

    check-cast v2, Landroidx/activity/compose/internal/BackHandlerCompat;

    invoke-virtual {v1, v2}, Landroidx/activity/compose/internal/BackHandlerDispatcherCompat;->removeHandler(Landroidx/activity/compose/internal/BackHandlerCompat;)V

    .line 68
    .end local v0    # "$i$a$-onDispose-BackHandlerKt$BackHandler$3$1$1":I
    nop
