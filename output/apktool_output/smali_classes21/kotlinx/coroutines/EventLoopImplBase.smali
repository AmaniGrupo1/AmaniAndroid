...
.method private final closeQueue()V
    ...
    .line 349
    .local v3, "$i$a$-loop$atomicfu$ATOMIC_FIELD_UPDATER$Any-EventLoopImplBase$closeQueue$2":I
    nop
    ...
    const-string/jumbo v5, "null cannot be cast to non-null type java.lang.Runnable"
    ...
    .end local v3    # "$i$a$-loop$atomicfu$ATOMIC_FIELD_UPDATER$Any-EventLoopImplBase$closeQueue$2":I
    goto :goto_1
.end method
...
.method private final dequeue()Ljava/lang/Runnable;
    ...
    .line 312
    .local v3, "$i$a$-loop$atomicfu$ATOMIC_FIELD_UPDATER$Any-EventLoopImplBase$dequeue$1":I
    nop
    ...
    .line 315
    const-string/jumbo v4, "null cannot be cast to non-null type kotlinx.coroutines.internal.LockFreeTaskQueueCore<java.lang.Runnable>"
    ...
    const-string/jumbo v4, "null cannot be cast to non-null type java.lang.Runnable"
    ...
    .end local v2    # "queue":Ljava/lang/Object;
    .end local v3    # "$i$a$-loop$atomicfu$ATOMIC_FIELD_UPDATER$Any-EventLoopImplBase$dequeue$1":I
    goto :goto_0
.end method
...
.method private final enqueueImpl(Ljava/lang/Runnable;)Z
    ...
    .line 285
    .local v3, "$i$a$-loop$atomicfu$ATOMIC_FIELD_UPDATER$Any-EventLoopImplBase$enqueueImpl$1":I
    invoke-direct {p0}, Lkotlinx/coroutines/EventLoopImplBase;->isCompleted()Z
    ...
    .line 289
    const-string/jumbo v6, "null cannot be cast to non-null type kotlinx.coroutines.internal.LockFreeTaskQueueCore<java.lang.Runnable>"
    ...
    const-string/jumbo v6, "null cannot be cast to non-null type java.lang.Runnable"
    ...
    .end local v2    # "queue":Ljava/lang/Object;
    .end local v3    # "$i$a$-loop$atomicfu$ATOMIC_FIELD_UPDATER$Any-EventLoopImplBase$enqueueImpl$1":I
    goto :goto_0
