...
.method public static synthetic $r8$lambda$A3AggpeIcVTXny9TWGNUBxfCgaU(ZLkotlin/io/path/CopyActionContext;Ljava/nio/file/Path;Ljava/nio/file/Path;)Lkotlin/io/path/CopyActionResult;
    .locals 0

    invoke-static {p0, p1, p2, p3}, Lkotlin/io/path/PathsKt__PathRecursiveFunctionsKt;->copyToRecursively$lambda$3$PathsKt__PathRecursiveFunctionsKt(ZLkotlin/io/path/CopyActionContext;Ljava/nio/file/Path;Ljava/nio/file/Path;)Lkotlin/io/path/CopyActionResult;
...
.method public static synthetic $r8$lambda$De4yXv8T0vx7waJvVzG_4HFVSss(Ljava/nio/file/Path;Ljava/nio/file/Path;Ljava/lang/Exception;)Lkotlin/io/path/OnErrorResult;
    .locals 0

    invoke-static {p0, p1, p2}, Lkotlin/io/path/PathsKt__PathRecursiveFunctionsKt;->copyToRecursively$lambda$2$PathsKt__PathRecursiveFunctionsKt(Ljava/nio/file/Path;Ljava/nio/file/Path;Ljava/lang/Exception;)Lkotlin/io/path/OnErrorResult;
...
.method public static synthetic $r8$lambda$IkZ125cv9leHdM_R4zOtmPWi6nc(Ljava/util/ArrayList;Lkotlin/jvm/functions/Function3;Ljava/nio/file/Path;Ljava/nio/file/Path;Ljava/nio/file/Path;Ljava/nio/file/Path;Ljava/io/IOException;)Ljava/nio/file/FileVisitResult;
    .locals 0

    invoke-static/range {p0 .. p6}, Lkotlin/io/path/PathsKt__PathRecursiveFunctionsKt;->copyToRecursively$lambda$5$1$PathsKt__PathRecursiveFunctionsKt(Ljava/util/ArrayList;Lkotlin/jvm/functions/Function3;Ljava/nio/file/Path;Ljava/nio/file/Path;Ljava/nio/file/Path;Ljava/nio/file/Path;Ljava/io/IOException;)Ljava/nio/file/FileVisitResult;
...
.method public static synthetic $r8$lambda$Q20yqNtXDRXNb_l9dEjE2GC-B44(Ljava/util/ArrayList;Lkotlin/jvm/functions/Function3;Ljava/nio/file/Path;Ljava/nio/file/Path;Ljava/nio/file/Path;Lkotlin/jvm/functions/Function3;Ljava/nio/file/Path;Ljava/nio/file/attribute/BasicFileAttributes;)Ljava/nio/file/FileVisitResult;
    .locals 0

    invoke-static/range {p0 .. p7}, Lkotlin/io/path/PathsKt__PathRecursiveFunctionsKt;->copyToRecursively$lambda$5$0$PathsKt__PathRecursiveFunctionsKt(Ljava/util/ArrayList;Lkotlin/jvm/functions/Function3;Ljava/nio/file/Path;Ljava/nio/file/Path;Ljava/nio/file/Path;Lkotlin/jvm/functions/Function3;Ljava/nio/file/Path;Ljava/nio/file/attribute/BasicFileAttributes;)Ljava/nio/file/FileVisitResult;
...
.method public static synthetic $r8$lambda$RTX0Ejym-JswkQvhEjqK7fQVJOQ(Ljava/nio/file/Path;Ljava/nio/file/Path;Ljava/lang/Exception;)Lkotlin/io/path/OnErrorResult;
    .locals 0

    invoke-static {p0, p1, p2}, Lkotlin/io/path/PathsKt__PathRecursiveFunctionsKt;->copyToRecursively$lambda$0$PathsKt__PathRecursiveFunctionsKt(Ljava/nio/file/Path;Ljava/nio/file/Path;Ljava/lang/Exception;)Lkotlin/io/path/OnErrorResult;
...
.method public static synthetic $r8$lambda$iE84oOjPIAfm60pr-kh4MNeINmU(Ljava/util/ArrayList;Lkotlin/jvm/functions/Function3;Ljava/nio/file/Path;Ljava/nio/file/Path;Ljava/nio/file/Path;Lkotlin/jvm/functions/Function3;Lkotlin/io/path/FileVisitorBuilder;)Lkotlin/Unit;
    .locals 0

    invoke-static/range {p0 .. p6}, Lkotlin/io/path/PathsKt__PathRecursiveFunctionsKt;->copyToRecursively$lambda$5$PathsKt__PathRecursiveFunctionsKt(Ljava/util/ArrayList;Lkotlin/jvm/functions/Function3;Ljava/nio/file/Path;Ljava/nio/file/Path;Ljava/nio/file/Path;Lkotlin/jvm/functions/Function3;Lkotlin/io/path/FileVisitorBuilder;)Lkotlin/Unit;
...
.method public static final copyToRecursively(Ljava/nio/file/Path;Ljava/nio/file/Path;Lkotlin/jvm/functions/Function3;ZLkotlin/jvm/functions/Function3;)Ljava/nio/file/Path;
    ...
    .line 537
    .local v8, "it":Ljava/nio/file/Path;
    const/4 v9, 0x0
    ...
    .line 186
    .end local v8    # "it":Ljava/nio/file/Path;
    ...
    .line 222
    .local v5, "normalizedTarget":Ljava/nio/file/Path;
    ...
    new-instance v3, Lkotlin/io/path/PathsKt__PathRecursiveFunctionsKt$$ExternalSyntheticLambda3;
    ...
    invoke-direct/range {v0 .. v6}, Lkotlin/io/path/PathsKt__PathRecursiveFunctionsKt$$ExternalSyntheticLambda3;-><init>(Ljava/util/ArrayList;Lkotlin/jvm/functions/Function3;Ljava/nio/file/Path;Ljava/nio/file/Path;Ljava/nio/file/Path;Lkotlin/jvm/functions/Function3;)V
    ...
    .end local v5    # "normalizedTarget":Ljava/nio/file/Path;
    .local v6, "normalizedTarget":Ljava/nio/file/Path;
    ...
    .line 172
    .end local v6    # "normalizedTarget":Ljava/nio/file/Path;
...
.method public static final copyToRecursively(Ljava/nio/file/Path;Ljava/nio/file/Path;Lkotlin/jvm/functions/Function3;ZZ)Ljava/nio/file/Path;
    ...
    invoke-direct {v0, p3}, Lkotlin/io/path/PathsKt__PathRecursiveFunctionsKt$$ExternalSyntheticLambda2;-><init>(Z)V
...
.method private static final copyToRecursively$copy$PathsKt__PathRecursiveFunctionsKt(Ljava/util/ArrayList;Lkotlin/jvm/functions/Function3;Ljava/nio/file/Path;Ljava/nio/file/Path;Ljava/nio/file/Path;Lkotlin/jvm/functions/Function3;Ljava/nio/file/Path;Ljava/nio/file/attribute/BasicFileAttributes;)Ljava/nio/file/FileVisitResult;
    ...
    .end local p2    # "$this_copyToRecursively":Ljava/nio/file/Path;
    .end local p3    # "$target":Ljava/nio/file/Path;
    .end local p4    # "normalizedTarget":Ljava/nio/file/Path;
    .end local p5    # "$onError":Lkotlin/jvm/functions/Function3;
    .end local p6    # "source":Ljava/nio/file/Path;
    .local v1, "$onError":Lkotlin/jvm/functions/Function3;
    .local v2, "$this_copyToRecursively":Ljava/nio/file/Path;
    .local v3, "$target":Ljava/nio/file/Path;
    .local v4, "normalizedTarget":Ljava/nio/file/Path;
    .local v5, "source":Ljava/nio/file/Path;
...
.method public static synthetic copyToRecursively$default(Ljava/nio/file/Path;Ljava/nio/file/Path;Lkotlin/jvm/functions/Function3;ZLkotlin/jvm/functions/Function3;ILjava/lang/Object;)Ljava/nio/file/Path;
    ...
    .line 165
    new-instance p2, Lkotlin/io/path/PathsKt__PathRecursiveFunctionsKt$$ExternalSyntheticLambda0;

    invoke-direct {p2}, Lkotlin/io/path/PathsKt__PathRecursiveFunctionsKt$$ExternalSyntheticLambda0;-><init>()V
...
.method public static synthetic copyToRecursively$default(Ljava/nio/file/Path;Ljava/nio/file/Path;Lkotlin/jvm/functions/Function3;ZZILjava/lang/Object;)Ljava/nio/file/Path;
    ...
    .line 78
    new-instance p2, Lkotlin/io/path/PathsKt__PathRecursiveFunctionsKt$$ExternalSyntheticLambda6;

    invoke-direct {p2}, Lkotlin/io/path/PathsKt__PathRecursiveFunctionsKt$$ExternalSyntheticLambda6;-><init>()V
...
.method private static final copyToRecursively$lambda$0$PathsKt__PathRecursiveFunctionsKt(Ljava/nio/file/Path;Ljava/nio/file/Path;Ljava/lang/Exception;)Lkotlin/io/path/OnErrorResult;
    .locals 1
...
.method private static final copyToRecursively$lambda$2$PathsKt__PathRecursiveFunctionsKt(Ljava/nio/file/Path;Ljava/nio/file/Path;Ljava/lang/Exception;)Lkotlin/io/path/OnErrorResult;
    .locals 1
    .param p2, "exception"    # Ljava/lang/Exception;
...
.method private static final copyToRecursively$lambda$3$PathsKt__PathRecursiveFunctionsKt(ZLkotlin/io/path/CopyActionContext;Ljava/nio/file/Path;Ljava/nio/file/Path;)Lkotlin/io/path/CopyActionResult;
    .locals 1
    .param p0, "$followLinks"    # Z
...
.method private static final copyToRecursively$lambda$5$0$PathsKt__PathRecursiveFunctionsKt(Ljava/util/ArrayList;Lkotlin/jvm/functions/Function3;Ljava/nio/file/Path;Ljava/nio/file/Path;Ljava/nio/file/Path;Lkotlin/jvm/functions/Function3;Ljava/nio/file/Path;Ljava/nio/file/attribute/BasicFileAttributes;)Ljava/nio/file/FileVisitResult;
    .locals 4
    .param p0, "$stack"    # Ljava/util/ArrayList;
    .param p1, "$copyAction"    # Lkotlin/jvm/functions/Function3;
    .param p2, "$this_copyToRecursively"    # Ljava/nio/file/Path;
    ...
    .param p4, "$normalizedTarget"    # Ljava/nio/file/Path;
    .param p5, "$onError"    # Lkotlin/jvm/functions/Function3;
    .param p6, "directory"    # Ljava/nio/file/Path;
    .param p7, "attributes"    # Ljava/nio/file/attribute/BasicFileAttributes;
    ...
    .local v1, "it":Ljava/nio/file/FileVisitResult;
    const/4 v2, 0x0
    ...
    .line 240
    .end local v1    # "it":Ljava/nio/file/FileVisitResult;
...
.method private static final copyToRecursively$lambda$5$1$PathsKt__PathRecursiveFunctionsKt(Ljava/util/ArrayList;Lkotlin/jvm/functions/Function3;Ljava/nio/file/Path;Ljava/nio/file/Path;Ljava/nio/file/Path;Ljava/nio/file/Path;Ljava/io/IOException;)Ljava/nio/file/FileVisitResult;
    .locals 7
    .param p0, "$stack"    # Ljava/util/ArrayList;
    ...
    .end local p3    # "$target":Ljava/nio/file/Path;
    .end local p4    # "$normalizedTarget":Ljava/nio/file/Path;
    .end local p5    # "directory":Ljava/nio/file/Path;
    .local v1, "$onError":Lkotlin/jvm/functions/Function3;
    .local v2, "$this_copyToRecursively":Ljava/nio/file/Path;
    .local v3, "$target":Ljava/nio/file/Path;
    .local v4, "$normalizedTarget":Ljava/nio/file/Path;
    .local v5, "directory":Ljava/nio/file/Path;
    invoke-static/range {v1 .. v6}, Lkotlin/io/path/PathsKt__PathRecursiveFunctionsKt;->copyToRecursively$error$PathsKt__PathRecursiveFunctionsKt(Lkotlin/jvm/functions/Function3;Ljava/nio/file/Path;Ljava/nio/file/Path;Ljava/nio/file/Path;Ljava/nio/file/Path;Ljava/lang/Exception;)Ljava/nio/file/FileVisitResult;
...
.method private static final copyToRecursively$lambda$5$PathsKt__PathRecursiveFunctionsKt(Ljava/util/ArrayList;Lkotlin/jvm/functions/Function3;Ljava/nio/file/Path;Ljava/nio/file/Path;Ljava/nio/file/Path;Lkotlin/jvm/functions/Function3;Lkotlin/io/path/FileVisitorBuilder;)Lkotlin/Unit;
    .locals 9
    .param p0, "$stack"    # Ljava/util/ArrayList;
    .param p1, "$copyAction"    # Lkotlin/jvm/functions/Function3;
    .param p2, "$this_copyToRecursively"    # Ljava/nio/file/Path;
    ...
    .line 239
    new-instance v1, Lkotlin/io/path/PathsKt__PathRecursiveFunctionsKt$$ExternalSyntheticLambda4;
    ...
    .local v4, "$this_copyToRecursively":Ljava/nio/file/Path;
    .local v5, "$target":Ljava/nio/file/Path;
    .local v6, "$normalizedTarget":Ljava/nio/file/Path;
    .local v7, "$onError":Lkotlin/jvm/functions/Function3;
    invoke-direct/range {v1 .. v7}, Lkotlin/io/path/PathsKt__PathRecursiveFunctionsKt$$ExternalSyntheticLambda4;-><init>(Ljava/util/ArrayList;Lkotlin/jvm/functions/Function3;Ljava/nio/file/Path;Ljava/nio/file/Path;Ljava/nio/file/Path;Lkotlin/jvm/functions/Function3;)V
    ...
    .end local v4    # "$this_copyToRecursively":Ljava/nio/file/Path;
    .end local v5    # "$target":Ljava/nio/file/Path;
    .end local v6    # "$normalizedTarget":Ljava/nio/file/Path;
    ...
    .local p3, "$this_copyToRecursively":Ljava/nio/file/Path;
    .local p4, "$target":Ljava/nio/file/Path;
    .local p5, "$normalizedTarget":Ljava/nio/file/Path;
    ...
    .end local p2    # "$onError":Lkotlin/jvm/functions/Function3;
    .end local p3    # "$this_copyToRecursively":Ljava/nio/file/Path;
    .end local p4    # "$target":Ljava/nio/file/Path;
    .end local p5    # "$normalizedTarget":Ljava/nio/file/Path;
    .local v3, "$stack":Ljava/util/ArrayList;
    .local v4, "$copyAction":Lkotlin/jvm/functions/Function3;
    .local v5, "$this_copyToRecursively":Ljava/nio/file/Path;
    .local v6, "$target":Ljava/nio/file/Path;
    .local v7, "$normalizedTarget":Ljava/nio/file/Path;
    ...
    .end local v5    # "$this_copyToRecursively":Ljava/nio/file/Path;
    .end local v6    # "$target":Ljava/nio/file/Path;
    .end local v7    # "$normalizedTarget":Ljava/nio/file/Path;
    ...
    .restart local p3    # "$this_copyToRecursively":Ljava/nio/file/Path;
    .restart local p4    # "$target":Ljava/nio/file/Path;
    .restart local p5    # "$normalizedTarget":Ljava/nio/file/Path;
    ...
    .line 246
    new-instance p0, Lkotlin/io/path/PathsKt__PathRecursiveFunctionsKt$$ExternalSyntheticLambda5;

    invoke-direct/range {p0 .. p5}, Lkotlin/io/path/PathsKt__PathRecursiveFunctionsKt$$ExternalSyntheticLambda5;-><init>(Ljava/util/ArrayList;Lkotlin/jvm/functions/Function3;Ljava/nio/file/Path;Ljava/nio/file/Path;Ljava/nio/file/Path;)V
...
.method public static final deleteRecursively(Ljava/nio/file/Path;)V
    ...
    .local v2, "$this$deleteRecursively_u24lambda_u240":Ljava/nio/file/FileSystemException;
    const/4 v3, 0x0
    ...
    .line 317
    .end local v2    # "$this$deleteRecursively_u24lambda_u240":Ljava/nio/file/FileSystemException;
...
.method private static final deleteRecursivelyImpl$PathsKt__PathRecursiveFunctionsKt(Ljava/nio/file/Path;)Ljava/util/List;
    ...
    .local v4, "fileName":Ljava/nio/file/Path;
    const/4 v5, 0x0

    .line 362
    .local v5, "$i$a$-let-PathsKt__PathRecursiveFunctionsKt$deleteRecursivelyImpl$1":I
    ...
    invoke-virtual {v6, v7, v1}, Ljava/nio/file/FileSystem;->getPath(Ljava/lang/String;[Ljava/lang/String;)Ljava/nio/file/Path;
    ...
    :try_start_0
    invoke-static {v6}, Ljava/nio/file/Files;->newDirectoryStream(Ljava/nio/file/Path;)Ljava/nio/file/DirectoryStream;
    ...
    .line 365
    .local v1, "directoryStream":Ljava/nio/file/DirectoryStream;
    :goto_0
    if-eqz v1, :cond_2
    ...
    check-cast v8, Ljava/nio/file/DirectoryStream;

    .local v8, "stream":Ljava/nio/file/DirectoryStream;
    const/4 v9, 0x0

    .line 366
    .local v9, "$i$a$-use-PathsKt__PathRecursiveFunctionsKt$deleteRecursivelyImpl$1$1":I
    instance-of v10, v8, Ljava/nio/file/SecureDirectoryStream;
    ...
    .line 368
    invoke-virtual {v0, v6}, Lkotlin/io/path/ExceptionsCollector;->setPath(Ljava/nio/file/Path;)V

    .line 369
    move-object v10, v8

    check-cast v10, Ljava/nio/file/SecureDirectoryStream;

    invoke-static {v10, v4, v3, v0}, Lkotlin/io/path/PathsKt__PathRecursiveFunctionsKt;->handleEntry$PathsKt__PathRecursiveFunctionsKt(Ljava/nio/file/SecureDirectoryStream;Ljava/nio/file/Path;Ljava/nio/file/Path;Lkotlin/io/path/ExceptionsCollector;)V

    .line 371
    :cond_1
    nop

    .end local v8    # "stream":Ljava/nio/file/DirectoryStream;
    .end local v9    # "$i$a$-use-PathsKt__PathRecursiveFunctionsKt$deleteRecursivelyImpl$1$1":I
    ...
    .end local v1    # "directoryStream":Ljava/nio/file/DirectoryStream;
    .end local v2    # "useInsecure":Z
    .end local v4    # "fileName":Ljava/nio/file/Path;
    .end local v5    # "$i$a$-let-PathsKt__PathRecursiveFunctionsKt$deleteRecursivelyImpl$1":I
    ...
    .restart local v1    # "directoryStream":Ljava/nio/file/DirectoryStream;
    .restart local v2    # "useInsecure":Z
    .restart local v4    # "fileName":Ljava/nio/file/Path;
    .restart local v5    # "$i$a$-let-PathsKt__PathRecursiveFunctionsKt$deleteRecursivelyImpl$1":I
...
.method private static final enterDirectory$PathsKt__PathRecursiveFunctionsKt(Ljava/nio/file/SecureDirectoryStream;Ljava/nio/file/Path;Lkotlin/io/path/ExceptionsCollector;)V
    ...
    .local v0, "collector$iv":Lkotlin/io/path/ExceptionsCollector;
    const/4 v1, 0x0

    .line 548
    .local v1, "$i$f$collectIfThrows":I
    nop
    ...
    .line 427
    .local v2, "$i$a$-collectIfThrows-PathsKt__PathRecursiveFunctionsKt$enterDirectory$1":I
    nop
    ...
    .line 426
    .local v4, "$i$a$-tryIgnoreNoSuchFileException-PathsKt__PathRecursiveFunctionsKt$enterDirectory$1$1":I
    const/4 v5, 0x1
    ...
    .line 550
    .end local v4    # "$i$a$-tryIgnoreNoSuchFileException-PathsKt__PathRecursiveFunctionsKt$enterDirectory$1$1":I
    goto :goto_0

    .line 551
    .end local v2    # "$i$a$-collectIfThrows-PathsKt__PathRecursiveFunctionsKt$enterDirectory$1":I
    ...
    .line 550
    .restart local v2    # "$i$a$-collectIfThrows-PathsKt__PathRecursiveFunctionsKt$enterDirectory$1":I
    .restart local v3    # "$i$f$tryIgnoreNoSuchFileException":I
    :catch_1
    move-exception v4
    ...
    .local v3, "directoryStream":Ljava/nio/file/SecureDirectoryStream;
    const/4 v4, 0x0

    .line 428
    .local v4, "$i$a$-use-PathsKt__PathRecursiveFunctionsKt$enterDirectory$1$2":I
    invoke-interface {v3}, Ljava/nio/file/SecureDirectoryStream;->iterator()Ljava/util/Iterator;
    ...
    .line 429
    .local v8, "entry":Ljava/nio/file/Path;
    ...
    invoke-static {v3, v9, v10, p2}, Lkotlin/io/path/PathsKt__PathRecursiveFunctionsKt;->handleEntry$PathsKt__PathRecursiveFunctionsKt(Ljava/nio/file/SecureDirectoryStream;Ljava/nio/file/Path;Ljava/nio/file/Path;Lkotlin/io/path/ExceptionsCollector;)V

    .end local v8    # "entry":Ljava/nio/file/Path;
    goto :goto_1
    ...
    .end local v3    # "directoryStream":Ljava/nio/file/SecureDirectoryStream;
    .end local v4    # "$i$a$-use-PathsKt__PathRecursiveFunctionsKt$enterDirectory$1$2":I
    ...
    .end local v0    # "collector$iv":Lkotlin/io/path/ExceptionsCollector;
    .end local v1    # "$i$f$collectIfThrows":I
    .end local v2    # "$i$a$-collectIfThrows-PathsKt__PathRecursiveFunctionsKt$enterDirectory$1":I
    ...
    .restart local v0    # "collector$iv":Lkotlin/io/path/ExceptionsCollector;
    .restart local v1    # "$i$f$collectIfThrows":I
    .restart local v2    # "$i$a$-collectIfThrows-PathsKt__PathRecursiveFunctionsKt$enterDirectory$1":I
    ...
    .restart local v0    # "collector$iv":Lkotlin/io/path/ExceptionsCollector;
    .restart local v1    # "$i$f$collectIfThrows":I
    .local v2, "exception$iv":Ljava/lang/Exception;
    .restart local p0    # "$this$enterDirectory":Ljava/nio/file/SecureDirectoryStream;
    .restart local p1    # "name":Ljava/nio/file/Path;
    .restart local p2    # "collector":Lkotlin/io/path/ExceptionsCollector;
    :goto_2
    invoke-virtual {v0, v2}, Lkotlin/io/path/ExceptionsCollector;->collect(Ljava/lang/Exception;)V
...
.method private static final handleEntry$PathsKt__PathRecursiveFunctionsKt(Ljava/nio/file/SecureDirectoryStream;Ljava/nio/file/Path;Ljava/nio/file/Path;Lkotlin/io/path/ExceptionsCollector;)V
    ...
    .line 399
    .local v2, "$i$a$-collectIfThrows-PathsKt__PathRecursiveFunctionsKt$handleEntry$1":I
    if-eqz p2, :cond_0
    ...
    invoke-static {v3}, Lkotlin/io/path/PathsKt;->checkFileName(Ljava/nio/file/Path;)V

    .line 403
    invoke-static {v3, p2}, Lkotlin/io/path/PathsKt__PathRecursiveFunctionsKt;->checkNotSameAs$PathsKt__PathRecursiveFunctionsKt(Ljava/nio/file/Path;Ljava/nio/file/Path;)V
    ...
    invoke-static {p0, p1, v3}, Lkotlin/io/path/PathsKt__PathRecursiveFunctionsKt;->isDirectory$PathsKt__PathRecursiveFunctionsKt(Ljava/nio/file/SecureDirectoryStream;Ljava/nio/file/Path;[Ljava/nio/file/LinkOption;)Z
    ...
    .line 408
    .local v3, "preEnterTotalExceptions":I
    ...
    .line 542
    .local v4, "$i$f$tryIgnoreNoSuchFileException":I
    const/4 v5, 0x0

    .line 413
    .local v5, "$i$a$-tryIgnoreNoSuchFileException-PathsKt__PathRecursiveFunctionsKt$handleEntry$1$1":I
    :try_start_1
    invoke-interface {p0, p1}, Ljava/nio/file/SecureDirectoryStream;->deleteDirectory(Ljava/lang/Object;)V

    .end local v5    # "$i$a$-tryIgnoreNoSuchFileException-PathsKt__PathRecursiveFunctionsKt$handleEntry$1$1":I
    ...
    .end local v3    # "preEnterTotalExceptions":I
    .end local v4    # "$i$f$tryIgnoreNoSuchFileException":I
    goto :goto_0
    ...
    .line 416
    .local v4, "$i$a$-tryIgnoreNoSuchFileException-PathsKt__PathRecursiveFunctionsKt$handleEntry$1$2":I
    :try_start_2
    invoke-interface {p0, p1}, Ljava/nio/file/SecureDirectoryStream;->deleteFile(Ljava/lang/Object;)V

    .end local v4    # "$i$a$-tryIgnoreNoSuchFileException-PathsKt__PathRecursiveFunctionsKt$handleEntry$1$2":I
    ...
    .line 541
    .end local v2    # "$i$a$-collectIfThrows-PathsKt__PathRecursiveFunctionsKt$handleEntry$1":I
    goto :goto_1
    ...
    .line 547
    .end local v2    # "exception$iv":Ljava/lang/Exception;
    :goto_1
    nop
...
.method private static final insecureEnterDirectory$PathsKt__PathRecursiveFunctionsKt(Ljava/nio/file/Path;Lkotlin/io/path/ExceptionsCollector;)V
    ...
    .line 470
    .local v2, "$i$a$-collectIfThrows-PathsKt__PathRecursiveFunctionsKt$insecureEnterDirectory$1":I
    nop
    ...
    .line 469
    .local v4, "$i$a$-tryIgnoreNoSuchFileException-PathsKt__PathRecursiveFunctionsKt$insecureEnterDirectory$1$1":I
    const/4 v5, 0x0
    ...
    .line 564
    .end local v4    # "$i$a$-tryIgnoreNoSuchFileException-PathsKt__PathRecursiveFunctionsKt$insecureEnterDirectory$1$1":I
    goto :goto_0

    .line 565
    .end local v2    # "$i$a$-collectIfThrows-PathsKt__PathRecursiveFunctionsKt$insecureEnterDirectory$1":I
    .end local v3    # "$i$f$tryIgnoreNoSuchFileException":I
    :catch_0
    move-exception v2
    ...
    .line 564
    .restart local v2    # "$i$a$-collectIfThrows-PathsKt__PathRecursiveFunctionsKt$insecureEnterDirectory$1":I
    .restart local v3    # "$i$f$tryIgnoreNoSuchFileException":I
    :catch_1
    move-exception v4
    ...
    .local v3, "directoryStream":Ljava/nio/file/DirectoryStream;
    const/4 v4, 0x0

    .line 471
    .local v4, "$i$a$-use-PathsKt__PathRecursiveFunctionsKt$insecureEnterDirectory$1$2":I
    ...
    invoke-static {v8, p0, p1}, Lkotlin/io/path/PathsKt__PathRecursiveFunctionsKt;->insecureHandleEntry$PathsKt__PathRecursiveFunctionsKt(Ljava/nio/file/Path;Ljava/nio/file/Path;Lkotlin/io/path/ExceptionsCollector;)V
    ...
    .end local v3    # "directoryStream":Ljava/nio/file/DirectoryStream;
    .end local v4    # "$i$a$-use-PathsKt__PathRecursiveFunctionsKt$insecureEnterDirectory$1$2":I
    sget-object v3, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
...
.method private static final insecureHandleEntry$PathsKt__PathRecursiveFunctionsKt(Ljava/nio/file/Path;Ljava/nio/file/Path;Lkotlin/io/path/ExceptionsCollector;)V
    ...
    .line 445
    .local v2, "$i$a$-collectIfThrows-PathsKt__PathRecursiveFunctionsKt$insecureHandleEntry$1":I
    if-eqz p1, :cond_0
    ...
    .line 557
    .end local v2    # "$i$a$-collectIfThrows-PathsKt__PathRecursiveFunctionsKt$insecureHandleEntry$1":I
    goto :goto_1
