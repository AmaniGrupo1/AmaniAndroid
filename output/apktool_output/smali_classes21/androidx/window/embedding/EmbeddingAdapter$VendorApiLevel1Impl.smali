...
.method private final setDefaultSplitAttributesCompat(Landroidx/window/extensions/embedding/SplitPairRule$Builder;Landroidx/window/embedding/SplitAttributes;)Landroidx/window/extensions/embedding/SplitPairRule$Builder;
    ...
    .local v0, "$this$setDefaultSplitAttributesCompat_u24lambda_u245":Landroidx/window/extensions/embedding/SplitPairRule$Builder;
    const/4 v1, 0x0
    ...
    .line 756
    .end local v0    # "$this$setDefaultSplitAttributesCompat_u24lambda_u245":Landroidx/window/extensions/embedding/SplitPairRule$Builder;
...
.method private final translateActivityIntentPredicates(Ljava/util/Set;)Ljava/lang/Object;
    ...
    new-instance v3, Landroidx/window/embedding/EmbeddingAdapter$VendorApiLevel1Impl$$ExternalSyntheticLambda2;

    invoke-direct {v3, p1}, Landroidx/window/embedding/EmbeddingAdapter$VendorApiLevel1Impl$$ExternalSyntheticLambda2;-><init>(Ljava/util/Set;)V
...
.method static final translateActivityIntentPredicates$lambda$4(Ljava/util/Set;Landroid/app/Activity;Landroid/content/Intent;)Z
    .locals 7
    .param p0, "$splitPairFilters"    # Ljava/util/Set;
    .param p1, "first"    # Landroid/app/Activity;
    .param p2, "second"    # Landroid/content/Intent;
    ...
    .line 750
    .local v6, "$i$a$-any-EmbeddingAdapter$VendorApiLevel1Impl$translateActivityIntentPredicates$1$1":I
    invoke-virtual {v5, p1, p2}, Landroidx/window/embedding/SplitPairFilter;->matchesActivityIntentPair(Landroid/app/Activity;Landroid/content/Intent;)Z

    move-result v5

    .line 851
    .end local v5    # "filter":Landroidx/window/embedding/SplitPairFilter;
    .end local v6    # "$i$a$-any-EmbeddingAdapter$VendorApiLevel1Impl$translateActivityIntentPredicates$1$1":I
    if-eqz v5, :cond_1
...
.method private final translateActivityPairPredicates(Ljava/util/Set;)Ljava/lang/Object;
    ...
    new-instance v3, Landroidx/window/embedding/EmbeddingAdapter$VendorApiLevel1Impl$$ExternalSyntheticLambda3;

    invoke-direct {v3, p1}, Landroidx/window/embedding/EmbeddingAdapter$VendorApiLevel1Impl$$ExternalSyntheticLambda3;-><init>(Ljava/util/Set;)V
...
.method static final translateActivityPairPredicates$lambda$2(Ljava/util/Set;Landroid/app/Activity;Landroid/app/Activity;)Z
    .locals 7
    .param p0, "$splitPairFilters"    # Ljava/util/Set;
    .param p1, "first"    # Landroid/app/Activity;
    .param p2, "second"    # Landroid/app/Activity;
    ...
    .line 741
    .local v6, "$i$a$-any-EmbeddingAdapter$VendorApiLevel1Impl$translateActivityPairPredicates$1$1":I
    invoke-virtual {v5, p1, p2}, Landroidx/window/embedding/SplitPairFilter;->matchesActivityPair(Landroid/app/Activity;Landroid/app/Activity;)Z

    move-result v5

    .line 848
    .end local v5    # "filter":Landroidx/window/embedding/SplitPairFilter;
    .end local v6    # "$i$a$-any-EmbeddingAdapter$VendorApiLevel1Impl$translateActivityPairPredicates$1$1":I
    if-eqz v5, :cond_1
...
.method private final translateActivityPredicates(Ljava/util/Set;)Ljava/lang/Object;
    ...
    new-instance v2, Landroidx/window/embedding/EmbeddingAdapter$VendorApiLevel1Impl$$ExternalSyntheticLambda4;

    invoke-direct {v2, p1}, Landroidx/window/embedding/EmbeddingAdapter$VendorApiLevel1Impl$$ExternalSyntheticLambda4;-><init>(Ljava/util/Set;)V
...
.method static final translateActivityPredicates$lambda$7(Ljava/util/Set;Landroid/app/Activity;)Z
    .locals 7
    ...
    .line 798
    .local v6, "$i$a$-any-EmbeddingAdapter$VendorApiLevel1Impl$translateActivityPredicates$1$1":I
    ...
    .end local v6    # "$i$a$-any-EmbeddingAdapter$VendorApiLevel1Impl$translateActivityPredicates$1$1":I
    if-eqz v5, :cond_1
...
.method private final translateIntentPredicates(Ljava/util/Set;)Ljava/lang/Object;
    ...
    new-instance v2, Landroidx/window/embedding/EmbeddingAdapter$VendorApiLevel1Impl$$ExternalSyntheticLambda0;

    invoke-direct {v2, p1}, Landroidx/window/embedding/EmbeddingAdapter$VendorApiLevel1Impl$$ExternalSyntheticLambda0;-><init>(Ljava/util/Set;)V
...
.method static final translateIntentPredicates$lambda$9(Ljava/util/Set;Landroid/content/Intent;)Z
    .locals 7
    .param p0, "$activityFilters"    # Ljava/util/Set;
...
.method private final translateParentMetricsPredicate(Landroid/content/Context;Landroidx/window/embedding/SplitRule;)Ljava/lang/Object;
    ...
    new-instance v2, Landroidx/window/embedding/EmbeddingAdapter$VendorApiLevel1Impl$$ExternalSyntheticLambda1;

    invoke-direct {v2, p2, p1}, Landroidx/window/embedding/EmbeddingAdapter$VendorApiLevel1Impl$$ExternalSyntheticLambda1;-><init>(Landroidx/window/embedding/SplitRule;Landroid/content/Context;)V
...
.method static final translateParentMetricsPredicate$lambda$10(Landroidx/window/embedding/SplitRule;Landroid/content/Context;Landroid/view/WindowMetrics;)Z
    .locals 1
...
.method public final translateSplitPlaceholderRuleCompat(Landroid/content/Context;Landroidx/window/embedding/SplitPlaceholderRule;Ljava/lang/Class;)Landroidx/window/extensions/embedding/SplitPlaceholderRule;
    ...
    const-string/jumbo v1, "setFinishPrimaryWithSecondary(...)"
