...
.method public constructor <init>(Landroidx/window/embedding/ActivityStack;Landroidx/window/embedding/ActivityStack;Landroidx/window/embedding/SplitAttributes;)V
    ...
    .end local p1    # "primaryActivityStack":Landroidx/window/embedding/ActivityStack;
    .end local p2    # "secondaryActivityStack":Landroidx/window/embedding/ActivityStack;
    .end local p3    # "splitAttributes":Landroidx/window/embedding/SplitAttributes;
    .local v2, "primaryActivityStack":Landroidx/window/embedding/ActivityStack;
    .local v3, "secondaryActivityStack":Landroidx/window/embedding/ActivityStack;
    .local v4, "splitAttributes":Landroidx/window/embedding/SplitAttributes;
...
.method private constructor <init>(Landroidx/window/embedding/ActivityStack;Landroidx/window/embedding/ActivityStack;Landroidx/window/embedding/SplitAttributes;Landroid/os/IBinder;Landroidx/window/extensions/embedding/SplitInfo$Token;)V
    ...
    .param p3, "splitAttributes"    # Landroidx/window/embedding/SplitAttributes;
    .param p4, "binder"    # Landroid/os/IBinder;
    .param p5, "token"    # Landroidx/window/extensions/embedding/SplitInfo$Token;
...
.method public constructor <init>(Landroidx/window/embedding/ActivityStack;Landroidx/window/embedding/ActivityStack;Landroidx/window/embedding/SplitAttributes;Landroidx/window/extensions/embedding/SplitInfo$Token;)V
    ...
    .param p2, "secondaryActivityStack"    # Landroidx/window/embedding/ActivityStack;
    .param p3, "splitAttributes"    # Landroidx/window/embedding/SplitAttributes;
    .param p4, "token"    # Landroidx/window/extensions/embedding/SplitInfo$Token;
    ...
    .end local p2    # "secondaryActivityStack":Landroidx/window/embedding/ActivityStack;
    .end local p3    # "splitAttributes":Landroidx/window/embedding/SplitAttributes;
    .end local p4    # "token":Landroidx/window/extensions/embedding/SplitInfo$Token;
    .local v2, "primaryActivityStack":Landroidx/window/embedding/ActivityStack;
    .local v3, "secondaryActivityStack":Landroidx/window/embedding/ActivityStack;
    .local v4, "splitAttributes":Landroidx/window/embedding/SplitAttributes;
    .local v6, "token":Landroidx/window/extensions/embedding/SplitInfo$Token;
    invoke-direct/range {v1 .. v6}, Landroidx/window/embedding/SplitInfo;-><init>(Landroidx/window/embedding/ActivityStack;Landroidx/window/embedding/ActivityStack;Landroidx/window/embedding/SplitAttributes;Landroid/os/IBinder;Landroidx/window/extensions/embedding/SplitInfo$Token;)V
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget-object v3, v3, Landroidx/window/embedding/SplitInfo;->token:Landroidx/window/extensions/embedding/SplitInfo$Token;
    ...
    iget-object v3, v3, Landroidx/window/embedding/SplitInfo;->binder:Landroid/os/IBinder;
...
.method public final getBinder$window_release()Landroid/os/IBinder;
    ...
    .local v0, "it":Landroidx/window/embedding/SplitInfo;
    const/4 v1, 0x0

    .line 89
    .local v1, "$i$a$-let-SplitInfo$getBinder$1":I
    ...
    invoke-virtual {v2, v3}, Landroidx/window/WindowSdkExtensions;->requireExtensionVersion$window_release(Lkotlin/ranges/IntRange;)V
    ...
    .line 88
    .end local v0    # "it":Landroidx/window/embedding/SplitInfo;
    .end local v1    # "$i$a$-let-SplitInfo$getBinder$1":I
    nop
    ...
    .line 90
    .restart local v0    # "it":Landroidx/window/embedding/SplitInfo;
    .restart local v1    # "$i$a$-let-SplitInfo$getBinder$1":I
    :cond_0
...
.method public final getToken$window_release()Landroidx/window/extensions/embedding/SplitInfo$Token;
    ...
    .line 95
    .local v1, "$i$a$-let-SplitInfo$getToken$1":I
    sget-object v2, Landroidx/window/WindowSdkExtensions;->Companion:Landroidx/window/WindowSdkExtensions$Companion;
    ...
    .line 94
    .end local v0    # "it":Landroidx/window/embedding/SplitInfo;
    .end local v1    # "$i$a$-let-SplitInfo$getToken$1":I
    nop
    ...
    .line 96
    .restart local v0    # "it":Landroidx/window/embedding/SplitInfo;
    .restart local v1    # "$i$a$-let-SplitInfo$getToken$1":I
    :cond_0
    new-instance v2, Ljava/lang/IllegalArgumentException;
...
.method public toString()Ljava/lang/String;
    ...
    const-string/jumbo v4, "primaryActivityStack="
    ...
    const-string/jumbo v5, "secondaryActivityStack="
    ...
    const-string/jumbo v5, "splitAttributes="
    ...
    .line 135
    iget-object v3, p0, Landroidx/window/embedding/SplitInfo;->token:Landroidx/window/extensions/embedding/SplitInfo$Token;
    ...
    iget-object v4, p0, Landroidx/window/embedding/SplitInfo;->token:Landroidx/window/extensions/embedding/SplitInfo$Token;
    ...
    .line 138
    :cond_0
    iget-object v3, p0, Landroidx/window/embedding/SplitInfo;->binder:Landroid/os/IBinder;
    ...
    iget-object v4, p0, Landroidx/window/embedding/SplitInfo;->binder:Landroid/os/IBinder;
