...
.method static final performAttach$lambda$12(Landroidx/savedstate/internal/SavedStateRegistryImpl;Landroidx/lifecycle/LifecycleOwner;Landroidx/lifecycle/Lifecycle$Event;)V
    .locals 1
...
.method public final getOnAttach$savedstate()Lkotlin/jvm/functions/Function0;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public final performRestore$savedstate(Landroid/os/Bundle;)V
    ...
    const-string/jumbo v2, "performRestore cannot be called when owner is "
...
.method public final unregisterSavedStateProvider(Ljava/lang/String;)V
    ...
    .line 84
    .local v4, "$i$a$-synchronized-SavedStateRegistryImpl$unregisterSavedStateProvider$1":I
    :try_start_0
    invoke-static {p0}, Landroidx/savedstate/internal/SavedStateRegistryImpl;->access$getKeyToProviders$p(Landroidx/savedstate/internal/SavedStateRegistryImpl;)Ljava/util/Map;
    ...
    .line 163
    .end local v4    # "$i$a$-synchronized-SavedStateRegistryImpl$unregisterSavedStateProvider$1":I
    monitor-exit v2
