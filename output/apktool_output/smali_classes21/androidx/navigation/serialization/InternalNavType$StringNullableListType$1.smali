...
.method public get(Landroid/os/Bundle;Ljava/lang/String;)Ljava/util/List;
    ...
    .line 365
    .local v5, "$i$a$-read-InternalNavType$StringNullableListType$1$get$1":I
    ...
    .line 366
    .local v14, "$i$a$-map-InternalNavType$StringNullableListType$1$get$1$1":I
    sget-object v15, Landroidx/navigation/NavType;->StringType:Landroidx/navigation/NavType;

    invoke-virtual {v15, v13}, Landroidx/navigation/NavType;->parseValue(Ljava/lang/String;)Ljava/lang/Object;
    ...
    .end local v14    # "$i$a$-map-InternalNavType$StringNullableListType$1$get$1$1":I
    ...
    .end local v5    # "$i$a$-read-InternalNavType$StringNullableListType$1$get$1":I
    :goto_1
    nop
...
.method public put(Landroid/os/Bundle;Ljava/lang/String;Ljava/util/List;)V
    ...
    .line 358
    .local v5, "$i$a$-write-InternalNavType$StringNullableListType$1$put$1":I
    if-nez p3, :cond_0
    ...
    .line 359
    .local v14, "$i$a$-map-InternalNavType$StringNullableListType$1$put$1$1":I
    if-nez v13, :cond_1
    ...
    .line 458
    .end local v13    # "it":Ljava/lang/String;
    .end local v14    # "$i$a$-map-InternalNavType$StringNullableListType$1$put$1$1":I
    :cond_1
    ...
    .end local v5    # "$i$a$-write-InternalNavType$StringNullableListType$1$put$1":I
    nop
...
.method public serializeAsValues(Ljava/util/List;)Ljava/util/List;
    ...
    .line 385
    .local v8, "$i$a$-map-InternalNavType$StringNullableListType$1$serializeAsValues$1":I
    if-eqz v7, :cond_0
    ...
    .line 385
    .local v10, "$i$a$-let-InternalNavType$StringNullableListType$1$serializeAsValues$1$1":I
    sget-object v11, Landroidx/navigation/NavUriUtils;->INSTANCE:Landroidx/navigation/NavUriUtils;

    const/4 v12, 0x2

    const/4 v13, 0x0

    invoke-static {v11, v9, v13, v12, v13}, Landroidx/navigation/NavUriUtils;->encode$default(Landroidx/navigation/NavUriUtils;Ljava/lang/String;Ljava/lang/String;ILjava/lang/Object;)Ljava/lang/String;

    move-result-object v9

    .end local v9    # "it":Ljava/lang/String;
    .end local v10    # "$i$a$-let-InternalNavType$StringNullableListType$1$serializeAsValues$1$1":I
    if-nez v9, :cond_1
    ...
    .end local v8    # "$i$a$-map-InternalNavType$StringNullableListType$1$serializeAsValues$1":I
    :cond_1
