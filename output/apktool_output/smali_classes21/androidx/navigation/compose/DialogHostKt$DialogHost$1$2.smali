...
.method static final invoke$lambda$2$lambda$1(Landroidx/compose/runtime/snapshots/SnapshotStateList;Landroidx/navigation/NavBackStackEntry;Landroidx/navigation/compose/DialogNavigator;Landroidx/compose/runtime/DisposableEffectScope;)Landroidx/compose/runtime/DisposableEffectResult;
    .locals 3
    .param p0, "$dialogsToDispose"    # Landroidx/compose/runtime/snapshots/SnapshotStateList;
    .param p1, "$backStackEntry"    # Landroidx/navigation/NavBackStackEntry;
    .param p2, "$dialogNavigator"    # Landroidx/navigation/compose/DialogNavigator;
    ...
    new-instance v2, Landroidx/navigation/compose/DialogHostKt$DialogHost$1$2$invoke$lambda$2$lambda$1$$inlined$onDispose$1;

    invoke-direct {v2, p2, p1, p0}, Landroidx/navigation/compose/DialogHostKt$DialogHost$1$2$invoke$lambda$2$lambda$1$$inlined$onDispose$1;-><init>(Landroidx/navigation/compose/DialogNavigator;Landroidx/navigation/NavBackStackEntry;Landroidx/compose/runtime/snapshots/SnapshotStateList;)V
...
.method public final invoke(Landroidx/compose/runtime/Composer;I)V
    ...
    new-instance v10, Landroidx/navigation/compose/DialogHostKt$DialogHost$1$2$$ExternalSyntheticLambda0;

    invoke-direct {v10, v2, v3, v4}, Landroidx/navigation/compose/DialogHostKt$DialogHost$1$2$$ExternalSyntheticLambda0;-><init>(Landroidx/compose/runtime/snapshots/SnapshotStateList;Landroidx/navigation/NavBackStackEntry;Landroidx/navigation/compose/DialogNavigator;)V
