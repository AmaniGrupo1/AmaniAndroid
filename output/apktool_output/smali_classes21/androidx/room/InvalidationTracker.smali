...
.method public varargs constructor <init>(Landroidx/room/RoomDatabase;Ljava/util/Map;Ljava/util/Map;[Ljava/lang/String;)V
    ...
    invoke-virtual {v0}, Landroidx/room/RoomDatabase;->getUseTempTrackingTable$room_runtime_release()Z
...
.method private final addObserverOnly(Landroidx/room/InvalidationTracker$Observer;)Z
    ...
    invoke-virtual {v3, v0}, Landroidx/room/TriggerBasedInvalidationTracker;->onObserverAdded$room_runtime_release([I)Z
...
.method private final notifyInvalidatedObservers(Ljava/util/Set;)V
    ...
    invoke-virtual {v4, p1}, Landroidx/room/ObserverWrapper;->notifyByTableIds$room_runtime_release(Ljava/util/Set;)V
...
.method private final onAutoCloseCallback()V
    ...
    invoke-virtual {v11}, Landroidx/room/InvalidationTracker$Observer;->isRemote$room_runtime_release()Z
    ...
    invoke-virtual {v2}, Landroidx/room/TriggerBasedInvalidationTracker;->resetSync$room_runtime_release()V
...
.method private final removeObserverOnly(Landroidx/room/InvalidationTracker$Observer;)Z
    ...
    invoke-virtual {v3}, Landroidx/room/ObserverWrapper;->getTableIds$room_runtime_release()[I

    move-result-object v1

    invoke-virtual {v0, v1}, Landroidx/room/TriggerBasedInvalidationTracker;->onObserverRemoved$room_runtime_release([I)Z
...
.method public final createFlow([Ljava/lang/String;Z)Lkotlinx/coroutines/flow/Flow;
    ...
    invoke-virtual {v2, v1, v0, p2}, Landroidx/room/TriggerBasedInvalidationTracker;->createFlow$room_runtime_release([Ljava/lang/String;[IZ)Lkotlinx/coroutines/flow/Flow;
...
.method public final notifyObserversByTableNames$room_runtime_release(Ljava/util/Set;)V
    ...
    invoke-virtual {v4}, Landroidx/room/ObserverWrapper;->getObserver$room_runtime_release()Landroidx/room/InvalidationTracker$Observer;

    move-result-object v6

    invoke-virtual {v6}, Landroidx/room/InvalidationTracker$Observer;->isRemote$room_runtime_release()Z
    ...
    .line 367
    invoke-virtual {v4, p1}, Landroidx/room/ObserverWrapper;->notifyByTableNames$room_runtime_release(Ljava/util/Set;)V
