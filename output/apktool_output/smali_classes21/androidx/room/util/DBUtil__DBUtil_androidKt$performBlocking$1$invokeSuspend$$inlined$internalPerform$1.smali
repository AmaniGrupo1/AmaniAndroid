...
.method public final invoke(Landroidx/room/Transactor;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    check-cast v0, Landroidx/room/util/DBUtil__DBUtil_androidKt$performBlocking$1$invokeSuspend$$inlined$internalPerform$1;

    sget-object v1, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;

    invoke-virtual {v0, v1}, Landroidx/room/util/DBUtil__DBUtil_androidKt$performBlocking$1$invokeSuspend$$inlined$internalPerform$1;->invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v2, p0, Landroidx/room/util/DBUtil__DBUtil_androidKt$performBlocking$1$invokeSuspend$$inlined$internalPerform$1;->L$0:Ljava/lang/Object;
    ...
    .line 49
    .local v1, "transactor":Landroidx/room/Transactor;
    iget-boolean v2, p0, Landroidx/room/util/DBUtil__DBUtil_androidKt$performBlocking$1$invokeSuspend$$inlined$internalPerform$1;->$inTransaction:Z
    ...
    iput-object v3, p0, Landroidx/room/util/DBUtil__DBUtil_androidKt$performBlocking$1$invokeSuspend$$inlined$internalPerform$1;->L$0:Ljava/lang/Object;
    ...
    invoke-virtual {p1, v4}, Landroidx/room/InvalidationTracker;->sync$room_runtime_release(Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    :cond_4
    :goto_3
    new-instance v3, Landroidx/room/util/DBUtil__DBUtil_androidKt$performBlocking$1$invokeSuspend$$inlined$internalPerform$1$1;
    ...
    invoke-direct {v3, v5, v4}, Landroidx/room/util/DBUtil__DBUtil_androidKt$performBlocking$1$invokeSuspend$$inlined$internalPerform$1$1;-><init>(Lkotlin/coroutines/Continuation;Lkotlin/jvm/functions/Function1;)V
    ...
    .end local v1    # "transactor":Landroidx/room/Transactor;
    .local v0, "connection":Landroidx/room/PooledConnection;
    const/4 v1, 0x0

    .line 67
    .local v1, "$i$a$-internalPerform-DBUtil__DBUtil_androidKt$performBlocking$1$1":I
    const-string/jumbo v2, "null cannot be cast to non-null type androidx.room.coroutines.RawConnectionAccessor"

    invoke-static {v0, v2}, Lkotlin/jvm/internal/Intrinsics;->checkNotNull(Ljava/lang/Object;Ljava/lang/String;)V

    move-object v2, v0

    check-cast v2, Landroidx/room/coroutines/RawConnectionAccessor;

    invoke-interface {v2}, Landroidx/room/coroutines/RawConnectionAccessor;->getRawConnection()Landroidx/sqlite/SQLiteConnection;

    move-result-object v2

    .line 68
    .local v2, "rawConnection":Landroidx/sqlite/SQLiteConnection;
    ...
    .line 65
    .end local v0    # "connection":Landroidx/room/PooledConnection;
    .end local v1    # "$i$a$-internalPerform-DBUtil__DBUtil_androidKt$performBlocking$1$1":I
    .end local v2    # "rawConnection":Landroidx/sqlite/SQLiteConnection;
    :goto_6
    nop
