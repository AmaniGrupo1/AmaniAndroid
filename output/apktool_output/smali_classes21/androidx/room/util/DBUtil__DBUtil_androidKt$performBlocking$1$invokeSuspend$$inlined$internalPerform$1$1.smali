...
.method public final invoke(Landroidx/room/TransactionScope;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    check-cast v0, Landroidx/room/util/DBUtil__DBUtil_androidKt$performBlocking$1$invokeSuspend$$inlined$internalPerform$1$1;

    sget-object v1, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;

    invoke-virtual {v0, v1}, Landroidx/room/util/DBUtil__DBUtil_androidKt$performBlocking$1$invokeSuspend$$inlined$internalPerform$1$1;->invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v0, p0, Landroidx/room/util/DBUtil__DBUtil_androidKt$performBlocking$1$invokeSuspend$$inlined$internalPerform$1$1;->L$0:Ljava/lang/Object;

    check-cast v0, Landroidx/room/TransactionScope;

    .line 59
    .local v0, "$this$withTransaction":Landroidx/room/TransactionScope;
    move-object v1, p0
    ...
    .local v1, "connection":Landroidx/room/PooledConnection;
    const/4 v2, 0x0

    .line 60
    .local v2, "$i$a$-internalPerform-DBUtil__DBUtil_androidKt$performBlocking$1$1":I
    const-string/jumbo v3, "null cannot be cast to non-null type androidx.room.coroutines.RawConnectionAccessor"

    invoke-static {v1, v3}, Lkotlin/jvm/internal/Intrinsics;->checkNotNull(Ljava/lang/Object;Ljava/lang/String;)V

    move-object v3, v1

    check-cast v3, Landroidx/room/coroutines/RawConnectionAccessor;

    invoke-interface {v3}, Landroidx/room/coroutines/RawConnectionAccessor;->getRawConnection()Landroidx/sqlite/SQLiteConnection;

    move-result-object v3

    .line 61
    .local v3, "rawConnection":Landroidx/sqlite/SQLiteConnection;
    iget-object v4, p0, Landroidx/room/util/DBUtil__DBUtil_androidKt$performBlocking$1$invokeSuspend$$inlined$internalPerform$1$1;->$block$inlined:Lkotlin/jvm/functions/Function1;
    ...
    .line 59
    .end local v1    # "connection":Landroidx/room/PooledConnection;
    .end local v2    # "$i$a$-internalPerform-DBUtil__DBUtil_androidKt$performBlocking$1$1":I
    .end local v3    # "rawConnection":Landroidx/sqlite/SQLiteConnection;
    return-object v1
