...
.method private createTransformAnimator(Landroidx/transition/TransitionValues;Landroidx/transition/TransitionValues;Z)Landroid/animation/ObjectAnimator;
    ...
    filled-new-array {v11, v12}, [[F

    move-result-object v3

    invoke-static {v4, v9, v3}, Landroid/animation/PropertyValuesHolder;->ofObject(Landroid/util/Property;Landroid/animation/TypeEvaluator;[Ljava/lang/Object;)Landroid/animation/PropertyValuesHolder;

    move-result-object v3

    .line 316
    .local v3, "valuesProperty":Landroid/animation/PropertyValuesHolder;
    ...
    invoke-virtual {v4, v10, v14, v15, v13}, Landroidx/transition/PathMotion;->getPath(FFFF)Landroid/graphics/Path;
    ...
    invoke-virtual {v15, v4}, Landroid/animation/ObjectAnimator;->addListener(Landroid/animation/Animator$AnimatorListener;)V

    .line 328
    invoke-virtual {v15, v4}, Landroid/animation/ObjectAnimator;->addPauseListener(Landroid/animation/Animator$AnimatorPauseListener;)V
