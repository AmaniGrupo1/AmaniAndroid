...
.method protected constructor <init>([Landroidx/media3/decoder/DecoderInputBuffer;[Landroidx/media3/decoder/DecoderOutputBuffer;)V
    ...
    .line 60
    .local p0, "this":Landroidx/media3/decoder/SimpleDecoder;, "Landroidx/media3/decoder/SimpleDecoder<TI;TO;TE;>;"
    .local p1, "inputBuffers":[Landroidx/media3/decoder/DecoderInputBuffer;, "[TI;"
    .local p2, "outputBuffers":[Landroidx/media3/decoder/DecoderOutputBuffer;, "[TO;"
    ...
    iput v0, p0, Landroidx/media3/decoder/SimpleDecoder;->availableInputBufferCount:I
    ...
    iput v0, p0, Landroidx/media3/decoder/SimpleDecoder;->availableOutputBufferCount:I
    ...
    .line 73
    iget-object v1, p0, Landroidx/media3/decoder/SimpleDecoder;->availableOutputBuffers:[Landroidx/media3/decoder/DecoderOutputBuffer;
    ...
    invoke-direct {v0, p0, v1}, Landroidx/media3/decoder/SimpleDecoder$1;-><init>(Landroidx/media3/decoder/SimpleDecoder;Ljava/lang/String;)V

    iput-object v0, p0, Landroidx/media3/decoder/SimpleDecoder;->decodeThread:Ljava/lang/Thread;
...
.method static synthetic access$000(Landroidx/media3/decoder/SimpleDecoder;)V
    .locals 0
    .param p0, "x0"    # Landroidx/media3/decoder/SimpleDecoder;
...
.method private decode()Z
    ...
    .line 255
    .local v1, "inputBuffer":Landroidx/media3/decoder/DecoderInputBuffer;, "TI;"
    ...
    .line 256
    .local v3, "outputBuffer":Landroidx/media3/decoder/DecoderOutputBuffer;, "TO;"
    ...
    .line 282
    .local v0, "exception":Landroidx/media3/decoder/DecoderException;, "TE;"
    :goto_1
    goto :goto_2

    .line 277
    .end local v0    # "exception":Landroidx/media3/decoder/DecoderException;, "TE;"
    :catch_0
    move-exception v0
    ...
    .local v6, "exception":Landroidx/media3/decoder/DecoderException;, "TE;"
    goto :goto_2

    .line 273
    .end local v0    # "e":Ljava/lang/OutOfMemoryError;
    .end local v6    # "exception":Landroidx/media3/decoder/DecoderException;, "TE;"
    :catch_1
    move-exception v0
    ...
    .line 284
    iget-object v6, p0, Landroidx/media3/decoder/SimpleDecoder;->lock:Ljava/lang/Object;
    ...
    .line 298
    iget v7, p0, Landroidx/media3/decoder/SimpleDecoder;->skippedOutputBufferCount:I
    ...
    :try_start_4
    iput v7, p0, Landroidx/media3/decoder/SimpleDecoder;->skippedOutputBufferCount:I
    ...
    .line 298
    :cond_7
    iput v7, v3, Landroidx/media3/decoder/DecoderOutputBuffer;->skippedOutputBufferCount:I
    ...
    .line 258
    .end local v1    # "inputBuffer":Landroidx/media3/decoder/DecoderInputBuffer;, "TI;"
    .end local v3    # "outputBuffer":Landroidx/media3/decoder/DecoderOutputBuffer;, "TO;"
...
.method private releaseInputBufferInternal(Landroidx/media3/decoder/DecoderInputBuffer;)V
    ...
    .line 314
    .local p0, "this":Landroidx/media3/decoder/SimpleDecoder;, "Landroidx/media3/decoder/SimpleDecoder<TI;TO;TE;>;"
    .local p1, "inputBuffer":Landroidx/media3/decoder/DecoderInputBuffer;, "TI;"
...
.method private releaseOutputBufferInternal(Landroidx/media3/decoder/DecoderOutputBuffer;)V
    ...
    .line 319
    .local p0, "this":Landroidx/media3/decoder/SimpleDecoder;, "Landroidx/media3/decoder/SimpleDecoder<TI;TO;TE;>;"
    .local p1, "outputBuffer":Landroidx/media3/decoder/DecoderOutputBuffer;, "TO;"
...
.method public final dequeueInputBuffer()Landroidx/media3/decoder/DecoderInputBuffer;
    ...
    iget v3, p0, Landroidx/media3/decoder/SimpleDecoder;->availableInputBufferCount:I

    sub-int/2addr v3, v2

    iput v3, p0, Landroidx/media3/decoder/SimpleDecoder;->availableInputBufferCount:I
...
.method protected final setInitialInputBufferSize(I)V
    ...
    .line 96
    .local v3, "inputBuffer":Landroidx/media3/decoder/DecoderInputBuffer;, "TI;"
    invoke-virtual {v3, p1}, Landroidx/media3/decoder/DecoderInputBuffer;->ensureSpaceForWrite(I)V

    .line 95
    .end local v3    # "inputBuffer":Landroidx/media3/decoder/DecoderInputBuffer;, "TI;"
