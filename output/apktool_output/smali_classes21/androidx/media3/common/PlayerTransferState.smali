...
.method private constructor <init>(Landroidx/media3/common/PlayerTransferState$Builder;)V
    .locals 2
    .param p1, "builder"    # Landroidx/media3/common/PlayerTransferState$Builder;
    ...
    iput-object v0, p0, Landroidx/media3/common/PlayerTransferState;->trackSelectionParameters:Landroidx/media3/common/TrackSelectionParameters;
...
.method synthetic constructor <init>(Landroidx/media3/common/PlayerTransferState$Builder;Landroidx/media3/common/PlayerTransferState$1;)V
    .locals 0
    .param p1, "x0"    # Landroidx/media3/common/PlayerTransferState$Builder;
...
.method static synthetic access$000(Landroidx/media3/common/PlayerTransferState;)Z
    .locals 1
    .param p0, "x0"    # Landroidx/media3/common/PlayerTransferState;
...
.method public static builderFromPlayer(Landroidx/media3/common/Player;)Landroidx/media3/common/PlayerTransferState$Builder;
    ...
    invoke-virtual {v1, v2}, Landroidx/media3/common/PlayerTransferState$Builder;->setPlaybackParameters(Landroidx/media3/common/PlaybackParameters;)Landroidx/media3/common/PlayerTransferState$Builder;
    ...
    invoke-virtual {v1, v2}, Landroidx/media3/common/PlayerTransferState$Builder;->setTrackSelectionParameters(Landroidx/media3/common/TrackSelectionParameters;)Landroidx/media3/common/PlayerTransferState$Builder;
...
.method public static fromPlayer(Landroidx/media3/common/Player;)Landroidx/media3/common/PlayerTransferState;
    ...
    invoke-virtual {v0}, Landroidx/media3/common/PlayerTransferState$Builder;->build()Landroidx/media3/common/PlayerTransferState;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    check-cast v1, Landroidx/media3/common/PlayerTransferState;

    .line 310
    .local v1, "that":Landroidx/media3/common/PlayerTransferState;
    iget-boolean v2, p0, Landroidx/media3/common/PlayerTransferState;->playWhenReady:Z

    iget-boolean v3, v1, Landroidx/media3/common/PlayerTransferState;->playWhenReady:Z

    if-ne v2, v3, :cond_1

    iget v2, p0, Landroidx/media3/common/PlayerTransferState;->repeatMode:I

    iget v3, v1, Landroidx/media3/common/PlayerTransferState;->repeatMode:I

    if-ne v2, v3, :cond_1

    iget-boolean v2, p0, Landroidx/media3/common/PlayerTransferState;->shuffleModeEnabled:Z

    iget-boolean v3, v1, Landroidx/media3/common/PlayerTransferState;->shuffleModeEnabled:Z

    if-ne v2, v3, :cond_1

    iget v2, p0, Landroidx/media3/common/PlayerTransferState;->currentMediaItemIndex:I

    iget v3, v1, Landroidx/media3/common/PlayerTransferState;->currentMediaItemIndex:I

    if-ne v2, v3, :cond_1

    iget-wide v2, p0, Landroidx/media3/common/PlayerTransferState;->currentPosition:J

    iget-wide v4, v1, Landroidx/media3/common/PlayerTransferState;->currentPosition:J

    cmp-long v2, v2, v4

    if-nez v2, :cond_1

    iget-object v2, p0, Landroidx/media3/common/PlayerTransferState;->mediaItems:Lcom/google/common/collect/ImmutableList;

    iget-object v3, v1, Landroidx/media3/common/PlayerTransferState;->mediaItems:Lcom/google/common/collect/ImmutableList;
    ...
    iget-object v2, p0, Landroidx/media3/common/PlayerTransferState;->playbackParameters:Landroidx/media3/common/PlaybackParameters;

    iget-object v3, v1, Landroidx/media3/common/PlayerTransferState;->playbackParameters:Landroidx/media3/common/PlaybackParameters;
    ...
    iget-object v2, p0, Landroidx/media3/common/PlayerTransferState;->trackSelectionParameters:Landroidx/media3/common/TrackSelectionParameters;

    iget-object v3, v1, Landroidx/media3/common/PlayerTransferState;->trackSelectionParameters:Landroidx/media3/common/TrackSelectionParameters;
    ...
    .line 307
    .end local v1    # "that":Landroidx/media3/common/PlayerTransferState;
    :cond_2
    :goto_1
    return v0
.end method
