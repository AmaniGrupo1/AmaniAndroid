...
.method public constructor <init>(Ljava/lang/Object;Landroid/os/Looper;Landroid/os/Looper;Landroidx/media3/common/util/Clock;Landroidx/media3/common/util/BackgroundThreadStateHandler$StateChangeListener;)V
    ...
    .param p3, "foregroundLooper"    # Landroid/os/Looper;
    ...
    .line 80
    .local p0, "this":Landroidx/media3/common/util/BackgroundThreadStateHandler;, "Landroidx/media3/common/util/BackgroundThreadStateHandler<TT;>;"
    .local p1, "initialState":Ljava/lang/Object;, "TT;"
    .local p5, "onStateChanged":Landroidx/media3/common/util/BackgroundThreadStateHandler$StateChangeListener;, "Landroidx/media3/common/util/BackgroundThreadStateHandler$StateChangeListener<TT;>;"
    ...
    iput-object v1, p0, Landroidx/media3/common/util/BackgroundThreadStateHandler;->backgroundHandler:Landroidx/media3/common/util/HandlerWrapper;
    ...
    iput-object v0, p0, Landroidx/media3/common/util/BackgroundThreadStateHandler;->foregroundHandler:Landroidx/media3/common/util/HandlerWrapper;
...
.method private updateStateInForeground(Ljava/lang/Object;)V
    ...
    .line 179
    .local v0, "oldState":Ljava/lang/Object;, "TT;"
    iput-object p1, p0, Landroidx/media3/common/util/BackgroundThreadStateHandler;->foregroundState:Ljava/lang/Object;
...
.method public get()Ljava/lang/Object;
    ...
    .line 97
    iget-object v1, p0, Landroidx/media3/common/util/BackgroundThreadStateHandler;->foregroundState:Ljava/lang/Object;
    ...
    .line 100
    iget-object v1, p0, Landroidx/media3/common/util/BackgroundThreadStateHandler;->backgroundState:Ljava/lang/Object;
...
.method synthetic lambda$updateStateAsync$1$androidx-media3-common-util-BackgroundThreadStateHandler(Lcom/google/common/base/Function;)V
    .locals 2
    .param p1, "backgroundStateUpdate"    # Lcom/google/common/base/Function;
    ...
    iput-object v0, p0, Landroidx/media3/common/util/BackgroundThreadStateHandler;->backgroundState:Ljava/lang/Object;

    .line 121
    iget-object v0, p0, Landroidx/media3/common/util/BackgroundThreadStateHandler;->backgroundState:Ljava/lang/Object;

    .line 122
    .local v0, "newState":Ljava/lang/Object;, "TT;"
    new-instance v1, Landroidx/media3/common/util/BackgroundThreadStateHandler$$ExternalSyntheticLambda2;

    invoke-direct {v1, p0, v0}, Landroidx/media3/common/util/BackgroundThreadStateHandler$$ExternalSyntheticLambda2;-><init>(Landroidx/media3/common/util/BackgroundThreadStateHandler;Ljava/lang/Object;)V

    invoke-direct {p0, v1}, Landroidx/media3/common/util/BackgroundThreadStateHandler;->runInForeground(Ljava/lang/Runnable;)V
...
.method public updateStateAsync(Lcom/google/common/base/Function;Lcom/google/common/base/Function;)V
    ...
    .line 116
    .local p0, "this":Landroidx/media3/common/util/BackgroundThreadStateHandler;, "Landroidx/media3/common/util/BackgroundThreadStateHandler<TT;>;"
    .local p1, "placeholderState":Lcom/google/common/base/Function;, "Lcom/google/common/base/Function<TT;TT;>;"
    .local p2, "backgroundStateUpdate":Lcom/google/common/base/Function;, "Lcom/google/common/base/Function<TT;TT;>;"
    invoke-static {}, Landroid/os/Looper;->myLooper()Landroid/os/Looper;
    ...
    invoke-direct {p0, v0}, Landroidx/media3/common/util/BackgroundThreadStateHandler;->updateStateInForeground(Ljava/lang/Object;)V
