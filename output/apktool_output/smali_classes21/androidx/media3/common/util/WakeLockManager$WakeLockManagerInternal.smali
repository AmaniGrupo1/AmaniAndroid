...
.method static synthetic access$100(Landroidx/media3/common/util/WakeLockManager$WakeLockManagerInternal;ZZ)V
    .locals 0
    .param p0, "x0"    # Landroidx/media3/common/util/WakeLockManager$WakeLockManagerInternal;
    .param p1, "x1"    # Z
    .param p2, "x2"    # Z
...
.method private declared-synchronized forceReleaseWakeLockInternal(Ljava/util/concurrent/atomic/AtomicBoolean;)V
    ...
    .line 177
    .end local p0    # "this":Landroidx/media3/common/util/WakeLockManager$WakeLockManagerInternal;
    :cond_0
    monitor-exit p0
...
.method private declared-synchronized updateWakeLock(ZZ)V
    ...
    const-string v1, "WAKE_LOCK permission not granted, can\'t acquire wake lock for playback"
    ...
    const-string v2, "PowerManager is null, therefore not creating the WakeLock."
    ...
    iput-object v1, p0, Landroidx/media3/common/util/WakeLockManager$WakeLockManagerInternal;->wakeLock:Landroid/os/PowerManager$WakeLock;

    .line 153
    iget-object v1, p0, Landroidx/media3/common/util/WakeLockManager$WakeLockManagerInternal;->wakeLock:Landroid/os/PowerManager$WakeLock;
