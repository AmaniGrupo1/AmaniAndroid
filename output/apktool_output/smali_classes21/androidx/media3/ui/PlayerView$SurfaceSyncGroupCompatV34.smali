...
.method synthetic constructor <init>(Landroidx/media3/ui/PlayerView$1;)V
    .locals 0
    .param p1, "x0"    # Landroidx/media3/ui/PlayerView$1;
...
.method synthetic lambda$postRegister$1$androidx-media3-ui-PlayerView$SurfaceSyncGroupCompatV34(Landroid/view/SurfaceView;Ljava/lang/Runnable;)V
    ...
    .param p2, "invalidate"    # Ljava/lang/Runnable;
    ...
    .line 2017
    .local v0, "rootSurfaceControl":Landroid/view/AttachedSurfaceControl;
    if-nez v0, :cond_0
    ...
    iput-object v1, p0, Landroidx/media3/ui/PlayerView$SurfaceSyncGroupCompatV34;->surfaceSyncGroup:Landroid/window/SurfaceSyncGroup;

    .line 2022
    iget-object v1, p0, Landroidx/media3/ui/PlayerView$SurfaceSyncGroupCompatV34;->surfaceSyncGroup:Landroid/window/SurfaceSyncGroup;

    new-instance v2, Landroidx/media3/ui/PlayerView$SurfaceSyncGroupCompatV34$$ExternalSyntheticLambda1;

    invoke-direct {v2}, Landroidx/media3/ui/PlayerView$SurfaceSyncGroupCompatV34$$ExternalSyntheticLambda1;-><init>()V
    ...
    invoke-interface {v0, v1}, Landroid/view/AttachedSurfaceControl;->applyTransactionOnDraw(Landroid/view/SurfaceControl$Transaction;)Z
...
.method public postRegister(Landroid/os/Handler;Landroid/view/SurfaceView;Ljava/lang/Runnable;)V
    .locals 1
    .param p1, "mainLooperHandler"    # Landroid/os/Handler;
    .param p2, "surfaceView"    # Landroid/view/SurfaceView;
    .param p3, "invalidate"    # Ljava/lang/Runnable;
