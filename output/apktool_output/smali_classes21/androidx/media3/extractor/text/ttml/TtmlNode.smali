...
.method private constructor <init>(Ljava/lang/String;Ljava/lang/String;JJLandroidx/media3/extractor/text/ttml/TtmlStyle;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroidx/media3/extractor/text/ttml/TtmlNode;)V
    ...
    .param p7, "style"    # Landroidx/media3/extractor/text/ttml/TtmlStyle;
    .param p8, "styleIds"    # [Ljava/lang/String;
    .param p9, "regionId"    # Ljava/lang/String;
    .param p10, "imageId"    # Ljava/lang/String;
    .param p11, "parent"    # Landroidx/media3/extractor/text/ttml/TtmlNode;
    ...
    :goto_0
    iput-boolean v0, p0, Landroidx/media3/extractor/text/ttml/TtmlNode;->isTextNode:Z
    ...
    iput-object v0, p0, Landroidx/media3/extractor/text/ttml/TtmlNode;->regionId:Ljava/lang/String;
    ...
    iput-object v0, p0, Landroidx/media3/extractor/text/ttml/TtmlNode;->nodeStartsByRegion:Ljava/util/HashMap;
    ...
    iput-object v0, p0, Landroidx/media3/extractor/text/ttml/TtmlNode;->nodeEndsByRegion:Ljava/util/HashMap;
...
.method private applyStyleToOutput(Ljava/util/Map;Landroidx/media3/common/text/Cue$Builder;III)V
    .locals 9
    .param p2, "regionOutput"    # Landroidx/media3/common/text/Cue$Builder;
    .param p3, "start"    # I
    .param p4, "end"    # I
    ...
    .line 401
    .local v5, "resolvedStyle":Landroidx/media3/extractor/text/ttml/TtmlStyle;
    ...
    .line 406
    .end local v0    # "text":Landroid/text/SpannableStringBuilder;
    ...
    .end local p1    # "globalStyles":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Landroidx/media3/extractor/text/ttml/TtmlStyle;>;"
    .end local p3    # "start":I
    .end local p4    # "end":I
    .end local p5    # "verticalType":I
    .local v3, "start":I
    .local v4, "end":I
    .local v7, "globalStyles":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Landroidx/media3/extractor/text/ttml/TtmlStyle;>;"
    .local v8, "verticalType":I
    ...
    .end local v8    # "verticalType":I
    .restart local p1    # "globalStyles":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Landroidx/media3/extractor/text/ttml/TtmlStyle;>;"
    .restart local p3    # "start":I
    .restart local p4    # "end":I
    .restart local p5    # "verticalType":I
    :cond_3
    move-object v7, p1
    ...
    .restart local v7    # "globalStyles":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Landroidx/media3/extractor/text/ttml/TtmlStyle;>;"
    .restart local v8    # "verticalType":I
    :cond_4
    :goto_1
    return-void
.end method
...
.method public static buildNode(Ljava/lang/String;JJLandroidx/media3/extractor/text/ttml/TtmlStyle;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroidx/media3/extractor/text/ttml/TtmlNode;)Landroidx/media3/extractor/text/ttml/TtmlNode;
    ...
    .param p5, "style"    # Landroidx/media3/extractor/text/ttml/TtmlStyle;
    .param p6, "styleIds"    # [Ljava/lang/String;
    .param p7, "regionId"    # Ljava/lang/String;
    .param p8, "imageId"    # Ljava/lang/String;
    .param p9, "parent"    # Landroidx/media3/extractor/text/ttml/TtmlNode;
...
.method private static cleanUpText(Landroid/text/SpannableStringBuilder;)V
    ...
    .line 434
    .local v0, "deleteTextSpans":[Landroidx/media3/extractor/text/ttml/DeleteTextSpan;
    array-length v1, v0
    ...
    .line 435
    .local v4, "deleteTextSpan":Landroidx/media3/extractor/text/ttml/DeleteTextSpan;
    ...
    .line 434
    .end local v4    # "deleteTextSpan":Landroidx/media3/extractor/text/ttml/DeleteTextSpan;
...
.method private getEventTimes(Ljava/util/TreeSet;Z)V
    ...
    iget-object v2, p0, Landroidx/media3/extractor/text/ttml/TtmlNode;->imageId:Ljava/lang/String;

    if-eqz v2, :cond_2

    .line 229
    :cond_0
    iget-wide v2, p0, Landroidx/media3/extractor/text/ttml/TtmlNode;->startTimeUs:J
    ...
    .line 236
    :cond_2
    iget-object v2, p0, Landroidx/media3/extractor/text/ttml/TtmlNode;->children:Ljava/util/List;
...
.method private static getRegionOutputText(Ljava/lang/String;Ljava/util/Map;)Landroid/text/SpannableStringBuilder;
    ...
    .line 359
    .local p1, "regionOutputs":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Landroidx/media3/common/text/Cue$Builder;>;"
    ...
    .line 361
    .local v0, "regionOutput":Landroidx/media3/common/text/Cue$Builder;
    new-instance v1, Landroid/text/SpannableStringBuilder;
    ...
    .line 364
    .end local v0    # "regionOutput":Landroidx/media3/common/text/Cue$Builder;
    :cond_0
...
.method private traverseForImage(JLjava/lang/String;Ljava/util/List;)V
    ...
    :cond_0
    iget-object v0, p0, Landroidx/media3/extractor/text/ttml/TtmlNode;->regionId:Ljava/lang/String;
    ...
    invoke-direct {v2, p1, p2, v0, p4}, Landroidx/media3/extractor/text/ttml/TtmlNode;->traverseForImage(JLjava/lang/String;Ljava/util/List;)V
...
.method private traverseForStyle(JLjava/util/Map;Ljava/util/Map;Ljava/lang/String;Ljava/util/Map;)V
    ...
    .line 373
    .local p3, "globalStyles":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Landroidx/media3/extractor/text/ttml/TtmlStyle;>;"
    .local p4, "regionMaps":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Landroidx/media3/extractor/text/ttml/TtmlRegion;>;"
    .local p6, "regionOutputs":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Landroidx/media3/common/text/Cue$Builder;>;"
    ...
    .line 384
    .local v2, "regionOutput":Landroidx/media3/common/text/Cue$Builder;
    ...
    iget v5, v1, Landroidx/media3/extractor/text/ttml/TtmlRegion;->verticalType:I
    ...
    .line 381
    .end local v2    # "regionOutput":Landroidx/media3/common/text/Cue$Builder;
...
.method private traverseForText(JZLjava/lang/String;Ljava/util/Map;)V
    ...
    .line 323
    .local p5, "regionOutputs":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Landroidx/media3/common/text/Cue$Builder;>;"
    ...
    .line 333
    invoke-static {v5, p5}, Landroidx/media3/extractor/text/ttml/TtmlNode;->getRegionOutputText(Ljava/lang/String;Ljava/util/Map;)Landroid/text/SpannableStringBuilder;

    move-result-object v0

    iget-object v1, p0, Landroidx/media3/extractor/text/ttml/TtmlNode;->text:Ljava/lang/String;
    ...
    .line 339
    .local v1, "entry":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Ljava/lang/String;Landroidx/media3/common/text/Cue$Builder;>;"
    ...
    invoke-virtual {v4}, Landroidx/media3/common/text/Cue$Builder;->getText()Ljava/lang/CharSequence;
    ...
    .line 340
    .end local v1    # "entry":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Ljava/lang/String;Landroidx/media3/common/text/Cue$Builder;>;"
    goto :goto_1
    ...
    .end local p5    # "regionOutputs":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Landroidx/media3/common/text/Cue$Builder;>;"
    .local v2, "timeUs":J
    .local v6, "regionOutputs":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Landroidx/media3/common/text/Cue$Builder;>;"
    invoke-direct/range {v1 .. v6}, Landroidx/media3/extractor/text/ttml/TtmlNode;->traverseForText(JZLjava/lang/String;Ljava/util/Map;)V
    ...
    .end local v6    # "regionOutputs":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Landroidx/media3/common/text/Cue$Builder;>;"
    .restart local p1    # "timeUs":J
    .restart local p5    # "regionOutputs":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Landroidx/media3/common/text/Cue$Builder;>;"
    :cond_7
    move-wide v2, p1
    ...
    .restart local v6    # "regionOutputs":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Landroidx/media3/common/text/Cue$Builder;>;"
    if-eqz v0, :cond_8

    .line 348
    invoke-static {v5, v6}, Landroidx/media3/extractor/text/ttml/TtmlNode;->getRegionOutputText(Ljava/lang/String;Ljava/util/Map;)Landroid/text/SpannableStringBuilder;
    ...
    .line 352
    .local p2, "entry":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Ljava/lang/String;Landroidx/media3/common/text/Cue$Builder;>;"
    iget-object p5, p0, Landroidx/media3/extractor/text/ttml/TtmlNode;->nodeEndsByRegion:Ljava/util/HashMap;
    ...
    .line 353
    .end local p2    # "entry":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Ljava/lang/String;Landroidx/media3/common/text/Cue$Builder;>;"
    goto :goto_5
...
.method public addChild(Landroidx/media3/extractor/text/ttml/TtmlNode;)V
    .locals 1
    .param p1, "child"    # Landroidx/media3/extractor/text/ttml/TtmlNode;
...
.method public getCues(JLjava/util/Map;Ljava/util/Map;Ljava/util/Map;)Ljava/util/List;
    ...
    .line 255
    .local p3, "globalStyles":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Landroidx/media3/extractor/text/ttml/TtmlStyle;>;"
    .local p4, "regionMap":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Landroidx/media3/extractor/text/ttml/TtmlRegion;>;"
    ...
    .line 256
    .local v7, "regionImageOutputs":Ljava/util/List;, "Ljava/util/List<Landroid/util/Pair<Ljava/lang/String;Ljava/lang/String;>;>;"
    iget-object v0, p0, Landroidx/media3/extractor/text/ttml/TtmlNode;->regionId:Ljava/lang/String;

    move-wide v1, p1

    invoke-direct {p0, v1, v2, v0, v7}, Landroidx/media3/extractor/text/ttml/TtmlNode;->traverseForImage(JLjava/lang/String;Ljava/util/List;)V
    ...
    .line 259
    .local v6, "regionTextOutputs":Ljava/util/TreeMap;, "Ljava/util/TreeMap<Ljava/lang/String;Landroidx/media3/common/text/Cue$Builder;>;"
    const/4 v4, 0x0

    iget-object v5, p0, Landroidx/media3/extractor/text/ttml/TtmlNode;->regionId:Ljava/lang/String;
    ...
    invoke-direct/range {v0 .. v6}, Landroidx/media3/extractor/text/ttml/TtmlNode;->traverseForStyle(JLjava/util/Map;Ljava/util/Map;Ljava/lang/String;Ljava/util/Map;)V
    ...
    invoke-static {v9, v8, v10}, Landroid/graphics/BitmapFactory;->decodeByteArray([BII)Landroid/graphics/Bitmap;
    ...
    check-cast v11, Landroidx/media3/extractor/text/ttml/TtmlRegion;
    ...
    .line 276
    .local v11, "region":Landroidx/media3/extractor/text/ttml/TtmlRegion;
    new-instance v12, Landroidx/media3/common/text/Cue$Builder;

    invoke-direct {v12}, Landroidx/media3/common/text/Cue$Builder;-><init>()V

    .line 278
    invoke-virtual {v12, v10}, Landroidx/media3/common/text/Cue$Builder;->setBitmap(Landroid/graphics/Bitmap;)Landroidx/media3/common/text/Cue$Builder;

    move-result-object v12

    iget v13, v11, Landroidx/media3/extractor/text/ttml/TtmlRegion;->position:F

    .line 279
    invoke-virtual {v12, v13}, Landroidx/media3/common/text/Cue$Builder;->setPosition(F)Landroidx/media3/common/text/Cue$Builder;

    move-result-object v12

    .line 280
    invoke-virtual {v12, v8}, Landroidx/media3/common/text/Cue$Builder;->setPositionAnchor(I)Landroidx/media3/common/text/Cue$Builder;

    move-result-object v12

    iget v13, v11, Landroidx/media3/extractor/text/ttml/TtmlRegion;->line:F

    .line 281
    invoke-virtual {v12, v13, v8}, Landroidx/media3/common/text/Cue$Builder;->setLine(FI)Landroidx/media3/common/text/Cue$Builder;

    move-result-object v8

    iget v12, v11, Landroidx/media3/extractor/text/ttml/TtmlRegion;->lineAnchor:I

    .line 282
    invoke-virtual {v8, v12}, Landroidx/media3/common/text/Cue$Builder;->setLineAnchor(I)Landroidx/media3/common/text/Cue$Builder;

    move-result-object v8

    iget v12, v11, Landroidx/media3/extractor/text/ttml/TtmlRegion;->width:F

    .line 283
    invoke-virtual {v8, v12}, Landroidx/media3/common/text/Cue$Builder;->setSize(F)Landroidx/media3/common/text/Cue$Builder;

    move-result-object v8

    iget v12, v11, Landroidx/media3/extractor/text/ttml/TtmlRegion;->height:F

    .line 284
    invoke-virtual {v8, v12}, Landroidx/media3/common/text/Cue$Builder;->setBitmapHeight(F)Landroidx/media3/common/text/Cue$Builder;

    move-result-object v8

    iget v12, v11, Landroidx/media3/extractor/text/ttml/TtmlRegion;->verticalType:I

    .line 285
    invoke-virtual {v8, v12}, Landroidx/media3/common/text/Cue$Builder;->setVerticalType(I)Landroidx/media3/common/text/Cue$Builder;

    move-result-object v8

    .line 286
    invoke-virtual {v8}, Landroidx/media3/common/text/Cue$Builder;->build()Landroidx/media3/common/text/Cue;
    ...
    .end local v11    # "region":Landroidx/media3/extractor/text/ttml/TtmlRegion;
    goto :goto_0
    ...
    .line 291
    .local v2, "entry":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Ljava/lang/String;Landroidx/media3/common/text/Cue$Builder;>;"
    ...
    .line 292
    .local v3, "region":Landroidx/media3/extractor/text/ttml/TtmlRegion;
    invoke-interface {v2}, Ljava/util/Map$Entry;->getValue()Ljava/lang/Object;

    move-result-object v8

    check-cast v8, Landroidx/media3/common/text/Cue$Builder;

    .line 293
    .local v8, "regionOutput":Landroidx/media3/common/text/Cue$Builder;
    invoke-virtual {v8}, Landroidx/media3/common/text/Cue$Builder;->getText()Ljava/lang/CharSequence;
    ...
    invoke-static {v9}, Landroidx/media3/extractor/text/ttml/TtmlNode;->cleanUpText(Landroid/text/SpannableStringBuilder;)V

    .line 294
    iget v9, v3, Landroidx/media3/extractor/text/ttml/TtmlRegion;->line:F

    iget v10, v3, Landroidx/media3/extractor/text/ttml/TtmlRegion;->lineType:I

    invoke-virtual {v8, v9, v10}, Landroidx/media3/common/text/Cue$Builder;->setLine(FI)Landroidx/media3/common/text/Cue$Builder;

    .line 295
    iget v9, v3, Landroidx/media3/extractor/text/ttml/TtmlRegion;->lineAnchor:I

    invoke-virtual {v8, v9}, Landroidx/media3/common/text/Cue$Builder;->setLineAnchor(I)Landroidx/media3/common/text/Cue$Builder;

    .line 296
    iget v9, v3, Landroidx/media3/extractor/text/ttml/TtmlRegion;->position:F

    invoke-virtual {v8, v9}, Landroidx/media3/common/text/Cue$Builder;->setPosition(F)Landroidx/media3/common/text/Cue$Builder;

    .line 297
    iget v9, v3, Landroidx/media3/extractor/text/ttml/TtmlRegion;->width:F

    invoke-virtual {v8, v9}, Landroidx/media3/common/text/Cue$Builder;->setSize(F)Landroidx/media3/common/text/Cue$Builder;

    .line 298
    iget v9, v3, Landroidx/media3/extractor/text/ttml/TtmlRegion;->textSize:F

    iget v10, v3, Landroidx/media3/extractor/text/ttml/TtmlRegion;->textSizeType:I

    invoke-virtual {v8, v9, v10}, Landroidx/media3/common/text/Cue$Builder;->setTextSize(FI)Landroidx/media3/common/text/Cue$Builder;

    .line 299
    iget v9, v3, Landroidx/media3/extractor/text/ttml/TtmlRegion;->verticalType:I

    invoke-virtual {v8, v9}, Landroidx/media3/common/text/Cue$Builder;->setVerticalType(I)Landroidx/media3/common/text/Cue$Builder;
    ...
    .line 301
    .end local v2    # "entry":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Ljava/lang/String;Landroidx/media3/common/text/Cue$Builder;>;"
    .end local v3    # "region":Landroidx/media3/extractor/text/ttml/TtmlRegion;
    .end local v8    # "regionOutput":Landroidx/media3/common/text/Cue$Builder;
    goto :goto_1
