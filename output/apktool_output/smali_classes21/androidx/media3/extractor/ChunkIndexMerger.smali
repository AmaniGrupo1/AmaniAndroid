...
.method public add(Landroidx/media3/extractor/ChunkIndex;)V
    .locals 5
    .param p1, "chunk"    # Landroidx/media3/extractor/ChunkIndex;
...
.method public merge()Landroidx/media3/extractor/ChunkIndex;
    ...
    .line 60
    .local v0, "sizesList":Ljava/util/List;, "Ljava/util/List<[I>;"
    new-instance v1, Ljava/util/ArrayList;

    invoke-direct {v1}, Ljava/util/ArrayList;-><init>()V

    .line 61
    .local v1, "offsetsList":Ljava/util/List;, "Ljava/util/List<[J>;"
    new-instance v2, Ljava/util/ArrayList;

    invoke-direct {v2}, Ljava/util/ArrayList;-><init>()V

    .line 62
    .local v2, "durationsList":Ljava/util/List;, "Ljava/util/List<[J>;"
    new-instance v3, Ljava/util/ArrayList;

    invoke-direct {v3}, Ljava/util/ArrayList;-><init>()V

    .line 64
    .local v3, "timesList":Ljava/util/List;, "Ljava/util/List<[J>;"
    ...
    .line 65
    .local v5, "chunk":Landroidx/media3/extractor/ChunkIndex;
    ...
    .line 68
    iget-object v6, v5, Landroidx/media3/extractor/ChunkIndex;->timesUs:[J

    invoke-interface {v3, v6}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    .line 69
    .end local v5    # "chunk":Landroidx/media3/extractor/ChunkIndex;
    goto :goto_0
    ...
    invoke-static {v6}, Lcom/google/common/primitives/Longs;->concat([[J)[J
    ...
    invoke-static {v7}, Lcom/google/common/primitives/Longs;->concat([[J)[J
    ...
    invoke-static {v8}, Lcom/google/common/primitives/Longs;->concat([[J)[J

    move-result-object v8

    invoke-direct {v4, v5, v6, v7, v8}, Landroidx/media3/extractor/ChunkIndex;-><init>([I[J[J[J)V
