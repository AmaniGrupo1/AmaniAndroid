...
.method public constructor <init>(Landroidx/media3/extractor/SeekPoint;)V
    .locals 0
    .param p1, "point"    # Landroidx/media3/extractor/SeekPoint;
...
.method public constructor <init>(Landroidx/media3/extractor/SeekPoint;Landroidx/media3/extractor/SeekPoint;)V
    .locals 1
    .param p1, "first"    # Landroidx/media3/extractor/SeekPoint;
    .param p2, "second"    # Landroidx/media3/extractor/SeekPoint;
    ...
    iput-object v0, p0, Landroidx/media3/extractor/SeekMap$SeekPoints;->first:Landroidx/media3/extractor/SeekPoint;
    ...
    iput-object v0, p0, Landroidx/media3/extractor/SeekMap$SeekPoints;->second:Landroidx/media3/extractor/SeekPoint;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    check-cast v2, Landroidx/media3/extractor/SeekMap$SeekPoints;

    .line 110
    .local v2, "other":Landroidx/media3/extractor/SeekMap$SeekPoints;
    iget-object v3, p0, Landroidx/media3/extractor/SeekMap$SeekPoints;->first:Landroidx/media3/extractor/SeekPoint;

    iget-object v4, v2, Landroidx/media3/extractor/SeekMap$SeekPoints;->first:Landroidx/media3/extractor/SeekPoint;

    invoke-virtual {v3, v4}, Landroidx/media3/extractor/SeekPoint;->equals(Ljava/lang/Object;)Z

    move-result v3

    if-eqz v3, :cond_2

    iget-object v3, p0, Landroidx/media3/extractor/SeekMap$SeekPoints;->second:Landroidx/media3/extractor/SeekPoint;

    iget-object v4, v2, Landroidx/media3/extractor/SeekMap$SeekPoints;->second:Landroidx/media3/extractor/SeekPoint;
    ...
    .line 107
    .end local v2    # "other":Landroidx/media3/extractor/SeekMap$SeekPoints;
    :cond_3
    :goto_1
    return v1
.end method
