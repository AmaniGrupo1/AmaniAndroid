...
.method static synthetic lambda$static$0(Landroidx/media3/extractor/metadata/mp4/SlowMotionData$Segment;Landroidx/media3/extractor/metadata/mp4/SlowMotionData$Segment;)I
    .locals 5
    .param p0, "s1"    # Landroidx/media3/extractor/metadata/mp4/SlowMotionData$Segment;
    .param p1, "s2"    # Landroidx/media3/extractor/metadata/mp4/SlowMotionData$Segment;
    ...
    iget v2, p1, Landroidx/media3/extractor/metadata/mp4/SlowMotionData$Segment;->speedDivisor:I
...
.method public equals(Ljava/lang/Object;)Z
    ...
    .line 88
    .local v2, "segment":Landroidx/media3/extractor/metadata/mp4/SlowMotionData$Segment;
    iget-wide v3, p0, Landroidx/media3/extractor/metadata/mp4/SlowMotionData$Segment;->startTimeMs:J

    iget-wide v5, v2, Landroidx/media3/extractor/metadata/mp4/SlowMotionData$Segment;->startTimeMs:J

    cmp-long v3, v3, v5

    if-nez v3, :cond_2

    iget-wide v3, p0, Landroidx/media3/extractor/metadata/mp4/SlowMotionData$Segment;->endTimeMs:J

    iget-wide v5, v2, Landroidx/media3/extractor/metadata/mp4/SlowMotionData$Segment;->endTimeMs:J

    cmp-long v3, v3, v5

    if-nez v3, :cond_2

    iget v3, p0, Landroidx/media3/extractor/metadata/mp4/SlowMotionData$Segment;->speedDivisor:I

    iget v4, v2, Landroidx/media3/extractor/metadata/mp4/SlowMotionData$Segment;->speedDivisor:I
    ...
    .line 85
    .end local v2    # "segment":Landroidx/media3/extractor/metadata/mp4/SlowMotionData$Segment;
    :cond_3
    :goto_1
    return v1
.end method
