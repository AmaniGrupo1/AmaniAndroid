...
.method private static resetPosition(Landroidx/media3/common/util/ParsableByteArray;)Landroidx/media3/common/util/ParsableByteArray;
    .locals 1
    .param p0, "scratch"    # Landroidx/media3/common/util/ParsableByteArray;
...
.method private sniffInternal(Landroidx/media3/extractor/ExtractorInput;)Z
    ...
    .line 97
    .local v0, "header":Landroidx/media3/extractor/ogg/OggPageHeader;
    const/4 v1, 0x1
    ...
    .line 101
    :cond_0
    iget v2, v0, Landroidx/media3/extractor/ogg/OggPageHeader;->bodySize:I
    ...
    .line 105
    invoke-static {v4}, Landroidx/media3/extractor/ogg/OggExtractor;->resetPosition(Landroidx/media3/common/util/ParsableByteArray;)Landroidx/media3/common/util/ParsableByteArray;

    move-result-object v5

    invoke-static {v5}, Landroidx/media3/extractor/ogg/FlacReader;->verifyBitstreamType(Landroidx/media3/common/util/ParsableByteArray;)Z
    ...
    .line 106
    new-instance v3, Landroidx/media3/extractor/ogg/FlacReader;

    invoke-direct {v3}, Landroidx/media3/extractor/ogg/FlacReader;-><init>()V

    iput-object v3, p0, Landroidx/media3/extractor/ogg/OggExtractor;->streamReader:Landroidx/media3/extractor/ogg/StreamReader;
    ...
    invoke-static {v5}, Landroidx/media3/extractor/ogg/VorbisReader;->verifyBitstreamType(Landroidx/media3/common/util/ParsableByteArray;)Z
    ...
    .line 108
    new-instance v3, Landroidx/media3/extractor/ogg/VorbisReader;

    invoke-direct {v3}, Landroidx/media3/extractor/ogg/VorbisReader;-><init>()V
    ...
    invoke-static {v5}, Landroidx/media3/extractor/ogg/OpusReader;->verifyBitstreamType(Landroidx/media3/common/util/ParsableByteArray;)Z
    ...
    .line 110
    new-instance v3, Landroidx/media3/extractor/ogg/OpusReader;

    invoke-direct {v3}, Landroidx/media3/extractor/ogg/OpusReader;-><init>()V
    ...
    .end local v4    # "scratch":Landroidx/media3/common/util/ParsableByteArray;
    :cond_4
    :goto_1
    return v3
.end method
