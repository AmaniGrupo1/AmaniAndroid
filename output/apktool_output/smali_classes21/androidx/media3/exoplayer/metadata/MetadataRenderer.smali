...
.method public constructor <init>(Landroidx/media3/exoplayer/metadata/MetadataOutput;Landroid/os/Looper;)V
    .locals 1
    .param p1, "output"    # Landroidx/media3/exoplayer/metadata/MetadataOutput;
...
.method public constructor <init>(Landroidx/media3/exoplayer/metadata/MetadataOutput;Landroid/os/Looper;Landroidx/media3/exoplayer/metadata/MetadataDecoderFactory;)V
    ...
    .param p1, "output"    # Landroidx/media3/exoplayer/metadata/MetadataOutput;
    .param p2, "outputLooper"    # Landroid/os/Looper;
    .param p3, "decoderFactory"    # Landroidx/media3/exoplayer/metadata/MetadataDecoderFactory;
...
.method public constructor <init>(Landroidx/media3/exoplayer/metadata/MetadataOutput;Landroid/os/Looper;Landroidx/media3/exoplayer/metadata/MetadataDecoderFactory;Z)V
    ...
    check-cast v0, Landroidx/media3/exoplayer/metadata/MetadataOutput;

    iput-object v0, p0, Landroidx/media3/exoplayer/metadata/MetadataRenderer;->output:Landroidx/media3/exoplayer/metadata/MetadataOutput;
    ...
    :goto_0
    iput-object v0, p0, Landroidx/media3/exoplayer/metadata/MetadataRenderer;->outputHandler:Landroid/os/Handler;
    ...
    check-cast v0, Landroidx/media3/exoplayer/metadata/MetadataDecoderFactory;
    ...
    .line 124
    new-instance v0, Landroidx/media3/extractor/metadata/MetadataInputBuffer;

    invoke-direct {v0}, Landroidx/media3/extractor/metadata/MetadataInputBuffer;-><init>()V

    iput-object v0, p0, Landroidx/media3/exoplayer/metadata/MetadataRenderer;->buffer:Landroidx/media3/extractor/metadata/MetadataInputBuffer;
...
.method private decodeWrappedMetadata(Landroidx/media3/common/Metadata;Ljava/util/List;)V
    ...
    .line 181
    .local p2, "decodedEntries":Ljava/util/List;, "Ljava/util/List<Landroidx/media3/common/Metadata$Entry;>;"
    const/4 v0, 0x0
    ...
    .line 183
    .local v1, "wrappedMetadataFormat":Landroidx/media3/common/Format;
    if-eqz v1, :cond_1
    ...
    .line 187
    .local v2, "wrappedMetadataDecoder":Landroidx/media3/extractor/metadata/MetadataDecoder;
    invoke-virtual {p1, v0}, Landroidx/media3/common/Metadata;->get(I)Landroidx/media3/common/Metadata$Entry;

    move-result-object v3

    invoke-interface {v3}, Landroidx/media3/common/Metadata$Entry;->getWrappedMetadataBytes()[B
    ...
    iget-object v4, p0, Landroidx/media3/exoplayer/metadata/MetadataRenderer;->buffer:Landroidx/media3/extractor/metadata/MetadataInputBuffer;

    invoke-virtual {v4}, Landroidx/media3/extractor/metadata/MetadataInputBuffer;->clear()V
    ...
    invoke-virtual {v4, v5}, Landroidx/media3/extractor/metadata/MetadataInputBuffer;->ensureSpaceForWrite(I)V

    .line 190
    iget-object v4, p0, Landroidx/media3/exoplayer/metadata/MetadataRenderer;->buffer:Landroidx/media3/extractor/metadata/MetadataInputBuffer;

    iget-object v4, v4, Landroidx/media3/extractor/metadata/MetadataInputBuffer;->data:Ljava/nio/ByteBuffer;
    ...
    invoke-virtual {v4}, Landroidx/media3/extractor/metadata/MetadataInputBuffer;->flip()V

    .line 192
    iget-object v4, p0, Landroidx/media3/exoplayer/metadata/MetadataRenderer;->buffer:Landroidx/media3/extractor/metadata/MetadataInputBuffer;

    invoke-interface {v2, v4}, Landroidx/media3/extractor/metadata/MetadataDecoder;->decode(Landroidx/media3/extractor/metadata/MetadataInputBuffer;)Landroidx/media3/common/Metadata;

    move-result-object v4

    .line 193
    .local v4, "innerMetadata":Landroidx/media3/common/Metadata;
    if-eqz v4, :cond_0

    .line 195
    invoke-direct {p0, v4, p2}, Landroidx/media3/exoplayer/metadata/MetadataRenderer;->decodeWrappedMetadata(Landroidx/media3/common/Metadata;Ljava/util/List;)V

    .line 197
    .end local v2    # "wrappedMetadataDecoder":Landroidx/media3/extractor/metadata/MetadataDecoder;
    .end local v3    # "wrappedMetadataBytes":[B
    .end local v4    # "innerMetadata":Landroidx/media3/common/Metadata;
    :cond_0
    goto :goto_1
    ...
    .line 181
    .end local v1    # "wrappedMetadataFormat":Landroidx/media3/common/Format;
    :goto_1
...
.method private outputMetadata(J)Z
    ...
    iget-object v1, p0, Landroidx/media3/exoplayer/metadata/MetadataRenderer;->pendingMetadata:Landroidx/media3/common/Metadata;

    if-eqz v1, :cond_1

    iget-boolean v1, p0, Landroidx/media3/exoplayer/metadata/MetadataRenderer;->outputMetadataEarly:Z

    if-nez v1, :cond_0

    iget-object v1, p0, Landroidx/media3/exoplayer/metadata/MetadataRenderer;->pendingMetadata:Landroidx/media3/common/Metadata;

    iget-wide v1, v1, Landroidx/media3/common/Metadata;->presentationTimeUs:J
    ...
    invoke-direct {p0, v1}, Landroidx/media3/exoplayer/metadata/MetadataRenderer;->invokeRenderer(Landroidx/media3/common/Metadata;)V
    ...
    .line 271
    :cond_1
    iget-boolean v1, p0, Landroidx/media3/exoplayer/metadata/MetadataRenderer;->inputStreamEnded:Z
...
.method private readMetadata()V
    ...
    invoke-virtual {v2}, Landroidx/media3/extractor/metadata/MetadataInputBuffer;->isEndOfStream()Z
    ...
    iput-boolean v2, p0, Landroidx/media3/exoplayer/metadata/MetadataRenderer;->inputStreamEnded:Z
    ...
    iput-wide v3, v2, Landroidx/media3/extractor/metadata/MetadataInputBuffer;->subsampleOffsetUs:J
    ...
    .line 245
    iget-object v2, p0, Landroidx/media3/exoplayer/metadata/MetadataRenderer;->decoder:Landroidx/media3/extractor/metadata/MetadataDecoder;

    invoke-static {v2}, Landroidx/media3/common/util/Util;->castNonNull(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v2

    check-cast v2, Landroidx/media3/extractor/metadata/MetadataDecoder;
    ...
    invoke-interface {v2, v3}, Landroidx/media3/extractor/metadata/MetadataDecoder;->decode(Landroidx/media3/extractor/metadata/MetadataInputBuffer;)Landroidx/media3/common/Metadata;
    ...
    .line 248
    .local v3, "entries":Ljava/util/List;, "Ljava/util/List<Landroidx/media3/common/Metadata$Entry;>;"
    invoke-direct {p0, v2, v3}, Landroidx/media3/exoplayer/metadata/MetadataRenderer;->decodeWrappedMetadata(Landroidx/media3/common/Metadata;Ljava/util/List;)V
    ...
    iget-object v5, p0, Landroidx/media3/exoplayer/metadata/MetadataRenderer;->buffer:Landroidx/media3/extractor/metadata/MetadataInputBuffer;

    iget-wide v5, v5, Landroidx/media3/extractor/metadata/MetadataInputBuffer;->timeUs:J

    .line 251
    invoke-direct {p0, v5, v6}, Landroidx/media3/exoplayer/metadata/MetadataRenderer;->getPresentationTimeUs(J)J

    move-result-wide v5

    invoke-direct {v4, v5, v6, v3}, Landroidx/media3/common/Metadata;-><init>(JLjava/util/List;)V

    .line 252
    .local v4, "expandedMetadata":Landroidx/media3/common/Metadata;
    iput-object v4, p0, Landroidx/media3/exoplayer/metadata/MetadataRenderer;->pendingMetadata:Landroidx/media3/common/Metadata;

    .line 255
    .end local v2    # "metadata":Landroidx/media3/common/Metadata;
    .end local v3    # "entries":Ljava/util/List;, "Ljava/util/List<Landroidx/media3/common/Metadata$Entry;>;"
    .end local v4    # "expandedMetadata":Landroidx/media3/common/Metadata;
    :cond_1
    goto :goto_0
    ...
    iput-wide v2, p0, Landroidx/media3/exoplayer/metadata/MetadataRenderer;->subsampleOffsetUs:J
...
.method public handleMessage(Landroid/os/Message;)Z
    ...
    invoke-direct {p0, v0}, Landroidx/media3/exoplayer/metadata/MetadataRenderer;->invokeRendererInternal(Landroidx/media3/common/Metadata;)V
...
.method protected onPositionReset(JZZ)V
    ...
    .line 163
    iput-boolean v0, p0, Landroidx/media3/exoplayer/metadata/MetadataRenderer;->outputStreamEnded:Z
...
.method protected onStreamChanged([Landroidx/media3/common/Format;JJLandroidx/media3/exoplayer/source/MediaSource$MediaPeriodId;)V
    ...
    invoke-interface {v0, v1}, Landroidx/media3/exoplayer/metadata/MetadataDecoderFactory;->createDecoder(Landroidx/media3/common/Format;)Landroidx/media3/extractor/metadata/MetadataDecoder;
    ...
    iget-wide v3, p0, Landroidx/media3/exoplayer/metadata/MetadataRenderer;->outputStreamOffsetUs:J
    ...
    .line 152
    invoke-virtual {v0, v1, v2}, Landroidx/media3/common/Metadata;->copyWithPresentationTimeUs(J)Landroidx/media3/common/Metadata;
