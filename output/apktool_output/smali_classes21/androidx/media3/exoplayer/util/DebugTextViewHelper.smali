...
.method public constructor <init>(Landroidx/media3/exoplayer/ExoPlayer;Landroid/widget/TextView;)V
    .locals 2
    .param p1, "player"    # Landroidx/media3/exoplayer/ExoPlayer;
    ...
    .line 57
    new-instance v0, Landroidx/media3/exoplayer/util/DebugTextViewHelper$Updater;

    const/4 v1, 0x0

    invoke-direct {v0, p0, v1}, Landroidx/media3/exoplayer/util/DebugTextViewHelper$Updater;-><init>(Landroidx/media3/exoplayer/util/DebugTextViewHelper;Landroidx/media3/exoplayer/util/DebugTextViewHelper$1;)V

    iput-object v0, p0, Landroidx/media3/exoplayer/util/DebugTextViewHelper;->updater:Landroidx/media3/exoplayer/util/DebugTextViewHelper$Updater;
...
.method private static getDecoderCountersBufferCountString(Landroidx/media3/exoplayer/DecoderCounters;)Ljava/lang/String;
    .locals 2
    .param p0, "counters"    # Landroidx/media3/exoplayer/DecoderCounters;
...
.method protected getAudioString()Ljava/lang/String;
    ...
    .line 160
    .local v1, "decoderCounters":Landroidx/media3/exoplayer/DecoderCounters;
    if-eqz v0, :cond_1
    ...
    iget v3, v0, Landroidx/media3/common/Format;->channelCount:I
...
.method protected getPlayerStateString()Ljava/lang/String;
    ...
    .line 123
    const-string/jumbo v2, "playWhenReady:%s playbackState:%s item:%s"
...
.method protected getVideoString()Ljava/lang/String;
    ...
    .line 133
    .local v1, "videoSize":Landroidx/media3/common/VideoSize;
    iget-object v2, p0, Landroidx/media3/exoplayer/util/DebugTextViewHelper;->player:Landroidx/media3/exoplayer/ExoPlayer;
    ...
    .line 134
    .local v2, "decoderCounters":Landroidx/media3/exoplayer/DecoderCounters;
    if-eqz v0, :cond_1
    ...
    .line 145
    invoke-static {v4}, Landroidx/media3/exoplayer/util/DebugTextViewHelper;->getColorInfoString(Landroidx/media3/common/ColorInfo;)Ljava/lang/String;
    ...
    .line 146
    invoke-static {v4}, Landroidx/media3/exoplayer/util/DebugTextViewHelper;->getPixelAspectRatioString(F)Ljava/lang/String;
    ...
    iget-wide v4, v2, Landroidx/media3/exoplayer/DecoderCounters;->totalVideoFrameProcessingOffsetUs:J

    iget v6, v2, Landroidx/media3/exoplayer/DecoderCounters;->videoFrameProcessingOffsetCount:I

    .line 149
    invoke-static {v4, v5, v6}, Landroidx/media3/exoplayer/util/DebugTextViewHelper;->getVideoFrameProcessingOffsetAverageString(JI)Ljava/lang/String;
