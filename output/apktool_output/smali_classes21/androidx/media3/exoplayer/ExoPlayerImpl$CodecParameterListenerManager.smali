...
.method synthetic constructor <init>(Landroidx/media3/exoplayer/ExoPlayerImpl;ILandroidx/media3/exoplayer/ExoPlayerImpl$1;)V
    ...
    .param p2, "x1"    # I
    .param p3, "x2"    # Landroidx/media3/exoplayer/ExoPlayerImpl$1;
...
.method static synthetic access$2000(Landroidx/media3/exoplayer/ExoPlayerImpl$CodecParameterListenerManager;Landroidx/media3/exoplayer/CodecParameters;)V
    .locals 0
    .param p0, "x0"    # Landroidx/media3/exoplayer/ExoPlayerImpl$CodecParameterListenerManager;
    .param p1, "x1"    # Landroidx/media3/exoplayer/CodecParameters;
...
.method static synthetic access$500(Landroidx/media3/exoplayer/ExoPlayerImpl$CodecParameterListenerManager;Landroidx/media3/exoplayer/CodecParametersChangeListener;Ljava/util/List;)V
    .locals 0
    .param p0, "x0"    # Landroidx/media3/exoplayer/ExoPlayerImpl$CodecParameterListenerManager;
    .param p1, "x1"    # Landroidx/media3/exoplayer/CodecParametersChangeListener;
...
.method private addListener(Landroidx/media3/exoplayer/CodecParametersChangeListener;Ljava/util/List;)V
    ...
    .line 3237
    .local v0, "listenerInitialState":Landroidx/media3/exoplayer/CodecParameters;
    invoke-interface {p1, v0}, Landroidx/media3/exoplayer/CodecParametersChangeListener;->onCodecParametersChanged(Landroidx/media3/exoplayer/CodecParameters;)V
...
.method private createFilteredCodecParameters(Landroidx/media3/exoplayer/CodecParameters;Ljava/util/List;)Landroidx/media3/exoplayer/CodecParameters;
    .locals 5
    .param p1, "source"    # Landroidx/media3/exoplayer/CodecParameters;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 3277
    .local v1, "keysToKeep":Ljava/util/Set;, "Ljava/util/Set<Ljava/lang/String;>;"
    ...
    .line 3279
    invoke-virtual {v0, v3}, Landroidx/media3/exoplayer/CodecParameters$Builder;->remove(Ljava/lang/String;)Landroidx/media3/exoplayer/CodecParameters$Builder;
...
.method private onParametersChanged(Landroidx/media3/exoplayer/CodecParameters;)V
    ...
    .line 3249
    .local v1, "entry":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Landroidx/media3/exoplayer/CodecParametersChangeListener;Ljava/util/List<Ljava/lang/String;>;>;"
    ...
    .line 3250
    .local v2, "listener":Landroidx/media3/exoplayer/CodecParametersChangeListener;
    ...
    .line 3252
    .local v3, "listenerKeys":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    nop

    .line 3253
    invoke-direct {p0, p1, v3}, Landroidx/media3/exoplayer/ExoPlayerImpl$CodecParameterListenerManager;->createFilteredCodecParameters(Landroidx/media3/exoplayer/CodecParameters;Ljava/util/List;)Landroidx/media3/exoplayer/CodecParameters;

    move-result-object v4

    .line 3254
    .local v4, "listenerCurrentState":Landroidx/media3/exoplayer/CodecParameters;
    iget-object v5, p0, Landroidx/media3/exoplayer/ExoPlayerImpl$CodecParameterListenerManager;->lastNotifiedParameters:Landroidx/media3/exoplayer/CodecParameters;

    .line 3255
    invoke-direct {p0, v5, v3}, Landroidx/media3/exoplayer/ExoPlayerImpl$CodecParameterListenerManager;->createFilteredCodecParameters(Landroidx/media3/exoplayer/CodecParameters;Ljava/util/List;)Landroidx/media3/exoplayer/CodecParameters;

    move-result-object v5

    .line 3257
    .local v5, "listenerPreviousState":Landroidx/media3/exoplayer/CodecParameters;
    invoke-virtual {v4, v5}, Landroidx/media3/exoplayer/CodecParameters;->equals(Ljava/lang/Object;)Z
    ...
    .line 3258
    invoke-interface {v2, v4}, Landroidx/media3/exoplayer/CodecParametersChangeListener;->onCodecParametersChanged(Landroidx/media3/exoplayer/CodecParameters;)V

    .line 3260
    .end local v1    # "entry":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Landroidx/media3/exoplayer/CodecParametersChangeListener;Ljava/util/List<Ljava/lang/String;>;>;"
    .end local v2    # "listener":Landroidx/media3/exoplayer/CodecParametersChangeListener;
    .end local v3    # "listenerKeys":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    .end local v4    # "listenerCurrentState":Landroidx/media3/exoplayer/CodecParameters;
    .end local v5    # "listenerPreviousState":Landroidx/media3/exoplayer/CodecParameters;
    :cond_0
    goto :goto_0
...
.method private updateAndSendSubscribedKeysToRenderer()V
    ...
    .line 3266
    .local v0, "newKeysBuilder":Lcom/google/common/collect/ImmutableSet$Builder;, "Lcom/google/common/collect/ImmutableSet$Builder<Ljava/lang/String;>;"
    iget-object v1, p0, Landroidx/media3/exoplayer/ExoPlayerImpl$CodecParameterListenerManager;->listeners:Ljava/util/Map;
    ...
    invoke-static {v1, v2, v4, v3}, Landroidx/media3/exoplayer/ExoPlayerImpl;->access$800(Landroidx/media3/exoplayer/ExoPlayerImpl;IILjava/lang/Object;)V
