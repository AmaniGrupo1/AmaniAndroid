...
.method public constructor <init>(Landroidx/media3/datasource/DataSource$Factory;Lcom/google/common/base/Supplier;)V
    ...
    .line 95
    .local p2, "downloadExecutorSupplier":Lcom/google/common/base/Supplier;, "Lcom/google/common/base/Supplier<Landroidx/media3/exoplayer/util/ReleasableExecutor;>;"
...
.method constructor <init>(Landroidx/media3/datasource/DataSource$Factory;Lcom/google/common/base/Supplier;Landroidx/media3/common/util/Clock;)V
    ...
    .line 113
    new-instance v0, Landroidx/media3/exoplayer/upstream/contentsteering/SteeringManifestTracker$SteeringManifestLoaderCallback;

    const/4 v1, 0x0

    invoke-direct {v0, p0, v1}, Landroidx/media3/exoplayer/upstream/contentsteering/SteeringManifestTracker$SteeringManifestLoaderCallback;-><init>(Landroidx/media3/exoplayer/upstream/contentsteering/SteeringManifestTracker;Landroidx/media3/exoplayer/upstream/contentsteering/SteeringManifestTracker$1;)V

    iput-object v0, p0, Landroidx/media3/exoplayer/upstream/contentsteering/SteeringManifestTracker;->steeringManifestLoaderCallback:Landroidx/media3/exoplayer/upstream/contentsteering/SteeringManifestTracker$SteeringManifestLoaderCallback;
...
.method static synthetic access$100(Landroidx/media3/exoplayer/upstream/contentsteering/SteeringManifestTracker;)Z
    .locals 1
    .param p0, "x0"    # Landroidx/media3/exoplayer/upstream/contentsteering/SteeringManifestTracker;
...
.method static synthetic access$200(Landroidx/media3/exoplayer/upstream/ParsingLoadable;JJ)Landroidx/media3/exoplayer/source/LoadEventInfo;
    .locals 1
    .param p0, "x0"    # Landroidx/media3/exoplayer/upstream/ParsingLoadable;
    .param p1, "x1"    # J
    .param p3, "x2"    # J
...
.method static synthetic access$300(Landroidx/media3/exoplayer/upstream/contentsteering/SteeringManifestTracker;)Landroidx/media3/exoplayer/source/MediaSourceEventListener$EventDispatcher;
    ...
    .line 47
    iget-object v0, p0, Landroidx/media3/exoplayer/upstream/contentsteering/SteeringManifestTracker;->eventDispatcher:Landroidx/media3/exoplayer/source/MediaSourceEventListener$EventDispatcher;
...
.method static synthetic access$400(Landroidx/media3/exoplayer/upstream/contentsteering/SteeringManifestTracker;)Landroidx/media3/exoplayer/upstream/contentsteering/SteeringManifest;
    ...
    .line 47
    iget-object v0, p0, Landroidx/media3/exoplayer/upstream/contentsteering/SteeringManifestTracker;->steeringManifest:Landroidx/media3/exoplayer/upstream/contentsteering/SteeringManifest;
...
.method static synthetic access$402(Landroidx/media3/exoplayer/upstream/contentsteering/SteeringManifestTracker;Landroidx/media3/exoplayer/upstream/contentsteering/SteeringManifest;)Landroidx/media3/exoplayer/upstream/contentsteering/SteeringManifest;
    .locals 0
    .param p0, "x0"    # Landroidx/media3/exoplayer/upstream/contentsteering/SteeringManifestTracker;
    .param p1, "x1"    # Landroidx/media3/exoplayer/upstream/contentsteering/SteeringManifest;
...
.method static synthetic access$500(Landroidx/media3/exoplayer/upstream/contentsteering/SteeringManifestTracker;)Landroidx/media3/exoplayer/upstream/contentsteering/SteeringManifestTracker$Callback;
    ...
    .line 47
    iget-object v0, p0, Landroidx/media3/exoplayer/upstream/contentsteering/SteeringManifestTracker;->callback:Landroidx/media3/exoplayer/upstream/contentsteering/SteeringManifestTracker$Callback;
...
.method static synthetic access$800(Landroidx/media3/exoplayer/upstream/contentsteering/SteeringManifestTracker;)Landroidx/media3/common/util/HandlerWrapper;
    ...
    .line 47
    iget-object v0, p0, Landroidx/media3/exoplayer/upstream/contentsteering/SteeringManifestTracker;->steeringManifestReloadHandler:Landroidx/media3/common/util/HandlerWrapper;
...
.method private static buildLoadEventInfo(Landroidx/media3/exoplayer/upstream/ParsingLoadable;JJ)Landroidx/media3/exoplayer/source/LoadEventInfo;
    ...
    .line 197
    .local p0, "loadable":Landroidx/media3/exoplayer/upstream/ParsingLoadable;, "Landroidx/media3/exoplayer/upstream/ParsingLoadable<Landroidx/media3/exoplayer/upstream/contentsteering/SteeringManifest;>;"
...
.method private static getSteeringManifestUrl(Landroid/net/Uri;Landroid/net/Uri;)Landroid/net/Uri;
    .locals 2
    .param p0, "previousSteeringManifestUrl"    # Landroid/net/Uri;
    .param p1, "reloadUri"    # Landroid/net/Uri;
...
.method private loadSteeringManifestImmediately()V
    ...
    .line 160
    .local v0, "steeringManifestUrlBuilder":Landroid/net/Uri$Builder;
    ...
    .line 162
    .local v1, "steeringQueryParameters":Lcom/google/common/collect/ImmutableMap;, "Lcom/google/common/collect/ImmutableMap<Ljava/lang/String;Ljava/lang/String;>;"
    ...
    iget-object v4, p0, Landroidx/media3/exoplayer/upstream/contentsteering/SteeringManifestTracker;->dataSourceFactory:Landroidx/media3/datasource/DataSource$Factory;

    .line 169
    invoke-interface {v4}, Landroidx/media3/datasource/DataSource$Factory;->createDataSource()Landroidx/media3/datasource/DataSource;

    move-result-object v4

    new-instance v5, Landroidx/media3/exoplayer/upstream/contentsteering/SteeringManifestParser;

    invoke-direct {v5}, Landroidx/media3/exoplayer/upstream/contentsteering/SteeringManifestParser;-><init>()V

    const/16 v6, 0x8

    invoke-direct {v3, v4, v2, v6, v5}, Landroidx/media3/exoplayer/upstream/ParsingLoadable;-><init>(Landroidx/media3/datasource/DataSource;Landroidx/media3/datasource/DataSpec;ILandroidx/media3/exoplayer/upstream/ParsingLoadable$Parser;)V

    .line 173
    .local v3, "steeringManifestLoadable":Landroidx/media3/exoplayer/upstream/ParsingLoadable;, "Landroidx/media3/exoplayer/upstream/ParsingLoadable<Landroidx/media3/exoplayer/upstream/contentsteering/SteeringManifest;>;"
    iget-object v4, p0, Landroidx/media3/exoplayer/upstream/contentsteering/SteeringManifestTracker;->steeringManifestLoader:Landroidx/media3/exoplayer/upstream/Loader;

    invoke-static {v4}, Lcom/google/common/base/Preconditions;->checkNotNull(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v4

    check-cast v4, Landroidx/media3/exoplayer/upstream/Loader;

    iget-object v5, p0, Landroidx/media3/exoplayer/upstream/contentsteering/SteeringManifestTracker;->steeringManifestLoaderCallback:Landroidx/media3/exoplayer/upstream/contentsteering/SteeringManifestTracker$SteeringManifestLoaderCallback;

    .line 174
    const/4 v6, 0x0

    invoke-virtual {v4, v3, v5, v6}, Landroidx/media3/exoplayer/upstream/Loader;->startLoading(Landroidx/media3/exoplayer/upstream/Loader$Loadable;Landroidx/media3/exoplayer/upstream/Loader$Callback;I)J
...
.method public start(Landroid/net/Uri;Landroidx/media3/exoplayer/upstream/contentsteering/SteeringManifestTracker$Callback;Landroidx/media3/exoplayer/source/MediaSourceEventListener$EventDispatcher;)V
    .locals 3
    .param p1, "initialSteeringManifestUrl"    # Landroid/net/Uri;
    .param p2, "callback"    # Landroidx/media3/exoplayer/upstream/contentsteering/SteeringManifestTracker$Callback;
    .param p3, "eventDispatcher"    # Landroidx/media3/exoplayer/source/MediaSourceEventListener$EventDispatcher;
    ...
    .line 131
    iget-object v0, p0, Landroidx/media3/exoplayer/upstream/contentsteering/SteeringManifestTracker;->clock:Landroidx/media3/common/util/Clock;
    ...
    .line 134
    iget-object v0, p0, Landroidx/media3/exoplayer/upstream/contentsteering/SteeringManifestTracker;->downloadExecutorSupplier:Lcom/google/common/base/Supplier;
    ...
    iget-object v1, p0, Landroidx/media3/exoplayer/upstream/contentsteering/SteeringManifestTracker;->downloadExecutorSupplier:Lcom/google/common/base/Supplier;

    invoke-interface {v1}, Lcom/google/common/base/Supplier;->get()Ljava/lang/Object;

    move-result-object v1

    check-cast v1, Landroidx/media3/exoplayer/util/ReleasableExecutor;

    invoke-direct {v0, v1}, Landroidx/media3/exoplayer/upstream/Loader;-><init>(Landroidx/media3/exoplayer/util/ReleasableExecutor;)V
    ...
    const-string v1, "SteeringManifestTracker"
