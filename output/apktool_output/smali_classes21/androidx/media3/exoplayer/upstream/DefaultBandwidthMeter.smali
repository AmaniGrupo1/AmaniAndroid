...
.method private constructor <init>(Landroid/content/Context;Ljava/util/Map;ILandroidx/media3/common/util/Clock;Z)V
    ...
    iput-object v0, p0, Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter;->initialBitrateEstimates:Lcom/google/common/collect/ImmutableMap;
    ...
    iput-object v0, p0, Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter;->eventDispatcher:Landroidx/media3/exoplayer/upstream/BandwidthMeter$EventListener$EventDispatcher;

    .line 322
    new-instance v0, Landroidx/media3/exoplayer/upstream/SlidingPercentile;

    invoke-direct {v0, p3}, Landroidx/media3/exoplayer/upstream/SlidingPercentile;-><init>(I)V

    iput-object v0, p0, Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter;->slidingPercentile:Landroidx/media3/exoplayer/upstream/SlidingPercentile;
    ...
    .line 327
    .local v0, "networkTypeObserver":Landroidx/media3/common/util/NetworkTypeObserver;
    invoke-virtual {v0}, Landroidx/media3/common/util/NetworkTypeObserver;->getNetworkType()I

    move-result v1

    iput v1, p0, Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter;->networkType:I

    .line 328
    iget v1, p0, Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter;->networkType:I

    invoke-direct {p0, v1}, Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter;->getInitialBitrateEstimateForNetworkType(I)J

    move-result-wide v1

    iput-wide v1, p0, Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter;->bitrateEstimate:J

    .line 329
    new-instance v1, Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter$$ExternalSyntheticLambda0;

    invoke-direct {v1, p0}, Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter$$ExternalSyntheticLambda0;-><init>(Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter;)V
    ...
    .line 329
    invoke-virtual {v0, v1, v2}, Landroidx/media3/common/util/NetworkTypeObserver;->register(Landroidx/media3/common/util/NetworkTypeObserver$Listener;Ljava/util/concurrent/Executor;)V

    .line 331
    .end local v0    # "networkTypeObserver":Landroidx/media3/common/util/NetworkTypeObserver;
    goto :goto_1
    ...
    iput v0, p0, Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter;->networkType:I
...
.method synthetic constructor <init>(Landroid/content/Context;Ljava/util/Map;ILandroidx/media3/common/util/Clock;ZLandroidx/media3/exoplayer/upstream/DefaultBandwidthMeter$1;)V
    ...
    .param p3, "x2"    # I
    .param p4, "x3"    # Landroidx/media3/common/util/Clock;
    .param p5, "x4"    # Z
    .param p6, "x5"    # Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter$1;
...
.method private getInitialBitrateEstimateForNetworkType(I)J
    ...
    .line 475
    iget-object v1, p0, Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter;->initialBitrateEstimates:Lcom/google/common/collect/ImmutableMap;
    ...
    .line 477
    iget-object v1, p0, Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter;->countryCode:Ljava/lang/String;

    invoke-static {v1, p1}, Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter;->getInitialBitrateEstimatesForCountry(Ljava/lang/String;I)J
...
.method private static getInitialBitrateEstimatesForCountry(Ljava/lang/String;I)J
    ...
    invoke-static {v0}, Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter;->getInitialBitrateCountryGroupAssignment(Ljava/lang/String;)[I
    ...
    .line 504
    :pswitch_1
    sget-object v1, Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter;->DEFAULT_INITIAL_BITRATE_ESTIMATES_5G_NSA:Lcom/google/common/collect/ImmutableList;
    ...
    .line 507
    :pswitch_2
    sget-object v1, Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter;->DEFAULT_INITIAL_BITRATE_ESTIMATES_5G_SA:Lcom/google/common/collect/ImmutableList;
    ...
    .line 502
    :pswitch_3
    sget-object v1, Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter;->DEFAULT_INITIAL_BITRATE_ESTIMATES_4G:Lcom/google/common/collect/ImmutableList;
    ...
    .line 500
    :pswitch_4
    sget-object v1, Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter;->DEFAULT_INITIAL_BITRATE_ESTIMATES_3G:Lcom/google/common/collect/ImmutableList;
    ...
    .line 498
    :pswitch_5
    sget-object v1, Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter;->DEFAULT_INITIAL_BITRATE_ESTIMATES_2G:Lcom/google/common/collect/ImmutableList;
    ...
    .line 496
    :pswitch_6
    sget-object v1, Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter;->DEFAULT_INITIAL_BITRATE_ESTIMATES_WIFI:Lcom/google/common/collect/ImmutableList;
...
.method private static isTransferAtFullNetworkSpeed(Landroidx/media3/datasource/DataSpec;Z)Z
    ...
    invoke-virtual {p0, v0}, Landroidx/media3/datasource/DataSpec;->isFlagSet(I)Z
...
.method private declared-synchronized onNetworkTypeChanged(I)V
    ...
    :try_start_1
    iget-boolean v0, p0, Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter;->resetOnNetworkTypeChange:Z
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    .line 423
    .end local p0    # "this":Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter;
    ...
    :cond_0
    :try_start_2
    iget-boolean v0, p0, Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter;->networkTypeOverrideSet:Z
    :try_end_2
    ...
    .line 430
    :try_start_3
    iget v0, p0, Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter;->networkTypeOverride:I
    :try_end_3
    ...
    .line 450
    iget-object v0, p0, Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter;->clock:Landroidx/media3/common/util/Clock;
    ...
    .line 451
    .local v0, "nowMs":J
    iget v2, p0, Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter;->streamCount:I
    :try_end_8
    ...
    :try_start_a
    iget-wide v5, p0, Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter;->sampleBytesTransferred:J

    iget-wide v7, p0, Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter;->bitrateEstimate:J
    :try_end_a
    .catchall {:try_start_a .. :try_end_a} :catchall_1

    move-object v3, p0

    .restart local p0    # "this":Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter;
    :try_start_b
    invoke-direct/range {v3 .. v8}, Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter;->maybeNotifyBandwidthSample(IJJ)V

    .line 455
    iput-wide v0, v3, Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter;->sampleStartTimeMs:J

    .line 456
    const-wide/16 v5, 0x0

    iput-wide v5, v3, Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter;->sampleBytesTransferred:J

    .line 457
    iput-wide v5, v3, Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter;->totalBytesTransferred:J

    .line 458
    iput-wide v5, v3, Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter;->totalElapsedTimeMs:J

    .line 459
    iget-object v2, v3, Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter;->slidingPercentile:Landroidx/media3/exoplayer/upstream/SlidingPercentile;

    invoke-virtual {v2}, Landroidx/media3/exoplayer/upstream/SlidingPercentile;->reset()V
    :try_end_b
...
.method public declared-synchronized onBytesTransferred(Landroidx/media3/datasource/DataSource;Landroidx/media3/datasource/DataSpec;ZI)V
    ...
    :cond_0
    :try_start_1
    iget-wide v0, p0, Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter;->sampleBytesTransferred:J
    ...
    .line 392
    .end local p0    # "this":Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter;
    .end local p1    # "source":Landroidx/media3/datasource/DataSource;
...
.method public declared-synchronized onTransferEnd(Landroidx/media3/datasource/DataSource;Landroidx/media3/datasource/DataSpec;Z)V
    ...
    :cond_0
    :try_start_1
    iget v0, p0, Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter;->streamCount:I
    ...
    .line 406
    .local v2, "nowMs":J
    iget-wide v4, p0, Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter;->sampleStartTimeMs:J
    ...
    iget-wide v4, p0, Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter;->totalElapsedTimeMs:J

    int-to-long v8, v7

    add-long/2addr v4, v8

    iput-wide v4, p0, Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter;->totalElapsedTimeMs:J

    .line 408
    iget-wide v4, p0, Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter;->totalBytesTransferred:J

    iget-wide v8, p0, Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter;->sampleBytesTransferred:J

    add-long/2addr v4, v8

    iput-wide v4, p0, Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter;->totalBytesTransferred:J
    ...
    iget-object v4, p0, Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter;->slidingPercentile:Landroidx/media3/exoplayer/upstream/SlidingPercentile;
    ...
    invoke-virtual {v4, v5, v0}, Landroidx/media3/exoplayer/upstream/SlidingPercentile;->addSample(IF)V
    ...
    .line 414
    .restart local v0    # "bitsPerSecond":F
    .restart local v2    # "nowMs":J
    .restart local v7    # "sampleElapsedTimeMs":I
    .restart local p1    # "source":Landroidx/media3/datasource/DataSource;
    ...
    invoke-virtual {v4, v5}, Landroidx/media3/exoplayer/upstream/SlidingPercentile;->getPercentile(F)F

    move-result v4

    float-to-long v4, v4

    iput-wide v4, p0, Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter;->bitrateEstimate:J

    .line 416
    :cond_3
    iget-wide v8, p0, Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter;->sampleBytesTransferred:J

    iget-wide v10, p0, Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter;->bitrateEstimate:J
    :try_end_3
    ...
    .restart local p0    # "this":Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter;
    :try_start_4
    invoke-direct/range {v6 .. v11}, Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter;->maybeNotifyBandwidthSample(IJJ)V

    .line 417
    iput-wide v2, v6, Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter;->sampleStartTimeMs:J

    .line 418
    const-wide/16 v4, 0x0

    iput-wide v4, v6, Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter;->sampleBytesTransferred:J
    ...
    .line 420
    :goto_2
    iget v0, v6, Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter;->streamCount:I

    sub-int/2addr v0, v1

    iput v0, v6, Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter;->streamCount:I
    :try_end_4
...
.method public declared-synchronized onTransferStart(Landroidx/media3/datasource/DataSource;Landroidx/media3/datasource/DataSpec;Z)V
    ...
    iput v0, p0, Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter;->streamCount:I
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
