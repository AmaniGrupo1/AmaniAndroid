...
.method public read(Landroid/net/http/UploadDataSink;Ljava/nio/ByteBuffer;)V
    .locals 3
    .param p1, "uploadDataSink"    # Landroid/net/http/UploadDataSink;
    ...
    .line 48
    iget v1, p0, Landroidx/media3/datasource/ByteArrayUploadDataProvider;->position:I

    add-int/2addr v1, v0

    iput v1, p0, Landroidx/media3/datasource/ByteArrayUploadDataProvider;->position:I

    .line 49
    const/4 v1, 0x0

    invoke-virtual {p1, v1}, Landroid/net/http/UploadDataSink;->onReadSucceeded(Z)V
