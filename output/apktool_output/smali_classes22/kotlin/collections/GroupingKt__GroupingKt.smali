...
.method public static final eachCountTo(Lkotlin/collections/Grouping;Ljava/util/Map;)Ljava/util/Map;
    ...
    .local v5, "destination$iv":Ljava/util/Map;
    const/4 v6, 0x0

    .line 337
    .local v6, "$i$f$foldTo":I
    move-object v7, v5
    ...
    .line 337
    .local v18, "$i$a$-aggregateTo-GroupingKt__GroupingKt$foldTo$2$iv":I
    if-eqz v15, :cond_1
    ...
    .end local v18    # "$i$a$-aggregateTo-GroupingKt__GroupingKt$foldTo$2$iv":I
    ...
    .end local v5    # "destination$iv":Ljava/util/Map;
    .end local v6    # "$i$f$foldTo":I
    return-object v7
.end method
...
.method public static final foldTo(Lkotlin/collections/Grouping;Ljava/util/Map;Lkotlin/jvm/functions/Function2;Lkotlin/jvm/functions/Function3;)Ljava/util/Map;
    ...
    .local v6, "$this$aggregateTo$iv":Lkotlin/collections/Grouping;
    const/4 v7, 0x0
    ...
    .line 143
    .local v16, "$i$a$-aggregateTo-GroupingKt__GroupingKt$foldTo$1":I
    if-eqz v12, :cond_1

    invoke-interface {v0, v13, v15}, Lkotlin/jvm/functions/Function2;->invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :goto_2
    invoke-interface {v1, v13, v0, v15}, Lkotlin/jvm/functions/Function3;->invoke(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .end local v14    # "acc":Ljava/lang/Object;
    .end local v15    # "e":Ljava/lang/Object;
    .end local v16    # "$i$a$-aggregateTo-GroupingKt__GroupingKt$foldTo$1":I
    ...
    .line 143
    .end local v5    # "destination$iv":Ljava/util/Map;
    .end local v6    # "$this$aggregateTo$iv":Lkotlin/collections/Grouping;
    .end local v7    # "$i$f$aggregateTo":I
    return-object v5
.end method
...
.method public static final reduceTo(Lkotlin/collections/Grouping;Ljava/util/Map;Lkotlin/jvm/functions/Function3;)Ljava/util/Map;
    ...
    .line 241
    .local v15, "$i$a$-aggregateTo-GroupingKt__GroupingKt$reduceTo$1":I
    if-eqz v11, :cond_1

    goto :goto_2

    :cond_1
    invoke-interface {v0, v12, v14, v13}, Lkotlin/jvm/functions/Function3;->invoke(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .end local v13    # "e":Ljava/lang/Object;
    .end local v14    # "acc":Ljava/lang/Object;
    .end local v15    # "$i$a$-aggregateTo-GroupingKt__GroupingKt$reduceTo$1":I
    :goto_2
