...
.method public static final eachCount(Lkotlin/collections/Grouping;)Ljava/util/Map;
    ...
    .local v5, "$this$aggregateTo$iv$iv":Lkotlin/collections/Grouping;
    const/4 v6, 0x0
    ...
    .line 55
    .local v8, "e$iv$iv":Ljava/lang/Object;
    ...
    .line 57
    .local v10, "accumulator$iv$iv":Ljava/lang/Object;
    if-nez v10, :cond_0
    ...
    .local v12, "first$iv":Z
    .local v15, "acc$iv":Ljava/lang/Object;
    const/16 v16, 0x0

    .line 53
    .local v16, "$i$a$-aggregateTo-GroupingKt__GroupingKt$foldTo$1$iv":I
    if-eqz v12, :cond_1

    const/16 v17, 0x0

    .line 23
    .local v17, "$i$a$-foldTo-GroupingKt__GroupingJVMKt$eachCount$1":I
    new-instance v18, Lkotlin/jvm/internal/Ref$IntRef;

    invoke-direct/range {v18 .. v18}, Lkotlin/jvm/internal/Ref$IntRef;-><init>()V

    .line 53
    .end local v17    # "$i$a$-foldTo-GroupingKt__GroupingJVMKt$eachCount$1":I
    goto :goto_2
    ...
    .local v11, "acc":Lkotlin/jvm/internal/Ref$IntRef;
    const/16 v18, 0x0

    .line 24
    .local v18, "$i$a$-foldTo-GroupingKt__GroupingJVMKt$eachCount$2":I
    move-object/from16 v19, v11

    .line 58
    .local v19, "$this$eachCount_u24lambda_u241_u240":Lkotlin/jvm/internal/Ref$IntRef;
    const/16 v20, 0x0

    .line 24
    .local v20, "$i$a$-apply-GroupingKt__GroupingJVMKt$eachCount$2$1":I
    move-object/from16 v21, v0

    move-object/from16 v0, v19

    .end local v19    # "$this$eachCount_u24lambda_u241_u240":Lkotlin/jvm/internal/Ref$IntRef;
    .local v0, "$this$eachCount_u24lambda_u241_u240":Lkotlin/jvm/internal/Ref$IntRef;
    .local v21, "destination$iv":Ljava/util/Map;
    ...
    .line 53
    .end local v0    # "$this$eachCount_u24lambda_u241_u240":Lkotlin/jvm/internal/Ref$IntRef;
    .end local v11    # "acc":Lkotlin/jvm/internal/Ref$IntRef;
    .end local v18    # "$i$a$-foldTo-GroupingKt__GroupingJVMKt$eachCount$2":I
    .end local v20    # "$i$a$-apply-GroupingKt__GroupingJVMKt$eachCount$2$1":I
    nop

    .line 57
    .end local v12    # "first$iv":Z
    .end local v13    # "key$iv":Ljava/lang/Object;
    .end local v14    # "e$iv":Ljava/lang/Object;
    .end local v15    # "acc$iv":Ljava/lang/Object;
    .end local v16    # "$i$a$-aggregateTo-GroupingKt__GroupingKt$foldTo$1$iv":I
    ...
    .line 59
    .end local v8    # "e$iv$iv":Ljava/lang/Object;
    .end local v9    # "key$iv$iv":Ljava/lang/Object;
    .end local v10    # "accumulator$iv$iv":Ljava/lang/Object;
    .end local v21    # "destination$iv":Ljava/util/Map;
    .local v0, "destination$iv":Ljava/util/Map;
    :cond_2
    move-object/from16 v21, v0
    ...
    .end local v5    # "$this$aggregateTo$iv$iv":Lkotlin/collections/Grouping;
    .end local v6    # "$i$f$aggregateTo":I
    .restart local v21    # "destination$iv":Ljava/util/Map;
    nop
    ...
    .line 25
    .local v3, "$i$a$-mapValuesInPlace-GroupingKt__GroupingJVMKt$eachCount$3":I
    ...
    .end local v3    # "$i$a$-mapValuesInPlace-GroupingKt__GroupingJVMKt$eachCount$3":I
