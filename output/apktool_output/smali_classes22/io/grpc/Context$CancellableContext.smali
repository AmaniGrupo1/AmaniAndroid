...
.method private notifyAndClearListeners()V
    ...
    .line 849
    :cond_0
    iget-object v0, p0, Lio/grpc/Context$CancellableContext;->parentListener:Lio/grpc/Context$CancellationListener;

    .line 850
    .local v0, "tmpParentListener":Lio/grpc/Context$CancellationListener;
    const/4 v1, 0x0

    iput-object v1, p0, Lio/grpc/Context$CancellableContext;->parentListener:Lio/grpc/Context$CancellationListener;

    .line 851
    iget-object v2, p0, Lio/grpc/Context$CancellableContext;->listeners:Ljava/util/ArrayList;

    .line 852
    .local v2, "tmpListeners":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lio/grpc/Context$ExecutableListener;>;"
    iput-object v1, p0, Lio/grpc/Context$CancellableContext;->listeners:Ljava/util/ArrayList;
    ...
    .line 868
    :cond_4
    iget-object v1, p0, Lio/grpc/Context$CancellableContext;->cancellableAncestor:Lio/grpc/Context$CancellableContext;
    ...
    invoke-virtual {v1, v0}, Lio/grpc/Context$CancellableContext;->removeListener(Lio/grpc/Context$CancellationListener;)V
    ...
    .line 853
    .end local v0    # "tmpParentListener":Lio/grpc/Context$CancellationListener;
    .end local v2    # "tmpListeners":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lio/grpc/Context$ExecutableListener;>;"
    :catchall_0
    move-exception v0
