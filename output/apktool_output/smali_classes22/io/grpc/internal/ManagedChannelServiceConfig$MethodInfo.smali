...
.method private static retryPolicy(Ljava/util/Map;I)Lio/grpc/internal/RetryPolicy;
    ...
    .line 340
    const-string v4, "initialBackoff cannot be empty"
    ...
    .line 343
    .local v6, "initialBackoffNanos":J
    ...
    invoke-static {v0, v4, v6, v7}, Lcom/google/common/base/Preconditions;->checkArgument(ZLjava/lang/String;J)V
    ...
    invoke-static {v0, v4, v10, v11}, Lcom/google/common/base/Preconditions;->checkArgument(ZLjava/lang/String;J)V
    ...
    .line 357
    const-string v14, "backoffMultiplier must be greater than 0: %s"

    invoke-static {v0, v14, v4}, Lcom/google/common/base/Preconditions;->checkArgument(ZLjava/lang/String;Ljava/lang/Object;)V
    ...
    .end local v12    # "backoffMultiplier":D
    .local v8, "maxBackoffNanos":J
    .local v10, "backoffMultiplier":D
    ...
    .line 364
    .local v12, "perAttemptRecvTimeout":Ljava/lang/Long;
    if-eqz v12, :cond_5
    ...
    invoke-static {v0, v4, v12}, Lcom/google/common/base/Preconditions;->checkArgument(ZLjava/lang/String;Ljava/lang/Object;)V
    ...
    .line 371
    .local v13, "retryableCodes":Ljava/util/Set;, "Ljava/util/Set<Lio/grpc/Status$Code;>;"
    if-nez v12, :cond_7
