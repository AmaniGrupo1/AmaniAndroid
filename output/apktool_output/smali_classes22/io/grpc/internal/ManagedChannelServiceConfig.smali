...
.method static fromServiceConfig(Ljava/util/Map;ZIILjava/lang/Object;)Lio/grpc/internal/ManagedChannelServiceConfig;
    ...
    .line 99
    .end local v1    # "retryThrottling":Lio/grpc/internal/RetriableStream$Throttle;
    .local v6, "retryThrottling":Lio/grpc/internal/RetriableStream$Throttle;
    :goto_0
    ...
    .line 100
    .local v4, "serviceMethodMap":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Lio/grpc/internal/ManagedChannelServiceConfig$MethodInfo;>;"
    new-instance v5, Ljava/util/HashMap;

    invoke-direct {v5}, Ljava/util/HashMap;-><init>()V

    .line 101
    .local v5, "serviceMap":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Lio/grpc/internal/ManagedChannelServiceConfig$MethodInfo;>;"
    nop
    ...
    .line 109
    .local v1, "methodConfigs":Ljava/util/List;, "Ljava/util/List<Ljava/util/Map<Ljava/lang/String;*>;>;"
    if-nez v1, :cond_1

    .line 111
    new-instance v2, Lio/grpc/internal/ManagedChannelServiceConfig;
    ...
    new-instance v9, Lio/grpc/internal/ManagedChannelServiceConfig$MethodInfo;

    move/from16 v10, p2

    move/from16 v11, p3

    invoke-direct {v9, v7, v0, v10, v11}, Lio/grpc/internal/ManagedChannelServiceConfig$MethodInfo;-><init>(Ljava/util/Map;ZII)V

    .line 126
    .local v9, "info":Lio/grpc/internal/ManagedChannelServiceConfig$MethodInfo;
    nop
    ...
    .line 129
    .local v12, "nameList":Ljava/util/List;, "Ljava/util/List<Ljava/util/Map<Ljava/lang/String;*>;>;"
    if-eqz v12, :cond_7
    ...
    .end local v1    # "methodConfigs":Ljava/util/List;, "Ljava/util/List<Ljava/util/Map<Ljava/lang/String;*>;>;"
    .local v16, "methodConfigs":Ljava/util/List;, "Ljava/util/List<Ljava/util/Map<Ljava/lang/String;*>;>;"
    ...
    .local v18, "defaultMethodConfig":Lio/grpc/internal/ManagedChannelServiceConfig$MethodInfo;
    const-string v2, "missing service name for method %s"
    ...
    const-string v2, "Duplicate default method config in service config %s"

    move-object/from16 v10, p0

    invoke-static {v1, v2, v10}, Lcom/google/common/base/Preconditions;->checkArgument(ZLjava/lang/String;Ljava/lang/Object;)V

    .line 142
    move-object v2, v9

    .end local v18    # "defaultMethodConfig":Lio/grpc/internal/ManagedChannelServiceConfig$MethodInfo;
    .restart local v2    # "defaultMethodConfig":Lio/grpc/internal/ManagedChannelServiceConfig$MethodInfo;
    goto :goto_5

    .line 143
    .end local v16    # "methodConfigs":Ljava/util/List;, "Ljava/util/List<Ljava/util/Map<Ljava/lang/String;*>;>;"
    .restart local v1    # "methodConfigs":Ljava/util/List;, "Ljava/util/List<Ljava/util/Map<Ljava/lang/String;*>;>;"
    :cond_4
    move-object/from16 v10, p0
    ...
    .end local v1    # "methodConfigs":Ljava/util/List;, "Ljava/util/List<Ljava/util/Map<Ljava/lang/String;*>;>;"
    .end local v2    # "defaultMethodConfig":Lio/grpc/internal/ManagedChannelServiceConfig$MethodInfo;
    .restart local v16    # "methodConfigs":Ljava/util/List;, "Ljava/util/List<Ljava/util/Map<Ljava/lang/String;*>;>;"
    .restart local v18    # "defaultMethodConfig":Lio/grpc/internal/ManagedChannelServiceConfig$MethodInfo;
    invoke-static {v0}, Lcom/google/common/base/Strings;->isNullOrEmpty(Ljava/lang/String;)Z
    ...
    .line 145
    const-string v2, "Duplicate service %s"

    invoke-static {v1, v2, v15}, Lcom/google/common/base/Preconditions;->checkArgument(ZLjava/lang/String;Ljava/lang/Object;)V
    ...
    .end local v9    # "info":Lio/grpc/internal/ManagedChannelServiceConfig$MethodInfo;
    .end local v12    # "nameList":Ljava/util/List;, "Ljava/util/List<Ljava/util/Map<Ljava/lang/String;*>;>;"
    .restart local v16    # "methodConfigs":Ljava/util/List;, "Ljava/util/List<Ljava/util/Map<Ljava/lang/String;*>;>;"
    .restart local v18    # "defaultMethodConfig":Lio/grpc/internal/ManagedChannelServiceConfig$MethodInfo;
    move/from16 v0, p1
    ...
    .restart local v1    # "methodConfigs":Ljava/util/List;, "Ljava/util/List<Ljava/util/Map<Ljava/lang/String;*>;>;"
    .restart local v2    # "defaultMethodConfig":Lio/grpc/internal/ManagedChannelServiceConfig$MethodInfo;
    .restart local v7    # "methodConfig":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;*>;"
    .restart local v9    # "info":Lio/grpc/internal/ManagedChannelServiceConfig$MethodInfo;
    .restart local v12    # "nameList":Ljava/util/List;, "Ljava/util/List<Ljava/util/Map<Ljava/lang/String;*>;>;"
    :cond_7
    move-object/from16 v10, p0
    ...
    .end local v2    # "defaultMethodConfig":Lio/grpc/internal/ManagedChannelServiceConfig$MethodInfo;
    .local v3, "defaultMethodConfig":Lio/grpc/internal/ManagedChannelServiceConfig$MethodInfo;
    new-instance v2, Lio/grpc/internal/ManagedChannelServiceConfig;
