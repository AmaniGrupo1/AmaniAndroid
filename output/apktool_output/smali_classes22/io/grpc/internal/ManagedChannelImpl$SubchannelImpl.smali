...
.method constructor <init>(Lio/grpc/internal/ManagedChannelImpl;Lio/grpc/LoadBalancer$CreateSubchannelArgs;)V
    .locals 7
    .param p2, "args"    # Lio/grpc/LoadBalancer$CreateSubchannelArgs;
    ...
    .line 1941
    .local v0, "eagsWithoutOverrideAttr":Ljava/util/List;, "Ljava/util/List<Lio/grpc/EquivalentAddressGroup;>;"
    ...
    .line 1943
    .end local v0    # "eagsWithoutOverrideAttr":Ljava/util/List;, "Ljava/util/List<Lio/grpc/EquivalentAddressGroup;>;"
    :cond_0
    ...
    iput-object v0, p0, Lio/grpc/internal/ManagedChannelImpl$SubchannelImpl;->subchannelLogId:Lio/grpc/InternalLogId;

    .line 1945
    new-instance v1, Lio/grpc/internal/ChannelTracer;

    iget-object v2, p0, Lio/grpc/internal/ManagedChannelImpl$SubchannelImpl;->subchannelLogId:Lio/grpc/InternalLogId;
    ...
    iput-object v1, p0, Lio/grpc/internal/ManagedChannelImpl$SubchannelImpl;->subchannelTracer:Lio/grpc/internal/ChannelTracer;

    .line 1948
    new-instance v0, Lio/grpc/internal/ChannelLoggerImpl;

    iget-object v1, p0, Lio/grpc/internal/ManagedChannelImpl$SubchannelImpl;->subchannelTracer:Lio/grpc/internal/ChannelTracer;

    invoke-static {p1}, Lio/grpc/internal/ManagedChannelImpl;->access$5100(Lio/grpc/internal/ManagedChannelImpl;)Lio/grpc/internal/TimeProvider;

    move-result-object p1

    invoke-direct {v0, v1, p1}, Lio/grpc/internal/ChannelLoggerImpl;-><init>(Lio/grpc/internal/ChannelTracer;Lio/grpc/internal/TimeProvider;)V
...
.method private stripOverrideAuthorityAttributes(Ljava/util/List;)Ljava/util/List;
    ...
    .line 2124
    .local p1, "eags":Ljava/util/List;, "Ljava/util/List<Lio/grpc/EquivalentAddressGroup;>;"
    ...
    .line 2126
    .local v2, "eag":Lio/grpc/EquivalentAddressGroup;
    ...
    invoke-direct {v3, v4, v5}, Lio/grpc/EquivalentAddressGroup;-><init>(Ljava/util/List;Lio/grpc/Attributes;)V

    .line 2129
    .local v3, "eagWithoutOverrideAttr":Lio/grpc/EquivalentAddressGroup;
    invoke-interface {v0, v3}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    .line 2130
    .end local v2    # "eag":Lio/grpc/EquivalentAddressGroup;
    .end local v3    # "eagWithoutOverrideAttr":Lio/grpc/EquivalentAddressGroup;
    goto :goto_0
...
.method public start(Lio/grpc/LoadBalancer$SubchannelStateListener;)V
    ...
    iget-object v1, v0, Lio/grpc/internal/ManagedChannelImpl$SubchannelImpl;->subchannelLogger:Lio/grpc/internal/ChannelLoggerImpl;
