...
.method private maySwitchExecutor(Lio/grpc/ServerMethodDefinition;Lio/grpc/internal/ServerStream;Lio/grpc/Metadata;Lio/grpc/Context$CancellableContext;Lio/perfmark/Tag;)Lio/grpc/internal/ServerImpl$ServerTransportListenerImpl$ServerCallParameters;
    ...
    .end local p2    # "stream":Lio/grpc/internal/ServerStream;
    .end local p3    # "headers":Lio/grpc/Metadata;
    .end local p4    # "context":Lio/grpc/Context$CancellableContext;
    .end local p5    # "tag":Lio/perfmark/Tag;
    .local v1, "stream":Lio/grpc/internal/ServerStream;
    .local v3, "headers":Lio/grpc/Metadata;
    .local v4, "context":Lio/grpc/Context$CancellableContext;
    .local v8, "tag":Lio/perfmark/Tag;
    ...
    .line 584
    .local p2, "switchingExecutor":Ljava/util/concurrent/Executor;
    if-eqz p2, :cond_0
    ...
    .line 588
    .end local p2    # "switchingExecutor":Ljava/util/concurrent/Executor;
    :cond_0
    ...
    invoke-direct {p2, p3, v0, p4}, Lio/grpc/internal/ServerImpl$ServerTransportListenerImpl$ServerCallParameters;-><init>(Lio/grpc/internal/ServerImpl$ServerTransportListenerImpl;Lio/grpc/internal/ServerCallImpl;Lio/grpc/ServerCallHandler;)V
...
.method private runInternal()V
    ...
    .line 538
    .local v0, "method":Lio/grpc/ServerMethodDefinition;, "Lio/grpc/ServerMethodDefinition<**>;"
    if-nez v0, :cond_0
    ...
    invoke-virtual {v4, v2}, Lio/grpc/Context$CancellableContext;->cancel(Ljava/lang/Throwable;)Z
    ...
    invoke-virtual {v4, v1}, Lcom/google/common/util/concurrent/SettableFuture;->cancel(Z)Z
    ...
    .line 556
    .local v5, "wrapMethod":Lio/grpc/ServerMethodDefinition;, "Lio/grpc/ServerMethodDefinition<**>;"
    iget-object v6, p0, Lio/grpc/internal/ServerImpl$ServerTransportListenerImpl$1MethodLookup;->val$stream:Lio/grpc/internal/ServerStream;

    iget-object v7, p0, Lio/grpc/internal/ServerImpl$ServerTransportListenerImpl$1MethodLookup;->val$headers:Lio/grpc/Metadata;

    iget-object v8, p0, Lio/grpc/internal/ServerImpl$ServerTransportListenerImpl$1MethodLookup;->val$context:Lio/grpc/Context$CancellableContext;

    iget-object v9, p0, Lio/grpc/internal/ServerImpl$ServerTransportListenerImpl$1MethodLookup;->val$tag:Lio/perfmark/Tag;
    :try_end_0
    ...
    :try_start_1
    invoke-direct/range {v4 .. v9}, Lio/grpc/internal/ServerImpl$ServerTransportListenerImpl$1MethodLookup;->maySwitchExecutor(Lio/grpc/ServerMethodDefinition;Lio/grpc/internal/ServerStream;Lio/grpc/Metadata;Lio/grpc/Context$CancellableContext;Lio/perfmark/Tag;)Lio/grpc/internal/ServerImpl$ServerTransportListenerImpl$ServerCallParameters;
    ...
    iget-object v6, v4, Lio/grpc/internal/ServerImpl$ServerTransportListenerImpl$1MethodLookup;->val$future:Lcom/google/common/util/concurrent/SettableFuture;

    invoke-virtual {v6, v3}, Lcom/google/common/util/concurrent/SettableFuture;->set(Ljava/lang/Object;)Z
    :try_end_1
    ...
    .line 565
    .end local v0    # "method":Lio/grpc/ServerMethodDefinition;, "Lio/grpc/ServerMethodDefinition<**>;"
    return-void
    ...
    .end local v5    # "wrapMethod":Lio/grpc/ServerMethodDefinition;, "Lio/grpc/ServerMethodDefinition<**>;"
    :catchall_0
    move-exception v0
    ...
    :goto_0
    iget-object v3, v4, Lio/grpc/internal/ServerImpl$ServerTransportListenerImpl$1MethodLookup;->val$jumpListener:Lio/grpc/internal/ServerImpl$JumpToApplicationThreadServerStreamListener;

    invoke-static {}, Lio/grpc/internal/ServerImpl;->access$1600()Lio/grpc/internal/ServerStreamListener;

    move-result-object v5

    invoke-virtual {v3, v5}, Lio/grpc/internal/ServerImpl$JumpToApplicationThreadServerStreamListener;->setListener(Lio/grpc/internal/ServerStreamListener;)V

    .line 560
    iget-object v3, v4, Lio/grpc/internal/ServerImpl$ServerTransportListenerImpl$1MethodLookup;->val$stream:Lio/grpc/internal/ServerStream;
    ...
    invoke-interface {v3, v5, v6}, Lio/grpc/internal/ServerStream;->close(Lio/grpc/Status;Lio/grpc/Metadata;)V

    .line 561
    iget-object v3, v4, Lio/grpc/internal/ServerImpl$ServerTransportListenerImpl$1MethodLookup;->val$context:Lio/grpc/Context$CancellableContext;

    invoke-virtual {v3, v2}, Lio/grpc/Context$CancellableContext;->cancel(Ljava/lang/Throwable;)Z

    .line 562
    iget-object v2, v4, Lio/grpc/internal/ServerImpl$ServerTransportListenerImpl$1MethodLookup;->val$future:Lcom/google/common/util/concurrent/SettableFuture;
