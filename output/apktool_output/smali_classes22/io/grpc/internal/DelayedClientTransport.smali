...
.method private createPendingStream(Lio/grpc/LoadBalancer$PickSubchannelArgs;[Lio/grpc/ClientStreamTracer;)Lio/grpc/internal/DelayedClientTransport$PendingStream;
    ...
    .line 187
    .local v3, "streamTracer":Lio/grpc/ClientStreamTracer;
    invoke-virtual {v3}, Lio/grpc/ClientStreamTracer;->createPendingStream()V

    .line 186
    .end local v3    # "streamTracer":Lio/grpc/ClientStreamTracer;
...
.method final reprocess(Lio/grpc/LoadBalancer$SubchannelPicker;)V
    ...
    iget-object v4, p0, Lio/grpc/internal/DelayedClientTransport;->reportTransportTerminated:Ljava/lang/Runnable;
...
.method public final shutdownNow(Lio/grpc/Status;)V
    ...
    .line 241
    .local v1, "savedPendingStreams":Ljava/util/Collection;, "Ljava/util/Collection<Lio/grpc/internal/DelayedClientTransport$PendingStream;>;"
    iget-object v2, p0, Lio/grpc/internal/DelayedClientTransport;->reportTransportTerminated:Ljava/lang/Runnable;

    .line 242
    .local v2, "savedReportTransportTerminated":Ljava/lang/Runnable;
    const/4 v3, 0x0
    ...
    .line 250
    invoke-static {v3}, Lio/grpc/internal/DelayedClientTransport$PendingStream;->access$200(Lio/grpc/internal/DelayedClientTransport$PendingStream;)[Lio/grpc/ClientStreamTracer;
    ...
    .line 249
    invoke-virtual {v3, v4}, Lio/grpc/internal/DelayedClientTransport$PendingStream;->setStream(Lio/grpc/internal/ClientStream;)Ljava/lang/Runnable;
    ...
    .line 246
    .end local v1    # "savedPendingStreams":Ljava/util/Collection;, "Ljava/util/Collection<Lio/grpc/internal/DelayedClientTransport$PendingStream;>;"
    .end local v2    # "savedReportTransportTerminated":Ljava/lang/Runnable;
    :catchall_0
    move-exception v1
