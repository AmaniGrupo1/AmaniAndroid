...
.method tryAcceptResolvedAddresses(Lio/grpc/LoadBalancer$ResolvedAddresses;)Lio/grpc/Status;
    ...
    .line 131
    .local v1, "old":Lio/grpc/LoadBalancer;
    iget-object v2, p0, Lio/grpc/internal/AutoConfiguredLoadBalancerFactory$AutoConfiguredLoadBalancer;->delegateProvider:Lio/grpc/LoadBalancerProvider;
    ...
    invoke-virtual {v2, v3}, Lio/grpc/LoadBalancerProvider;->newLoadBalancer(Lio/grpc/LoadBalancer$Helper;)Lio/grpc/LoadBalancer;
    ...
    .line 136
    .end local v1    # "old":Lio/grpc/LoadBalancer;
    :cond_2
    ...
    .line 142
    invoke-virtual {v2, v3}, Lio/grpc/LoadBalancer;->acceptResolvedAddresses(Lio/grpc/LoadBalancer$ResolvedAddresses;)Lio/grpc/Status;
