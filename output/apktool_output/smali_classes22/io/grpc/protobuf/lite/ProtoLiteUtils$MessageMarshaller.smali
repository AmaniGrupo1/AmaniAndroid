...
.method public parse(Ljava/io/InputStream;)Lcom/google/protobuf/MessageLite;
    ...
    .local v3, "ref":Ljava/lang/ref/Reference;, "Ljava/lang/ref/Reference<[B>;"
    if-eqz v2, :cond_1
    ...
    invoke-static {v4, v5, v1}, Lcom/google/protobuf/CodedInputStream;->newInstance([BII)Lcom/google/protobuf/CodedInputStream;
    ...
    .end local v3    # "ref":Ljava/lang/ref/Reference;, "Ljava/lang/ref/Reference<[B>;"
    .end local v4    # "buf":[B
    :cond_5
    goto :goto_2
    ...
    .restart local v3    # "ref":Ljava/lang/ref/Reference;, "Ljava/lang/ref/Reference<[B>;"
    .restart local v4    # "buf":[B
    :cond_6
    sub-int v5, v1, v2
    ...
    .line 232
    iget v1, p0, Lio/grpc/protobuf/lite/ProtoLiteUtils$MessageMarshaller;->recursionLimit:I
