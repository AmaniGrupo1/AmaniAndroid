...
.method public data(ZILokio/BufferedSource;II)V
    ...
    .line 1160
    .local p1, "stream":Lio/grpc/okhttp/OkHttpClientStream;
    if-nez p1, :cond_1

    .line 1161
    iget-object p2, p0, Lio/grpc/okhttp/OkHttpClientTransport$ClientFrameHandler;->this$0:Lio/grpc/okhttp/OkHttpClientTransport;

    invoke-virtual {p2, v2}, Lio/grpc/okhttp/OkHttpClientTransport;->mayHaveCreatedStream(I)Z
    ...
    invoke-static {p4}, Lio/grpc/okhttp/OkHttpClientTransport;->access$2200(Lio/grpc/okhttp/OkHttpClientTransport;)Lio/grpc/okhttp/ExceptionHandlingFrameWriter;

    move-result-object p4

    sget-object v0, Lio/grpc/okhttp/internal/framed/ErrorCode;->STREAM_CLOSED:Lio/grpc/okhttp/internal/framed/ErrorCode;

    invoke-virtual {p4, v2, v0}, Lio/grpc/okhttp/ExceptionHandlingFrameWriter;->rstStream(ILio/grpc/okhttp/internal/framed/ErrorCode;)V
    ...
    const-string v1, "Received data for unknown stream: "
    ...
    invoke-static {p4, p2, v0}, Lio/grpc/okhttp/OkHttpClientTransport;->access$2300(Lio/grpc/okhttp/OkHttpClientTransport;Lio/grpc/okhttp/internal/framed/ErrorCode;Ljava/lang/String;)V
    ...
    invoke-virtual {p2, p4, v0, v1}, Lokio/Buffer;->write(Lokio/Buffer;J)V

    .line 1176
    const-string p4, "OkHttpClientTransport$ClientFrameHandler.data"
    ...
    .line 1176
    invoke-static {p4, v0}, Lio/perfmark/PerfMark;->event(Ljava/lang/String;Lio/perfmark/Tag;)V
    ...
    invoke-virtual {v0, p2, v5, v1}, Lio/grpc/okhttp/OkHttpClientStream$TransportState;->transportDataReceived(Lokio/Buffer;ZI)V
    ...
    .line 1186
    .end local p2    # "buf":Lokio/Buffer;
    :goto_0
    iget-object p2, p0, Lio/grpc/okhttp/OkHttpClientTransport$ClientFrameHandler;->this$0:Lio/grpc/okhttp/OkHttpClientTransport;

    invoke-static {p2, p5}, Lio/grpc/okhttp/OkHttpClientTransport;->access$2412(Lio/grpc/okhttp/OkHttpClientTransport;I)I
    ...
    invoke-static {p4}, Lio/grpc/okhttp/OkHttpClientTransport;->access$300(Lio/grpc/okhttp/OkHttpClientTransport;)I
    ...
    invoke-static {v0}, Lio/grpc/okhttp/OkHttpClientTransport;->access$2400(Lio/grpc/okhttp/OkHttpClientTransport;)I
    ...
    invoke-virtual {p4, v3, v0, v1}, Lio/grpc/okhttp/ExceptionHandlingFrameWriter;->windowUpdate(IJ)V
    ...
    invoke-static {p2, v3}, Lio/grpc/okhttp/OkHttpClientTransport;->access$2402(Lio/grpc/okhttp/OkHttpClientTransport;I)I
    ...
    .line 1182
    .restart local p2    # "buf":Lokio/Buffer;
    :catchall_2
    move-exception v0
...
.method public headers(ZZIILjava/util/List;Lio/grpc/okhttp/internal/framed/HeadersMode;)V
    ...
    invoke-static {v3}, Lio/grpc/okhttp/OkHttpClientTransport;->access$2600(Lio/grpc/okhttp/OkHttpClientTransport;)Ljava/util/Map;
    ...
    invoke-virtual {v4, p3}, Lio/grpc/okhttp/OkHttpClientTransport;->mayHaveCreatedStream(I)Z
    ...
    sget-object v5, Lio/grpc/okhttp/internal/framed/ErrorCode;->STREAM_CLOSED:Lio/grpc/okhttp/internal/framed/ErrorCode;

    invoke-virtual {v4, p3, v5}, Lio/grpc/okhttp/ExceptionHandlingFrameWriter;->rstStream(ILio/grpc/okhttp/internal/framed/ErrorCode;)V
    ...
    .line 1231
    const-string v4, "OkHttpClientTransport$ClientFrameHandler.headers"
    ...
    .line 1231
    invoke-static {v4, v5}, Lio/perfmark/PerfMark;->event(Ljava/lang/String;Lio/perfmark/Tag;)V
    ...
    invoke-virtual {v4, p5, p2}, Lio/grpc/okhttp/OkHttpClientStream$TransportState;->transportHeadersReceived(Ljava/util/List;Z)V
    ...
    invoke-virtual {v4, v1, v6, v5}, Lio/grpc/okhttp/OkHttpClientStream$TransportState;->transportReportStatus(Lio/grpc/Status;ZLio/grpc/Metadata;)V
...
.method public ping(ZII)V
    ...
    invoke-static {v4}, Lio/grpc/okhttp/OkHttpClientTransport;->access$2700(Lio/grpc/okhttp/OkHttpClientTransport;)Lio/grpc/internal/Http2Ping;
    ...
    invoke-static {v4, v5}, Lio/grpc/okhttp/OkHttpClientTransport;->access$2702(Lio/grpc/okhttp/OkHttpClientTransport;Lio/grpc/internal/Http2Ping;)Lio/grpc/internal/Http2Ping;
    ...
    .line 1333
    invoke-static {v8}, Lio/grpc/okhttp/OkHttpClientTransport;->access$2700(Lio/grpc/okhttp/OkHttpClientTransport;)Lio/grpc/internal/Http2Ping;

    move-result-object v8

    invoke-virtual {v8}, Lio/grpc/internal/Http2Ping;->payload()J
...
.method public rstStream(ILio/grpc/okhttp/internal/framed/ErrorCode;)V
    ...
    .line 1265
    .local v4, "status":Lio/grpc/Status;
    nop
    ...
    .line 1274
    .restart local v0    # "stream":Lio/grpc/okhttp/OkHttpClientStream;
    :cond_2
    :try_start_2
...
.method public settings(ZLio/grpc/okhttp/internal/framed/Settings;)V
    ...
    invoke-static {v3}, Lio/grpc/okhttp/OkHttpClientTransport;->access$000(Lio/grpc/okhttp/OkHttpClientTransport;)Lio/grpc/internal/ManagedClientTransport$Listener;
    ...
    invoke-static {v2, v3}, Lio/grpc/okhttp/OkHttpClientTransport;->access$1002(Lio/grpc/okhttp/OkHttpClientTransport;Lio/grpc/Attributes;)Lio/grpc/Attributes;
...
.method public windowUpdate(IJ)V
    ...
    invoke-virtual {v0, v3, v4}, Lio/grpc/okhttp/OutboundFlowController;->windowUpdate(Lio/grpc/okhttp/OutboundFlowController$StreamState;I)I
    ...
    .line 1407
    :cond_3
    invoke-virtual {v3, v2}, Lio/grpc/okhttp/OkHttpClientTransport;->mayHaveCreatedStream(I)Z
    ...
    invoke-static {v0, v1, v3}, Lio/grpc/okhttp/OkHttpClientTransport;->access$2300(Lio/grpc/okhttp/OkHttpClientTransport;Lio/grpc/okhttp/internal/framed/ErrorCode;Ljava/lang/String;)V
