...
.method private constructor <init>(Lio/grpc/internal/ObjectPool;Lio/grpc/internal/ObjectPool;Ljavax/net/SocketFactory;Ljavax/net/ssl/SSLSocketFactory;Ljavax/net/ssl/HostnameVerifier;Lio/grpc/okhttp/internal/ConnectionSpec;IZJJIZILio/grpc/internal/TransportTracer$Factory;Z)V
    ...
    .line 814
    invoke-interface {v3}, Lio/grpc/internal/ObjectPool;->getObject()Ljava/lang/Object;
...
.method public newClientTransport(Ljava/net/SocketAddress;Lio/grpc/internal/ClientTransportFactory$ClientTransportOptions;Lio/grpc/ChannelLogger;)Lio/grpc/internal/ConnectionClientTransport;
    ...
    .line 842
    .local v8, "keepAliveTimeNanosState":Lio/grpc/internal/AtomicBackoff$State;
    ...
    .line 850
    .local v2, "inetSocketAddr":Ljava/net/InetSocketAddress;
    ...
    .line 858
    .local v9, "transport":Lio/grpc/okhttp/OkHttpClientTransport;
    ...
    .line 839
    .end local v2    # "inetSocketAddr":Ljava/net/InetSocketAddress;
    .end local v7    # "tooManyPingsRunnable":Ljava/lang/Runnable;
    .end local v8    # "keepAliveTimeNanosState":Lio/grpc/internal/AtomicBackoff$State;
    .end local v9    # "transport":Lio/grpc/okhttp/OkHttpClientTransport;
    :cond_1
...
.method public swapChannelCredentials(Lio/grpc/ChannelCredentials;)Lio/grpc/internal/ClientTransportFactory$SwapChannelCredentialsResult;
    ...
    .line 878
    :cond_0
    new-instance v3, Lio/grpc/okhttp/OkHttpChannelBuilder$OkHttpTransportFactory;
    ...
    iget v2, v0, Lio/grpc/okhttp/OkHttpChannelBuilder$OkHttpTransportFactory;->flowControlWindow:I
    ...
    .line 894
    .local v3, "factory":Lio/grpc/internal/ClientTransportFactory;
    new-instance v2, Lio/grpc/internal/ClientTransportFactory$SwapChannelCredentialsResult;

    iget-object v4, v1, Lio/grpc/okhttp/OkHttpChannelBuilder$SslSocketFactoryResult;->callCredentials:Lio/grpc/CallCredentials;

    invoke-direct {v2, v3, v4}, Lio/grpc/internal/ClientTransportFactory$SwapChannelCredentialsResult;-><init>(Lio/grpc/internal/ClientTransportFactory;Lio/grpc/CallCredentials;)V
