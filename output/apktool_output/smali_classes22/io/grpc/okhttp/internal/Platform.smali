...
.method private static findPlatform()Lio/grpc/okhttp/internal/Platform;
    ...
    .line 161
    .local v7, "androidOrAppEngineProvider":Ljava/security/Provider;
    const/4 v0, 0x0
    ...
    invoke-direct {v3, v0, v5, v4}, Lio/grpc/okhttp/internal/OptionalMethod;-><init>(Ljava/lang/Class;Ljava/lang/String;[Ljava/lang/Class;)V

    .line 165
    .local v3, "setUseSessionTickets":Lio/grpc/okhttp/internal/OptionalMethod;, "Lio/grpc/okhttp/internal/OptionalMethod<Ljava/net/Socket;>;"
    ...
    invoke-direct {v4, v0, v6, v5}, Lio/grpc/okhttp/internal/OptionalMethod;-><init>(Ljava/lang/Class;Ljava/lang/String;[Ljava/lang/Class;)V

    .line 167
    .local v4, "setHostname":Lio/grpc/okhttp/internal/OptionalMethod;, "Lio/grpc/okhttp/internal/OptionalMethod<Ljava/net/Socket;>;"
    const/4 v5, 0x0
    ...
    invoke-direct {v8, v11, v9, v10}, Lio/grpc/okhttp/internal/OptionalMethod;-><init>(Ljava/lang/Class;Ljava/lang/String;[Ljava/lang/Class;)V

    .line 171
    .local v8, "getAlpnSelectedProtocol":Lio/grpc/okhttp/internal/OptionalMethod;, "Lio/grpc/okhttp/internal/OptionalMethod<Ljava/net/Socket;>;"
    ...
    invoke-direct {v9, v0, v11, v10}, Lio/grpc/okhttp/internal/OptionalMethod;-><init>(Ljava/lang/Class;Ljava/lang/String;[Ljava/lang/Class;)V

    .line 176
    .local v9, "setAlpnProtocols":Lio/grpc/okhttp/internal/OptionalMethod;, "Lio/grpc/okhttp/internal/OptionalMethod<Ljava/net/Socket;>;"
    :try_start_0
    ...
    .local v0, "tlsExtensionType":Lio/grpc/okhttp/internal/Platform$TlsExtensionType;
    goto :goto_3

    .line 192
    .end local v0    # "tlsExtensionType":Lio/grpc/okhttp/internal/Platform$TlsExtensionType;
    :cond_1
    ...
    .restart local v0    # "tlsExtensionType":Lio/grpc/okhttp/internal/Platform$TlsExtensionType;
    goto :goto_3
    ...
    .end local v0    # "tlsExtensionType":Lio/grpc/okhttp/internal/Platform$TlsExtensionType;
    .local v1, "setUseSessionTickets":Lio/grpc/okhttp/internal/OptionalMethod;, "Lio/grpc/okhttp/internal/OptionalMethod<Ljava/net/Socket;>;"
    .local v3, "trafficStatsTagSocket":Ljava/lang/reflect/Method;
    .local v5, "getAlpnSelectedProtocol":Lio/grpc/okhttp/internal/OptionalMethod;, "Lio/grpc/okhttp/internal/OptionalMethod<Ljava/net/Socket;>;"
    .local v8, "tlsExtensionType":Lio/grpc/okhttp/internal/Platform$TlsExtensionType;
    ...
    .end local v9    # "setAlpnProtocols":Lio/grpc/okhttp/internal/OptionalMethod;, "Lio/grpc/okhttp/internal/OptionalMethod<Ljava/net/Socket;>;"
    .local v2, "setHostname":Lio/grpc/okhttp/internal/OptionalMethod;, "Lio/grpc/okhttp/internal/OptionalMethod<Ljava/net/Socket;>;"
    .local v4, "trafficStatsUntagSocket":Ljava/lang/reflect/Method;
    .local v6, "setAlpnProtocols":Lio/grpc/okhttp/internal/OptionalMethod;, "Lio/grpc/okhttp/internal/OptionalMethod<Ljava/net/Socket;>;"
    ...
    .line 209
    .end local v1    # "setUseSessionTickets":Lio/grpc/okhttp/internal/OptionalMethod;, "Lio/grpc/okhttp/internal/OptionalMethod<Ljava/net/Socket;>;"
    .end local v2    # "setHostname":Lio/grpc/okhttp/internal/OptionalMethod;, "Lio/grpc/okhttp/internal/OptionalMethod<Ljava/net/Socket;>;"
    ...
    .end local v5    # "getAlpnSelectedProtocol":Lio/grpc/okhttp/internal/OptionalMethod;, "Lio/grpc/okhttp/internal/OptionalMethod<Ljava/net/Socket;>;"
    .end local v6    # "setAlpnProtocols":Lio/grpc/okhttp/internal/OptionalMethod;, "Lio/grpc/okhttp/internal/OptionalMethod<Ljava/net/Socket;>;"
    .end local v8    # "tlsExtensionType":Lio/grpc/okhttp/internal/Platform$TlsExtensionType;
    :cond_4
    :try_start_1
    ...
    .line 212
    .local v14, "sslProvider":Ljava/security/Provider;
    nop
    ...
    invoke-static {v3, v14}, Ljavax/net/ssl/SSLContext;->getInstance(Ljava/lang/String;Ljava/security/Provider;)Ljavax/net/ssl/SSLContext;
    ...
    .line 229
    .local v5, "getEngineApplicationProtocol":Ljava/lang/reflect/Method;
    new-array v6, v2, [Ljava/lang/Object;

    invoke-virtual {v5, v4, v6}, Ljava/lang/reflect/Method;->invoke(Ljava/lang/Object;[Ljava/lang/Object;)Ljava/lang/Object;

    .line 231
    new-instance v6, Lio/grpc/okhttp/internal/Platform$2;

    invoke-direct {v6}, Lio/grpc/okhttp/internal/Platform$2;-><init>()V
    ...
    .line 239
    .local v6, "setApplicationProtocols":Ljava/lang/reflect/Method;
    ...
    invoke-direct {v9, v14, v6, v8, v0}, Lio/grpc/okhttp/internal/Platform$JdkAlpnPlatform;-><init>(Ljava/security/Provider;Ljava/lang/reflect/Method;Ljava/lang/reflect/Method;Lio/grpc/okhttp/internal/Platform$1;)V
    :try_end_2
    ...
    .end local v5    # "getEngineApplicationProtocol":Ljava/lang/reflect/Method;
    .end local v6    # "setApplicationProtocols":Ljava/lang/reflect/Method;
    ...
    .line 210
    .end local v14    # "sslProvider":Ljava/security/Provider;
    :catch_9
    move-exception v0
