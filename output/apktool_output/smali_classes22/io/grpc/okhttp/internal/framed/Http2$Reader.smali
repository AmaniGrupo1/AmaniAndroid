...
.method private readData(Lio/grpc/okhttp/internal/framed/FrameReader$Handler;IBI)V
    ...
    .end local p1    # "handler":Lio/grpc/okhttp/internal/framed/FrameReader$Handler;
    .end local p2    # "paddedLength":I
    .end local p4    # "streamId":I
    .local v3, "handler":Lio/grpc/okhttp/internal/framed/FrameReader$Handler;
    .local v5, "streamId":I
    .local v8, "paddedLength":I
    ...
    invoke-interface {p1, v9, v10}, Lokio/BufferedSource;->skip(J)V
    ...
    .end local v3    # "handler":Lio/grpc/okhttp/internal/framed/FrameReader$Handler;
    .end local v5    # "streamId":I
    .end local v7    # "length":I
    .end local v8    # "paddedLength":I
    .restart local p1    # "handler":Lio/grpc/okhttp/internal/framed/FrameReader$Handler;
    .restart local p2    # "paddedLength":I
    ...
    .end local p1    # "handler":Lio/grpc/okhttp/internal/framed/FrameReader$Handler;
    .end local p2    # "paddedLength":I
    .restart local v3    # "handler":Lio/grpc/okhttp/internal/framed/FrameReader$Handler;
    .restart local v8    # "paddedLength":I
...
.method private readHeaders(Lio/grpc/okhttp/internal/framed/FrameReader$Handler;IBI)V
    ...
    .line 207
    .local v7, "headerBlock":Ljava/util/List;, "Ljava/util/List<Lio/grpc/okhttp/internal/framed/Header;>;"
    const/4 v6, -0x1
    ...
    .end local p1    # "handler":Lio/grpc/okhttp/internal/framed/FrameReader$Handler;
    .end local p4    # "streamId":I
    .local v2, "handler":Lio/grpc/okhttp/internal/framed/FrameReader$Handler;
    .local v5, "streamId":I
    ...
    .end local v2    # "handler":Lio/grpc/okhttp/internal/framed/FrameReader$Handler;
    .end local v4    # "endStream":Z
    .end local v5    # "streamId":I
    .end local v7    # "headerBlock":Ljava/util/List;, "Ljava/util/List<Lio/grpc/okhttp/internal/framed/Header;>;"
    .restart local p1    # "handler":Lio/grpc/okhttp/internal/framed/FrameReader$Handler;
    .restart local p4    # "streamId":I
    :cond_3
    move-object v2, p1
    ...
    .end local p1    # "handler":Lio/grpc/okhttp/internal/framed/FrameReader$Handler;
    .end local p4    # "streamId":I
    .restart local v2    # "handler":Lio/grpc/okhttp/internal/framed/FrameReader$Handler;
    .restart local v5    # "streamId":I
    const-string p1, "PROTOCOL_ERROR: TYPE_HEADERS streamId == 0"

    new-array p4, v0, [Ljava/lang/Object;

    invoke-static {p1, p4}, Lio/grpc/okhttp/internal/framed/Http2;->access$200(Ljava/lang/String;[Ljava/lang/Object;)Ljava/io/IOException;
