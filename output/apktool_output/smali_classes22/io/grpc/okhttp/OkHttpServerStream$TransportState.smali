...
.method public bytesRead(I)V
    ...
    .line 191
    iget v0, p0, Lio/grpc/okhttp/OkHttpServerStream$TransportState;->initialWindowSize:I

    iget v1, p0, Lio/grpc/okhttp/OkHttpServerStream$TransportState;->processedWindow:I
    ...
    iput v1, p0, Lio/grpc/okhttp/OkHttpServerStream$TransportState;->processedWindow:I
...
.method public inboundDataReceived(Lokio/Buffer;IIZ)V
    ...
    invoke-super {p0, v1, p4}, Lio/grpc/internal/AbstractServerStream$TransportState;->inboundDataReceived(Lio/grpc/internal/ReadableBuffer;Z)V
