...
.method public write(Lokio/Buffer;J)V
    ...
    .line 106
    .local v1, "closeSocket":Z
    :try_start_0
    iget-object v2, p0, Lio/grpc/okhttp/AsyncSink;->lock:Ljava/lang/Object;
    ...
    .line 107
    :try_start_1
    iget-object v3, p0, Lio/grpc/okhttp/AsyncSink;->buffer:Lokio/Buffer;

    invoke-virtual {v3, p1, p2, p3}, Lokio/Buffer;->write(Lokio/Buffer;J)V

    .line 109
    iget v3, p0, Lio/grpc/okhttp/AsyncSink;->queuedControlFrames:I

    iget v4, p0, Lio/grpc/okhttp/AsyncSink;->controlFramesInWrite:I

    add-int/2addr v3, v4

    iput v3, p0, Lio/grpc/okhttp/AsyncSink;->queuedControlFrames:I
    ...
    iget v5, p0, Lio/grpc/okhttp/AsyncSink;->maxQueuedControlFrames:I
    ...
    .line 115
    :cond_0
    iget-boolean v3, p0, Lio/grpc/okhttp/AsyncSink;->writeEnqueued:Z

    if-nez v3, :cond_5

    iget-boolean v3, p0, Lio/grpc/okhttp/AsyncSink;->flushEnqueued:Z
    ...
    .line 123
    :try_start_2
    iget-object v2, p0, Lio/grpc/okhttp/AsyncSink;->socket:Ljava/net/Socket;
    ...
    :try_start_3
    iget-object v3, p0, Lio/grpc/okhttp/AsyncSink;->transportExceptionHandler:Lio/grpc/okhttp/ExceptionHandlingFrameWriter$TransportExceptionHandler;

    invoke-interface {v3, v2}, Lio/grpc/okhttp/ExceptionHandlingFrameWriter$TransportExceptionHandler;->onException(Ljava/lang/Throwable;)V
    :try_end_3
    .catchall {:try_start_3 .. :try_end_3} :catchall_1
    ...
    :cond_3
    :try_start_4
    iget-object v2, p0, Lio/grpc/okhttp/AsyncSink;->serializingExecutor:Lio/grpc/internal/SerializingExecutor;

    new-instance v3, Lio/grpc/okhttp/AsyncSink$1;

    invoke-direct {v3, p0}, Lio/grpc/okhttp/AsyncSink$1;-><init>(Lio/grpc/okhttp/AsyncSink;)V
    ...
    .line 116
    .restart local v0    # "ignore":Lio/perfmark/TaskCloseable;
    .restart local v1    # "closeSocket":Z
    :cond_5
    :goto_2
    :try_start_5
    monitor-exit v2
