...
.method public static create(DJLjava/util/concurrent/TimeUnit;)Lcom/google/common/util/concurrent/RateLimiter;
    ...
    .end local p0    # "permitsPerSecond":D
    .end local p2    # "warmupPeriod":J
    .end local p4    # "unit":Ljava/util/concurrent/TimeUnit;
    .local v2, "permitsPerSecond":D
    .local v4, "warmupPeriod":J
...
.method static create(DJLjava/util/concurrent/TimeUnit;DLcom/google/common/util/concurrent/RateLimiter$SleepingStopwatch;)Lcom/google/common/util/concurrent/RateLimiter;
    ...
    .end local p2    # "warmupPeriod":J
    .end local p4    # "unit":Ljava/util/concurrent/TimeUnit;
    .end local p5    # "coldFactor":D
    .end local p7    # "stopwatch":Lcom/google/common/util/concurrent/RateLimiter$SleepingStopwatch;
    .local v1, "stopwatch":Lcom/google/common/util/concurrent/RateLimiter$SleepingStopwatch;
    .local v2, "warmupPeriod":J
    .local v4, "unit":Ljava/util/concurrent/TimeUnit;
    .local v5, "coldFactor":D
...
.method public tryAcquire(IJLjava/util/concurrent/TimeUnit;)Z
    ...
    invoke-virtual {v2, v5, v6}, Lcom/google/common/util/concurrent/RateLimiter$SleepingStopwatch;->sleepMicrosUninterruptibly(J)V
