...
.method public static difference(Ljava/util/Map;Ljava/util/Map;Lcom/google/common/base/Equivalence;)Lcom/google/common/collect/MapDifference;
    ...
    .end local p0    # "left":Ljava/util/Map;, "Ljava/util/Map<+TK;+TV;>;"
    .end local p1    # "right":Ljava/util/Map;, "Ljava/util/Map<+TK;+TV;>;"
    .end local p2    # "valueEquivalence":Lcom/google/common/base/Equivalence;, "Lcom/google/common/base/Equivalence<-TV;>;"
    .local v0, "left":Ljava/util/Map;, "Ljava/util/Map<+TK;+TV;>;"
    .local v1, "right":Ljava/util/Map;, "Ljava/util/Map<+TK;+TV;>;"
    .local v2, "valueEquivalence":Lcom/google/common/base/Equivalence;, "Lcom/google/common/base/Equivalence<-TV;>;"
...
.method public static difference(Ljava/util/SortedMap;Ljava/util/Map;)Lcom/google/common/collect/SortedMapDifference;
    ...
    .line 567
    .local v4, "onlyOnLeft":Ljava/util/SortedMap;, "Ljava/util/SortedMap<TK;TV;>;"
    invoke-static {v0}, Lcom/google/common/collect/Maps;->newTreeMap(Ljava/util/Comparator;)Ljava/util/TreeMap;

    move-result-object v5

    .line 568
    .local v5, "onlyOnRight":Ljava/util/SortedMap;, "Ljava/util/SortedMap<TK;TV;>;"
    ...
    .line 570
    .local v6, "onBoth":Ljava/util/SortedMap;, "Ljava/util/SortedMap<TK;TV;>;"
    invoke-static {v0}, Lcom/google/common/collect/Maps;->newTreeMap(Ljava/util/Comparator;)Ljava/util/TreeMap;

    move-result-object v7

    .line 572
    .local v7, "differences":Ljava/util/SortedMap;, "Ljava/util/SortedMap<TK;Lcom/google/common/collect/MapDifference$ValueDifference<TV;>;>;"
    invoke-static {}, Lcom/google/common/base/Equivalence;->equals()Lcom/google/common/base/Equivalence;
    ...
    .end local p0    # "left":Ljava/util/SortedMap;, "Ljava/util/SortedMap<TK;+TV;>;"
    .end local p1    # "right":Ljava/util/Map;, "Ljava/util/Map<+TK;+TV;>;"
    .local v1, "left":Ljava/util/SortedMap;, "Ljava/util/SortedMap<TK;+TV;>;"
    .local v2, "right":Ljava/util/Map;, "Ljava/util/Map<+TK;+TV;>;"
...
.method public static immutableEnumMap(Ljava/util/Map;)Lcom/google/common/collect/ImmutableMap;
    ...
    .line 171
    .local v4, "enumMap":Ljava/util/EnumMap;, "Ljava/util/EnumMap<TK;TV;>;"
    :goto_0
    invoke-interface {v0}, Ljava/util/Iterator;->hasNext()Z
    ...
    .line 174
    .local v6, "key":Ljava/lang/Enum;, "TK;"
    ...
    .end local v6    # "key":Ljava/lang/Enum;, "TK;"
    .end local v7    # "value":Ljava/lang/Object;, "TV;"
    goto :goto_0

    .line 178
    :cond_2
    invoke-static {v4}, Lcom/google/common/collect/ImmutableEnumMap;->asImmutable(Ljava/util/EnumMap;)Lcom/google/common/collect/ImmutableMap;
...
.method public static uniqueIndex(Ljava/lang/Iterable;Lcom/google/common/base/Function;)Lcom/google/common/collect/ImmutableMap;
    ...
    .line 1329
    invoke-static {v0, p1, v1}, Lcom/google/common/collect/Maps;->uniqueIndex(Ljava/util/Iterator;Lcom/google/common/base/Function;Lcom/google/common/collect/ImmutableMap$Builder;)Lcom/google/common/collect/ImmutableMap;
...
.method private static uniqueIndex(Ljava/util/Iterator;Lcom/google/common/base/Function;Lcom/google/common/collect/ImmutableMap$Builder;)Lcom/google/common/collect/ImmutableMap;
    ...
    .line 1382
    .local v0, "duplicateKeys":Ljava/lang/IllegalArgumentException;
    ...
    const-string v3, ". To index multiple values under a key, use Multimaps.index."
