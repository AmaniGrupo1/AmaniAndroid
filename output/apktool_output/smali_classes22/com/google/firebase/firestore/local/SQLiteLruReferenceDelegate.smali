...
.method synthetic lambda$removeOrphanedDocuments$2$com-google-firebase-firestore-local-SQLiteLruReferenceDelegate([ILjava/util/List;[Lcom/google/firebase/firestore/model/ResourcePath;Landroid/database/Cursor;)V
    ...
    .param p3, "startPath"    # [Lcom/google/firebase/firestore/model/ResourcePath;
...
.method public removeOrphanedDocuments(J)I
    ...
    new-array v4, v0, [Lcom/google/firebase/firestore/model/ResourcePath;

    sget-object v5, Lcom/google/firebase/firestore/model/ResourcePath;->EMPTY:Lcom/google/firebase/firestore/model/ResourcePath;
    ...
    .line 166
    .local v4, "startPath":[Lcom/google/firebase/firestore/model/ResourcePath;
    :goto_0
    nop
    ...
    .line 169
    const-string v7, "select path from target_documents group by path having COUNT(*) = 1 AND target_id = 0 AND sequence_number <= ? AND path > ? LIMIT ?"

    invoke-virtual {v5, v7}, Lcom/google/firebase/firestore/local/SQLitePersistence;->query(Ljava/lang/String;)Lcom/google/firebase/firestore/local/SQLitePersistence$Query;
    ...
    new-instance v7, Lcom/google/firebase/firestore/local/SQLiteLruReferenceDelegate$$ExternalSyntheticLambda1;

    invoke-direct {v7, p0, v1, v3, v4}, Lcom/google/firebase/firestore/local/SQLiteLruReferenceDelegate$$ExternalSyntheticLambda1;-><init>(Lcom/google/firebase/firestore/local/SQLiteLruReferenceDelegate;[ILjava/util/List;[Lcom/google/firebase/firestore/model/ResourcePath;)V
    ...
    .line 193
    :cond_1
    invoke-virtual {v5}, Lcom/google/firebase/firestore/local/SQLitePersistence;->getRemoteDocumentCache()Lcom/google/firebase/firestore/local/RemoteDocumentCache;
