...
.method private generateQueryAndBindings(Lcom/google/firebase/firestore/core/Target;ILjava/util/List;[Ljava/lang/Object;Ljava/lang/String;[Ljava/lang/Object;Ljava/lang/String;[Ljava/lang/Object;)[Ljava/lang/Object;
    ...
    .line 612
    .local v7, "statement":Ljava/lang/StringBuilder;
    ...
    invoke-static {v7, v1, v0}, Lcom/google/firebase/firestore/util/Util;->repeatSequence(Ljava/lang/CharSequence;ILjava/lang/CharSequence;)Ljava/lang/StringBuilder;
    ...
    invoke-static {v10, v2, v3}, Lcom/google/firebase/firestore/util/Util;->repeatSequence(Ljava/lang/CharSequence;ILjava/lang/CharSequence;)Ljava/lang/StringBuilder;
    ...
    .line 633
    .local v11, "bindArgs":[Ljava/lang/Object;
    new-instance v0, Ljava/util/ArrayList;
...
.method public getCollectionParents(Ljava/lang/String;)Ljava/util/List;
    ...
    new-instance v2, Lcom/google/firebase/firestore/local/SQLiteIndexManager$$ExternalSyntheticLambda3;

    invoke-direct {v2, v0}, Lcom/google/firebase/firestore/local/SQLiteIndexManager$$ExternalSyntheticLambda3;-><init>(Ljava/util/ArrayList;)V
...
.method public getDocumentsMatchingTarget(Lcom/google/firebase/firestore/core/Target;)Ljava/util/List;
    ...
    .line 506
    .local v10, "subQueries":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    new-instance v1, Ljava/util/ArrayList;
    ...
    .line 507
    .local v11, "bindings":Ljava/util/List;, "Ljava/util/List<Ljava/lang/Object;>;"
    new-instance v1, Ljava/util/ArrayList;
    ...
    .line 509
    .local v12, "indexes":Ljava/util/List;, "Ljava/util/List<Landroid/util/Pair<Lcom/google/firebase/firestore/core/Target;Lcom/google/firebase/firestore/model/FieldIndex;>;>;"
    ...
    invoke-direct {v0, v2}, Lcom/google/firebase/firestore/local/SQLiteIndexManager;->getFieldIndex(Lcom/google/firebase/firestore/core/Target;)Lcom/google/firebase/firestore/model/FieldIndex;

    move-result-object v3

    .line 511
    .local v3, "fieldIndex":Lcom/google/firebase/firestore/model/FieldIndex;
    if-nez v3, :cond_0
    ...
    .end local v3    # "fieldIndex":Lcom/google/firebase/firestore/model/FieldIndex;
    goto :goto_0
    ...
    .line 518
    .local v15, "pair":Landroid/util/Pair;, "Landroid/util/Pair<Lcom/google/firebase/firestore/core/Target;Lcom/google/firebase/firestore/model/FieldIndex;>;"
    ...
    invoke-virtual {v1, v2}, Lcom/google/firebase/firestore/core/Target;->getArrayValues(Lcom/google/firebase/firestore/model/FieldIndex;)Ljava/util/List;

    move-result-object v3

    .line 521
    .local v3, "arrayValues":Ljava/util/List;, "Ljava/util/List<Lcom/google/firestore/v1/Value;>;"
    invoke-virtual {v1, v2}, Lcom/google/firebase/firestore/core/Target;->getNotInValues(Lcom/google/firebase/firestore/model/FieldIndex;)Ljava/util/Collection;

    move-result-object v4

    .line 522
    .local v4, "notInValues":Ljava/util/Collection;, "Ljava/util/Collection<Lcom/google/firestore/v1/Value;>;"
    invoke-virtual {v1, v2}, Lcom/google/firebase/firestore/core/Target;->getLowerBound(Lcom/google/firebase/firestore/model/FieldIndex;)Lcom/google/firebase/firestore/core/Bound;

    move-result-object v5

    .line 523
    .local v5, "lowerBound":Lcom/google/firebase/firestore/core/Bound;
    invoke-virtual {v1, v2}, Lcom/google/firebase/firestore/core/Target;->getUpperBound(Lcom/google/firebase/firestore/model/FieldIndex;)Lcom/google/firebase/firestore/core/Bound;

    move-result-object v6

    .line 525
    .local v6, "upperBound":Lcom/google/firebase/firestore/core/Bound;
    ...
    filled-new-array {v2, v1, v3, v5, v6}, [Ljava/lang/Object;

    move-result-object v9

    invoke-static {v7, v8, v9}, Lcom/google/firebase/firestore/util/Logger;->debug(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    .line 536
    :goto_2
    invoke-direct {v0, v2, v1, v5}, Lcom/google/firebase/firestore/local/SQLiteIndexManager;->encodeBound(Lcom/google/firebase/firestore/model/FieldIndex;Lcom/google/firebase/firestore/core/Target;Lcom/google/firebase/firestore/core/Bound;)[Ljava/lang/Object;

    move-result-object v7

    .line 537
    .local v7, "lowerBoundEncoded":[Ljava/lang/Object;
    ...
    .line 538
    .local v8, "lowerBoundOp":Ljava/lang/String;
    :goto_3
    move-object v9, v6

    .end local v6    # "upperBound":Lcom/google/firebase/firestore/core/Bound;
    .local v9, "upperBound":Lcom/google/firebase/firestore/core/Bound;
    invoke-direct {v0, v2, v1, v9}, Lcom/google/firebase/firestore/local/SQLiteIndexManager;->encodeBound(Lcom/google/firebase/firestore/model/FieldIndex;Lcom/google/firebase/firestore/core/Target;Lcom/google/firebase/firestore/core/Bound;)[Ljava/lang/Object;

    move-result-object v6

    .line 539
    .local v6, "upperBoundEncoded":[Ljava/lang/Object;
    invoke-virtual {v9}, Lcom/google/firebase/firestore/core/Bound;->isInclusive()Z
    ...
    .line 540
    .local v17, "upperBoundOp":Ljava/lang/String;
    :goto_4
    move-object/from16 v18, v5

    move-object v5, v8

    .end local v8    # "lowerBoundOp":Ljava/lang/String;
    .local v5, "lowerBoundOp":Ljava/lang/String;
    .local v18, "lowerBound":Lcom/google/firebase/firestore/core/Bound;
    invoke-direct {v0, v2, v1, v4}, Lcom/google/firebase/firestore/local/SQLiteIndexManager;->encodeValues(Lcom/google/firebase/firestore/model/FieldIndex;Lcom/google/firebase/firestore/core/Target;Ljava/util/Collection;)[Ljava/lang/Object;

    move-result-object v8

    .line 542
    .local v8, "notInEncoded":[Ljava/lang/Object;
    nop
    ...
    .local v19, "fieldIndex":Lcom/google/firebase/firestore/model/FieldIndex;
    invoke-virtual/range {v19 .. v19}, Lcom/google/firebase/firestore/model/FieldIndex;->getIndexId()I
    ...
    .local v4, "lowerBoundEncoded":[Ljava/lang/Object;
    .local v7, "upperBoundOp":Ljava/lang/String;
    .local v9, "notInValues":Ljava/util/Collection;, "Ljava/util/Collection<Lcom/google/firestore/v1/Value;>;"
    .local v17, "upperBound":Lcom/google/firebase/firestore/core/Bound;
    ...
    .line 552
    .local v2, "subQueryAndBindings":[Ljava/lang/Object;
    ...
    .end local v1    # "subTarget":Lcom/google/firebase/firestore/core/Target;
    .local v20, "subTarget":Lcom/google/firebase/firestore/core/Target;
    array-length v1, v2
    ...
    .end local v2    # "subQueryAndBindings":[Ljava/lang/Object;
    .local v21, "subQueryAndBindings":[Ljava/lang/Object;
    ...
    .end local v4    # "lowerBoundEncoded":[Ljava/lang/Object;
    .end local v5    # "lowerBoundOp":Ljava/lang/String;
    .end local v6    # "upperBoundEncoded":[Ljava/lang/Object;
    .end local v7    # "upperBoundOp":Ljava/lang/String;
    .end local v8    # "notInEncoded":[Ljava/lang/Object;
    .end local v9    # "notInValues":Ljava/util/Collection;, "Ljava/util/Collection<Lcom/google/firestore/v1/Value;>;"
    .end local v15    # "pair":Landroid/util/Pair;, "Landroid/util/Pair<Lcom/google/firebase/firestore/core/Target;Lcom/google/firebase/firestore/model/FieldIndex;>;"
    .end local v17    # "upperBound":Lcom/google/firebase/firestore/core/Bound;
    .end local v18    # "lowerBound":Lcom/google/firebase/firestore/core/Bound;
    .end local v19    # "fieldIndex":Lcom/google/firebase/firestore/model/FieldIndex;
    .end local v20    # "subTarget":Lcom/google/firebase/firestore/core/Target;
    .end local v21    # "subQueryAndBindings":[Ljava/lang/Object;
    move/from16 v9, v16
    ...
    .line 572
    .local v1, "unionSubTargets":Ljava/lang/String;
    ...
    invoke-static {v14, v2, v4}, Lcom/google/firebase/firestore/util/Assert;->hardAssert(ZLjava/lang/String;[Ljava/lang/Object;)V
    ...
    .line 582
    .local v4, "result":Ljava/util/List;, "Ljava/util/List<Lcom/google/firebase/firestore/model/DocumentKey;>;"
    new-instance v5, Lcom/google/firebase/firestore/local/SQLiteIndexManager$$ExternalSyntheticLambda4;

    invoke-direct {v5, v4}, Lcom/google/firebase/firestore/local/SQLiteIndexManager$$ExternalSyntheticLambda4;-><init>(Ljava/util/List;)V

    invoke-virtual {v2, v5}, Lcom/google/firebase/firestore/local/SQLitePersistence$Query;->forEach(Lcom/google/firebase/firestore/util/Consumer;)I
    ...
    const-string v7, "Index scan returned %s documents"

    invoke-static {v5, v7, v6}, Lcom/google/firebase/firestore/util/Logger;->debug(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
