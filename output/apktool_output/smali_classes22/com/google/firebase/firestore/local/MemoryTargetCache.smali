...
.method getByteSize(Lcom/google/firebase/firestore/local/LocalSerializer;)J
    ...
    .line 178
    .local v3, "entry":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Lcom/google/firebase/firestore/core/TargetOrPipeline;Lcom/google/firebase/firestore/local/TargetData;>;"
    ...
    .line 179
    .end local v3    # "entry":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Lcom/google/firebase/firestore/core/TargetOrPipeline;Lcom/google/firebase/firestore/local/TargetData;>;"
    goto :goto_0
...
.method removeQueries(JLandroid/util/SparseArray;)I
    ...
    .line 121
    .local v1, "it":Ljava/util/Iterator;, "Ljava/util/Iterator<Ljava/util/Map$Entry<Lcom/google/firebase/firestore/core/TargetOrPipeline;Lcom/google/firebase/firestore/local/TargetData;>;>;"
    :goto_0
    invoke-interface {v1}, Ljava/util/Iterator;->hasNext()Z
    ...
    .line 123
    .local v2, "entry":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Lcom/google/firebase/firestore/core/TargetOrPipeline;Lcom/google/firebase/firestore/local/TargetData;>;"
    ...
    .line 130
    .end local v2    # "entry":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Lcom/google/firebase/firestore/core/TargetOrPipeline;Lcom/google/firebase/firestore/local/TargetData;>;"
    ...
    .line 131
    .end local v1    # "it":Ljava/util/Iterator;, "Ljava/util/Iterator<Ljava/util/Map$Entry<Lcom/google/firebase/firestore/core/TargetOrPipeline;Lcom/google/firebase/firestore/local/TargetData;>;>;"
    :cond_1
    return v0
.end method
