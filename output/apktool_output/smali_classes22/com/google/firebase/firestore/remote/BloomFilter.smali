...
.method public mightContain(Ljava/lang/String;)Z
    ...
    invoke-static {v0, v2}, Lcom/google/firebase/firestore/remote/BloomFilter;->getLongLittleEndian([BI)J
    ...
    .local v9, "i":I
    :goto_0
    iget v2, p0, Lcom/google/firebase/firestore/remote/BloomFilter;->hashCount:I
    ...
    .line 125
    .local v2, "index":I
    invoke-direct {p0, v2}, Lcom/google/firebase/firestore/remote/BloomFilter;->isBitSet(I)Z
    ...
    .line 116
    .end local v5    # "hash1":J
    .end local v7    # "hash2":J
    :cond_3
    move-object v4, p0
