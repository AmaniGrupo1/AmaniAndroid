...
.method public onLogMessage(Lcom/google/firebase/database/logging/Logger$Level;Ljava/lang/String;Ljava/lang/String;J)V
    ...
    .end local p1    # "level":Lcom/google/firebase/database/logging/Logger$Level;
    .local v0, "toLog":Ljava/lang/String;
    .local v1, "msTimestamp":J
    .local p2, "level":Lcom/google/firebase/database/logging/Logger$Level;
    .local p3, "tag":Ljava/lang/String;
    .local p4, "message":Ljava/lang/String;
    ...
    .end local v1    # "msTimestamp":J
    .restart local p1    # "level":Lcom/google/firebase/database/logging/Logger$Level;
    .local p2, "tag":Ljava/lang/String;
    .local p3, "message":Ljava/lang/String;
    .local p4, "msTimestamp":J
    :cond_0
    move-wide v1, p4
    ...
    .line 62
    .end local p1    # "level":Lcom/google/firebase/database/logging/Logger$Level;
    .restart local v1    # "msTimestamp":J
    .local p2, "level":Lcom/google/firebase/database/logging/Logger$Level;
    .local p3, "tag":Ljava/lang/String;
    .local p4, "message":Ljava/lang/String;
    :goto_0
