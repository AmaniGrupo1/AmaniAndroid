...
.method private loadNested(Lcom/google/firebase/database/core/Path;)Lcom/google/firebase/database/snapshot/Node;
    ...
    .line 952
    .local v9, "pathStrings":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    new-instance v0, Ljava/util/ArrayList;
    ...
    .line 954
    .local v10, "payloads":Ljava/util/List;, "Ljava/util/List<[B>;"
    invoke-static {}, Ljava/lang/System;->currentTimeMillis()J

    move-result-wide v11

    .line 955
    .local v11, "queryStart":J
    ...
    invoke-direct {v1, v4, v0}, Lcom/google/firebase/database/android/SqlPersistenceStorageEngine;->loadNestedQuery(Lcom/google/firebase/database/core/Path;[Ljava/lang/String;)Landroid/database/Cursor;
    ...
    .line 957
    .local v14, "queryDuration":J
    invoke-static {}, Ljava/lang/System;->currentTimeMillis()J

    move-result-wide v16

    .line 959
    .local v16, "loadingStart":J
    :goto_0
    :try_start_0
    ...
    .line 967
    .local v18, "loadingDuration":J
    invoke-static {}, Ljava/lang/System;->currentTimeMillis()J

    move-result-wide v20

    .line 969
    .local v20, "serializingStart":J
    ...
    .line 971
    .local v5, "sawDescendant":Z
    new-instance v6, Ljava/util/HashMap;

    invoke-direct {v6}, Ljava/util/HashMap;-><init>()V

    .line 972
    .local v6, "priorities":Ljava/util/Map;, "Ljava/util/Map<Lcom/google/firebase/database/core/Path;Lcom/google/firebase/database/snapshot/Node;>;"
    const/4 v7, 0x0

    move/from16 v22, v5

    .end local v5    # "sawDescendant":Z
    .local v7, "i":I
    .local v22, "sawDescendant":Z
    :goto_1
    ...
    invoke-direct {v2, v8}, Lcom/google/firebase/database/core/Path;-><init>(Ljava/lang/String;)V

    .line 981
    .local v2, "savedPath":Lcom/google/firebase/database/core/Path;
    invoke-direct {v1, v2, v9, v7}, Lcom/google/firebase/database/android/SqlPersistenceStorageEngine;->splitNodeRunLength(Lcom/google/firebase/database/core/Path;Ljava/util/List;I)I

    move-result v8

    .line 982
    .local v8, "splitNodeRunLength":I
    iget-object v3, v1, Lcom/google/firebase/database/android/SqlPersistenceStorageEngine;->logger:Lcom/google/firebase/database/logging/LogWrapper;
    ...
    .end local v2    # "savedPath":Lcom/google/firebase/database/core/Path;
    ...
    const-string v5, "Loading split node with "
    ...
    .end local v8    # "splitNodeRunLength":I
    .local v24, "splitNodeRunLength":I
    new-array v8, v5, [Ljava/lang/Object;

    invoke-virtual {v3, v2, v8}, Lcom/google/firebase/database/logging/LogWrapper;->debug(Ljava/lang/String;[Ljava/lang/Object;)V

    goto :goto_2

    .line 982
    .end local v24    # "splitNodeRunLength":I
    .end local v25    # "savedPath":Lcom/google/firebase/database/core/Path;
    .end local v26    # "pathString":Ljava/lang/String;
    .restart local v2    # "savedPath":Lcom/google/firebase/database/core/Path;
    .restart local v5    # "pathString":Ljava/lang/String;
    .restart local v8    # "splitNodeRunLength":I
    :cond_1
    move-object/from16 v25, v2
    ...
    .end local v5    # "pathString":Ljava/lang/String;
    .end local v8    # "splitNodeRunLength":I
    .restart local v24    # "splitNodeRunLength":I
    ...
    .line 987
    .local v2, "savedNode":Lcom/google/firebase/database/snapshot/Node;
    add-int v8, v7, v24
    ...
    .line 989
    .end local v2    # "savedNode":Lcom/google/firebase/database/snapshot/Node;
    .end local v25    # "savedPath":Lcom/google/firebase/database/core/Path;
    :cond_2
    move/from16 v23, v2
    ...
    .line 990
    .restart local v2    # "savedNode":Lcom/google/firebase/database/snapshot/Node;
    ...
    invoke-direct {v3, v8}, Lcom/google/firebase/database/core/Path;-><init>(Ljava/lang/String;)V
    ...
    .line 992
    .local v2, "savedPath":Lcom/google/firebase/database/core/Path;
    .local v3, "savedNode":Lcom/google/firebase/database/snapshot/Node;
    :goto_3
    ...
    .line 996
    :cond_3
    invoke-virtual {v2, v4}, Lcom/google/firebase/database/core/Path;->contains(Lcom/google/firebase/database/core/Path;)Z
    ...
    const-string v5, "Descendants of path must come after ancestors."

    invoke-static {v8, v5}, Lcom/google/firebase/database/core/utilities/Utilities;->hardAssert(ZLjava/lang/String;)V

    .line 998
    invoke-static {v2, v4}, Lcom/google/firebase/database/core/Path;->getRelative(Lcom/google/firebase/database/core/Path;Lcom/google/firebase/database/core/Path;)Lcom/google/firebase/database/core/Path;

    move-result-object v5

    invoke-interface {v3, v5}, Lcom/google/firebase/database/snapshot/Node;->getChild(Lcom/google/firebase/database/core/Path;)Lcom/google/firebase/database/snapshot/Node;
    ...
    .line 999
    :cond_4
    invoke-virtual {v4, v2}, Lcom/google/firebase/database/core/Path;->contains(Lcom/google/firebase/database/core/Path;)Z
    ...
    .line 1001
    .end local v22    # "sawDescendant":Z
    .local v5, "sawDescendant":Z
    invoke-static {v4, v2}, Lcom/google/firebase/database/core/Path;->getRelative(Lcom/google/firebase/database/core/Path;Lcom/google/firebase/database/core/Path;)Lcom/google/firebase/database/core/Path;

    move-result-object v8

    .line 1002
    .local v8, "childPath":Lcom/google/firebase/database/core/Path;
    invoke-interface {v0, v8, v3}, Lcom/google/firebase/database/snapshot/Node;->updateChild(Lcom/google/firebase/database/core/Path;Lcom/google/firebase/database/snapshot/Node;)Lcom/google/firebase/database/snapshot/Node;

    move-result-object v0

    .line 1003
    .end local v8    # "childPath":Lcom/google/firebase/database/core/Path;
    move/from16 v22, v5

    .line 972
    .end local v2    # "savedPath":Lcom/google/firebase/database/core/Path;
    .end local v3    # "savedNode":Lcom/google/firebase/database/snapshot/Node;
    .end local v5    # "sawDescendant":Z
    .restart local v22    # "sawDescendant":Z
    :goto_4
    ...
    .line 1004
    .restart local v2    # "savedPath":Lcom/google/firebase/database/core/Path;
    .restart local v3    # "savedNode":Lcom/google/firebase/database/snapshot/Node;
    :cond_5
    ...
    .restart local v0    # "node":Lcom/google/firebase/database/snapshot/Node;
    :cond_6
    move-object/from16 v23, v0
    ...
    .line 1011
    .local v3, "entry":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Lcom/google/firebase/database/core/Path;Lcom/google/firebase/database/snapshot/Node;>;"
    ...
    .line 1012
    .local v5, "priorityPath":Lcom/google/firebase/database/core/Path;
    ...
    invoke-interface {v2, v7, v8}, Lcom/google/firebase/database/snapshot/Node;->updateChild(Lcom/google/firebase/database/core/Path;Lcom/google/firebase/database/snapshot/Node;)Lcom/google/firebase/database/snapshot/Node;

    move-result-object v2

    .line 1013
    .end local v3    # "entry":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Lcom/google/firebase/database/core/Path;Lcom/google/firebase/database/snapshot/Node;>;"
    .end local v5    # "priorityPath":Lcom/google/firebase/database/core/Path;
    goto :goto_5
    ...
    .line 1024
    invoke-static {v2}, Lcom/google/firebase/database/core/utilities/NodeSizeEstimator;->nodeCount(Lcom/google/firebase/database/snapshot/Node;)I
    ...
    .end local v6    # "priorities":Ljava/util/Map;, "Ljava/util/Map<Lcom/google/firebase/database/core/Path;Lcom/google/firebase/database/snapshot/Node;>;"
    .local v8, "priorities":Ljava/util/Map;, "Ljava/util/Map<Lcom/google/firebase/database/core/Path;Lcom/google/firebase/database/snapshot/Node;>;"
    ...
    .end local v8    # "priorities":Ljava/util/Map;, "Ljava/util/Map<Lcom/google/firebase/database/core/Path;Lcom/google/firebase/database/snapshot/Node;>;"
    .local v30, "priorities":Ljava/util/Map;, "Ljava/util/Map<Lcom/google/firebase/database/core/Path;Lcom/google/firebase/database/snapshot/Node;>;"
    ...
    .end local v9    # "pathStrings":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    .local v24, "pathStrings":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    ...
    .line 1017
    .end local v23    # "node":Lcom/google/firebase/database/snapshot/Node;
    .end local v24    # "pathStrings":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    .end local v30    # "priorities":Ljava/util/Map;, "Ljava/util/Map<Lcom/google/firebase/database/core/Path;Lcom/google/firebase/database/snapshot/Node;>;"
    .restart local v2    # "node":Lcom/google/firebase/database/snapshot/Node;
    .restart local v6    # "priorities":Ljava/util/Map;, "Ljava/util/Map<Lcom/google/firebase/database/core/Path;Lcom/google/firebase/database/snapshot/Node;>;"
    .restart local v9    # "pathStrings":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    :cond_8
    move-object/from16 v23, v2
    ...
    .end local v9    # "pathStrings":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    .restart local v23    # "node":Lcom/google/firebase/database/snapshot/Node;
    .restart local v24    # "pathStrings":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    .restart local v30    # "priorities":Ljava/util/Map;, "Ljava/util/Map<Lcom/google/firebase/database/core/Path;Lcom/google/firebase/database/snapshot/Node;>;"
    :goto_6
    return-object v23

    .line 964
    .end local v18    # "loadingDuration":J
    .end local v20    # "serializingStart":J
    .end local v22    # "sawDescendant":Z
    .end local v23    # "node":Lcom/google/firebase/database/snapshot/Node;
    .end local v24    # "pathStrings":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    .end local v25    # "serializeDuration":J
...
.method private pruneTreeRecursive(Lcom/google/firebase/database/core/Path;Lcom/google/firebase/database/core/Path;Lcom/google/firebase/database/core/utilities/ImmutableTree;Lcom/google/firebase/database/core/utilities/ImmutableTree;Lcom/google/firebase/database/core/persistence/PruneForest;Ljava/util/List;)V
    ...
    .line 736
    .local v8, "absolutePath":Lcom/google/firebase/database/core/Path;
    ...
    .line 738
    const-string v9, "Need to rewrite %d nodes below path %s"
    ...
    .line 745
    .local v5, "currentNode":Lcom/google/firebase/database/snapshot/Node;
    ...
    .line 734
    .end local v5    # "currentNode":Lcom/google/firebase/database/snapshot/Node;
    .end local v8    # "absolutePath":Lcom/google/firebase/database/core/Path;
    :cond_1
    move-object v9, v2
    ...
    .line 763
    .local v10, "entry":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Lcom/google/firebase/database/snapshot/ChildKey;Lcom/google/firebase/database/core/utilities/ImmutableTree<Ljava/lang/Long;>;>;"
    ...
    .line 765
    .local v5, "childPruneForest":Lcom/google/firebase/database/core/persistence/PruneForest;
    nop
    ...
    .line 772
    .end local v5    # "childPruneForest":Lcom/google/firebase/database/core/persistence/PruneForest;
    .end local v10    # "entry":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Lcom/google/firebase/database/snapshot/ChildKey;Lcom/google/firebase/database/core/utilities/ImmutableTree<Ljava/lang/Long;>;>;"
...
.method private saveWrite(Lcom/google/firebase/database/core/Path;JLjava/lang/String;[B)V
    ...
    .line 339
    .end local v2    # "parts":Ljava/util/List;, "Ljava/util/List<[B>;"
    .end local v11    # "i":I
    :cond_0
    goto :goto_1
...
.method public loadTrackedQueries()Ljava/util/List;
    ...
    .line 496
    .local v8, "paramsStr":Ljava/lang/String;
    :try_start_1
    invoke-static {v8}, Lcom/google/firebase/database/util/JsonMapper;->parseJson(Ljava/lang/String;)Ljava/util/Map;
    ...
    .line 500
    :try_start_2
    invoke-static {v7, v0}, Lcom/google/firebase/database/core/view/QuerySpec;->fromPathAndQueryObject(Lcom/google/firebase/database/core/Path;Ljava/util/Map;)Lcom/google/firebase/database/core/view/QuerySpec;

    move-result-object v15

    .line 501
    .local v15, "query":Lcom/google/firebase/database/core/view/QuerySpec;
    const/4 v9, 0x3
    ...
    .line 505
    .local v12, "trackedQuery":Lcom/google/firebase/database/core/persistence/TrackedQuery;
    ...
    .end local v8    # "paramsStr":Ljava/lang/String;
    .end local v12    # "trackedQuery":Lcom/google/firebase/database/core/persistence/TrackedQuery;
    .end local v13    # "id":J
    .end local v15    # "query":Lcom/google/firebase/database/core/view/QuerySpec;
    .end local v16    # "lastUse":J
    .end local v18    # "complete":Z
    .end local v19    # "active":Z
    goto :goto_0

    .line 497
    .restart local v7    # "path":Lcom/google/firebase/database/core/Path;
    .restart local v8    # "paramsStr":Ljava/lang/String;
    ...
    const-string v9, "Loaded %d tracked queries in %dms"
    ...
    .line 509
    invoke-virtual {v0, v8, v5}, Lcom/google/firebase/database/logging/LogWrapper;->debug(Ljava/lang/String;[Ljava/lang/Object;)V
    :try_end_2
...
.method public loadTrackedQueryKeys(Ljava/util/Set;)Ljava/util/Set;
    ...
    .line 630
    invoke-virtual {v0, v9, v4}, Lcom/google/firebase/database/logging/LogWrapper;->debug(Ljava/lang/String;[Ljava/lang/Object;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public loadUserWrites()Ljava/util/List;
    ...
    .line 282
    .local v15, "path":Lcom/google/firebase/database/core/Path;
    const/4 v0, 0x2
    ...
    .local v5, "serialized":[B
    goto :goto_1

    .line 289
    .end local v5    # "serialized":[B
    :cond_0
    ...
    .line 291
    .local v6, "parts":Ljava/util/List;, "Ljava/util/List<[B>;"
    :cond_1
    invoke-interface {v2, v7}, Landroid/database/Cursor;->getBlob(I)[B
    ...
    .line 297
    .end local v6    # "parts":Ljava/util/List;, "Ljava/util/List<[B>;"
    .restart local v5    # "serialized":[B
    :goto_1
    ...
    .line 306
    .local v8, "merge":Lcom/google/firebase/database/core/CompoundWrite;
    ...
    .line 307
    .end local v8    # "merge":Lcom/google/firebase/database/core/CompoundWrite;
    .restart local v12    # "record":Lcom/google/firebase/database/core/UserWriteRecord;
    nop
    ...
    .end local v5    # "serialized":[B
    .end local v6    # "serializedString":Ljava/lang/String;
    .end local v7    # "writeValue":Ljava/lang/Object;
    .end local v12    # "record":Lcom/google/firebase/database/core/UserWriteRecord;
    .end local v13    # "writeId":J
    .end local v15    # "path":Lcom/google/firebase/database/core/Path;
    goto/16 :goto_0

    .line 308
    .restart local v0    # "type":Ljava/lang/String;
    .restart local v5    # "serialized":[B
    .restart local v6    # "serializedString":Ljava/lang/String;
    .restart local v7    # "writeValue":Ljava/lang/Object;
    .restart local v13    # "writeId":J
    .restart local v15    # "path":Lcom/google/firebase/database/core/Path;
    :cond_4
    ...
    const-string v9, "Loaded %d writes in %dms"
...
.method public pruneCache(Lcom/google/firebase/database/core/Path;Lcom/google/firebase/database/core/persistence/PruneForest;)V
    ...
    .line 653
    .local v2, "rowIdsToPrune":Lcom/google/firebase/database/core/utilities/ImmutableTree;, "Lcom/google/firebase/database/core/utilities/ImmutableTree<Ljava/lang/Long;>;"
    ...
    .line 654
    .end local v2    # "rowIdsToPrune":Lcom/google/firebase/database/core/utilities/ImmutableTree;, "Lcom/google/firebase/database/core/utilities/ImmutableTree<Ljava/lang/Long;>;"
    .local v3, "rowIdsToPrune":Lcom/google/firebase/database/core/utilities/ImmutableTree;, "Lcom/google/firebase/database/core/utilities/ImmutableTree<Ljava/lang/Long;>;"
    ...
    invoke-virtual {v6, v13}, Lcom/google/firebase/database/logging/LogWrapper;->warn(Ljava/lang/String;)V
    ...
    invoke-virtual {v3, v6, v13}, Lcom/google/firebase/database/core/utilities/ImmutableTree;->set(Lcom/google/firebase/database/core/Path;Ljava/lang/Object;)Lcom/google/firebase/database/core/utilities/ImmutableTree;
    ...
    invoke-virtual {v4, v6, v13}, Lcom/google/firebase/database/core/utilities/ImmutableTree;->set(Lcom/google/firebase/database/core/Path;Ljava/lang/Object;)Lcom/google/firebase/database/core/utilities/ImmutableTree;
    ...
    invoke-virtual {v14, v13}, Lcom/google/firebase/database/logging/LogWrapper;->warn(Ljava/lang/String;)V
    ...
    .line 692
    .local v2, "rowIdsToDelete":Ljava/util/Collection;, "Ljava/util/Collection<Ljava/lang/Long;>;"
    new-instance v5, Ljava/lang/StringBuilder;

    invoke-direct {v5}, Ljava/lang/StringBuilder;-><init>()V

    const-string v14, "rowid IN ("
    ...
    const-string v15, "serverCache"

    invoke-virtual {v14, v15, v5, v10}, Landroid/database/sqlite/SQLiteDatabase;->delete(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    check-cast v14, Lcom/google/firebase/database/core/utilities/Pair;

    .line 696
    .local v14, "node":Lcom/google/firebase/database/core/utilities/Pair;, "Lcom/google/firebase/database/core/utilities/Pair<Lcom/google/firebase/database/core/Path;Lcom/google/firebase/database/snapshot/Node;>;"
    invoke-virtual {v14}, Lcom/google/firebase/database/core/utilities/Pair;->getFirst()Ljava/lang/Object;
    ...
    invoke-virtual {v14}, Lcom/google/firebase/database/core/utilities/Pair;->getSecond()Ljava/lang/Object;

    move-result-object v16

    move-object/from16 v11, v16

    check-cast v11, Lcom/google/firebase/database/snapshot/Node;

    invoke-direct {v0, v15, v11}, Lcom/google/firebase/database/android/SqlPersistenceStorageEngine;->saveNested(Lcom/google/firebase/database/core/Path;Lcom/google/firebase/database/snapshot/Node;)I

    .line 697
    .end local v14    # "node":Lcom/google/firebase/database/core/utilities/Pair;, "Lcom/google/firebase/database/core/utilities/Pair<Lcom/google/firebase/database/core/Path;Lcom/google/firebase/database/snapshot/Node;>;"
    const/4 v11, 0x0
    ...
    .line 702
    .end local v2    # "rowIdsToDelete":Ljava/util/Collection;, "Ljava/util/Collection<Ljava/lang/Long;>;"
    ...
    .line 705
    const-string v14, "Pruned %d rows with %d nodes resaved in %dms"
    ...
    .line 704
    invoke-virtual {v2, v10, v11}, Lcom/google/firebase/database/logging/LogWrapper;->debug(Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public removeUserWrite(J)V
    ...
    .line 251
    const-string v8, "Deleted %d write(s) with writeId %d in %dms"
...
.method public resetPreviouslyActiveTrackedQueries(J)V
    ...
    const-string v10, "Reset active tracked queries in %dms"
...
.method public saveTrackedQueryKeys(JLjava/util/Set;)V
    ...
    .line 545
    .local v3, "keysWhereClause":Ljava/lang/String;
    ...
    .line 548
    .local v5, "addedKey":Lcom/google/firebase/database/snapshot/ChildKey;
    ...
    .line 553
    .end local v5    # "addedKey":Lcom/google/firebase/database/snapshot/ChildKey;
...
.method public saveUserMerge(Lcom/google/firebase/database/core/Path;Lcom/google/firebase/database/core/CompoundWrite;J)V
    ...
    invoke-direct {p0, v2}, Lcom/google/firebase/database/android/SqlPersistenceStorageEngine;->serializeObject(Ljava/lang/Object;)[B

    move-result-object v8

    .line 236
    .local v8, "serializedNode":[B
    const-string v7, "m"
    ...
    .line 238
    .local p3, "duration":J
    iget-object p1, v3, Lcom/google/firebase/database/android/SqlPersistenceStorageEngine;->logger:Lcom/google/firebase/database/logging/LogWrapper;
    ...
    const-string v9, "Persisted user merge in %dms"
    ...
    invoke-virtual {p1, v2, v7}, Lcom/google/firebase/database/logging/LogWrapper;->debug(Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public saveUserOverwrite(Lcom/google/firebase/database/core/Path;Lcom/google/firebase/database/snapshot/Node;J)V
    ...
    const-string v9, "Persisted user overwrite in %dms"
...
.method public updateTrackedQueryKeys(JLjava/util/Set;Ljava/util/Set;)V
    ...
    .line 576
    .local v5, "removedKey":Lcom/google/firebase/database/snapshot/ChildKey;
    ...
    .line 578
    .end local v5    # "removedKey":Lcom/google/firebase/database/snapshot/ChildKey;
    goto :goto_0
