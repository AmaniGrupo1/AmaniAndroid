...
.method private ackWriteAndRerunTransactions(JLcom/google/firebase/database/core/Path;Lcom/google/firebase/database/DatabaseError;)V
    ...
    .line 448
    .local p1, "clearEvents":Ljava/util/List;, "Ljava/util/List<+Lcom/google/firebase/database/core/view/Event;>;"
    ...
    .end local p1    # "clearEvents":Ljava/util/List;, "Ljava/util/List<+Lcom/google/firebase/database/core/view/Event;>;"
    :goto_2
    return-void
.end method
...
.method private rerunTransactionQueue(Ljava/util/List;Lcom/google/firebase/database/core/Path;)V
    ...
    .line 1290
    .local v0, "newDataNode":Lcom/google/firebase/database/snapshot/Node;
    nop
    ...
    .line 1293
    .local v4, "newNodeResolved":Lcom/google/firebase/database/snapshot/Node;
    ...
    .end local v0    # "newDataNode":Lcom/google/firebase/database/snapshot/Node;
    .end local v4    # "newNodeResolved":Lcom/google/firebase/database/snapshot/Node;
    .local v18, "newDataNode":Lcom/google/firebase/database/snapshot/Node;
    .local v19, "newNodeResolved":Lcom/google/firebase/database/snapshot/Node;
    ...
    .end local v18    # "newDataNode":Lcom/google/firebase/database/snapshot/Node;
    .end local v19    # "newNodeResolved":Lcom/google/firebase/database/snapshot/Node;
    goto :goto_4
...
.method private restoreWrites(Lcom/google/firebase/database/core/persistence/PersistenceManager;)V
    ...
    .line 270
    iget-object v9, v0, Lcom/google/firebase/database/core/Repo;->operationLogger:Lcom/google/firebase/database/logging/LogWrapper;
    ...
    invoke-interface {v10, v11}, Lcom/google/firebase/database/snapshot/Node;->getValue(Z)Ljava/lang/Object;
    ...
    .line 262
    .local v14, "resolved":Lcom/google/firebase/database/snapshot/Node;
    ...
    .line 269
    .end local v14    # "resolved":Lcom/google/firebase/database/snapshot/Node;
    goto :goto_1
    ...
    invoke-virtual {v10, v11}, Lcom/google/firebase/database/core/CompoundWrite;->getValue(Z)Ljava/util/Map;
    ...
    .line 277
    .local v14, "resolved":Lcom/google/firebase/database/core/CompoundWrite;
    iget-object v11, v0, Lcom/google/firebase/database/core/Repo;->serverSyncTree:Lcom/google/firebase/database/core/SyncTree;
    ...
    .end local v14    # "resolved":Lcom/google/firebase/database/core/CompoundWrite;
    :goto_1
    goto/16 :goto_0
...
.method public onDataUpdate(Ljava/util/List;Ljava/lang/Object;ZLjava/lang/Long;)V
    ...
    .line 357
    .end local v2    # "taggedChildren":Ljava/util/Map;, "Ljava/util/Map<Lcom/google/firebase/database/core/Path;Lcom/google/firebase/database/snapshot/Node;>;"
    .end local v3    # "rawMergeData":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Ljava/lang/Object;>;"
    .local v4, "events":Ljava/util/List;, "Ljava/util/List<+Lcom/google/firebase/database/core/view/Event;>;"
    goto :goto_1

    .line 358
    .end local v4    # "events":Ljava/util/List;, "Ljava/util/List<+Lcom/google/firebase/database/core/view/Event;>;"
    :cond_3
    invoke-static {p2}, Lcom/google/firebase/database/snapshot/NodeUtilities;->NodeFromJSON(Ljava/lang/Object;)Lcom/google/firebase/database/snapshot/Node;
    ...
    .end local v2    # "taggedSnap":Lcom/google/firebase/database/snapshot/Node;
    .restart local v4    # "events":Ljava/util/List;, "Ljava/util/List<+Lcom/google/firebase/database/core/view/Event;>;"
    :goto_1
    goto :goto_3
    ...
    .end local v2    # "rawMergeData":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Ljava/lang/Object;>;"
    .local v4, "events":Ljava/util/List;, "Ljava/util/List<+Lcom/google/firebase/database/core/view/Event;>;"
    goto :goto_3
...
.method public setValue(Lcom/google/firebase/database/core/Path;Lcom/google/firebase/database/snapshot/Node;Lcom/google/firebase/database/DatabaseReference$CompletionListener;)V
    ...
    .line 467
    .local v10, "serverValues":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Ljava/lang/Object;>;"
    iget-object v0, v1, Lcom/google/firebase/database/core/Repo;->serverSyncTree:Lcom/google/firebase/database/core/SyncTree;
    ...
    .line 468
    .local v11, "existing":Lcom/google/firebase/database/snapshot/Node;
    nop
    ...
    .end local v5    # "newValue":Lcom/google/firebase/database/snapshot/Node;
    .end local v6    # "writeId":J
    .local v3, "writeId":J
    .local v7, "newValue":Lcom/google/firebase/database/snapshot/Node;
...
.method public startTransaction(Lcom/google/firebase/database/core/Path;Lcom/google/firebase/database/Transaction$Handler;Z)V
    ...
    .line 931
    .local v11, "watchRef":Lcom/google/firebase/database/DatabaseReference;
    ...
    .line 943
    .local v5, "listener":Lcom/google/firebase/database/ValueEventListener;
    ...
    .end local v5    # "listener":Lcom/google/firebase/database/ValueEventListener;
    .local v12, "listener":Lcom/google/firebase/database/ValueEventListener;
    move-object v13, v2

    .line 955
    .local v13, "transaction":Lcom/google/firebase/database/core/Repo$TransactionData;
    ...
    .line 956
    .local v14, "currentState":Lcom/google/firebase/database/snapshot/Node;
    ...
    .line 959
    .local v15, "mutableCurrent":Lcom/google/firebase/database/MutableData;
    const/4 v2, 0x0
    ...
    .end local v11    # "watchRef":Lcom/google/firebase/database/DatabaseReference;
    .end local v12    # "listener":Lcom/google/firebase/database/ValueEventListener;
    .end local v13    # "transaction":Lcom/google/firebase/database/core/Repo$TransactionData;
    .end local v14    # "currentState":Lcom/google/firebase/database/snapshot/Node;
    .end local v15    # "mutableCurrent":Lcom/google/firebase/database/MutableData;
    ...
    .restart local v11    # "watchRef":Lcom/google/firebase/database/DatabaseReference;
    .restart local v12    # "listener":Lcom/google/firebase/database/ValueEventListener;
    .restart local v13    # "transaction":Lcom/google/firebase/database/core/Repo$TransactionData;
    .restart local v14    # "currentState":Lcom/google/firebase/database/snapshot/Node;
    .restart local v15    # "mutableCurrent":Lcom/google/firebase/database/MutableData;
    ...
    .line 979
    .local v4, "snap":Lcom/google/firebase/database/DataSnapshot;
    ...
    .end local v4    # "snap":Lcom/google/firebase/database/DataSnapshot;
    goto :goto_1
    ...
    .line 991
    .local v2, "queueNode":Lcom/google/firebase/database/core/utilities/Tree;, "Lcom/google/firebase/database/core/utilities/Tree<Ljava/util/List<Lcom/google/firebase/database/core/Repo$TransactionData;>;>;"
    ...
    .line 992
    .local v4, "nodeQueue":Ljava/util/List;, "Ljava/util/List<Lcom/google/firebase/database/core/Repo$TransactionData;>;"
    if-nez v4, :cond_5
    ...
    .end local v4    # "nodeQueue":Ljava/util/List;, "Ljava/util/List<Lcom/google/firebase/database/core/Repo$TransactionData;>;"
    ...
    .line 1000
    .local v4, "newNodeUnresolved":Lcom/google/firebase/database/snapshot/Node;
    nop
    ...
    .line 1004
    .local v7, "newNode":Lcom/google/firebase/database/snapshot/Node;
    ...
    .end local v2    # "queueNode":Lcom/google/firebase/database/core/utilities/Tree;, "Lcom/google/firebase/database/core/utilities/Tree<Ljava/util/List<Lcom/google/firebase/database/core/Repo$TransactionData;>;>;"
    ...
    .end local v7    # "newNode":Lcom/google/firebase/database/snapshot/Node;
    .local v5, "newNode":Lcom/google/firebase/database/snapshot/Node;
    .local v9, "nodeQueue":Ljava/util/List;, "Ljava/util/List<Lcom/google/firebase/database/core/Repo$TransactionData;>;"
    ...
    .end local v9    # "nodeQueue":Ljava/util/List;, "Ljava/util/List<Lcom/google/firebase/database/core/Repo$TransactionData;>;"
    .local v18, "nodeQueue":Ljava/util/List;, "Ljava/util/List<Lcom/google/firebase/database/core/Repo$TransactionData;>;"
    const/4 v9, 0x0
    ...
    .line 1019
    .end local v2    # "events":Ljava/util/List;, "Ljava/util/List<+Lcom/google/firebase/database/core/view/Event;>;"
    .end local v4    # "newNodeUnresolved":Lcom/google/firebase/database/snapshot/Node;
    .end local v5    # "newNode":Lcom/google/firebase/database/snapshot/Node;
    ...
    .end local v18    # "nodeQueue":Ljava/util/List;, "Ljava/util/List<Lcom/google/firebase/database/core/Repo$TransactionData;>;"
    .end local v19    # "serverValues":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Ljava/lang/Object;>;"
    :goto_1
    return-void
.end method
...
.method public updateChildren(Lcom/google/firebase/database/core/Path;Lcom/google/firebase/database/core/CompoundWrite;Lcom/google/firebase/database/DatabaseReference$CompletionListener;Ljava/util/Map;)V
    ...
    .line 612
    .local v5, "resolved":Lcom/google/firebase/database/core/CompoundWrite;
    ...
    .end local v5    # "resolved":Lcom/google/firebase/database/core/CompoundWrite;
    .local v3, "writeId":J
    .local v6, "resolved":Lcom/google/firebase/database/core/CompoundWrite;
    .local v8, "events":Ljava/util/List;, "Ljava/util/List<+Lcom/google/firebase/database/core/view/Event;>;"
    ...
    .line 633
    .local v5, "update":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Lcom/google/firebase/database/core/Path;Lcom/google/firebase/database/snapshot/Node;>;"
    invoke-interface {v5}, Ljava/util/Map$Entry;->getKey()Ljava/lang/Object;
    ...
    .line 634
    .local v7, "pathFromRoot":Lcom/google/firebase/database/core/Path;
    const/16 v10, -0x9
    ...
    .line 635
    .local v10, "affectedPath":Lcom/google/firebase/database/core/Path;
    ...
    .line 636
    .end local v5    # "update":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Lcom/google/firebase/database/core/Path;Lcom/google/firebase/database/snapshot/Node;>;"
    .end local v7    # "pathFromRoot":Lcom/google/firebase/database/core/Path;
    .end local v10    # "affectedPath":Lcom/google/firebase/database/core/Path;
    goto :goto_0
