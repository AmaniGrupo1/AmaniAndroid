...
.method public generateEventsForChanges(Ljava/util/List;Lcom/google/firebase/database/snapshot/IndexedNode;Ljava/util/List;)Ljava/util/List;
    ...
    .line 81
    .local v0, "moves":Ljava/util/List;, "Ljava/util/List<Lcom/google/firebase/database/core/view/Change;>;"
    ...
    .line 82
    .local v3, "change":Lcom/google/firebase/database/core/view/Change;
    ...
    .line 87
    .end local v3    # "change":Lcom/google/firebase/database/core/view/Change;
    :cond_0
    goto :goto_0
    ...
    .end local p1    # "changes":Ljava/util/List;, "Ljava/util/List<Lcom/google/firebase/database/core/view/Change;>;"
    .end local p2    # "eventCache":Lcom/google/firebase/database/snapshot/IndexedNode;
    .end local p3    # "eventRegistrations":Ljava/util/List;, "Ljava/util/List<Lcom/google/firebase/database/core/EventRegistration;>;"
    .local v4, "changes":Ljava/util/List;, "Ljava/util/List<Lcom/google/firebase/database/core/view/Change;>;"
    .local v5, "eventRegistrations":Ljava/util/List;, "Ljava/util/List<Lcom/google/firebase/database/core/EventRegistration;>;"
    .local v6, "eventCache":Lcom/google/firebase/database/snapshot/IndexedNode;
    ...
    .line 93
    .end local v4    # "changes":Ljava/util/List;, "Ljava/util/List<Lcom/google/firebase/database/core/view/Change;>;"
    .restart local p1    # "changes":Ljava/util/List;, "Ljava/util/List<Lcom/google/firebase/database/core/view/Change;>;"
    ...
    .end local v0    # "moves":Ljava/util/List;, "Ljava/util/List<Lcom/google/firebase/database/core/view/Change;>;"
    .local v4, "moves":Ljava/util/List;, "Ljava/util/List<Lcom/google/firebase/database/core/view/Change;>;"
    invoke-direct/range {v1 .. v6}, Lcom/google/firebase/database/core/view/EventGenerator;->generateEventsForType(Ljava/util/List;Lcom/google/firebase/database/core/view/Event$EventType;Ljava/util/List;Ljava/util/List;Lcom/google/firebase/database/snapshot/IndexedNode;)V

    .line 95
    move-object p2, v4

    .end local v4    # "moves":Ljava/util/List;, "Ljava/util/List<Lcom/google/firebase/database/core/view/Change;>;"
    .local p2, "moves":Ljava/util/List;, "Ljava/util/List<Lcom/google/firebase/database/core/view/Change;>;"
