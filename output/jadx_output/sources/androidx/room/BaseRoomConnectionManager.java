...
public abstract class BaseRoomConnectionManager {
    ...
    /* JADX INFO: compiled from: RoomConnectionManager.kt */
    @Metadata(d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0003\b\u0084\u0004\u0018\u00002\u00020\u0001B\u000f\u0012\u0006\u0010\u0002\u001a\u00020\u0001¢\u0006\u0004\b\u0003\u0010\u0004J\u0010\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\bH\u0016J\u0010\u0010\t\u001a\u00020\u00062\u0006\u0010\n\u001a\u00020\bH\u0002R\u000e\u0010\u0002\u001a\u00020\u0001X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u000b"}, d2 = {"Landroidx/room/BaseRoomConnectionManager$DriverWrapper;", "Landroidx/sqlite/SQLiteDriver;", "actual", "<init>", "(Landroidx/room/BaseRoomConnectionManager;Landroidx/sqlite/SQLiteDriver;)V", TtmlNode.TEXT_EMPHASIS_MARK_OPEN, "Landroidx/sqlite/SQLiteConnection;", "fileName", "", "openLocked", "filename", "room-runtime_release"}, k = 1, mv = {2, 0, 0}, xi = 48)
    protected final class DriverWrapper implements SQLiteDriver {
        ...
        static final SQLiteConnection openLocked$lambda$1(BaseRoomConnectionManager this$0, DriverWrapper this$1, String $filename) {
    ...
    public final void configureDatabase(SQLiteConnection connection) throws Throwable {
        ...
        try {
            ...
            if (version != getOpenDelegate().getVersion()) {
                ...
                Throwable it = Result.m8545exceptionOrNullimpl(objM8542constructorimpl);
                if (it != null) {
    ...
    private final void configureBusyTimeout(SQLiteConnection connection) {
        ...
        try {
            ...
            AutoCloseableKt.closeFinally(sQLiteStatementPrepare, null);
            if (currentBusyTimeout < C.DEFAULT_MAX_SEEK_TO_PREVIOUS_POSITION_MS) {
    ...
    private final void checkIdentity(SQLiteConnection connection) throws Throwable {
        ...
        try {
            ...
            Result.Companion companion2 = Result.INSTANCE;
            objM8542constructorimpl = Result.m8542constructorimpl(ResultKt.createFailure(th3));
        }
        if (!result.isValid) {
            throw new IllegalStateException(("Pre-packaged database has an invalid schema: " + result.expectedFoundMsg).toString());
        }
        ...
        Throwable it2 = Result.m8545exceptionOrNullimpl(objM8542constructorimpl);
        if (it2 == null) {
            Result.m8541boximpl(objM8542constructorimpl);
        } else {
            SQLite.execSQL(connection, "ROLLBACK TRANSACTION");
            throw it2;
        }
