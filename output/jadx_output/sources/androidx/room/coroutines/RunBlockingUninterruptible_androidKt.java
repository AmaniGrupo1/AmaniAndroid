...
public final class RunBlockingUninterruptible_androidKt {
    ...
    static final class AnonymousClass1<T> extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super T>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    BuildersKt.launch(GlobalScope.INSTANCE, dispatcher, CoroutineStart.UNDISPATCHED, new C01361(deferred, this.$block, null));
        ...
        static final class C01361 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            C01361(CompletableDeferred<T> completableDeferred, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super C01361> continuation) {
                super(2, continuation);
            ...
            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                C01361 c01361 = new C01361(this.$deferred, this.$block, continuation);
                c01361.L$0 = obj;
                return c01361;
            }
                ...
                switch (this.label) {
                    case 0:
                        ...
                        try {
                            ...
                            $result3 = Result.m8542constructorimpl(ResultKt.createFailure(th));
                        ...
                        $result = objInvoke;
                        try {
                            $result3 = Result.m8542constructorimpl($result);
                            break;
                        } catch (Throwable th2) {
                            Object obj = $result2;
                            th = th2;
