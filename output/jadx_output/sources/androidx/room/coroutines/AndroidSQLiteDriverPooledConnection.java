...
final class AndroidSQLiteDriverPooledConnection implements Transactor, RawConnectionAccessor {
    ...
    public <R> Object usePrepared(String sql, Function1<? super SQLiteStatement, ? extends R> function1, Continuation<? super R> continuation) {
        SQLiteStatement sQLiteStatementPrepare = this.delegate.prepare(sql);
        try {
    ...
    /* JADX WARN: Type inference failed for: r9v1, types: [androidx.room.coroutines.AndroidSQLiteDriverPooledConnection] */
    /* JADX WARN: Type inference failed for: r9v12 */
    /* JADX WARN: Type inference failed for: r9v2 */
    /* JADX WARN: Type inference failed for: r9v3 */
    /* JADX WARN: Type inference failed for: r9v4 */
    /* JADX WARN: Type inference failed for: r9v5, types: [androidx.room.coroutines.AndroidSQLiteDriverPooledConnection] */
    /* JADX WARN: Type inference failed for: r9v6, types: [androidx.room.coroutines.AndroidSQLiteDriverPooledConnection] */
    /* JADX WARN: Type inference failed for: r9v8, types: [androidx.room.coroutines.AndroidSQLiteDriverPooledConnection] */
    /*
    ...
    */
            ...
            switch (anonymousClass1.label) {
                case 0:
                    ...
                    try {
                        ...
                        objInvoke = function2.invoke(androidSQLiteDriverTransactor, anonymousClass1);
                        ...
                        try {
                            ...
                            db.endTransaction();
                            if (!db.inTransaction()) {
                                ((AndroidSQLiteDriverPooledConnection) function2).currentTransactionType = null;
                            }
                            return objInvoke;
                ...
                case 1:
                    ...
                    function2 = (Function2<? super TransactionScope<R>, ? super Continuation<? super R>, ? extends Object>) ((AndroidSQLiteDriverPooledConnection) anonymousClass1.L$0);
                    try {
                        ResultKt.throwOnFailure(obj);
                        db = sQLiteDatabase;
                        objInvoke = obj;
    ...
    private final class AndroidSQLiteDriverTransactor<T> implements TransactionScope<T>, RawConnectionAccessor {
        ...
        @Override // androidx.room.PooledConnection
        public <R> Object usePrepared(String sql, Function1<? super SQLiteStatement, ? extends R> function1, Continuation<? super R> continuation) {
            return AndroidSQLiteDriverPooledConnection.this.usePrepared(sql, function1, continuation);
        }
        ...
        public <R> Object withNestedTransaction(Function2<? super TransactionScope<R>, ? super Continuation<? super R>, ? extends Object> function2, Continuation<? super R> continuation) {
            ...
            Transactor.SQLiteTransactionType sQLiteTransactionType = AndroidSQLiteDriverPooledConnection.this.currentTransactionType;
