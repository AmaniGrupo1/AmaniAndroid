...
final /* synthetic */ class DBUtil__DBUtilKt {
    ...
    public static final class AnonymousClass2<R> extends SuspendLambda implements Function2<Transactor, Continuation<? super R>, Object> {
        ...
        */
            ...
            switch (this.label) {
                case 0:
                    ...
                    if (!this.$inTransaction) {
                        ...
                        this.label = 5;
                        Object objInvoke = function2.invoke(transactor, this);
                    ...
                    this.L$1 = null;
                    this.label = 3;
                    objWithTransaction = transactor.withTransaction(type, new DBUtil__DBUtilKt$internalPerform$2$result$1(this.$block, null), this);
        ...
        public final Object invokeSuspend$$forInline(Object $result) throws Throwable {
            Transactor.SQLiteTransactionType type;
    ...
    public static final <R> Object internalPerform(RoomDatabase $this$internalPerform, boolean isReadOnly, boolean inTransaction, Function2<? super PooledConnection, ? super Continuation<? super R>, ? extends Object> function2, Continuation<? super R> continuation) {
        return $this$internalPerform.useConnection$room_runtime_release(isReadOnly, new AnonymousClass2(inTransaction, isReadOnly, $this$internalPerform, function2, null), continuation);
    }
