...
public final class TableInfoKt {
    ...
    */
    public static final String toStringCommon(TableInfo $this$toStringCommon) {
        ...
        Iterable $this$sortedBy$iv2 = $this$toStringCommon.columns.values();
        StringBuilder sbAppend2 = sbAppend.append(formatString(CollectionsKt.sortedWith($this$sortedBy$iv2, new Comparator() { // from class: androidx.room.util.TableInfoKt$toStringCommon$$inlined$sortedBy$1
            /* JADX WARN: Multi-variable type inference failed */
            @Override // java.util.Comparator
            public final int compare(T t, T t2) {
                TableInfo.Column it = (TableInfo.Column) t;
                TableInfo.Column it2 = (TableInfo.Column) t2;
                return ComparisonsKt.compareValues(it.name, it2.name);
            }
        }))).append("\n            |    foreignKeys = {").append(formatString($this$toStringCommon.foreignKeys)).append("\n            |    indices = {");
        Iterable iterable = $this$toStringCommon.indices;
        if (iterable != null) {
            Iterable $this$sortedBy$iv3 = iterable;
            $this$sortedBy$iv = CollectionsKt.sortedWith($this$sortedBy$iv3, new Comparator() { // from class: androidx.room.util.TableInfoKt$toStringCommon$$inlined$sortedBy$2
                /* JADX WARN: Multi-variable type inference failed */
                @Override // java.util.Comparator
                public final int compare(T t, T t2) {
                    TableInfo.Index it = (TableInfo.Index) t;
                    TableInfo.Index it2 = (TableInfo.Index) t2;
                    return ComparisonsKt.compareValues(it.name, it2.name);
                }
            });
            if ($this$sortedBy$iv == null) {
                $this$sortedBy$iv = CollectionsKt.emptyList();
            }
        }
        return StringsKt.trimMargin$default(sbAppend2.append(formatString((Collection) $this$sortedBy$iv)).append("\n            |}\n        ").toString(), null, 1, null);
    }
