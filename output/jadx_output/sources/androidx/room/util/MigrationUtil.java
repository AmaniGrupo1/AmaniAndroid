...
public final class MigrationUtil {
    public static final boolean isMigrationRequired(DatabaseConfiguration $this$isMigrationRequired, int fromVersion, int toVersion) {
        ...
        Set<Integer> migrationNotRequiredFrom$room_runtime_release = $this$isMigrationRequired.getMigrationNotRequiredFrom$room_runtime_release();
        return $this$isMigrationRequired.requireMigration && (migrationNotRequiredFrom$room_runtime_release == null || !migrationNotRequiredFrom$room_runtime_release.contains(Integer.valueOf(fromVersion)));
    }
