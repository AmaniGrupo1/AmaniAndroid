...
public final class RoomSQLiteQuery implements SupportSQLiteQuery, SupportSQLiteProgram {
    ...
    public final void bindTo(SQLiteStatement statement) {
        ...
        while (true) {
            switch (this.bindingTypes[index]) {
                case 1:
                    statement.mo8065bindNull(index);
                    break;
                case 2:
                    statement.mo8064bindLong(index, this.longBindings[index]);
                    break;
                case 3:
                    statement.mo8063bindDouble(index, this.doubleBindings[index]);
                    break;
                case 4:
                    String str = this.stringBindings[index];
                    if (str == null) {
                    ...
                    statement.mo8066bindText(index, str);
                    break;
                    break;
                case 5:
                    byte[] bArr = this.blobBindings[index];
                    ...
                    statement.mo8062bindBlob(index, bArr);
                    break;
                    break;
            }
            if (index == argCount) {
