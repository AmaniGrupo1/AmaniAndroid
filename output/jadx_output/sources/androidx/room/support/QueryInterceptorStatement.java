...
public final class QueryInterceptorStatement implements SupportSQLiteStatement {
    ...
    static final class C06421 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C06421(List<? extends Object> list, Continuation<? super C06421> continuation) {
            super(2, continuation);
            this.$argsCopy = list;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return QueryInterceptorStatement.this.new C06421(this.$argsCopy, continuation);
        }
    ...
    public int executeUpdateDelete() {
        List argsCopy = CollectionsKt.toList(this.bindArgsCache);
        BuildersKt__Builders_commonKt.launch$default(this.queryCallbackScope, null, null, new C06421(argsCopy, null), 3, null);
    ...
    static final class C06411 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C06411(List<? extends Object> list, Continuation<? super C06411> continuation) {
            super(2, continuation);
            this.$argsCopy = list;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return QueryInterceptorStatement.this.new C06411(this.$argsCopy, continuation);
        }
    ...
    public long executeInsert() {
        List argsCopy = CollectionsKt.toList(this.bindArgsCache);
        BuildersKt__Builders_commonKt.launch$default(this.queryCallbackScope, null, null, new C06411(argsCopy, null), 3, null);
    ...
    static final class C06431 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C06431(List<? extends Object> list, Continuation<? super C06431> continuation) {
            super(2, continuation);
            this.$argsCopy = list;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return QueryInterceptorStatement.this.new C06431(this.$argsCopy, continuation);
        }
    ...
    public long simpleQueryForLong() {
        List argsCopy = CollectionsKt.toList(this.bindArgsCache);
        BuildersKt__Builders_commonKt.launch$default(this.queryCallbackScope, null, null, new C06431(argsCopy, null), 3, null);
    ...
    static final class C06441 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C06441(List<? extends Object> list, Continuation<? super C06441> continuation) {
            super(2, continuation);
            this.$argsCopy = list;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return QueryInterceptorStatement.this.new C06441(this.$argsCopy, continuation);
        }
    ...
    public String simpleQueryForString() {
        List argsCopy = CollectionsKt.toList(this.bindArgsCache);
        BuildersKt__Builders_commonKt.launch$default(this.queryCallbackScope, null, null, new C06441(argsCopy, null), 3, null);
