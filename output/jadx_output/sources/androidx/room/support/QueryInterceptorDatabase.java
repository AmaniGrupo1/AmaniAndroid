...
public final class QueryInterceptorDatabase implements SupportSQLiteDatabase {
    ...
    static final class C06331 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        int label;
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return QueryInterceptorDatabase.this.new C06331(continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
            return ((C06331) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public void beginTransactionNonExclusive() {
        BuildersKt__Builders_commonKt.launch$default(this.queryCallbackScope, null, null, new C06331(null), 3, null);
    ...
    static final class C06341 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return QueryInterceptorDatabase.this.new C06341(continuation);
        }
    ...
    public void beginTransactionWithListener(SQLiteTransactionListener transactionListener) {
        Intrinsics.checkNotNullParameter(transactionListener, "transactionListener");
        BuildersKt__Builders_commonKt.launch$default(this.queryCallbackScope, null, null, new C06341(null), 3, null);
    ...
    static final class C06351 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return QueryInterceptorDatabase.this.new C06351(continuation);
        }
    ...
    public void beginTransactionWithListenerNonExclusive(SQLiteTransactionListener transactionListener) {
        Intrinsics.checkNotNullParameter(transactionListener, "transactionListener");
        BuildersKt__Builders_commonKt.launch$default(this.queryCallbackScope, null, null, new C06351(null), 3, null);
    ...
    static final class C06361 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return QueryInterceptorDatabase.this.new C06361(continuation);
        }
    ...
    public void endTransaction() {
        BuildersKt__Builders_commonKt.launch$default(this.queryCallbackScope, null, null, new C06361(null), 3, null);
    ...
    static final class C06401 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return QueryInterceptorDatabase.this.new C06401(continuation);
        }
    ...
    public void setTransactionSuccessful() {
        BuildersKt__Builders_commonKt.launch$default(this.queryCallbackScope, null, null, new C06401(null), 3, null);
    ...
    static final class C06381 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        C06381(String str, Continuation<? super C06381> continuation) {
            super(2, continuation);
            this.$query = str;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return QueryInterceptorDatabase.this.new C06381(this.$query, continuation);
        }
    ...
    public Cursor query(String query) {
        ...
        BuildersKt__Builders_commonKt.launch$default(this.queryCallbackScope, null, null, new C06381(query, null), 3, null);
    ...
    static final class C06392 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        final /* synthetic */ List<Object> $argsCopy;
        final /* synthetic */ String $query;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C06392(String str, List<? extends Object> list, Continuation<? super C06392> continuation) {
            super(2, continuation);
            this.$query = str;
            this.$argsCopy = list;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return QueryInterceptorDatabase.this.new C06392(this.$query, this.$argsCopy, continuation);
        }
    ...
    public Cursor query(String query, Object[] bindArgs) {
        ...
        BuildersKt__Builders_commonKt.launch$default(this.queryCallbackScope, null, null, new C06392(query, argsCopy, null), 3, null);
    ...
    static final class C06371 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C06371(String str, Continuation<? super C06371> continuation) {
            super(2, continuation);
            this.$sql = str;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return QueryInterceptorDatabase.this.new C06371(this.$sql, continuation);
        }
    ...
    public void execSQL(String sql) {
        Intrinsics.checkNotNullParameter(sql, "sql");
        BuildersKt__Builders_commonKt.launch$default(this.queryCallbackScope, null, null, new C06371(sql, null), 3, null);
