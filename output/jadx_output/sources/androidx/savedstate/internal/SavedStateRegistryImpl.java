...
public final class SavedStateRegistryImpl {
    ...
    public final Bundle consumeRestoredStateForKey(String key) {
        ...
        Bundle $this$consumeRestoredStateForKey_u24lambda_u242 = SavedStateReader.m8071constructorimpl(state);
        Bundle consumed = SavedStateReader.m8072containsimpl($this$consumeRestoredStateForKey_u24lambda_u242, key) ? SavedStateReader.m8128getSavedStateimpl($this$consumeRestoredStateForKey_u24lambda_u242, key) : null;
        Bundle $this$consumeRestoredStateForKey_u24lambda_u243 = SavedStateWriter.m8157constructorimpl(state);
        SavedStateWriter.m8193removeimpl($this$consumeRestoredStateForKey_u24lambda_u243, key);
        Bundle $this$consumeRestoredStateForKey_u24lambda_u244 = SavedStateReader.m8071constructorimpl(state);
        if (SavedStateReader.m8149isEmptyimpl($this$consumeRestoredStateForKey_u24lambda_u244)) {
    ...
    public final void performRestore$savedstate(Bundle savedState) {
        ...
        Bundle bundleM8128getSavedStateimpl = null;
        if (savedState != null) {
            Bundle $this$performRestore_u24lambda_u2415 = SavedStateReader.m8071constructorimpl(savedState);
            if (SavedStateReader.m8072containsimpl($this$performRestore_u24lambda_u2415, SAVED_COMPONENTS_KEY)) {
                bundleM8128getSavedStateimpl = SavedStateReader.m8128getSavedStateimpl($this$performRestore_u24lambda_u2415, SAVED_COMPONENTS_KEY);
            }
        }
        this.restoredState = bundleM8128getSavedStateimpl;
    ...
    public final void performSave$savedstate(Bundle outBundle) {
        ...
        Bundle $this$performSave_u24lambda_u2418 = SavedStateWriter.m8157constructorimpl($this$savedState_u24lambda_u241$iv);
        Bundle it = this.restoredState;
        if (it != null) {
            SavedStateWriter.m8161putAllimpl($this$performSave_u24lambda_u2418, it);
        }
        SynchronizedObject lock$iv = this.lock;
        synchronized (lock$iv) {
            for (Map.Entry entry : this.keyToProviders.entrySet()) {
                ...
                SavedStateRegistry.SavedStateProvider provider = (SavedStateRegistry.SavedStateProvider) entry.getValue();
                SavedStateWriter.m8184putSavedStateimpl($this$performSave_u24lambda_u2418, key, provider.saveState());
                $this$savedState_u24lambda_u241$iv = $this$savedState_u24lambda_u241$iv;
            }
            inState = $this$savedState_u24lambda_u241$iv;
            Unit unit = Unit.INSTANCE;
        }
        Bundle $this$performSave_u24lambda_u2419 = SavedStateReader.m8071constructorimpl(inState);
        if (SavedStateReader.m8149isEmptyimpl($this$performSave_u24lambda_u2419)) {
            return;
        }
        Bundle $this$performSave_u24lambda_u2420 = SavedStateWriter.m8157constructorimpl(outBundle);
        SavedStateWriter.m8184putSavedStateimpl($this$performSave_u24lambda_u2420, SAVED_COMPONENTS_KEY, inState);
    }
