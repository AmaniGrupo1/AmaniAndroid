...
public final class LocalSavedStateRegistryOwnerKt {
    ...
    static {
        ...
        try {
            ...
            compositionLocalFromComposeUi = Result.m8542constructorimpl(providableCompositionLocal);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            compositionLocalFromComposeUi = Result.m8542constructorimpl(ResultKt.createFailure(th));
        }
        ProvidableCompositionLocal<SavedStateRegistryOwner> providableCompositionLocalStaticCompositionLocalOf = (ProvidableCompositionLocal) (Result.m8548isFailureimpl(compositionLocalFromComposeUi) ? null : compositionLocalFromComposeUi);
