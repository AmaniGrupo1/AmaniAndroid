...
public final class SavedStateEncoder extends AbstractEncoder {
    ...
    public CompositeEncoder beginStructure(SerialDescriptor descriptor) {
        ...
        SavedStateWriter.m8157constructorimpl(childState);
        Bundle $this$write$iv = this.savedState;
        Bundle $this$beginStructure_u24lambda_u240 = SavedStateWriter.m8157constructorimpl($this$write$iv);
        SavedStateWriter.m8184putSavedStateimpl($this$beginStructure_u24lambda_u240, this.key, childState);
    ...
    private final void putClassDiscriminatorIfRequired(SavedStateConfiguration configuration, SerialDescriptor descriptor, Bundle savedState) {
        ...
        Bundle $this$putClassDiscriminatorIfRequired_u24lambda_u241 = SavedStateReader.m8071constructorimpl(savedState);
        if (SavedStateReader.m8072containsimpl($this$putClassDiscriminatorIfRequired_u24lambda_u241, ClassDiscriminatorModeKt.CLASS_DISCRIMINATOR_KEY)) {
            return;
        }
        ...
        Bundle $this$putClassDiscriminatorIfRequired_u24lambda_u242 = SavedStateWriter.m8157constructorimpl(savedState);
        SavedStateWriter.m8190putStringimpl($this$putClassDiscriminatorIfRequired_u24lambda_u242, ClassDiscriminatorModeKt.CLASS_DISCRIMINATOR_KEY, descriptor.getSerialName());
    }
    ...
    public boolean encodeElement(SerialDescriptor descriptor, int index) {
        ...
        if (this.configuration.getClassDiscriminatorMode() == 1) {
            ...
            Bundle $this$encodeElement_u24lambda_u243 = SavedStateReader.m8071constructorimpl($this$read$iv);
            boolean hasClassDiscriminator = SavedStateReader.m8072containsimpl($this$encodeElement_u24lambda_u243, ClassDiscriminatorModeKt.CLASS_DISCRIMINATOR_KEY);
            ...
            if (hasClassDiscriminator && hasConflictingElementName) {
                ...
                Bundle $this$encodeElement_u24lambda_u244 = SavedStateReader.m8071constructorimpl($this$read$iv2);
                String classDiscriminator = SavedStateReader.m8142getStringimpl($this$encodeElement_u24lambda_u244, ClassDiscriminatorModeKt.CLASS_DISCRIMINATOR_KEY);
    ...
    public void encodeBoolean(boolean value) {
        Bundle $this$write$iv = this.savedState;
        Bundle $this$encodeBoolean_u24lambda_u245 = SavedStateWriter.m8157constructorimpl($this$write$iv);
        SavedStateWriter.m8163putBooleanimpl($this$encodeBoolean_u24lambda_u245, this.key, value);
    }

    @Override // kotlinx.serialization.encoding.AbstractEncoder, kotlinx.serialization.encoding.Encoder
    public void encodeByte(byte value) {
        Bundle $this$write$iv = this.savedState;
        Bundle $this$encodeByte_u24lambda_u246 = SavedStateWriter.m8157constructorimpl($this$write$iv);
        SavedStateWriter.m8174putIntimpl($this$encodeByte_u24lambda_u246, this.key, value);
    }

    @Override // kotlinx.serialization.encoding.AbstractEncoder, kotlinx.serialization.encoding.Encoder
    public void encodeShort(short value) {
        Bundle $this$write$iv = this.savedState;
        Bundle $this$encodeShort_u24lambda_u247 = SavedStateWriter.m8157constructorimpl($this$write$iv);
        SavedStateWriter.m8174putIntimpl($this$encodeShort_u24lambda_u247, this.key, value);
    }

    @Override // kotlinx.serialization.encoding.AbstractEncoder, kotlinx.serialization.encoding.Encoder
    public void encodeInt(int value) {
        Bundle $this$write$iv = this.savedState;
        Bundle $this$encodeInt_u24lambda_u248 = SavedStateWriter.m8157constructorimpl($this$write$iv);
        SavedStateWriter.m8174putIntimpl($this$encodeInt_u24lambda_u248, this.key, value);
    }

    @Override // kotlinx.serialization.encoding.AbstractEncoder, kotlinx.serialization.encoding.Encoder
    public void encodeLong(long value) {
        Bundle $this$write$iv = this.savedState;
        Bundle $this$encodeLong_u24lambda_u249 = SavedStateWriter.m8157constructorimpl($this$write$iv);
        SavedStateWriter.m8178putLongimpl($this$encodeLong_u24lambda_u249, this.key, value);
    }

    @Override // kotlinx.serialization.encoding.AbstractEncoder, kotlinx.serialization.encoding.Encoder
    public void encodeFloat(float value) {
        Bundle $this$write$iv = this.savedState;
        Bundle $this$encodeFloat_u24lambda_u2410 = SavedStateWriter.m8157constructorimpl($this$write$iv);
        SavedStateWriter.m8172putFloatimpl($this$encodeFloat_u24lambda_u2410, this.key, value);
    }

    @Override // kotlinx.serialization.encoding.AbstractEncoder, kotlinx.serialization.encoding.Encoder
    public void encodeDouble(double value) {
        Bundle $this$write$iv = this.savedState;
        Bundle $this$encodeDouble_u24lambda_u2411 = SavedStateWriter.m8157constructorimpl($this$write$iv);
        SavedStateWriter.m8170putDoubleimpl($this$encodeDouble_u24lambda_u2411, this.key, value);
    }

    @Override // kotlinx.serialization.encoding.AbstractEncoder, kotlinx.serialization.encoding.Encoder
    public void encodeChar(char value) {
        Bundle $this$write$iv = this.savedState;
        Bundle $this$encodeChar_u24lambda_u2412 = SavedStateWriter.m8157constructorimpl($this$write$iv);
        SavedStateWriter.m8165putCharimpl($this$encodeChar_u24lambda_u2412, this.key, value);
    }
    ...
    public void encodeString(String value) {
        ...
        Bundle $this$write$iv = this.savedState;
        Bundle $this$encodeString_u24lambda_u2413 = SavedStateWriter.m8157constructorimpl($this$write$iv);
        SavedStateWriter.m8190putStringimpl($this$encodeString_u24lambda_u2413, this.key, value);
    }
    ...
    public void encodeEnum(SerialDescriptor enumDescriptor, int index) {
        ...
        Bundle $this$write$iv = this.savedState;
        Bundle $this$encodeEnum_u24lambda_u2414 = SavedStateWriter.m8157constructorimpl($this$write$iv);
        SavedStateWriter.m8174putIntimpl($this$encodeEnum_u24lambda_u2414, this.key, index);
    }

    @Override // kotlinx.serialization.encoding.AbstractEncoder, kotlinx.serialization.encoding.Encoder
    public void encodeNull() {
        Bundle $this$write$iv = this.savedState;
        Bundle $this$encodeNull_u24lambda_u2415 = SavedStateWriter.m8157constructorimpl($this$write$iv);
        SavedStateWriter.m8180putNullimpl($this$encodeNull_u24lambda_u2415, this.key);
    }
    ...
    public <T> void encodeSerializableValue(SerializationStrategy<? super T> serializer, T value) {
        ...
        if (!Intrinsics.areEqual(descriptor, SavedStateCodecUtilsKt.getIntListDescriptor())) {
            if (!Intrinsics.areEqual(descriptor, SavedStateCodecUtilsKt.getStringListDescriptor())) {
                if (Intrinsics.areEqual(descriptor, SavedStateCodecUtilsKt.getBooleanArrayDescriptor())) {
                    Bundle $this$write$iv = this.savedState;
                    Bundle $this$encodeSerializableValue_u24lambda_u2418 = SavedStateWriter.m8157constructorimpl($this$write$iv);
                    String str = this.key;
                    Intrinsics.checkNotNull(value, "null cannot be cast to non-null type kotlin.BooleanArray");
                    SavedStateWriter.m8164putBooleanArrayimpl($this$encodeSerializableValue_u24lambda_u2418, str, (boolean[]) value);
                    return;
                }
                            ...
                            if (!Intrinsics.areEqual(descriptor, SavedStateCodecUtilsKt.getIntArrayDescriptor())) {
                                if (!Intrinsics.areEqual(descriptor, SavedStateCodecUtilsKt.getLongArrayDescriptor())) {
                                    if (Intrinsics.areEqual(descriptor, SavedStateCodecUtilsKt.getStringArrayDescriptor())) {
                                        ...
                                        Bundle $this$encodeSerializableValue_u24lambda_u2424 = SavedStateWriter.m8157constructorimpl($this$write$iv2);
                                        String str2 = this.key;
                                        Intrinsics.checkNotNull(value, "null cannot be cast to non-null type kotlin.Array<kotlin.String>");
                                        SavedStateWriter.m8191putStringArrayimpl($this$encodeSerializableValue_u24lambda_u2424, str2, (String[]) value);
                                        return;
                                    }
                                ...
                                Bundle $this$encodeSerializableValue_u24lambda_u2423 = SavedStateWriter.m8157constructorimpl($this$write$iv3);
                                String str3 = this.key;
                                Intrinsics.checkNotNull(value, "null cannot be cast to non-null type kotlin.LongArray");
                                SavedStateWriter.m8179putLongArrayimpl($this$encodeSerializableValue_u24lambda_u2423, str3, (long[]) value);
                                return;
                            }
                            Bundle $this$write$iv4 = this.savedState;
                            Bundle $this$encodeSerializableValue_u24lambda_u2422 = SavedStateWriter.m8157constructorimpl($this$write$iv4);
                            String str4 = this.key;
                            Intrinsics.checkNotNull(value, "null cannot be cast to non-null type kotlin.IntArray");
                            SavedStateWriter.m8175putIntArrayimpl($this$encodeSerializableValue_u24lambda_u2422, str4, (int[]) value);
                            return;
                        }
                        Bundle $this$write$iv5 = this.savedState;
                        Bundle $this$encodeSerializableValue_u24lambda_u2421 = SavedStateWriter.m8157constructorimpl($this$write$iv5);
                        String str5 = this.key;
                        Intrinsics.checkNotNull(value, "null cannot be cast to non-null type kotlin.FloatArray");
                        SavedStateWriter.m8173putFloatArrayimpl($this$encodeSerializableValue_u24lambda_u2421, str5, (float[]) value);
                        return;
                    }
                    Bundle $this$write$iv6 = this.savedState;
                    Bundle $this$encodeSerializableValue_u24lambda_u2420 = SavedStateWriter.m8157constructorimpl($this$write$iv6);
                    String str6 = this.key;
                    Intrinsics.checkNotNull(value, "null cannot be cast to non-null type kotlin.DoubleArray");
                    SavedStateWriter.m8171putDoubleArrayimpl($this$encodeSerializableValue_u24lambda_u2420, str6, (double[]) value);
                    return;
                }
                Bundle $this$write$iv7 = this.savedState;
                Bundle $this$encodeSerializableValue_u24lambda_u2419 = SavedStateWriter.m8157constructorimpl($this$write$iv7);
                String str7 = this.key;
                Intrinsics.checkNotNull(value, "null cannot be cast to non-null type kotlin.CharArray");
                SavedStateWriter.m8166putCharArrayimpl($this$encodeSerializableValue_u24lambda_u2419, str7, (char[]) value);
                return;
            }
            Bundle $this$write$iv8 = this.savedState;
            Bundle $this$encodeSerializableValue_u24lambda_u2417 = SavedStateWriter.m8157constructorimpl($this$write$iv8);
            String str8 = this.key;
            Intrinsics.checkNotNull(value, "null cannot be cast to non-null type kotlin.collections.List<kotlin.String>");
            SavedStateWriter.m8192putStringListimpl($this$encodeSerializableValue_u24lambda_u2417, str8, (List) value);
            return;
        }
        Bundle $this$write$iv9 = this.savedState;
        Bundle $this$encodeSerializableValue_u24lambda_u2416 = SavedStateWriter.m8157constructorimpl($this$write$iv9);
        ...
        SavedStateWriter.m8176putIntListimpl($this$encodeSerializableValue_u24lambda_u2416, str9, (List) value);
    }
}
