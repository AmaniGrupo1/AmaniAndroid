...
public abstract class JavaSerializableSerializer<T extends Serializable> implements KSerializer<T> {
    ...
    public final void serialize(Encoder encoder, T value) {
        ...
        SavedStateWriter.m8177putJavaSerializableimpl($this$serialize_u24lambda_u242_u24lambda_u241, $this$serialize_u24lambda_u242.getKey(), value);
    }
    ...
    public final T deserialize(Decoder decoder) {
        ...
        T t = (T) SavedStateReader.m8109getJavaSerializableimpl(SavedStateReader.m8071constructorimpl(savedStateDecoder.getSavedState()), savedStateDecoder.getKey(), Reflection.getOrCreateKotlinClass(Serializable.class));
