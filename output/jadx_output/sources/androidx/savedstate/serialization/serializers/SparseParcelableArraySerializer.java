...
public final class SparseParcelableArraySerializer implements KSerializer<SparseArray<Parcelable>> {
    ...
    public void serialize(Encoder encoder, SparseArray<Parcelable> value) {
        ...
        SavedStateWriter.m8189putSparseParcelableArrayimpl($this$serialize_u24lambda_u242_u24lambda_u241, $this$serialize_u24lambda_u242.getKey(), value);
    }
    ...
    public SparseArray<Parcelable> deserialize(Decoder decoder) {
        ...
        return SavedStateReader.m8139getSparseParcelableArrayimpl($this$deserialize_u24lambda_u245_u24lambda_u244, key$iv, Reflection.getOrCreateKotlinClass(Parcelable.class));
    }
}
