...
public abstract class ParcelableSerializer<T extends Parcelable> implements KSerializer<T> {
    ...
    public final void serialize(Encoder encoder, T value) {
        ...
        SavedStateWriter.m8181putParcelableimpl($this$serialize_u24lambda_u242_u24lambda_u241, $this$serialize_u24lambda_u242.getKey(), value);
    }
    ...
    public final T deserialize(Decoder decoder) {
        ...
        T t = (T) SavedStateReader.m8117getParcelableimpl(SavedStateReader.m8071constructorimpl(savedStateDecoder.getSavedState()), savedStateDecoder.getKey(), Reflection.getOrCreateKotlinClass(Parcelable.class));
