    ...
    */
    ...
    private static void dumpKeyframes(Object[] keyframes, String header) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            StringBuilder sbAppend = new StringBuilder().append("Keyframe ").append(i).append(": fraction ");
    ...
    private static Keyframe loadKeyframe(Context context, Resources res, Resources.Theme theme, AttributeSet attrs, int valueType, XmlPullParser parser) throws XmlPullParserException, IOException {
        ...
        if (hasValue) {
            switch (valueType) {
                case 0:
                    float value = TypedArrayUtils.getNamedFloat(a, parser, Values.VECTOR_MAP_VECTORS_KEY, 0, 0.0f);
                    keyframe = Keyframe.ofFloat(fraction, value);
                    break;
                case 1:
                case 3:
                    int intValue = TypedArrayUtils.getNamedInt(a, parser, Values.VECTOR_MAP_VECTORS_KEY, 0, 0);
