...
public final class TraceKt {
    ...
    */
    public static final <T> Object traceAsync(String methodName, int cookie, Function1<? super Continuation<? super T>, ? extends Object> function1, Continuation<? super T> continuation) throws Throwable {
        ...
        switch (anonymousClass1.label) {
            case 0:
                ...
                try {
                    anonymousClass1.L$0 = methodName;
                    anonymousClass1.I$0 = cookie;
                    ...
                    Trace.endAsyncSection(methodName2, cookie);
                    return objInvoke;
                } catch (Throwable th) {
                    th = th;
                    methodName2 = methodName;
            ...
            case 1:
                cookie = anonymousClass1.I$0;
                methodName2 = (String) anonymousClass1.L$0;
                try {
                    ResultKt.throwOnFailure($result);
                    objInvoke = $result;
                    Trace.endAsyncSection(methodName2, cookie);
    ...
    private static final <T> Object traceAsync$$forInline(String methodName, int cookie, Function1<? super Continuation<? super T>, ? extends Object> function1, Continuation<? super T> continuation) {
        Trace.beginAsyncSection(methodName, cookie);
        try {
    ...
    public static final <T> T traceAsync(Function0<String> lazyMethodName, Function0<Integer> lazyCookie, Function0<? extends T> block) {
        ...
        int cookie = 0;
        if (Trace.isEnabled()) {
            String methodName2 = lazyMethodName.invoke();
            methodName = methodName2;
            cookie = lazyCookie.invoke().intValue();
            Trace.beginAsyncSection(methodName, cookie);
        }
        try {
            return block.invoke();
