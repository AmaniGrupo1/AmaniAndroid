...
public final class SavedStateHandleSaverKt {
    public static /* synthetic */ Object saveable$default(SavedStateHandle savedStateHandle, String str, Saver saver, Function0 function0, int i, Object obj) {
        ...
        return m7819saveable(savedStateHandle, str, saver, function0);
    }

    /* JADX INFO: renamed from: saveable, reason: collision with other method in class */
    public static final <T> T m7819saveable(SavedStateHandle $this$saveable, String key, final Saver<T, ? extends Object> saver, Function0<? extends T> function0) {
        final T tInvoke;
        Object p0;
        ...
        if (bundle == null || (p0 = bundle.get(Values.VECTOR_MAP_VECTORS_KEY)) == null || (tInvoke = saver.restore(p0)) == null) {
    ...
    static final Bundle saveable$lambda$0(Saver $saver, Object $value) {
        Pair[] pairs$iv;
        Map initialState$iv = MapsKt.mapOf(TuplesKt.to(Values.VECTOR_MAP_VECTORS_KEY, $saver.save(new SavedStateHandleSaverKt$saveable$1$1$1(SavedStateHandle.INSTANCE), $value)));
    ...
    public static final <T> MutableState<T> saveable(SavedStateHandle $this$saveable, String key, Saver<T, ? extends Object> saver, Function0<? extends MutableState<T>> function0) {
        return (MutableState) m7819saveable($this$saveable, key, mutableStateSaver(saver), (Function0) function0);
    }
    ...
    static final ReadOnlyProperty saveable$lambda$1(SavedStateHandle $this_saveable, Saver $saver, Function0 $init, Object thisRef, KProperty property) {
        ...
        final Object value = m7819saveable($this_saveable, classNamePrefix + property.getName(), (Saver<Object, ? extends Object>) $saver, (Function0<? extends Object>) $init);
