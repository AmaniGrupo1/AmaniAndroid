            ...
            public final Object invokeSuspend(Object $result) throws Throwable {
                ...
                switch (this.label) {
                    case 0:
                        ...
                        final Ref.ObjectRef launchedJob2 = new Ref.ObjectRef();
                        observer = new Ref.ObjectRef();
                        try {
                            ...
                            observer.element = new LifecycleEventObserver() { // from class: androidx.lifecycle.RepeatOnLifecycleKt$repeatOnLifecycle$3$1$1$1
                                ...
                                public final void onStateChanged(LifecycleOwner lifecycleOwner, Lifecycle.Event event) {
                                    ...
                                    if (event == startWorkEvent) {
                                        launchedJob2.element = BuildersKt__Builders_commonKt.launch$default(coroutineScope, null, null, new AnonymousClass1(mutex, function2, null), 3, null);
                                        return;
                                    }
                                    if (event == cancelWorkEvent) {
                                        Job job3 = launchedJob2.element;
                                        if (job3 != null) {
                                            Job.DefaultImpls.cancel$default(job3, (CancellationException) null, 1, (Object) null);
                                        }
                                        launchedJob2.element = null;
                                    }
                                ...
                                /* JADX INFO: compiled from: RepeatOnLifecycle.kt */
                                @Metadata(d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\n"}, d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, k = 3, mv = {2, 0, 0}, xi = 48)
                                @DebugMetadata(c = "androidx.lifecycle.RepeatOnLifecycleKt$repeatOnLifecycle$3$1$1$1$1", f = "RepeatOnLifecycle.kt", i = {0, 1}, l = {166, 110}, m = "invokeSuspend", n = {"$this$withLock_u24default$iv", "$this$withLock_u24default$iv"}, s = {"L$0", "L$0"}, v = 1)
                                static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                                    final /* synthetic */ Function2<CoroutineScope, Continuation<? super Unit>, Object> $block;
                                    ...
                                    */
                                    public final Object invokeSuspend(Object $result) throws Throwable {
                                        ...
                                        switch (this.label) {
                                            case 0:
                                                ResultKt.throwOnFailure($result);
                                                Mutex $this$withLock_u24default$iv4 = this.$mutex;
                            ...
                            launchedJob = launchedJob2;
                            job2 = (Job) launchedJob.element;
                            if (job2 != null) {
                                Job.DefaultImpls.cancel$default(job2, (CancellationException) null, 1, (Object) null);
                            }
                            it2 = (LifecycleEventObserver) observer.element;
                            if (it2 != null) {
                                this.$this_repeatOnLifecycle.removeObserver(it2);
                            }
                            return Unit.INSTANCE;
                        } catch (Throwable th) {
                            th = th;
                            ...
                            it = (LifecycleEventObserver) observer.element;
                            if (it != null) {
                                this.$this_repeatOnLifecycle.removeObserver(it);
                            }
                            throw th;
                        }
                    case 1:
                        observer = (Ref.ObjectRef) this.L$1;
                        launchedJob = (Ref.ObjectRef) this.L$0;
                        try {
                            ResultKt.throwOnFailure($result);
                            job2 = (Job) launchedJob.element;
                            if (job2 != null) {
