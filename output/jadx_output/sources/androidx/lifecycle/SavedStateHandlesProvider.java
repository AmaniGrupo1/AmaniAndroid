...
public final class SavedStateHandlesProvider implements SavedStateRegistry.SavedStateProvider {
    ...
    public Bundle saveState() {
        ...
        Bundle $this$saveState_u24lambda_u240 = SavedStateWriter.m8157constructorimpl($this$savedState_u24lambda_u241$iv);
        Bundle it = this.restoredState;
        if (it != null) {
            SavedStateWriter.m8161putAllimpl($this$saveState_u24lambda_u240, it);
        }
        for (Map.Entry<String, SavedStateHandle> entry : getViewModel().getHandles().entrySet()) {
            ...
            Bundle $this$saveState_u24lambda_u240_u241_u240 = SavedStateReader.m8071constructorimpl(savedState);
            if (!SavedStateReader.m8149isEmptyimpl($this$saveState_u24lambda_u240_u241_u240)) {
                SavedStateWriter.m8184putSavedStateimpl($this$saveState_u24lambda_u240, key, savedState);
            }
    ...
    public final void performRestore() {
        ...
        if (!this.restored) {
            ...
            Bundle $this$savedState_u24lambda_u241$iv = BundleKt.bundleOf((Pair[]) Arrays.copyOf(pairs$iv, pairs$iv.length));
            Bundle $this$performRestore_u24lambda_u240 = SavedStateWriter.m8157constructorimpl($this$savedState_u24lambda_u241$iv);
            Bundle it = this.restoredState;
            if (it != null) {
                SavedStateWriter.m8161putAllimpl($this$performRestore_u24lambda_u240, it);
            }
            if (newState != null) {
                SavedStateWriter.m8161putAllimpl($this$performRestore_u24lambda_u240, newState);
            }
    ...
    public final Bundle consumeRestoredStateForKey(String key) {
        ...
        Bundle $this$consumeRestoredStateForKey_u24lambda_u240 = SavedStateReader.m8071constructorimpl(state);
        if (!SavedStateReader.m8072containsimpl($this$consumeRestoredStateForKey_u24lambda_u240, key)) {
            return null;
        }
        Bundle $this$consumeRestoredStateForKey_u24lambda_u241 = SavedStateReader.m8071constructorimpl(state);
        Bundle result = SavedStateReader.m8133getSavedStateOrNullimpl($this$consumeRestoredStateForKey_u24lambda_u241, key);
        if (result == null) {
            Map initialState$iv = MapsKt.emptyMap();
            if (initialState$iv.isEmpty()) {
                pairs$iv = new Pair[0];
        ...
        Bundle $this$consumeRestoredStateForKey_u24lambda_u242 = SavedStateWriter.m8157constructorimpl(state);
        SavedStateWriter.m8193removeimpl($this$consumeRestoredStateForKey_u24lambda_u242, key);
        Bundle $this$consumeRestoredStateForKey_u24lambda_u243 = SavedStateReader.m8071constructorimpl(state);
        if (SavedStateReader.m8149isEmptyimpl($this$consumeRestoredStateForKey_u24lambda_u243)) {
