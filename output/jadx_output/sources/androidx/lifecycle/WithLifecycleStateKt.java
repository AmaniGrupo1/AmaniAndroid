...
public final class WithLifecycleStateKt {
    ...
    public static final <R> Object suspendWithStateAtLeastUnchecked(final Lifecycle $this$suspendWithStateAtLeastUnchecked, final Lifecycle.State state, boolean dispatchNeeded, final CoroutineDispatcher lifecycleDispatcher, final Function0<? extends R> function0, Continuation<? super R> continuation) {
        ...
        final CancellableContinuationImpl co2 = cancellable$iv;
        final ?? r6 = new LifecycleEventObserver() { // from class: androidx.lifecycle.WithLifecycleStateKt$suspendWithStateAtLeastUnchecked$2$observer$1
            ...
            public void onStateChanged(LifecycleOwner source, Lifecycle.Event event) {
                ...
                if (event == Lifecycle.Event.INSTANCE.upTo(state)) {
                    ...
                    Continuation continuation2 = co2;
                    Function0<R> function02 = function0;
                    try {
                        Result.Companion companion = Result.INSTANCE;
                        objM8542constructorimpl = Result.m8542constructorimpl(function02.invoke());
                    } catch (Throwable th) {
                        Result.Companion companion2 = Result.INSTANCE;
                        objM8542constructorimpl = Result.m8542constructorimpl(ResultKt.createFailure(th));
                    }
                    continuation2.resumeWith(objM8542constructorimpl);
                    return;
                }
                if (event == Lifecycle.Event.ON_DESTROY) {
                    $this$suspendWithStateAtLeastUnchecked.removeObserver(this);
                    Continuation continuation3 = co2;
                    Result.Companion companion3 = Result.INSTANCE;
                    continuation3.resumeWith(Result.m8542constructorimpl(ResultKt.createFailure(new LifecycleDestroyedException())));
                }
            }
        };
        if (dispatchNeeded) {
            lifecycleDispatcher.mo10112dispatch(EmptyCoroutineContext.INSTANCE, new Runnable() { // from class: androidx.lifecycle.WithLifecycleStateKt$suspendWithStateAtLeastUnchecked$2$1
        ...
        co2.invokeOnCancellation(new Function1<Throwable, Unit>() { // from class: androidx.lifecycle.WithLifecycleStateKt$suspendWithStateAtLeastUnchecked$2$2
            ...
            public final void invoke2(Throwable it) {
                if (lifecycleDispatcher.isDispatchNeeded(EmptyCoroutineContext.INSTANCE)) {
                    ...
                    coroutineDispatcher.mo10112dispatch(emptyCoroutineContext, new Runnable() { // from class: androidx.lifecycle.WithLifecycleStateKt$suspendWithStateAtLeastUnchecked$2$2.1
                        @Override // java.lang.Runnable
                        public final void run() {
