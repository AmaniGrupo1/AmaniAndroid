...
public final class FlowExtKt {
    ...
    static final class AnonymousClass1<T> extends SuspendLambda implements Function2<ProducerScope<? super T>, Continuation<? super Unit>, Object> {
        ...
        static final class C01241 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            C01241(Flow<? extends T> flow, ProducerScope<? super T> producerScope, Continuation<? super C01241> continuation) {
                super(2, continuation);
                this.$this_flowWithLifecycle = flow;
            ...
            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                return new C01241(this.$this_flowWithLifecycle, this.$$this$callbackFlow, continuation);
            }
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    this.label = 1;
                    if (RepeatOnLifecycleKt.repeatOnLifecycle(this.$lifecycle, this.$minActiveState, new C01241(this.$this_flowWithLifecycle, $this$callbackFlow2, null), this) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
