...
public final class MutableScatterMap<K, V> extends ScatterMap<K, V> {
    ...
    public final V remove(K key) {
        ...
        loop0: while (true) {
            ...
            while (true) {
                ...
                if (Intrinsics.areEqual(this_$iv.keys[index$iv], key)) {
                    break loop0;
                }
    ...
    */
    ...
    public final void adjustStorage$collection() {
        if (this._capacity > 8 && Long.compare(ULong.m8716constructorimpl(ULong.m8716constructorimpl(this._size) * 32) ^ Long.MIN_VALUE, ULong.m8716constructorimpl(ULong.m8716constructorimpl(this._capacity) * 25) ^ Long.MIN_VALUE) <= 0) {
