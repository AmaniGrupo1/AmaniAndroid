...
public abstract class IntFloatMap {
    ...
    */
    public boolean equals(Object other) {
        ...
        boolean z4 = false;
        if (!(obj instanceof IntFloatMap) || ((IntFloatMap) obj).get_size() != get_size()) {
            return false;
        }
        int $i$f$forEach = 0;
        int[] k$iv = this.keys;
            ...
            if ($this$maskEmptyOrDeleted$iv$iv$iv == -9187201950435737472L) {
                ...
                while (j$iv$iv < bitCount$iv$iv) {
                    ...
                    if (!(value$iv$iv$iv < 128 ? z5 : z6)) {
                        ...
                        float value = v$iv[index$iv$iv];
                        i = index;
                        int index2 = ((IntFloatMap) obj).findKeyIndex(key);
                        if (index2 < 0) {
                            break loop0;
                        }
                        if (!(value == ((IntFloatMap) other).values[index2] ? z5 : z2)) {
                            break loop0;
                        }
                    }
                    slot$iv$iv >>= i;
