            ...
            if ($this$maskEmptyOrDeleted$iv$iv$iv != -9187201950435737472L) {
                ...
                while (j$iv$iv < bitCount$iv$iv) {
                    ...
                    if (!(value$iv$iv$iv < 128 ? z3 : z4)) {
                        ...
                        Object key = k$iv[index$iv$iv];
                        float value = v$iv[index$iv$iv];
                        int index = objectFloatMap.findKeyIndex(key);
                        if (index < 0) {
                            break loop0;
                        }
                        if (!(value == objectFloatMap.values[index] ? z3 : z4)) {
                            break loop0;
                        }
                    }
                    slot$iv$iv >>= i;
