...
public abstract class LongFloatMap {
    ...
    */
    public boolean equals(Object other) {
        ...
        boolean z4 = false;
        if (!(obj instanceof LongFloatMap) || ((LongFloatMap) obj).get_size() != get_size()) {
            return false;
        }
        LongFloatMap this_$iv3 = this;
        int $i$f$forEach = 0;
            ...
            if ($this$maskEmptyOrDeleted$iv$iv$iv == -9187201950435737472L) {
                ...
                while (j$iv$iv < bitCount$iv$iv) {
                    ...
                    if (!(value$iv$iv$iv < 128 ? z5 : z6)) {
                        ...
                        float value = v$iv[index$iv$iv];
                        z2 = z6;
                        int index = ((LongFloatMap) obj).findKeyIndex(key);
                        if (index < 0) {
                            break loop0;
                        }
                        if (!(value == ((LongFloatMap) other).values[index] ? z5 : z2)) {
                            break loop0;
                        }
                    }
                    slot$iv$iv >>= i;
