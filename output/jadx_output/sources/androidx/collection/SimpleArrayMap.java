...
public class SimpleArrayMap<K, V> {
    ...
    public String toString() {
        ...
        $this$toString_u24lambda_u245.append(AbstractJsonLexerKt.BEGIN_OBJ);
        int i = this.size;
        for (int i2 = 0; i2 < i; i2++) {
            if (i2 > 0) {
        ...
        $this$toString_u24lambda_u245.append(AbstractJsonLexerKt.END_OBJ);
