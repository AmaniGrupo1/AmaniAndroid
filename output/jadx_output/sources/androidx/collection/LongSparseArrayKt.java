...
public final class LongSparseArrayKt {
    ...
    public static final <E> String commonToString(LongSparseArray<E> longSparseArray) {
        ...
        $this$commonToString_u24lambda_u245.append(AbstractJsonLexerKt.BEGIN_OBJ);
        int i = longSparseArray.size;
        for (int i2 = 0; i2 < i; i2++) {
            if (i2 > 0) {
        ...
        $this$commonToString_u24lambda_u245.append(AbstractJsonLexerKt.END_OBJ);
    ...
    public static final class C01931<T> implements Iterator<T>, KMappedMarker {
        ...
        C01931(LongSparseArray<T> longSparseArray) {
    ...
    public static final <T> Iterator<T> valueIterator(LongSparseArray<T> longSparseArray) {
        Intrinsics.checkNotNullParameter(longSparseArray, "<this>");
        return new C01931(longSparseArray);
    }
}
