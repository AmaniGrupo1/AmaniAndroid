    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                ScatterMap this_$iv = ((MutableValues) this.this$0).parent;
                ...
                if ((((~slot$iv2) << 7) & slot$iv2 & (-9187201950435737472L)) == -9187201950435737472L) {
                    ...
                    mutableValues$iterator$1$iterator$1 = mutableValues$iterator$1$iterator$12;
                    lastIndex$iv = i2;
                    i$iv = i$iv2;
                    slot$iv = slot$iv2;
                    if (j$iv < bitCount$iv) {
                        ...
                        if (value$iv$iv >= 128) {
                            if (0 != 0) {
                                ...
                                mutableValues$iterator$1$iterator$1.L$0 = $this$iterator;
                                mutableValues$iterator$1$iterator$1.L$1 = m$iv;
                                mutableValues$iterator$1$iterator$1.I$0 = lastIndex$iv;
                                mutableValues$iterator$1$iterator$1.I$1 = i$iv;
                                mutableValues$iterator$1$iterator$1.J$0 = slot$iv;
                                mutableValues$iterator$1$iterator$1.I$2 = bitCount$iv;
                                mutableValues$iterator$1$iterator$1.I$3 = j$iv;
                                mutableValues$iterator$1$iterator$1.label = 1;
                                if ($this$iterator.yield(numBoxInt, mutableValues$iterator$1$iterator$1) == coroutine_suspended) {
                        ...
                        if (bitCount$iv == i) {
                            mutableValues$iterator$1$iterator$12 = mutableValues$iterator$1$iterator$1;
