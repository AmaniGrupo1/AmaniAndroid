...
public final class SieveCache<K, V> {
    ...
    public final V get(K key) {
        ...
        if (iFindKeyIndex >= 0) {
            this.nodes[iFindKeyIndex] = (this.nodes[iFindKeyIndex] & 4611686018427387903L) | 4611686018427387904L;
    ...
    */
    ...
    public final void adjustStorage$collection() {
        if (this.capacity > 8 && Long.compare(ULong.m8716constructorimpl(ULong.m8716constructorimpl(getCount()) * 32) ^ Long.MIN_VALUE, ULong.m8716constructorimpl(ULong.m8716constructorimpl(this.capacity) * 25) ^ Long.MIN_VALUE) <= 0) {
