...
public class SparseArrayCompat<E> implements Cloneable {
    ...
    public SparseArrayCompat<E> m34clone() throws CloneNotSupportedException {
    ...
    public String toString() {
        ...
        buffer$iv.append(AbstractJsonLexerKt.BEGIN_OBJ);
        int i = this.size;
        for (int i$iv = 0; i$iv < i; i$iv++) {
            if (i$iv > 0) {
                buffer$iv.append(", ");
        ...
        buffer$iv.append(AbstractJsonLexerKt.END_OBJ);
