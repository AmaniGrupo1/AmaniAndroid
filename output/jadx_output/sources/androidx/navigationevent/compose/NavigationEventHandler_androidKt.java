...
/* JADX INFO: compiled from: NavigationEventHandler.android.kt */
...
public final class NavigationEventHandler_androidKt {
    public static final boolean isInspectionMode(Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1476766739, $changed, -1, "androidx.navigationevent.compose.isInspectionMode (NavigationEventHandler.android.kt:21)");
        }
