        ...
        private void createListView(AlertController dialog) {
            ...
            if (this.mIsMultiChoice) {
                if (this.mCursor == null) {
                    ...
                    alertParams = this;
                    dialog2 = dialog;
                    adapter = new CursorAdapter(alertParams.mContext, alertParams.mCursor, false) { // from class: androidx.appcompat.app.AlertController.AlertParams.2
                ...
                if (alertParams.mCursor != null) {
                    adapter = new SimpleCursorAdapter(alertParams.mContext, layout, alertParams.mCursor, new String[]{alertParams.mLabelColumn}, new int[]{android.R.id.text1});
                } else if (alertParams.mAdapter != null) {
                    adapter = alertParams.mAdapter;
                } else {
                    adapter = new CheckedItemAdapter(alertParams.mContext, layout, android.R.id.text1, alertParams.mItems);
                }
            }
            if (alertParams.mOnPrepareListViewListener != null) {
                alertParams.mOnPrepareListViewListener.onPrepareListView(listView);
            }
            dialog2.mAdapter = adapter;
            dialog2.mCheckedItem = alertParams.mCheckedItem;
            ...
            if (alertParams.mOnItemSelectedListener != null) {
                listView.setOnItemSelectedListener(alertParams.mOnItemSelectedListener);
            }
            if (alertParams.mIsSingleChoice) {
