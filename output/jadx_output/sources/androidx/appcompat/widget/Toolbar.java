...
public class Toolbar extends ViewGroup implements MenuHost {
    ...
    */
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        int left2;
        int spaceBelow;
        boolean isRtl2 = getLayoutDirection() == 1;
        int width2 = getWidth();
        ...
        if (shouldLayout(this.mNavButtonView)) {
            ...
            if (isRtl2) {
                ...
                left3 = layoutChildLeft(view, left3, collapsingMargins, alignmentHeight);
            }
        }
        if (shouldLayout(this.mCollapseButtonView)) {
            View view2 = this.mCollapseButtonView;
            if (isRtl2) {
                right = layoutChildRight(view2, right, collapsingMargins, alignmentHeight);
            } else {
                left3 = layoutChildLeft(view2, left3, collapsingMargins, alignmentHeight);
            }
        }
        if (shouldLayout(this.mMenuView)) {
            View view3 = this.mMenuView;
            if (isRtl2) {
                left3 = layoutChildLeft(view3, left3, collapsingMargins, alignmentHeight);
            } else {
                right = layoutChildRight(view3, right, collapsingMargins, alignmentHeight);
            }
        }
        ...
        if (shouldLayout(this.mExpandedActionView)) {
            ...
            if (isRtl2) {
                right2 = layoutChildRight(view4, right2, collapsingMargins, alignmentHeight);
            } else {
                left4 = layoutChildLeft(view4, left4, collapsingMargins, alignmentHeight);
            }
        }
        if (shouldLayout(this.mLogoView)) {
            View view5 = this.mLogoView;
            if (isRtl2) {
                right2 = layoutChildRight(view5, right2, collapsingMargins, alignmentHeight);
            } else {
                left4 = layoutChildLeft(view5, left4, collapsingMargins, alignmentHeight);
            }
        }
        boolean layoutTitle = shouldLayout(this.mTitleTextView);
        boolean layoutSubtitle2 = shouldLayout(this.mSubtitleTextView);
        int titleHeight = 0;
        if (!layoutTitle) {
            isRtl = isRtl2;
            layoutSubtitle = layoutSubtitle2;
        } else {
            isRtl = isRtl2;
        ...
        if (layoutTitle || layoutSubtitle) {
            ...
            if (layoutTitle) {
                ...
                if (this.mTitleTextView.getMeasuredWidth() > 0) {
                    titleHasWidth = true;
                    boolean titleHasWidth2 = titleHasWidth;
                    switch (this.mGravity & 112) {
                        case 48:
                            spaceAbove = getPaddingTop() + toplp.topMargin + this.mTitleMarginTop;
                            width = width2;
                            break;
                        case GrpcUtil.DEFAULT_PORT_PLAINTEXT /* 80 */:
                            int spaceAbove2 = height - paddingBottom;
                            spaceAbove = ((spaceAbove2 - bottomlp.bottomMargin) - this.mTitleMarginBottom) - titleHeight;
                            width = width2;
                            break;
                        default:
                            int space = (((height - paddingTop) - paddingBottom) - titleHeight) / 2;
                            width = width2;
                            if (space < toplp.topMargin + this.mTitleMarginTop) {
                                int i = toplp.topMargin;
                                int spaceAbove3 = this.mTitleMarginTop;
                                spaceBelow = spaceAbove3 + i;
                            } else {
                                int spaceAbove4 = height - paddingBottom;
                                int spaceBelow2 = ((spaceAbove4 - titleHeight) - space) - paddingTop;
                                if (spaceBelow2 < toplp.bottomMargin + this.mTitleMarginBottom) {
                                    spaceBelow = Math.max(0, space - ((bottomlp.bottomMargin + this.mTitleMarginBottom) - spaceBelow2));
                                } else {
                                    spaceBelow = space;
                                }
                            }
                            spaceAbove = paddingTop + spaceBelow;
                            break;
                    }
                    if (isRtl) {
                        paddingLeft = paddingLeft2;
                        paddingRight = paddingRight2;
                        int ld = (titleHasWidth2 ? this.mTitleMarginStart : 0) - collapsingMargins[0];
                        ...
                        if (!layoutTitle) {
                            ...
                            left2 = left5;
                            int titleBottom = this.mTitleTextView.getMeasuredHeight() + spaceAbove;
                            this.mTitleTextView.layout(titleLeft, spaceAbove, titleRight, titleBottom);
                            titleLeft = titleRight + this.mTitleMarginEnd;
                            spaceAbove = titleBottom + lp3.bottomMargin;
                        }
                        if (layoutSubtitle) {
                            LayoutParams lp4 = (LayoutParams) this.mSubtitleTextView.getLayoutParams();
                            int titleTop = spaceAbove + lp4.topMargin;
                            ...
                            int titleTop2 = subtitleBottom + lp4.bottomMargin;
                        }
                        if (!titleHasWidth2) {
                            left4 = left2;
                        } else {
                            left4 = Math.max(titleLeft, subtitleLeft);
                        }
                    } else {
                        int rd = (titleHasWidth2 ? this.mTitleMarginStart : 0) - collapsingMargins[1];
                        ...
                        if (layoutTitle) {
                            ...
                            paddingLeft = paddingLeft2;
                            int titleBottom2 = this.mTitleTextView.getMeasuredHeight() + spaceAbove;
                            paddingRight = paddingRight2;
                            this.mTitleTextView.layout(titleLeft2, spaceAbove, titleRight2, titleBottom2);
                            titleRight2 = titleLeft2 - this.mTitleMarginEnd;
                            spaceAbove = titleBottom2 + lp5.bottomMargin;
                        } else {
                            paddingLeft = paddingLeft2;
                            paddingRight = paddingRight2;
                        }
                        if (layoutSubtitle) {
                            ...
                            int titleTop3 = spaceAbove + lp6.topMargin;
                            int subtitleLeft2 = subtitleRight2 - this.mSubtitleTextView.getMeasuredWidth();
                            ...
                            int titleTop4 = subtitleBottom2 + lp6.bottomMargin;
                        }
                        if (titleHasWidth2) {
            ...
            boolean titleHasWidth22 = titleHasWidth;
            switch (this.mGravity & 112) {
                case 48:
                    break;
                case GrpcUtil.DEFAULT_PORT_PLAINTEXT /* 80 */:
        ...
        while (true) {
            ...
            if (i2 < leftViewsCount) {
                left4 = layoutChildLeft(arrayList.get(i2), left4, collapsingMargins, alignmentHeight);
                i2++;
            } else {
                ...
                while (true) {
                    ...
                    if (i3 < rightViewsCount) {
                        right2 = layoutChildRight(arrayList2.get(i3), right2, collapsingMargins, alignmentHeight);
                        i3++;
                    } else {
                        ...
                        int leftViewsCount2 = centerLeft + centerViewsWidth;
                        if (centerLeft < left4) {
                            centerLeft = left4;
                        } else if (leftViewsCount2 > right2) {
                            centerLeft -= leftViewsCount2 - right2;
                        }
                        int centerViewsCount = this.mTempViews.size();
                        int rightViewsCount2 = 0;
                        while (true) {
                            int left6 = left4;
                            ArrayList<View> arrayList3 = this.mTempViews;
                            if (rightViewsCount2 < centerViewsCount) {
                                centerLeft = layoutChildLeft(arrayList3.get(rightViewsCount2), centerLeft, collapsingMargins, alignmentHeight);
                                rightViewsCount2++;
                                left4 = left6;
                            } else {
                                arrayList3.clear();
