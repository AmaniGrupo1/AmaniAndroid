...
public class MenuBuilder implements SupportMenu {
    ...
    */
    private void setShortcutsVisibleInner(boolean shortcutsVisible) {
        boolean z;
        if (shortcutsVisible) {
            z = this.mResources.getConfiguration().keyboard != 1 && ViewConfigurationCompat.shouldShowMenuShortcutsWhenKeyboardPresent(ViewConfiguration.get(this.mContext), this.mContext);
        }
