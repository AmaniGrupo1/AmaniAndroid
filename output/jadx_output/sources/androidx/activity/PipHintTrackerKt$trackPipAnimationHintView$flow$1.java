...
final class PipHintTrackerKt$trackPipAnimationHintView$flow$1 extends SuspendLambda implements Function2<ProducerScope<? super Rect>, Continuation<? super Unit>, Object> {
            ...
            case 0:
                ...
                final ViewTreeObserver.OnScrollChangedListener scrollChangeListener = new ViewTreeObserver.OnScrollChangedListener() { // from class: androidx.activity.PipHintTrackerKt$trackPipAnimationHintView$flow$1$$ExternalSyntheticLambda1
                    ...
                    public final void onScrollChanged() {
                        $this$callbackFlow.mo10050trySendJP2dKIU(PipHintTrackerKt.trackPipAnimationHintView$positionInWindow(view));
                    }
                };
                ...
                final ?? r3 = new View.OnAttachStateChangeListener() { // from class: androidx.activity.PipHintTrackerKt$trackPipAnimationHintView$flow$1$attachStateChangeListener$1
                    ...
                    public void onViewAttachedToWindow(View v) {
                        ...
                        $this$callbackFlow.mo10050trySendJP2dKIU(PipHintTrackerKt.trackPipAnimationHintView$positionInWindow(view2));
                ...
                if (this.$view.isAttachedToWindow()) {
                    $this$callbackFlow.mo10050trySendJP2dKIU(PipHintTrackerKt.trackPipAnimationHintView$positionInWindow(this.$view));
    ...
    static final void invokeSuspend$lambda$0(ProducerScope $$this$callbackFlow, View v, int l, int t, int r, int b, int oldLeft, int oldTop, int oldRight, int oldBottom) {
        if (l != oldLeft || r != oldRight || t != oldTop || b != oldBottom) {
            ...
            $$this$callbackFlow.mo10050trySendJP2dKIU(PipHintTrackerKt.trackPipAnimationHintView$positionInWindow(v));
        }
    }

    static final Unit invokeSuspend$lambda$2(View $view, ViewTreeObserver.OnScrollChangedListener $scrollChangeListener, View.OnLayoutChangeListener $layoutChangeListener, PipHintTrackerKt$trackPipAnimationHintView$flow$1$attachStateChangeListener$1 $attachStateChangeListener) {
