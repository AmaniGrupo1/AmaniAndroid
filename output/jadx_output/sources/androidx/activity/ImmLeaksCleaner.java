...
public final class ImmLeaksCleaner implements LifecycleEventObserver {
    ...
    public void onStateChanged(LifecycleOwner source, Lifecycle.Event event) {
        ...
        Cleaner $this$onStateChanged_u24lambda_u240 = INSTANCE.getCleaner();
        Object lock = $this$onStateChanged_u24lambda_u240.getLock(inputMethodManager);
        if (lock == null) {
            return;
        }
        synchronized (lock) {
            View servedView = $this$onStateChanged_u24lambda_u240.getServedView(inputMethodManager);
            if (servedView != null && !servedView.isAttachedToWindow()) {
                boolean success = $this$onStateChanged_u24lambda_u240.clearNextServedView(inputMethodManager);
                if (success) {
    ...
    /* JADX INFO: compiled from: ImmLeaksCleaner.kt */
    @Metadata(d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0005\b\u0087\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003R\u001b\u0010\u0004\u001a\u00020\u00058FX\u0086\u0084\u0002¢\u0006\f\n\u0004\b\b\u0010\t\u001a\u0004\b\u0006\u0010\u0007¨\u0006\n"}, d2 = {"Landroidx/activity/ImmLeaksCleaner$Companion;", "", "<init>", "()V", "cleaner", "Landroidx/activity/ImmLeaksCleaner$Cleaner;", "getCleaner", "()Landroidx/activity/ImmLeaksCleaner$Cleaner;", "cleaner$delegate", "Lkotlin/Lazy;", "activity"}, k = 1, mv = {2, 0, 0}, xi = 48)
