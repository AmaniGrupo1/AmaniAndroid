...
public final class LocalOnBackPressedDispatcherOwner {
    ...
    public final OnBackPressedDispatcherOwner getCurrent(Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-2068013981, $changed, -1, "androidx.activity.compose.LocalOnBackPressedDispatcherOwner.<get-current> (BackHandler.kt:59)");
        }
