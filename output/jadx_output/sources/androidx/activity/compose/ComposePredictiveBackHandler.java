...
final class ComposePredictiveBackHandler extends BackHandlerCompat {
    ...
    public ComposePredictiveBackHandler(CoroutineScope scope, PredictiveBackHandlerInfo info) {
        super(info);
        this.scope = scope;
            ...
            switch (this.label) {
                case 0:
                    ...
                    if (ComposePredictiveBackHandler.this.isBackEnabled()) {
                        ...
                        Flow<BackEventCompat> flowOnCompletion = FlowKt.onCompletion(FlowKt.consumeAsFlow(channel), new C00001(completed2, null));
                        this.L$0 = completed2;
                        this.label = 1;
    ...
    public void onBackProgressed(BackEventCompat event) {
        ...
        if (channel != null) {
            ChannelResult.m10064boximpl(channel.mo10050trySendJP2dKIU(event));
        }
    }
