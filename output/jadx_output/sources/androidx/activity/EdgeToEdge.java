...
public final class EdgeToEdge {
    ...
    public static final void enable(ComponentActivity $this$enableEdgeToEdge, SystemBarStyle statusBarStyle, SystemBarStyle navigationBarStyle) {
        EdgeToEdgeImpl impl;
        EdgeToEdgeBase edgeToEdgeApi23;
        ...
        boolean statusBarIsDark = detectDarkMode$activity.invoke(resources).booleanValue();
        Function1<Resources, Boolean> detectDarkMode$activity2 = navigationBarStyle.getDetectDarkMode$activity();
        Resources resources2 = view.getResources();
        Intrinsics.checkNotNullExpressionValue(resources2, "getResources(...)");
        boolean navigationBarIsDark = detectDarkMode$activity2.invoke(resources2).booleanValue();
        ...
        if (edgeToEdgeImpl != null) {
            ...
            EdgeToEdgeBase it = edgeToEdgeApi23;
            Impl = it;
