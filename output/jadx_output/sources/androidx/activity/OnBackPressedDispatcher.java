...
public final class OnBackPressedDispatcher {
    ...
    static final OnBackPressedEventInput eventInput_delegate$lambda$0(OnBackPressedDispatcher this$0) {
        return this$0.new OnBackPressedEventInput();
    }
    ...
    public final void addCallback(LifecycleOwner owner, OnBackPressedCallback onBackPressedCallback) {
        ...
        Intrinsics.checkNotNullParameter(onBackPressedCallback, "onBackPressedCallback");
        Lifecycle lifecycle = owner.getLifecycleRegistry();
        if (lifecycle.getState() == Lifecycle.State.DESTROYED) {
            return;
        }
        OnBackPressedCallbackInfo info = new OnBackPressedCallbackInfo(onBackPressedCallback, owner);
        OnBackPressedCallback.OnBackPressedEventHandler eventHandler = onBackPressedCallback.createNavigationEventHandler$activity(info);
        if (ActivityFlags.isOnBackPressedLifecycleOrderMaintained) {
            eventHandler.setLifecycleActive(false);
            NavigationEventDispatcher.addHandler$default(getEventDispatcher$activity(), eventHandler, 0, 2, null);
        }
        OnBackPressedDispatcher$addCallback$lifecycleObserver$1 lifecycleObserver = new OnBackPressedDispatcher$addCallback$lifecycleObserver$1(eventHandler, this, lifecycle);
    ...
    final class OnBackPressedEventInput extends NavigationEventInput {
        ...
        public OnBackPressedEventInput() {
            ...
            NavigationEventDispatcher it = new NavigationEventDispatcher(new OnBackCompletedFallback() { // from class: androidx.activity.OnBackPressedDispatcher$OnBackPressedEventInput$$ExternalSyntheticLambda0
        ...
        static final void dispatcher$lambda$0(OnBackPressedDispatcher this$0) {
