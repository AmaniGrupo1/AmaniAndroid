...
final class ListItemType implements Comparable<ListItemType> {
    ...
    private static final int OneLine = m2489constructorimpl(1);
    private static final int TwoLine = m2489constructorimpl(2);
    private static final int ThreeLine = m2489constructorimpl(3);

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ ListItemType m2487boximpl(int i) {
        return new ListItemType(i);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    private static int m2489constructorimpl(int i) {
        return i;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m2490equalsimpl(int i, Object obj) {
        return (obj instanceof ListItemType) && i == ((ListItemType) obj).getLines();
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m2491equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
    public static int m2492hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m2493toStringimpl(int i) {
        return "ListItemType(lines=" + i + ')';
    }

    public boolean equals(Object obj) {
        return m2490equalsimpl(this.lines, obj);
    }

    public int hashCode() {
        return m2492hashCodeimpl(this.lines);
    }

    public String toString() {
        return m2493toStringimpl(this.lines);
    }
    ...
    public /* bridge */ /* synthetic */ int compareTo(ListItemType listItemType) {
        return m2494compareToyh95HIg(listItemType.getLines());
    }
    ...
    public static int m2488compareToyh95HIg(int arg0, int other) {
        return Intrinsics.compare(arg0, other);
    }

    /* JADX INFO: renamed from: compareTo-yh95HIg, reason: not valid java name */
    public int m2494compareToyh95HIg(int other) {
        return m2488compareToyh95HIg(this.lines, other);
    }
