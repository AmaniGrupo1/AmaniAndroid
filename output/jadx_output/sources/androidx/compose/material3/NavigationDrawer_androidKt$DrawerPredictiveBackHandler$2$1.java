    ...
    public final Object invokeSuspend(Object $result) throws Throwable {
        ...
        try {
            try {
                ...
                swipeEdgeMatchesDrawer.$drawerPredictiveBackState.clear();
                if (swipeEdgeMatchesDrawer.$drawerPredictiveBackState.getSwipeEdgeMatchesDrawer()) {
                    BuildersKt__Builders_commonKt.launch$default(swipeEdgeMatchesDrawer.$scope, null, null, new AnonymousClass2(swipeEdgeMatchesDrawer.$drawerPredictiveBackState, null), 3, null);
                }
                swipeEdgeMatchesDrawer.label = 3;
                if (swipeEdgeMatchesDrawer.$drawerState.close((Continuation) swipeEdgeMatchesDrawer) == coroutine_suspended) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    this.label = 1;
                    if (progress.collect(new FlowCollector() { // from class: androidx.compose.material3.NavigationDrawer_androidKt$DrawerPredictiveBackHandler$2$1.1
                        ...
                        public final Object emit(BackEventCompat backEvent, Continuation<? super Unit> continuation) {
                            drawerPredictiveBackState.update(PredictiveBack.INSTANCE.transform$material3_release(backEvent.getProgress()), backEvent.getSwipeEdge() == 0, z, floatRef.element, floatRef2.element, floatRef3.element);
                            return Unit.INSTANCE;
                        }
                    }, this) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    navigationDrawer_androidKt$DrawerPredictiveBackHandler$2$1 = this;
                    swipeEdgeMatchesDrawer = navigationDrawer_androidKt$DrawerPredictiveBackHandler$2$1.$drawerPredictiveBackState.getSwipeEdgeMatchesDrawer();
                    if (swipeEdgeMatchesDrawer != 0) {
                        BuildersKt__Builders_commonKt.launch$default(navigationDrawer_androidKt$DrawerPredictiveBackHandler$2$1.$scope, null, null, new AnonymousClass2(navigationDrawer_androidKt$DrawerPredictiveBackHandler$2$1.$drawerPredictiveBackState, null), 3, null);
                    }
                    navigationDrawer_androidKt$DrawerPredictiveBackHandler$2$1.label = 2;
                    if (navigationDrawer_androidKt$DrawerPredictiveBackHandler$2$1.$drawerState.close(navigationDrawer_androidKt$DrawerPredictiveBackHandler$2$1) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    return Unit.INSTANCE;
                case 1:
            ...
            swipeEdgeMatchesDrawer.L$0 = th2;
            swipeEdgeMatchesDrawer.label = 4;
            if (swipeEdgeMatchesDrawer.$drawerState.close((Continuation) swipeEdgeMatchesDrawer) == coroutine_suspended) {
                return coroutine_suspended;
            }
            throw th2;
