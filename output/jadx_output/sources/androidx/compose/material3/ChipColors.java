...
public final class ChipColors {
    ...
    public static /* synthetic */ ChipColors m2137copyFD3wquc$default(ChipColors chipColors, long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, int i, Object obj) {
        long j9;
        long j10;
        ...
        return chipColors.m2139copyFD3wquc(j9, j12, j13, j14, j15, j16, j17, j10);
    }

    /* JADX INFO: renamed from: copy-FD3wquc, reason: not valid java name */
    public final ChipColors m2139copyFD3wquc(long containerColor, long labelColor, long leadingIconContentColor, long trailingIconContentColor, long disabledContainerColor, long disabledLabelColor, long disabledLeadingIconContentColor, long disabledTrailingIconContentColor) {
    ...
    public final long m2138containerColorvNxB06k$material3_release(boolean enabled) {
    ...
    public final long m2148labelColorvNxB06k$material3_release(boolean enabled) {
    ...
    public final long m2149leadingIconContentColorvNxB06k$material3_release(boolean enabled) {
    ...
    public final long m2150trailingIconContentColorvNxB06k$material3_release(boolean enabled) {
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof ChipColors) && Color.m4698equalsimpl0(this.containerColor, ((ChipColors) other).containerColor) && Color.m4698equalsimpl0(this.labelColor, ((ChipColors) other).labelColor) && Color.m4698equalsimpl0(this.leadingIconContentColor, ((ChipColors) other).leadingIconContentColor) && Color.m4698equalsimpl0(this.trailingIconContentColor, ((ChipColors) other).trailingIconContentColor) && Color.m4698equalsimpl0(this.disabledContainerColor, ((ChipColors) other).disabledContainerColor) && Color.m4698equalsimpl0(this.disabledLabelColor, ((ChipColors) other).disabledLabelColor) && Color.m4698equalsimpl0(this.disabledLeadingIconContentColor, ((ChipColors) other).disabledLeadingIconContentColor) && Color.m4698equalsimpl0(this.disabledTrailingIconContentColor, ((ChipColors) other).disabledTrailingIconContentColor)) {
            return true;
        }
        return false;
    }
