...
final class ScrollableTabData {
    ...
    private final int calculateTabOffset(TabPosition $this$calculateTabOffset, Density density, int edgeOffset, List<TabPosition> list) {
        int totalTabRowWidth = density.mo399roundToPx0680j_4(((TabPosition) CollectionsKt.last((List) list)).m2867getRightD9Ej5fM()) + edgeOffset;
        int visibleWidth = totalTabRowWidth - this.scrollState.getMaxValue();
        int tabOffset = density.mo399roundToPx0680j_4($this$calculateTabOffset.getLeft());
        int scrollerCenter = visibleWidth / 2;
        int tabWidth = density.mo399roundToPx0680j_4($this$calculateTabOffset.getWidth());
