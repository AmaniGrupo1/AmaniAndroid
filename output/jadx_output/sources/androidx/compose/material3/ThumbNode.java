...
final class ThumbNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo69measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        float thumbDiameter;
        final float offset;
        boolean hasContent = (measurable.maxIntrinsicHeight(Constraints.m7458getMaxWidthimpl(constraints)) == 0 || measurable.maxIntrinsicWidth(Constraints.m7457getMaxHeightimpl(constraints)) == 0) ? false : true;
        if (this.isPressed) {
            thumbDiameter = SwitchTokens.INSTANCE.m3801getPressedHandleWidthD9Ej5fM();
        } else if (hasContent || this.checked) {
            thumbDiameter = SwitchKt.getThumbDiameter();
        } else {
            thumbDiameter = SwitchKt.getUncheckedThumbDiameter();
        }
        float size = $this$measure_u2d3p2s80s.mo405toPx0680j_4(thumbDiameter);
        ...
        final Placeable placeable = measurable.mo6141measureBRTryo0(Constraints.INSTANCE.m7468fixedJhjzzOo(actualSize, actualSize));
        float arg0$iv = SwitchKt.SwitchHeight;
        float other$iv = $this$measure_u2d3p2s80s.mo401toDpu2uoSUM(size);
        float minBound = $this$measure_u2d3p2s80s.mo405toPx0680j_4(Dp.m7505constructorimpl(Dp.m7505constructorimpl(arg0$iv - other$iv) / 2.0f));
        float arg0$iv2 = SwitchKt.SwitchWidth;
        float other$iv2 = SwitchKt.getThumbDiameter();
        float arg0$iv3 = Dp.m7505constructorimpl(arg0$iv2 - other$iv2);
        float other$iv3 = SwitchKt.ThumbPadding;
        float maxBound = $this$measure_u2d3p2s80s.mo405toPx0680j_4(Dp.m7505constructorimpl(arg0$iv3 - other$iv3));
        if (this.isPressed && this.checked) {
            offset = maxBound - $this$measure_u2d3p2s80s.mo405toPx0680j_4(SwitchTokens.INSTANCE.m3807getTrackOutlineWidthD9Ej5fM());
        } else if (!this.isPressed || this.checked) {
            offset = this.checked ? maxBound : minBound;
        } else {
            offset = $this$measure_u2d3p2s80s.mo405toPx0680j_4(SwitchTokens.INSTANCE.m3807getTrackOutlineWidthD9Ej5fM());
        }
