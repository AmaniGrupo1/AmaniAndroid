...
public final class NavigationRailItemDefaults {
    ...
    public final NavigationRailItemColors m2616colors69fazGs(long selectedIconColor, long selectedTextColor, long indicatorColor, long unselectedIconColor, long unselectedTextColor, long disabledIconColor, long disabledTextColor, Composer $composer, int $changed, int i) {
        ...
        if ((i & 32) != 0) {
            ...
            disabledIconColor2 = Color.m4695copywmQWz5c(unselectedIconColor3, (14 & 1) != 0 ? Color.m4699getAlphaimpl(unselectedIconColor3) : 0.38f, (14 & 2) != 0 ? Color.m4703getRedimpl(unselectedIconColor3) : 0.0f, (14 & 4) != 0 ? Color.m4702getGreenimpl(unselectedIconColor3) : 0.0f, (14 & 8) != 0 ? Color.m4700getBlueimpl(unselectedIconColor3) : 0.0f);
        } else {
            disabledIconColor2 = disabledIconColor;
        }
        if ((i & 64) != 0) {
            long unselectedTextColor3 = unselectedTextColor2;
            disabledTextColor2 = Color.m4695copywmQWz5c(unselectedTextColor3, (14 & 1) != 0 ? Color.m4699getAlphaimpl(unselectedTextColor3) : 0.38f, (14 & 2) != 0 ? Color.m4703getRedimpl(unselectedTextColor3) : 0.0f, (14 & 4) != 0 ? Color.m4702getGreenimpl(unselectedTextColor3) : 0.0f, (14 & 8) != 0 ? Color.m4700getBlueimpl(unselectedTextColor3) : 0.0f);
        } else {
        ...
        NavigationRailItemColors navigationRailItemColorsM2605copy4JmcsL4 = getDefaultNavigationRailItemColors$material3_release(MaterialTheme.INSTANCE.getColorScheme($composer, 6)).m2605copy4JmcsL4(selectedIconColor2, selectedTextColor2, indicatorColor2, unselectedIconColor2, unselectedTextColor2, disabledIconColor2, disabledTextColor2);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd($composer);
        return navigationRailItemColorsM2605copy4JmcsL4;
    }
    ...
    public final NavigationRailItemColors getDefaultNavigationRailItemColors$material3_release(ColorScheme $this$defaultNavigationRailItemColors) {
        ...
        if (it == null) {
            ...
            NavigationRailItemColors it2 = new NavigationRailItemColors(jFromToken, jFromToken2, jFromToken3, jFromToken4, jFromToken5, jM4695copywmQWz5c, Color.m4695copywmQWz5c(jFromToken7, (14 & 1) != 0 ? Color.m4699getAlphaimpl(jFromToken7) : 0.38f, (14 & 2) != 0 ? Color.m4703getRedimpl(jFromToken7) : 0.0f, (14 & 4) != 0 ? Color.m4702getGreenimpl(jFromToken7) : 0.0f, (14 & 8) != 0 ? Color.m4700getBlueimpl(jFromToken7) : 0.0f), null);
    ...
    public final /* synthetic */ NavigationRailItemColors m2617colorszjMxDiM(long selectedIconColor, long selectedTextColor, long indicatorColor, long unselectedIconColor, long unselectedTextColor, Composer $composer, int $changed, int i) {
        ...
        long unselectedTextColor3 = unselectedTextColor2;
        NavigationRailItemColors navigationRailItemColors = new NavigationRailItemColors(selectedIconColor2, selectedTextColor2, indicatorColor2, unselectedIconColor2, unselectedTextColor2, jM4695copywmQWz5c, Color.m4695copywmQWz5c(unselectedTextColor3, (14 & 1) != 0 ? Color.m4699getAlphaimpl(unselectedTextColor3) : 0.38f, (14 & 2) != 0 ? Color.m4703getRedimpl(unselectedTextColor3) : 0.0f, (14 & 4) != 0 ? Color.m4702getGreenimpl(unselectedTextColor3) : 0.0f, (14 & 8) != 0 ? Color.m4700getBlueimpl(unselectedTextColor3) : 0.0f), null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd($composer);
