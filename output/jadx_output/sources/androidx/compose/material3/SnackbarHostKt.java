...
public final class SnackbarHostKt {
    ...
    public static final void SnackbarHost(SnackbarHostState hostState, Modifier modifier, Function3<? super SnackbarData, ? super Composer, ? super Integer, Unit> function3, Composer $composer, final int $changed, final int i) {
        ...
        Modifier modifier2;
        Function3<? super SnackbarData, ? super Composer, ? super Integer, Unit> function3M2264getLambda1$material3_release;
        ...
        if (i3 != 0) {
            ...
            function3M2264getLambda1$material3_release = function3;
        } else if (($changed & RendererCapabilities.DECODER_SUPPORT_MASK) == 0) {
            function3M2264getLambda1$material3_release = function3;
            $dirty |= $composer2.changedInstance(function3M2264getLambda1$material3_release) ? 256 : 128;
        } else {
            function3M2264getLambda1$material3_release = function3;
        }
        int $dirty2 = $dirty;
        if (($dirty2 & 147) == 146 && $composer2.getSkipping()) {
            ...
            function32 = function3M2264getLambda1$material3_release;
        } else {
            Modifier.Companion modifier3 = i2 != 0 ? Modifier.INSTANCE : modifier2;
            if (i3 != 0) {
                function3M2264getLambda1$material3_release = ComposableSingletons$SnackbarHostKt.INSTANCE.m2264getLambda1$material3_release();
            }
            ...
            FadeInFadeOutWithScale(snackbarHostState.getCurrentSnackbarData(), modifier4, function3M2264getLambda1$material3_release, $composer2, ($dirty2 & 896) | ($dirty2 & 112), 0);
            if (ComposerKt.isTraceInProgress()) {
