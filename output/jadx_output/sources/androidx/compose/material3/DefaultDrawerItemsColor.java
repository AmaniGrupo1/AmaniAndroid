...
final class DefaultDrawerItemsColor implements NavigationDrawerItemColors {
    ...
    public State<Color> iconColor(boolean selected, Composer $composer, int $changed) {
        ...
        State<Color> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m4687boximpl(selected ? this.selectedIconColor : this.unselectedIconColor), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public State<Color> textColor(boolean selected, Composer $composer, int $changed) {
        ...
        State<Color> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m4687boximpl(selected ? this.selectedTextColor : this.unselectedTextColor), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceGroup();
    ...
    public State<Color> containerColor(boolean selected, Composer $composer, int $changed) {
        ...
        State<Color> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m4687boximpl(selected ? this.selectedContainerColor : this.unselectedContainerColor), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceGroup();
    ...
    public State<Color> badgeColor(boolean selected, Composer $composer, int $changed) {
        ...
        State<Color> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m4687boximpl(selected ? this.selectedBadgeColor : this.unselectedBadgeColor), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceGroup();
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DefaultDrawerItemsColor) && Color.m4698equalsimpl0(this.selectedIconColor, ((DefaultDrawerItemsColor) other).selectedIconColor) && Color.m4698equalsimpl0(this.unselectedIconColor, ((DefaultDrawerItemsColor) other).unselectedIconColor) && Color.m4698equalsimpl0(this.selectedTextColor, ((DefaultDrawerItemsColor) other).selectedTextColor) && Color.m4698equalsimpl0(this.unselectedTextColor, ((DefaultDrawerItemsColor) other).unselectedTextColor) && Color.m4698equalsimpl0(this.selectedContainerColor, ((DefaultDrawerItemsColor) other).selectedContainerColor) && Color.m4698equalsimpl0(this.unselectedContainerColor, ((DefaultDrawerItemsColor) other).unselectedContainerColor) && Color.m4698equalsimpl0(this.selectedBadgeColor, ((DefaultDrawerItemsColor) other).selectedBadgeColor)) {
            return Color.m4698equalsimpl0(this.unselectedBadgeColor, ((DefaultDrawerItemsColor) other).unselectedBadgeColor);
        }
        return false;
    }

    public int hashCode() {
        int result = Color.m4704hashCodeimpl(this.selectedIconColor);
        return (((((((((((((result * 31) + Color.m4704hashCodeimpl(this.unselectedIconColor)) * 31) + Color.m4704hashCodeimpl(this.selectedTextColor)) * 31) + Color.m4704hashCodeimpl(this.unselectedTextColor)) * 31) + Color.m4704hashCodeimpl(this.selectedContainerColor)) * 31) + Color.m4704hashCodeimpl(this.unselectedContainerColor)) * 31) + Color.m4704hashCodeimpl(this.selectedBadgeColor)) * 31) + Color.m4704hashCodeimpl(this.unselectedBadgeColor);
    }
}
