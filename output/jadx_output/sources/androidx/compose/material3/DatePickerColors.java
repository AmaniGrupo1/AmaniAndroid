...
public final class DatePickerColors {
    ...
    public static /* synthetic */ DatePickerColors m2278copytNwlRmA$default(DatePickerColors datePickerColors, long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, long j9, long j10, long j11, long j12, long j13, long j14, long j15, long j16, long j17, long j18, long j19, long j20, long j21, long j22, long j23, long j24, TextFieldColors textFieldColors, int i, Object obj) {
        long j25;
        long j26;
        long j27;
        long j28;
        ...
        return datePickerColors.m2279copytNwlRmA(j50, j44, j45, j46, j47, j48, j49, j51, j52, j53, j54, j55, j56, j57, j25, j27, j29, j31, j33, j35, j37, j39, j41, j42, (i & 16777216) != 0 ? datePickerColors.dateTextFieldColors : textFieldColors);
    }

    /* JADX INFO: renamed from: copy-tNwlRmA, reason: not valid java name */
    public final DatePickerColors m2279copytNwlRmA(long containerColor, long titleContentColor, long headlineContentColor, long weekdayContentColor, long subheadContentColor, long navigationContentColor, long yearContentColor, long disabledYearContentColor, long currentYearContentColor, long selectedYearContentColor, long disabledSelectedYearContentColor, long selectedYearContainerColor, long disabledSelectedYearContainerColor, long dayContentColor, long disabledDayContentColor, long selectedDayContentColor, long disabledSelectedDayContentColor, long selectedDayContainerColor, long disabledSelectedDayContainerColor, long todayContentColor, long todayDateBorderColor, long dayInSelectionRangeContainerColor, long dayInSelectionRangeContentColor, long dividerColor, TextFieldColors dateTextFieldColors) {
        long j;
    ...
    public final State<Color> dayContentColor$material3_release(boolean isToday, boolean selected, boolean inRange, boolean enabled, Composer $composer, int $changed) {
        State<Color> stateM134animateColorAsStateeuL9pac;
        ...
        if (inRange) {
            ...
            stateM134animateColorAsStateeuL9pac = SnapshotStateKt.rememberUpdatedState(Color.m4687boximpl(target), $composer, 0);
            $composer.endReplaceGroup();
        } else {
            $composer.startReplaceGroup(-828426947);
            ComposerKt.sourceInformation($composer, "913@44523L88");
            stateM134animateColorAsStateeuL9pac = SingleValueAnimationKt.m134animateColorAsStateeuL9pac(target, AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, $composer, 0, 12);
            $composer.endReplaceGroup();
        }
        if (ComposerKt.isTraceInProgress()) {
        ...
        return stateM134animateColorAsStateeuL9pac;
    }
    ...
    public final State<Color> dayContainerColor$material3_release(boolean selected, boolean enabled, boolean animate, Composer $composer, int $changed) {
        ...
        long target = selected ? enabled ? this.selectedDayContainerColor : this.disabledSelectedDayContainerColor : Color.INSTANCE.m4732getTransparent0d7_KjU();
        if (animate) {
            $composer.startReplaceGroup(-217548653);
            ComposerKt.sourceInformation($composer, "937@45329L88");
            $composer2 = $composer;
            stateRememberUpdatedState = SingleValueAnimationKt.m134animateColorAsStateeuL9pac(target, AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, $composer2, 0, 12);
            $composer2.endReplaceGroup();
        } else {
            $composer2 = $composer;
            $composer2.startReplaceGroup(-217433457);
            ComposerKt.sourceInformation($composer2, "939@45447L28");
            stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m4687boximpl(target), $composer2, 0);
            $composer2.endReplaceGroup();
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
    ...
    public final State<Color> yearContentColor$material3_release(boolean currentYear, boolean selected, boolean enabled, Composer $composer, int $changed) {
        ...
        long target = j;
        State<Color> stateM134animateColorAsStateeuL9pac = SingleValueAnimationKt.m134animateColorAsStateeuL9pac(target, AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, $composer, 0, 12);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd($composer);
    ...
    public final State<Color> yearContainerColor$material3_release(boolean selected, boolean enabled, Composer $composer, int $changed) {
        ...
        if (selected) {
            jM4732getTransparent0d7_KjU = enabled ? this.selectedYearContainerColor : this.disabledSelectedYearContainerColor;
        } else {
            jM4732getTransparent0d7_KjU = Color.INSTANCE.m4732getTransparent0d7_KjU();
        }
        long target = jM4732getTransparent0d7_KjU;
        State<Color> stateM134animateColorAsStateeuL9pac = SingleValueAnimationKt.m134animateColorAsStateeuL9pac(target, AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, $composer, 0, 12);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
    ...
    public boolean equals(Object other) {
        return (other instanceof DatePickerColors) && Color.m4698equalsimpl0(this.containerColor, ((DatePickerColors) other).containerColor) && Color.m4698equalsimpl0(this.titleContentColor, ((DatePickerColors) other).titleContentColor) && Color.m4698equalsimpl0(this.headlineContentColor, ((DatePickerColors) other).headlineContentColor) && Color.m4698equalsimpl0(this.weekdayContentColor, ((DatePickerColors) other).weekdayContentColor) && Color.m4698equalsimpl0(this.subheadContentColor, ((DatePickerColors) other).subheadContentColor) && Color.m4698equalsimpl0(this.yearContentColor, ((DatePickerColors) other).yearContentColor) && Color.m4698equalsimpl0(this.disabledYearContentColor, ((DatePickerColors) other).disabledYearContentColor) && Color.m4698equalsimpl0(this.currentYearContentColor, ((DatePickerColors) other).currentYearContentColor) && Color.m4698equalsimpl0(this.selectedYearContentColor, ((DatePickerColors) other).selectedYearContentColor) && Color.m4698equalsimpl0(this.disabledSelectedYearContentColor, ((DatePickerColors) other).disabledSelectedYearContentColor) && Color.m4698equalsimpl0(this.selectedYearContainerColor, ((DatePickerColors) other).selectedYearContainerColor) && Color.m4698equalsimpl0(this.disabledSelectedYearContainerColor, ((DatePickerColors) other).disabledSelectedYearContainerColor) && Color.m4698equalsimpl0(this.dayContentColor, ((DatePickerColors) other).dayContentColor) && Color.m4698equalsimpl0(this.disabledDayContentColor, ((DatePickerColors) other).disabledDayContentColor) && Color.m4698equalsimpl0(this.selectedDayContentColor, ((DatePickerColors) other).selectedDayContentColor) && Color.m4698equalsimpl0(this.disabledSelectedDayContentColor, ((DatePickerColors) other).disabledSelectedDayContentColor) && Color.m4698equalsimpl0(this.selectedDayContainerColor, ((DatePickerColors) other).selectedDayContainerColor) && Color.m4698equalsimpl0(this.disabledSelectedDayContainerColor, ((DatePickerColors) other).disabledSelectedDayContainerColor) && Color.m4698equalsimpl0(this.todayContentColor, ((DatePickerColors) other).todayContentColor) && Color.m4698equalsimpl0(this.todayDateBorderColor, ((DatePickerColors) other).todayDateBorderColor) && Color.m4698equalsimpl0(this.dayInSelectionRangeContainerColor, ((DatePickerColors) other).dayInSelectionRangeContainerColor) && Color.m4698equalsimpl0(this.dayInSelectionRangeContentColor, ((DatePickerColors) other).dayInSelectionRangeContentColor);
    }

    public int hashCode() {
        int result = Color.m4704hashCodeimpl(this.containerColor);
        return (((((((((((((((((((((((((((((((((((((((((result * 31) + Color.m4704hashCodeimpl(this.titleContentColor)) * 31) + Color.m4704hashCodeimpl(this.headlineContentColor)) * 31) + Color.m4704hashCodeimpl(this.weekdayContentColor)) * 31) + Color.m4704hashCodeimpl(this.subheadContentColor)) * 31) + Color.m4704hashCodeimpl(this.yearContentColor)) * 31) + Color.m4704hashCodeimpl(this.disabledYearContentColor)) * 31) + Color.m4704hashCodeimpl(this.currentYearContentColor)) * 31) + Color.m4704hashCodeimpl(this.selectedYearContentColor)) * 31) + Color.m4704hashCodeimpl(this.disabledSelectedYearContentColor)) * 31) + Color.m4704hashCodeimpl(this.selectedYearContainerColor)) * 31) + Color.m4704hashCodeimpl(this.disabledSelectedYearContainerColor)) * 31) + Color.m4704hashCodeimpl(this.dayContentColor)) * 31) + Color.m4704hashCodeimpl(this.disabledDayContentColor)) * 31) + Color.m4704hashCodeimpl(this.selectedDayContentColor)) * 31) + Color.m4704hashCodeimpl(this.disabledSelectedDayContentColor)) * 31) + Color.m4704hashCodeimpl(this.selectedDayContainerColor)) * 31) + Color.m4704hashCodeimpl(this.disabledSelectedDayContainerColor)) * 31) + Color.m4704hashCodeimpl(this.todayContentColor)) * 31) + Color.m4704hashCodeimpl(this.todayDateBorderColor)) * 31) + Color.m4704hashCodeimpl(this.dayInSelectionRangeContainerColor)) * 31) + Color.m4704hashCodeimpl(this.dayInSelectionRangeContentColor);
    }
}
