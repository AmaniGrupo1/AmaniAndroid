...
final class ClockDialNode$pointerInputTapNode$1 extends SuspendLambda implements Function2<PointerInputScope, Continuation<? super Unit>, Object> {
            ...
            case 0:
                ...
                if (TapGestureDetectorKt.detectTapGestures$default($this$SuspendingPointerInputModifierNode, null, null, anonymousClass1, new Function1<Offset, Unit>() { // from class: androidx.compose.material3.ClockDialNode$pointerInputTapNode$1.2
                    ...
                    public /* bridge */ /* synthetic */ Unit invoke(Offset offset) {
                        m2169invokek4lQ0M(offset.m4462unboximpl());
                        ...
                        public final Object invokeSuspend(Object $result) {
                            ...
                            switch (this.label) {
                                case 0:
                                    ResultKt.throwOnFailure($result);
                                    this.label = 1;
                                    if (TimePickerKt.m3014onTaprOwcSBo(this.this$0.state, Offset.m4452getXimpl(this.$it), Offset.m4453getYimpl(this.$it), this.this$0.getMaxDist(), this.this$0.autoSwitchToMinute, this.this$0.center, this) == coroutine_suspended) {
                    ...
                    public final void m2169invokek4lQ0M(long it) {
                        BuildersKt__Builders_commonKt.launch$default(clockDialNode.getCoroutineScope(), null, null, new AnonymousClass1(clockDialNode, it, null), 3, null);
                    }
    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function3<PressGestureScope, Offset, Continuation<? super Unit>, Object> {
        ...
        public /* bridge */ /* synthetic */ Object invoke(PressGestureScope pressGestureScope, Offset offset, Continuation<? super Unit> continuation) {
            return m2168invoked4ec7I(pressGestureScope, offset.m4462unboximpl(), continuation);
        }

        /* JADX INFO: renamed from: invoke-d-4ec7I, reason: not valid java name */
        public final Object m2168invoked4ec7I(PressGestureScope pressGestureScope, long j, Continuation<? super Unit> continuation) {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    long it = this.J$0;
                    this.this$0.offsetX = Offset.m4452getXimpl(it);
                    this.this$0.offsetY = Offset.m4453getYimpl(it);
                    return Unit.INSTANCE;
                default:
                    throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
            }
