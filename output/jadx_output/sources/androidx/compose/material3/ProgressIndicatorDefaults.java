...
public final class ProgressIndicatorDefaults {
    ...
    public static /* synthetic */ void m2636getCircularIndicatorTrackGapSizeD9Ej5fM$annotations() {
    }
    ...
    public static /* synthetic */ void m2637getLinearIndicatorTrackGapSizeD9Ej5fM$annotations() {
    }

    /* JADX INFO: renamed from: getLinearTrackStopIndicatorSize-D9Ej5fM$annotations, reason: not valid java name */
    public static /* synthetic */ void m2638getLinearTrackStopIndicatorSizeD9Ej5fM$annotations() {
    }
    ...
    public final long getCircularTrackColor(Composer $composer, int $changed) {
        ...
        ComposerKt.sourceInformationMarkerEnd($composer);
        return jM4732getTransparent0d7_KjU;
    }
    ...
    public final int m2641getCircularIndeterminateStrokeCapKaPHkGw() {
    ...
    public final float m2646getLinearTrackStopIndicatorSizeD9Ej5fM() {
    ...
    public final float m2644getLinearIndicatorTrackGapSizeD9Ej5fM() {
    ...
    public final float m2642getCircularIndicatorTrackGapSizeD9Ej5fM() {
    ...
    public final void m2639drawStopIndicatorEgI2THU(DrawScope drawScope, float stopSize, long color, int strokeCap) {
        float adjustedStopSize = Math.min(drawScope.mo405toPx0680j_4(stopSize), Size.m4518getHeightimpl(drawScope.mo5271getSizeNHjbRc()));
        float stopOffset = (Size.m4518getHeightimpl(drawScope.mo5271getSizeNHjbRc()) - adjustedStopSize) / 2;
        if (StrokeCap.m5067equalsimpl0(strokeCap, StrokeCap.INSTANCE.m5072getRoundKaPHkGw())) {
            DrawScope.m5252drawCircleVaOC9Bg$default(drawScope, color, adjustedStopSize / 2.0f, OffsetKt.Offset((Size.m4521getWidthimpl(drawScope.mo5271getSizeNHjbRc()) - (adjustedStopSize / 2.0f)) - stopOffset, Size.m4518getHeightimpl(drawScope.mo5271getSizeNHjbRc()) / 2.0f), 0.0f, null, null, 0, 120, null);
        } else {
            DrawScope.m5265drawRectnJ9OG0$default(drawScope, color, OffsetKt.Offset((Size.m4521getWidthimpl(drawScope.mo5271getSizeNHjbRc()) - adjustedStopSize) - stopOffset, (Size.m4518getHeightimpl(drawScope.mo5271getSizeNHjbRc()) - adjustedStopSize) / 2.0f), SizeKt.Size(adjustedStopSize, adjustedStopSize), 0.0f, null, null, 0, 120, null);
        }
    }
}
