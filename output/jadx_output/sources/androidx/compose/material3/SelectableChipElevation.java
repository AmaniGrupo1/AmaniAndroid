...
public final class SelectableChipElevation {
    ...
    private final State<Dp> animateElevation(boolean enabled, InteractionSource interactionSource, Composer $composer, int $changed) {
        Object value$iv;
        Object value$iv2;
        SelectableChipElevation$animateElevation$1$1 value$iv3;
        float target;
        Object value$iv4;
        Animatable animatable;
        SelectableChipElevation$animateElevation$2$1 value$iv5;
        ...
        if (invalid$iv || it$iv3 == Composer.INSTANCE.getEmpty()) {
            value$iv3 = new SelectableChipElevation$animateElevation$1$1(interactionSource, interactions, null);
        ...
        if (it$iv4 == Composer.INSTANCE.getEmpty()) {
            value$iv4 = new Animatable(Dp.m7503boximpl(target), VectorConvertersKt.getVectorConverter(Dp.INSTANCE), null, null, 12, null);
        ...
        if (invalid$iv2 || it$iv5 == Composer.INSTANCE.getEmpty()) {
            ...
            value$iv5 = new SelectableChipElevation$animateElevation$2$1(animatable, target, enabled, interaction, lastInteraction$delegate, null);
        ...
        ComposerKt.sourceInformationMarkerEnd($composer);
        EffectsKt.LaunchedEffect(dpM7503boximpl, (Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object>) value$iv5, $composer, 0);
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof SelectableChipElevation) && Dp.m7510equalsimpl0(this.elevation, ((SelectableChipElevation) other).elevation) && Dp.m7510equalsimpl0(this.pressedElevation, ((SelectableChipElevation) other).pressedElevation) && Dp.m7510equalsimpl0(this.focusedElevation, ((SelectableChipElevation) other).focusedElevation) && Dp.m7510equalsimpl0(this.hoveredElevation, ((SelectableChipElevation) other).hoveredElevation) && Dp.m7510equalsimpl0(this.disabledElevation, ((SelectableChipElevation) other).disabledElevation)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        int result = Dp.m7511hashCodeimpl(this.elevation);
