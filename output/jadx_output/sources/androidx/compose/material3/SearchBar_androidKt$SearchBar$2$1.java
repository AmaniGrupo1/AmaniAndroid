    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            try {
                ...
                FiniteAnimationSpec finiteAnimationSpec = SearchBar_androidKt.AnimationPredictiveBackExitFloatSpec;
                anonymousClass1.label = 2;
                if (animatable.animateTo(fBoxFloat, (4 & 2) != 0 ? animatable.defaultSpringSpec : finiteAnimationSpec, (4 & 4) != 0 ? animatable.getVelocity() : null, (4 & 8) != 0 ? null : null, anonymousClass1) == coroutine_suspended) {
                ...
                case 0:
                    ...
                    if (flow.collect(new FlowCollector() { // from class: androidx.compose.material3.SearchBar_androidKt.SearchBar.2.1.1.1
                        ...
                        public final Object emit(BackEventCompat backEvent, Continuation<? super Unit> continuation) {
                            ...
                            Object objSnapTo = animatable2.snapTo(Boxing.boxFloat(1 - interpolatedProgress), continuation);
