            ...
            case 0:
                ...
                if (!Dp.m7510equalsimpl0(this.$animatable.getTargetValue().m7519unboximpl(), this.$target)) {
                    if (this.$enabled) {
                        ...
                        this.label = 2;
                        if (ElevationKt.m3183animateElevationrAjV9yQ(this.$animatable, this.$target, interactionAnimateElevation$lambda$2, this.$interaction, this) == coroutine_suspended) {
                        ...
                        this.label = 1;
                        if (this.$animatable.snapTo(Dp.m7503boximpl(this.$target), this) == coroutine_suspended) {
                            return coroutine_suspended;
                        }
