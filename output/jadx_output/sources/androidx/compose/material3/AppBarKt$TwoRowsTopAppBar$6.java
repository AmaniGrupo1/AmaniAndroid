    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        if (($changed & 3) != 2 || !$composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1350062619, $changed, -1, "androidx.compose.material3.TwoRowsTopAppBar.<anonymous> (AppBar.kt:2043)");
            }
            ...
            AppBarKt.m2058TopAppBarLayoutkXwM9vE(SizeKt.m852heightInVpY3zN4$default(ClipKt.clipToBounds(WindowInsetsPaddingKt.windowInsetsPadding(Modifier.INSTANCE, windowInsets)), 0.0f, f, 1, null), new ScrolledOffset() { // from class: androidx.compose.material3.AppBarKt$TwoRowsTopAppBar$6$$ExternalSyntheticLambda0
            ...
            Modifier modifierM852heightInVpY3zN4$default = SizeKt.m852heightInVpY3zN4$default(ClipKt.clipToBounds(WindowInsetsPaddingKt.windowInsetsPadding(Modifier.INSTANCE, WindowInsetsKt.m891onlybOOhFvg(windowInsets, WindowInsetsSides.INSTANCE.m913getHorizontalJoeWqyM()))), 0.0f, Dp.m7505constructorimpl(f3 - f), 1, null);
            ComposerKt.sourceInformationMarkerStart($composer, 1947835376, "CC(remember):AppBar.kt#9igjgp");
            boolean invalid$iv = $composer.changed(topAppBarScrollBehavior);
            Object it$iv = $composer.rememberedValue();
            if (invalid$iv || it$iv == Composer.INSTANCE.getEmpty()) {
                value$iv = new ScrolledOffset() { // from class: androidx.compose.material3.AppBarKt$TwoRowsTopAppBar$6$$ExternalSyntheticLambda1
                    @Override // androidx.compose.material3.ScrolledOffset
                    public final float offset() {
            ...
            AppBarKt.m2058TopAppBarLayoutkXwM9vE(modifierM852heightInVpY3zN4$default, (ScrolledOffset) value$iv, topAppBarColors.getNavigationIconContentColor(), topAppBarColors.getTitleContentColor(), topAppBarColors.getActionIconContentColor(), function24, textStyle2, f4, Arrangement.INSTANCE.getBottom(), Arrangement.INSTANCE.getStart(), intRef.element, z2, ComposableSingletons$AppBarKt.INSTANCE.m2231getLambda17$material3_release(), ComposableSingletons$AppBarKt.INSTANCE.m2232getLambda18$material3_release(), $composer, 905969664, 3456);
            ComposerKt.sourceInformationMarkerEnd($composer);
            ComposerKt.sourceInformationMarkerEnd($composer);
            $composer.endNode();
            ComposerKt.sourceInformationMarkerEnd($composer);
