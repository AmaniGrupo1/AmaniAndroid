...
public final class TabRowKt$ScrollableTabRowImpl$1$scope$1$1 implements TabIndicatorScope, TabPositionsHolder {
    ...
    public Modifier tabIndicatorLayout(Modifier $this$tabIndicatorLayout, final Function4<? super MeasureScope, ? super Measurable, ? super Constraints, ? super List<TabPosition>, ? extends MeasureResult> function4) {
        return LayoutModifierKt.layout($this$tabIndicatorLayout, new Function3<MeasureScope, Measurable, Constraints, MeasureResult>() { // from class: androidx.compose.material3.TabRowKt$ScrollableTabRowImpl$1$scope$1$1$tabIndicatorLayout$1
            ...
            public /* bridge */ /* synthetic */ MeasureResult invoke(MeasureScope measureScope, Measurable measurable, Constraints constraints) {
                return m2888invoke3p2s80s(measureScope, measurable, constraints.getValue());
            }

            /* JADX INFO: renamed from: invoke-3p2s80s, reason: not valid java name */
            public final MeasureResult m2888invoke3p2s80s(MeasureScope $this$layout, Measurable measurable, long constraints) {
                return function4.invoke($this$layout, measurable, Constraints.m7445boximpl(constraints), this.getTabPositions().getValue());
            }
        });
    }
    ...
    public Modifier tabIndicatorOffset(Modifier $this$tabIndicatorOffset, int selectedTabIndex, boolean matchContentSize) {
        return $this$tabIndicatorOffset.then(new TabIndicatorModifier(this.tabPositions, selectedTabIndex, matchContentSize));
    }
