...
public final class NavigationItemColors {
    ...
    public final NavigationItemColors m2575copy4JmcsL4(long selectedIconColor, long selectedTextColor, long selectedIndicatorColor, long unselectedIconColor, long unselectedTextColor, long disabledIconColor, long disabledTextColor) {
    ...
    public final long m2583iconColorWaAFU9c(boolean selected, boolean enabled) {
    ...
    public final long m2584textColorWaAFU9c(boolean selected, boolean enabled) {
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof NavigationItemColors) && Color.m4698equalsimpl0(this.selectedIconColor, ((NavigationItemColors) other).selectedIconColor) && Color.m4698equalsimpl0(this.unselectedIconColor, ((NavigationItemColors) other).unselectedIconColor) && Color.m4698equalsimpl0(this.selectedTextColor, ((NavigationItemColors) other).selectedTextColor) && Color.m4698equalsimpl0(this.unselectedTextColor, ((NavigationItemColors) other).unselectedTextColor) && Color.m4698equalsimpl0(this.selectedIndicatorColor, ((NavigationItemColors) other).selectedIndicatorColor) && Color.m4698equalsimpl0(this.disabledIconColor, ((NavigationItemColors) other).disabledIconColor) && Color.m4698equalsimpl0(this.disabledTextColor, ((NavigationItemColors) other).disabledTextColor)) {
            return true;
        }
        return false;
    }
