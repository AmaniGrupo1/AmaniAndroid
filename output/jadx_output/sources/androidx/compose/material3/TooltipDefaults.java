...
public final class TooltipDefaults {
    ...
    private static final long caretSize = DpKt.m7527DpSizeYgX7TsA(Dp.m7505constructorimpl(16), Dp.m7505constructorimpl(8));
    ...
    public final long m3123getCaretSizeMYxV2XQ() {
        return caretSize;
    }
    ...
    public final RichTooltipColors m3126richTooltipColorsro_MJ88(long containerColor, long contentColor, long titleContentColor, long actionContentColor, Composer $composer, int $changed, int i) {
        ...
        long titleContentColor2 = (i & 4) != 0 ? Color.INSTANCE.m4733getUnspecified0d7_KjU() : titleContentColor;
        long actionContentColor2 = (i & 8) != 0 ? Color.INSTANCE.m4733getUnspecified0d7_KjU() : actionContentColor;
        if (ComposerKt.isTraceInProgress()) {
        ...
        RichTooltipColors richTooltipColorsM2680copyjRlVdoo = getDefaultRichTooltipColors$material3_release(MaterialTheme.INSTANCE.getColorScheme($composer, 6)).m2680copyjRlVdoo(containerColor2, contentColor2, titleContentColor2, actionContentColor2);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd($composer);
        return richTooltipColorsM2680copyjRlVdoo;
    }
    ...
    public final PopupPositionProvider m3124rememberPlainTooltipPositionProviderkHDZbjc(float spacingBetweenTooltipAndAnchor, Composer $composer, int $changed, int i) {
        Object value$iv;
        ...
        final int tooltipAnchorSpacing = $this$rememberPlainTooltipPositionProvider_kHDZbjc_u24lambda_u241.mo399roundToPx0680j_4(spacingBetweenTooltipAndAnchor);
        ...
        if (invalid$iv || it$iv == Composer.INSTANCE.getEmpty()) {
            value$iv = new PopupPositionProvider() { // from class: androidx.compose.material3.TooltipDefaults$rememberPlainTooltipPositionProvider$1$1
                ...
                public long mo373calculatePositionllwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
                    int x = anchorBounds.getLeft() + ((anchorBounds.getWidth() - IntSize.m7676getWidthimpl(popupContentSize)) / 2);
                    int y = (anchorBounds.getTop() - IntSize.m7675getHeightimpl(popupContentSize)) - tooltipAnchorSpacing;
                    if (y < 0) {
    ...
    public final PopupPositionProvider m3125rememberRichTooltipPositionProviderkHDZbjc(float spacingBetweenTooltipAndAnchor, Composer $composer, int $changed, int i) {
        Object value$iv;
        ...
        final int tooltipAnchorSpacing = $this$rememberRichTooltipPositionProvider_kHDZbjc_u24lambda_u243.mo399roundToPx0680j_4(spacingBetweenTooltipAndAnchor);
        ...
        if (invalid$iv || it$iv == Composer.INSTANCE.getEmpty()) {
            value$iv = new PopupPositionProvider() { // from class: androidx.compose.material3.TooltipDefaults$rememberRichTooltipPositionProvider$1$1
                ...
                public long mo373calculatePositionllwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
                    ...
                    if (IntSize.m7676getWidthimpl(popupContentSize) + x > IntSize.m7676getWidthimpl(windowSize) && (x = anchorBounds.getRight() - IntSize.m7676getWidthimpl(popupContentSize)) < 0) {
                        x = anchorBounds.getLeft() + ((anchorBounds.getWidth() - IntSize.m7676getWidthimpl(popupContentSize)) / 2);
                    }
                    int y = (anchorBounds.getTop() - IntSize.m7675getHeightimpl(popupContentSize)) - tooltipAnchorSpacing;
                    if (y < 0) {
                        y = anchorBounds.getBottom() + tooltipAnchorSpacing;
