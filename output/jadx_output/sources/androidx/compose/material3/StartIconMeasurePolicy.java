...
final class StartIconMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo41measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, List<? extends Measurable> list, long constraints) {
        ...
        long iconConstraints = ConstraintsKt.m7477offsetNN6EwU(looseConstraints, i, -measureScope.mo399roundToPx0680j_4(Dp.m7505constructorimpl(2 * arg0$iv2)));
        ...
        while (index$iv$iv < size) {
            ...
            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(it), "icon")) {
                Placeable iconPlaceable = ((Measurable) item$iv$iv).mo6141measureBRTryo0(iconConstraints);
                ...
                while (index$iv$iv2 < size2) {
                    ...
                    if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(it2), "label")) {
                        Placeable labelPlaceable = ((Measurable) item$iv$iv2).mo6141measureBRTryo0(ConstraintsKt.m7478offsetNN6EwU$default(iconConstraints, -(iconPlaceable2.getWidth() + measureScope.mo399roundToPx0680j_4(this.startIconToLabelHorizontalPadding)), 0, 2, null));
                        ...
                        int totalIndicatorWidth = width + measureScope.mo399roundToPx0680j_4(Dp.m7505constructorimpl(arg0$iv3 + Dp.m7505constructorimpl(2 * arg0$iv4)));
                        int iMax = Math.max(iconPlaceable2.getHeight(), labelPlaceable.getHeight());
                        float arg0$iv5 = this.indicatorVerticalPadding;
                        int indicatorHeight = iMax + measureScope.mo399roundToPx0680j_4(Dp.m7505constructorimpl(2 * arg0$iv5));
                        ...
                        while (index$iv$iv3 < size3) {
                            ...
                            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(it3), "indicatorRipple")) {
                                Placeable indicatorRipplePlaceable = ((Measurable) item$iv$iv3).mo6141measureBRTryo0(ConstraintsKt.m7473constrainN9IONVI(looseConstraints, Constraints.INSTANCE.m7468fixedJhjzzOo(totalIndicatorWidth, indicatorHeight)));
                                ...
                                while (index$iv$iv5 < size4) {
                                    ...
                                    if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(it4), "indicator")) {
                                        Placeable indicatorPlaceable = ((Measurable) item$iv$iv4).mo6141measureBRTryo0(ConstraintsKt.m7473constrainN9IONVI(looseConstraints, Constraints.INSTANCE.m7468fixedJhjzzOo(animatedIndicatorWidth, indicatorHeight)));
                                        return NavigationItemKt.m2601placeLabelAndStartIconnru01g4($this$measure_u2d3p2s80s, labelPlaceable2, iconPlaceable2, indicatorRipplePlaceable, indicatorPlaceable, constraints, this.startIconToLabelHorizontalPadding);
                                    }
                                    index$iv$iv5++;
            ...
            if (Intrinsics.areEqual(TextFieldImplKt.getLayoutId(it), "icon")) {
                ...
                while (index$iv$iv2 < size2) {
                    ...
                    if (Intrinsics.areEqual(TextFieldImplKt.getLayoutId(it2), "label")) {
                        ...
                        int paddings = $this$maxIntrinsicWidth.mo399roundToPx0680j_4(Dp.m7505constructorimpl(arg0$iv2 + other$iv));
            ...
            if (Intrinsics.areEqual(TextFieldImplKt.getLayoutId(it), "icon")) {
                ...
                for (int index$iv$iv2 = 0; index$iv$iv2 < size2; index$iv$iv2++) {
                    ...
                    if (Intrinsics.areEqual(TextFieldImplKt.getLayoutId(it2), "label")) {
                        ...
                        int paddings = $this$maxIntrinsicHeight.mo399roundToPx0680j_4(Dp.m7505constructorimpl(2 * arg0$iv));
