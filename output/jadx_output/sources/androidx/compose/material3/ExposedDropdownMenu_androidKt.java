...
public final class ExposedDropdownMenu_androidKt {
    private static final float ExposedDropdownMenuItemHorizontalPadding = Dp.m7505constructorimpl(16);
    ...
    public static final void ExposedDropdownMenuBox(final boolean expanded, final Function1<? super Boolean, Unit> function1, Modifier modifier, Function3<? super ExposedDropdownMenuBoxScope, ? super Composer, ? super Integer, Unit> function3, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty3 & 1171) == 1170 && $composer2.getSkipping()) {
            ...
            final int verticalMargin2 = density2.mo399roundToPx0680j_4(MenuKt.getMenuVerticalMargin());
            ...
            String expandedDescription3 = Strings_androidKt.m3257getString2EP1pXo(Strings.m3187constructorimpl(R.string.m3c_dropdown_menu_expanded), $composer2, 0);
            Strings.Companion companion2 = Strings.INSTANCE;
            String collapsedDescription2 = Strings_androidKt.m3257getString2EP1pXo(Strings.m3187constructorimpl(R.string.m3c_dropdown_menu_collapsed), $composer2, 0);
            Strings.Companion companion3 = Strings.INSTANCE;
            String toggleDescription = Strings_androidKt.m3257getString2EP1pXo(Strings.m3187constructorimpl(R.string.m3c_dropdown_menu_toggle), $composer2, 0);
            ...
            if (value$iv10 == Composer.INSTANCE.getEmpty()) {
                $dirty = $dirty3;
                value$iv10 = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(MenuAnchorType.m2500boximpl(MenuAnchorType.INSTANCE.m2508getPrimaryNotEditableMg6Rgbw()), null, 2, null);
            ...
            if (invalid$iv || it$iv5 == Composer.INSTANCE.getEmpty()) {
                ...
                value$iv5 = new ExposedDropdownMenuBoxScopeImpl() { // from class: androidx.compose.material3.ExposedDropdownMenu_androidKt$ExposedDropdownMenuBox$scope$1$1
                    ...
                    public Modifier mo2366menuAnchorfsE2BvY(Modifier $this$menuAnchor_u2dfsE2BvY, final String type, boolean enabled) {
                        Modifier.Companion companionM2375expandableGq7TBQ4;
                        ...
                        if (enabled) {
                            ...
                            companionM2375expandableGq7TBQ4 = ExposedDropdownMenu_androidKt.m2375expandableGq7TBQ4(companion4, z2, new Function0<Unit>() { // from class: androidx.compose.material3.ExposedDropdownMenu_androidKt$ExposedDropdownMenuBox$scope$1$1$menuAnchor$1
                                ...
                                public final void invoke2() {
                                    mutableState.setValue(MenuAnchorType.m2500boximpl(type));
                            ...
                            companionM2375expandableGq7TBQ4 = Modifier.INSTANCE;
                        }
                        return modifierFocusRequester.then(companionM2375expandableGq7TBQ4);
                    }

                    @Override // androidx.compose.material3.ExposedDropdownMenuBoxScope
                    /* JADX INFO: renamed from: getAnchorType-Mg6Rgbw$material3_release */
                    public String mo2365getAnchorTypeMg6Rgbw$material3_release() {
                    ...
                    public Modifier exposedDropdownSize(Modifier $this$exposedDropdownSize, final boolean matchTextFieldWidth) {
                        ...
                        return LayoutModifierKt.layout($this$exposedDropdownSize, new Function3<MeasureScope, Measurable, Constraints, MeasureResult>() { // from class: androidx.compose.material3.ExposedDropdownMenu_androidKt$ExposedDropdownMenuBox$scope$1$1$exposedDropdownSize$1
                            ...
                            public /* bridge */ /* synthetic */ MeasureResult invoke(MeasureScope measureScope, Measurable measurable, Constraints constraints) {
                                return m2376invoke3p2s80s(measureScope, measurable, constraints.getValue());
                            }

                            /* JADX INFO: renamed from: invoke-3p2s80s, reason: not valid java name */
                            public final MeasureResult m2376invoke3p2s80s(MeasureScope $this$layout, Measurable measurable, long constraints) {
                                int menuWidth = ConstraintsKt.m7475constrainWidthK40F9xA(constraints, ExposedDropdownMenu_androidKt.ExposedDropdownMenuBox$lambda$5(mutableIntState));
                                long menuConstraints = Constraints.m7447copyZbe2FdA(constraints, (11 & 1) != 0 ? Constraints.m7460getMinWidthimpl(constraints) : matchTextFieldWidth ? menuWidth : Constraints.m7460getMinWidthimpl(constraints), (11 & 2) != 0 ? Constraints.m7458getMaxWidthimpl(constraints) : matchTextFieldWidth ? menuWidth : Constraints.m7458getMaxWidthimpl(constraints), (11 & 4) != 0 ? Constraints.m7459getMinHeightimpl(constraints) : 0, (11 & 8) != 0 ? Constraints.m7457getMaxHeightimpl(constraints) : ConstraintsKt.m7474constrainHeightK40F9xA(constraints, ExposedDropdownMenu_androidKt.ExposedDropdownMenuBox$lambda$8(mutableIntState2)));
                                final Placeable placeable = measurable.mo6141measureBRTryo0(menuConstraints);
            ...
            if (invalid$iv2 || it$iv6 == Composer.INSTANCE.getEmpty()) {
                ...
                Function1<LayoutCoordinates, Unit> function13 = new Function1<LayoutCoordinates, Unit>() { // from class: androidx.compose.material3.ExposedDropdownMenu_androidKt$ExposedDropdownMenuBox$1$1
                    ...
                    public final void invoke2(LayoutCoordinates it) {
                        ...
                        anchorWidth$delegate3.setIntValue(IntSize.m7676getWidthimpl(it.mo6149getSizeYbymL2g()));
    ...
    public static final Modifier m2375expandableGq7TBQ4(Modifier $this$expandable_u2dGq7TBQ4, final boolean expanded, final Function0<Unit> function0, final String anchorType, final String expandedDescription, final String collapsedDescription, final String toggleDescription, final SoftwareKeyboardController keyboardController) {
        return SemanticsModifierKt.semantics$default($this$expandable_u2dGq7TBQ4.then(new SuspendPointerInputElement(function0, null, null, new SuspendingPointerInputFilterKt$sam$androidx_compose_ui_input_pointer_PointerInputEventHandler$0(new ExposedDropdownMenu_androidKt$expandable$1(anchorType, function0, null)), 6, null)), false, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.ExposedDropdownMenu_androidKt$expandable$2
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
            ...
            public final void invoke2(SemanticsPropertyReceiver $this$semantics) {
                if (MenuAnchorType.m2503equalsimpl0(anchorType, MenuAnchorType.INSTANCE.m2509getSecondaryEditableMg6Rgbw())) {
                    ...
                    SemanticsPropertiesKt.m6718setRolekuIjeqM($this$semantics, Role.INSTANCE.m6702getDropdownListo7Vup1c());
                }
                ...
                SemanticsPropertiesKt.onClick$default($this$semantics, null, new Function0<Boolean>() { // from class: androidx.compose.material3.ExposedDropdownMenu_androidKt$expandable$2.1
                    ...
                    public final Boolean invoke() {
                        ...
                        function02.invoke();
                        if (MenuAnchorType.m2503equalsimpl0(str, MenuAnchorType.INSTANCE.m2507getPrimaryEditableMg6Rgbw()) && (softwareKeyboardController2 = softwareKeyboardController) != null) {
    ...
    public static final Rect getAnchorBounds(LayoutCoordinates $this$getAnchorBounds) {
        return $this$getAnchorBounds == null ? Rect.INSTANCE.getZero() : RectKt.m4492Recttz77jQw(LayoutCoordinatesKt.positionInWindow($this$getAnchorBounds), IntSizeKt.m7688toSizeozmzZPI($this$getAnchorBounds.mo6149getSizeYbymL2g()));
    }
}
