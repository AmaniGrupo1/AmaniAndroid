...
public final class TabPosition {
    ...
    public final float m2867getRightD9Ej5fM() {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof TabPosition) && Dp.m7510equalsimpl0(this.left, ((TabPosition) other).left) && Dp.m7510equalsimpl0(this.width, ((TabPosition) other).width) && Dp.m7510equalsimpl0(this.contentWidth, ((TabPosition) other).contentWidth);
    }

    public int hashCode() {
        int result = Dp.m7511hashCodeimpl(this.left);
        return (((result * 31) + Dp.m7511hashCodeimpl(this.width)) * 31) + Dp.m7511hashCodeimpl(this.contentWidth);
    }

    public String toString() {
        return "TabPosition(left=" + ((Object) Dp.m7516toStringimpl(this.left)) + ", right=" + ((Object) Dp.m7516toStringimpl(m2867getRightD9Ej5fM())) + ", width=" + ((Object) Dp.m7516toStringimpl(this.width)) + ", contentWidth=" + ((Object) Dp.m7516toStringimpl(this.contentWidth)) + ')';
    }
}
