...
public final class IconButtonKt {
    ...
    */
    public static final void IconButton(final Function0<Unit> function0, Modifier modifier, boolean enabled, IconButtonColors colors, MutableInteractionSource interactionSource, final Function2<? super Composer, ? super Integer, Unit> function2, Composer $composer, final int $changed, final int i) {
        ...
        ComposerKt.sourceInformation($composer2, "C(IconButton)P(5,4,2!1,3)85@4039L18,94@4366L5,102@4703L175,89@4160L944:IconButton.kt#uh7d8r");
        int $dirty2 = $changed;
        if ((i & 1) != 0) {
            $dirty2 |= 6;
        ...
        if ((74899 & $dirty2) == 74898 && $composer2.getSkipping()) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1142896114, $dirty, -1, "androidx.compose.material3.IconButton (IconButton.kt:88)");
            }
            Modifier modifierM264backgroundbw27NRU$default = BackgroundKt.m264backgroundbw27NRU$default(ClipKt.clip(SizeKt.m864size3ABfNKs(InteractiveComponentSizeKt.minimumInteractiveComponentSize(modifier3), IconButtonTokens.INSTANCE.m3573getStateLayerSizeD9Ej5fM()), ShapesKt.getValue(IconButtonTokens.INSTANCE.getStateLayerShape(), $composer2, 6)), colors3.m2412containerColorvNxB06k$material3_release(enabled3), null, 2, null);
            int iM6699getButtono7Vup1c = Role.INSTANCE.m6699getButtono7Vup1c();
            float arg0$iv = IconButtonTokens.INSTANCE.m3573getStateLayerSizeD9Ej5fM();
            int other$iv = $dirty;
            Indication indicationM2690rippleOrFallbackImplementation9IZ8Weo = RippleKt.m2690rippleOrFallbackImplementation9IZ8Weo(false, Dp.m7505constructorimpl(arg0$iv / 2), 0L, $composer2, 54, 4);
            Role roleM6692boximpl = Role.m6692boximpl(iM6699getButtono7Vup1c);
            boolean enabled5 = enabled3;
            MutableInteractionSource interactionSource4 = interactionSource2;
            Modifier modifier$iv = ClickableKt.m294clickableO2vRcR0(modifierM264backgroundbw27NRU$default, interactionSource4, indicationM2690rippleOrFallbackImplementation9IZ8Weo, (24 & 4) != 0 ? true : enabled5, (24 & 8) != 0 ? null : null, (24 & 16) != 0 ? null : roleM6692boximpl, function02);
            ...
            if ($this$Layout_u24lambda_u240$iv$iv.getInserting()) {
                ...
                ComposerKt.sourceInformationMarkerStart($composer2, 782643754, "C110@5014L84:IconButton.kt#uh7d8r");
                long contentColor = colors3.m2413contentColorvNxB06k$material3_release(enabled5);
                CompositionLocalKt.CompositionLocalProvider(ContentColorKt.getLocalContentColor().provides(Color.m4687boximpl(contentColor)), function2, $composer2, ProvidedValue.$stable | ((other$iv >> 12) & 112));
            ...
            ComposerKt.sourceInformationMarkerStart($composer2, 782643754, "C110@5014L84:IconButton.kt#uh7d8r");
            long contentColor2 = colors3.m2413contentColorvNxB06k$material3_release(enabled5);
            CompositionLocalKt.CompositionLocalProvider(ContentColorKt.getLocalContentColor().provides(Color.m4687boximpl(contentColor2)), function2, $composer2, ProvidedValue.$stable | ((other$iv >> 12) & 112));
            ComposerKt.sourceInformationMarkerEnd($composer2);
            ComposerKt.sourceInformationMarkerEnd($composer2);
            $composer2.endNode();
            ComposerKt.sourceInformationMarkerEnd($composer2);
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.IconButtonKt.IconButton.2
                ...
                public final void invoke(Composer composer, int i8) {
                    IconButtonKt.IconButton(function0, modifier4, enabled4, colors3, interactionSource3, function2, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    public static final void IconToggleButton(final boolean checked, final Function1<? super Boolean, Unit> function1, Modifier modifier, boolean enabled, IconToggleButtonColors colors, MutableInteractionSource interactionSource, final Function2<? super Composer, ? super Integer, Unit> function2, Composer $composer, final int $changed, final int i) {
        ...
        if ((599187 & $dirty2) == 599186 && $composer2.getSkipping()) {
            ...
            Modifier modifierM264backgroundbw27NRU$default = BackgroundKt.m264backgroundbw27NRU$default(ClipKt.clip(SizeKt.m864size3ABfNKs(InteractiveComponentSizeKt.minimumInteractiveComponentSize(modifier3), IconButtonTokens.INSTANCE.m3573getStateLayerSizeD9Ej5fM()), ShapesKt.getValue(IconButtonTokens.INSTANCE.getStateLayerShape(), $composer2, 6)), colors3.containerColor$material3_release(enabled2, checked, $composer2, (($dirty >> 9) & 14) | (($dirty << 3) & 112) | (($dirty >> 6) & 896)).getValue().m4707unboximpl(), null, 2, null);
            int iM6701getCheckboxo7Vup1c = Role.INSTANCE.m6701getCheckboxo7Vup1c();
            float arg0$iv = IconButtonTokens.INSTANCE.m3573getStateLayerSizeD9Ej5fM();
            float arg0$iv2 = Dp.m7505constructorimpl(arg0$iv / 2);
            IconToggleButtonColors colors5 = colors3;
            MutableInteractionSource interactionSource4 = interactionSource2;
            int $dirty3 = $dirty;
            Modifier modifier$iv = ToggleableKt.m1095toggleableO2vRcR0(modifierM264backgroundbw27NRU$default, checked, interactionSource4, RippleKt.m2690rippleOrFallbackImplementation9IZ8Weo(false, arg0$iv2, 0L, $composer2, 54, 4), enabled2, Role.m6692boximpl(iM6701getCheckboxo7Vup1c), function12);
            Alignment contentAlignment$iv = Alignment.INSTANCE.getCenter();
            ComposerKt.sourceInformationMarkerStart($composer2, 733328855, "CC(Box)P(2,1,3)72@3384L130:Box.kt#2w3rfo");
            MeasurePolicy measurePolicy$iv = BoxKt.maybeCachedBoxMeasurePolicy(contentAlignment$iv, false);
            int $changed$iv$iv = (48 << 3) & 112;
            ...
            long contentColor = colors5.contentColor$material3_release(enabled2, checked, $composer2, (($dirty3 >> 9) & 14) | (($dirty3 << 3) & 112) | (($dirty3 >> 6) & 896)).getValue().m4707unboximpl();
            CompositionLocalKt.CompositionLocalProvider(ContentColorKt.getLocalContentColor().provides(Color.m4687boximpl(contentColor)), function2, $composer2, ProvidedValue.$stable | (($dirty3 >> 15) & 112));
            ComposerKt.sourceInformationMarkerEnd($composer2);
            ComposerKt.sourceInformationMarkerEnd($composer2);
            $composer2.endNode();
            ComposerKt.sourceInformationMarkerEnd($composer2);
    ...
    public static final void FilledIconButton(final Function0<Unit> function0, Modifier modifier, boolean enabled, Shape shape, IconButtonColors colors, MutableInteractionSource interactionSource, final Function2<? super Composer, ? super Integer, Unit> function2, Composer $composer, final int $changed, final int i) {
        ...
        if ((599187 & $dirty2) == 599186 && $composer3.getSkipping()) {
            ...
            $composer2 = $composer3;
            SurfaceKt.m2829Surfaceo_FOJdg(function02, SemanticsModifierKt.semantics$default(modifier3, false, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.IconButtonKt.FilledIconButton.1
            ...
            }, 1, null), enabled3, shape3, colors3.m2412containerColorvNxB06k$material3_release(enabled3), colors3.m2413contentColorvNxB06k$material3_release(enabled3), 0.0f, 0.0f, null, interactionSource2, ComposableLambdaKt.rememberComposableLambda(-1560623888, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.IconButtonKt.FilledIconButton.2
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
                    super(2);
                ...
                public final void invoke(Composer $composer4, int $changed2) {
                    ...
                    if (($changed2 & 3) != 2 || !$composer4.getSkipping()) {
                        ...
                        Modifier modifier$iv = SizeKt.m866sizeVpY3zN4(Modifier.INSTANCE, FilledIconButtonTokens.INSTANCE.m3537getContainerWidthD9Ej5fM(), FilledIconButtonTokens.INSTANCE.m3536getContainerHeightD9Ej5fM());
                        Alignment contentAlignment$iv = Alignment.INSTANCE.getCenter();
            ...
            }, $composer3, 54), $composer2, ($dirty & 14) | ($dirty & 896) | ($dirty & 7168) | (($dirty << 12) & C.ENCODING_PCM_DOUBLE), 6, 448);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            colors4 = colors3;
    ...
    public static final void FilledTonalIconButton(final Function0<Unit> function0, Modifier modifier, boolean enabled, Shape shape, IconButtonColors colors, MutableInteractionSource interactionSource, final Function2<? super Composer, ? super Integer, Unit> function2, Composer $composer, final int $changed, final int i) {
        ...
        if ((599187 & $dirty2) == 599186 && $composer3.getSkipping()) {
            ...
            $composer2 = $composer3;
            SurfaceKt.m2829Surfaceo_FOJdg(function02, SemanticsModifierKt.semantics$default(modifier3, false, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.IconButtonKt.FilledTonalIconButton.1
                @Override // kotlin.jvm.functions.Function1
                public /* bridge */ /* synthetic */ Unit invoke(SemanticsPropertyReceiver semanticsPropertyReceiver) {
                    invoke2(semanticsPropertyReceiver);
                    return Unit.INSTANCE;
            ...
            }, 1, null), enabled3, shape3, colors3.m2412containerColorvNxB06k$material3_release(enabled3), colors3.m2413contentColorvNxB06k$material3_release(enabled3), 0.0f, 0.0f, null, interactionSource2, ComposableLambdaKt.rememberComposableLambda(-1772884636, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.IconButtonKt.FilledTonalIconButton.2
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
                    super(2);
                ...
                public final void invoke(Composer $composer4, int $changed2) {
                    ...
                    if (($changed2 & 3) != 2 || !$composer4.getSkipping()) {
                        ...
                        Modifier modifier$iv = SizeKt.m866sizeVpY3zN4(Modifier.INSTANCE, FilledTonalIconButtonTokens.INSTANCE.m3553getContainerWidthD9Ej5fM(), FilledTonalIconButtonTokens.INSTANCE.m3552getContainerHeightD9Ej5fM());
                        Alignment contentAlignment$iv = Alignment.INSTANCE.getCenter();
                        Function2<Composer, Integer, Unit> function22 = function2;
                        ComposerKt.sourceInformationMarkerStart($composer4, 733328855, "CC(Box)P(2,1,3)72@3384L130:Box.kt#2w3rfo");
                        MeasurePolicy measurePolicy$iv = BoxKt.maybeCachedBoxMeasurePolicy(contentAlignment$iv, false);
    ...
    public static final void FilledIconToggleButton(final boolean checked, final Function1<? super Boolean, Unit> function1, Modifier modifier, boolean enabled, Shape shape, IconToggleButtonColors colors, MutableInteractionSource interactionSource, final Function2<? super Composer, ? super Integer, Unit> function2, Composer $composer, final int $changed, final int i) {
        ...
        if ((4793491 & $dirty2) == 4793490 && $composer2.getSkipping()) {
            ...
            IconToggleButtonColors colors5 = colors3;
            Modifier modifier5 = modifier3;
            SurfaceKt.m2828Surfaced85dljk(checked, function1, SemanticsModifierKt.semantics$default(modifier3, false, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.IconButtonKt.FilledIconToggleButton.1
                @Override // kotlin.jvm.functions.Function1
                public /* bridge */ /* synthetic */ Unit invoke(SemanticsPropertyReceiver semanticsPropertyReceiver) {
                    invoke2(semanticsPropertyReceiver);
                    return Unit.INSTANCE;
            ...
            }, 1, null), enabled3, shape3, colors3.containerColor$material3_release(enabled3, checked, $composer2, (($dirty >> 9) & 14) | (($dirty << 3) & 112) | (($dirty >> 9) & 896)).getValue().m4707unboximpl(), colors3.contentColor$material3_release(enabled3, checked, $composer2, (($dirty >> 9) & 14) | (($dirty << 3) & 112) | (($dirty >> 9) & 896)).getValue().m4707unboximpl(), 0.0f, 0.0f, (BorderStroke) null, interactionSource2, ComposableLambdaKt.rememberComposableLambda(1235871670, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.IconButtonKt.FilledIconToggleButton.2
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
                    super(2);
    ...
    public static final void FilledTonalIconToggleButton(final boolean checked, final Function1<? super Boolean, Unit> function1, Modifier modifier, boolean enabled, Shape shape, IconToggleButtonColors colors, MutableInteractionSource interactionSource, final Function2<? super Composer, ? super Integer, Unit> function2, Composer $composer, final int $changed, final int i) {
        ...
        if ((4793491 & $dirty2) == 4793490 && $composer2.getSkipping()) {
            ...
            IconToggleButtonColors colors5 = colors3;
            Modifier modifier5 = modifier3;
            SurfaceKt.m2828Surfaced85dljk(checked, function1, SemanticsModifierKt.semantics$default(modifier3, false, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.IconButtonKt.FilledTonalIconToggleButton.1
                @Override // kotlin.jvm.functions.Function1
                public /* bridge */ /* synthetic */ Unit invoke(SemanticsPropertyReceiver semanticsPropertyReceiver) {
                    invoke2(semanticsPropertyReceiver);
                    return Unit.INSTANCE;
            ...
            }, 1, null), enabled3, shape3, colors3.containerColor$material3_release(enabled3, checked, $composer2, (($dirty >> 9) & 14) | (($dirty << 3) & 112) | (($dirty >> 9) & 896)).getValue().m4707unboximpl(), colors3.contentColor$material3_release(enabled3, checked, $composer2, (($dirty >> 9) & 14) | (($dirty << 3) & 112) | (($dirty >> 9) & 896)).getValue().m4707unboximpl(), 0.0f, 0.0f, (BorderStroke) null, interactionSource2, ComposableLambdaKt.rememberComposableLambda(-58218680, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.IconButtonKt.FilledTonalIconToggleButton.2
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
                    super(2);
    ...
    public static final void OutlinedIconButton(final Function0<Unit> function0, Modifier modifier, boolean enabled, Shape shape, IconButtonColors colors, BorderStroke border, MutableInteractionSource interactionSource, final Function2<? super Composer, ? super Integer, Unit> function2, Composer $composer, final int $changed, final int i) {
        ...
        if ((4793491 & $dirty2) == 4793490 && $composer3.getSkipping()) {
            ...
            $composer2 = $composer3;
            SurfaceKt.m2829Surfaceo_FOJdg(function02, SemanticsModifierKt.semantics$default(modifier3, false, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.IconButtonKt.OutlinedIconButton.1
                @Override // kotlin.jvm.functions.Function1
                public /* bridge */ /* synthetic */ Unit invoke(SemanticsPropertyReceiver semanticsPropertyReceiver) {
                    invoke2(semanticsPropertyReceiver);
                    return Unit.INSTANCE;
            ...
            }, 1, null), enabled3, shape3, colors3.m2412containerColorvNxB06k$material3_release(enabled3), colors3.m2413contentColorvNxB06k$material3_release(enabled3), 0.0f, 0.0f, border3, interactionSource2, ComposableLambdaKt.rememberComposableLambda(582332538, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.IconButtonKt.OutlinedIconButton.2
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
                    super(2);
                ...
                public final void invoke(Composer $composer4, int $changed2) {
                    ...
                    if (($changed2 & 3) != 2 || !$composer4.getSkipping()) {
                        ...
                        Modifier modifier$iv = SizeKt.m864size3ABfNKs(Modifier.INSTANCE, OutlinedIconButtonTokens.INSTANCE.m3636getContainerSizeD9Ej5fM());
                        Alignment contentAlignment$iv = Alignment.INSTANCE.getCenter();
                        Function2<Composer, Integer, Unit> function22 = function2;
                        ComposerKt.sourceInformationMarkerStart($composer4, 733328855, "CC(Box)P(2,1,3)72@3384L130:Box.kt#2w3rfo");
                        MeasurePolicy measurePolicy$iv = BoxKt.maybeCachedBoxMeasurePolicy(contentAlignment$iv, false);
            ...
            }, $composer3, 54), $composer2, ($dirty & 14) | ($dirty & 896) | ($dirty & 7168) | (($dirty << 9) & 234881024) | (1879048192 & ($dirty << 9)), 6, PsExtractor.AUDIO_STREAM);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            colors4 = colors3;
    ...
    public static final void OutlinedIconToggleButton(final boolean checked, final Function1<? super Boolean, Unit> function1, Modifier modifier, boolean enabled, Shape shape, IconToggleButtonColors colors, BorderStroke border, MutableInteractionSource interactionSource, final Function2<? super Composer, ? super Integer, Unit> function2, Composer $composer, final int $changed, final int i) {
        ...
        if ((38347923 & $dirty2) == 38347922 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if ((i & 64) != 0) {
                    BorderStroke border5 = IconButtonDefaults.INSTANCE.outlinedIconToggleButtonBorder(enabled2, checked, $composer2, (($dirty2 >> 9) & 14) | RendererCapabilities.DECODER_SUPPORT_MASK | (($dirty2 << 3) & 112));
                    $dirty2 &= -3670017;
                    border2 = border5;
                }
                if (i7 != 0) {
            ...
            Modifier modifier5 = modifier3;
            IconToggleButtonColors colors5 = colors3;
            SurfaceKt.m2828Surfaced85dljk(checked, function1, SemanticsModifierKt.semantics$default(modifier3, false, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.IconButtonKt.OutlinedIconToggleButton.1
                @Override // kotlin.jvm.functions.Function1
                public /* bridge */ /* synthetic */ Unit invoke(SemanticsPropertyReceiver semanticsPropertyReceiver) {
                    invoke2(semanticsPropertyReceiver);
                    return Unit.INSTANCE;
            ...
            }, 1, null), enabled3, shape3, colors3.containerColor$material3_release(enabled3, checked, $composer2, (($dirty >> 9) & 14) | (($dirty << 3) & 112) | (($dirty >> 9) & 896)).getValue().m4707unboximpl(), colors3.contentColor$material3_release(enabled3, checked, $composer2, (($dirty >> 9) & 896) | (($dirty >> 9) & 14) | (($dirty << 3) & 112)).getValue().m4707unboximpl(), 0.0f, 0.0f, border3, interactionSource2, ComposableLambdaKt.rememberComposableLambda(1207657396, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.IconButtonKt.OutlinedIconToggleButton.2
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
                    super(2);
            ...
            }, $composer2, 54), $composer2, ($dirty & 14) | ($dirty & 112) | ($dirty & 7168) | (57344 & $dirty) | (1879048192 & ($dirty << 9)), (($dirty >> 21) & 14) | 48, RendererCapabilities.DECODER_SUPPORT_MASK);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            shape4 = shape3;
