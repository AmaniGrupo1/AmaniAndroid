...
public final class LabelKt {
    ...
    public static final void Label(final Function3<? super TooltipScope, ? super Composer, ? super Integer, Unit> function3, Modifier modifier, MutableInteractionSource interactionSource, boolean isPersistent, final Function2<? super Composer, ? super Integer, Unit> function2, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty2 & 9363) == 9362 && $composer2.getSkipping()) {
            ...
            PopupPositionProvider positionProvider = TooltipDefaults.INSTANCE.m3124rememberPlainTooltipPositionProviderkHDZbjc(0.0f, $composer2, 48, 1);
            if (isPersistent3) {
            ...
            Function2 wrappedContent = ComposableLambdaKt.rememberComposableLambda(1950723216, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.LabelKt$Label$wrappedContent$1
                ...
                public final void invoke(Composer $composer3, int $changed2) {
                    ...
                    ComposerKt.sourceInformation($composer3, "C83@3656L87:Label.kt#uh7d8r");
                    if (($changed2 & 3) == 2 && $composer3.getSkipping()) {
                        $composer3.skipToGroupEnd();
                        return;
                    }
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventStart(1950723216, $changed2, -1, "androidx.compose.material3.Label.<anonymous> (Label.kt:83)");
                    }
                    Modifier.Companion companion = Modifier.INSTANCE;
                    final Ref.ObjectRef<MutableState<LayoutCoordinates>> objectRef = anchorBounds;
                    Modifier modifier$iv = OnGloballyPositionedModifierKt.onGloballyPositioned(companion, new Function1<LayoutCoordinates, Unit>() { // from class: androidx.compose.material3.LabelKt$Label$wrappedContent$1.1
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        {
                            super(1);
                        }
                    ...
                    int i6 = ((0 >> 6) & 112) | 6;
                    ComposerKt.sourceInformationMarkerStart($composer3, -90340533, "C83@3732L9:Label.kt#uh7d8r");
