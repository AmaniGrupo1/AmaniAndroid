...
public final class CheckboxColors {
    ...
    public static /* synthetic */ CheckboxColors m2118copy2qZNXz8$default(CheckboxColors checkboxColors, long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, long j9, long j10, long j11, long j12, int i, Object obj) {
        long j13;
        long j14;
        ...
        return checkboxColors.m2119copy2qZNXz8(j22, j16, j17, j18, j19, j20, j21, j23, j24, j25, j13, j14);
    }

    /* JADX INFO: renamed from: copy-2qZNXz8, reason: not valid java name */
    public final CheckboxColors m2119copy2qZNXz8(long checkedCheckmarkColor, long uncheckedCheckmarkColor, long checkedBoxColor, long uncheckedBoxColor, long disabledCheckedBoxColor, long disabledUncheckedBoxColor, long disabledIndeterminateBoxColor, long checkedBorderColor, long uncheckedBorderColor, long disabledBorderColor, long disabledUncheckedBorderColor, long disabledIndeterminateBorderColor) {
    ...
    public final State<Color> checkmarkColor$material3_release(ToggleableState state, Composer $composer, int $changed) {
        ...
        State<Color> stateM134animateColorAsStateeuL9pac = SingleValueAnimationKt.m134animateColorAsStateeuL9pac(target, AnimationSpecKt.tween$default(duration, 0, null, 6, null), null, null, $composer, 0, 12);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final State<Color> boxColor$material3_release(boolean enabled, ToggleableState state, Composer $composer, int $changed) {
        ...
        if (enabled) {
            ...
            int duration = state == ToggleableState.Off ? 100 : 50;
            $composer2 = $composer;
            stateRememberUpdatedState = SingleValueAnimationKt.m134animateColorAsStateeuL9pac(target, AnimationSpecKt.tween$default(duration, 0, null, 6, null), null, null, $composer2, 0, 12);
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof CheckboxColors) && Color.m4698equalsimpl0(this.checkedCheckmarkColor, ((CheckboxColors) other).checkedCheckmarkColor) && Color.m4698equalsimpl0(this.uncheckedCheckmarkColor, ((CheckboxColors) other).uncheckedCheckmarkColor) && Color.m4698equalsimpl0(this.checkedBoxColor, ((CheckboxColors) other).checkedBoxColor) && Color.m4698equalsimpl0(this.uncheckedBoxColor, ((CheckboxColors) other).uncheckedBoxColor) && Color.m4698equalsimpl0(this.disabledCheckedBoxColor, ((CheckboxColors) other).disabledCheckedBoxColor) && Color.m4698equalsimpl0(this.disabledUncheckedBoxColor, ((CheckboxColors) other).disabledUncheckedBoxColor) && Color.m4698equalsimpl0(this.disabledIndeterminateBoxColor, ((CheckboxColors) other).disabledIndeterminateBoxColor) && Color.m4698equalsimpl0(this.checkedBorderColor, ((CheckboxColors) other).checkedBorderColor) && Color.m4698equalsimpl0(this.uncheckedBorderColor, ((CheckboxColors) other).uncheckedBorderColor) && Color.m4698equalsimpl0(this.disabledBorderColor, ((CheckboxColors) other).disabledBorderColor) && Color.m4698equalsimpl0(this.disabledUncheckedBorderColor, ((CheckboxColors) other).disabledUncheckedBorderColor) && Color.m4698equalsimpl0(this.disabledIndeterminateBorderColor, ((CheckboxColors) other).disabledIndeterminateBorderColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        int result = Color.m4704hashCodeimpl(this.checkedCheckmarkColor);
        return (((((((((((((((((((((result * 31) + Color.m4704hashCodeimpl(this.uncheckedCheckmarkColor)) * 31) + Color.m4704hashCodeimpl(this.checkedBoxColor)) * 31) + Color.m4704hashCodeimpl(this.uncheckedBoxColor)) * 31) + Color.m4704hashCodeimpl(this.disabledCheckedBoxColor)) * 31) + Color.m4704hashCodeimpl(this.disabledUncheckedBoxColor)) * 31) + Color.m4704hashCodeimpl(this.disabledIndeterminateBoxColor)) * 31) + Color.m4704hashCodeimpl(this.checkedBorderColor)) * 31) + Color.m4704hashCodeimpl(this.uncheckedBorderColor)) * 31) + Color.m4704hashCodeimpl(this.disabledBorderColor)) * 31) + Color.m4704hashCodeimpl(this.disabledUncheckedBorderColor)) * 31) + Color.m4704hashCodeimpl(this.disabledIndeterminateBorderColor);
    }
}
