...
public final class DividerDefaults {
    ...
    private static final float Thickness = DividerTokens.INSTANCE.m3440getThicknessD9Ej5fM();

    private DividerDefaults() {
    }

    /* JADX INFO: renamed from: getThickness-D9Ej5fM, reason: not valid java name */
    public final float m2353getThicknessD9Ej5fM() {
        return Thickness;
    }
    ...
    public final long getColor(Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(77461041, $changed, -1, "androidx.compose.material3.DividerDefaults.<get-color> (Divider.kt:118)");
        }
