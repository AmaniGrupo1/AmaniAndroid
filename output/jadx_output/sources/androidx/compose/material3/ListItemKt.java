...
public final class ListItemKt {
    ...
    public static final void m2478ListItemHXNGIdc(final Function2<? super Composer, ? super Integer, Unit> function2, Modifier modifier, Function2<? super Composer, ? super Integer, Unit> function22, Function2<? super Composer, ? super Integer, Unit> function23, Function2<? super Composer, ? super Integer, Unit> function24, Function2<? super Composer, ? super Integer, Unit> function25, ListItemColors colors, float tonalElevation, float shadowElevation, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        ...
        if (i7 != 0) {
            ...
            function26 = function22;
            $dirty |= $composer3.changedInstance(function26) ? 256 : 128;
        } else {
            function26 = function22;
        }
        int i8 = i & 8;
        if (i8 != 0) {
            ...
            function27 = function23;
            $dirty |= $composer3.changedInstance(function27) ? 2048 : 1024;
        } else {
            function27 = function23;
        }
        int i9 = i & 16;
        ...
        if (($dirty & 38347923) == 38347922 && $composer4.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer4.getDefaultsInvalid()) {
                ...
                if ((i & 64) != 0) {
                    i4 = i2;
                    i5 = i3;
                    colors2 = ListItemDefaults.INSTANCE.m2476colorsJ08w3E(0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, $composer4, 805306368, FrameMetricsAggregator.EVERY_DURATION);
                    $composer2 = $composer4;
                    $dirty &= -3670017;
                } else {
                    i4 = i2;
                ...
                float tonalElevation4 = i4 != 0 ? ListItemDefaults.INSTANCE.m2477getElevationD9Ej5fM() : tonalElevation;
                if (i5 != 0) {
                    tonalElevation2 = tonalElevation4;
                    shadowElevation2 = ListItemDefaults.INSTANCE.m2477getElevationD9Ej5fM();
                    colors3 = colors2;
                } else {
            ...
            final Function2 decoratedHeadlineContent = ComposableLambdaKt.rememberComposableLambda(-403249643, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ListItemKt$ListItem$decoratedHeadlineContent$1
                ...
                public final void invoke(Composer $composer5, int $changed2) {
                    ...
                    if (($changed2 & 3) != 2 || !$composer5.getSkipping()) {
                        ...
                        ListItemKt.m2479ProvideTextStyleFromToken3JVO9M(colors3.m2471headlineColorvNxB06k$material3_release(true), ListTokens.INSTANCE.getListItemLabelTextFont(), function2, $composer5, 48);
                        if (ComposerKt.isTraceInProgress()) {
            ...
            if (function27 == null) {
                ...
                function211 = function29;
                leadingContent = ComposableLambdaKt.rememberComposableLambda(-1020860251, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ListItemKt$ListItem$decoratedSupportingContent$1$1
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    /* JADX WARN: Multi-variable type inference failed */
                    {
                        super(2);
                    ...
                    public final void invoke(Composer $composer5, int $changed2) {
                        ...
                        if (($changed2 & 3) != 2 || !$composer5.getSkipping()) {
                            ...
                            ListItemKt.m2479ProvideTextStyleFromToken3JVO9M(colors3.m2474supportingColor0d7_KjU$material3_release(), ListTokens.INSTANCE.getListItemSupportingTextFont(), function216, $composer5, 48);
                            if (ComposerKt.isTraceInProgress()) {
                                ComposerKt.traceEventEnd();
                                return;
                            }
                ...
                decoratedSupportingContent2 = ComposableLambdaKt.rememberComposableLambda(-764441232, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ListItemKt$ListItem$decoratedOverlineContent$1$1
                    ...
                    public final void invoke(Composer $composer5, int $changed2) {
                        ...
                        if (($changed2 & 3) != 2 || !$composer5.getSkipping()) {
                            ...
                            ListItemKt.m2479ProvideTextStyleFromToken3JVO9M(colors3.m2473overlineColor0d7_KjU$material3_release(), ListTokens.INSTANCE.getListItemOverlineFont(), function217, $composer5, 48);
                            if (ComposerKt.isTraceInProgress()) {
                                ComposerKt.traceEventEnd();
                                return;
                            }
            ...
            if (function211 == null) {
                ...
                final Function2<? super Composer, ? super Integer, Unit> function218 = function211;
                decoratedOverlineContent = decoratedSupportingContent2;
                decoratedLeadingContent = ComposableLambdaKt.rememberComposableLambda(1400509200, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ListItemKt$ListItem$decoratedLeadingContent$1$1
                    ...
                    public final void invoke(Composer $composer5, int $changed2) {
                        ...
                        if (($changed2 & 3) != 2 || !$composer5.getSkipping()) {
                            ...
                            Modifier modifier$iv = PaddingKt.m822paddingqDBjuR0$default(Modifier.INSTANCE, 0.0f, 0.0f, ListItemKt.getLeadingContentEndPadding(), 0.0f, 11, null);
                            ...
                            CompositionLocalKt.CompositionLocalProvider(ContentColorKt.getLocalContentColor().provides(Color.m4687boximpl(listItemColors.m2472leadingIconColorvNxB06k$material3_release(true))), function219, $composer5, ProvidedValue.$stable);
                ...
                decoratedTrailingContent = ComposableLambdaKt.rememberComposableLambda(1512306332, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ListItemKt$ListItem$decoratedTrailingContent$1$1
                    ...
                    public final void invoke(Composer $composer5, int $changed2) {
                        ...
                        if (($changed2 & 3) != 2 || !$composer5.getSkipping()) {
                            ...
                            Modifier modifier$iv = PaddingKt.m822paddingqDBjuR0$default(Modifier.INSTANCE, ListItemKt.getTrailingContentStartPadding(), 0.0f, 0.0f, 0.0f, 14, null);
                            ListItemColors listItemColors = colors3;
                            ...
                            ListItemKt.m2479ProvideTextStyleFromToken3JVO9M(listItemColors.m2475trailingIconColorvNxB06k$material3_release(true), ListTokens.INSTANCE.getListItemTrailingSupportingTextFont(), function220, $composer5, 48);
                            ComposerKt.sourceInformationMarkerEnd($composer5);
                            ComposerKt.sourceInformationMarkerEnd($composer5);
                            $composer5.endNode();
                            ComposerKt.sourceInformationMarkerEnd($composer5);
            ...
            SurfaceKt.m2826SurfaceT9BRK9s(SemanticsModifierKt.semantics(Modifier.INSTANCE, true, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.ListItemKt$ListItem$1
                ...
                public final void invoke(Composer $composer6, int $changed2) {
                    ...
                    if (($changed2 & 3) != 2 || !$composer6.getSkipping()) {
                        ...
                        ListItemKt.ListItemLayout(decoratedLeadingContent2, decoratedTrailingContent2, decoratedHeadlineContent, decoratedOverlineContent, decoratedSupportingContent, $composer6, RendererCapabilities.DECODER_SUPPORT_MASK);
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                            return;
                        }
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ListItemKt$ListItem$3
                ...
                public final void invoke(Composer composer, int i13) {
                    ListItemKt.m2478ListItemHXNGIdc(function2, modifier3, function213, function214, function215, function212, colors4, tonalElevation3, shadowElevation3, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    public static final void ListItemLayout(final Function2<? super Composer, ? super Integer, Unit> function2, final Function2<? super Composer, ? super Integer, Unit> function22, final Function2<? super Composer, ? super Integer, Unit> function23, final Function2<? super Composer, ? super Integer, Unit> function24, final Function2<? super Composer, ? super Integer, Unit> function25, Composer $composer, final int $changed) {
        ...
        if (($dirty & 9363) == 9362 && $composer2.getSkipping()) {
            ...
            function2Arr[1] = function24 == null ? ComposableSingletons$ListItemKt.INSTANCE.m2249getLambda1$material3_release() : function24;
            function2Arr[2] = function25 == null ? ComposableSingletons$ListItemKt.INSTANCE.m2250getLambda2$material3_release() : function25;
            function2Arr[3] = function2 == null ? ComposableSingletons$ListItemKt.INSTANCE.m2251getLambda3$material3_release() : function2;
            function2Arr[4] = function22 == null ? ComposableSingletons$ListItemKt.INSTANCE.m2252getLambda4$material3_release() : function22;
            ...
            boolean invalid$iv$iv = (((384 & 896) ^ RendererCapabilities.DECODER_SUPPORT_MASK) > 256 && $composer2.changed(measurePolicy)) || (384 & RendererCapabilities.DECODER_SUPPORT_MASK) == 256;
    ...
    public static final int m2485calculateWidthyeHjK3Y(IntrinsicMeasureScope $this$calculateWidth_u2dyeHjK3Y, int leadingWidth, int trailingWidth, int headlineWidth, int overlineWidth, int supportingWidth, int horizontalPadding, long constraints) {
        if (Constraints.m7454getHasBoundedWidthimpl(constraints)) {
            return Constraints.m7458getMaxWidthimpl(constraints);
        }
    ...
    public static final int m2484calculateHeightN4Jib3Y(IntrinsicMeasureScope $this$calculateHeight_u2dN4Jib3Y, int leadingHeight, int trailingHeight, int headlineHeight, int overlineHeight, int supportingHeight, int listItemType, int verticalPadding, long constraints) {
        float defaultMinHeight;
        if (ListItemType.m2491equalsimpl0(listItemType, ListItemType.INSTANCE.m2496getOneLineAlXitO8())) {
            defaultMinHeight = ListTokens.INSTANCE.m3593getListItemOneLineContainerHeightD9Ej5fM();
        } else {
            defaultMinHeight = ListItemType.m2491equalsimpl0(listItemType, ListItemType.INSTANCE.m2498getTwoLineAlXitO8()) ? ListTokens.INSTANCE.m3598getListItemTwoLineContainerHeightD9Ej5fM() : ListTokens.INSTANCE.m3595getListItemThreeLineContainerHeightD9Ej5fM();
        }
        int minHeight = Math.max(Constraints.m7459getMinHeightimpl(constraints), $this$calculateHeight_u2dN4Jib3Y.mo399roundToPx0680j_4(defaultMinHeight));
        int mainContentHeight = headlineHeight + overlineHeight + supportingHeight;
        return RangesKt.coerceAtMost(Math.max(minHeight, Math.max(leadingHeight, Math.max(mainContentHeight, trailingHeight)) + verticalPadding), Constraints.m7457getMaxHeightimpl(constraints));
    }
    ...
    public static final void m2479ProvideTextStyleFromToken3JVO9M(final long color, final TypographyKeyTokens textToken, final Function2<? super Composer, ? super Integer, Unit> function2, Composer $composer, final int $changed) {
        ...
        if (($dirty2 & 147) != 146 || !$composer2.getSkipping()) {
            ...
            ProvideContentColorTextStyleKt.m3185ProvideContentColorTextStyle3JVO9M(color, TypographyKt.getValue(textToken, $composer2, ($dirty2 >> 3) & 14), function22, $composer2, ($dirty2 & 14) | ($dirty2 & 896));
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        } else {
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ListItemKt$ProvideTextStyleFromToken$1
                ...
                public final void invoke(Composer composer, int i) {
                    ListItemKt.m2479ProvideTextStyleFromToken3JVO9M(color, textToken, function2, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1));
                }
            });
        }
    }
    ...
    public static final boolean isSupportingMultilineHeuristic(Density $this$isSupportingMultilineHeuristic, int estimatedSupportingHeight) {
        return estimatedSupportingHeight > $this$isSupportingMultilineHeuristic.mo398roundToPxR2X_6o(TextUnitKt.getSp(30));
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: verticalPadding-yh95HIg, reason: not valid java name */
    public static final float m2486verticalPaddingyh95HIg(int listItemType) {
        return ListItemType.m2491equalsimpl0(listItemType, ListItemType.INSTANCE.m2497getThreeLineAlXitO8()) ? ListItemThreeLineVerticalPadding : ListItemVerticalPadding;
    }
