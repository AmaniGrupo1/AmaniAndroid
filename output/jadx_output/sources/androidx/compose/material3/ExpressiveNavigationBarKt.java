...
public final class ExpressiveNavigationBarKt {
    ...
    private static final float IconSize = Dp.m7505constructorimpl((float) 24.0d);
    private static final float TopIconItemActiveIndicatorWidth = Dp.m7505constructorimpl(56);
    private static final float TopIconItemActiveIndicatorHeight = Dp.m7505constructorimpl(32);
    private static final float StartIconItemActiveIndicatorHeight = Dp.m7505constructorimpl(40);
    ...
    private static final float NavigationBarHeight = Dp.m7505constructorimpl(64);
    private static final float TopIconItemVerticalPadding = Dp.m7505constructorimpl(6);

    /* JADX INFO: renamed from: ExpressiveNavigationBar-NiJtXQ4, reason: not valid java name */
    public static final void m2378ExpressiveNavigationBarNiJtXQ4(Modifier modifier, long containerColor, long contentColor, WindowInsets windowInsets, int arrangement, final Function2<? super Composer, ? super Integer, Unit> function2, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        ...
        if (($changed & 3072) == 0) {
            if ((i & 8) == 0) {
                ...
                int i6 = $composer3.changed(windowInsets2) ? 2048 : 1024;
                $dirty |= i6;
            } else {
                windowInsets2 = windowInsets;
            }
        ...
        if (($changed & 24576) == 0) {
            if ((i & 16) == 0) {
                i2 = arrangement;
                int i7 = $composer3.changed(i2) ? 16384 : 8192;
                $dirty |= i7;
            } else {
                i2 = arrangement;
            }
        ...
        if ((74899 & $dirty) == 74898 && $composer3.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer3.getDefaultsInvalid()) {
                ...
                if ((i & 16) != 0) {
                    arrangement2 = ExpressiveNavigationBarDefaults.INSTANCE.m2377getArrangementEbr7WPU();
                    $dirty &= -57345;
            ...
            $composer2 = $composer3;
            SurfaceKt.m2826SurfaceT9BRK9s(null, null, containerColor3, contentColor3, 0.0f, 0.0f, null, ComposableLambdaKt.rememberComposableLambda(1573697866, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ExpressiveNavigationBarKt$ExpressiveNavigationBar$1
                ...
                public final void invoke(Composer $composer4, int $changed2) {
                    ...
                    if (($changed2 & 3) != 2 || !$composer4.getSkipping()) {
                        ...
                        Modifier modifierSelectableGroup = SelectableGroupKt.selectableGroup(SizeKt.m849defaultMinSizeVpY3zN4$default(WindowInsetsPaddingKt.windowInsetsPadding(modifier3, windowInsets2), 0.0f, ExpressiveNavigationBarKt.NavigationBarHeight, 1, null));
                        int i8 = arrangement2;
                        if (NavigationBarArrangement.m2535equalsimpl0(i8, NavigationBarArrangement.INSTANCE.m2540getEqualWeightEbr7WPU())) {
                            centeredContentMeasurePolicy = new EqualWeightContentMeasurePolicy();
                        } else if (NavigationBarArrangement.m2535equalsimpl0(i8, NavigationBarArrangement.INSTANCE.m2539getCenteredEbr7WPU())) {
                        ...
                        Modifier materialized$iv = ComposedModifierKt.materializeModifier($composer4, modifierSelectableGroup);
                        ...
                        Updater.m3975setimpl($this$Layout_u24lambda_u240$iv, centeredContentMeasurePolicy, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
                        ...
                        function22.invoke($composer4, Integer.valueOf(($changed$iv$iv >> 6) & 14));
                        $composer4.endNode();
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ExpressiveNavigationBarKt$ExpressiveNavigationBar$2
                ...
                public final void invoke(Composer composer, int i8) {
                    ExpressiveNavigationBarKt.m2378ExpressiveNavigationBarNiJtXQ4(modifier4, containerColor4, contentColor4, windowInsets3, arrangement3, function2, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    public static final void m2379ExpressiveNavigationBarItemplit6k(final boolean selected, final Function0<Unit> function0, final Function2<? super Composer, ? super Integer, Unit> function2, Modifier modifier, boolean enabled, Function2<? super Composer, ? super Integer, Unit> function22, Function2<? super Composer, ? super Integer, Unit> function23, int iconPosition, NavigationItemColors colors, MutableInteractionSource interactionSource, Composer $composer, final int $changed, final int i) {
        boolean z;
        ...
        if (i6 != 0) {
            ...
            function25 = function22;
            $dirty2 |= $composer3.changedInstance(function25) ? 131072 : 65536;
        } else {
            function25 = function22;
        }
        int i7 = i & 64;
        ...
        if (($changed & 100663296) == 0) {
            $dirty2 |= ((i & 256) == 0 && $composer3.changed(colors)) ? 67108864 : 33554432;
        }
        int i9 = i & 512;
        if (i9 != 0) {
            $dirty2 |= 805306368;
        ...
        if (($dirty2 & 306783379) == 306783378 && $composer3.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer3.getDefaultsInvalid()) {
                ...
                iconPosition2 = i2 != 0 ? NavigationItemIconPosition.INSTANCE.m2593getTopxw1Ddg() : iconPosition;
                if ((i & 256) != 0) {
            ...
            boolean isIconPositionTop = NavigationItemIconPosition.m2588equalsimpl0(iconPosition2, NavigationItemIconPosition.INSTANCE.m2593getTopxw1Ddg());
            ...
            $composer2 = $composer3;
            NavigationItemKt.m2594NavigationItemSHbi2eg(z, function02, function24, TypographyKt.getValue(LabelTextFont, $composer3, 6), ShapesKt.getValue(ActiveIndicatorShape, $composer3, 6), TopIconItemActiveIndicatorWidth, indicatorHorizontalPadding, indicatorVerticalPadding, TopIconIndicatorToLabelPadding, StartIconToLabelPadding, TopIconItemVerticalPadding, colors3, modifier3, enabled3, function27, function28, iconPosition4, interactionSource3, $composer2, ($dirty & 14) | 906166272 | ($dirty & 112) | ($dirty & 896), 6 | (($dirty >> 21) & 112) | (($dirty >> 3) & 896) | (($dirty >> 3) & 7168) | (($dirty >> 3) & 57344) | (($dirty >> 3) & 458752) | (3670016 & ($dirty >> 3)));
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ExpressiveNavigationBarKt$ExpressiveNavigationBarItem$1
                ...
                public final void invoke(Composer composer, int i10) {
                    ExpressiveNavigationBarKt.m2379ExpressiveNavigationBarItemplit6k(selected, function0, function2, modifier4, enabled4, function29, function210, iconPosition3, colors4, interactionSource4, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    static {
        ...
        TopIconIndicatorVerticalPadding = Dp.m7505constructorimpl(Dp.m7505constructorimpl(arg0$iv - other$iv) / 2);
        float arg0$iv2 = TopIconItemActiveIndicatorWidth;
        float other$iv2 = IconSize;
        TopIconIndicatorHorizontalPadding = Dp.m7505constructorimpl(Dp.m7505constructorimpl(arg0$iv2 - other$iv2) / 2);
        float arg0$iv3 = StartIconItemActiveIndicatorHeight;
        float other$iv3 = IconSize;
        StartIconIndicatorVerticalPadding = Dp.m7505constructorimpl(Dp.m7505constructorimpl(arg0$iv3 - other$iv3) / 2);
        TopIconIndicatorToLabelPadding = Dp.m7505constructorimpl(4);
        StartIconIndicatorHorizontalPadding = Dp.m7505constructorimpl(16);
        StartIconToLabelPadding = Dp.m7505constructorimpl(4);
    }
