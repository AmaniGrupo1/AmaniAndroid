...
public final class EnterAlwaysScrollBehavior$nestedScrollConnection$1 implements NestedScrollConnection {
    ...
    */
    public Object mo572onPostFlingRZ2iAVY(long consumed, long j, Continuation<? super Velocity> continuation) {
        ...
        Object $result = enterAlwaysScrollBehavior$nestedScrollConnection$1$onPostFling$12.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        switch (enterAlwaysScrollBehavior$nestedScrollConnection$1$onPostFling$12.label) {
            case 0:
                ResultKt.throwOnFailure($result);
                available = j;
                enterAlwaysScrollBehavior$nestedScrollConnection$1$onPostFling$12.L$0 = this;
                enterAlwaysScrollBehavior$nestedScrollConnection$1$onPostFling$12.J$0 = available;
                enterAlwaysScrollBehavior$nestedScrollConnection$1$onPostFling$12.label = 1;
                objMo572onPostFlingRZ2iAVY = super.mo572onPostFlingRZ2iAVY(consumed, available, enterAlwaysScrollBehavior$nestedScrollConnection$1$onPostFling$12);
                ...
                obj = AppBarKt.settleAppBar(state, fM7744getYimpl, flingAnimationSpec, snapAnimationSpec, enterAlwaysScrollBehavior$nestedScrollConnection$1$onPostFling$12);
                if (obj == coroutine_suspended) {
                    return coroutine_suspended;
                }
                return Velocity.m7734boximpl(Velocity.m7747plusAH228Gc(packedValue, ((Velocity) obj).getPackedValue()));
            case 1:
                long available2 = enterAlwaysScrollBehavior$nestedScrollConnection$1$onPostFling$12.J$0;
                ...
                enterAlwaysScrollBehavior$nestedScrollConnection$1$onPostFling$12.J$0 = packedValue;
                enterAlwaysScrollBehavior$nestedScrollConnection$1$onPostFling$12.label = 2;
                obj = AppBarKt.settleAppBar(state2, fM7744getYimpl2, flingAnimationSpec2, snapAnimationSpec2, enterAlwaysScrollBehavior$nestedScrollConnection$1$onPostFling$12);
                if (obj == coroutine_suspended) {
                }
                return Velocity.m7734boximpl(Velocity.m7747plusAH228Gc(packedValue, ((Velocity) obj).getPackedValue()));
            case 2:
