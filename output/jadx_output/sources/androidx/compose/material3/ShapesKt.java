...
public final class ShapesKt {
    ...
    public static final CornerBasedShape top(CornerBasedShape $this$top) {
        return CornerBasedShape.copy$default($this$top, null, null, CornerSizeKt.m1118CornerSize0680j_4(Dp.m7505constructorimpl((float) 0.0d)), CornerSizeKt.m1118CornerSize0680j_4(Dp.m7505constructorimpl((float) 0.0d)), 3, null);
    }

    public static final CornerBasedShape bottom(CornerBasedShape $this$bottom) {
        return CornerBasedShape.copy$default($this$bottom, CornerSizeKt.m1118CornerSize0680j_4(Dp.m7505constructorimpl((float) 0.0d)), CornerSizeKt.m1118CornerSize0680j_4(Dp.m7505constructorimpl((float) 0.0d)), null, null, 12, null);
    }

    public static final CornerBasedShape start(CornerBasedShape $this$start) {
        return CornerBasedShape.copy$default($this$start, null, CornerSizeKt.m1118CornerSize0680j_4(Dp.m7505constructorimpl((float) 0.0d)), CornerSizeKt.m1118CornerSize0680j_4(Dp.m7505constructorimpl((float) 0.0d)), null, 9, null);
    }

    public static final CornerBasedShape end(CornerBasedShape $this$end) {
        return CornerBasedShape.copy$default($this$end, CornerSizeKt.m1118CornerSize0680j_4(Dp.m7505constructorimpl((float) 0.0d)), null, null, CornerSizeKt.m1118CornerSize0680j_4(Dp.m7505constructorimpl((float) 0.0d)), 6, null);
    }
