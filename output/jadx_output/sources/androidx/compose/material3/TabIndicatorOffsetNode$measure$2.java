    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                Dp dpM7503boximpl = Dp.m7503boximpl(this.$currentTabWidth);
                AnimationSpec animationSpec = TabRowKt.TabRowIndicatorSpec;
                this.label = 1;
                if (animatable.animateTo(dpM7503boximpl, (4 & 2) != 0 ? animatable.defaultSpringSpec : animationSpec, (4 & 4) != 0 ? animatable.getVelocity() : null, (4 & 8) != 0 ? null : null, this) == coroutine_suspended) {
