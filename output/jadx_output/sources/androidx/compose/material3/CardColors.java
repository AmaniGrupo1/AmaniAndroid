...
public final class CardColors {
    ...
    public final CardColors m2107copyjRlVdoo(long containerColor, long contentColor, long disabledContainerColor, long disabledContentColor) {
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof CardColors) && Color.m4698equalsimpl0(this.containerColor, ((CardColors) other).containerColor) && Color.m4698equalsimpl0(this.contentColor, ((CardColors) other).contentColor) && Color.m4698equalsimpl0(this.disabledContainerColor, ((CardColors) other).disabledContainerColor) && Color.m4698equalsimpl0(this.disabledContentColor, ((CardColors) other).disabledContentColor)) {
            return true;
        }
        return false;
    }
