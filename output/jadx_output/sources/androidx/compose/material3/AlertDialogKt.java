...
public final class AlertDialogKt {
    private static final float DialogMinWidth = Dp.m7505constructorimpl(280);
    private static final float DialogMaxWidth = Dp.m7505constructorimpl(560);
    private static final float ButtonsMainAxisSpacing = Dp.m7505constructorimpl(8);
    private static final float ButtonsCrossAxisSpacing = Dp.m7505constructorimpl(12);
    private static final PaddingValues DialogPadding = PaddingKt.m811PaddingValues0680j_4(Dp.m7505constructorimpl(24));
    private static final PaddingValues IconPadding = PaddingKt.m815PaddingValuesa9UjIt4$default(0.0f, 0.0f, 0.0f, Dp.m7505constructorimpl(16), 7, null);
    private static final PaddingValues TitlePadding = PaddingKt.m815PaddingValuesa9UjIt4$default(0.0f, 0.0f, 0.0f, Dp.m7505constructorimpl(16), 7, null);
    private static final PaddingValues TextPadding = PaddingKt.m815PaddingValuesa9UjIt4$default(0.0f, 0.0f, 0.0f, Dp.m7505constructorimpl(24), 7, null);
        ...
        if (($dirty2 & 1171) == 1170 && $composer2.getSkipping()) {
            ...
            AndroidDialog_androidKt.Dialog(function02, properties3, ComposableLambdaKt.rememberComposableLambda(905289008, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.AlertDialogKt.BasicAlertDialog.1
                ...
                public final void invoke(Composer $composer3, int $changed2) {
                    ...
                    ComposerKt.sourceInformation($composer3, "C150@6969L25,155@7183L37,151@7003L306:AlertDialog.kt#uh7d8r");
                    if (($changed2 & 3) != 2 || !$composer3.getSkipping()) {
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventStart(905289008, $changed2, -1, "androidx.compose.material3.BasicAlertDialog.<anonymous> (AlertDialog.kt:150)");
                        }
                        Strings.Companion companion = Strings.INSTANCE;
                        final String dialogPaneDescription = Strings_androidKt.m3257getString2EP1pXo(Strings.m3187constructorimpl(R.string.m3c_dialog), $composer3, 0);
                        Modifier modifierM868sizeInqDBjuR0$default = SizeKt.m868sizeInqDBjuR0$default(modifier4, AlertDialogKt.getDialogMinWidth(), 0.0f, AlertDialogKt.getDialogMaxWidth(), 0.0f, 10, null);
                        Modifier.Companion companion2 = Modifier.INSTANCE;
                        ComposerKt.sourceInformationMarkerStart($composer3, -1349419811, "CC(remember):AlertDialog.kt#9igjgp");
                        boolean invalid$iv = $composer3.changed(dialogPaneDescription);
                        Object it$iv = $composer3.rememberedValue();
                        if (invalid$iv || it$iv == Composer.INSTANCE.getEmpty()) {
                            value$iv = (Function1) new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.AlertDialogKt$BasicAlertDialog$1$1$1
                                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                {
                                    super(1);
                                }
                        ...
                        Modifier modifier$iv = modifierM868sizeInqDBjuR0$default.then(SemanticsModifierKt.semantics$default(companion2, false, (Function1) value$iv, 1, null));
                        ...
                        ComposerKt.sourceInformationMarkerStart($composer3, 1061665763, "C158@7290L9:AlertDialog.kt#uh7d8r");
            ...
            }, $composer2, 54), $composer2, ($dirty2 & 14) | RendererCapabilities.DECODER_SUPPORT_MASK | (($dirty2 >> 3) & 112), 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            modifier3 = modifier4;
    ...
    public static final void m2042AlertDialogImplwrnwzgE(final Function0<Unit> function0, final Function2<? super Composer, ? super Integer, Unit> function2, final Modifier modifier, final Function2<? super Composer, ? super Integer, Unit> function22, final Function2<? super Composer, ? super Integer, Unit> function23, final Function2<? super Composer, ? super Integer, Unit> function24, final Function2<? super Composer, ? super Integer, Unit> function25, final Shape shape, final long containerColor, final long iconContentColor, final long titleContentColor, final long textContentColor, final float tonalElevation, final DialogProperties properties, Composer $composer, final int $changed, final int $changed1) {
        ...
        if (($changed & 805306368) == 0) {
            $dirty = $dirty2 | ($composer3.changed(iconContentColor) ? C.BUFFER_FLAG_LAST_SAMPLE : 268435456);
        } else {
            $dirty = $dirty2;
        }
        int $dirty3 = $dirty;
            ...
            BasicAlertDialog(function02, modifier, properties, ComposableLambdaKt.rememberComposableLambda(-1852840226, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.AlertDialogKt$AlertDialogImpl$1
                ...
                public final void invoke(Composer $composer4, int $changed2) {
                    ...
                    if (($changed2 & 3) != 2 || !$composer4.getSkipping()) {
                        ...
                        AlertDialogKt.m2040AlertDialogContent4hvqGtA(ComposableLambdaKt.rememberComposableLambda(1163543932, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.AlertDialogKt$AlertDialogImpl$1.1
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            /* JADX WARN: Multi-variable type inference failed */
                            {
                                super(2);
                            ...
                            public final void invoke(Composer $composer5, int $changed3) {
                                ...
                                if (($changed3 & 3) != 2 || !$composer5.getSkipping()) {
                                    ...
                                    AlertDialogKt.m2041AlertDialogFlowRowixp7dh8(f, f2, ComposableLambdaKt.rememberComposableLambda(1887135077, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.AlertDialogKt.AlertDialogImpl.1.1.1
                                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                        /* JADX WARN: Multi-variable type inference failed */
                                        {
                                            super(2);
    ...
    public static final void m2040AlertDialogContent4hvqGtA(final Function2<? super Composer, ? super Integer, Unit> function2, Modifier modifier, final Function2<? super Composer, ? super Integer, Unit> function22, final Function2<? super Composer, ? super Integer, Unit> function23, final Function2<? super Composer, ? super Integer, Unit> function24, final Shape shape, final long containerColor, final float tonalElevation, final long buttonContentColor, final long iconContentColor, final long titleContentColor, final long textContentColor, Composer $composer, final int $changed, final int $changed1, final int i) {
        ...
        if ((i & 512) != 0) {
            ...
            $dirty |= $composer3.changed(iconContentColor) ? C.BUFFER_FLAG_LAST_SAMPLE : 268435456;
        }
        int $dirty3 = $dirty;
        if ((i & 1024) != 0) {
            $dirty1 |= 6;
        ...
        if (($dirty3 & 306783379) != 306783378 || ($dirty1 & 19) != 18 || !$composer3.getSkipping()) {
            ...
            SurfaceKt.m2826SurfaceT9BRK9s(modifier4, shape2, containerColor, 0L, f, 0.0f, null, ComposableLambdaKt.rememberComposableLambda(-2126308228, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.AlertDialogKt$AlertDialogContent$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
                    super(2);
                ...
                */
                public final void invoke(Composer $composer4, int $changed2) {
                    ...
                    ComposerKt.sourceInformation($composer4, "C300@12338L2046:AlertDialog.kt#uh7d8r");
                    if (($changed2 & 3) != 2 || !$composer4.getSkipping()) {
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventStart(-2126308228, $changed2, -1, "androidx.compose.material3.AlertDialogContent.<anonymous> (AlertDialog.kt:300)");
                        }
                        ...
                        long j6 = iconContentColor;
                        long j7 = j2;
                        long j8 = textContentColor;
                        long j9 = buttonContentColor;
                        ...
                        ComposerKt.sourceInformationMarkerStart($composer4, 455478874, "C343@14042L332:AlertDialog.kt#uh7d8r");
                        $composer4.startReplaceGroup(-1924971291);
                        ComposerKt.sourceInformation($composer4, "*302@12501L165,302@12431L235");
                        if (function212 == null) {
                            j3 = j7;
                        } else {
                            j3 = j7;
                            CompositionLocalKt.CompositionLocalProvider(ContentColorKt.getLocalContentColor().provides(Color.m4687boximpl(j6)), ComposableLambdaKt.rememberComposableLambda(934657765, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.AlertDialogKt$AlertDialogContent$1$1$1$1
                                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                /* JADX WARN: Multi-variable type inference failed */
                                {
                                    super(2);
                                ...
                                public final void invoke(Composer $composer6, int $changed3) {
                                    ...
                                    ComposerKt.sourceInformation($composer6, "C303@12523L125:AlertDialog.kt#uh7d8r");
                                    if (($changed3 & 3) != 2 || !$composer6.getSkipping()) {
                                        if (ComposerKt.isTraceInProgress()) {
                                            ComposerKt.traceEventStart(934657765, $changed3, -1, "androidx.compose.material3.AlertDialogContent.<anonymous>.<anonymous>.<anonymous>.<anonymous> (AlertDialog.kt:303)");
                                        }
                                        ...
                                        Composer $this$Layout_u24lambda_u240$iv$iv2 = Updater.m3967constructorimpl($composer6);
                                        ...
                                        BoxScopeInstance boxScopeInstance = BoxScopeInstance.INSTANCE;
                                        int i7 = ((0 >> 6) & 112) | 6;
                                        ComposerKt.sourceInformationMarkerStart($composer6, -1509127830, "C304@12620L6:AlertDialog.kt#uh7d8r");
                        ...
                        $composer4.startReplaceGroup(-1924961479);
                        ComposerKt.sourceInformation($composer4, "*311@12864L5,312@12888L569,309@12722L735");
                        if (function213 == null) {
                            j4 = j8;
                            j5 = j9;
                            str = "CC(Layout)P(!1,2)78@3182L23,81@3333L411:Layout.kt#80mrfh";
                        } else {
                            TextStyle value = TypographyKt.getValue(DialogTokens.INSTANCE.getHeadlineFont(), $composer4, 6);
                            ComposableLambda composableLambdaRememberComposableLambda = ComposableLambdaKt.rememberComposableLambda(434448772, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.AlertDialogKt$AlertDialogContent$1$1$2$1
                                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                /* JADX WARN: Multi-variable type inference failed */
                                {
                                    super(2);
                                ...
                                public final void invoke(Composer $composer6, int $changed3) {
                                    ...
                                    Function0<ComposeUiNode> function02;
                                    ComposerKt.sourceInformation($composer6, "C313@12910L529:AlertDialog.kt#uh7d8r");
                                    if (($changed3 & 3) != 2 || !$composer6.getSkipping()) {
                                        if (ComposerKt.isTraceInProgress()) {
                                            ComposerKt.traceEventStart(434448772, $changed3, -1, "androidx.compose.material3.AlertDialogContent.<anonymous>.<anonymous>.<anonymous>.<anonymous> (AlertDialog.kt:313)");
                                        }
                                        ...
                                        Modifier modifier$iv2 = columnScope.align(modifierPadding, centerHorizontally);
                                        ...
                                        BoxScopeInstance boxScopeInstance = BoxScopeInstance.INSTANCE;
                                        int i7 = ((0 >> 6) & 112) | 6;
                                        ComposerKt.sourceInformationMarkerStart($composer6, -1508344119, "C324@13410L7:AlertDialog.kt#uh7d8r");
                                        function216.invoke($composer6, 0);
                                        ComposerKt.sourceInformationMarkerEnd($composer6);
                                        ComposerKt.sourceInformationMarkerEnd($composer6);
                                        $composer6.endNode();
                            ...
                            j4 = j8;
                            j5 = j9;
                            ProvideContentColorTextStyleKt.m3185ProvideContentColorTextStyle3JVO9M(j3, value, composableLambdaRememberComposableLambda, $composer4, RendererCapabilities.DECODER_SUPPORT_MASK);
                        }
                        $composer4.endReplaceGroup();
                        $composer4.startReplaceGroup(-1924936431);
                        ComposerKt.sourceInformation($composer4, "*329@13560L5,333@13725L290,330@13582L433");
                        if (function214 == null) {
                            $composer5 = $composer4;
                            function210 = function215;
                        } else {
                            TextStyle textStyle = TypographyKt.getValue(DialogTokens.INSTANCE.getSupportingTextFont(), $composer4, 6);
                            function210 = function215;
                            ProvideContentColorTextStyleKt.m3185ProvideContentColorTextStyle3JVO9M(j4, textStyle, ComposableLambdaKt.rememberComposableLambda(-796843771, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.AlertDialogKt$AlertDialogContent$1$1$3$1
                                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                /* JADX WARN: Multi-variable type inference failed */
                                {
                                    super(2);
                                ...
                                public final void invoke(Composer $composer6, int $changed3) {
                                    Function0<ComposeUiNode> function02;
                                    ComposerKt.sourceInformation($composer6, "C334@13747L250:AlertDialog.kt#uh7d8r");
                                    if (($changed3 & 3) != 2 || !$composer6.getSkipping()) {
                                        if (ComposerKt.isTraceInProgress()) {
                                            ComposerKt.traceEventStart(-796843771, $changed3, -1, "androidx.compose.material3.AlertDialogContent.<anonymous>.<anonymous>.<anonymous>.<anonymous> (AlertDialog.kt:334)");
                                        }
                                        Modifier modifier$iv2 = $this$invoke_u24lambda_u244.align(PaddingKt.padding($this$invoke_u24lambda_u244.weight(Modifier.INSTANCE, 1.0f, false), AlertDialogKt.TextPadding), Alignment.INSTANCE.getStart());
                                        ...
                                        BoxScopeInstance boxScopeInstance = BoxScopeInstance.INSTANCE;
                                        int i7 = ((0 >> 6) & 112) | 6;
                                        ComposerKt.sourceInformationMarkerStart($composer6, -1507789622, "C339@13969L6:AlertDialog.kt#uh7d8r");
                                        function216.invoke($composer6, 0);
                                        ComposerKt.sourceInformationMarkerEnd($composer6);
                                        ComposerKt.sourceInformationMarkerEnd($composer6);
                                        $composer6.endNode();
                        ...
                        if (!$this$Layout_u24lambda_u240$iv$iv2.getInserting()) {
                            ...
                            BoxScopeInstance boxScopeInstance = BoxScopeInstance.INSTANCE;
                            int i7 = ((0 >> 6) & 112) | 6;
                            ComposerKt.sourceInformationMarkerStart($composer$iv, -1768340368, "C344@14155L5,345@14177L183:AlertDialog.kt#uh7d8r");
                            TextStyle textStyle2 = TypographyKt.getValue(DialogTokens.INSTANCE.getActionLabelTextFont(), $composer$iv, 6);
                            ProvideContentColorTextStyleKt.m3185ProvideContentColorTextStyle3JVO9M(j5, textStyle2, function211, $composer$iv, 0);
                        ...
                        int i72 = ((0 >> 6) & 112) | 6;
                        ComposerKt.sourceInformationMarkerStart($composer$iv2, -1768340368, "C344@14155L5,345@14177L183:AlertDialog.kt#uh7d8r");
                        TextStyle textStyle22 = TypographyKt.getValue(DialogTokens.INSTANCE.getActionLabelTextFont(), $composer$iv2, 6);
                        ProvideContentColorTextStyleKt.m3185ProvideContentColorTextStyle3JVO9M(j5, textStyle22, function211, $composer$iv2, 0);
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.AlertDialogKt$AlertDialogContent$2
                ...
                public final void invoke(Composer composer, int i4) {
                    AlertDialogKt.m2040AlertDialogContent4hvqGtA(function2, modifier3, function22, function23, function24, shape, containerColor, tonalElevation, buttonContentColor, iconContentColor, titleContentColor, textContentColor, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), RecomposeScopeImplKt.updateChangedFlags($changed1), i);
                }
            });
        }
    }
    ...
    public static final void m2041AlertDialogFlowRowixp7dh8(final float mainAxisSpacing, final float crossAxisSpacing, final Function2<? super Composer, ? super Integer, Unit> function2, Composer $composer, final int $changed) {
        MeasurePolicy value$iv;
        Composer $composer2 = $composer.startRestartGroup(586821353);
        ComposerKt.sourceInformation($composer2, "C(AlertDialogFlowRow)P(2:c#ui.unit.Dp,1:c#ui.unit.Dp)365@14664L3370,365@14648L3386:AlertDialog.kt#uh7d8r");
        int $dirty = $changed;
        if (($changed & 6) == 0) {
        ...
        if (($dirty & 147) != 146 || !$composer2.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(586821353, $dirty, -1, "androidx.compose.material3.AlertDialogFlowRow (AlertDialog.kt:364)");
            }
            ComposerKt.sourceInformationMarkerStart($composer2, -767073803, "CC(remember):AlertDialog.kt#9igjgp");
                ...
                value$iv = new MeasurePolicy() { // from class: androidx.compose.material3.AlertDialogKt$AlertDialogFlowRow$1$1
                    ...
                    public final MeasureResult mo41measure3p2s80s(final MeasureScope $this$Layout, List<? extends Measurable> list, long constraints) {
                        ...
                        while (index$iv2 < size) {
                            ...
                            Placeable placeable = measurable.mo6141measureBRTryo0(constraints);
                            int i = size;
                            ...
                            if (!currentSequence.isEmpty()) {
                                currentMainAxisSize.element += $this$Layout.mo399roundToPx0680j_4(f);
                            }
                        ...
                        if (currentSequence.isEmpty()) {
                            ...
                            measure_3p2s80s$startNewSequence(sequences, crossAxisSpace, $this$Layout, crossAxisSpacing, currentSequence, crossAxisSizes, currentCrossAxisSize2, crossAxisPositions, mainAxisSpace, currentMainAxisSize);
                            currentCrossAxisSize = crossAxisSpace;
                        }
                        final int mainAxisLayoutSize = Math.max(mainAxisSpace.element, Constraints.m7460getMinWidthimpl(constraints));
                        ...
                        final float f3 = mainAxisSpacing;
                        return MeasureScope.layout$default($this$Layout, mainAxisLayoutSize, crossAxisLayoutSize, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.AlertDialogKt$AlertDialogFlowRow$1$1.2
                            ...
                            public final void invoke2(Placeable.PlacementScope $this$layout) {
                                List<List<Placeable>> list4 = sequences3;
                                ...
                                while (index$iv3 < size2) {
                                    ...
                                    int i4 = 0;
                                    while (i4 < size3) {
                                        childrenMainAxisSizes[i4] = list6.get(i4).getWidth() + (i4 < CollectionsKt.getLastIndex(list6) ? measureScope.mo399roundToPx0680j_4(f4) : 0);
                                        i4++;
                                    }
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.AlertDialogKt$AlertDialogFlowRow$2
                ...
                public final void invoke(Composer composer, int i) {
                    AlertDialogKt.m2041AlertDialogFlowRowixp7dh8(mainAxisSpacing, crossAxisSpacing, function2, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1));
                }
            });
        }
    }
