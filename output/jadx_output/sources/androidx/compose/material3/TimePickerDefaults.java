...
public final class TimePickerDefaults {
    ...
    public final TimePickerColors m3000colorsu3YEpmA(long clockDialColor, long clockDialSelectedContentColor, long clockDialUnselectedContentColor, long selectorColor, long containerColor, long periodSelectorBorderColor, long periodSelectorSelectedContainerColor, long periodSelectorUnselectedContainerColor, long periodSelectorSelectedContentColor, long periodSelectorUnselectedContentColor, long timeSelectorSelectedContainerColor, long timeSelectorUnselectedContainerColor, long timeSelectorSelectedContentColor, long timeSelectorUnselectedContentColor, Composer $composer, int $changed, int $changed1, int i) {
        ...
        long clockDialColor2 = (i & 1) != 0 ? Color.INSTANCE.m4733getUnspecified0d7_KjU() : clockDialColor;
        long clockDialSelectedContentColor2 = (i & 2) != 0 ? Color.INSTANCE.m4733getUnspecified0d7_KjU() : clockDialSelectedContentColor;
        long clockDialUnselectedContentColor2 = (i & 4) != 0 ? Color.INSTANCE.m4733getUnspecified0d7_KjU() : clockDialUnselectedContentColor;
        long selectorColor2 = (i & 8) != 0 ? Color.INSTANCE.m4733getUnspecified0d7_KjU() : selectorColor;
        long containerColor2 = (i & 16) != 0 ? Color.INSTANCE.m4733getUnspecified0d7_KjU() : containerColor;
        long periodSelectorBorderColor2 = (i & 32) != 0 ? Color.INSTANCE.m4733getUnspecified0d7_KjU() : periodSelectorBorderColor;
        long periodSelectorSelectedContainerColor2 = (i & 64) != 0 ? Color.INSTANCE.m4733getUnspecified0d7_KjU() : periodSelectorSelectedContainerColor;
        long periodSelectorUnselectedContainerColor2 = (i & 128) != 0 ? Color.INSTANCE.m4733getUnspecified0d7_KjU() : periodSelectorUnselectedContainerColor;
        long periodSelectorSelectedContentColor2 = (i & 256) != 0 ? Color.INSTANCE.m4733getUnspecified0d7_KjU() : periodSelectorSelectedContentColor;
        long periodSelectorUnselectedContentColor2 = (i & 512) != 0 ? Color.INSTANCE.m4733getUnspecified0d7_KjU() : periodSelectorUnselectedContentColor;
        long timeSelectorSelectedContainerColor2 = (i & 1024) != 0 ? Color.INSTANCE.m4733getUnspecified0d7_KjU() : timeSelectorSelectedContainerColor;
        long timeSelectorUnselectedContainerColor2 = (i & 2048) != 0 ? Color.INSTANCE.m4733getUnspecified0d7_KjU() : timeSelectorUnselectedContainerColor;
        long timeSelectorSelectedContentColor2 = (i & 4096) != 0 ? Color.INSTANCE.m4733getUnspecified0d7_KjU() : timeSelectorSelectedContentColor;
        long timeSelectorUnselectedContentColor2 = (i & 8192) != 0 ? Color.INSTANCE.m4733getUnspecified0d7_KjU() : timeSelectorUnselectedContentColor;
        if (ComposerKt.isTraceInProgress()) {
        ...
        TimePickerColors timePickerColorsM2981copydVHXu7A = getDefaultTimePickerColors$material3_release(MaterialTheme.INSTANCE.getColorScheme($composer, 6)).m2981copydVHXu7A(clockDialColor2, selectorColor2, containerColor2, periodSelectorBorderColor2, clockDialSelectedContentColor2, clockDialUnselectedContentColor2, periodSelectorSelectedContainerColor2, periodSelectorUnselectedContainerColor2, periodSelectorSelectedContentColor2, periodSelectorUnselectedContentColor2, timeSelectorSelectedContainerColor2, timeSelectorUnselectedContainerColor2, timeSelectorSelectedContentColor2, timeSelectorUnselectedContentColor2);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd($composer);
        return timePickerColorsM2981copydVHXu7A;
    }
    ...
    public final int m3001layoutTypesDNSZnc(Composer $composer, int $changed) {
