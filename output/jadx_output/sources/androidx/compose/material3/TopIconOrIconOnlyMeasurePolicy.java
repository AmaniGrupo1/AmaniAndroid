    ...
    public MeasureResult mo41measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, List<? extends Measurable> list, long constraints) {
        ...
        while (index$iv$iv < size) {
            ...
            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(it), "icon")) {
                ...
                int i = -measureScope.mo399roundToPx0680j_4(Dp.m7505constructorimpl(2 * arg0$iv));
                float arg0$iv2 = this.indicatorVerticalPadding;
                Placeable iconPlaceable = ((Measurable) item$iv$iv).mo6141measureBRTryo0(ConstraintsKt.m7477offsetNN6EwU(looseConstraints, i, -measureScope.mo399roundToPx0680j_4(Dp.m7505constructorimpl(2 * arg0$iv2))));
                int width = iconPlaceable.getWidth();
                float arg0$iv3 = this.indicatorHorizontalPadding;
                int totalIndicatorWidth = width + measureScope.mo399roundToPx0680j_4(Dp.m7505constructorimpl(2 * arg0$iv3));
                int height = iconPlaceable.getHeight();
                float arg0$iv4 = this.indicatorVerticalPadding;
                int indicatorHeight = height + measureScope.mo399roundToPx0680j_4(Dp.m7505constructorimpl(2 * arg0$iv4));
                ...
                while (index$iv$iv2 < size2) {
                    ...
                    if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(it2), "indicatorRipple")) {
                        Placeable indicatorRipplePlaceable = ((Measurable) item$iv$iv2).mo6141measureBRTryo0(ConstraintsKt.m7473constrainN9IONVI(looseConstraints, Constraints.INSTANCE.m7468fixedJhjzzOo(totalIndicatorWidth, indicatorHeight)));
                        int index$iv$iv3 = 0;
                        int size3 = list.size();
                        while (index$iv$iv3 < size3) {
                            ...
                            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(it3), "indicator")) {
                                Placeable indicatorPlaceable = ((Measurable) item$iv$iv3).mo6141measureBRTryo0(ConstraintsKt.m7473constrainN9IONVI(looseConstraints, Constraints.INSTANCE.m7468fixedJhjzzOo(animatedIndicatorWidth, indicatorHeight)));
                                if (!this.hasLabel) {
                                    return NavigationItemKt.m2600placeIconX9ElhV4($this$measure_u2d3p2s80s, iconPlaceable2, indicatorRipplePlaceable2, indicatorPlaceable, constraints);
                                }
                                ...
                                while (index$iv$iv4 < size4) {
                                    ...
                                    if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(it4), "label")) {
                                        Placeable labelPlaceable = ((Measurable) item$iv$iv4).mo6141measureBRTryo0(ConstraintsKt.m7478offsetNN6EwU$default(looseConstraints, 0, -(indicatorPlaceable2.getHeight() + measureScope.mo399roundToPx0680j_4(this.indicatorToLabelVerticalPadding)), 1, null));
                                        return NavigationItemKt.m2602placeLabelAndTopIconqoqLrGI(measureScope, labelPlaceable, iconPlaceable2, indicatorRipplePlaceable2, indicatorPlaceable2, constraints, this.indicatorToLabelVerticalPadding, this.indicatorVerticalPadding, this.topIconItemVerticalPadding);
                                    }
                                    index$iv$iv4++;
    ...
    public int maxIntrinsicHeight(IntrinsicMeasureScope $this$maxIntrinsicHeight, List<? extends IntrinsicMeasurable> list, int width) {
        ...
        for (int index$iv$iv = 0; index$iv$iv < size; index$iv$iv++) {
            ...
            if (Intrinsics.areEqual(TextFieldImplKt.getLayoutId(it), "icon")) {
                ...
                float arg0$iv2 = Dp.m7505constructorimpl(2 * arg0$iv);
                float arg0$iv3 = this.indicatorVerticalPadding;
                float arg0$iv4 = Dp.m7505constructorimpl(arg0$iv2 + Dp.m7505constructorimpl(2 * arg0$iv3));
                float other$iv = this.indicatorToLabelVerticalPadding;
                int paddings = $this$maxIntrinsicHeight.mo399roundToPx0680j_4(Dp.m7505constructorimpl(arg0$iv4 + other$iv));
