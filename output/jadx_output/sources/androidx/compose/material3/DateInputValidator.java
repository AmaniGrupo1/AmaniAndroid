...
public final class DateInputValidator {
    ...
    */
    public final String m2277validateXivgLIo(CalendarDate dateToValidate, int inputIdentifier, Locale locale) {
        ...
        SelectableDates $this$validate_XivgLIo_u24lambda_u240 = this.selectableDates;
        if (!$this$validate_XivgLIo_u24lambda_u240.isSelectableYear(dateToValidate.getYear()) || !$this$validate_XivgLIo_u24lambda_u240.isSelectableDate(dateToValidate.getUtcTimeMillis())) {
        ...
        if (InputIdentifier.m2453equalsimpl0(inputIdentifier, InputIdentifier.INSTANCE.m2459getStartDateInputJ2x2o4M())) {
            ...
            if (utcTimeMillis < (l != null ? l.longValue() : Long.MAX_VALUE)) {
                if (InputIdentifier.m2453equalsimpl0(inputIdentifier, InputIdentifier.INSTANCE.m2457getEndDateInputJ2x2o4M())) {
