...
public final class TopAppBarColors {
    ...
    public final TopAppBarColors m3133copyt635Npw(long containerColor, long scrolledContainerColor, long navigationIconContentColor, long titleContentColor, long actionIconContentColor) {
    ...
    public final long m3132containerColorvNxB06k$material3_release(float colorTransitionFraction) {
        return ColorKt.m4748lerpjxsXWHM(this.containerColor, this.scrolledContainerColor, EasingKt.getFastOutLinearInEasing().transform(colorTransitionFraction));
    }
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof TopAppBarColors) && Color.m4698equalsimpl0(this.containerColor, ((TopAppBarColors) other).containerColor) && Color.m4698equalsimpl0(this.scrolledContainerColor, ((TopAppBarColors) other).scrolledContainerColor) && Color.m4698equalsimpl0(this.navigationIconContentColor, ((TopAppBarColors) other).navigationIconContentColor) && Color.m4698equalsimpl0(this.titleContentColor, ((TopAppBarColors) other).titleContentColor) && Color.m4698equalsimpl0(this.actionIconContentColor, ((TopAppBarColors) other).actionIconContentColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (((((((result * 31) + Color.m4704hashCodeimpl(this.scrolledContainerColor)) * 31) + Color.m4704hashCodeimpl(this.navigationIconContentColor)) * 31) + Color.m4704hashCodeimpl(this.titleContentColor)) * 31) + Color.m4704hashCodeimpl(this.actionIconContentColor);
    }
}
