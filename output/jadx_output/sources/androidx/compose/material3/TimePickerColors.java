...
public final class TimePickerColors {
    ...
    public static /* synthetic */ TimePickerColors m2979copydVHXu7A$default(TimePickerColors timePickerColors, long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, long j9, long j10, long j11, long j12, long j13, long j14, int i, Object obj) {
        long j15;
        long j16;
        ...
        return timePickerColors.m2981copydVHXu7A(j24, j18, j19, j20, j21, j22, j23, j25, j26, j27, j28, j29, j15, j16);
    }

    /* JADX INFO: renamed from: copy-dVHXu7A, reason: not valid java name */
    public final TimePickerColors m2981copydVHXu7A(long clockDialColor, long selectorColor, long containerColor, long periodSelectorBorderColor, long clockDialSelectedContentColor, long clockDialUnselectedContentColor, long periodSelectorSelectedContainerColor, long periodSelectorUnselectedContainerColor, long periodSelectorSelectedContentColor, long periodSelectorUnselectedContentColor, long timeSelectorSelectedContainerColor, long timeSelectorUnselectedContainerColor, long timeSelectorSelectedContentColor, long timeSelectorUnselectedContentColor) {
        long j;
        long j2;
        long j3;
        long j4;
    ...
    public final long m2996periodSelectorContainerColorvNxB06k$material3_release(boolean selected) {
        if (selected) {
            return this.periodSelectorSelectedContainerColor;
        }
        return this.periodSelectorUnselectedContainerColor;
    ...
    public final long m2997periodSelectorContentColorvNxB06k$material3_release(boolean selected) {
        if (selected) {
            return this.periodSelectorSelectedContentColor;
        }
        return this.periodSelectorUnselectedContentColor;
    ...
    public final long m2998timeSelectorContainerColorvNxB06k$material3_release(boolean selected) {
        if (selected) {
            return this.timeSelectorSelectedContainerColor;
        }
        return this.timeSelectorUnselectedContainerColor;
    ...
    public final long m2999timeSelectorContentColorvNxB06k$material3_release(boolean selected) {
        if (selected) {
            return this.timeSelectorSelectedContentColor;
        }
        return this.timeSelectorUnselectedContentColor;
    ...
    public final long m2980clockDialContentColorvNxB06k$material3_release(boolean selected) {
        if (selected) {
            return this.clockDialSelectedContentColor;
        }
        return this.clockDialUnselectedContentColor;
    ...
    public boolean equals(Object other) {
        ...
        if (Color.m4698equalsimpl0(this.clockDialColor, ((TimePickerColors) other).clockDialColor) && Color.m4698equalsimpl0(this.selectorColor, ((TimePickerColors) other).selectorColor) && Color.m4698equalsimpl0(this.containerColor, ((TimePickerColors) other).containerColor) && Color.m4698equalsimpl0(this.periodSelectorBorderColor, ((TimePickerColors) other).periodSelectorBorderColor) && Color.m4698equalsimpl0(this.periodSelectorSelectedContainerColor, ((TimePickerColors) other).periodSelectorSelectedContainerColor) && Color.m4698equalsimpl0(this.periodSelectorUnselectedContainerColor, ((TimePickerColors) other).periodSelectorUnselectedContainerColor) && Color.m4698equalsimpl0(this.periodSelectorSelectedContentColor, ((TimePickerColors) other).periodSelectorSelectedContentColor) && Color.m4698equalsimpl0(this.periodSelectorUnselectedContentColor, ((TimePickerColors) other).periodSelectorUnselectedContentColor) && Color.m4698equalsimpl0(this.timeSelectorSelectedContainerColor, ((TimePickerColors) other).timeSelectorSelectedContainerColor) && Color.m4698equalsimpl0(this.timeSelectorUnselectedContainerColor, ((TimePickerColors) other).timeSelectorUnselectedContainerColor) && Color.m4698equalsimpl0(this.timeSelectorSelectedContentColor, ((TimePickerColors) other).timeSelectorSelectedContentColor) && Color.m4698equalsimpl0(this.timeSelectorUnselectedContentColor, ((TimePickerColors) other).timeSelectorUnselectedContentColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        int result = Color.m4704hashCodeimpl(this.clockDialColor);
        return (((((((((((((((((((((result * 31) + Color.m4704hashCodeimpl(this.selectorColor)) * 31) + Color.m4704hashCodeimpl(this.containerColor)) * 31) + Color.m4704hashCodeimpl(this.periodSelectorBorderColor)) * 31) + Color.m4704hashCodeimpl(this.periodSelectorSelectedContainerColor)) * 31) + Color.m4704hashCodeimpl(this.periodSelectorUnselectedContainerColor)) * 31) + Color.m4704hashCodeimpl(this.periodSelectorSelectedContentColor)) * 31) + Color.m4704hashCodeimpl(this.periodSelectorUnselectedContentColor)) * 31) + Color.m4704hashCodeimpl(this.timeSelectorSelectedContainerColor)) * 31) + Color.m4704hashCodeimpl(this.timeSelectorUnselectedContainerColor)) * 31) + Color.m4704hashCodeimpl(this.timeSelectorSelectedContentColor)) * 31) + Color.m4704hashCodeimpl(this.timeSelectorUnselectedContentColor);
    }
}
