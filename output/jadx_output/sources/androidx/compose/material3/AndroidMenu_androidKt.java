...
public final class AndroidMenu_androidKt {
    ...
    public static final void m2048DropdownMenuIlH_yew(final boolean expanded, final Function0<Unit> function0, Modifier modifier, long offset, ScrollState scrollState, PopupProperties properties, Shape shape, long containerColor, float tonalElevation, float shadowElevation, BorderStroke border, final Function3<? super ColumnScope, ? super Composer, ? super Integer, Unit> function3, Composer $composer, final int $changed, final int $changed1, final int i) {
        ...
        if (($changed & 24576) == 0) {
            if ((i & 16) == 0) {
                ...
                int i7 = $composer3.changed(scrollState2) ? 16384 : 8192;
                $dirty4 |= i7;
            } else {
                scrollState2 = scrollState;
            }
        ...
        if (($changed & 12582912) == 0) {
            if ((i & 128) == 0) {
                $dirty3 = $dirty4;
                $dirty1 = $changed1;
                int i10 = $composer3.changed(containerColor) ? 8388608 : 4194304;
                $dirty = $dirty3 | i10;
            } else {
                $dirty3 = $dirty4;
                $dirty1 = $changed1;
        ...
        if (($dirty & 306783379) == 306783378 && ($dirty15 & 19) == 18 && $composer3.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer3.getDefaultsInvalid()) {
                ...
                if (i6 != 0) {
                    offset2 = DpKt.m7526DpOffsetYgX7TsA(Dp.m7505constructorimpl(0), Dp.m7505constructorimpl(0));
                }
                if ((i & 16) != 0) {
                ...
                float tonalElevation4 = i2 != 0 ? MenuDefaults.INSTANCE.m2511getTonalElevationD9Ej5fM() : tonalElevation;
            ...
            expandedState2.setTargetState$animation_core(Boolean.valueOf(z));
            if (((Boolean) expandedState2.getCurrentState()).booleanValue() || ((Boolean) expandedState2.getTargetState()).booleanValue()) {
                ...
                if (it$iv2 == Composer.INSTANCE.getEmpty()) {
                    ...
                    value$iv2 = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(TransformOrigin.m5097boximpl(TransformOrigin.INSTANCE.m5110getCenterSzJe1aQ()), null, 2, null);
                ...
                if (invalid$iv || it$iv3 == Composer.INSTANCE.getEmpty()) {
                    ...
                    value$iv3 = new DropdownMenuPositionProvider(offset5, density, 0, new Function2<IntRect, IntRect, Unit>() { // from class: androidx.compose.material3.AndroidMenu_androidKt$DropdownMenu$popupPositionProvider$1$1
                        ...
                        public final void invoke2(IntRect parentBounds, IntRect menuBounds) {
                            transformOriginState.setValue(TransformOrigin.m5097boximpl(MenuKt.calculateTransformOrigin(parentBounds, menuBounds)));
                        }
                    }, 4, null);
                    offset3 = offset5;
                ...
                AndroidPopup_androidKt.Popup(popupPositionProvider, function02, properties2, ComposableLambdaKt.rememberComposableLambda(2126968933, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.AndroidMenu_androidKt$DropdownMenu$1
                    ...
                    public final void invoke(Composer $composer4, int $changed2) {
                        ...
                        if (($changed2 & 3) != 2 || !$composer4.getSkipping()) {
                            ...
                            MenuKt.m2524DropdownMenuContentQj0Zi0g(modifier3, expandedState, transformOriginState, scrollState3, shape4, containerColor3, tonalElevation2, shadowElevation2, border2, function3, $composer4, (MutableTransitionState.$stable << 3) | RendererCapabilities.DECODER_SUPPORT_MASK);
                            if (ComposerKt.isTraceInProgress()) {
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.AndroidMenu_androidKt$DropdownMenu$2
                ...
                public final void invoke(Composer composer, int i13) {
                    AndroidMenu_androidKt.m2048DropdownMenuIlH_yew(expanded, function0, modifier4, offset4, scrollState2, properties3, shape5, containerColor4, tonalElevation3, shadowElevation3, border3, function3, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), RecomposeScopeImplKt.updateChangedFlags($changed1), i);
                }
            });
        }
    }
    ...
    public static final /* synthetic */ void m2046DropdownMenu4kj_NE(final boolean expanded, final Function0 onDismissRequest, Modifier modifier, long offset, ScrollState scrollState, PopupProperties properties, final Function3 content, Composer $composer, final int $changed, final int i) {
        boolean z;
        Function0 function0;
        Modifier modifier2;
        long offset2;
        ...
        if ((599187 & $dirty) == 599186 && $composer3.getSkipping()) {
            ...
            $composer2 = $composer3;
            m2048DropdownMenuIlH_yew(z, function0, modifier3, offset3, scrollState3, properties2, MenuDefaults.INSTANCE.getShape($composer3, 6), MenuDefaults.INSTANCE.getContainerColor($composer3, 6), MenuDefaults.INSTANCE.m2511getTonalElevationD9Ej5fM(), MenuDefaults.INSTANCE.m2510getShadowElevationD9Ej5fM(), null, content, $composer2, ($dirty & 14) | 905969664 | ($dirty & 112) | ($dirty & 896) | ($dirty & 7168) | (57344 & $dirty) | (458752 & $dirty), (($dirty >> 15) & 112) | 6, 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            modifier4 = modifier3;
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.AndroidMenu_androidKt$DropdownMenu$3
                ...
                public final void invoke(Composer composer, int i8) {
                    AndroidMenu_androidKt.m2046DropdownMenu4kj_NE(expanded, onDismissRequest, modifier4, offset4, scrollState4, properties3, content, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    public static final /* synthetic */ void m2047DropdownMenuILWXrKs(final boolean expanded, final Function0 onDismissRequest, Modifier modifier, long offset, PopupProperties properties, final Function3 content, Composer $composer, final int $changed, final int i) {
        boolean z;
        Function0 function0;
        Modifier modifier2;
        long offset2;
        ...
        if ((74899 & $dirty) == 74898 && $composer3.getSkipping()) {
            ...
            m2048DropdownMenuIlH_yew(z, function0, modifier5, offset4, ScrollKt.rememberScrollState(0, $composer3, 0, 1), properties3, null, 0L, 0.0f, 0.0f, null, function3, $composer2, ($dirty & 14) | ($dirty & 112) | ($dirty & 896) | ($dirty & 7168) | (($dirty << 3) & 458752), ($dirty >> 12) & 112, 1984);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            modifier3 = modifier5;
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.AndroidMenu_androidKt$DropdownMenu$4
                ...
                public final void invoke(Composer composer, int i5) {
                    AndroidMenu_androidKt.m2047DropdownMenuILWXrKs(expanded, onDismissRequest, modifier3, offset3, properties2, content, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    public static final void DropdownMenuItem(final Function2<? super Composer, ? super Integer, Unit> function2, final Function0<Unit> function0, Modifier modifier, Function2<? super Composer, ? super Integer, Unit> function22, Function2<? super Composer, ? super Integer, Unit> function23, boolean enabled, MenuItemColors colors, PaddingValues contentPadding, MutableInteractionSource interactionSource, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty2 & 38347923) == 38347922 && $composer3.getSkipping()) {
            ...
            $composer2 = $composer3;
            MenuKt.DropdownMenuItemContent(function24, function02, modifier3, function28, function27, enabled3, colors3, contentPadding2, interactionSource2, $composer2, ($dirty & 14) | ($dirty & 112) | ($dirty & 896) | ($dirty & 7168) | (57344 & $dirty) | (458752 & $dirty) | (3670016 & $dirty) | (29360128 & $dirty) | (234881024 & $dirty));
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            modifier4 = modifier3;
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.AndroidMenu_androidKt.DropdownMenuItem.1
                ...
                public final void invoke(Composer composer, int i12) {
                    AndroidMenu_androidKt.DropdownMenuItem(function2, function0, modifier4, function29, function210, enabled4, colors4, contentPadding3, interactionSource3, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
