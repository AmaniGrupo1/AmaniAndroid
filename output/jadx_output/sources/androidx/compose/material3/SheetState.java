...
public final class SheetState {
    ...
    public SheetState(boolean skipPartiallyExpanded, final Density density, SheetValue initialValue, Function1<? super SheetValue, Boolean> function1, boolean skipHiddenState) {
        ...
        this.anchoredDraggableState = new AnchoredDraggableState<>(initialValue, new Function1<Float, Float>() { // from class: androidx.compose.material3.SheetState$anchoredDraggableState$1
            ...
            public final Float invoke(float it) {
                ...
                return Float.valueOf($this$invoke_u24lambda_u240.mo405toPx0680j_4(Dp.m7505constructorimpl(56)));
            }
            ...
            public final Float invoke() {
                Density $this$invoke_u24lambda_u240 = density;
                return Float.valueOf($this$invoke_u24lambda_u240.mo405toPx0680j_4(Dp.m7505constructorimpl(ComposerImplKt.nodeKey)));
            }
        ...
        public final Saver<SheetState, SheetValue> Saver(final boolean skipPartiallyExpanded, final Function1<? super SheetValue, Boolean> confirmValueChange, final Density density, final boolean skipHiddenState) {
            return SaverKt.Saver(new Function2<SaverScope, SheetState, SheetValue>() { // from class: androidx.compose.material3.SheetState$Companion$Saver$1
                ...
                public final SheetState invoke(SheetValue savedValue) {
                    return new SheetState(skipPartiallyExpanded, density, savedValue, confirmValueChange, skipHiddenState);
                }
            });
        }
    }
