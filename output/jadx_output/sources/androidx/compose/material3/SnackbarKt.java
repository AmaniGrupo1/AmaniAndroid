...
public final class SnackbarKt {
    private static final float ContainerMaxWidth = Dp.m7505constructorimpl(600);
    ...
    public static final void m2811SnackbareQBnUkQ(Modifier modifier, Function2<? super Composer, ? super Integer, Unit> function2, Function2<? super Composer, ? super Integer, Unit> function22, boolean actionOnNewLine, Shape shape, long containerColor, long contentColor, long actionContentColor, long dismissActionContentColor, final Function2<? super Composer, ? super Integer, Unit> function23, Composer $composer, final int $changed, final int i) {
        ...
        if ((100663296 & $changed) == 0) {
            $dirty |= ((i & 256) == 0 && $composer3.changed(dismissActionContentColor)) ? 67108864 : 33554432;
        }
        if ((i & 512) != 0) {
            $dirty |= 805306368;
        } else if (($changed & 805306368) == 0) {
            $dirty |= $composer3.changedInstance(function23) ? C.BUFFER_FLAG_LAST_SAMPLE : 268435456;
        }
        if (($dirty & 306783379) == 306783378 && $composer3.getSkipping()) {
            ...
            SurfaceKt.m2826SurfaceT9BRK9s(modifier5, shape3, containerColor2, contentColor2, 0.0f, SnackbarTokens.INSTANCE.m3784getContainerElevationD9Ej5fM(), null, ComposableLambdaKt.rememberComposableLambda(-1829663446, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.SnackbarKt$Snackbar$1
                            ...
                            public final void invoke(Composer $composer5, int $changed3) {
                                ...
                                if (($changed3 & 3) != 2 || !$composer5.getSkipping()) {
                                    ...
                                    if (z2 && function212 != null) {
                                        ...
                                        SnackbarKt.m2809NewLineButtonSnackbarkKq0p4A(function213, function212, function214, actionTextStyle, j2, j3, $composer5, 0);
                                        $composer5.endReplaceGroup();
                                    } else {
                                        $composer5.startReplaceGroup(-810701708);
                                        ComposerKt.sourceInformation($composer5, "135@6301L366");
                                        SnackbarKt.m2810OneRowSnackbarkKq0p4A(function213, function212, function214, actionTextStyle, j2, j3, $composer5, 0);
                                        $composer5.endReplaceGroup();
                                    }
                                    if (ComposerKt.isTraceInProgress()) {
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.SnackbarKt$Snackbar$2
                ...
                public final void invoke(Composer composer, int i10) {
                    SnackbarKt.m2811SnackbareQBnUkQ(modifier4, function28, function29, actionOnNewLine3, shape4, containerColor3, contentColor3, containerColor4, contentColor4, function23, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    public static final void m2812SnackbarsDKtq54(final SnackbarData snackbarData, Modifier modifier, boolean actionOnNewLine, Shape shape, long containerColor, long contentColor, long actionColor, long actionContentColor, long dismissActionContentColor, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        boolean z;
        Shape shape2;
        long j;
        ...
        if ((38347923 & $dirty) == 38347922 && $composer3.getSkipping()) {
            ...
            Function2 actionComposable = actionLabel != null ? ComposableLambdaKt.rememberComposableLambda(-1378313599, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.SnackbarKt$Snackbar$actionComposable$1
                ...
                public final void invoke(Composer $composer4, int $changed2) {
                    ...
                    if (($changed2 & 3) != 2 || !$composer4.getSkipping()) {
                        ...
                        ButtonColors buttonColorsM2103textButtonColorsro_MJ88 = ButtonDefaults.INSTANCE.m2103textButtonColorsro_MJ88(0L, actionColor3, 0L, 0L, $composer4, 24576, 13);
                        ...
                        ButtonKt.TextButton((Function0) value$iv, null, false, null, buttonColorsM2103textButtonColorsro_MJ88, null, null, null, null, ComposableLambdaKt.rememberComposableLambda(521110564, true, new Function3<RowScope, Composer, Integer, Unit>() { // from class: androidx.compose.material3.SnackbarKt$Snackbar$actionComposable$1.2
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            {
                                super(3);
                            }
                            ...
                            public final void invoke(RowScope $this$TextButton, Composer $composer5, int $changed3) {
                                ...
                                TextKt.m2976Text4IGK_g(str, (Modifier) null, 0L, 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, $composer5, 0, 0, 131070);
                                if (ComposerKt.isTraceInProgress()) {
                                    ComposerKt.traceEventEnd();
                                }
                            }
            ...
            Function2 dismissActionComposable = snackbarData.getVisuals().getWithDismissAction() ? ComposableLambdaKt.rememberComposableLambda(-1812633777, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.SnackbarKt$Snackbar$dismissActionComposable$1
                ...
                public final void invoke(Composer $composer4, int $changed2) {
                    ...
                    if (($changed2 & 3) != 2 || !$composer4.getSkipping()) {
                        ...
                        ComposerKt.sourceInformationMarkerEnd($composer4);
                        IconButtonKt.IconButton((Function0) value$iv, null, false, null, null, ComposableSingletons$SnackbarKt.INSTANCE.m2265getLambda1$material3_release(), $composer4, ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE, 30);
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                            return;
                        }
            ...
            m2811SnackbareQBnUkQ(PaddingKt.m818padding3ABfNKs(modifier3, Dp.m7505constructorimpl(12)), actionComposable, dismissActionComposable, actionOnNewLine2, shape4, containerColor3, contentColor3, actionContentColor3, dismissActionContentColor2, ComposableLambdaKt.rememberComposableLambda(-1266389126, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.SnackbarKt$Snackbar$3
                ...
                public final void invoke(Composer $composer4, int $changed2) {
                    ...
                    TextKt.m2976Text4IGK_g(snackbarData.getVisuals().getMessage(), (Modifier) null, 0L, 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, $composer4, 0, 0, 131070);
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                    }
                }
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.SnackbarKt$Snackbar$4
                ...
                public final void invoke(Composer composer, int i9) {
                    SnackbarKt.m2812SnackbarsDKtq54(snackbarData, modifier3, actionOnNewLine3, shape5, containerColor4, contentColor4, actionColor4, actionContentColor4, dismissActionContentColor3, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    */
    public static final void m2809NewLineButtonSnackbarkKq0p4A(final Function2<? super Composer, ? super Integer, Unit> function2, final Function2<? super Composer, ? super Integer, Unit> function22, final Function2<? super Composer, ? super Integer, Unit> function23, final TextStyle actionTextStyle, final long actionContentColor, final long dismissActionContentColor, Composer $composer, final int $changed) {
        ...
        Composer $composer4;
        Composer $composer5 = $composer.startRestartGroup(-1332496681);
        ComposerKt.sourceInformation($composer5, "C(NewLineButtonSnackbar)P(5!1,3,2,1:c#ui.graphics.Color,4:c#ui.graphics.Color)264@11690L1175:Snackbar.kt#uh7d8r");
        int $dirty = $changed;
        if (($changed & 6) == 0) {
            $dirty |= $composer5.changedInstance(function2) ? 4 : 2;
        }
        if (($changed & 48) == 0) {
            $dirty |= $composer5.changedInstance(function22) ? 32 : 16;
        }
        if (($changed & RendererCapabilities.DECODER_SUPPORT_MASK) == 0) {
            $dirty |= $composer5.changedInstance(function23) ? 256 : 128;
        }
        if (($changed & 3072) == 0) {
            $dirty |= $composer5.changed(actionTextStyle) ? 2048 : 1024;
        }
        if (($changed & 24576) == 0) {
            $dirty |= $composer5.changed(actionContentColor) ? 16384 : 8192;
        }
        if ((196608 & $changed) == 0) {
            $dirty |= $composer5.changed(dismissActionContentColor) ? 131072 : 65536;
        }
        int $dirty2 = $dirty;
        if ((74899 & $dirty2) != 74898 || !$composer5.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1332496681, $dirty2, -1, "androidx.compose.material3.NewLineButtonSnackbar (Snackbar.kt:263)");
            }
            Modifier modifier$iv = PaddingKt.m822paddingqDBjuR0$default(SizeKt.fillMaxWidth$default(SizeKt.m871widthInVpY3zN4$default(Modifier.INSTANCE, 0.0f, ContainerMaxWidth, 1, null), 0.0f, 1, null), HorizontalSpacing, 0.0f, 0.0f, SeparateButtonExtraY, 6, null);
            ...
            MeasurePolicy measurePolicy$iv = ColumnKt.columnMeasurePolicy(verticalArrangement$iv, horizontalAlignment$iv, $composer5, $changed$iv);
            ...
            ComposerKt.sourceInformationMarkerStart($composer2, -376152340, "C272@11979L191,279@12180L679:Snackbar.kt#uh7d8r");
            Modifier modifier$iv2 = PaddingKt.m822paddingqDBjuR0$default(AlignmentLineKt.m662paddingFromBaselineVpY3zN4(Modifier.INSTANCE, HeightToFirstLine, LongButtonVerticalOffset), 0.0f, 0.0f, HorizontalSpacingButtonSide, 0.0f, 11, null);
            ...
            int i4 = ((6 >> 6) & 112) | 6;
            ComposerKt.sourceInformationMarkerStart($composer2, -1482962025, "C276@12154L6:Snackbar.kt#uh7d8r");
            ...
            ComposerKt.sourceInformationMarkerEnd($composer2);
            ComposerKt.sourceInformationMarkerEnd($composer2);
            Modifier modifier$iv3 = PaddingKt.m822paddingqDBjuR0$default($this$NewLineButtonSnackbar_kKq0p4A_u24lambda_u243.align(Modifier.INSTANCE, Alignment.INSTANCE.getEnd()), 0.0f, 0.0f, function23 == null ? HorizontalSpacingButtonSide : Dp.m7505constructorimpl(0), 0.0f, 11, null);
            ComposerKt.sourceInformationMarkerStart($composer2, 733328855, "CC(Box)P(2,1,3)72@3384L130:Box.kt#2w3rfo");
            ...
            if ($this$Layout_u24lambda_u240$iv$iv4.getInserting()) {
                ...
                $composer3 = $composer2;
                if (!Intrinsics.areEqual($this$Layout_u24lambda_u240$iv$iv4.rememberedValue(), Integer.valueOf(compositeKeyHash$iv$iv3))) {
                }
                ...
                int i6 = ((0 >> 6) & 112) | 6;
                ComposerKt.sourceInformationMarkerStart($composer$iv, -1482754232, "C283@12348L501:Snackbar.kt#uh7d8r");
                ComposerKt.sourceInformationMarkerStart($composer$iv, 693286680, "CC(Row)P(2,1,3)98@4939L58,99@5002L130:Row.kt#2w3rfo");
                Modifier modifier$iv4 = Modifier.INSTANCE;
                Arrangement.Horizontal horizontalArrangement$iv = Arrangement.INSTANCE.getStart();
                Alignment.Vertical verticalAlignment$iv = Alignment.INSTANCE.getTop();
                MeasurePolicy measurePolicy$iv4 = RowKt.rowMeasurePolicy(horizontalArrangement$iv, verticalAlignment$iv, $composer$iv, ((0 >> 3) & 14) | ((0 >> 3) & 112));
                ...
                int compositeKeyHash$iv$iv4 = ComposablesKt.getCurrentCompositeKeyHash($composer$iv, 0);
                ...
                if ($this$Layout_u24lambda_u240$iv$iv.getInserting()) {
                    ...
                    int i8 = ((0 >> 6) & 112) | 6;
                    ComposerKt.sourceInformationMarkerStart($composer$iv2, 1996615437, "C284@12370L208:Snackbar.kt#uh7d8r");
                    CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m4687boximpl(actionContentColor)), TextKt.getLocalTextStyle().provides(actionTextStyle)}, function22, $composer$iv2, ProvidedValue.$stable | ($dirty2 & 112));
                    $composer$iv2.startReplaceGroup(618603253);
                    ComposerKt.sourceInformation($composer$iv2, "290@12644L173");
                    if (function23 != null) {
                        CompositionLocalKt.CompositionLocalProvider(ContentColorKt.getLocalContentColor().provides(Color.m4687boximpl(dismissActionContentColor)), function23, $composer$iv2, ProvidedValue.$stable | (($dirty2 >> 3) & 112));
                    }
                ...
                $this$Layout_u24lambda_u240$iv$iv.apply(Integer.valueOf(compositeKeyHash$iv$iv4), setCompositeKeyHash4);
                Updater.m3975setimpl($this$Layout_u24lambda_u240$iv$iv, materialized$iv$iv4, ComposeUiNode.INSTANCE.getSetModifier());
                int i72 = ($changed$iv$iv$iv4 >> 6) & 14;
                Composer $composer$iv22 = $composer4;
                ComposerKt.sourceInformationMarkerStart($composer$iv22, -407918630, "C100@5047L9:Row.kt#2w3rfo");
                RowScopeInstance rowScopeInstance2 = RowScopeInstance.INSTANCE;
                int i82 = ((0 >> 6) & 112) | 6;
                ComposerKt.sourceInformationMarkerStart($composer$iv22, 1996615437, "C284@12370L208:Snackbar.kt#uh7d8r");
                CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m4687boximpl(actionContentColor)), TextKt.getLocalTextStyle().provides(actionTextStyle)}, function22, $composer$iv22, ProvidedValue.$stable | ($dirty2 & 112));
                $composer$iv22.startReplaceGroup(618603253);
                ComposerKt.sourceInformation($composer$iv22, "290@12644L173");
                if (function23 != null) {
                }
                $composer$iv22.endReplaceGroup();
            ...
            $this$Layout_u24lambda_u240$iv$iv4.apply(Integer.valueOf(compositeKeyHash$iv$iv3), setCompositeKeyHash3);
            Updater.m3975setimpl($this$Layout_u24lambda_u240$iv$iv4, materialized$iv$iv3, ComposeUiNode.INSTANCE.getSetModifier());
            ...
            ComposerKt.sourceInformationMarkerStart($composer$iv, -1482754232, "C283@12348L501:Snackbar.kt#uh7d8r");
            ComposerKt.sourceInformationMarkerStart($composer$iv, 693286680, "CC(Row)P(2,1,3)98@4939L58,99@5002L130:Row.kt#2w3rfo");
            Modifier modifier$iv42 = Modifier.INSTANCE;
            Arrangement.Horizontal horizontalArrangement$iv2 = Arrangement.INSTANCE.getStart();
            Alignment.Vertical verticalAlignment$iv2 = Alignment.INSTANCE.getTop();
            MeasurePolicy measurePolicy$iv42 = RowKt.rowMeasurePolicy(horizontalArrangement$iv2, verticalAlignment$iv2, $composer$iv, ((0 >> 3) & 14) | ((0 >> 3) & 112));
            int $changed$iv$iv42 = (0 << 3) & 112;
            ComposerKt.sourceInformationMarkerStart($composer$iv, -1323940314, "CC(Layout)P(!1,2)78@3182L23,81@3333L411:Layout.kt#80mrfh");
            int compositeKeyHash$iv$iv42 = ComposablesKt.getCurrentCompositeKeyHash($composer$iv, 0);
            CompositionLocalMap localMap$iv$iv42 = $composer$iv.getCurrentCompositionLocalMap();
            Modifier materialized$iv$iv42 = ComposedModifierKt.materializeModifier($composer$iv, modifier$iv42);
            ...
            $this$Layout_u24lambda_u240$iv$iv.apply(Integer.valueOf(compositeKeyHash$iv$iv42), setCompositeKeyHash42);
            Updater.m3975setimpl($this$Layout_u24lambda_u240$iv$iv, materialized$iv$iv42, ComposeUiNode.INSTANCE.getSetModifier());
            int i722 = ($changed$iv$iv$iv42 >> 6) & 14;
            Composer $composer$iv222 = $composer4;
            ComposerKt.sourceInformationMarkerStart($composer$iv222, -407918630, "C100@5047L9:Row.kt#2w3rfo");
            RowScopeInstance rowScopeInstance22 = RowScopeInstance.INSTANCE;
            int i822 = ((0 >> 6) & 112) | 6;
            ComposerKt.sourceInformationMarkerStart($composer$iv222, 1996615437, "C284@12370L208:Snackbar.kt#uh7d8r");
            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m4687boximpl(actionContentColor)), TextKt.getLocalTextStyle().provides(actionTextStyle)}, function22, $composer$iv222, ProvidedValue.$stable | ($dirty2 & 112));
            $composer$iv222.startReplaceGroup(618603253);
            ComposerKt.sourceInformation($composer$iv222, "290@12644L173");
            if (function23 != null) {
            }
            $composer$iv222.endReplaceGroup();
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.SnackbarKt$NewLineButtonSnackbar$2
                ...
                public final void invoke(Composer composer, int i9) {
                    SnackbarKt.m2809NewLineButtonSnackbarkKq0p4A(function2, function22, function23, actionTextStyle, actionContentColor, dismissActionContentColor, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1));
                }
            });
        }
    }
    ...
    public static final void m2810OneRowSnackbarkKq0p4A(final Function2<? super Composer, ? super Integer, Unit> function2, final Function2<? super Composer, ? super Integer, Unit> function22, final Function2<? super Composer, ? super Integer, Unit> function23, final TextStyle actionTextStyle, final long actionTextColor, final long dismissActionColor, Composer $composer, final int $changed) {
        Function0<ComposeUiNode> function0;
        Composer $composer2;
        Function0<ComposeUiNode> function02;
        Function0<ComposeUiNode> function03;
        ...
        if ((74899 & $dirty2) != 74898 || !$composer3.getSkipping()) {
            ...
            Modifier modifier$iv = PaddingKt.m822paddingqDBjuR0$default(Modifier.INSTANCE, HorizontalSpacing, 0.0f, function23 == null ? HorizontalSpacingButtonSide : Dp.m7505constructorimpl(0), 0.0f, 10, null);
            ...
            if (value$iv == Composer.INSTANCE.getEmpty()) {
                value$iv = new MeasurePolicy() { // from class: androidx.compose.material3.SnackbarKt$OneRowSnackbar$2$1
                    ...
                    public final MeasureResult mo41measure3p2s80s(MeasureScope $this$Layout, List<? extends Measurable> list, long constraints) {
                        ...
                        long j = constraints;
                        int containerWidth = Math.min(Constraints.m7458getMaxWidthimpl(j), measureScope.mo399roundToPx0680j_4(SnackbarKt.ContainerMaxWidth));
                        ...
                        final Placeable actionButtonPlaceable = measurable != null ? measurable.mo6141measureBRTryo0(j) : null;
                        ...
                        final Placeable dismissButtonPlaceable = measurable2 != null ? measurable2.mo6141measureBRTryo0(j) : null;
                        ...
                        int extraSpacingWidth = dismissButtonWidth == 0 ? measureScope.mo399roundToPx0680j_4(SnackbarKt.TextEndExtraSpacing) : 0;
                        int textMaxWidth = RangesKt.coerceAtLeast(((containerWidth - actionButtonWidth) - dismissButtonWidth) - extraSpacingWidth, Constraints.m7460getMinWidthimpl(j));
                        String str3 = textTag;
                        int size3 = list.size();
                        int index$iv$iv3 = 0;
                        while (index$iv$iv3 < size3) {
                            ...
                            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId((Measurable) item$iv$iv), str3)) {
                                ...
                                final Placeable textPlaceable = ((Measurable) item$iv$iv).mo6141measureBRTryo0(Constraints.m7447copyZbe2FdA(j, (11 & 1) != 0 ? Constraints.m7460getMinWidthimpl(j) : 0, (11 & 2) != 0 ? Constraints.m7458getMaxWidthimpl(j) : textMaxWidth, (11 & 4) != 0 ? Constraints.m7459getMinHeightimpl(j) : 0, (11 & 8) != 0 ? Constraints.m7457getMaxHeightimpl(j) : 0));
                                ...
                                if (isOneLine) {
                                    int minContainerHeight2 = measureScope.mo399roundToPx0680j_4(SnackbarTokens.INSTANCE.m3786getSingleLineContainerHeightD9Ej5fM());
                                    ...
                                    int i = (actionButtonPlaceable == null || (it = actionButtonPlaceable.get(androidx.compose.ui.layout.AlignmentLineKt.getFirstBaseline())) == Integer.MIN_VALUE) ? 0 : (textPlaceY2 + firstTextBaseline) - it;
                                    ...
                                    int minContainerHeight3 = measureScope.mo399roundToPx0680j_4(SnackbarTokens.INSTANCE.m3787getTwoLinesContainerHeightD9Ej5fM());
                                ...
                                return MeasureScope.layout$default(measureScope, containerWidth, minContainerHeight, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.SnackbarKt$OneRowSnackbar$2$1.2
                                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                    {
                                        super(1);
                                    }
            ...
            if (function22 != null) {
                ...
                CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m4687boximpl(actionTextColor)), TextKt.getLocalTextStyle().provides(actionTextStyle)}, function22, $composer2, ProvidedValue.$stable | ($dirty2 & 112));
                ComposerKt.sourceInformationMarkerEnd($composer2);
                ComposerKt.sourceInformationMarkerEnd($composer2);
                $composer2.endNode();
                ComposerKt.sourceInformationMarkerEnd($composer2);
            ...
            if (function23 != null) {
                ...
                if ($this$Layout_u24lambda_u240$iv$iv3.getInserting()) {
                    ...
                    CompositionLocalKt.CompositionLocalProvider(ContentColorKt.getLocalContentColor().provides(Color.m4687boximpl(dismissActionColor)), function23, $composer2, ProvidedValue.$stable | (($dirty2 >> 3) & 112));
                    ComposerKt.sourceInformationMarkerEnd($composer2);
                    ComposerKt.sourceInformationMarkerEnd($composer2);
                    $composer2.endNode();
                    ComposerKt.sourceInformationMarkerEnd($composer2);
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.SnackbarKt$OneRowSnackbar$3
                ...
                public final void invoke(Composer composer, int i8) {
                    SnackbarKt.m2810OneRowSnackbarkKq0p4A(function2, function22, function23, actionTextStyle, actionTextColor, dismissActionColor, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1));
                }
            });
        }
    }
