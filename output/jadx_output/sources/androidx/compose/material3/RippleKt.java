...
public final class RippleKt {
    ...
    private static final RippleNodeFactory DefaultBoundedRipple = new RippleNodeFactory(true, Dp.INSTANCE.m7525getUnspecifiedD9Ej5fM(), Color.INSTANCE.m4733getUnspecified0d7_KjU(), (DefaultConstructorMarker) null);
    private static final RippleNodeFactory DefaultUnboundedRipple = new RippleNodeFactory(false, Dp.INSTANCE.m7525getUnspecifiedD9Ej5fM(), Color.INSTANCE.m4733getUnspecified0d7_KjU(), (DefaultConstructorMarker) null);
    ...
    public static /* synthetic */ IndicationNodeFactory m2687rippleH2RKhps$default(boolean z, float f, long j, int i, Object obj) {
        if ((i & 1) != 0) {
            z = true;
        }
        if ((i & 2) != 0) {
        ...
        if ((i & 4) != 0) {
            j = Color.INSTANCE.m4733getUnspecified0d7_KjU();
        }
        return m2686rippleH2RKhps(z, f, j);
    }

    /* JADX INFO: renamed from: ripple-H2RKhps, reason: not valid java name */
    public static final IndicationNodeFactory m2686rippleH2RKhps(boolean bounded, float radius, long color) {
        if (Dp.m7510equalsimpl0(radius, Dp.INSTANCE.m7525getUnspecifiedD9Ej5fM()) && Color.m4698equalsimpl0(color, Color.INSTANCE.m4733getUnspecified0d7_KjU())) {
    ...
    public static /* synthetic */ IndicationNodeFactory m2689ripplewH6b6FI$default(ColorProducer colorProducer, boolean z, float f, int i, Object obj) {
        if ((i & 2) != 0) {
            z = true;
        }
        if ((i & 4) != 0) {
        ...
        return m2688ripplewH6b6FI(colorProducer, z, f);
    }

    /* JADX INFO: renamed from: ripple-wH6b6FI, reason: not valid java name */
    public static final IndicationNodeFactory m2688ripplewH6b6FI(ColorProducer color, boolean bounded, float radius) {
        return new RippleNodeFactory(bounded, radius, color, (DefaultConstructorMarker) null);
    }
    ...
    public static final Indication m2690rippleOrFallbackImplementation9IZ8Weo(boolean bounded, float radius, long color, Composer $composer, int $changed, int i) {
        float radius2;
        long color2;
        Composer $composer2;
        IndicationNodeFactory indicationNodeFactoryM2686rippleH2RKhps;
        ...
        if ((i & 2) != 0) {
            float radius3 = Dp.INSTANCE.m7525getUnspecifiedD9Ej5fM();
            radius2 = radius3;
        } else {
            radius2 = radius;
        }
        if ((i & 4) != 0) {
            long color3 = Color.INSTANCE.m4733getUnspecified0d7_KjU();
            color2 = color3;
        } else {
            color2 = color;
        }
        ...
        if (((Boolean) objConsume).booleanValue()) {
            $composer2 = $composer;
            indicationNodeFactoryM2686rippleH2RKhps = androidx.compose.material.ripple.RippleKt.m2030rememberRipple9IZ8Weo(bounded2, radius2, color2, $composer2, ($changed & 14) | ($changed & 112) | ($changed & 896), 0);
        } else {
            $composer2 = $composer;
            indicationNodeFactoryM2686rippleH2RKhps = m2686rippleH2RKhps(bounded2, radius2, color2);
        }
        ...
        return indicationNodeFactoryM2686rippleH2RKhps;
    }
}
