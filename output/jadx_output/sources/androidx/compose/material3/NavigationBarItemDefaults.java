...
public final class NavigationBarItemDefaults {
    ...
    public final NavigationBarItemColors m2554colors69fazGs(long selectedIconColor, long selectedTextColor, long indicatorColor, long unselectedIconColor, long unselectedTextColor, long disabledIconColor, long disabledTextColor, Composer $composer, int $changed, int i) {
        ...
        long selectedIconColor2 = (i & 1) != 0 ? Color.INSTANCE.m4733getUnspecified0d7_KjU() : selectedIconColor;
        long selectedTextColor2 = (i & 2) != 0 ? Color.INSTANCE.m4733getUnspecified0d7_KjU() : selectedTextColor;
        long indicatorColor2 = (i & 4) != 0 ? Color.INSTANCE.m4733getUnspecified0d7_KjU() : indicatorColor;
        long unselectedIconColor2 = (i & 8) != 0 ? Color.INSTANCE.m4733getUnspecified0d7_KjU() : unselectedIconColor;
        long unselectedTextColor2 = (i & 16) != 0 ? Color.INSTANCE.m4733getUnspecified0d7_KjU() : unselectedTextColor;
        long disabledIconColor2 = (i & 32) != 0 ? Color.INSTANCE.m4733getUnspecified0d7_KjU() : disabledIconColor;
        long disabledTextColor2 = (i & 64) != 0 ? Color.INSTANCE.m4733getUnspecified0d7_KjU() : disabledTextColor;
        if (ComposerKt.isTraceInProgress()) {
        ...
        NavigationBarItemColors navigationBarItemColorsM2543copy4JmcsL4 = getDefaultNavigationBarItemColors$material3_release(MaterialTheme.INSTANCE.getColorScheme($composer, 6)).m2543copy4JmcsL4(selectedIconColor2, selectedTextColor2, indicatorColor2, unselectedIconColor2, unselectedTextColor2, disabledIconColor2, disabledTextColor2);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd($composer);
        return navigationBarItemColorsM2543copy4JmcsL4;
    }
    ...
    public final NavigationBarItemColors getDefaultNavigationBarItemColors$material3_release(ColorScheme $this$defaultNavigationBarItemColors) {
        ...
        if (it == null) {
            ...
            NavigationBarItemColors it2 = new NavigationBarItemColors(jFromToken, jFromToken2, jFromToken3, jFromToken4, jFromToken5, jM4695copywmQWz5c, Color.m4695copywmQWz5c(jFromToken7, (14 & 1) != 0 ? Color.m4699getAlphaimpl(jFromToken7) : 0.38f, (14 & 2) != 0 ? Color.m4703getRedimpl(jFromToken7) : 0.0f, (14 & 4) != 0 ? Color.m4702getGreenimpl(jFromToken7) : 0.0f, (14 & 8) != 0 ? Color.m4700getBlueimpl(jFromToken7) : 0.0f), null);
    ...
    public final /* synthetic */ NavigationBarItemColors m2555colorszjMxDiM(long selectedIconColor, long selectedTextColor, long indicatorColor, long unselectedIconColor, long unselectedTextColor, Composer $composer, int $changed, int i) {
        ...
        long jM4695copywmQWz5c = Color.m4695copywmQWz5c(unselectedIconColor3, (14 & 1) != 0 ? Color.m4699getAlphaimpl(unselectedIconColor3) : 0.38f, (14 & 2) != 0 ? Color.m4703getRedimpl(unselectedIconColor3) : 0.0f, (14 & 4) != 0 ? Color.m4702getGreenimpl(unselectedIconColor3) : 0.0f, (14 & 8) != 0 ? Color.m4700getBlueimpl(unselectedIconColor3) : 0.0f);
        long unselectedTextColor3 = unselectedTextColor2;
        NavigationBarItemColors navigationBarItemColors = new NavigationBarItemColors(selectedIconColor2, selectedTextColor2, indicatorColor2, unselectedIconColor2, unselectedTextColor2, jM4695copywmQWz5c, Color.m4695copywmQWz5c(unselectedTextColor3, (14 & 1) != 0 ? Color.m4699getAlphaimpl(unselectedTextColor3) : 0.38f, (14 & 2) != 0 ? Color.m4703getRedimpl(unselectedTextColor3) : 0.0f, (14 & 4) != 0 ? Color.m4702getGreenimpl(unselectedTextColor3) : 0.0f, (14 & 8) != 0 ? Color.m4700getBlueimpl(unselectedTextColor3) : 0.0f), null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd($composer);
