...
final class EnterAlwaysScrollBehavior implements TopAppBarScrollBehavior {
    ...
    public EnterAlwaysScrollBehavior(TopAppBarState state, AnimationSpec<Float> animationSpec, DecayAnimationSpec<Float> decayAnimationSpec, Function0<Boolean> function0) {
        this.state = state;
