...
final class OutlinedTextFieldMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo41measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, List<? extends Measurable> list, long constraints) {
        ...
        int bottomPadding = measureScope.mo399roundToPx0680j_4(outlinedTextFieldMeasurePolicy.paddingValues.getBottom());
        ...
        if (measurable2 != null) {
            ...
            trailingPlaceable = measurable2.mo6141measureBRTryo0(ConstraintsKt.m7478offsetNN6EwU$default(relaxedConstraints, -occupiedSpaceHorizontally3, 0, 2, null));
        } else {
            relaxedConstraints = relaxedConstraints3;
        ...
        final Placeable prefixPlaceable = measurable3 != null ? measurable3.mo6141measureBRTryo0(ConstraintsKt.m7478offsetNN6EwU$default(relaxedConstraints, -occupiedSpaceHorizontally4, 0, 2, null)) : null;
        ...
        if (measurable4 != null) {
            ...
            suffixPlaceable = measurable4.mo6141measureBRTryo0(ConstraintsKt.m7478offsetNN6EwU$default(relaxedConstraints, -occupiedSpaceHorizontally5, 0, 2, null));
        } else {
            relaxedConstraints2 = relaxedConstraints;
        ...
        int labelHorizontalPaddingOffset = measureScope.mo399roundToPx0680j_4(outlinedTextFieldMeasurePolicy.paddingValues.mo768calculateLeftPaddingu2uoSUM(measureScope.getLayoutDirection())) + measureScope.mo399roundToPx0680j_4(outlinedTextFieldMeasurePolicy.paddingValues.mo769calculateRightPaddingu2uoSUM(measureScope.getLayoutDirection()));
        long labelConstraints = ConstraintsKt.m7477offsetNN6EwU(relaxedConstraints2, MathHelpersKt.lerp((-occupiedSpaceHorizontally6) - labelHorizontalPaddingOffset, -labelHorizontalPaddingOffset, outlinedTextFieldMeasurePolicy.animationProgress), -bottomPadding);
        ...
        Placeable labelPlaceable = measurable5 != null ? measurable5.mo6141measureBRTryo0(labelConstraints) : null;
        if (labelPlaceable != null) {
            Placeable it6 = labelPlaceable;
            jM4530getZeroNHjbRc = SizeKt.Size(it6.getWidth(), it6.getHeight());
        } else {
        ...
        int topPadding = Math.max(TextFieldImplKt.heightOrZero(labelPlaceable2) / 2, measureScope.mo399roundToPx0680j_4(outlinedTextFieldMeasurePolicy.paddingValues.getTop()));
        final Placeable trailingPlaceable2 = trailingPlaceable;
        long jM7477offsetNN6EwU = ConstraintsKt.m7477offsetNN6EwU(constraints, -occupiedSpaceHorizontally6, ((-bottomPadding) - topPadding) - supportingIntrinsicHeight);
        ...
        while (index$iv$iv8 < occupiedSpaceHorizontally7) {
            ...
            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(it8), "TextField")) {
                Placeable textFieldPlaceable = ((Measurable) item$iv$iv).mo6141measureBRTryo0(textConstraints);
                ...
                while (true) {
                    ...
                    it$iv7 = list11.get(index$iv$iv10);
                ...
                Placeable placeholderPlaceable = measurable6 != null ? measurable6.mo6141measureBRTryo0(placeholderConstraints) : null;
                ...
                final int width = OutlinedTextFieldKt.m2635calculateWidthDHJA7U0(TextFieldImplKt.widthOrZero(leadingPlaceable), TextFieldImplKt.widthOrZero(trailingPlaceable2), TextFieldImplKt.widthOrZero(prefixPlaceable), TextFieldImplKt.widthOrZero(suffixPlaceable2), textFieldPlaceable2.getWidth(), TextFieldImplKt.widthOrZero(labelPlaceable2), TextFieldImplKt.widthOrZero(placeholderPlaceable), outlinedTextFieldMeasurePolicy.animationProgress, constraints, measureScope.getDensity(), outlinedTextFieldMeasurePolicy.paddingValues);
                long relaxedConstraints4 = ConstraintsKt.m7478offsetNN6EwU$default(relaxedConstraints2, 0, -occupiedSpaceVertically5, 1, null);
                long supportingConstraints = Constraints.m7447copyZbe2FdA(relaxedConstraints4, (11 & 1) != 0 ? Constraints.m7460getMinWidthimpl(relaxedConstraints4) : 0, (11 & 2) != 0 ? Constraints.m7458getMaxWidthimpl(relaxedConstraints4) : width, (11 & 4) != 0 ? Constraints.m7459getMinHeightimpl(relaxedConstraints4) : 0, (11 & 8) != 0 ? Constraints.m7457getMaxHeightimpl(relaxedConstraints4) : 0);
                final Placeable supportingPlaceable = supportingMeasurable != null ? supportingMeasurable.mo6141measureBRTryo0(supportingConstraints) : null;
                int supportingHeight = TextFieldImplKt.heightOrZero(supportingPlaceable);
                final int totalHeight = OutlinedTextFieldKt.m2634calculateHeightmKXJcVc(TextFieldImplKt.heightOrZero(leadingPlaceable), TextFieldImplKt.heightOrZero(trailingPlaceable2), TextFieldImplKt.heightOrZero(prefixPlaceable), TextFieldImplKt.heightOrZero(suffixPlaceable2), textFieldPlaceable2.getHeight(), TextFieldImplKt.heightOrZero(labelPlaceable2), TextFieldImplKt.heightOrZero(placeholderPlaceable2), TextFieldImplKt.heightOrZero(supportingPlaceable), outlinedTextFieldMeasurePolicy.animationProgress, constraints, measureScope.getDensity(), outlinedTextFieldMeasurePolicy.paddingValues);
                int height = totalHeight - supportingHeight;
                List<? extends Measurable> list12 = list;
                int totalHeight2 = list12.size();
                int index$iv$iv12 = 0;
                while (index$iv$iv12 < totalHeight2) {
                    int i5 = totalHeight2;
                    List<? extends Measurable> list13 = list12;
                    Object item$iv$iv2 = list13.get(index$iv$iv12);
                    ...
                    if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(it10), TextFieldImplKt.ContainerId)) {
                        ...
                        return MeasureScope.layout$default($this$measure_u2d3p2s80s, width, totalHeight, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.OutlinedTextFieldMeasurePolicy$measure$1
                            ...
                            public final void invoke2(Placeable.PlacementScope $this$layout) {
                                OutlinedTextFieldKt.place($this$layout, totalHeight, width, leadingPlaceable3, trailingPlaceable2, prefixPlaceable, suffixPlaceable3, textFieldPlaceable3, labelPlaceable2, placeholderPlaceable3, containerPlaceable, supportingPlaceable, outlinedTextFieldMeasurePolicy.animationProgress, outlinedTextFieldMeasurePolicy.singleLine, measureScope.getDensity(), measureScope.getLayoutDirection(), outlinedTextFieldMeasurePolicy.paddingValues);
                            }
                        }, 4, null);
                    }
        ...
        for (int index$iv$iv = 0; index$iv$iv < size; index$iv$iv++) {
            ...
            if (Intrinsics.areEqual(TextFieldImplKt.getLayoutId((IntrinsicMeasurable) item$iv$iv), "TextField")) {
                ...
                while (true) {
                    ...
                    Object item$iv$iv2 = list10.get(index$iv$iv7);
                ...
                return OutlinedTextFieldKt.m2635calculateWidthDHJA7U0(leadingWidth, trailingWidth, prefixWidth, suffixWidth, textFieldWidth, labelWidth, placeholderWidth, this.animationProgress, TextFieldImplKt.getZeroConstraints(), $this$intrinsicWidth.getDensity(), this.paddingValues);
            }
        }
        throw new NoSuchElementException("Collection contains no element matching the predicate.");
    }
    ...
    private final int intrinsicHeight(IntrinsicMeasureScope $this$intrinsicHeight, List<? extends IntrinsicMeasurable> list, int width, Function2<? super IntrinsicMeasurable, ? super Integer, Integer> function2) {
        ...
        if (it3 != null) {
            i = width;
            labelHeight = function2.invoke(it3, Integer.valueOf(MathHelpersKt.lerp(remainingWidth, i, this.animationProgress))).intValue();
        } else {
            i = width;
            labelHeight = 0;
        }
        ...
        while (index$iv$iv6 < size6) {
            Object item$iv$iv = list6.get(index$iv$iv6);
            ...
            if (Intrinsics.areEqual(TextFieldImplKt.getLayoutId((IntrinsicMeasurable) item$iv$iv), "TextField")) {
                ...
                while (true) {
                    ...
                    Object item$iv$iv2 = list10.get(index$iv$iv8);
                    placeholderHeight = placeholderHeight2;
                    List<? extends IntrinsicMeasurable> list11 = list10;
                ...
                return OutlinedTextFieldKt.m2634calculateHeightmKXJcVc(leadingHeight, trailingHeight3, prefixHeight3, trailingHeight4, textFieldHeight, labelHeight, prefixHeight4, supportingHeight, this.animationProgress, TextFieldImplKt.getZeroConstraints(), $this$intrinsicHeight.getDensity(), this.paddingValues);
            }
            index$iv$iv6++;
            list6 = list7;
