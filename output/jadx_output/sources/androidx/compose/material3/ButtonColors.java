...
public final class ButtonColors {
    ...
    public final ButtonColors m2087copyjRlVdoo(long containerColor, long contentColor, long disabledContainerColor, long disabledContentColor) {
    ...
    public final long m2085containerColorvNxB06k$material3_release(boolean enabled) {
    ...
    public final long m2086contentColorvNxB06k$material3_release(boolean enabled) {
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof ButtonColors) && Color.m4698equalsimpl0(this.containerColor, ((ButtonColors) other).containerColor) && Color.m4698equalsimpl0(this.contentColor, ((ButtonColors) other).contentColor) && Color.m4698equalsimpl0(this.disabledContainerColor, ((ButtonColors) other).disabledContainerColor) && Color.m4698equalsimpl0(this.disabledContentColor, ((ButtonColors) other).disabledContentColor)) {
            return true;
        }
        return false;
    }
