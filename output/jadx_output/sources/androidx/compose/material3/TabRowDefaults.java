...
public final class TabRowDefaults {
    ...
    public final float m2872getScrollableTabRowEdgeStartPaddingD9Ej5fM() {
    ...
    public final void m2869Indicator9IZ8Weo(Modifier modifier, float height, long color, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        float f;
        long j;
        ...
        if (($dirty & 147) == 146 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                height2 = i3 != 0 ? PrimaryNavigationTabTokens.INSTANCE.m3740getActiveIndicatorHeightD9Ej5fM() : f;
                if ((i & 4) != 0) {
                    $dirty &= -897;
            ...
            BoxKt.Box(BackgroundKt.m264backgroundbw27NRU$default(SizeKt.m850height3ABfNKs(SizeKt.fillMaxWidth$default(modifier3, 0.0f, 1, null), height2), color2, null, 2, null), $composer2, 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            color3 = color2;
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TabRowDefaults$Indicator$1
                ...
                public final void invoke(Composer composer, int i5) {
                    this.$tmp0_rcvr.m2869Indicator9IZ8Weo(modifier3, height2, color3, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    public final void m2870PrimaryIndicator10LGxhE(Modifier modifier, float width, float height, long color, Shape shape, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        float f;
        float height2;
        long color2;
        ...
        if (($dirty & 9363) == 9362 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                modifier3 = i2 != 0 ? Modifier.INSTANCE : modifier2;
                width2 = i3 != 0 ? Dp.m7505constructorimpl(24) : f;
                if (i4 != 0) {
                    height2 = PrimaryNavigationTabTokens.INSTANCE.m3740getActiveIndicatorHeightD9Ej5fM();
                }
                if ((i & 8) != 0) {
                    $dirty &= -7169;
            ...
            SpacerKt.Spacer(BackgroundKt.m263backgroundbw27NRU(SizeKt.m861requiredWidth3ABfNKs(SizeKt.m853requiredHeight3ABfNKs(modifier3, height2), width2), color2, shape2), $composer2, 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            height3 = height2;
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TabRowDefaults$PrimaryIndicator$1
                ...
                public final void invoke(Composer composer, int i7) {
                    this.$tmp0_rcvr.m2870PrimaryIndicator10LGxhE(modifier3, width2, height3, color3, shape3, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    public final void m2871SecondaryIndicator9IZ8Weo(Modifier modifier, float height, long color, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        float f;
        long j;
        final Modifier.Companion modifier3;
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TabRowDefaults$SecondaryIndicator$1
                ...
                public final void invoke(Composer composer, int i5) {
                    this.$tmp0_rcvr.m2871SecondaryIndicator9IZ8Weo(modifier3, height2, color3, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    static final class AnonymousClass2 extends Lambda implements Function3<Modifier, Composer, Integer, Modifier> {
        ...
        private static final float invoke$lambda$0(State<Dp> state) {
            return state.getValue().m7519unboximpl();
        }
        ...
        public final Modifier invoke(Modifier $this$composed, Composer $composer, int $changed) {
            ...
            State<Dp> stateM161animateDpAsStateAjpBEmI = AnimateAsStateKt.m161animateDpAsStateAjpBEmI(this.$currentTabPosition.getWidth(), TabRowKt.TabRowIndicatorSpec, null, null, $composer, 0, 12);
            final State<Dp> stateM161animateDpAsStateAjpBEmI2 = AnimateAsStateKt.m161animateDpAsStateAjpBEmI(this.$currentTabPosition.getLeft(), TabRowKt.TabRowIndicatorSpec, null, null, $composer, 0, 12);
            ...
            boolean invalid$iv = $composer.changed(stateM161animateDpAsStateAjpBEmI2);
            ...
            if (invalid$iv || it$iv == Composer.INSTANCE.getEmpty()) {
                value$iv = (Function1) new Function1<Density, IntOffset>() { // from class: androidx.compose.material3.TabRowDefaults$tabIndicatorOffset$2$1$1
                    ...
                    public /* bridge */ /* synthetic */ IntOffset invoke(Density density) {
                        return IntOffset.m7624boximpl(m2873invokeBjo55l4(density));
                    }

                    /* JADX INFO: renamed from: invoke-Bjo55l4, reason: not valid java name */
                    public final long m2873invokeBjo55l4(Density $this$offset) {
                        return IntOffsetKt.IntOffset($this$offset.mo399roundToPx0680j_4(TabRowDefaults.AnonymousClass2.invoke$lambda$1(stateM161animateDpAsStateAjpBEmI2)), 0);
                    }
                };
            ...
            ComposerKt.sourceInformationMarkerEnd($composer);
            Modifier modifierM869width3ABfNKs = SizeKt.m869width3ABfNKs(OffsetKt.offset(modifierWrapContentSize$default, (Function1) value$iv), invoke$lambda$0(stateM161animateDpAsStateAjpBEmI));
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            $composer.endReplaceGroup();
            return modifierM869width3ABfNKs;
        }
