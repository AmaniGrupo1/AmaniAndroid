...
public final class PullToRefreshStateImpl implements PullToRefreshState {
    ...
    public Object animateToThreshold(Continuation<? super Unit> continuation) {
        ...
        Object objAnimateTo = animatable.animateTo(Boxing.boxFloat(1.0f), (4 & 2) != 0 ? animatable.defaultSpringSpec : null, (4 & 4) != 0 ? animatable.getVelocity() : null, (4 & 8) != 0 ? null : null, continuation);
    ...
    public Object animateToHidden(Continuation<? super Unit> continuation) {
        Animatable<Float, AnimationVector1D> animatable = this.anim;
        Object objAnimateTo = animatable.animateTo(Boxing.boxFloat(0.0f), (4 & 2) != 0 ? animatable.defaultSpringSpec : null, (4 & 4) != 0 ? animatable.getVelocity() : null, (4 & 8) != 0 ? null : null, continuation);
        return objAnimateTo == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objAnimateTo : Unit.INSTANCE;
    }
