...
public final /* data */ class PullToRefreshElement extends ModifierNodeElement<PullToRefreshModifierNode> {
    ...
    public static /* synthetic */ PullToRefreshElement m3269copyM2VBTUQ$default(PullToRefreshElement pullToRefreshElement, boolean z, Function0 function0, boolean z2, PullToRefreshState pullToRefreshState, float f, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        float f2 = f;
        boolean z3 = z2;
        return pullToRefreshElement.m3271copyM2VBTUQ(z, function0, z3, pullToRefreshState, f2);
    }
    ...
    public final PullToRefreshElement m3271copyM2VBTUQ(boolean isRefreshing, Function0<Unit> onRefresh, boolean enabled, PullToRefreshState state, float threshold) {
    ...
    public boolean equals(Object other) {
        ...
        return this.isRefreshing == pullToRefreshElement.isRefreshing && Intrinsics.areEqual(this.onRefresh, pullToRefreshElement.onRefresh) && this.enabled == pullToRefreshElement.enabled && Intrinsics.areEqual(this.state, pullToRefreshElement.state) && Dp.m7510equalsimpl0(this.threshold, pullToRefreshElement.threshold);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (((((((Boolean.hashCode(this.isRefreshing) * 31) + this.onRefresh.hashCode()) * 31) + Boolean.hashCode(this.enabled)) * 31) + this.state.hashCode()) * 31) + Dp.m7511hashCodeimpl(this.threshold);
    }

    public String toString() {
        return "PullToRefreshElement(isRefreshing=" + this.isRefreshing + ", onRefresh=" + this.onRefresh + ", enabled=" + this.enabled + ", state=" + this.state + ", threshold=" + ((Object) Dp.m7516toStringimpl(this.threshold)) + ')';
    }
    ...
    public final float m3272getThresholdD9Ej5fM() {
        return this.threshold;
    }
    ...
    public void update(PullToRefreshModifierNode node) {
        ...
        node.m3285setThreshold0680j_4(this.threshold);
    ...
    public void inspectableProperties(InspectorInfo $this$inspectableProperties) {
        ...
        $this$inspectableProperties.getProperties().set("threshold", Dp.m7503boximpl(this.threshold));
    }
}
