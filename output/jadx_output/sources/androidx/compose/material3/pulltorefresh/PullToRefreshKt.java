...
public final class PullToRefreshKt {
    ...
    private static final float ArcRadius = Dp.m7505constructorimpl((float) 5.5d);
    private static final float SpinnerSize = Dp.m7505constructorimpl(16);
    private static final float SpinnerContainerSize = Dp.m7505constructorimpl(40);
    ...
    public static final void PullToRefreshBox(final boolean isRefreshing, final Function0<Unit> function0, Modifier modifier, PullToRefreshState state, Alignment contentAlignment, Function3<? super BoxScope, ? super Composer, ? super Integer, Unit> function3, final Function3<? super BoxScope, ? super Composer, ? super Integer, Unit> function32, Composer $composer, final int $changed, final int i) {
        ...
        if ((599187 & $dirty2) == 599186 && $composer2.getSkipping()) {
                ...
                if (i5 != 0) {
                    ...
                    function3RememberComposableLambda = ComposableLambdaKt.rememberComposableLambda(1989171225, true, new Function3<BoxScope, Composer, Integer, Unit>() { // from class: androidx.compose.material3.pulltorefresh.PullToRefreshKt.PullToRefreshBox.1
                        ...
                        public final void invoke(BoxScope $this$null, Composer $composer3, int $changed2) {
                            ...
                            PullToRefreshDefaults.INSTANCE.m3266Indicator2poqoh4(state2, isRefreshing, $this$null.align(Modifier.INSTANCE, Alignment.INSTANCE.getTopCenter()), 0L, 0L, 0.0f, $composer3, 1572864, 56);
                            if (ComposerKt.isTraceInProgress()) {
            ...
            Modifier modifier$iv = m3280pullToRefreshZ4HSEVQ$default(modifier5, isRefreshing, state3, false, 0.0f, function02, 12, null);
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.pulltorefresh.PullToRefreshKt.PullToRefreshBox.3
                ...
                public final void invoke(Composer composer, int i7) {
                    PullToRefreshKt.PullToRefreshBox(isRefreshing, function0, modifier4, state4, contentAlignment3, function33, function32, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    public static final Modifier m3281pullToRefreshIndicatorwUdLESc(Modifier $this$pullToRefreshIndicator_u2dwUdLESc, final PullToRefreshState state, final boolean isRefreshing, final float threshold, final Shape shape, long containerColor, final float elevation) {
        return BackgroundKt.m263backgroundbw27NRU(GraphicsLayerModifierKt.graphicsLayer(DrawModifierKt.drawWithContent(SizeKt.m864size3ABfNKs($this$pullToRefreshIndicator_u2dwUdLESc, SpinnerContainerSize), new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.material3.pulltorefresh.PullToRefreshKt$pullToRefreshIndicator$1
            ...
            public final void invoke2(ContentDrawScope $this$drawWithContent) {
                ...
                try {
                    ...
                    $this$clipRect_rOu3jXo_u24lambda_u244$iv.mo5195clipRectN_I0leg(-3.4028235E38f, 0.0f, Float.MAX_VALUE, Float.MAX_VALUE, clipOp$iv);
            ...
            public final void invoke2(GraphicsLayerScope $this$graphicsLayer) {
                ...
                $this$graphicsLayer.setTranslationY((state.getDistanceFraction() * $this$graphicsLayer.mo399roundToPx0680j_4(threshold)) - Size.m4518getHeightimpl($this$graphicsLayer.getSize()));
                $this$graphicsLayer.setShadowElevation(showElevation ? $this$graphicsLayer.mo405toPx0680j_4(elevation) : 0.0f);
    ...
    public static /* synthetic */ Modifier m3280pullToRefreshZ4HSEVQ$default(Modifier modifier, boolean z, PullToRefreshState pullToRefreshState, boolean z2, float f, Function0 function0, int i, Object obj) {
        boolean z3;
        float fM3268getPositionalThresholdD9Ej5fM;
        if ((i & 4) == 0) {
            z3 = z2;
        } else {
            z3 = true;
        ...
        if ((i & 8) == 0) {
            fM3268getPositionalThresholdD9Ej5fM = f;
        } else {
            fM3268getPositionalThresholdD9Ej5fM = PullToRefreshDefaults.INSTANCE.m3268getPositionalThresholdD9Ej5fM();
        }
        return m3279pullToRefreshZ4HSEVQ(modifier, z, pullToRefreshState, z3, fM3268getPositionalThresholdD9Ej5fM, function0);
    }

    /* JADX INFO: renamed from: pullToRefresh-Z4HSEVQ, reason: not valid java name */
    public static final Modifier m3279pullToRefreshZ4HSEVQ(Modifier $this$pullToRefresh_u2dZ4HSEVQ, boolean isRefreshing, PullToRefreshState state, boolean enabled, float threshold, Function0<Unit> function0) {
    ...
    public static final PullToRefreshState rememberPullToRefreshState(Composer $composer, int $changed) {
        ...
        PullToRefreshStateImpl pullToRefreshStateImpl = (PullToRefreshStateImpl) RememberSaveableKt.m4137rememberSaveable(new Object[0], (Saver) PullToRefreshStateImpl.INSTANCE.getSaver(), (String) null, (Function0) new Function0<PullToRefreshStateImpl>() { // from class: androidx.compose.material3.pulltorefresh.PullToRefreshKt.rememberPullToRefreshState.1
    ...
    public static final void m3273CircularArrowProgressIndicatorRPmYEkk(final Function0<Float> function0, final long j, Composer composer, final int i) {
        Object obj;
        ...
        if ((i2 & 19) == 18 && composerStartRestartGroup.getSkipping()) {
            ...
            ComposerKt.sourceInformationMarkerEnd(composerStartRestartGroup);
            Modifier modifierM864size3ABfNKs = SizeKt.m864size3ABfNKs(SemanticsModifierKt.semantics(companion, true, (Function1) obj2), SpinnerSize);
                ...
                obj3 = (Function1) new Function1<DrawScope, Unit>() { // from class: androidx.compose.material3.pulltorefresh.PullToRefreshKt$CircularArrowProgressIndicator$2$1
                    ...
                    public final void invoke2(DrawScope $this$Canvas) throws Throwable {
                        ...
                        try {
                            ...
                            float arcRadius = $this$Canvas.mo405toPx0680j_4(PullToRefreshKt.ArcRadius) + ($this$Canvas.mo405toPx0680j_4(PullToRefreshKt.StrokeWidth) / 2.0f);
                            Rect arcBounds = RectKt.m4491Rect3MmeM6k(androidx.compose.ui.geometry.SizeKt.m4531getCenteruvyYCjk($this$Canvas.mo5271getSizeNHjbRc()), arcRadius);
                            try {
                                previousSize$iv$iv = previousSize$iv$iv2;
                                try {
                                    PullToRefreshKt.m3278drawCircularIndicatorKzyDr3Q($this$Canvas, j2, alpha, values, arcBounds, PullToRefreshKt.StrokeWidth);
                                    $this$withTransform_u24lambda_u246$iv$iv = $this$withTransform_u24lambda_u246$iv$iv2;
                                    try {
                                        try {
                                            PullToRefreshKt.m3277drawArrowuDrxG_w($this$Canvas, path2, arcBounds, j2, alpha, values, PullToRefreshKt.StrokeWidth);
                                            $this$withTransform_u24lambda_u246$iv$iv.getCanvas().restore();
                                            $this$withTransform_u24lambda_u246$iv$iv.mo5193setSizeuvyYCjk(previousSize$iv$iv);
                                        } catch (Throwable th) {
                                            th = th;
            ...
            ComposerKt.sourceInformationMarkerEnd(composerStartRestartGroup);
            CanvasKt.Canvas(modifierM864size3ABfNKs, (Function1) obj3, composerStartRestartGroup, 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.pulltorefresh.PullToRefreshKt$CircularArrowProgressIndicator$3
                ...
                public final void invoke(Composer composer2, int i4) {
                    PullToRefreshKt.m3273CircularArrowProgressIndicatorRPmYEkk(function0, j, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1));
                }
            });
        }
    }
    ...
    public static final void m3278drawCircularIndicatorKzyDr3Q(DrawScope $this$drawCircularIndicator_u2dKzyDr3Q, long color, float alpha, ArrowValues values, Rect arcBounds, float strokeWidth) {
        DrawScope.m5250drawArcyD3GUKo$default($this$drawCircularIndicator_u2dKzyDr3Q, color, values.getStartAngle(), values.getEndAngle() - values.getStartAngle(), false, arcBounds.m4487getTopLeftF1C5BW0(), arcBounds.m4485getSizeNHjbRc(), alpha, new Stroke($this$drawCircularIndicator_u2dKzyDr3Q.mo405toPx0680j_4(strokeWidth), 0.0f, StrokeCap.INSTANCE.m5071getButtKaPHkGw(), 0, null, 26, null), null, 0, ValidationPath.MAX_PATH_LENGTH_BYTES, null);
    }
    ...
    public static final void m3277drawArrowuDrxG_w(DrawScope $this$drawArrow_u2duDrxG_w, Path arrow, Rect bounds, long color, float alpha, ArrowValues values, float strokeWidth) throws Throwable {
        DrawContext $this$withTransform_u24lambda_u246$iv$iv;
        long previousSize$iv$iv;
        arrow.reset();
        arrow.moveTo(0.0f, 0.0f);
        arrow.lineTo(($this$drawArrow_u2duDrxG_w.mo405toPx0680j_4(ArrowWidth) * values.getScale()) / 2, $this$drawArrow_u2duDrxG_w.mo405toPx0680j_4(ArrowHeight) * values.getScale());
        arrow.lineTo($this$drawArrow_u2duDrxG_w.mo405toPx0680j_4(ArrowWidth) * values.getScale(), 0.0f);
        float radius = Math.min(bounds.getWidth(), bounds.getHeight()) / 2.0f;
        float inset = ($this$drawArrow_u2duDrxG_w.mo405toPx0680j_4(ArrowWidth) * values.getScale()) / 2.0f;
        arrow.mo4589translatek4lQ0M(OffsetKt.Offset((Offset.m4452getXimpl(bounds.m4482getCenterF1C5BW0()) + radius) - inset, Offset.m4453getYimpl(bounds.m4482getCenterF1C5BW0()) - $this$drawArrow_u2duDrxG_w.mo405toPx0680j_4(strokeWidth)));
        float degrees$iv = values.getEndAngle() - $this$drawArrow_u2duDrxG_w.mo405toPx0680j_4(strokeWidth);
        long pivot$iv = $this$drawArrow_u2duDrxG_w.mo5270getCenterF1C5BW0();
        ...
        try {
            DrawScope.m5261drawPathLG529CI$default($this$drawArrow_u2duDrxG_w, arrow, color, alpha, new Stroke($this$drawArrow_u2duDrxG_w.mo405toPx0680j_4(strokeWidth), 0.0f, 0, 0, null, 30, null), null, 0, 48, null);
            $this$withTransform_u24lambda_u246$iv$iv.getCanvas().restore();
            $this$withTransform_u24lambda_u246$iv$iv.mo5193setSizeuvyYCjk(previousSize$iv$iv);
        } catch (Throwable th3) {
            th = th3;
