...
public final class TabIndicatorOffsetNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo69measure3p2s80s(final MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        if (!this.tabPositionsState.getValue().isEmpty()) {
            ...
            if (this.initialWidth == null) {
                this.initialWidth = Dp.m7503boximpl(currentTabWidth);
            } else {
                ...
                if (!Dp.m7510equalsimpl0(currentTabWidth, animatable.getTargetValue().m7519unboximpl())) {
                    BuildersKt__Builders_commonKt.launch$default(getCoroutineScope(), null, null, new TabIndicatorOffsetNode$measure$2(animatable, currentTabWidth, null), 3, null);
                }
            }
            float indicatorOffset = this.tabPositionsState.getValue().get(this.selectedTabIndex).getLeft();
            if (this.initialOffset == null) {
                this.initialOffset = Dp.m7503boximpl(indicatorOffset);
            } else {
                ...
                if (!Dp.m7510equalsimpl0(indicatorOffset, animatable2.getTargetValue().m7519unboximpl())) {
                    BuildersKt__Builders_commonKt.launch$default(getCoroutineScope(), null, null, new TabIndicatorOffsetNode$measure$3(animatable2, indicatorOffset, null), 3, null);
                }
            }
            Animatable<Dp, AnimationVector1D> animatable3 = this.offsetAnimatable;
            final float offset = animatable3 != null ? animatable3.getValue().m7519unboximpl() : indicatorOffset;
            Animatable<Dp, AnimationVector1D> animatable4 = this.widthAnimatable;
            float width = animatable4 != null ? animatable4.getValue().m7519unboximpl() : currentTabWidth;
            final Placeable placeable = measurable.mo6141measureBRTryo0(Constraints.m7447copyZbe2FdA(constraints, (11 & 1) != 0 ? Constraints.m7460getMinWidthimpl(constraints) : $this$measure_u2d3p2s80s.mo399roundToPx0680j_4(width), (11 & 2) != 0 ? Constraints.m7458getMaxWidthimpl(constraints) : $this$measure_u2d3p2s80s.mo399roundToPx0680j_4(width), (11 & 4) != 0 ? Constraints.m7459getMinHeightimpl(constraints) : 0, (11 & 8) != 0 ? Constraints.m7457getMaxHeightimpl(constraints) : 0));
            return MeasureScope.layout$default($this$measure_u2d3p2s80s, placeable.getWidth(), placeable.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.TabIndicatorOffsetNode$measure$4
                ...
                public final void invoke2(Placeable.PlacementScope $this$layout) {
                    Placeable.PlacementScope.place$default($this$layout, placeable, $this$measure_u2d3p2s80s.mo399roundToPx0680j_4(offset), 0, 0.0f, 4, null);
                }
            }, 4, null);
        }
