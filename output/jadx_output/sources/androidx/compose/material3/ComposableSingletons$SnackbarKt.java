...
public final class ComposableSingletons$SnackbarKt {
    ...
    public static Function2<Composer, Integer, Unit> f121lambda1 = ComposableLambdaKt.composableLambdaInstance(-505750804, false, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ComposableSingletons$SnackbarKt$lambda-1$1
        ...
        public final void invoke(Composer $composer, int $changed) {
            ...
            if (($changed & 3) != 2 || !$composer.getSkipping()) {
                ...
                IconKt.m2433Iconww6aTOc(close, Strings_androidKt.m3257getString2EP1pXo(Strings.m3187constructorimpl(R.string.m3c_snackbar_dismiss), $composer, 0), (Modifier) null, 0L, $composer, 0, 12);
                if (ComposerKt.isTraceInProgress()) {
    ...
    public final Function2<Composer, Integer, Unit> m2265getLambda1$material3_release() {
        return f121lambda1;
    }
}
