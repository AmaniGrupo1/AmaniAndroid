...
public final class SearchBarColors {
    ...
    private SearchBarColors(long containerColor, long dividerColor) {
        this(containerColor, dividerColor, SearchBar_androidKt.UnspecifiedTextFieldColors, null);
    }
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof SearchBarColors) && Color.m4698equalsimpl0(this.containerColor, ((SearchBarColors) other).containerColor) && Color.m4698equalsimpl0(this.dividerColor, ((SearchBarColors) other).dividerColor) && Intrinsics.areEqual(this.inputFieldColors, ((SearchBarColors) other).inputFieldColors);
    }

    public int hashCode() {
        int result = Color.m4704hashCodeimpl(this.containerColor);
        return (((result * 31) + Color.m4704hashCodeimpl(this.dividerColor)) * 31) + this.inputFieldColors.hashCode();
    }
}
