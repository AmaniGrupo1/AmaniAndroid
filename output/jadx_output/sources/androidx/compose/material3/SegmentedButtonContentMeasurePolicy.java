...
public final class SegmentedButtonContentMeasurePolicy implements MultiContentMeasurePolicy {
    ...
    public MeasureResult mo762measure3p2s80s(final MeasureScope $this$measure_u2d3p2s80s, List<? extends List<? extends Measurable>> list, long constraints) {
        Object maxElem$iv;
        Object maxElem$iv2;
        Object maxElem$iv3;
        ...
        while (index$iv$iv2 < size2) {
            ...
            target$iv2.add(it4.mo6141measureBRTryo0(constraints));
            index$iv$iv2++;
        ...
        int width3 = Math.max($this$measure_u2d3p2s80s.mo399roundToPx0680j_4(SegmentedButtonDefaults.INSTANCE.m2737getIconSizeD9Ej5fM()), iconWidth) + $this$measure_u2d3p2s80s.mo399roundToPx0680j_4(SegmentedButtonKt.IconSpacing) + (contentWidth != null ? contentWidth.intValue() : 0);
        final int offsetX = iconWidth == 0 ? (-($this$measure_u2d3p2s80s.mo399roundToPx0680j_4(SegmentedButtonDefaults.INSTANCE.m2737getIconSizeD9Ej5fM()) + $this$measure_u2d3p2s80s.mo399roundToPx0680j_4(SegmentedButtonKt.IconSpacing))) / 2 : 0;
        ...
        return MeasureScope.layout$default($this$measure_u2d3p2s80s, width3, height3, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.SegmentedButtonContentMeasurePolicy$measure$2
            ...
            public final void invoke2(Placeable.PlacementScope $this$layout) {
                List<Placeable> list8 = iconPlaceables2;
                int i = height3;
                ...
                int i2 = $this$measure_u2d3p2s80s.mo399roundToPx0680j_4(SegmentedButtonDefaults.INSTANCE.m2737getIconSizeD9Ej5fM()) + $this$measure_u2d3p2s80s.mo399roundToPx0680j_4(SegmentedButtonKt.IconSpacing);
