...
public final class IconKt {
    private static final Modifier DefaultIconSizeModifier = SizeKt.m864size3ABfNKs(Modifier.INSTANCE, IconButtonTokens.INSTANCE.m3572getIconSizeD9Ej5fM());

    /* JADX INFO: renamed from: Icon-ww6aTOc, reason: not valid java name */
    public static final void m2433Iconww6aTOc(final ImageVector imageVector, final String contentDescription, Modifier modifier, long tint, Composer $composer, final int $changed, final int i) {
        String str;
        ...
        if (($dirty & 1171) == 1170 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if ((i & 8) != 0) {
                    ...
                    $dirty &= -7169;
                    modifier3 = modifier4;
                    tint3 = ((Color) objConsume).m4707unboximpl();
                } else {
                    modifier3 = modifier4;
                    tint3 = tint2;
                }
            ...
            m2432Iconww6aTOc(VectorPainterKt.rememberVectorPainter(imageVector, $composer2, $dirty & 14), str, modifier3, tint3, $composer2, VectorPainter.$stable | ($dirty & 112) | ($dirty & 896) | ($dirty & 7168), 0);
            if (ComposerKt.isTraceInProgress()) {
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.IconKt.Icon.1
                ...
                public final void invoke(Composer composer, int i4) {
                    IconKt.m2433Iconww6aTOc(imageVector, contentDescription, modifier2, tint2, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    /* JADX INFO: renamed from: Icon-ww6aTOc, reason: not valid java name */
    public static final void m2431Iconww6aTOc(final ImageBitmap bitmap, final String contentDescription, Modifier modifier, long tint, Composer $composer, final int $changed, final int i) {
        String str;
        Modifier modifier2;
        long j;
        int $dirty;
        ...
        if (($dirty2 & 1171) == 1170 && $composer3.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer3.getDefaultsInvalid()) {
                ...
                if ((i & 8) != 0) {
                    ...
                    long tint4 = ((Color) objConsume).m4707unboximpl();
                    $dirty = $dirty2 & (-7169);
                    modifier3 = modifier5;
                    tint2 = tint4;
                } else {
            ...
            ComposerKt.sourceInformationMarkerEnd($composer3);
            m2432Iconww6aTOc(painter, str, modifier3, tint2, $composer3, ($dirty & 112) | ($dirty & 896) | ($dirty & 7168), 0);
            $composer2 = $composer3;
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.IconKt.Icon.2
                ...
                public final void invoke(Composer composer, int i4) {
                    IconKt.m2431Iconww6aTOc(bitmap, contentDescription, modifier4, tint3, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    /* JADX INFO: renamed from: Icon-ww6aTOc, reason: not valid java name */
    public static final void m2432Iconww6aTOc(final Painter painter, final String contentDescription, Modifier modifier, long tint, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        long j;
        long tint2;
        Modifier modifier3;
        ...
        if (($changed & 3072) == 0) {
            if ((i & 8) == 0) {
                j = tint;
                int i4 = $composer2.changed(j) ? 2048 : 1024;
                $dirty |= i4;
            } else {
                j = tint;
            }
        ...
        if (($dirty & 1171) == 1170 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if ((i & 8) != 0) {
                    ...
                    $dirty &= -7169;
                    modifier3 = modifier5;
                    tint2 = ((Color) objConsume).m4707unboximpl();
                } else {
                    tint2 = j;
                    modifier3 = modifier5;
                }
            ...
            if (invalid$iv || value$iv2 == Composer.INSTANCE.getEmpty()) {
                value$iv2 = Color.m4698equalsimpl0(tint2, Color.INSTANCE.m4733getUnspecified0d7_KjU()) ? null : ColorFilter.Companion.m4738tintxETnrds$default(ColorFilter.INSTANCE, tint2, 0, 2, null);
                ...
                if (invalid$iv2 || it$iv == Composer.INSTANCE.getEmpty()) {
                    value$iv = (Function1) new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.IconKt$Icon$semantics$1$1
                        ...
                        public final void invoke2(SemanticsPropertyReceiver $this$semantics) {
                            ...
                            SemanticsPropertiesKt.m6718setRolekuIjeqM($this$semantics, Role.INSTANCE.m6703getImageo7Vup1c());
                        }
                    };
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.IconKt.Icon.3
                ...
                public final void invoke(Composer composer, int i5) {
                    IconKt.m2432Iconww6aTOc(painter, contentDescription, modifier4, tint3, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    public static final void Icon(final Painter painter, final ColorProducer tint, final String contentDescription, Modifier modifier, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty2 & 1171) != 1170 || !$composer2.getSkipping()) {
            ...
            $composer2.endReplaceGroup();
            Modifier modifierDefaultSizeForColorProducer = defaultSizeForColorProducer(GraphicsLayerModifierKt.toolingGraphicsLayer(modifier2), painter);
            ...
            if (invalid$iv2 || it$iv2 == Composer.INSTANCE.getEmpty()) {
                value$iv = (Function1) new Function1<DrawScope, Unit>() { // from class: androidx.compose.material3.IconKt$Icon$4$1
                    ...
                    /* JADX INFO: renamed from: invoke, reason: avoid collision after fix types in other method */
                    public final void invoke2(DrawScope $this$drawBehind) throws Throwable {
                        ColorFilter colorFilterM4738tintxETnrds$default;
                        Painter $this$invoke_u24lambda_u241 = painter;
                        ColorProducer colorProducer = tint;
                        long jMo5271getSizeNHjbRc = $this$drawBehind.mo5271getSizeNHjbRc();
                        if (colorProducer != null) {
                            long it = colorProducer.mo1802invoke0d7_KjU();
                            colorFilterM4738tintxETnrds$default = ColorFilter.Companion.m4738tintxETnrds$default(ColorFilter.INSTANCE, it, 0, 2, null);
                        } else {
                            colorFilterM4738tintxETnrds$default = null;
                        }
                        Painter.m5396drawx_KDEd0$default($this$invoke_u24lambda_u241, $this$drawBehind, jMo5271getSizeNHjbRc, 0.0f, colorFilterM4738tintxETnrds$default, 2, null);
                    }
                };
                $composer2.updateRememberedValue(value$iv);
            } else {
            ...
            ComposerKt.sourceInformationMarkerEnd($composer2);
            BoxKt.Box(DrawModifierKt.drawBehind(modifierDefaultSizeForColorProducer, (Function1) value$iv).then(semantics), $composer2, 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            modifier3 = modifier2;
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.IconKt.Icon.5
                ...
                public final void invoke(Composer composer, int i3) {
                    IconKt.Icon(painter, tint, contentDescription, modifier3, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    private static final Modifier defaultSizeForColorProducer(Modifier $this$defaultSizeForColorProducer, Painter painter) {
        ...
        if (Size.m4517equalsimpl0(painter.getIntrinsicSize(), Size.INSTANCE.m4529getUnspecifiedNHjbRc()) || m2434isInfiniteuvyYCjk(painter.getIntrinsicSize())) {
            modifierLayout = DefaultIconSizeModifier;
        } else {
            long intrinsicSize = painter.getIntrinsicSize();
            final float srcWidth = Size.m4521getWidthimpl(intrinsicSize);
            final float srcHeight = Size.m4518getHeightimpl(intrinsicSize);
            modifierLayout = LayoutModifierKt.layout(Modifier.INSTANCE, new Function3<MeasureScope, Measurable, Constraints, MeasureResult>() { // from class: androidx.compose.material3.IconKt.defaultSizeForColorProducer.1
                ...
                public /* bridge */ /* synthetic */ MeasureResult invoke(MeasureScope measureScope, Measurable measurable, Constraints constraints) {
                    return m2435invoke3p2s80s(measureScope, measurable, constraints.getValue());
                }

                /* JADX INFO: renamed from: invoke-3p2s80s, reason: not valid java name */
                public final MeasureResult m2435invoke3p2s80s(MeasureScope $this$layout, Measurable measurable, long j) {
                    final Placeable placeable = measurable.mo6141measureBRTryo0(Constraints.INSTANCE.m7468fixedJhjzzOo((int) srcWidth, (int) srcHeight));
        ...
        return $this$defaultSizeForColorProducer.then(modifierLayout);
    }
    ...
    private static final boolean m2434isInfiniteuvyYCjk(long $this$isInfinite_u2duvyYCjk) {
        return Float.isInfinite(Size.m4521getWidthimpl($this$isInfinite_u2duvyYCjk)) && Float.isInfinite(Size.m4518getHeightimpl($this$isInfinite_u2duvyYCjk));
    }
}
