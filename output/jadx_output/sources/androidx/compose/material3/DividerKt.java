...
@Metadata(d1 = {"\u0000\u001c\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0007\u001a0\u0010\u0000\u001a\u00020\u00012\b\b\u0002\u0010\u0002\u001a\u00020\u00032\b\b\u0002\u0010\u0004\u001a\u00020\u00052\b\b\u0002\u0010\u0006\u001a\u00020\u0007H\u0007ø\u0001\u0000¢\u0006\u0004\b\b\u0010\t\u001a0\u0010\n\u001a\u00020\u00012\b\b\u0002\u0010\u0002\u001a\u00020\u00032\b\b\u0002\u0010\u0004\u001a\u00020\u00052\b\b\u0002\u0010\u0006\u001a\u00020\u0007H\u0007ø\u0001\u0000¢\u0006\u0004\b\u000b\u0010\t\u001a0\u0010\f\u001a\u00020\u00012\b\b\u0002\u0010\u0002\u001a\u00020\u00032\b\b\u0002\u0010\u0004\u001a\u00020\u00052\b\b\u0002\u0010\u0006\u001a\u00020\u0007H\u0007ø\u0001\u0000¢\u0006\u0004\b\r\u0010\t\u0082\u0002\u0007\n\u0005\b¡\u001e0\u0001¨\u0006\u000e"}, d2 = {"Divider", "", "modifier", "Landroidx/compose/ui/Modifier;", "thickness", "Landroidx/compose/ui/unit/Dp;", TtmlNode.ATTR_TTS_COLOR, "Landroidx/compose/ui/graphics/Color;", "Divider-9IZ8Weo", "(Landroidx/compose/ui/Modifier;FJLandroidx/compose/runtime/Composer;II)V", "HorizontalDivider", "HorizontalDivider-9IZ8Weo", "VerticalDivider", "VerticalDivider-9IZ8Weo", "material3_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
public final class DividerKt {
    /* JADX INFO: renamed from: HorizontalDivider-9IZ8Weo, reason: not valid java name */
    public static final void m2355HorizontalDivider9IZ8Weo(Modifier modifier, float thickness, long color, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        float f;
        final long color2;
        ...
        if (($dirty & 147) == 146 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                thickness2 = i3 != 0 ? DividerDefaults.INSTANCE.m2353getThicknessD9Ej5fM() : f;
                if ((i & 4) != 0) {
                    $dirty &= -897;
            ...
            boolean z = true;
            Modifier modifierM850height3ABfNKs = SizeKt.m850height3ABfNKs(SizeKt.fillMaxWidth$default(modifier3, 0.0f, 1, null), thickness2);
            ...
            if (invalid$iv || it$iv == Composer.INSTANCE.getEmpty()) {
                value$iv = (Function1) new Function1<DrawScope, Unit>() { // from class: androidx.compose.material3.DividerKt$HorizontalDivider$1$1
                    ...
                    public final void invoke2(DrawScope $this$Canvas) {
                        float f2 = 2;
                        DrawScope.m5257drawLineNGM6Ib0$default($this$Canvas, color2, OffsetKt.Offset(0.0f, $this$Canvas.mo405toPx0680j_4(thickness2) / f2), OffsetKt.Offset(Size.m4521getWidthimpl($this$Canvas.mo5271getSizeNHjbRc()), $this$Canvas.mo405toPx0680j_4(thickness2) / f2), $this$Canvas.mo405toPx0680j_4(thickness2), 0, null, 0.0f, null, 0, 496, null);
                    }
                };
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DividerKt$HorizontalDivider$2
                ...
                public final void invoke(Composer composer, int i5) {
                    DividerKt.m2355HorizontalDivider9IZ8Weo(modifier4, thickness3, color3, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    public static final void m2356VerticalDivider9IZ8Weo(Modifier modifier, float thickness, long color, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        float f;
        final long color2;
        Modifier.Companion modifier3;
        ...
        if (($dirty & 147) == 146 && $composer2.getSkipping()) {
            ...
            boolean z = true;
            Modifier modifierM869width3ABfNKs = SizeKt.m869width3ABfNKs(SizeKt.fillMaxHeight$default(modifier3, 0.0f, 1, null), thickness2);
            ...
            if (invalid$iv || it$iv == Composer.INSTANCE.getEmpty()) {
                value$iv = (Function1) new Function1<DrawScope, Unit>() { // from class: androidx.compose.material3.DividerKt$VerticalDivider$1$1
                    ...
                    public final void invoke2(DrawScope $this$Canvas) {
                        float f2 = 2;
                        DrawScope.m5257drawLineNGM6Ib0$default($this$Canvas, color2, OffsetKt.Offset($this$Canvas.mo405toPx0680j_4(thickness2) / f2, 0.0f), OffsetKt.Offset($this$Canvas.mo405toPx0680j_4(thickness2) / f2, Size.m4518getHeightimpl($this$Canvas.mo5271getSizeNHjbRc())), $this$Canvas.mo405toPx0680j_4(thickness2), 0, null, 0.0f, null, 0, 496, null);
                    }
                };
                $composer2.updateRememberedValue(value$iv);
            } else {
            ...
            ComposerKt.sourceInformationMarkerEnd($composer2);
            CanvasKt.Canvas(modifierM869width3ABfNKs, (Function1) value$iv, $composer2, 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            modifier4 = modifier3;
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DividerKt$VerticalDivider$2
                ...
                public final void invoke(Composer composer, int i5) {
                    DividerKt.m2356VerticalDivider9IZ8Weo(modifier4, thickness3, color3, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    public static final void m2354Divider9IZ8Weo(Modifier modifier, float thickness, long color, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        float f;
        long color2;
        Modifier.Companion modifier3;
        ...
        if (($dirty & 147) == 146 && $composer2.getSkipping()) {
            ...
            if (Dp.m7510equalsimpl0(thickness2, Dp.INSTANCE.m7523getHairlineD9Ej5fM())) {
                ProvidableCompositionLocal<Density> localDensity = CompositionLocalsKt.getLocalDensity();
                ComposerKt.sourceInformationMarkerStart($composer2, 2023513938, "CC:CompositionLocal.kt#9igjgp");
                Object objConsume = $composer2.consume(localDensity);
                ComposerKt.sourceInformationMarkerEnd($composer2);
                float $this$dp$iv = 1.0f / ((Density) objConsume).getDensity();
                targetThickness = Dp.m7505constructorimpl($this$dp$iv);
            } else {
                targetThickness = thickness2;
            }
            $composer2.endReplaceGroup();
            BoxKt.Box(BackgroundKt.m264backgroundbw27NRU$default(SizeKt.m850height3ABfNKs(SizeKt.fillMaxWidth$default(modifier3, 0.0f, 1, null), targetThickness), color3, null, 2, null), $composer2, 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            modifier4 = modifier3;
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DividerKt$Divider$1
                ...
                public final void invoke(Composer composer, int i5) {
                    DividerKt.m2354Divider9IZ8Weo(modifier4, thickness3, color4, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
