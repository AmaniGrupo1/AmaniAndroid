...
public final class NavigationBarKt {
    ...
    private static final float NavigationBarHeight = NavigationBarTokens.INSTANCE.m3603getContainerHeightD9Ej5fM();
    private static final float NavigationBarItemHorizontalPadding = Dp.m7505constructorimpl(8);
    private static final float NavigationBarIndicatorToLabelPadding = Dp.m7505constructorimpl(4);

    /* JADX INFO: renamed from: NavigationBar-HsRjFd4, reason: not valid java name */
    public static final void m2556NavigationBarHsRjFd4(Modifier modifier, long containerColor, long contentColor, float tonalElevation, WindowInsets windowInsets, final Function3<? super RowScope, ? super Composer, ? super Integer, Unit> function3, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        ...
        if ((74899 & $dirty) == 74898 && $composer3.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer3.getDefaultsInvalid()) {
                ...
                if ((i & 4) != 0) {
                    contentColor2 = ColorSchemeKt.m2212contentColorFor4WTKRHQ(MaterialTheme.INSTANCE.getColorScheme($composer3, 6), containerColor2);
                    $dirty &= -897;
                }
                if (i5 != 0) {
                    tonalElevation2 = NavigationBarDefaults.INSTANCE.m2541getElevationD9Ej5fM();
                }
                if ((i & 16) != 0) {
            ...
            $composer2 = $composer3;
            SurfaceKt.m2826SurfaceT9BRK9s(modifier3, null, containerColor3, contentColor3, tonalElevation3, 0.0f, null, ComposableLambdaKt.rememberComposableLambda(105663120, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.NavigationBarKt$NavigationBar$1
                ...
                public final void invoke(Composer $composer4, int $changed2) {
                    ComposerKt.sourceInformation($composer4, "C123@5642L425:NavigationBar.kt#uh7d8r");
                    if (($changed2 & 3) != 2 || !$composer4.getSkipping()) {
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventStart(105663120, $changed2, -1, "androidx.compose.material3.NavigationBar.<anonymous> (NavigationBar.kt:123)");
                        }
                        Modifier modifier$iv = SelectableGroupKt.selectableGroup(SizeKt.m849defaultMinSizeVpY3zN4$default(WindowInsetsPaddingKt.windowInsetsPadding(SizeKt.fillMaxWidth$default(Modifier.INSTANCE, 0.0f, 1, null), windowInsets3), 0.0f, NavigationBarKt.NavigationBarHeight, 1, null));
                        Arrangement.Horizontal horizontalArrangement$iv = Arrangement.INSTANCE.m688spacedBy0680j_4(NavigationBarKt.getNavigationBarItemHorizontalPadding());
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.NavigationBarKt$NavigationBar$2
                ...
                public final void invoke(Composer composer, int i7) {
                    NavigationBarKt.m2556NavigationBarHsRjFd4(modifier4, containerColor4, contentColor4, tonalElevation4, windowInsets4, function3, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    */
    public static final void NavigationBarItem(final RowScope $this$NavigationBarItem, final boolean selected, final Function0<Unit> function0, final Function2<? super Composer, ? super Integer, Unit> function2, Modifier modifier, boolean enabled, Function2<? super Composer, ? super Integer, Unit> function22, boolean alwaysShowLabel, NavigationBarItemColors colors, MutableInteractionSource interactionSource, Composer $composer, final int $changed, final int i) {
        ...
        boolean invalid$iv;
        Object value$iv3;
        final NavigationBarItemColors colors4;
        ...
        ComposerKt.sourceInformation($composer2, "C(NavigationBarItem)P(8,7,3,6,2,5)179@8344L8,185@8576L633,215@9873L33,229@10315L24,217@9912L2687:NavigationBar.kt#uh7d8r");
        int $dirty2 = $changed;
        ...
        if (i5 != 0) {
            ...
            enabled2 = enabled;
            $dirty2 |= $composer2.changed(enabled2) ? 131072 : 65536;
        } else {
            enabled2 = enabled;
        }
        int i6 = i & 32;
        ...
        if (i7 != 0) {
            ...
            alwaysShowLabel2 = alwaysShowLabel;
            $dirty2 |= $composer2.changed(alwaysShowLabel2) ? 8388608 : 4194304;
        } else {
            alwaysShowLabel2 = alwaysShowLabel;
        }
        if (($changed & 100663296) == 0) {
            $dirty2 |= ((i & 128) == 0 && $composer2.changed(colors)) ? 67108864 : 33554432;
        }
        int i8 = i & 256;
        if (i8 != 0) {
            $dirty2 |= 805306368;
            ...
            i2 = i8;
            $dirty2 |= $composer2.changed(interactionSource) ? C.BUFFER_FLAG_LAST_SAMPLE : 268435456;
        } else {
            i2 = i8;
        }
        int $dirty3 = $dirty2;
        if (($dirty2 & 306783379) == 306783378 && $composer2.getSkipping()) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                i3 = 6;
                ComposerKt.traceEventStart(-663510974, $dirty, -1, "androidx.compose.material3.NavigationBarItem (NavigationBar.kt:181)");
            } else {
                i3 = 6;
            }
            $composer2.startReplaceGroup(-103235253);
            ComposerKt.sourceInformation($composer2, "183@8495L39");
            if (interactionSource2 == null) {
                ComposerKt.sourceInformationMarkerStart($composer2, -103234602, "CC(remember):NavigationBar.kt#9igjgp");
                colors3 = colors2;
                ...
                interactionSource3 = (MutableInteractionSource) value$iv4;
            ...
            final NavigationBarItemColors colors5 = colors3;
            MutableInteractionSource interactionSource6 = interactionSource3;
            Function2 styledIcon = ComposableLambdaKt.rememberComposableLambda(-1419576100, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.NavigationBarKt$NavigationBarItem$styledIcon$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
                    super(2);
                ...
                */
                public final void invoke(Composer $composer3, int $changed2) {
                    ...
                    if (($changed2 & 3) != 2 || !$composer3.getSkipping()) {
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventStart(-1419576100, $changed2, -1, "androidx.compose.material3.NavigationBarItem.<anonymous> (NavigationBar.kt:186)");
                        }
                        State<Color> stateM134animateColorAsStateeuL9pac = SingleValueAnimationKt.m134animateColorAsStateeuL9pac(colors3.m2552iconColorWaAFU9c$material3_release(selected, enabled4), AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, $composer3, 48, 12);
            ...
            $composer2.startReplaceGroup(-103209106);
            ComposerKt.sourceInformation($composer2, "*200@9305L535");
            Function2 styledLabel = function24 == null ? null : ComposableLambdaKt.rememberComposableLambda(1644987592, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.NavigationBarKt$NavigationBarItem$styledLabel$1$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
                    super(2);
                ...
                public final void invoke(Composer $composer3, int $changed2) {
                    ...
                    if (($changed2 & 3) != 2 || !$composer3.getSkipping()) {
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventStart(1644987592, $changed2, -1, "androidx.compose.material3.NavigationBarItem.<anonymous>.<anonymous> (NavigationBar.kt:201)");
                        }
                        TextStyle style = TypographyKt.getValue(NavigationBarTokens.INSTANCE.getLabelTextFont(), $composer3, 6);
                        ProvideContentColorTextStyleKt.m3185ProvideContentColorTextStyle3JVO9M(invoke$lambda$0(SingleValueAnimationKt.m134animateColorAsStateeuL9pac(colors5.m2553textColorWaAFU9c$material3_release(selected, enabled2), AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, $composer3, 48, 12)), style, function24, $composer3, 0);
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                            return;
                        }
            ...
            $composer2.endReplaceGroup();
            ComposerKt.sourceInformationMarkerStart($composer2, -103190512, "CC(remember):NavigationBar.kt#9igjgp");
            ...
            ComposerKt.sourceInformationMarkerEnd($composer2);
            int $dirty4 = $dirty;
            Modifier modifierWeight$default = RowScope.weight$default($this$NavigationBarItem, SizeKt.m849defaultMinSizeVpY3zN4$default(SelectableKt.m1088selectableO2vRcR0(modifier2, selected, interactionSource6, null, enabled2, Role.m6692boximpl(Role.INSTANCE.m6706getTabo7Vup1c()), function02), 0.0f, NavigationBarHeight, 1, null), 1.0f, false, 2, null);
            ComposerKt.sourceInformationMarkerStart($composer2, -103176377, "CC(remember):NavigationBar.kt#9igjgp");
            Object it$iv3 = $composer2.rememberedValue();
            if (it$iv3 == Composer.INSTANCE.getEmpty()) {
                value$iv2 = (Function1) new Function1<IntSize, Unit>() { // from class: androidx.compose.material3.NavigationBarKt$NavigationBarItem$1$1
                    {
                        super(1);
                    }
                    ...
                    public /* bridge */ /* synthetic */ Unit invoke(IntSize intSize) {
                        m2561invokeozmzZPI(intSize.m7680unboximpl());
                        return Unit.INSTANCE;
                    }

                    /* JADX INFO: renamed from: invoke-ozmzZPI, reason: not valid java name */
                    public final void m2561invokeozmzZPI(long it) {
            ...
            ComposerKt.sourceInformationMarkerEnd($composer2);
            Modifier modifier$iv = OnRemeasuredModifierKt.onSizeChanged(modifierWeight$default, (Function1) value$iv2);
            ...
            BoxScopeInstance boxScopeInstance = BoxScopeInstance.INSTANCE;
            int i10 = ((432 >> 6) & 112) | 6;
            ComposerKt.sourceInformationMarkerStart($composer2, -1652122706, "C234@10492L157,*243@10933L7,249@11215L128,256@11558L293,264@11900L395,281@12555L27,275@12305L288:NavigationBar.kt#uh7d8r");
            final State<Float> stateAnimateFloatAsState = AnimateAsStateKt.animateFloatAsState(selected ? 1.0f : 0.0f, AnimationSpecKt.tween$default(100, 0, null, i3, null), 0.0f, null, null, $composer2, 48, 28);
            ...
            int indicatorWidth = $this$NavigationBarItem_u24lambda_u249_u24lambda_u246.mo399roundToPx0680j_4(NavigationBarTokens.INSTANCE.m3601getActiveIndicatorWidthD9Ej5fM());
            long deltaOffset = OffsetKt.Offset((NavigationBarItem$lambda$3(itemWidth$delegate) - indicatorWidth) / 2, $this$NavigationBarItem_u24lambda_u249_u24lambda_u246.mo405toPx0680j_4(IndicatorVerticalOffset));
            Unit unit = Unit.INSTANCE;
            ComposerKt.sourceInformationMarkerStart($composer2, 2024938414, "CC(remember):NavigationBar.kt#9igjgp");
            ...
            if (invalid$iv2) {
                ...
                final MappedInteractionSource offsetInteractionSource = (MappedInteractionSource) value$iv5;
                ComposerKt.sourceInformationMarkerEnd($composer2);
                Function2 indicatorRipple = ComposableLambdaKt.rememberComposableLambda(691730997, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.NavigationBarKt$NavigationBarItem$2$indicatorRipple$1
                    {
                        super(2);
                    }
                    ...
                    public final void invoke(Composer $composer3, int $changed2) {
                        ...
                        if (($changed2 & 3) != 2 || !$composer3.getSkipping()) {
                            if (ComposerKt.isTraceInProgress()) {
                                ComposerKt.traceEventStart(691730997, $changed2, -1, "androidx.compose.material3.NavigationBarItem.<anonymous>.<anonymous> (NavigationBar.kt:257)");
                            }
                            BoxKt.Box(IndicationKt.indication(ClipKt.clip(LayoutIdKt.layoutId(Modifier.INSTANCE, "indicatorRipple"), ShapesKt.getValue(NavigationBarTokens.INSTANCE.getActiveIndicatorShape(), $composer3, 6)), offsetInteractionSource, RippleKt.m2690rippleOrFallbackImplementation9IZ8Weo(false, 0.0f, 0L, $composer3, 0, 7)), $composer3, 0);
                            if (ComposerKt.isTraceInProgress()) {
                                ComposerKt.traceEventEnd();
                                return;
                            }
                ...
                Function2 indicator = ComposableLambdaKt.rememberComposableLambda(-474426875, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.NavigationBarKt$NavigationBarItem$2$indicator$1
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(2);
                    }
                    ...
                    public final void invoke(Composer $composer3, int $changed2) {
                        ...
                        if (($changed2 & 3) != 2 || !$composer3.getSkipping()) {
                            if (ComposerKt.isTraceInProgress()) {
                                ComposerKt.traceEventStart(-474426875, $changed2, -1, "androidx.compose.material3.NavigationBarItem.<anonymous>.<anonymous> (NavigationBar.kt:265)");
                            }
                            ...
                            if (invalid$iv3 || it$iv4 == Composer.INSTANCE.getEmpty()) {
                                value$iv6 = (Function1) new Function1<GraphicsLayerScope, Unit>() { // from class: androidx.compose.material3.NavigationBarKt$NavigationBarItem$2$indicator$1$1$1
                                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                    {
                                        super(1);
                                    }
                            ...
                            ComposerKt.sourceInformationMarkerEnd($composer3);
                            BoxKt.Box(BackgroundKt.m263backgroundbw27NRU(GraphicsLayerModifierKt.graphicsLayer(modifierLayoutId, (Function1) value$iv6), colors5.getSelectedIndicatorColor(), ShapesKt.getValue(NavigationBarTokens.INSTANCE.getActiveIndicatorShape(), $composer3, 6)), $composer3, 0);
                            if (ComposerKt.isTraceInProgress()) {
                                ComposerKt.traceEventEnd();
                                return;
                            }
                ...
                ComposerKt.sourceInformationMarkerStart($composer2, 2024981193, "CC(remember):NavigationBar.kt#9igjgp");
                invalid$iv = $composer2.changed(stateAnimateFloatAsState);
                Object it$iv4 = $composer2.rememberedValue();
                if (!invalid$iv || it$iv4 == Composer.INSTANCE.getEmpty()) {
                    value$iv3 = (Function0) new Function0<Float>() { // from class: androidx.compose.material3.NavigationBarKt$NavigationBarItem$2$2$1
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        {
                            super(0);
                        }
                ...
                ComposerKt.sourceInformationMarkerEnd($composer2);
                NavigationBarItemLayout(indicatorRipple, indicator, styledIcon, styledLabel, alwaysShowLabel3, (Function0) value$iv3, $composer2, (($dirty4 >> 9) & 57344) | 438);
                ComposerKt.sourceInformationMarkerEnd($composer2);
                ComposerKt.sourceInformationMarkerEnd($composer2);
                $composer2.endNode();
                ComposerKt.sourceInformationMarkerEnd($composer2);
                ...
                colors4 = colors5;
                enabled3 = enabled2;
                interactionSource5 = mutableInteractionSource;
                alwaysShowLabel4 = alwaysShowLabel3;
                modifier4 = modifier3;
                function25 = function24;
            }
            modifier3 = modifier2;
            value$iv5 = new MappedInteractionSource(interactionSource4, deltaOffset, null);
            $composer2.updateRememberedValue(value$iv5);
            final MappedInteractionSource offsetInteractionSource2 = (MappedInteractionSource) value$iv5;
            ComposerKt.sourceInformationMarkerEnd($composer2);
            Function2 indicatorRipple2 = ComposableLambdaKt.rememberComposableLambda(691730997, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.NavigationBarKt$NavigationBarItem$2$indicatorRipple$1
                {
                    super(2);
                }
                ...
                public final void invoke(Composer $composer3, int $changed2) {
                    ...
                    if (($changed2 & 3) != 2 || !$composer3.getSkipping()) {
                        ...
                        BoxKt.Box(IndicationKt.indication(ClipKt.clip(LayoutIdKt.layoutId(Modifier.INSTANCE, "indicatorRipple"), ShapesKt.getValue(NavigationBarTokens.INSTANCE.getActiveIndicatorShape(), $composer3, 6)), offsetInteractionSource2, RippleKt.m2690rippleOrFallbackImplementation9IZ8Weo(false, 0.0f, 0L, $composer3, 0, 7)), $composer3, 0);
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                            return;
                        }
            ...
            Function2 indicator2 = ComposableLambdaKt.rememberComposableLambda(-474426875, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.NavigationBarKt$NavigationBarItem$2$indicator$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(2);
                }
                ...
                public final void invoke(Composer $composer3, int $changed2) {
                    ...
                    if (($changed2 & 3) != 2 || !$composer3.getSkipping()) {
                        ...
                        if (invalid$iv3 || it$iv42 == Composer.INSTANCE.getEmpty()) {
                            value$iv6 = (Function1) new Function1<GraphicsLayerScope, Unit>() { // from class: androidx.compose.material3.NavigationBarKt$NavigationBarItem$2$indicator$1$1$1
                                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                {
                                    super(1);
            ...
            if (invalid$iv) {
                ...
                $composer2.updateRememberedValue(value$iv3);
                ComposerKt.sourceInformationMarkerEnd($composer2);
                NavigationBarItemLayout(indicatorRipple2, indicator2, styledIcon, styledLabel, alwaysShowLabel3, (Function0) value$iv3, $composer2, (($dirty4 >> 9) & 57344) | 438);
                ComposerKt.sourceInformationMarkerEnd($composer2);
                ComposerKt.sourceInformationMarkerEnd($composer2);
                $composer2.endNode();
                ComposerKt.sourceInformationMarkerEnd($composer2);
                ...
                MutableInteractionSource mutableInteractionSource2 = interactionSource2;
                colors4 = colors5;
                enabled3 = enabled2;
                interactionSource5 = mutableInteractionSource2;
                alwaysShowLabel4 = alwaysShowLabel3;
                modifier4 = modifier3;
                function25 = function24;
            }
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.NavigationBarKt.NavigationBarItem.3
                ...
                public final void invoke(Composer composer, int i11) {
                    NavigationBarKt.NavigationBarItem($this$NavigationBarItem, selected, function0, function2, modifier4, enabled3, function25, alwaysShowLabel4, colors4, interactionSource5, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    public static final void NavigationBarItemLayout(final Function2<? super Composer, ? super Integer, Unit> function2, final Function2<? super Composer, ? super Integer, Unit> function22, final Function2<? super Composer, ? super Integer, Unit> function23, final Function2<? super Composer, ? super Integer, Unit> function24, final boolean alwaysShowLabel, final Function0<Float> function0, Composer $composer, final int $changed) {
        ...
        Object value$iv2;
        Function0<ComposeUiNode> function04;
        Composer $composer3 = $composer.startRestartGroup(-1427075886);
        ComposerKt.sourceInformation($composer3, "C(NavigationBarItemLayout)P(4,3,2,5)532@23467L1717,517@23004L2180:NavigationBar.kt#uh7d8r");
        int $dirty = $changed;
        if (($changed & 6) == 0) {
        ...
        if ((74899 & $dirty) == 74898 && $composer3.getSkipping()) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1427075886, $dirty, -1, "androidx.compose.material3.NavigationBarItemLayout (NavigationBar.kt:516)");
            }
            ComposerKt.sourceInformationMarkerStart($composer3, -96239762, "CC(remember):NavigationBar.kt#9igjgp");
                    ...
                    public final MeasureResult mo41measure3p2s80s(MeasureScope $this$Layout, List<? extends Measurable> list, long constraints) {
                        ...
                        while (index$iv$iv < size) {
                            ...
                            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(it), "icon")) {
                                ...
                                int indicatorHeight = height + measureScope.mo399roundToPx0680j_4(Dp.m7505constructorimpl(2 * arg0$iv2));
                                int size2 = list.size();
                                for (int index$iv$iv2 = 0; index$iv$iv2 < size2; index$iv$iv2++) {
                                    ...
                                    if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(it2), "indicatorRipple")) {
                                        ...
                                        if (function24 == null) {
                                            return NavigationBarKt.m2559placeIconX9ElhV4($this$Layout, iconPlaceable2, indicatorRipplePlaceable, indicatorPlaceable, constraints);
                                        }
                                        Intrinsics.checkNotNull(labelPlaceable);
                                        return NavigationBarKt.m2560placeLabelAndIconzUg2_y0($this$Layout, labelPlaceable, iconPlaceable2, indicatorRipplePlaceable, indicatorPlaceable, constraints, alwaysShowLabel, animationProgress);
                                    }
            ...
            ComposerKt.sourceInformationMarkerStart($composer2, -656695659, "C518@23021L17,519@23047L11,521@23068L50:NavigationBar.kt#uh7d8r");
            ...
            BoxScopeInstance boxScopeInstance = BoxScopeInstance.INSTANCE;
            int i3 = ((6 >> 6) & 112) | 6;
            ComposerKt.sourceInformationMarkerStart($composer2, -2034219770, "C521@23110L6:NavigationBar.kt#uh7d8r");
            ...
            ComposerKt.sourceInformationMarkerEnd($composer2);
            ComposerKt.sourceInformationMarkerEnd($composer2);
            $composer2.startReplaceGroup(1087198243);
            ComposerKt.sourceInformation($composer2, "526@23253L60,524@23161L288");
            if (function24 != null) {
                Modifier modifierLayoutId = LayoutIdKt.layoutId(Modifier.INSTANCE, LabelLayoutIdTag);
                ComposerKt.sourceInformationMarkerStart($composer2, 1087201972, "CC(remember):NavigationBar.kt#9igjgp");
                ...
                Modifier modifier$iv3 = PaddingKt.m820paddingVpY3zN4$default(modifierGraphicsLayer, Dp.m7505constructorimpl(arg0$iv / 2), 0.0f, 2, null);
                ComposerKt.sourceInformationMarkerStart($composer2, 733328855, "CC(Box)P(2,1,3)72@3384L130:Box.kt#2w3rfo");
                ...
                BoxScopeInstance boxScopeInstance2 = BoxScopeInstance.INSTANCE;
                int i5 = ((0 >> 6) & 112) | 6;
                ComposerKt.sourceInformationMarkerStart($composer2, -2033904283, "C529@23428L7:NavigationBar.kt#uh7d8r");
    ...
    public static final MeasureResult m2559placeIconX9ElhV4(MeasureScope $this$placeIcon_u2dX9ElhV4, final Placeable iconPlaceable, final Placeable indicatorRipplePlaceable, final Placeable indicatorPlaceable, long constraints) {
        final int width = Constraints.m7458getMaxWidthimpl(constraints);
        final int height = ConstraintsKt.m7474constrainHeightK40F9xA(constraints, $this$placeIcon_u2dX9ElhV4.mo399roundToPx0680j_4(NavigationBarHeight));
    ...
    public static final MeasureResult m2560placeLabelAndIconzUg2_y0(final MeasureScope $this$placeLabelAndIcon_u2dzUg2_y0, final Placeable labelPlaceable, final Placeable iconPlaceable, final Placeable indicatorRipplePlaceable, final Placeable indicatorPlaceable, long constraints, final boolean alwaysShowLabel, final float animationProgress) {
        float contentHeight = iconPlaceable.getHeight() + $this$placeLabelAndIcon_u2dzUg2_y0.mo405toPx0680j_4(IndicatorVerticalPadding) + $this$placeLabelAndIcon_u2dzUg2_y0.mo405toPx0680j_4(NavigationBarIndicatorToLabelPadding) + labelPlaceable.getHeight();
        float f = 2;
        final float contentVerticalPadding = RangesKt.coerceAtLeast((Constraints.m7459getMinHeightimpl(constraints) - contentHeight) / f, $this$placeLabelAndIcon_u2dzUg2_y0.mo405toPx0680j_4(IndicatorVerticalPadding));
        ...
        final float labelY = iconPlaceable.getHeight() + contentVerticalPadding + $this$placeLabelAndIcon_u2dzUg2_y0.mo405toPx0680j_4(IndicatorVerticalPadding) + $this$placeLabelAndIcon_u2dzUg2_y0.mo405toPx0680j_4(NavigationBarIndicatorToLabelPadding);
        final int containerWidth = Constraints.m7458getMaxWidthimpl(constraints);
        ...
        final float rippleY = contentVerticalPadding - $this$placeLabelAndIcon_u2dzUg2_y0.mo405toPx0680j_4(IndicatorVerticalPadding);
            ...
            */
            public final void invoke2(Placeable.PlacementScope $this$layout) {
                ...
                if (it != null) {
                    ...
                    float f3 = offset;
                    int indicatorX = (i - it.getWidth()) / 2;
                    float indicatorY = f2 - measureScope.mo399roundToPx0680j_4(NavigationBarKt.getIndicatorVerticalPadding());
    ...
    static {
        float arg0$iv = NavigationBarTokens.INSTANCE.m3601getActiveIndicatorWidthD9Ej5fM();
        float other$iv = NavigationBarTokens.INSTANCE.m3604getIconSizeD9Ej5fM();
        IndicatorHorizontalPadding = Dp.m7505constructorimpl(Dp.m7505constructorimpl(arg0$iv - other$iv) / 2);
        float arg0$iv2 = NavigationBarTokens.INSTANCE.m3600getActiveIndicatorHeightD9Ej5fM();
        float other$iv2 = NavigationBarTokens.INSTANCE.m3604getIconSizeD9Ej5fM();
        IndicatorVerticalPadding = Dp.m7505constructorimpl(Dp.m7505constructorimpl(arg0$iv2 - other$iv2) / 2);
        IndicatorVerticalOffset = Dp.m7505constructorimpl(12);
    }
