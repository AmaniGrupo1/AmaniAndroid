...
public final class RadioButtonColors {
    ...
    public final RadioButtonColors m2672copyjRlVdoo(long selectedColor, long unselectedColor, long disabledSelectedColor, long disabledUnselectedColor) {
    ...
    public final State<Color> radioColor$material3_release(boolean enabled, boolean selected, Composer $composer, int $changed) {
        ...
        if (enabled) {
            ...
            $composer2 = $composer;
            stateRememberUpdatedState = SingleValueAnimationKt.m134animateColorAsStateeuL9pac(target, AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, $composer2, 48, 12);
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof RadioButtonColors) && Color.m4698equalsimpl0(this.selectedColor, ((RadioButtonColors) other).selectedColor) && Color.m4698equalsimpl0(this.unselectedColor, ((RadioButtonColors) other).unselectedColor) && Color.m4698equalsimpl0(this.disabledSelectedColor, ((RadioButtonColors) other).disabledSelectedColor) && Color.m4698equalsimpl0(this.disabledUnselectedColor, ((RadioButtonColors) other).disabledUnselectedColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        int result = Color.m4704hashCodeimpl(this.selectedColor);
        return (((((result * 31) + Color.m4704hashCodeimpl(this.unselectedColor)) * 31) + Color.m4704hashCodeimpl(this.disabledSelectedColor)) * 31) + Color.m4704hashCodeimpl(this.disabledUnselectedColor);
    }
}
