...
public final class TimePicker_androidKt {
    ...
    public static final int getDefaultTimePickerLayoutType(Composer $composer, int $changed) {
        ...
        Configuration $this$_get_defaultTimePickerLayoutType__u24lambda_u240 = (Configuration) objConsume;
        if ($this$_get_defaultTimePickerLayoutType__u24lambda_u240.screenHeightDp < $this$_get_defaultTimePickerLayoutType__u24lambda_u240.screenWidthDp) {
            iM3026getVerticalQJTpgSE = TimePickerLayoutType.INSTANCE.m3025getHorizontalQJTpgSE();
        } else {
            iM3026getVerticalQJTpgSE = TimePickerLayoutType.INSTANCE.m3026getVerticalQJTpgSE();
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd($composer);
        return iM3026getVerticalQJTpgSE;
    }
}
