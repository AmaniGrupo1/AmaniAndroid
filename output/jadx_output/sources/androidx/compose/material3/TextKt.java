...
public final class TextKt {
    ...
    public static final void m2976Text4IGK_g(final String text, Modifier modifier, long color, long fontSize, FontStyle fontStyle, FontWeight fontWeight, FontFamily fontFamily, long letterSpacing, TextDecoration textDecoration, TextAlign textAlign, long lineHeight, int overflow, boolean softWrap, int maxLines, int minLines, Function1<? super TextLayoutResult, Unit> function1, TextStyle style, Composer $composer, final int $changed, final int $changed1, final int i) {
        ...
        if (($dirty5 & 306783379) == 306783378 && (599187 & $dirty13) == 599186 && $composer3.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer3.getDefaultsInvalid()) {
                ...
                long lineHeight4 = $dirty14 != 0 ? TextUnit.INSTANCE.m7710getUnspecifiedXSAIIZE() : lineHeight;
                overflow2 = i5 != 0 ? TextOverflow.INSTANCE.m7415getClipgIe3tQ8() : overflow;
                if (i15 != 0) {
                    softWrap2 = true;
                }
                maxLines2 = i16 != 0 ? Integer.MAX_VALUE : maxLines;
                minLines2 = i17 != 0 ? 1 : minLines;
                function12 = i18 != 0 ? null : function1;
                if ((i & 65536) != 0) {
            ...
            if ($this$takeOrElse_u2dDxMtmZc$iv != 16) {
                ...
                long $this$takeOrElse_u2dDxMtmZc$iv2 = style2.m6958getColor0d7_KjU();
                if ($this$takeOrElse_u2dDxMtmZc$iv2 != 16) {
                    ...
                    ComposerKt.sourceInformationMarkerEnd($composer3);
                    $this$takeOrElse_u2dDxMtmZc$iv2 = ((Color) objConsume2).m4707unboximpl();
                }
                $composer3.endReplaceGroup();
                textColor = $this$takeOrElse_u2dDxMtmZc$iv2;
            }
            $composer3.endReplaceGroup();
            BasicTextKt.m1157BasicTextVhcvRP8(str, modifier2, TextStyle.m6948mergedA7vx0o$default(style2, textColor, fontSize3, fontWeight3, fontStyle3, null, fontFamily2, null, letterSpacing2, null, null, null, 0L, textDecoration2, null, null, textAlign2 != null ? textAlign2.m7357unboximpl() : TextAlign.INSTANCE.m7364getUnspecifiede0LSkKk(), 0, lineHeight2, null, null, 0, 0, null, null, 16609104, null), function12, overflow2, softWrap2, maxLines2, minLines2, (ColorProducer) null, $composer3, ($dirty2 & 14) | ($dirty2 & 112) | (($dirty13 >> 6) & 7168) | (($dirty13 << 9) & 57344) | (($dirty13 << 9) & 458752) | (($dirty13 << 9) & 3670016) | (29360128 & ($dirty13 << 9)), 256);
            $composer2 = $composer3;
            if (ComposerKt.isTraceInProgress()) {
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TextKt$Text$1
                ...
                public final void invoke(Composer composer, int i19) {
                    TextKt.m2976Text4IGK_g(text, modifier3, color3, fontSize4, fontStyle4, fontWeight4, fontFamily3, letterSpacing3, textDecoration3, textAlign3, lineHeight3, maxLines4, softWrap3, maxLines3, minLines3, function13, style3, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), RecomposeScopeImplKt.updateChangedFlags($changed1), i);
                }
            });
        }
    }
    ...
    public static final /* synthetic */ void m2978TextfLXpl1I(final String text, Modifier modifier, long color, long fontSize, FontStyle fontStyle, FontWeight fontWeight, FontFamily fontFamily, long letterSpacing, TextDecoration textDecoration, TextAlign textAlign, long lineHeight, int overflow, boolean softWrap, int maxLines, Function1 onTextLayout, TextStyle style, Composer $composer, final int $changed, final int $changed1, final int i) {
        ...
        ComposerKt.sourceInformation($composer3, "C(Text)P(13,8,0:c#ui.graphics.Color,2:c#ui.unit.TextUnit,3:c#ui.text.font.FontStyle,4!1,5:c#ui.unit.TextUnit,15,14:c#ui.text.style.TextAlign,6:c#ui.unit.TextUnit,10:c#ui.text.style.TextOverflow,11)156@7042L7,158@7058L322:Text.kt#uh7d8r");
        int $dirty2 = $changed;
        if ((i & 1) != 0) {
            $dirty2 |= 6;
        } else if (($changed & 6) == 0) {
        ...
        if (($dirty4 & 306783379) == 306783378 && (74899 & $dirty13) == 74898 && $composer3.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer3.getDefaultsInvalid()) {
                ...
                TextKt$Text$2 onTextLayout4 = i17 != 0 ? new Function1<TextLayoutResult, Unit>() { // from class: androidx.compose.material3.TextKt$Text$2
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TextKt$Text$3
                ...
                public final void invoke(Composer composer, int i18) {
                    TextKt.m2978TextfLXpl1I(text, modifier4, color4, fontSize4, fontStyle4, fontWeight4, fontFamily3, letterSpacing4, textDecoration3, textAlign3, lineHeight2, overflow3, softWrap4, maxLines3, onTextLayout3, style3, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), RecomposeScopeImplKt.updateChangedFlags($changed1), i);
                }
            });
        }
    }
    ...
    public static final void m2977TextIbK3jfQ(final AnnotatedString text, Modifier modifier, long color, long fontSize, FontStyle fontStyle, FontWeight fontWeight, FontFamily fontFamily, long letterSpacing, TextDecoration textDecoration, TextAlign textAlign, long lineHeight, int overflow, boolean softWrap, int maxLines, int minLines, Map<String, InlineTextContent> map, Function1<? super TextLayoutResult, Unit> function1, TextStyle style, Composer $composer, final int $changed, final int $changed1, final int i) {
        ...
        if (($dirty5 & 306783379) == 306783378 && (4793491 & $dirty13) == 4793490 && $composer3.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer3.getDefaultsInvalid()) {
                ...
                int overflow5 = $dirty16 != 0 ? TextOverflow.INSTANCE.m7415getClipgIe3tQ8() : overflow;
                ...
                TextKt$Text$4 textKt$Text$4 = i19 != 0 ? new Function1<TextLayoutResult, Unit>() { // from class: androidx.compose.material3.TextKt$Text$4
                    @Override // kotlin.jvm.functions.Function1
                    public /* bridge */ /* synthetic */ Unit invoke(TextLayoutResult textLayoutResult) {
                        invoke2(textLayoutResult);
                        return Unit.INSTANCE;
            ...
            if (textColor != 16) {
                ...
                long $this$takeOrElse_u2dDxMtmZc$iv = style2.m6958getColor0d7_KjU();
                if ($this$takeOrElse_u2dDxMtmZc$iv != 16) {
                    overflow3 = overflow2;
                } else {
                    ProvidableCompositionLocal<Color> localContentColor = ContentColorKt.getLocalContentColor();
                    ...
                    Object objConsume2 = $composer3.consume(localContentColor);
                    ComposerKt.sourceInformationMarkerEnd($composer3);
                    $this$takeOrElse_u2dDxMtmZc$iv = ((Color) objConsume2).m4707unboximpl();
                }
                $composer3.endReplaceGroup();
                textColor = $this$takeOrElse_u2dDxMtmZc$iv;
            }
            ...
            BasicTextKt.m1154BasicTextRWo7tUw(annotatedString, modifier2, TextStyle.m6948mergedA7vx0o$default(style2, textColor, fontSize3, fontWeight3, fontStyle3, null, fontFamily3, null, letterSpacing2, null, null, null, 0L, textDecoration2, null, null, textAlign3 != null ? textAlign3.m7357unboximpl() : TextAlign.INSTANCE.m7364getUnspecifiede0LSkKk(), 0, lineHeight2, null, null, 0, 0, null, null, 16609104, null), function14, overflow3, softWrap5, maxLines4, minLines6, map4, (ColorProducer) null, $composer3, (($dirty113 >> 9) & 7168) | ($dirty2 & 14) | ($dirty2 & 112) | (($dirty113 << 9) & 57344) | (($dirty113 << 9) & 458752) | (($dirty113 << 9) & 3670016) | (($dirty113 << 9) & 29360128) | (($dirty113 << 9) & 234881024), 512);
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TextKt$Text$5
                ...
                public final void invoke(Composer composer, int i22) {
                    TextKt.m2977TextIbK3jfQ(text, modifier3, color3, fontSize4, fontStyle2, fontWeight4, fontFamily4, letterSpacing3, textDecoration3, textAlign4, lineHeight3, overflow4, softWrap3, maxLines2, minLines4, map3, function13, style3, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), RecomposeScopeImplKt.updateChangedFlags($changed1), i);
                }
            });
        }
    }
    ...
    public static final /* synthetic */ void m2975Text4IGK_g(final AnnotatedString text, Modifier modifier, long color, long fontSize, FontStyle fontStyle, FontWeight fontWeight, FontFamily fontFamily, long letterSpacing, TextDecoration textDecoration, TextAlign textAlign, long lineHeight, int overflow, boolean softWrap, int maxLines, Map inlineContent, Function1 onTextLayout, TextStyle style, Composer $composer, final int $changed, final int $changed1, final int i) {
        ...
        if (($dirty4 & 306783379) == 306783378 && (599187 & $dirty13) == 599186 && $composer3.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer3.getDefaultsInvalid()) {
                ...
                TextKt$Text$6 onTextLayout4 = i18 != 0 ? new Function1<TextLayoutResult, Unit>() { // from class: androidx.compose.material3.TextKt$Text$6
                    @Override // kotlin.jvm.functions.Function1
                    public /* bridge */ /* synthetic */ Unit invoke(TextLayoutResult textLayoutResult) {
                        invoke2(textLayoutResult);
                        return Unit.INSTANCE;
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TextKt$Text$7
                ...
                public final void invoke(Composer composer, int i21) {
                    TextKt.m2975Text4IGK_g(text, modifier4, color4, fontSize4, fontStyle4, fontWeight4, fontFamily3, letterSpacing4, textDecoration3, textAlign3, lineHeight2, overflow3, softWrap4, maxLines3, inlineContent3, onTextLayout3, style3, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), RecomposeScopeImplKt.updateChangedFlags($changed1), i);
                }
            });
        }
    }
