...
public final class ChipBorder {
    ...
    public final State<BorderStroke> borderStroke$material3_release(boolean enabled, Composer $composer, int $changed) {
        ...
        State<BorderStroke> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(BorderStrokeKt.m290BorderStrokecXLIe8U(this.borderWidth, enabled ? this.borderColor : this.disabledBorderColor), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof ChipBorder) && Color.m4698equalsimpl0(this.borderColor, ((ChipBorder) other).borderColor) && Color.m4698equalsimpl0(this.disabledBorderColor, ((ChipBorder) other).disabledBorderColor) && Dp.m7510equalsimpl0(this.borderWidth, ((ChipBorder) other).borderWidth)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        int result = Color.m4704hashCodeimpl(this.borderColor);
        return (((result * 31) + Color.m4704hashCodeimpl(this.disabledBorderColor)) * 31) + Dp.m7511hashCodeimpl(this.borderWidth);
    }
}
