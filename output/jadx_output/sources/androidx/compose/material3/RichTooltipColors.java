...
public final class RichTooltipColors {
    ...
    public final RichTooltipColors m2680copyjRlVdoo(long containerColor, long contentColor, long titleContentColor, long actionContentColor) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof RichTooltipColors) && Color.m4698equalsimpl0(this.containerColor, ((RichTooltipColors) other).containerColor) && Color.m4698equalsimpl0(this.contentColor, ((RichTooltipColors) other).contentColor) && Color.m4698equalsimpl0(this.titleContentColor, ((RichTooltipColors) other).titleContentColor) && Color.m4698equalsimpl0(this.actionContentColor, ((RichTooltipColors) other).actionContentColor);
    }

    public int hashCode() {
        int result = Color.m4704hashCodeimpl(this.containerColor);
        return (((((result * 31) + Color.m4704hashCodeimpl(this.contentColor)) * 31) + Color.m4704hashCodeimpl(this.titleContentColor)) * 31) + Color.m4704hashCodeimpl(this.actionContentColor);
    }
}
