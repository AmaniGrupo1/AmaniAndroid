...
public final class MenuAnchorType {
    ...
    private static final String PrimaryNotEditable = m2501constructorimpl("PrimaryNotEditable");
    private static final String PrimaryEditable = m2501constructorimpl("PrimaryEditable");
    private static final String SecondaryEditable = m2501constructorimpl("SecondaryEditable");

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ MenuAnchorType m2500boximpl(String str) {
        return new MenuAnchorType(str);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    private static String m2501constructorimpl(String str) {
        return str;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m2502equalsimpl(String str, Object obj) {
        return (obj instanceof MenuAnchorType) && Intrinsics.areEqual(str, ((MenuAnchorType) obj).getName());
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m2503equalsimpl0(String str, String str2) {
        return Intrinsics.areEqual(str, str2);
    }

    /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
    public static int m2504hashCodeimpl(String str) {
        return str.hashCode();
    }

    public boolean equals(Object obj) {
        return m2502equalsimpl(this.name, obj);
    }

    public int hashCode() {
        return m2504hashCodeimpl(this.name);
    }
