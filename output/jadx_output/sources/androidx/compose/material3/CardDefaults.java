...
public final class CardDefaults {
    ...
    public final CardElevation m2113cardElevationaqJV_2Y(float defaultElevation, float pressedElevation, float focusedElevation, float hoveredElevation, float draggedElevation, float disabledElevation, Composer $composer, int $changed, int i) {
        ...
        if ((i & 1) != 0) {
            float defaultElevation3 = FilledCardTokens.INSTANCE.m3529getContainerElevationD9Ej5fM();
            defaultElevation2 = defaultElevation3;
        } else {
            defaultElevation2 = defaultElevation;
        }
        if ((i & 2) != 0) {
            float pressedElevation3 = FilledCardTokens.INSTANCE.m3535getPressedContainerElevationD9Ej5fM();
            pressedElevation2 = pressedElevation3;
        } else {
            pressedElevation2 = pressedElevation;
        }
        if ((i & 4) != 0) {
            float focusedElevation3 = FilledCardTokens.INSTANCE.m3532getFocusContainerElevationD9Ej5fM();
            focusedElevation2 = focusedElevation3;
        } else {
            focusedElevation2 = focusedElevation;
        }
        float hoveredElevation2 = (i & 8) != 0 ? FilledCardTokens.INSTANCE.m3533getHoverContainerElevationD9Ej5fM() : hoveredElevation;
        float draggedElevation2 = (i & 16) != 0 ? FilledCardTokens.INSTANCE.m3531getDraggedContainerElevationD9Ej5fM() : draggedElevation;
        float disabledElevation2 = (i & 32) != 0 ? FilledCardTokens.INSTANCE.m3530getDisabledContainerElevationD9Ej5fM() : disabledElevation;
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final CardElevation m2115elevatedCardElevationaqJV_2Y(float defaultElevation, float pressedElevation, float focusedElevation, float hoveredElevation, float draggedElevation, float disabledElevation, Composer $composer, int $changed, int i) {
        float defaultElevation2;
        float pressedElevation2;
        float focusedElevation2;
        ...
        if ((i & 1) != 0) {
            float defaultElevation3 = ElevatedCardTokens.INSTANCE.m3448getContainerElevationD9Ej5fM();
            defaultElevation2 = defaultElevation3;
        } else {
            defaultElevation2 = defaultElevation;
        }
        if ((i & 2) != 0) {
            float pressedElevation3 = ElevatedCardTokens.INSTANCE.m3454getPressedContainerElevationD9Ej5fM();
            pressedElevation2 = pressedElevation3;
        } else {
            pressedElevation2 = pressedElevation;
        }
        if ((i & 4) != 0) {
            float focusedElevation3 = ElevatedCardTokens.INSTANCE.m3451getFocusContainerElevationD9Ej5fM();
            focusedElevation2 = focusedElevation3;
        } else {
            focusedElevation2 = focusedElevation;
        }
        float hoveredElevation2 = (i & 8) != 0 ? ElevatedCardTokens.INSTANCE.m3452getHoverContainerElevationD9Ej5fM() : hoveredElevation;
        float draggedElevation2 = (i & 16) != 0 ? ElevatedCardTokens.INSTANCE.m3450getDraggedContainerElevationD9Ej5fM() : draggedElevation;
        float disabledElevation2 = (i & 32) != 0 ? ElevatedCardTokens.INSTANCE.m3449getDisabledContainerElevationD9Ej5fM() : disabledElevation;
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final CardElevation m2117outlinedCardElevationaqJV_2Y(float defaultElevation, float pressedElevation, float focusedElevation, float hoveredElevation, float draggedElevation, float disabledElevation, Composer $composer, int $changed, int i) {
        float defaultElevation2;
        float pressedElevation2;
        float focusedElevation2;
        ...
        if ((i & 1) != 0) {
            float defaultElevation3 = OutlinedCardTokens.INSTANCE.m3628getContainerElevationD9Ej5fM();
            defaultElevation2 = defaultElevation3;
        } else {
            defaultElevation2 = defaultElevation;
        }
        ...
        float draggedElevation2 = (i & 16) != 0 ? OutlinedCardTokens.INSTANCE.m3630getDraggedContainerElevationD9Ej5fM() : draggedElevation;
        float disabledElevation2 = (i & 32) != 0 ? OutlinedCardTokens.INSTANCE.m3629getDisabledContainerElevationD9Ej5fM() : disabledElevation;
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final CardColors m2112cardColorsro_MJ88(long containerColor, long contentColor, long disabledContainerColor, long disabledContentColor, Composer $composer, int $changed, int i) {
        ...
        long disabledContentColor2 = (i & 8) != 0 ? Color.m4695copywmQWz5c(contentColor2, (14 & 1) != 0 ? Color.m4699getAlphaimpl(contentColor2) : 0.38f, (14 & 2) != 0 ? Color.m4703getRedimpl(contentColor2) : 0.0f, (14 & 4) != 0 ? Color.m4702getGreenimpl(contentColor2) : 0.0f, (14 & 8) != 0 ? Color.m4700getBlueimpl(contentColor2) : 0.0f) : disabledContentColor;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1589582123, $changed, -1, "androidx.compose.material3.CardDefaults.cardColors (Card.kt:494)");
        }
        CardColors cardColorsM2107copyjRlVdoo = getDefaultCardColors$material3_release(MaterialTheme.INSTANCE.getColorScheme($composer, 6)).m2107copyjRlVdoo(containerColor2, contentColor2, disabledContainerColor2, disabledContentColor2);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd($composer);
        return cardColorsM2107copyjRlVdoo;
    }
    ...
    public final CardColors getDefaultCardColors$material3_release(ColorScheme $this$defaultCardColors) {
        ...
        if (it == null) {
            ...
            long jM2212contentColorFor4WTKRHQ = ColorSchemeKt.m2212contentColorFor4WTKRHQ($this$defaultCardColors, ColorSchemeKt.fromToken($this$defaultCardColors, FilledCardTokens.INSTANCE.getContainerColor()));
            long jFromToken2 = ColorSchemeKt.fromToken($this$defaultCardColors, FilledCardTokens.INSTANCE.getDisabledContainerColor());
            long jM4742compositeOverOWjLjI = ColorKt.m4742compositeOverOWjLjI(Color.m4695copywmQWz5c(jFromToken2, (14 & 1) != 0 ? Color.m4699getAlphaimpl(jFromToken2) : FilledCardTokens.INSTANCE.getDisabledContainerOpacity(), (14 & 2) != 0 ? Color.m4703getRedimpl(jFromToken2) : 0.0f, (14 & 4) != 0 ? Color.m4702getGreenimpl(jFromToken2) : 0.0f, (14 & 8) != 0 ? Color.m4700getBlueimpl(jFromToken2) : 0.0f), ColorSchemeKt.fromToken($this$defaultCardColors, FilledCardTokens.INSTANCE.getContainerColor()));
            long jM2212contentColorFor4WTKRHQ2 = ColorSchemeKt.m2212contentColorFor4WTKRHQ($this$defaultCardColors, ColorSchemeKt.fromToken($this$defaultCardColors, FilledCardTokens.INSTANCE.getContainerColor()));
            CardColors it2 = new CardColors(jFromToken, jM2212contentColorFor4WTKRHQ, jM4742compositeOverOWjLjI, Color.m4695copywmQWz5c(jM2212contentColorFor4WTKRHQ2, (14 & 1) != 0 ? Color.m4699getAlphaimpl(jM2212contentColorFor4WTKRHQ2) : 0.38f, (14 & 2) != 0 ? Color.m4703getRedimpl(jM2212contentColorFor4WTKRHQ2) : 0.0f, (14 & 4) != 0 ? Color.m4702getGreenimpl(jM2212contentColorFor4WTKRHQ2) : 0.0f, (14 & 8) != 0 ? Color.m4700getBlueimpl(jM2212contentColorFor4WTKRHQ2) : 0.0f), null);
    ...
    public final CardColors m2114elevatedCardColorsro_MJ88(long containerColor, long contentColor, long disabledContainerColor, long disabledContentColor, Composer $composer, int $changed, int i) {
        ...
        CardColors cardColorsM2107copyjRlVdoo = getDefaultElevatedCardColors$material3_release(MaterialTheme.INSTANCE.getColorScheme($composer, 6)).m2107copyjRlVdoo(containerColor2, contentColor2, disabledContainerColor2, disabledContentColor2);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd($composer);
    ...
    public final CardColors getDefaultElevatedCardColors$material3_release(ColorScheme $this$defaultElevatedCardColors) {
        ...
        if (it == null) {
            ...
            long jM2212contentColorFor4WTKRHQ = ColorSchemeKt.m2212contentColorFor4WTKRHQ($this$defaultElevatedCardColors, ColorSchemeKt.fromToken($this$defaultElevatedCardColors, ElevatedCardTokens.INSTANCE.getContainerColor()));
            ...
            long jM4742compositeOverOWjLjI = ColorKt.m4742compositeOverOWjLjI(Color.m4695copywmQWz5c(jFromToken2, (14 & 1) != 0 ? Color.m4699getAlphaimpl(jFromToken2) : ElevatedCardTokens.INSTANCE.getDisabledContainerOpacity(), (14 & 2) != 0 ? Color.m4703getRedimpl(jFromToken2) : 0.0f, (14 & 4) != 0 ? Color.m4702getGreenimpl(jFromToken2) : 0.0f, (14 & 8) != 0 ? Color.m4700getBlueimpl(jFromToken2) : 0.0f), ColorSchemeKt.fromToken($this$defaultElevatedCardColors, ElevatedCardTokens.INSTANCE.getDisabledContainerColor()));
            long jM2212contentColorFor4WTKRHQ2 = ColorSchemeKt.m2212contentColorFor4WTKRHQ($this$defaultElevatedCardColors, ColorSchemeKt.fromToken($this$defaultElevatedCardColors, ElevatedCardTokens.INSTANCE.getContainerColor()));
            CardColors it2 = new CardColors(jFromToken, jM2212contentColorFor4WTKRHQ, jM4742compositeOverOWjLjI, Color.m4695copywmQWz5c(jM2212contentColorFor4WTKRHQ2, (14 & 1) != 0 ? Color.m4699getAlphaimpl(jM2212contentColorFor4WTKRHQ2) : 0.38f, (14 & 2) != 0 ? Color.m4703getRedimpl(jM2212contentColorFor4WTKRHQ2) : 0.0f, (14 & 4) != 0 ? Color.m4702getGreenimpl(jM2212contentColorFor4WTKRHQ2) : 0.0f, (14 & 8) != 0 ? Color.m4700getBlueimpl(jM2212contentColorFor4WTKRHQ2) : 0.0f), null);
    ...
    public final CardColors m2116outlinedCardColorsro_MJ88(long containerColor, long contentColor, long disabledContainerColor, long disabledContentColor, Composer $composer, int $changed, int i) {
        ...
        long disabledContainerColor2 = (i & 4) != 0 ? Color.INSTANCE.m4733getUnspecified0d7_KjU() : disabledContainerColor;
        if ((i & 8) != 0) {
            long jM2213contentColorForek8zF_U = ColorSchemeKt.m2213contentColorForek8zF_U(containerColor2, $composer, $changed & 14);
            disabledContentColor2 = Color.m4695copywmQWz5c(jM2213contentColorForek8zF_U, (14 & 1) != 0 ? Color.m4699getAlphaimpl(jM2213contentColorForek8zF_U) : 0.38f, (14 & 2) != 0 ? Color.m4703getRedimpl(jM2213contentColorForek8zF_U) : 0.0f, (14 & 4) != 0 ? Color.m4702getGreenimpl(jM2213contentColorForek8zF_U) : 0.0f, (14 & 8) != 0 ? Color.m4700getBlueimpl(jM2213contentColorForek8zF_U) : 0.0f);
        } else {
        ...
        CardColors cardColorsM2107copyjRlVdoo = getDefaultOutlinedCardColors$material3_release(MaterialTheme.INSTANCE.getColorScheme($composer, 6)).m2107copyjRlVdoo(containerColor2, contentColor2, disabledContainerColor2, disabledContentColor2);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd($composer);
    ...
    public final CardColors getDefaultOutlinedCardColors$material3_release(ColorScheme $this$defaultOutlinedCardColors) {
        ...
        if (it == null) {
            ...
            long jM2212contentColorFor4WTKRHQ = ColorSchemeKt.m2212contentColorFor4WTKRHQ($this$defaultOutlinedCardColors, ColorSchemeKt.fromToken($this$defaultOutlinedCardColors, OutlinedCardTokens.INSTANCE.getContainerColor()));
            long jFromToken2 = ColorSchemeKt.fromToken($this$defaultOutlinedCardColors, OutlinedCardTokens.INSTANCE.getContainerColor());
            long jM2212contentColorFor4WTKRHQ2 = ColorSchemeKt.m2212contentColorFor4WTKRHQ($this$defaultOutlinedCardColors, ColorSchemeKt.fromToken($this$defaultOutlinedCardColors, OutlinedCardTokens.INSTANCE.getContainerColor()));
            CardColors it2 = new CardColors(jFromToken, jM2212contentColorFor4WTKRHQ, jFromToken2, Color.m4695copywmQWz5c(jM2212contentColorFor4WTKRHQ2, (14 & 1) != 0 ? Color.m4699getAlphaimpl(jM2212contentColorFor4WTKRHQ2) : 0.38f, (14 & 2) != 0 ? Color.m4703getRedimpl(jM2212contentColorFor4WTKRHQ2) : 0.0f, (14 & 4) != 0 ? Color.m4702getGreenimpl(jM2212contentColorFor4WTKRHQ2) : 0.0f, (14 & 8) != 0 ? Color.m4700getBlueimpl(jM2212contentColorFor4WTKRHQ2) : 0.0f), null);
    ...
    public final BorderStroke outlinedCardBorder(boolean enabled, Composer $composer, int $changed, int i) {
        ...
        if (enabled) {
            ...
            color = ColorKt.m4742compositeOverOWjLjI(Color.m4695copywmQWz5c(value, (14 & 1) != 0 ? Color.m4699getAlphaimpl(value) : 0.12f, (14 & 2) != 0 ? Color.m4703getRedimpl(value) : 0.0f, (14 & 4) != 0 ? Color.m4702getGreenimpl(value) : 0.0f, (14 & 8) != 0 ? Color.m4700getBlueimpl(value) : 0.0f), ColorSchemeKt.getValue(ElevatedCardTokens.INSTANCE.getContainerColor(), $composer, 6));
            $composer.endReplaceGroup();
        }
        ...
        if (invalid$iv || it$iv == Composer.INSTANCE.getEmpty()) {
            value$iv = BorderStrokeKt.m290BorderStrokecXLIe8U(OutlinedCardTokens.INSTANCE.m3634getOutlineWidthD9Ej5fM(), color);
