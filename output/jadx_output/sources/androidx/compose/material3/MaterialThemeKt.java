...
public final class MaterialThemeKt {
    ...
    public static final void MaterialTheme(ColorScheme colorScheme, Shapes shapes, Typography typography, final Function2<? super Composer, ? super Integer, Unit> function2, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty2 & 1171) == 1170 && $composer2.getSkipping()) {
            ...
            int $dirty3 = $dirty;
            Indication rippleIndication = RippleKt.m2690rippleOrFallbackImplementation9IZ8Weo(false, 0.0f, 0L, $composer2, 0, 7);
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.MaterialThemeKt.MaterialTheme.2
                ...
                public final void invoke(Composer composer, int i5) {
                    MaterialThemeKt.MaterialTheme(colorScheme3, shapes4, typography4, function2, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    public static final void MaterialExpressiveTheme(final ColorScheme colorScheme, final Shapes shapes, Typography typography, final Function2<? super Composer, ? super Integer, Unit> function2, Composer $composer, final int $changed, final int i) {
                ...
                CompositionLocalKt.CompositionLocalProvider(LocalUsingExpressiveTheme.provides(true), ComposableLambdaKt.rememberComposableLambda(2050809758, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.MaterialThemeKt.MaterialExpressiveTheme.1
                    ...
                    public final void invoke(Composer $composer4, int $changed2) {
                        ...
                        if (($changed2 & 3) != 2 || !$composer4.getSkipping()) {
                            ...
                            ColorScheme colorScheme4 = colorSchemeExpressiveLightColorScheme;
                            ...
                            MaterialThemeKt.MaterialTheme(colorScheme4, shapes5, typography5 == null ? new Typography(null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, 32767, null) : typography5, function2, $composer4, 0, 0);
                            if (ComposerKt.isTraceInProgress()) {
                                ComposerKt.traceEventEnd();
                                return;
                            }
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.MaterialThemeKt.MaterialExpressiveTheme.2
                ...
                public final void invoke(Composer composer, int i5) {
                    MaterialThemeKt.MaterialExpressiveTheme(colorScheme2, shapes2, typography3, function2, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    public static final SelectionColors rememberTextSelectionColors(ColorScheme colorScheme, Composer $composer, int $changed) {
        ...
        if (invalid$iv || it$iv == Composer.INSTANCE.getEmpty()) {
            value$iv = new SelectionColors(primaryColor, Color.m4695copywmQWz5c(primaryColor, (14 & 1) != 0 ? Color.m4699getAlphaimpl(primaryColor) : 0.4f, (14 & 2) != 0 ? Color.m4703getRedimpl(primaryColor) : 0.0f, (14 & 4) != 0 ? Color.m4702getGreenimpl(primaryColor) : 0.0f, (14 & 8) != 0 ? Color.m4700getBlueimpl(primaryColor) : 0.0f), null);
