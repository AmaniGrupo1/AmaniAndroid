...
public final class NavigationRailItemColors {
    ...
    public final long m2610getSelectedIndicatorColor0d7_KjU() {
    ...
    public final NavigationRailItemColors m2605copy4JmcsL4(long selectedIconColor, long selectedTextColor, long selectedIndicatorColor, long unselectedIconColor, long unselectedTextColor, long disabledIconColor, long disabledTextColor) {
    ...
    public final long m2614iconColorWaAFU9c$material3_release(boolean selected, boolean enabled) {
    ...
    public final long m2615textColorWaAFU9c$material3_release(boolean selected, boolean enabled) {
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof NavigationRailItemColors) && Color.m4698equalsimpl0(this.selectedIconColor, ((NavigationRailItemColors) other).selectedIconColor) && Color.m4698equalsimpl0(this.unselectedIconColor, ((NavigationRailItemColors) other).unselectedIconColor) && Color.m4698equalsimpl0(this.selectedTextColor, ((NavigationRailItemColors) other).selectedTextColor) && Color.m4698equalsimpl0(this.unselectedTextColor, ((NavigationRailItemColors) other).unselectedTextColor) && Color.m4698equalsimpl0(this.selectedIndicatorColor, ((NavigationRailItemColors) other).selectedIndicatorColor) && Color.m4698equalsimpl0(this.disabledIconColor, ((NavigationRailItemColors) other).disabledIconColor) && Color.m4698equalsimpl0(this.disabledTextColor, ((NavigationRailItemColors) other).disabledTextColor)) {
            return true;
        }
        return false;
    }
