...
public final class SelectableChipColors {
    ...
    public static /* synthetic */ SelectableChipColors m2741copydaRQuJA$default(SelectableChipColors selectableChipColors, long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, long j9, long j10, long j11, long j12, long j13, int i, Object obj) {
        long j14;
        long j15;
        ...
        return selectableChipColors.m2743copydaRQuJA(j23, j17, j18, j19, j20, j21, j22, j24, j25, j26, j27, j14, j15);
    }

    /* JADX INFO: renamed from: copy-daRQuJA, reason: not valid java name */
    public final SelectableChipColors m2743copydaRQuJA(long containerColor, long labelColor, long leadingIconColor, long trailingIconColor, long disabledContainerColor, long disabledLabelColor, long disabledLeadingIconColor, long disabledTrailingIconColor, long selectedContainerColor, long disabledSelectedContainerColor, long selectedLabelColor, long selectedLeadingIconColor, long selectedTrailingIconColor) {
    ...
    public final long m2742containerColorWaAFU9c$material3_release(boolean enabled, boolean selected) {
    ...
    public final long m2744labelColorWaAFU9c$material3_release(boolean enabled, boolean selected) {
    ...
    public final long m2745leadingIconContentColorWaAFU9c$material3_release(boolean enabled, boolean selected) {
    ...
    public final long m2746trailingIconContentColorWaAFU9c$material3_release(boolean enabled, boolean selected) {
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof SelectableChipColors) && Color.m4698equalsimpl0(this.containerColor, ((SelectableChipColors) other).containerColor) && Color.m4698equalsimpl0(this.labelColor, ((SelectableChipColors) other).labelColor) && Color.m4698equalsimpl0(this.leadingIconColor, ((SelectableChipColors) other).leadingIconColor) && Color.m4698equalsimpl0(this.trailingIconColor, ((SelectableChipColors) other).trailingIconColor) && Color.m4698equalsimpl0(this.disabledContainerColor, ((SelectableChipColors) other).disabledContainerColor) && Color.m4698equalsimpl0(this.disabledLabelColor, ((SelectableChipColors) other).disabledLabelColor) && Color.m4698equalsimpl0(this.disabledLeadingIconColor, ((SelectableChipColors) other).disabledLeadingIconColor) && Color.m4698equalsimpl0(this.disabledTrailingIconColor, ((SelectableChipColors) other).disabledTrailingIconColor) && Color.m4698equalsimpl0(this.selectedContainerColor, ((SelectableChipColors) other).selectedContainerColor) && Color.m4698equalsimpl0(this.disabledSelectedContainerColor, ((SelectableChipColors) other).disabledSelectedContainerColor) && Color.m4698equalsimpl0(this.selectedLabelColor, ((SelectableChipColors) other).selectedLabelColor) && Color.m4698equalsimpl0(this.selectedLeadingIconColor, ((SelectableChipColors) other).selectedLeadingIconColor) && Color.m4698equalsimpl0(this.selectedTrailingIconColor, ((SelectableChipColors) other).selectedTrailingIconColor)) {
            return true;
        }
        return false;
    }
