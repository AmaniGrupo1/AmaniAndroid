            ...
            case 0:
                ...
                if (interactions2.collect(new FlowCollector() { // from class: androidx.compose.material3.FloatingActionButtonElevation$animateElevation$2$1.1
                    ...
                    public final Object emit(Interaction interaction, Continuation<? super Unit> continuation) {
                        ...
                        BuildersKt__Builders_commonKt.launch$default($this$LaunchedEffect, null, null, new C00821(floatingActionButtonElevationAnimatable, targetInteraction, null), 3, null);
                    ...
                    static final class C00821 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                        ...
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        C00821(FloatingActionButtonElevationAnimatable floatingActionButtonElevationAnimatable, Interaction interaction, Continuation<? super C00821> continuation) {
                            super(2, continuation);
                            this.$animatable = floatingActionButtonElevationAnimatable;
                        ...
                        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
                        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                            return new C00821(this.$animatable, this.$targetInteraction, continuation);
                        }
