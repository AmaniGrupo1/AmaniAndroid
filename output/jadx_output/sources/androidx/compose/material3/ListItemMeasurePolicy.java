...
final class ListItemMeasurePolicy implements MultiContentMeasurePolicy {
    ...
    public MeasureResult mo762measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, List<? extends List<? extends Measurable>> list, long constraints) {
        ...
        int horizontalPadding = $this$measure_u2d3p2s80s.mo399roundToPx0680j_4(Dp.m7505constructorimpl(startPadding + endPadding));
        Measurable measurable = (Measurable) CollectionsKt.firstOrNull((List) list5);
        int intrinsicLeadingWidth = measurable != null ? measurable.minIntrinsicWidth(Constraints.m7457getMaxHeightimpl(constraints)) : 0;
        Measurable measurable2 = (Measurable) CollectionsKt.firstOrNull((List) list6);
        int intrinsicTrailingWidth = measurable2 != null ? measurable2.minIntrinsicWidth(Constraints.m7457getMaxHeightimpl(constraints)) : 0;
        int intrinsicSupportingWidthConstraint = ListItemKt.subtractConstraintSafely(Constraints.m7458getMaxWidthimpl(looseConstraints), intrinsicLeadingWidth + intrinsicTrailingWidth + horizontalPadding);
        ...
        int intrinsicListItemType = companion.m2499invokeZLSjz4$material3_release(z2, z, intrinsicIsSupportingMultiline);
        float arg0$iv = ListItemKt.m2486verticalPaddingyh95HIg(intrinsicListItemType);
        float arg0$iv2 = 2;
        int intrinsicVerticalPadding = $this$measure_u2d3p2s80s.mo399roundToPx0680j_4(Dp.m7505constructorimpl(arg0$iv2 * arg0$iv));
        long paddedLooseConstraints2 = ConstraintsKt.m7477offsetNN6EwU(looseConstraints, -horizontalPadding, -intrinsicVerticalPadding);
        Measurable measurable4 = (Measurable) CollectionsKt.firstOrNull((List) list5);
        Placeable placeableMo6141measureBRTryo0 = null;
        Placeable leadingPlaceable = measurable4 != null ? measurable4.mo6141measureBRTryo0(paddedLooseConstraints2) : null;
        ...
        Placeable trailingPlaceable3 = measurable5 != null ? measurable5.mo6141measureBRTryo0(ConstraintsKt.m7478offsetNN6EwU$default(paddedLooseConstraints2, -currentTotalWidth2, 0, 2, null)) : null;
        ...
        if (measurable6 != null) {
            ...
            headlinePlaceable = measurable6.mo6141measureBRTryo0(ConstraintsKt.m7478offsetNN6EwU$default(paddedLooseConstraints2, -currentTotalWidth3, 0, 2, null));
        } else {
            trailingPlaceable = trailingPlaceable3;
            currentTotalHeight = 0;
            paddedLooseConstraints = paddedLooseConstraints2;
        ...
        if (measurable7 != null) {
            ...
            supportingPlaceable = measurable7.mo6141measureBRTryo0(ConstraintsKt.m7477offsetNN6EwU(paddedLooseConstraints, -currentTotalWidth3, -currentTotalHeight3));
        } else {
            headlinePlaceable2 = headlinePlaceable;
            currentTotalHeight2 = currentTotalHeight3;
            trailingPlaceable2 = trailingPlaceable;
        ...
        if (measurable8 != null) {
            ...
            placeableMo6141measureBRTryo0 = measurable8.mo6141measureBRTryo0(ConstraintsKt.m7477offsetNN6EwU(paddedLooseConstraints, i, currentTotalWidth4));
        } else {
            supportingPlaceable2 = supportingPlaceable;
        }
        Placeable overlinePlaceable = placeableMo6141measureBRTryo0;
        int listItemType = ListItemType.INSTANCE.m2499invokeZLSjz4$material3_release(overlinePlaceable != null, supportingPlaceable2 != null, isSupportingMultiline);
        float topPadding = ListItemKt.m2486verticalPaddingyh95HIg(listItemType);
        float verticalPadding = Dp.m7505constructorimpl(2 * topPadding);
        int width = ListItemKt.m2485calculateWidthyeHjK3Y($this$measure_u2d3p2s80s, TextFieldImplKt.widthOrZero(leadingPlaceable2), TextFieldImplKt.widthOrZero(trailingPlaceable2), TextFieldImplKt.widthOrZero(headlinePlaceable2), TextFieldImplKt.widthOrZero(overlinePlaceable), TextFieldImplKt.widthOrZero(supportingPlaceable2), horizontalPadding, constraints);
        int height = ListItemKt.m2484calculateHeightN4Jib3Y($this$measure_u2d3p2s80s, TextFieldImplKt.heightOrZero(leadingPlaceable2), TextFieldImplKt.heightOrZero(trailingPlaceable2), TextFieldImplKt.heightOrZero(headlinePlaceable2), TextFieldImplKt.heightOrZero(overlinePlaceable), TextFieldImplKt.heightOrZero(supportingPlaceable2), listItemType, $this$measure_u2d3p2s80s.mo399roundToPx0680j_4(verticalPadding), constraints);
        boolean zM2491equalsimpl0 = ListItemType.m2491equalsimpl0(listItemType, ListItemType.INSTANCE.m2497getThreeLineAlXitO8());
        int intrinsicSupportingWidthConstraint2 = $this$measure_u2d3p2s80s.mo399roundToPx0680j_4(startPadding);
        int intrinsicSupportingHeight2 = $this$measure_u2d3p2s80s.mo399roundToPx0680j_4(endPadding);
        return ListItemKt.place($this$measure_u2d3p2s80s, width, height, leadingPlaceable2, trailingPlaceable2, headlinePlaceable2, overlinePlaceable, supportingPlaceable2, zM2491equalsimpl0, intrinsicSupportingWidthConstraint2, intrinsicSupportingHeight2, $this$measure_u2d3p2s80s.mo399roundToPx0680j_4(topPadding));
    }
    ...
    /* JADX INFO: compiled from: ListItem.kt */
    @Metadata(k = 3, mv = {1, 8, 0}, xi = 48)
    /* synthetic */ class C04651 extends FunctionReferenceImpl implements Function2<IntrinsicMeasurable, Integer, Integer> {
    ...
    public int maxIntrinsicWidth(IntrinsicMeasureScope $this$maxIntrinsicWidth, List<? extends List<? extends IntrinsicMeasurable>> list, int height) {
        return calculateIntrinsicWidth($this$maxIntrinsicWidth, list, height, C04651.INSTANCE);
    }
    ...
    /* JADX INFO: compiled from: ListItem.kt */
    @Metadata(k = 3, mv = {1, 8, 0}, xi = 48)
    /* synthetic */ class C04661 extends FunctionReferenceImpl implements Function2<IntrinsicMeasurable, Integer, Integer> {
    ...
    public int minIntrinsicHeight(IntrinsicMeasureScope $this$minIntrinsicHeight, List<? extends List<? extends IntrinsicMeasurable>> list, int width) {
        return calculateIntrinsicHeight($this$minIntrinsicHeight, list, width, C04661.INSTANCE);
    }
    ...
    /* JADX INFO: compiled from: ListItem.kt */
    @Metadata(k = 3, mv = {1, 8, 0}, xi = 48)
    /* synthetic */ class C04671 extends FunctionReferenceImpl implements Function2<IntrinsicMeasurable, Integer, Integer> {
    ...
    public int minIntrinsicWidth(IntrinsicMeasureScope $this$minIntrinsicWidth, List<? extends List<? extends IntrinsicMeasurable>> list, int height) {
        return calculateIntrinsicWidth($this$minIntrinsicWidth, list, height, C04671.INSTANCE);
    }
    ...
    private final int calculateIntrinsicWidth(IntrinsicMeasureScope $this$calculateIntrinsicWidth, List<? extends List<? extends IntrinsicMeasurable>> list, int height, Function2<? super IntrinsicMeasurable, ? super Integer, Integer> function2) {
        ...
        return ListItemKt.m2485calculateWidthyeHjK3Y($this$calculateIntrinsicWidth, iIntValue, iIntValue2, iIntValue3, iIntValue4, iIntValue5, $this$calculateIntrinsicWidth.mo399roundToPx0680j_4(Dp.m7505constructorimpl(arg0$iv + other$iv)), ConstraintsKt.Constraints$default(0, 0, 0, 0, 15, null));
    }
    ...
    private final int calculateIntrinsicHeight(IntrinsicMeasureScope $this$calculateIntrinsicHeight, List<? extends List<? extends IntrinsicMeasurable>> list, int width, Function2<? super IntrinsicMeasurable, ? super Integer, Integer> function2) {
        ...
        float arg0$iv = ListItemKt.getListItemStartPadding();
        float other$iv = ListItemKt.getListItemEndPadding();
        int remainingWidth2 = ListItemKt.subtractConstraintSafely(width, $this$calculateIntrinsicHeight.mo399roundToPx0680j_4(Dp.m7505constructorimpl(arg0$iv + other$iv)));
        ...
        IntrinsicMeasurable intrinsicMeasurable2 = (IntrinsicMeasurable) CollectionsKt.firstOrNull((List) list4);
        ...
        int listItemType = ListItemType.INSTANCE.m2499invokeZLSjz4$material3_release(overlineHeight > 0, supportingHeight > 0, isSupportingMultiline);
        IntrinsicMeasurable intrinsicMeasurable3 = (IntrinsicMeasurable) CollectionsKt.firstOrNull((List) list2);
        int supportingHeight2 = intrinsicMeasurable3 != null ? function2.invoke(intrinsicMeasurable3, Integer.valueOf(width)).intValue() : 0;
        float arg0$iv2 = ListItemKt.m2486verticalPaddingyh95HIg(listItemType);
        int other$iv2 = $this$calculateIntrinsicHeight.mo399roundToPx0680j_4(Dp.m7505constructorimpl(2 * arg0$iv2));
        return ListItemKt.m2484calculateHeightN4Jib3Y($this$calculateIntrinsicHeight, leadingHeight, trailingHeight, supportingHeight2, overlineHeight, supportingHeight, listItemType, other$iv2, ConstraintsKt.Constraints$default(0, 0, 0, 0, 15, null));
    }
}
