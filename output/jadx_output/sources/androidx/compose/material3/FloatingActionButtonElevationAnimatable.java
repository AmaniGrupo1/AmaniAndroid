...
final class FloatingActionButtonElevationAnimatable {
    ...
    private FloatingActionButtonElevationAnimatable(float defaultElevation, float pressedElevation, float hoveredElevation, float focusedElevation) {
        ...
        this.animatable = new Animatable<>(Dp.m7503boximpl(this.defaultElevation), VectorConvertersKt.getVectorConverter(Dp.INSTANCE), null, null, 12, null);
    }

    /* JADX INFO: renamed from: calculateTarget-u2uoSUM, reason: not valid java name */
    private final float m2404calculateTargetu2uoSUM(Interaction $this$calculateTarget_u2du2uoSUM) {
    ...
    public final Object m2405updateElevationlDy3nrA(float defaultElevation, float pressedElevation, float hoveredElevation, float focusedElevation, Continuation<? super Unit> continuation) throws Throwable {
        this.defaultElevation = defaultElevation;
        this.pressedElevation = pressedElevation;
        this.hoveredElevation = hoveredElevation;
        this.focusedElevation = focusedElevation;
    ...
    */
    public final Object snapElevation(Continuation<? super Unit> continuation) throws Throwable {
        ...
        if (continuation instanceof C04441) {
            c04441 = (C04441) continuation;
            if ((c04441.label & Integer.MIN_VALUE) != 0) {
                c04441.label -= Integer.MIN_VALUE;
            } else {
                c04441 = new C04441(continuation);
            }
        }
        Object $result = c04441.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        switch (c04441.label) {
            case 0:
                ResultKt.throwOnFailure($result);
                float target = m2404calculateTargetu2uoSUM(this.targetInteraction);
                if (!Dp.m7510equalsimpl0(this.animatable.getTargetValue().m7519unboximpl(), target)) {
                    try {
                        Animatable<Dp, AnimationVector1D> animatable = this.animatable;
                        Dp dpM7503boximpl = Dp.m7503boximpl(target);
                        c04441.L$0 = this;
                        c04441.label = 1;
                        if (animatable.snapTo(dpM7503boximpl, c04441) == coroutine_suspended) {
            ...
            case 1:
                floatingActionButtonElevationAnimatable = (FloatingActionButtonElevationAnimatable) c04441.L$0;
                try {
                    ResultKt.throwOnFailure($result);
                    floatingActionButtonElevationAnimatable.lastTargetInteraction = floatingActionButtonElevationAnimatable.targetInteraction;
                    return Unit.INSTANCE;
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final Object animateElevation(Interaction to, Continuation<? super Unit> continuation) throws Throwable {
        AnonymousClass1 anonymousClass1;
        FloatingActionButtonElevationAnimatable floatingActionButtonElevationAnimatable;
        Throwable th;
        FloatingActionButtonElevationAnimatable floatingActionButtonElevationAnimatable2;
        ...
        switch (anonymousClass1.label) {
            case 0:
                ResultKt.throwOnFailure($result);
                floatingActionButtonElevationAnimatable = this;
                float target = floatingActionButtonElevationAnimatable.m2404calculateTargetu2uoSUM(to);
                floatingActionButtonElevationAnimatable.targetInteraction = to;
                try {
                    if (!Dp.m7510equalsimpl0(floatingActionButtonElevationAnimatable.animatable.getTargetValue().m7519unboximpl(), target)) {
                        Animatable<Dp, AnimationVector1D> animatable = floatingActionButtonElevationAnimatable.animatable;
                        Interaction interaction = floatingActionButtonElevationAnimatable.lastTargetInteraction;
                        anonymousClass1.L$0 = floatingActionButtonElevationAnimatable;
                        anonymousClass1.L$1 = to;
                        anonymousClass1.label = 1;
                        if (ElevationKt.m3183animateElevationrAjV9yQ(animatable, target, interaction, to, anonymousClass1) == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                        floatingActionButtonElevationAnimatable2 = floatingActionButtonElevationAnimatable;
                        floatingActionButtonElevationAnimatable = floatingActionButtonElevationAnimatable2;
                    }
                    floatingActionButtonElevationAnimatable.lastTargetInteraction = to;
                    return Unit.INSTANCE;
                } catch (Throwable th2) {
                    th = th2;
                    floatingActionButtonElevationAnimatable2 = floatingActionButtonElevationAnimatable;
                    floatingActionButtonElevationAnimatable2.lastTargetInteraction = to;
                    throw th;
                }
            case 1:
                to = (Interaction) anonymousClass1.L$1;
                floatingActionButtonElevationAnimatable2 = (FloatingActionButtonElevationAnimatable) anonymousClass1.L$0;
                try {
                    ResultKt.throwOnFailure($result);
                    floatingActionButtonElevationAnimatable = floatingActionButtonElevationAnimatable2;
                    floatingActionButtonElevationAnimatable.lastTargetInteraction = to;
