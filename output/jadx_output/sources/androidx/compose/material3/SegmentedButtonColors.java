...
public final class SegmentedButtonColors {
    ...
    public static /* synthetic */ SegmentedButtonColors m2716copy2qZNXz8$default(SegmentedButtonColors segmentedButtonColors, long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, long j9, long j10, long j11, long j12, int i, Object obj) {
        long j13;
        long j14;
        ...
        return segmentedButtonColors.m2720copy2qZNXz8(j22, j16, j17, j18, j19, j20, j21, j23, j24, j25, j13, j14);
    }

    /* JADX INFO: renamed from: copy-2qZNXz8, reason: not valid java name */
    public final SegmentedButtonColors m2720copy2qZNXz8(long activeContainerColor, long activeContentColor, long activeBorderColor, long inactiveContainerColor, long inactiveContentColor, long inactiveBorderColor, long disabledActiveContainerColor, long disabledActiveContentColor, long disabledActiveBorderColor, long disabledInactiveContainerColor, long disabledInactiveContentColor, long disabledInactiveBorderColor) {
    ...
    public final long m2717borderColorWaAFU9c$material3_release(boolean enabled, boolean active) {
    ...
    public final long m2719contentColorWaAFU9c$material3_release(boolean enabled, boolean checked) {
    ...
    public final long m2718containerColorWaAFU9c$material3_release(boolean enabled, boolean active) {
    ...
    public boolean equals(Object other) {
        ...
        if (Color.m4698equalsimpl0(this.activeBorderColor, ((SegmentedButtonColors) other).activeBorderColor) && Color.m4698equalsimpl0(this.activeContentColor, ((SegmentedButtonColors) other).activeContentColor) && Color.m4698equalsimpl0(this.activeContainerColor, ((SegmentedButtonColors) other).activeContainerColor) && Color.m4698equalsimpl0(this.inactiveBorderColor, ((SegmentedButtonColors) other).inactiveBorderColor) && Color.m4698equalsimpl0(this.inactiveContentColor, ((SegmentedButtonColors) other).inactiveContentColor) && Color.m4698equalsimpl0(this.inactiveContainerColor, ((SegmentedButtonColors) other).inactiveContainerColor) && Color.m4698equalsimpl0(this.disabledActiveBorderColor, ((SegmentedButtonColors) other).disabledActiveBorderColor) && Color.m4698equalsimpl0(this.disabledActiveContentColor, ((SegmentedButtonColors) other).disabledActiveContentColor) && Color.m4698equalsimpl0(this.disabledActiveContainerColor, ((SegmentedButtonColors) other).disabledActiveContainerColor) && Color.m4698equalsimpl0(this.disabledInactiveBorderColor, ((SegmentedButtonColors) other).disabledInactiveBorderColor) && Color.m4698equalsimpl0(this.disabledInactiveContentColor, ((SegmentedButtonColors) other).disabledInactiveContentColor) && Color.m4698equalsimpl0(this.disabledInactiveContainerColor, ((SegmentedButtonColors) other).disabledInactiveContainerColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        int result = Color.m4704hashCodeimpl(this.activeBorderColor);
        return (((((((((((((((((((((result * 31) + Color.m4704hashCodeimpl(this.activeContentColor)) * 31) + Color.m4704hashCodeimpl(this.activeContainerColor)) * 31) + Color.m4704hashCodeimpl(this.inactiveBorderColor)) * 31) + Color.m4704hashCodeimpl(this.inactiveContentColor)) * 31) + Color.m4704hashCodeimpl(this.inactiveContainerColor)) * 31) + Color.m4704hashCodeimpl(this.disabledActiveBorderColor)) * 31) + Color.m4704hashCodeimpl(this.disabledActiveContentColor)) * 31) + Color.m4704hashCodeimpl(this.disabledActiveContainerColor)) * 31) + Color.m4704hashCodeimpl(this.disabledInactiveBorderColor)) * 31) + Color.m4704hashCodeimpl(this.disabledInactiveContentColor)) * 31) + Color.m4704hashCodeimpl(this.disabledInactiveContainerColor);
    }
}
