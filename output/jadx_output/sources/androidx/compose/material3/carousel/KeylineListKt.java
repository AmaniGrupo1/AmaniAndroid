...
public final class KeylineListKt {
    ...
    public static final KeylineList m3170keylineListOfWNYm7Xg(float carouselMainAxisSize, float itemSpacing, int carouselAlignment, Function1<? super KeylineListScope, Unit> function1) {
        KeylineListScopeImpl keylineListScope = new KeylineListScopeImpl();
        function1.invoke(keylineListScope);
        return keylineListScope.m3171createWithAlignmentwaks0t8(carouselMainAxisSize, itemSpacing, carouselAlignment);
    }
