...
public final class CarouselItemScopeImpl implements CarouselItemScope {
    ...
    /* JADX INFO: renamed from: getCarouselItemInfo, reason: from getter */
    ...
    public GenericShape rememberMaskShape(final Shape shape, Composer $composer, int $changed) {
        ...
        if (invalid$iv || it$iv == Composer.INSTANCE.getEmpty()) {
            value$iv = new GenericShape(new Function3<Path, Size, LayoutDirection, Unit>() { // from class: androidx.compose.material3.carousel.CarouselItemScopeImpl$rememberMaskShape$1$1
                ...
                public /* bridge */ /* synthetic */ Unit invoke(Path path, Size size, LayoutDirection layoutDirection) {
                    m3165invoke12SF9DM(path, size.m4526unboximpl(), layoutDirection);
                    return Unit.INSTANCE;
                }

                /* JADX INFO: renamed from: invoke-12SF9DM, reason: not valid java name */
                public final void m3165invoke12SF9DM(Path $this$$receiver, long size, LayoutDirection direction) {
                    Rect rect = this.this$0.getItemInfo().getMaskRect().intersect(SizeKt.m4542toRectuvyYCjk(size));
                    OutlineKt.addOutline($this$$receiver, shape.mo320createOutlinePq9zytI(rect.m4485getSizeNHjbRc(), direction, density));
                    $this$$receiver.mo4589translatek4lQ0M(OffsetKt.Offset(rect.getLeft(), rect.getTop()));
                }
            });
