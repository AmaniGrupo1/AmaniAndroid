...
public final class CarouselStateKt {
    public static final CarouselState rememberCarouselState(final int initialItem, final Function0<Integer> function0, Composer $composer, int $changed, int i) {
        ...
        Object objM4137rememberSaveable = RememberSaveableKt.m4137rememberSaveable(objArr, saver, (String) null, (Function0<? extends Object>) value$iv, $composer, 0, 4);
        CarouselState $this$rememberCarouselState_u24lambda_u241 = (CarouselState) objM4137rememberSaveable;
        $this$rememberCarouselState_u24lambda_u241.getItemCountState().setValue(function0);
        CarouselState carouselState = (CarouselState) objM4137rememberSaveable;
        if (ComposerKt.isTraceInProgress()) {
