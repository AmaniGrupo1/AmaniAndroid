...
public final class CarouselDefaults {
    ...
    private static final float MinSmallItemSize = Dp.m7505constructorimpl(40);
    private static final float MaxSmallItemSize = Dp.m7505constructorimpl(56);
    private static final float AnchorSize = Dp.m7505constructorimpl(10);
    ...
    public final TargetedFlingBehavior multiBrowseFlingBehavior(CarouselState state, DecayAnimationSpec<Float> decayAnimationSpec, AnimationSpec<Float> animationSpec, Composer $composer, int $changed, int i) {
        ...
        DecayAnimationSpec<Float> decayAnimationSpecRememberSplineBasedDecay = (i & 2) != 0 ? SplineBasedFloatDecayAnimationSpec_androidKt.rememberSplineBasedDecay($composer, 0) : decayAnimationSpec;
        if ((i & 4) != 0) {
            AnimationSpec snapAnimationSpec = AnimationSpecKt.spring$default(0.0f, 400.0f, null, 5, null);
            animationSpec2 = snapAnimationSpec;
        } else {
