...
public final class KeylinesKt {
    public static /* synthetic */ KeylineList multiBrowseKeylineList$default(Density $this$multiBrowseKeylineList_u24lambda_u240, float f, float f2, float f3, int i, float f4, float f5, int i2, Object obj) {
        float fMo405toPx0680j_4;
        float fMo405toPx0680j_42;
        if ((i2 & 32) == 0) {
            fMo405toPx0680j_4 = f4;
        } else {
            fMo405toPx0680j_4 = $this$multiBrowseKeylineList_u24lambda_u240.mo405toPx0680j_4(CarouselDefaults.INSTANCE.m3164getMinSmallItemSizeD9Ej5fM$material3_release());
        }
        if ((i2 & 64) == 0) {
            fMo405toPx0680j_42 = f5;
        } else {
            fMo405toPx0680j_42 = $this$multiBrowseKeylineList_u24lambda_u240.mo405toPx0680j_4(CarouselDefaults.INSTANCE.m3163getMaxSmallItemSizeD9Ej5fM$material3_release());
        }
        return multiBrowseKeylineList($this$multiBrowseKeylineList_u24lambda_u240, f, f2, f3, i, fMo405toPx0680j_4, fMo405toPx0680j_42);
    }
    ...
    public static final KeylineList multiBrowseKeylineList(Density density, float carouselMainAxisSize, float preferredItemSize, float itemSpacing, int itemCount, float minSmallItemSize, float maxSmallItemSize) {
        ...
        if (!(carouselMainAxisSize == 0.0f)) {
            if (!(preferredItemSize == 0.0f)) {
                ...
                float anchorSize = density.mo405toPx0680j_4(CarouselDefaults.INSTANCE.m3162getAnchorSizeD9Ej5fM$material3_release());
    ...
    public static final KeylineList createLeftAlignedKeylineList(float carouselMainAxisSize, float itemSpacing, final float leftAnchorSize, final float rightAnchorSize, final Arrangement arrangement) {
        return KeylineListKt.m3170keylineListOfWNYm7Xg(carouselMainAxisSize, itemSpacing, CarouselAlignment.INSTANCE.m3161getStartNUL3oTo(), new Function1<KeylineListScope, Unit>() { // from class: androidx.compose.material3.carousel.KeylinesKt.createLeftAlignedKeylineList.1
    ...
    public static final KeylineList uncontainedKeylineList(Density density, float carouselMainAxisSize, float itemSize, float itemSpacing) {
        if (!(carouselMainAxisSize == 0.0f)) {
            if (!(itemSize == 0.0f)) {
                ...
                float defaultAnchorSize = density.mo405toPx0680j_4(CarouselDefaults.INSTANCE.m3162getAnchorSizeD9Ej5fM$material3_release());
