...
public final class CarouselState implements ScrollableState {
    ...
    private static final Saver<CarouselState, ?> Saver = ListSaverKt.listSaver(new Function2<SaverScope, CarouselState, List<? extends Object>>() { // from class: androidx.compose.material3.carousel.CarouselState$Companion$Saver$1
        ...
        public final List<Object> invoke(SaverScope $this$listSaver, CarouselState it) {
            return CollectionsKt.listOf(Integer.valueOf(it.getPagerState().getCurrentPage()), Float.valueOf(it.getPagerState().getCurrentPageOffsetFraction()), Integer.valueOf(it.getPagerState().getPageCount()));
        }
    ...
    public CarouselState(int currentItem, float currentItemOffsetFraction, Function0<Integer> function0) {
        this.itemCountState = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(function0, null, 2, null);
        this.pagerState = PagerStateKt.PagerState(currentItem, currentItemOffsetFraction, this.itemCountState.getValue());
    }
    ...
    /* JADX INFO: renamed from: getPagerState$material3_release, reason: from getter */
