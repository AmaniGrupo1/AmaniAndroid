...
public final class DateInputKt {
    private static final PaddingValues InputTextFieldPadding = PaddingKt.m815PaddingValuesa9UjIt4$default(Dp.m7505constructorimpl(24), Dp.m7505constructorimpl(10), Dp.m7505constructorimpl(24), 0.0f, 8, null);
    private static final float InputTextNonErroneousBottomPadding = Dp.m7505constructorimpl(16);
    ...
    public static final void DateInputContent(final Long selectedDateMillis, final Function1<? super Long, Unit> function1, final CalendarModel calendarModel, final IntRange yearRange, final DatePickerFormatter dateFormatter, final SelectableDates selectableDates, final DatePickerColors colors, Composer $composer, final int $changed) {
        ...
        if ((599187 & $dirty2) != 599186 || !$composer4.getSkipping()) {
            ...
            if (invalid$iv2 || value$iv2 == Composer.INSTANCE.getEmpty()) {
                ...
                $composer2 = $composer4;
                $dirty = $dirty2;
                value$iv2 = new DateInputValidator(yearRange, selectableDates2, dateInputFormat, dateFormatter, errorDatePattern, errorDateOutOfYearRange, errorInvalidNotAllowed, "", null, null, ValidationPath.MAX_PATH_LENGTH_BYTES, null);
            ...
            final String labelText = Strings_androidKt.m3257getString2EP1pXo(Strings.m3187constructorimpl(R.string.m3c_date_input_label), $composer2, 0);
            ...
            int iM2458getSingleDateInputJ2x2o4M = InputIdentifier.INSTANCE.m2458getSingleDateInputJ2x2o4M();
            dateInputValidator.setCurrentStartDateMillis$material3_release(selectedDateMillis);
            Composer $composer5 = $composer2;
            m2276DateInputTextFieldtQNruF0(modifierPadding, selectedDateMillis, function1, calendarModel, ComposableLambdaKt.rememberComposableLambda(-1819015125, r3, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateInputKt.DateInputContent.2
                ...
                public final void invoke(Composer $composer6, int $changed2) {
                    ...
                    if (($changed2 & 3) != 2 || !$composer6.getSkipping()) {
                        ...
                        TextKt.m2976Text4IGK_g(str, SemanticsModifierKt.semantics$default(companion5, false, (Function1) value$iv3, 1, null), 0L, 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, $composer6, 0, 0, 131068);
                        if (ComposerKt.isTraceInProgress()) {
                ...
                public final void invoke(Composer $composer6, int $changed2) {
                    ...
                    TextKt.m2976Text4IGK_g(pattern, SemanticsModifierKt.clearAndSetSemantics(Modifier.INSTANCE, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.DateInputKt.DateInputContent.3.1
                        @Override // kotlin.jvm.functions.Function1
                        public /* bridge */ /* synthetic */ Unit invoke(SemanticsPropertyReceiver semanticsPropertyReceiver) {
                            invoke2(semanticsPropertyReceiver);
                            return Unit.INSTANCE;
            ...
            }, $composer2, 54), iM2458getSingleDateInputJ2x2o4M, dateInputValidator, dateInputFormat, defaultLocale, colors, $composer5, (($dirty << 3) & 112) | 1794054 | (($dirty << 3) & 896) | (($dirty << 3) & 7168), ($dirty >> 18) & 14);
            $composer3 = $composer5;
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
    ...
    public static final void m2276DateInputTextFieldtQNruF0(final Modifier modifier, final Long initialDateMillis, final Function1<? super Long, Unit> function1, final CalendarModel calendarModel, final Function2<? super Composer, ? super Integer, Unit> function2, final Function2<? super Composer, ? super Integer, Unit> function22, final int inputIdentifier, final DateInputValidator dateInputValidator, DateInputFormat dateInputFormat, final Locale locale, final DatePickerColors colors, Composer $composer, final int $changed, final int $changed1) {
        ...
        if (($changed & 805306368) == 0) {
            $dirty2 |= $composer3.changedInstance(locale) ? C.BUFFER_FLAG_LAST_SAMPLE : 268435456;
        }
        if (($changed1 & 6) == 0) {
        ...
        if (($dirty2 & 306783379) != 306783378 || ($dirty1 & 3) != 2 || !$composer3.getSkipping()) {
            ...
            MutableState errorText2 = (MutableState) RememberSaveableKt.m4137rememberSaveable(new Object[0], (Saver) null, (String) null, (Function0) new Function0<MutableState<String>>() { // from class: androidx.compose.material3.DateInputKt$DateInputTextField$errorText$1
                    ...
                    */
                    public final MutableState<TextFieldValue> invoke() {
                        ...
                        if (l != null) {
                            ...
                            long it = l.longValue();
                            String withPattern = calendarModel2.formatWithPattern(it, dateInputFormat3.getPatternWithoutDelimiters(), locale2);
                            str = withPattern == null ? "" : withPattern;
                        }
            ...
            if (invalid$iv2 || it$iv2 == Composer.INSTANCE.getEmpty()) {
                ...
                Object obj = new Function1<TextFieldValue, Unit>() { // from class: androidx.compose.material3.DateInputKt$DateInputTextField$1$1
                    ...
                    public final void invoke2(TextFieldValue input) {
                        boolean z;
                        if (input.getText().length() <= dateInputFormat2.getPatternWithoutDelimiters().length()) {
                            CharSequence $this$all$iv = input.getText();
                            int i3 = 0;
                            while (true) {
                                if (i3 < $this$all$iv.length()) {
                                    char element$iv = $this$all$iv.charAt(i3);
                            ...
                            Long lValueOf = null;
                            if ((trimmedText.length() == 0) || trimmedText.length() < dateInputFormat2.getPatternWithoutDelimiters().length()) {
                                errorText.setValue("");
                                function13.invoke(null);
                                return;
                            }
                            CalendarDate parsedDate = calendarModel.parse(trimmedText, dateInputFormat2.getPatternWithoutDelimiters());
                            errorText.setValue(dateInputValidator.m2277validateXivgLIo(parsedDate, i2, locale));
            ...
            if (StringsKt.isBlank((CharSequence) errorText.getValue())) {
                fM7505constructorimpl = InputTextNonErroneousBottomPadding;
            } else {
                fM7505constructorimpl = Dp.m7505constructorimpl(0);
            }
            Modifier modifierM822paddingqDBjuR0$default = PaddingKt.m822paddingqDBjuR0$default(modifier, 0.0f, 0.0f, 0.0f, fM7505constructorimpl, 7, null);
            ...
            ComposerKt.sourceInformationMarkerEnd($composer3);
            OutlinedTextFieldKt.OutlinedTextField(textFieldValueDateInputTextField_tQNruF0$lambda$4, (Function1<? super TextFieldValue, Unit>) function14, SemanticsModifierKt.semantics$default(modifierM822paddingqDBjuR0$default, false, (Function1) value$iv3, 1, null), false, false, (TextStyle) null, function2, function22, (Function2<? super Composer, ? super Integer, Unit>) null, (Function2<? super Composer, ? super Integer, Unit>) null, (Function2<? super Composer, ? super Integer, Unit>) null, (Function2<? super Composer, ? super Integer, Unit>) null, (Function2<? super Composer, ? super Integer, Unit>) ComposableLambdaKt.rememberComposableLambda(-591991974, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateInputKt$DateInputTextField$3
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(2);
                }
                ...
                public final void invoke(Composer $composer4, int $changed2) {
                    ...
                    if (!StringsKt.isBlank(errorText.getValue())) {
                        TextKt.m2976Text4IGK_g(errorText.getValue(), (Modifier) null, 0L, 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, $composer4, 0, 0, 131070);
                    }
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                    }
                }
            }, $composer3, 54), !StringsKt.isBlank((CharSequence) errorText.getValue()), (VisualTransformation) new DateVisualTransformation(dateInputFormat2), new KeyboardOptions(0, (Boolean) false, KeyboardType.INSTANCE.m7166getNumberPjHm6EE(), ImeAction.INSTANCE.m7110getDoneeUduSuo(), (PlatformImeOptions) null, (Boolean) null, (LocaleList) null, 113, (DefaultConstructorMarker) null), (KeyboardActions) null, true, 0, 0, (MutableInteractionSource) null, (Shape) null, colors.getDateTextFieldColors(), $composer3, (($dirty << 6) & 3670016) | (($dirty << 6) & 29360128), 12779904, 0, 4001592);
            $composer2 = $composer3;
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateInputKt$DateInputTextField$4
                ...
                public final void invoke(Composer composer, int i3) {
                    DateInputKt.m2276DateInputTextFieldtQNruF0(modifier, initialDateMillis, function1, calendarModel, function2, function22, inputIdentifier, dateInputValidator, dateInputFormat2, locale, colors, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), RecomposeScopeImplKt.updateChangedFlags($changed1));
                }
            });
        }
    }
