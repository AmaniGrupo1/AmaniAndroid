...
public final class NavigationDrawer_androidKt {
    private static final float PredictiveBackDrawerMaxScaleXDistanceGrow = Dp.m7505constructorimpl(12);
    private static final float PredictiveBackDrawerMaxScaleXDistanceShrink = Dp.m7505constructorimpl(24);
    private static final float PredictiveBackDrawerMaxScaleYDistance = Dp.m7505constructorimpl(48);
    ...
    public static final void DrawerPredictiveBackHandler(final DrawerState drawerState, final Function3<? super DrawerPredictiveBackState, ? super Composer, ? super Integer, Unit> function3, Composer $composer, final int $changed) {
        ...
        if (($dirty2 & 19) != 18 || !$composer2.getSkipping()) {
            ...
            maxScaleXDistanceGrow.element = $this$DrawerPredictiveBackHandler_u24lambda_u241.mo405toPx0680j_4(PredictiveBackDrawerMaxScaleXDistanceGrow);
            maxScaleXDistanceShrink.element = $this$DrawerPredictiveBackHandler_u24lambda_u241.mo405toPx0680j_4(PredictiveBackDrawerMaxScaleXDistanceShrink);
            maxScaleYDistance.element = $this$DrawerPredictiveBackHandler_u24lambda_u241.mo405toPx0680j_4(PredictiveBackDrawerMaxScaleYDistance);
