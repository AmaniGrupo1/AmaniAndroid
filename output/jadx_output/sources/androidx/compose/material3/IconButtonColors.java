...
public final class IconButtonColors {
    ...
    public final IconButtonColors m2414copyjRlVdoo(long containerColor, long contentColor, long disabledContainerColor, long disabledContentColor) {
    ...
    public final long m2412containerColorvNxB06k$material3_release(boolean enabled) {
    ...
    public final long m2413contentColorvNxB06k$material3_release(boolean enabled) {
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof IconButtonColors) && Color.m4698equalsimpl0(this.containerColor, ((IconButtonColors) other).containerColor) && Color.m4698equalsimpl0(this.contentColor, ((IconButtonColors) other).contentColor) && Color.m4698equalsimpl0(this.disabledContainerColor, ((IconButtonColors) other).disabledContainerColor) && Color.m4698equalsimpl0(this.disabledContentColor, ((IconButtonColors) other).disabledContentColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (((((result * 31) + Color.m4704hashCodeimpl(this.contentColor)) * 31) + Color.m4704hashCodeimpl(this.disabledContainerColor)) * 31) + Color.m4704hashCodeimpl(this.disabledContentColor);
    }
}
