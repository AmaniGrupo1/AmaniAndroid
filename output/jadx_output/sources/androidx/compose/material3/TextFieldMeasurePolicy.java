...
final class TextFieldMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo41measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, List<? extends Measurable> list, long constraints) {
        ...
        final int topPaddingValue = measureScope.mo399roundToPx0680j_4(textFieldMeasurePolicy.paddingValues.getTop());
        int bottomPaddingValue = measureScope.mo399roundToPx0680j_4(textFieldMeasurePolicy.paddingValues.getBottom());
        int occupiedSpaceHorizontally2 = 0;
        long looseConstraints3 = Constraints.m7447copyZbe2FdA(constraints, (11 & 1) != 0 ? Constraints.m7460getMinWidthimpl(constraints) : 0, (11 & 2) != 0 ? Constraints.m7458getMaxWidthimpl(constraints) : 0, (11 & 4) != 0 ? Constraints.m7459getMinHeightimpl(constraints) : 0, (11 & 8) != 0 ? Constraints.m7457getMaxHeightimpl(constraints) : 0);
        int index$iv$iv = 0;
        int size = list.size();
        while (true) {
            if (index$iv$iv >= size) {
        ...
        Placeable leadingPlaceable = measurable != null ? measurable.mo6141measureBRTryo0(looseConstraints3) : null;
        ...
        if (measurable2 != null) {
            ...
            trailingPlaceable = measurable2.mo6141measureBRTryo0(ConstraintsKt.m7478offsetNN6EwU$default(looseConstraints, -occupiedSpaceHorizontally3, 0, 2, null));
        } else {
            looseConstraints = looseConstraints3;
        ...
        final Placeable prefixPlaceable = measurable3 != null ? measurable3.mo6141measureBRTryo0(ConstraintsKt.m7478offsetNN6EwU$default(looseConstraints, -occupiedSpaceHorizontally4, 0, 2, null)) : null;
        ...
        if (measurable4 != null) {
            ...
            suffixPlaceable = measurable4.mo6141measureBRTryo0(ConstraintsKt.m7478offsetNN6EwU$default(looseConstraints, -occupiedSpaceHorizontally5, 0, 2, null));
        } else {
            looseConstraints2 = looseConstraints;
        ...
        long labelConstraints = ConstraintsKt.m7477offsetNN6EwU(looseConstraints2, -occupiedSpaceHorizontally6, -bottomPaddingValue);
        ...
        final Placeable labelPlaceable = measurable5 != null ? measurable5.mo6141measureBRTryo0(labelConstraints) : null;
        ...
        while (true) {
            ...
            it$iv6 = list11.get(index$iv$iv7);
        ...
        int supportingIntrinsicHeight = supportingMeasurable != null ? supportingMeasurable.minIntrinsicHeight(Constraints.m7460getMinWidthimpl(constraints)) : 0;
        ...
        long textFieldConstraints = ConstraintsKt.m7477offsetNN6EwU(Constraints.m7447copyZbe2FdA(constraints, (11 & 1) != 0 ? Constraints.m7460getMinWidthimpl(constraints) : 0, (11 & 2) != 0 ? Constraints.m7458getMaxWidthimpl(constraints) : 0, (11 & 4) != 0 ? Constraints.m7459getMinHeightimpl(constraints) : 0, (11 & 8) != 0 ? Constraints.m7457getMaxHeightimpl(constraints) : 0), -occupiedSpaceHorizontally6, ((-effectiveTopOffset) - bottomPaddingValue) - supportingIntrinsicHeight);
        int $i$f$fastFirst = 0;
        List<? extends Measurable> list12 = list;
        int occupiedSpaceHorizontally7 = list12.size();
        int index$iv$iv9 = 0;
        while (true) {
            ...
            Object item$iv$iv = list13.get(index$iv$iv9);
            ...
            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(it7), "TextField")) {
                final Placeable textFieldPlaceable = ((Measurable) item$iv$iv).mo6141measureBRTryo0(textFieldConstraints);
                long placeholderConstraints = Constraints.m7447copyZbe2FdA(textFieldConstraints, (11 & 1) != 0 ? Constraints.m7460getMinWidthimpl(textFieldConstraints) : 0, (11 & 2) != 0 ? Constraints.m7458getMaxWidthimpl(textFieldConstraints) : 0, (11 & 4) != 0 ? Constraints.m7459getMinHeightimpl(textFieldConstraints) : 0, (11 & 8) != 0 ? Constraints.m7457getMaxHeightimpl(textFieldConstraints) : 0);
                ...
                while (true) {
                    ...
                    it$iv7 = list15.get(index$iv$iv12);
                ...
                final Placeable placeholderPlaceable = measurable6 != null ? measurable6.mo6141measureBRTryo0(placeholderConstraints) : null;
                ...
                while (totalHeight3 < totalHeight2) {
                    ...
                    if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(it9), TextFieldImplKt.ContainerId)) {
                        final Placeable containerPlaceable = ((Measurable) item$iv$iv2).mo6141measureBRTryo0(ConstraintsKt.Constraints(width != Integer.MAX_VALUE ? width : 0, width, height != Integer.MAX_VALUE ? height : 0, height));
                        ...
                        return MeasureScope.layout$default($this$measure_u2d3p2s80s, width, totalHeight4, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.TextFieldMeasurePolicy$measure$1
                            ...
                            public final void invoke2(Placeable.PlacementScope $this$layout) {
                                ...
                                int i6 = width;
                                if (placeable != null) {
                                    TextFieldKt.placeWithLabel($this$layout, i6, totalHeight4, textFieldPlaceable, labelPlaceable, placeholderPlaceable, leadingPlaceable2, trailingPlaceable, prefixPlaceable, suffixPlaceable2, containerPlaceable, leadingPlaceable3, textFieldMeasurePolicy.singleLine, topPaddingValue, topPaddingValue + labelPlaceable.getHeight(), textFieldMeasurePolicy.animationProgress, measureScope.getDensity());
                                } else {
                                    TextFieldKt.placeWithoutLabel($this$layout, i6, totalHeight4, textFieldPlaceable, placeholderPlaceable, leadingPlaceable2, trailingPlaceable, prefixPlaceable, suffixPlaceable2, containerPlaceable, leadingPlaceable3, textFieldMeasurePolicy.singleLine, measureScope.getDensity(), textFieldMeasurePolicy.paddingValues);
                                }
                            }
                        }, 4, null);
                    }
    ...
    private final int intrinsicWidth(List<? extends IntrinsicMeasurable> measurables, int height, Function2<? super IntrinsicMeasurable, ? super Integer, Integer> intrinsicMeasurer) {
        ...
        for (int index$iv$iv = 0; index$iv$iv < size; index$iv$iv++) {
            ...
            if (Intrinsics.areEqual(TextFieldImplKt.getLayoutId((IntrinsicMeasurable) item$iv$iv), "TextField")) {
                ...
                return TextFieldKt.m2974calculateWidthyeHjK3Y(leadingWidth, trailingWidth, prefixWidth, suffixWidth, textFieldWidth, labelWidth, placeholderWidth, TextFieldImplKt.getZeroConstraints());
            }
        }
        throw new NoSuchElementException("Collection contains no element matching the predicate.");
    }
    ...
    private final int intrinsicHeight(IntrinsicMeasureScope $this$intrinsicHeight, List<? extends IntrinsicMeasurable> list, int width, Function2<? super IntrinsicMeasurable, ? super Integer, Integer> function2) {
        ...
        while (index$iv$iv6 < size6) {
            ...
            if (Intrinsics.areEqual(TextFieldImplKt.getLayoutId((IntrinsicMeasurable) item$iv$iv2), "TextField")) {
                ...
                return TextFieldKt.m2973calculateHeightmKXJcVc(textFieldHeight3, textFieldHeight4, leadingHeight, trailingHeight, labelHeight3, suffixHeight, placeholderHeight, supportingHeight, this.animationProgress, TextFieldImplKt.getZeroConstraints(), $this$intrinsicHeight.getDensity(), this.paddingValues);
            }
            index$iv$iv6++;
