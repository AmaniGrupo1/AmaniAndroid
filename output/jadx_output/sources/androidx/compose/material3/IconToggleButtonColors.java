...
public final class IconToggleButtonColors {
    ...
    public final IconToggleButtonColors m2437copytNS2XkQ(long containerColor, long contentColor, long disabledContainerColor, long disabledContentColor, long checkedContainerColor, long checkedContentColor) {
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof IconToggleButtonColors) && Color.m4698equalsimpl0(this.containerColor, ((IconToggleButtonColors) other).containerColor) && Color.m4698equalsimpl0(this.contentColor, ((IconToggleButtonColors) other).contentColor) && Color.m4698equalsimpl0(this.disabledContainerColor, ((IconToggleButtonColors) other).disabledContainerColor) && Color.m4698equalsimpl0(this.disabledContentColor, ((IconToggleButtonColors) other).disabledContentColor) && Color.m4698equalsimpl0(this.checkedContainerColor, ((IconToggleButtonColors) other).checkedContainerColor) && Color.m4698equalsimpl0(this.checkedContentColor, ((IconToggleButtonColors) other).checkedContentColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (((((((((result * 31) + Color.m4704hashCodeimpl(this.contentColor)) * 31) + Color.m4704hashCodeimpl(this.disabledContainerColor)) * 31) + Color.m4704hashCodeimpl(this.disabledContentColor)) * 31) + Color.m4704hashCodeimpl(this.checkedContainerColor)) * 31) + Color.m4704hashCodeimpl(this.checkedContentColor);
    }
}
