...
public final class ExposedDropdownMenuPositionProvider implements PopupPositionProvider {
    ...
    public /* synthetic */ ExposedDropdownMenuPositionProvider(Density $this$_init__u24lambda_u240, int i, State state, int i2, Function2 function2, int i3, DefaultConstructorMarker defaultConstructorMarker) {
        this($this$_init__u24lambda_u240, i, (i3 & 4) != 0 ? null : state, (i3 & 8) != 0 ? $this$_init__u24lambda_u240.mo399roundToPx0680j_4(MenuKt.getMenuVerticalMargin()) : i2, (i3 & 16) != 0 ? new Function2<IntRect, IntRect, Unit>() { // from class: androidx.compose.material3.ExposedDropdownMenuPositionProvider.2
    ...
    public long mo373calculatePositionllwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
        ...
        long windowSize2 = IntSizeKt.IntSize(IntSize.m7676getWidthimpl(windowSize), IntSize.m7675getHeightimpl(windowSize) + this.topWindowInsets);
        MenuPosition.Horizontal[] horizontalArr = new MenuPosition.Horizontal[3];
        horizontalArr[0] = this.startToAnchorStart;
        horizontalArr[1] = this.endToAnchorEnd;
        if (IntOffset.m7633getXimpl(anchorBounds.m7657getCenternOccac()) < IntSize.m7676getWidthimpl(windowSize2) / 2) {
        ...
        for (int index = 0; index < size; index++) {
            int xCandidate = ((MenuPosition.Horizontal) xCandidates.get(index)).mo3173position95KtPRI(anchorBounds, windowSize2, IntSize.m7676getWidthimpl(popupContentSize), layoutDirection);
            if (index == CollectionsKt.getLastIndex(xCandidates) || (xCandidate >= 0 && IntSize.m7676getWidthimpl(popupContentSize) + xCandidate <= IntSize.m7676getWidthimpl(windowSize2))) {
                x = xCandidate;
                break;
            }
        }
        ...
        if (IntOffset.m7634getYimpl(anchorBounds.m7657getCenternOccac()) < IntSize.m7675getHeightimpl(windowSize2) / 2) {
        ...
        for (int index2 = 0; index2 < size2; index2++) {
            int yCandidate = ((MenuPosition.Vertical) yCandidates.get(index2)).mo3174positionJVtK1S4(anchorBounds, windowSize2, IntSize.m7675getHeightimpl(popupContentSize));
            if (index2 == CollectionsKt.getLastIndex(yCandidates) || (yCandidate >= 0 && IntSize.m7675getHeightimpl(popupContentSize) + yCandidate <= IntSize.m7675getHeightimpl(windowSize2))) {
                y = yCandidate;
                break;
            }
        }
