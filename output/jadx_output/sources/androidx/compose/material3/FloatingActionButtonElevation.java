...
public class FloatingActionButtonElevation {
    ...
    public boolean equals(Object other) {
        ...
        if (other == null || !(other instanceof FloatingActionButtonElevation) || !Dp.m7510equalsimpl0(this.defaultElevation, ((FloatingActionButtonElevation) other).defaultElevation) || !Dp.m7510equalsimpl0(this.pressedElevation, ((FloatingActionButtonElevation) other).pressedElevation) || !Dp.m7510equalsimpl0(this.focusedElevation, ((FloatingActionButtonElevation) other).focusedElevation)) {
            return false;
        }
        return Dp.m7510equalsimpl0(this.hoveredElevation, ((FloatingActionButtonElevation) other).hoveredElevation);
    }

    public int hashCode() {
        int result = Dp.m7511hashCodeimpl(this.defaultElevation);
        return (((((result * 31) + Dp.m7511hashCodeimpl(this.pressedElevation)) * 31) + Dp.m7511hashCodeimpl(this.focusedElevation)) * 31) + Dp.m7511hashCodeimpl(this.hoveredElevation);
    }
}
