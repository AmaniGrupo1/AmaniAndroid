...
public final class SegmentedButtonKt {
    ...
    public static final void SegmentedButton(final MultiChoiceSegmentedButtonRowScope $this$SegmentedButton, final boolean checked, final Function1<? super Boolean, Unit> function1, final Shape shape, Modifier modifier, boolean enabled, SegmentedButtonColors colors, BorderStroke border, MutableInteractionSource interactionSource, Function2<? super Composer, ? super Integer, Unit> function2, final Function2<? super Composer, ? super Integer, Unit> function22, Composer $composer, final int $changed, final int $changed1, final int i) {
        ...
        if ((306783379 & $dirty3) == 306783378 && ($dirty12 & 3) == 2 && $composer3.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer3.getDefaultsInvalid()) {
                ...
                if ((i & 64) != 0) {
                    border2 = SegmentedButtonDefaults.m2733borderStrokel07J4OM$default(SegmentedButtonDefaults.INSTANCE, colors2.m2717borderColorWaAFU9c$material3_release(enabled2, checked), 0.0f, 2, null);
                    $dirty3 &= -29360129;
                }
            ...
            long containerColor = colors3.m2718containerColorWaAFU9c$material3_release(enabled3, checked);
            int $dirty4 = $dirty;
            long contentColor = colors3.m2719contentColorWaAFU9c$material3_release(enabled3, checked);
            ...
            SurfaceKt.m2828Surfaced85dljk(checked, function1, SizeKt.m848defaultMinSizeVpY3zN4(interactionZIndex(RowScope.weight$default($this$SegmentedButton, modifier3, 1.0f, false, 2, null), checked, interactionCountAsState(interactionSource3, $composer3, 0)), ButtonDefaults.INSTANCE.m2101getMinWidthD9Ej5fM(), ButtonDefaults.INSTANCE.m2100getMinHeightD9Ej5fM()), enabled3, shape, containerColor, contentColor, 0.0f, 0.0f, border3, interactionSource3, ComposableLambdaKt.rememberComposableLambda(1635710341, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.SegmentedButtonKt.SegmentedButton.2
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                ...
                public final void invoke(Composer $composer4, int $changed2) {
                    ...
                    if (($changed2 & 3) != 2 || !$composer4.getSkipping()) {
                        ...
                        SegmentedButtonKt.SegmentedButtonContent(function2RememberComposableLambda, function22, $composer4, 0);
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                            return;
                        }
            ...
            }, $composer3, 54), $composer2, (($dirty4 >> 3) & 14) | (($dirty4 >> 3) & 112) | (($dirty4 >> 6) & 7168) | (57344 & ($dirty4 << 3)) | (($dirty4 << 6) & C.ENCODING_PCM_DOUBLE), 48, RendererCapabilities.DECODER_SUPPORT_MASK);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            $dirty2 = $dirty4;
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.SegmentedButtonKt.SegmentedButton.3
                ...
                public final void invoke(Composer composer, int i12) {
                    SegmentedButtonKt.SegmentedButton($this$SegmentedButton, checked, function1, shape, modifier4, enabled4, colors4, border4, interactionSource4, function23, function22, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), RecomposeScopeImplKt.updateChangedFlags($changed1), i);
                }
            });
        }
    }
    ...
    public static final void SegmentedButton(final SingleChoiceSegmentedButtonRowScope $this$SegmentedButton, final boolean selected, final Function0<Unit> function0, final Shape shape, Modifier modifier, boolean enabled, SegmentedButtonColors colors, BorderStroke border, MutableInteractionSource interactionSource, Function2<? super Composer, ? super Integer, Unit> function2, final Function2<? super Composer, ? super Integer, Unit> function22, Composer $composer, final int $changed, final int $changed1, final int i) {
        ...
        if ((306783379 & $dirty3) == 306783378 && ($dirty12 & 3) == 2 && $composer3.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer3.getDefaultsInvalid()) {
                ...
                if ((i & 64) != 0) {
                    border2 = SegmentedButtonDefaults.m2733borderStrokel07J4OM$default(SegmentedButtonDefaults.INSTANCE, colors2.m2717borderColorWaAFU9c$material3_release(enabled2, selected), 0.0f, 2, null);
                    $dirty3 &= -29360129;
                }
                MutableInteractionSource interactionSource5 = i2 != 0 ? null : interactionSource;
                if (i3 != 0) {
            ...
            $composer3.endReplaceGroup();
            long containerColor = colors3.m2718containerColorWaAFU9c$material3_release(enabled3, selected);
            int $dirty4 = $dirty;
            long contentColor = colors3.m2719contentColorWaAFU9c$material3_release(enabled3, selected);
            Modifier modifier7 = modifier3;
            SegmentedButtonColors colors5 = colors3;
            $composer2 = $composer3;
            Function2<? super Composer, ? super Integer, Unit> function24 = function2RememberComposableLambda;
            SurfaceKt.m2827Surfaced85dljk(selected, function0, SemanticsModifierKt.semantics$default(SizeKt.m848defaultMinSizeVpY3zN4(interactionZIndex(RowScope.weight$default($this$SegmentedButton, modifier3, 1.0f, false, 2, null), selected, interactionCountAsState(interactionSource3, $composer3, 0)), ButtonDefaults.INSTANCE.m2101getMinWidthD9Ej5fM(), ButtonDefaults.INSTANCE.m2100getMinHeightD9Ej5fM()), false, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.SegmentedButtonKt.SegmentedButton.5
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.SegmentedButtonKt.SegmentedButton.7
                ...
                public final void invoke(Composer composer, int i12) {
                    SegmentedButtonKt.SegmentedButton($this$SegmentedButton, selected, function0, shape, modifier4, enabled4, colors4, border4, interactionSource4, function23, function22, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), RecomposeScopeImplKt.updateChangedFlags($changed1), i);
                }
            });
        }
    }
    ...
    public static final void m2739SingleChoiceSegmentedButtonRowuFdPcIQ(Modifier modifier, float space, final Function3<? super SingleChoiceSegmentedButtonRowScope, ? super Composer, ? super Integer, Unit> function3, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        float f;
        ...
        if (($dirty2 & 147) == 146 && $composer2.getSkipping()) {
            ...
            float space3 = i3 != 0 ? SegmentedButtonDefaults.INSTANCE.m2736getBorderWidthD9Ej5fM() : f;
            if (ComposerKt.isTraceInProgress()) {
            ...
            Modifier modifier$iv = IntrinsicKt.width(SizeKt.m849defaultMinSizeVpY3zN4$default(SelectableGroupKt.selectableGroup(modifier4), 0.0f, OutlinedSegmentedButtonTokens.INSTANCE.m3639getContainerHeightD9Ej5fM(), 1, null), IntrinsicSize.Min);
            Arrangement.Horizontal horizontalArrangement$iv = Arrangement.INSTANCE.m688spacedBy0680j_4(Dp.m7505constructorimpl(-space3));
            ...
            RowScope $this$SingleChoiceSegmentedButtonRow_uFdPcIQ_u24lambda_u243 = rowScope;
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.SegmentedButtonKt$SingleChoiceSegmentedButtonRow$2
                ...
                public final void invoke(Composer composer, int i6) {
                    SegmentedButtonKt.m2739SingleChoiceSegmentedButtonRowuFdPcIQ(modifier3, space2, function3, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    public static final void m2738MultiChoiceSegmentedButtonRowuFdPcIQ(Modifier modifier, float space, final Function3<? super MultiChoiceSegmentedButtonRowScope, ? super Composer, ? super Integer, Unit> function3, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        float f;
        Function0<ComposeUiNode> function0;
        final Modifier modifier3;
        ...
        if (($dirty2 & 147) == 146 && $composer2.getSkipping()) {
            ...
            Modifier modifier$iv = IntrinsicKt.width(SizeKt.m849defaultMinSizeVpY3zN4$default(modifier4, 0.0f, OutlinedSegmentedButtonTokens.INSTANCE.m3639getContainerHeightD9Ej5fM(), 1, null), IntrinsicSize.Min);
            Arrangement.Horizontal horizontalArrangement$iv = Arrangement.INSTANCE.m688spacedBy0680j_4(Dp.m7505constructorimpl(-space3));
            Alignment.Vertical verticalAlignment$iv = Alignment.INSTANCE.getCenterVertically();
            ComposerKt.sourceInformationMarkerStart($composer2, 693286680, "CC(Row)P(2,1,3)98@4939L58,99@5002L130:Row.kt#2w3rfo");
            MeasurePolicy measurePolicy$iv = RowKt.rowMeasurePolicy(horizontalArrangement$iv, verticalAlignment$iv, $composer2, ((RendererCapabilities.DECODER_SUPPORT_MASK >> 3) & 14) | ((RendererCapabilities.DECODER_SUPPORT_MASK >> 3) & 112));
            ...
            RowScope rowScope = RowScopeInstance.INSTANCE;
            int i5 = ((RendererCapabilities.DECODER_SUPPORT_MASK >> 6) & 112) | 6;
            RowScope $this$MultiChoiceSegmentedButtonRow_uFdPcIQ_u24lambda_u245 = rowScope;
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.SegmentedButtonKt$MultiChoiceSegmentedButtonRow$2
                ...
                public final void invoke(Composer composer, int i6) {
                    SegmentedButtonKt.m2738MultiChoiceSegmentedButtonRowuFdPcIQ(modifier3, space2, function3, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
            ...
            TextKt.ProvideTextStyle(typography, ComposableLambdaKt.rememberComposableLambda(1420592651, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.SegmentedButtonKt$SegmentedButtonContent$1$1
                ...
                public final void invoke(Composer $composer4, int $changed2) {
                    ...
                    if (($changed2 & 3) != 2 || !$composer4.getSkipping()) {
                        ...
                        if ((((432 & 896) ^ RendererCapabilities.DECODER_SUPPORT_MASK) <= 256 || !$composer4.changed(measurePolicy)) && (432 & RendererCapabilities.DECODER_SUPPORT_MASK) != 256) {
                            invalid$iv$iv = false;
                        }
                        ...
                        Updater.m3975setimpl($this$Layout_u24lambda_u240$iv$iv2, measurePolicy$iv$iv, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
    ...
    private static final Modifier interactionZIndex(Modifier $this$interactionZIndex, final boolean checked, final State<Integer> state) {
        return LayoutModifierKt.layout($this$interactionZIndex, new Function3<MeasureScope, Measurable, Constraints, MeasureResult>() { // from class: androidx.compose.material3.SegmentedButtonKt.interactionZIndex.1
            ...
            public /* bridge */ /* synthetic */ MeasureResult invoke(MeasureScope measureScope, Measurable measurable, Constraints constraints) {
                return m2740invoke3p2s80s(measureScope, measurable, constraints.getValue());
            }

            /* JADX INFO: renamed from: invoke-3p2s80s, reason: not valid java name */
            public final MeasureResult m2740invoke3p2s80s(MeasureScope $this$layout, Measurable measurable, long constraints) {
