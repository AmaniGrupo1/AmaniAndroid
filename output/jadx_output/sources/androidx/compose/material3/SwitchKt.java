...
public final class SwitchKt {
    ...
    private static final float ThumbDiameter = SwitchTokens.INSTANCE.m3803getSelectedHandleWidthD9Ej5fM();
    private static final float UncheckedThumbDiameter = SwitchTokens.INSTANCE.m3810getUnselectedHandleWidthD9Ej5fM();
    private static final float SwitchWidth = SwitchTokens.INSTANCE.m3808getTrackWidthD9Ej5fM();
    private static final float SwitchHeight = SwitchTokens.INSTANCE.m3806getTrackHeightD9Ej5fM();
    ...
    public static final void Switch(final boolean checked, final Function1<? super Boolean, Unit> function1, Modifier modifier, Function2<? super Composer, ? super Integer, Unit> function2, boolean enabled, SwitchColors colors, MutableInteractionSource interactionSource, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty2 & 599187) == 599186 && $composer3.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer3.getDefaultsInvalid()) {
                ...
                Function2<? super Composer, ? super Integer, Unit> function25 = i3 != 0 ? null : function22;
                if (i4 != 0) {
                    enabled2 = true;
                }
                if ((i & 32) != 0) {
            ...
            Modifier.Companion toggleableModifier = function1 != null ? ToggleableKt.m1095toggleableO2vRcR0(InteractiveComponentSizeKt.minimumInteractiveComponentSize(Modifier.INSTANCE), z, interactionSource3, null, enabled3, Role.m6692boximpl(Role.INSTANCE.m6705getSwitcho7Vup1c()), function1) : Modifier.INSTANCE;
            int $dirty3 = $dirty;
            $composer2 = $composer3;
            Modifier modifier5 = modifier3;
            SwitchImpl(SizeKt.m858requiredSizeVpY3zN4(SizeKt.wrapContentSize$default(modifier3.then(toggleableModifier), Alignment.INSTANCE.getCenter(), false, 2, null), SwitchWidth, SwitchHeight), checked, enabled3, colors3, function23, interactionSource3, ShapesKt.getValue(SwitchTokens.INSTANCE.getHandleShape(), $composer3, 6), $composer2, (($dirty3 << 3) & 112) | (($dirty3 >> 6) & 896) | (($dirty3 >> 6) & 7168) | (57344 & ($dirty3 << 3)));
            if (ComposerKt.isTraceInProgress()) {
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.SwitchKt.Switch.1
                ...
                public final void invoke(Composer composer, int i7) {
                    SwitchKt.Switch(checked, function1, modifier2, function24, enabled4, colors4, interactionSource4, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    public static final void SwitchImpl(final Modifier modifier, final boolean checked, final boolean enabled, final SwitchColors colors, final Function2<? super Composer, ? super Integer, Unit> function2, final InteractionSource interactionSource, final Shape thumbShape, Composer $composer, final int $changed) {
        ...
        if ((599187 & $dirty) != 599186 || !$composer3.getSkipping()) {
            ...
            long trackColor = colors.m2857trackColorWaAFU9c$material3_release(enabled, checked);
            long resolvedThumbColor = colors.m2856thumbColorWaAFU9c$material3_release(enabled, checked);
            Shape trackShape = ShapesKt.getValue(SwitchTokens.INSTANCE.getTrackShape(), $composer3, 6);
            Modifier modifier$iv = BackgroundKt.m263backgroundbw27NRU(BorderKt.m275borderxT4_qwU(modifier, SwitchTokens.INSTANCE.m3807getTrackOutlineWidthD9Ej5fM(), colors.m2837borderColorWaAFU9c$material3_release(enabled, checked), trackShape), trackColor, trackShape);
            ...
            float arg0$iv = SwitchTokens.INSTANCE.m3805getStateLayerSizeD9Ej5fM();
            float arg0$iv2 = 2;
            Modifier modifier$iv2 = BackgroundKt.m263backgroundbw27NRU(IndicationKt.indication(modifierThen, interactionSource, RippleKt.m2690rippleOrFallbackImplementation9IZ8Weo(false, Dp.m7505constructorimpl(arg0$iv / arg0$iv2), 0L, $composer2, 54, 4)), resolvedThumbColor, thumbShape);
            ...
            if (function2 != null) {
                long iconColor = colors.m2855iconColorWaAFU9c$material3_release(enabled, checked);
                CompositionLocalKt.CompositionLocalProvider(ContentColorKt.getLocalContentColor().provides(Color.m4687boximpl(iconColor)), function2, $composer2, ProvidedValue.$stable | (($dirty2 >> 9) & 112));
            }
    ...
    static {
        ...
        ThumbPadding = Dp.m7505constructorimpl(Dp.m7505constructorimpl(arg0$iv - other$iv) / 2);
