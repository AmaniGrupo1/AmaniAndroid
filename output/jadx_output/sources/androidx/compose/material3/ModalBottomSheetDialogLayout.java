...
final class ModalBottomSheetDialogLayout extends AbstractComposeView implements DialogWindowProvider {
    ...
    public ModalBottomSheetDialogLayout(Context context, Window window, boolean shouldDismissOnBackPress, Function0<Unit> function0, Animatable<Float, AnimationVector1D> animatable, CoroutineScope scope) {
        ...
        this.scope = scope;
        this.content = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(ComposableSingletons$ModalBottomSheet_androidKt.INSTANCE.m2256getLambda2$material3_release(), null, 2, null);
    }
    ...
    private final void maybeRegisterBackCallback() {
        ...
        if (this.backCallback == null) {
            ...
            if (i >= 34) {
                onBackAnimationCallbackCreateBackCallback = Api34Impl.createBackCallback(function0, this.predictiveBackProgress, this.scope);
            } else {
                onBackAnimationCallbackCreateBackCallback = Api33Impl.createBackCallback(function0);
            }
