...
public final class AnalogTimePickerState implements TimePickerState {
    ...
    public int mo2043getSelectionyecRtBI() {
        return this.state.mo2043getSelectionyecRtBI();
    }
    ...
    public void mo2044setSelection6_8s6DQ(int i) {
        this.state.mo2044setSelection6_8s6DQ(i);
    }
    ...
    public final Object animateToCurrent(Continuation<? super Unit> continuation) {
        ...
        if (TimePickerSelectionMode.m3030equalsimpl0(mo2043getSelectionyecRtBI(), TimePickerSelectionMode.INSTANCE.m3034getHouryecRtBI())) {
    ...
    private final boolean isUpdated() {
        ...
        if (TimePickerSelectionMode.m3030equalsimpl0(mo2043getSelectionyecRtBI(), TimePickerSelectionMode.INSTANCE.m3035getMinuteyecRtBI())) {
    ...
    public final IntList getClockFaceValues() {
        return TimePickerSelectionMode.m3030equalsimpl0(mo2043getSelectionyecRtBI(), TimePickerSelectionMode.INSTANCE.m3035getMinuteyecRtBI()) ? TimePickerKt.Minutes : TimePickerKt.Hours;
    }
    ...
    public final Object onGestureEnd(Continuation<? super Unit> continuation) {
        ...
        Object objMutate = this.mutex.mutate(MutatePriority.PreventUserInput, new C03962(end, null), continuation);
        return objMutate == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objMutate : Unit.INSTANCE;
    }
    ...
    static final class C03962 extends SuspendLambda implements Function1<Continuation<? super AnimationResult<Float, AnimationVector1D>>, Object> {
        final /* synthetic */ float $end;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C03962(float f, Continuation<? super C03962> continuation) {
            super(1, continuation);
            this.$end = f;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Continuation<?> continuation) {
            return AnalogTimePickerState.this.new C03962(this.$end, continuation);
        }

        @Override // kotlin.jvm.functions.Function1
        public final Object invoke(Continuation<? super AnimationResult<Float, AnimationVector1D>> continuation) {
            return ((C03962) create(continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    static final class C03972 extends SuspendLambda implements Function1<Continuation<? super Object>, Object> {
        final /* synthetic */ float $angle;
        final /* synthetic */ boolean $animate;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C03972(float f, boolean z, Continuation<? super C03972> continuation) {
            super(1, continuation);
            this.$angle = f;
            this.$animate = z;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Continuation<?> continuation) {
            return AnalogTimePickerState.this.new C03972(this.$angle, this.$animate, continuation);
        }
        ...
        public final Object invoke2(Continuation<Object> continuation) {
            return ((C03972) create(continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            switch (this.label) {
                case 0:
                    ResultKt.throwOnFailure($result);
                    boolean zM3030equalsimpl0 = TimePickerSelectionMode.m3030equalsimpl0(AnalogTimePickerState.this.mo2043getSelectionyecRtBI(), TimePickerSelectionMode.INSTANCE.m3034getHouryecRtBI());
                    AnalogTimePickerState analogTimePickerState = AnalogTimePickerState.this;
                    if (zM3030equalsimpl0) {
    ...
    public final Object rotateTo(float angle, boolean animate, Continuation<? super Unit> continuation) {
        Object objMutate = this.mutex.mutate(MutatePriority.UserInput, new C03972(angle, animate, null), continuation);
        return objMutate == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objMutate : Unit.INSTANCE;
    }
