...
public final class ButtonElevation {
    ...
    private final State<Dp> animateElevation(boolean enabled, InteractionSource interactionSource, Composer $composer, int $changed) {
        Object value$iv;
        ButtonElevation$animateElevation$1$1 value$iv2;
        float target;
        Object value$iv3;
        Animatable animatable;
        ButtonElevation$animateElevation$2$1 value$iv4;
        ...
        if (it$iv3 == Composer.INSTANCE.getEmpty()) {
            value$iv3 = new Animatable(Dp.m7503boximpl(target), VectorConvertersKt.getVectorConverter(Dp.INSTANCE), null, null, 12, null);
        ...
        boolean invalid$iv2 = $composer.changedInstance(animatable2) | $composer.changed(target) | (((($changed & 14) ^ 6) > 4 && $composer.changed(enabled)) || ($changed & 6) == 4) | (((($changed & 896) ^ RendererCapabilities.DECODER_SUPPORT_MASK) > 256 && $composer.changed(this)) || ($changed & RendererCapabilities.DECODER_SUPPORT_MASK) == 256) | $composer.changedInstance(interaction);
        Object it$iv4 = $composer.rememberedValue();
        if (invalid$iv2 || it$iv4 == Composer.INSTANCE.getEmpty()) {
            animatable = animatable2;
            value$iv4 = new ButtonElevation$animateElevation$2$1(animatable, target, enabled, this, interaction, null);
        ...
        ComposerKt.sourceInformationMarkerEnd($composer);
        EffectsKt.LaunchedEffect(dpM7503boximpl, (Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object>) value$iv4, $composer, 0);
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof ButtonElevation) && Dp.m7510equalsimpl0(this.defaultElevation, ((ButtonElevation) other).defaultElevation) && Dp.m7510equalsimpl0(this.pressedElevation, ((ButtonElevation) other).pressedElevation) && Dp.m7510equalsimpl0(this.focusedElevation, ((ButtonElevation) other).focusedElevation) && Dp.m7510equalsimpl0(this.hoveredElevation, ((ButtonElevation) other).hoveredElevation) && Dp.m7510equalsimpl0(this.disabledElevation, ((ButtonElevation) other).disabledElevation)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        int result = Dp.m7511hashCodeimpl(this.defaultElevation);
        return (((((((result * 31) + Dp.m7511hashCodeimpl(this.pressedElevation)) * 31) + Dp.m7511hashCodeimpl(this.focusedElevation)) * 31) + Dp.m7511hashCodeimpl(this.hoveredElevation)) * 31) + Dp.m7511hashCodeimpl(this.disabledElevation);
    }
}
