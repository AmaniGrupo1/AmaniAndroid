...
public final class NavigationBarDefaults {
    ...
    private static final float Elevation = ElevationTokens.INSTANCE.m3455getLevel0D9Ej5fM();

    private NavigationBarDefaults() {
    }

    /* JADX INFO: renamed from: getElevation-D9Ej5fM, reason: not valid java name */
    public final float m2541getElevationD9Ej5fM() {
        return Elevation;
    }
    ...
    public final long getContainerColor(Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1528098623, $changed, -1, "androidx.compose.material3.NavigationBarDefaults.<get-containerColor> (NavigationBar.kt:293)");
        }
    ...
    public final WindowInsets getWindowInsets(Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1938678202, $changed, -1, "androidx.compose.material3.NavigationBarDefaults.<get-windowInsets> (NavigationBar.kt:299)");
        }
