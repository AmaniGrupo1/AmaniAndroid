...
public final class NavigationDrawerItemDefaults {
    ...
    private static final PaddingValues ItemPadding = PaddingKt.m813PaddingValuesYgX7TsA$default(Dp.m7505constructorimpl(12), 0.0f, 2, null);

    private NavigationDrawerItemDefaults() {
    }

    /* JADX INFO: renamed from: colors-oq7We08, reason: not valid java name */
    public final NavigationDrawerItemColors m2562colorsoq7We08(long selectedContainerColor, long unselectedContainerColor, long selectedIconColor, long unselectedIconColor, long selectedTextColor, long unselectedTextColor, long selectedBadgeColor, long unselectedBadgeColor, Composer $composer, int $changed, int i) {
        ComposerKt.sourceInformationMarkerStart($composer, -1574983348, "C(colors)P(1:c#ui.graphics.Color,5:c#ui.graphics.Color,2:c#ui.graphics.Color,6:c#ui.graphics.Color,3:c#ui.graphics.Color,7:c#ui.graphics.Color,0:c#ui.graphics.Color,4:c#ui.graphics.Color)1014@42017L5,1016@42159L5,1017@42244L5,1018@42330L5,1019@42420L5:NavigationDrawer.kt#uh7d8r");
        ...
        long unselectedContainerColor2 = (i & 2) != 0 ? Color.INSTANCE.m4732getTransparent0d7_KjU() : unselectedContainerColor;
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1574983348, $changed, -1, "androidx.compose.material3.NavigationDrawerItemDefaults.colors (NavigationDrawer.kt:1023)");
        }
