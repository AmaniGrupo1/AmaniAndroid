...
public final class SliderColors {
    ...
    public static /* synthetic */ SliderColors m2755copyK518z4$default(SliderColors sliderColors, long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, long j9, long j10, int i, Object obj) {
        long j11;
        long j12;
        ...
        return sliderColors.m2756copyK518z4(j20, j14, j15, j16, j17, j18, j19, j21, j11, j12);
    }

    /* JADX INFO: renamed from: copy--K518z4, reason: not valid java name */
    public final SliderColors m2756copyK518z4(long thumbColor, long activeTrackColor, long activeTickColor, long inactiveTrackColor, long inactiveTickColor, long disabledThumbColor, long disabledActiveTrackColor, long disabledActiveTickColor, long disabledInactiveTrackColor, long disabledInactiveTickColor) {
    ...
    public final long m2767thumbColorvNxB06k$material3_release(boolean enabled) {
    ...
    public final long m2769trackColorWaAFU9c$material3_release(boolean enabled, boolean active) {
    ...
    public final long m2768tickColorWaAFU9c$material3_release(boolean enabled, boolean active) {
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof SliderColors) && Color.m4698equalsimpl0(this.thumbColor, ((SliderColors) other).thumbColor) && Color.m4698equalsimpl0(this.activeTrackColor, ((SliderColors) other).activeTrackColor) && Color.m4698equalsimpl0(this.activeTickColor, ((SliderColors) other).activeTickColor) && Color.m4698equalsimpl0(this.inactiveTrackColor, ((SliderColors) other).inactiveTrackColor) && Color.m4698equalsimpl0(this.inactiveTickColor, ((SliderColors) other).inactiveTickColor) && Color.m4698equalsimpl0(this.disabledThumbColor, ((SliderColors) other).disabledThumbColor) && Color.m4698equalsimpl0(this.disabledActiveTrackColor, ((SliderColors) other).disabledActiveTrackColor) && Color.m4698equalsimpl0(this.disabledActiveTickColor, ((SliderColors) other).disabledActiveTickColor) && Color.m4698equalsimpl0(this.disabledInactiveTrackColor, ((SliderColors) other).disabledInactiveTrackColor) && Color.m4698equalsimpl0(this.disabledInactiveTickColor, ((SliderColors) other).disabledInactiveTickColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        int result = Color.m4704hashCodeimpl(this.thumbColor);
        return (((((((((((((((((result * 31) + Color.m4704hashCodeimpl(this.activeTrackColor)) * 31) + Color.m4704hashCodeimpl(this.activeTickColor)) * 31) + Color.m4704hashCodeimpl(this.inactiveTrackColor)) * 31) + Color.m4704hashCodeimpl(this.inactiveTickColor)) * 31) + Color.m4704hashCodeimpl(this.disabledThumbColor)) * 31) + Color.m4704hashCodeimpl(this.disabledActiveTrackColor)) * 31) + Color.m4704hashCodeimpl(this.disabledActiveTickColor)) * 31) + Color.m4704hashCodeimpl(this.disabledInactiveTrackColor)) * 31) + Color.m4704hashCodeimpl(this.disabledInactiveTickColor);
    }
}
