...
public final class SliderState implements DraggableState {
    ...
    public void dispatchRawDelta(float delta) {
        float f = 2;
        float maxPx = Math.max(getTotalWidth() - (getThumbWidth$material3_release() / f), 0.0f);
        float minPx = Math.min(getThumbWidth$material3_release() / f, maxPx);
    ...
    public final void m2808onPressk4lQ0M$material3_release(long pos) {
        float to = this.isRtl ? getTotalWidth() - Offset.m4452getXimpl(pos) : Offset.m4452getXimpl(pos);
