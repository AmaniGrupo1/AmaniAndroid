...
public final class ModalBottomSheet_androidKt {
    ...
    public static final /* synthetic */ void m2531ModalBottomSheetdYc4hso(final Function0 onDismissRequest, Modifier modifier, SheetState sheetState, float sheetMaxWidth, Shape shape, long containerColor, long contentColor, float tonalElevation, long scrimColor, Function2 dragHandle, WindowInsets windowInsets, ModalBottomSheetProperties properties, final Function3 content, Composer $composer, final int $changed, final int $changed1, final int i) {
        ...
        if (i12 != 0) {
            ...
            i2 = i12;
            $dirty |= $composer3.changedInstance(dragHandle) ? C.BUFFER_FLAG_LAST_SAMPLE : 268435456;
        } else {
            i2 = i12;
        }
        int $dirty5 = $dirty;
        ...
        if ((306783379 & $dirty5) == 306783378 && ($dirty14 & 147) == 146 && $composer3.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer3.getDefaultsInvalid()) {
                ...
                float sheetMaxWidth5 = i7 != 0 ? BottomSheetDefaults.INSTANCE.m2076getSheetMaxWidthD9Ej5fM() : f;
                if ((i & 16) != 0) {
                ...
                if ((i & 64) != 0) {
                    contentColor2 = ColorSchemeKt.m2213contentColorForek8zF_U(containerColor2, $composer3, ($dirty5 >> 15) & 14);
                    $dirty5 &= i4;
                } else {
                    contentColor2 = contentColor;
                }
                float tonalElevation4 = i11 != 0 ? Dp.m7505constructorimpl(0) : tonalElevation;
                if ((i & 256) != 0) {
                ...
                Function2 dragHandle4 = i2 != 0 ? ComposableSingletons$ModalBottomSheet_androidKt.INSTANCE.m2255getLambda1$material3_release() : dragHandle;
                int $dirty6 = $dirty5;
                if ((i & 1024) != 0) {
            ...
            ModalBottomSheetKt.m2525ModalBottomSheetdYc4hso(onDismissRequest, modifier4, sheetState3, sheetMaxWidth3, shape4, containerColor2, contentColor2, tonalElevation5, scrimColor3, dragHandle2, new Function2<Composer, Integer, WindowInsets>() { // from class: androidx.compose.material3.ModalBottomSheet_androidKt$ModalBottomSheet$1
                {
                    super(2);
                }
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ModalBottomSheet_androidKt$ModalBottomSheet$2
                ...
                public final void invoke(Composer composer, int i16) {
                    ModalBottomSheet_androidKt.m2531ModalBottomSheetdYc4hso(onDismissRequest, modifier3, sheetState4, sheetMaxWidth4, shape5, containerColor3, contentColor3, tonalElevation3, contentColor4, dragHandle3, windowInsets4, properties3, content, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), RecomposeScopeImplKt.updateChangedFlags($changed1), i);
                }
            });
        }
    }
    ...
    public static final void ModalBottomSheetDialog(Function0<Unit> function0, ModalBottomSheetProperties properties, final Animatable<Float, AnimationVector1D> animatable, final Function2<? super Composer, ? super Integer, Unit> function2, Composer $composer, final int $changed) {
        ...
        if (($dirty2 & 1171) != 1170 || !$composer3.getSkipping()) {
            ...
            $composer2 = $composer3;
            UUID dialogId = (UUID) RememberSaveableKt.m4137rememberSaveable(new Object[0], (Saver) null, (String) null, (Function0) new Function0<UUID>() { // from class: androidx.compose.material3.ModalBottomSheet_androidKt$ModalBottomSheetDialog$dialogId$1
