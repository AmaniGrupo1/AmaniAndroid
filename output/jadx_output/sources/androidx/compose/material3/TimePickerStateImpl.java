...
final class TimePickerStateImpl implements TimePickerState {
    ...
    public TimePickerStateImpl(int initialHour, int initialMinute, boolean is24Hour) {
        ...
        this.selection = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(TimePickerSelectionMode.m3027boximpl(TimePickerSelectionMode.INSTANCE.m3034getHouryecRtBI()), null, 2, null);
        this.isAfternoon = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Boolean.valueOf(initialHour >= 12), null, 2, null);
    ...
    public int mo2043getSelectionyecRtBI() {
        ...
        return ((TimePickerSelectionMode) $this$getValue$iv.getValue()).m3033unboximpl();
    }
    ...
    public void mo2044setSelection6_8s6DQ(int i) {
        ...
        $this$setValue$iv.setValue(TimePickerSelectionMode.m3027boximpl(i));
    }
    ...
    public void setAfternoon(boolean z) {
        MutableState $this$setValue$iv = this.isAfternoon;
    ...
    public static final class Companion {
        ...
        public final Saver<TimePickerStateImpl, ?> Saver() {
            return SaverKt.Saver(new Function2<SaverScope, TimePickerStateImpl, List<? extends Object>>() { // from class: androidx.compose.material3.TimePickerStateImpl$Companion$Saver$1
                ...
                public final List<Object> invoke(SaverScope $this$Saver, TimePickerStateImpl it) {
