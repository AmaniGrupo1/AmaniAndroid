...
public final class DateRangePickerDefaults {
    ...
    public final void m2325DateRangePickerTitlehOD91z4(final int displayMode, Modifier modifier, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        Composer $composer2;
        ...
        if (($dirty & 19) != 18 || !$composer3.getSkipping()) {
            ...
            if (!DisplayMode.m2347equalsimpl0(displayMode, DisplayMode.INSTANCE.m2352getPickerjFl4v0())) {
                ...
                if (DisplayMode.m2347equalsimpl0(displayMode, DisplayMode.INSTANCE.m2351getInputjFl4v0())) {
                    ...
                    TextKt.m2976Text4IGK_g(Strings_androidKt.m3257getString2EP1pXo(Strings.m3187constructorimpl(R.string.m3c_date_range_input_title), $composer3, 0), modifier4, 0L, 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, $composer3, $dirty2 & 112, 0, 131068);
                    $composer2 = $composer3;
                ...
                TextKt.m2976Text4IGK_g(Strings_androidKt.m3257getString2EP1pXo(Strings.m3187constructorimpl(R.string.m3c_date_range_picker_title), $composer3, 0), modifier4, 0L, 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, $composer3, $dirty & 112, 0, 131068);
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateRangePickerDefaults$DateRangePickerTitle$1
                ...
                public final void invoke(Composer composer, int i3) {
                    this.$tmp0_rcvr.m2325DateRangePickerTitlehOD91z4(displayMode, modifier3, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    public final void m2324DateRangePickerHeadlinev84Udv0(final Long selectedStartDateMillis, final Long selectedEndDateMillis, final int displayMode, final DatePickerFormatter dateFormatter, Modifier modifier, Composer $composer, final int $changed, final int i) {
        Long l;
        Long l2;
        int i2;
        Modifier modifier2;
        ...
        if ((74899 & $dirty2) != 74898 || !$composer2.getSkipping()) {
            ...
            Strings.Companion companion = Strings.INSTANCE;
            final String startDateText = Strings_androidKt.m3257getString2EP1pXo(Strings.m3187constructorimpl(R.string.m3c_date_range_picker_start_headline), $composer2, 0);
            Strings.Companion companion2 = Strings.INSTANCE;
            final String endDateText = Strings_androidKt.m3257getString2EP1pXo(Strings.m3187constructorimpl(R.string.m3c_date_range_picker_end_headline), $composer2, 0);
            Modifier modifier4 = modifier2;
            dateRangePickerDefaults.m2322DateRangePickerHeadline0YIUgSQ(l, l2, i2, dateFormatter, modifier4, startDateText, endDateText, ComposableLambdaKt.rememberComposableLambda(482821121, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateRangePickerDefaults$DateRangePickerHeadline$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(2);
                }
                ...
                public final void invoke(Composer $composer3, int $changed2) {
                    ...
                    TextKt.m2976Text4IGK_g(startDateText, (Modifier) null, 0L, 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, $composer3, 0, 0, 131070);
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                    }
                }
                ...
                public final void invoke(Composer $composer3, int $changed2) {
                    ...
                    TextKt.m2976Text4IGK_g(endDateText, (Modifier) null, 0L, 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, $composer3, 0, 0, 131070);
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                    }
                }
            }, $composer2, 54), ComposableSingletons$DateRangePickerKt.INSTANCE.m2248getLambda1$material3_release(), $composer2, ($dirty2 & 14) | 918552576 | ($dirty2 & 112) | ($dirty2 & 896) | ($dirty2 & 7168) | (57344 & $dirty2), ($dirty2 >> 15) & 14);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            modifier3 = modifier4;
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateRangePickerDefaults$DateRangePickerHeadline$3
                ...
                public final void invoke(Composer composer, int i4) {
                    this.$tmp0_rcvr.m2324DateRangePickerHeadlinev84Udv0(selectedStartDateMillis, selectedEndDateMillis, displayMode, dateFormatter, modifier3, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    public final void m2322DateRangePickerHeadline0YIUgSQ(Long selectedStartDateMillis, final Long selectedEndDateMillis, final int displayMode, final DatePickerFormatter dateFormatter, final Modifier modifier, final String startDateText, final String endDateText, final Function2<? super Composer, ? super Integer, Unit> function2, final Function2<? super Composer, ? super Integer, Unit> function22, final Function2<? super Composer, ? super Integer, Unit> function23, Composer $composer, final int $changed, final int $changed1) {
        ...
        if ((100663296 & $changed) == 0) {
            $dirty |= $composer2.changedInstance(function22) ? 67108864 : 33554432;
        }
        if ((805306368 & $changed) == 0) {
            $dirty |= $composer2.changedInstance(function23) ? C.BUFFER_FLAG_LAST_SAMPLE : 268435456;
        }
        if ((306783379 & $dirty) != 306783378 || ($changed1 & 1) != 0 || !$composer2.getSkipping()) {
            ...
            l = selectedStartDateMillis;
            String formatterEndDate2 = DatePickerFormatter.formatDate$default(dateFormatter, selectedEndDateMillis, defaultLocale, false, 4, null);
            ...
            if (verboseStartDateDescription != null) {
                ...
                Strings.Companion companion = Strings.INSTANCE;
                formatterEndDate = formatterEndDate2;
                verboseStartDateDescription = Strings_androidKt.m3257getString2EP1pXo(Strings.m3187constructorimpl(R.string.m3c_date_picker_no_selection_description), $composer2, 0);
                $composer2.endReplaceGroup();
            } else {
                formatterEndDate = formatterEndDate2;
                if (DisplayMode.m2347equalsimpl0(displayMode, DisplayMode.INSTANCE.m2351getInputjFl4v0())) {
                    ...
                    Strings.Companion companion2 = Strings.INSTANCE;
                    String strM3257getString2EP1pXo = Strings_androidKt.m3257getString2EP1pXo(Strings.m3187constructorimpl(R.string.m3c_date_input_no_input_description), $composer2, 0);
                    $composer2.endReplaceGroup();
                    verboseStartDateDescription = strM3257getString2EP1pXo;
                } else {
            ...
            if (date != null) {
                ...
                verboseEndDateDescription = Strings_androidKt.m3257getString2EP1pXo(Strings.m3187constructorimpl(R.string.m3c_date_picker_no_selection_description), $composer2, 0);
                $composer2.endReplaceGroup();
                ...
                verboseEndDateDescription = Strings_androidKt.m3257getString2EP1pXo(Strings.m3187constructorimpl(R.string.m3c_date_input_no_input_description), $composer2, 0);
                $composer2.endReplaceGroup();
            } else {
            ...
            if (invalid$iv || value$iv == Composer.INSTANCE.getEmpty()) {
                value$iv = (Function1) new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.DateRangePickerDefaults$DateRangePickerHeadline$4$1
                    ...
                    public final void invoke2(SemanticsPropertyReceiver $this$clearAndSetSemantics) {
                        SemanticsPropertiesKt.m6717setLiveRegionhR3wRGc($this$clearAndSetSemantics, LiveRegionMode.INSTANCE.m6691getPolite0phEisY());
            ...
            Arrangement.HorizontalOrVertical horizontalOrVerticalM688spacedBy0680j_4 = Arrangement.INSTANCE.m688spacedBy0680j_4(Dp.m7505constructorimpl(4));
            ComposerKt.sourceInformationMarkerStart($composer2, 693286680, "CC(Row)P(2,1,3)98@4939L58,99@5002L130:Row.kt#2w3rfo");
            MeasurePolicy measurePolicy$iv = RowKt.rowMeasurePolicy(horizontalOrVerticalM688spacedBy0680j_4, centerVertically, $composer2, ((432 >> 3) & 14) | ((432 >> 3) & 112));
            ...
            if (formatterStartDate != null) {
                ...
                TextKt.m2976Text4IGK_g(formatterStartDate, (Modifier) null, 0L, 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, $composer2, 0, 0, 131070);
                $composer2.endReplaceGroup();
            } else {
            ...
            if (formatterEndDate != null) {
                ...
                TextKt.m2976Text4IGK_g(formatterEndDate, (Modifier) null, 0L, 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, $composer2, 0, 0, 131070);
                $composer2.endReplaceGroup();
            } else {
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            ...
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateRangePickerDefaults$DateRangePickerHeadline$6
                ...
                public final void invoke(Composer composer, int i3) {
                    this.$tmp7_rcvr.m2322DateRangePickerHeadline0YIUgSQ(l2, selectedEndDateMillis, displayMode, dateFormatter, modifier, startDateText, endDateText, function2, function22, function23, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), RecomposeScopeImplKt.updateChangedFlags($changed1));
                }
            });
        }
    }
