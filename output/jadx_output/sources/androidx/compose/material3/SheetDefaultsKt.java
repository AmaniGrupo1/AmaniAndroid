...
public final class SheetDefaultsKt {
    private static final float DragHandleVerticalPadding = Dp.m7505constructorimpl(22);
        ...
        return new NestedScrollConnection() { // from class: androidx.compose.material3.SheetDefaultsKt.ConsumeSwipeWithinBottomSheetBoundsNestedScrollConnection.1
            ...
            public Object mo895onPreFlingQWom1Mo(long available, Continuation<? super Velocity> continuation) {
                ...
                if (toFling < 0.0f && currentOffset > minAnchor) {
                    ...
                    jM7754getZero9UxMQ8M = available;
                } else {
            ...
            public Object mo572onPostFlingRZ2iAVY(long consumed, long available, Continuation<? super Velocity> continuation) {
            ...
            private final float velocityToFloat(long $this$toFloat) {
                return orientation == Orientation.Horizontal ? Velocity.m7743getXimpl($this$toFloat) : Velocity.m7744getYimpl($this$toFloat);
            }

            private final float offsetToFloat(long $this$toFloat) {
                return orientation == Orientation.Horizontal ? Offset.m4452getXimpl($this$toFloat) : Offset.m4453getYimpl($this$toFloat);
            }
        };
    }
    ...
    public static final SheetState rememberSheetState(boolean skipPartiallyExpanded, Function1<? super SheetValue, Boolean> function1, SheetValue initialValue, boolean skipHiddenState, Composer $composer, int $changed, int i) {
        ...
        final Function1<? super SheetValue, Boolean> function12 = (i & 2) != 0 ? new Function1<SheetValue, Boolean>() { // from class: androidx.compose.material3.SheetDefaultsKt.rememberSheetState.1
        ...
        Saver<SheetState, SheetValue> Saver = SheetState.INSTANCE.Saver(skipPartiallyExpanded2, function12, density, skipHiddenState2);
        ComposerKt.sourceInformationMarkerStart($composer, -349419818, "CC(remember):SheetDefaults.kt#9igjgp");
        boolean invalid$iv = (((($changed & 14) ^ 6) > 4 && $composer.changed(skipPartiallyExpanded2)) || ($changed & 6) == 4) | $composer.changed(density) | (((($changed & 896) ^ RendererCapabilities.DECODER_SUPPORT_MASK) > 256 && $composer.changed(initialValue2)) || ($changed & RendererCapabilities.DECODER_SUPPORT_MASK) == 256) | (((($changed & 112) ^ 48) > 32 && $composer.changed(function12)) || ($changed & 48) == 32) | (((($changed & 7168) ^ 3072) > 2048 && $composer.changed(skipHiddenState2)) || ($changed & 3072) == 2048);
        ...
        if (invalid$iv || it$iv == Composer.INSTANCE.getEmpty()) {
            value$iv = (Function0) new Function0<SheetState>() { // from class: androidx.compose.material3.SheetDefaultsKt$rememberSheetState$2$1
                ...
                public final SheetState invoke() {
                    return new SheetState(skipPartiallyExpanded2, density, initialValue2, function12, skipHiddenState2);
                }
            };
        ...
        ComposerKt.sourceInformationMarkerEnd($composer);
        SheetState sheetState = (SheetState) RememberSaveableKt.m4137rememberSaveable(objArr, (Saver) Saver, (String) null, (Function0) value$iv, $composer, 0, 4);
        if (ComposerKt.isTraceInProgress()) {
