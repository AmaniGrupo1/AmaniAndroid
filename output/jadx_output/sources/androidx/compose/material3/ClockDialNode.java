...
public final class ClockDialNode extends DelegatingNode implements PointerInputModifierNode, CompositionLocalConsumerModifierNode, LayoutAwareModifierNode {
    ...
    private ClockDialNode(AnalogTimePickerState state, boolean autoSwitchToMinute, int selection) {
        ...
        this.center = IntOffset.INSTANCE.m7644getZeronOccac();
    ...
    public final float getMaxDist() {
        ...
        return $this$_get_maxDist__u24lambda_u240.mo405toPx0680j_4(TimePickerKt.MaxDistance);
    }

    @Override // androidx.compose.ui.node.LayoutAwareModifierNode
    /* JADX INFO: renamed from: onRemeasured-ozmzZPI */
    public void mo394onRemeasuredozmzZPI(long size) {
        this.center = IntSizeKt.m7682getCenterozmzZPI(size);
    }

    @Override // androidx.compose.ui.node.PointerInputModifierNode
    /* JADX INFO: renamed from: onPointerEvent-H0pRuoY */
    public void mo233onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long bounds) {
        this.pointerInputTapNode.mo233onPointerEventH0pRuoY(pointerEvent, pass, bounds);
        this.pointerInputDragNode.mo233onPointerEventH0pRuoY(pointerEvent, pass, bounds);
    }
    ...
    public final void m2166updateNodee8ubxrI(AnalogTimePickerState state, boolean autoSwitchToMinute, int selection) {
        this.state = state;
        this.autoSwitchToMinute = autoSwitchToMinute;
        if (!TimePickerSelectionMode.m3030equalsimpl0(this.selection, selection)) {
            this.selection = selection;
