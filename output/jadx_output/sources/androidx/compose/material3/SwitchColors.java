...
public final class SwitchColors {
    ...
    public static /* synthetic */ SwitchColors m2836copyQ_H9qLU$default(SwitchColors switchColors, long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, long j9, long j10, long j11, long j12, long j13, long j14, long j15, long j16, int i, Object obj) {
        long j17;
        long j18;
        ...
        return switchColors.m2838copyQ_H9qLU(j26, j20, j21, j22, j23, j24, j25, j27, j28, j29, j30, j31, j32, j33, j17, j18);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof SwitchColors) && Color.m4698equalsimpl0(this.checkedThumbColor, ((SwitchColors) other).checkedThumbColor) && Color.m4698equalsimpl0(this.checkedTrackColor, ((SwitchColors) other).checkedTrackColor) && Color.m4698equalsimpl0(this.checkedBorderColor, ((SwitchColors) other).checkedBorderColor) && Color.m4698equalsimpl0(this.checkedIconColor, ((SwitchColors) other).checkedIconColor) && Color.m4698equalsimpl0(this.uncheckedThumbColor, ((SwitchColors) other).uncheckedThumbColor) && Color.m4698equalsimpl0(this.uncheckedTrackColor, ((SwitchColors) other).uncheckedTrackColor) && Color.m4698equalsimpl0(this.uncheckedBorderColor, ((SwitchColors) other).uncheckedBorderColor) && Color.m4698equalsimpl0(this.uncheckedIconColor, ((SwitchColors) other).uncheckedIconColor) && Color.m4698equalsimpl0(this.disabledCheckedThumbColor, ((SwitchColors) other).disabledCheckedThumbColor) && Color.m4698equalsimpl0(this.disabledCheckedTrackColor, ((SwitchColors) other).disabledCheckedTrackColor) && Color.m4698equalsimpl0(this.disabledCheckedBorderColor, ((SwitchColors) other).disabledCheckedBorderColor) && Color.m4698equalsimpl0(this.disabledCheckedIconColor, ((SwitchColors) other).disabledCheckedIconColor) && Color.m4698equalsimpl0(this.disabledUncheckedThumbColor, ((SwitchColors) other).disabledUncheckedThumbColor) && Color.m4698equalsimpl0(this.disabledUncheckedTrackColor, ((SwitchColors) other).disabledUncheckedTrackColor) && Color.m4698equalsimpl0(this.disabledUncheckedBorderColor, ((SwitchColors) other).disabledUncheckedBorderColor) && Color.m4698equalsimpl0(this.disabledUncheckedIconColor, ((SwitchColors) other).disabledUncheckedIconColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        int result = Color.m4704hashCodeimpl(this.checkedThumbColor);
        return (((((((((((((((((((((((((((((result * 31) + Color.m4704hashCodeimpl(this.checkedTrackColor)) * 31) + Color.m4704hashCodeimpl(this.checkedBorderColor)) * 31) + Color.m4704hashCodeimpl(this.checkedIconColor)) * 31) + Color.m4704hashCodeimpl(this.uncheckedThumbColor)) * 31) + Color.m4704hashCodeimpl(this.uncheckedTrackColor)) * 31) + Color.m4704hashCodeimpl(this.uncheckedBorderColor)) * 31) + Color.m4704hashCodeimpl(this.uncheckedIconColor)) * 31) + Color.m4704hashCodeimpl(this.disabledCheckedThumbColor)) * 31) + Color.m4704hashCodeimpl(this.disabledCheckedTrackColor)) * 31) + Color.m4704hashCodeimpl(this.disabledCheckedBorderColor)) * 31) + Color.m4704hashCodeimpl(this.disabledCheckedIconColor)) * 31) + Color.m4704hashCodeimpl(this.disabledUncheckedThumbColor)) * 31) + Color.m4704hashCodeimpl(this.disabledUncheckedTrackColor)) * 31) + Color.m4704hashCodeimpl(this.disabledUncheckedBorderColor)) * 31) + Color.m4704hashCodeimpl(this.disabledUncheckedIconColor);
    }
}
