...
public final class CardElevation {
    ...
    public final State<Dp> shadowElevation$material3_release(boolean enabled, InteractionSource interactionSource, Composer $composer, int $changed) {
        ...
        if (interactionSource == null) {
            ...
            if (it$iv == Composer.INSTANCE.getEmpty()) {
                value$iv = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Dp.m7503boximpl(this.defaultElevation), null, 2, null);
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof CardElevation) && Dp.m7510equalsimpl0(this.defaultElevation, ((CardElevation) other).defaultElevation) && Dp.m7510equalsimpl0(this.pressedElevation, ((CardElevation) other).pressedElevation) && Dp.m7510equalsimpl0(this.focusedElevation, ((CardElevation) other).focusedElevation) && Dp.m7510equalsimpl0(this.hoveredElevation, ((CardElevation) other).hoveredElevation) && Dp.m7510equalsimpl0(this.disabledElevation, ((CardElevation) other).disabledElevation)) {
            return true;
        }
        return false;
    }
