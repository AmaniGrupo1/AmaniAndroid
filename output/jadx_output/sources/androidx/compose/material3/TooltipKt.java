...
public final class TooltipKt {
    ...
    private static final float SpacingBetweenTooltipAndAnchor = Dp.m7505constructorimpl(4);
    private static final float TooltipMinHeight = Dp.m7505constructorimpl(24);
    private static final float TooltipMinWidth = Dp.m7505constructorimpl(40);
    private static final float PlainTooltipMaxWidth = Dp.m7505constructorimpl(200);
    private static final float PlainTooltipVerticalPadding = Dp.m7505constructorimpl(4);
    private static final float PlainTooltipHorizontalPadding = Dp.m7505constructorimpl(8);
    private static final PaddingValues PlainTooltipContentPadding = PaddingKt.m812PaddingValuesYgX7TsA(PlainTooltipHorizontalPadding, PlainTooltipVerticalPadding);
    private static final float RichTooltipMaxWidth = Dp.m7505constructorimpl(320);
    private static final float RichTooltipHorizontalPadding = Dp.m7505constructorimpl(16);
    private static final float HeightToSubheadFirstLine = Dp.m7505constructorimpl(28);
    private static final float HeightFromSubheadToTextFirstLine = Dp.m7505constructorimpl(24);
    private static final float TextBottomPadding = Dp.m7505constructorimpl(16);
    private static final float ActionLabelMinHeight = Dp.m7505constructorimpl(36);
    private static final float ActionLabelBottomPadding = Dp.m7505constructorimpl(8);
    ...
    public static final Modifier textVerticalPadding(Modifier $this$textVerticalPadding, boolean subheadExists, boolean actionExists) {
        if (!subheadExists && !actionExists) {
            return PaddingKt.m820paddingVpY3zN4$default($this$textVerticalPadding, 0.0f, PlainTooltipVerticalPadding, 1, null);
        }
        return PaddingKt.m822paddingqDBjuR0$default(AlignmentLineKt.m663paddingFromBaselineVpY3zN4$default($this$textVerticalPadding, HeightFromSubheadToTextFirstLine, 0.0f, 2, null), 0.0f, 0.0f, 0.0f, TextBottomPadding, 7, null);
    }
    ...
    public static final Modifier animateTooltip(Modifier $this$animateTooltip, final Transition<Boolean> transition) {
        return ComposedModifierKt.composed($this$animateTooltip, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.material3.TooltipKt$animateTooltip$$inlined$debugInspectorInfo$1
            ...
            public final Modifier invoke(Modifier $this$composed, Composer $composer, int $changed) {
                ...
                String str;
                Composer $composer2;
                Transition<Boolean> transition3;
                boolean it;
                boolean it2;
                ...
                Transition<Boolean> transition4 = transition;
                ...
                boolean it3 = transition4.getCurrentState().booleanValue();
                ...
                ComposerKt.sourceInformationMarkerEnd($composer);
                ComposerKt.sourceInformationMarkerEnd($composer);
                Transition<Boolean> transition5 = transition;
                ...
                boolean it5 = transition5.getCurrentState().booleanValue();
                ...
                boolean it6 = transition3.getTargetState().booleanValue();
                $composer.startReplaceGroup(2073045083);
                ComposerKt.sourceInformation($composer, "C:Tooltip.kt#uh7d8r");
                if (ComposerKt.isTraceInProgress()) {
                    it2 = it6;
                ...
                ComposerKt.sourceInformationMarkerEnd($composer);
                ComposerKt.sourceInformationMarkerEnd($composer);
                Modifier modifierM4859graphicsLayerAp8cVGQ = GraphicsLayerModifierKt.m4859graphicsLayerAp8cVGQ($this$composed, (131067 & 1) != 0 ? 1.0f : invoke$lambda$1(scale$delegate), (131067 & 2) != 0 ? 1.0f : invoke$lambda$1(scale$delegate), (131067 & 4) == 0 ? invoke$lambda$3(alpha$delegate) : 1.0f, (131067 & 8) != 0 ? 0.0f : 0.0f, (131067 & 16) != 0 ? 0.0f : 0.0f, (131067 & 32) != 0 ? 0.0f : 0.0f, (131067 & 64) != 0 ? 0.0f : 0.0f, (131067 & 128) != 0 ? 0.0f : 0.0f, (131067 & 256) == 0 ? 0.0f : 0.0f, (131067 & 512) != 0 ? 8.0f : 0.0f, (131067 & 1024) != 0 ? TransformOrigin.INSTANCE.m5110getCenterSzJe1aQ() : 0L, (131067 & 2048) != 0 ? RectangleShapeKt.getRectangleShape() : null, (131067 & 4096) != 0 ? false : false, (131067 & 8192) != 0 ? null : null, (131067 & 16384) != 0 ? GraphicsLayerScopeKt.getDefaultShadowColor() : 0L, (32768 & 131067) != 0 ? GraphicsLayerScopeKt.getDefaultShadowColor() : 0L, (131067 & 65536) != 0 ? CompositingStrategy.INSTANCE.m4786getAutoNrFUSI() : 0);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                $composer.endReplaceGroup();
                return modifierM4859graphicsLayerAp8cVGQ;
            }
