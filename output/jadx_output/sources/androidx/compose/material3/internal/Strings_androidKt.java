...
public final class Strings_androidKt {
    ...
    public static final String m3257getString2EP1pXo(int string, Composer $composer, int $changed) {
    ...
    public static final String m3258getStringqBjtwXw(int string, Object[] formatArgs, Composer $composer, int $changed) {
        ...
        String raw = m3257getString2EP1pXo(string, $composer, $changed & 14);
        ProvidableCompositionLocal<Configuration> localConfiguration = AndroidCompositionLocals_androidKt.getLocalConfiguration();
        ComposerKt.sourceInformationMarkerStart($composer, 2023513938, "CC:CompositionLocal.kt#9igjgp");
