...
public final class CalendarModel_androidKt {
    ...
    public static final String formatWithSkeleton(long utcTimeMillis, String skeleton, Locale locale, Map<String, Object> map) {
        ...
        return Build.VERSION.SDK_INT >= 26 ? CalendarModelImpl.INSTANCE.formatWithPattern(utcTimeMillis, pattern, locale, map) : LegacyCalendarModelImpl.INSTANCE.formatWithPattern(utcTimeMillis, pattern, locale, map);
    }
}
