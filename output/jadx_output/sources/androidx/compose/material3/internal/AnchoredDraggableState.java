...
public final class AnchoredDraggableState<T> {
    ...
    /* JADX INFO: renamed from: androidx.compose.material3.internal.AnchoredDraggableState$anchoredDrag$1, reason: invalid class name and case insensitive filesystem */
    /* JADX INFO: compiled from: AnchoredDraggable.kt */
    ...
    static final class C05251 extends ContinuationImpl {
        ...
        C05251(AnchoredDraggableState<T> anchoredDraggableState, Continuation<? super C05251> continuation) {
            super(continuation);
    ...
    public /* synthetic */ AnchoredDraggableState(Object obj, Function1 function1, Function0 function0, AnimationSpec animationSpec, Function1 function12, int i, DefaultConstructorMarker defaultConstructorMarker) {
        ...
        if ((i & 16) == 0) {
            ...
            function13 = new Function1<T, Boolean>() { // from class: androidx.compose.material3.internal.AnchoredDraggableState.1
                /* JADX WARN: Can't rename method to resolve collision */
    ...
    public /* synthetic */ AnchoredDraggableState(Object obj, DraggableAnchors draggableAnchors, Function1 function1, Function0 function0, AnimationSpec animationSpec, Function1 function12, int i, DefaultConstructorMarker defaultConstructorMarker) {
        ...
        if ((i & 32) == 0) {
            ...
            function13 = new Function1<T, Boolean>() { // from class: androidx.compose.material3.internal.AnchoredDraggableState.2
                /* JADX WARN: Can't rename method to resolve collision */
                @Override // kotlin.jvm.functions.Function1
                public final Boolean invoke(T t) {
                    return true;
    ...
    */
    public final Object anchoredDrag(MutatePriority dragPriority, Function3<? super AnchoredDragScope, ? super DraggableAnchors<T>, ? super Continuation<? super Unit>, ? extends Object> function3, Continuation<? super Unit> continuation) throws Throwable {
        ...
        if (continuation instanceof C05251) {
            ...
            if ((c05251.label & Integer.MIN_VALUE) != 0) {
                c05251.label -= Integer.MIN_VALUE;
            } else {
                c05251 = new C05251(this, continuation);
            }
        }
        Object $result = c05251.result;
        ...
        switch (c05251.label) {
            case 0:
                ...
                try {
                    ...
                    C05262 c05262 = new C05262(this, function3, null);
                    c05251.L$0 = this;
                    c05251.label = 1;
                    if (internalMutatorMutex.mutate(dragPriority, c05262, c05251) == coroutine_suspended) {
            ...
            case 1:
                anchoredDraggableState = (AnchoredDraggableState) c05251.L$0;
                try {
                    ResultKt.throwOnFailure($result);
                    tClosestAnchor2 = anchoredDraggableState.getAnchors().closestAnchor(anchoredDraggableState.getOffset());
                    if (tClosestAnchor2 != null) {
    ...
    /* JADX INFO: renamed from: androidx.compose.material3.internal.AnchoredDraggableState$anchoredDrag$2, reason: invalid class name and case insensitive filesystem */
    /* JADX INFO: compiled from: AnchoredDraggable.kt */
    ...
    static final class C05262 extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C05262(AnchoredDraggableState<T> anchoredDraggableState, Function3<? super AnchoredDragScope, ? super DraggableAnchors<T>, ? super Continuation<? super Unit>, ? extends Object> function3, Continuation<? super C05262> continuation) {
        ...
        public final Continuation<Unit> create(Continuation<?> continuation) {
            return new C05262(this.this$0, this.$block, continuation);
        }

        @Override // kotlin.jvm.functions.Function1
        public final Object invoke(Continuation<? super Unit> continuation) {
            return ((C05262) create(continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        static final class C01092 extends SuspendLambda implements Function2<DraggableAnchors<T>, Continuation<? super Unit>, Object> {
            final /* synthetic */ Function3<AnchoredDragScope, DraggableAnchors<T>, Continuation<? super Unit>, Object> $block;
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            C01092(Function3<? super AnchoredDragScope, ? super DraggableAnchors<T>, ? super Continuation<? super Unit>, ? extends Object> function3, AnchoredDraggableState<T> anchoredDraggableState, Continuation<? super C01092> continuation) {
            ...
            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                C01092 c01092 = new C01092(this.$block, this.this$0, continuation);
                c01092.L$0 = obj;
                return c01092;
            }
            ...
            public final Object invoke(DraggableAnchors<T> draggableAnchors, Continuation<? super Unit> continuation) {
                return ((C01092) create(draggableAnchors, continuation)).invokeSuspend(Unit.INSTANCE);
            }
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    }, new C01092(this.$block, this.this$0, null), this) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    break;
                case 1:
    ...
    static final class AnonymousClass4 extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
        ...
        static final class AnonymousClass2 extends SuspendLambda implements Function2<Pair<? extends DraggableAnchors<T>, ? extends T>, Continuation<? super Unit>, Object> {
            ...
            /*  JADX ERROR: JadxRuntimeException in pass: ModVisitor
                jadx.core.utils.exceptions.JadxRuntimeException: Can't change immutable type java.lang.Object to androidx.compose.material3.internal.AnchoredDraggableState$anchoredDrag$4$2 for r7v1 'this'  java.lang.Object
            ...
            public final java.lang.Object invokeSuspend(java.lang.Object r8) {
                ...
                L16:
                    ...
                    kotlin.jvm.functions.Function4<androidx.compose.material3.internal.AnchoredDragScope, androidx.compose.material3.internal.DraggableAnchors<T>, T, kotlin.coroutines.Continuation<? super kotlin.Unit>, java.lang.Object> r4 = r1.$block
                    androidx.compose.material3.internal.AnchoredDraggableState<T> r5 = r1.this$0
                    androidx.compose.material3.internal.AnchoredDragScope r5 = androidx.compose.material3.internal.AnchoredDraggableState.access$getAnchoredDragScope$p(r5)
                    r6 = 1
                    r1.label = r6
