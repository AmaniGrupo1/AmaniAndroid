...
public final /* data */ class DropdownMenuPositionProvider implements PopupPositionProvider {
    ...
    public static /* synthetic */ DropdownMenuPositionProvider m3179copyuVxBXkw$default(DropdownMenuPositionProvider dropdownMenuPositionProvider, long j, Density density, int i, Function2 function2, int i2, Object obj) {
        if ((i2 & 1) != 0) {
        ...
        return dropdownMenuPositionProvider.m3181copyuVxBXkw(j2, density2, i3, function2);
    }
    ...
    public final DropdownMenuPositionProvider m3181copyuVxBXkw(long contentOffset, Density density, int verticalMargin, Function2<? super IntRect, ? super IntRect, Unit> onPositionCalculated) {
    ...
    public boolean equals(Object other) {
        ...
        return DpOffset.m7565equalsimpl0(this.contentOffset, dropdownMenuPositionProvider.contentOffset) && Intrinsics.areEqual(this.density, dropdownMenuPositionProvider.density) && this.verticalMargin == dropdownMenuPositionProvider.verticalMargin && Intrinsics.areEqual(this.onPositionCalculated, dropdownMenuPositionProvider.onPositionCalculated);
    }

    public int hashCode() {
        return (((((DpOffset.m7570hashCodeimpl(this.contentOffset) * 31) + this.density.hashCode()) * 31) + Integer.hashCode(this.verticalMargin)) * 31) + this.onPositionCalculated.hashCode();
    }

    public String toString() {
        return "DropdownMenuPositionProvider(contentOffset=" + ((Object) DpOffset.m7573toStringimpl(this.contentOffset)) + ", density=" + this.density + ", verticalMargin=" + this.verticalMargin + ", onPositionCalculated=" + this.onPositionCalculated + ')';
    }
    ...
    private DropdownMenuPositionProvider(long contentOffset, Density density, int verticalMargin, Function2<? super IntRect, ? super IntRect, Unit> function2) {
        ...
        int contentOffsetX = $this$_init__u24lambda_u241.mo399roundToPx0680j_4(DpOffset.m7566getXD9Ej5fM(this.contentOffset));
        ...
        int contentOffsetY = $this$_init__u24lambda_u242.mo399roundToPx0680j_4(DpOffset.m7568getYD9Ej5fM(this.contentOffset));
    ...
    public /* synthetic */ DropdownMenuPositionProvider(long j, Density $this$_init__u24lambda_u240, int i, Function2 function2, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        int iMo399roundToPx0680j_4;
        Function2 function22;
        if ((i2 & 4) == 0) {
            iMo399roundToPx0680j_4 = i;
        } else {
            iMo399roundToPx0680j_4 = $this$_init__u24lambda_u240.mo399roundToPx0680j_4(MenuKt.getMenuVerticalMargin());
        }
        if ((i2 & 8) == 0) {
            function22 = function2;
        } else {
            function22 = new Function2<IntRect, IntRect, Unit>() { // from class: androidx.compose.material3.internal.DropdownMenuPositionProvider.2
        ...
        this(j, $this$_init__u24lambda_u240, iMo399roundToPx0680j_4, function22, null);
    }

    /* JADX INFO: renamed from: getContentOffset-RKDOV3M, reason: not valid java name */
    public final long m3182getContentOffsetRKDOV3M() {
        return this.contentOffset;
    }
    ...
    public long mo373calculatePositionllwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
        ...
        horizontalArr[2] = IntOffset.m7633getXimpl(anchorBounds.m7657getCenternOccac()) < IntSize.m7676getWidthimpl(windowSize) / 2 ? this.leftToWindowLeft : this.rightToWindowRight;
        List xCandidates = CollectionsKt.listOf((Object[]) horizontalArr);
        int x = 0;
        int size = xCandidates.size();
        for (int index = 0; index < size; index++) {
            int xCandidate = ((MenuPosition.Horizontal) xCandidates.get(index)).mo3173position95KtPRI(anchorBounds, windowSize, IntSize.m7676getWidthimpl(popupContentSize), layoutDirection);
            if (index == CollectionsKt.getLastIndex(xCandidates) || (xCandidate >= 0 && IntSize.m7676getWidthimpl(popupContentSize) + xCandidate <= IntSize.m7676getWidthimpl(windowSize))) {
                x = xCandidate;
                break;
            }
        }
        ...
        verticalArr[3] = IntOffset.m7634getYimpl(anchorBounds.m7657getCenternOccac()) < IntSize.m7675getHeightimpl(windowSize) / 2 ? this.topToWindowTop : this.bottomToWindowBottom;
        List yCandidates = CollectionsKt.listOf((Object[]) verticalArr);
        int y = 0;
        int size2 = yCandidates.size();
        for (int index2 = 0; index2 < size2; index2++) {
            int yCandidate = ((MenuPosition.Vertical) yCandidates.get(index2)).mo3174positionJVtK1S4(anchorBounds, windowSize, IntSize.m7675getHeightimpl(popupContentSize));
            if (index2 == CollectionsKt.getLastIndex(yCandidates) || (yCandidate >= this.verticalMargin && IntSize.m7675getHeightimpl(popupContentSize) + yCandidate <= IntSize.m7675getHeightimpl(windowSize) - this.verticalMargin)) {
                y = yCandidate;
                break;
            }
        }
        long menuOffset = IntOffsetKt.IntOffset(x, y);
        this.onPositionCalculated.invoke(anchorBounds, IntRectKt.m7666IntRectVbeCjmY(menuOffset, popupContentSize));
        return menuOffset;
    }
}
