...
public final class ElevationKt {
    ...
    public static /* synthetic */ Object m3184animateElevationrAjV9yQ$default(Animatable animatable, float f, Interaction interaction, Interaction interaction2, Continuation continuation, int i, Object obj) {
        if ((i & 2) != 0) {
            interaction = null;
        }
        if ((i & 4) != 0) {
        ...
        return m3183animateElevationrAjV9yQ(animatable, f, interaction, interaction2, continuation);
    }

    /* JADX INFO: renamed from: animateElevation-rAjV9yQ, reason: not valid java name */
    public static final Object m3183animateElevationrAjV9yQ(Animatable<Dp, ?> animatable, float target, Interaction from, Interaction to, Continuation<? super Unit> continuation) {
        ...
        if (animationSpec == null) {
            Object objSnapTo = animatable.snapTo(Dp.m7503boximpl(target), continuation);
            return objSnapTo == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objSnapTo : Unit.INSTANCE;
        }
        Object objAnimateTo = animatable.animateTo(Dp.m7503boximpl(target), (4 & 2) != 0 ? animatable.defaultSpringSpec : animationSpec, (4 & 4) != 0 ? animatable.getVelocity() : null, (4 & 8) != 0 ? null : null, continuation);
