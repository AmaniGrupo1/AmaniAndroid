    ...
    public final boolean getSwitchAccessEnabled(AccessibilityManager $this$switchAccessEnabled) {
        ...
        while (true) {
            ...
            if (settingsActivityName != null) {
                ...
                boolean zContains$default = StringsKt.contains$default((CharSequence) settingsActivityName, (CharSequence) "SwitchAccess", false, 2, (Object) null);
                z = true;
