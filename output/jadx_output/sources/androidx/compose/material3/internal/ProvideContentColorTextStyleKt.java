...
public final class ProvideContentColorTextStyleKt {
    ...
    public static final void m3185ProvideContentColorTextStyle3JVO9M(final long contentColor, final TextStyle textStyle, final Function2<? super Composer, ? super Integer, Unit> function2, Composer $composer, final int $changed) {
        ...
        if (($dirty & 147) != 146 || !$composer2.getSkipping()) {
            ...
            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m4687boximpl(contentColor)), TextKt.getLocalTextStyle().provides(mergedStyle)}, function2, $composer2, ProvidedValue.$stable | (($dirty >> 3) & 112));
            if (ComposerKt.isTraceInProgress()) {
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.internal.ProvideContentColorTextStyleKt$ProvideContentColorTextStyle$1
                ...
                public final void invoke(Composer composer, int i) {
                    ProvideContentColorTextStyleKt.m3185ProvideContentColorTextStyle3JVO9M(contentColor, textStyle, function2, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1));
                }
            });
        }
    }
