...
public final class InternalMutatorMutex {
    ...
    static final class C05322<R> extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super R>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C05322(MutatePriority mutatePriority, InternalMutatorMutex internalMutatorMutex, Function2<? super T, ? super Continuation<? super R>, ? extends Object> function2, T t, Continuation<? super C05322> continuation) {
            super(2, continuation);
            this.$priority = mutatePriority;
            this.this$0 = internalMutatorMutex;
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C05322 c05322 = new C05322(this.$priority, this.this$0, this.$block, this.$receiver, continuation);
            c05322.L$0 = obj;
            return c05322;
        }
        ...
        public final Object invokeSuspend(Object $result) throws Throwable {
            ...
            switch (this.label) {
                case 0:
                    ResultKt.throwOnFailure($result);
                    c05322 = this;
                    CoroutineScope $this$coroutineScope = (CoroutineScope) c05322.L$0;
                    MutatePriority mutatePriority = c05322.$priority;
                    CoroutineContext.Element element = $this$coroutineScope.getCoroutineContext().get(Job.INSTANCE);
                    Intrinsics.checkNotNull(element);
                    Mutator mutator2 = new Mutator(mutatePriority, (Job) element);
                    c05322.this$0.tryMutateOrCancel(mutator2);
                    Mutex $this$withLock_u24default$iv4 = c05322.this$0.mutex;
                    function2 = c05322.$block;
                    obj = c05322.$receiver;
                    InternalMutatorMutex internalMutatorMutex2 = c05322.this$0;
                    c05322.L$0 = mutator2;
                    c05322.L$1 = $this$withLock_u24default$iv4;
                    c05322.L$2 = function2;
                    c05322.L$3 = obj;
                    c05322.L$4 = internalMutatorMutex2;
                    c05322.label = 1;
                    if ($this$withLock_u24default$iv4.lock(null, c05322) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    $this$withLock_u24default$iv = $this$withLock_u24default$iv4;
                    $this$withLock_u24default$iv2 = null;
                    ...
                    try {
                        c05322.L$0 = mutator;
                        c05322.L$1 = $this$withLock_u24default$iv;
                        c05322.L$2 = internalMutatorMutex;
                        c05322.L$3 = null;
                        c05322.L$4 = null;
                        c05322.label = 2;
                        objInvoke = function2.invoke(obj, c05322);
                        if (objInvoke != coroutine_suspended) {
                            return coroutine_suspended;
                        }
                        $result = objInvoke;
                ...
                case 1:
                    c05322 = this;
                    $this$withLock_u24default$iv2 = null;
                    internalMutatorMutex = (InternalMutatorMutex) c05322.L$4;
                    obj = c05322.L$3;
                    function2 = (Function2) c05322.L$2;
                    owner$iv = null;
                    $this$withLock_u24default$iv = (Mutex) c05322.L$1;
                    mutator = (Mutator) c05322.L$0;
                    ResultKt.throwOnFailure($result);
                    c05322.L$0 = mutator;
                    c05322.L$1 = $this$withLock_u24default$iv;
                    c05322.L$2 = internalMutatorMutex;
                ...
                case 2:
                    c053222 = this;
                    mutex = null;
                    internalMutatorMutex = (InternalMutatorMutex) c053222.L$2;
                    owner$iv2 = null;
                    $this$withLock_u24default$iv3 = (Mutex) c053222.L$1;
                    owner$iv3 = (Mutator) c053222.L$0;
                    try {
                        ResultKt.throwOnFailure($result);
                        MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m(internalMutatorMutex.currentMutator, owner$iv3, null);
                        $this$withLock_u24default$iv3.unlock(owner$iv2);
    ...
    public final <T, R> Object mutateWith(T t, MutatePriority priority, Function2<? super T, ? super Continuation<? super R>, ? extends Object> function2, Continuation<? super R> continuation) {
        return CoroutineScopeKt.coroutineScope(new C05322(priority, this, function2, t, null), continuation);
    }
