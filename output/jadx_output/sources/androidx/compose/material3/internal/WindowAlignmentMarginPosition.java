...
public final class WindowAlignmentMarginPosition {
    ...
    public static final /* data */ class Horizontal implements MenuPosition.Horizontal {
        ...
        public int mo3173position95KtPRI(IntRect anchorBounds, long windowSize, int menuWidth, LayoutDirection layoutDirection) {
            if (menuWidth >= IntSize.m7676getWidthimpl(windowSize) - (this.margin * 2)) {
                return Alignment.INSTANCE.getCenterHorizontally().align(menuWidth, IntSize.m7676getWidthimpl(windowSize), layoutDirection);
            }
            int x = this.alignment.align(menuWidth, IntSize.m7676getWidthimpl(windowSize), layoutDirection);
            return RangesKt.coerceIn(x, this.margin, (IntSize.m7676getWidthimpl(windowSize) - this.margin) - menuWidth);
        }
    }
    ...
    public static final /* data */ class Vertical implements MenuPosition.Vertical {
        ...
        public int mo3174positionJVtK1S4(IntRect anchorBounds, long windowSize, int menuHeight) {
            if (menuHeight >= IntSize.m7675getHeightimpl(windowSize) - (this.margin * 2)) {
                return Alignment.INSTANCE.getCenterVertically().align(menuHeight, IntSize.m7675getHeightimpl(windowSize));
            }
            int y = this.alignment.align(menuHeight, IntSize.m7675getHeightimpl(windowSize));
            return RangesKt.coerceIn(y, this.margin, (IntSize.m7675getHeightimpl(windowSize) - this.margin) - menuHeight);
        }
    }
}
