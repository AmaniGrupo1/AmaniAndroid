...
public final class SuggestionChipDefaults {
    ...
    private static final float Height = SuggestionChipTokens.INSTANCE.m3788getContainerHeightD9Ej5fM();
    private static final float IconSize = SuggestionChipTokens.INSTANCE.m3797getLeadingIconSizeD9Ej5fM();

    private SuggestionChipDefaults() {
    }

    /* JADX INFO: renamed from: getHeight-D9Ej5fM, reason: not valid java name */
    public final float m2820getHeightD9Ej5fM() {
        return Height;
    }

    /* JADX INFO: renamed from: getIconSize-D9Ej5fM, reason: not valid java name */
    public final float m2821getIconSizeD9Ej5fM() {
        return IconSize;
    }
    ...
    public final ChipColors m2824suggestionChipColors5tl4gsc(long containerColor, long labelColor, long iconContentColor, long disabledContainerColor, long disabledLabelColor, long disabledIconContentColor, Composer $composer, int $changed, int i) {
        ...
        long iconContentColor2 = (i & 4) != 0 ? Color.INSTANCE.m4733getUnspecified0d7_KjU() : iconContentColor;
        ...
        long disabledIconContentColor2 = (i & 32) != 0 ? Color.INSTANCE.m4733getUnspecified0d7_KjU() : disabledIconContentColor;
        if (ComposerKt.isTraceInProgress()) {
        ...
        ChipColors chipColorsM2139copyFD3wquc = ChipKt.getDefaultSuggestionChipColors(MaterialTheme.INSTANCE.getColorScheme($composer, 6)).m2139copyFD3wquc(containerColor2, labelColor2, iconContentColor2, Color.INSTANCE.m4733getUnspecified0d7_KjU(), disabledContainerColor2, disabledLabelColor2, disabledIconContentColor2, Color.INSTANCE.m4733getUnspecified0d7_KjU());
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd($composer);
    ...
    public final ChipElevation m2825suggestionChipElevationaqJV_2Y(float elevation, float pressedElevation, float focusedElevation, float hoveredElevation, float draggedElevation, float disabledElevation, Composer $composer, int $changed, int i) {
        float elevation2;
        ...
        if ((i & 1) != 0) {
            float elevation3 = SuggestionChipTokens.INSTANCE.m3795getFlatContainerElevationD9Ej5fM();
        ...
        float draggedElevation2 = (i & 16) != 0 ? SuggestionChipTokens.INSTANCE.m3789getDraggedContainerElevationD9Ej5fM() : draggedElevation;
    ...
    public final BorderStroke m2823suggestionChipBorderh1eTWw(boolean enabled, long borderColor, long disabledBorderColor, float borderWidth, Composer $composer, int $changed, int i) {
        ...
        if ((i & 4) != 0) {
            ...
            disabledBorderColor2 = Color.m4695copywmQWz5c(value, (14 & 1) != 0 ? Color.m4699getAlphaimpl(value) : SuggestionChipTokens.INSTANCE.getFlatDisabledOutlineOpacity(), (14 & 2) != 0 ? Color.m4703getRedimpl(value) : 0.0f, (14 & 4) != 0 ? Color.m4702getGreenimpl(value) : 0.0f, (14 & 8) != 0 ? Color.m4700getBlueimpl(value) : 0.0f);
        } else {
            disabledBorderColor2 = disabledBorderColor;
        }
        float borderWidth2 = (i & 8) != 0 ? SuggestionChipTokens.INSTANCE.m3796getFlatOutlineWidthD9Ej5fM() : borderWidth;
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final ChipBorder m2822suggestionChipBorderd_3_b6Q(long borderColor, long disabledBorderColor, float borderWidth, Composer $composer, int $changed, int i) {
        long disabledBorderColor2;
        ...
        float borderWidth2 = (i & 4) != 0 ? SuggestionChipTokens.INSTANCE.m3796getFlatOutlineWidthD9Ej5fM() : borderWidth;
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final ChipColors m2818elevatedSuggestionChipColors5tl4gsc(long containerColor, long labelColor, long iconContentColor, long disabledContainerColor, long disabledLabelColor, long disabledIconContentColor, Composer $composer, int $changed, int i) {
        ...
        ChipColors chipColorsM2139copyFD3wquc = getDefaultElevatedSuggestionChipColors$material3_release(MaterialTheme.INSTANCE.getColorScheme($composer, 6)).m2139copyFD3wquc(containerColor2, labelColor2, iconContentColor2, Color.INSTANCE.m4733getUnspecified0d7_KjU(), disabledContainerColor2, disabledLabelColor2, disabledIconContentColor2, Color.INSTANCE.m4733getUnspecified0d7_KjU());
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd($composer);
    ...
    public final ChipColors getDefaultElevatedSuggestionChipColors$material3_release(ColorScheme $this$defaultElevatedSuggestionChipColors) {
        ...
        if (it == null) {
            ...
            long jM4695copywmQWz5c = Color.m4695copywmQWz5c(jFromToken4, (14 & 1) != 0 ? Color.m4699getAlphaimpl(jFromToken4) : AssistChipTokens.INSTANCE.getElevatedDisabledContainerOpacity(), (14 & 2) != 0 ? Color.m4703getRedimpl(jFromToken4) : 0.0f, (14 & 4) != 0 ? Color.m4702getGreenimpl(jFromToken4) : 0.0f, (14 & 8) != 0 ? Color.m4700getBlueimpl(jFromToken4) : 0.0f);
            ...
            long jM4695copywmQWz5c2 = Color.m4695copywmQWz5c(jFromToken5, (14 & 1) != 0 ? Color.m4699getAlphaimpl(jFromToken5) : SuggestionChipTokens.INSTANCE.getDisabledLabelTextOpacity(), (14 & 2) != 0 ? Color.m4703getRedimpl(jFromToken5) : 0.0f, (14 & 4) != 0 ? Color.m4702getGreenimpl(jFromToken5) : 0.0f, (14 & 8) != 0 ? Color.m4700getBlueimpl(jFromToken5) : 0.0f);
            ...
            ChipColors it2 = new ChipColors(jFromToken, jFromToken2, jFromToken3, jM4733getUnspecified0d7_KjU, jM4695copywmQWz5c, jM4695copywmQWz5c2, Color.m4695copywmQWz5c(jFromToken6, (14 & 1) != 0 ? Color.m4699getAlphaimpl(jFromToken6) : AssistChipTokens.INSTANCE.getDisabledIconOpacity(), (14 & 2) != 0 ? Color.m4703getRedimpl(jFromToken6) : 0.0f, (14 & 4) != 0 ? Color.m4702getGreenimpl(jFromToken6) : 0.0f, (14 & 8) != 0 ? Color.m4700getBlueimpl(jFromToken6) : 0.0f), Color.INSTANCE.m4733getUnspecified0d7_KjU(), null);
    ...
    public final ChipElevation m2819elevatedSuggestionChipElevationaqJV_2Y(float elevation, float pressedElevation, float focusedElevation, float hoveredElevation, float draggedElevation, float disabledElevation, Composer $composer, int $changed, int i) {
        float elevation2;
        float pressedElevation2;
        float focusedElevation2;
        ...
        if ((i & 1) != 0) {
            float elevation3 = SuggestionChipTokens.INSTANCE.m3790getElevatedContainerElevationD9Ej5fM();
            elevation2 = elevation3;
        } else {
            elevation2 = elevation;
        }
        if ((i & 2) != 0) {
            float pressedElevation3 = SuggestionChipTokens.INSTANCE.m3794getElevatedPressedContainerElevationD9Ej5fM();
            pressedElevation2 = pressedElevation3;
        } else {
            pressedElevation2 = pressedElevation;
        }
        if ((i & 4) != 0) {
            float focusedElevation3 = SuggestionChipTokens.INSTANCE.m3792getElevatedFocusContainerElevationD9Ej5fM();
            focusedElevation2 = focusedElevation3;
        } else {
            focusedElevation2 = focusedElevation;
        }
        float hoveredElevation2 = (i & 8) != 0 ? SuggestionChipTokens.INSTANCE.m3793getElevatedHoverContainerElevationD9Ej5fM() : hoveredElevation;
        float draggedElevation2 = (i & 16) != 0 ? SuggestionChipTokens.INSTANCE.m3789getDraggedContainerElevationD9Ej5fM() : draggedElevation;
        float disabledElevation2 = (i & 32) != 0 ? SuggestionChipTokens.INSTANCE.m3791getElevatedDisabledContainerElevationD9Ej5fM() : disabledElevation;
        if (ComposerKt.isTraceInProgress()) {
