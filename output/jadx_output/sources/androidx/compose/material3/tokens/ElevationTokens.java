...
public final class ElevationTokens {
    ...
    private static final float Level0 = Dp.m7505constructorimpl((float) 0.0d);
    private static final float Level1 = Dp.m7505constructorimpl((float) 1.0d);
    private static final float Level2 = Dp.m7505constructorimpl((float) 3.0d);
    private static final float Level3 = Dp.m7505constructorimpl((float) 6.0d);
    private static final float Level4 = Dp.m7505constructorimpl((float) 8.0d);
    private static final float Level5 = Dp.m7505constructorimpl((float) 12.0d);

    private ElevationTokens() {
    }

    /* JADX INFO: renamed from: getLevel0-D9Ej5fM, reason: not valid java name */
    public final float m3455getLevel0D9Ej5fM() {
        return Level0;
    }

    /* JADX INFO: renamed from: getLevel1-D9Ej5fM, reason: not valid java name */
    public final float m3456getLevel1D9Ej5fM() {
        return Level1;
    }

    /* JADX INFO: renamed from: getLevel2-D9Ej5fM, reason: not valid java name */
    public final float m3457getLevel2D9Ej5fM() {
        return Level2;
    }

    /* JADX INFO: renamed from: getLevel3-D9Ej5fM, reason: not valid java name */
    public final float m3458getLevel3D9Ej5fM() {
        return Level3;
    }

    /* JADX INFO: renamed from: getLevel4-D9Ej5fM, reason: not valid java name */
    public final float m3459getLevel4D9Ej5fM() {
        return Level4;
    }

    /* JADX INFO: renamed from: getLevel5-D9Ej5fM, reason: not valid java name */
    public final float m3460getLevel5D9Ej5fM() {
        return Level5;
    }
}
