...
public final class ProgressIndicatorTokens {
    ...
    private static final float ActiveThickness = Dp.m7505constructorimpl((float) 4.0d);
    private static final float ActiveTrackSpace = Dp.m7505constructorimpl((float) 4.0d);
    private static final ColorSchemeKeyTokens StopColor = ColorSchemeKeyTokens.Primary;
    private static final float StopShape = Dp.m7505constructorimpl((float) 4.0d);
    private static final float StopSize = Dp.m7505constructorimpl((float) 4.0d);
    ...
    private static final float TrackThickness = Dp.m7505constructorimpl((float) 4.0d);
    private static final float Size = Dp.m7505constructorimpl((float) 48.0d);
    ...
    public final float m3745getActiveThicknessD9Ej5fM() {
        return ActiveThickness;
    }

    /* JADX INFO: renamed from: getActiveTrackSpace-D9Ej5fM, reason: not valid java name */
    public final float m3746getActiveTrackSpaceD9Ej5fM() {
    ...
    /* JADX INFO: renamed from: getStopShape-D9Ej5fM, reason: not valid java name */
    public final float m3748getStopShapeD9Ej5fM() {
        return StopShape;
    }

    /* JADX INFO: renamed from: getStopSize-D9Ej5fM, reason: not valid java name */
    public final float m3749getStopSizeD9Ej5fM() {
        return StopSize;
    }
    ...
    public final float m3750getTrackThicknessD9Ej5fM() {
        return TrackThickness;
    }

    /* JADX INFO: renamed from: getSize-D9Ej5fM, reason: not valid java name */
    public final float m3747getSizeD9Ej5fM() {
        return Size;
    }
}
