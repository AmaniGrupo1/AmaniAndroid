...
public final class OutlinedIconButtonTokens {
    ...
    private static final float ContainerSize = Dp.m7505constructorimpl((float) 40.0d);
    ...
    private static final float Size = Dp.m7505constructorimpl((float) 24.0d);
    ...
    public final float m3636getContainerSizeD9Ej5fM() {
    ...
    public final float m3637getSizeD9Ej5fM() {
        return Size;
    }
    ...
    public final float m3638getUnselectedOutlineWidthD9Ej5fM() {
