...
public final class BadgeTokens {
    ...
    private static final float LargeSize = Dp.m7505constructorimpl((float) 16.0d);
    private static final ShapeKeyTokens Shape = ShapeKeyTokens.CornerFull;
    private static final float Size = Dp.m7505constructorimpl((float) 6.0d);
    ...
    public final float m3296getLargeSizeD9Ej5fM() {
        return LargeSize;
    }
    ...
    public final float m3297getSizeD9Ej5fM() {
        return Size;
    }
}
