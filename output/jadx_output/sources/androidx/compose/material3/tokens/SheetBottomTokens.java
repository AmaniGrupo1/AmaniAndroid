...
public final class SheetBottomTokens {
    ...
    private static final float DockedDragHandleHeight = Dp.m7505constructorimpl((float) 4.0d);
    private static final float DockedDragHandleWidth = Dp.m7505constructorimpl((float) 32.0d);
    private static final ShapeKeyTokens DockedMinimizedContainerShape = ShapeKeyTokens.CornerNone;
    private static final float DockedModalContainerElevation = ElevationTokens.INSTANCE.m3456getLevel1D9Ej5fM();
    private static final float DockedStandardContainerElevation = ElevationTokens.INSTANCE.m3456getLevel1D9Ej5fM();
    ...
    public final float m3764getDockedDragHandleHeightD9Ej5fM() {
        return DockedDragHandleHeight;
    }

    /* JADX INFO: renamed from: getDockedDragHandleWidth-D9Ej5fM, reason: not valid java name */
    public final float m3765getDockedDragHandleWidthD9Ej5fM() {
    ...
    public final float m3766getDockedModalContainerElevationD9Ej5fM() {
    ...
    public final float m3767getDockedStandardContainerElevationD9Ej5fM() {
