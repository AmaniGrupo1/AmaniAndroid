...
public final class TopAppBarMediumTokens {
    ...
    private static final float ContainerHeight = Dp.m7505constructorimpl((float) 112.0d);
    ...
    public final float m3838getContainerElevationD9Ej5fM() {
        return ContainerElevation;
    }

    /* JADX INFO: renamed from: getContainerHeight-D9Ej5fM, reason: not valid java name */
    public final float m3839getContainerHeightD9Ej5fM() {
    ...
    public final float m3840getLeadingIconSizeD9Ej5fM() {
    ...
    public final float m3841getTrailingIconSizeD9Ej5fM() {
