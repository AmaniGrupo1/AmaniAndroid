...
public final class DateInputModalTokens {
    ...
    private static final float ContainerHeight = Dp.m7505constructorimpl((float) 512.0d);
    ...
    private static final float ContainerWidth = Dp.m7505constructorimpl((float) 328.0d);
    private static final float HeaderContainerHeight = Dp.m7505constructorimpl((float) 120.0d);
    private static final float HeaderContainerWidth = Dp.m7505constructorimpl((float) 328.0d);
    ...
    public final float m3416getContainerElevationD9Ej5fM() {
        return ContainerElevation;
    }

    /* JADX INFO: renamed from: getContainerHeight-D9Ej5fM, reason: not valid java name */
    public final float m3417getContainerHeightD9Ej5fM() {
