...
public final class InputChipDefaults {
    ...
    private static final float Height = InputChipTokens.INSTANCE.m3576getContainerHeightD9Ej5fM();
    private static final float IconSize = InputChipTokens.INSTANCE.m3578getLeadingIconSizeD9Ej5fM();
    private static final float AvatarSize = InputChipTokens.INSTANCE.m3574getAvatarSizeD9Ej5fM();

    private InputChipDefaults() {
    }

    /* JADX INFO: renamed from: getHeight-D9Ej5fM, reason: not valid java name */
    public final float m2445getHeightD9Ej5fM() {
        return Height;
    }

    /* JADX INFO: renamed from: getIconSize-D9Ej5fM, reason: not valid java name */
    public final float m2446getIconSizeD9Ej5fM() {
        return IconSize;
    }

    /* JADX INFO: renamed from: getAvatarSize-D9Ej5fM, reason: not valid java name */
    public final float m2444getAvatarSizeD9Ej5fM() {
        return AvatarSize;
    }
    ...
    public final SelectableChipColors m2448inputChipColorskwJvTHA(long containerColor, long labelColor, long leadingIconColor, long trailingIconColor, long disabledContainerColor, long disabledLabelColor, long disabledLeadingIconColor, long disabledTrailingIconColor, long selectedContainerColor, long disabledSelectedContainerColor, long selectedLabelColor, long selectedLeadingIconColor, long selectedTrailingIconColor, Composer $composer, int $changed, int $changed1, int i) {
        ...
        long leadingIconColor2 = (i & 4) != 0 ? Color.INSTANCE.m4733getUnspecified0d7_KjU() : leadingIconColor;
        long trailingIconColor2 = (i & 8) != 0 ? Color.INSTANCE.m4733getUnspecified0d7_KjU() : trailingIconColor;
        ...
        long disabledLeadingIconColor2 = (i & 64) != 0 ? Color.INSTANCE.m4733getUnspecified0d7_KjU() : disabledLeadingIconColor;
        long disabledTrailingIconColor2 = (i & 128) != 0 ? Color.INSTANCE.m4733getUnspecified0d7_KjU() : disabledTrailingIconColor;
        long selectedContainerColor2 = (i & 256) != 0 ? Color.INSTANCE.m4733getUnspecified0d7_KjU() : selectedContainerColor;
        long disabledSelectedContainerColor2 = (i & 512) != 0 ? Color.INSTANCE.m4733getUnspecified0d7_KjU() : disabledSelectedContainerColor;
        long selectedLabelColor2 = (i & 1024) != 0 ? Color.INSTANCE.m4733getUnspecified0d7_KjU() : selectedLabelColor;
        long selectedLeadingIconColor2 = (i & 2048) != 0 ? Color.INSTANCE.m4733getUnspecified0d7_KjU() : selectedLeadingIconColor;
        long selectedTrailingIconColor2 = (i & 4096) != 0 ? Color.INSTANCE.m4733getUnspecified0d7_KjU() : selectedTrailingIconColor;
        if (ComposerKt.isTraceInProgress()) {
        ...
        SelectableChipColors selectableChipColorsM2743copydaRQuJA = getDefaultInputChipColors$material3_release(MaterialTheme.INSTANCE.getColorScheme($composer, 6)).m2743copydaRQuJA(containerColor2, labelColor2, leadingIconColor2, trailingIconColor2, disabledContainerColor2, disabledLabelColor2, disabledLeadingIconColor2, disabledTrailingIconColor2, selectedContainerColor2, disabledSelectedContainerColor2, selectedLabelColor2, selectedLeadingIconColor2, selectedTrailingIconColor2);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd($composer);
    ...
    public final SelectableChipColors getDefaultInputChipColors$material3_release(ColorScheme $this$defaultInputChipColors) {
        ...
        long jM4695copywmQWz5c = Color.m4695copywmQWz5c(jFromToken4, (14 & 1) != 0 ? Color.m4699getAlphaimpl(jFromToken4) : 0.38f, (14 & 2) != 0 ? Color.m4703getRedimpl(jFromToken4) : 0.0f, (14 & 4) != 0 ? Color.m4702getGreenimpl(jFromToken4) : 0.0f, (14 & 8) != 0 ? Color.m4700getBlueimpl(jFromToken4) : 0.0f);
        ...
        long jM4695copywmQWz5c2 = Color.m4695copywmQWz5c(jFromToken5, (14 & 1) != 0 ? Color.m4699getAlphaimpl(jFromToken5) : 0.38f, (14 & 2) != 0 ? Color.m4703getRedimpl(jFromToken5) : 0.0f, (14 & 4) != 0 ? Color.m4702getGreenimpl(jFromToken5) : 0.0f, (14 & 8) != 0 ? Color.m4700getBlueimpl(jFromToken5) : 0.0f);
        ...
        long jM4695copywmQWz5c3 = Color.m4695copywmQWz5c(jFromToken6, (14 & 1) != 0 ? Color.m4699getAlphaimpl(jFromToken6) : 0.38f, (14 & 2) != 0 ? Color.m4703getRedimpl(jFromToken6) : 0.0f, (14 & 4) != 0 ? Color.m4702getGreenimpl(jFromToken6) : 0.0f, (14 & 8) != 0 ? Color.m4700getBlueimpl(jFromToken6) : 0.0f);
        ...
        SelectableChipColors it2 = new SelectableChipColors(jM4732getTransparent0d7_KjU, jFromToken, jFromToken2, jFromToken3, jM4732getTransparent0d7_KjU2, jM4695copywmQWz5c, jM4695copywmQWz5c2, jM4695copywmQWz5c3, jFromToken7, Color.m4695copywmQWz5c(jFromToken8, (14 & 1) != 0 ? Color.m4699getAlphaimpl(jFromToken8) : 0.12f, (14 & 2) != 0 ? Color.m4703getRedimpl(jFromToken8) : 0.0f, (14 & 4) != 0 ? Color.m4702getGreenimpl(jFromToken8) : 0.0f, (14 & 8) != 0 ? Color.m4700getBlueimpl(jFromToken8) : 0.0f), ColorSchemeKt.fromToken($this$defaultInputChipColors, InputChipTokens.INSTANCE.getSelectedLabelTextColor()), ColorSchemeKt.fromToken($this$defaultInputChipColors, InputChipTokens.INSTANCE.getSelectedLeadingIconColor()), ColorSchemeKt.fromToken($this$defaultInputChipColors, InputChipTokens.INSTANCE.getSelectedTrailingIconColor()), null);
    ...
    public final SelectableChipElevation m2449inputChipElevationaqJV_2Y(float elevation, float pressedElevation, float focusedElevation, float hoveredElevation, float draggedElevation, float disabledElevation, Composer $composer, int $changed, int i) {
        float elevation2;
        ...
        if ((i & 1) != 0) {
            float elevation3 = InputChipTokens.INSTANCE.m3575getContainerElevationD9Ej5fM();
        ...
        float draggedElevation2 = (i & 16) != 0 ? InputChipTokens.INSTANCE.m3577getDraggedContainerElevationD9Ej5fM() : draggedElevation;
    ...
    public final BorderStroke m2447inputChipBorder_7El2pE(boolean enabled, boolean selected, long borderColor, long selectedBorderColor, long disabledBorderColor, long disabledSelectedBorderColor, float borderWidth, float selectedBorderWidth, Composer $composer, int $changed, int i) {
        ...
        if ((i & 16) != 0) {
            ...
            disabledBorderColor2 = Color.m4695copywmQWz5c(value, (14 & 1) != 0 ? Color.m4699getAlphaimpl(value) : 0.12f, (14 & 2) != 0 ? Color.m4703getRedimpl(value) : 0.0f, (14 & 4) != 0 ? Color.m4702getGreenimpl(value) : 0.0f, (14 & 8) != 0 ? Color.m4700getBlueimpl(value) : 0.0f);
        } else {
            disabledBorderColor2 = disabledBorderColor;
        }
        long disabledSelectedBorderColor2 = (i & 32) != 0 ? Color.INSTANCE.m4732getTransparent0d7_KjU() : disabledSelectedBorderColor;
        float borderWidth2 = (i & 64) != 0 ? InputChipTokens.INSTANCE.m3581getUnselectedOutlineWidthD9Ej5fM() : borderWidth;
        float selectedBorderWidth2 = (i & 128) != 0 ? InputChipTokens.INSTANCE.m3579getSelectedOutlineWidthD9Ej5fM() : selectedBorderWidth;
        if (ComposerKt.isTraceInProgress()) {
