...
public final class AnimatedContentTransitionScopeImpl<S> implements AnimatedContentTransitionScope<S> {
    ...
    private final MutableState measuredSize = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntSize.m7668boximpl(IntSize.INSTANCE.m7681getZeroYbymL2g()), null, 2, null);
    ...
    public EnterTransition mo44slideIntoContainermOhB8PU(int towards, FiniteAnimationSpec<IntOffset> animationSpec, final Function1<? super Integer, Integer> initialOffset) {
        if (m63isLeftgWo6LJ4(towards)) {
            return EnterExitTransitionKt.slideInHorizontally(animationSpec, new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideIntoContainer$1
                ...
                public final Integer invoke(int it) {
                    return initialOffset.invoke(Integer.valueOf(((int) (this.m62getCurrentSizeYbymL2g() >> 32)) - IntOffset.m7633getXimpl(this.m61calculateOffsetemnUabE(IntSize.m7671constructorimpl((((long) it) << 32) | (((long) it) & 4294967295L)), this.m62getCurrentSizeYbymL2g()))));
                }
            });
        }
        if (m64isRightgWo6LJ4(towards)) {
            return EnterExitTransitionKt.slideInHorizontally(animationSpec, new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideIntoContainer$2
                ...
                public final Integer invoke(int it) {
                    return initialOffset.invoke(Integer.valueOf((-IntOffset.m7633getXimpl(this.m61calculateOffsetemnUabE(IntSize.m7671constructorimpl((((long) it) << 32) | (((long) it) & 4294967295L)), this.m62getCurrentSizeYbymL2g()))) - it));
                }
            });
        }
        if (AnimatedContentTransitionScope.SlideDirection.m49equalsimpl0(towards, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m58getUpDKzdypw())) {
            return EnterExitTransitionKt.slideInVertically(animationSpec, new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideIntoContainer$3
                ...
                public final Integer invoke(int it) {
                    return initialOffset.invoke(Integer.valueOf(((int) (this.m62getCurrentSizeYbymL2g() & 4294967295L)) - IntOffset.m7634getYimpl(this.m61calculateOffsetemnUabE(IntSize.m7671constructorimpl((((long) it) << 32) | (4294967295L & ((long) it))), this.m62getCurrentSizeYbymL2g()))));
                }
            });
        }
        if (AnimatedContentTransitionScope.SlideDirection.m49equalsimpl0(towards, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m53getDownDKzdypw())) {
            return EnterExitTransitionKt.slideInVertically(animationSpec, new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideIntoContainer$4
                ...
                public final Integer invoke(int it) {
                    return initialOffset.invoke(Integer.valueOf((-IntOffset.m7634getYimpl(this.m61calculateOffsetemnUabE(IntSize.m7671constructorimpl((((long) it) << 32) | (((long) it) & 4294967295L)), this.m62getCurrentSizeYbymL2g()))) - it));
                }
            });
        }
    ...
    private final boolean m63isLeftgWo6LJ4(int i) {
        return AnimatedContentTransitionScope.SlideDirection.m49equalsimpl0(i, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m55getLeftDKzdypw()) || (AnimatedContentTransitionScope.SlideDirection.m49equalsimpl0(i, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m57getStartDKzdypw()) && this.layoutDirection == LayoutDirection.Ltr) || (AnimatedContentTransitionScope.SlideDirection.m49equalsimpl0(i, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m54getEndDKzdypw()) && this.layoutDirection == LayoutDirection.Rtl);
    }

    /* JADX INFO: renamed from: isRight-gWo6LJ4, reason: not valid java name */
    private final boolean m64isRightgWo6LJ4(int i) {
        return AnimatedContentTransitionScope.SlideDirection.m49equalsimpl0(i, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m56getRightDKzdypw()) || (AnimatedContentTransitionScope.SlideDirection.m49equalsimpl0(i, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m57getStartDKzdypw()) && this.layoutDirection == LayoutDirection.Rtl) || (AnimatedContentTransitionScope.SlideDirection.m49equalsimpl0(i, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m54getEndDKzdypw()) && this.layoutDirection == LayoutDirection.Ltr);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: calculateOffset-emnUabE, reason: not valid java name */
    public final long m61calculateOffsetemnUabE(long fullSize, long currentSize) {
        return getContentAlignment().mo4171alignKFBX0sM(fullSize, currentSize, LayoutDirection.Ltr);
    }

    @Override // androidx.compose.animation.AnimatedContentTransitionScope
    /* JADX INFO: renamed from: slideOutOfContainer-mOhB8PU */
    public ExitTransition mo45slideOutOfContainermOhB8PU(int towards, FiniteAnimationSpec<IntOffset> animationSpec, final Function1<? super Integer, Integer> targetOffset) {
        if (m63isLeftgWo6LJ4(towards)) {
            return EnterExitTransitionKt.slideOutHorizontally(animationSpec, new Function1<Integer, Integer>(this) { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideOutOfContainer$1
                ...
                public final Integer invoke(int it) {
                    ...
                    long targetSize = state != null ? ((IntSize) state.getValue()).m7680unboximpl() : IntSize.INSTANCE.m7681getZeroYbymL2g();
                    return targetOffset.invoke(Integer.valueOf((-IntOffset.m7633getXimpl(this.this$0.m61calculateOffsetemnUabE(IntSize.m7671constructorimpl((((long) it) << 32) | (((long) it) & 4294967295L)), targetSize))) - it));
                }
            });
        }
        if (m64isRightgWo6LJ4(towards)) {
            return EnterExitTransitionKt.slideOutHorizontally(animationSpec, new Function1<Integer, Integer>(this) { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideOutOfContainer$2
                ...
                public final Integer invoke(int it) {
                    State state = (State) this.this$0.getTargetSizeMap$animation().get(this.this$0.getTransition$animation().getTargetState());
                    long targetSize = state != null ? ((IntSize) state.getValue()).m7680unboximpl() : IntSize.INSTANCE.m7681getZeroYbymL2g();
                    return targetOffset.invoke(Integer.valueOf((-IntOffset.m7633getXimpl(this.this$0.m61calculateOffsetemnUabE(IntSize.m7671constructorimpl((((long) it) << 32) | (((long) it) & 4294967295L)), targetSize))) + ((int) (targetSize >> 32))));
                }
            });
        }
        if (AnimatedContentTransitionScope.SlideDirection.m49equalsimpl0(towards, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m58getUpDKzdypw())) {
            return EnterExitTransitionKt.slideOutVertically(animationSpec, new Function1<Integer, Integer>(this) { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideOutOfContainer$3
                ...
                public final Integer invoke(int it) {
                    State state = (State) this.this$0.getTargetSizeMap$animation().get(this.this$0.getTransition$animation().getTargetState());
                    long targetSize = state != null ? ((IntSize) state.getValue()).m7680unboximpl() : IntSize.INSTANCE.m7681getZeroYbymL2g();
                    return targetOffset.invoke(Integer.valueOf((-IntOffset.m7634getYimpl(this.this$0.m61calculateOffsetemnUabE(IntSize.m7671constructorimpl((((long) it) << 32) | (((long) it) & 4294967295L)), targetSize))) - it));
                }
            });
        }
        if (AnimatedContentTransitionScope.SlideDirection.m49equalsimpl0(towards, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m53getDownDKzdypw())) {
            return EnterExitTransitionKt.slideOutVertically(animationSpec, new Function1<Integer, Integer>(this) { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideOutOfContainer$4
                ...
                public final Integer invoke(int it) {
                    State state = (State) this.this$0.getTargetSizeMap$animation().get(this.this$0.getTransition$animation().getTargetState());
                    long targetSize = state != null ? ((IntSize) state.getValue()).m7680unboximpl() : IntSize.INSTANCE.m7681getZeroYbymL2g();
                    return targetOffset.invoke(Integer.valueOf((-IntOffset.m7634getYimpl(this.this$0.m61calculateOffsetemnUabE(IntSize.m7671constructorimpl((((long) it) << 32) | (((long) it) & 4294967295L)), targetSize))) + ((int) (targetSize & 4294967295L))));
                }
            });
        }
    ...
    public final long m65getMeasuredSizeYbymL2g$animation() {
        ...
        return ((IntSize) $this$getValue$iv.getValue()).m7680unboximpl();
    }
    ...
    public final void m66setMeasuredSizeozmzZPI$animation(long j) {
        ...
        $this$setValue$iv.setValue(IntSize.m7668boximpl(j));
    }
    ...
    public final long m62getCurrentSizeYbymL2g() {
        ...
        return state != null ? state.getValue().m7680unboximpl() : m65getMeasuredSizeYbymL2g$animation();
    }
    ...
    static final class SizeModifierNode<S> extends LayoutModifierNodeWithPassThroughIntrinsics {
        ...
        public final long m68lastContinuousSizeOrDefaultmzRDjE0(long j) {
            return IntSize.m7674equalsimpl0(this.lastSize, AnimatedContentKt.UnspecifiedSize) ? j : this.lastSize;
        }
        ...
        public MeasureResult mo69measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
            long j2;
            final long jM7671constructorimpl;
            final Placeable placeableMo6141measureBRTryo0 = measurable.mo6141measureBRTryo0(j);
            if (measureScope.isLookingAhead()) {
                int width = placeableMo6141measureBRTryo0.getWidth();
                j2 = 4294967295L;
                jM7671constructorimpl = IntSize.m7671constructorimpl((((long) placeableMo6141measureBRTryo0.getHeight()) & 4294967295L) | (((long) width) << 32));
            } else {
                j2 = 4294967295L;
                if (this.sizeAnimation == null) {
                    ...
                    this.lastSize = IntSize.m7671constructorimpl((((long) placeableMo6141measureBRTryo0.getWidth()) << 32) | (((long) placeableMo6141measureBRTryo0.getHeight()) & 4294967295L));
                } else {
                    final long jM7671constructorimpl2 = IntSize.m7671constructorimpl((((long) placeableMo6141measureBRTryo0.getWidth()) << 32) | (((long) placeableMo6141measureBRTryo0.getHeight()) & 4294967295L));
                    Transition<S>.DeferredAnimation<IntSize, AnimationVector2D> deferredAnimation = this.sizeAnimation;
                    ...
                    State<IntSize> stateAnimate = deferredAnimation.animate(new Function1<Transition.Segment<S>, FiniteAnimationSpec<IntSize>>(this) { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$SizeModifierNode$measure$size$1
                        ...
                        public final FiniteAnimationSpec<IntSize> invoke(Transition.Segment<S> segment) {
                            long initial;
                            FiniteAnimationSpec<IntSize> finiteAnimationSpecMo143createAnimationSpecTemP2vQ;
                            ...
                            if (zAreEqual) {
                                initial = sizeModifierNode.m68lastContinuousSizeOrDefaultmzRDjE0(jM7671constructorimpl2);
                            } else {
                                State<IntSize> state = sizeModifierNode.getScope().getTargetSizeMap$animation().get(segment.getInitialState());
                                initial = state != null ? state.getValue().m7680unboximpl() : IntSize.INSTANCE.m7681getZeroYbymL2g();
                            }
                            State<IntSize> state2 = this.this$0.getScope().getTargetSizeMap$animation().get(segment.getTargetState());
                            long target = state2 != null ? state2.getValue().m7680unboximpl() : IntSize.INSTANCE.m7681getZeroYbymL2g();
                            SizeTransform value = this.this$0.getSizeTransform().getValue();
                            return (value == null || (finiteAnimationSpecMo143createAnimationSpecTemP2vQ = value.mo143createAnimationSpecTemP2vQ(initial, target)) == null) ? AnimationSpecKt.spring$default(0.0f, 400.0f, null, 5, null) : finiteAnimationSpecMo143createAnimationSpecTemP2vQ;
                        }
                        ...
                        public /* bridge */ /* synthetic */ IntSize invoke(Object obj) {
                            return IntSize.m7668boximpl(m70invokeYEO4UFw(obj));
                        }
                        ...
                        public final long m70invokeYEO4UFw(S s) {
                            ...
                            AnimatedContentTransitionScopeImpl.SizeModifierNode<S> sizeModifierNode = this.this$0;
                            if (zAreEqual) {
                                return sizeModifierNode.m68lastContinuousSizeOrDefaultmzRDjE0(jM7671constructorimpl2);
                            }
                            State<IntSize> state = sizeModifierNode.getScope().getTargetSizeMap$animation().get(s);
                            return state != null ? state.getValue().m7680unboximpl() : IntSize.INSTANCE.m7681getZeroYbymL2g();
                        }
                    });
                    this.scope.setAnimatedSize$animation(stateAnimate);
                    long jM7680unboximpl = stateAnimate.getValue().m7680unboximpl();
                    this.lastSize = stateAnimate.getValue().m7680unboximpl();
                    jM7671constructorimpl = jM7680unboximpl;
                }
            }
            long j3 = jM7671constructorimpl;
            return MeasureScope.layout$default(measureScope, (int) (j3 >> 32), (int) (j3 & j2), null, new Function1<Placeable.PlacementScope, Unit>(this) { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$SizeModifierNode$measure$1
                ...
                public final void invoke2(Placeable.PlacementScope $this$layout) {
                    ...
                    int width$iv = placeableMo6141measureBRTryo0.getWidth();
                    int height$iv = placeableMo6141measureBRTryo0.getHeight();
                    long offset = contentAlignment.mo4171alignKFBX0sM(IntSize.m7671constructorimpl((((long) width$iv) << 32) | (((long) height$iv) & 4294967295L)), jM7671constructorimpl, LayoutDirection.Ltr);
                    Placeable.PlacementScope.m6207place70tqf50$default($this$layout, placeableMo6141measureBRTryo0, offset, 0.0f, 2, null);
                }
            }, 4, null);
        }
    }
