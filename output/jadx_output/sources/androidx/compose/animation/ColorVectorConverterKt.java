        ...
        public final TwoWayConverter<Color, AnimationVector4D> invoke(final ColorSpace colorSpace) {
            return VectorConvertersKt.TwoWayConverter(new Function1<Color, AnimationVector4D>() { // from class: androidx.compose.animation.ColorVectorConverterKt$ColorToVector$1.1
                ...
                public /* bridge */ /* synthetic */ AnimationVector4D invoke(Color color) {
                    return m82invoke8_81llA(color.m4707unboximpl());
                }

                /* JADX INFO: renamed from: invoke-8_81llA, reason: not valid java name */
                public final AnimationVector4D m82invoke8_81llA(long j) {
                    long jM4694convertvNxB06k = Color.m4694convertvNxB06k(j, ColorSpaces.INSTANCE.getOklab());
                    float l = Color.m4703getRedimpl(jM4694convertvNxB06k);
                    float a = Color.m4702getGreenimpl(jM4694convertvNxB06k);
                    float b = Color.m4700getBlueimpl(jM4694convertvNxB06k);
                    float alpha = Color.m4699getAlphaimpl(jM4694convertvNxB06k);
                ...
                public /* bridge */ /* synthetic */ Color invoke(AnimationVector4D animationVector4D) {
                    return Color.m4687boximpl(m83invokevNxB06k(animationVector4D));
                }
                ...
                public final long m83invokevNxB06k(AnimationVector4D vector) {
                    ...
                    return Color.m4694convertvNxB06k(ColorKt.Color($this$fastCoerceAtLeast$iv$iv, $this$fastCoerceAtLeast$iv$iv2, $this$fastCoerceAtLeast$iv$iv3, $this$fastCoerceAtLeast$iv$iv4, ColorSpaces.INSTANCE.getOklab()), colorSpace);
                }
            });
        }
    };
