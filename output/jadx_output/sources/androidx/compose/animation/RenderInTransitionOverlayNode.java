...
public final class RenderInTransitionOverlayNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, ModifierLocalModifierNode {
    ...
    private long positionInOverlay = Offset.INSTANCE.m4468getZeroF1C5BW0();
    ...
    public final void m115setPositionInOverlayk4lQ0M(long j) {
        if (!Offset.m4449equalsimpl0(j, this.positionInOverlay)) {
            Function0<Unit> invalidateOverlay = this.sharedScope.getInvalidateOverlay();
            if (invalidateOverlay != null) {
                invalidateOverlay.invoke();
            }
            ...
            public final void invoke2(Placeable.PlacementScope $this$layout) {
                if (!$this$measure_u2d3p2s80s.isLookingAhead()) {
                    if (!this.getRenderInOverlay().invoke().booleanValue()) {
                        ...
                        renderInTransitionOverlayNode.m115setPositionInOverlayk4lQ0M(renderInTransitionOverlayNode.getSharedScope().getRoot$animation().mo6150localPositionOfR5De75A(DelegatableNodeKt.requireLayoutCoordinates(renderInTransitionOverlayNode), Offset.INSTANCE.m4468getZeroF1C5BW0()));
                    }
                }
    ...
    public void draw(final ContentDrawScope $this$draw) {
        ...
        DrawScope.m5269recordJVtK1S4$default($this$draw, layer, 0L, new Function1<DrawScope, Unit>() { // from class: androidx.compose.animation.RenderInTransitionOverlayNode.draw.1
            {
                super(1);
            }
