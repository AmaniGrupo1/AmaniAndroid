...
public interface SharedTransitionScope extends LookaheadScope {
    ...
    public interface PlaceholderSize {
        ...
        long mo123calculateSizeJyjRU_E(long contentSize, long animatedSize);
    ...
    default Modifier skipToLookaheadPosition(Modifier $this$skipToLookaheadPosition, final Function0<Boolean> function0) {
        return LookaheadScopeKt.approachLayout($this$skipToLookaheadPosition, new Function1<IntSize, Boolean>() { // from class: androidx.compose.animation.SharedTransitionScope.skipToLookaheadPosition.2
            ...
            public /* bridge */ /* synthetic */ Boolean invoke(IntSize intSize) {
                return m126invokeozmzZPI(intSize.m7680unboximpl());
            }
            ...
            public /* bridge */ /* synthetic */ MeasureResult invoke(ApproachMeasureScope approachMeasureScope, Measurable measurable, Constraints constraints) {
                return m127invoke3p2s80s(approachMeasureScope, measurable, constraints.getValue());
            }

            /* JADX INFO: renamed from: invoke-3p2s80s, reason: not valid java name */
            public final MeasureResult m127invoke3p2s80s(ApproachMeasureScope $this$approachLayout, Measurable m, long j) {
                final Placeable $this$invoke_3p2s80s_u24lambda_u240 = m.mo6141measureBRTryo0(j);
                    ...
                    public final void invoke2(Placeable.PlacementScope $this$layout) {
                        if (function02.invoke().booleanValue()) {
                            ...
                            if (it != null) {
                                ...
                                long target = LookaheadScope.m6171localLookaheadPositionOfauaQtc$default(sharedTransitionScope2, sharedTransitionScope2.getLookaheadScopeCoordinates($this$layout), it, 0L, false, 6, null);
                                long actual = LayoutCoordinates.m6148localPositionOfS_NoaFU$default(sharedTransitionScope2.getLookaheadScopeCoordinates($this$layout), it, 0L, false, 6, null);
                                long delta = Offset.m4456minusMKHz9U(target, actual);
                                long offset = Offset.m4456minusMKHz9U(it.mo6150localPositionOfR5De75A(sharedTransitionScope2.getLookaheadScopeCoordinates($this$layout), delta), LayoutCoordinates.m6148localPositionOfS_NoaFU$default(it, sharedTransitionScope2.getLookaheadScopeCoordinates($this$layout), 0L, false, 6, null));
                                Placeable.PlacementScope.m6207place70tqf50$default($this$layout, placeable, IntOffsetKt.m7650roundk4lQ0M(offset), 0.0f, 2, null);
                                return;
                            }
    ...
    default SharedContentState rememberSharedContentState(Object key, Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(800730162, $changed, -1, "androidx.compose.animation.SharedTransitionScope.rememberSharedContentState (SharedTransitionScope.kt:796)");
        }
    ...
    default SharedContentState rememberSharedContentState(Object key, SharedContentConfig config, Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-148945892, $changed, -1, "androidx.compose.animation.SharedTransitionScope.rememberSharedContentState (SharedTransitionScope.kt:818)");
        }
    ...
    public static final class SharedContentState {
        ...
        public final void m125prepareTransitionWithInitialVelocityTH1AsA0(long initialVelocity) {
            ...
            if ($this$prepareTransitionWithInitialVelocity_TH1AsA0_u24lambda_u240_u240.isEnabled(this)) {
                it.getSharedElement().m120updateExitVelocityTH1AsA0$animation(initialVelocity);
            }
        }
    ...
    public interface SharedContentConfig {
        ...
        default Rect m124alternativeTargetBoundsInTransitionScopeAfterRemovalcSwnlzA(SharedContentState $this$alternativeTargetBoundsInTransitionScopeAfterRemoval_u2dcSwnlzA, Rect targetBoundsBeforeRemoval, long j) {
            return null;
        }
    }
