...
public final class SharedTransitionScopeKt {
    ...
    public static final void SharedTransitionLayout(final Modifier modifier, final Function3<? super SharedTransitionScope, ? super Composer, ? super Integer, Unit> function3, Composer $composer, final int $changed, final int i) {
        ...
        ComposerKt.sourceInformation($composer2, "C(SharedTransitionLayout)P(1)121@5979L279,121@5957L301:SharedTransitionScope.kt#xbi5r1");
        int $dirty = $changed;
        int i2 = i & 1;
        if (i2 != 0) {
            $dirty |= 6;
        ...
        if (!$composer2.shouldExecute(($dirty & 19) != 18, $dirty & 1)) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(646379026, $dirty, -1, "androidx.compose.animation.SharedTransitionLayout (SharedTransitionScope.kt:120)");
            }
            SharedTransitionScope(ComposableLambdaKt.rememberComposableLambda(1948801580, true, new Function4<SharedTransitionScope, Modifier, Composer, Integer, Unit>() { // from class: androidx.compose.animation.SharedTransitionScopeKt.SharedTransitionLayout.1
                ...
                public final void invoke(SharedTransitionScope $this$SharedTransitionScope, Modifier sharedTransitionModifier, Composer $composer3, int $changed2) {
                    ...
                    ComposerKt.sourceInformation($composer3, "C124@6194L58:SharedTransitionScope.kt#xbi5r1");
                    int $dirty2 = $changed2;
                    if (($changed2 & 6) == 0) {
                    ...
                    if ($composer3.shouldExecute(($dirty2 & 147) != 146, $dirty2 & 1)) {
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventStart(1948801580, $dirty2, -1, "androidx.compose.animation.SharedTransitionLayout.<anonymous> (SharedTransitionScope.kt:124)");
                        }
                        ...
                        int i4 = ((0 >> 6) & 112) | 6;
                        ComposerKt.sourceInformationMarkerStart($composer3, 158724660, "C124@6241L9:SharedTransitionScope.kt#xbi5r1");
    ...
    public static final void SharedTransitionScope(final Function4<? super SharedTransitionScope, ? super Modifier, ? super Composer, ? super Integer, Unit> function4, Composer $composer, final int $changed) {
        ...
        ComposerKt.sourceInformation($composer2, "C(SharedTransitionScope)143@7122L231,143@7107L246:SharedTransitionScope.kt#xbi5r1");
        int $dirty = $changed;
        if (($changed & 6) == 0) {
        ...
        if (!$composer2.shouldExecute(($dirty & 3) != 2, $dirty & 1)) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(1908320054, $dirty, -1, "androidx.compose.animation.SharedTransitionScope (SharedTransitionScope.kt:142)");
            }
            LookaheadScopeKt.LookaheadScope(ComposableLambdaKt.rememberComposableLambda(2062852661, true, new Function3<LookaheadScope, Composer, Integer, Unit>() { // from class: androidx.compose.animation.SharedTransitionScopeKt.SharedTransitionScope.1
                ...
                public final void invoke(LookaheadScope $this$LookaheadScope, Composer $composer3, int $changed2) {
                    ComposerKt.sourceInformation($composer3, "C144@7153L24,145@7204L60,146@7285L62:SharedTransitionScope.kt#xbi5r1");
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventStart(2062852661, $changed2, -1, "androidx.compose.animation.SharedTransitionScope.<anonymous> (SharedTransitionScope.kt:144)");
                    }
