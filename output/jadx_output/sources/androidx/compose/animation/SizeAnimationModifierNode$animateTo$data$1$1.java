    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                IntSize intSizeM7668boximpl = IntSize.m7668boximpl(this.f1$$v$c$androidxcomposeuiunitIntSize$targetSize$0);
                AnimationSpec<IntSize> animationSpec = this.this$0.getAnimationSpec();
                this.label = 1;
                Object objAnimateTo = anim.animateTo(intSizeM7668boximpl, (4 & 2) != 0 ? anim.defaultSpringSpec : animationSpec, (4 & 4) != 0 ? anim.getVelocity() : null, (4 & 8) != 0 ? null : null, this);
        ...
        if (result.getEndReason() == AnimationEndReason.Finished && (listener = this.this$0.getListener()) != 0) {
            listener.invoke(IntSize.m7668boximpl(this.$this_apply.m141getStartSizeYbymL2g()), result.getEndState().getValue());
        }
