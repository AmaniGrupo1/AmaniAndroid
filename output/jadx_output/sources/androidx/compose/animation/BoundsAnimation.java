...
public final class BoundsAnimation {
    ...
    public final Rect getValue() {
        ...
        long offset = this.momentumOffset.invoke().m4462unboximpl();
        if (!Offset.m4449equalsimpl0(offset, Offset.INSTANCE.m4468getZeroF1C5BW0())) {
            return it.m4489translatek4lQ0M(offset);
        }
        return it;
    }
