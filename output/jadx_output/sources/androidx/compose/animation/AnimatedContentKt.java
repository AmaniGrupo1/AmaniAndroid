...
public final class AnimatedContentKt {
    private static final long UnspecifiedSize = IntSize.m7671constructorimpl((((long) Integer.MIN_VALUE) << 32) | (((long) Integer.MIN_VALUE) & 4294967295L));
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            ...
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.animation.AnimatedContentKt.AnimatedContent.3
                ...
                public final void invoke(Composer composer, int i10) throws Throwable {
                    AnimatedContentKt.AnimatedContent(s, modifier3, function15, contentAlignment2, label2, function16, function4, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
        ...
        if ((i & 2) != 0) {
            function2 = new Function2<IntSize, IntSize, SpringSpec<IntSize>>() { // from class: androidx.compose.animation.AnimatedContentKt.SizeTransform.1
                ...
                public /* bridge */ /* synthetic */ SpringSpec<IntSize> invoke(IntSize intSize, IntSize intSize2) {
                    return m40invokeTemP2vQ(intSize.m7680unboximpl(), intSize2.m7680unboximpl());
                }
                ...
                public final SpringSpec<IntSize> m40invokeTemP2vQ(long j, long j2) {
                    return AnimationSpecKt.spring$default(0.0f, 400.0f, IntSize.m7668boximpl(VisibilityThresholdsKt.getVisibilityThreshold(IntSize.INSTANCE)), 1, null);
                }
            };
        }
    ...
    public static final <S> void AnimatedContent(final Transition<S> transition, Modifier modifier, Function1<? super AnimatedContentTransitionScope<S>, ContentTransform> function1, Alignment contentAlignment, Function1<? super S, ? extends Object> function12, final Function4<? super AnimatedContentScope, ? super S, ? super Composer, ? super Integer, Unit> function4, Composer $composer, final int $changed, final int i) throws Throwable {
        ...
        ComposerKt.sourceInformation($composer2, "C(AnimatedContent)P(3,4,1,2)765@38134L226,771@38459L6,774@38592L7,776@38628L114,780@38830L51,781@38903L69,867@43438L58,868@43530L45,874@43785L52,869@43580L264:AnimatedContent.kt#xbi5r1");
        int $dirty = $changed;
        if (($changed & 6) == 0) {
        ...
        if ($composer2.shouldExecute((74899 & $dirty2) != 74898, $dirty2 & 1)) {
            ...
            if (contentMap.containsKey(transition.getTargetState()) && contentMap.containsKey(transition.getCurrentState())) {
                $composer2.startReplaceGroup(1925931827);
                    ...
                    contentMap.set(item$iv, ComposableLambdaKt.rememberComposableLambda(-23915175, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.animation.AnimatedContentKt$AnimatedContent$6$1
                        ...
                        */
                        public final void invoke(Composer $composer3, int $changed2) {
                            ...
                            boolean invalid$iv4;
                            Object it$iv6;
                            ComposerKt.sourceInformation($composer3, "C818@40885L38,822@41099L323,829@41455L125,840@42023L348,836@41832L25,847@42511L233,852@42764L616,834@41763L1617:AnimatedContent.kt#xbi5r1");
                            if (!$composer3.shouldExecute(($changed2 & 3) != 2, $changed2 & 1)) {
                                $composer3.skipToGroupEnd();
                                return;
                            }
                            if (ComposerKt.isTraceInProgress()) {
                                ComposerKt.traceEventStart(-23915175, $changed2, -1, "androidx.compose.animation.AnimatedContent.<anonymous>.<anonymous> (AnimatedContent.kt:818)");
                            }
                            ComposerKt.sourceInformationMarkerStart($composer3, -1507645505, "CC(remember):AnimatedContent.kt#9igjgp");
                            Function1<AnimatedContentTransitionScope<S>, ContentTransform> function110 = function19;
                            Object obj = rootScope;
                            Object it$iv7 = $composer3.rememberedValue();
                            if (it$iv7 == Composer.INSTANCE.getEmpty()) {
                                ContentTransform value$iv7 = function110.invoke(obj);
                                $composer3.updateRememberedValue(value$iv7);
                                it$iv7 = value$iv7;
                            }
                            final ContentTransform specOnEnter = (ContentTransform) it$iv7;
                            ComposerKt.sourceInformationMarkerEnd($composer3);
                            boolean zAreEqual = Intrinsics.areEqual(transition.getSegment().getTargetState(), item$iv);
                            ComposerKt.sourceInformationMarkerStart($composer3, -1507638372, "CC(remember):AnimatedContent.kt#9igjgp");
                            boolean invalid$iv5 = $composer3.changed(zAreEqual);
                            Transition<S> transition3 = transition;
                            S s = item$iv;
                            Function1<AnimatedContentTransitionScope<S>, ContentTransform> function111 = function19;
                            Object obj2 = rootScope;
                            ...
                            if (invalid$iv5 || it$iv8 == Composer.INSTANCE.getEmpty()) {
                                if (Intrinsics.areEqual(transition3.getSegment().getTargetState(), s)) {
                                    value$iv6 = ExitTransition.INSTANCE.getNone();
                                } else {
                                    value$iv6 = function111.invoke(obj2).getInitialContentExit();
                                }
                                $composer3.updateRememberedValue(value$iv6);
                                it$iv8 = value$iv6;
                            }
                            final ExitTransition exit = (ExitTransition) it$iv8;
                            ComposerKt.sourceInformationMarkerEnd($composer3);
                            ComposerKt.sourceInformationMarkerStart($composer3, -1507627178, "CC(remember):AnimatedContent.kt#9igjgp");
                            S s2 = item$iv;
                            Transition<S> transition4 = transition;
                            Object it$iv9 = $composer3.rememberedValue();
                            if (it$iv9 == Composer.INSTANCE.getEmpty()) {
                                Object value$iv8 = new AnimatedContentTransitionScopeImpl.ChildData(Intrinsics.areEqual(s2, transition4.getTargetState()));
                                $composer3.updateRememberedValue(value$iv8);
                                it$iv9 = value$iv8;
                            }
                            AnimatedContentTransitionScopeImpl.ChildData childData = (AnimatedContentTransitionScopeImpl.ChildData) it$iv9;
                            ComposerKt.sourceInformationMarkerEnd($composer3);
                            EnterTransition targetContentEnter = specOnEnter.getTargetContentEnter();
                            Modifier.Companion companion = Modifier.INSTANCE;
                            ComposerKt.sourceInformationMarkerStart($composer3, -1507608779, "CC(remember):AnimatedContent.kt#9igjgp");
                            boolean invalid$iv6 = $composer3.changedInstance(specOnEnter);
                            Object it$iv10 = $composer3.rememberedValue();
                            if (invalid$iv6 || it$iv10 == Composer.INSTANCE.getEmpty()) {
                                Object value$iv9 = (Function3) new Function3<MeasureScope, Measurable, Constraints, MeasureResult>() { // from class: androidx.compose.animation.AnimatedContentKt$AnimatedContent$6$1$1$1
                                    {
                                        super(3);
                                    }
                                    ...
                                    public final MeasureResult m39invoke3p2s80s(MeasureScope $this$layout, Measurable measurable, long j) {
                                        ...
                                        return MeasureScope.layout$default($this$layout, width, height, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.AnimatedContentKt$AnimatedContent$6$1$1$1.1
                                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                            {
                                                super(1);
                                            }
                                            ...
                                            public final void invoke2(Placeable.PlacementScope $this$layout2) {
                                                $this$layout2.place(placeable, 0, 0, contentTransform.getTargetContentZIndex());
                                            }
                                        }, 4, null);
                                    }
                                };
                            ...
                            ComposerKt.sourceInformationMarkerEnd($composer3);
                            Modifier modifierLayout = LayoutModifierKt.layout(companion, (Function3) it$iv10);
                            ...
                            ComposerKt.sourceInformationMarkerStart($composer3, -1507615214, "CC(remember):AnimatedContent.kt#9igjgp");
                            boolean invalid$iv7 = $composer3.changedInstance(item$iv);
                            final S s3 = item$iv;
                            ...
                            if (!invalid$iv7) {
                                ...
                                Function1 function112 = (Function1) it$iv11;
                                ComposerKt.sourceInformationMarkerEnd($composer3);
                                ComposerKt.sourceInformationMarkerStart($composer3, -1507593278, "CC(remember):AnimatedContent.kt#9igjgp");
                                invalid$iv4 = $composer3.changed(exit);
                                it$iv6 = $composer3.rememberedValue();
                                if (!invalid$iv4 || it$iv6 == Composer.INSTANCE.getEmpty()) {
                                    Object value$iv10 = (Function2) new Function2<EnterExitState, EnterExitState, Boolean>() { // from class: androidx.compose.animation.AnimatedContentKt$AnimatedContent$6$1$4$1
                                        {
                                            super(2);
                                        }

                                        @Override // kotlin.jvm.functions.Function2
                                        public final Boolean invoke(EnterExitState currentState, EnterExitState targetState) {
                                            return Boolean.valueOf(currentState == EnterExitState.PostExit && targetState == EnterExitState.PostExit && !exit.getData().getHold());
                                        }
                                    };
                                ...
                                final S s4 = item$iv;
                                final AnimatedContentTransitionScopeImpl<S> animatedContentTransitionScopeImpl = rootScope;
                                final Function4<AnimatedContentScope, S, Composer, Integer, Unit> function44 = function43;
                                AnimatedVisibilityKt.AnimatedEnterExitImpl(transition2, function112, modifierThen, targetContentEnter, exit, function2, null, ComposableLambdaKt.rememberComposableLambda(-143346359, true, new Function3<AnimatedVisibilityScope, Composer, Integer, Unit>() { // from class: androidx.compose.animation.AnimatedContentKt$AnimatedContent$6$1.5
                                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                    /* JADX WARN: Multi-variable type inference failed */
                                    {
                                        super(3);
                                    ...
                                    /*  JADX ERROR: JadxRuntimeException in pass: FinishTypeInference
                                        jadx.core.utils.exceptions.JadxRuntimeException: Code variable not set in r4v28 boolean
                                ...
                                }, $composer3, 54), $composer3, 12582912, 64);
                                if (!ComposerKt.isTraceInProgress()) {
                                    ComposerKt.traceEventEnd();
                                    return;
                                }
                            ...
                            transition2 = transition5;
                            Object value$iv11 = (Function1) new Function1<S, Boolean>() { // from class: androidx.compose.animation.AnimatedContentKt$AnimatedContent$6$1$3$1
                                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                {
                                    super(1);
                                }
                                ...
                                public final Boolean invoke(S s5) {
                                    return Boolean.valueOf(Intrinsics.areEqual(s5, s3));
                                }
                            };
                            $composer3.updateRememberedValue(value$iv11);
                            it$iv11 = value$iv11;
                            Function1 function1122 = (Function1) it$iv11;
                            ComposerKt.sourceInformationMarkerEnd($composer3);
                            ComposerKt.sourceInformationMarkerStart($composer3, -1507593278, "CC(remember):AnimatedContent.kt#9igjgp");
                            invalid$iv4 = $composer3.changed(exit);
                            it$iv6 = $composer3.rememberedValue();
                            if (!invalid$iv4) {
                                Object value$iv102 = (Function2) new Function2<EnterExitState, EnterExitState, Boolean>() { // from class: androidx.compose.animation.AnimatedContentKt$AnimatedContent$6$1$4$1
                                    {
                                        super(2);
                                    }
                            ...
                            final Function4<? super AnimatedContentScope, ? super S, ? super Composer, ? super Integer, Unit> function442 = function43;
                            AnimatedVisibilityKt.AnimatedEnterExitImpl(transition2, function1122, modifierThen, targetContentEnter, exit, function22, null, ComposableLambdaKt.rememberComposableLambda(-143346359, true, new Function3<AnimatedVisibilityScope, Composer, Integer, Unit>() { // from class: androidx.compose.animation.AnimatedContentKt$AnimatedContent$6$1.5
                                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                /* JADX WARN: Multi-variable type inference failed */
                                {
                                    super(3);
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.animation.AnimatedContentKt.AnimatedContent.9
                ...
                public final void invoke(Composer composer, int i8) throws Throwable {
                    AnimatedContentKt.AnimatedContent(transition, modifier3, function15, contentAlignment3, function16, function4, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
