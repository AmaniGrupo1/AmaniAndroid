...
final class EnterExitTransitionModifierNode extends LayoutModifierNodeWithPassThroughIntrinsics {
    ...
    private final void m106setLookaheadConstraintsBRTryo0(long j) {
    ...
    public final long m107sizeByStateUzc_VyU(EnterExitState targetState, long fullSize) {
        ...
        switch (WhenMappings.$EnumSwitchMapping$0[targetState.ordinal()]) {
            ...
            case 2:
                ChangeSize changeSize = this.enter.getData().getChangeSize();
                return (changeSize == null || (size = changeSize.getSize()) == null) ? fullSize : size.invoke(IntSize.m7668boximpl(fullSize)).m7680unboximpl();
            case 3:
                ChangeSize changeSize2 = this.exit.getData().getChangeSize();
                return (changeSize2 == null || (size2 = changeSize2.getSize()) == null) ? fullSize : size2.invoke(IntSize.m7668boximpl(fullSize)).m7680unboximpl();
            default:
    ...
    public final long m109targetOffsetByStateoFUgxo0(EnterExitState targetState, long fullSize) {
        if (this.currentAlignment != null && getAlignment() != null && !Intrinsics.areEqual(this.currentAlignment, getAlignment())) {
            switch (WhenMappings.$EnumSwitchMapping$0[targetState.ordinal()]) {
                case 1:
                    return IntOffset.INSTANCE.m7644getZeronOccac();
                case 2:
                    return IntOffset.INSTANCE.m7644getZeronOccac();
                case 3:
                    ...
                    long endSize = it.getSize().invoke(IntSize.m7668boximpl(fullSize)).m7680unboximpl();
                    Alignment alignment = getAlignment();
                    Intrinsics.checkNotNull(alignment);
                    long targetOffset = alignment.mo4171alignKFBX0sM(fullSize, endSize, LayoutDirection.Ltr);
                    Alignment alignment2 = this.currentAlignment;
                    Intrinsics.checkNotNull(alignment2);
                    long currentOffset = alignment2.mo4171alignKFBX0sM(fullSize, endSize, LayoutDirection.Ltr);
                    return IntOffset.m7636minusqkQi6aY(targetOffset, currentOffset);
                default:
                    throw new NoWhenBranchMatchedException();
            }
        }
    ...
    public MeasureResult mo69measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long j) {
        ...
        if ($this$measure_u2d3p2s80s.isLookingAhead()) {
            ...
            long measuredSize = IntSize.m7671constructorimpl((((long) height$iv) & 4294967295L) | (((long) width$iv) << 32));
            this.lookaheadSize = measuredSize;
            m106setLookaheadConstraintsBRTryo0(j);
        ...
        final Placeable placeable2 = measurable.mo6141measureBRTryo0(j);
        int width$iv2 = placeable2.getWidth();
        int height$iv2 = placeable2.getHeight();
        long measuredSize2 = IntSize.m7671constructorimpl((((long) width$iv2) << 32) | (((long) height$iv2) & 4294967295L));
        final long target = AnimationModifierKt.m73isValidozmzZPI(this.lookaheadSize) ? this.lookaheadSize : measuredSize2;
        ...
        State<IntSize> stateAnimate3 = deferredAnimation != null ? deferredAnimation.animate(this.sizeTransitionSpec, new Function1<EnterExitState, IntSize>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$animSize$1
            ...
            public /* bridge */ /* synthetic */ IntSize invoke(EnterExitState enterExitState) {
                return IntSize.m7668boximpl(m110invokeYEO4UFw(enterExitState));
            }

            /* JADX INFO: renamed from: invoke-YEO4UFw, reason: not valid java name */
            public final long m110invokeYEO4UFw(EnterExitState it) {
                return this.this$0.m107sizeByStateUzc_VyU(it, target);
            }
        }) : null;
        long currentSize = ConstraintsKt.m7472constrain4WqzIAM(j, stateAnimate3 != null ? stateAnimate3.getValue().m7680unboximpl() : measuredSize2);
        ...
        final long offsetDelta = (deferredAnimation2 == null || (stateAnimate2 = deferredAnimation2.animate(new Function1<Transition.Segment<EnterExitState>, FiniteAnimationSpec<IntOffset>>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$offsetDelta$1
            ...
            public /* bridge */ /* synthetic */ IntOffset invoke(EnterExitState enterExitState) {
                return IntOffset.m7624boximpl(m111invokeBjo55l4(enterExitState));
            }

            /* JADX INFO: renamed from: invoke-Bjo55l4, reason: not valid java name */
            public final long m111invokeBjo55l4(EnterExitState it) {
                return this.this$0.m109targetOffsetByStateoFUgxo0(it, target);
            }
        })) == null) ? IntOffset.INSTANCE.m7644getZeronOccac() : stateAnimate2.getValue().m7642unboximpl();
        ...
        long slideOffset = (deferredAnimation3 == null || (stateAnimate = deferredAnimation3.animate(this.slideSpec, new Function1<EnterExitState, IntOffset>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$slideOffset$1
            ...
            @Override // kotlin.jvm.functions.Function1
            public /* bridge */ /* synthetic */ IntOffset invoke(EnterExitState enterExitState) {
                return IntOffset.m7624boximpl(m112invokeBjo55l4(enterExitState));
            }

            /* JADX INFO: renamed from: invoke-Bjo55l4, reason: not valid java name */
            public final long m112invokeBjo55l4(EnterExitState it) {
                return this.this$0.m108slideTargetValueByStateoFUgxo0(it, target);
            }
        })) == null) ? IntOffset.INSTANCE.m7644getZeronOccac() : stateAnimate.getValue().m7642unboximpl();
        Alignment alignment2 = this.currentAlignment;
        final long offset = IntOffset.m7637plusqkQi6aY(alignment2 != null ? alignment2.mo4171alignKFBX0sM(target, currentSize, LayoutDirection.Ltr) : IntOffset.INSTANCE.m7644getZeronOccac(), slideOffset);
        return MeasureScope.layout$default($this$measure_u2d3p2s80s, (int) (currentSize >> 32), (int) (currentSize & 4294967295L), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$2
            ...
            /* JADX INFO: renamed from: invoke, reason: avoid collision after fix types in other method */
            public final void invoke2(Placeable.PlacementScope $this$layout) {
                $this$layout.placeWithLayer(placeable2, IntOffset.m7633getXimpl(offsetDelta) + IntOffset.m7633getXimpl(offset), IntOffset.m7634getYimpl(offsetDelta) + IntOffset.m7634getYimpl(offset), 0.0f, function1Init);
            }
        }, 4, null);
    }
    ...
    public final long m108slideTargetValueByStateoFUgxo0(EnterExitState targetState, long fullSize) {
        Function1<IntSize, IntOffset> slideOffset;
        Function1<IntSize, IntOffset> slideOffset2;
        Slide slide = this.enter.getData().getSlide();
        long preEnter = (slide == null || (slideOffset2 = slide.getSlideOffset()) == null) ? IntOffset.INSTANCE.m7644getZeronOccac() : slideOffset2.invoke(IntSize.m7668boximpl(fullSize)).m7642unboximpl();
        Slide slide2 = this.exit.getData().getSlide();
        long postExit = (slide2 == null || (slideOffset = slide2.getSlideOffset()) == null) ? IntOffset.INSTANCE.m7644getZeronOccac() : slideOffset.invoke(IntSize.m7668boximpl(fullSize)).m7642unboximpl();
        switch (WhenMappings.$EnumSwitchMapping$0[targetState.ordinal()]) {
            case 1:
                return IntOffset.INSTANCE.m7644getZeronOccac();
            case 2:
