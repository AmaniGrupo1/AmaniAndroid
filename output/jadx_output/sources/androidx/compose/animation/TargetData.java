...
public final class TargetData {
    ...
    private TargetData(long size, long initialMfrOffset, long targetStructuralOffset) {
        this.size = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Size.m4509boximpl(size), null, 2, null);
        this.initialMfrOffset = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m4441boximpl(initialMfrOffset), null, 2, null);
        this.targetStructuralOffset = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m4441boximpl(targetStructuralOffset), null, 2, null);
        this.currentMfrOffset = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m4441boximpl(initialMfrOffset), null, 2, null);
    }
