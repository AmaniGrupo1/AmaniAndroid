...
public final /* data */ class Scale {
    ...
    public final Scale m118copybnNdC4k(float scale, long transformOrigin, FiniteAnimationSpec<Float> animationSpec) {
    ...
    public boolean equals(Object other) {
        ...
        return Float.compare(this.scale, scale.scale) == 0 && TransformOrigin.m5104equalsimpl0(this.transformOrigin, scale.transformOrigin) && Intrinsics.areEqual(this.animationSpec, scale.animationSpec);
    }

    public int hashCode() {
        return (((Float.hashCode(this.scale) * 31) + TransformOrigin.m5107hashCodeimpl(this.transformOrigin)) * 31) + this.animationSpec.hashCode();
    }

    public String toString() {
        return "Scale(scale=" + this.scale + ", transformOrigin=" + ((Object) TransformOrigin.m5108toStringimpl(this.transformOrigin)) + ", animationSpec=" + this.animationSpec + ')';
    }
