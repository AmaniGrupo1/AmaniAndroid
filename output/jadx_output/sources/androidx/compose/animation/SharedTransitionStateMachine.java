...
public final class SharedTransitionStateMachine {
    ...
    public static abstract class State {
        ...
        public State mo36configureActiveMatch38uP1EE(SharedElement sharedElement, BoundsProvider targetBoundsProvider, long lookaheadSize, long topLeft, long structuralOffset) {
    ...
    public final void m129configureActiveMatchL7TYDSY(long lookaheadSize, long topLeft, long structuralOffset) {
        State state = getState();
        ...
        setState(state.mo36configureActiveMatch38uP1EE(sharedElement, boundsProvider, lookaheadSize, topLeft, structuralOffset));
    }
}
