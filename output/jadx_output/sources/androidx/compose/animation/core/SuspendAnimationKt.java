...
public final class SuspendAnimationKt {
    ...
    */
    public static final <T, V extends AnimationVector> Object animate(AnimationState<T, V> animationState, final Animation<T, V> animation, long j, final Function1<? super AnimationScope<T, V>, Unit> function1, Continuation<? super Unit> continuation) {
        ...
        final AnimationState<T, V> animationState3;
        ...
        Animation<T, V> animation3;
        AnimationState<T, V> animationState4;
        ?? r4;
        T t;
        final Animation<T, V> animation4;
        final Function1<? super AnimationScope<T, V>, Unit> function14;
        ...
        final Ref.ObjectRef objectRef = anonymousClass42.label;
        try {
            switch (objectRef) {
                case 0:
                    ...
                    try {
                        if (j == Long.MIN_VALUE) {
                            ...
                            try {
                                Function1 function15 = new Function1() { // from class: androidx.compose.animation.core.SuspendAnimationKt$$ExternalSyntheticLambda0
                                    @Override // kotlin.jvm.functions.Function1
                                    public final Object invoke(Object obj2) {
                                        return SuspendAnimationKt.animate$lambda$3(objectRef, valueFromNanos, animation, velocityVectorFromNanos, animationState3, durationScale, function1, ((Long) obj2).longValue());
                                    }
                                };
                                function13 = function1;
                                anonymousClass42.L$0 = animationState3;
                                anonymousClass42.L$1 = animation;
                                anonymousClass42.L$2 = function13;
                                anonymousClass42.L$3 = objectRef;
                                anonymousClass42.label = 1;
                                if (callWithFrameNanos(animation, function15, anonymousClass42) == coroutine_suspended) {
                                ...
                                while (true) {
                                    try {
                                        ...
                                        final AnimationState<T, V> animationState5 = animationState3;
                                        function14 = function12;
                                        try {
                                            Function1 function16 = new Function1() { // from class: androidx.compose.animation.core.SuspendAnimationKt$$ExternalSyntheticLambda2
                                                @Override // kotlin.jvm.functions.Function1
                                                public final Object invoke(Object obj2) {
                                                    return SuspendAnimationKt.animate$lambda$6(objectRef2, durationScale2, animation4, animationState5, function14, ((Long) obj2).longValue());
                                                }
                                            };
                                            animationState2 = animationState5;
                                            try {
                                                anonymousClass42.L$0 = animationState2;
                                                anonymousClass42.L$1 = animation4;
                                                anonymousClass42.L$2 = function14;
                                                anonymousClass42.L$3 = objectRef;
                                                anonymousClass42.label = 2;
                                                if (callWithFrameNanos(animation4, function16, anonymousClass42) == coroutine_suspended) {
                                                    return coroutine_suspended;
                                                }
                            ...
                            ?? r15 = (T) new AnimationScope(valueFromNanos, animation.getTypeConverter(), velocityVectorFromNanos, j, animation.getTargetValue(), j, true, new Function0() { // from class: androidx.compose.animation.core.SuspendAnimationKt$$ExternalSyntheticLambda1
                                @Override // kotlin.jvm.functions.Function0
                                public final Object invoke() {
                                    return SuspendAnimationKt.animate$lambda$4(animationState3);
                                }
                            });
                            function12 = function1;
                            doAnimationFrameWithScale(r15, j, getDurationScale(anonymousClass42.getContext()), animation, animationState3, function12);
                    ...
                    break;
                case 1:
                    Ref.ObjectRef objectRef3 = (Ref.ObjectRef) anonymousClass42.L$3;
                    function13 = (Function1) anonymousClass42.L$2;
                    animation3 = (Animation) anonymousClass42.L$1;
                    animationState4 = (AnimationState) anonymousClass42.L$0;
                    ResultKt.throwOnFailure(obj);
                    r4 = objectRef3;
                    function12 = function13;
                    animation2 = animation3;
                    ...
                    break;
                case 2:
                    Ref.ObjectRef objectRef4 = (Ref.ObjectRef) anonymousClass42.L$3;
                    Function1<? super AnimationScope<T, V>, Unit> function17 = (Function1) anonymousClass42.L$2;
                    Animation<T, V> animation5 = (Animation) anonymousClass42.L$1;
                    AnimationState<T, V> animationState6 = (AnimationState) anonymousClass42.L$0;
                    ResultKt.throwOnFailure(obj);
                    function12 = function17;
                    animation2 = animation5;
                    animationState3 = animationState6;
