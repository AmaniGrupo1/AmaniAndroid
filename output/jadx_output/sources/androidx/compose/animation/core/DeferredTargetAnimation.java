            ...
            switch (this.label) {
                case 0:
                    ...
                    if (!Intrinsics.areEqual(this.$anim.getTargetValue(), this.this$0.get_pendingTarget())) {
                        ...
                        this.label = 1;
                        if (animatable.animateTo(t, (4 & 2) != 0 ? animatable.defaultSpringSpec : finiteAnimationSpec, (4 & 4) != 0 ? animatable.getVelocity() : null, (4 & 8) != 0 ? null : null, this) == coroutine_suspended) {
