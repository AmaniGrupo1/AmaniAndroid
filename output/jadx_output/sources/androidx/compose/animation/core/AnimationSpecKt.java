...
public final class AnimationSpecKt {
    ...
    public static /* synthetic */ RepeatableSpec m174repeatable91I0pcU$default(int i, DurationBasedAnimationSpec durationBasedAnimationSpec, RepeatMode repeatMode, long j, int i2, Object obj) {
        if ((i2 & 4) != 0) {
            repeatMode = RepeatMode.Restart;
        }
        if ((i2 & 8) != 0) {
            j = StartOffset.m204constructorimpl$default(0, 0, 2, null);
        }
        return m173repeatable91I0pcU(i, durationBasedAnimationSpec, repeatMode, j);
    }

    /* JADX INFO: renamed from: repeatable-91I0pcU, reason: not valid java name */
    public static final <T> RepeatableSpec<T> m173repeatable91I0pcU(int iterations, DurationBasedAnimationSpec<T> durationBasedAnimationSpec, RepeatMode repeatMode, long j) {
        return new RepeatableSpec<>(iterations, durationBasedAnimationSpec, repeatMode, j, (DefaultConstructorMarker) null);
    }
    ...
    public static final /* synthetic */ RepeatableSpec repeatable(int iterations, DurationBasedAnimationSpec animation, RepeatMode repeatMode) {
        return new RepeatableSpec(iterations, animation, repeatMode, StartOffset.m204constructorimpl$default(0, 0, 2, null), (DefaultConstructorMarker) null);
    }

    /* JADX INFO: renamed from: infiniteRepeatable-9IiC70o$default, reason: not valid java name */
    public static /* synthetic */ InfiniteRepeatableSpec m172infiniteRepeatable9IiC70o$default(DurationBasedAnimationSpec durationBasedAnimationSpec, RepeatMode repeatMode, long j, int i, Object obj) {
        if ((i & 2) != 0) {
            repeatMode = RepeatMode.Restart;
        }
        if ((i & 4) != 0) {
        ...
        return m171infiniteRepeatable9IiC70o(durationBasedAnimationSpec, repeatMode, j);
    }

    /* JADX INFO: renamed from: infiniteRepeatable-9IiC70o, reason: not valid java name */
    public static final <T> InfiniteRepeatableSpec<T> m171infiniteRepeatable9IiC70o(DurationBasedAnimationSpec<T> durationBasedAnimationSpec, RepeatMode repeatMode, long j) {
    ...
    public static final /* synthetic */ InfiniteRepeatableSpec infiniteRepeatable(DurationBasedAnimationSpec animation, RepeatMode repeatMode) {
        return new InfiniteRepeatableSpec(animation, repeatMode, StartOffset.m204constructorimpl$default(0, 0, 2, null), (DefaultConstructorMarker) null);
    }
