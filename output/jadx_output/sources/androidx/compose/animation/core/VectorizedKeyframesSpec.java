...
public final class VectorizedKeyframesSpec<V extends AnimationVector> implements VectorizedDurationBasedAnimationSpec<V> {
    ...
    public VectorizedKeyframesSpec(Map<Integer, ? extends Pair<? extends V, ? extends Easing>> map, int durationMillis, int delayMillis) {
        ...
        for (Map.Entry<Integer, ? extends Pair<? extends V, ? extends Easing>> entry : map.entrySet()) {
            ...
            timeToInfoMap.set(time, new VectorizedKeyframeSpecElementInfo(value.getFirst(), value.getSecond(), ArcMode.INSTANCE.m185getArcLinear9TMq4(), null));
        }
        this(mutableIntList, timeToInfoMap, i, delayMillis, EasingKt.getLinearEasing(), ArcMode.INSTANCE.m185getArcLinear9TMq4(), null);
    }
    ...
    private final void init(V initialValue, V targetValue, V initialVelocity) {
        ...
        if (this.valueVector == null) {
            ...
            for (int i4 = 0; i4 < i3; i4++) {
                ...
                int iM226getArcMode9TMq4 = vectorizedKeyframeSpecElementInfo != null ? vectorizedKeyframeSpecElementInfo.m226getArcMode9TMq4() : this.initialArcMode;
                if (!ArcMode.m179equalsimpl0(iM226getArcMode9TMq4, ArcMode.INSTANCE.m185getArcLinear9TMq4())) {
                    z = true;
                }
                iArr[i4] = iM226getArcMode9TMq4;
            }
            this.modes = iArr;
        }
        if (z) {
    ...
    public V getValueFromNanos(long playTimeNanos, V initialValue, V targetValue, V initialVelocity) {
        ...
        while (i2 < size) {
            ...
            v.set$animation_core(i2, ((1 - easedTimeFromIndex) * vectorValue.get$animation_core(i2)) + (animationVector2.get$animation_core(i2) * easedTimeFromIndex));
            i2++;
            size = i3;
    ...
    public V getVelocityFromNanos(long playTimeNanos, V initialValue, V targetValue, V initialVelocity) {
        long playTimeMillis = playTimeNanos / 1000000;
    ...
    private final float getEasedTimeFromIndex(int index, int timeMillis, boolean asFraction) {
        ...
        if (!asFraction) {
            return ((timeRange * easedFraction) + timeMin) / 1000;
        }
