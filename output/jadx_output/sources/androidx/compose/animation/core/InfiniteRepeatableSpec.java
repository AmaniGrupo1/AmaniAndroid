...
public final class InfiniteRepeatableSpec<T> implements AnimationSpec<T> {
    ...
    public /* synthetic */ InfiniteRepeatableSpec(DurationBasedAnimationSpec durationBasedAnimationSpec, RepeatMode repeatMode, long j, int i, DefaultConstructorMarker defaultConstructorMarker) {
        ...
        this(durationBasedAnimationSpec, repeatMode2, jM204constructorimpl$default, (DefaultConstructorMarker) null);
    }
    ...
    public boolean equals(Object other) {
        return (other instanceof InfiniteRepeatableSpec) && Intrinsics.areEqual(((InfiniteRepeatableSpec) other).animation, this.animation) && ((InfiniteRepeatableSpec) other).repeatMode == this.repeatMode && StartOffset.m206equalsimpl0(((InfiniteRepeatableSpec) other).initialStartOffset, this.initialStartOffset);
    }

    public int hashCode() {
        return (((this.animation.hashCode() * 31) + this.repeatMode.hashCode()) * 31) + StartOffset.m209hashCodeimpl(this.initialStartOffset);
    }
}
