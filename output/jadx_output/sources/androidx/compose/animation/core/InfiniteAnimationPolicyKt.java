...
public final class InfiniteAnimationPolicyKt {
    public static final <R> Object withInfiniteAnimationFrameNanos(Function1<? super Long, ? extends R> function1, Continuation<? super R> continuation) {
        ...
        return policy == null ? MonotonicFrameClockKt.withFrameNanos(function1, continuation) : policy.onInfiniteOperation(new C02222(function1, null), continuation);
    }
    ...
    static final class C02222<R> extends SuspendLambda implements Function1<Continuation<? super R>, Object> {
        final /* synthetic */ Function1<Long, R> $onFrame;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C02222(Function1<? super Long, ? extends R> function1, Continuation<? super C02222> continuation) {
        ...
        public final Continuation<Unit> create(Continuation<?> continuation) {
            return new C02222(this.$onFrame, continuation);
        }

        @Override // kotlin.jvm.functions.Function1
        public final Object invoke(Continuation<? super R> continuation) {
            return ((C02222) create(continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final class AnonymousClass2<R> implements Function1<Long, R> {
        ...
        public final R invoke(long it) {
            return this.$onFrame.invoke(Long.valueOf(it / 1000000));
        }
