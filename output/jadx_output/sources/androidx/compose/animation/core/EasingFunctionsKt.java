...
public final class EasingFunctionsKt {
    ...
    static final float EaseInElastic$lambda$0(float fraction) {
        ...
        if (!(fraction == 1.0f)) {
            return (float) (((double) (-((float) Math.pow(2.0f, (fraction * 10.0f) - 10.0f)))) * Math.sin(((double) ((10.0f * fraction) - 10.75f)) * 2.0943951023931953d));
        }
        return 1.0f;
    }
    ...
    static final float EaseOutElastic$lambda$0(float fraction) {
        ...
        return (float) ((((double) ((float) Math.pow(2.0f, (-10.0f) * fraction))) * Math.sin(((double) ((10.0f * fraction) - 0.75f)) * 2.0943951023931953d)) + ((double) 1.0f));
    }
    ...
    static final float EaseInOutElastic$lambda$0(float fraction) {
        ...
        if (0.0f <= fraction && fraction <= 0.5f) {
            double d = 2.0f;
            return (float) ((-(((double) ((float) Math.pow(d, (fraction * 20.0f) - 10.0f))) * Math.sin(((double) ((20.0f * fraction) - 11.125f)) * 1.3962634015954636d))) / d);
        }
        double d2 = 2.0f;
        return ((float) ((((double) ((float) Math.pow(d2, ((-20.0f) * fraction) + 10.0f))) * Math.sin(((double) ((20.0f * fraction) - 11.125f)) * 1.3962634015954636d)) / d2)) + 1.0f;
    }
    ...
    static final float EaseInBounce$lambda$0(float fraction) {
        return 1 - EaseOutBounce.transform(1.0f - fraction);
    }
    ...
    static final float EaseInOutBounce$lambda$0(float fraction) {
        if (fraction < 0.5d) {
            return (1 - EaseOutBounce.transform(1.0f - (fraction * 2.0f))) / 2.0f;
        }
        return (1 + EaseOutBounce.transform((fraction * 2.0f) - 1.0f)) / 2.0f;
    }
}
