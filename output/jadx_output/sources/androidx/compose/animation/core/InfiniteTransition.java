    ...
    public final void run$animation_core(Composer $composer, final int $changed) {
        ...
        if (!$composer2.shouldExecute(($dirty & 3) != 2, $dirty & 1)) {
            ...
            if (isRunning() || getRefreshChildNeeded()) {
                ...
                $composer2.startReplaceGroup(-151918981);
            }
