...
public final class ArcAnimationSpec<T> implements DurationBasedAnimationSpec<T> {
    ...
    public /* synthetic */ ArcAnimationSpec(int i, int i2, int i3, Easing easing, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this((i4 & 1) != 0 ? ArcMode.INSTANCE.m184getArcBelow9TMq4() : i, (i4 & 2) != 0 ? 300 : i2, (i4 & 4) != 0 ? 0 : i3, (i4 & 8) != 0 ? EasingKt.getFastOutSlowInEasing() : easing, null);
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ArcAnimationSpec) && ArcMode.m179equalsimpl0(this.mode, ((ArcAnimationSpec) other).mode) && this.durationMillis == ((ArcAnimationSpec) other).durationMillis && this.delayMillis == ((ArcAnimationSpec) other).delayMillis) {
    ...
    public int hashCode() {
        int result = ArcMode.m180hashCodeimpl(this.mode);
