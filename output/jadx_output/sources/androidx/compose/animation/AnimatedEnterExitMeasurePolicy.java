...
final class AnimatedEnterExitMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo41measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, List<? extends Measurable> list, long j) {
        ...
        if ($this$measure_u2d3p2s80s.isLookingAhead()) {
            ...
            this.scope.getTargetSize$animation().setValue(IntSize.m7668boximpl(IntSize.m7671constructorimpl((((long) height$iv) & 4294967295L) | (((long) width$iv) << 32))));
        } else if (!this.hasLookaheadOccurred) {
            int height$iv2 = maxHeight;
            int width$iv2 = maxWidth;
            this.scope.getTargetSize$animation().setValue(IntSize.m7668boximpl(IntSize.m7671constructorimpl((((long) height$iv2) & 4294967295L) | (((long) width$iv2) << 32))));
        }
