...
public final class SingleValueAnimationKt {
    ...
    public static final State<Color> m134animateColorAsStateeuL9pac(long j, AnimationSpec<Color> animationSpec, String label, Function1<? super Color, Unit> function1, Composer $composer, int $changed, int i) {
        ...
        ColorSpace colorSpaceM4701getColorSpaceimpl = Color.m4701getColorSpaceimpl(j);
        ComposerKt.sourceInformationMarkerStart($composer, -483338000, "CC(remember):SingleValueAnimation.kt#9igjgp");
        boolean invalid$iv = $composer.changed(colorSpaceM4701getColorSpaceimpl);
        Object it$iv = $composer.rememberedValue();
        if (invalid$iv || it$iv == Composer.INSTANCE.getEmpty()) {
            Object value$iv = (TwoWayConverter) ColorVectorConverterKt.getVectorConverter(Color.INSTANCE).invoke(Color.m4701getColorSpaceimpl(j));
            $composer.updateRememberedValue(value$iv);
            it$iv = value$iv;
        }
        TwoWayConverter converter = (TwoWayConverter) it$iv;
        ComposerKt.sourceInformationMarkerEnd($composer);
        State<Color> stateAnimateValueAsState = AnimateAsStateKt.animateValueAsState(Color.m4687boximpl(j), converter, animationSpec2, null, label2, function12, $composer, ($changed & 14) | (($changed << 3) & 896) | (($changed << 6) & 57344) | (458752 & ($changed << 6)), 8);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static final /* synthetic */ State m133animateColorAsStateKTwxG1Y(long j, AnimationSpec animationSpec, Function1 finishedListener, Composer $composer, int $changed, int i) {
        ...
        State<Color> stateM134animateColorAsStateeuL9pac = m134animateColorAsStateeuL9pac(j, animationSpec2, null, finishedListener2, $composer, ($changed & 14) | ($changed & 112) | (($changed << 3) & 7168), 4);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd($composer);
    ...
    public static final Animatable<Color, AnimationVector4D> m132Animatable8_81llA(long j) {
        return new Animatable<>(Color.m4687boximpl(j), ColorVectorConverterKt.getVectorConverter(Color.INSTANCE).invoke(Color.m4701getColorSpaceimpl(j)), null, null, 12, null);
    }
}
