    ...
    public void draw(ContentDrawScope $this$draw) {
        ...
        State<Color> stateAnimate = this.veilAnimation.animate(new Function1<Transition.Segment<EnterExitState>, FiniteAnimationSpec<Color>>() { // from class: androidx.compose.animation.VeilModifierNode$draw$veilColor$1
            ...
            public /* bridge */ /* synthetic */ Color invoke(EnterExitState enterExitState) {
                return Color.m4687boximpl(m160invokevNxB06k(enterExitState));
            }

            /* JADX INFO: renamed from: invoke-vNxB06k, reason: not valid java name */
            public final long m160invokevNxB06k(EnterExitState it) {
                switch (WhenMappings.$EnumSwitchMapping$0[it.ordinal()]) {
                    case 1:
                        ...
                        Veil veil2 = this.this$0.getExit().getData().getVeil();
                        return veil2 != null ? veil2.m158getInitialColor0d7_KjU() : Color.INSTANCE.m4732getTransparent0d7_KjU();
                    case 2:
                        Veil veil3 = this.this$0.getEnter().getData().getVeil();
                        return veil3 != null ? veil3.m158getInitialColor0d7_KjU() : Color.INSTANCE.m4732getTransparent0d7_KjU();
                    case 3:
                        Veil veil4 = this.this$0.getExit().getData().getVeil();
                        return veil4 != null ? veil4.m159getTargetColor0d7_KjU() : Color.INSTANCE.m4732getTransparent0d7_KjU();
                    default:
                        throw new NoWhenBranchMatchedException();
                }
            }
        });
        if (Color.m4699getAlphaimpl(stateAnimate.getValue().m4707unboximpl()) == 0.0f) {
            return;
        }
        ...
        if (!(veil != null && veil.getMatchParentSize())) {
            DrawScope.m5265drawRectnJ9OG0$default($this$draw, stateAnimate.getValue().m4707unboximpl(), 0L, 0L, 0.0f, null, null, 0, WebSocketProtocol.PAYLOAD_SHORT, null);
            return;
        }
        LayoutCoordinates layoutCoordinates = DelegatableNodeKt.requireLayoutCoordinates(this);
        LayoutCoordinates parentLayoutCoordinates = layoutCoordinates.getParentLayoutCoordinates();
        if (parentLayoutCoordinates != null) {
            long it = parentLayoutCoordinates.mo6149getSizeYbymL2g();
            float width$iv = (int) (it >> 32);
            float height$iv = (int) (it & 4294967295L);
            long v1$iv$iv = Float.floatToRawIntBits(width$iv);
            state = stateAnimate;
            long v2$iv$iv2 = Float.floatToRawIntBits(height$iv);
            v2$iv$iv = Size.m4512constructorimpl((v1$iv$iv << 32) | (v2$iv$iv2 & 4294967295L));
        } else {
            state = stateAnimate;
            v2$iv$iv = Size.INSTANCE.m4530getZeroNHjbRc();
        }
        long parentSize = v2$iv$iv;
        long offsetInParent = LayoutCoordinatesKt.positionInParent(layoutCoordinates);
        DrawScope.m5265drawRectnJ9OG0$default($this$draw, state.getValue().m4707unboximpl(), Offset.m4444constructorimpl((-9223372034707292160L) ^ offsetInParent), parentSize, 0.0f, null, null, 0, 120, null);
    }
}
