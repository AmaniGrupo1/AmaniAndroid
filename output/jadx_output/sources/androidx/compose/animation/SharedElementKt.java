...
public final class SharedElementKt {
    ...
    static {
        ...
        DefaultMomentumSpring = AnimationSpecKt.spring$default(0.0f, 400.0f, Offset.m4441boximpl(Offset.m4444constructorimpl((v1$iv$iv << 32) | (4294967295L & v2$iv$iv))), 1, null);
    }

    /* JADX INFO: renamed from: toOffset-TH1AsA0, reason: not valid java name */
    public static final long m122toOffsetTH1AsA0(long j) {
        float x$iv = Velocity.m7743getXimpl(j);
        float y$iv = Velocity.m7744getYimpl(j);
