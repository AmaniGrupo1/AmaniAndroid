...
public final class SharedElementEntry implements LayerRenderer, RememberObserver {
    ...
    public final Rect calculateTargetBounds(Rect previousTargetBoundsBeforeLosingTarget) {
        ...
        return $this$calculateTargetBounds_u24lambda_u240.m124alternativeTargetBoundsInTransitionScopeAfterRemovalcSwnlzA(getUserState(), previousTargetBoundsBeforeLosingTarget, IntSizeKt.m7688toSizeozmzZPI(getSharedElement().getScope().getLookaheadRoot$animation().mo6149getSizeYbymL2g()));
    }
    ...
    public void drawInOverlay(DrawScope drawScope) throws Throwable {
        ...
        if (currentBounds != null && getShouldRenderInOverlay$animation()) {
            long jM4487getTopLeftF1C5BW0 = currentBounds.m4487getTopLeftF1C5BW0();
            int bits$iv$iv$iv$iv = (int) (jM4487getTopLeftF1C5BW0 >> 32);
            float x = Float.intBitsToFloat(bits$iv$iv$iv$iv);
            int bits$iv$iv$iv$iv2 = (int) (4294967295L & jM4487getTopLeftF1C5BW0);
            ...
            try {
                ...
                $this$clipPath_KD09W0M_u24lambda_u240$iv.mo5194clipPathmtrdDE(it, iM4686getIntersectrtfAjoo);
                try {
                    drawScope.getDrawContext().getTransform().translate(x, y);
                    try {
                        try {
