...
public final /* data */ class Veil {
    ...
    public static /* synthetic */ Veil m154copyRFnl5yQ$default(Veil veil, long j, long j2, FiniteAnimationSpec finiteAnimationSpec, boolean z, int i, Object obj) {
        ...
        return veil.m157copyRFnl5yQ(j3, j4, finiteAnimationSpec2, z);
    }
    ...
    public final Veil m157copyRFnl5yQ(long initialColor, long targetColor, FiniteAnimationSpec<Color> animationSpec, boolean matchParentSize) {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m4698equalsimpl0(this.initialColor, veil.initialColor) && Color.m4698equalsimpl0(this.targetColor, veil.targetColor) && Intrinsics.areEqual(this.animationSpec, veil.animationSpec) && this.matchParentSize == veil.matchParentSize;
    }

    public int hashCode() {
        return (((((Color.m4704hashCodeimpl(this.initialColor) * 31) + Color.m4704hashCodeimpl(this.targetColor)) * 31) + this.animationSpec.hashCode()) * 31) + Boolean.hashCode(this.matchParentSize);
    }

    public String toString() {
        return "Veil(initialColor=" + ((Object) Color.m4705toStringimpl(this.initialColor)) + ", targetColor=" + ((Object) Color.m4705toStringimpl(this.targetColor)) + ", animationSpec=" + this.animationSpec + ", matchParentSize=" + this.matchParentSize + ')';
    }
