...
public final class ActiveMatchConfigured extends MatchIsOrHasBeenConfigured {
    ...
    public SharedTransitionStateMachine.State mo36configureActiveMatch38uP1EE(SharedElement sharedElement, BoundsProvider targetBoundsProvider, long lookaheadSize, long topLeft, long structuralOffset) {
        ...
        SharedTransitionStateMachineKt.m131updateTargetDataBGTQxF0(getTargetData(), lookaheadSize, topLeft, structuralOffset, targetBoundsProviderChanged);
    ...
    public SharedTransitionStateMachine.State onVisibleContentRemovedDuringTransition() {
        Rect lastTarget = RectKt.m4492Recttz77jQw(Offset.m4457plusMKHz9U(getTargetData().m144getCurrentMfrOffsetF1C5BW0(), getTargetData().m147getTargetStructuralOffsetF1C5BW0()), getTargetData().m146getSizeNHjbRc());
        Rect newTarget = getTargetBoundsProvider().calculateAlternativeTargetBounds(lastTarget);
        if (newTarget == null) {
            return NoMatchFound.INSTANCE;
        }
        TargetData it = new TargetData(newTarget.m4485getSizeNHjbRc(), getTargetData().m145getInitialMfrOffsetF1C5BW0(), Offset.m4456minusMKHz9U(newTarget.m4487getTopLeftF1C5BW0(), getTargetData().m144getCurrentMfrOffsetF1C5BW0()), null);
        it.m148setCurrentMfrOffsetk4lQ0M(getTargetData().m144getCurrentMfrOffsetF1C5BW0());
