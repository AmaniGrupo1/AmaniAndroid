...
final class AnimatedContentMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo41measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, List<? extends Measurable> list, long j) {
        ...
        long targetSize = IntSize.INSTANCE.m7681getZeroYbymL2g();
        ...
        while (true) {
            ...
            if (childData != null && childData.isTarget()) {
                ...
                list2 = list3;
                targetSize = IntSize.m7671constructorimpl((((long) width$iv) << 32) | (((long) height$iv) & 4294967295L));
        ...
        for (int index$iv2 = 0; index$iv2 < size2; index$iv2++) {
            ...
            if (placeables[index2] == null) {
                placeables[index2] = measurable2.mo6141measureBRTryo0(j);
            }
        }
        ...
        if (!$this$measure_u2d3p2s80s.isLookingAhead()) {
            ...
            this.rootScope.m66setMeasuredSizeozmzZPI$animation(IntSize.m7671constructorimpl((((long) maxHeight) & 4294967295L) | (((long) width$iv2) << 32)));
        }
            ...
            public final void invoke2(Placeable.PlacementScope $this$layout) {
                ...
                while (i < length) {
                    ...
                    if (placeable5 == null) {
                        ...
                        placeableArr = placeableArr2;
                        animatedContentMeasurePolicy = animatedContentMeasurePolicy2;
                        long offset = contentAlignment.mo4171alignKFBX0sM(IntSize.m7671constructorimpl((((long) width$iv4) << 32) | (((long) height$iv3) & 4294967295L)), IntSize.m7671constructorimpl((((long) width$iv3) << 32) | (((long) height$iv2) & 4294967295L)), LayoutDirection.Ltr);
                        Placeable.PlacementScope.place$default($this$layout, placeable5, IntOffset.m7633getXimpl(offset), IntOffset.m7634getYimpl(offset), 0.0f, 4, null);
                    }
                    i++;
