...
public final class BorderStroke {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof BorderStroke) && Dp.m7510equalsimpl0(this.width, ((BorderStroke) other).width) && Intrinsics.areEqual(this.brush, ((BorderStroke) other).brush);
    }

    public int hashCode() {
        int result = Dp.m7511hashCodeimpl(this.width);
        return (result * 31) + this.brush.hashCode();
    }

    public String toString() {
        return "BorderStroke(width=" + ((Object) Dp.m7516toStringimpl(this.width)) + ", brush=" + this.brush + ')';
    }
    ...
    public final BorderStroke m288copyD5KLDUw(float width, Brush brush) {
