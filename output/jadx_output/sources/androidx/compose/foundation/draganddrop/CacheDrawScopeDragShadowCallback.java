...
public final class CacheDrawScopeDragShadowCallback {
    ...
    public final DrawResult cachePicture(CacheDrawScope scope) {
        ...
        scope.m4233recordTdoYBX4($this$cachePicture_u24lambda_u240_u240, (7 & 1) != 0 ? scope : null, (7 & 2) != 0 ? scope.getLayoutDirection() : null, (7 & 4) != 0 ? IntSizeKt.m7687toIntSizeuvyYCjk(scope.m4232getSizeNHjbRc()) : 0L, new Function1() { // from class: androidx.compose.foundation.draganddrop.CacheDrawScopeDragShadowCallback$$ExternalSyntheticLambda0
