...
final class MarqueeModifierNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, FocusEventModifierNode {
    ...
    private MarqueeModifierNode(int iterations, int animationMode, int delayMillis, int initialDelayMillis, final MarqueeSpacing spacing, float velocity) {
        ...
        this.animationMode = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(MarqueeAnimationMode.m334boximpl(animationMode), null, 2, null);
    ...
    public final void m349setAnimationMode97h66l8(int i) {
        ...
        $this$setValue$iv.setValue(MarqueeAnimationMode.m334boximpl(i));
    }
    ...
    public final void m350updatelWfNwf4(int iterations, int animationMode, int delayMillis, int initialDelayMillis, MarqueeSpacing spacing, float velocity) {
        setSpacing(spacing);
        m349setAnimationMode97h66l8(animationMode);
        if (this.iterations != iterations || this.delayMillis != delayMillis || this.initialDelayMillis != initialDelayMillis || !Dp.m7510equalsimpl0(this.velocity, velocity)) {
            this.iterations = iterations;
            this.delayMillis = delayMillis;
            this.initialDelayMillis = initialDelayMillis;
            this.velocity = velocity;
    ...
    public MeasureResult mo69measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long j) {
        long childConstraints = Constraints.m7447copyZbe2FdA(j, (11 & 1) != 0 ? Constraints.m7460getMinWidthimpl(j) : 0, (11 & 2) != 0 ? Constraints.m7458getMaxWidthimpl(j) : Integer.MAX_VALUE, (11 & 4) != 0 ? Constraints.m7459getMinHeightimpl(j) : 0, (11 & 8) != 0 ? Constraints.m7457getMaxHeightimpl(j) : 0);
        final Placeable placeable = measurable.mo6141measureBRTryo0(childConstraints);
        setContainerWidth(ConstraintsKt.m7475constrainWidthK40F9xA(j, placeable.getWidth()));
    ...
    public void draw(final ContentDrawScope $this$draw) throws Throwable {
        ...
        if (Dp.m7504compareTo0680j_4(this.velocity, Dp.m7505constructorimpl(0)) > 0) {
        ...
        int bits$iv$iv$iv = (int) ($this$draw.mo5271getSizeNHjbRc() & 4294967295L);
        ...
        if (layer3 != null) {
            ...
            $this$draw.mo5272recordJVtK1S4(layer3, IntSize.m7671constructorimpl((((long) height$iv) & 4294967295L) | (((long) width$iv) << 32)), new Function1() { // from class: androidx.compose.foundation.MarqueeModifierNode$$ExternalSyntheticLambda0
                @Override // kotlin.jvm.functions.Function1
                public final Object invoke(Object obj) {
        ...
        int bits$iv$iv$iv$iv = (int) ($this$clipRect_u2drOu3jXo_u24default$iv.mo5271getSizeNHjbRc() & j);
        ...
        long previousSize$iv$iv = $this$withTransform_u24lambda_u240$iv$iv2.mo5192getSizeNHjbRc();
        ...
        try {
            ...
            try {
                $this$clipRect_rOu3jXo_u24lambda_u240$iv.mo5195clipRectN_I0leg(0.0f, 0.0f, right$iv, bottom$iv, iM4686getIntersectrtfAjoo);
                    ...
                    try {
                        if (layer != null) {
                            if (firstCopyVisible) {
                                ...
                                layer2 = layer;
                                try {
                                    GraphicsLayerKt.drawLayer($this$draw_u24lambda_u241_u240, layer2);
                                } catch (Throwable th2) {
                                    th = th2;
                                    $this$withTransform_u24lambda_u240$iv$iv = $this$withTransform_u24lambda_u240$iv$iv2;
                                    try {
                            ...
                            if (secondCopyVisible) {
                                ...
                                try {
                                    try {
                                        ...
                                        try {
                                            GraphicsLayerKt.drawLayer($this$translate_u24default$iv, layer2);
                                            $this$translate_u24default$iv.getDrawContext().getTransform().translate(-left$iv2, -0.0f);
                                        } catch (Throwable th4) {
                                            $this$translate_u24default$iv.getDrawContext().getTransform().translate(-left$iv2, -0.0f);
                                            throw th4;
                        ...
                        try {
                            ...
                            $this$withTransform_u24lambda_u240$iv$iv2.mo5193setSizeuvyYCjk(previousSize$iv$iv);
                        } catch (Throwable th7) {
                            th = th7;
                            $this$withTransform_u24lambda_u240$iv$iv = $this$withTransform_u24lambda_u240$iv$iv2;
                            $this$withTransform_u24lambda_u240$iv$iv.getCanvas().restore();
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    }), new C00092(MarqueeModifierNode.this, null), this) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    break;
                case 1:
        ...
        static final Float invokeSuspend$lambda$0(MarqueeModifierNode this$0) {
            ...
            if (!MarqueeAnimationMode.m337equalsimpl0(this$0.m348getAnimationModeZbEOnfQ(), MarqueeAnimationMode.INSTANCE.m342getWhileFocusedZbEOnfQ()) || this$0.getHasFocus()) {
        ...
        static final class C00092 extends SuspendLambda implements Function2<Float, Continuation<? super Unit>, Object> {
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C00092(MarqueeModifierNode marqueeModifierNode, Continuation<? super C00092> continuation) {
                super(2, continuation);
                this.this$0 = marqueeModifierNode;
            }
            ...
            public final Object invoke(Float f, Continuation<? super Unit> continuation) {
                return ((C00092) create(f, continuation)).invokeSuspend(Unit.INSTANCE);
            }
            ...
            public final Object invokeSuspend(Object $result) throws Throwable {
                ...
                try {
                    switch (this.label) {
                        case 0:
                            ResultKt.throwOnFailure($result);
                            Float contentWithSpacingWidth2 = (Float) this.L$0;
                            if (contentWithSpacingWidth2 == null) {
                                return Unit.INSTANCE;
                            }
                            AnimationSpec spec2 = BasicMarqueeKt.m271createMarqueeAnimationSpecZ4HSEVQ(this.this$0.iterations, contentWithSpacingWidth2.floatValue(), this.this$0.initialDelayMillis, this.this$0.delayMillis, this.this$0.velocity, DelegatableNodeKt.requireDensity(this.this$0));
                            this.L$0 = contentWithSpacingWidth2;
                            this.L$1 = spec2;
                            this.label = 1;
                            ...
                            spec = spec2;
                            contentWithSpacingWidth = contentWithSpacingWidth2;
                            Animatable animatable = this.this$0.offset;
                            this.L$0 = null;
                            this.L$1 = null;
                            this.label = 2;
                            objAnimateTo = animatable.animateTo(contentWithSpacingWidth, (4 & 2) != 0 ? animatable.defaultSpringSpec : spec, (4 & 4) != 0 ? animatable.getVelocity() : null, (4 & 8) != 0 ? null : null, this);
                            ...
                            try {
                                this.label = 3;
                                return this.this$0.offset.snapTo(Boxing.boxFloat(0.0f), this) != coroutine_suspended ? coroutine_suspended : Unit.INSTANCE;
                            } catch (Throwable th) {
                                th = th;
                                this.L$0 = th;
                                this.L$1 = null;
                        ...
                        case 1:
                            AnimationSpec spec3 = (AnimationSpec) this.L$1;
                            Float contentWithSpacingWidth3 = (Float) this.L$0;
                            ResultKt.throwOnFailure($result);
                            spec = spec3;
                            contentWithSpacingWidth = contentWithSpacingWidth3;
                            Animatable animatable2 = this.this$0.offset;
                            this.L$0 = null;
                            this.L$1 = null;
                            this.label = 2;
                            objAnimateTo = animatable2.animateTo(contentWithSpacingWidth, (4 & 2) != 0 ? animatable2.defaultSpringSpec : spec, (4 & 4) != 0 ? animatable2.getVelocity() : null, (4 & 8) != 0 ? null : null, this);
                            if (objAnimateTo != coroutine_suspended) {
                            }
                            break;
                        case 2:
