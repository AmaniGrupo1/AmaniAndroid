...
public final class ImageKt {
    ...
    public static final /* synthetic */ void Image(ImageBitmap bitmap, String contentDescription, Modifier modifier, Alignment alignment, ContentScale contentScale, float alpha, ColorFilter colorFilter, Composer $composer, int $changed, int i) {
        ...
        m321Image5hnEew(bitmap, contentDescription, modifier2, alignment2, contentScale2, alpha2, colorFilter2, FilterQuality.INSTANCE.m4797getLowfv9h1I(), $composer, ($changed & 14) | ($changed & 112) | ($changed & 896) | ($changed & 7168) | (57344 & $changed) | (458752 & $changed) | (3670016 & $changed), 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static final void m321Image5hnEew(ImageBitmap bitmap, String contentDescription, Modifier modifier, Alignment alignment, ContentScale contentScale, float alpha, ColorFilter colorFilter, int i, Composer $composer, int $changed, int i2) {
        ...
        if ((i2 & 128) == 0) {
            iM5274getDefaultFilterQualityfv9h1I = i;
        } else {
        ...
        if (invalid$iv || it$iv == Composer.INSTANCE.getEmpty()) {
            Object value$iv = BitmapPainterKt.m5394BitmapPainterQZhYCtY$default(bitmap, 0L, 0L, iM5274getDefaultFilterQualityfv9h1I, 6, null);
