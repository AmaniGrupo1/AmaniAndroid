...
public final class BasicMarqueeKt {
    ...
    public static /* synthetic */ Modifier m270basicMarquee1Mj1MLw$default(Modifier modifier, int i, int i2, int i3, int i4, MarqueeSpacing marqueeSpacing, float f, int i5, Object obj) {
        ...
        if ((i5 & 2) != 0) {
            i2 = MarqueeAnimationMode.INSTANCE.m341getImmediatelyZbEOnfQ();
        }
        if ((i5 & 4) != 0) {
            i3 = MarqueeDefaults.INSTANCE.getRepeatDelayMillis();
        }
        if ((i5 & 8) != 0) {
            i4 = MarqueeAnimationMode.m337equalsimpl0(i2, MarqueeAnimationMode.INSTANCE.m341getImmediatelyZbEOnfQ()) ? i3 : 0;
        }
        if ((i5 & 16) != 0) {
            marqueeSpacing = MarqueeDefaults.INSTANCE.getSpacing();
        }
        float fM343getVelocityD9Ej5fM = (i5 & 32) != 0 ? MarqueeDefaults.INSTANCE.m343getVelocityD9Ej5fM() : f;
        MarqueeSpacing marqueeSpacing2 = marqueeSpacing;
        return m269basicMarquee1Mj1MLw(modifier, i, i2, i3, i4, marqueeSpacing2, fM343getVelocityD9Ej5fM);
    }

    /* JADX INFO: renamed from: basicMarquee-1Mj1MLw, reason: not valid java name */
    public static final Modifier m269basicMarquee1Mj1MLw(Modifier $this$basicMarquee_u2d1Mj1MLw, int iterations, int i, int repeatDelayMillis, int initialDelayMillis, MarqueeSpacing spacing, float f) {
        return $this$basicMarquee_u2d1Mj1MLw.then(new MarqueeModifierElement(iterations, i, repeatDelayMillis, initialDelayMillis, spacing, f, null));
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: createMarqueeAnimationSpec-Z4HSEVQ, reason: not valid java name */
    public static final AnimationSpec<Float> m271createMarqueeAnimationSpecZ4HSEVQ(int iterations, float targetValue, int initialDelayMillis, int delayMillis, float f, Density density) {
        float pxPerSec = density.mo405toPx0680j_4(f);
        TweenSpec<Float> tweenSpecVelocityBasedTween = velocityBasedTween(Math.abs(pxPerSec), targetValue, delayMillis);
        long startOffset = StartOffset.m204constructorimpl$default((-delayMillis) + initialDelayMillis, 0, 2, null);
        if (iterations == Integer.MAX_VALUE) {
            return AnimationSpecKt.m172infiniteRepeatable9IiC70o$default(tweenSpecVelocityBasedTween, null, startOffset, 2, null);
        }
        return AnimationSpecKt.m174repeatable91I0pcU$default(iterations, tweenSpecVelocityBasedTween, null, startOffset, 4, null);
    }
    ...
    public static final MarqueeSpacing m267MarqueeSpacing0680j_4(final float f) {
        return new MarqueeSpacing() { // from class: androidx.compose.foundation.BasicMarqueeKt$$ExternalSyntheticLambda0
            ...
            public final int calculateSpacing(Density density, int i, int i2) {
                return density.mo399roundToPx0680j_4(f);
            }
        };
    }
}
