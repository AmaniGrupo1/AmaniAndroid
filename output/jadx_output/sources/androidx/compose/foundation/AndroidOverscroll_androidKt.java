...
public final class AndroidOverscroll_androidKt {
    ...
    private static final PaddingValues DefaultGlowPaddingValues = PaddingKt.m813PaddingValuesYgX7TsA$default(0.0f, 0.0f, 3, null);
    ...
    public static final OverscrollFactory m262rememberPlatformOverscrollFactory3JVO9M(long j, PaddingValues glowDrawPadding, Composer $composer, int $changed, int i) {
        long j2;
        ...
        AndroidEdgeEffectOverscrollFactory androidEdgeEffectOverscrollFactory = new AndroidEdgeEffectOverscrollFactory(context, density, j2, glowDrawPadding2, null);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static final float m261destretchMultiplierGyEprt8(int i) {
        return NestedScrollSource.m5878equalsimpl0(i, NestedScrollSource.INSTANCE.m5889getSideEffectWNlRxjI()) ? 4.0f : 1.0f;
    }
}
