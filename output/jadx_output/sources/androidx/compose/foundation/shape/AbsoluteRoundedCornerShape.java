...
public final class AbsoluteRoundedCornerShape extends CornerBasedShape {
    ...
    public Outline mo1109createOutlineLjSzlW0(long size, float topStart, float topEnd, float bottomEnd, float bottomStart, LayoutDirection layoutDirection) {
        if (((topStart + topEnd) + bottomEnd) + bottomStart == 0.0f) {
            return new Outline.Rectangle(SizeKt.m4542toRectuvyYCjk(size));
        }
        Rect rectM4542toRectuvyYCjk = SizeKt.m4542toRectuvyYCjk(size);
        ...
        long jM4406constructorimpl2 = CornerRadius.m4406constructorimpl((v1$iv$iv2 << 32) | (v2$iv$iv2 & 4294967295L));
        long v1$iv$iv3 = Float.floatToRawIntBits(bottomEnd);
        long v2$iv$iv3 = Float.floatToRawIntBits(bottomEnd);
        long jM4406constructorimpl3 = CornerRadius.m4406constructorimpl((v1$iv$iv3 << 32) | (v2$iv$iv3 & 4294967295L));
        long v1$iv$iv4 = Float.floatToRawIntBits(bottomStart);
        long v2$iv$iv4 = Float.floatToRawIntBits(bottomStart);
        return new Outline.Rounded(RoundRectKt.m4504RoundRectZAM2FJo(rectM4542toRectuvyYCjk, jM4406constructorimpl, jM4406constructorimpl2, jM4406constructorimpl3, CornerRadius.m4406constructorimpl((v1$iv$iv4 << 32) | (4294967295L & v2$iv$iv4))));
    }
    ...
    private final long m1113toRadiusBz7bX_o(float $this$toRadius_u2dBz7bX_o) {
