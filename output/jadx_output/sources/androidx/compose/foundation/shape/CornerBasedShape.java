...
public abstract class CornerBasedShape implements Shape, Interpolatable {
    ...
    public abstract Outline mo1109createOutlineLjSzlW0(long size, float topStart, float topEnd, float bottomEnd, float bottomStart, LayoutDirection layoutDirection);
    ...
    public final Outline mo320createOutlinePq9zytI(long size, LayoutDirection layoutDirection, Density density) {
        float scale;
        float scale2;
        float bottomEnd;
        float topStart = this.topStart.mo1117toPxTmRCtEA(size, density);
        float topEnd = this.topEnd.mo1117toPxTmRCtEA(size, density);
        float bottomEnd2 = this.bottomEnd.mo1117toPxTmRCtEA(size, density);
        float bottomStart = this.bottomStart.mo1117toPxTmRCtEA(size, density);
        float minDimension = Size.m4520getMinDimensionimpl(size);
        ...
        return mo1109createOutlineLjSzlW0(size, topStart, bottomEnd, scale2, scale, layoutDirection);
    }
