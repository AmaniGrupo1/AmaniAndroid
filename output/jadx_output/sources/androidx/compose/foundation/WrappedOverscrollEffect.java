...
final class WrappedOverscrollEffect implements OverscrollEffect {
    ...
    public long mo242applyToScrollRhakbz0(long delta, int source, Function1<? super Offset, Offset> performScroll) {
        if (this.eventHandlingEnabled) {
            return this.innerOverscrollEffect.mo242applyToScrollRhakbz0(delta, source, performScroll);
        }
    ...
    public Object mo241applyToFlingBMRW4eQ(long j, Function2<? super Velocity, ? super Continuation<? super Velocity>, ? extends Object> function2, Continuation<? super Unit> continuation) {
        if (this.eventHandlingEnabled) {
            Object objMo241applyToFlingBMRW4eQ = this.innerOverscrollEffect.mo241applyToFlingBMRW4eQ(j, function2, continuation);
