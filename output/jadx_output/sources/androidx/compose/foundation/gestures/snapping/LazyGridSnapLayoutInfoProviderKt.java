...
public final class LazyGridSnapLayoutInfoProviderKt {
        ...
        return new SnapLayoutInfoProvider() { // from class: androidx.compose.foundation.gestures.snapping.LazyGridSnapLayoutInfoProviderKt.SnapLayoutInfoProvider.1
            ...
            private final int getAverageItemSize() {
                ...
                for (LazyGridItemInfo it : layoutInfo.getVisibleItemsInfo()) {
                    iSizeOnMainAxis += LazyGridSnapLayoutInfoProviderKt.sizeOnMainAxis(it, layoutInfo.getOrientation());
                }
                return iSizeOnMainAxis / numberOfItems;
            }
            ...
            public float calculateSnapOffset(float velocity) {
                ...
                return SnapFlingBehaviorKt.m628calculateFinalOffsetFhqu1e0(LazyListSnapLayoutInfoProviderKt.calculateFinalSnappingItem($this$calculateSnapOffset_u24lambda_u242, velocity), distanceFromItemBeforeTarget, distanceFromItemAfterTarget);
            }
        };
    }
    ...
    public static final int sizeOnMainAxis(LazyGridItemInfo $this$sizeOnMainAxis, Orientation orientation) {
        if (orientation == Orientation.Vertical) {
            return (int) (4294967295L & $this$sizeOnMainAxis.getSize());
        }
        return (int) ($this$sizeOnMainAxis.getSize() >> 32);
    }

    public static final int offsetOnMainAxis(LazyGridItemInfo $this$offsetOnMainAxis, Orientation orientation) {
        if (orientation == Orientation.Vertical) {
            return IntOffset.m7634getYimpl($this$offsetOnMainAxis.getOffset());
        }
        return IntOffset.m7633getXimpl($this$offsetOnMainAxis.getOffset());
    }
}
