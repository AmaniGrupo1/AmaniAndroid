...
public final class LazyListSnapLayoutInfoProviderKt {
    ...
    public static final SnapLayoutInfoProvider SnapLayoutInfoProvider(final LazyListState lazyListState, final SnapPosition snapPosition) {
        return new SnapLayoutInfoProvider() { // from class: androidx.compose.foundation.gestures.snapping.LazyListSnapLayoutInfoProviderKt.SnapLayoutInfoProvider.1
            ...
            public float calculateSnapOffset(float velocity) {
                ...
                return SnapFlingBehaviorKt.m628calculateFinalOffsetFhqu1e0(LazyListSnapLayoutInfoProviderKt.calculateFinalSnappingItem($this$calculateSnapOffset_u24lambda_u242, velocity), lowerBoundOffset, upperBoundOffset);
            }
        };
    }
    ...
    public static final int getSingleAxisViewportSize(LazyListLayoutInfo $this$singleAxisViewportSize) {
        if ($this$singleAxisViewportSize.getOrientation() == Orientation.Vertical) {
            return (int) (4294967295L & $this$singleAxisViewportSize.mo923getViewportSizeYbymL2g());
        }
        return (int) ($this$singleAxisViewportSize.mo923getViewportSizeYbymL2g() >> 32);
    }

    public static final int calculateFinalSnappingItem(Density $this$calculateFinalSnappingItem, float velocity) {
        if (Math.abs(velocity) < $this$calculateFinalSnappingItem.mo405toPx0680j_4(SnapFlingBehaviorKt.getMinFlingVelocityDp())) {
            return FinalSnappingItem.INSTANCE.m625getClosestItembbeMdSM();
        }
        return velocity > 0.0f ? FinalSnappingItem.INSTANCE.m626getNextItembbeMdSM() : FinalSnappingItem.INSTANCE.m627getPreviousItembbeMdSM();
    }
}
