...
public final class PagerSnapLayoutInfoProviderKt {
    ...
    private static final float dragGestureDelta(PagerState $this$dragGestureDelta) {
        if ($this$dragGestureDelta.getLayoutInfo().getOrientation() == Orientation.Horizontal) {
            int bits$iv$iv$iv = (int) ($this$dragGestureDelta.m1084getUpDownDifferenceF1C5BW0$foundation() >> 32);
            return Float.intBitsToFloat(bits$iv$iv$iv);
        }
        int bits$iv$iv$iv2 = (int) (4294967295L & $this$dragGestureDelta.m1084getUpDownDifferenceF1C5BW0$foundation());
    ...
    public static final float calculateFinalSnappingBound(PagerState pagerState, LayoutDirection layoutDirection, float snapPositionalThreshold, float flingVelocity, float lowerBoundOffset, float upperBoundOffset) {
        ...
        if (FinalSnappingItem.m621equalsimpl0(finalSnappingItem, FinalSnappingItem.INSTANCE.m625getClosestItembbeMdSM())) {
            return Math.abs(offsetFromSnappedPositionOverflow) <= snapPositionalThreshold ? upperBoundOffset : upperBoundOffset;
        }
        if (!FinalSnappingItem.m621equalsimpl0(finalSnappingItem, FinalSnappingItem.INSTANCE.m626getNextItembbeMdSM())) {
            if (!FinalSnappingItem.m621equalsimpl0(finalSnappingItem, FinalSnappingItem.INSTANCE.m627getPreviousItembbeMdSM())) {
                return 0.0f;
            }
