...
public final class Draggable2DNode extends DragGestureNode {
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<Drag2DScope, Continuation<? super Unit>, Object> {
        ...
        static final Unit invokeSuspend$lambda$0(Drag2DScope $$this$drag, Draggable2DNode this$0, DragEvent.DragDelta dragDelta) {
            ...
            if (this$0.reverseDirection) {
                delta = Offset.m4444constructorimpl((-9223372034707292160L) ^ delta);
            }
            $$this$drag.mo443dragByk4lQ0M(delta);
            return Unit.INSTANCE;
        }
    }
    ...
    public void mo423onDragStartedk4lQ0M(long startedPosition) {
        this.onDragStarted.invoke(Offset.m4441boximpl(startedPosition));
    }

    @Override // androidx.compose.foundation.gestures.DragGestureNode
    public void onDragStopped(DragEvent.DragStopped event) {
        this.onDragStopped.invoke(Velocity.m7734boximpl(event.getVelocity()));
    }
    ...
    private final long m484reverseIfNeededMKHz9U(long j) {
        ...
        return Offset.m4444constructorimpl((-9223372034707292160L) ^ j);
    }
}
