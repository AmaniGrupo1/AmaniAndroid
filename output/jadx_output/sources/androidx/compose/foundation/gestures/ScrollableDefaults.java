...
public final class ScrollableDefaults {
    ...
    public final FlingBehavior flingBehavior(Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1107739818, $changed, -1, "androidx.compose.foundation.gestures.ScrollableDefaults.flingBehavior (Scrollable.kt:591)");
        }
    ...
    public final OverscrollEffect overscrollEffect(Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1809802212, $changed, -1, "androidx.compose.foundation.gestures.ScrollableDefaults.overscrollEffect (Scrollable.kt:608)");
        }
    ...
    private static final class NoOpOverscrollEffect implements OverscrollEffect {
        ...
        public Object mo241applyToFlingBMRW4eQ(long j, Function2<? super Velocity, ? super Continuation<? super Velocity>, ? extends Object> function2, Continuation<? super Unit> continuation) {
            Object objInvoke = function2.invoke(Velocity.m7734boximpl(j), continuation);
