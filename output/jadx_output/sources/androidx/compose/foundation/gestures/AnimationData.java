...
final /* data */ class AnimationData {
    ...
    public final AnimationData m429copyd4ec7I(float zoom, long offset, float degrees) {
    ...
    public boolean equals(Object other) {
        ...
        return Float.compare(this.zoom, animationData.zoom) == 0 && Offset.m4449equalsimpl0(this.offset, animationData.offset) && Float.compare(this.degrees, animationData.degrees) == 0;
    }

    public int hashCode() {
        return (((Float.hashCode(this.zoom) * 31) + Offset.m4454hashCodeimpl(this.offset)) * 31) + Float.hashCode(this.degrees);
    }

    public String toString() {
        return "AnimationData(zoom=" + this.zoom + ", offset=" + ((Object) Offset.m4460toStringimpl(this.offset)) + ", degrees=" + this.degrees + ')';
    }
