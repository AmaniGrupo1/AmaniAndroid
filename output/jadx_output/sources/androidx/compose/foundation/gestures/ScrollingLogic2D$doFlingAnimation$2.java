            ...
            case 0:
                ...
                ScrollScope scrollScope = new ScrollScope() { // from class: androidx.compose.foundation.gestures.ScrollingLogic2D$doFlingAnimation$2$flingScope$1
                    ...
                    public float scrollBy(float pixels) {
                        ...
                        if (!Offset.m4449equalsimpl0(pixelsOffset, Offset.INSTANCE.m4468getZeroF1C5BW0()) && !((Boolean) scrollingLogic2D.isScrollableNodeAttached.invoke()).booleanValue()) {
                            throw new FlingCancellationException();
                        }
                        long consumedOffset = nestedScrollScope.mo531scrollByWithOverscrollOzD1aCk(pixelsOffset, NestedScrollSource.INSTANCE.m5889getSideEffectWNlRxjI());
                ...
                float fM567getMagnitudeTH1AsA0 = Scrollable2DKt.m567getMagnitudeTH1AsA0(j3);
                this.L$0 = longRef2;
                this.J$0 = j3;
                this.label = 1;
                Object objPerformFling = $this$invokeSuspend_u24lambda_u240_u240.performFling(scrollScope, fM567getMagnitudeTH1AsA0, this);
