...
public final class Scrollable2DNode extends DragGestureNode implements SemanticsModifierNode {
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    this.label = 1;
                    if (Scrollable2DNode.this.scrollingLogic.m597onScrollStoppedsFctU(this.$event.getVelocity(), this) == coroutine_suspended) {
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<Offset, Continuation<? super Offset>, Object> {
        ...
        public /* bridge */ /* synthetic */ Object invoke(Offset offset, Continuation<? super Offset> continuation) {
            return m569invoke3MmeM6k(offset.m4462unboximpl(), continuation);
        }
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    this.label = 1;
                    Object objM568semanticsScrollByd4ec7I = Scrollable2DKt.m568semanticsScrollByd4ec7I(Scrollable2DNode.this.scrollingLogic, offset, this);
                    return objM568semanticsScrollByd4ec7I == coroutine_suspended ? coroutine_suspended : objM568semanticsScrollByd4ec7I;
                case 1:
                    ResultKt.throwOnFailure($result);
                    return $result;
                default:
