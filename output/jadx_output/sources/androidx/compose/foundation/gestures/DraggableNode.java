...
public final class DraggableNode extends DragGestureNode {
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<DragScope, Continuation<? super Unit>, Object> {
        ...
        static final Unit invokeSuspend$lambda$0(DragScope $$this$drag, DraggableNode this$0, DragEvent.DragDelta dragDelta) {
            $$this$drag.dragBy(DraggableKt.m486toFloat3MmeM6k(this$0.m493reverseIfNeededMKHz9U(dragDelta.getDelta()), this$0.orientation));
            return Unit.INSTANCE;
        }
    }
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    Float fBoxFloat = Boxing.boxFloat(DraggableKt.m487toFloatsFctU(DraggableNode.this.m492reverseIfNeededAH228Gc(this.$event.getVelocity()), DraggableNode.this.orientation));
                    this.label = 1;
    ...
    public final long m492reverseIfNeededAH228Gc(long j) {
        return Velocity.m7749timesadjELrA(j, this.reverseDirection ? -1.0f : 1.0f);
    }
    ...
    public final long m493reverseIfNeededMKHz9U(long j) {
        return Offset.m4459timestuRUvjQ(j, this.reverseDirection ? -1.0f : 1.0f);
    }
}
