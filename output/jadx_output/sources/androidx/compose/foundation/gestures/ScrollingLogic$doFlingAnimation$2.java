...
final class ScrollingLogic$doFlingAnimation$2 extends SuspendLambda implements Function2<NestedScrollScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object $result) {
            ...
            case 0:
                ...
                ScrollScope scrollScope = new ScrollScope() { // from class: androidx.compose.foundation.gestures.ScrollingLogic$doFlingAnimation$2$reverseScope$1
                    ...
                    public float scrollBy(float pixels) {
                        ...
                        return scrollingLogic3.reverseIfNeeded(scrollingLogic3.m589toFloatk4lQ0M(nestedScrollScope.mo531scrollByWithOverscrollOzD1aCk(scrollingLogic3.m587reverseIfNeededMKHz9U(scrollingLogic3.m590toOffsettuRUvjQ(pixels)), NestedScrollSource.INSTANCE.m5889getSideEffectWNlRxjI())));
                    }
                };
                ...
                float fReverseIfNeeded = scrollingLogic.reverseIfNeeded(scrollingLogic.m584toFloatTH1AsA0(j2));
        ...
        longRef.element = scrollingLogic.m585updateQWom1Mo(j, scrollingLogic2.reverseIfNeeded(((Number) $result).floatValue()));
