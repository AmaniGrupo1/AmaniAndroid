...
@Metadata(d1 = {"\u0000J\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u0007\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\t\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0002\b\u0006\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0001\u0018\u0000 \u001e2\u00020\u0001:\u0001\u001eB\u0015\u0012\f\u0010\u0002\u001a\b\u0012\u0004\u0012\u00020\u00040\u0003¢\u0006\u0004\b\u0005\u0010\u0006JJ\u0010\u0014\u001a\u00020\u00152!\u0010\u0016\u001a\u001d\u0012\u0013\u0012\u00110\u0004¢\u0006\f\b\u0018\u0012\b\b\u0019\u0012\u0004\b\b(\u001a\u0012\u0004\u0012\u00020\u00150\u00172\f\u0010\u001b\u001a\b\u0012\u0004\u0012\u00020\u00150\u001cH\u0086@\u0082\u0002\b\n\u0006\b\u0001\u0012\u0002\u0010\u0001¢\u0006\u0002\u0010\u001dR\u0014\u0010\u0007\u001a\b\u0012\u0004\u0012\u00020\t0\bX\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\n\u001a\u00020\u000bX\u0082\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\f\u001a\u00020\tX\u0082\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\r\u001a\u00020\u000eX\u0082\u000e¢\u0006\u0002\n\u0000R\u001a\u0010\u000f\u001a\u00020\u0004X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u0010\u0010\u0011\"\u0004\b\u0012\u0010\u0013¨\u0006\u001f"}, d2 = {"Landroidx/compose/foundation/gestures/UpdatableAnimationState;", "", "animationSpec", "Landroidx/compose/animation/core/AnimationSpec;", "", "<init>", "(Landroidx/compose/animation/core/AnimationSpec;)V", "vectorizedSpec", "Landroidx/compose/animation/core/VectorizedAnimationSpec;", "Landroidx/compose/animation/core/AnimationVector1D;", "lastFrameTime", "", "lastVelocity", "isRunning", "", Values.VECTOR_MAP_VECTORS_KEY, "getValue", "()F", "setValue", "(F)V", "animateToZero", "", "beforeFrame", "Lkotlin/Function1;", "Lkotlin/ParameterName;", HintConstants.AUTOFILL_HINT_NAME, "valueDelta", "afterFrame", "Lkotlin/Function0;", "(Lkotlin/jvm/functions/Function1;Lkotlin/jvm/functions/Function0;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;", "Companion", "foundation"}, k = 1, mv = {2, 0, 0}, xi = 48)
public final class UpdatableAnimationState {
    ...
    */
    public final Object animateToZero(Function1<? super Float, Unit> function1, Function0<Unit> function0, Continuation<? super Unit> continuation) throws Throwable {
        ...
        Object obj3 = anonymousClass13.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        final ?? r5 = anonymousClass13.label;
        boolean z = true;
        try {
            switch (r5) {
                case 0:
                    ...
                    MotionDurationScale motionDurationScale = (MotionDurationScale) anonymousClass13.getContext().get(MotionDurationScale.INSTANCE);
                    float scaleFactor = motionDurationScale != null ? motionDurationScale.getScaleFactor() : 1.0f;
                    r5.isRunning = true;
                    function02 = function0;
                    f = scaleFactor;
                    function12 = function1;
                    if (Companion.isZeroish(r5.value)) {
                        try {
                            Function1 function13 = new Function1() { // from class: androidx.compose.foundation.gestures.UpdatableAnimationState$$ExternalSyntheticLambda0
                                ...
                                public final Object invoke(Object obj4) {
                                    return UpdatableAnimationState.animateToZero$lambda$1(this.f$0, f, function12, ((Long) obj4).longValue());
                                }
                            };
                            anonymousClass13.L$0 = function12;
                            anonymousClass13.L$1 = function02;
                            anonymousClass13.F$0 = f;
                            anonymousClass13.label = 1;
                            r5 = r5;
                            if (MonotonicFrameClockKt.withFrameNanos(function13, anonymousClass13) == coroutine_suspended) {
                            ...
                            } else if (Companion.isZeroish(r5.value)) {
                                r11 = r5;
                                obj = obj3;
                                anonymousClass12 = anonymousClass13;
                                obj2 = coroutine_suspended;
                            ...
                            try {
                                ...
                                if (!z) {
                                    Function1 function14 = new Function1() { // from class: androidx.compose.foundation.gestures.UpdatableAnimationState$$ExternalSyntheticLambda1
                                        @Override // kotlin.jvm.functions.Function1
                                        public final Object invoke(Object obj4) {
                                            return UpdatableAnimationState.animateToZero$lambda$2(this.f$0, function12, ((Long) obj4).longValue());
                                        }
                                    };
                                    anonymousClass12.L$0 = function03;
                                    anonymousClass12.L$1 = null;
                                    anonymousClass12.label = 2;
                                    if (MonotonicFrameClockKt.withFrameNanos(function14, anonymousClass12) == obj2) {
                                        return obj2;
                                    }
                                ...
                                r11.lastFrameTime = Long.MIN_VALUE;
                                r11.lastVelocity = ZeroVector;
                                r11.isRunning = false;
                                return Unit.INSTANCE;
                            } catch (Throwable th) {
                                th = th;
                                r5 = r11;
                                r5.lastFrameTime = Long.MIN_VALUE;
                                r5.lastVelocity = ZeroVector;
                                r5.isRunning = false;
                                throw th;
                            }
                        } catch (Throwable th2) {
                ...
                case 1:
                    r5 = this;
                    f = anonymousClass13.F$0;
                    function02 = (Function0) anonymousClass13.L$1;
                    function12 = (Function1) anonymousClass13.L$0;
                    ResultKt.throwOnFailure(obj3);
                    function02.invoke();
                    if (!(f != 0.0f)) {
                    }
                ...
                case 2:
                    r5 = this;
                    function03 = (Function0) anonymousClass13.L$0;
                    ResultKt.throwOnFailure(obj3);
                    function03.invoke();
                    r11 = r5;
                    r11.lastFrameTime = Long.MIN_VALUE;
