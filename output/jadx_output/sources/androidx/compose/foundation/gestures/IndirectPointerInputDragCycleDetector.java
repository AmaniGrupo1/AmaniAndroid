...
public final class IndirectPointerInputDragCycleDetector {
    ...
    static /* synthetic */ void m496moveToAwaitTouchSlopStateaWI9W7U$default(IndirectPointerInputDragCycleDetector indirectPointerInputDragCycleDetector, IndirectPointerInputChange indirectPointerInputChange, long j, long j2, boolean z, int i, Object obj) {
        ...
        indirectPointerInputDragCycleDetector.m495moveToAwaitTouchSlopStateaWI9W7U(indirectPointerInputChange, j, jM4468getZeroF1C5BW0, z2);
    }

    /* JADX INFO: renamed from: moveToAwaitTouchSlopState-aWI9W7U, reason: not valid java name */
    private final void m495moveToAwaitTouchSlopStateaWI9W7U(IndirectPointerInputChange initialDown, long pointerId, long initialTouchSlopPositionChange, boolean verifyConsumptionInFinalPass) {
        ...
        $this$moveToAwaitTouchSlopState_aWI9W7U_u24lambda_u240.m504setPointerId0FcD4WY(pointerId);
    ...
    private final void m497moveToDraggingState0FcD4WY(long pointerId) {
        DragDetectionState.Dragging $this$moveToDraggingState_0FcD4WY_u24lambda_u240 = getDraggingState();
        $this$moveToDraggingState_0FcD4WY_u24lambda_u240.m506setPointerId0FcD4WY(pointerId);
    ...
    private final void m494moveToAwaitGesturePickupStaternUCldI(IndirectPointerInputChange initialDown, long pointerId, TouchSlopDetector touchSlopDetector) {
        ...
        $this$moveToAwaitGesturePickupState_rnUCldI_u24lambda_u240.m502setPointerId0FcD4WY(pointerId);
        ...
        if (z) {
            ...
            if (pass == PointerEventPass.Main) {
                if (awaitTouchSlop2 == DragDetectionState.AwaitDown.AwaitTouchSlop.Yes) {
                    m496moveToAwaitTouchSlopStateaWI9W7U$default(this, firstDown, firstDown.getId(), 0L, false, 12, null);
                } else if (state.getConsumedOnInitial()) {
                    m499sendDragStart3f7A7Is(firstDown, firstDown, IndirectPointerEventPrimaryDirectionalMotionAxis.m5516boximpl(indirectPointerInputEvent.getPrimaryDirectionalMotionAxis()), Offset.INSTANCE.m4468getZeroF1C5BW0());
                    m498sendDragEventEu1f8Dk(firstDown, IndirectPointerEventPrimaryDirectionalMotionAxis.m5516boximpl(indirectPointerInputEvent.getPrimaryDirectionalMotionAxis()), Offset.INSTANCE.m4468getZeroF1C5BW0());
                    m497moveToDraggingState0FcD4WY(firstDown.getId());
                }
            }
        }
    }
    ...
    private final void processAwaitTouchSlop(IndirectPointerEvent indirectPointerInputEvent, PointerEventPass pass, DragDetectionState.AwaitTouchSlop state) {
        ...
        if (eventFromPointerId == null) {
            ...
            if (otherDown == null) {
                ...
                state.m504setPointerId0FcD4WY(otherDown.getId());
                dragEvent = otherDown;
            }
        } else {
            ...
            if (!dragEvent.getIsConsumed()) {
                if (IndirectPointerInputDragCycleDetectorKt.changedToUpIgnoreConsumed(dragEvent)) {
                    ...
                    if (otherDown2 == null) {
                        ...
                        state.m504setPointerId0FcD4WY(otherDown2.getId());
                    }
                } else {
                    float touchSlop = DragGestureDetectorKt.m476pointerSlopE8SPZFQ((ViewConfiguration) CompositionLocalConsumerModifierNodeKt.currentValueOf(this.node, CompositionLocalsKt.getLocalViewConfiguration()), PointerType.INSTANCE.m6088getTouchT8wyACA());
                    long postSlopOffset = requireTouchSlopDetector().m604addPositionsakrDWew(IndirectPointerInputDragCycleDetectorKt.m517primaryAxisPosition_bfSUIo(dragEvent, this.node.getOrientationLock(), IndirectPointerEventPrimaryDirectionalMotionAxis.m5516boximpl(indirectPointerInputEvent.getPrimaryDirectionalMotionAxis())), IndirectPointerInputDragCycleDetectorKt.m519primaryAxisPreviousPosition_bfSUIo(dragEvent, this.node.getOrientationLock(), IndirectPointerEventPrimaryDirectionalMotionAxis.m5516boximpl(indirectPointerInputEvent.getPrimaryDirectionalMotionAxis())), touchSlop);
                    if (((9223372034707292159L & postSlopOffset) != InlineClassHelperKt.UnspecifiedPackedFloats ? 1 : 0) != 0) {
                        ...
                        m499sendDragStart3f7A7Is(initialDown, dragEvent, IndirectPointerEventPrimaryDirectionalMotionAxis.m5516boximpl(indirectPointerInputEvent.getPrimaryDirectionalMotionAxis()), postSlopOffset);
                        m498sendDragEventEu1f8Dk(dragEvent, IndirectPointerEventPrimaryDirectionalMotionAxis.m5516boximpl(indirectPointerInputEvent.getPrimaryDirectionalMotionAxis()), postSlopOffset);
                        m497moveToDraggingState0FcD4WY(dragEvent.getId());
                    } else {
                ...
                TouchSlopDetector touchSlopDetector = this.touchSlopDetector;
                if (touchSlopDetector != null) {
                    m494moveToAwaitGesturePickupStaternUCldI(initialDown2, pointerId, touchSlopDetector);
                } else {
        ...
        if (pass == PointerEventPass.Final && state.getVerifyConsumptionInFinalPass()) {
            if (dragEvent.getIsConsumed()) {
                ...
                TouchSlopDetector touchSlopDetector2 = this.touchSlopDetector;
                if (touchSlopDetector2 != null) {
                    m494moveToAwaitGesturePickupStaternUCldI(initialDown3, pointerId2, touchSlopDetector2);
                    return;
                }
                throw new IllegalArgumentException("AwaitTouchSlop.touchSlopDetector was not initialized".toString());
            }
    ...
    private final void processAwaitGesturePickup(IndirectPointerEvent indirectPointerInputEvent, PointerEventPass pass, DragDetectionState.AwaitGesturePickup state) {
        ...
        if (hasUnconsumedDrag) {
            long jM517primaryAxisPosition_bfSUIo = IndirectPointerInputDragCycleDetectorKt.m517primaryAxisPosition_bfSUIo((IndirectPointerInputChange) CollectionsKt.first((List) indirectPointerInputEvent.getChanges()), this.node.getOrientationLock(), IndirectPointerEventPrimaryDirectionalMotionAxis.m5516boximpl(indirectPointerInputEvent.getPrimaryDirectionalMotionAxis()));
            IndirectPointerInputChange initialDown = state.getInitialDown();
            Intrinsics.checkNotNull(initialDown);
            long initialPositionChange = Offset.m4456minusMKHz9U(jM517primaryAxisPosition_bfSUIo, IndirectPointerInputDragCycleDetectorKt.m517primaryAxisPosition_bfSUIo(initialDown, this.node.getOrientationLock(), IndirectPointerEventPrimaryDirectionalMotionAxis.m5516boximpl(indirectPointerInputEvent.getPrimaryDirectionalMotionAxis())));
            IndirectPointerInputChange initialDown2 = state.getInitialDown();
            if (initialDown2 != null) {
                m496moveToAwaitTouchSlopStateaWI9W7U$default(this, initialDown2, state.getPointerId(), initialPositionChange, false, 8, null);
                return;
            }
    ...
    private final void processDraggingState(IndirectPointerEvent indirectPointerInputEvent, PointerEventPass pass, DragDetectionState.Dragging state) {
        ...
        if (!IndirectPointerInputDragCycleDetectorKt.changedToUpIgnoreConsumed(dragEvent)) {
            if (!dragEvent.getIsConsumed()) {
                long positionChange = IndirectPointerInputDragCycleDetectorKt.m514positionChangeIgnoreConsumed_bfSUIo(dragEvent, this.node.getOrientationLock(), IndirectPointerEventPrimaryDirectionalMotionAxis.m5516boximpl(indirectPointerInputEvent.getPrimaryDirectionalMotionAxis()));
                float motionChange = Offset.m4450getDistanceimpl(positionChange);
                if (!(motionChange == 0.0f)) {
                    long positionChange2 = IndirectPointerInputDragCycleDetectorKt.m513positionChange_bfSUIo(dragEvent, this.node.getOrientationLock(), IndirectPointerEventPrimaryDirectionalMotionAxis.m5516boximpl(indirectPointerInputEvent.getPrimaryDirectionalMotionAxis()));
                    m498sendDragEventEu1f8Dk(dragEvent, IndirectPointerEventPrimaryDirectionalMotionAxis.m5516boximpl(indirectPointerInputEvent.getPrimaryDirectionalMotionAxis()), positionChange2);
                    dragEvent.consume();
                    return;
                }
                return;
        ...
        if (otherDown == null) {
            if (!dragEvent.getIsConsumed() && IndirectPointerInputDragCycleDetectorKt.changedToUpIgnoreConsumed(dragEvent)) {
                m500sendDragStoppedk92h6UU(dragEvent, IndirectPointerEventPrimaryDirectionalMotionAxis.m5516boximpl(indirectPointerInputEvent.getPrimaryDirectionalMotionAxis()));
            } else {
                sendDragCancelled();
            }
            moveToAwaitDownState();
        ...
        state.m506setPointerId0FcD4WY(otherDown.getId());
    }

    /* JADX INFO: renamed from: sendDragStart-3f7A7Is, reason: not valid java name */
    private final void m499sendDragStart3f7A7Is(IndirectPointerInputChange down, IndirectPointerInputChange slopTriggerChange, IndirectPointerEventPrimaryDirectionalMotionAxis primaryDirectionalMotionAxis, long overSlopOffset) {
        if (this.velocityTracker == null) {
            this.velocityTracker = new VelocityTracker();
        }
        this.nodeOffset = Offset.INSTANCE.m4468getZeroF1C5BW0();
        IndirectPointerInputDragCycleDetectorKt.m512addIndirectPointerInputChangeQf4Zb88(requireVelocityTracker(), down, this.node.getOrientationLock(), primaryDirectionalMotionAxis, this.touchSmooth, this.nodeOffset);
        long dragStartedOffset = Offset.m4456minusMKHz9U(IndirectPointerInputDragCycleDetectorKt.m517primaryAxisPosition_bfSUIo(slopTriggerChange, this.node.getOrientationLock(), primaryDirectionalMotionAxis), overSlopOffset);
        if (this.node.getCanDrag().invoke(PointerType.m6078boximpl(PointerType.INSTANCE.m6088getTouchT8wyACA())).booleanValue()) {
    ...
    private final void m498sendDragEventEu1f8Dk(IndirectPointerInputChange change, IndirectPointerEventPrimaryDirectionalMotionAxis primaryDirectionalMotionAxis, long dragAmount) {
        ...
        if (Math.abs(DraggableKt.m486toFloat3MmeM6k(dragAmount, orientationLock)) > 2.0f) {
            IndirectPointerInputDragCycleDetectorKt.m512addIndirectPointerInputChangeQf4Zb88(requireVelocityTracker(), change, this.node.getOrientationLock(), primaryDirectionalMotionAxis, this.touchSmooth, this.nodeOffset);
            this.node.onDragEvent(new DragEvent.DragDelta(this.offsetSmoother.m532smoothEventPositionMKHz9U(dragAmount), true, null));
        }
    }

    /* JADX INFO: renamed from: sendDragStopped-k92h6UU, reason: not valid java name */
    private final void m500sendDragStoppedk92h6UU(IndirectPointerInputChange change, IndirectPointerEventPrimaryDirectionalMotionAxis primaryDirectionalMotionAxis) {
        IndirectPointerInputDragCycleDetectorKt.m512addIndirectPointerInputChangeQf4Zb88(requireVelocityTracker(), change, this.node.getOrientationLock(), primaryDirectionalMotionAxis, this.touchSmooth, this.nodeOffset);
        ...
        this.node.onDragEvent(new DragEvent.DragStopped(DraggableKt.m488toValidVelocityTH1AsA0(velocity), true, null));
    }
    ...
    public static abstract class DragDetectionState {
        ...
        public static final class AwaitTouchSlop extends DragDetectionState {
            ...
            public /* synthetic */ AwaitTouchSlop(IndirectPointerInputChange indirectPointerInputChange, long j, boolean z, int i, DefaultConstructorMarker defaultConstructorMarker) {
                this((i & 1) != 0 ? null : indirectPointerInputChange, (i & 2) != 0 ? PointerId.m5990constructorimpl(Long.MAX_VALUE) : j, (i & 4) != 0 ? false : z, null);
            }
        ...
        public static final class AwaitGesturePickup extends DragDetectionState {
            ...
            public /* synthetic */ AwaitGesturePickup(IndirectPointerInputChange indirectPointerInputChange, long j, TouchSlopDetector touchSlopDetector, int i, DefaultConstructorMarker defaultConstructorMarker) {
                this((i & 1) != 0 ? null : indirectPointerInputChange, (i & 2) != 0 ? PointerId.m5990constructorimpl(Long.MAX_VALUE) : j, (i & 4) != 0 ? null : touchSlopDetector, null);
            }
        ...
        public static final class Dragging extends DragDetectionState {
            ...
            public /* synthetic */ Dragging(long j, int i, DefaultConstructorMarker defaultConstructorMarker) {
                this((i & 1) != 0 ? PointerId.m5990constructorimpl(Long.MAX_VALUE) : j, null);
            }
