...
public final class DraggableKt {
    ...
    public static final DraggableState rememberDraggableState(Function1<? super Float, Unit> function1, Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-183245213, $changed, -1, "androidx.compose.foundation.gestures.rememberDraggableState (Draggable.kt:144)");
        }
    ...
    public static final float m486toFloat3MmeM6k(long j, Orientation orientation) {
    ...
    public static final float m487toFloatsFctU(long j, Orientation orientation) {
        return orientation == Orientation.Vertical ? Velocity.m7744getYimpl(j) : Velocity.m7743getXimpl(j);
    }

    /* JADX INFO: renamed from: toValidVelocity-TH1AsA0, reason: not valid java name */
    public static final long m488toValidVelocityTH1AsA0(long j) {
        return VelocityKt.Velocity(Float.isNaN(Velocity.m7743getXimpl(j)) ? 0.0f : Velocity.m7743getXimpl(j), Float.isNaN(Velocity.m7744getYimpl(j)) ? 0.0f : Velocity.m7744getYimpl(j));
    }
}
