...
final class ContentInViewNode$launchAnimation$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            switch (r1) {
                case 0:
                    ...
                    try {
                        ...
                        this.label = 1;
                        if (this.this$0.scrollingLogic.scroll(MutatePriority.Default, new AnonymousClass1(this.$animationState, this.this$0, this.$bringIntoViewSpec, this.f8x677d03b0, animationJob, null), this) == coroutine_suspended) {
    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function2<NestedScrollScope, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    this.$animationState.setValue(this.this$0.m432calculateScrollDeltaI_oMVgE(this.$bringIntoViewSpec, this.f9x677d03b0));
        ...
        static final Unit invokeSuspend$lambda$0(ContentInViewNode this$0, UpdatableAnimationState $animationState, Job $animationJob, NestedScrollScope $$this$scroll, float delta) {
            ...
            float consumedScroll = $this$invokeSuspend_u24lambda_u240_u240.m589toFloatk4lQ0M($this$invokeSuspend_u24lambda_u240_u240.m587reverseIfNeededMKHz9U($$this$scroll.mo530scrollByOzD1aCk($this$invokeSuspend_u24lambda_u240_u240.m587reverseIfNeededMKHz9U($this$invokeSuspend_u24lambda_u240_u240.m590toOffsettuRUvjQ(adjustedDelta)), NestedScrollSource.INSTANCE.m5890getUserInputWNlRxjI()))) * scrollMultiplier;
        ...
        static final Unit invokeSuspend$lambda$1(ContentInViewNode this$0, UpdatableAnimationState $animationState, BringIntoViewSpec $bringIntoViewSpec) {
            ...
            while (true) {
                ...
                if (!(bounds == null ? true : ContentInViewNode.m436isMaxVisibleEQwtKw$default(this$0, bounds, 0L, 0L, 3, null))) {
                    break;
                }
                ...
                continuation.resumeWith(Result.m8542constructorimpl(unit));
            }
            if (this$0.trackingFocusedChild) {
                Rect focusedChildBounds = this$0.getFocusedChildBounds();
                if (focusedChildBounds != null && ContentInViewNode.m436isMaxVisibleEQwtKw$default(this$0, focusedChildBounds, 0L, 0L, 3, null)) {
                    this$0.trackingFocusedChild = false;
                }
            }
            $animationState.setValue(this$0.m432calculateScrollDeltaI_oMVgE($bringIntoViewSpec, IntOffset.INSTANCE.m7644getZeronOccac()));
            return Unit.INSTANCE;
        }
    }
}
