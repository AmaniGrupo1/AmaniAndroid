...
public final class ScrollingLogic implements ScrollLogic {
    ...
    private final ScrollingLogic$nestedScrollScope$1 nestedScrollScope = new NestedScrollScope() { // from class: androidx.compose.foundation.gestures.ScrollingLogic$nestedScrollScope$1
        ...
        public long mo530scrollByOzD1aCk(long offset, int source) {
            ...
            return this.this$0.m582performScroll3eAAhYA($this$scrollBy_OzD1aCk_u24lambda_u240, offset, source);
        }
        ...
        public long mo531scrollByWithOverscrollOzD1aCk(long offset, int source) {
            ...
            if (overscroll == null || !this.this$0.getShouldDispatchOverscroll()) {
                ...
                return this.this$0.m582performScroll3eAAhYA($this$scrollByWithOverscroll_OzD1aCk_u24lambda_u241, offset, source);
            }
    ...
    public final long m590toOffsettuRUvjQ(float $this$toOffset_u2dtuRUvjQ) {
    ...
    public final long m588singleAxisOffsetMKHz9U(long j) {
        return this.orientation == Orientation.Horizontal ? Offset.m4446copydBAh8RU$default(j, 0.0f, 0.0f, 1, null) : Offset.m4446copydBAh8RU$default(j, 0.0f, 0.0f, 2, null);
    }
    ...
    public final long m592toVelocityadjELrA(float $this$toVelocity_u2dadjELrA) {
        if ($this$toVelocity_u2dadjELrA == 0.0f) {
            return Velocity.INSTANCE.m7754getZero9UxMQ8M();
        }
        if (this.orientation == Orientation.Horizontal) {
    ...
    public final float m584toFloatTH1AsA0(long j) {
        return this.orientation == Orientation.Horizontal ? Velocity.m7743getXimpl(j) : Velocity.m7744getYimpl(j);
    }
    ...
    private final long m583singleAxisVelocityAH228Gc(long j) {
        return this.orientation == Orientation.Horizontal ? Velocity.m7739copyOhffZ5M$default(j, 0.0f, 0.0f, 1, null) : Velocity.m7739copyOhffZ5M$default(j, 0.0f, 0.0f, 2, null);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: update-QWom1Mo, reason: not valid java name */
    public final long m585updateQWom1Mo(long j, float newValue) {
        return this.orientation == Orientation.Horizontal ? Velocity.m7739copyOhffZ5M$default(j, newValue, 0.0f, 2, null) : Velocity.m7739copyOhffZ5M$default(j, 0.0f, newValue, 1, null);
    }
    ...
    public final long m587reverseIfNeededMKHz9U(long j) {
        return this.reverseDirection ? Offset.m4459timestuRUvjQ(j, -1.0f) : j;
    }
    ...
    static final Offset performScrollForOverscroll$lambda$0(ScrollingLogic this$0, Offset delta) {
        ...
        return Offset.m4441boximpl(this$0.m582performScroll3eAAhYA($this$performScrollForOverscroll_u24lambda_u240_u240, delta.m4462unboximpl(), this$0.latestScrollSource));
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: performScroll-3eAAhYA, reason: not valid java name */
    public final long m582performScroll3eAAhYA(ScrollScope $this$performScroll_u2d3eAAhYA, long j, int i) {
        ...
        float singleAxisDeltaForSelfScroll = m589toFloatk4lQ0M(m587reverseIfNeededMKHz9U(m588singleAxisOffsetMKHz9U(scrollAvailableAfterPreScroll)));
        long consumedBySelfScroll = m587reverseIfNeededMKHz9U(m590toOffsettuRUvjQ($this$performScroll_u2d3eAAhYA.scrollBy(singleAxisDeltaForSelfScroll)));
        this.onScrollChangedDispatcher.mo533dispatchScrollDeltaInfok4lQ0M(consumedBySelfScroll);
    ...
    public long mo562performRawScrollMKHz9U(long scroll) {
        ...
        return m581dispatchRawDeltaMKHz9U(scroll);
    }

    /* JADX INFO: renamed from: dispatchRawDelta-MK-Hz9U, reason: not valid java name */
    private final long m581dispatchRawDeltaMKHz9U(long scroll) {
        return m590toOffsettuRUvjQ(reverseIfNeeded(this.scrollableState.dispatchRawDelta(reverseIfNeeded(m589toFloatk4lQ0M(scroll)))));
    }

    /* JADX INFO: renamed from: onScrollStopped-BMRW4eQ, reason: not valid java name */
    public final Object m586onScrollStoppedBMRW4eQ(long j, boolean isMouseWheel, Continuation<? super Unit> continuation) {
        if (isMouseWheel && !ScrollableKt.getShouldBeTriggeredByMouseWheel(this.flingBehavior)) {
            return Unit.INSTANCE;
        }
        long availableVelocity = m583singleAxisVelocityAH228Gc(j);
        ...
        if (overscroll != null && getShouldDispatchOverscroll()) {
            Object objMo241applyToFlingBMRW4eQ = overscroll.mo241applyToFlingBMRW4eQ(availableVelocity, performFling, continuation);
            return objMo241applyToFlingBMRW4eQ == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objMo241applyToFlingBMRW4eQ : Unit.INSTANCE;
        }
        Object objInvoke = performFling.invoke(Velocity.m7734boximpl(availableVelocity), continuation);
        ...
        switch (scrollingLogic$doFlingAnimation$12.label) {
            case 0:
                ...
                try {
                    ...
                    ScrollingLogic$doFlingAnimation$2 scrollingLogic$doFlingAnimation$2 = new ScrollingLogic$doFlingAnimation$2(this, result2, j, null);
                    scrollingLogic$doFlingAnimation$12.L$0 = result2;
                    scrollingLogic$doFlingAnimation$12.label = 1;
                    if (scroll(mutatePriority, scrollingLogic$doFlingAnimation$2, scrollingLogic$doFlingAnimation$12) == coroutine_suspended) {
