...
final class AnchoredDraggableNode<T> extends DragGestureNode {
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function3<AnchoredDragScope, DraggableAnchors<T>, Continuation<? super Unit>, Object> {
        ...
        static final Unit invokeSuspend$lambda$0(final AnchoredDraggableNode this$0, final AnchoredDragScope $$this$anchoredDrag, DragEvent.DragDelta dragDelta) {
            float oneDirectionalDelta = this$0.m420toFloatk4lQ0M(this$0.m418reverseIfNeededMKHz9U(dragDelta.getDelta()));
            if (this$0.overscrollEffect == null) {
                ...
                Offset.m4441boximpl(overscrollEffect.mo242applyToScrollRhakbz0(this$0.m421toOffsettuRUvjQ(oneDirectionalDelta), NestedScrollSource.INSTANCE.m5890getUserInputWNlRxjI(), new Function1() { // from class: androidx.compose.foundation.gestures.AnchoredDraggableNode$drag$2$$ExternalSyntheticLambda0
                    @Override // kotlin.jvm.functions.Function1
                    public final Object invoke(Object obj) {
        ...
        public static final Offset invokeSuspend$lambda$0$0(AnchoredDraggableNode this$0, AnchoredDragScope $$this$anchoredDrag, Offset deltaForDrag) {
            float dragOffset = this$0.state.newOffsetForDelta$foundation(this$0.m420toFloatk4lQ0M(deltaForDrag.m4462unboximpl()));
            long consumedDelta = this$0.m421toOffsettuRUvjQ(dragOffset - this$0.state.requireOffset());
            AnchoredDragScope.dragTo$default($$this$anchoredDrag, dragOffset, 0.0f, 2, null);
            return Offset.m4441boximpl(consumedDelta);
        }
    }
    ...
    static final class C02441 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C02441(AnchoredDraggableNode<T> anchoredDraggableNode, DragEvent.DragStopped dragStopped, Continuation<? super C02441> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C02441(this.this$0, this.$event, continuation);
        }
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            switch (this.label) {
                case 0:
                    ResultKt.throwOnFailure($result);
                    float oneDirectionalVelocity = this.this$0.m419toFloatTH1AsA0(this.this$0.m417reverseIfNeededAH228Gc(this.$event.getVelocity()));
                    ...
                    this.label = 2;
                    if (overscrollEffect2.mo241applyToFlingBMRW4eQ(this.this$0.m422toVelocityadjELrA(oneDirectionalVelocity), new C00131(this.this$0, null), this) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
        ...
        static final class C00131 extends SuspendLambda implements Function2<Velocity, Continuation<? super Velocity>, Object> {
            ...
            public /* bridge */ /* synthetic */ Object invoke(Velocity velocity, Continuation<? super Velocity> continuation) {
                return m425invokesFctU(velocity.getPackedValue(), continuation);
            }
            ...
            public final Object m425invokesFctU(long j, Continuation<? super Velocity> continuation) {
                return ((C00131) create(Velocity.m7734boximpl(j), continuation)).invokeSuspend(Unit.INSTANCE);
            }
            ...
            public final Object invokeSuspend(Object $result) {
                ...
                switch (this.label) {
                    case 0:
                        ...
                        this.label = 1;
                        Object objFling = this.this$0.fling(this.this$0.m419toFloatTH1AsA0(availableVelocity), this);
                ...
                if (currentOffset >= maxAnchor || currentOffset <= minAnchor) {
                    availableVelocity = this.this$0.m422toVelocityadjELrA(consumed);
                }
                return Velocity.m7734boximpl(availableVelocity);
            }
        }
    }
    ...
    public void onDragStopped(DragEvent.DragStopped event) {
        if (getIsAttached()) {
            BuildersKt__Builders_commonKt.launch$default(getCoroutineScope(), null, null, new C02441(this, event, null), 3, null);
        }
    }
    ...
    */
    public final Object fling(float velocity, Continuation<? super Float> continuation) {
        AnonymousClass1 anonymousClass1;
        Ref.FloatRef leftoverVelocity;
        ...
        switch (anonymousClass12.label) {
            case 0:
                ...
                if (this.state.getUsePreModifierChangeBehavior$foundation()) {
                    ...
                    Object obj = anchoredDraggableState.settle(velocity, anonymousClass12);
                    if (obj == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    return obj;
                }
                Ref.FloatRef leftoverVelocity2 = new Ref.FloatRef();
                leftoverVelocity2.element = velocity;
                AnchoredDraggableState<T> anchoredDraggableState2 = this.state;
                C02432 c02432 = new C02432(this, leftoverVelocity2, velocity, null);
                anonymousClass12.L$0 = leftoverVelocity2;
                anonymousClass12.label = 2;
                if (AnchoredDraggableState.anchoredDrag$default(anchoredDraggableState2, null, c02432, anonymousClass12, 1, null) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                leftoverVelocity = leftoverVelocity2;
                break;
                break;
            case 1:
                ResultKt.throwOnFailure($result);
                return $result;
            case 2:
                leftoverVelocity = (Ref.FloatRef) anonymousClass12.L$0;
                ResultKt.throwOnFailure($result);
                break;
            default:
                throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
        }
        return Boxing.boxFloat(leftoverVelocity.element);
    }
    ...
    static final class C02432 extends SuspendLambda implements Function3<AnchoredDragScope, DraggableAnchors<T>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C02432(AnchoredDraggableNode<T> anchoredDraggableNode, Ref.FloatRef floatRef, float f, Continuation<? super C02432> continuation) {
            super(3, continuation);
            this.this$0 = anchoredDraggableNode;
        ...
        @Override // kotlin.jvm.functions.Function3
        public final Object invoke(AnchoredDragScope anchoredDragScope, DraggableAnchors<T> draggableAnchors, Continuation<? super Unit> continuation) {
            C02432 c02432 = new C02432(this.this$0, this.$leftoverVelocity, this.$velocity, continuation);
            c02432.L$0 = anchoredDragScope;
            return c02432.invokeSuspend(Unit.INSTANCE);
        }
    ...
    public final long m421toOffsettuRUvjQ(float $this$toOffset_u2dtuRUvjQ) {
    ...
    public final long m422toVelocityadjELrA(float $this$toVelocity_u2dadjELrA) {
    ...
    public final float m419toFloatTH1AsA0(long j) {
        return this.orientation == Orientation.Vertical ? Velocity.m7744getYimpl(j) : Velocity.m7743getXimpl(j);
    }
    ...
    public final long m417reverseIfNeededAH228Gc(long j) {
        return Velocity.m7749timesadjELrA(j, isReverseDirection() ? -1.0f : 1.0f);
    }
    ...
    public final long m418reverseIfNeededMKHz9U(long j) {
        return Offset.m4459timestuRUvjQ(j, isReverseDirection() ? -1.0f : 1.0f);
    }
}
