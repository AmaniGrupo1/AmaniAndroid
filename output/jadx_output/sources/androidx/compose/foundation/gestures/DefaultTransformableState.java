...
final class DefaultTransformableState implements TransformableState {
    ...
    private final TransformScope transformScope = new TransformScope() { // from class: androidx.compose.foundation.gestures.DefaultTransformableState$transformScope$1
        ...
        public void mo447transformByd4ec7I(float zoomChange, long panChange, float rotationChange) {
            this.this$0.getOnTransformation().invoke(Float.valueOf(zoomChange), Offset.m4441boximpl(panChange), Float.valueOf(rotationChange));
        }
    };
    ...
    @DebugMetadata(c = "androidx.compose.foundation.gestures.DefaultTransformableState$transform$2", f = "TransformableState.kt", i = {}, l = {GrpcUtil.DEFAULT_PORT_SSL}, m = "invokeSuspend", n = {}, s = {}, v = 1)
