...
final class DefaultScrollable2DState implements Scrollable2DState {
        ...
        public long mo446scrollByMKHz9U(long delta) {
            ...
            if (!Float.isNaN(Float.intBitsToFloat(bits$iv$iv$iv))) {
                ...
                if (!Float.isNaN(Float.intBitsToFloat(bits$iv$iv$iv2))) {
                    return this.this$0.getOnDelta().invoke(Offset.m4441boximpl(delta)).m4462unboximpl();
                }
            }
    ...
    public long mo445dispatchRawDeltaMKHz9U(long delta) {
        return this.onDelta.invoke(Offset.m4441boximpl(delta)).m4462unboximpl();
    }
    ...
    public boolean mo444canScrollk4lQ0M(long offset) {
        return true;
    }
}
