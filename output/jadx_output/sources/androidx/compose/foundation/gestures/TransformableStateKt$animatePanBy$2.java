...
final class TransformableStateKt$animatePanBy$2 extends SuspendLambda implements Function2<TransformScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                AnimationState animationState = new AnimationState(VectorConvertersKt.getVectorConverter(Offset.INSTANCE), Offset.m4441boximpl(this.$previous.element), null, 0L, 0L, false, 60, null);
                Offset offsetM4441boximpl = Offset.m4441boximpl(this.f19$$v$c$androidxcomposeuigeometryOffset$offset$0);
                ...
                Function1 function1 = new Function1() { // from class: androidx.compose.foundation.gestures.TransformableStateKt$animatePanBy$2$$ExternalSyntheticLambda0
                    ...
                    public final Object invoke(Object obj) {
                        return TransformableStateKt$animatePanBy$2.invokeSuspend$lambda$0(longRef, $this$transform, (AnimationScope) obj);
                    }
                };
                this.label = 1;
                if (SuspendAnimationKt.animateTo(animationState, offsetM4441boximpl, (4 & 2) != 0 ? AnimationSpecKt.spring$default(0.0f, 0.0f, null, 7, null) : animationSpec, (4 & 4) != 0 ? false : false, (4 & 8) != 0 ? new Function1() { // from class: androidx.compose.animation.core.SuspendAnimationKt$$ExternalSyntheticLambda9
                    @Override // kotlin.jvm.functions.Function1
                    public final Object invoke(Object obj) {
    ...
    static final Unit invokeSuspend$lambda$0(Ref.LongRef $previous, TransformScope $$this$transform, AnimationScope $this$animateTo) {
        long delta = Offset.m4456minusMKHz9U(((Offset) $this$animateTo.getValue()).m4462unboximpl(), $previous.element);
        TransformScope.m610transformByd4ec7I$default($$this$transform, 0.0f, delta, 0.0f, 5, null);
        $previous.element = ((Offset) $this$animateTo.getValue()).m4462unboximpl();
        return Unit.INSTANCE;
    }
}
