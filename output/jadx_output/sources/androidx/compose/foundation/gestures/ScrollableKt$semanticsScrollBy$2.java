...
final class ScrollableKt$semanticsScrollBy$2 extends SuspendLambda implements Function2<NestedScrollScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                float fM589toFloatk4lQ0M = this.$this_semanticsScrollBy.m589toFloatk4lQ0M(this.f14$$v$c$androidxcomposeuigeometryOffset$offset$0);
                final Ref.FloatRef floatRef = this.$previousValue;
                final ScrollingLogic scrollingLogic = this.$this_semanticsScrollBy;
                this.label = 1;
                if (SuspendAnimationKt.animate$default(0.0f, fM589toFloatk4lQ0M, 0.0f, null, new Function2() { // from class: androidx.compose.foundation.gestures.ScrollableKt$semanticsScrollBy$2$$ExternalSyntheticLambda0
                    @Override // kotlin.jvm.functions.Function2
    ...
    static final Unit invokeSuspend$lambda$0(Ref.FloatRef $previousValue, ScrollingLogic $this_semanticsScrollBy, NestedScrollScope $$this$scroll, float currentValue, float f) {
        ...
        float consumed = $this_semanticsScrollBy.reverseIfNeeded($this_semanticsScrollBy.m589toFloatk4lQ0M($$this$scroll.mo530scrollByOzD1aCk($this_semanticsScrollBy.m590toOffsettuRUvjQ($this_semanticsScrollBy.reverseIfNeeded(delta)), NestedScrollSource.INSTANCE.m5890getUserInputWNlRxjI())));
