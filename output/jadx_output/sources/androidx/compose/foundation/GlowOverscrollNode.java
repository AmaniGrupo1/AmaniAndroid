...
final class GlowOverscrollNode extends DelegatingNode implements DrawModifierNode {
    ...
    private final boolean drawLeftGlow(DrawScope $this$drawLeftGlow, EdgeEffect left, Canvas canvas) {
        int bits$iv$iv$iv = (int) ($this$drawLeftGlow.mo5271getSizeNHjbRc() & 4294967295L);
        float x$iv = -Float.intBitsToFloat(bits$iv$iv$iv);
        float y$iv = $this$drawLeftGlow.mo405toPx0680j_4(this.glowDrawPadding.mo768calculateLeftPaddingu2uoSUM($this$drawLeftGlow.getLayoutDirection()));
        long v1$iv$iv = Float.floatToRawIntBits(x$iv);
        long v2$iv$iv = Float.floatToRawIntBits(y$iv);
        long offset = Offset.m4444constructorimpl((v1$iv$iv << 32) | (4294967295L & v2$iv$iv));
        return m319drawWithRotationAndOffsetubNVwUQ(270.0f, offset, left, canvas);
    }

    private final boolean drawTopGlow(DrawScope $this$drawTopGlow, EdgeEffect top, Canvas canvas) {
        float y$iv = $this$drawTopGlow.mo405toPx0680j_4(this.glowDrawPadding.getTop());
        long v1$iv$iv = Float.floatToRawIntBits(0.0f);
        long v2$iv$iv = Float.floatToRawIntBits(y$iv);
        long offset = Offset.m4444constructorimpl((v1$iv$iv << 32) | (4294967295L & v2$iv$iv));
        return m319drawWithRotationAndOffsetubNVwUQ(0.0f, offset, top, canvas);
    }

    private final boolean drawRightGlow(DrawScope $this$drawRightGlow, EdgeEffect right, Canvas canvas) {
        int bits$iv$iv$iv = (int) ($this$drawRightGlow.mo5271getSizeNHjbRc() >> 32);
        int width = MathKt.roundToInt(Float.intBitsToFloat(bits$iv$iv$iv));
        float rightPadding = this.glowDrawPadding.mo769calculateRightPaddingu2uoSUM($this$drawRightGlow.getLayoutDirection());
        float y$iv = (-width) + $this$drawRightGlow.mo405toPx0680j_4(rightPadding);
        long v1$iv$iv = Float.floatToRawIntBits(0.0f);
        long v2$iv$iv = Float.floatToRawIntBits(y$iv);
        long offset = Offset.m4444constructorimpl((v1$iv$iv << 32) | (v2$iv$iv & 4294967295L));
        return m319drawWithRotationAndOffsetubNVwUQ(90.0f, offset, right, canvas);
    }

    private final boolean drawBottomGlow(DrawScope $this$drawBottomGlow, EdgeEffect bottom, Canvas canvas) {
        float bottomPadding = $this$drawBottomGlow.mo405toPx0680j_4(this.glowDrawPadding.getBottom());
        int bits$iv$iv$iv = (int) ($this$drawBottomGlow.mo5271getSizeNHjbRc() >> 32);
        float x$iv = -Float.intBitsToFloat(bits$iv$iv$iv);
        int bits$iv$iv$iv2 = (int) ($this$drawBottomGlow.mo5271getSizeNHjbRc() & 4294967295L);
        float y$iv = (-Float.intBitsToFloat(bits$iv$iv$iv2)) + bottomPadding;
        long v1$iv$iv = Float.floatToRawIntBits(x$iv);
        long v2$iv$iv = Float.floatToRawIntBits(y$iv);
        long offset = Offset.m4444constructorimpl((v1$iv$iv << 32) | (4294967295L & v2$iv$iv));
        return m319drawWithRotationAndOffsetubNVwUQ(180.0f, offset, bottom, canvas);
    }

    /* JADX INFO: renamed from: drawWithRotationAndOffset-ubNVwUQ, reason: not valid java name */
    private final boolean m319drawWithRotationAndOffsetubNVwUQ(float rotationDegrees, long offset, EdgeEffect edgeEffect, Canvas canvas) {
