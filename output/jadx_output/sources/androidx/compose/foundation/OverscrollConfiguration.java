...
public final class OverscrollConfiguration {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m4698equalsimpl0(this.glowColor, ((OverscrollConfiguration) other).glowColor) && Intrinsics.areEqual(this.drawPadding, ((OverscrollConfiguration) other).drawPadding);
    }

    public int hashCode() {
        int result = Color.m4704hashCodeimpl(this.glowColor);
        return (result * 31) + this.drawPadding.hashCode();
    }

    public String toString() {
        return "OverscrollConfiguration(glowColor=" + ((Object) Color.m4705toStringimpl(this.glowColor)) + ", drawPadding=" + this.drawPadding + ')';
    }
}
