...
abstract class BaseAndroidExternalSurfaceState implements AndroidExternalSurfaceScope, SurfaceScope {
    ...
    @DebugMetadata(c = "androidx.compose.foundation.BaseAndroidExternalSurfaceState$dispatchSurfaceCreated$1", f = "AndroidExternalSurface.android.kt", i = {0}, l = {TsExtractor.TS_STREAM_TYPE_HDMV_DTS, TsExtractor.TS_STREAM_TYPE_DTS_HD}, m = "invokeSuspend", n = {"$this$launch"}, s = {"L$0"}, v = 1)
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    BaseAndroidExternalSurfaceState$dispatchSurfaceCreated$1$receiver$1 receiver = new BaseAndroidExternalSurfaceState$dispatchSurfaceCreated$1$receiver$1(BaseAndroidExternalSurfaceState.this, $this$launch);
                    function5 = BaseAndroidExternalSurfaceState.this.onSurface;
                    if (function5 != null) {
                        ...
                        this.L$0 = null;
                        this.label = 2;
                        if (function5.invoke(receiver, surface, numBoxInt, numBoxInt2, this) == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                    }
                ...
                case 1:
                    $this$launch = (CoroutineScope) this.L$0;
                    ResultKt.throwOnFailure($result);
                    BaseAndroidExternalSurfaceState$dispatchSurfaceCreated$1$receiver$1 receiver2 = new BaseAndroidExternalSurfaceState$dispatchSurfaceCreated$1$receiver$1(BaseAndroidExternalSurfaceState.this, $this$launch);
                    function5 = BaseAndroidExternalSurfaceState.this.onSurface;
                    if (function5 != null) {
                    }
                    return Unit.INSTANCE;
