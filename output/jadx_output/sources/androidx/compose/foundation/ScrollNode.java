...
public final class ScrollNode extends Modifier.Node implements LayoutModifierNode, SemanticsModifierNode {
    ...
    public MeasureResult mo69measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long j) {
        ...
        long childConstraints = Constraints.m7447copyZbe2FdA(j, (11 & 1) != 0 ? Constraints.m7460getMinWidthimpl(j) : 0, (11 & 2) != 0 ? Constraints.m7458getMaxWidthimpl(j) : this.isVertical ? Constraints.m7458getMaxWidthimpl(j) : Integer.MAX_VALUE, (11 & 4) != 0 ? Constraints.m7459getMinHeightimpl(j) : 0, (11 & 8) != 0 ? Constraints.m7457getMaxHeightimpl(j) : this.isVertical ? Integer.MAX_VALUE : Constraints.m7457getMaxHeightimpl(j));
        final Placeable placeable = measurable.mo6141measureBRTryo0(childConstraints);
        int width = RangesKt.coerceAtMost(placeable.getWidth(), Constraints.m7458getMaxWidthimpl(j));
        int height = RangesKt.coerceAtMost(placeable.getHeight(), Constraints.m7457getMaxHeightimpl(j));
