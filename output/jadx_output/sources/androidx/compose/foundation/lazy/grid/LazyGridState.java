...
public final class LazyGridState implements ScrollableState {
    ...
    static final class C03032 extends SuspendLambda implements Function2<ScrollScope, Continuation<? super Unit>, Object> {
        final /* synthetic */ int $index;
        final /* synthetic */ int $scrollOffset;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C03032(int i, int i2, Continuation<? super C03032> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return LazyGridState.this.new C03032(this.$index, this.$scrollOffset, continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(ScrollScope scrollScope, Continuation<? super Unit> continuation) {
            return ((C03032) create(scrollScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public final Object scrollToItem(int index, int scrollOffset, Continuation<? super Unit> continuation) {
        Object objScroll$default = ScrollableState.scroll$default(this, null, new C03032(index, scrollOffset, null), continuation, 1, null);
    ...
    */
    public Object scroll(MutatePriority scrollPriority, Function2<? super ScrollScope, ? super Continuation<? super Unit>, ? extends Object> function2, Continuation<? super Unit> continuation) {
        ...
        Object $result = c03021.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        switch (c03021.label) {
            case 0:
                ResultKt.throwOnFailure($result);
                lazyGridState = this;
                if (lazyGridState.layoutInfoState.getValue() == LazyGridStateKt.EmptyLazyGridLayoutInfo) {
                    AwaitFirstLayoutModifier awaitFirstLayoutModifier = lazyGridState.awaitLayoutModifier;
                    c03021.L$0 = scrollPriority;
                    c03021.L$1 = function2;
                    c03021.label = 1;
                    if (awaitFirstLayoutModifier.waitForFirstLayout(c03021) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                ...
                c03021.L$1 = null;
                c03021.label = 2;
                if (scrollableState.scroll(scrollPriority, function2, c03021) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                return Unit.INSTANCE;
            case 1:
                lazyGridState2 = this;
                function2 = (Function2) c03021.L$1;
                scrollPriority2 = (MutatePriority) c03021.L$0;
                ResultKt.throwOnFailure($result);
    ...
    public final void applyMeasureResult$foundation(LazyGridMeasureResult result, boolean isLookingAhead, boolean visibleItemsStayedTheSame) {
        ...
        if (visibleItemsStayedTheSame) {
            ...
            if (this.prefetchingEnabled) {
                LazyGridPrefetchStrategy $this$applyMeasureResult_u24lambda_u240 = this.prefetchStrategy;
                $this$applyMeasureResult_u24lambda_u240.onVisibleItemsUpdated(this.prefetchScope, result);
            }
        }
        if (isLookingAhead) {
