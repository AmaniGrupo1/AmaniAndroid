...
public abstract class LazyGridMeasuredLineProvider {
    ...
    public final long m962childConstraintsJhjzzOo$foundation(int startSlot, int span) {
        int i;
        ...
        if (this.isVertical) {
            return Constraints.INSTANCE.m7470fixedWidthOenEA2s(crossAxisSize);
        }
        return Constraints.INSTANCE.m7469fixedHeightOenEA2s(crossAxisSize);
    }
    ...
    public final LazyGridMeasuredLine getAndMeasure(int lineIndex) {
        ...
        for (int i2 = 0; i2 < lineItemsCount; i2++) {
            int span = GridItemSpan.m942getCurrentLineSpanimpl(lineConfiguration.getSpans().get(i2).getPackedValue());
            long constraints = m962childConstraintsJhjzzOo$foundation(startSlot, span);
            LazyGridMeasuredItem lazyGridMeasuredItemM961getAndMeasurem8Kt_7k = this.measuredItemProvider.m961getAndMeasurem8Kt_7k(lineConfiguration.getFirstItemIndex() + i2, constraints, startSlot, span, mainAxisSpacing);
            startSlot += span;
            Unit unit = Unit.INSTANCE;
            items[i2] = lazyGridMeasuredItemM961getAndMeasurem8Kt_7k;
        }
