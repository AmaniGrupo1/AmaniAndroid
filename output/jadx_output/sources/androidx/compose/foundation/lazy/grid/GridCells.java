...
public interface GridCells {
    ...
    public static final class Adaptive implements GridCells {
        ...
        private Adaptive(float minSize) {
            ...
            boolean value$iv = Dp.m7504compareTo0680j_4(this.minSize, Dp.m7505constructorimpl((float) 0)) > 0;
            if (value$iv) {
                return;
            }
        ...
        @Override // androidx.compose.foundation.lazy.grid.GridCells
        public List<Integer> calculateCrossAxisCellSizes(Density $this$calculateCrossAxisCellSizes, int availableSize, int spacing) {
            int count = Math.max((availableSize + spacing) / ($this$calculateCrossAxisCellSizes.mo399roundToPx0680j_4(this.minSize) + spacing), 1);
            return LazyGridDslKt.calculateCellsCrossAxisSizeImpl(availableSize, count, spacing);
        }

        public int hashCode() {
            return Dp.m7511hashCodeimpl(this.minSize);
        }

        public boolean equals(Object other) {
            return (other instanceof Adaptive) && Dp.m7510equalsimpl0(this.minSize, ((Adaptive) other).minSize);
        }
    }
    ...
    public static final class FixedSize implements GridCells {
        ...
        private FixedSize(float size) {
            this.size = size;
            boolean value$iv = Dp.m7504compareTo0680j_4(this.size, Dp.m7505constructorimpl((float) 0)) > 0;
            if (value$iv) {
                return;
            }
        ...
        @Override // androidx.compose.foundation.lazy.grid.GridCells
        public List<Integer> calculateCrossAxisCellSizes(Density $this$calculateCrossAxisCellSizes, int availableSize, int spacing) {
            int cellSize = $this$calculateCrossAxisCellSizes.mo399roundToPx0680j_4(this.size);
            int i = 0;
        ...
        public int hashCode() {
            return Dp.m7511hashCodeimpl(this.size);
        }

        public boolean equals(Object other) {
            return (other instanceof FixedSize) && Dp.m7510equalsimpl0(this.size, ((FixedSize) other).size);
        }
    }
}
