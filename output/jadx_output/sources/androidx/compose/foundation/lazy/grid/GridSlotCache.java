...
final class GridSlotCache implements LazyGridSlotsProvider {
    ...
    public LazyGridSlots mo946invoke0kLqBqw(Density density, long constraints) {
        ...
        LazyGridSlots lazyGridSlotsInvoke = this.calculation.invoke(density, Constraints.m7445boximpl(constraints));
