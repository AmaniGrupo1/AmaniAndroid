...
public final class LazyGridDslKt {
    ...
    public static final void LazyVerticalGrid(final GridCells columns, Modifier modifier, LazyGridState state, PaddingValues contentPadding, boolean reverseLayout, Arrangement.Vertical verticalArrangement, Arrangement.Horizontal horizontalArrangement, FlingBehavior flingBehavior, boolean userScrollEnabled, OverscrollEffect overscrollEffect, final Function1<? super LazyGridScope, Unit> function1, Composer $composer, final int $changed, final int $changed1, final int i) {
        ...
        if ($composer3.shouldExecute((($dirty2 & 306783379) == 306783378 && ($dirty12 & 3) == 2) ? false : true, $dirty2 & 1)) {
            ...
            $composer2 = $composer3;
            LazyGridKt.LazyGrid(modifier4, state4, rememberColumnWidthSums(columns, horizontalArrangement3, $composer3, ($dirty2 & 14) | (($dirty2 >> 15) & 112)), contentPadding4, reverseLayout4, true, flingBehavior4, userScrollEnabled4, overscrollEffect3, verticalArrangement4, horizontalArrangement4, function1, $composer2, i4 | (($dirty2 >> 3) & 14) | (($dirty2 >> 3) & 112) | ($dirty2 & 7168) | (57344 & $dirty2) | (($dirty2 >> 3) & 3670016) | (($dirty2 >> 3) & 29360128) | (($dirty2 >> 3) & 234881024) | (($dirty2 << 12) & C.ENCODING_PCM_DOUBLE), (($dirty2 >> 18) & 14) | (($dirty12 << 3) & 112), 0);
            if (ComposerKt.isTraceInProgress()) {
    ...
    public static final void LazyHorizontalGrid(final GridCells rows, Modifier modifier, LazyGridState state, PaddingValues contentPadding, boolean reverseLayout, Arrangement.Horizontal horizontalArrangement, Arrangement.Vertical verticalArrangement, FlingBehavior flingBehavior, boolean userScrollEnabled, OverscrollEffect overscrollEffect, final Function1<? super LazyGridScope, Unit> function1, Composer $composer, final int $changed, final int $changed1, final int i) {
        ...
        if ($composer3.shouldExecute((($dirty2 & 306783379) == 306783378 && ($dirty12 & 3) == 2) ? false : true, $dirty2 & 1)) {
            ...
            $composer2 = $composer3;
            LazyGridKt.LazyGrid(modifier4, state4, rememberRowHeightSums(rows, verticalArrangement3, $composer3, ($dirty2 & 14) | (($dirty2 >> 15) & 112)), contentPadding4, reverseLayout4, false, flingBehavior4, userScrollEnabled4, overscrollEffect3, verticalArrangement4, horizontalArrangement4, function1, $composer2, i4 | (($dirty2 >> 3) & 14) | (($dirty2 >> 3) & 112) | ($dirty2 & 7168) | (57344 & $dirty2) | (($dirty2 >> 3) & 3670016) | (($dirty2 >> 3) & 29360128) | (($dirty2 >> 3) & 234881024) | (($dirty2 << 9) & C.ENCODING_PCM_DOUBLE), (($dirty2 >> 15) & 14) | (($dirty12 << 3) & 112), 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            $dirty1 = $dirty12;
    ...
    public static final LazyGridSlots rememberColumnWidthSums$lambda$0$0(GridCells $columns, Arrangement.Horizontal $horizontalArrangement, Density $this$GridSlotCache, Constraints constraints) {
        ...
        int gridWidth = Constraints.m7458getMaxWidthimpl(constraints.getValue());
        int[] sizes = CollectionsKt.toIntArray($columns.calculateCrossAxisCellSizes($this$GridSlotCache, gridWidth, $this$GridSlotCache.mo399roundToPx0680j_4($horizontalArrangement.getSpacing())));
    ...
    public static final LazyGridSlots rememberRowHeightSums$lambda$0$0(GridCells $rows, Arrangement.Vertical $verticalArrangement, Density $this$GridSlotCache, Constraints constraints) {
        ...
        int gridHeight = Constraints.m7457getMaxHeightimpl(constraints.getValue());
        int[] sizes = CollectionsKt.toIntArray($rows.calculateCrossAxisCellSizes($this$GridSlotCache, gridHeight, $this$GridSlotCache.mo399roundToPx0680j_4($verticalArrangement.getSpacing())));
        int[] positions = new int[sizes.length];
    ...
    public static /* synthetic */ void itemsIndexed$default(LazyGridScope $this$itemsIndexed_u24default, List items, Function2 key, Function3 span, Function2 contentType, Function5 itemContent, int i, Object obj) {
        ...
        $this$itemsIndexed_u24default.items(items.size(), key != null ? new C02942(key, items) : null, span != null ? new C02953(span, items) : null, new C02964(contentType, items), ComposableLambdaKt.composableLambdaInstance(-1942245546, true, new C02975(itemContent, items)));
    }
    ...
    /* JADX INFO: compiled from: LazyGridDsl.kt */
    @Metadata(k = 3, mv = {2, 0, 0}, xi = 176)
    public static final class C02942 implements Function1<Integer, Object> {
        final /* synthetic */ List<T> $items;
        final /* synthetic */ Function2<Integer, T, Object> $key;

        /* JADX WARN: Multi-variable type inference failed */
        public C02942(Function2<? super Integer, ? super T, ? extends Object> function2, List<? extends T> list) {
            this.$key = function2;
            this.$items = list;
        }
    ...
    /* JADX INFO: compiled from: LazyGridDsl.kt */
    @Metadata(k = 3, mv = {2, 0, 0}, xi = 176)
    public static final class C02953 implements Function2<LazyGridItemSpanScope, Integer, GridItemSpan> {
        final /* synthetic */ List<T> $items;
        final /* synthetic */ Function3<LazyGridItemSpanScope, Integer, T, GridItemSpan> $span;

        /* JADX WARN: Multi-variable type inference failed */
        public C02953(Function3<? super LazyGridItemSpanScope, ? super Integer, ? super T, GridItemSpan> function3, List<? extends T> list) {
            this.$span = function3;
            this.$items = list;
        }
    ...
    /* JADX INFO: compiled from: LazyGridDsl.kt */
    @Metadata(k = 3, mv = {2, 0, 0}, xi = 176)
    public static final class C02964 implements Function1<Integer, Object> {
        final /* synthetic */ Function2<Integer, T, Object> $contentType;
        final /* synthetic */ List<T> $items;

        /* JADX WARN: Multi-variable type inference failed */
        public C02964(Function2<? super Integer, ? super T, ? extends Object> function2, List<? extends T> list) {
    ...
    public static final <T> void itemsIndexed(LazyGridScope $this$itemsIndexed, List<? extends T> list, Function2<? super Integer, ? super T, ? extends Object> function2, Function3<? super LazyGridItemSpanScope, ? super Integer, ? super T, GridItemSpan> function3, Function2<? super Integer, ? super T, ? extends Object> function22, Function5<? super LazyGridItemScope, ? super Integer, ? super T, ? super Composer, ? super Integer, Unit> function5) {
        $this$itemsIndexed.items(list.size(), function2 != null ? new C02942(function2, list) : null, function3 != null ? new C02953(function3, list) : null, new C02964(function22, list), ComposableLambdaKt.composableLambdaInstance(-1942245546, true, new C02975(function5, list)));
    }
    ...
    /* JADX INFO: compiled from: LazyGridDsl.kt */
    @Metadata(k = 3, mv = {2, 0, 0}, xi = 176)
    public static final class C02975 implements Function4<LazyGridItemScope, Integer, Composer, Integer, Unit> {
        final /* synthetic */ Function5<LazyGridItemScope, Integer, T, Composer, Integer, Unit> $itemContent;
        final /* synthetic */ List<T> $items;

        /* JADX WARN: Multi-variable type inference failed */
        public C02975(Function5<? super LazyGridItemScope, ? super Integer, ? super T, ? super Composer, ? super Integer, Unit> function5, List<? extends T> list) {
    ...
    public static final class AnonymousClass8 implements Function2<LazyGridItemSpanScope, Integer, GridItemSpan> {
         ...
         */
        /* JADX INFO: renamed from: invoke-_-orMbw, reason: not valid java name */
        public final long m948invoke_orMbw(LazyGridItemSpanScope $this$items, int it) {
    ...
    public static /* synthetic */ void itemsIndexed$default(LazyGridScope $this$itemsIndexed_u24default, Object[] items, Function2 key, Function3 span, Function2 contentType, Function5 itemContent, int i, Object obj) {
        ...
        $this$itemsIndexed_u24default.items(items.length, key != null ? new C02997(key, items) : null, span != null ? new C03008(span, items) : null, new C03019(contentType, items), ComposableLambdaKt.composableLambdaInstance(49283819, true, new C029310(itemContent, items)));
    }
    ...
    /* JADX INFO: compiled from: LazyGridDsl.kt */
    @Metadata(k = 3, mv = {2, 0, 0}, xi = 176)
    public static final class C02997 implements Function1<Integer, Object> {
        final /* synthetic */ T[] $items;
        final /* synthetic */ Function2<Integer, T, Object> $key;

        /* JADX WARN: Multi-variable type inference failed */
        public C02997(Function2<? super Integer, ? super T, ? extends Object> function2, T[] tArr) {
            this.$key = function2;
            this.$items = tArr;
        }
    ...
    /* JADX INFO: compiled from: LazyGridDsl.kt */
    @Metadata(k = 3, mv = {2, 0, 0}, xi = 176)
    public static final class C03008 implements Function2<LazyGridItemSpanScope, Integer, GridItemSpan> {
        final /* synthetic */ T[] $items;
        final /* synthetic */ Function3<LazyGridItemSpanScope, Integer, T, GridItemSpan> $span;

        /* JADX WARN: Multi-variable type inference failed */
        public C03008(Function3<? super LazyGridItemSpanScope, ? super Integer, ? super T, GridItemSpan> function3, T[] tArr) {
            this.$span = function3;
            this.$items = tArr;
        }
         ...
         */
        /* JADX INFO: renamed from: invoke-_-orMbw, reason: not valid java name */
        public final long m950invoke_orMbw(LazyGridItemSpanScope $this$items, int it) {
    ...
    /* JADX INFO: compiled from: LazyGridDsl.kt */
    @Metadata(k = 3, mv = {2, 0, 0}, xi = 176)
    public static final class C03019 implements Function1<Integer, Object> {
        final /* synthetic */ Function2<Integer, T, Object> $contentType;
        final /* synthetic */ T[] $items;

        /* JADX WARN: Multi-variable type inference failed */
        public C03019(Function2<? super Integer, ? super T, ? extends Object> function2, T[] tArr) {
            this.$contentType = function2;
            this.$items = tArr;
        }
    ...
    public static final <T> void itemsIndexed(LazyGridScope $this$itemsIndexed, T[] tArr, Function2<? super Integer, ? super T, ? extends Object> function2, Function3<? super LazyGridItemSpanScope, ? super Integer, ? super T, GridItemSpan> function3, Function2<? super Integer, ? super T, ? extends Object> function22, Function5<? super LazyGridItemScope, ? super Integer, ? super T, ? super Composer, ? super Integer, Unit> function5) {
        $this$itemsIndexed.items(tArr.length, function2 != null ? new C02997(function2, tArr) : null, function3 != null ? new C03008(function3, tArr) : null, new C03019(function22, tArr), ComposableLambdaKt.composableLambdaInstance(49283819, true, new C029310(function5, tArr)));
    }
    ...
    /* JADX INFO: compiled from: LazyGridDsl.kt */
    @Metadata(k = 3, mv = {2, 0, 0}, xi = 176)
    public static final class C029310 implements Function4<LazyGridItemScope, Integer, Composer, Integer, Unit> {
        final /* synthetic */ Function5<LazyGridItemScope, Integer, T, Composer, Integer, Unit> $itemContent;
        final /* synthetic */ T[] $items;

        /* JADX WARN: Multi-variable type inference failed */
        public C029310(Function5<? super LazyGridItemScope, ? super Integer, ? super T, ? super Composer, ? super Integer, Unit> function5, T[] tArr) {
            this.$itemContent = function5;
            this.$items = tArr;
        }
