...
public final class LazyListStateKt {
    ...
    public static final LazyListState rememberLazyListState(final int initialFirstVisibleItemIndex, final int initialFirstVisibleItemScrollOffset, Composer $composer, int $changed, int i) {
        ...
        LazyListState lazyListState = (LazyListState) RememberSaveableKt.m4138rememberSaveable(objArr, (Saver) saver, (Function0) it$iv, $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static final LazyListState rememberLazyListState(int initialFirstVisibleItemIndex, int initialFirstVisibleItemScrollOffset, LazyListPrefetchStrategy prefetchStrategy, Composer $composer, int $changed, int i) {
        ...
        if (((($changed & 896) ^ RendererCapabilities.DECODER_SUPPORT_MASK) <= 256 || !$composer.changedInstance(prefetchStrategy2)) && ($changed & RendererCapabilities.DECODER_SUPPORT_MASK) != 256) {
            z = false;
        }
        boolean invalid$iv = z2 | z;
        ...
        ComposerKt.sourceInformationMarkerEnd($composer);
        LazyListState lazyListState = (LazyListState) RememberSaveableKt.m4138rememberSaveable(objArr, (Saver) saverSaver$foundation, (Function0) it$iv2, $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd($composer);
    ...
    public static final LazyListState rememberLazyListState(final LazyLayoutCacheWindow cacheWindow, final int initialFirstVisibleItemIndex, final int initialFirstVisibleItemScrollOffset, Composer $composer, int $changed, int i) {
        ...
        if (((($changed & 896) ^ RendererCapabilities.DECODER_SUPPORT_MASK) <= 256 || !$composer.changed(initialFirstVisibleItemScrollOffset)) && ($changed & RendererCapabilities.DECODER_SUPPORT_MASK) != 256) {
            z = false;
        }
        boolean invalid$iv = z2 | z;
        Object it$iv = $composer.rememberedValue();
        ...
        ComposerKt.sourceInformationMarkerEnd($composer);
        LazyListState lazyListState = (LazyListState) RememberSaveableKt.m4138rememberSaveable(objArr, (Saver) saverSaver$foundation, (Function0) it$iv, $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd($composer);
