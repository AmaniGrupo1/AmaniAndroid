...
final class LazyStaggeredGridSlotCache implements LazyGridStaggeredGridSlotsProvider {
    ...
    public LazyStaggeredGridSlots mo1025invoke0kLqBqw(Density density, long constraints) {
        if (this.cachedSizes != null && Constraints.m7451equalsimpl0(this.cachedConstraints, constraints)) {
        ...
        LazyStaggeredGridSlots lazyStaggeredGridSlotsInvoke = this.calculation.invoke(density, Constraints.m7445boximpl(constraints));
