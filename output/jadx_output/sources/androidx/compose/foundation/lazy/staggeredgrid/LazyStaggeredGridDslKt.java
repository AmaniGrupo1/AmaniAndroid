...
public final class LazyStaggeredGridDslKt {
    ...
    public static final void m1028LazyVerticalStaggeredGrid6qCrX9Q(final StaggeredGridCells columns, Modifier modifier, LazyStaggeredGridState state, PaddingValues contentPadding, boolean reverseLayout, float f, Arrangement.Horizontal horizontalArrangement, FlingBehavior flingBehavior, boolean userScrollEnabled, OverscrollEffect overscrollEffect, final Function1<? super LazyStaggeredGridScope, Unit> function1, Composer $composer, final int $changed, final int $changed1, final int i) {
        ...
        if (i8 != 0) {
            ...
            fM7505constructorimpl = f;
        } else if (($changed & ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE) == 0) {
            fM7505constructorimpl = f;
            $dirty2 |= $composer3.changed(fM7505constructorimpl) ? 131072 : 65536;
        } else {
            fM7505constructorimpl = f;
        }
        int i9 = i & 64;
        ...
        if (($changed & 805306368) == 0) {
            $dirty2 |= ((i & 512) == 0 && $composer3.changed(overscrollEffect)) ? C.BUFFER_FLAG_LAST_SAMPLE : 268435456;
        }
        if (($changed1 & 6) == 0) {
        ...
        if ($composer3.shouldExecute((($dirty2 & 306783379) == 306783378 && ($dirty12 & 3) == 2) ? false : true, $dirty2 & 1)) {
            ...
            if (($changed & 1) == 0 || $composer3.getDefaultsInvalid()) {
                ...
                horizontalArrangement3 = i9 != 0 ? Arrangement.INSTANCE.m688spacedBy0680j_4(Dp.m7505constructorimpl(0)) : horizontalArrangement;
                if ((i & 128) != 0) {
            ...
            LazyStaggeredGridKt.m1033LazyStaggeredGridw41Enmo(state4, Orientation.Vertical, rememberColumnSlots(columns, horizontalArrangement3, contentPadding2, $composer3, ($dirty2 & 14) | (($dirty2 >> 15) & 112) | (($dirty2 >> 3) & 896)), modifier4, contentPadding4, reverseLayout4, flingBehavior4, userScrollEnabled3, overscrollEffect3, f3, horizontalArrangement3.getSpacing(), function1, $composer2, (($dirty2 >> 6) & 14) | 48 | (($dirty2 << 6) & 7168) | (($dirty2 << 3) & 57344) | (($dirty2 << 3) & 458752) | (($dirty2 >> 3) & 3670016) | (($dirty2 >> 3) & 29360128) | (($dirty2 >> 3) & 234881024) | (($dirty2 << 12) & C.ENCODING_PCM_DOUBLE), ($dirty12 << 3) & 112, 0);
            if (ComposerKt.isTraceInProgress()) {
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2() { // from class: androidx.compose.foundation.lazy.staggeredgrid.LazyStaggeredGridDslKt$$ExternalSyntheticLambda0
                ...
                public final Object invoke(Object obj, Object obj2) {
                    return LazyStaggeredGridDslKt.LazyVerticalStaggeredGrid_6qCrX9Q$lambda$0(columns, modifier3, state3, contentPadding3, reverseLayout3, f2, horizontalArrangement2, flingBehavior2, userScrollEnabled2, overscrollEffect2, function1, $changed, $changed1, i, (Composer) obj, ((Integer) obj2).intValue());
                }
            });
        }
    }
    ...
    public static final /* synthetic */ void m1029LazyVerticalStaggeredGridzadm560(final StaggeredGridCells columns, Modifier modifier, LazyStaggeredGridState state, PaddingValues contentPadding, boolean reverseLayout, float f, Arrangement.Horizontal horizontalArrangement, FlingBehavior flingBehavior, boolean userScrollEnabled, final Function1 content, Composer $composer, final int $changed, final int i) {
        ...
        if (($changed & 805306368) == 0) {
            $dirty |= $composer3.changedInstance(content) ? C.BUFFER_FLAG_LAST_SAMPLE : 268435456;
        }
        if ($composer3.shouldExecute(($dirty & 306783379) != 306783378, $dirty & 1)) {
            ...
            if (($changed & 1) == 0 || $composer3.getDefaultsInvalid()) {
                ...
                PaddingValues contentPadding4 = i8 != 0 ? PaddingKt.m811PaddingValues0680j_4(Dp.m7505constructorimpl(0)) : paddingValues;
                boolean reverseLayout4 = i9 != 0 ? false : z;
                float fM7505constructorimpl = i10 != 0 ? Dp.m7505constructorimpl(0) : f2;
                Arrangement.HorizontalOrVertical horizontalArrangement4 = i11 != 0 ? Arrangement.INSTANCE.m688spacedBy0680j_4(Dp.m7505constructorimpl(0)) : horizontalArrangement;
                if ((i & 128) != 0) {
                    flingBehavior3 = ScrollableDefaults.INSTANCE.flingBehavior($composer3, 6);
                    $dirty &= i3;
                } else {
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2() { // from class: androidx.compose.foundation.lazy.staggeredgrid.LazyStaggeredGridDslKt$$ExternalSyntheticLambda5
                @Override // kotlin.jvm.functions.Function2
                public final Object invoke(Object obj, Object obj2) {
                    return LazyStaggeredGridDslKt.LazyVerticalStaggeredGrid_zadm560$lambda$0(columns, modifier2, state2, contentPadding2, reverseLayout2, f3, horizontalArrangement2, flingBehavior2, userScrollEnabled2, content, $changed, i, (Composer) obj, ((Integer) obj2).intValue());
                }
            });
        }
    }
    ...
    private static final LazyGridStaggeredGridSlotsProvider rememberColumnSlots(final StaggeredGridCells columns, final Arrangement.Horizontal horizontalArrangement, final PaddingValues contentPadding, Composer $composer, int $changed) {
        ...
        boolean invalid$iv = (((($changed & 14) ^ 6) > 4 && $composer.changed(columns)) || ($changed & 6) == 4) | (((($changed & 112) ^ 48) > 32 && $composer.changed(horizontalArrangement)) || ($changed & 48) == 32) | (((($changed & 896) ^ RendererCapabilities.DECODER_SUPPORT_MASK) > 256 && $composer.changed(contentPadding)) || ($changed & RendererCapabilities.DECODER_SUPPORT_MASK) == 256);
    ...
    public static final LazyStaggeredGridSlots rememberColumnSlots$lambda$0$0(PaddingValues $contentPadding, StaggeredGridCells $columns, Arrangement.Horizontal $horizontalArrangement, Density $this$LazyStaggeredGridSlotCache, Constraints constraints) {
        boolean value$iv = Constraints.m7458getMaxWidthimpl(constraints.getValue()) != Integer.MAX_VALUE;
        if (!value$iv) {
            InlineClassHelperKt.throwIllegalArgumentException("LazyVerticalStaggeredGrid's width should be bound by parent.");
        }
        int gridWidth = Constraints.m7458getMaxWidthimpl(constraints.getValue()) - $this$LazyStaggeredGridSlotCache.mo399roundToPx0680j_4(Dp.m7505constructorimpl(PaddingKt.calculateStartPadding($contentPadding, LayoutDirection.Ltr) + PaddingKt.calculateEndPadding($contentPadding, LayoutDirection.Ltr)));
        int[] sizes = $columns.calculateCrossAxisCellSizes($this$LazyStaggeredGridSlotCache, gridWidth, $this$LazyStaggeredGridSlotCache.mo399roundToPx0680j_4($horizontalArrangement.getSpacing()));
    ...
    public static final void m1026LazyHorizontalStaggeredGrid121YqSk(final StaggeredGridCells rows, Modifier modifier, LazyStaggeredGridState state, PaddingValues contentPadding, boolean reverseLayout, Arrangement.Vertical verticalArrangement, float f, FlingBehavior flingBehavior, boolean userScrollEnabled, OverscrollEffect overscrollEffect, final Function1<? super LazyStaggeredGridScope, Unit> function1, Composer $composer, final int $changed, final int $changed1, final int i) {
        ...
        if (i9 != 0) {
            ...
            $dirty2 |= $composer3.changed(f) ? 1048576 : 524288;
        }
        if (($changed & 12582912) == 0) {
            $dirty2 |= ((i & 128) == 0 && $composer3.changed(flingBehavior)) ? 8388608 : 4194304;
        }
        ...
        if ($composer3.shouldExecute((($dirty2 & 306783379) == 306783378 && ($dirty12 & 3) == 2) ? false : true, $dirty2 & 1)) {
            ...
            if (($changed & 1) != 0 && !$composer3.getDefaultsInvalid()) {
                ...
                if (i8 != 0) {
                    verticalArrangement2 = Arrangement.INSTANCE.m688spacedBy0680j_4(Dp.m7505constructorimpl(0));
                }
                if (i9 == 0) {
                    fM7505constructorimpl = f;
                } else {
            ...
            Modifier modifier4 = modifier2;
            PaddingValues contentPadding4 = contentPadding2;
            LazyStaggeredGridKt.m1033LazyStaggeredGridw41Enmo(state4, Orientation.Horizontal, rememberRowSlots(rows, verticalArrangement2, contentPadding2, $composer3, ($dirty2 & 14) | (($dirty2 >> 12) & 112) | (($dirty2 >> 3) & 896)), modifier4, contentPadding4, reverseLayout4, flingBehavior4, userScrollEnabled4, overscrollEffect3, f3, verticalArrangement2.getSpacing(), function1, $composer2, (($dirty2 >> 6) & 14) | 48 | (($dirty2 << 6) & 7168) | (($dirty2 << 3) & 57344) | (($dirty2 << 3) & 458752) | (($dirty2 >> 3) & 3670016) | (($dirty2 >> 3) & 29360128) | (($dirty2 >> 3) & 234881024) | (($dirty2 << 9) & C.ENCODING_PCM_DOUBLE), ($dirty12 << 3) & 112, 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            LazyStaggeredGridState lazyStaggeredGridState = state4;
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2() { // from class: androidx.compose.foundation.lazy.staggeredgrid.LazyStaggeredGridDslKt$$ExternalSyntheticLambda4
                @Override // kotlin.jvm.functions.Function2
                public final Object invoke(Object obj, Object obj2) {
                    return LazyStaggeredGridDslKt.LazyHorizontalStaggeredGrid_121YqSk$lambda$0(rows, modifier3, state3, contentPadding3, reverseLayout3, verticalArrangement3, f2, flingBehavior2, userScrollEnabled2, overscrollEffect2, function1, $changed, $changed1, i, (Composer) obj, ((Integer) obj2).intValue());
                }
            });
        }
    }
    ...
    public static final /* synthetic */ void m1027LazyHorizontalStaggeredGridcJHQLPU(final StaggeredGridCells rows, Modifier modifier, LazyStaggeredGridState state, PaddingValues contentPadding, boolean reverseLayout, Arrangement.Vertical verticalArrangement, float f, FlingBehavior flingBehavior, boolean userScrollEnabled, final Function1 content, Composer $composer, final int $changed, final int i) {
        ...
        if ($composer3.shouldExecute(($dirty & 306783379) != 306783378, $dirty & 1)) {
            ...
            if (($changed & 1) == 0 || $composer3.getDefaultsInvalid()) {
                ...
                PaddingValues contentPadding4 = i8 != 0 ? PaddingKt.m811PaddingValues0680j_4(Dp.m7505constructorimpl(0)) : paddingValues;
                boolean reverseLayout4 = i9 != 0 ? false : z;
                Arrangement.HorizontalOrVertical verticalArrangement4 = i10 != 0 ? Arrangement.INSTANCE.m688spacedBy0680j_4(Dp.m7505constructorimpl(0)) : vertical;
                float fM7505constructorimpl = i11 != 0 ? Dp.m7505constructorimpl(0) : f;
                if ((i & 128) != 0) {
                    flingBehavior3 = ScrollableDefaults.INSTANCE.flingBehavior($composer3, 6);
                    $dirty &= i3;
                } else {
            ...
            $composer2 = $composer3;
            m1026LazyHorizontalStaggeredGrid121YqSk(staggeredGridCells, modifier3, state4, contentPadding3, reverseLayout3, verticalArrangement3, f3, flingBehavior4, userScrollEnabled3, OverscrollKt.rememberOverscrollEffect($composer3, i4), content, $composer2, ($dirty & 14) | ($dirty & 112) | ($dirty & 896) | ($dirty & 7168) | (57344 & $dirty) | (458752 & $dirty) | (3670016 & $dirty) | (29360128 & $dirty) | (234881024 & $dirty), ($dirty >> 27) & 14, 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            modifier2 = modifier3;
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2() { // from class: androidx.compose.foundation.lazy.staggeredgrid.LazyStaggeredGridDslKt$$ExternalSyntheticLambda3
                @Override // kotlin.jvm.functions.Function2
                public final Object invoke(Object obj, Object obj2) {
                    return LazyStaggeredGridDslKt.LazyHorizontalStaggeredGrid_cJHQLPU$lambda$0(rows, modifier2, state2, contentPadding2, reverseLayout2, verticalArrangement2, f2, flingBehavior2, userScrollEnabled2, content, $changed, i, (Composer) obj, ((Integer) obj2).intValue());
                }
            });
        }
    }
    ...
    private static final LazyGridStaggeredGridSlotsProvider rememberRowSlots(final StaggeredGridCells rows, final Arrangement.Vertical verticalArrangement, final PaddingValues contentPadding, Composer $composer, int $changed) {
        ...
        boolean invalid$iv = (((($changed & 14) ^ 6) > 4 && $composer.changed(rows)) || ($changed & 6) == 4) | (((($changed & 112) ^ 48) > 32 && $composer.changed(verticalArrangement)) || ($changed & 48) == 32) | (((($changed & 896) ^ RendererCapabilities.DECODER_SUPPORT_MASK) > 256 && $composer.changed(contentPadding)) || ($changed & RendererCapabilities.DECODER_SUPPORT_MASK) == 256);
        Object it$iv = $composer.rememberedValue();
        if (invalid$iv || it$iv == Composer.INSTANCE.getEmpty()) {
    ...
    public static final LazyStaggeredGridSlots rememberRowSlots$lambda$0$0(PaddingValues $contentPadding, StaggeredGridCells $rows, Arrangement.Vertical $verticalArrangement, Density $this$LazyStaggeredGridSlotCache, Constraints constraints) {
        boolean value$iv = Constraints.m7457getMaxHeightimpl(constraints.getValue()) != Integer.MAX_VALUE;
        if (!value$iv) {
            InlineClassHelperKt.throwIllegalArgumentException("LazyHorizontalStaggeredGrid's height should be bound by parent.");
        }
        int gridHeight = Constraints.m7457getMaxHeightimpl(constraints.getValue()) - $this$LazyStaggeredGridSlotCache.mo399roundToPx0680j_4(Dp.m7505constructorimpl($contentPadding.getTop() + $contentPadding.getBottom()));
        int[] sizes = $rows.calculateCrossAxisCellSizes($this$LazyStaggeredGridSlotCache, gridHeight, $this$LazyStaggeredGridSlotCache.mo399roundToPx0680j_4($verticalArrangement.getSpacing()));
        int[] positions = new int[sizes.length];
    ...
    /* JADX INFO: compiled from: LazyStaggeredGridDsl.kt */
    @Metadata(k = 3, mv = {2, 0, 0}, xi = 176)
    public static final class C03103 implements Function1<Integer, Object> {
        final /* synthetic */ Function2<Integer, T, Object> $contentType;
        final /* synthetic */ List<T> $items;

        /* JADX WARN: Multi-variable type inference failed */
        public C03103(Function2<? super Integer, ? super T, ? extends Object> function2, List<? extends T> list) {
    ...
    public static final <T> void itemsIndexed(LazyStaggeredGridScope $this$itemsIndexed, List<? extends T> list, Function2<? super Integer, ? super T, ? extends Object> function2, Function2<? super Integer, ? super T, ? extends Object> function22, Function2<? super Integer, ? super T, StaggeredGridItemSpan> function23, Function5<? super LazyStaggeredGridItemScope, ? super Integer, ? super T, ? super Composer, ? super Integer, Unit> function5) {
        ...
        C03103 c03103 = new C03103(function22, list);
        if (function23 == null) {
        ...
        $this$itemsIndexed.items(size, lazyStaggeredGridDslKt$itemsIndexed$2$1, c03103, lazyStaggeredGridDslKt$itemsIndexed$4$1, ComposableLambdaKt.composableLambdaInstance(-1466459515, true, new C03115(function5, list)));
    }
    ...
    /* JADX INFO: compiled from: LazyStaggeredGridDsl.kt */
    @Metadata(k = 3, mv = {2, 0, 0}, xi = 176)
    public static final class C03115 implements Function4<LazyStaggeredGridItemScope, Integer, Composer, Integer, Unit> {
        final /* synthetic */ Function5<LazyStaggeredGridItemScope, Integer, T, Composer, Integer, Unit> $itemContent;
        final /* synthetic */ List<T> $items;

        /* JADX WARN: Multi-variable type inference failed */
        public C03115(Function5<? super LazyStaggeredGridItemScope, ? super Integer, ? super T, ? super Composer, ? super Integer, Unit> function5, List<? extends T> list) {
    ...
    public static /* synthetic */ void itemsIndexed$default(LazyStaggeredGridScope $this$itemsIndexed_u24default, Object[] items, Function2 key, Function2 contentType, Function2 span, Function5 itemContent, int i, Object obj) {
        ...
        $this$itemsIndexed_u24default.items(items.length, key != null ? new LazyStaggeredGridDslKt$itemsIndexed$7$1(key, items) : null, new C03138(contentType, items), span != null ? new LazyStaggeredGridDslKt$itemsIndexed$9$1(span, items) : null, ComposableLambdaKt.composableLambdaInstance(425846862, true, new C030910(itemContent, items)));
    }
    ...
    /* JADX INFO: compiled from: LazyStaggeredGridDsl.kt */
    @Metadata(k = 3, mv = {2, 0, 0}, xi = 176)
    public static final class C03138 implements Function1<Integer, Object> {
        final /* synthetic */ Function2<Integer, T, Object> $contentType;
        final /* synthetic */ T[] $items;

        /* JADX WARN: Multi-variable type inference failed */
        public C03138(Function2<? super Integer, ? super T, ? extends Object> function2, T[] tArr) {
            this.$contentType = function2;
            this.$items = tArr;
        }
    ...
    public static final <T> void itemsIndexed(LazyStaggeredGridScope $this$itemsIndexed, T[] tArr, Function2<? super Integer, ? super T, ? extends Object> function2, Function2<? super Integer, ? super T, ? extends Object> function22, Function2<? super Integer, ? super T, StaggeredGridItemSpan> function23, Function5<? super LazyStaggeredGridItemScope, ? super Integer, ? super T, ? super Composer, ? super Integer, Unit> function5) {
        ...
        C03138 c03138 = new C03138(function22, tArr);
        if (function23 == null) {
        ...
        $this$itemsIndexed.items(length, lazyStaggeredGridDslKt$itemsIndexed$7$1, c03138, lazyStaggeredGridDslKt$itemsIndexed$9$1, ComposableLambdaKt.composableLambdaInstance(425846862, true, new C030910(function5, tArr)));
    }
    ...
    /* JADX INFO: compiled from: LazyStaggeredGridDsl.kt */
    @Metadata(k = 3, mv = {2, 0, 0}, xi = 176)
    public static final class C030910 implements Function4<LazyStaggeredGridItemScope, Integer, Composer, Integer, Unit> {
        final /* synthetic */ Function5<LazyStaggeredGridItemScope, Integer, T, Composer, Integer, Unit> $itemContent;
        final /* synthetic */ T[] $items;

        /* JADX WARN: Multi-variable type inference failed */
        public C030910(Function5<? super LazyStaggeredGridItemScope, ? super Integer, ? super T, ? super Composer, ? super Integer, Unit> function5, T[] tArr) {
            this.$itemContent = function5;
            this.$items = tArr;
        }
