...
public final class LazyStaggeredGridKt {
    ...
    public static final void m1033LazyStaggeredGridw41Enmo(final LazyStaggeredGridState state, final Orientation orientation, final LazyGridStaggeredGridSlotsProvider slots, Modifier modifier, PaddingValues contentPadding, boolean reverseLayout, FlingBehavior flingBehavior, boolean userScrollEnabled, final OverscrollEffect overscrollEffect, float f, float f2, final Function1<? super LazyStaggeredGridScope, Unit> function1, Composer $composer, final int $changed, final int $changed1, final int i) {
        Modifier modifier2;
        ...
        if (($changed & 100663296) == 0) {
            ...
            $dirty3 |= $composer3.changed(overscrollEffect2) ? 67108864 : 33554432;
        } else {
            overscrollEffect2 = overscrollEffect;
        }
        int i9 = i & 512;
        ...
        if (i10 != 0) {
            ...
            i3 = i10;
            $dirty1 |= $composer3.changed(f2) ? 4 : 2;
        } else {
            i3 = i10;
        }
        if (($changed1 & 48) == 0) {
        ...
        if ($composer3.shouldExecute((($dirty3 & 306783379) == 306783378 && ($dirty1 & 19) == 18) ? false : true, $dirty4 & 1)) {
            ...
            if (($changed & 1) == 0 || $composer3.getDefaultsInvalid()) {
                ...
                PaddingValues contentPadding4 = i5 != 0 ? PaddingKt.m811PaddingValues0680j_4(Dp.m7505constructorimpl(0)) : paddingValues;
                ...
                fM7505constructorimpl = i2 != 0 ? Dp.m7505constructorimpl(0) : f;
                if (i3 != 0) {
            ...
            float f5 = fM7505constructorimpl2;
            ...
            int $dirty5 = $dirty2;
            float f6 = fM7505constructorimpl;
            LazyLayoutMeasurePolicy measurePolicy = LazyStaggeredGridMeasurePolicyKt.m1045rememberStaggeredGridMeasurePolicyqKj4JfE(state, function0RememberStaggeredGridItemProviderLambda, contentPadding5, reverseLayout5, orientation, f6, f5, coroutineScope, slots, graphicsContext, $composer3, ($dirty2 & 14) | (($dirty2 >> 6) & 896) | (($dirty2 >> 6) & 7168) | (($dirty2 << 9) & 57344) | (($dirty2 >> 12) & 458752) | (($dirty1 << 18) & 3670016) | (($dirty2 << 18) & 234881024));
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2() { // from class: androidx.compose.foundation.lazy.staggeredgrid.LazyStaggeredGridKt$$ExternalSyntheticLambda0
                ...
                public final Object invoke(Object obj, Object obj2) {
                    return LazyStaggeredGridKt.LazyStaggeredGrid_w41Enmo$lambda$0(state, orientation, slots, modifier3, contentPadding2, reverseLayout2, flingBehavior3, userScrollEnabled2, overscrollEffect, f3, f4, function1, $changed, $changed1, i, (Composer) obj, ((Integer) obj2).intValue());
                }
            });
        }
    }
