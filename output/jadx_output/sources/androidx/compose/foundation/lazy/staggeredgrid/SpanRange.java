...
public final class SpanRange {
    ...
    public boolean equals(Object other) {
        return m1055equalsimpl(this.packedValue, other);
    }
    ...
    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static long m1053constructorimpl(int lane, int span) {
        int val2$iv = lane + span;
        return m1054constructorimpl((((long) lane) << 32) | (((long) val2$iv) & 4294967295L));
    }
