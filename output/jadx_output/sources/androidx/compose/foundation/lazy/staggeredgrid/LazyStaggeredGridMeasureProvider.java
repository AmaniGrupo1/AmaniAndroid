...
public abstract class LazyStaggeredGridMeasureProvider extends LazyLayoutMeasuredItemProvider<LazyStaggeredGridMeasuredItem> {
    ...
    public abstract LazyStaggeredGridMeasuredItem mo1040createItempitSLOA(int index, int lane, int span, Object key, Object contentType, List<? extends Placeable> placeables, long constraints);
    ...
    private final long m1046childConstraintsJhjzzOo(int slot, int span) {
        int start;
        ...
        if (this.isVertical) {
            return Constraints.INSTANCE.m7470fixedWidthOenEA2s(start);
        }
        return Constraints.INSTANCE.m7469fixedHeightOenEA2s(start);
    }

    /* JADX INFO: renamed from: getAndMeasure-jy6DScQ, reason: not valid java name */
    public final LazyStaggeredGridMeasuredItem m1047getAndMeasurejy6DScQ(int index, long span) {
        ...
        long constraints = m1046childConstraintsJhjzzOo(spanStart, spanSize);
        return mo1040createItempitSLOA(index, spanStart, spanSize, key, contentType, m995getPlaceables3p2s80s(this.measureScope, index, constraints), constraints);
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyLayoutMeasuredItemProvider
    /* JADX INFO: renamed from: getAndMeasure--hBUhpc */
    public LazyStaggeredGridMeasuredItem mo933getAndMeasurehBUhpc(int index, int lane, int span, long constraints) {
        Object key = this.itemProvider.getKey(index);
        Object contentType = this.itemProvider.getContentType(index);
        return mo1040createItempitSLOA(index, lane, span, key, contentType, m995getPlaceables3p2s80s(this.measureScope, index, constraints), constraints);
    }
