    ...
    public static final class AnonymousClass1 implements LazyLayoutScrollScope, ScrollScope {
        ...
        public int calculateDistanceTo(int targetIndex, int targetOffset) {
            ...
            if (visibleItem == null) {
                ...
                iM7633getXimpl = (averageMainAxisItemSize * lineDiff) - getFirstVisibleItemScrollOffset();
            } else if (layoutInfo.getOrientation() == Orientation.Vertical) {
                iM7633getXimpl = IntOffset.m7634getYimpl(visibleItem.getOffset());
            } else {
                iM7633getXimpl = IntOffset.m7633getXimpl(visibleItem.getOffset());
            }
            return iM7633getXimpl + targetOffset;
        }
    }
