...
public final class LazyLayoutPrefetchState {
    ...
    public interface PrefetchResultScope {
        ...
        long mo1003getSizeYEO4UFw(int placeableIndex);
    }
    ...
    public final PrefetchHandle m1000schedulePrecompositionAndPremeasureVKLhPVY(int index, long constraints, Function1<? super PrefetchResultScope, Unit> onItemPremeasured) {
        return m1001schedulePrecompositionAndPremeasure_EkL_Y$foundation(index, constraints, true, onItemPremeasured);
    }
    ...
    public final PrefetchHandle m1001schedulePrecompositionAndPremeasure_EkL_Y$foundation(int index, long constraints, boolean isHighPriority, Function1<? super PrefetchResultScope, Unit> onItemPremeasured) {
        PrefetchHandle prefetchHandleM1016schedulePremeasurem8Kt_7k;
        PrefetchHandleProvider prefetchHandleProvider = this.prefetchHandleProvider;
        if (prefetchHandleProvider != null && (prefetchHandleM1016schedulePremeasurem8Kt_7k = prefetchHandleProvider.m1016schedulePremeasurem8Kt_7k(index, constraints, this.prefetchMetrics, isHighPriority, onItemPremeasured)) != null) {
            return prefetchHandleM1016schedulePremeasurem8Kt_7k;
        }
        return DummyHandle.INSTANCE;
    }
    ...
    private final class NestedPrefetchScopeImpl implements NestedPrefetchScope {
        ...
        public void mo1002schedulePrecompositionAndPremeasure0kLqBqw(int index, long constraints) {
            PrefetchHandleProvider prefetchHandleProvider = LazyLayoutPrefetchState.this.getPrefetchHandleProvider();
            if (prefetchHandleProvider == null) {
                return;
            }
            this._requests.add(prefetchHandleProvider.m1015createNestedPrefetchRequestVKLhPVY(index, constraints, LazyLayoutPrefetchState.this.prefetchMetrics));
        }
    }
}
