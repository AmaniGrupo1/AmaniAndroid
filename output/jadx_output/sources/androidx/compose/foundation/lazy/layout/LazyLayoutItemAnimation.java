...
public final class LazyLayoutItemAnimation {
    ...
    private static final long NotInitialized = IntOffset.m7627constructorimpl((((long) Integer.MAX_VALUE) << 32) | (((long) Integer.MAX_VALUE) & 4294967295L));
    ...
    public LazyLayoutItemAnimation(CoroutineScope coroutineScope, GraphicsContext graphicsContext, Function0<Unit> function0) {
        ...
        this.finalOffset = IntOffset.INSTANCE.m7644getZeronOccac();
        ...
        String str = null;
        this.placementDeltaAnimation = new Animatable<>(IntOffset.m7624boximpl(IntOffset.INSTANCE.m7644getZeronOccac()), VectorConvertersKt.getVectorConverter(IntOffset.INSTANCE), null, str, 12, null);
        ...
        this.placementDelta = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntOffset.m7624boximpl(IntOffset.INSTANCE.m7644getZeronOccac()), null, 2, null);
    ...
    public final void m977setPlacementDeltagyyYBs(long j) {
        ...
        $this$setValue$iv.setValue(IntOffset.m7624boximpl(j));
    }
    ...
    public final long m981getPlacementDeltanOccac() {
        ...
        return ((IntOffset) $this$getValue$iv.getValue()).m7642unboximpl();
    }
    ...
    static final class C03051 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return LazyLayoutItemAnimation.this.new C03051(continuation);
        }
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    this.label = 1;
                    if (LazyLayoutItemAnimation.this.placementDeltaAnimation.snapTo(IntOffset.m7624boximpl(IntOffset.INSTANCE.m7644getZeronOccac()), this) == coroutine_suspended) {
            ...
            LazyLayoutItemAnimation.this.m977setPlacementDeltagyyYBs(IntOffset.INSTANCE.m7644getZeronOccac());
    ...
    public final void cancelPlacementAnimation() {
        if (isPlacementAnimationInProgress()) {
            BuildersKt__Builders_commonKt.launch$default(this.coroutineScope, null, null, new C03051(null), 3, null);
        }
    }
    ...
    public final void m978animatePlacementDeltaar5cAso(long delta, boolean isMovingAway) {
        FiniteAnimationSpec<IntOffset> finiteAnimationSpec = this.placementSpec;
        if (finiteAnimationSpec == null) {
            return;
        }
        long totalDelta = IntOffset.m7636minusqkQi6aY(m981getPlacementDeltanOccac(), delta);
        m977setPlacementDeltagyyYBs(totalDelta);
    ...
    public final void animateAppearance() {
        ...
        if (isAppearanceAnimationInProgress() || finiteAnimationSpec == null || layer == null) {
            LazyLayoutItemAnimation lazyLayoutItemAnimation = this;
            if (isDisappearanceAnimationInProgress()) {
                if (layer != null) {
                    layer.setAlpha(1.0f);
                }
                BuildersKt__Builders_commonKt.launch$default(lazyLayoutItemAnimation.coroutineScope, null, null, new AnonymousClass1(null), 3, null);
                return;
            }
            return;
        }
            ...
            try {
                switch (this.label) {
                    case 0:
                        ...
                        Function1 function1 = new Function1() { // from class: androidx.compose.foundation.lazy.layout.LazyLayoutItemAnimation$animateAppearance$2$$ExternalSyntheticLambda0
                            @Override // kotlin.jvm.functions.Function1
                            public final Object invoke(Object obj) {
                                return LazyLayoutItemAnimation.AnonymousClass2.invokeSuspend$lambda$0(graphicsLayer, lazyLayoutItemAnimation, (Animatable) obj);
                            }
                        };
                        this.label = 2;
                        objAnimateTo = animatable.animateTo(fBoxFloat, (4 & 2) != 0 ? animatable.defaultSpringSpec : finiteAnimationSpec, (4 & 4) != 0 ? animatable.getVelocity() : null, (4 & 8) != 0 ? null : function1, this);
                    ...
                    case 1:
                        ...
                        FiniteAnimationSpec<Float> finiteAnimationSpec2 = this.$spec;
                        final GraphicsLayer graphicsLayer2 = this.$layer;
                        final LazyLayoutItemAnimation lazyLayoutItemAnimation2 = this.this$0;
                        Function1 function12 = new Function1() { // from class: androidx.compose.foundation.lazy.layout.LazyLayoutItemAnimation$animateAppearance$2$$ExternalSyntheticLambda0
                            @Override // kotlin.jvm.functions.Function1
                            public final Object invoke(Object obj) {
                                return LazyLayoutItemAnimation.AnonymousClass2.invokeSuspend$lambda$0(graphicsLayer2, lazyLayoutItemAnimation2, (Animatable) obj);
                            }
                        };
                        this.label = 2;
                        objAnimateTo = animatable2.animateTo(fBoxFloat2, (4 & 2) != 0 ? animatable2.defaultSpringSpec : finiteAnimationSpec2, (4 & 4) != 0 ? animatable2.getVelocity() : null, (4 & 8) != 0 ? null : function12, this);
                        if (objAnimateTo != coroutine_suspended) {
                        }
                        break;
                    case 2:
    ...
    public final void animateDisappearance() {
        ...
        BuildersKt__Builders_commonKt.launch$default(this.coroutineScope, null, null, new C03041(finiteAnimationSpec, layer, null), 3, null);
    }
    ...
    static final class C03041 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C03041(FiniteAnimationSpec<Float> finiteAnimationSpec, GraphicsLayer graphicsLayer, Continuation<? super C03041> continuation) {
            super(2, continuation);
            this.$spec = finiteAnimationSpec;
            this.$layer = graphicsLayer;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return LazyLayoutItemAnimation.this.new C03041(this.$spec, this.$layer, continuation);
        }
                ...
                switch (this.label) {
                    case 0:
                        ...
                        Function1 function1 = new Function1() { // from class: androidx.compose.foundation.lazy.layout.LazyLayoutItemAnimation$animateDisappearance$1$$ExternalSyntheticLambda0
                            @Override // kotlin.jvm.functions.Function1
                            public final Object invoke(Object obj) {
                                return LazyLayoutItemAnimation.C03041.invokeSuspend$lambda$0(graphicsLayer, lazyLayoutItemAnimation, (Animatable) obj);
                            }
                        };
                        this.label = 1;
                        if (animatable.animateTo(fBoxFloat, (4 & 2) != 0 ? animatable.defaultSpringSpec : finiteAnimationSpec, (4 & 4) != 0 ? animatable.getVelocity() : null, (4 & 8) != 0 ? null : function1, this) == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                        break;
                    case 1:
    ...
    public final void release() {
        ...
        if (isPlacementAnimationInProgress()) {
            ...
            BuildersKt__Builders_commonKt.launch$default(this.coroutineScope, null, null, new C03061(null), 3, null);
        }
        if (isAppearanceAnimationInProgress()) {
            setAppearanceAnimationInProgress(false);
            BuildersKt__Builders_commonKt.launch$default(this.coroutineScope, null, null, new C03072(null), 3, null);
        }
        if (isDisappearanceAnimationInProgress()) {
        ...
        m977setPlacementDeltagyyYBs(IntOffset.INSTANCE.m7644getZeronOccac());
        this.rawOffset = NotInitialized;
    ...
    static final class C03061 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return LazyLayoutItemAnimation.this.new C03061(continuation);
        }
    ...
    static final class C03072 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return LazyLayoutItemAnimation.this.new C03072(continuation);
        }
