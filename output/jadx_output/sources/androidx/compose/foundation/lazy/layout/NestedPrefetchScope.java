...
public interface NestedPrefetchScope {
    ...
    void mo1002schedulePrecompositionAndPremeasure0kLqBqw(int index, long constraints);
    ...
    default void m1004schedulePrefetch0kLqBqw(int index, long constraints) {
        mo1002schedulePrecompositionAndPremeasure0kLqBqw(index, constraints);
    }
}
