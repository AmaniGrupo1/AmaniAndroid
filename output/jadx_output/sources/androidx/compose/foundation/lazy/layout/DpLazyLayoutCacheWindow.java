...
final class DpLazyLayoutCacheWindow implements LazyLayoutCacheWindow {
    ...
    public int calculateAheadWindow(Density $this$calculateAheadWindow, int viewport) {
        return $this$calculateAheadWindow.mo399roundToPx0680j_4(this.ahead);
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyLayoutCacheWindow
    public int calculateBehindWindow(Density $this$calculateBehindWindow, int viewport) {
        return $this$calculateBehindWindow.mo399roundToPx0680j_4(this.behind);
    }

    public int hashCode() {
        return (Dp.m7511hashCodeimpl(this.ahead) * 31) + Dp.m7511hashCodeimpl(this.behind);
    }

    public boolean equals(Object other) {
        return (other instanceof DpLazyLayoutCacheWindow) && Dp.m7510equalsimpl0(((DpLazyLayoutCacheWindow) other).ahead, this.ahead) && Dp.m7510equalsimpl0(((DpLazyLayoutCacheWindow) other).behind, this.behind);
    }
}
