...
public final class NearestRangeKeyIndexMap implements LazyLayoutKeyIndexMap {
    ...
    */
    static final Unit lambda$1$0(int $first, int $last, MutableObjectIntMap $map, NearestRangeKeyIndexMap this$0, IntervalList.Interval it) {
        Object key;
        Function1<Integer, Object> key2 = ((LazyLayoutIntervalContent.Interval) it.getValue()).getKey();
        ...
        if (i <= end) {
            while (true) {
                if (key2 == null) {
                    ...
                    $map.set(key, i);
                    this$0.keys[i - this$0.keysStartIndex] = key;
                    if (i != end) {
                        break;
                    }
                    i++;
