...
public abstract class LazyLayoutMeasuredItemProvider<T extends LazyLayoutMeasuredItem> {
    ...
    public abstract T mo933getAndMeasurehBUhpc(int index, int lane, int span, long constraints);

    /* JADX INFO: renamed from: getPlaceables-3p2s80s, reason: not valid java name */
    public final List<Placeable> m995getPlaceables3p2s80s(LazyLayoutMeasureScope $this$getPlaceables_u2d3p2s80s, int index, long j) {
        ...
        for (int i = 0; i < size; i++) {
            int i2 = i;
            arrayList.add(listCompose.get(i2).mo6141measureBRTryo0(j));
        }
