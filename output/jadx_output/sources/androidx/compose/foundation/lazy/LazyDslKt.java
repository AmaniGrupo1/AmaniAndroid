...
public final class LazyDslKt {
    ...
    public static /* synthetic */ void itemsIndexed$default(LazyListScope $this$itemsIndexed_u24default, List items, Function2 key, Function2 contentType, Function5 itemContent, int i, Object obj) {
        ...
        $this$itemsIndexed_u24default.items(items.size(), key != null ? new C02832(key, items) : null, new C02843(contentType, items), ComposableLambdaKt.composableLambdaInstance(2039820996, true, new C02854(itemContent, items)));
    }
    ...
    /* JADX INFO: compiled from: LazyDsl.kt */
    @Metadata(k = 3, mv = {2, 0, 0}, xi = 176)
    public static final class C02832 implements Function1<Integer, Object> {
        final /* synthetic */ List<T> $items;
        final /* synthetic */ Function2<Integer, T, Object> $key;

        /* JADX WARN: Multi-variable type inference failed */
        public C02832(Function2<? super Integer, ? super T, ? extends Object> function2, List<? extends T> list) {
            this.$key = function2;
            this.$items = list;
        }
    ...
    /* JADX INFO: compiled from: LazyDsl.kt */
    @Metadata(k = 3, mv = {2, 0, 0}, xi = 176)
    public static final class C02843 implements Function1<Integer, Object> {
        final /* synthetic */ Function2<Integer, T, Object> $contentType;
        final /* synthetic */ List<T> $items;

        /* JADX WARN: Multi-variable type inference failed */
        public C02843(Function2<? super Integer, ? super T, ? extends Object> function2, List<? extends T> list) {
    ...
    public static final <T> void itemsIndexed(LazyListScope $this$itemsIndexed, List<? extends T> list, Function2<? super Integer, ? super T, ? extends Object> function2, Function2<? super Integer, ? super T, ? extends Object> function22, Function5<? super LazyItemScope, ? super Integer, ? super T, ? super Composer, ? super Integer, Unit> function5) {
        $this$itemsIndexed.items(list.size(), function2 != null ? new C02832(function2, list) : null, new C02843(function22, list), ComposableLambdaKt.composableLambdaInstance(2039820996, true, new C02854(function5, list)));
    }
    ...
    /* JADX INFO: compiled from: LazyDsl.kt */
    @Metadata(k = 3, mv = {2, 0, 0}, xi = 176)
    public static final class C02854 implements Function4<LazyItemScope, Integer, Composer, Integer, Unit> {
        final /* synthetic */ Function5<LazyItemScope, Integer, T, Composer, Integer, Unit> $itemContent;
        final /* synthetic */ List<T> $items;

        /* JADX WARN: Multi-variable type inference failed */
        public C02854(Function5<? super LazyItemScope, ? super Integer, ? super T, ? super Composer, ? super Integer, Unit> function5, List<? extends T> list) {
    ...
    public static /* synthetic */ void itemsIndexed$default(LazyListScope $this$itemsIndexed_u24default, List items, Function2 key, Function5 itemContent, int i, Object obj) {
        ...
        $this$itemsIndexed_u24default.items(items.size(), key$iv != null ? new C02832(key$iv, items) : null, new LazyDslKt$itemsIndexed$$inlined$itemsIndexed$default$1(items), ComposableLambdaKt.composableLambdaInstance(2039820996, true, new C02854(itemContent, items)));
    }
    ...
    public static /* synthetic */ void itemsIndexed$default(LazyListScope $this$itemsIndexed_u24default, Object[] items, Function2 key, Function2 contentType, Function5 itemContent, int i, Object obj) {
        ...
        $this$itemsIndexed_u24default.items(items.length, key != null ? new C02876(key, items) : null, new C02887(contentType, items), ComposableLambdaKt.composableLambdaInstance(1763000017, true, new C02898(itemContent, items)));
    }
    ...
    /* JADX INFO: compiled from: LazyDsl.kt */
    @Metadata(k = 3, mv = {2, 0, 0}, xi = 176)
    public static final class C02876 implements Function1<Integer, Object> {
        final /* synthetic */ T[] $items;
        final /* synthetic */ Function2<Integer, T, Object> $key;

        /* JADX WARN: Multi-variable type inference failed */
        public C02876(Function2<? super Integer, ? super T, ? extends Object> function2, T[] tArr) {
            this.$key = function2;
            this.$items = tArr;
        }
    ...
    /* JADX INFO: compiled from: LazyDsl.kt */
    @Metadata(k = 3, mv = {2, 0, 0}, xi = 176)
    public static final class C02887 implements Function1<Integer, Object> {
        final /* synthetic */ Function2<Integer, T, Object> $contentType;
        final /* synthetic */ T[] $items;

        /* JADX WARN: Multi-variable type inference failed */
        public C02887(Function2<? super Integer, ? super T, ? extends Object> function2, T[] tArr) {
            this.$contentType = function2;
            this.$items = tArr;
        }
    ...
    public static final <T> void itemsIndexed(LazyListScope $this$itemsIndexed, T[] tArr, Function2<? super Integer, ? super T, ? extends Object> function2, Function2<? super Integer, ? super T, ? extends Object> function22, Function5<? super LazyItemScope, ? super Integer, ? super T, ? super Composer, ? super Integer, Unit> function5) {
        $this$itemsIndexed.items(tArr.length, function2 != null ? new C02876(function2, tArr) : null, new C02887(function22, tArr), ComposableLambdaKt.composableLambdaInstance(1763000017, true, new C02898(function5, tArr)));
    }
    ...
    /* JADX INFO: compiled from: LazyDsl.kt */
    @Metadata(k = 3, mv = {2, 0, 0}, xi = 176)
    public static final class C02898 implements Function4<LazyItemScope, Integer, Composer, Integer, Unit> {
        final /* synthetic */ Function5<LazyItemScope, Integer, T, Composer, Integer, Unit> $itemContent;
        final /* synthetic */ T[] $items;

        /* JADX WARN: Multi-variable type inference failed */
        public C02898(Function5<? super LazyItemScope, ? super Integer, ? super T, ? super Composer, ? super Integer, Unit> function5, T[] tArr) {
            this.$itemContent = function5;
            this.$items = tArr;
        }
    ...
    public static /* synthetic */ void itemsIndexed$default(LazyListScope $this$itemsIndexed_u24default, Object[] items, Function2 key, Function5 itemContent, int i, Object obj) {
        ...
        Function2 key$iv = key;
        $this$itemsIndexed_u24default.items(items.length, key$iv != null ? new C02876(key$iv, items) : null, new LazyDslKt$itemsIndexed$$inlined$itemsIndexed$default$2(items), ComposableLambdaKt.composableLambdaInstance(1763000017, true, new C02898(itemContent, items)));
    }
    ...
    public static final void LazyRow(Modifier modifier, LazyListState state, PaddingValues contentPadding, boolean reverseLayout, Arrangement.Horizontal horizontalArrangement, Alignment.Vertical verticalAlignment, FlingBehavior flingBehavior, boolean userScrollEnabled, OverscrollEffect overscrollEffect, final Function1<? super LazyListScope, Unit> function1, Composer $composer, final int $changed, final int i) {
        ...
        if (($changed & 100663296) == 0) {
            $dirty4 |= ((i & 256) == 0 && $composer3.changed(overscrollEffect)) ? 67108864 : 33554432;
        }
        if (($changed & 805306368) == 0) {
            $dirty4 |= $composer3.changedInstance(function1) ? C.BUFFER_FLAG_LAST_SAMPLE : 268435456;
        }
        int $dirty5 = $dirty4;
    ...
    public static final void LazyColumn(Modifier modifier, LazyListState state, PaddingValues contentPadding, boolean reverseLayout, Arrangement.Vertical verticalArrangement, Alignment.Horizontal horizontalAlignment, FlingBehavior flingBehavior, boolean userScrollEnabled, OverscrollEffect overscrollEffect, final Function1<? super LazyListScope, Unit> function1, Composer $composer, final int $changed, final int i) {
        ...
        if (!$composer3.shouldExecute(($dirty4 & 306783379) != 306783378, $dirty5 & 1)) {
            ...
            $composer2 = $composer3;
            LazyListKt.LazyList(modifier4, state4, contentPadding4, reverseLayout4, true, flingBehavior4, userScrollEnabled4, overscrollEffect3, 0, horizontalAlignment4, verticalArrangement4, null, null, function1, $composer2, ($dirty2 & 14) | 24576 | ($dirty2 & 112) | ($dirty2 & 896) | ($dirty2 & 7168) | (($dirty2 >> 3) & 458752) | (($dirty2 >> 3) & 3670016) | (($dirty2 >> 3) & 29360128) | (($dirty2 << 12) & C.ENCODING_PCM_DOUBLE), (($dirty2 >> 12) & 14) | (($dirty2 >> 18) & 7168), 6400);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            modifier3 = modifier4;
    ...
    public static final /* synthetic */ void LazyColumn(Modifier modifier, LazyListState state, PaddingValues contentPadding, boolean reverseLayout, Arrangement.Vertical verticalArrangement, Alignment.Horizontal horizontalAlignment, FlingBehavior flingBehavior, final Function1 content, Composer $composer, final int $changed, final int i) {
        ...
        if (!$composer3.shouldExecute(($dirty2 & 4793491) != 4793490, $dirty3 & 1)) {
            ...
            $composer2 = $composer3;
            LazyColumn(modifier5, state4, contentPadding4, reverseLayout4, verticalArrangement4, horizontalAlignment4, flingBehavior4, true, null, content, $composer2, ($dirty & 14) | i2 | ($dirty & 112) | ($dirty & 896) | ($dirty & 7168) | (57344 & $dirty) | (458752 & $dirty) | (3670016 & $dirty) | (($dirty << 6) & C.ENCODING_PCM_DOUBLE), 256);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            modifier3 = modifier5;
    ...
    public static final /* synthetic */ void LazyRow(Modifier modifier, LazyListState state, PaddingValues contentPadding, boolean reverseLayout, Arrangement.Horizontal horizontalArrangement, Alignment.Vertical verticalAlignment, FlingBehavior flingBehavior, final Function1 content, Composer $composer, final int $changed, final int i) {
        ...
        if (!$composer3.shouldExecute(($dirty2 & 4793491) != 4793490, $dirty3 & 1)) {
            ...
            $composer2 = $composer3;
            LazyRow(modifier5, state4, contentPadding4, reverseLayout4, horizontalArrangement4, verticalAlignment4, flingBehavior4, true, null, content, $composer2, ($dirty & 14) | i2 | ($dirty & 112) | ($dirty & 896) | ($dirty & 7168) | (57344 & $dirty) | (458752 & $dirty) | (3670016 & $dirty) | (($dirty << 6) & C.ENCODING_PCM_DOUBLE), 256);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            modifier3 = modifier5;
