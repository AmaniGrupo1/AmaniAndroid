...
public abstract class LazyListMeasuredItemProvider extends LazyLayoutMeasuredItemProvider<LazyListMeasuredItem> {
    ...
    public abstract LazyListMeasuredItem mo921createItemX9ElhV4(int index, Object key, Object contentType, List<? extends Placeable> placeables, long constraints);
    ...
    private LazyListMeasuredItemProvider(long constraints, boolean isVertical, LazyListItemProvider itemProvider, LazyLayoutMeasureScope measureScope) {
        ...
        this.childConstraints = ConstraintsKt.Constraints$default(0, isVertical ? Constraints.m7458getMaxWidthimpl(constraints) : Integer.MAX_VALUE, 0, isVertical ? Integer.MAX_VALUE : Constraints.m7457getMaxHeightimpl(constraints), 5, null);
    }
    ...
    public LazyListMeasuredItem mo933getAndMeasurehBUhpc(int index, int lane, int span, long constraints) {
        return m934getAndMeasure0kLqBqw(index, constraints);
    }
    ...
    public final LazyListMeasuredItem m934getAndMeasure0kLqBqw(int index, long constraints) {
        Object key = this.itemProvider.getKey(index);
        Object contentType = this.itemProvider.getContentType(index);
        return mo921createItemX9ElhV4(index, key, contentType, m995getPlaceables3p2s80s(this.measureScope, index, constraints), constraints);
    }
