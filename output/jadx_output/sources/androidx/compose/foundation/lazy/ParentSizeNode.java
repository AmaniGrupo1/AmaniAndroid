...
final class ParentSizeNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo69measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long j) {
        ...
        long childConstraints = ConstraintsKt.Constraints(width != Integer.MAX_VALUE ? width : Constraints.m7460getMinWidthimpl(j), width != Integer.MAX_VALUE ? width : Constraints.m7458getMaxWidthimpl(j), height != Integer.MAX_VALUE ? height : Constraints.m7459getMinHeightimpl(j), height != Integer.MAX_VALUE ? height : Constraints.m7457getMaxHeightimpl(j));
