...
public final class LazyListState$prefetchScope$1 implements LazyListPrefetchScope {
    ...
    public LazyLayoutPrefetchState.PrefetchHandle schedulePrefetch(final int index, final Function1<? super LazyListPrefetchResultScope, Unit> onPrefetchFinished) {
        ...
        try {
            ...
            return this.this$0.getPrefetchState().m1001schedulePrecompositionAndPremeasure_EkL_Y$foundation(index, lastMeasureResult.getChildConstraints(), this.this$0.executeRequestsInHighPriorityMode, new Function1() { // from class: androidx.compose.foundation.lazy.LazyListState$prefetchScope$1$$ExternalSyntheticLambda0
        ...
        if ($onPrefetchFinished != null) {
            ...
            for (int i = 0; i < placeablesCount; i++) {
                ...
                if ($lastMeasureResult.getOrientation() == Orientation.Vertical) {
                    jMo1003getSizeYEO4UFw = 4294967295L & $this$schedulePrecompositionAndPremeasure.mo1003getSizeYEO4UFw(it);
                } else {
                    jMo1003getSizeYEO4UFw = $this$schedulePrecompositionAndPremeasure.mo1003getSizeYEO4UFw(it) >> 32;
                }
                mainAxisItemSize += (int) jMo1003getSizeYEO4UFw;
            }
