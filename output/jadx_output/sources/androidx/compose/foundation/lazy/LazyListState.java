...
public final class LazyListState implements ScrollableState {
    ...
    static final class C02912 extends SuspendLambda implements Function2<ScrollScope, Continuation<? super Unit>, Object> {
        final /* synthetic */ int $index;
        final /* synthetic */ int $scrollOffset;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C02912(int i, int i2, Continuation<? super C02912> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return LazyListState.this.new C02912(this.$index, this.$scrollOffset, continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(ScrollScope scrollScope, Continuation<? super Unit> continuation) {
            return ((C02912) create(scrollScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public final Object scrollToItem(int index, int scrollOffset, Continuation<? super Unit> continuation) {
        Object objScroll$default = ScrollableState.scroll$default(this, null, new C02912(index, scrollOffset, null), continuation, 1, null);
    ...
    */
    public Object scroll(MutatePriority scrollPriority, Function2<? super ScrollScope, ? super Continuation<? super Unit>, ? extends Object> function2, Continuation<? super Unit> continuation) {
        ...
        Object $result = c02901.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        switch (c02901.label) {
            case 0:
                ResultKt.throwOnFailure($result);
                lazyListState = this;
                if (lazyListState.layoutInfoState.getValue() == LazyListStateKt.EmptyLazyListMeasureResult) {
                    AwaitFirstLayoutModifier awaitFirstLayoutModifier = lazyListState.awaitLayoutModifier;
                    c02901.L$0 = scrollPriority;
                    c02901.L$1 = function2;
                    c02901.label = 1;
                    if (awaitFirstLayoutModifier.waitForFirstLayout(c02901) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                ...
                c02901.L$1 = null;
                c02901.label = 2;
                if (scrollableState.scroll(scrollPriority, function2, c02901) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                return Unit.INSTANCE;
            case 1:
                lazyListState2 = this;
                function2 = (Function2) c02901.L$1;
                scrollPriority2 = (MutatePriority) c02901.L$0;
                ResultKt.throwOnFailure($result);
