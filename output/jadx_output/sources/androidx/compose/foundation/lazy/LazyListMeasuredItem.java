...
public final class LazyListMeasuredItem implements LazyListItemInfo, LazyLayoutMeasuredItem {
    ...
    public long mo931getOffsetBjo55l4(int index) {
        ...
        if (index == 0 && getPlaceablesCount() == 0) {
            ...
            int val2$iv$iv = y$iv;
            int val1$iv$iv = x$iv;
            return IntOffset.m7627constructorimpl((4294967295L & ((long) val2$iv$iv)) | (((long) val1$iv$iv) << 32));
        }
        int x$iv2 = this.placeableOffsets[index * 2];
        int y$iv2 = this.placeableOffsets[(index * 2) + 1];
        return IntOffset.m7627constructorimpl((4294967295L & ((long) y$iv2)) | (((long) x$iv2) << 32));
    }
        ...
        if (updateAnimations) {
            ...
            while (index < placeablesCount) {
                ...
                if (animation != null) {
                    ...
                    if (getIsVertical()) {
                        int x$iv$iv = IntOffset.m7633getXimpl(rawOffset);
                        int mainAxis = IntOffset.m7634getYimpl(rawOffset);
                        int y$iv$iv = Integer.valueOf(mainAxis + delta).intValue();
                        val2$iv$iv$iv = placeablesCount;
                        jM7627constructorimpl = IntOffset.m7627constructorimpl((((long) y$iv$iv) & 4294967295L) | (((long) x$iv$iv) << 32));
                    } else {
                        val2$iv$iv$iv = placeablesCount;
                        int mainAxis2 = IntOffset.m7633getXimpl(rawOffset);
                        int x$iv$iv2 = Integer.valueOf(mainAxis2 + delta).intValue();
                        int y$iv$iv2 = IntOffset.m7634getYimpl(rawOffset);
                        jM7627constructorimpl = IntOffset.m7627constructorimpl((((long) x$iv$iv2) << 32) | (((long) y$iv$iv2) & 4294967295L));
                    }
                    animation.m985setRawOffsetgyyYBs(jM7627constructorimpl);
                } else {
                    val2$iv$iv$iv = placeablesCount;
                }
                index++;
    ...
    public final void place(Placeable.PlacementScope scope, boolean isLookingAhead) {
        ...
        for (int i = 0; i < placeablesCount; i++) {
            ...
            long targetOffset = mo931getOffsetBjo55l4(index);
            LazyLayoutItemAnimation animation = this.animator.getAnimation(getKey(), index);
            if (animation != null) {
                if (isLookingAhead) {
                    animation.m984setLookaheadOffsetgyyYBs(targetOffset);
                    $this$place_u24lambda_u240 = $this$place_u24lambda_u2402;
                } else {
                    long targetOffset2 = !IntOffset.m7632equalsimpl0(animation.getLookaheadOffset(), LazyLayoutItemAnimation.INSTANCE.m986getNotInitializednOccac()) ? animation.getLookaheadOffset() : targetOffset;
                    long animatedOffset = IntOffset.m7637plusqkQi6aY(targetOffset2, animation.m981getPlacementDeltanOccac());
                    $this$place_u24lambda_u240 = $this$place_u24lambda_u2402;
                    if ((m929getMainAxisgyyYBs(targetOffset2) <= minOffset && m929getMainAxisgyyYBs(animatedOffset) <= minOffset) || (m929getMainAxisgyyYBs(targetOffset2) >= maxOffset && m929getMainAxisgyyYBs(animatedOffset) >= maxOffset)) {
            ...
            if (this.reverseLayout) {
                long j = targetOffset;
                if (getIsVertical()) {
                    int x$iv$iv = IntOffset.m7633getXimpl(j);
                    int mainAxisOffset = IntOffset.m7634getYimpl(j);
                    layer2 = layer;
                    int y$iv$iv = (this.mainAxisLayoutSize - mainAxisOffset) - getMainAxisSize(placeable2);
                    targetOffset = IntOffset.m7627constructorimpl((((long) x$iv$iv) << 32) | (((long) y$iv$iv) & 4294967295L));
                    ...
                    int y$iv$iv2 = IntOffset.m7634getYimpl(j);
                    placeable = placeable2;
                    targetOffset = IntOffset.m7627constructorimpl((((long) x$iv$iv2) << 32) | (((long) y$iv$iv2) & 4294967295L));
                }
            } else {
                layer2 = layer;
                placeable = placeable2;
            }
            long offset = IntOffset.m7637plusqkQi6aY(targetOffset, this.visualOffset);
            if (!isLookingAhead && animation != null) {
                animation.m983setFinalOffsetgyyYBs(offset);
            }
            if (!getIsVertical()) {
                $this$place_u24lambda_u2402 = $this$place_u24lambda_u240;
                Placeable placeable3 = placeable;
                if (layer2 != null) {
                    Placeable.PlacementScope.m6210placeRelativeWithLayeraW9wM$default($this$place_u24lambda_u2402, placeable3, offset, layer2, 0.0f, 4, (Object) null);
                } else {
                    Placeable.PlacementScope.m6209placeRelativeWithLayeraW9wM$default($this$place_u24lambda_u2402, placeable3, offset, 0.0f, (Function1) null, 6, (Object) null);
                }
            } else if (layer2 != null) {
                $this$place_u24lambda_u2402 = $this$place_u24lambda_u240;
                Placeable.PlacementScope.m6212placeWithLayeraW9wM$default($this$place_u24lambda_u2402, placeable, offset, layer2, 0.0f, 4, (Object) null);
            } else {
                $this$place_u24lambda_u2402 = $this$place_u24lambda_u240;
                Placeable.PlacementScope.m6211placeWithLayeraW9wM$default($this$place_u24lambda_u2402, placeable, offset, 0.0f, (Function1) null, 6, (Object) null);
            }
        }
    }
    ...
    private final long m928copy4Tuh3kE(long j, Function1<? super Integer, Integer> function1) {
        if (getIsVertical()) {
            int x$iv = IntOffset.m7633getXimpl(j);
            int y$iv = function1.invoke(Integer.valueOf(IntOffset.m7634getYimpl(j))).intValue();
            return IntOffset.m7627constructorimpl((4294967295L & ((long) y$iv)) | (((long) x$iv) << 32));
        }
        int x$iv2 = function1.invoke(Integer.valueOf(IntOffset.m7633getXimpl(j))).intValue();
        int y$iv2 = IntOffset.m7634getYimpl(j);
        return IntOffset.m7627constructorimpl((4294967295L & ((long) y$iv2)) | (((long) x$iv2) << 32));
    }
}
