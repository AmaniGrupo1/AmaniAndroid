...
public final class FocusableNode extends DelegatingNode implements SemanticsModifierNode, GlobalPositionAwareModifierNode, CompositionLocalConsumerModifierNode, ObserverModifierNode, TraversableNode {
    ...
    private FocusableNode(MutableInteractionSource interactionSource, int focusability, Function1<? super Boolean, Unit> function1) {
        ...
        this.focusTargetNode = (FocusTargetModifierNode) delegate(FocusTargetModifierNodeKt.m4363FocusTargetModifierNodePYyLHbc(focusability, new FocusableNode$focusTargetNode$1(this)));
    }
    ...
    public /* synthetic */ FocusableNode(MutableInteractionSource mutableInteractionSource, int i, Function1 function1, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(mutableInteractionSource, (i2 & 2) != 0 ? Focusability.INSTANCE.m4386getAlwaysLCbbffg() : i, (i2 & 4) != 0 ? null : function1, null);
    }
    ...
    public final boolean requestFocus() {
        return FocusTargetModifierNode.m4359requestFocus3ESFkO8$default(this.focusTargetNode, 0, 1, null);
    }
    ...
    public final void onFocusStateChange(FocusState previousState, FocusState currentState) {
        if (getIsAttached()) {
            ...
            if (isFocused) {
                BuildersKt__Builders_commonKt.launch$default(getCoroutineScope(), null, null, new C02361(null), 3, null);
    ...
    static final class C02361 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return FocusableNode.this.new C02361(continuation);
        }
    ...
    private final void emitWithFallback(final MutableInteractionSource $this$emitWithFallback, final Interaction interaction) {
        if (getIsAttached()) {
            ...
            BuildersKt__Builders_commonKt.launch$default(getCoroutineScope(), null, null, new C02351($this$emitWithFallback, interaction, handler, null), 3, null);
            return;
        }
    ...
    static final class C02351 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        C02351(MutableInteractionSource mutableInteractionSource, Interaction interaction, DisposableHandle disposableHandle, Continuation<? super C02351> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C02351(this.$this_emitWithFallback, this.$interaction, this.$handler, continuation);
        }
