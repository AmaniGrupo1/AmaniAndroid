...
public final class Magnifier_androidKt {
    ...
    public static /* synthetic */ Modifier m331magnifierUpNRX3w$default(Modifier modifier, Function1 function1, Function1 function12, Function1 function13, float f, long j, float f2, float f3, boolean z, int i, Object obj) {
        if ((i & 2) != 0) {
            function12 = null;
        }
        if ((i & 4) != 0) {
        ...
        if ((i & 16) != 0) {
            j = DpSize.INSTANCE.m7612getUnspecifiedMYxV2XQ();
        }
        if ((i & 32) != 0) {
        ...
        return m330magnifierUpNRX3w(modifier, function1, function12, function13, f, j, f2, f3, z);
    }

    /* JADX INFO: renamed from: magnifier-UpNRX3w, reason: not valid java name */
    public static final Modifier m330magnifierUpNRX3w(Modifier $this$magnifier_u2dUpNRX3w, Function1<? super Density, Offset> function1, Function1<? super Density, Offset> function12, Function1<? super DpSize, Unit> function13, float zoom, long j, float f, float f2, boolean clip) {
        return m333magnifierjPUL71Q$default($this$magnifier_u2dUpNRX3w, function1, function12, function13, zoom, false, j, f, f2, clip, null, 512, null);
    }

    /* JADX INFO: renamed from: magnifier-jPUL71Q$default, reason: not valid java name */
    public static /* synthetic */ Modifier m333magnifierjPUL71Q$default(Modifier modifier, Function1 function1, Function1 function12, Function1 function13, float f, boolean z, long j, float f2, float f3, boolean z2, PlatformMagnifierFactory platformMagnifierFactory, int i, Object obj) {
        if ((i & 2) != 0) {
            function12 = null;
        }
        if ((i & 4) != 0) {
        ...
        return m332magnifierjPUL71Q(modifier, function1, function12, function13, f, z, j, f2, f3, z2, platformMagnifierFactory);
    }

    /* JADX INFO: renamed from: magnifier-jPUL71Q, reason: not valid java name */
    public static final Modifier m332magnifierjPUL71Q(Modifier $this$magnifier_u2djPUL71Q, Function1<? super Density, Offset> function1, Function1<? super Density, Offset> function12, Function1<? super DpSize, Unit> function13, float zoom, boolean useTextDefault, long j, float f, float f2, boolean clippingEnabled, PlatformMagnifierFactory platformMagnifierFactory) {
        ...
        if (isPlatformMagnifierSupported$default(0, 1, null)) {
            ...
            return $this$magnifier_u2djPUL71Q.then(new MagnifierElement(function1, function12, function13, zoom, useTextDefault, j, f, f2, clippingEnabled, forCurrentPlatform, null));
        }
