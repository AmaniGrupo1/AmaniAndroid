...
final class ClickableElement extends ModifierNodeElement<ClickableNode> {
    ...
    public void update(ClickableNode node) {
        node.m314updateO2vRcR0(this.interactionSource, this.indicationNodeFactory, this.useLocalIndication, this.enabled, this.onClickLabel, this.role, this.onClick);
    }
    ...
    public int hashCode() {
        ...
        Role role = this.role;
        return ((result4 + (role != null ? Role.m6696hashCodeimpl(role.getValue()) : 0)) * 31) + this.onClick.hashCode();
    }
}
