...
public final class ReceiveContentDragAndDropNode_androidKt {
    ...
    public static final TransferableContent toTransferableContent(DragAndDropEvent $this$toTransferableContent) {
        ...
        return new TransferableContent(AndroidClipboardManager_androidKt.toClipEntry($this$toTransferableContent_u24lambda_u240.getClipData()), AndroidClipboardManager_androidKt.toClipMetadata($this$toTransferableContent_u24lambda_u240.getClipDescription()), TransferableContent.Source.INSTANCE.m364getDragAndDropkB6V9T0(), null, 8, null);
    }
}
