...
public final class MagnifierElement extends ModifierNodeElement<MagnifierNode> {
    ...
    public /* synthetic */ MagnifierElement(Function1 function1, Function1 function12, Function1 function13, float f, boolean z, long j, float f2, float f3, boolean z2, PlatformMagnifierFactory platformMagnifierFactory, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(function1, (i & 2) != 0 ? null : function12, (i & 4) != 0 ? null : function13, (i & 8) != 0 ? Float.NaN : f, (i & 16) != 0 ? false : z, (i & 32) != 0 ? DpSize.INSTANCE.m7612getUnspecifiedMYxV2XQ() : j, (i & 64) != 0 ? Dp.INSTANCE.m7525getUnspecifiedD9Ej5fM() : f2, (i & 128) != 0 ? Dp.INSTANCE.m7525getUnspecifiedD9Ej5fM() : f3, (i & 256) != 0 ? true : z2, platformMagnifierFactory, null);
    }
    ...
    public void update(MagnifierNode node) {
        node.m329update5F03MCQ(this.sourceCenter, this.magnifierCenter, this.zoom, this.useTextDefault, this.size, this.cornerRadius, this.elevation, this.clippingEnabled, this.onSizeChanged, this.platformMagnifierFactory);
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof MagnifierElement) && this.sourceCenter == ((MagnifierElement) other).sourceCenter && this.magnifierCenter == ((MagnifierElement) other).magnifierCenter) {
            return ((this.zoom > ((MagnifierElement) other).zoom ? 1 : (this.zoom == ((MagnifierElement) other).zoom ? 0 : -1)) == 0) && this.useTextDefault == ((MagnifierElement) other).useTextDefault && DpSize.m7600equalsimpl0(this.size, ((MagnifierElement) other).size) && Dp.m7510equalsimpl0(this.cornerRadius, ((MagnifierElement) other).cornerRadius) && Dp.m7510equalsimpl0(this.elevation, ((MagnifierElement) other).elevation) && this.clippingEnabled == ((MagnifierElement) other).clippingEnabled && this.onSizeChanged == ((MagnifierElement) other).onSizeChanged && Intrinsics.areEqual(this.platformMagnifierFactory, ((MagnifierElement) other).platformMagnifierFactory);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        int result3 = ((((((((((((result2 * 31) + Float.hashCode(this.zoom)) * 31) + Boolean.hashCode(this.useTextDefault)) * 31) + DpSize.m7605hashCodeimpl(this.size)) * 31) + Dp.m7511hashCodeimpl(this.cornerRadius)) * 31) + Dp.m7511hashCodeimpl(this.elevation)) * 31) + Boolean.hashCode(this.clippingEnabled)) * 31;
    ...
    public void inspectableProperties(InspectorInfo $this$inspectableProperties) {
        ...
        $this$inspectableProperties.getProperties().set("size", DpSize.m7591boximpl(this.size));
        $this$inspectableProperties.getProperties().set("cornerRadius", Dp.m7503boximpl(this.cornerRadius));
