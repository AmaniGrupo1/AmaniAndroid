...
final class Insets implements WindowInsets {
    ...
    public int getLeft(Density density, LayoutDirection layoutDirection) {
        return density.mo399roundToPx0680j_4(this.left);
    }

    @Override // androidx.compose.foundation.layout.WindowInsets
    public int getTop(Density density) {
        return density.mo399roundToPx0680j_4(this.top);
    }

    @Override // androidx.compose.foundation.layout.WindowInsets
    public int getRight(Density density, LayoutDirection layoutDirection) {
        return density.mo399roundToPx0680j_4(this.right);
    }

    @Override // androidx.compose.foundation.layout.WindowInsets
    public int getBottom(Density density) {
        return density.mo399roundToPx0680j_4(this.bottom);
    }

    public String toString() {
        return "Insets(left=" + ((Object) Dp.m7516toStringimpl(this.left)) + ", top=" + ((Object) Dp.m7516toStringimpl(this.top)) + ", right=" + ((Object) Dp.m7516toStringimpl(this.right)) + ", bottom=" + ((Object) Dp.m7516toStringimpl(this.bottom)) + ')';
    }
    ...
    public boolean equals(Object other) {
        ...
        if (other instanceof Insets) {
            return Dp.m7510equalsimpl0(this.left, ((Insets) other).left) && Dp.m7510equalsimpl0(this.top, ((Insets) other).top) && Dp.m7510equalsimpl0(this.right, ((Insets) other).right) && Dp.m7510equalsimpl0(this.bottom, ((Insets) other).bottom);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (((((result * 31) + Dp.m7511hashCodeimpl(this.top)) * 31) + Dp.m7511hashCodeimpl(this.right)) * 31) + Dp.m7511hashCodeimpl(this.bottom);
    }
}
