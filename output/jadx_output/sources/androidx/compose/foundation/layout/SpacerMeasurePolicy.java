...
final class SpacerMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo41measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, List<? extends Measurable> list, long j) {
        int width = Constraints.m7456getHasFixedWidthimpl(j) ? Constraints.m7458getMaxWidthimpl(j) : 0;
        int height = Constraints.m7455getHasFixedHeightimpl(j) ? Constraints.m7457getMaxHeightimpl(j) : 0;
