...
final class PaddingNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public /* synthetic */ PaddingNode(float f, float f2, float f3, float f4, boolean z, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? Dp.m7505constructorimpl(0) : f, (i & 2) != 0 ? Dp.m7505constructorimpl(0) : f2, (i & 4) != 0 ? Dp.m7505constructorimpl(0) : f3, (i & 8) != 0 ? Dp.m7505constructorimpl(0) : f4, z, null);
    }
    ...
    public final void m829setStart0680j_4(float f) {
        this.start = f;
    }
    ...
    public final void m830setTop0680j_4(float f) {
        this.top = f;
    }
    ...
    public final void m828setEnd0680j_4(float f) {
        this.end = f;
    }
    ...
    public final void m827setBottom0680j_4(float f) {
        this.bottom = f;
    }
    ...
    public MeasureResult mo69measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long j) {
        int horizontal = $this$measure_u2d3p2s80s.mo399roundToPx0680j_4(this.start) + $this$measure_u2d3p2s80s.mo399roundToPx0680j_4(this.end);
        int vertical = $this$measure_u2d3p2s80s.mo399roundToPx0680j_4(this.top) + $this$measure_u2d3p2s80s.mo399roundToPx0680j_4(this.bottom);
        final Placeable placeable = measurable.mo6141measureBRTryo0(ConstraintsKt.m7477offsetNN6EwU(j, -horizontal, -vertical));
        int width = ConstraintsKt.m7475constrainWidthK40F9xA(j, placeable.getWidth() + horizontal);
        int height = ConstraintsKt.m7474constrainHeightK40F9xA(j, placeable.getHeight() + vertical);
    ...
    static final Unit measure_3p2s80s$lambda$0(PaddingNode this$0, Placeable $placeable, Placeable.PlacementScope $this$layout) {
        if (this$0.rtlAware) {
            Placeable.PlacementScope.placeRelative$default($this$layout, $placeable, $this$layout.mo399roundToPx0680j_4(this$0.start), $this$layout.mo399roundToPx0680j_4(this$0.top), 0.0f, 4, null);
        } else {
            Placeable.PlacementScope.place$default($this$layout, $placeable, $this$layout.mo399roundToPx0680j_4(this$0.start), $this$layout.mo399roundToPx0680j_4(this$0.top), 0.0f, 4, null);
        }
