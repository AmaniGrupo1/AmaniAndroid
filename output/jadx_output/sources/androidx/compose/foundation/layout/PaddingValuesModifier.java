...
final class PaddingValuesModifier extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo69measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long j) {
        float leftPadding = this.paddingValues.mo768calculateLeftPaddingu2uoSUM($this$measure_u2d3p2s80s.getLayoutDirection());
        float topPadding = this.paddingValues.getTop();
        float rightPadding = this.paddingValues.mo769calculateRightPaddingu2uoSUM($this$measure_u2d3p2s80s.getLayoutDirection());
        float bottomPadding = this.paddingValues.getBottom();
        int $this$dp$iv = Dp.m7504compareTo0680j_4(leftPadding, Dp.m7505constructorimpl(0));
        boolean z = $this$dp$iv >= 0;
        int $this$dp$iv2 = Dp.m7504compareTo0680j_4(topPadding, Dp.m7505constructorimpl(0));
        boolean z2 = z & ($this$dp$iv2 >= 0);
        int $this$dp$iv3 = Dp.m7504compareTo0680j_4(rightPadding, Dp.m7505constructorimpl(0));
        boolean z3 = z2 & ($this$dp$iv3 >= 0);
        int $this$dp$iv4 = Dp.m7504compareTo0680j_4(bottomPadding, Dp.m7505constructorimpl(0));
        boolean value$iv = z3 & ($this$dp$iv4 >= 0);
        if (!value$iv) {
            InlineClassHelperKt.throwIllegalArgumentException("Padding must be non-negative");
        }
        final int roundedLeftPadding = $this$measure_u2d3p2s80s.mo399roundToPx0680j_4(leftPadding);
        int horizontal = roundedLeftPadding + $this$measure_u2d3p2s80s.mo399roundToPx0680j_4(rightPadding);
        final int roundedTopPadding = $this$measure_u2d3p2s80s.mo399roundToPx0680j_4(topPadding);
        int vertical = $this$measure_u2d3p2s80s.mo399roundToPx0680j_4(bottomPadding) + roundedTopPadding;
