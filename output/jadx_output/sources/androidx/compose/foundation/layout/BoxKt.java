...
public final class BoxKt {
    ...
    public static final void placeInBox(Placeable.PlacementScope $this$placeInBox, Placeable placeable, Measurable measurable, LayoutDirection layoutDirection, int boxWidth, int boxHeight, Alignment alignment) {
        ...
        long position = childAlignment.mo4171alignKFBX0sM(IntSize.m7671constructorimpl((((long) width$iv) << 32) | (((long) height$iv) & 4294967295L)), IntSize.m7671constructorimpl((((long) boxWidth) << 32) | (((long) boxHeight) & 4294967295L)), layoutDirection);
        Placeable.PlacementScope.m6207place70tqf50$default($this$placeInBox, placeable, position, 0.0f, 2, null);
    }
