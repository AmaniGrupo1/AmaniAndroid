...
public final class OffsetKt {
    ...
    public static final Modifier m777offsetVpY3zN4(Modifier $this$offset_u2dVpY3zN4, final float f, final float f2) {
        return $this$offset_u2dVpY3zN4.then(new OffsetModifierElement(f, f2, true, new Function1() { // from class: androidx.compose.foundation.layout.OffsetKt$$ExternalSyntheticLambda3
    ...
    static final Unit offset_VpY3zN4$lambda$0(float f, float f2, InspectorInfo $this$OffsetElement) {
        $this$OffsetElement.setName("offset");
        $this$OffsetElement.getProperties().set("x", Dp.m7503boximpl(f));
        $this$OffsetElement.getProperties().set("y", Dp.m7503boximpl(f2));
    ...
    public static final Modifier m775absoluteOffsetVpY3zN4(Modifier $this$absoluteOffset_u2dVpY3zN4, final float f, final float f2) {
        return $this$absoluteOffset_u2dVpY3zN4.then(new OffsetModifierElement(f, f2, false, new Function1() { // from class: androidx.compose.foundation.layout.OffsetKt$$ExternalSyntheticLambda2
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
    ...
    static final Unit absoluteOffset_VpY3zN4$lambda$0(float f, float f2, InspectorInfo $this$OffsetElement) {
