...
final class FillNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo69measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long j) {
        ...
        if (Constraints.m7454getHasBoundedWidthimpl(j) && this.direction != Direction.Vertical) {
            float $this$fastRoundToInt$iv = Constraints.m7458getMaxWidthimpl(j) * this.fraction;
            ...
            minWidth = Constraints.m7460getMinWidthimpl(j);
            $this$fastCoerceAtLeast$iv$iv = Constraints.m7458getMaxWidthimpl(j);
        }
        if (Constraints.m7453getHasBoundedHeightimpl(j) && this.direction != Direction.Horizontal) {
            float $this$fastRoundToInt$iv2 = Constraints.m7457getMaxHeightimpl(j) * this.fraction;
            ...
            minHeight = Constraints.m7459getMinHeightimpl(j);
            maximumValue$iv$iv = Constraints.m7457getMaxHeightimpl(j);
        }
        final Placeable placeable = measurable.mo6141measureBRTryo0(ConstraintsKt.Constraints(minWidth, $this$fastCoerceAtLeast$iv$iv, minHeight, maximumValue$iv$iv));
