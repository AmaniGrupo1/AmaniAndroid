...
final class DerivedWidthModifierNode extends InsetsConsumingModifierNode implements LayoutModifierNode {
    ...
    public DerivedWidthModifierNode(WindowInsets insets, Function3<? super WindowInsets, ? super LayoutDirection, ? super Density, Integer> function3) {
        this.insets = insets;
    ...
    public MeasureResult mo69measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long j) {
        int width = this.widthCalc.invoke(this.widthInsets, $this$measure_u2d3p2s80s.getLayoutDirection(), $this$measure_u2d3p2s80s).intValue();
        if (width != 0) {
            long childConstraints = Constraints.m7447copyZbe2FdA(j, (11 & 1) != 0 ? Constraints.m7460getMinWidthimpl(j) : width, (11 & 2) != 0 ? Constraints.m7458getMaxWidthimpl(j) : width, (11 & 4) != 0 ? Constraints.m7459getMinHeightimpl(j) : 0, (11 & 8) != 0 ? Constraints.m7457getMaxHeightimpl(j) : 0);
