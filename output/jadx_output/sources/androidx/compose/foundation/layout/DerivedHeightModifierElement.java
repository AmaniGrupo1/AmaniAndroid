...
final class DerivedHeightModifierElement extends ModifierNodeElement<DerivedHeightModifierNode> {
    ...
    public DerivedHeightModifierElement(WindowInsets insets, Function1<? super InspectorInfo, Unit> function1, Function2<? super WindowInsets, ? super Density, Integer> function2) {
        this.insets = insets;
