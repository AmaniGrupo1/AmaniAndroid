...
final class AlignmentLineOffsetTextUnitElement extends ModifierNodeElement<AlignmentLineOffsetTextUnitNode> {
    ...
    public int hashCode() {
        ...
        return (((result * 31) + TextUnit.m7700hashCodeimpl(this.before)) * 31) + TextUnit.m7700hashCodeimpl(this.after);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.alignmentLine, otherModifier.alignmentLine) && TextUnit.m7696equalsimpl0(this.before, otherModifier.before) && TextUnit.m7696equalsimpl0(this.after, otherModifier.after);
    }
    ...
    public void update(AlignmentLineOffsetTextUnitNode node) {
        ...
        node.m677setBeforeR2X_6o(this.before);
        node.m676setAfterR2X_6o(this.after);
    }
}
