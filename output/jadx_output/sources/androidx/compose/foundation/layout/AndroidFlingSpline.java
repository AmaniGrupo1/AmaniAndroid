...
final class AndroidFlingSpline {
    ...
    private static final float[] SplinePositions = new float[Endpoint.TARGET_FIELD_NUMBER];
    private static final float[] SplineTimes = new float[Endpoint.TARGET_FIELD_NUMBER];
    ...
    public final long m678flingPositionLfoxSSI(float time) {
        float f = 100;
        ...
        return FlingResult.m680constructorimpl((v1$iv << 32) | (4294967295L & v2$iv));
    }
    ...
    public static final class FlingResult {
        ...
        public static final /* synthetic */ FlingResult m679boximpl(long j) {
        ...
        public int hashCode() {
            return m685hashCodeimpl(this.packedValue);
        }

        public String toString() {
            return m686toStringimpl(this.packedValue);
        }
        ...
        public static final float m683getDistanceCoefficientimpl(long j) {
        ...
        public static final float m684getVelocityCoefficientimpl(long j) {
