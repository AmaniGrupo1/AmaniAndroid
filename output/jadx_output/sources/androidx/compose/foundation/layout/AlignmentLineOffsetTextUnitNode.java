...
final class AlignmentLineOffsetTextUnitNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo69measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long j) {
        return AlignmentLineKt.m657alignmentLineOffsetMeasuretjqqzMA($this$measure_u2d3p2s80s, this.alignmentLine, ((TextUnit.m7697getRawTypeimpl(this.before) > 0L ? 1 : (TextUnit.m7697getRawTypeimpl(this.before) == 0L ? 0 : -1)) == 0 ? 1 : 0) == 0 ? $this$measure_u2d3p2s80s.mo400toDpGaN1DYA(this.before) : Dp.INSTANCE.m7525getUnspecifiedD9Ej5fM(), !(TextUnit.m7697getRawTypeimpl(this.after) == 0) ? $this$measure_u2d3p2s80s.mo400toDpGaN1DYA(this.after) : Dp.INSTANCE.m7525getUnspecifiedD9Ej5fM(), measurable, j);
    }
}
