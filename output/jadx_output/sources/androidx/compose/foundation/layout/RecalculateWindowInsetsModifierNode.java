...
final class RecalculateWindowInsetsModifierNode extends InsetsConsumingModifierNode implements LayoutModifierNode {
    ...
    public MeasureResult mo69measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, final Measurable measurable, long j) {
        if (!Constraints.m7456getHasFixedWidthimpl(j) || !Constraints.m7455getHasFixedHeightimpl(j)) {
        ...
        final int width = Constraints.m7458getMaxWidthimpl(j);
        final int height = Constraints.m7457getMaxHeightimpl(j);
    ...
    static final Unit measure_3p2s80s$lambda$1(RecalculateWindowInsetsModifierNode this$0, Measurable $measurable, int $width, int $height, Placeable.PlacementScope $this$layout) {
        ...
        if (coordinates != null) {
            ...
            long bottomRight = coordinates.mo6152localToRootMKHz9U(Offset.m4444constructorimpl((v1$iv$iv << 32) | (v2$iv$iv & 4294967295L)));
            LayoutCoordinates root = LayoutCoordinatesKt.findRootCoordinates(coordinates);
            long rootSize = root.mo6149getSizeYbymL2g();
        ...
        Placeable placeable = $measurable.mo6141measureBRTryo0(Constraints.INSTANCE.m7468fixedJhjzzOo($width, $height));
        Placeable.PlacementScope.place$default($this$layout, placeable, 0, 0, 0.0f, 4, null);
        return Unit.INSTANCE;
    }
