...
final class DerivedHeightModifierNode extends InsetsConsumingModifierNode implements LayoutModifierNode {
    ...
    public DerivedHeightModifierNode(WindowInsets insets, Function2<? super WindowInsets, ? super Density, Integer> function2) {
        this.insets = insets;
    ...
    public MeasureResult mo69measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long j) {
        int height = this.heightCalc.invoke(this.heightInsets, $this$measure_u2d3p2s80s).intValue();
        if (height != 0) {
            long childConstraints = Constraints.m7447copyZbe2FdA(j, (11 & 1) != 0 ? Constraints.m7460getMinWidthimpl(j) : 0, (11 & 2) != 0 ? Constraints.m7458getMaxWidthimpl(j) : 0, (11 & 4) != 0 ? Constraints.m7459getMinHeightimpl(j) : height, (11 & 8) != 0 ? Constraints.m7457getMaxHeightimpl(j) : height);
