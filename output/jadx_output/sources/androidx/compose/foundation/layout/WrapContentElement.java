...
final class WrapContentElement extends ModifierNodeElement<WrapContentNode> {
    ...
    public static final class Companion {
        ...
        static final IntOffset width$lambda$0(Alignment.Horizontal $align, IntSize size, LayoutDirection layoutDirection) {
            int x$iv = $align.align(0, (int) (size.m7680unboximpl() >> 32), layoutDirection);
            return IntOffset.m7624boximpl(IntOffset.m7627constructorimpl((((long) x$iv) << 32) | (((long) 0) & 4294967295L)));
        }
        ...
        static final IntOffset height$lambda$0(Alignment.Vertical $align, IntSize size, LayoutDirection layoutDirection) {
            int y$iv = $align.align(0, (int) (size.m7680unboximpl() & 4294967295L));
            return IntOffset.m7624boximpl(IntOffset.m7627constructorimpl((((long) 0) << 32) | (4294967295L & ((long) y$iv))));
        }
        ...
        public final WrapContentElement size(final Alignment align, boolean unbounded) {
            return new WrapContentElement(Direction.Both, unbounded, new Function2() { // from class: androidx.compose.foundation.layout.WrapContentElement$Companion$$ExternalSyntheticLambda2
                @Override // kotlin.jvm.functions.Function2
                public final Object invoke(Object obj, Object obj2) {
                    return IntOffset.m7624boximpl(align.mo4171alignKFBX0sM(IntSize.INSTANCE.m7681getZeroYbymL2g(), ((IntSize) obj).m7680unboximpl(), (LayoutDirection) obj2));
                }
