...
public final class WindowInsetsConnection_androidKt {
    ...
    static final Modifier imeNestedScroll$lambda$1(Modifier $this$composed, Composer $composer, int $changed) {
        ...
        NestedScrollConnection nestedScrollConnection = m888rememberWindowInsetsConnectionVRgvIgI(WindowInsetsHolder.INSTANCE.current($composer, 6).getIme(), WindowInsetsSides.INSTANCE.m911getBottomJoeWqyM(), $composer, 48);
    ...
    public static final NestedScrollConnection m888rememberWindowInsetsConnectionVRgvIgI(AndroidWindowInsets windowInsets, int i, Composer $composer, int $changed) {
        ...
        SideCalculator sideCalculator = SideCalculator.INSTANCE.m847chooseCalculatorni1skBw(i, layoutDirection);
