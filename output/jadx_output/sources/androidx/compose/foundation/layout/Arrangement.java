...
public final class Arrangement {
    ...
    private static final HorizontalOrVertical Center = new HorizontalOrVertical() { // from class: androidx.compose.foundation.layout.Arrangement$Center$1
        private final float spacing = Dp.m7505constructorimpl(0);
    ...
    public interface Horizontal {
        ...
        public static final class DefaultImpls {
            ...
            public static float m696getSpacingD9Ej5fM(Horizontal $this) {
    ...
    public interface Vertical {
        ...
        public static final class DefaultImpls {
            @Deprecated
            /* JADX INFO: renamed from: getSpacing-D9Ej5fM, reason: not valid java name */
            public static float m704getSpacingD9Ej5fM(Vertical $this) {
    ...
    public interface HorizontalOrVertical extends Horizontal, Vertical {
        ...
        public static final class DefaultImpls {
            @Deprecated
            /* JADX INFO: renamed from: getSpacing-D9Ej5fM, reason: not valid java name */
            public static float m698getSpacingD9Ej5fM(HorizontalOrVertical $this) {
    ...
    public final HorizontalOrVertical m688spacedBy0680j_4(float space) {
    ...
    public final Horizontal m689spacedByD5KLDUw(float space, final Alignment.Horizontal alignment) {
    ...
    /* JADX INFO: renamed from: spacedBy-D5KLDUw, reason: not valid java name */
    public final Vertical m690spacedByD5KLDUw(float space, final Alignment.Vertical alignment) {
    ...
    public final Horizontal aligned(final Alignment.Horizontal alignment) {
        return new SpacedAligned(Dp.m7505constructorimpl(0), true, new Function2() { // from class: androidx.compose.foundation.layout.Arrangement$$ExternalSyntheticLambda2
            @Override // kotlin.jvm.functions.Function2
            public final Object invoke(Object obj, Object obj2) {
                return Integer.valueOf(alignment.align(0, ((Integer) obj).intValue(), (LayoutDirection) obj2));
            }
    ...
    public final Vertical aligned(final Alignment.Vertical alignment) {
        return new SpacedAligned(Dp.m7505constructorimpl(0), false, new Function2() { // from class: androidx.compose.foundation.layout.Arrangement$$ExternalSyntheticLambda3
            @Override // kotlin.jvm.functions.Function2
            public final Object invoke(Object obj, Object obj2) {
                return Integer.valueOf(alignment.align(0, ((Integer) obj).intValue()));
            }
    ...
    public static final class Absolute {
        ...
        /* JADX INFO: renamed from: spacedBy-0680j_4, reason: not valid java name */
        public final HorizontalOrVertical m691spacedBy0680j_4(float space) {
            return new SpacedAligned(space, false, null, 0 == true ? 1 : 0);
        }

        /* JADX INFO: renamed from: spacedBy-D5KLDUw, reason: not valid java name */
        public final Horizontal m692spacedByD5KLDUw(float space, final Alignment.Horizontal alignment) {
        ...
        /* JADX INFO: renamed from: spacedBy-D5KLDUw, reason: not valid java name */
        public final Vertical m693spacedByD5KLDUw(float space, final Alignment.Vertical alignment) {
        ...
        public final Horizontal aligned(final Alignment.Horizontal alignment) {
            return new SpacedAligned(Dp.m7505constructorimpl(0), false, new Function2() { // from class: androidx.compose.foundation.layout.Arrangement$Absolute$$ExternalSyntheticLambda1
                @Override // kotlin.jvm.functions.Function2
                public final Object invoke(Object obj, Object obj2) {
                    return Integer.valueOf(alignment.align(0, ((Integer) obj).intValue(), (LayoutDirection) obj2));
                }
    ...
    public static final /* data */ class SpacedAligned implements HorizontalOrVertical {
        ...
        public final SpacedAligned m701copy8Feqmps(float space, boolean rtlMirror, Function2<? super Integer, ? super LayoutDirection, Integer> alignment) {
        ...
        public boolean equals(Object other) {
            ...
            return Dp.m7510equalsimpl0(this.space, spacedAligned.space) && this.rtlMirror == spacedAligned.rtlMirror && Intrinsics.areEqual(this.alignment, spacedAligned.alignment);
        }

        public int hashCode() {
            return (((Dp.m7511hashCodeimpl(this.space) * 31) + Boolean.hashCode(this.rtlMirror)) * 31) + (this.alignment == null ? 0 : this.alignment.hashCode());
        }
        ...
        public void arrange(Density $this$arrange, int totalSize, int[] sizes, LayoutDirection layoutDirection, int[] outPositions) {
            ...
            int spacePx = $this$arrange.mo399roundToPx0680j_4(this.space);
            int occupied2 = 0;
            int lastSpace2 = 0;
            boolean reversed = this.rtlMirror && layoutDirection == LayoutDirection.Rtl;
            Arrangement arrangement = Arrangement.INSTANCE;
            boolean reversed$iv = reversed;
            if (!reversed$iv) {
        ...
        public String toString() {
            return (this.rtlMirror ? "" : "Absolute") + "Arrangement#spacedAligned(" + ((Object) Dp.m7516toStringimpl(this.space)) + ", " + this.alignment + ')';
        }
    }
