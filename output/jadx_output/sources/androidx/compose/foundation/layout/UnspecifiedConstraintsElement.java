...
final class UnspecifiedConstraintsElement extends ModifierNodeElement<UnspecifiedConstraintsNode> {
    ...
    public void update(UnspecifiedConstraintsNode node) {
        node.m887setMinWidth0680j_4(this.minWidth);
        node.m886setMinHeight0680j_4(this.minHeight);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public void inspectableProperties(InspectorInfo $this$inspectableProperties) {
        $this$inspectableProperties.setName("defaultMinSize");
        $this$inspectableProperties.getProperties().set("minWidth", Dp.m7503boximpl(this.minWidth));
        $this$inspectableProperties.getProperties().set("minHeight", Dp.m7503boximpl(this.minHeight));
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public boolean equals(Object other) {
        return (other instanceof UnspecifiedConstraintsElement) && Dp.m7510equalsimpl0(this.minWidth, ((UnspecifiedConstraintsElement) other).minWidth) && Dp.m7510equalsimpl0(this.minHeight, ((UnspecifiedConstraintsElement) other).minHeight);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (Dp.m7511hashCodeimpl(this.minWidth) * 31) + Dp.m7511hashCodeimpl(this.minHeight);
    }
}
