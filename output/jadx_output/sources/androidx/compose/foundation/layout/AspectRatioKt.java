...
public final class AspectRatioKt {
    ...
    public static final boolean m705isSatisfiedByNN6EwU(long j, int width, int height) {
        if (width <= Constraints.m7458getMaxWidthimpl(j) && Constraints.m7460getMinWidthimpl(j) <= width) {
            if (height <= Constraints.m7457getMaxHeightimpl(j) && Constraints.m7459getMinHeightimpl(j) <= height) {
                return true;
            }
        }
        return false;
