...
public final class ContextualFlowColumnOverflow extends FlowLayoutOverflow {
    ...
    public static final class Companion {
        ...
        public final ContextualFlowColumnOverflow m723expandOrCollapseIndicatorjt2gSs(final Function3<? super ContextualFlowColumnOverflowScope, ? super Composer, ? super Integer, Unit> function3, final Function3<? super ContextualFlowColumnOverflowScope, ? super Composer, ? super Integer, Unit> function32, int minColumnsToShowCollapse, float f, Composer $composer, int $changed, int i) {
            ...
            int minWidthToShowCollapsePx = $this$expandOrCollapseIndicator__jt2gSs_u24lambda_u240.mo399roundToPx0680j_4(fM7505constructorimpl);
            ComposerKt.sourceInformationMarkerStart($composer, 1274002808, "CC(remember):FlowLayoutOverflow.kt#9igjgp");
            boolean invalid$iv = (((($changed & 896) ^ RendererCapabilities.DECODER_SUPPORT_MASK) > 256 && $composer.changed(minColumnsToShowCollapse2)) || ($changed & RendererCapabilities.DECODER_SUPPORT_MASK) == 256) | $composer.changed(minWidthToShowCollapsePx) | (((($changed & 14) ^ 6) > 4 && $composer.changed(function3)) || ($changed & 6) == 4) | (((($changed & 112) ^ 48) > 32 && $composer.changed(function32)) || ($changed & 48) == 32);
