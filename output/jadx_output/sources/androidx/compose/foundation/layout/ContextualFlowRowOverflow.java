...
public final class ContextualFlowRowOverflow extends FlowLayoutOverflow {
    ...
    public static final class Companion {
        ...
        public final ContextualFlowRowOverflow m728expandOrCollapseIndicatorjt2gSs(final Function3<? super ContextualFlowRowOverflowScope, ? super Composer, ? super Integer, Unit> function3, final Function3<? super ContextualFlowRowOverflowScope, ? super Composer, ? super Integer, Unit> function32, int minRowsToShowCollapse, float f, Composer $composer, int $changed, int i) {
            ...
            float fM7505constructorimpl = (i & 8) != 0 ? Dp.m7505constructorimpl(0) : f;
            if (ComposerKt.isTraceInProgress()) {
            ...
            int minHeightToShowCollapsePx = $this$expandOrCollapseIndicator__jt2gSs_u24lambda_u240.mo399roundToPx0680j_4(fM7505constructorimpl);
            ComposerKt.sourceInformationMarkerStart($composer, 1297597357, "CC(remember):FlowLayoutOverflow.kt#9igjgp");
            boolean invalid$iv = (((($changed & 896) ^ RendererCapabilities.DECODER_SUPPORT_MASK) > 256 && $composer.changed(minRowsToShowCollapse2)) || ($changed & RendererCapabilities.DECODER_SUPPORT_MASK) == 256) | $composer.changed(minHeightToShowCollapsePx) | (((($changed & 14) ^ 6) > 4 && $composer.changed(function3)) || ($changed & 6) == 4) | (((($changed & 112) ^ 48) > 32 && $composer.changed(function32)) || ($changed & 48) == 32);
