...
final class PaddingElement extends ModifierNodeElement<PaddingNode> {
    ...
    private PaddingElement(float start, float top, float end, float bottom, boolean rtlAware, Function1<? super InspectorInfo, Unit> function1) {
        this.start = start;
        this.top = top;
        this.end = end;
        this.bottom = bottom;
        ...
        boolean value$iv = (this.start >= 0.0f || Float.isNaN(this.start)) & (this.top >= 0.0f || Float.isNaN(this.top)) & (this.end >= 0.0f || Float.isNaN(this.end)) & (this.bottom >= 0.0f || Float.isNaN(this.bottom));
        if (value$iv) {
            return;
        }
    ...
    public /* synthetic */ PaddingElement(float f, float f2, float f3, float f4, boolean z, Function1 function1, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? Dp.m7505constructorimpl(0) : f, (i & 2) != 0 ? Dp.m7505constructorimpl(0) : f2, (i & 4) != 0 ? Dp.m7505constructorimpl(0) : f3, (i & 8) != 0 ? Dp.m7505constructorimpl(0) : f4, z, function1, null);
    }
    ...
    public void update(PaddingNode node) {
        node.m829setStart0680j_4(this.start);
        node.m830setTop0680j_4(this.top);
        node.m828setEnd0680j_4(this.end);
        node.m827setBottom0680j_4(this.bottom);
        node.setRtlAware(this.rtlAware);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        int result = Dp.m7511hashCodeimpl(this.start);
        return (((((((result * 31) + Dp.m7511hashCodeimpl(this.top)) * 31) + Dp.m7511hashCodeimpl(this.end)) * 31) + Dp.m7511hashCodeimpl(this.bottom)) * 31) + Boolean.hashCode(this.rtlAware);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public boolean equals(Object other) {
        PaddingElement otherModifierElement = other instanceof PaddingElement ? (PaddingElement) other : null;
        return otherModifierElement != null && Dp.m7510equalsimpl0(this.start, otherModifierElement.start) && Dp.m7510equalsimpl0(this.top, otherModifierElement.top) && Dp.m7510equalsimpl0(this.end, otherModifierElement.end) && Dp.m7510equalsimpl0(this.bottom, otherModifierElement.bottom) && this.rtlAware == otherModifierElement.rtlAware;
    }
