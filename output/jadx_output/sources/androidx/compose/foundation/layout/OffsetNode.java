...
final class OffsetNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public final void m783updateMdfbLM(float x, float y, boolean rtlAware) {
        if (!Dp.m7510equalsimpl0(this.x, x) || !Dp.m7510equalsimpl0(this.y, y) || this.rtlAware != rtlAware) {
    ...
    static final Unit measure_3p2s80s$lambda$0(OffsetNode this$0, Placeable $placeable, Placeable.PlacementScope $this$layout) {
        if (this$0.rtlAware) {
            Placeable.PlacementScope.placeRelative$default($this$layout, $placeable, $this$layout.mo399roundToPx0680j_4(this$0.x), $this$layout.mo399roundToPx0680j_4(this$0.y), 0.0f, 4, null);
        } else {
            Placeable.PlacementScope.place$default($this$layout, $placeable, $this$layout.mo399roundToPx0680j_4(this$0.x), $this$layout.mo399roundToPx0680j_4(this$0.y), 0.0f, 4, null);
        }
