...
final class UnspecifiedConstraintsNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public /* synthetic */ UnspecifiedConstraintsNode(float f, float f2, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? Dp.INSTANCE.m7525getUnspecifiedD9Ej5fM() : f, (i & 2) != 0 ? Dp.INSTANCE.m7525getUnspecifiedD9Ej5fM() : f2, null);
    }
    ...
    public MeasureResult mo69measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long j) {
        ...
        if (!Float.isNaN(this.minWidth) && Constraints.m7460getMinWidthimpl(j) == 0) {
            int $this$fastCoerceIn$iv = $this$measure_u2d3p2s80s.mo399roundToPx0680j_4(this.minWidth);
            ...
            maximumValue$iv$iv = Constraints.m7460getMinWidthimpl(j);
        }
        int iM7458getMaxWidthimpl = Constraints.m7458getMaxWidthimpl(j);
        if (!Float.isNaN(this.minHeight) && Constraints.m7459getMinHeightimpl(j) == 0) {
            int $this$fastCoerceIn$iv2 = $this$measure_u2d3p2s80s.mo399roundToPx0680j_4(this.minHeight);
            ...
            maximumValue$iv$iv2 = Constraints.m7459getMinHeightimpl(j);
        }
        long wrappedConstraints = ConstraintsKt.Constraints(maximumValue$iv$iv, iM7458getMaxWidthimpl, maximumValue$iv$iv2, Constraints.m7457getMaxHeightimpl(j));
    ...
    public int minIntrinsicWidth(IntrinsicMeasureScope $this$minIntrinsicWidth, IntrinsicMeasurable measurable, int height) {
        ...
        int minimumValue$iv = !Float.isNaN(this.minWidth) ? $this$minIntrinsicWidth.mo399roundToPx0680j_4(this.minWidth) : 0;
    ...
    public int maxIntrinsicWidth(IntrinsicMeasureScope $this$maxIntrinsicWidth, IntrinsicMeasurable measurable, int height) {
        ...
        int minimumValue$iv = !Float.isNaN(this.minWidth) ? $this$maxIntrinsicWidth.mo399roundToPx0680j_4(this.minWidth) : 0;
        return $this$fastCoerceAtLeast$iv < minimumValue$iv ? minimumValue$iv : $this$fastCoerceAtLeast$iv;
    }
    ...
    public int minIntrinsicHeight(IntrinsicMeasureScope $this$minIntrinsicHeight, IntrinsicMeasurable measurable, int width) {
        ...
        int minimumValue$iv = !Float.isNaN(this.minHeight) ? $this$minIntrinsicHeight.mo399roundToPx0680j_4(this.minHeight) : 0;
        return $this$fastCoerceAtLeast$iv < minimumValue$iv ? minimumValue$iv : $this$fastCoerceAtLeast$iv;
    }
    ...
    public int maxIntrinsicHeight(IntrinsicMeasureScope $this$maxIntrinsicHeight, IntrinsicMeasurable measurable, int width) {
        ...
        int minimumValue$iv = !Float.isNaN(this.minHeight) ? $this$maxIntrinsicHeight.mo399roundToPx0680j_4(this.minHeight) : 0;
        return $this$fastCoerceAtLeast$iv < minimumValue$iv ? minimumValue$iv : $this$fastCoerceAtLeast$iv;
    }
}
