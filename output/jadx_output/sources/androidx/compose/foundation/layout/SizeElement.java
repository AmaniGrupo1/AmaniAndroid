...
final class SizeElement extends ModifierNodeElement<SizeNode> {
    ...
    public /* synthetic */ SizeElement(float f, float f2, float f3, float f4, boolean z, Function1 function1, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? Dp.INSTANCE.m7525getUnspecifiedD9Ej5fM() : f, (i & 2) != 0 ? Dp.INSTANCE.m7525getUnspecifiedD9Ej5fM() : f2, (i & 4) != 0 ? Dp.INSTANCE.m7525getUnspecifiedD9Ej5fM() : f3, (i & 8) != 0 ? Dp.INSTANCE.m7525getUnspecifiedD9Ej5fM() : f4, z, function1, null);
    }
    ...
    public void update(SizeNode node) {
        node.m880setMinWidth0680j_4(this.minWidth);
        node.m879setMinHeight0680j_4(this.minHeight);
        node.m878setMaxWidth0680j_4(this.maxWidth);
        node.m877setMaxHeight0680j_4(this.maxHeight);
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof SizeElement) && Dp.m7510equalsimpl0(this.minWidth, ((SizeElement) other).minWidth) && Dp.m7510equalsimpl0(this.minHeight, ((SizeElement) other).minHeight) && Dp.m7510equalsimpl0(this.maxWidth, ((SizeElement) other).maxWidth) && Dp.m7510equalsimpl0(this.maxHeight, ((SizeElement) other).maxHeight) && this.enforceIncoming == ((SizeElement) other).enforceIncoming;
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        int result = Dp.m7511hashCodeimpl(this.minWidth);
        return (((((((result * 31) + Dp.m7511hashCodeimpl(this.minHeight)) * 31) + Dp.m7511hashCodeimpl(this.maxWidth)) * 31) + Dp.m7511hashCodeimpl(this.maxHeight)) * 31) + Boolean.hashCode(this.enforceIncoming);
    }
}
