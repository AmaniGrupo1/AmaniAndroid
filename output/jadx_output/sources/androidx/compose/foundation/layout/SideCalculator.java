...
interface SideCalculator {
    ...
    long mo845consumedOffsetsMKHz9U(long available);

    /* JADX INFO: renamed from: consumedVelocity-QWom1Mo, reason: not valid java name */
    long mo846consumedVelocityQWom1Mo(long available, float remaining);
    ...
    public static final class Companion {
        ...
        private static final SideCalculator$Companion$LeftSideCalculator$1 LeftSideCalculator = new SideCalculator() { // from class: androidx.compose.foundation.layout.SideCalculator$Companion$LeftSideCalculator$1
            ...
            public long mo845consumedOffsetsMKHz9U(long available) {
            ...
            public long mo846consumedVelocityQWom1Mo(long available, float remaining) {
                return VelocityKt.Velocity(Velocity.m7743getXimpl(available) - remaining, 0.0f);
            }
        };
        private static final SideCalculator$Companion$TopSideCalculator$1 TopSideCalculator = new SideCalculator() { // from class: androidx.compose.foundation.layout.SideCalculator$Companion$TopSideCalculator$1
            ...
            /* JADX INFO: renamed from: consumedVelocity-QWom1Mo */
            public long mo846consumedVelocityQWom1Mo(long available, float remaining) {
                return VelocityKt.Velocity(0.0f, Velocity.m7744getYimpl(available) - remaining);
            }
        };
        ...
        public final SideCalculator m847chooseCalculatorni1skBw(int side, LayoutDirection layoutDirection) {
            if (WindowInsetsSides.m900equalsimpl0(side, WindowInsetsSides.INSTANCE.m914getLeftJoeWqyM())) {
                return LeftSideCalculator;
            }
            if (WindowInsetsSides.m900equalsimpl0(side, WindowInsetsSides.INSTANCE.m917getTopJoeWqyM())) {
                return TopSideCalculator;
            }
            if (WindowInsetsSides.m900equalsimpl0(side, WindowInsetsSides.INSTANCE.m915getRightJoeWqyM())) {
                return RightSideCalculator;
            }
            if (WindowInsetsSides.m900equalsimpl0(side, WindowInsetsSides.INSTANCE.m911getBottomJoeWqyM())) {
                return BottomSideCalculator;
            }
            if (WindowInsetsSides.m900equalsimpl0(side, WindowInsetsSides.INSTANCE.m916getStartJoeWqyM())) {
                if (layoutDirection == LayoutDirection.Ltr) {
                    return LeftSideCalculator;
                }
                return RightSideCalculator;
            }
            if (WindowInsetsSides.m900equalsimpl0(side, WindowInsetsSides.INSTANCE.m912getEndJoeWqyM())) {
                if (layoutDirection == LayoutDirection.Ltr) {
                    return RightSideCalculator;
                }
                return LeftSideCalculator;
