...
abstract class IntrinsicSizeModifier extends Modifier.Node implements LayoutModifierNode {
    ...
    public abstract long mo771calculateContentConstraintsl58MMJ0(MeasureScope measureScope, Measurable measurable, long j);

    public abstract boolean getEnforceIncoming();

    @Override // androidx.compose.ui.node.LayoutModifierNode
    /* JADX INFO: renamed from: measure-3p2s80s */
    public final MeasureResult mo69measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long j) {
        long contentConstraints = mo771calculateContentConstraintsl58MMJ0($this$measure_u2d3p2s80s, measurable, j);
        final Placeable placeable = measurable.mo6141measureBRTryo0(getEnforceIncoming() ? ConstraintsKt.m7473constrainN9IONVI(j, contentConstraints) : contentConstraints);
    ...
    static final Unit measure_3p2s80s$lambda$0(Placeable $placeable, Placeable.PlacementScope $this$layout) {
        Placeable.PlacementScope.m6208placeRelative70tqf50$default($this$layout, $placeable, IntOffset.INSTANCE.m7644getZeronOccac(), 0.0f, 2, null);
