...
public final /* data */ class ColumnMeasurePolicy implements MeasurePolicy, RowColumnMeasurePolicy {
    ...
    public MeasureResult mo41measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, List<? extends Measurable> list, long j) {
        return RowColumnMeasurePolicyKt.measure$default(this, Constraints.m7459getMinHeightimpl(j), Constraints.m7460getMinWidthimpl(j), Constraints.m7457getMaxHeightimpl(j), Constraints.m7458getMaxWidthimpl(j), $this$measure_u2d3p2s80s.mo399roundToPx0680j_4(this.verticalArrangement.getSpacing()), $this$measure_u2d3p2s80s, list, new Placeable[list.size()], 0, list.size(), null, 0, 3072, null);
    }
    ...
    public int minIntrinsicWidth(IntrinsicMeasureScope $this$minIntrinsicWidth, List<? extends IntrinsicMeasurable> list, int height) {
        return IntrinsicMeasureBlocks.INSTANCE.VerticalMinWidth(list, height, $this$minIntrinsicWidth.mo399roundToPx0680j_4(this.verticalArrangement.getSpacing()));
    }
    ...
    public int minIntrinsicHeight(IntrinsicMeasureScope $this$minIntrinsicHeight, List<? extends IntrinsicMeasurable> list, int width) {
        return IntrinsicMeasureBlocks.INSTANCE.VerticalMinHeight(list, width, $this$minIntrinsicHeight.mo399roundToPx0680j_4(this.verticalArrangement.getSpacing()));
    }
    ...
    public int maxIntrinsicWidth(IntrinsicMeasureScope $this$maxIntrinsicWidth, List<? extends IntrinsicMeasurable> list, int height) {
        return IntrinsicMeasureBlocks.INSTANCE.VerticalMaxWidth(list, height, $this$maxIntrinsicWidth.mo399roundToPx0680j_4(this.verticalArrangement.getSpacing()));
    }
    ...
    public int maxIntrinsicHeight(IntrinsicMeasureScope $this$maxIntrinsicHeight, List<? extends IntrinsicMeasurable> list, int width) {
        return IntrinsicMeasureBlocks.INSTANCE.VerticalMaxHeight(list, width, $this$maxIntrinsicHeight.mo399roundToPx0680j_4(this.verticalArrangement.getSpacing()));
    }
}
