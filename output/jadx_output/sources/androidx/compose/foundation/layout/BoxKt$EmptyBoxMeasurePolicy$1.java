...
final class BoxKt$EmptyBoxMeasurePolicy$1 implements MeasurePolicy {
    ...
    public final MeasureResult mo41measure3p2s80s(MeasureScope $this$MeasurePolicy, List<? extends Measurable> list, long j) {
        return MeasureScope.layout$default($this$MeasurePolicy, Constraints.m7460getMinWidthimpl(j), Constraints.m7459getMinHeightimpl(j), null, new Function1() { // from class: androidx.compose.foundation.layout.BoxKt$EmptyBoxMeasurePolicy$1$$ExternalSyntheticLambda0
