...
final /* data */ class FlowMeasurePolicy implements MultiContentMeasurePolicy, FlowLineMeasurePolicy {
    ...
    public boolean equals(Object other) {
        ...
        return this.isHorizontal == flowMeasurePolicy.isHorizontal && Intrinsics.areEqual(this.horizontalArrangement, flowMeasurePolicy.horizontalArrangement) && Intrinsics.areEqual(this.verticalArrangement, flowMeasurePolicy.verticalArrangement) && Dp.m7510equalsimpl0(this.mainAxisSpacing, flowMeasurePolicy.mainAxisSpacing) && Intrinsics.areEqual(this.crossAxisAlignment, flowMeasurePolicy.crossAxisAlignment) && Dp.m7510equalsimpl0(this.crossAxisArrangementSpacing, flowMeasurePolicy.crossAxisArrangementSpacing) && this.maxItemsInMainAxis == flowMeasurePolicy.maxItemsInMainAxis && this.maxLines == flowMeasurePolicy.maxLines && Intrinsics.areEqual(this.overflow, flowMeasurePolicy.overflow);
    }

    public int hashCode() {
        return (((((((((((((((Boolean.hashCode(this.isHorizontal) * 31) + this.horizontalArrangement.hashCode()) * 31) + this.verticalArrangement.hashCode()) * 31) + Dp.m7511hashCodeimpl(this.mainAxisSpacing)) * 31) + this.crossAxisAlignment.hashCode()) * 31) + Dp.m7511hashCodeimpl(this.crossAxisArrangementSpacing)) * 31) + Integer.hashCode(this.maxItemsInMainAxis)) * 31) + Integer.hashCode(this.maxLines)) * 31) + this.overflow.hashCode();
    }

    public String toString() {
        return "FlowMeasurePolicy(isHorizontal=" + this.isHorizontal + ", horizontalArrangement=" + this.horizontalArrangement + ", verticalArrangement=" + this.verticalArrangement + ", mainAxisSpacing=" + ((Object) Dp.m7516toStringimpl(this.mainAxisSpacing)) + ", crossAxisAlignment=" + this.crossAxisAlignment + ", crossAxisArrangementSpacing=" + ((Object) Dp.m7516toStringimpl(this.crossAxisArrangementSpacing)) + ", maxItemsInMainAxis=" + this.maxItemsInMainAxis + ", maxLines=" + this.maxLines + ", overflow=" + this.overflow + ')';
    }
    ...
    public MeasureResult mo762measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, List<? extends List<? extends Measurable>> list, long j) {
        LayoutOrientation layoutOrientation;
        if (this.maxLines == 0 || this.maxItemsInMainAxis == 0 || list.isEmpty() || (Constraints.m7457getMaxHeightimpl(j) == 0 && this.overflow.getType$foundation_layout() != FlowLayoutOverflow.OverflowType.Visible)) {
        ...
        if (!list2.isEmpty()) {
            ...
            this.overflow.m744setOverflowMeasurableshBUhpc$foundation_layout(this, seeMoreMeasurable, collapseMeasurable, j);
            ...
            return FlowLayoutKt.m738breakDownItemsdi9J0FM($this$measure_u2d3p2s80s, flowMeasurePolicy, it, f, f2, OrientationIndependentConstraints.m787constructorimpl(j, layoutOrientation), this.maxItemsInMainAxis, this.maxLines, this.overflow);
        }
    ...
    public int minIntrinsicWidth(IntrinsicMeasureScope $this$minIntrinsicWidth, List<? extends List<? extends IntrinsicMeasurable>> list, int height) {
        ...
        flowLayoutOverflowState.m745setOverflowMeasurableshBUhpc$foundation_layout(intrinsicMeasurable, list3 != null ? (IntrinsicMeasurable) CollectionsKt.firstOrNull(list3) : null, isHorizontal(), ConstraintsKt.Constraints$default(0, 0, 0, height, 7, null));
        if (isHorizontal()) {
            List<? extends IntrinsicMeasurable> listEmptyList = (List) CollectionsKt.firstOrNull((List) list);
            if (listEmptyList == null) {
                listEmptyList = CollectionsKt.emptyList();
            }
            return minIntrinsicMainAxisSize(listEmptyList, height, $this$minIntrinsicWidth.mo399roundToPx0680j_4(this.mainAxisSpacing), $this$minIntrinsicWidth.mo399roundToPx0680j_4(this.crossAxisArrangementSpacing), this.maxItemsInMainAxis, this.maxLines, this.overflow);
        }
        List<? extends IntrinsicMeasurable> listEmptyList2 = (List) CollectionsKt.firstOrNull((List) list);
        if (listEmptyList2 == null) {
            listEmptyList2 = CollectionsKt.emptyList();
        }
        return intrinsicCrossAxisSize(listEmptyList2, height, $this$minIntrinsicWidth.mo399roundToPx0680j_4(this.mainAxisSpacing), $this$minIntrinsicWidth.mo399roundToPx0680j_4(this.crossAxisArrangementSpacing), this.maxItemsInMainAxis, this.maxLines, this.overflow);
    }
    ...
    public int minIntrinsicHeight(IntrinsicMeasureScope $this$minIntrinsicHeight, List<? extends List<? extends IntrinsicMeasurable>> list, int width) {
        ...
        IntrinsicMeasurable intrinsicMeasurable = list2 != null ? (IntrinsicMeasurable) CollectionsKt.firstOrNull(list2) : null;
        List list3 = (List) CollectionsKt.getOrNull(list, 2);
        flowLayoutOverflowState.m745setOverflowMeasurableshBUhpc$foundation_layout(intrinsicMeasurable, list3 != null ? (IntrinsicMeasurable) CollectionsKt.firstOrNull(list3) : null, isHorizontal(), ConstraintsKt.Constraints$default(0, width, 0, 0, 13, null));
        if (isHorizontal()) {
            List<? extends IntrinsicMeasurable> listEmptyList = (List) CollectionsKt.firstOrNull((List) list);
            if (listEmptyList == null) {
                listEmptyList = CollectionsKt.emptyList();
            }
            return intrinsicCrossAxisSize(listEmptyList, width, $this$minIntrinsicHeight.mo399roundToPx0680j_4(this.mainAxisSpacing), $this$minIntrinsicHeight.mo399roundToPx0680j_4(this.crossAxisArrangementSpacing), this.maxItemsInMainAxis, this.maxLines, this.overflow);
        }
        List<? extends IntrinsicMeasurable> listEmptyList2 = (List) CollectionsKt.firstOrNull((List) list);
        if (listEmptyList2 == null) {
            listEmptyList2 = CollectionsKt.emptyList();
        }
        return minIntrinsicMainAxisSize(listEmptyList2, width, $this$minIntrinsicHeight.mo399roundToPx0680j_4(this.mainAxisSpacing), $this$minIntrinsicHeight.mo399roundToPx0680j_4(this.crossAxisArrangementSpacing), this.maxItemsInMainAxis, this.maxLines, this.overflow);
    }
    ...
    public int maxIntrinsicHeight(IntrinsicMeasureScope $this$maxIntrinsicHeight, List<? extends List<? extends IntrinsicMeasurable>> list, int width) {
        ...
        if (isHorizontal()) {
            ...
            return intrinsicCrossAxisSize(listEmptyList, width, $this$maxIntrinsicHeight.mo399roundToPx0680j_4(this.mainAxisSpacing), $this$maxIntrinsicHeight.mo399roundToPx0680j_4(this.crossAxisArrangementSpacing), this.maxItemsInMainAxis, this.maxLines, this.overflow);
        }
        List<? extends IntrinsicMeasurable> listEmptyList2 = (List) CollectionsKt.firstOrNull((List) list);
        if (listEmptyList2 == null) {
            listEmptyList2 = CollectionsKt.emptyList();
        }
        return maxIntrinsicMainAxisSize(listEmptyList2, width, $this$maxIntrinsicHeight.mo399roundToPx0680j_4(this.mainAxisSpacing));
    }
    ...
    public int maxIntrinsicWidth(IntrinsicMeasureScope $this$maxIntrinsicWidth, List<? extends List<? extends IntrinsicMeasurable>> list, int height) {
        ...
        if (!isHorizontal()) {
            ...
            return intrinsicCrossAxisSize(listEmptyList, height, $this$maxIntrinsicWidth.mo399roundToPx0680j_4(this.mainAxisSpacing), $this$maxIntrinsicWidth.mo399roundToPx0680j_4(this.crossAxisArrangementSpacing), this.maxItemsInMainAxis, this.maxLines, this.overflow);
        }
        List<? extends IntrinsicMeasurable> listEmptyList2 = (List) CollectionsKt.firstOrNull((List) list);
        if (listEmptyList2 == null) {
            listEmptyList2 = CollectionsKt.emptyList();
        }
        return maxIntrinsicMainAxisSize(listEmptyList2, height, $this$maxIntrinsicWidth.mo399roundToPx0680j_4(this.mainAxisSpacing));
    }
    ...
    public final int minIntrinsicMainAxisSize(List<? extends IntrinsicMeasurable> measurables, int crossAxisAvailable, int mainAxisSpacing, int crossAxisSpacing, int maxItemsInMainAxis, int maxLines, FlowLayoutOverflowState overflow) {
        ...
        while (true) {
            ...
            int crossAxisUsed$iv4 = IntIntPair.m28getFirstimpl(pair$iv);
            int itemShown$iv2 = IntIntPair.m29getSecondimpl(pair$iv);
    ...
    public final int intrinsicCrossAxisSize(List<? extends IntrinsicMeasurable> measurables, int mainAxisAvailable, int mainAxisSpacing, int crossAxisSpacing, int maxItemsInMainAxis, int maxLines, FlowLayoutOverflowState overflow) {
        ...
        if (!measurables.isEmpty()) {
            ...
            if (buildingBlocks$iv.m735getWrapInfoOpUlnko(measurables.size() > 1, 0, IntIntPair.m24constructorimpl(currentCrossAxisSize$iv, Integer.MAX_VALUE), nextChild$iv2 == null ? null : IntIntPair.m21boximpl(IntIntPair.m24constructorimpl(nextMainAxisSize$iv, nextCrossAxisSize$iv)), 0, 0, 0, false, false).getIsLastItemInContainer()) {
                IntIntPair intIntPairM743ellipsisSizeF35zmw$foundation_layout = overflow.m743ellipsisSizeF35zmw$foundation_layout(nextChild$iv2 != null, 0, 0);
                ...
                jM24constructorimpl = IntIntPair.m24constructorimpl(size$iv, 0);
            } else {
                ...
                while (true) {
                    ...
                    long jM24constructorimpl2 = IntIntPair.m24constructorimpl(currentCrossAxisSize$iv, Integer.MAX_VALUE);
                    if (nextChild$iv == null) {
                        intIntPairM21boximpl = null;
                    } else {
                        intIntPairM21boximpl = IntIntPair.m21boximpl(IntIntPair.m24constructorimpl(nextMainAxisSize$iv2, nextCrossAxisSize$iv));
                    }
                    FlowLayoutBuildingBlocks.WrapInfo wrapInfo$iv = buildingBlocks$iv.m735getWrapInfoOpUlnko(z, i, jM24constructorimpl2, intIntPairM21boximpl, lineIndex$iv2, totalCrossAxisSize$iv, currentCrossAxisSize$iv2, false, false);
                ...
                jM24constructorimpl = IntIntPair.m24constructorimpl(totalCrossAxisSize$iv - crossAxisSpacing, noOfItemsShown$iv);
            }
        } else {
