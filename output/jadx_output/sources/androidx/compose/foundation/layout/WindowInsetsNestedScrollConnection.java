...
final class WindowInsetsNestedScrollConnection implements NestedScrollConnection, WindowInsetsAnimationControlListener {
    ...
    public long mo896onPreScrollOzD1aCk(long available, int source) {
        ...
        return m894scroll8S9VItk(available, this.sideCalculator.hideMotion(Float.intBitsToFloat(bits$iv$iv$iv), Float.intBitsToFloat(bits$iv$iv$iv2)));
    }
    ...
    public long mo573onPostScrollDzOQY0M(long consumed, long available, int source) {
        int bits$iv$iv$iv = (int) (available >> 32);
        int bits$iv$iv$iv2 = (int) (4294967295L & available);
        return m894scroll8S9VItk(available, this.sideCalculator.showMotion(Float.intBitsToFloat(bits$iv$iv$iv), Float.intBitsToFloat(bits$iv$iv$iv2)));
    }

    /* JADX INFO: renamed from: scroll-8S9VItk, reason: not valid java name */
    private final long m894scroll8S9VItk(long available, float scrollAmount) {
        ...
        if (!(scrollAmount == 0.0f)) {
            if (this.windowInsets.isVisible() != (scrollAmount > 0.0f) || animationController != null) {
                if (animationController == null) {
                    ...
                    requestAnimationController();
                    return this.sideCalculator.mo845consumedOffsetsMKHz9U(available);
                }
    ...
    public Object mo895onPreFlingQWom1Mo(long j, Continuation<? super Velocity> continuation) {
        return m893flinghuYlsQE(j, this.sideCalculator.hideMotion(Velocity.m7743getXimpl(j), Velocity.m7744getYimpl(j)), false, continuation);
    }

    @Override // androidx.compose.ui.input.nestedscroll.NestedScrollConnection
    /* JADX INFO: renamed from: onPostFling-RZ2iAVY */
    public Object mo572onPostFlingRZ2iAVY(long j, long j2, Continuation<? super Velocity> continuation) {
        return m893flinghuYlsQE(j2, this.sideCalculator.showMotion(Velocity.m7743getXimpl(j2), Velocity.m7744getYimpl(j2)), true, continuation);
    }
    ...
    */
    public final Object m893flinghuYlsQE(long j, float f, boolean towardShown, Continuation<? super Velocity> continuation) {
        ...
        switch (windowInsetsNestedScrollConnection$fling$1.label) {
            case 0:
                ...
                animationController = getAnimationController(windowInsetsNestedScrollConnection$fling$1);
                if (animationController == coroutine_suspended) {
                    return coroutine_suspended;
                }
                windowInsetsNestedScrollConnection = this;
                animationController2 = (WindowInsetsAnimationController) animationController;
                if (animationController2 != null) {
                    return Velocity.m7734boximpl(Velocity.INSTANCE.m7754getZero9UxMQ8M());
                }
                int hidden = windowInsetsNestedScrollConnection.sideCalculator.valueOf(animationController2.getHiddenStateInsets());
                int shown = windowInsetsNestedScrollConnection.sideCalculator.valueOf(animationController2.getShownStateInsets());
                Insets currentInsets = animationController2.getCurrentInsets();
                int current = windowInsetsNestedScrollConnection.sideCalculator.valueOf(currentInsets);
                if ((flingAmount <= 0.0f && current == hidden) || (flingAmount >= 0.0f && current == shown)) {
                    animationController2.finish(current == shown);
                ...
                float distance = current + spec.flingDistance(flingAmount);
                float endPercent = (distance - hidden) / (shown - hidden);
                boolean targetShown = endPercent > 0.5f;
                int target = targetShown ? shown : hidden;
                boolean targetShown2 = targetShown;
                if (distance <= shown && distance >= hidden) {
                    WindowInsetsNestedScrollConnection$fling$3 windowInsetsNestedScrollConnection$fling$3 = new WindowInsetsNestedScrollConnection$fling$3(windowInsetsNestedScrollConnection, current, target, flingAmount, animationController2, targetShown2, null);
                    windowInsetsNestedScrollConnection$fling$1.J$0 = j2;
                    ...
                    return Velocity.m7734boximpl(windowInsetsNestedScrollConnection3.sideCalculator.mo846consumedVelocityQWom1Mo(j4, 0.0f));
                }
                WindowInsetsAnimationController animationController3 = animationController2;
                int current2 = current;
                float flingAmount2 = flingAmount;
                boolean z = false;
                Ref.FloatRef endVelocity2 = new Ref.FloatRef();
                WindowInsetsNestedScrollConnection$fling$2 windowInsetsNestedScrollConnection$fling$2 = new WindowInsetsNestedScrollConnection$fling$2(windowInsetsNestedScrollConnection, current2, flingAmount2, spec, hidden, shown, endVelocity2, animationController3, targetShown2 ? true : z, null);
                endVelocity = endVelocity2;
                windowInsetsNestedScrollConnection$fling$1.L$0 = endVelocity;
                windowInsetsNestedScrollConnection$fling$1.J$0 = j2;
                ...
                return Velocity.m7734boximpl(windowInsetsNestedScrollConnection2.sideCalculator.mo846consumedVelocityQWom1Mo(j3, endVelocity.element));
            case 1:
                float flingAmount3 = windowInsetsNestedScrollConnection$fling$1.F$0;
                j2 = windowInsetsNestedScrollConnection$fling$1.J$0;
                ResultKt.throwOnFailure($result);
                flingAmount = flingAmount3;
            ...
            case 2:
                ...
                endVelocity = (Ref.FloatRef) windowInsetsNestedScrollConnection$fling$1.L$0;
                ResultKt.throwOnFailure($result);
                return Velocity.m7734boximpl(windowInsetsNestedScrollConnection2.sideCalculator.mo846consumedVelocityQWom1Mo(j3, endVelocity.element));
            case 3:
                windowInsetsNestedScrollConnection3 = this;
