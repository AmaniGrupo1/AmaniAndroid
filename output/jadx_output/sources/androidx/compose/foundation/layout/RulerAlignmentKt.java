...
public final class RulerAlignmentKt {
    ...
    static final MeasureResult fitInside$lambda$0(final RectRulers $rulers, MeasureScope $this$layout, final Measurable measurable, Constraints constraints) {
        if (Constraints.m7454getHasBoundedWidthimpl(constraints.getValue()) && Constraints.m7453getHasBoundedHeightimpl(constraints.getValue())) {
            final int width = Constraints.m7458getMaxWidthimpl(constraints.getValue());
            final int height = Constraints.m7457getMaxHeightimpl(constraints.getValue());
        ...
        final Placeable placeable = measurable.mo6141measureBRTryo0(constraints.getValue());
    ...
    public static final Unit fitInside$lambda$0$0(RectRulers $rulers, int $width, int $height, Measurable $measurable, Placeable.PlacementScope $this$layout) {
        ...
        long childConstraints = Constraints.INSTANCE.m7468fixedJhjzzOo($this$fastCoerceAtLeast$iv$iv - maximumValue$iv$iv, maximumValue$iv$iv3 - maximumValue$iv);
        Placeable placeable = $measurable.mo6141measureBRTryo0(childConstraints);
    ...
    public static final Unit fitOutside$lambda$0$0(RectRulers $rulers, int $width, int $height, Measurable $measurable, Placeable.PlacementScope $this$layout) {
        ...
        long childConstraints = Constraints.INSTANCE.m7468fixedJhjzzOo(childWidth, childHeight);
        Placeable placeable = $measurable.mo6141measureBRTryo0(childConstraints);
    ...
    public static final Unit fitOutside$lambda$0$1(Measurable $measurable, Placeable.PlacementScope $this$layout) {
        Placeable.PlacementScope.place$default($this$layout, $measurable.mo6141measureBRTryo0(Constraints.INSTANCE.m7468fixedJhjzzOo(0, 0)), 0, 0, 0.0f, 4, null);
        return Unit.INSTANCE;
    }
}
