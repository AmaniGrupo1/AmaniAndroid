...
final class LimitInsets implements WindowInsets {
    ...
    public int getLeft(Density density, LayoutDirection layoutDirection) {
        ...
        if (layoutDirection == LayoutDirection.Ltr) {
            layoutDirectionSide = WindowInsetsSides.INSTANCE.m907getAllowLeftInLtrJoeWqyM$foundation_layout();
        } else {
            layoutDirectionSide = WindowInsetsSides.INSTANCE.m908getAllowLeftInRtlJoeWqyM$foundation_layout();
        }
        boolean allowLeft = WindowInsetsSides.m901hasAnybkgdKaI$foundation_layout(this.sides, layoutDirectionSide);
        if (allowLeft) {
    ...
    public int getTop(Density density) {
        if (WindowInsetsSides.m901hasAnybkgdKaI$foundation_layout(this.sides, WindowInsetsSides.INSTANCE.m917getTopJoeWqyM())) {
    ...
    public int getRight(Density density, LayoutDirection layoutDirection) {
        int layoutDirectionSide;
        if (layoutDirection == LayoutDirection.Ltr) {
            layoutDirectionSide = WindowInsetsSides.INSTANCE.m909getAllowRightInLtrJoeWqyM$foundation_layout();
        } else {
            layoutDirectionSide = WindowInsetsSides.INSTANCE.m910getAllowRightInRtlJoeWqyM$foundation_layout();
        }
        boolean allowRight = WindowInsetsSides.m901hasAnybkgdKaI$foundation_layout(this.sides, layoutDirectionSide);
        if (allowRight) {
    ...
    public int getBottom(Density density) {
        if (WindowInsetsSides.m901hasAnybkgdKaI$foundation_layout(this.sides, WindowInsetsSides.INSTANCE.m911getBottomJoeWqyM())) {
    ...
    public boolean equals(Object other) {
        ...
        if (other instanceof LimitInsets) {
            return Intrinsics.areEqual(this.insets, ((LimitInsets) other).insets) && WindowInsetsSides.m900equalsimpl0(this.sides, ((LimitInsets) other).sides);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (result * 31) + WindowInsetsSides.m902hashCodeimpl(this.sides);
    }
