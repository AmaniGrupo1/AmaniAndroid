...
final class WrapContentNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo69measure3p2s80s(final MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long j) {
        ...
        int iM7460getMinWidthimpl = this.direction != Direction.Vertical ? 0 : Constraints.m7460getMinWidthimpl(j);
        int iM7459getMinHeightimpl = this.direction == Direction.Horizontal ? Constraints.m7459getMinHeightimpl(j) : 0;
        ...
        long wrappedConstraints = ConstraintsKt.Constraints(iM7460getMinWidthimpl, iM7458getMaxWidthimpl, iM7459getMinHeightimpl, (this.direction == Direction.Horizontal || !this.unbounded) ? Constraints.m7457getMaxHeightimpl(j) : Integer.MAX_VALUE);
        final Placeable placeable = measurable.mo6141measureBRTryo0(wrappedConstraints);
        final int wrapperWidth = RangesKt.coerceIn(placeable.getWidth(), Constraints.m7460getMinWidthimpl(j), Constraints.m7458getMaxWidthimpl(j));
        final int wrapperHeight = RangesKt.coerceIn(placeable.getHeight(), Constraints.m7459getMinHeightimpl(j), Constraints.m7457getMaxHeightimpl(j));
    ...
    static final Unit measure_3p2s80s$lambda$0(WrapContentNode this$0, int $wrapperWidth, Placeable $placeable, int $wrapperHeight, MeasureScope $this_measure, Placeable.PlacementScope $this$layout) {
        ...
        long position = function2.invoke(IntSize.m7668boximpl(IntSize.m7671constructorimpl((((long) width$iv) << 32) | (((long) height$iv) & 4294967295L))), $this_measure.getLayoutDirection()).m7642unboximpl();
