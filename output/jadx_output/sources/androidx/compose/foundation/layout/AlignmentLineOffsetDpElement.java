...
final class AlignmentLineOffsetDpElement extends ModifierNodeElement<AlignmentLineOffsetDpNode> {
    ...
    private AlignmentLineOffsetDpElement(AlignmentLine alignmentLine, float before, float after, Function1<? super InspectorInfo, Unit> function1) {
        this.alignmentLine = alignmentLine;
        this.before = before;
        this.after = after;
        this.inspectorInfo = function1;
        boolean value$iv = (this.before >= 0.0f || Float.isNaN(this.before)) & (this.after >= 0.0f || Float.isNaN(this.after));
        if (value$iv) {
            return;
        }
    ...
    public void update(AlignmentLineOffsetDpNode node) {
        ...
        node.m671setBefore0680j_4(this.before);
        node.m670setAfter0680j_4(this.after);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.alignmentLine, otherModifier.alignmentLine) && Dp.m7510equalsimpl0(this.before, otherModifier.before) && Dp.m7510equalsimpl0(this.after, otherModifier.after);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        int result = this.alignmentLine.hashCode();
        return (((result * 31) + Dp.m7511hashCodeimpl(this.before)) * 31) + Dp.m7511hashCodeimpl(this.after);
    }
}
