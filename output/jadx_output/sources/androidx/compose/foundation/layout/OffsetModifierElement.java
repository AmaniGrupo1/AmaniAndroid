...
final class OffsetModifierElement extends ModifierNodeElement<OffsetNode> {
    ...
    public void update(OffsetNode node) {
        node.m783updateMdfbLM(this.x, this.y, this.rtlAware);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m7510equalsimpl0(this.x, otherModifierElement.x) && Dp.m7510equalsimpl0(this.y, otherModifierElement.y) && this.rtlAware == otherModifierElement.rtlAware;
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        int result = Dp.m7511hashCodeimpl(this.x);
        return (((result * 31) + Dp.m7511hashCodeimpl(this.y)) * 31) + Boolean.hashCode(this.rtlAware);
    }

    public String toString() {
        return "OffsetModifierElement(x=" + ((Object) Dp.m7516toStringimpl(this.x)) + ", y=" + ((Object) Dp.m7516toStringimpl(this.y)) + ", rtlAware=" + this.rtlAware + ')';
    }
