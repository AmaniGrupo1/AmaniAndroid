...
final /* data */ class BoxWithConstraintsScopeImpl implements BoxWithConstraintsScope, BoxScope {
    ...
    public final BoxWithConstraintsScopeImpl m719copy0kLqBqw(Density density, long constraints) {
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.density, boxWithConstraintsScopeImpl.density) && Constraints.m7451equalsimpl0(this.constraints, boxWithConstraintsScopeImpl.constraints);
    }

    public int hashCode() {
        return (this.density.hashCode() * 31) + Constraints.m7461hashCodeimpl(this.constraints);
    }
    ...
    public String toString() {
        return "BoxWithConstraintsScopeImpl(density=" + this.density + ", constraints=" + ((Object) Constraints.m7463toStringimpl(this.constraints)) + ')';
    }
    ...
    public float mo716getMinWidthD9Ej5fM() {
        ...
        return $this$getMinWidth_D9Ej5fM_u24lambda_u240.mo402toDpu2uoSUM(Constraints.m7460getMinWidthimpl(mo712getConstraintsmsEJaDk()));
    }
    ...
    public float mo714getMaxWidthD9Ej5fM() {
        ...
        return Constraints.m7454getHasBoundedWidthimpl(mo712getConstraintsmsEJaDk()) ? $this$getMaxWidth_D9Ej5fM_u24lambda_u240.mo402toDpu2uoSUM(Constraints.m7458getMaxWidthimpl(mo712getConstraintsmsEJaDk())) : Dp.INSTANCE.m7524getInfinityD9Ej5fM();
    }
    ...
    public float mo715getMinHeightD9Ej5fM() {
        ...
        return $this$getMinHeight_D9Ej5fM_u24lambda_u240.mo402toDpu2uoSUM(Constraints.m7459getMinHeightimpl(mo712getConstraintsmsEJaDk()));
    }
    ...
    public float mo713getMaxHeightD9Ej5fM() {
        ...
        return Constraints.m7453getHasBoundedHeightimpl(mo712getConstraintsmsEJaDk()) ? $this$getMaxHeight_D9Ej5fM_u24lambda_u240.mo402toDpu2uoSUM(Constraints.m7457getMaxHeightimpl(mo712getConstraintsmsEJaDk())) : Dp.INSTANCE.m7524getInfinityD9Ej5fM();
    }
}
