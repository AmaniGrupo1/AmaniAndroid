...
final class DerivedWidthModifierElement extends ModifierNodeElement<DerivedWidthModifierNode> {
    ...
    public DerivedWidthModifierElement(WindowInsets insets, Function1<? super InspectorInfo, Unit> function1, Function3<? super WindowInsets, ? super LayoutDirection, ? super Density, Integer> function3) {
        this.insets = insets;
