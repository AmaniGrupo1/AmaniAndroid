...
public final /* data */ class FlowLayoutOverflowState {
    ...
    public final IntIntPair m743ellipsisSizeF35zmw$foundation_layout(boolean hasNext, int lineIndex, int totalCrossAxisSize) {
    ...
    public final void m745setOverflowMeasurableshBUhpc$foundation_layout(IntrinsicMeasurable seeMoreMeasurable, IntrinsicMeasurable collapseMeasurable, boolean isHorizontal, long constraints) {
        LayoutOrientation orientation = isHorizontal ? LayoutOrientation.Horizontal : LayoutOrientation.Vertical;
        long orientationIndependentConstraints = OrientationIndependentConstraints.m787constructorimpl(constraints, orientation);
        if (seeMoreMeasurable != null) {
            int mainAxisSize = FlowLayoutKt.mainAxisMin(seeMoreMeasurable, isHorizontal, Constraints.m7457getMaxHeightimpl(orientationIndependentConstraints));
            int crossAxisSize = FlowLayoutKt.crossAxisMin(seeMoreMeasurable, isHorizontal, mainAxisSize);
            this.seeMoreSize = IntIntPair.m21boximpl(IntIntPair.m24constructorimpl(mainAxisSize, crossAxisSize));
        ...
        if (collapseMeasurable != null) {
            int mainAxisSize2 = FlowLayoutKt.mainAxisMin(collapseMeasurable, isHorizontal, Constraints.m7457getMaxHeightimpl(orientationIndependentConstraints));
            int crossAxisSize2 = FlowLayoutKt.crossAxisMin(collapseMeasurable, isHorizontal, mainAxisSize2);
            this.collapseSize = IntIntPair.m21boximpl(IntIntPair.m24constructorimpl(mainAxisSize2, crossAxisSize2));
    ...
    /* JADX INFO: renamed from: setOverflowMeasurables--hBUhpc$foundation_layout, reason: not valid java name */
    public final void m744setOverflowMeasurableshBUhpc$foundation_layout(final FlowLineMeasurePolicy measurePolicy, Measurable seeMoreMeasurable, Measurable collapseMeasurable, long constraints) {
        boolean isHorizontal = measurePolicy.isHorizontal();
        LayoutOrientation orientation = isHorizontal ? LayoutOrientation.Horizontal : LayoutOrientation.Vertical;
        long jM787constructorimpl = OrientationIndependentConstraints.m787constructorimpl(constraints, orientation);
        long orientationIndependentConstraints = OrientationIndependentConstraints.m788copyyUG9Ft0(jM787constructorimpl, (10 & 1) != 0 ? Constraints.m7460getMinWidthimpl(jM787constructorimpl) : 0, (10 & 2) != 0 ? Constraints.m7458getMaxWidthimpl(jM787constructorimpl) : 0, (10 & 4) != 0 ? Constraints.m7459getMinHeightimpl(jM787constructorimpl) : 0, (10 & 8) != 0 ? Constraints.m7457getMaxHeightimpl(jM787constructorimpl) : 0);
        long finalConstraints = OrientationIndependentConstraints.m800toBoxConstraintsOenEA2s(orientationIndependentConstraints, orientation);
        if (seeMoreMeasurable != null) {
            FlowLayoutKt.m739measureAndCacherqJ1uqs(seeMoreMeasurable, measurePolicy, finalConstraints, new Function1() { // from class: androidx.compose.foundation.layout.FlowLayoutOverflowState$$ExternalSyntheticLambda0
        ...
        if (collapseMeasurable != null) {
            FlowLayoutKt.m739measureAndCacherqJ1uqs(collapseMeasurable, measurePolicy, finalConstraints, new Function1() { // from class: androidx.compose.foundation.layout.FlowLayoutOverflowState$$ExternalSyntheticLambda1
                @Override // kotlin.jvm.functions.Function1
                public final Object invoke(Object obj) {
    ...
    public static final Unit setOverflowMeasurables__hBUhpc$lambda$2$0(FlowLayoutOverflowState this$0, FlowLineMeasurePolicy $measurePolicy, Placeable placeable) {
        ...
        this$0.seeMoreSize = IntIntPair.m21boximpl(IntIntPair.m24constructorimpl(mainAxisSize, crossAxisSize));
    ...
    public static final Unit setOverflowMeasurables__hBUhpc$lambda$3$0(FlowLayoutOverflowState this$0, FlowLineMeasurePolicy $measurePolicy, Placeable placeable) {
        ...
        this$0.collapseSize = IntIntPair.m21boximpl(IntIntPair.m24constructorimpl(mainAxisSize, crossAxisSize));
    ...
    public final void m746setOverflowMeasurablesVKLhPVY$foundation_layout(FlowLineMeasurePolicy measurePolicy, long constraints, Function2<? super Boolean, ? super Integer, ? extends Measurable> getOverflowMeasurable) {
        this.itemShown = 0;
        ...
        m744setOverflowMeasurableshBUhpc$foundation_layout(measurePolicy, seeMoreMeasurable, collapseMeasurable, constraints);
    }
}
