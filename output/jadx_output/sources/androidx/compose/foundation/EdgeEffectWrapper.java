...
final class EdgeEffectWrapper {
    ...
    private final EdgeEffect createEdgeEffect(Orientation orientation) {
        ...
        if (!IntSize.m7674equalsimpl0(this.size, IntSize.INSTANCE.m7681getZeroYbymL2g())) {
            if (orientation == Orientation.Vertical) {
                $this$createEdgeEffect_u24lambda_u240.setSize((int) (this.size >> 32), (int) (4294967295L & this.size));
            } else {
                $this$createEdgeEffect_u24lambda_u240.setSize((int) (4294967295L & this.size), (int) (this.size >> 32));
            }
        }
    ...
    public final void m318updateSizeozmzZPI(long size) {
        this.size = size;
        EdgeEffect edgeEffect = this.topEffect;
        if (edgeEffect != null) {
