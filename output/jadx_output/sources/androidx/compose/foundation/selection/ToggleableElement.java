...
final class ToggleableElement extends ModifierNodeElement<ToggleableNode> {
    ...
    public void update(ToggleableNode node) {
        node.m1107updateO2vRcR0(this.value, this.interactionSource, this.indicationNodeFactory, this.useLocalIndication, this.enabled, this.role, this.onValueChange);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public void inspectableProperties(InspectorInfo $this$inspectableProperties) {
        $this$inspectableProperties.setName("toggleable");
        $this$inspectableProperties.getProperties().set(Values.VECTOR_MAP_VECTORS_KEY, $this$inspectableProperties.getValue());
    ...
    public int hashCode() {
        ...
        Role role = this.role;
        return ((result4 + (role != null ? Role.m6696hashCodeimpl(role.getValue()) : 0)) * 31) + this.onValueChange.hashCode();
    }
}
