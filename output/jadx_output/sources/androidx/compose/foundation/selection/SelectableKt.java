...
public final class SelectableKt {
    ...
    public static final /* synthetic */ Modifier m1090selectableXHw0xAI(Modifier $this$selectable_u2dXHw0xAI, final boolean selected, final boolean enabled, final Role role, final Function0 onClick) {
    ...
    static final Modifier selectable_XHw0xAI$lambda$1(boolean $selected, boolean $enabled, Role $role, Function0 $onClick, Modifier $this$composed, Composer $composer, int $changed) {
        ...
        Modifier modifierM1088selectableO2vRcR0 = m1088selectableO2vRcR0(Modifier.INSTANCE, $selected, interactionSource, localIndication2, $enabled, $role, $onClick);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceGroup();
        return modifierM1088selectableO2vRcR0;
    }

    /* JADX INFO: renamed from: selectable-oSLSa3U, reason: not valid java name */
    public static final Modifier m1092selectableoSLSa3U(Modifier $this$selectable_u2doSLSa3U, boolean selected, boolean enabled, Role role, MutableInteractionSource interactionSource, Function0<Unit> function0) {
    ...
    public static /* synthetic */ Modifier m1089selectableO2vRcR0$default(Modifier modifier, boolean z, MutableInteractionSource mutableInteractionSource, Indication indication, boolean z2, Role role, Function0 function0, int i, Object obj) {
        ...
        return m1088selectableO2vRcR0(modifier, z, mutableInteractionSource, indication, z3, role2, function0);
    }

    /* JADX INFO: renamed from: selectable-O2vRcR0, reason: not valid java name */
    public static final Modifier m1088selectableO2vRcR0(Modifier $this$selectable_u2dO2vRcR0, final boolean selected, MutableInteractionSource interactionSource, final Indication indication, final boolean enabled, final Role role, final Function0<Unit> function0) {
