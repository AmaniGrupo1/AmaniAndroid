...
public final class ToggleableKt {
    ...
    public static final /* synthetic */ Modifier m1097toggleableXHw0xAI(Modifier $this$toggleable_u2dXHw0xAI, final boolean value, final boolean enabled, final Role role, final Function1 onValueChange) {
        return ComposedModifierKt.composed($this$toggleable_u2dXHw0xAI, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.selection.ToggleableKt$toggleable-XHw0xAI$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo inspectorInfo) {
                ...
                inspectorInfo.getProperties().set(Values.VECTOR_MAP_VECTORS_KEY, Boolean.valueOf(value));
    ...
    static final Modifier toggleable_XHw0xAI$lambda$1(boolean $value, boolean $enabled, Role $role, Function1 $onValueChange, Modifier $this$composed, Composer $composer, int $changed) {
        ...
        Modifier modifierM1095toggleableO2vRcR0 = m1095toggleableO2vRcR0(Modifier.INSTANCE, $value, interactionSource, localIndication2, $enabled, $role, $onValueChange);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceGroup();
        return modifierM1095toggleableO2vRcR0;
    }

    /* JADX INFO: renamed from: toggleable-oSLSa3U, reason: not valid java name */
    public static final Modifier m1099toggleableoSLSa3U(Modifier $this$toggleable_u2doSLSa3U, boolean value, boolean enabled, Role role, MutableInteractionSource interactionSource, Function1<? super Boolean, Unit> function1) {
    ...
    public static /* synthetic */ Modifier m1096toggleableO2vRcR0$default(Modifier modifier, boolean z, MutableInteractionSource mutableInteractionSource, Indication indication, boolean z2, Role role, Function1 function1, int i, Object obj) {
        ...
        return m1095toggleableO2vRcR0(modifier, z, mutableInteractionSource, indication, z3, role2, function1);
    }

    /* JADX INFO: renamed from: toggleable-O2vRcR0, reason: not valid java name */
    public static final Modifier m1095toggleableO2vRcR0(Modifier $this$toggleable_u2dO2vRcR0, final boolean value, MutableInteractionSource interactionSource, final Indication indication, final boolean enabled, final Role role, final Function1<? super Boolean, Unit> function1) {
    ...
    public static final /* synthetic */ Modifier m1103triStateToggleableXHw0xAI(Modifier $this$triStateToggleable_u2dXHw0xAI, final ToggleableState state, final boolean enabled, final Role role, final Function0 onClick) {
    ...
    static final Modifier triStateToggleable_XHw0xAI$lambda$1(ToggleableState $state, boolean $enabled, Role $role, Function0 $onClick, Modifier $this$composed, Composer $composer, int $changed) {
        ...
        Modifier modifierM1101triStateToggleableO2vRcR0 = m1101triStateToggleableO2vRcR0(Modifier.INSTANCE, $state, interactionSource, localIndication2, $enabled, $role, $onClick);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceGroup();
        return modifierM1101triStateToggleableO2vRcR0;
    }

    /* JADX INFO: renamed from: triStateToggleable-oSLSa3U, reason: not valid java name */
    public static final Modifier m1105triStateToggleableoSLSa3U(Modifier $this$triStateToggleable_u2doSLSa3U, ToggleableState state, boolean enabled, Role role, MutableInteractionSource interactionSource, Function0<Unit> function0) {
    ...
    public static /* synthetic */ Modifier m1102triStateToggleableO2vRcR0$default(Modifier modifier, ToggleableState toggleableState, MutableInteractionSource mutableInteractionSource, Indication indication, boolean z, Role role, Function0 function0, int i, Object obj) {
        ...
        return m1101triStateToggleableO2vRcR0(modifier, toggleableState, mutableInteractionSource, indication, z2, role2, function0);
    }

    /* JADX INFO: renamed from: triStateToggleable-O2vRcR0, reason: not valid java name */
    public static final Modifier m1101triStateToggleableO2vRcR0(Modifier $this$triStateToggleable_u2dO2vRcR0, final ToggleableState state, MutableInteractionSource interactionSource, final Indication indication, final boolean enabled, final Role role, final Function0<Unit> function0) {
