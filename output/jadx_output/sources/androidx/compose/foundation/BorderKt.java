...
public final class BorderKt {
    ...
    public static final Modifier border(Modifier $this$border, BorderStroke border, Shape shape) {
        return m277borderziNgDLE($this$border, border.getWidth(), border.getBrush(), shape);
    }
    ...
    public static final Modifier m275borderxT4_qwU(Modifier $this$border_u2dxT4_qwU, float f, long j, Shape shape) {
        return m277borderziNgDLE($this$border_u2dxT4_qwU, f, new SolidColor(j, null), shape);
    }

    /* JADX INFO: renamed from: border-ziNgDLE, reason: not valid java name */
    public static final Modifier m277borderziNgDLE(Modifier $this$border_u2dziNgDLE, float f, Brush brush, Shape shape) {
        return $this$border_u2dziNgDLE.then(new BorderModifierNodeElement(f, brush, shape, null));
    }
    ...
    public static final DrawResult m278drawRectBorderNsqcLGU(CacheDrawScope $this$drawRectBorder_u2dNsqcLGU, final Brush brush, long j, long j2, boolean fillArea, float strokeWidthPx) {
        final long rectTopLeft = fillArea ? Offset.INSTANCE.m4468getZeroF1C5BW0() : j;
        final long size = fillArea ? $this$drawRectBorder_u2dNsqcLGU.m4232getSizeNHjbRc() : j2;
    ...
    static final Unit drawRectBorder_NsqcLGU$lambda$0(Brush $brush, long $rectTopLeft, long $size, DrawStyle $style, ContentDrawScope $this$onDrawWithContent) {
        $this$onDrawWithContent.drawContent();
        DrawScope.m5264drawRectAsUm42w$default($this$onDrawWithContent, $brush, $rectTopLeft, $size, 0.0f, $style, null, 0, LocationRequestCompat.QUALITY_LOW_POWER, null);
        return Unit.INSTANCE;
    }
    ...
    public static final Path createRoundRectPath(Path targetPath, RoundRect roundedRect, float strokeWidth, boolean fillArea) {
        ...
        if (!fillArea) {
            ...
            targetPath.mo4586opN5in7k0(targetPath, insetPath, PathOperation.INSTANCE.m5003getDifferenceb3I0S0c());
        }
        return targetPath;
    }

    private static final RoundRect createInsetRoundedRect(float widthPx, RoundRect roundedRect) {
        return new RoundRect(widthPx, widthPx, roundedRect.getWidth() - widthPx, roundedRect.getHeight() - widthPx, m279shrinkKibmq7A(roundedRect.m4502getTopLeftCornerRadiuskKHJgLs(), widthPx), m279shrinkKibmq7A(roundedRect.m4503getTopRightCornerRadiuskKHJgLs(), widthPx), m279shrinkKibmq7A(roundedRect.m4501getBottomRightCornerRadiuskKHJgLs(), widthPx), m279shrinkKibmq7A(roundedRect.m4500getBottomLeftCornerRadiuskKHJgLs(), widthPx), null);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: shrink-Kibmq7A, reason: not valid java name */
    public static final long m279shrinkKibmq7A(long j, float value) {
        ...
        return CornerRadius.m4406constructorimpl((v1$iv$iv << 32) | (4294967295L & v2$iv$iv));
    }
}
