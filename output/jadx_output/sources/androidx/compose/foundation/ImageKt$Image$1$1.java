...
final class ImageKt$Image$1$1 implements MeasurePolicy {
    ...
    public final MeasureResult mo41measure3p2s80s(MeasureScope $this$Layout, List<? extends Measurable> list, long j) {
        return MeasureScope.layout$default($this$Layout, Constraints.m7460getMinWidthimpl(j), Constraints.m7459getMinHeightimpl(j), null, new Function1() { // from class: androidx.compose.foundation.ImageKt$Image$1$1$$ExternalSyntheticLambda0
