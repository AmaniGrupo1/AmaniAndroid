...
@Metadata(d1 = {"\u0000\u0016\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\u001a\u001d\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u0005¢\u0006\u0004\b\u0006\u0010\u0007¨\u0006\b"}, d2 = {"checkScrollableContainerConstraints", "", "constraints", "Landroidx/compose/ui/unit/Constraints;", "orientation", "Landroidx/compose/foundation/gestures/Orientation;", "checkScrollableContainerConstraints-K40F9xA", "(JLandroidx/compose/foundation/gestures/Orientation;)V", "foundation"}, k = 2, mv = {2, 0, 0}, xi = 48)
public final class CheckScrollableContainerConstraintsKt {
    ...
    public static final void m291checkScrollableContainerConstraintsK40F9xA(long j, Orientation orientation) {
        boolean value$iv;
        if (orientation == Orientation.Vertical) {
            value$iv = Constraints.m7457getMaxHeightimpl(j) != Integer.MAX_VALUE;
            if (value$iv) {
                return;
            }
        ...
        value$iv = Constraints.m7458getMaxWidthimpl(j) != Integer.MAX_VALUE;
        if (value$iv) {
            return;
        }
