...
final class BackgroundNode extends Modifier.Node implements DrawModifierNode, ObserverModifierNode, SemanticsModifierNode {
    ...
    private BackgroundNode(long color, Brush brush, float alpha, Shape shape) {
        ...
        this.alpha = alpha;
        this.shape = shape;
        this.lastSize = Size.INSTANCE.m4529getUnspecifiedNHjbRc();
    }
    ...
    private final void drawRect(ContentDrawScope $this$drawRect) {
        if (!Color.m4698equalsimpl0(this.color, Color.INSTANCE.m4733getUnspecified0d7_KjU())) {
            DrawScope.m5265drawRectnJ9OG0$default($this$drawRect, this.color, 0L, 0L, 0.0f, null, null, 0, WebSocketProtocol.PAYLOAD_SHORT, null);
        }
        Brush it = this.brush;
        if (it != null) {
            DrawScope.m5264drawRectAsUm42w$default($this$drawRect, it, 0L, 0L, this.alpha, null, null, 0, 118, null);
        }
    }
    ...
    private final void drawOutline(ContentDrawScope $this$drawOutline) {
        ...
        if (!Color.m4698equalsimpl0(this.color, Color.INSTANCE.m4733getUnspecified0d7_KjU())) {
            OutlineKt.m4969drawOutlinewDX37Ww($this$drawOutline, outline, this.color, (60 & 4) != 0 ? 1.0f : 0.0f, (60 & 8) != 0 ? Fill.INSTANCE : null, (60 & 16) != 0 ? null : null, (60 & 32) != 0 ? DrawScope.INSTANCE.m5273getDefaultBlendMode0nO6VwU() : 0);
        }
        Brush it = this.brush;
        if (it != null) {
            OutlineKt.m4967drawOutlinehn5TExg($this$drawOutline, outline, it, (56 & 4) != 0 ? 1.0f : this.alpha, (56 & 8) != 0 ? Fill.INSTANCE : null, (56 & 16) != 0 ? null : null, (56 & 32) != 0 ? DrawScope.INSTANCE.m5273getDefaultBlendMode0nO6VwU() : 0);
        }
    }

    private final Outline getOutline(final ContentDrawScope $this$getOutline) {
        Outline outline;
        if (Size.m4517equalsimpl0($this$getOutline.mo5271getSizeNHjbRc(), this.lastSize) && $this$getOutline.getLayoutDirection() == this.lastLayoutDirection && Intrinsics.areEqual(this.lastShape, this.shape)) {
        ...
        this.lastSize = $this$getOutline.mo5271getSizeNHjbRc();
    ...
    static final Unit getOutline$lambda$0(BackgroundNode this$0, ContentDrawScope $this_getOutline) {
        this$0.tmpOutline = this$0.shape.mo320createOutlinePq9zytI($this_getOutline.mo5271getSizeNHjbRc(), $this_getOutline.getLayoutDirection(), $this_getOutline);
