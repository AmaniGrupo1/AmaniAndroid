...
public final class DecodeHelper {
    ...
    public final SpanStyle decodeSpanStyle() {
        ...
        while (this.parcel.dataAvail() > 1) {
            ...
            if (bDecodeByte == 1) {
                ...
                mutableSpanStyle.m653setFontStylemLjRB2g(FontStyle.m7037boximpl(m633decodeFontStyle_LCdwA()));
            } else if (bDecodeByte == 5) {
                if (dataAvailable() < 1) {
                    break;
                }
                mutableSpanStyle.m654setFontSynthesistDdu0R4(FontSynthesis.m7048boximpl(m634decodeFontSynthesisGVVA2EU()));
                ...
                mutableSpanStyle.m650setBaselineShift_isdbwI(BaselineShift.m7220boximpl(m630decodeBaselineShifty9eOQZs()));
    ...
    private final Shadow decodeShadow() {
        long jM632decodeColor0d7_KjU = m632decodeColor0d7_KjU();
        float x$iv = decodeFloat();
        float y$iv = decodeFloat();
        long v1$iv$iv = Float.floatToRawIntBits(x$iv);
        long v2$iv$iv = Float.floatToRawIntBits(y$iv);
        return new Shadow(jM632decodeColor0d7_KjU, Offset.m4444constructorimpl((v1$iv$iv << 32) | (4294967295L & v2$iv$iv)), decodeFloat(), null);
    }
