...
public final class MeasuredPage implements PageInfo {
    ...
    public final void place(Placeable.PlacementScope scope) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (this.isVertical) {
                ...
                $this$place_u24lambda_u2402 = $this$place_u24lambda_u240;
                Placeable.PlacementScope.m6209placeRelativeWithLayeraW9wM$default($this$place_u24lambda_u2402, placeable, offset2, 0.0f, (Function1) null, 6, (Object) null);
            }
        }
    }
    ...
    private final long m1069getOffsetBjo55l4(int index) {
    ...
    private final long m1068copy4Tuh3kE(long j, Function1<? super Integer, Integer> function1) {
        int x$iv = this.isVertical ? IntOffset.m7633getXimpl(j) : function1.invoke(Integer.valueOf(IntOffset.m7633getXimpl(j))).intValue();
        int y$iv = this.isVertical ? function1.invoke(Integer.valueOf(IntOffset.m7634getYimpl(j))).intValue() : IntOffset.m7634getYimpl(j);
        int val2$iv$iv = y$iv;
        int val1$iv$iv = x$iv;
