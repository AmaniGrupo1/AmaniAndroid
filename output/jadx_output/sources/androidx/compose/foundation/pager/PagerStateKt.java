...
public final class PagerStateKt {
    ...
    private static final float DefaultPositionThreshold = Dp.m7505constructorimpl(56);
    ...
    public static final PagerState rememberPagerState(final int initialPage, final float initialPageOffsetFraction, final Function0<Integer> function0, Composer $composer, int $changed, int i) {
        ...
        if (((($changed & 896) ^ RendererCapabilities.DECODER_SUPPORT_MASK) <= 256 || !$composer.changed(function0)) && ($changed & RendererCapabilities.DECODER_SUPPORT_MASK) != 256) {
            z = false;
        }
        ...
        Object objM4138rememberSaveable = RememberSaveableKt.m4138rememberSaveable(objArr, saver, (Function0<? extends Object>) it$iv, $composer, 0);
        DefaultPagerState $this$rememberPagerState_u24lambda_u241 = (DefaultPagerState) objM4138rememberSaveable;
        $this$rememberPagerState_u24lambda_u241.getPageCountState().setValue(function0);
        DefaultPagerState defaultPagerState = (DefaultPagerState) objM4138rememberSaveable;
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static final long calculateNewMaxScrollOffset(PagerLayoutInfo $this$calculateNewMaxScrollOffset, int pageCount) {
        int iMo1076getViewportSizeYbymL2g;
        ...
        if ($this$calculateNewMaxScrollOffset.getOrientation() == Orientation.Horizontal) {
            iMo1076getViewportSizeYbymL2g = (int) ($this$calculateNewMaxScrollOffset.mo1076getViewportSizeYbymL2g() >> 32);
        } else {
            iMo1076getViewportSizeYbymL2g = (int) (4294967295L & $this$calculateNewMaxScrollOffset.mo1076getViewportSizeYbymL2g());
        }
        int layoutSize = iMo1076getViewportSizeYbymL2g;
    ...
    public static final long calculateNewMinScrollOffset(PagerMeasureResult $this$calculateNewMinScrollOffset, int pageCount) {
        ...
        if ($this$calculateNewMinScrollOffset.getOrientation() == Orientation.Horizontal) {
            iMo1076getViewportSizeYbymL2g = (int) ($this$calculateNewMinScrollOffset.mo1076getViewportSizeYbymL2g() >> 32);
        } else {
            iMo1076getViewportSizeYbymL2g = (int) (4294967295L & $this$calculateNewMinScrollOffset.mo1076getViewportSizeYbymL2g());
        }
        int layoutSize = iMo1076getViewportSizeYbymL2g;
