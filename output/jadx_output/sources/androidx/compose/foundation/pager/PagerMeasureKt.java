...
public final class PagerMeasureKt {
    ...
    public static final PagerMeasureResult m1078measurePager7L1iB3k(final LazyLayoutMeasureScope $this$measurePager_u2d7L1iB3k, int pageCount, final PagerLazyLayoutItemProvider pagerItemProvider, int mainAxisAvailableSize, int beforeContentPadding, int afterContentPadding, int spaceBetweenPages, int currentPage, int currentPageOffset, long j, final Orientation orientation, final Alignment.Vertical verticalAlignment, final Alignment.Horizontal horizontalAlignment, final boolean reverseLayout, final long j2, final int pageAvailableSize, int beyondViewportPageCount, List<Integer> list, SnapPosition snapPosition, final MutableState<Unit> mutableState, CoroutineScope coroutineScope, Density density, Function3<? super Integer, ? super Integer, ? super Function1<? super Placeable.PlacementScope, Unit>, ? extends MeasureResult> function3, final MutableIntObjectMap<List<Placeable>> mutableIntObjectMap) {
        ...
        if (orientation == Orientation.Vertical) {
            iM7458getMaxWidthimpl = Constraints.m7458getMaxWidthimpl(j);
        } else {
            iM7458getMaxWidthimpl = pageAvailableSize;
        }
        if (orientation != Orientation.Vertical) {
            iM7457getMaxHeightimpl = Constraints.m7457getMaxHeightimpl(j);
        } else {
            iM7457getMaxHeightimpl = pageAvailableSize;
        }
        final long childConstraints = ConstraintsKt.Constraints$default(0, iM7458getMaxWidthimpl, 0, iM7457getMaxHeightimpl, 5, null);
        if (pageCount <= 0) {
            return new PagerMeasureResult(CollectionsKt.emptyList(), pageAvailableSize, spaceBetweenPages, afterContentPadding, orientation, -i2, mainAxisAvailableSize + afterContentPadding, false, coercedBeyondViewportPageCount, null, null, 0.0f, 0, false, snapPosition, function3.invoke(Integer.valueOf(Constraints.m7460getMinWidthimpl(j)), Integer.valueOf(Constraints.m7459getMinHeightimpl(j)), new Function1() { // from class: androidx.compose.foundation.pager.PagerMeasureKt$$ExternalSyntheticLambda0
        ...
        while (previous < 0 && currentFirstPage2 > 0) {
            ...
            MeasuredPage measuredPage = m1077getAndMeasureG5IdpRk($this$measurePager_u2d7L1iB3k, currentFirstPageScrollOffset7, childConstraints, pagerItemProvider, j2, orientation, horizontalAlignment, verticalAlignment, $this$measurePager_u2d7L1iB3k.getLayoutDirection(), reverseLayout, pageAvailableSize, mutableIntObjectMap);
        ...
        while (true) {
            ...
            MeasuredPage measuredPage2 = m1077getAndMeasureG5IdpRk($this$measurePager_u2d7L1iB3k, currentFirstPageScrollOffset10, childConstraints, pagerItemProvider, j2, orientation, horizontalAlignment, verticalAlignment, $this$measurePager_u2d7L1iB3k.getLayoutDirection(), reverseLayout, pageAvailableSize, mutableIntObjectMap);
        ...
        if (currentMainAxisOffset >= maxOffset) {
            ...
            while (maxCrossAxis2 < i2 && currentFirstPage2 > 0) {
                ...
                MeasuredPage measuredPage3 = m1077getAndMeasureG5IdpRk($this$measurePager_u2d7L1iB3k, previousIndex, childConstraints, pagerItemProvider, j2, orientation, horizontalAlignment, verticalAlignment, $this$measurePager_u2d7L1iB3k.getLayoutDirection(), reverseLayout, pageAvailableSize, mutableIntObjectMap);
        ...
        List<MeasuredPage> listCreatePagesBeforeList = createPagesBeforeList(currentFirstPage2, coercedBeyondViewportPageCount2, list, new Function1() { // from class: androidx.compose.foundation.pager.PagerMeasureKt$$ExternalSyntheticLambda1
            ...
            public final Object invoke(Object obj) {
                ...
                return PagerMeasureKt.m1077getAndMeasureG5IdpRk(lazyLayoutMeasureScope, ((Integer) obj).intValue(), childConstraints, pagerItemProvider, j2, orientation, horizontalAlignment, verticalAlignment, lazyLayoutMeasureScope.getLayoutDirection(), reverseLayout, pageAvailableSize, mutableIntObjectMap);
            }
        });
        ...
        int layoutWidth = ConstraintsKt.m7475constrainWidthK40F9xA(j, orientation == Orientation.Vertical ? maxCrossAxis9 : currentMainAxisOffset);
        int layoutHeight = ConstraintsKt.m7474constrainHeightK40F9xA(j, orientation == Orientation.Vertical ? currentMainAxisOffset : maxCrossAxis9);
    ...
    static final Unit measurePager_7L1iB3k$lambda$18(MutableState mutableState, final List $positionedPages, Placeable.PlacementScope $this$layout) {
    ...
    public static final MeasuredPage m1077getAndMeasureG5IdpRk(LazyLayoutMeasureScope $this$getAndMeasure_u2dG5IdpRk, int index, long j, PagerLazyLayoutItemProvider pagerItemProvider, long j2, Orientation orientation, Alignment.Horizontal horizontalAlignment, Alignment.Vertical verticalAlignment, LayoutDirection layoutDirection, boolean reverseLayout, int pageAvailableSize, MutableIntObjectMap<List<Placeable>> mutableIntObjectMap) {
        ArrayList arrayList;
        ...
        if (list != null) {
            ...
            for (int i = 0; i < size; i++) {
                int i2 = i;
                arrayList2.add(listCompose.get(i2).mo6141measureBRTryo0(j));
            }
            arrayList = arrayList2;
            mutableIntObjectMap.set(index, arrayList);
        }
        return new MeasuredPage(index, pageAvailableSize, arrayList, j2, key, orientation, horizontalAlignment, verticalAlignment, layoutDirection, reverseLayout, null);
    }
    ...
    private static final List<MeasuredPage> calculatePagesOffsets(LazyLayoutMeasureScope $this$calculatePagesOffsets, List<MeasuredPage> list, List<MeasuredPage> list2, List<MeasuredPage> list3, int layoutWidth, int layoutHeight, int finalMainAxisOffset, int maxOffset, int pagesScrollOffset, Orientation orientation, boolean reverseLayout, Density density, int spaceBetweenPages, int pageAvailableSize) {
        ...
        if (hasSpareSpace) {
            ...
            Arrangement.HorizontalOrVertical arrangement = Arrangement.Absolute.INSTANCE.m691spacedBy0680j_4($this$calculatePagesOffsets.mo402toDpu2uoSUM(spaceBetweenPages));
            if (orientation == Orientation.Vertical) {
