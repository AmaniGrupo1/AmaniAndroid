...
public final class PagerKt {
    static final Unit HorizontalPager__8jOkeI$lambda$0(PagerState pagerState, Modifier modifier, PaddingValues paddingValues, PageSize pageSize, int i, float f, Alignment.Vertical vertical, TargetedFlingBehavior targetedFlingBehavior, boolean z, boolean z2, Function1 function1, NestedScrollConnection nestedScrollConnection, SnapPosition snapPosition, OverscrollEffect overscrollEffect, Function4 function4, int i2, int i3, int i4, Composer composer, int i5) {
        m1072HorizontalPager8jOkeI(pagerState, modifier, paddingValues, pageSize, i, f, vertical, targetedFlingBehavior, z, z2, function1, nestedScrollConnection, snapPosition, overscrollEffect, function4, composer, RecomposeScopeImplKt.updateChangedFlags(i2 | 1), RecomposeScopeImplKt.updateChangedFlags(i3), i4);
    ...
    static final Unit HorizontalPager_oI3XNZo$lambda$0(PagerState pagerState, Modifier modifier, PaddingValues paddingValues, PageSize pageSize, int i, float f, Alignment.Vertical vertical, TargetedFlingBehavior targetedFlingBehavior, boolean z, boolean z2, Function1 function1, NestedScrollConnection nestedScrollConnection, SnapPosition snapPosition, Function4 function4, int i2, int i3, int i4, Composer composer, int i5) {
        m1073HorizontalPageroI3XNZo(pagerState, modifier, paddingValues, pageSize, i, f, vertical, targetedFlingBehavior, z, z2, function1, nestedScrollConnection, snapPosition, function4, composer, RecomposeScopeImplKt.updateChangedFlags(i2 | 1), RecomposeScopeImplKt.updateChangedFlags(i3), i4);
        return Unit.INSTANCE;
    }
    ...
    static final Unit VerticalPager__8jOkeI$lambda$0(PagerState pagerState, Modifier modifier, PaddingValues paddingValues, PageSize pageSize, int i, float f, Alignment.Horizontal horizontal, TargetedFlingBehavior targetedFlingBehavior, boolean z, boolean z2, Function1 function1, NestedScrollConnection nestedScrollConnection, SnapPosition snapPosition, OverscrollEffect overscrollEffect, Function4 function4, int i2, int i3, int i4, Composer composer, int i5) {
        m1074VerticalPager8jOkeI(pagerState, modifier, paddingValues, pageSize, i, f, horizontal, targetedFlingBehavior, z, z2, function1, nestedScrollConnection, snapPosition, overscrollEffect, function4, composer, RecomposeScopeImplKt.updateChangedFlags(i2 | 1), RecomposeScopeImplKt.updateChangedFlags(i3), i4);
        return Unit.INSTANCE;
    }

    static final Unit VerticalPager_oI3XNZo$lambda$0(PagerState pagerState, Modifier modifier, PaddingValues paddingValues, PageSize pageSize, int i, float f, Alignment.Horizontal horizontal, TargetedFlingBehavior targetedFlingBehavior, boolean z, boolean z2, Function1 function1, NestedScrollConnection nestedScrollConnection, SnapPosition snapPosition, Function4 function4, int i2, int i3, int i4, Composer composer, int i5) {
        m1075VerticalPageroI3XNZo(pagerState, modifier, paddingValues, pageSize, i, f, horizontal, targetedFlingBehavior, z, z2, function1, nestedScrollConnection, snapPosition, function4, composer, RecomposeScopeImplKt.updateChangedFlags(i2 | 1), RecomposeScopeImplKt.updateChangedFlags(i3), i4);
        return Unit.INSTANCE;
    }

    /* JADX INFO: renamed from: HorizontalPager--8jOkeI, reason: not valid java name */
    public static final void m1072HorizontalPager8jOkeI(final PagerState state, Modifier modifier, PaddingValues contentPadding, PageSize pageSize, int beyondViewportPageCount, float f, Alignment.Vertical verticalAlignment, TargetedFlingBehavior flingBehavior, boolean userScrollEnabled, boolean reverseLayout, Function1<? super Integer, ? extends Object> function1, NestedScrollConnection pageNestedScrollConnection, SnapPosition snapPosition, OverscrollEffect overscrollEffect, final Function4<? super PagerScope, ? super Integer, ? super Composer, ? super Integer, Unit> function4, Composer $composer, final int $changed, final int $changed1, final int i) {
        Modifier modifier2;
        ...
        if (i12 != 0) {
            ...
            f2 = f;
            $dirty3 |= $composer4.changed(f2) ? 131072 : 65536;
        } else {
            f2 = f;
        }
        int i13 = i & 64;
        ...
        if (i15 != 0) {
            ...
            if (($changed & 805306368) == 0) {
                i4 = i15;
                $dirty3 |= $composer4.changed(reverseLayout) ? C.BUFFER_FLAG_LAST_SAMPLE : 268435456;
            } else {
                i4 = i15;
            }
            $dirty = $dirty3;
        ...
        if ($composer4.shouldExecute((($dirty & 306783379) == 306783378 && ($dirty19 & 9363) == 9362) ? false : true, $dirty & 1)) {
            ...
            ComposerKt.sourceInformation($composer4, "121@7026L28,126@7250L57,128@7404L26");
            if (($changed & 1) == 0 || $composer4.getDefaultsInvalid()) {
                ...
                float fM7505constructorimpl = i12 != 0 ? Dp.m7505constructorimpl(0) : f2;
                if (i13 != 0) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                modifier5 = modifier4;
                ComposerKt.traceEventStart(1860873769, $dirty2, $dirty15, "androidx.compose.foundation.pager.HorizontalPager (Pager.kt:130)");
            } else {
                modifier5 = modifier4;
            }
            ...
            int i17 = (($dirty2 >> 3) & 14) | 24576 | (($dirty2 << 3) & 112) | ($dirty2 & 896) | (($dirty2 >> 18) & 7168) | (($dirty2 >> 6) & 458752) | (($dirty2 >> 6) & 3670016) | (($dirty110 << 12) & 29360128) | (($dirty2 << 12) & 234881024) | (($dirty2 << 12) & C.ENCODING_PCM_DOUBLE);
            int i18 = (($dirty2 >> 9) & 14) | 3072 | ($dirty110 & 112) | (($dirty110 << 6) & 896) | (($dirty2 >> 6) & 57344) | (($dirty110 << 9) & 458752) | (($dirty110 << 6) & 3670016);
            Modifier modifier6 = modifier5;
            LazyLayoutPagerKt.m1067PagereLwUrMk(modifier6, state, contentPadding3, reverseLayout3, orientation, flingBehavior4, userScrollEnabled3, overscrollEffect3, beyondViewportPageCount3, f4, pageSize4, pageNestedScrollConnection4, function13, centerHorizontally, verticalAlignment4, snapPosition3, function4, $composer3, i17, i18, 0);
            $composer2 = $composer3;
            if (ComposerKt.isTraceInProgress()) {
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2() { // from class: androidx.compose.foundation.pager.PagerKt$$ExternalSyntheticLambda8
                ...
                public final Object invoke(Object obj, Object obj2) {
                    return PagerKt.HorizontalPager__8jOkeI$lambda$0(state, modifier3, contentPadding2, pageSize3, beyondViewportPageCount2, f3, verticalAlignment3, flingBehavior2, userScrollEnabled2, reverseLayout2, function12, pageNestedScrollConnection2, snapPosition2, overscrollEffect2, function4, $changed, $changed1, i, (Composer) obj, ((Integer) obj2).intValue());
                }
            });
        }
    }
    ...
    public static final /* synthetic */ void m1073HorizontalPageroI3XNZo(final PagerState state, Modifier modifier, PaddingValues contentPadding, PageSize pageSize, int beyondViewportPageCount, float f, Alignment.Vertical verticalAlignment, TargetedFlingBehavior flingBehavior, boolean userScrollEnabled, boolean reverseLayout, Function1 key, NestedScrollConnection pageNestedScrollConnection, SnapPosition snapPosition, final Function4 pageContent, Composer $composer, final int $changed, final int $changed1, final int i) {
        ...
        int i14 = i & 4096;
        if (i14 != 0) {
            $dirty12 = $dirty16 | RendererCapabilities.DECODER_SUPPORT_MASK;
        } else if (($changed1 & RendererCapabilities.DECODER_SUPPORT_MASK) == 0) {
        ...
        if ($composer4.shouldExecute((($dirty & 306783379) == 306783378 && ($dirty17 & 1171) == 1170) ? false : true, $dirty & 1)) {
            $composer4.startDefaults();
            ComposerKt.sourceInformation($composer4, "162@8711L28,167@8935L57");
            if (($changed & 1) == 0 || $composer4.getDefaultsInvalid()) {
                modifier4 = i6 != 0 ? Modifier.INSTANCE : modifier2;
                PaddingValues contentPadding4 = i7 != 0 ? PaddingKt.m811PaddingValues0680j_4(Dp.m7505constructorimpl(0)) : paddingValues;
            ...
            if (ComposerKt.isTraceInProgress()) {
                ...
                ComposerKt.traceEventStart(1163833967, $dirty2, $dirty14, "androidx.compose.foundation.pager.HorizontalPager (Pager.kt:170)");
            } else {
                reverseLayout5 = reverseLayout4;
            }
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2() { // from class: androidx.compose.foundation.pager.PagerKt$$ExternalSyntheticLambda7
                @Override // kotlin.jvm.functions.Function2
                public final Object invoke(Object obj, Object obj2) {
                    return PagerKt.HorizontalPager_oI3XNZo$lambda$0(state, modifier3, contentPadding2, pageSize3, beyondViewportPageCount2, f3, verticalAlignment3, flingBehavior2, reverseLayout2, reverseLayout3, key2, pageNestedScrollConnection2, snapPosition2, pageContent, $changed, $changed1, i, (Composer) obj, ((Integer) obj2).intValue());
                }
            });
        }
    }
    ...
    public static final void m1074VerticalPager8jOkeI(final PagerState state, Modifier modifier, PaddingValues contentPadding, PageSize pageSize, int beyondViewportPageCount, float f, Alignment.Horizontal horizontalAlignment, TargetedFlingBehavior flingBehavior, boolean userScrollEnabled, boolean reverseLayout, Function1<? super Integer, ? extends Object> function1, NestedScrollConnection pageNestedScrollConnection, SnapPosition snapPosition, OverscrollEffect overscrollEffect, final Function4<? super PagerScope, ? super Integer, ? super Composer, ? super Integer, Unit> function4, Composer $composer, final int $changed, final int $changed1, final int i) {
        Modifier modifier2;
        PaddingValues paddingValues;
        PageSize pageSize2;
        int i2;
        ...
        if ($composer4.shouldExecute((($dirty & 306783379) == 306783378 && ($dirty19 & 9363) == 9362) ? false : true, $dirty & 1)) {
            $composer4.startDefaults();
            ComposerKt.sourceInformation($composer4, "251@13957L28,256@14181L55,258@14333L26");
            if (($changed & 1) == 0 || $composer4.getDefaultsInvalid()) {
                if (i7 != 0) {
                    modifier2 = Modifier.INSTANCE;
                }
            ...
            if (ComposerKt.isTraceInProgress()) {
                modifier5 = modifier4;
                ComposerKt.traceEventStart(-1590376023, $dirty2, $dirty15, "androidx.compose.foundation.pager.VerticalPager (Pager.kt:260)");
            } else {
                modifier5 = modifier4;
            }
            int $dirty110 = $dirty15;
            ...
            Modifier modifier6 = modifier5;
            LazyLayoutPagerKt.m1067PagereLwUrMk(modifier6, state, contentPadding3, reverseLayout3, orientation, flingBehavior4, userScrollEnabled3, overscrollEffect3, beyondViewportPageCount3, f4, pageSize4, pageNestedScrollConnection4, function13, horizontalAlignment4, centerVertically, snapPosition3, function4, $composer3, i17, i18, 0);
            $composer2 = $composer3;
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2() { // from class: androidx.compose.foundation.pager.PagerKt$$ExternalSyntheticLambda6
                @Override // kotlin.jvm.functions.Function2
                public final Object invoke(Object obj, Object obj2) {
                    return PagerKt.VerticalPager__8jOkeI$lambda$0(state, modifier3, contentPadding2, pageSize3, beyondViewportPageCount2, f3, horizontalAlignment3, flingBehavior2, userScrollEnabled2, reverseLayout2, function12, pageNestedScrollConnection2, snapPosition2, overscrollEffect2, function4, $changed, $changed1, i, (Composer) obj, ((Integer) obj2).intValue());
                }
            });
        }
    }
    ...
    public static final /* synthetic */ void m1075VerticalPageroI3XNZo(final PagerState state, Modifier modifier, PaddingValues contentPadding, PageSize pageSize, int beyondViewportPageCount, float f, Alignment.Horizontal horizontalAlignment, TargetedFlingBehavior flingBehavior, boolean userScrollEnabled, boolean reverseLayout, Function1 key, NestedScrollConnection pageNestedScrollConnection, SnapPosition snapPosition, final Function4 pageContent, Composer $composer, final int $changed, final int $changed1, final int i) {
        Modifier modifier2;
        PaddingValues paddingValues;
        PageSize pageSize2;
        int i2;
        ...
        if ($composer4.shouldExecute((($dirty & 306783379) == 306783378 && ($dirty17 & 1171) == 1170) ? false : true, $dirty & 1)) {
            $composer4.startDefaults();
            ComposerKt.sourceInformation($composer4, "292@15642L28,297@15866L55");
            if (($changed & 1) == 0 || $composer4.getDefaultsInvalid()) {
                modifier4 = i6 != 0 ? Modifier.INSTANCE : modifier2;
                PaddingValues contentPadding4 = i7 != 0 ? PaddingKt.m811PaddingValues0680j_4(Dp.m7505constructorimpl(0)) : paddingValues;
                PageSize pageSize5 = i8 != 0 ? PageSize.Fill.INSTANCE : pageSize2;
            ...
            if (ComposerKt.isTraceInProgress()) {
                reverseLayout5 = reverseLayout4;
                ComposerKt.traceEventStart(-1474550033, $dirty2, $dirty14, "androidx.compose.foundation.pager.VerticalPager (Pager.kt:300)");
            } else {
                reverseLayout5 = reverseLayout4;
            }
            boolean reverseLayout7 = reverseLayout5;
            ...
            m1074VerticalPager8jOkeI(pagerState2, modifier5, contentPadding3, pageSize4, beyondViewportPageCount3, f4, horizontalAlignment4, flingBehavior4, userScrollEnabled2, reverseLayout7, key3, pageNestedScrollConnection4, snapPosition3, OverscrollKt.rememberOverscrollEffect($composer3, 0), pageContent, $composer5, ($dirty2 & 896) | ($dirty2 & 14) | ($dirty2 & 112) | ($dirty2 & 7168) | (57344 & $dirty2) | (458752 & $dirty2) | (3670016 & $dirty2) | (29360128 & $dirty2) | (234881024 & $dirty2) | (1879048192 & $dirty2), ($dirty14 & 14) | ($dirty14 & 112) | ($dirty14 & 896) | (($dirty14 << 3) & 57344), 0);
            $composer2 = $composer5;
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2() { // from class: androidx.compose.foundation.pager.PagerKt$$ExternalSyntheticLambda1
                @Override // kotlin.jvm.functions.Function2
                public final Object invoke(Object obj, Object obj2) {
                    return PagerKt.VerticalPager_oI3XNZo$lambda$0(state, modifier3, contentPadding2, pageSize3, beyondViewportPageCount2, f3, horizontalAlignment3, flingBehavior2, reverseLayout2, reverseLayout3, key2, pageNestedScrollConnection2, snapPosition2, pageContent, $changed, $changed1, i, (Composer) obj, ((Integer) obj2).intValue());
                }
            });
        }
    }
