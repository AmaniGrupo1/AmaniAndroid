...
public interface PageSize {
    ...
    public static final class Fixed implements PageSize {
        ...
        @Override // androidx.compose.foundation.pager.PageSize
        public int calculateMainAxisPageSize(Density $this$calculateMainAxisPageSize, int availableSpace, int pageSpacing) {
            return $this$calculateMainAxisPageSize.mo399roundToPx0680j_4(this.pageSize);
        }
        ...
        public boolean equals(Object other) {
            ...
            if (other instanceof Fixed) {
                return Dp.m7510equalsimpl0(this.pageSize, ((Fixed) other).pageSize);
            }
            return false;
        }

        public int hashCode() {
            return Dp.m7511hashCodeimpl(this.pageSize);
        }
    }
}
