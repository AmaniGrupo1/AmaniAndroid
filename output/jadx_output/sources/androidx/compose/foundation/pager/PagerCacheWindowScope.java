...
final class PagerCacheWindowScope implements CacheWindowScope {
    ...
    public List<LazyLayoutPrefetchState.PrefetchHandle> schedulePrefetch(int lineIndex, final Function2<? super Integer, ? super Integer, Unit> onItemPrefetched) {
        ...
        return CollectionsKt.listOf(getState().m1001schedulePrecompositionAndPremeasure_EkL_Y$foundation(lineIndex, childConstraints, true, new Function1() { // from class: androidx.compose.foundation.pager.PagerCacheWindowScope$$ExternalSyntheticLambda0
