...
public abstract class PagerState implements ScrollableState {
    ...
    public PagerState(int currentPage, float currentPageOffsetFraction, PrefetchScheduler prefetchScheduler) {
        ...
        this.upDownDifference = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m4441boximpl(Offset.INSTANCE.m4468getZeroF1C5BW0()), null, 2, null);
    ...
    public final float getPositionThresholdFraction$foundation() {
        ...
        float minThreshold = Math.min($this$_get_positionThresholdFraction__u24lambda_u240.mo405toPx0680j_4(PagerStateKt.getDefaultPositionThreshold()), getPageSize$foundation() / 2.0f);
    ...
    static final class C03161 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return PagerState.this.new C03161(continuation);
        }
    ...
    public final void requestScrollToPage(int page, float pageOffsetFraction) {
        if (isScrollInProgress()) {
            BuildersKt__Builders_commonKt.launch$default(this.pagerLayoutInfoState.getValue().getCoroutineScope(), null, null, new C03161(null), 3, null);
        }
            ...
            case 0:
                ...
                if (page != getCurrentPage()) {
                    if (getPageCount() != 0) {
                        ...
                        int targetPage = pagerState.coerceInPageRange(page);
                        float targetPageOffsetToSnappedPosition = pageOffsetFraction * pagerState.getPageSizeWithSpacing$foundation();
                        anonymousClass3 = pagerState.new AnonymousClass3(targetPage, targetPageOffsetToSnappedPosition, animationSpec2, null);
                        anonymousClass12.L$0 = null;
                        anonymousClass12.label = 2;
                        if (ScrollableState.scroll$default(pagerState, null, anonymousClass3, anonymousClass12, 1, null) == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                    }
                    return Unit.INSTANCE;
                ...
                return Unit.INSTANCE;
            case 1:
                pageOffsetFraction = anonymousClass12.F$0;
                page = anonymousClass12.I$0;
                AnimationSpec<Float> animationSpec3 = (AnimationSpec) anonymousClass12.L$0;
                ResultKt.throwOnFailure($result);
                pagerState = this;
                ...
                int targetPage2 = pagerState.coerceInPageRange(page);
                float targetPageOffsetToSnappedPosition2 = pageOffsetFraction * pagerState.getPageSizeWithSpacing$foundation();
                anonymousClass3 = pagerState.new AnonymousClass3(targetPage2, targetPageOffsetToSnappedPosition2, animationSpec2, null);
                anonymousClass12.L$0 = null;
                anonymousClass12.label = 2;
                if (ScrollableState.scroll$default(pagerState, null, anonymousClass3, anonymousClass12, 1, null) == coroutine_suspended) {
                }
    ...
    */
    static /* synthetic */ Object scroll$suspendImpl(PagerState $this, MutatePriority scrollPriority, Function2<? super ScrollScope, ? super Continuation<? super Unit>, ? extends Object> function2, Continuation<? super Unit> continuation) {
        ...
        if (continuation instanceof C03171) {
            ...
            if ((c03171.label & Integer.MIN_VALUE) != 0) {
                ...
                c03171 = $this.new C03171(continuation);
            }
        }
        Object $result = c03171.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        switch (c03171.label) {
            case 0:
                ResultKt.throwOnFailure($result);
                c03171.L$0 = $this;
                c03171.L$1 = scrollPriority;
                c03171.L$2 = function2;
                c03171.label = 1;
                if ($this.awaitScrollDependencies(c03171) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                ...
                c03171.L$2 = null;
                c03171.label = 2;
                if (scrollableState.scroll(scrollPriority, function2, c03171) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                $this.setProgrammaticScrollTargetPage(-1);
                return Unit.INSTANCE;
            case 1:
                Function2<? super ScrollScope, ? super Continuation<? super Unit>, ? extends Object> function22 = (Function2) c03171.L$2;
                scrollPriority = (MutatePriority) c03171.L$1;
                PagerState $this2 = (PagerState) c03171.L$0;
                ResultKt.throwOnFailure($result);
    ...
    private final boolean isGestureActionMatchesScroll(float scrollDelta) {
        ...
        if (getLayoutInfo().getOrientation() == Orientation.Vertical) {
            ...
            int bits$iv$iv$iv = (int) (4294967295L & m1084getUpDownDifferenceF1C5BW0$foundation());
            z = fSignum == Math.signum(-Float.intBitsToFloat(bits$iv$iv$iv));
        } else {
            float fSignum2 = Math.signum(scrollDelta);
            int bits$iv$iv$iv2 = (int) (m1084getUpDownDifferenceF1C5BW0$foundation() >> 32);
    ...
    public final boolean isNotGestureAction$foundation() {
        int bits$iv$iv$iv = (int) (m1084getUpDownDifferenceF1C5BW0$foundation() >> 32);
        if (((int) Float.intBitsToFloat(bits$iv$iv$iv)) == 0) {
            int bits$iv$iv$iv2 = (int) (4294967295L & m1084getUpDownDifferenceF1C5BW0$foundation());
        ...
        if (this.prefetchingEnabled && !info.getVisiblePagesInfo().isEmpty()) {
            ...
            if (indexToPrefetch >= 0 && indexToPrefetch < getPageCount()) {
                if (indexToPrefetch != this.indexToPrefetch) {
                    ...
                    this.currentPrefetchHandle = LazyLayoutPrefetchState.m998schedulePrecompositionAndPremeasureVKLhPVY$default(this.prefetchState, indexToPrefetch, this.premeasureConstraints, null, 4, null);
                }
