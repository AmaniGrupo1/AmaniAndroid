...
public final class PagerLazyLayoutItemProvider implements LazyLayoutItemProvider {
    ...
    public void Item(final int index, Object key, Composer $composer, final int $changed) {
        ...
        ComposerKt.sourceInformation($composer2, "C(Item)N(index,key)209@9044L155,209@8990L209:LazyLayoutPager.kt#g6yjnt");
        int $dirty = $changed;
        if (($changed & 6) == 0) {
        ...
        if (!$composer2.shouldExecute(($dirty & 147) != 146, $dirty & 1)) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1201380429, $dirty, -1, "androidx.compose.foundation.pager.PagerLazyLayoutItemProvider.Item (LazyLayoutPager.kt:208)");
            }
            index2 = index;
            key2 = key;
    ...
    static final Unit Item$lambda$0(PagerLazyLayoutItemProvider this$0, int $index, Composer $composer, int $changed) {
        ...
        if (!$composer.shouldExecute(($changed & 3) != 2, $changed & 1)) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(1142237095, $changed, -1, "androidx.compose.foundation.pager.PagerLazyLayoutItemProvider.Item.<anonymous> (LazyLayoutPager.kt:210)");
            }
