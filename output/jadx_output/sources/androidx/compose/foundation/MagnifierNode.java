...
public final class MagnifierNode extends Modifier.Node implements GlobalPositionAwareModifierNode, DrawModifierNode, SemanticsModifierNode, ObserverModifierNode {
    ...
    private MagnifierNode(Function1<? super Density, Offset> function1, Function1<? super Density, Offset> function12, Function1<? super DpSize, Unit> function13, float zoom, boolean useTextDefault, long size, float cornerRadius, float elevation, boolean clippingEnabled, PlatformMagnifierFactory platformMagnifierFactory) {
        ...
        this.sourceCenterInRoot = Offset.INSTANCE.m4467getUnspecifiedF1C5BW0();
    }
    ...
    private final long m322getAnchorPositionInRootF1C5BW0() {
        ...
        return state != null ? state.getValue().m4462unboximpl() : Offset.INSTANCE.m4467getUnspecifiedF1C5BW0();
    }
    ...
    public final void m329update5F03MCQ(Function1<? super Density, Offset> sourceCenter, Function1<? super Density, Offset> magnifierCenter, float zoom, boolean useTextDefault, long size, float cornerRadius, float elevation, boolean clippingEnabled, Function1<? super DpSize, Unit> onSizeChanged, PlatformMagnifierFactory platformMagnifierFactory) {
        ...
        boolean previousClippingEnabled2 = (this.magnifier == null || ((Magnifier_androidKt.equalsIncludingNaN(zoom, previousZoom) || platformMagnifierFactory.getCanUpdateZoom()) && DpSize.m7600equalsimpl0(size, previousSize) && Dp.m7510equalsimpl0(cornerRadius, previousCornerRadius) && Dp.m7510equalsimpl0(elevation, previousElevation) && useTextDefault == previousUseTextDefault && clippingEnabled == previousClippingEnabled && Intrinsics.areEqual(platformMagnifierFactory, previousPlatformMagnifierFactory) && Intrinsics.areEqual(view, previousView) && Intrinsics.areEqual(density, previousDensity))) ? false : true;
    ...
    private final void recreateMagnifier() {
        ...
        this.magnifier = this.platformMagnifierFactory.mo354createnHHXs2Y(view, this.useTextDefault, this.size, this.cornerRadius, this.elevation, this.clippingEnabled, density, this.zoom);
    ...
    */
    private final void updateMagnifier() {
        long it;
        Density it2 = this.density;
        if (it2 == null) {
            it2 = DelegatableNodeKt.requireDensity(this);
            this.density = it2;
        }
        long sourceCenterOffset = this.sourceCenter.invoke(it2).m4462unboximpl();
        if ((sourceCenterOffset & 9223372034707292159L) != InlineClassHelperKt.UnspecifiedPackedFloats) {
            if ((m322getAnchorPositionInRootF1C5BW0() & 9223372034707292159L) != InlineClassHelperKt.UnspecifiedPackedFloats) {
                this.sourceCenterInRoot = Offset.m4457plusMKHz9U(m322getAnchorPositionInRootF1C5BW0(), sourceCenterOffset);
                Function1<? super Density, Offset> function1 = this.magnifierCenter;
                if (function1 != null) {
                    Offset offsetM4441boximpl = Offset.m4441boximpl(function1.invoke(it2).m4462unboximpl());
                    if (!((9223372034707292159L & offsetM4441boximpl.m4462unboximpl()) != InlineClassHelperKt.UnspecifiedPackedFloats)) {
                        offsetM4441boximpl = null;
                    }
                    it = offsetM4441boximpl != null ? Offset.m4457plusMKHz9U(m322getAnchorPositionInRootF1C5BW0(), offsetM4441boximpl.m4462unboximpl()) : Offset.INSTANCE.m4467getUnspecifiedF1C5BW0();
                }
                long magnifierCenter = it;
                if (this.magnifier == null) {
                    recreateMagnifier();
                }
                PlatformMagnifier platformMagnifier = this.magnifier;
                if (platformMagnifier != null) {
                    platformMagnifier.mo353updateWko1d7g(this.sourceCenterInRoot, magnifierCenter, this.zoom);
                }
                updateSizeIfNecessary();
                return;
            }
    ...
    private final void updateSizeIfNecessary() {
        ...
        if (magnifier != null && (density = this.density) != null && !IntSize.m7673equalsimpl(magnifier.mo352getSizeYbymL2g(), this.previousSize)) {
            Function1<? super DpSize, Unit> function1 = this.onSizeChanged;
            if (function1 != null) {
                function1.invoke(DpSize.m7591boximpl(density.mo403toDpSizekrfVVM(IntSizeKt.m7688toSizeozmzZPI(magnifier.mo352getSizeYbymL2g()))));
            }
            this.previousSize = IntSize.m7668boximpl(magnifier.mo352getSizeYbymL2g());
        }
    }
    ...
    public void draw(ContentDrawScope $this$draw) {
        ...
        if (channel != null) {
            ChannelResult.m10064boximpl(channel.mo10050trySendJP2dKIU(Unit.INSTANCE));
        }
    }
    ...
    public void applySemantics(SemanticsPropertyReceiver $this$applySemantics) {
        $this$applySemantics.set(Magnifier_androidKt.getMagnifierPositionInRoot(), new Function0() { // from class: androidx.compose.foundation.MagnifierNode$$ExternalSyntheticLambda1
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                return Offset.m4441boximpl(this.f$0.sourceCenterInRoot);
            }
        });
    }
}
