...
public final class ContextMenuUi_androidKt {
    ...
    public static final ContextMenuColors computeContextMenuColors(int backgroundStyleId, int foregroundStyleId, Composer $composer, int $changed) {
        ...
        if (invalid$iv || it$iv == Composer.INSTANCE.getEmpty()) {
            long backgroundColor = m392resolveColorg2O1Hgs(context, backgroundStyleId, R.attr.colorBackground, ContextMenuUiKt.getDefaultContextMenuColors().getBackgroundColor());
            ColorStateList textColorStateList = resolveColorStateList(context, foregroundStyleId, R.attr.textColorPrimary);
            long enabledColor = m391enabledColor4WTKRHQ(textColorStateList, ContextMenuUiKt.getDefaultContextMenuColors().getTextColor());
            long disabledColor = m390disabledColor4WTKRHQ(textColorStateList, ContextMenuUiKt.getDefaultContextMenuColors().getDisabledTextColor());
    ...
    private static final long m392resolveColorg2O1Hgs(Context $this$resolveColor_u2dg2O1Hgs, int resId, int attrId, long j) {
        TypedArray typedArray = $this$resolveColor_u2dg2O1Hgs.obtainStyledAttributes(resId, new int[]{attrId});
        int defaultColorAndroid = ColorKt.m4751toArgb8_81llA(j);
        int colorInt = typedArray.getColor(0, defaultColorAndroid);
        typedArray.recycle();
        return colorInt == defaultColorAndroid ? j : ColorKt.Color(colorInt);
    }
    ...
    private static final long m391enabledColor4WTKRHQ(ColorStateList $this$enabledColor_u2d4WTKRHQ, long j) {
        int defaultColorArgb = ColorKt.m4751toArgb8_81llA(j);
        ...
        return (color == null || color.intValue() == defaultColorArgb) ? j : ColorKt.Color(color.intValue());
    }

    /* JADX INFO: renamed from: disabledColor-4WTKRHQ, reason: not valid java name */
    private static final long m390disabledColor4WTKRHQ(ColorStateList $this$disabledColor_u2d4WTKRHQ, long j) {
        int defaultColorArgb = ColorKt.m4751toArgb8_81llA(j);
