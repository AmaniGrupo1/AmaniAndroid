...
public final class ComposableSingletons$ContextMenuUiKt {
    ...
    static final Unit lambda__1455401925$lambda$0(ContextMenuColors colors, Composer $composer, int $changed) {
        ...
        if (!$composer.shouldExecute(($dirty & 19) != 18, $dirty & 1)) {
            ...
            BoxKt.Box(BackgroundKt.m264backgroundbw27NRU$default(SizeKt.m850height3ABfNKs(SizeKt.fillMaxWidth$default(PaddingKt.m820paddingVpY3zN4$default(Modifier.INSTANCE, 0.0f, ContextMenuSpec.INSTANCE.m378getDividerVerticalPaddingD9Ej5fM(), 1, null), 0.0f, 1, null), ContextMenuSpec.INSTANCE.m377getDividerHeightD9Ej5fM()), colors.getIconColor(), null, 2, null), $composer, 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
