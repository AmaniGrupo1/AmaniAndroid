...
public final class ContextMenuPopupPositionProvider implements PopupPositionProvider {
    ...
    private ContextMenuPopupPositionProvider(final long anchorPosition, Function2<? super IntOffset, ? super IntRect, Unit> function2) {
        this((Function0<IntOffset>) new Function0() { // from class: androidx.compose.foundation.contextmenu.ContextMenuPopupPositionProvider$$ExternalSyntheticLambda0
            ...
            public final Object invoke() {
                return IntOffset.m7624boximpl(anchorPosition);
            }
        }, function2);
    }
    ...
    public long mo373calculatePositionllwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
        long anchorPosition = this.anchorPositionBlock.invoke().m7642unboximpl();
        int x$iv = ContextMenuPopupPositionProviderKt.alignPopupAxis(anchorBounds.getLeft() + IntOffset.m7633getXimpl(anchorPosition), (int) (popupContentSize >> 32), (int) (windowSize >> 32), layoutDirection == LayoutDirection.Ltr);
        int $i$f$unpackInt2 = (int) (popupContentSize & 4294967295L);
        int $i$f$unpackInt22 = (int) (windowSize & 4294967295L);
        int y$iv = ContextMenuPopupPositionProviderKt.alignPopupAxis$default(anchorBounds.getTop() + IntOffset.m7634getYimpl(anchorPosition), $i$f$unpackInt2, $i$f$unpackInt22, false, 8, null);
        long resultPosition = IntOffset.m7627constructorimpl((((long) x$iv) << 32) | (((long) y$iv) & 4294967295L));
        Function2<IntOffset, IntRect, Unit> function2 = this.onPositionCalculated;
        if (function2 != null) {
            function2.invoke(IntOffset.m7624boximpl(anchorPosition), IntRectKt.m7666IntRectVbeCjmY(resultPosition, popupContentSize));
        }
