...
public final class ContextMenuUiKt {
    ...
    static {
        ...
        long jM4723getBlack0d7_KjU2 = Color.INSTANCE.m4723getBlack0d7_KjU();
        long jM4723getBlack0d7_KjU3 = Color.INSTANCE.m4723getBlack0d7_KjU();
        long jM4695copywmQWz5c = Color.m4695copywmQWz5c(jM4723getBlack0d7_KjU3, (14 & 1) != 0 ? Color.m4699getAlphaimpl(jM4723getBlack0d7_KjU3) : 0.38f, (14 & 2) != 0 ? Color.m4703getRedimpl(jM4723getBlack0d7_KjU3) : 0.0f, (14 & 4) != 0 ? Color.m4702getGreenimpl(jM4723getBlack0d7_KjU3) : 0.0f, (14 & 8) != 0 ? Color.m4700getBlueimpl(jM4723getBlack0d7_KjU3) : 0.0f);
        long jM4723getBlack0d7_KjU4 = Color.INSTANCE.m4723getBlack0d7_KjU();
        DefaultContextMenuColors = new ContextMenuColors(jM4734getWhite0d7_KjU, jM4723getBlack0d7_KjU, jM4723getBlack0d7_KjU2, jM4695copywmQWz5c, Color.m4695copywmQWz5c(jM4723getBlack0d7_KjU4, (14 & 1) != 0 ? Color.m4699getAlphaimpl(jM4723getBlack0d7_KjU4) : 0.38f, (14 & 2) != 0 ? Color.m4703getRedimpl(jM4723getBlack0d7_KjU4) : 0.0f, (14 & 4) != 0 ? Color.m4702getGreenimpl(jM4723getBlack0d7_KjU4) : 0.0f, (14 & 8) != 0 ? Color.m4700getBlueimpl(jM4723getBlack0d7_KjU4) : 0.0f), null);
    }
    ...
    public static final void ContextMenuColumnBuilder(Modifier modifier, ContextMenuColors colors, final Function1<? super ContextMenuScope, Unit> function1, Composer $composer, final int $changed, final int i) {
        ...
        if (!$composer2.shouldExecute(($dirty2 & 147) != 146, $dirty2 & 1)) {
            ...
            }, $composer2, 54), $composer2, (($dirty2 >> 3) & 14) | RendererCapabilities.DECODER_SUPPORT_MASK | (($dirty2 << 3) & 112), 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            colors2 = colors3;
    ...
    static final Unit ContextMenuColumnBuilder$lambda$0(Function1 $contextMenuBuilderBlock, ContextMenuColors $colors, ColumnScope $this$ContextMenuColumn, Composer $composer, int $changed) {
        ...
        if (!$composer.shouldExecute(($changed & 17) != 16, $changed & 1)) {
            ...
            if (it$iv == Composer.INSTANCE.getEmpty()) {
                Object value$iv = new ContextMenuScope(ComposableSingletons$ContextMenuUiKt.INSTANCE.m367getLambda$1571120048$foundation());
    ...
    public static final void ContextMenuColumn(final ContextMenuColors colors, Modifier modifier, final Function3<? super ColumnScope, ? super Composer, ? super Integer, Unit> function3, Composer $composer, final int $changed, final int i) {
        ...
        if (!$composer2.shouldExecute(($dirty2 & 147) != 146, $dirty2 & 1)) {
            ...
            Modifier modifier$iv = ScrollKt.verticalScroll$default(PaddingKt.m820paddingVpY3zN4$default(IntrinsicKt.width(BackgroundKt.m264backgroundbw27NRU$default(ShadowKt.m4295shadows4CzXII$default(modifier4, ContextMenuSpec.INSTANCE.m386getMenuContainerElevationD9Ej5fM(), RoundedCornerShapeKt.m1126RoundedCornerShape0680j_4(ContextMenuSpec.INSTANCE.m376getCornerRadiusD9Ej5fM()), false, 0L, 0L, 28, null), contextMenuColors.getBackgroundColor(), null, 2, null), IntrinsicSize.Max), 0.0f, ContextMenuSpec.INSTANCE.m387getVerticalPaddingD9Ej5fM(), 1, null), ScrollKt.rememberScrollState(0, $composer2, 0, 1), false, null, false, 14, null);
    ...
    public static final void ContextMenuItem(final String label, final boolean enabled, final ContextMenuColors colors, Modifier modifier, Function3<? super Color, ? super Composer, ? super Integer, Unit> function3, final Function0<Unit> function0, Composer $composer, final int $changed, final int i) {
        ...
        Function3<? super Color, ? super Composer, ? super Integer, Unit> function34;
        ...
        if ($composer3.shouldExecute((74899 & $dirty2) != 74898, $dirty2 & 1)) {
            ...
            Arrangement.Horizontal horizontalM688spacedBy0680j_4 = Arrangement.INSTANCE.m688spacedBy0680j_4(ContextMenuSpec.INSTANCE.m380getHorizontalPaddingD9Ej5fM());
            ...
            Modifier modifier$iv$iv = PaddingKt.m820paddingVpY3zN4$default(SizeKt.m867sizeInqDBjuR0(SizeKt.fillMaxWidth$default(ClickableKt.m299clickableoSLSa3U$default(modifier5, enabled, str, null, null, (Function0) it$iv, 12, null), 0.0f, 1, null), ContextMenuSpec.INSTANCE.m375getContainerWidthMinD9Ej5fM(), ContextMenuSpec.INSTANCE.m385getListItemHeightD9Ej5fM(), ContextMenuSpec.INSTANCE.m374getContainerWidthMaxD9Ej5fM(), ContextMenuSpec.INSTANCE.m385getListItemHeightD9Ej5fM()), ContextMenuSpec.INSTANCE.m380getHorizontalPaddingD9Ej5fM(), 0.0f, 2, null);
            Arrangement.Horizontal horizontalArrangement$iv = horizontalM688spacedBy0680j_4;
            ...
            if (function34 == null) {
                ...
                Modifier modifier$iv = SizeKt.m860requiredSizeInqDBjuR0$default(Modifier.INSTANCE, ContextMenuSpec.INSTANCE.m381getIconSizeD9Ej5fM(), 0.0f, ContextMenuSpec.INSTANCE.m381getIconSizeD9Ej5fM(), ContextMenuSpec.INSTANCE.m381getIconSizeD9Ej5fM(), 2, null);
                $composer2 = $composer3;
                ...
                function35.invoke(Color.m4687boximpl(enabled ? contextMenuColors.getIconColor() : contextMenuColors.getDisabledIconColor()), $composer3, 0);
                ComposerKt.sourceInformationMarkerEnd($composer3);
                ComposerKt.sourceInformationMarkerEnd($composer3);
                $composer3.endNode();
                ComposerKt.sourceInformationMarkerEnd($composer3);
