...
public final class ContextMenuAreaKt {
    ...
    public static final Unit ContextMenuArea$lambda$1$0(Function0 $onOpenGesture, ContextMenuState $state, Offset it) {
        ...
        $state.setStatus(new ContextMenuState.Status.Open(it.m4462unboximpl(), null));
        return Unit.INSTANCE;
    }
        ...
        if (!$composer2.shouldExecute(($dirty2 & 1171) != 1170, $dirty2 & 1)) {
            ...
            if (status instanceof ContextMenuState.Status.Open) {
                ...
                if (invalid$iv || it$iv == Composer.INSTANCE.getEmpty()) {
                    Object value$iv = new ContextMenuPopupPositionProvider(IntOffsetKt.m7650roundk4lQ0M(((ContextMenuState.Status.Open) status).getOffset()), (Function2) null, 2, (DefaultConstructorMarker) null);
                    $composer2.updateRememberedValue(value$iv);
                    it$iv = value$iv;
                }
