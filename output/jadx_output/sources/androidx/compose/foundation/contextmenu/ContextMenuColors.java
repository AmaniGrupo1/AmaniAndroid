...
public final class ContextMenuColors {
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof ContextMenuColors) && Color.m4698equalsimpl0(this.backgroundColor, ((ContextMenuColors) other).backgroundColor) && Color.m4698equalsimpl0(this.textColor, ((ContextMenuColors) other).textColor) && Color.m4698equalsimpl0(this.iconColor, ((ContextMenuColors) other).iconColor) && Color.m4698equalsimpl0(this.disabledTextColor, ((ContextMenuColors) other).disabledTextColor) && Color.m4698equalsimpl0(this.disabledIconColor, ((ContextMenuColors) other).disabledIconColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (((((((result * 31) + Color.m4704hashCodeimpl(this.textColor)) * 31) + Color.m4704hashCodeimpl(this.iconColor)) * 31) + Color.m4704hashCodeimpl(this.disabledTextColor)) * 31) + Color.m4704hashCodeimpl(this.disabledIconColor);
    }

    public String toString() {
        return "ContextMenuColors(backgroundColor=" + ((Object) Color.m4705toStringimpl(this.backgroundColor)) + ", textColor=" + ((Object) Color.m4705toStringimpl(this.textColor)) + ", iconColor=" + ((Object) Color.m4705toStringimpl(this.iconColor)) + ", disabledTextColor=" + ((Object) Color.m4705toStringimpl(this.disabledTextColor)) + ", disabledIconColor=" + ((Object) Color.m4705toStringimpl(this.disabledIconColor)) + ')';
    }
}
