    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                press = new PressInteraction.Press(this.f4$$v$c$androidxcomposeuigeometryOffset$offset$0, null);
            ...
            case 1:
                ResultKt.throwOnFailure($result);
                press = new PressInteraction.Press(this.f4$$v$c$androidxcomposeuigeometryOffset$offset$0, null);
                PressInteraction.Release release22 = new PressInteraction.Release(press);
                this.L$0 = release22;
                this.label = 2;
                if (this.$interactionSource.emit(press, this) != coroutine_suspended) {
                }
