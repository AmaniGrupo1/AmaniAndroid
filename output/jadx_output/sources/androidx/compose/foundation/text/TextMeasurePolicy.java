...
final class TextMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo41measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, List<? extends Measurable> list, long j) {
        ...
        if (listInvoke != null) {
            ...
            while (index$iv$iv2 < size2) {
                ...
                if (rect != null) {
                    ...
                    Placeable placeableMo6141measureBRTryo0 = ((Measurable) inlineContentMeasurables2.get(index$iv)).mo6141measureBRTryo0(ConstraintsKt.Constraints$default(0, (int) Math.floor(rect.getRight() - rect.getLeft()), 0, (int) Math.floor(rect.getBottom() - rect.getTop()), 5, null));
                    ...
                    pair = new Pair(placeableMo6141measureBRTryo0, IntOffset.m7624boximpl(IntOffset.m7627constructorimpl((((long) val1$iv$iv) << 32) | (((long) y$iv) & 4294967295L))));
                } else {
                    inlineContentMeasurables = inlineContentMeasurables2;
                    list2 = listInvoke;
                    $i$f$fastMapIndexedNotNull = $i$f$fastMapIndexedNotNull2;
        ...
        return MeasureScope.layout$default($this$measure_u2d3p2s80s, Constraints.m7458getMaxWidthimpl(j), Constraints.m7457getMaxHeightimpl(j), null, new Function1() { // from class: androidx.compose.foundation.text.TextMeasurePolicy$$ExternalSyntheticLambda0
    ...
    static final Unit measure_3p2s80s$lambda$3(List $inlineContentToPlace, List $linksToPlace, Placeable.PlacementScope $this$layout) {
        if ($inlineContentToPlace != null) {
            ...
            for (int index$iv = 0; index$iv < size; index$iv++) {
                ...
                long position = ((IntOffset) pair.component2()).m7642unboximpl();
                Placeable.PlacementScope.m6207place70tqf50$default($this$layout, placeable, position, 0.0f, 2, null);
            }
        }
        if ($linksToPlace != null) {
            ...
            for (int index$iv2 = 0; index$iv2 < size2; index$iv2++) {
                ...
                Placeable.PlacementScope.m6207place70tqf50$default($this$layout, placeable2, measureResult != null ? ((IntOffset) measureResult.invoke()).m7642unboximpl() : IntOffset.INSTANCE.m7644getZeronOccac(), 0.0f, 2, null);
            }
        }
