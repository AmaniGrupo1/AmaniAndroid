...
public final class PasswordInputTransformation implements InputTransformation {
    ...
    public void transformInput(TextFieldBuffer $this$transformInput) {
        boolean singleCharacterChange = $this$transformInput.getChanges().getChangeCount() == 1 && TextRange.m6924getLengthimpl($this$transformInput.getChanges().mo1333getRangejx7JFs(0)) == 1;
        if (!singleCharacterChange || $this$transformInput.hasSelection()) {
            setRevealCodepointIndex(-1);
            return;
        }
        int insertionPoint = TextRange.m6926getMinimpl($this$transformInput.getChanges().mo1333getRangejx7JFs(0));
