...
public final class TextLinkScope {
    ...
    */
    static final List _init_$lambda$0(AnnotatedString.Range it) {
        ...
        if (it.getItem() instanceof LinkAnnotation) {
            ...
            if (!TextLinkScopeKt.isNullOrEmpty(((LinkAnnotation) item).getStyles())) {
                ...
                arrayListArrayListOf = CollectionsKt.arrayListOf(it);
            }
        }
    ...
    public static final IntOffset textRange$lambda$0$0() {
        return IntOffset.m7624boximpl(IntOffset.INSTANCE.m7644getZeronOccac());
    }
    ...
    public static final IntOffset textRange$lambda$0$2(IntRect $bounds) {
        return IntOffset.m7624boximpl($bounds.m7662getTopLeftnOccac());
    }
    ...
    private final Path pathForRangeInRangeCoordinates(AnnotatedString.Range<LinkAnnotation> link) {
        ...
        path.mo4589translatek4lQ0M(Offset.m4444constructorimpl((-9223372034707292160L) ^ Offset.m4444constructorimpl(v2$iv$iv)));
        return path;
    }
        ...
        if ($composer2.shouldExecute(($dirty2 & 3) != 2, $dirty2 & 1)) {
            ...
            while (index$iv < size) {
                ...
                if (range.getStart() != range.getEnd()) {
                    ...
                    ComposerKt.sourceInformationMarkerEnd($composer2);
                    BoxKt.Box(ClickableKt.m303combinedClickableauXiCPI$default(modifierPointerHoverIcon$default, interactionSource, null, false, null, null, null, null, null, false, (Function0) it$iv3, 508, null), $composer2, 0);
                    if (TextLinkScopeKt.isNullOrEmpty(range.getItem().getStyles())) {
                        uriHandler = uriHandler2;
                        $composer2.startReplaceGroup(716130110);
                    } else {
