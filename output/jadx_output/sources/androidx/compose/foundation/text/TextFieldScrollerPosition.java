...
public final class TextFieldScrollerPosition {
    ...
    public TextFieldScrollerPosition(Orientation initialOrientation, float initial) {
        ...
        this.previousSelection = TextRange.INSTANCE.m6933getZerod9O1mEE();
    ...
    */
    public final void update(Orientation orientation, Rect cursorRect, int containerSize, int textFieldSize) {
        ...
        if (cursorRect.getLeft() == this.previousCursorRect.getLeft()) {
            ...
            coerceOffset$foundation(cursorStart, cursorEnd, containerSize);
            this.previousCursorRect = cursorRect;
        }
        float cursorStart2 = getOffset();
        setOffset(RangesKt.coerceIn(cursorStart2, 0.0f, difference));
    ...
    public final int m1281getOffsetToFollow5zctL8(long selection) {
        return TextRange.m6928getStartimpl(selection) != TextRange.m6928getStartimpl(this.previousSelection) ? TextRange.m6928getStartimpl(selection) : TextRange.m6923getEndimpl(selection) != TextRange.m6923getEndimpl(this.previousSelection) ? TextRange.m6923getEndimpl(selection) : TextRange.m6926getMinimpl(selection);
    }
