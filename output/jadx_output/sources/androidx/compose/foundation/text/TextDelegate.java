...
public final class TextDelegate {
    ...
    public /* synthetic */ TextDelegate(AnnotatedString annotatedString, TextStyle textStyle, int i, int i2, boolean z, int i3, Density density, FontFamily.Resolver resolver, List list, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this(annotatedString, textStyle, (i4 & 4) != 0 ? Integer.MAX_VALUE : i, (i4 & 8) != 0 ? 1 : i2, (i4 & 16) != 0 ? true : z, (i4 & 32) != 0 ? TextOverflow.INSTANCE.m7415getClipgIe3tQ8() : i3, density, resolver, (i4 & 256) != 0 ? CollectionsKt.emptyList() : list, null);
    }
    ...
    private final MultiParagraph m1248layoutTextK40F9xA(long constraints, LayoutDirection layoutDirection) {
        int maxWidth;
        int width;
        layoutIntrinsics(layoutDirection);
        int minWidth = Constraints.m7460getMinWidthimpl(constraints);
        boolean widthMatters = this.softWrap || TextOverflow.m7406equalsimpl0(this.overflow, TextOverflow.INSTANCE.m7416getEllipsisgIe3tQ8());
        if (widthMatters && Constraints.m7454getHasBoundedWidthimpl(constraints)) {
            maxWidth = Constraints.m7458getMaxWidthimpl(constraints);
        } else {
            maxWidth = Integer.MAX_VALUE;
        }
        boolean overwriteMaxLines = !this.softWrap && TextOverflow.m7406equalsimpl0(this.overflow, TextOverflow.INSTANCE.m7416getEllipsisgIe3tQ8());
        ...
        return new MultiParagraph(getNonNullIntrinsics(), Constraints.INSTANCE.m7467fitPrioritizingWidthZbe2FdA(0, width, 0, Constraints.m7457getMaxHeightimpl(constraints)), finalMaxLines, this.overflow, (DefaultConstructorMarker) null);
    }
    ...
    public final TextLayoutResult m1250layoutNN6EwU(long constraints, LayoutDirection layoutDirection, TextLayoutResult prevResult) {
        if (prevResult == null || !TextLayoutHelperKt.m1287canReuse7_7YC6M(prevResult, this.text, this.style, this.placeholders, this.maxLines, this.softWrap, this.overflow, this.density, layoutDirection, this.fontFamilyResolver, constraints)) {
            long j = constraints;
            long j2 = 4294967295L;
            MultiParagraph multiParagraph = m1248layoutTextK40F9xA(constraints, layoutDirection);
            ...
            long size = ConstraintsKt.m7472constrain4WqzIAM(j, IntSize.m7671constructorimpl((((long) width$iv) << 32) | (((long) height$iv) & j2)));
        ...
        return prevResult.m6897copyO0kMr_c(textLayoutInput, ConstraintsKt.m7472constrain4WqzIAM(constraints, IntSize.m7671constructorimpl((((long) width$iv2) << 32) | (((long) height$iv2) & 4294967295L))));
    }
