...
public final class TextFieldMagnifierKt {
    ...
    public static final long m1493calculateSelectionMagnifierCenterAndroidhUlJWOE(TransformedTextFieldState textFieldState, TextFieldSelectionState selectionState, TextLayoutState textLayoutState, long j) {
        int textOffset;
        long localDragPosition = selectionState.m1508getHandleDragPositionF1C5BW0();
        if (!((9223372034707292159L & localDragPosition) == InlineClassHelperKt.UnspecifiedPackedFloats)) {
            if (!(textFieldState.getVisualText().length() == 0)) {
                ...
                switch (draggingHandle == null ? -1 : WhenMappings.$EnumSwitchMapping$0[draggingHandle.ordinal()]) {
                    ...
                    case 1:
                    case 2:
                        textOffset = TextRange.m6928getStartimpl(selection);
                        break;
                    case 3:
                        textOffset = TextRange.m6923getEndimpl(selection);
                        break;
                }
                ...
                if (!IntSize.m7674equalsimpl0(j, IntSize.INSTANCE.m7681getZeroYbymL2g()) && Math.abs(dragX - centerX) > ((int) (j >> 32)) / 2) {
                    return Offset.INSTANCE.m4467getUnspecifiedF1C5BW0();
                }
                ...
                if (innerCoordinates != null) {
                    ...
                    if (innerCoordinates != null) {
                        offset = TextLayoutStateKt.m1453coerceIn3MmeM6k(offset, SelectionManagerKt.visibleBounds(innerCoordinates));
                    }
                }
                return TextLayoutStateKt.m1455fromTextLayoutToCoreUv8p0NA(textLayoutState, offset);
            }
        }
        return Offset.INSTANCE.m4467getUnspecifiedF1C5BW0();
    }
