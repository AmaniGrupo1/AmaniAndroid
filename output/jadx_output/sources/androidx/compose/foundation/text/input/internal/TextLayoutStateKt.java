...
public final class TextLayoutStateKt {
    ...
    public static final long m1455fromTextLayoutToCoreUv8p0NA(TextLayoutState $this$fromTextLayoutToCore_u2dUv8p0NA, long j) {
        LayoutCoordinates textLayoutNodeCoordinates = $this$fromTextLayoutToCore_u2dUv8p0NA.getTextLayoutNodeCoordinates();
        if (textLayoutNodeCoordinates != null) {
            Offset offsetM4441boximpl = null;
            ...
            if (textLayoutNodeCoordinates != null) {
                ...
                if (it != null) {
                    ...
                    if (it != null) {
                        offsetM4441boximpl = Offset.m4441boximpl(it.mo6150localPositionOfR5De75A(textLayoutNodeCoordinates, j));
                    }
                }
                if (offsetM4441boximpl != null) {
                    return offsetM4441boximpl.m4462unboximpl();
                }
            }
        }
        return j;
    ...
    public static final long m1454fromDecorationToTextLayoutUv8p0NA(TextLayoutState $this$fromDecorationToTextLayout_u2dUv8p0NA, long j) {
        Offset offsetM4441boximpl;
        long jMo6150localPositionOfR5De75A;
        ...
        if (textLayoutNodeCoordinates != null) {
            ...
            if (decoratorNodeCoordinates != null) {
                if (textLayoutNodeCoordinates.isAttached() && decoratorNodeCoordinates.isAttached()) {
                    jMo6150localPositionOfR5De75A = textLayoutNodeCoordinates.mo6150localPositionOfR5De75A(decoratorNodeCoordinates, j);
                } else {
                    jMo6150localPositionOfR5De75A = j;
                }
                offsetM4441boximpl = Offset.m4441boximpl(jMo6150localPositionOfR5De75A);
            } else {
    ...
    public static final long m1456fromWindowToDecorationUv8p0NA(TextLayoutState $this$fromWindowToDecoration_u2dUv8p0NA, long j) {
        LayoutCoordinates decoratorNodeCoordinates = $this$fromWindowToDecoration_u2dUv8p0NA.getDecoratorNodeCoordinates();
        if (decoratorNodeCoordinates != null) {
            if (decoratorNodeCoordinates.isAttached()) {
                return decoratorNodeCoordinates.mo6158windowToLocalMKHz9U(j);
            }
            return j;
        }
        return j;
        ...
        if (textLayoutNode != null) {
            ...
            if (textLayoutNode != null && (it = $this$fromTextLayoutToDecoration.getDecoratorNodeCoordinates()) != null) {
                ...
                if (decoratorNode != null) {
                    long topLeft = decoratorNode.localBoundingBoxOf(textLayoutNode, false).m4487getTopLeftF1C5BW0();
                    return rect.m4489translatek4lQ0M(topLeft);
                }
            }
            return rect;
        }
