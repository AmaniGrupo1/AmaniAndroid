...
public final class TextFieldBuffer implements Appendable {
    ...
    public interface ChangeList {
        ...
        long mo1332getOriginalRangejx7JFs(int changeIndex);

        /* JADX INFO: renamed from: getRange--jx7JFs, reason: not valid java name */
        long mo1333getRangejx7JFs(int changeIndex);
    }
    ...
    public final boolean hasSelection() {
        return !TextRange.m6922getCollapsedimpl(getSelectionInChars());
    }
    ...
    private final void m1324setCompositionOEnZFl4(TextRange value) {
        if (value == null || TextRange.m6922getCollapsedimpl(value.getPackedValue())) {
    ...
    public final void setComposition$foundation(int start, int end, List<AnnotatedString.Range<AnnotatedString.Annotation>> annotations) {
        ...
        if (start < end) {
            m1324setCompositionOEnZFl4(TextRange.m6916boximpl(TextRangeKt.TextRange(start, end)));
            MutableVector<AnnotatedString.Range<AnnotatedString.Annotation>> mutableVector = this.composingAnnotations;
            if (mutableVector != null) {
                mutableVector.clear();
            }
    ...
    public final void m1329setHighlightK7f2yys$foundation(int type, int start, int end) {
        if (start >= end) {
            throw new IllegalArgumentException("Do not set reversed or empty range: " + start + " > " + end);
        }
        int clampedStart = RangesKt.coerceIn(start, 0, getLength());
        int clampedEnd = RangesKt.coerceIn(end, 0, getLength());
        this.highlight = new Pair<>(TextHighlightType.m1342boximpl(type), TextRange.m6916boximpl(TextRangeKt.TextRange(clampedStart, clampedEnd)));
    }
    ...
    private final void onTextWillChange(int replaceStart, int replaceEnd, int newLength) {
        ...
        this.selectionInChars = TextFieldBufferKt.m1334adjustTextRangevJH6DeI(getSelectionInChars(), replaceStart, replaceEnd, newLength);
    }
    ...
    public final void revertAllChanges() {
        ...
        m1330setSelection5zctL8(this.originalValue.getSelection());
        clearChangeList();
    }
    ...
    public static /* synthetic */ TextFieldCharSequence m1325toTextFieldCharSequencewFTz33Y$foundation$default(TextFieldBuffer textFieldBuffer, long j, TextRange textRange, List list, List list2, int i, Object obj) {
        ...
        return textFieldBuffer.m1331toTextFieldCharSequencewFTz33Y$foundation(selectionInChars, textRange2, list3, (i & 8) != 0 ? null : list2);
    }

    /* JADX INFO: renamed from: toTextFieldCharSequence-wFTz33Y$foundation, reason: not valid java name */
    public final TextFieldCharSequence m1331toTextFieldCharSequencewFTz33Y$foundation(long selection, TextRange composition, List<AnnotatedString.Range<AnnotatedString.Annotation>> composingAnnotations, List<AnnotatedString.Range<AnnotatedString.Annotation>> outputAnnotations) {
    ...
    private final void m1323requireValidRange5zctL8(long range) {
        long validRange = TextRangeKt.TextRange(0, getLength());
        boolean value$iv = TextRange.m6918contains5zctL8(validRange, range);
        if (value$iv) {
            return;
        }
        InlineClassHelperKt.throwIllegalArgumentException("Expected " + ((Object) TextRange.m6931toStringimpl(range)) + " to be in " + ((Object) TextRange.m6931toStringimpl(validRange)));
    }
