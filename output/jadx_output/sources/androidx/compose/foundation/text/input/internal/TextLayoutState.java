...
public final class TextLayoutState {
    ...
    public final TextLayoutResult m1451layoutWithNewMeasureInputshBUhpc(Density density, LayoutDirection layoutDirection, FontFamily.Resolver fontFamilyResolver, long constraints) {
        TextLayoutResult layoutResult = this.layoutCache.m1440layoutWithNewMeasureInputshBUhpc(density, layoutDirection, fontFamilyResolver, constraints);
    ...
    public final int m1449getOffsetForPosition3MmeM6k(long position, boolean coerceInVisibleBounds) {
        ...
        if (coerceInVisibleBounds) {
            coercedPosition = m1447coercedInVisibleBoundsOfInputTextMKHz9U$foundation(position);
        } else {
            coercedPosition = position;
        }
        long relativePosition = TextLayoutStateKt.m1454fromDecorationToTextLayoutUv8p0NA(this, coercedPosition);
        return layoutResult.m6898getOffsetForPositionk4lQ0M(relativePosition);
    }

    /* JADX INFO: renamed from: isPositionOnText-k-4lQ0M, reason: not valid java name */
    public final boolean m1450isPositionOnTextk4lQ0M(long offset) {
        TextLayoutResult layoutResult = getLayoutResult();
        if (layoutResult == null) {
            return false;
        }
        long relativeOffset = TextLayoutStateKt.m1454fromDecorationToTextLayoutUv8p0NA(this, m1447coercedInVisibleBoundsOfInputTextMKHz9U$foundation(offset));
    ...
    */
    public final long m1447coercedInVisibleBoundsOfInputTextMKHz9U$foundation(long offset) {
        Rect visibleTextLayoutNodeRect;
        ...
        if (textLayoutNodeCoordinates != null) {
            if (textLayoutNodeCoordinates.isAttached()) {
                ...
                visibleTextLayoutNodeRect = null;
                if (decoratorNodeCoordinates != null) {
                    visibleTextLayoutNodeRect = LayoutCoordinates.localBoundingBoxOf$default(decoratorNodeCoordinates, textLayoutNodeCoordinates, false, 2, null);
                }
            } else {
                visibleTextLayoutNodeRect = Rect.INSTANCE.getZero();
            }
            if (visibleTextLayoutNodeRect == null) {
            }
        } else {
            visibleTextLayoutNodeRect = Rect.INSTANCE.getZero();
        }
        return TextLayoutStateKt.m1453coerceIn3MmeM6k(offset, visibleTextLayoutNodeRect);
    }
}
