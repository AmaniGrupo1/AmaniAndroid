...
public final class TextFieldMagnifierNodeImpl28 extends TextFieldMagnifierNode implements CompositionLocalConsumerModifierNode {
    ...
    private final MutableState magnifierSize = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntSize.m7668boximpl(IntSize.INSTANCE.m7681getZeroYbymL2g()), null, 2, null);
    ...
    public TextFieldMagnifierNodeImpl28(TransformedTextFieldState textFieldState, TextFieldSelectionState textFieldSelectionState, TextLayoutState textLayoutState, boolean visible) {
        ...
        this.animatable = new Animatable<>(Offset.m4441boximpl(TextFieldMagnifierKt.m1493calculateSelectionMagnifierCenterAndroidhUlJWOE(this.textFieldState, this.textFieldSelectionState, this.textLayoutState, m1495getMagnifierSizeYbymL2g())), SelectionMagnifierKt.getUnspecifiedSafeOffsetVectorConverter(), Offset.m4441boximpl(SelectionMagnifierKt.getOffsetDisplacementThreshold()), null, 8, null);
    }
    ...
    static final Unit magnifierNode$lambda$1(TextFieldMagnifierNodeImpl28 this$0, DpSize size) {
        ...
        int width$iv = $this$magnifierNode_u24lambda_u241_u240.mo399roundToPx0680j_4(DpSize.m7603getWidthD9Ej5fM(size.getPackedValue()));
        int height$iv = $this$magnifierNode_u24lambda_u241_u240.mo399roundToPx0680j_4(DpSize.m7601getHeightD9Ej5fM(size.getPackedValue()));
        this$0.m1496setMagnifierSizeozmzZPI(IntSize.m7671constructorimpl((((long) width$iv) << 32) | (((long) height$iv) & 4294967295L)));
    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                ...
                case 0:
                    ...
                    if (flowSnapshotFlow.collect(new FlowCollector() { // from class: androidx.compose.foundation.text.input.internal.selection.TextFieldMagnifierNodeImpl28.restartAnimationJob.1.2
                        ...
                        public /* bridge */ /* synthetic */ Object emit(Object value, Continuation $completion) {
                            return m1497emit3MmeM6k(((Offset) value).m4462unboximpl(), $completion);
                        }
                        ...
                        public final Object m1497emit3MmeM6k(long j, Continuation<? super Unit> continuation) {
                            if ((((Offset) textFieldMagnifierNodeImpl282.animatable.getValue()).m4462unboximpl() & 9223372034707292159L) != InlineClassHelperKt.UnspecifiedPackedFloats) {
                                if ((9223372034707292159L & j) != InlineClassHelperKt.UnspecifiedPackedFloats) {
                                    int bits$iv$iv$iv = (int) (((Offset) textFieldMagnifierNodeImpl282.animatable.getValue()).m4462unboximpl() & 4294967295L);
                                    int bits$iv$iv$iv2 = (int) (4294967295L & j);
                                    if (!(Float.intBitsToFloat(bits$iv$iv$iv) == Float.intBitsToFloat(bits$iv$iv$iv2))) {
                                        BuildersKt__Builders_commonKt.launch$default(animationScope, null, null, new C00361(textFieldMagnifierNodeImpl282, j, null), 3, null);
                                        return Unit.INSTANCE;
                                    }
                                }
                            }
                            Object objSnapTo = textFieldMagnifierNodeImpl282.animatable.snapTo(Offset.m4441boximpl(j), continuation);
                        ...
                        static final class C00361 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                            ...
                            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
                            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                                return new C00361(this.this$0, this.f57$$v$c$androidxcomposeuigeometryOffset$targetValue$0, continuation);
                            }
                            ...
                            public final Object invokeSuspend(Object $result) {
                                ...
                                switch (this.label) {
                                    case 0:
                                        ...
                                        Offset offsetM4441boximpl = Offset.m4441boximpl(this.f57$$v$c$androidxcomposeuigeometryOffset$targetValue$0);
                                        SpringSpec<Offset> magnifierSpringSpec = SelectionMagnifierKt.getMagnifierSpringSpec();
                                        this.label = 1;
                                        if (animatable.animateTo(offsetM4441boximpl, (4 & 2) != 0 ? animatable.defaultSpringSpec : magnifierSpringSpec, (4 & 4) != 0 ? animatable.getVelocity() : null, (4 & 8) != 0 ? null : null, this) == coroutine_suspended) {
        ...
        static final Offset invokeSuspend$lambda$0(TextFieldMagnifierNodeImpl28 this$0) {
            ...
            return Offset.m4441boximpl(TextFieldMagnifierKt.m1493calculateSelectionMagnifierCenterAndroidhUlJWOE(this$0.textFieldState, this$0.textFieldSelectionState, this$0.textLayoutState, this$0.m1495getMagnifierSizeYbymL2g()));
        }
    }
