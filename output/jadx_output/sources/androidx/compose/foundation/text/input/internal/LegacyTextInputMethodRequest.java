...
public final class LegacyTextInputMethodRequest implements PlatformTextInputMethodRequest {
    ...
    private TextFieldValue state = new TextFieldValue("", TextRange.INSTANCE.m6933getZerod9O1mEE(), (TextRange) null, 4, (DefaultConstructorMarker) null);
    ...
    public RecordingInputConnection createInputConnection(EditorInfo outAttributes) {
        EditorInfo_androidKt.m1378updatepLxbY9I$default(outAttributes, this.state.getText(), this.state.getSelection(), this.imeOptions, null, 8, null);
        ...
        RecordingInputConnection it = new RecordingInputConnection(textFieldValue, new InputEventCallback2() { // from class: androidx.compose.foundation.text.input.internal.LegacyTextInputMethodRequest.createInputConnection.1
            ...
            public void mo1404onImeActionKlQnJC8(int imeAction) {
                LegacyTextInputMethodRequest.this.onImeActionPerformed.invoke(ImeAction.m7093boximpl(imeAction));
            }
    ...
    public final void updateState(TextFieldValue oldValue, TextFieldValue newValue) {
        ...
        boolean needUpdateSelection = (TextRange.m6921equalsimpl0(this.state.getSelection(), newValue.getSelection()) && Intrinsics.areEqual(this.state.getComposition(), newValue.getComposition())) ? false : true;
        this.state = newValue;
        ...
        if (Intrinsics.areEqual(oldValue, newValue)) {
            if (needUpdateSelection) {
                ...
                int iM6926getMinimpl = TextRange.m6926getMinimpl(newValue.getSelection());
                int iM6925getMaximpl = TextRange.m6925getMaximpl(newValue.getSelection());
                TextRange composition = this.state.getComposition();
                int iM6926getMinimpl2 = composition != null ? TextRange.m6926getMinimpl(composition.getPackedValue()) : -1;
                TextRange composition2 = this.state.getComposition();
                inputMethodManager.updateSelection(iM6926getMinimpl, iM6925getMaximpl, iM6926getMinimpl2, composition2 != null ? TextRange.m6925getMaximpl(composition2.getPackedValue()) : -1);
                return;
            }
            return;
        }
        if (oldValue != null && (!Intrinsics.areEqual(oldValue.getText(), newValue.getText()) || (TextRange.m6921equalsimpl0(oldValue.getSelection(), newValue.getSelection()) && !Intrinsics.areEqual(oldValue.getComposition(), newValue.getComposition())))) {
            restartInput = true;
        }
        if (restartInput) {
