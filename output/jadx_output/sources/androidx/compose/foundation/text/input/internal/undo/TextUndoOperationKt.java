...
public final class TextUndoOperationKt {
    public static final void undo(TextFieldState $this$undo, TextUndoOperation op) {
        ...
        TextFieldBufferKt.setSelectionCoerced($this$undo_u24lambda_u240, TextRange.m6928getStartimpl(op.getPreSelection()), TextRange.m6923getEndimpl(op.getPreSelection()));
        TextFieldCharSequence afterEditValue$iv = TextFieldBuffer.m1325toTextFieldCharSequencewFTz33Y$foundation$default($this$undo.getMainBuffer(), 0L, null, null, null, 15, null);
    ...
    public static final void redo(TextFieldState $this$redo, TextUndoOperation op) {
        ...
        TextFieldBufferKt.setSelectionCoerced($this$redo_u24lambda_u240, TextRange.m6928getStartimpl(op.getPostSelection()), TextRange.m6923getEndimpl(op.getPostSelection()));
        TextFieldCharSequence afterEditValue$iv = TextFieldBuffer.m1325toTextFieldCharSequencewFTz33Y$foundation$default($this$redo.getMainBuffer(), 0L, null, null, null, 15, null);
