...
public final class AndroidLegacyPlatformTextInputServiceAdapter extends LegacyPlatformTextInputServiceAdapter {
    ...
    public static final void startInput$localToScreen(LegacyPlatformTextInputServiceAdapter.LegacyPlatformTextInputNode node, float[] matrix) {
        ...
        if (coordinates != null) {
            ...
            coordinates.mo6157transformToScreen58bKbWc(matrix);
        }
    }
    ...
    @DebugMetadata(c = "androidx.compose.foundation.text.input.internal.AndroidLegacyPlatformTextInputServiceAdapter$startInput$2", f = "LegacyPlatformTextInputServiceAdapter.android.kt", i = {}, l = {ComposerImplKt.nodeKey}, m = "invokeSuspend", n = {}, s = {}, v = 1)
                ...
                try {
                    switch (this.label) {
                        case 0:
                            ...
                            if (StylusHandwriting_androidKt.isStylusHandwritingSupported()) {
                                BuildersKt__Builders_commonKt.launch$default($this$coroutineScope, null, null, new C00321(this.this$0, inputMethodManager, null), 3, null);
                            }
