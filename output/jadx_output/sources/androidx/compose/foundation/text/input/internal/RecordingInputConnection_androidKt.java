...
public final class RecordingInputConnection_androidKt {
    ...
    public static final ExtractedText toExtractedText(TextFieldValue textFieldValue) {
        ...
        extractedText.selectionStart = TextRange.m6926getMinimpl(textFieldValue.getSelection());
        extractedText.selectionEnd = TextRange.m6925getMaximpl(textFieldValue.getSelection());
