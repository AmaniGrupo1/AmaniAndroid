...
public final class StatelessInputConnection_androidKt {
    ...
    public static final ExtractedText toExtractedText(TextFieldCharSequence textFieldCharSequence) {
        ...
        extractedText.selectionStart = TextRange.m6926getMinimpl(textFieldCharSequence.getSelection());
        extractedText.selectionEnd = TextRange.m6925getMaximpl(textFieldCharSequence.getSelection());
    ...
    public static final TransferableContent toTransferableContent(InputContentInfoCompat $this$toTransferableContent, Bundle extras) {
        ...
        return new TransferableContent(AndroidClipboardManager_androidKt.toClipEntry(clipData), AndroidClipboardManager_androidKt.toClipMetadata($this$toTransferableContent.getDescription()), TransferableContent.Source.INSTANCE.m365getKeyboardkB6V9T0(), new PlatformTransferableContent($this$toTransferableContent.getLinkUri(), extras == null ? Bundle.EMPTY : extras), null);
    }
