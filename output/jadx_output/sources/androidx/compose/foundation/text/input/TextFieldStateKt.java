...
public final class TextFieldStateKt {
    ...
    public static final TextFieldState m1341rememberTextFieldStateLepunE(final String initialText, final long j, Composer $composer, int $changed, int i) {
        ...
        if ((i & 2) != 0) {
            j = TextRangeKt.TextRange(initialText.length());
        }
        ...
        boolean invalid$iv = (((($changed & 112) ^ 48) > 32 && $composer.changed(j)) || ($changed & 48) == 32) | (((($changed & 14) ^ 6) > 4 && $composer.changed(initialText)) || ($changed & 6) == 4);
        ...
        if (invalid$iv || it$iv == Composer.INSTANCE.getEmpty()) {
            Object value$iv = new Function0() { // from class: androidx.compose.foundation.text.input.TextFieldStateKt$$ExternalSyntheticLambda0
                ...
                public final Object invoke() {
                    return TextFieldStateKt.rememberTextFieldState_Le_punE$lambda$0$0(initialText, j);
                }
            };
        ...
        TextFieldState textFieldState = (TextFieldState) RememberSaveableKt.m4138rememberSaveable(objArr, (Saver) saver, (Function0) it$iv, $composer, 48);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static final TextFieldState rememberTextFieldState_Le_punE$lambda$0$0(String $initialText, long j) {
        return new TextFieldState($initialText, j, (DefaultConstructorMarker) null);
    }
    ...
    public static final List<AnnotatedString.Range<AnnotatedString.Annotation>> m1340finalizeComposingAnnotationsitr0ztk(TextRange composition, MutableVector<AnnotatedString.Range<AnnotatedString.Annotation>> mutableVector) {
        if (mutableVector != null) {
            if (mutableVector.getSize() != 0) {
                return CollectionsKt.toList(mutableVector.asMutableList());
            }
        }
        if (composition != null && !TextRange.m6922getCollapsedimpl(composition.getPackedValue())) {
            return CollectionsKt.listOf(new AnnotatedString.Range(new SpanStyle(0L, 0L, (FontWeight) null, (FontStyle) null, (FontSynthesis) null, (FontFamily) null, (String) null, 0L, (BaselineShift) null, (TextGeometricTransform) null, (LocaleList) null, 0L, TextDecoration.INSTANCE.getUnderline(), (Shadow) null, (PlatformSpanStyle) null, (DrawStyle) null, 61439, (DefaultConstructorMarker) null), TextRange.m6926getMinimpl(composition.getPackedValue()), TextRange.m6925getMaximpl(composition.getPackedValue())));
        }
