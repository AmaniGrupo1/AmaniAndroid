...
public final class TextFieldTextLayoutModifierNode extends DelegatingNode implements LayoutModifierNode, GlobalPositionAwareModifierNode, CompositionLocalConsumerModifierNode {
    ...
    public MeasureResult mo69measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long j) {
        ...
        TextLayoutResult result = this.textLayoutState.m1451layoutWithNewMeasureInputshBUhpc($this$measure_u2d3p2s80s, $this$measure_u2d3p2s80s.getLayoutDirection(), (FontFamily.Resolver) CompositionLocalConsumerModifierNodeKt.currentValueOf(this, CompositionLocalsKt.getLocalFontFamilyResolver()), j);
        Constraints.Companion companion = Constraints.INSTANCE;
        int size = (int) (result.getSize() >> 32);
        int size2 = (int) (result.getSize() >> 32);
        int $i$f$unpackInt2 = (int) (result.getSize() & 4294967295L);
        final Placeable placeable = measurable.mo6141measureBRTryo0(companion.m7467fitPrioritizingWidthZbe2FdA(size, size2, $i$f$unpackInt2, (int) (result.getSize() & 4294967295L)));
        TextLayoutState textLayoutState = this.textLayoutState;
        if (this.singleLine) {
            fM7505constructorimpl = $this$measure_u2d3p2s80s.mo402toDpu2uoSUM(TextDelegateKt.ceilToIntPx(result.getLineBottom(0)));
        } else {
            fM7505constructorimpl = Dp.m7505constructorimpl(0);
        }
        textLayoutState.m1452setMinHeightForSingleLineField0680j_4(fM7505constructorimpl);
        ...
        int size3 = (int) (result.getSize() >> 32);
        int size4 = (int) (result.getSize() & 4294967295L);
        Map<AlignmentLine, Integer> map = this.baselineCache;
        Intrinsics.checkNotNull(map);
        return $this$measure_u2d3p2s80s.layout(size3, size4, map, new Function1() { // from class: androidx.compose.foundation.text.input.internal.TextFieldTextLayoutModifierNode$$ExternalSyntheticLambda0
