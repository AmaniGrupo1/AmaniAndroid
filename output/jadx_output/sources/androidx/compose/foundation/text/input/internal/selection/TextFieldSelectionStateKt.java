...
public final class TextFieldSelectionStateKt {
    ...
    static final Unit defaultDetectTextFieldTapGestures$lambda$0(Function0 $requestFocus, TextFieldSelectionState $this_defaultDetectTextFieldTapGestures, Function0 $showKeyboard, Offset offset) {
        ...
        if ($this_defaultDetectTextFieldTapGestures.getEnabled() && $this_defaultDetectTextFieldTapGestures.getIsFocused()) {
            ...
            long coercedOffset = $this_defaultDetectTextFieldTapGestures.getTextLayoutState().m1447coercedInVisibleBoundsOfInputTextMKHz9U$foundation(offset.m4462unboximpl());
            $this_defaultDetectTextFieldTapGestures.m1509placeCursorAtNearestOffsetk4lQ0M(TextLayoutStateKt.m1454fromDecorationToTextLayoutUv8p0NA($this_defaultDetectTextFieldTapGestures.getTextLayoutState(), coercedOffset));
        }
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function3<PressGestureScope, Offset, Continuation<? super Unit>, Object> {
        ...
        public /* bridge */ /* synthetic */ Object invoke(PressGestureScope pressGestureScope, Offset offset, Continuation<? super Unit> continuation) {
            return m1519invoked4ec7I(pressGestureScope, offset.m4462unboximpl(), continuation);
        }
    ...
    public static final long m1518reverse5zctL8(long j) {
        return TextRangeKt.TextRange(TextRange.m6923getEndimpl(j), TextRange.m6928getStartimpl(j));
    }
    ...
    static final Unit contextMenuBuilder$lambda$0(State $itemsAvailability, ContextMenuState $state, Function2 $onMenuItemClicked, TextFieldSelectionState $this_contextMenuBuilder, ContextMenuScope contextMenuScope) {
        ...
        contextMenuBuilder$lambda$0$textFieldItem(contextMenuScope, $state, $onMenuItemClicked, $this_contextMenuBuilder, TextContextMenuItems.Cut, MenuItemsAvailability.m1234getCanCutimpl(availability));
        contextMenuBuilder$lambda$0$textFieldItem(contextMenuScope, $state, $onMenuItemClicked, $this_contextMenuBuilder, TextContextMenuItems.Copy, MenuItemsAvailability.m1233getCanCopyimpl(availability));
        contextMenuBuilder$lambda$0$textFieldItem(contextMenuScope, $state, $onMenuItemClicked, $this_contextMenuBuilder, TextContextMenuItems.Paste, MenuItemsAvailability.m1235getCanPasteimpl(availability));
        contextMenuBuilder$lambda$0$textFieldItem(contextMenuScope, $state, $onMenuItemClicked, $this_contextMenuBuilder, TextContextMenuItems.SelectAll, MenuItemsAvailability.m1236getCanSelectAllimpl(availability));
        if (PlatformUtils_androidKt.isAutofillAvailable()) {
            contextMenuBuilder$lambda$0$textFieldItem(contextMenuScope, $state, $onMenuItemClicked, $this_contextMenuBuilder, TextContextMenuItems.Autofill, MenuItemsAvailability.m1232getCanAutofillimpl(availability));
        }
        return Unit.INSTANCE;
    }
}
