...
public final class AndroidTextInputSession_androidKt$platformSpecificTextInputSession$3$3$textInputSession$1 implements TextInputSession, ImeEditCommandScope {
    ...
    public long mo1365mapFromTransformedGEjPoXI(long range) {
        return this.$$delegate_0.mo1365mapFromTransformedGEjPoXI(range);
    }
    ...
    public long mo1366mapToTransformedGEjPoXI(long range) {
        return this.$$delegate_0.mo1366mapToTransformedGEjPoXI(range);
    }
    ...
    public void mo1367onImeActionKlQnJC8(int imeAction) {
        Function1<ImeAction, Unit> function1 = this.$onImeAction;
        if (function1 != null) {
            function1.invoke(ImeAction.m7093boximpl(imeAction));
        }
    }
