...
public final class TextUndoManagerKt {
    ...
    public static final void recordChanges(TextUndoManager $this$recordChanges, TextFieldCharSequence pre, TextFieldCharSequence post, TextFieldBuffer.ChangeList changes, boolean allowMerge) {
        ...
        if (changes.getChangeCount() == 1) {
            long preRange = changes.mo1332getOriginalRangejx7JFs(0);
            long postRange = changes.mo1333getRangejx7JFs(0);
            if (!TextRange.m6922getCollapsedimpl(preRange) || !TextRange.m6922getCollapsedimpl(postRange)) {
                $this$recordChanges.record(new TextUndoOperation(TextRange.m6926getMinimpl(preRange), TextRangeKt.m6935substringFDrldGo(pre, preRange), TextRangeKt.m6935substringFDrldGo(post, postRange), pre.getSelection(), post.getSelection(), 0L, allowMerge, 32, null));
            }
        }
    }
