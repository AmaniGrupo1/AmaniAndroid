...
public final class TextFieldLayoutStateCache implements State<TextLayoutResult>, StateObject {
    ...
    public final void updateNonMeasureInputs(TransformedTextFieldState textFieldState, TextStyle textStyle, boolean singleLine, boolean softWrap, KeyboardOptions keyboardOptions) {
        setNonMeasureInputs(new NonMeasureInputs(textFieldState, textStyle, singleLine, softWrap, KeyboardType.m7149equalsimpl0(keyboardOptions.getKeyboardType(), KeyboardType.INSTANCE.m7169getPhonePjHm6EE())));
    }

    /* JADX INFO: renamed from: layoutWithNewMeasureInputs--hBUhpc, reason: not valid java name */
    public final TextLayoutResult m1440layoutWithNewMeasureInputshBUhpc(Density density, LayoutDirection layoutDirection, FontFamily.Resolver fontFamilyResolver, long constraints) {
    ...
    private final TextLayoutResult getOrComputeLayout(NonMeasureInputs nonMeasureInputs, MeasureInputs measureInputs) throws Throwable {
        CacheRecord $this$getOrComputeLayout_u24lambda_u240_u240_u240;
        ...
        if (cachedResult != null) {
            ...
            if ((visualText2 != null && StringsKt.contentEquals(visualText2, visualText)) && Intrinsics.areEqual(cachedRecord.getAnnotations(), listMergeNullableLists) && Intrinsics.areEqual(cachedRecord.getComposition(), visualText.getComposition()) && cachedRecord.getSingleLine() == nonMeasureInputs.getSingleLine() && cachedRecord.getSoftWrap() == nonMeasureInputs.getSoftWrap() && cachedRecord.getLayoutDirection() == measureInputs.getLayoutDirection()) {
                if (cachedRecord.getDensityValue() == measureInputs.getDensity().getDensity()) {
                    if ((cachedRecord.getFontScale() == measureInputs.getDensity().getFontScale()) && Constraints.m7451equalsimpl0(cachedRecord.getConstraints(), measureInputs.getConstraints()) && Intrinsics.areEqual(cachedRecord.getFontFamilyResolver(), measureInputs.getFontFamilyResolver()) && !cachedResult.getMultiParagraph().getIntrinsics().getHasStaleResolvedFonts()) {
        ...
        synchronized (lock$iv$iv$iv$iv) {
            try {
                $this$getOrComputeLayout_u24lambda_u240_u240_u240 = (CacheRecord) SnapshotKt.writableRecord($this$writable$iv$iv, state$iv$iv, snapshot$iv);
                try {
                    ...
                    $this$getOrComputeLayout_u24lambda_u240_u240_u240.m1443setCompositionOEnZFl4(visualText.getComposition());
            ...
            try {
                $this$getOrComputeLayout_u24lambda_u240_u240_u240.m1444setConstraintsBRTryo0(measureInputs.getConstraints());
    ...
    static final class MeasureInputs {
        ...
        private static final SnapshotMutationPolicy<MeasureInputs> mutationPolicy = new SnapshotMutationPolicy<MeasureInputs>() { // from class: androidx.compose.foundation.text.input.internal.TextFieldLayoutStateCache$MeasureInputs$Companion$mutationPolicy$1
            ...
            public boolean equivalent(TextFieldLayoutStateCache.MeasureInputs a, TextFieldLayoutStateCache.MeasureInputs b) {
                ...
                if (a.getDensityValue() == b.getDensityValue()) {
                    if ((a.getFontScale() == b.getFontScale()) && a.getLayoutDirection() == b.getLayoutDirection() && Intrinsics.areEqual(a.getFontFamilyResolver(), b.getFontFamilyResolver()) && Constraints.m7451equalsimpl0(a.getConstraints(), b.getConstraints())) {
                        return true;
                    }
                }
                return false;
        ...
        public String toString() {
            return "MeasureInputs(density=" + this.density + ", densityValue=" + this.densityValue + ", fontScale=" + this.fontScale + ", layoutDirection=" + this.layoutDirection + ", fontFamilyResolver=" + this.fontFamilyResolver + ", constraints=" + ((Object) Constraints.m7463toStringimpl(this.constraints)) + ')';
        }
