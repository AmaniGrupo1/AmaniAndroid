...
public final class MathUtilsKt {
    ...
    public static final int m1406findClosestRect9KIMszo(long j, Rect rect1, Rect rect2) {
        float comparativeDistTo1 = m1405distanceSquaredToClosestCornerFromOutside3MmeM6k(j, rect1);
        float comparativeDistTo2 = m1405distanceSquaredToClosestCornerFromOutside3MmeM6k(j, rect2);
    ...
    private static final float m1405distanceSquaredToClosestCornerFromOutside3MmeM6k(long j, Rect rect) {
        ...
        float it = Offset.m4451getDistanceSquaredimpl(Offset.m4456minusMKHz9U(rect.m4487getTopLeftF1C5BW0(), j));
        float distance = it < Float.MAX_VALUE ? it : Float.MAX_VALUE;
        float it2 = Offset.m4451getDistanceSquaredimpl(Offset.m4456minusMKHz9U(rect.m4488getTopRightF1C5BW0(), j));
        if (it2 < distance) {
            distance = it2;
        }
        float it3 = Offset.m4451getDistanceSquaredimpl(Offset.m4456minusMKHz9U(rect.m4480getBottomLeftF1C5BW0(), j));
        if (it3 < distance) {
            distance = it3;
        }
        float it4 = Offset.m4451getDistanceSquaredimpl(Offset.m4456minusMKHz9U(rect.m4481getBottomRightF1C5BW0(), j));
