...
public final class TextFieldCharSequenceKt {
    public static final CharSequence getTextBeforeSelection(TextFieldCharSequence $this$getTextBeforeSelection, int maxChars) {
        int $this$subtractExactOrElse$iv = TextRange.m6926getMinimpl($this$getTextBeforeSelection.getSelection());
        ...
        return $this$getTextBeforeSelection.subSequence(Math.max(0, result$iv), TextRange.m6926getMinimpl($this$getTextBeforeSelection.getSelection()));
    }

    public static final CharSequence getTextAfterSelection(TextFieldCharSequence $this$getTextAfterSelection, int maxChars) {
        int iM6925getMaximpl = TextRange.m6925getMaximpl($this$getTextAfterSelection.getSelection());
        int $this$addExactOrElse$iv = TextRange.m6925getMaximpl($this$getTextAfterSelection.getSelection());
        ...
        return $this$getTextAfterSelection.subSequence(iM6925getMaximpl, Math.min(result$iv, $this$getTextAfterSelection.length()));
    }

    public static final CharSequence getSelectedText(TextFieldCharSequence $this$getSelectedText) {
        return $this$getSelectedText.subSequence(TextRange.m6926getMinimpl($this$getSelectedText.getSelection()), TextRange.m6925getMaximpl($this$getSelectedText.getSelection()));
    }
}
