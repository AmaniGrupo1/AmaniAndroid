...
public final class HandwritingGestureApi34 {
    ...
    private final int performSelectGesture(TransformedTextFieldState $this$performSelectGesture, SelectGesture gesture, TextLayoutState layoutState, Function0<Unit> function0) {
        long rangeInTransformedText = HandwritingGesture_androidKt.m1401getRangeForScreenRectOH9lIzo(layoutState, RectHelper_androidKt.toComposeRect(gesture.getSelectionArea()), m1383toTextGranularityNUwxegE(gesture.getGranularity()), TextInclusionStrategy.INSTANCE.getContainsCenter());
        if (TextRange.m6922getCollapsedimpl(rangeInTransformedText)) {
            return INSTANCE.fallback($this$performSelectGesture, gesture);
        }
        $this$performSelectGesture.m1466selectCharsIn5zctL8(rangeInTransformedText);
        if (function0 != null) {
            function0.invoke();
            return 1;
        }
    ...
    private final void previewSelectGesture(TransformedTextFieldState $this$previewSelectGesture, SelectGesture gesture, TextLayoutState layoutState) {
        m1379highlightRangeXJREzCE($this$previewSelectGesture, HandwritingGesture_androidKt.m1401getRangeForScreenRectOH9lIzo(layoutState, RectHelper_androidKt.toComposeRect(gesture.getSelectionArea()), m1383toTextGranularityNUwxegE(gesture.getGranularity()), TextInclusionStrategy.INSTANCE.getContainsCenter()), TextHighlightType.INSTANCE.m1350getHandwritingSelectPreviewsxJuwY());
    }
    ...
    private final int performDeleteGesture(TransformedTextFieldState $this$performDeleteGesture, DeleteGesture gesture, TextLayoutState layoutState) {
        int granularity = m1383toTextGranularityNUwxegE(gesture.getGranularity());
        long rangeInTransformedText = HandwritingGesture_androidKt.m1401getRangeForScreenRectOH9lIzo(layoutState, RectHelper_androidKt.toComposeRect(gesture.getDeletionArea()), granularity, TextInclusionStrategy.INSTANCE.getContainsCenter());
        if (TextRange.m6922getCollapsedimpl(rangeInTransformedText)) {
            return INSTANCE.fallback($this$performDeleteGesture, gesture);
        }
        m1380performDeletionSbBc2M($this$performDeleteGesture, rangeInTransformedText, TextGranularity.m6886equalsimpl0(granularity, TextGranularity.INSTANCE.m6891getWordDRrd7Zo()));
        return 1;
    }
    ...
    private final void previewDeleteGesture(TransformedTextFieldState $this$previewDeleteGesture, DeleteGesture gesture, TextLayoutState layoutState) {
        m1379highlightRangeXJREzCE($this$previewDeleteGesture, HandwritingGesture_androidKt.m1401getRangeForScreenRectOH9lIzo(layoutState, RectHelper_androidKt.toComposeRect(gesture.getDeletionArea()), m1383toTextGranularityNUwxegE(gesture.getGranularity()), TextInclusionStrategy.INSTANCE.getContainsCenter()), TextHighlightType.INSTANCE.m1349getHandwritingDeletePreviewsxJuwY());
    }
    ...
    private final int performSelectRangeGesture(TransformedTextFieldState $this$performSelectRangeGesture, SelectRangeGesture gesture, TextLayoutState layoutState, Function0<Unit> function0) {
        long rangeInTransformedText = HandwritingGesture_androidKt.m1403getRangeForScreenRectsO048IG0(layoutState, RectHelper_androidKt.toComposeRect(gesture.getSelectionStartArea()), RectHelper_androidKt.toComposeRect(gesture.getSelectionEndArea()), m1383toTextGranularityNUwxegE(gesture.getGranularity()), TextInclusionStrategy.INSTANCE.getContainsCenter());
        if (TextRange.m6922getCollapsedimpl(rangeInTransformedText)) {
            return INSTANCE.fallback($this$performSelectRangeGesture, gesture);
        }
        $this$performSelectRangeGesture.m1466selectCharsIn5zctL8(rangeInTransformedText);
        if (function0 != null) {
            function0.invoke();
            return 1;
        }
    ...
    private final void previewSelectRangeGesture(TransformedTextFieldState $this$previewSelectRangeGesture, SelectRangeGesture gesture, TextLayoutState layoutState) {
        m1379highlightRangeXJREzCE($this$previewSelectRangeGesture, HandwritingGesture_androidKt.m1403getRangeForScreenRectsO048IG0(layoutState, RectHelper_androidKt.toComposeRect(gesture.getSelectionStartArea()), RectHelper_androidKt.toComposeRect(gesture.getSelectionEndArea()), m1383toTextGranularityNUwxegE(gesture.getGranularity()), TextInclusionStrategy.INSTANCE.getContainsCenter()), TextHighlightType.INSTANCE.m1350getHandwritingSelectPreviewsxJuwY());
    }
    ...
    private final int performDeleteRangeGesture(TransformedTextFieldState $this$performDeleteRangeGesture, DeleteRangeGesture gesture, TextLayoutState layoutState) {
        int granularity = m1383toTextGranularityNUwxegE(gesture.getGranularity());
        long rangeInTransformedText = HandwritingGesture_androidKt.m1403getRangeForScreenRectsO048IG0(layoutState, RectHelper_androidKt.toComposeRect(gesture.getDeletionStartArea()), RectHelper_androidKt.toComposeRect(gesture.getDeletionEndArea()), granularity, TextInclusionStrategy.INSTANCE.getContainsCenter());
        if (TextRange.m6922getCollapsedimpl(rangeInTransformedText)) {
            return INSTANCE.fallback($this$performDeleteRangeGesture, gesture);
        }
        m1380performDeletionSbBc2M($this$performDeleteRangeGesture, rangeInTransformedText, TextGranularity.m6886equalsimpl0(granularity, TextGranularity.INSTANCE.m6891getWordDRrd7Zo()));
        return 1;
    }
    ...
    private final void previewDeleteRangeGesture(TransformedTextFieldState $this$previewDeleteRangeGesture, DeleteRangeGesture gesture, TextLayoutState layoutState) {
        m1379highlightRangeXJREzCE($this$previewDeleteRangeGesture, HandwritingGesture_androidKt.m1403getRangeForScreenRectsO048IG0(layoutState, RectHelper_androidKt.toComposeRect(gesture.getDeletionStartArea()), RectHelper_androidKt.toComposeRect(gesture.getDeletionEndArea()), m1383toTextGranularityNUwxegE(gesture.getGranularity()), TextInclusionStrategy.INSTANCE.getContainsCenter()), TextHighlightType.INSTANCE.m1349getHandwritingDeletePreviewsxJuwY());
    }
    ...
    private final int performJoinOrSplitGesture(TransformedTextFieldState $this$performJoinOrSplitGesture, JoinOrSplitGesture gesture, TextLayoutState layoutState, ViewConfiguration viewConfiguration) {
        if ($this$performJoinOrSplitGesture.getOutputText() == $this$performJoinOrSplitGesture.getUntransformedText()) {
            int offset = HandwritingGesture_androidKt.m1396getOffsetForHandwritingGestured4ec7I(layoutState, HandwritingGesture_androidKt.toOffset(gesture.getJoinOrSplitPoint()), viewConfiguration);
            if (offset != -1) {
                ...
                if (!(layoutResult != null && HandwritingGesture_androidKt.isBiDiBoundary(layoutResult, offset))) {
                    ...
                    if (TextRange.m6922getCollapsedimpl(textRange)) {
                        TransformedTextFieldState.m1459replaceTextM8tDOmk$default($this$performJoinOrSplitGesture, " ", textRange, null, false, 12, null);
                    } else {
                        m1380performDeletionSbBc2M($this$performJoinOrSplitGesture, textRange, false);
                    }
                    return 1;
                }
            }
    ...
    private final int performInsertGesture(TransformedTextFieldState $this$performInsertGesture, InsertGesture gesture, TextLayoutState layoutState, ViewConfiguration viewConfiguration) {
        int offset = HandwritingGesture_androidKt.m1396getOffsetForHandwritingGestured4ec7I(layoutState, HandwritingGesture_androidKt.toOffset(gesture.getInsertionPoint()), viewConfiguration);
        if (offset == -1) {
            return fallback($this$performInsertGesture, gesture);
        }
        TransformedTextFieldState.m1459replaceTextM8tDOmk$default($this$performInsertGesture, gesture.getTextToInsert(), TextRangeKt.TextRange(offset), null, false, 12, null);
        return 1;
    }
    ...
    private final int performRemoveSpaceGesture(TransformedTextFieldState $this$performRemoveSpaceGesture, RemoveSpaceGesture gesture, TextLayoutState layoutState, ViewConfiguration viewConfiguration) {
        long $this$performRemoveSpaceGesture_u24lambda_u240 = HandwritingGesture_androidKt.m1398getRangeForRemoveSpaceGesture5iVPX68(layoutState.getLayoutResult(), HandwritingGesture_androidKt.toOffset(gesture.getStartPoint()), HandwritingGesture_androidKt.toOffset(gesture.getEndPoint()), layoutState.getTextLayoutNodeCoordinates(), viewConfiguration);
        if (TextRange.m6922getCollapsedimpl($this$performRemoveSpaceGesture_u24lambda_u240)) {
        ...
        String newText = new Regex("\\s+").replace(TextRangeKt.m6935substringFDrldGo($this$performRemoveSpaceGesture.getVisualText(), $this$performRemoveSpaceGesture_u24lambda_u240), new Function1() { // from class: androidx.compose.foundation.text.input.internal.HandwritingGestureApi34$$ExternalSyntheticLambda0
        ...
        if (firstMatchStart.element != -1 && lastMatchEnd.element != -1) {
            long finalRange = TextRangeKt.TextRange(TextRange.m6928getStartimpl($this$performRemoveSpaceGesture_u24lambda_u240) + firstMatchStart.element, TextRange.m6928getStartimpl($this$performRemoveSpaceGesture_u24lambda_u240) + lastMatchEnd.element);
            String finalNewText = newText.substring(firstMatchStart.element, newText.length() - (TextRange.m6924getLengthimpl($this$performRemoveSpaceGesture_u24lambda_u240) - lastMatchEnd.element));
            Intrinsics.checkNotNullExpressionValue(finalNewText, "substring(...)");
            TransformedTextFieldState.m1459replaceTextM8tDOmk$default($this$performRemoveSpaceGesture, finalNewText, finalRange, null, false, 12, null);
            return 1;
        }
    ...
    private final void m1380performDeletionSbBc2M(TransformedTextFieldState $this$performDeletion_u2dSb_u2dBc2M, long j, boolean adjustRange) {
        long jM1392adjustHandwritingDeleteGestureRange72CqOWE;
        if (adjustRange) {
            jM1392adjustHandwritingDeleteGestureRange72CqOWE = HandwritingGesture_androidKt.m1392adjustHandwritingDeleteGestureRange72CqOWE(j, $this$performDeletion_u2dSb_u2dBc2M.getVisualText());
        } else {
            jM1392adjustHandwritingDeleteGestureRange72CqOWE = j;
        }
        long finalRange = jM1392adjustHandwritingDeleteGestureRange72CqOWE;
        TransformedTextFieldState.m1459replaceTextM8tDOmk$default($this$performDeletion_u2dSb_u2dBc2M, "", finalRange, null, false, 12, null);
    }
    ...
    private final void m1379highlightRangeXJREzCE(TransformedTextFieldState $this$highlightRange_u2dXJREzCE, long j, int i) {
        if (TextRange.m6922getCollapsedimpl(j)) {
        ...
        $this$highlightRange_u2dXJREzCE.m1460highlightCharsIn7RAjNK8(i, j);
    }
    ...
    private final int performSelectGesture(LegacyTextFieldState $this$performSelectGesture, SelectGesture gesture, TextFieldSelectionManager textSelectionManager, Function1<? super EditCommand, Unit> function1) {
        long range = HandwritingGesture_androidKt.m1400getRangeForScreenRectOH9lIzo($this$performSelectGesture, RectHelper_androidKt.toComposeRect(gesture.getSelectionArea()), m1383toTextGranularityNUwxegE(gesture.getGranularity()), TextInclusionStrategy.INSTANCE.getContainsCenter());
        if (TextRange.m6922getCollapsedimpl(range)) {
            return INSTANCE.fallbackOnLegacyTextField(gesture, function1);
        }
        m1382performSelectionOnLegacyTextField8ffj60Q(range, textSelectionManager, function1);
        return 1;
    }
    ...
    private final void previewSelectGesture(LegacyTextFieldState $this$previewSelectGesture, SelectGesture gesture, TextFieldSelectionManager textFieldSelectionManager) {
        if (textFieldSelectionManager != null) {
            textFieldSelectionManager.m1667setSelectionPreviewHighlight5zctL8$foundation(HandwritingGesture_androidKt.m1400getRangeForScreenRectOH9lIzo($this$previewSelectGesture, RectHelper_androidKt.toComposeRect(gesture.getSelectionArea()), m1383toTextGranularityNUwxegE(gesture.getGranularity()), TextInclusionStrategy.INSTANCE.getContainsCenter()));
        }
    }
    ...
    private final int performDeleteGesture(LegacyTextFieldState $this$performDeleteGesture, DeleteGesture gesture, AnnotatedString text, Function1<? super EditCommand, Unit> function1) {
        int granularity = m1383toTextGranularityNUwxegE(gesture.getGranularity());
        long range = HandwritingGesture_androidKt.m1400getRangeForScreenRectOH9lIzo($this$performDeleteGesture, RectHelper_androidKt.toComposeRect(gesture.getDeletionArea()), granularity, TextInclusionStrategy.INSTANCE.getContainsCenter());
        if (TextRange.m6922getCollapsedimpl(range)) {
            return INSTANCE.fallbackOnLegacyTextField(gesture, function1);
        }
        m1381performDeletionOnLegacyTextFieldvJH6DeI(range, text, TextGranularity.m6886equalsimpl0(granularity, TextGranularity.INSTANCE.m6891getWordDRrd7Zo()), function1);
        return 1;
    }
    ...
    private final void previewDeleteGesture(LegacyTextFieldState $this$previewDeleteGesture, DeleteGesture gesture, TextFieldSelectionManager textFieldSelectionManager) {
        if (textFieldSelectionManager != null) {
            textFieldSelectionManager.m1665setDeletionPreviewHighlight5zctL8$foundation(HandwritingGesture_androidKt.m1400getRangeForScreenRectOH9lIzo($this$previewDeleteGesture, RectHelper_androidKt.toComposeRect(gesture.getDeletionArea()), m1383toTextGranularityNUwxegE(gesture.getGranularity()), TextInclusionStrategy.INSTANCE.getContainsCenter()));
        }
    }
    ...
    private final int performSelectRangeGesture(LegacyTextFieldState $this$performSelectRangeGesture, SelectRangeGesture gesture, TextFieldSelectionManager textSelectionManager, Function1<? super EditCommand, Unit> function1) {
        long range = HandwritingGesture_androidKt.m1402getRangeForScreenRectsO048IG0($this$performSelectRangeGesture, RectHelper_androidKt.toComposeRect(gesture.getSelectionStartArea()), RectHelper_androidKt.toComposeRect(gesture.getSelectionEndArea()), m1383toTextGranularityNUwxegE(gesture.getGranularity()), TextInclusionStrategy.INSTANCE.getContainsCenter());
        if (TextRange.m6922getCollapsedimpl(range)) {
            return INSTANCE.fallbackOnLegacyTextField(gesture, function1);
        }
        m1382performSelectionOnLegacyTextField8ffj60Q(range, textSelectionManager, function1);
    ...
    private final void previewSelectRangeGesture(LegacyTextFieldState $this$previewSelectRangeGesture, SelectRangeGesture gesture, TextFieldSelectionManager textFieldSelectionManager) {
        if (textFieldSelectionManager != null) {
            textFieldSelectionManager.m1667setSelectionPreviewHighlight5zctL8$foundation(HandwritingGesture_androidKt.m1402getRangeForScreenRectsO048IG0($this$previewSelectRangeGesture, RectHelper_androidKt.toComposeRect(gesture.getSelectionStartArea()), RectHelper_androidKt.toComposeRect(gesture.getSelectionEndArea()), m1383toTextGranularityNUwxegE(gesture.getGranularity()), TextInclusionStrategy.INSTANCE.getContainsCenter()));
        }
    }
    ...
    private final int performDeleteRangeGesture(LegacyTextFieldState $this$performDeleteRangeGesture, DeleteRangeGesture gesture, AnnotatedString text, Function1<? super EditCommand, Unit> function1) {
        int granularity = m1383toTextGranularityNUwxegE(gesture.getGranularity());
        long range = HandwritingGesture_androidKt.m1402getRangeForScreenRectsO048IG0($this$performDeleteRangeGesture, RectHelper_androidKt.toComposeRect(gesture.getDeletionStartArea()), RectHelper_androidKt.toComposeRect(gesture.getDeletionEndArea()), granularity, TextInclusionStrategy.INSTANCE.getContainsCenter());
        if (TextRange.m6922getCollapsedimpl(range)) {
            return INSTANCE.fallbackOnLegacyTextField(gesture, function1);
        }
        m1381performDeletionOnLegacyTextFieldvJH6DeI(range, text, TextGranularity.m6886equalsimpl0(granularity, TextGranularity.INSTANCE.m6891getWordDRrd7Zo()), function1);
    ...
    private final void previewDeleteRangeGesture(LegacyTextFieldState $this$previewDeleteRangeGesture, DeleteRangeGesture gesture, TextFieldSelectionManager textFieldSelectionManager) {
        if (textFieldSelectionManager != null) {
            textFieldSelectionManager.m1665setDeletionPreviewHighlight5zctL8$foundation(HandwritingGesture_androidKt.m1402getRangeForScreenRectsO048IG0($this$previewDeleteRangeGesture, RectHelper_androidKt.toComposeRect(gesture.getDeletionStartArea()), RectHelper_androidKt.toComposeRect(gesture.getDeletionEndArea()), m1383toTextGranularityNUwxegE(gesture.getGranularity()), TextInclusionStrategy.INSTANCE.getContainsCenter()));
        }
    }
    ...
    private final int performJoinOrSplitGesture(LegacyTextFieldState $this$performJoinOrSplitGesture, JoinOrSplitGesture gesture, AnnotatedString text, ViewConfiguration viewConfiguration, Function1<? super EditCommand, Unit> function1) {
        ...
        if (viewConfiguration != null) {
            int offset = HandwritingGesture_androidKt.m1395getOffsetForHandwritingGestured4ec7I($this$performJoinOrSplitGesture, HandwritingGesture_androidKt.toOffset(gesture.getJoinOrSplitPoint()), viewConfiguration);
            if (offset != -1) {
                ...
                if (!z) {
                    ...
                    if (TextRange.m6922getCollapsedimpl(range)) {
                        performInsertionOnLegacyTextField(TextRange.m6928getStartimpl(range), " ", function1);
                    } else {
                        m1381performDeletionOnLegacyTextFieldvJH6DeI(range, text, false, function1);
                    }
                    return 1;
                }
    ...
    private final int performInsertGesture(LegacyTextFieldState $this$performInsertGesture, InsertGesture gesture, ViewConfiguration viewConfiguration, Function1<? super EditCommand, Unit> function1) {
        TextLayoutResult value;
        if (viewConfiguration != null) {
            int offset = HandwritingGesture_androidKt.m1395getOffsetForHandwritingGestured4ec7I($this$performInsertGesture, HandwritingGesture_androidKt.toOffset(gesture.getInsertionPoint()), viewConfiguration);
            if (offset != -1) {
    ...
    private final int performRemoveSpaceGesture(LegacyTextFieldState $this$performRemoveSpaceGesture, RemoveSpaceGesture gesture, AnnotatedString text, ViewConfiguration viewConfiguration, Function1<? super EditCommand, Unit> function1) {
        ...
        final Ref.IntRef lastMatchEnd = new Ref.IntRef();
        lastMatchEnd.element = -1;
        String newText = new Regex("\\s+").replace(TextRangeKt.m6935substringFDrldGo(text, range), new Function1() { // from class: androidx.compose.foundation.text.input.internal.HandwritingGestureApi34$$ExternalSyntheticLambda2
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
        ...
        int replacedRangeStart = TextRange.m6928getStartimpl(range) + firstMatchStart.element;
        int replacedRangeEnd = TextRange.m6928getStartimpl(range) + lastMatchEnd.element;
        String finalNewText = newText.substring(firstMatchStart.element, newText.length() - (TextRange.m6924getLengthimpl(range) - lastMatchEnd.element));
        Intrinsics.checkNotNullExpressionValue(finalNewText, "substring(...)");
    ...
    private final void m1382performSelectionOnLegacyTextField8ffj60Q(long range, TextFieldSelectionManager textSelectionManager, Function1<? super EditCommand, Unit> editCommandConsumer) {
        editCommandConsumer.invoke(new SetSelectionCommand(TextRange.m6928getStartimpl(range), TextRange.m6923getEndimpl(range)));
    ...
    private final void m1381performDeletionOnLegacyTextFieldvJH6DeI(long range, AnnotatedString text, boolean adjustRange, Function1<? super EditCommand, Unit> editCommandConsumer) {
        long finalRange;
        if (adjustRange) {
            finalRange = HandwritingGesture_androidKt.m1392adjustHandwritingDeleteGestureRange72CqOWE(range, text);
        } else {
            finalRange = range;
        }
        editCommandConsumer.invoke(HandwritingGesture_androidKt.compoundEditCommand(new SetSelectionCommand(TextRange.m6923getEndimpl(finalRange), TextRange.m6923getEndimpl(finalRange)), new DeleteSurroundingTextCommand(TextRange.m6924getLengthimpl(finalRange), 0)));
    }
    ...
    private final int m1383toTextGranularityNUwxegE(int $this$toTextGranularity_u2dNUwxegE) {
        switch ($this$toTextGranularity_u2dNUwxegE) {
            case 1:
                return TextGranularity.INSTANCE.m6891getWordDRrd7Zo();
            case 2:
                return TextGranularity.INSTANCE.m6890getCharacterDRrd7Zo();
            default:
                return TextGranularity.INSTANCE.m6890getCharacterDRrd7Zo();
        }
    }
