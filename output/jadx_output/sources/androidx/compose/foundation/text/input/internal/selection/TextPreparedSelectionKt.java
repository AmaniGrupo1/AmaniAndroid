...
public final class TextPreparedSelectionKt {
    ...
    public static final long calculateNextCursorPositionAndWedgeAffinity(int proposedCursor, int cursor, TransformedTextFieldState transformedTextFieldState) {
        ...
        if (proposedCursor != -1) {
            ...
            long untransformed$iv = transformedTextFieldState.m1461mapFromTransformedjx7JFs(proposedCursor);
            long retransformed$iv = transformedTextFieldState.m1464mapToTransformedGEjPoXI(untransformed$iv);
            ...
            switch (WhenMappings.$EnumSwitchMapping$0[type.ordinal()]) {
                case 1:
                    return CursorAndWedgeAffinity.m1477constructorimpl(proposedCursor, forward ? WedgeAffinity.Start : WedgeAffinity.End);
                case 2:
                    return CursorAndWedgeAffinity.m1476constructorimpl(proposedCursor);
                case 3:
                    if (forward) {
                        return CursorAndWedgeAffinity.m1477constructorimpl(TextRange.m6923getEndimpl(retransformed$iv), WedgeAffinity.Start);
                    }
                    return CursorAndWedgeAffinity.m1477constructorimpl(TextRange.m6928getStartimpl(retransformed$iv), WedgeAffinity.End);
                case 4:
                    if (forward) {
                        if (proposedCursor == TextRange.m6928getStartimpl(retransformed$iv)) {
                            return CursorAndWedgeAffinity.m1477constructorimpl(proposedCursor, WedgeAffinity.Start);
                        }
                        return CursorAndWedgeAffinity.m1477constructorimpl(TextRange.m6923getEndimpl(retransformed$iv), WedgeAffinity.End);
                    }
                    if (proposedCursor == TextRange.m6923getEndimpl(retransformed$iv)) {
                        return CursorAndWedgeAffinity.m1477constructorimpl(proposedCursor, WedgeAffinity.End);
                    }
                    return CursorAndWedgeAffinity.m1477constructorimpl(TextRange.m6928getStartimpl(retransformed$iv), WedgeAffinity.Start);
                default:
                    throw new NoWhenBranchMatchedException();
            }
        }
        return CursorAndWedgeAffinity.m1476constructorimpl(cursor);
    }
}
