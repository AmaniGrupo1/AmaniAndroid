...
public final class CursorAnchorInfoBuilder_androidKt {
    ...
    public static final CursorAnchorInfo m1375buildvxqZcH0(CursorAnchorInfo.Builder $this$build_u2dvxqZcH0, CharSequence text, long j, TextRange composition, TextLayoutResult textLayoutResult, Matrix matrix, Rect innerTextFieldBounds, Rect decorationBoxBounds, boolean includeInsertionMarker, boolean includeCharacterBounds, boolean includeEditorBounds, boolean includeLineBounds) {
        $this$build_u2dvxqZcH0.reset();
        $this$build_u2dvxqZcH0.setMatrix(matrix);
        int selectionStart = TextRange.m6926getMinimpl(j);
        int selectionEnd = TextRange.m6925getMaximpl(j);
        ...
        if (includeCharacterBounds) {
            ...
            int compositionEnd = composition != null ? TextRange.m6925getMaximpl(composition.getPackedValue()) : -1;
            boolean z = false;
    ...
    private static final CursorAnchorInfo.Builder setInsertionMarker(CursorAnchorInfo.Builder $this$setInsertionMarker, int selectionStart, TextLayoutResult textLayoutResult, Rect innerTextFieldBounds) {
        ...
        float x = RangesKt.coerceIn(cursorRect.getLeft(), 0.0f, (int) (textLayoutResult.getSize() >> 32));
    ...
    private static final CursorAnchorInfo.Builder addCharacterBounds(CursorAnchorInfo.Builder $this$addCharacterBounds, int startOffset, int endOffset, TextLayoutResult textLayoutResult, Rect innerTextFieldBounds) {
        ...
        textLayoutResult.getMultiParagraph().m6788fillBoundingBoxes8ffj60Q(TextRangeKt.TextRange(startOffset, endOffset), array, 0);
