...
public final class ChangeTracker implements TextFieldBuffer.ChangeList {
    ...
    public long mo1333getRangejx7JFs(int changeIndex) {
    ...
    public long mo1332getOriginalRangejx7JFs(int changeIndex) {
        Change it = this._changes.content[changeIndex];
    ...
    public String toString() {
        ...
        for (int i$iv = 0; i$iv < size$iv; i$iv++) {
            ...
            int i = i$iv;
            $this$toString_u24lambda_u240.append('(' + change.getOriginalStart() + AbstractJsonLexerKt.COMMA + change.getOriginalEnd() + ")->(" + change.getPreStart() + AbstractJsonLexerKt.COMMA + change.getPreEnd() + ')');
