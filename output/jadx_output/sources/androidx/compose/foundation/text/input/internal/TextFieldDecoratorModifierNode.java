    ...
    public TextFieldDecoratorModifierNode(TransformedTextFieldState textFieldState, TextLayoutState textLayoutState, TextFieldSelectionState textFieldSelectionState, InputTransformation filter, boolean enabled, boolean readOnly, KeyboardOptions keyboardOptions, KeyboardActionHandler keyboardActionHandler, boolean singleLine, MutableInteractionSource interactionSource, boolean isPassword, MutableSharedFlow<Unit> mutableSharedFlow) {
        ...
        this.pointerInputNode = (SuspendingPointerInputModifierNode) delegate(SuspendingPointerInputFilterKt.SuspendingPointerInputModifierNode(new PointerInputEventHandler() { // from class: androidx.compose.foundation.text.input.internal.TextFieldDecoratorModifierNode$pointerInputNode$1
            ...
            static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                ...
                this.clipboardKeyCommandsHandler = ClipboardKeyCommandsHandler.m1369constructorimpl(new Function1() { // from class: androidx.compose.foundation.text.input.internal.TextFieldDecoratorModifierNode$$ExternalSyntheticLambda24
                    @Override // kotlin.jvm.functions.Function1
                    public final Object invoke(Object obj) {
            ...
            static final Unit dragAndDropNode$lambda$4(TextFieldDecoratorModifierNode this$0, Offset position) {
                long positionOnTextField = TextLayoutStateKt.m1456fromWindowToDecorationUv8p0NA(this$0.textLayoutState, position.m4462unboximpl());
                int cursorPosition = TextLayoutState.m1446getOffsetForPosition3MmeM6k$default(this$0.textLayoutState, positionOnTextField, false, 2, null);
                if (cursorPosition >= 0) {
                    this$0.textFieldState.m1466selectCharsIn5zctL8(TextRangeKt.TextRange(cursorPosition));
                }
                this$0.textFieldSelectionState.m1510updateHandleDraggingUv8p0NA(Handle.Cursor, positionOnTextField);
                return Unit.INSTANCE;
            }
            ...
            static final boolean dragAndDropNode$lambda$1(TextFieldDecoratorModifierNode this$0, ClipEntry clipEntry, ClipMetadata clipMetadata) {
                ...
                if (receiveContentConfiguration != null) {
                    TransferableContent transferableContent = new TransferableContent(clipEntry, clipMetadata, TransferableContent.Source.INSTANCE.m364getDragAndDropkB6V9T0(), null, 8, null);
            ...
            public void draw(ContentDrawScope $this$draw) {
                ...
                if (getAutofillHighlightOn()) {
                    DrawScope.m5264drawRectAsUm42w$default($this$draw, AutofillHighlightKt.m1132resolveAutofillHighlightWkMShQ((Brush) CompositionLocalConsumerModifierNodeKt.currentValueOf(this, AutofillHighlightKt.getLocalAutofillHighlightBrush()), ((Color) CompositionLocalConsumerModifierNodeKt.currentValueOf(this, AutofillHighlightKt.getLocalAutofillHighlightColor())).m4707unboximpl(), AutofillHighlight_androidKt.autofillHighlightColor()), 0L, 0L, 0.0f, null, null, 0, WebSocketProtocol.PAYLOAD_SHORT, null);
                }
            }
            ...
            public final void updateNode(TransformedTextFieldState textFieldState, TextLayoutState textLayoutState, TextFieldSelectionState textFieldSelectionState, InputTransformation filter, boolean enabled, boolean readOnly, KeyboardOptions keyboardOptions, KeyboardActionHandler keyboardActionHandler, boolean singleLine, MutableInteractionSource interactionSource, boolean isPassword, MutableSharedFlow<Unit> stylusHandwritingTrigger) {
                ...
                if (enabled != previousEnabled || editable != previousEditable || !ImeAction.m7096equalsimpl0(keyboardOptions.m1216getImeActionOrDefaulteUduSuo$foundation(), previousKeyboardOptions.m1216getImeActionOrDefaulteUduSuo$foundation()) || isPassword != previousIsPassword) {
                ...
                if (!Intrinsics.areEqual(textFieldSelectionState, previousTextFieldSelectionState)) {
                    ...
                    if (getIsAttached()) {
                        ...
                        if (isFocused() && this.toolbarAndHandlesVisibilityObserverJob != null) {
                            ...
                            this.toolbarAndHandlesVisibilityObserverJob = BuildersKt__Builders_commonKt.launch$default(getCoroutineScope(), null, null, new C03221(textFieldSelectionState, null), 3, null);
                        }
                    }
            ...
            static final class C03221 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                ...
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                C03221(TextFieldSelectionState textFieldSelectionState, Continuation<? super C03221> continuation) {
                    super(2, continuation);
                    this.$textFieldSelectionState = textFieldSelectionState;
                }
                ...
                @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
                public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                    return new C03221(this.$textFieldSelectionState, continuation);
                }
            ...
            public void applySemantics(SemanticsPropertyReceiver $this$applySemantics) {
                ...
                SemanticsPropertiesKt.m6719setTextSelectionRangeFDrldGo($this$applySemantics, selection);
                if (!this.enabled) {
                ...
                if (KeyboardType.m7149equalsimpl0(keyboardType, KeyboardType.INSTANCE.m7165getEmailPjHm6EE())) {
                    SemanticsPropertiesKt.setContentType($this$applySemantics, ContentType.INSTANCE.getEmailAddress());
                } else if (KeyboardType.m7149equalsimpl0(keyboardType, KeyboardType.INSTANCE.m7168getPasswordPjHm6EE()) || KeyboardType.m7149equalsimpl0(keyboardType, KeyboardType.INSTANCE.m7167getNumberPasswordPjHm6EE())) {
                ...
                final int effectiveImeAction = this.keyboardOptions.m1216getImeActionOrDefaulteUduSuo$foundation();
                SemanticsPropertiesKt.m6715onImeAction9UiTYpY$default($this$applySemantics, effectiveImeAction, null, new Function0() { // from class: androidx.compose.foundation.text.input.internal.TextFieldDecoratorModifierNode$$ExternalSyntheticLambda7
                    @Override // kotlin.jvm.functions.Function0
                    public final Object invoke() {
                ...
                if (!TextRange.m6922getCollapsedimpl(selection) && !this.isPassword) {
            ...
            static final boolean applySemantics$lambda$5(TextFieldDecoratorModifierNode this$0, int start, int end, boolean relativeToOriginal) {
                ...
                if (start == TextRange.m6928getStartimpl(selection) && end == TextRange.m6923getEndimpl(selection)) {
                    return true;
                }
                ...
                if (relativeToOriginal) {
                    this$0.textFieldState.m1467selectUntransformedCharsIn5zctL8(selectionRange);
                } else {
                    this$0.textFieldState.m1466selectCharsIn5zctL8(selectionRange);
                }
                return true;
            }

            static final boolean applySemantics$lambda$6(TextFieldDecoratorModifierNode this$0, int $effectiveImeAction) {
                this$0.m1432onImeActionPerformedKlQnJC8($effectiveImeAction);
                return true;
            }
            ...
            public boolean mo234onPreKeyEventZmokQxo(KeyEvent event) {
                return this.textFieldKeyEventHandler.mo1363onPreKeyEventMyFupTE(event, this.textFieldState, this.textFieldSelectionState, (FocusManager) CompositionLocalConsumerModifierNodeKt.currentValueOf(this, CompositionLocalsKt.getLocalFocusManager()), requireKeyboardController());
            }

            @Override // androidx.compose.ui.input.key.KeyInputModifierNode
            /* JADX INFO: renamed from: onKeyEvent-ZmokQxo */
            public boolean mo232onKeyEventZmokQxo(KeyEvent event) {
                return this.textFieldKeyEventHandler.mo1362onKeyEvent8zsqlwg(event, this.textFieldState, this.textLayoutState, this.textFieldSelectionState, this.clipboardKeyCommandsHandler, requireKeyboardController(), this.enabled && !this.readOnly, this.singleLine, new Function0() { // from class: androidx.compose.foundation.text.input.internal.TextFieldDecoratorModifierNode$$ExternalSyntheticLambda25
                    @Override // kotlin.jvm.functions.Function0
                    public final Object invoke() {
                        TextFieldDecoratorModifierNode textFieldDecoratorModifierNode = this.f$0;
                        return Boolean.valueOf(textFieldDecoratorModifierNode.m1432onImeActionPerformedKlQnJC8(textFieldDecoratorModifierNode.keyboardOptions.m1216getImeActionOrDefaulteUduSuo$foundation()));
                    }
                });
            }
            ...
            public void mo394onRemeasuredozmzZPI(long size) {
                this.dragAndDropNode.mo394onRemeasuredozmzZPI(size);
            }
            ...
            public final void startInputSession(boolean fromTap) {
                if (fromTap || this.keyboardOptions.getShowKeyboardOnFocusOrDefault$foundation()) {
                    ...
                    this.inputSessionJob = BuildersKt__Builders_commonKt.launch$default(getCoroutineScope(), null, null, new C03211(receiveContentConfiguration, null), 3, null);
                }
            }
            ...
            static final class C03211 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                ...
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                C03211(ReceiveContentConfiguration receiveContentConfiguration, Continuation<? super C03211> continuation) {
                    super(2, continuation);
                ...
                @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
                public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                    return TextFieldDecoratorModifierNode.this.new C03211(this.$receiveContentConfiguration, continuation);
                }
                ...
                static final class C00341 extends SuspendLambda implements Function2<PlatformTextInputSessionScope, Continuation<?>, Object> {
                        ...
                        switch (this.label) {
                            case 0:
                                ...
                                Function0 function0 = new Function0() { // from class: androidx.compose.foundation.text.input.internal.TextFieldDecoratorModifierNode$startInputSession$1$1$$ExternalSyntheticLambda0
                                    @Override // kotlin.jvm.functions.Function0
                                    public final Object invoke() {
                                        return TextFieldDecoratorModifierNode.C03211.C00341.invokeSuspend$lambda$0(textFieldDecoratorModifierNode);
                                    }
                                };
                                ...
                                if (AndroidTextInputSession_androidKt.platformSpecificTextInputSession(platformTextInputSessionScope, textFieldState, textLayoutState, imeOptions$foundation, receiveContentConfiguration, c00351, function0, stylusHandwritingTrigger, viewConfiguration, new Function1() { // from class: androidx.compose.foundation.text.input.internal.TextFieldDecoratorModifierNode$startInputSession$1$1$$ExternalSyntheticLambda1
                                    @Override // kotlin.jvm.functions.Function1
                                    public final Object invoke(Object obj) {
                                        return TextFieldDecoratorModifierNode.C03211.C00341.invokeSuspend$lambda$1(textFieldDecoratorModifierNode2, ((Boolean) obj).booleanValue());
                                    }
                    ...
                    static final /* synthetic */ class C00351 extends AdaptedFunctionReference implements Function1<ImeAction, Unit> {
                        ...
                        public /* bridge */ /* synthetic */ Unit invoke(ImeAction imeAction) {
                            m1434invokeKlQnJC8(imeAction.getValue());
                            return Unit.INSTANCE;
                        }
            ...
            public final boolean m1432onImeActionPerformedKlQnJC8(final int imeAction) {
                if (ImeAction.m7096equalsimpl0(imeAction, ImeAction.INSTANCE.m7113getNoneeUduSuo()) || ImeAction.m7096equalsimpl0(imeAction, ImeAction.INSTANCE.m7109getDefaulteUduSuo()) || this.keyboardActionHandler == null) {
                    return m1431defaultKeyboardActionWithResultKlQnJC8(imeAction);
                }
            ...
            static final Unit onImeActionPerformed_KlQnJC8$lambda$0(TextFieldDecoratorModifierNode this$0, int i) {
                this$0.keyboardActionScope.mo1202defaultKeyboardActionKlQnJC8(i);
                return Unit.INSTANCE;
            }

            /* JADX INFO: Access modifiers changed from: private */
            /* JADX INFO: renamed from: defaultKeyboardActionWithResult-KlQnJC8, reason: not valid java name */
            public final boolean m1431defaultKeyboardActionWithResultKlQnJC8(int imeAction) {
                if (ImeAction.m7096equalsimpl0(imeAction, ImeAction.INSTANCE.m7112getNexteUduSuo())) {
                    ((FocusManager) CompositionLocalConsumerModifierNodeKt.currentValueOf(this, CompositionLocalsKt.getLocalFocusManager())).mo4341moveFocus3ESFkO8(FocusDirection.INSTANCE.m4335getNextdhqQ8s());
                    return true;
                }
                if (ImeAction.m7096equalsimpl0(imeAction, ImeAction.INSTANCE.m7114getPreviouseUduSuo())) {
                    ((FocusManager) CompositionLocalConsumerModifierNodeKt.currentValueOf(this, CompositionLocalsKt.getLocalFocusManager())).mo4341moveFocus3ESFkO8(FocusDirection.INSTANCE.m4336getPreviousdhqQ8s());
                    return true;
                }
                if (ImeAction.m7096equalsimpl0(imeAction, ImeAction.INSTANCE.m7110getDoneeUduSuo())) {
