...
public final class ImeEditCommand_androidKt {
    ...
    static final Unit commitText$lambda$0(String $text, int $newCursorPosition, TextFieldBuffer $this$edit) {
        ...
        if (compositionRange != null) {
            imeReplace($this$edit, TextRange.m6928getStartimpl(compositionRange.getPackedValue()), TextRange.m6923getEndimpl(compositionRange.getPackedValue()), $text);
        } else {
            imeReplace($this$edit, TextRange.m6928getStartimpl($this$edit.getSelectionInChars()), TextRange.m6923getEndimpl($this$edit.getSelectionInChars()), $text);
        }
        int newCursor = TextRange.m6928getStartimpl($this$edit.getSelectionInChars());
        if ($newCursorPosition > 0) {
            newCursorInBuffer = (newCursor + $newCursorPosition) - 1;
        } else {
            newCursorInBuffer = (newCursor + $newCursorPosition) - $text.length();
        }
        $this$edit.m1330setSelection5zctL8(TextRangeKt.TextRange(RangesKt.coerceIn(newCursorInBuffer, 0, $this$edit.getLength())));
    ...
    public static final void setComposingRegion(ImeEditCommandScope $this$setComposingRegion, final int start, final int end) {
        $this$setComposingRegion.edit(new Function1() { // from class: androidx.compose.foundation.text.input.internal.ImeEditCommand_androidKt$$ExternalSyntheticLambda6
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return ImeEditCommand_androidKt.setComposingRegion$lambda$0(start, end, (TextFieldBuffer) obj);
            }
        });
    }

    static final Unit setComposingRegion$lambda$0(int $start, int $end, TextFieldBuffer $this$edit) {
    ...
    static final Unit setComposingText$lambda$0(String $text, List $annotations, int $newCursorPosition, TextFieldBuffer $this$edit) {
        ...
        if (compositionRange != null) {
            imeReplace($this$edit, TextRange.m6928getStartimpl(compositionRange.getPackedValue()), TextRange.m6923getEndimpl(compositionRange.getPackedValue()), $text);
            if ($text.length() > 0) {
                $this$edit.setComposition$foundation(TextRange.m6928getStartimpl(compositionRange.getPackedValue()), TextRange.m6928getStartimpl(compositionRange.getPackedValue()) + $text.length(), $annotations);
            }
        } else {
            int initialSelectionStart = TextRange.m6928getStartimpl($this$edit.getSelectionInChars());
            imeReplace($this$edit, initialSelectionStart, TextRange.m6923getEndimpl($this$edit.getSelectionInChars()), $text);
            if ($text.length() > 0) {
    ...
    static final Unit deleteSurroundingText$lambda$0(int $lengthBeforeCursor, int $lengthAfterCursor, ImeEditCommandScope $this_deleteSurroundingText, TextFieldBuffer $this$edit) {
        ...
        long transformedSelection = $this_deleteSurroundingText.mo1366mapToTransformedGEjPoXI($this$edit.getSelectionInChars());
        int $this$addExactOrElse$iv = TextRange.m6923getEndimpl(transformedSelection);
        ...
        long untransformedDeleteRangeAfter = $this_deleteSurroundingText.mo1365mapFromTransformedGEjPoXI(TextRangeKt.TextRange(TextRange.m6923getEndimpl(transformedSelection), Math.min(result$iv, $this_deleteSurroundingText.getTransformedLength())));
        imeDelete($this$edit, TextRange.m6926getMinimpl(untransformedDeleteRangeAfter), TextRange.m6925getMaximpl(untransformedDeleteRangeAfter));
        int $this$subtractExactOrElse$iv = TextRange.m6928getStartimpl(transformedSelection);
        ...
        long untransformedDeleteRangeBefore = $this_deleteSurroundingText.mo1365mapFromTransformedGEjPoXI(TextRangeKt.TextRange(Math.max(0, result$iv2), TextRange.m6928getStartimpl(transformedSelection)));
        imeDelete($this$edit, TextRange.m6926getMinimpl(untransformedDeleteRangeBefore), TextRange.m6925getMaximpl(untransformedDeleteRangeBefore));
        return Unit.INSTANCE;
    }
    ...
    static final Unit deleteSurroundingTextInCodePoints$lambda$0(int $lengthBeforeCursor, int $lengthAfterCursor, TextFieldBuffer $this$edit) {
        ...
        while (true) {
            if (i < $lengthBeforeCursor) {
                beforeLenInChars++;
                if (TextRange.m6928getStartimpl($this$edit.getSelectionInChars()) <= beforeLenInChars) {
                    beforeLenInChars = TextRange.m6928getStartimpl($this$edit.getSelectionInChars());
                    break;
                }
                char lead = $this$edit.asCharSequence().charAt((TextRange.m6928getStartimpl($this$edit.getSelectionInChars()) - beforeLenInChars) - 1);
                char trail = $this$edit.asCharSequence().charAt(TextRange.m6928getStartimpl($this$edit.getSelectionInChars()) - beforeLenInChars);
        ...
        while (true) {
            ...
            afterLenInChars++;
            if (TextRange.m6923getEndimpl($this$edit.getSelectionInChars()) + afterLenInChars >= $this$edit.getLength()) {
                afterLenInChars = $this$edit.getLength() - TextRange.m6923getEndimpl($this$edit.getSelectionInChars());
                break;
            }
            char lead2 = $this$edit.asCharSequence().charAt((TextRange.m6923getEndimpl($this$edit.getSelectionInChars()) + afterLenInChars) - 1);
            char trail2 = $this$edit.asCharSequence().charAt(TextRange.m6923getEndimpl($this$edit.getSelectionInChars()) + afterLenInChars);
            if (isSurrogatePair(lead2, trail2)) {
                afterLenInChars++;
            }
            i2++;
        }
        imeDelete($this$edit, TextRange.m6923getEndimpl($this$edit.getSelectionInChars()), TextRange.m6923getEndimpl($this$edit.getSelectionInChars()) + afterLenInChars);
        imeDelete($this$edit, TextRange.m6928getStartimpl($this$edit.getSelectionInChars()) - beforeLenInChars, TextRange.m6928getStartimpl($this$edit.getSelectionInChars()));
        return Unit.INSTANCE;
    }
    ...
    static final Unit setSelection$lambda$0(ImeEditCommandScope $this_setSelection, int $start, int $end, TextFieldBuffer $this$edit) {
        long transformedSpaceLength = $this_setSelection.mo1366mapToTransformedGEjPoXI(TextRangeKt.TextRange(0, $this$edit.getLength()));
        int minimumValue$iv = TextRange.m6926getMinimpl(transformedSpaceLength);
        int maximumValue$iv = TextRange.m6925getMaximpl(transformedSpaceLength);
        ...
        int minimumValue$iv2 = TextRange.m6926getMinimpl(transformedSpaceLength);
        int maximumValue$iv2 = TextRange.m6925getMaximpl(transformedSpaceLength);
        ...
        $this$edit.m1330setSelection5zctL8($this_setSelection.mo1365mapFromTransformedGEjPoXI(TextRangeKt.TextRange(maximumValue$iv$iv, $this$fastCoerceAtLeast$iv$iv)));
        return Unit.INSTANCE;
    }
    ...
    public static final void imeReplace(TextFieldBuffer $this$imeReplace, int start, int end, CharSequence text) {
        ...
        $this$imeReplace.m1330setSelection5zctL8(TextRangeKt.TextRange(text.length() + min));
    }
    ...
    public static final void imeDelete(TextFieldBuffer $this$imeDelete, int start, int end) {
        ...
        if (initialComposition != null) {
            ...
            long adjustedComposition = TextFieldBufferKt.m1334adjustTextRangevJH6DeI(initialComposition.getPackedValue(), min, max, 0);
            if (TextRange.m6922getCollapsedimpl(adjustedComposition)) {
                $this$imeDelete.commitComposition$foundation();
            } else {
                TextFieldBuffer.setComposition$foundation$default($this$imeDelete, TextRange.m6926getMinimpl(adjustedComposition), TextRange.m6925getMaximpl(adjustedComposition), null, 4, null);
            }
        }
    }
}
