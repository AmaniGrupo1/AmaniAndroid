...
public final class CursorAnchorInfoController {
    ...
    private final float[] matrix = Matrix.m4941constructorimpl$default(null, 1, null);
        ...
        if (textLayoutCoordinates != null) {
            ...
            if (textLayoutCoordinates != null && (coreCoordinates = this.textLayoutState.getCoreNodeCoordinates()) != null) {
                ...
                if (coreCoordinates != null && (decorationBoxCoordinates = this.textLayoutState.getDecoratorNodeCoordinates()) != null) {
                    ...
                    Matrix.m4950resetimpl(this.matrix);
                    textLayoutCoordinates.mo6157transformToScreen58bKbWc(this.matrix);
                    AndroidMatrixConversions_androidKt.m4564setFromEL8BTi8(this.androidMatrix, this.matrix);
                    Rect innerTextFieldBounds = SelectionManagerKt.visibleBounds(coreCoordinates).m4489translatek4lQ0M(textLayoutCoordinates.mo6150localPositionOfR5De75A(coreCoordinates, Offset.INSTANCE.m4468getZeroF1C5BW0()));
                    Rect decorationBoxBounds = SelectionManagerKt.visibleBounds(decorationBoxCoordinates).m4489translatek4lQ0M(textLayoutCoordinates.mo6150localPositionOfR5De75A(decorationBoxCoordinates, Offset.INSTANCE.m4468getZeroF1C5BW0()));
                    return CursorAnchorInfoBuilder_androidKt.m1375buildvxqZcH0(this.builder, text, text.getSelection(), text.getComposition(), textLayoutResult, this.androidMatrix, innerTextFieldBounds, decorationBoxBounds, this.includeInsertionMarker, this.includeCharacterBounds, this.includeEditorBounds, this.includeLineBounds);
                }
                return null;
            }
            return null;
