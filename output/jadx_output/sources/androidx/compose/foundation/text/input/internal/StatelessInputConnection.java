...
public final class StatelessInputConnection implements InputConnection {
    ...
    public CharSequence getSelectedText(int flags) {
        CharSequence result;
        if (TextRange.m6922getCollapsedimpl(getText().getSelection())) {
            result = null;
        } else {
    ...
    public int getCursorCapsMode(int reqModes) {
        ...
        return TextUtils.getCapsMode(getText(), TextRange.m6926getMinimpl(getText().getSelection()), reqModes);
    }
    ...
    public boolean performEditorAction(int editorAction) {
        ...
        this.session.mo1367onImeActionKlQnJC8(imeAction);
        return true;
    }
