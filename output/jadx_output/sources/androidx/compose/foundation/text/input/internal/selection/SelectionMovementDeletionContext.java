...
public final class SelectionMovementDeletionContext {
    ...
    public final SelectionMovementDeletionContext deselect() {
        ...
        if (this.text.length() > 0) {
            ...
            $this$deselect_u24lambda_u240.selection = TextRangeKt.TextRange(TextRange.m6923getEndimpl($this$deselect_u24lambda_u240.selection));
        }
        return this;
    }
    ...
    public final SelectionMovementDeletionContext collapseLeftOr(Function1<? super SelectionMovementDeletionContext, Unit> or) {
        ...
        if (this.text.length() > 0) {
            ...
            if (TextRange.m6922getCollapsedimpl($this$collapseLeftOr_u24lambda_u240.selection)) {
                ...
                if (zIsLtr) {
                    $this$collapseLeftOr_u24lambda_u240.selection = TextRangeKt.TextRange(TextRange.m6926getMinimpl(j));
                } else {
                    $this$collapseLeftOr_u24lambda_u240.selection = TextRangeKt.TextRange(TextRange.m6925getMaximpl(j));
                }
            }
        }
        return this;
    ...
    public final SelectionMovementDeletionContext collapseRightOr(Function1<? super SelectionMovementDeletionContext, Unit> or) {
        ...
        if (this.text.length() > 0) {
            ...
            if (TextRange.m6922getCollapsedimpl($this$collapseRightOr_u24lambda_u240.selection)) {
                ...
                if (zIsLtr) {
                    $this$collapseRightOr_u24lambda_u240.selection = TextRangeKt.TextRange(TextRange.m6925getMaximpl(j));
                } else {
                    $this$collapseRightOr_u24lambda_u240.selection = TextRangeKt.TextRange(TextRange.m6926getMinimpl(j));
                }
            }
        }
        return this;
    ...
    public final int getPrecedingCharacterIndex() {
        return StringHelpers_androidKt.findPrecedingBreak(this.text, TextRange.m6923getEndimpl(this.selection));
    }

    public final int getNextCharacterIndex() {
        return StringHelpers_androidKt.findFollowingBreak(this.text, TextRange.m6923getEndimpl(this.selection));
    }
    ...
    static /* synthetic */ SelectionMovementDeletionContext moveCursorTo$default(SelectionMovementDeletionContext $this, boolean resetCachedX, Function0 proposedCursorMovement, int i, Object obj) {
        ...
        if ($this.text.length() > 0) {
            int oldCursor = TextRange.m6923getEndimpl($this.getSelection());
            ...
            int newCursor = CursorAndWedgeAffinity.m1474component1impl(jCalculateNextCursorPositionAndWedgeAffinity);
            WedgeAffinity newWedgeAffinity = CursorAndWedgeAffinity.m1475component2impl(jCalculateNextCursorPositionAndWedgeAffinity);
            if (newCursor != oldCursor || !TextRange.m6922getCollapsedimpl($this.getSelection())) {
                $this.m1487setSelection5zctL8(TextRangeKt.TextRange(newCursor));
            }
    ...
    private final SelectionMovementDeletionContext moveCursorTo(boolean resetCachedX, Function0<Integer> proposedCursorMovement) {
        ...
        if (this.text.length() > 0) {
            ...
            int oldCursor = TextRange.m6923getEndimpl($this$moveCursorTo_u24lambda_u240.getSelection());
            ...
            int newCursor = CursorAndWedgeAffinity.m1474component1impl(jCalculateNextCursorPositionAndWedgeAffinity);
            WedgeAffinity newWedgeAffinity = CursorAndWedgeAffinity.m1475component2impl(jCalculateNextCursorPositionAndWedgeAffinity);
            if (newCursor != oldCursor || !TextRange.m6922getCollapsedimpl($this$moveCursorTo_u24lambda_u240.getSelection())) {
                $this$moveCursorTo_u24lambda_u240.m1487setSelection5zctL8(TextRangeKt.TextRange(newCursor));
            }
            if (newWedgeAffinity != null) {
    ...
    public final SelectionMovementDeletionContext moveCursorPrevByCodePointOrEmoji() {
        ...
        if (this.text.length() > 0) {
            ...
            int oldCursor$iv = TextRange.m6923getEndimpl($this$moveCursorTo_u24lambda_u240$iv.getSelection());
            long jCalculateNextCursorPositionAndWedgeAffinity = TextPreparedSelectionKt.calculateNextCursorPositionAndWedgeAffinity(StringHelpers_androidKt.findCodePointOrEmojiStartBefore(this.text, TextRange.m6923getEndimpl(this.selection), -1), oldCursor$iv, $this$moveCursorTo_u24lambda_u240$iv.state);
            int newCursor$iv = CursorAndWedgeAffinity.m1474component1impl(jCalculateNextCursorPositionAndWedgeAffinity);
            WedgeAffinity newWedgeAffinity$iv = CursorAndWedgeAffinity.m1475component2impl(jCalculateNextCursorPositionAndWedgeAffinity);
            if (newCursor$iv != oldCursor$iv || !TextRange.m6922getCollapsedimpl($this$moveCursorTo_u24lambda_u240$iv.getSelection())) {
                $this$moveCursorTo_u24lambda_u240$iv.m1487setSelection5zctL8(TextRangeKt.TextRange(newCursor$iv));
            }
    ...
    public final SelectionMovementDeletionContext moveCursorPrevByChar() {
        ...
        if (this.text.length() > 0) {
            SelectionMovementDeletionContext $this$moveCursorTo_u24lambda_u240$iv = this;
            int oldCursor$iv = TextRange.m6923getEndimpl($this$moveCursorTo_u24lambda_u240$iv.getSelection());
            long jCalculateNextCursorPositionAndWedgeAffinity = TextPreparedSelectionKt.calculateNextCursorPositionAndWedgeAffinity(StringHelpers_androidKt.findPrecedingBreak(this.text, TextRange.m6923getEndimpl(this.selection)), oldCursor$iv, $this$moveCursorTo_u24lambda_u240$iv.state);
            int newCursor$iv = CursorAndWedgeAffinity.m1474component1impl(jCalculateNextCursorPositionAndWedgeAffinity);
            WedgeAffinity newWedgeAffinity$iv = CursorAndWedgeAffinity.m1475component2impl(jCalculateNextCursorPositionAndWedgeAffinity);
            if (newCursor$iv != oldCursor$iv || !TextRange.m6922getCollapsedimpl($this$moveCursorTo_u24lambda_u240$iv.getSelection())) {
                $this$moveCursorTo_u24lambda_u240$iv.m1487setSelection5zctL8(TextRangeKt.TextRange(newCursor$iv));
    ...
    public final SelectionMovementDeletionContext moveCursorNextByChar() {
        ...
        if (this.text.length() > 0) {
            SelectionMovementDeletionContext $this$moveCursorTo_u24lambda_u240$iv = this;
            int oldCursor$iv = TextRange.m6923getEndimpl($this$moveCursorTo_u24lambda_u240$iv.getSelection());
            long jCalculateNextCursorPositionAndWedgeAffinity = TextPreparedSelectionKt.calculateNextCursorPositionAndWedgeAffinity(StringHelpers_androidKt.findFollowingBreak(this.text, TextRange.m6923getEndimpl(this.selection)), oldCursor$iv, $this$moveCursorTo_u24lambda_u240$iv.state);
            int newCursor$iv = CursorAndWedgeAffinity.m1474component1impl(jCalculateNextCursorPositionAndWedgeAffinity);
            WedgeAffinity newWedgeAffinity$iv = CursorAndWedgeAffinity.m1475component2impl(jCalculateNextCursorPositionAndWedgeAffinity);
            if (newCursor$iv != oldCursor$iv || !TextRange.m6922getCollapsedimpl($this$moveCursorTo_u24lambda_u240$iv.getSelection())) {
                $this$moveCursorTo_u24lambda_u240$iv.m1487setSelection5zctL8(TextRangeKt.TextRange(newCursor$iv));
    ...
    public final SelectionMovementDeletionContext moveCursorPrevByParagraph() {
        ...
        if (this.text.length() > 0) {
            SelectionMovementDeletionContext $this$moveCursorTo_u24lambda_u240$iv = this;
            int oldCursor$iv = TextRange.m6923getEndimpl($this$moveCursorTo_u24lambda_u240$iv.getSelection());
            int paragraphStart = StringHelpersKt.findParagraphStart(this.text, TextRange.m6926getMinimpl(this.selection));
            if (paragraphStart == TextRange.m6926getMinimpl(this.selection) && paragraphStart != 0) {
    ...
    public final SelectionMovementDeletionContext moveCursorNextByParagraph() {
        ...
        if (this.text.length() > 0) {
            SelectionMovementDeletionContext $this$moveCursorTo_u24lambda_u240$iv = this;
            int oldCursor$iv = TextRange.m6923getEndimpl($this$moveCursorTo_u24lambda_u240$iv.getSelection());
            int paragraphEnd = StringHelpersKt.findParagraphEnd(this.text, TextRange.m6925getMaximpl(this.selection));
            if (paragraphEnd == TextRange.m6925getMaximpl(this.selection) && paragraphEnd != this.text.length()) {
    ...
    public final SelectionMovementDeletionContext selectMovement() {
        if (this.text.length() > 0) {
            ...
            $this$selectMovement_u24lambda_u240.selection = TextRangeKt.TextRange(TextRange.m6928getStartimpl($this$selectMovement_u24lambda_u240.initialValue.getSelection()), TextRange.m6923getEndimpl($this$selectMovement_u24lambda_u240.selection));
        }
        return this;
    }
    ...
    public final SelectionMovementDeletionContext deleteMovement() {
        if (this.text.length() > 0) {
            ...
            boolean zM6922getCollapsedimpl = TextRange.m6922getCollapsedimpl($this$deleteMovement_u24lambda_u240.initialValue.getSelection());
            TransformedTextFieldState transformedTextFieldState = $this$deleteMovement_u24lambda_u240.state;
            if (zM6922getCollapsedimpl) {
                TransformedTextFieldState.m1459replaceTextM8tDOmk$default(transformedTextFieldState, "", TextRangeKt.TextRange(TextRange.m6928getStartimpl($this$deleteMovement_u24lambda_u240.initialValue.getSelection()), TextRange.m6923getEndimpl($this$deleteMovement_u24lambda_u240.selection)), null, !$this$deleteMovement_u24lambda_u240.isFromSoftKeyboard, 4, null);
            } else {
    ...
    private final boolean isLtr() {
        ...
        TextLayoutResult textLayoutResult = this.textLayoutResult;
        return textLayoutResult == null || (direction = textLayoutResult.getParagraphDirection(TextRange.m6923getEndimpl(this.selection))) == null || direction == ResolvedTextDirection.Ltr;
    }
    ...
    static /* synthetic */ int getNextWordOffsetForLayout$default(SelectionMovementDeletionContext selectionMovementDeletionContext, TextLayoutResult textLayoutResult, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            i = TextRange.m6923getEndimpl(selectionMovementDeletionContext.selection);
        }
    ...
    private final int getNextWordOffsetForLayout(TextLayoutResult $this$getNextWordOffsetForLayout, int currentOffset) {
        while (currentOffset < this.initialValue.length()) {
            long currentWord = $this$getNextWordOffsetForLayout.m6900getWordBoundaryjx7JFs(charOffset(currentOffset));
            if (TextRange.m6923getEndimpl(currentWord) <= currentOffset) {
                currentOffset++;
            } else {
                return TextRange.m6923getEndimpl(currentWord);
            }
        }
    ...
    private final int getPrevWordOffsetForLayout(TextLayoutResult $this$getPrevWordOffsetForLayout, int currentOffset) {
        while (currentOffset > 0) {
            long currentWord = $this$getPrevWordOffsetForLayout.m6900getWordBoundaryjx7JFs(charOffset(currentOffset));
            if (TextRange.m6928getStartimpl(currentWord) >= currentOffset) {
                currentOffset--;
            } else {
                return TextRange.m6928getStartimpl(currentWord);
            }
        }
        return 0;
    }
    ...
    static /* synthetic */ int getLineStartByOffsetForLayout$default(SelectionMovementDeletionContext selectionMovementDeletionContext, TextLayoutResult textLayoutResult, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            i = TextRange.m6926getMinimpl(selectionMovementDeletionContext.selection);
        }
    ...
    static /* synthetic */ int getLineEndByOffsetForLayout$default(SelectionMovementDeletionContext selectionMovementDeletionContext, TextLayoutResult textLayoutResult, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            i = TextRange.m6925getMaximpl(selectionMovementDeletionContext.selection);
        }
    ...
    private final int jumpByLinesOffset(TextLayoutResult $this$jumpByLinesOffset, int linesAmount) {
        int currentOffset = TextRange.m6923getEndimpl(this.selection);
        ...
        return $this$jumpByLinesOffset.m6898getOffsetForPositionk4lQ0M(Offset.m4444constructorimpl((v1$iv$iv << 32) | (v2$iv$iv & 4294967295L)));
    }

    private final int jumpByPagesOffset(int pagesAmount) {
        int currentOffset = TextRange.m6923getEndimpl(this.initialValue.getSelection());
        ...
        TextLayoutResult textLayoutResult = this.textLayoutResult;
        if (fAbs > fAbs2) {
            return textLayoutResult.m6898getOffsetForPositionk4lQ0M(newPos.m4487getTopLeftF1C5BW0());
        }
        return textLayoutResult.m6898getOffsetForPositionk4lQ0M(newPos.m4480getBottomLeftF1C5BW0());
    }
