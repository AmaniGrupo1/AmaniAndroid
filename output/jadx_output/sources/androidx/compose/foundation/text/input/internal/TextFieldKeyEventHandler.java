...
public abstract class TextFieldKeyEventHandler {
    ...
    public boolean mo1363onPreKeyEventMyFupTE(KeyEvent event, TransformedTextFieldState textFieldState, TextFieldSelectionState textFieldSelectionState, FocusManager focusManager, SoftwareKeyboardController keyboardController) {
        long selection = textFieldState.getVisualText().getSelection();
        if (!TextRange.m6922getCollapsedimpl(selection) && KeyEventHelpers_androidKt.m1199cancelsTextSelectionZmokQxo(event)) {
    ...
    public boolean mo1362onKeyEvent8zsqlwg(KeyEvent event, TransformedTextFieldState textFieldState, TextLayoutState textLayoutState, TextFieldSelectionState textFieldSelectionState, Function1<? super KeyCommand, ? extends Unit> clipboardKeyCommandsHandler, SoftwareKeyboardController keyboardController, boolean editable, boolean singleLine, Function0<Boolean> onSubmit) {
        long keyCode = KeyEvent_androidKt.m5853getKeyZmokQxo(event);
        if (KeyEventType.m5846equalsimpl0(KeyEvent_androidKt.m5854getTypeZmokQxo(event), KeyEventType.INSTANCE.m5851getKeyUpCS__XNY())) {
        ...
        if (KeyEventType.m5846equalsimpl0(KeyEvent_androidKt.m5854getTypeZmokQxo(event), KeyEventType.INSTANCE.m5852getUnknownCS__XNY()) && !TextFieldKeyInput_androidKt.m1279isTypedEventZmokQxo(event)) {
            return false;
        }
        boolean consumed = m1436processKeyDownEventq0GpTC0(event, textFieldState, textLayoutState, clipboardKeyCommandsHandler, keyboardController, editable, singleLine, onSubmit);
        if (consumed) {
    ...
    private final boolean m1436processKeyDownEventq0GpTC0(KeyEvent event, TransformedTextFieldState textFieldState, TextLayoutState textLayoutState, Function1<? super KeyCommand, ? extends Unit> clipboardKeyCommandsHandler, SoftwareKeyboardController keyboardController, boolean editable, boolean singleLine, Function0<Boolean> onSubmit) {
        ...
        Integer codePoint;
        if (TextFieldKeyInput_androidKt.m1279isTypedEventZmokQxo(event) && (codePoint = this.deadKeyCombiner.m1197consumeZmokQxo(event)) != null) {
            String text = StringHelpers_jvmKt.appendCodePointX(new StringBuilder(2), codePoint.intValue()).toString();
            if (!editable) {
                return false;
            }
            TransformedTextFieldState.replaceSelectedText$default(textFieldState, text, true, null, !TextFieldKeyEventHandler_androidKt.m1438isFromSoftKeyboardZmokQxo(event), 4, null);
            this.preparedSelectionState.resetCachedX();
            return true;
        }
        KeyCommand command = this.keyMapping.mo1200mapZmokQxo(event);
        ...
        SelectionMovementDeletionContext $this$processKeyDownEvent_q0GpTC0_u24lambda_u240 = new SelectionMovementDeletionContext(textFieldState, layoutResult, TextFieldKeyEventHandler_androidKt.m1438isFromSoftKeyboardZmokQxo(event), visibleTextLayoutHeight, this.preparedSelectionState);
        ...
        switch (WhenMappings.$EnumSwitchMapping$0[command.ordinal()]) {
            ...
            case 26:
                if (!singleLine) {
                    transformedTextFieldState = textFieldState;
                    TransformedTextFieldState.replaceSelectedText$default(transformedTextFieldState, "\n", true, null, !TextFieldKeyEventHandler_androidKt.m1438isFromSoftKeyboardZmokQxo(event), 4, null);
                } else {
                    transformedTextFieldState = textFieldState;
            ...
            case 27:
                if (!singleLine) {
                    TransformedTextFieldState.replaceSelectedText$default(textFieldState, "\t", true, null, !TextFieldKeyEventHandler_androidKt.m1438isFromSoftKeyboardZmokQxo(event), 4, null);
                } else {
                    consumed = false;
                }
        ...
        if (ComposeFoundationFlags.isTextFieldDpadNavigationEnabled && (command == KeyCommand.UP || command == KeyCommand.DOWN || command == KeyCommand.LEFT_CHAR || command == KeyCommand.RIGHT_CHAR)) {
            consumed = !TextRange.m6921equalsimpl0($this$processKeyDownEvent_q0GpTC0_u24lambda_u240.getInitialValue().getSelection(), $this$processKeyDownEvent_q0GpTC0_u24lambda_u240.getSelection());
        }
        if (!TextRange.m6921equalsimpl0($this$processKeyDownEvent_q0GpTC0_u24lambda_u240.getSelection(), $this$processKeyDownEvent_q0GpTC0_u24lambda_u240.getInitialValue().getSelection())) {
            transformedTextFieldState.m1466selectCharsIn5zctL8($this$processKeyDownEvent_q0GpTC0_u24lambda_u240.getSelection());
        }
        if ($this$processKeyDownEvent_q0GpTC0_u24lambda_u240.getWedgeAffinity() != null && (wedgeAffinity = $this$processKeyDownEvent_q0GpTC0_u24lambda_u240.getWedgeAffinity()) != null) {
            if (TextRange.m6922getCollapsedimpl(transformedTextFieldState.getUntransformedText().getSelection())) {
        ...
        if (textLayoutCoordinates != null) {
            ...
            if (textLayoutCoordinates != null) {
                ...
                if (rectLocalBoundingBoxOf$default != null) {
                    int bits$iv$iv$iv = (int) (4294967295L & rectLocalBoundingBoxOf$default.m4485getSizeNHjbRc());
