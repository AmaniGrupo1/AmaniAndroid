...
public final class HandwritingGesture_androidKt {
    ...
    public static final long m1392adjustHandwritingDeleteGestureRange72CqOWE(long j, CharSequence text) {
        int codePointBeforeStart;
        int start = TextRange.m6928getStartimpl(j);
        int end = TextRange.m6923getEndimpl(j);
    ...
    public static final long m1401getRangeForScreenRectOH9lIzo(TextLayoutState $this$getRangeForScreenRect_u2dOH9lIzo, Rect rectInScreen, int i, TextInclusionStrategy inclusionStrategy) {
        TextLayoutResult layoutResult = $this$getRangeForScreenRect_u2dOH9lIzo.getLayoutResult();
        return m1399getRangeForScreenRectO048IG0(layoutResult != null ? layoutResult.getMultiParagraph() : null, rectInScreen, $this$getRangeForScreenRect_u2dOH9lIzo.getTextLayoutNodeCoordinates(), i, inclusionStrategy);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: getRangeForScreenRects-O048IG0, reason: not valid java name */
    public static final long m1403getRangeForScreenRectsO048IG0(TextLayoutState $this$getRangeForScreenRects_u2dO048IG0, Rect startRectInScreen, Rect endRectInScreen, int i, TextInclusionStrategy inclusionStrategy) {
        long startRange = m1401getRangeForScreenRectOH9lIzo($this$getRangeForScreenRects_u2dO048IG0, startRectInScreen, i, inclusionStrategy);
        if (TextRange.m6922getCollapsedimpl(startRange)) {
            return TextRange.INSTANCE.m6933getZerod9O1mEE();
        }
        long endRange = m1401getRangeForScreenRectOH9lIzo($this$getRangeForScreenRects_u2dO048IG0, endRectInScreen, i, inclusionStrategy);
        return TextRange.m6922getCollapsedimpl(endRange) ? TextRange.INSTANCE.m6933getZerod9O1mEE() : m1393enclosurepWDy79M(startRange, endRange);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: getRangeForScreenRect-OH9lIzo, reason: not valid java name */
    public static final long m1400getRangeForScreenRectOH9lIzo(LegacyTextFieldState $this$getRangeForScreenRect_u2dOH9lIzo, Rect rectInScreen, int i, TextInclusionStrategy inclusionStrategy) {
        TextLayoutResult value;
        TextLayoutResultProxy layoutResult = $this$getRangeForScreenRect_u2dOH9lIzo.getLayoutResult();
        return m1399getRangeForScreenRectO048IG0((layoutResult == null || (value = layoutResult.getValue()) == null) ? null : value.getMultiParagraph(), rectInScreen, $this$getRangeForScreenRect_u2dOH9lIzo.getLayoutCoordinates(), i, inclusionStrategy);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: getRangeForScreenRects-O048IG0, reason: not valid java name */
    public static final long m1402getRangeForScreenRectsO048IG0(LegacyTextFieldState $this$getRangeForScreenRects_u2dO048IG0, Rect startRectInScreen, Rect endRectInScreen, int i, TextInclusionStrategy inclusionStrategy) {
        long startRange = m1400getRangeForScreenRectOH9lIzo($this$getRangeForScreenRects_u2dO048IG0, startRectInScreen, i, inclusionStrategy);
        if (TextRange.m6922getCollapsedimpl(startRange)) {
            return TextRange.INSTANCE.m6933getZerod9O1mEE();
        }
        long endRange = m1400getRangeForScreenRectOH9lIzo($this$getRangeForScreenRects_u2dO048IG0, endRectInScreen, i, inclusionStrategy);
        return TextRange.m6922getCollapsedimpl(endRange) ? TextRange.INSTANCE.m6933getZerod9O1mEE() : m1393enclosurepWDy79M(startRange, endRange);
    }
    ...
    public static final int m1396getOffsetForHandwritingGestured4ec7I(TextLayoutState $this$getOffsetForHandwritingGesture_u2dd_u2d4ec7I, long j, ViewConfiguration viewConfiguration) {
        ...
        return m1397getOffsetForHandwritingGestureubNVwUQ(multiParagraph, j, $this$getOffsetForHandwritingGesture_u2dd_u2d4ec7I.getTextLayoutNodeCoordinates(), viewConfiguration);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: getOffsetForHandwritingGesture-d-4ec7I, reason: not valid java name */
    public static final int m1395getOffsetForHandwritingGestured4ec7I(LegacyTextFieldState $this$getOffsetForHandwritingGesture_u2dd_u2d4ec7I, long j, ViewConfiguration viewConfiguration) {
        TextLayoutResult value;
        MultiParagraph multiParagraph;
        ...
        return m1397getOffsetForHandwritingGestureubNVwUQ(multiParagraph, j, $this$getOffsetForHandwritingGesture_u2dd_u2d4ec7I.getLayoutCoordinates(), viewConfiguration);
    }
    ...
    private static final long m1399getRangeForScreenRectO048IG0(MultiParagraph $this$getRangeForScreenRect_u2dO048IG0, Rect rectInScreen, LayoutCoordinates layoutCoordinates, int i, TextInclusionStrategy inclusionStrategy) {
        if ($this$getRangeForScreenRect_u2dO048IG0 == null || layoutCoordinates == null) {
            return TextRange.INSTANCE.m6933getZerod9O1mEE();
        }
        long screenOriginInLocal = layoutCoordinates.mo6155screenToLocalMKHz9U(Offset.INSTANCE.m4468getZeroF1C5BW0());
        Rect localRect = rectInScreen.m4489translatek4lQ0M(screenOriginInLocal);
        return $this$getRangeForScreenRect_u2dO048IG0.m6790getRangeForRect86BmAI(localRect, i, inclusionStrategy);
    }

    /* JADX INFO: renamed from: getOffsetForHandwritingGesture-ubNVwUQ, reason: not valid java name */
    private static final int m1397getOffsetForHandwritingGestureubNVwUQ(MultiParagraph $this$getOffsetForHandwritingGesture_u2dubNVwUQ, long j, LayoutCoordinates layoutCoordinates, ViewConfiguration viewConfiguration) {
        long localPoint;
        int line;
        if (layoutCoordinates == null || (line = m1394getLineForHandwritingGestured4ec7I($this$getOffsetForHandwritingGesture_u2dubNVwUQ, (localPoint = layoutCoordinates.mo6155screenToLocalMKHz9U(j)), viewConfiguration)) == -1) {
            return -1;
        }
        long adjustedPoint = Offset.m4446copydBAh8RU$default(localPoint, 0.0f, ($this$getOffsetForHandwritingGesture_u2dubNVwUQ.getLineTop(line) + $this$getOffsetForHandwritingGesture_u2dubNVwUQ.getLineBottom(line)) / 2.0f, 1, null);
        return $this$getOffsetForHandwritingGesture_u2dubNVwUQ.m6789getOffsetForPositionk4lQ0M(adjustedPoint);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: getRangeForRemoveSpaceGesture-5iVPX68, reason: not valid java name */
    public static final long m1398getRangeForRemoveSpaceGesture5iVPX68(TextLayoutResult $this$getRangeForRemoveSpaceGesture_u2d5iVPX68, long j, long j2, LayoutCoordinates layoutCoordinates, ViewConfiguration viewConfiguration) {
        int line;
        if ($this$getRangeForRemoveSpaceGesture_u2d5iVPX68 == null || layoutCoordinates == null) {
            return TextRange.INSTANCE.m6933getZerod9O1mEE();
        }
        long localStartPoint = layoutCoordinates.mo6155screenToLocalMKHz9U(j);
        long localEndPoint = layoutCoordinates.mo6155screenToLocalMKHz9U(j2);
        int startLine = m1394getLineForHandwritingGestured4ec7I($this$getRangeForRemoveSpaceGesture_u2d5iVPX68.getMultiParagraph(), localStartPoint, viewConfiguration);
        int endLine = m1394getLineForHandwritingGestured4ec7I($this$getRangeForRemoveSpaceGesture_u2d5iVPX68.getMultiParagraph(), localEndPoint, viewConfiguration);
        if (startLine != -1) {
        ...
        return $this$getRangeForRemoveSpaceGesture_u2d5iVPX68.getMultiParagraph().m6790getRangeForRect86BmAI(rect, TextGranularity.INSTANCE.m6890getCharacterDRrd7Zo(), TextInclusionStrategy.INSTANCE.getAnyOverlap());
    }

    /* JADX INFO: renamed from: getLineForHandwritingGesture-d-4ec7I, reason: not valid java name */
    private static final int m1394getLineForHandwritingGestured4ec7I(MultiParagraph $this$getLineForHandwritingGesture_u2dd_u2d4ec7I, long j, ViewConfiguration viewConfiguration) {
        ...
        if (Float.intBitsToFloat(bits$iv$iv$iv2) >= $this$getLineForHandwritingGesture_u2dd_u2d4ec7I.getLineTop(line) - lineMargin) {
            int bits$iv$iv$iv3 = (int) (4294967295L & j);
    ...
    private static final long m1393enclosurepWDy79M(long j, long j2) {
        return TextRangeKt.TextRange(Math.min(TextRange.m6928getStartimpl(j), TextRange.m6928getStartimpl(j)), Math.max(TextRange.m6923getEndimpl(j2), TextRange.m6923getEndimpl(j2)));
    }
}
