...
public final class TextFieldCharSequence implements CharSequence {
    ...
    private TextFieldCharSequence(CharSequence text, long selection, TextRange composition, Pair<TextHighlightType, TextRange> pair, List<AnnotatedString.Range<AnnotatedString.Annotation>> list, List<AnnotatedString.Range<AnnotatedString.Annotation>> list2) {
        ...
        this.selection = TextRangeKt.m6934coerceIn8ffj60Q(selection, 0, text.length());
        this.composition = composition != null ? TextRange.m6916boximpl(TextRangeKt.m6934coerceIn8ffj60Q(composition.getPackedValue(), 0, text.length())) : null;
        this.highlight = pair != null ? Pair.copy$default(pair, null, TextRange.m6916boximpl(TextRangeKt.m6934coerceIn8ffj60Q(pair.getSecond().getPackedValue(), 0, text.length())), 1, null) : null;
    }
    ...
    public /* synthetic */ TextFieldCharSequence(CharSequence charSequence, long j, TextRange textRange, Pair pair, List list, List list2, int i, DefaultConstructorMarker defaultConstructorMarker) {
        ...
        long jM6933getZerod9O1mEE = (i & 2) != 0 ? TextRange.INSTANCE.m6933getZerod9O1mEE() : j;
        TextRange textRange2 = (i & 4) != 0 ? null : textRange;
        Pair pair2 = (i & 8) != 0 ? null : pair;
        List list3 = (i & 16) != 0 ? null : list;
        this(charSequence2, jM6933getZerod9O1mEE, textRange2, pair2, list3, (i & 32) == 0 ? list2 : null, null);
    }
    ...
    public int hashCode() {
        ...
        int result3 = (result2 + (textRange != null ? TextRange.m6929hashCodeimpl(textRange.getPackedValue()) : 0)) * 31;
