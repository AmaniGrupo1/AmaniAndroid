...
public final class TextFieldState {
    ...
    private TextFieldState(String initialText, long initialSelection, TextUndoManager initialTextUndoManager) {
        ...
        this.mainBuffer = new TextFieldBuffer(new TextFieldCharSequence(initialText, TextRangeKt.m6934coerceIn8ffj60Q(initialSelection, 0, initialText.length()), null, null, null, null, 60, null), null, null, null, 14, null);
    ...
    public String toString() {
        ...
        try {
            return "TextFieldState(selection=" + ((Object) TextRange.m6931toStringimpl(m1338getSelectiond9O1mEE())) + ", text=\"" + ((Object) getText()) + "\")";
        } finally {
    ...
    public final void commitEdit(TextFieldBuffer newValue) {
        ...
        boolean selectionChanged = !TextRange.m6921equalsimpl0(newValue.getSelectionInChars(), this.mainBuffer.getSelectionInChars());
        ...
        if (!textChanged) {
            ...
            newValue2 = newValue;
            recordEditForUndo(getValue$foundation(), TextFieldBuffer.m1325toTextFieldCharSequencewFTz33Y$foundation$default(newValue2, 0L, null, null, null, 15, null), newValue2.getChanges(), TextFieldEditUndoBehavior.NeverMerge);
        }
    ...
    public final void editWithNoSideEffects$foundation(Function1<? super TextFieldBuffer, Unit> block) {
        getMainBuffer().getChangeTracker$foundation().clearChanges();
        block.invoke(getMainBuffer());
        TextFieldCharSequence afterEditValue = TextFieldBuffer.m1325toTextFieldCharSequencewFTz33Y$foundation$default(getMainBuffer(), 0L, null, null, null, 15, null);
    ...
    public final void commitEditAsUser(InputTransformation inputTransformation, boolean restartImeIfContentChanges, TextFieldEditUndoBehavior undoBehavior) {
        ...
        if (this.mainBuffer.getChangeTracker$foundation().getChangeCount() == 0 && TextRange.m6921equalsimpl0(beforeEditValue.getSelection(), this.mainBuffer.getSelectionInChars())) {
            if (!Intrinsics.areEqual(beforeEditValue.getComposition(), this.mainBuffer.getComposition()) || !Intrinsics.areEqual(beforeEditValue.getHighlight(), this.mainBuffer.getHighlight$foundation()) || !Intrinsics.areEqual(beforeEditValue.getComposingAnnotations(), this.mainBuffer.getComposingAnnotations$foundation())) {
                updateValueAndNotifyListeners(getValue$foundation(), new TextFieldCharSequence(this.mainBuffer.toString(), this.mainBuffer.getSelectionInChars(), this.mainBuffer.getComposition(), this.mainBuffer.getHighlight$foundation(), TextFieldStateKt.m1340finalizeComposingAnnotationsitr0ztk(this.mainBuffer.getComposition(), this.mainBuffer.getComposingAnnotations$foundation()), null, 32, null), restartImeIfContentChanges);
                return;
            }
            return;
        }
        ...
        TextFieldCharSequence afterEditValue = new TextFieldCharSequence(this.mainBuffer.toString(), this.mainBuffer.getSelectionInChars(), this.mainBuffer.getComposition(), this.mainBuffer.getHighlight$foundation(), TextFieldStateKt.m1340finalizeComposingAnnotationsitr0ztk(this.mainBuffer.getComposition(), this.mainBuffer.getComposingAnnotations$foundation()), null, 32, null);
        ...
        boolean selectionChangedByFilter = !TextRange.m6921equalsimpl0(textFieldBuffer.getSelectionInChars(), afterEditValue.getSelection());
        if (textChangedByFilter || selectionChangedByFilter) {
            ...
            updateValueAndNotifyListeners(beforeEditValue, TextFieldBuffer.m1325toTextFieldCharSequencewFTz33Y$foundation$default(textFieldBuffer, 0L, afterEditValue.getComposition(), null, null, 13, null), restartImeIfContentChanges);
        }
    ...
    public final void syncMainBufferToTemporaryBuffer$foundation(TextFieldBuffer temporaryBuffer, boolean textChanged, boolean selectionChanged) {
        TextFieldCharSequence oldValue = TextFieldBuffer.m1325toTextFieldCharSequencewFTz33Y$foundation$default(this.mainBuffer, 0L, null, null, null, 15, null);
        if (textChanged) {
            ...
            this.mainBuffer.m1330setSelection5zctL8(TextRangeKt.TextRange(TextRange.m6928getStartimpl(temporaryBuffer.getSelectionInChars()), TextRange.m6923getEndimpl(temporaryBuffer.getSelectionInChars())));
        }
        ...
        TextFieldCharSequence finalValue = TextFieldBuffer.m1325toTextFieldCharSequencewFTz33Y$foundation$default(this.mainBuffer, 0L, null, null, null, 15, null);
        updateValueAndNotifyListeners(oldValue, finalValue, true);
    }

    /* JADX INFO: compiled from: TextFieldState.kt */
    @Metadata(d1 = {"\u0000\u001c\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0003\bÇ\u0002\u0018\u00002\u000e\u0012\u0004\u0012\u00020\u0002\u0012\u0004\u0012\u00020\u00030\u0001B\t\b\u0002¢\u0006\u0004\b\u0004\u0010\u0005J\u0016\u0010\u0006\u001a\u0004\u0018\u00010\u0003*\u00020\u00072\u0006\u0010\b\u001a\u00020\u0002H\u0016J\u0012\u0010\t\u001a\u0004\u0018\u00010\u00022\u0006\u0010\b\u001a\u00020\u0003H\u0016¨\u0006\n"}, d2 = {"Landroidx/compose/foundation/text/input/TextFieldState$Saver;", "Landroidx/compose/runtime/saveable/Saver;", "Landroidx/compose/foundation/text/input/TextFieldState;", "", "<init>", "()V", "save", "Landroidx/compose/runtime/saveable/SaverScope;", Values.VECTOR_MAP_VECTORS_KEY, "restore", "foundation"}, k = 1, mv = {2, 0, 0}, xi = 48)
    public static final class Saver implements androidx.compose.runtime.saveable.Saver<TextFieldState, Object> {
        ...
        public Object save(SaverScope $this$save, TextFieldState value) {
            ...
            Integer numValueOf = Integer.valueOf(TextRange.m6928getStartimpl(value.m1338getSelectiond9O1mEE()));
            Integer numValueOf2 = Integer.valueOf(TextRange.m6923getEndimpl(value.m1338getSelectiond9O1mEE()));
