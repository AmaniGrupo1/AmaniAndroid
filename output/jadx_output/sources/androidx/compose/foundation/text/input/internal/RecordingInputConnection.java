...
public final class RecordingInputConnection implements InputConnection {
    ...
    public final void updateInputState(TextFieldValue state, InputMethodManager inputMethodManager) {
        if (this.isActive) {
            ...
            int compositionStart = composition != null ? TextRange.m6926getMinimpl(composition.getPackedValue()) : -1;
            TextRange composition2 = state.getComposition();
            int compositionEnd = composition2 != null ? TextRange.m6925getMaximpl(composition2.getPackedValue()) : -1;
            inputMethodManager.updateSelection(TextRange.m6926getMinimpl(state.getSelection()), TextRange.m6925getMaximpl(state.getSelection()), compositionStart, compositionEnd);
        }
    }
    ...
    public CharSequence getSelectedText(int flags) {
        if (TextRange.m6922getCollapsedimpl(this.textFieldValue.getSelection())) {
            return null;
        }
    ...
    public boolean performEditorAction(int editorAction) {
        ...
        if (applying$iv) {
            switch (editorAction) {
                case 0:
                    imeAction = ImeAction.INSTANCE.m7109getDefaulteUduSuo();
                    break;
                case 1:
                default:
                    ...
                    break;
                case 2:
                    imeAction = ImeAction.INSTANCE.m7111getGoeUduSuo();
                    break;
                case 3:
                    imeAction = ImeAction.INSTANCE.m7115getSearcheUduSuo();
                    break;
                case 4:
                    imeAction = ImeAction.INSTANCE.m7116getSendeUduSuo();
                    break;
                case 5:
                    imeAction = ImeAction.INSTANCE.m7112getNexteUduSuo();
                    break;
                case 6:
                    imeAction = ImeAction.INSTANCE.m7110getDoneeUduSuo();
                    break;
                case 7:
                    imeAction = ImeAction.INSTANCE.m7114getPreviouseUduSuo();
                    break;
            }
            this.eventCallback.mo1404onImeActionKlQnJC8(imeAction);
            return true;
        }
        return applying$iv;
    }
    ...
    public int getCursorCapsMode(int reqModes) {
        return TextUtils.getCapsMode(this.textFieldValue.getText(), TextRange.m6926getMinimpl(this.textFieldValue.getSelection()), reqModes);
    }
