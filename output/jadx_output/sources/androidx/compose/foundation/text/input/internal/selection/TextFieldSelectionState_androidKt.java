...
public final class TextFieldSelectionState_androidKt {
    ...
    static final Unit addBasicTextFieldTextContextMenuComponents$lambda$0(final TextFieldSelectionState $state, final CoroutineScope $coroutineScope, TextContextMenuBuilderScope $this$addTextContextMenuComponentsWithContext, final Context context) {
        PlatformSelectionBehaviors_androidKt.m1600addPlatformTextContextMenuItems71BSaZU($this$addTextContextMenuComponentsWithContext, context, $state.getEditable$foundation(), $state.getTextFieldState().getVisualText().getText(), TextRange.m6916boximpl($state.getTextFieldState().getVisualText().getSelection()), $state.getPlatformSelectionBehaviors(), new Function1() { // from class: androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState_androidKt$$ExternalSyntheticLambda6
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
