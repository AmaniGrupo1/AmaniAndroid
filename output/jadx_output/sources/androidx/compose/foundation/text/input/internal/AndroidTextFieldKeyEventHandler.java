...
public final class AndroidTextFieldKeyEventHandler extends TextFieldKeyEventHandler {
    ...
    public boolean mo1363onPreKeyEventMyFupTE(KeyEvent event, TransformedTextFieldState textFieldState, TextFieldSelectionState textFieldSelectionState, FocusManager focusManager, SoftwareKeyboardController keyboardController) {
        boolean consumed = super.mo1363onPreKeyEventMyFupTE(event, textFieldState, textFieldSelectionState, focusManager, keyboardController);
        ...
        if (device != null && device.supportsSource(InputDeviceCompat.SOURCE_DPAD) && !device.isVirtual() && KeyEventType.m5846equalsimpl0(KeyEvent_androidKt.m5854getTypeZmokQxo(event), KeyEventType.INSTANCE.m5850getKeyDownCS__XNY()) && event.getSource() != 257) {
            if (TextFieldKeyEventHandler_androidKt.m1439isKeyCodeYhN2O0w(event, 19)) {
                return focusManager.mo4341moveFocus3ESFkO8(FocusDirection.INSTANCE.m4338getUpdhqQ8s());
            }
            if (TextFieldKeyEventHandler_androidKt.m1439isKeyCodeYhN2O0w(event, 20)) {
                return focusManager.mo4341moveFocus3ESFkO8(FocusDirection.INSTANCE.m4331getDowndhqQ8s());
            }
            if (TextFieldKeyEventHandler_androidKt.m1439isKeyCodeYhN2O0w(event, 21)) {
                return focusManager.mo4341moveFocus3ESFkO8(FocusDirection.INSTANCE.m4334getLeftdhqQ8s());
            }
            if (TextFieldKeyEventHandler_androidKt.m1439isKeyCodeYhN2O0w(event, 22)) {
                return focusManager.mo4341moveFocus3ESFkO8(FocusDirection.INSTANCE.m4337getRightdhqQ8s());
            }
            if (!TextFieldKeyEventHandler_androidKt.m1439isKeyCodeYhN2O0w(event, 23)) {
                return false;
            }
    ...
    public boolean mo1362onKeyEvent8zsqlwg(KeyEvent event, TransformedTextFieldState textFieldState, TextLayoutState textLayoutState, TextFieldSelectionState textFieldSelectionState, Function1<? super KeyCommand, ? extends Unit> clipboardKeyCommandsHandler, SoftwareKeyboardController keyboardController, boolean editable, boolean singleLine, Function0<Boolean> onSubmit) {
        if (KeyEventType.m5846equalsimpl0(KeyEvent_androidKt.m5854getTypeZmokQxo(event), KeyEventType.INSTANCE.m5850getKeyDownCS__XNY()) && event.isFromSource(257) && (!TextFieldKeyEventHandler_androidKt.m1438isFromSoftKeyboardZmokQxo(event) || !TextFieldKeyInput_androidKt.m1279isTypedEventZmokQxo(event))) {
            textFieldSelectionState.setInTouchMode(false);
        }
        return super.mo1362onKeyEvent8zsqlwg(event, textFieldState, textLayoutState, textFieldSelectionState, clipboardKeyCommandsHandler, keyboardController, editable, singleLine, onSubmit);
    }
}
