...
public final class TransformedTextFieldStateKt {
    public static final <R> R getIndexTransformationType(TransformedTextFieldState $this$getIndexTransformationType, int transformedQueryIndex, Function3<? super IndexTransformationType, ? super TextRange, ? super TextRange, ? extends R> function3) {
        ...
        long untransformed = $this$getIndexTransformationType.m1461mapFromTransformedjx7JFs(transformedQueryIndex);
        long retransformed = $this$getIndexTransformationType.m1464mapToTransformedGEjPoXI(untransformed);
        if (TextRange.m6922getCollapsedimpl(untransformed) && TextRange.m6922getCollapsedimpl(retransformed)) {
            type = IndexTransformationType.Untransformed;
        } else if (!TextRange.m6922getCollapsedimpl(untransformed) && !TextRange.m6922getCollapsedimpl(retransformed)) {
        ...
        return function3.invoke(type, TextRange.m6916boximpl(untransformed), TextRange.m6916boximpl(retransformed));
    }
}
