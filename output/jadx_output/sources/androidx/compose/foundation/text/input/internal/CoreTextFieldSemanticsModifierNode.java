...
public final class CoreTextFieldSemanticsModifierNode extends DelegatingNode implements SemanticsModifierNode {
    ...
    public void applySemantics(final SemanticsPropertyReceiver $this$applySemantics) {
        ...
        SemanticsPropertiesKt.m6719setTextSelectionRangeFDrldGo($this$applySemantics, this.value.getSelection());
        ...
        SemanticsPropertiesKt.m6715onImeAction9UiTYpY$default($this$applySemantics, this.imeOptions.getImeAction(), null, new Function0() { // from class: androidx.compose.foundation.text.input.internal.CoreTextFieldSemanticsModifierNode$$ExternalSyntheticLambda8
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
        ...
        if (!TextRange.m6922getCollapsedimpl(this.value.getSelection()) && !this.isPassword) {
    ...
    static final boolean applySemantics$lambda$4(CoreTextFieldSemanticsModifierNode this$0, SemanticsPropertyReceiver $this_applySemantics, AnnotatedString text) {
        ...
        if (session != null) {
            ...
            String newText = StringsKt.replaceRange((CharSequence) this$0.value.getText(), TextRange.m6928getStartimpl(this$0.value.getSelection()), TextRange.m6923getEndimpl(this$0.value.getSelection()), (CharSequence) text).toString();
            long newCursor = TextRangeKt.TextRange(TextRange.m6928getStartimpl(this$0.value.getSelection()) + text.length());
    ...
    static final boolean applySemantics$lambda$5(CoreTextFieldSemanticsModifierNode this$0, int selectionStart, int selectionEnd, boolean relativeToOriginalText) {
        ...
        if (start == TextRange.m6928getStartimpl(this$0.value.getSelection()) && end == TextRange.m6923getEndimpl(this$0.value.getSelection())) {
            return false;
        }
    ...
    static final boolean applySemantics$lambda$6(CoreTextFieldSemanticsModifierNode this$0) {
        this$0.state.getOnImeActionPerformed().invoke(ImeAction.m7093boximpl(this$0.imeOptions.getImeAction()));
        return true;
    }
    ...
    public final void updateNodeSemantics(TransformedText transformedText, TextFieldValue value, LegacyTextFieldState state, boolean readOnly, boolean enabled, boolean isPassword, OffsetMapping offsetMapping, TextFieldSelectionManager manager, ImeOptions imeOptions, FocusRequester focusRequester) {
        ...
        this.imeOptions = imeOptions;
        this.focusRequester = focusRequester;
        if (enabled != previousEnabled || editable != previousEditable || !Intrinsics.areEqual(imeOptions, previousImeOptions) || isPassword != previousIsPassword || !TextRange.m6922getCollapsedimpl(value.getSelection())) {
