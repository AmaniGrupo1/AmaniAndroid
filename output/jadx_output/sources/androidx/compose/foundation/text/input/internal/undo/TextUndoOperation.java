...
public final class TextUndoOperation {
    ...
    private static final Saver<TextUndoOperation, Object> Saver = new Saver<TextUndoOperation, Object>() { // from class: androidx.compose.foundation.text.input.internal.undo.TextUndoOperation$Companion$Saver$1
        ...
        public Object save(SaverScope $this$save, TextUndoOperation value) {
            return CollectionsKt.listOf(Integer.valueOf(value.getIndex()), value.getPreText(), value.getPostText(), Integer.valueOf(TextRange.m6928getStartimpl(value.getPreSelection())), Integer.valueOf(TextRange.m6923getEndimpl(value.getPreSelection())), Integer.valueOf(TextRange.m6928getStartimpl(value.getPostSelection())), Integer.valueOf(TextRange.m6923getEndimpl(value.getPostSelection())), Long.valueOf(value.getTimeInMillis()));
        }
    ...
    */
    ...
    public final TextDeleteType getDeletionType() {
        if (this.textEditType == TextEditType.Delete && TextRange.m6922getCollapsedimpl(this.postSelection)) {
            boolean zM6922getCollapsedimpl = TextRange.m6922getCollapsedimpl(this.preSelection);
            long j = this.preSelection;
            if (zM6922getCollapsedimpl) {
                if (TextRange.m6928getStartimpl(j) > TextRange.m6928getStartimpl(this.postSelection)) {
                    return TextDeleteType.Start;
                }
                return TextDeleteType.End;
            }
            if (TextRange.m6928getStartimpl(j) == TextRange.m6928getStartimpl(this.postSelection) && TextRange.m6928getStartimpl(this.preSelection) == this.index) {
