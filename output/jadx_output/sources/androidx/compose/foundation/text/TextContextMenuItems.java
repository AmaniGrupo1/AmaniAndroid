...
public enum TextContextMenuItems {
    Cut(TextContextMenuKeys.INSTANCE.getCutKey(), ContextMenuStrings.INSTANCE.m1188getCut9Hzcbyc(), ContextMenuIcons.INSTANCE.m1175getActionModeCutDrawable3I4p1mQ()),
    Copy(TextContextMenuKeys.INSTANCE.getCopyKey(), ContextMenuStrings.INSTANCE.m1187getCopy9Hzcbyc(), ContextMenuIcons.INSTANCE.m1174getActionModeCopyDrawable3I4p1mQ()),
    Paste(TextContextMenuKeys.INSTANCE.getPasteKey(), ContextMenuStrings.INSTANCE.m1189getPaste9Hzcbyc(), ContextMenuIcons.INSTANCE.m1176getActionModePasteDrawable3I4p1mQ()),
    SelectAll(TextContextMenuKeys.INSTANCE.getSelectAllKey(), ContextMenuStrings.INSTANCE.m1190getSelectAll9Hzcbyc(), ContextMenuIcons.INSTANCE.m1177getActionModeSelectAllDrawable3I4p1mQ()),
    Autofill(TextContextMenuKeys.INSTANCE.getAutofillKey(), ContextMenuStrings.INSTANCE.m1186getAutofill9Hzcbyc(), ContextMenuIcons.INSTANCE.m1178getID_NULL3I4p1mQ());
    ...
    public final String resolvedString(Composer $composer, int $changed) {
        ...
        String strM1191getStringtk4Tqcs = ContextMenuStrings_androidKt.m1191getStringtk4Tqcs(this.stringId, $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd($composer);
        return strM1191getStringtk4Tqcs;
    }
}
