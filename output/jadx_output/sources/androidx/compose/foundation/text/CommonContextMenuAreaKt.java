...
public final class CommonContextMenuAreaKt {
    ...
    static final class C03192 extends ContinuationImpl {
        Object L$0;
        int label;
        /* synthetic */ Object result;

        C03192(Continuation<? super C03192> continuation) {
            super(continuation);
        }
        ...
        if ($composer3.shouldExecute(($dirty2 & 19) != 18, $dirty2 & 1)) {
            ...
            if (ComposeFoundationFlags.isNewContextMenuEnabled) {
                ...
                if (it$iv2 == Composer.INSTANCE.getEmpty()) {
                    Object value$iv2 = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(MenuItemsAvailability.m1227boximpl(MenuItemsAvailability.INSTANCE.m1240getNoneJKCFgKw()), null, 2, null);
    ...
    public static final void CommonContextMenuArea(final TextFieldSelectionState selectionState, boolean enabled, final Function2<? super Composer, ? super Integer, Unit> function2, Composer $composer, final int $changed) {
        ...
        if ($composer3.shouldExecute(($dirty2 & 147) != 146, $dirty2 & 1)) {
            ...
            if (ComposeFoundationFlags.isNewContextMenuEnabled) {
                ...
                Object it$iv3 = $composer3.rememberedValue();
                if (it$iv3 == Composer.INSTANCE.getEmpty()) {
                    Object value$iv3 = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(MenuItemsAvailability.m1227boximpl(MenuItemsAvailability.INSTANCE.m1240getNoneJKCFgKw()), null, 2, null);
                    $composer3.updateRememberedValue(value$iv3);
                    it$iv3 = value$iv3;
                }
    ...
    */
    public static final Object getContextMenuItemsAvailability(TextFieldSelectionState $this$getContextMenuItemsAvailability, Continuation<? super MenuItemsAvailability> continuation) {
        C03181 c03181;
        if (continuation instanceof C03181) {
            c03181 = (C03181) continuation;
            if ((c03181.label & Integer.MIN_VALUE) != 0) {
                c03181.label -= Integer.MIN_VALUE;
            } else {
                c03181 = new C03181(continuation);
            }
        }
        Object $result = c03181.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        switch (c03181.label) {
            case 0:
                ResultKt.throwOnFailure($result);
                c03181.L$0 = $this$getContextMenuItemsAvailability;
                c03181.label = 1;
                if ($this$getContextMenuItemsAvailability.updateClipboardEntry(c03181) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                break;
            case 1:
                $this$getContextMenuItemsAvailability = (TextFieldSelectionState) c03181.L$0;
                ResultKt.throwOnFailure($result);
                break;
            default:
                throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
        }
        return MenuItemsAvailability.m1227boximpl(MenuItemsAvailability.m1229constructorimpl($this$getContextMenuItemsAvailability.canShowCopyMenuItem(), $this$getContextMenuItemsAvailability.canShowPasteMenuItem(), $this$getContextMenuItemsAvailability.canShowCutMenuItem(), $this$getContextMenuItemsAvailability.canShowSelectAllMenuItem(), $this$getContextMenuItemsAvailability.canShowAutofillMenuItem()));
    }
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public static final Object getContextMenuItemsAvailability(TextFieldSelectionManager $this$getContextMenuItemsAvailability, Continuation<? super MenuItemsAvailability> continuation) {
        C03192 c03192;
        if (continuation instanceof C03192) {
            c03192 = (C03192) continuation;
            if ((c03192.label & Integer.MIN_VALUE) != 0) {
                c03192.label -= Integer.MIN_VALUE;
            } else {
                c03192 = new C03192(continuation);
            }
        }
        ...
        switch (c03192.label) {
            case 0:
                ResultKt.throwOnFailure($result);
                c03192.L$0 = $this$getContextMenuItemsAvailability;
                c03192.label = 1;
                if ($this$getContextMenuItemsAvailability.updateClipboardEntry$foundation(c03192) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                break;
            case 1:
                $this$getContextMenuItemsAvailability = (TextFieldSelectionManager) c03192.L$0;
                ResultKt.throwOnFailure($result);
                break;
            default:
                throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
        }
        return MenuItemsAvailability.m1227boximpl(MenuItemsAvailability.m1229constructorimpl($this$getContextMenuItemsAvailability.canShowCopyMenuItem$foundation(), $this$getContextMenuItemsAvailability.canShowPasteMenuItem$foundation(), $this$getContextMenuItemsAvailability.canShowCutMenuItem$foundation(), $this$getContextMenuItemsAvailability.canShowSelectAllMenuItem$foundation(), $this$getContextMenuItemsAvailability.canShowAutofillMenuItem$foundation()));
    }
}
