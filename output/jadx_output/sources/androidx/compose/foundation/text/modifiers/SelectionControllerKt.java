...
public final class SelectionControllerKt {
    ...
    public static final Modifier makeDefaultSelectionModifier(final SelectionRegistrar $this$makeDefaultSelectionModifier, final long selectableId, final Function0<? extends LayoutCoordinates> function0) {
        final ?? r0 = new TextDragObserver() { // from class: androidx.compose.foundation.text.modifiers.SelectionControllerKt$makeDefaultSelectionModifier$longPressDragObserver$1
            private long lastPosition = Offset.INSTANCE.m4468getZeroF1C5BW0();
            ...
            public void mo1255onStart3MmeM6k(long startPoint, SelectionAdjustment selectionAdjustment) {
                ...
                if (it != null) {
                    ...
                    selectionRegistrar.mo1644notifySelectionUpdateStartubNVwUQ(it, startPoint, this.selectionAdjustmentMode, true);
            ...
            public void mo1254onDragk4lQ0M(long delta) {
                ...
                if (it != null) {
                    ...
                    if (it.isAttached() && SelectionRegistrarKt.hasSelection(selectionRegistrar, j)) {
                        ...
                        long newPosition = Offset.m4457plusMKHz9U(this.lastPosition, this.dragTotalDistance);
                        boolean consumed = selectionRegistrar.mo1643notifySelectionUpdatenjBpvok(it, newPosition, this.lastPosition, false, this.selectionAdjustmentMode, true);
                        if (consumed) {
        ...
        final ?? r1 = new MouseSelectionObserver() { // from class: androidx.compose.foundation.text.modifiers.SelectionControllerKt$makeDefaultSelectionModifier$mouseSelectionObserver$1
            ...
            public boolean mo1514onExtendk4lQ0M(long downPosition) {
                ...
                boolean consumed = selectionRegistrar.mo1643notifySelectionUpdatenjBpvok(layoutCoordinates, downPosition, this.lastPosition, false, SelectionAdjustment.INSTANCE.getNone(), false);
                if (consumed) {
            ...
            public boolean mo1515onExtendDragk4lQ0M(long dragPosition) {
                ...
                if (layoutCoordinates != null) {
                    ...
                    boolean consumed = selectionRegistrar.mo1643notifySelectionUpdatenjBpvok(layoutCoordinates, dragPosition, this.lastPosition, false, SelectionAdjustment.INSTANCE.getNone(), false);
                    if (consumed) {
            ...
            public boolean mo1516onStart9KIMszo(long downPosition, SelectionAdjustment adjustment, int clickCount) {
                ...
                selectionRegistrar.mo1644notifySelectionUpdateStartubNVwUQ(it, downPosition, adjustment, false);
                this.lastPosition = downPosition;
                return SelectionRegistrarKt.hasSelection(selectionRegistrar, j);
            }
            ...
            public boolean mo1513onDrag3MmeM6k(long dragPosition, SelectionAdjustment adjustment) {
                ...
                if (it != null) {
                    ...
                    boolean consumed = selectionRegistrar.mo1643notifySelectionUpdatenjBpvok(it, dragPosition, this.lastPosition, false, adjustment, false);
                    if (consumed) {
                        this.lastPosition = dragPosition;
                        return true;
                    }
