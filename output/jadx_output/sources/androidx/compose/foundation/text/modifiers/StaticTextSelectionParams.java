...
public class StaticTextSelectionParams {
    ...
    public boolean getShouldClip() {
        ...
        return (it == null || TextOverflow.m7406equalsimpl0(it.getLayoutInput().getOverflow(), TextOverflow.INSTANCE.m7419getVisiblegIe3tQ8()) || !it.getHasVisualOverflow()) ? false : true;
    }
