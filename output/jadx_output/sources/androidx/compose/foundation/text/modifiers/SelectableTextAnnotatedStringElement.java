...
public final class SelectableTextAnnotatedStringElement extends ModifierNodeElement<SelectableTextAnnotatedStringNode> {
    ...
    public void update(SelectableTextAnnotatedStringNode node) {
        node.m1574update7NebLg4(this.text, this.style, this.placeholders, this.minLines, this.maxLines, this.softWrap, this.fontFamilyResolver, this.overflow, this.onTextLayout, this.onPlaceholderLayout, this.selectionController, this.color, this.autoSize);
    }
    ...
    public int hashCode() {
        ...
        int result3 = (((((((((result2 + (function1 != null ? function1.hashCode() : 0)) * 31) + TextOverflow.m7407hashCodeimpl(this.overflow)) * 31) + Boolean.hashCode(this.softWrap)) * 31) + this.maxLines) * 31) + this.minLines) * 31;
