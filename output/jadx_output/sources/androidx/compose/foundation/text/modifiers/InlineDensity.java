...
public final class InlineDensity {
    ...
    public boolean equals(Object other) {
        return m1527equalsimpl(this.packedValue, other);
    }
    ...
    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static long m1524constructorimpl(float density, float fontScale) {
        long v1$iv = Float.floatToRawIntBits(density);
        long v2$iv = Float.floatToRawIntBits(fontScale);
        return m1525constructorimpl((v1$iv << 32) | (4294967295L & v2$iv));
    }
