...
public final class MultiParagraphLayoutCache {
    ...
    private MultiParagraphLayoutCache(AnnotatedString text, TextStyle style, FontFamily.Resolver fontFamilyResolver, int overflow, boolean softWrap, int maxLines, int minLines, List<AnnotatedString.Range<Placeholder>> list, TextAutoSize autoSize) {
        ...
        this.lastDensity = InlineDensity.INSTANCE.m1534getUnspecifiedL26CHvs();
        this.style = style;
    ...
    public /* synthetic */ MultiParagraphLayoutCache(AnnotatedString annotatedString, TextStyle textStyle, FontFamily.Resolver resolver, int i, boolean z, int i2, int i3, List list, TextAutoSize textAutoSize, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this(annotatedString, textStyle, resolver, (i4 & 8) != 0 ? TextOverflow.INSTANCE.m7415getClipgIe3tQ8() : i, (i4 & 16) != 0 ? true : z, (i4 & 32) != 0 ? Integer.MAX_VALUE : i2, (i4 & 64) != 0 ? 1 : i3, (i4 & 128) != 0 ? null : list, (i4 & 256) != 0 ? null : textAutoSize, null);
    }
    ...
    public final void setDensity$foundation(Density value) {
        ...
        long newDensity = value != null ? InlineDensity.m1526constructorimpl(value) : InlineDensity.INSTANCE.m1534getUnspecifiedL26CHvs();
        if (localField == null) {
            this.density = value;
            this.lastDensity = newDensity;
        } else if (value == null || !InlineDensity.m1528equalsimpl0(this.lastDensity, newDensity)) {
            this.density = value;
            this.lastDensity = newDensity;
            m1557recordHistory4ETZmGE(LayoutCacheOperation.INSTANCE.m1543getMarkDirtyDensityDEKiAbY());
            markDirty();
        }
    }
    ...
    private final void m1557recordHistory4ETZmGE(long op) {
        this.historyFlag = (this.historyFlag << 2) | op;
    }

    /* JADX INFO: renamed from: layoutWithConstraints-K40F9xA, reason: not valid java name */
    public final boolean m1560layoutWithConstraintsK40F9xA(long constraints, LayoutDirection layoutDirection) {
        long finalConstraints;
        m1557recordHistory4ETZmGE(LayoutCacheOperation.INSTANCE.m1542getLayoutWithConstraintsDEKiAbY());
        if (this.minLines > 1) {
            finalConstraints = m1559useMinLinesConstrainerOh53vG4(constraints, layoutDirection);
        } else {
            finalConstraints = constraints;
        }
        if (!m1556newLayoutWillBeDifferentVKLhPVY(this.layoutCache, finalConstraints, layoutDirection)) {
            TextLayoutResult textLayoutResult = this.layoutCache;
            Intrinsics.checkNotNull(textLayoutResult);
            if (Constraints.m7451equalsimpl0(finalConstraints, textLayoutResult.getLayoutInput().getConstraints())) {
                return false;
            }
            TextLayoutResult textLayoutResult2 = this.layoutCache;
            Intrinsics.checkNotNull(textLayoutResult2);
            this.layoutCache = m1558textLayoutResultVKLhPVY(layoutDirection, finalConstraints, textLayoutResult2.getMultiParagraph());
            return true;
        }
        if (this.autoSize != null) {
            this.intrinsicsLayoutDirection = layoutDirection;
            long fontSizeBeforeLayout = this.style.m6959getFontSizeXSAIIZE();
            ...
            long autoSizeFontSize = $this$layoutWithConstraints_K40F9xA_u24lambda_u240.mo1131getFontSizeCi0_558($this$layoutWithConstraints_K40F9xA_u24lambda_u240_u240, constraints, this.text);
            if (TextUnit.m7701isEmimpl(autoSizeFontSize)) {
                autoSizeFontSize = MultiParagraphLayoutCacheKt.m1564timesNB67dxo(fontSizeBeforeLayout, autoSizeFontSize);
            }
            TextLayoutResult autoSizeLayoutCache = getFontSizeSearchScope().getLastLayoutResult();
            if (autoSizeLayoutCache == null || !TextUnit.m7696equalsimpl0(autoSizeFontSize, autoSizeLayoutCache.getLayoutInput().getStyle().m6959getFontSizeXSAIIZE()) || !TextOverflow.m7406equalsimpl0(autoSizeLayoutCache.getLayoutInput().getOverflow(), this.overflow)) {
                long optimalFontSize = autoSizeFontSize;
                setStyle(TextStyle.m6941copyp1EtxEg$default(this.style, 0L, optimalFontSize, null, null, null, null, null, 0L, null, null, null, 0L, null, null, null, 0, 0, 0L, null, null, null, 0, 0, null, 16777213, null));
            } else {
                this.layoutCache = autoSizeLayoutCache;
                return true;
            }
        }
        MultiParagraph multiParagraph = m1555layoutTextK40F9xA(finalConstraints, layoutDirection);
        this.layoutCache = m1558textLayoutResultVKLhPVY(layoutDirection, finalConstraints, multiParagraph);
        return true;
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: useMinLinesConstrainer-Oh53vG4, reason: not valid java name */
    public final long m1559useMinLinesConstrainerOh53vG4(long constraints, LayoutDirection layoutDirection) {
        ...
        return localMin.m1550coerceMinLinesOh53vG4$foundation(constraints, this.minLines);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: textLayoutResult-VKLhPVY, reason: not valid java name */
    public final TextLayoutResult m1558textLayoutResultVKLhPVY(LayoutDirection layoutDirection, long finalConstraints, MultiParagraph multiParagraph) {
        ...
        return new TextLayoutResult(textLayoutInput, multiParagraph, ConstraintsKt.m7472constrain4WqzIAM(finalConstraints, IntSize.m7671constructorimpl((((long) width$iv) << 32) | (((long) height$iv) & 4294967295L))), null);
    }
    ...
    public final int intrinsicHeight(int width, LayoutDirection layoutDirection) {
        ...
        int result = RangesKt.coerceAtLeast(TextDelegateKt.ceilToIntPx(m1555layoutTextK40F9xA(finalConstraints, layoutDirection).getHeight()), Constraints.m7459getMinHeightimpl(finalConstraints));
    ...
    public final void m1561updateJ2qo7bo(AnnotatedString text, TextStyle style, FontFamily.Resolver fontFamilyResolver, int overflow, boolean softWrap, int maxLines, int minLines, List<AnnotatedString.Range<Placeholder>> placeholders, TextAutoSize autoSize) {
        this.text = text;
        setStyle(style);
        this.fontFamilyResolver = fontFamilyResolver;
        this.overflow = overflow;
        ...
        this.autoSize = autoSize;
        m1557recordHistory4ETZmGE(LayoutCacheOperation.INSTANCE.m1544getMarkDirtyNodeDEKiAbY());
        markDirty();
    }
    ...
    public final MultiParagraph m1555layoutTextK40F9xA(long constraints, LayoutDirection layoutDirection) {
        MultiParagraphIntrinsics localParagraphIntrinsics = setLayoutDirection(layoutDirection);
        return new MultiParagraph(localParagraphIntrinsics, LayoutUtilsKt.m1546finalConstraintstfFHcEY(constraints, this.softWrap, this.overflow, localParagraphIntrinsics.getMaxIntrinsicWidth()), LayoutUtilsKt.m1547finalMaxLinesxdlQI24(this.softWrap, this.overflow, this.maxLines), this.overflow, (DefaultConstructorMarker) null);
    }

    /* JADX INFO: renamed from: newLayoutWillBeDifferent-VKLhPVY, reason: not valid java name */
    private final boolean m1556newLayoutWillBeDifferentVKLhPVY(TextLayoutResult $this$newLayoutWillBeDifferent_u2dVKLhPVY, long j, LayoutDirection layoutDirection) {
        ...
        if (Constraints.m7451equalsimpl0(j, $this$newLayoutWillBeDifferent_u2dVKLhPVY.getLayoutInput().getConstraints())) {
            return false;
        }
        return Constraints.m7458getMaxWidthimpl(j) != Constraints.m7458getMaxWidthimpl($this$newLayoutWillBeDifferent_u2dVKLhPVY.getLayoutInput().getConstraints()) || Constraints.m7460getMinWidthimpl(j) != Constraints.m7460getMinWidthimpl($this$newLayoutWillBeDifferent_u2dVKLhPVY.getLayoutInput().getConstraints()) || ((float) Constraints.m7457getMaxHeightimpl(j)) < $this$newLayoutWillBeDifferent_u2dVKLhPVY.getMultiParagraph().getHeight() || $this$newLayoutWillBeDifferent_u2dVKLhPVY.getMultiParagraph().getDidExceedMaxLines();
    }
    ...
    private final void markStyleAffectedDirty() {
        m1557recordHistory4ETZmGE(LayoutCacheOperation.INSTANCE.m1545getMarkDirtyStyleDEKiAbY());
        this.paragraphIntrinsics = null;
        this.layoutCache = null;
        this.cachedIntrinsicHeight = -1;
        this.cachedIntrinsicHeightInputWidth = -1;
    ...
    private final class TextAutoSizeLayoutScopeImpl implements TextAutoSizeLayoutScope {
        ...
        public TextLayoutResult mo1562performLayout5ZSfY2I(long constraints, AnnotatedString text, long fontSize) {
            long jM1564timesNB67dxo;
            long layoutConstraints;
            TextStyle styleBeforeLayout = MultiParagraphLayoutCache.this.style;
            if (TextUnit.m7701isEmimpl(fontSize)) {
                jM1564timesNB67dxo = MultiParagraphLayoutCacheKt.m1564timesNB67dxo(MultiParagraphLayoutCache.this.style.m6959getFontSizeXSAIIZE(), fontSize);
            } else {
                jM1564timesNB67dxo = fontSize;
            }
            long scaledFontSize = jM1564timesNB67dxo;
            if (!TextUnit.m7696equalsimpl0(scaledFontSize, MultiParagraphLayoutCache.this.style.m6959getFontSizeXSAIIZE())) {
                MultiParagraphLayoutCache.this.setStyle(TextStyle.m6941copyp1EtxEg$default(MultiParagraphLayoutCache.this.style, 0L, scaledFontSize, null, null, null, null, null, 0L, null, null, null, 0L, null, null, null, 0, 0, 0L, null, null, null, 0, 0, null, 16777213, null));
            }
            if (MultiParagraphLayoutCache.this.minLines > 1) {
                ...
                layoutConstraints = multiParagraphLayoutCache.m1559useMinLinesConstrainerOh53vG4(constraints, layoutDirection);
            } else {
            ...
            MultiParagraph multiParagraph = multiParagraphLayoutCache2.m1555layoutTextK40F9xA(layoutConstraints, layoutDirection2);
            ...
            TextLayoutResult layoutResult = multiParagraphLayoutCache3.m1558textLayoutResultVKLhPVY(layoutDirection3, layoutConstraints, multiParagraph);
        ...
        public float mo404toPxR2X_6o(long j) {
            if (TextUnit.m7701isEmimpl(j)) {
                if (!TextUnit.m7701isEmimpl(MultiParagraphLayoutCache.this.style.m6959getFontSizeXSAIIZE())) {
                    if (!TextUnit.m7696equalsimpl0(MultiParagraphLayoutCache.this.style.m6959getFontSizeXSAIIZE(), TextUnit.INSTANCE.m7710getUnspecifiedXSAIIZE())) {
                        return mo404toPxR2X_6o(MultiParagraphLayoutCache.this.style.m6959getFontSizeXSAIIZE()) * TextUnit.m7699getValueimpl(j);
                    }
    ...
    public String toString() {
        ...
        StringBuilder sbAppend = new StringBuilder().append("MultiParagraphLayoutCache(textLayoutResult=");
        TextLayoutResult textLayoutResult = this.layoutCache;
        Object objM7445boximpl = AbstractJsonLexerKt.NULL;
        StringBuilder sbAppend2 = sbAppend.append(textLayoutResult != null ? "<TextLayoutResult>" : AbstractJsonLexerKt.NULL).append(", lastDensity=").append((Object) InlineDensity.m1532toStringimpl(this.lastDensity)).append(", history=").append(this.historyFlag).append(", constraints=");
        TextLayoutResult textLayoutResult2 = this.layoutCache;
        if (textLayoutResult2 != null && (layoutInput = textLayoutResult2.getLayoutInput()) != null) {
            objM7445boximpl = Constraints.m7445boximpl(layoutInput.getConstraints());
        }
        return sbAppend2.append(objM7445boximpl).append(')').toString();
    }
}
