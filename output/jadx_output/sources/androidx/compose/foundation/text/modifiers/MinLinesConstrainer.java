...
public final class MinLinesConstrainer {
    ...
    public final long m1550coerceMinLinesOh53vG4$foundation(long inConstraints, int minLines) {
        int minHeight;
        ...
        if (Float.isNaN(oneLineHeight) || Float.isNaN(lineHeight)) {
            oneLineHeight = ParagraphKt.m6807ParagraphUl8oQg4(MinLinesConstrainerKt.EmptyTextReplacement, this.resolvedStyle, ConstraintsKt.Constraints$default(0, 0, 0, 0, 15, null), this.density, this.fontFamilyResolver, (64 & 32) != 0 ? CollectionsKt.emptyList() : null, (64 & 64) != 0 ? CollectionsKt.emptyList() : null, (64 & 128) != 0 ? Integer.MAX_VALUE : 1, (64 & 256) != 0 ? TextOverflow.INSTANCE.m7415getClipgIe3tQ8() : TextOverflow.INSTANCE.m7415getClipgIe3tQ8()).getHeight();
            float twoLineHeight = ParagraphKt.m6807ParagraphUl8oQg4(MinLinesConstrainerKt.TwoLineTextReplacement, this.resolvedStyle, ConstraintsKt.Constraints$default(0, 0, 0, 0, 15, null), this.density, this.fontFamilyResolver, (64 & 32) != 0 ? CollectionsKt.emptyList() : null, (64 & 64) != 0 ? CollectionsKt.emptyList() : null, (64 & 128) != 0 ? Integer.MAX_VALUE : 2, (64 & 256) != 0 ? TextOverflow.INSTANCE.m7415getClipgIe3tQ8() : TextOverflow.INSTANCE.m7415getClipgIe3tQ8()).getHeight();
        ...
        if (minLines != 1) {
            ...
            minHeight = RangesKt.coerceAtMost(RangesKt.coerceAtLeast(Math.round($this$fastRoundToInt$iv), 0), Constraints.m7457getMaxHeightimpl(inConstraints));
        } else {
            minHeight = Constraints.m7459getMinHeightimpl(inConstraints);
        }
        return ConstraintsKt.Constraints(Constraints.m7460getMinWidthimpl(inConstraints), Constraints.m7458getMaxWidthimpl(inConstraints), minHeight, Constraints.m7457getMaxHeightimpl(inConstraints));
    }
}
