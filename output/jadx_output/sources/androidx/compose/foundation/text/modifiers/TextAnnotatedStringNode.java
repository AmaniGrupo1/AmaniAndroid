...
public final class TextAnnotatedStringNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, SemanticsModifierNode {
    ...
    public final boolean m1576updateLayoutRelatedArgsy0kMQk(TextStyle style, List<AnnotatedString.Range<Placeholder>> placeholders, int minLines, int maxLines, boolean softWrap, FontFamily.Resolver fontFamilyResolver, int overflow, TextAutoSize autoSize) {
        ...
        if (!TextOverflow.m7406equalsimpl0(this.overflow, overflow)) {
            this.overflow = overflow;
            changed = true;
        }
    ...
    private final boolean setSubstitution(AnnotatedString updatedText) {
        ...
        if (currentTextSubstitution != null) {
            ...
            layoutCache.m1561updateJ2qo7bo(updatedText, this.style, this.fontFamilyResolver, this.overflow, this.softWrap, this.maxLines, this.minLines, CollectionsKt.emptyList(), this.autoSize);
            return true;
        }
    ...
    */
    static final boolean applySemantics$lambda$0(TextAnnotatedStringNode this$0, List textLayoutResult) {
        TextLayoutResult it;
        TextLayoutResult inputLayout = this$0.getLayoutCache().getLayoutCache();
        if (inputLayout != null) {
            AnnotatedString text = inputLayout.getLayoutInput().getText();
            TextStyle textStyle = this$0.style;
            ColorProducer colorProducer = this$0.overrideColor;
            it = TextLayoutResult.m6896copyO0kMr_c$default(inputLayout, new TextLayoutInput(text, TextStyle.m6948mergedA7vx0o$default(textStyle, colorProducer != null ? colorProducer.mo1802invoke0d7_KjU() : Color.INSTANCE.m4733getUnspecified0d7_KjU(), 0L, null, null, null, null, null, 0L, null, null, null, 0L, null, null, null, 0, 0, 0L, null, null, 0, 0, null, null, 16777214, null), inputLayout.getLayoutInput().getPlaceholders(), inputLayout.getLayoutInput().getMaxLines(), inputLayout.getLayoutInput().getSoftWrap(), inputLayout.getLayoutInput().getOverflow(), inputLayout.getLayoutInput().getDensity(), inputLayout.getLayoutInput().getLayoutDirection(), inputLayout.getLayoutInput().getFontFamilyResolver(), inputLayout.getLayoutInput().getConstraints(), (DefaultConstructorMarker) null), 0L, 2, null);
            if (it != null) {
    ...
    public final MeasureResult m1575measureNonExtension3p2s80s(MeasureScope measureScope, Measurable measurable, long constraints) {
        return mo69measure3p2s80s(measureScope, measurable, constraints);
    }

    @Override // androidx.compose.ui.node.LayoutModifierNode
    /* JADX INFO: renamed from: measure-3p2s80s */
    public MeasureResult mo69measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long j) throws Throwable {
        ...
        try {
            ...
            boolean didChangeLayout = layoutCache.m1560layoutWithConstraintsK40F9xA(j, $this$measure_u2d3p2s80s.getLayoutDirection());
            ...
            try {
                try {
                    final Placeable placeable = measurable.mo6141measureBRTryo0(Constraints.INSTANCE.m7467fitPrioritizingWidthZbe2FdA((int) (textLayoutResult.getSize() >> 32), (int) (textLayoutResult.getSize() >> 32), (int) (textLayoutResult.getSize() & 4294967295L), (int) (textLayoutResult.getSize() & 4294967295L)));
                    int $i$f$unpackInt1 = (int) (textLayoutResult.getSize() >> 32);
                    int size = (int) (textLayoutResult.getSize() & 4294967295L);
                    Map<AlignmentLine, Integer> map = this.baselineCache;
                    Intrinsics.checkNotNull(map);
                    MeasureResult measureResultLayout = $this$measure_u2d3p2s80s.layout($i$f$unpackInt1, size, map, new Function1() { // from class: androidx.compose.foundation.text.modifiers.TextAnnotatedStringNode$$ExternalSyntheticLambda0
                        @Override // kotlin.jvm.functions.Function1
                        public final Object invoke(Object obj) {
    ...
    public void draw(ContentDrawScope $this$draw) throws Throwable {
        ...
        boolean willClip = textLayoutResult.getHasVisualOverflow() && !TextOverflow.m7406equalsimpl0(this.overflow, TextOverflow.INSTANCE.m7419getVisiblegIe3tQ8());
        if (willClip) {
            float width = (int) (textLayoutResult.getSize() >> 32);
            float height = (int) (textLayoutResult.getSize() & 4294967295L);
            ...
            Rect bounds = RectKt.m4492Recttz77jQw(jM4468getZeroF1C5BW0, Size.m4512constructorimpl(v2$iv$iv));
            canvas.save();
            z = false;
            Canvas.m4670clipRectmtrdDE$default(canvas, bounds, 0, 2, null);
        } else {
            z = false;
        }
        try {
            ...
            if (brush != null) {
                ...
                z2 = z;
                z3 = true;
                localParagraph.m6794painthn5TExg(canvas, brush, (64 & 4) != 0 ? Float.NaN : alpha, (64 & 8) != 0 ? null : shadow, (64 & 16) != 0 ? null : textDecoration2, (64 & 32) != 0 ? null : drawStyle2, (64 & 64) != 0 ? DrawScope.INSTANCE.m5273getDefaultBlendMode0nO6VwU() : 0);
            } else {
                z2 = z;
                z3 = true;
                Shadow shadow2 = shadow;
                ColorProducer colorProducer = this.overrideColor;
                long overrideColorVal = colorProducer != null ? colorProducer.mo1802invoke0d7_KjU() : Color.INSTANCE.m4733getUnspecified0d7_KjU();
                if (overrideColorVal != 16 ? true : z2) {
                    color = overrideColorVal;
                } else {
                    if (this.style.m6958getColor0d7_KjU() != 16 ? true : z2) {
                        color = this.style.m6958getColor0d7_KjU();
                    } else {
                        color = Color.INSTANCE.m4723getBlack0d7_KjU();
                    }
                }
                localParagraph.m6792paintLG529CI(canvas, (32 & 2) != 0 ? Color.INSTANCE.m4733getUnspecified0d7_KjU() : color, (32 & 4) != 0 ? null : shadow2, (32 & 8) != 0 ? null : textDecoration2, (32 & 16) == 0 ? drawStyle2 : null, (32 & 32) != 0 ? DrawScope.INSTANCE.m5273getDefaultBlendMode0nO6VwU() : 0);
            }
            TextSubstitutionValue textSubstitutionValue = this.textSubstitution;
