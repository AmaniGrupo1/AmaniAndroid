...
public final class TextStringSimpleNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, SemanticsModifierNode {
    ...
    public /* synthetic */ TextStringSimpleNode(String str, TextStyle textStyle, FontFamily.Resolver resolver, int i, boolean z, int i2, int i3, ColorProducer colorProducer, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, textStyle, resolver, (i4 & 8) != 0 ? TextOverflow.INSTANCE.m7415getClipgIe3tQ8() : i, (i4 & 16) != 0 ? true : z, (i4 & 32) != 0 ? Integer.MAX_VALUE : i2, (i4 & 64) != 0 ? 1 : i3, (i4 & 128) != 0 ? null : colorProducer, null);
    }
    ...
    public final boolean m1577updateLayoutRelatedArgsHuAbxIM(TextStyle style, int minLines, int maxLines, boolean softWrap, FontFamily.Resolver fontFamilyResolver, int overflow) {
    ...
    private final boolean setSubstitution(String updatedText) {
        ...
        if (currentTextSubstitution != null) {
            ...
            layoutCache.m1573updateL6sJoHM(updatedText, this.style, this.fontFamilyResolver, this.overflow, this.softWrap, this.maxLines, this.minLines);
            return true;
        }
    ...
    static final boolean applySemantics$lambda$0(TextStringSimpleNode this$0, List textLayoutResult) {
        ...
        TextLayoutResult layout = layoutCache.slowCreateTextLayoutResultOrNull(TextStyle.m6948mergedA7vx0o$default(textStyle, colorProducer != null ? colorProducer.mo1802invoke0d7_KjU() : Color.INSTANCE.m4733getUnspecified0d7_KjU(), 0L, null, null, null, null, null, 0L, null, null, null, 0L, null, null, null, 0, 0, 0L, null, null, 0, 0, null, null, 16777214, null));
        if (layout != null) {
    ...
    public MeasureResult mo69measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long j) throws Throwable {
        ...
        try {
            ...
            boolean didChangeLayout = layoutCache.m1571layoutWithConstraintsK40F9xA(j, $this$measure_u2d3p2s80s.getLayoutDirection());
            ...
            if (didChangeLayout) {
                try {
                    ...
                    try {
                        final Placeable placeable = measurable.mo6141measureBRTryo0(Constraints.INSTANCE.m7467fitPrioritizingWidthZbe2FdA((int) (layoutSize >> 32), (int) (layoutSize >> 32), (int) (layoutSize & 4294967295L), (int) (layoutSize & 4294967295L)));
                ...
                final Placeable placeable2 = measurable.mo6141measureBRTryo0(Constraints.INSTANCE.m7467fitPrioritizingWidthZbe2FdA((int) (layoutSize >> 32), (int) (layoutSize >> 32), (int) (layoutSize & 4294967295L), (int) (layoutSize & 4294967295L)));
    ...
    public void draw(ContentDrawScope $this$draw) {
        ...
        if (localParagraph != null) {
            ...
            if (willClip) {
                float width = (int) (layoutCache.getLayoutSize() >> 32);
                float height = (int) (4294967295L & layoutCache.getLayoutSize());
                canvas.save();
                Canvas.m4669clipRectN_I0leg$default(canvas, 0.0f, 0.0f, width, height, 0, 16, null);
            }
            try {
                ...
                if (brush == null) {
                    ...
                    long jMo1802invoke0d7_KjU = colorProducer != null ? colorProducer.mo1802invoke0d7_KjU() : Color.INSTANCE.m4733getUnspecified0d7_KjU();
                    long overrideColorVal = jMo1802invoke0d7_KjU;
                    boolean z = true;
                    if (jMo1802invoke0d7_KjU != 16) {
                        color = overrideColorVal;
                    } else {
                        if (this.style.m6958getColor0d7_KjU() == 16) {
                            z = false;
                        }
                        if (z) {
                    ...
                    Paragraph.m6796paintLG529CI$default(localParagraph, canvas, color, shadow2, textDecoration2, drawStyle2, 0, 32, null);
                } else {
                    float alpha = this.style.getAlpha();
                    Paragraph.m6798painthn5TExg$default(localParagraph, canvas, brush, alpha, shadow2, textDecoration2, drawStyle2, 0, 64, null);
                }
                if (willClip) {
                    return;
                } else {
