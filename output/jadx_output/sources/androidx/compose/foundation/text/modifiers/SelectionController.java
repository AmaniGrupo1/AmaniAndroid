...
public final class SelectionController implements RememberObserver {
    ...
    public final void draw(DrawScope drawScope) throws Throwable {
        ...
        if (!this.params.getShouldClip()) {
            DrawScope.m5261drawPathLG529CI$default(drawScope, selectionPath, this.backgroundSelectionColor, 0.0f, null, null, 0, 60, null);
            return;
        }
        int bits$iv$iv$iv$iv = (int) (drawScope.mo5271getSizeNHjbRc() >> 32);
        float right$iv = Float.intBitsToFloat(bits$iv$iv$iv$iv);
        int bits$iv$iv$iv$iv2 = (int) (drawScope.mo5271getSizeNHjbRc() & 4294967295L);
