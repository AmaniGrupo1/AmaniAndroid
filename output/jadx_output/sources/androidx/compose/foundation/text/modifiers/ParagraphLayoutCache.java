...
public final class ParagraphLayoutCache {
    ...
    private ParagraphLayoutCache(String text, TextStyle style, FontFamily.Resolver fontFamilyResolver, int overflow, boolean softWrap, int maxLines, int minLines) {
        ...
        this.layoutSize = IntSize.m7671constructorimpl((((long) 0) & 4294967295L) | (((long) 0) << 32));
        this.prevConstraints = Constraints.INSTANCE.m7468fixedJhjzzOo(0, 0);
    ...
    public /* synthetic */ ParagraphLayoutCache(String str, TextStyle textStyle, FontFamily.Resolver resolver, int i, boolean z, int i2, int i3, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, textStyle, resolver, (i4 & 8) != 0 ? TextOverflow.INSTANCE.m7415getClipgIe3tQ8() : i, (i4 & 16) != 0 ? true : z, (i4 & 32) != 0 ? Integer.MAX_VALUE : i2, (i4 & 64) != 0 ? 1 : i3, null);
    }
    ...
    public final void setDensity$foundation(Density value) {
        ...
        if (localField == null) {
            ...
            this.density = value;
            this.lastDensity = newDensity;
            m1566recordHistory4ETZmGE(LayoutCacheOperation.INSTANCE.m1543getMarkDirtyDensityDEKiAbY());
            markDirty();
        }
    }
    ...
    private final void m1566recordHistory4ETZmGE(long op) {
        this.historyFlag = (this.historyFlag << 2) | op;
    }

    /* JADX INFO: renamed from: layoutWithConstraints-K40F9xA, reason: not valid java name */
    public final boolean m1571layoutWithConstraintsK40F9xA(long constraints, LayoutDirection layoutDirection) {
        LayoutDirection layoutDirection2;
        long finalConstraints;
        boolean z;
        boolean z2;
        m1566recordHistory4ETZmGE(LayoutCacheOperation.INSTANCE.m1542getLayoutWithConstraintsDEKiAbY());
        if (this.minLines > 1) {
            layoutDirection2 = layoutDirection;
            finalConstraints = m1568useMinLinesConstrainereuUD3Qg$default(this, constraints, layoutDirection2, null, 4, null);
        } else {
            layoutDirection2 = layoutDirection;
            finalConstraints = constraints;
        }
        if (m1565newLayoutWillBeDifferentK40F9xA(finalConstraints, layoutDirection2)) {
            boolean z3 = false;
            Paragraph it = m1570layoutTextK40F9xA$foundation(finalConstraints, layoutDirection);
            ...
            long localSize = ConstraintsKt.m7472constrain4WqzIAM(finalConstraints, IntSize.m7671constructorimpl((((long) height$iv) & 4294967295L) | (((long) width$iv) << 32)));
            this.layoutSize = localSize;
            if (!TextOverflow.m7406equalsimpl0(this.overflow, TextOverflow.INSTANCE.m7419getVisiblegIe3tQ8()) && (((int) (localSize >> 32)) < it.getWidth() || ((int) (localSize & 4294967295L)) < it.getHeight())) {
                z3 = true;
            }
            this.didOverflow = z3;
            this.paragraph = it;
        ...
        if (Constraints.m7451equalsimpl0(finalConstraints, this.prevConstraints)) {
            return false;
        }
        ...
        long localSize2 = ConstraintsKt.m7472constrain4WqzIAM(finalConstraints, IntSize.m7671constructorimpl((((long) width$iv2) << 32) | (((long) height$iv2) & 4294967295L)));
        this.layoutSize = localSize2;
        if (TextOverflow.m7406equalsimpl0(this.overflow, TextOverflow.INSTANCE.m7419getVisiblegIe3tQ8())) {
            z = false;
        } else {
            z = false;
    ...
    private final long m1567useMinLinesConstrainereuUD3Qg(long constraints, LayoutDirection layoutDirection, TextStyle style) {
    ...
    public final int intrinsicHeight(int width, LayoutDirection layoutDirection) {
        ...
        if (this.minLines > 1) {
            ...
            layoutDirection2 = layoutDirection;
            finalConstraints = m1568useMinLinesConstrainereuUD3Qg$default(paragraphLayoutCache, constraints, layoutDirection2, null, 4, null);
        } else {
            paragraphLayoutCache = this;
            layoutDirection2 = layoutDirection;
            finalConstraints = constraints;
        }
        int result = RangesKt.coerceAtLeast(TextDelegateKt.ceilToIntPx(m1570layoutTextK40F9xA$foundation(finalConstraints, layoutDirection2).getHeight()), Constraints.m7459getMinHeightimpl(finalConstraints));
    ...
    public final void m1573updateL6sJoHM(String text, TextStyle style, FontFamily.Resolver fontFamilyResolver, int overflow, boolean softWrap, int maxLines, int minLines) {
        this.text = text;
        this.style = style;
        this.fontFamilyResolver = fontFamilyResolver;
        this.overflow = overflow;
        ...
        this.maxLines = maxLines;
        this.minLines = minLines;
        m1566recordHistory4ETZmGE(LayoutCacheOperation.INSTANCE.m1544getMarkDirtyNodeDEKiAbY());
        markDirty();
    }
    ...
    public final Paragraph m1570layoutTextK40F9xA$foundation(long constraints, LayoutDirection layoutDirection) {
        ParagraphIntrinsics localParagraphIntrinsics = setLayoutDirection(layoutDirection);
        return ParagraphKt.m6811ParagraphczeNHc(localParagraphIntrinsics, LayoutUtilsKt.m1546finalConstraintstfFHcEY(constraints, this.softWrap, this.overflow, localParagraphIntrinsics.getMaxIntrinsicWidth()), LayoutUtilsKt.m1547finalMaxLinesxdlQI24(this.softWrap, this.overflow, this.maxLines), this.overflow);
    }

    /* JADX INFO: renamed from: newLayoutWillBeDifferent-K40F9xA, reason: not valid java name */
    private final boolean m1565newLayoutWillBeDifferentK40F9xA(long constraints, LayoutDirection layoutDirection) {
        ...
        if (Constraints.m7451equalsimpl0(constraints, this.prevConstraints)) {
            return false;
        }
        return Constraints.m7458getMaxWidthimpl(constraints) != Constraints.m7458getMaxWidthimpl(this.prevConstraints) || Constraints.m7460getMinWidthimpl(constraints) != Constraints.m7460getMinWidthimpl(this.prevConstraints) || ((float) Constraints.m7457getMaxHeightimpl(constraints)) < localParagraph.getHeight() || localParagraph.getDidExceedMaxLines();
    }
    ...
    private final void markDirty() {
        ...
        this.cachedIntrinsicHeight = -1;
        this.prevConstraints = Constraints.INSTANCE.m7468fixedJhjzzOo(0, 0);
        this.layoutSize = IntSize.m7671constructorimpl((((long) 0) << 32) | (((long) 0) & 4294967295L));
    ...
    public final TextLayoutResult slowCreateTextLayoutResultOrNull(TextStyle style) {
        ...
        long finalConstraints = Constraints.m7446constructorimpl(ConstraintsKt.MaxDimensionsAndFocusMask & this.prevConstraints);
