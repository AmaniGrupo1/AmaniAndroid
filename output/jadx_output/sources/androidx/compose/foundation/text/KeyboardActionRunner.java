...
public final class KeyboardActionRunner implements KeyboardActionScope {
    ...
    public final boolean m1203runActionKlQnJC8(int imeAction) {
        ...
        } else if (ImeAction.m7096equalsimpl0(imeAction, ImeAction.INSTANCE.m7109getDefaulteUduSuo()) || ImeAction.m7096equalsimpl0(imeAction, ImeAction.INSTANCE.m7113getNoneeUduSuo())) {
            onSend = null;
        } else {
        ...
        return m1201defaultKeyboardActionWithResultKlQnJC8(imeAction);
    }

    /* JADX INFO: renamed from: defaultKeyboardActionWithResult-KlQnJC8, reason: not valid java name */
    private final boolean m1201defaultKeyboardActionWithResultKlQnJC8(int imeAction) {
        if (ImeAction.m7096equalsimpl0(imeAction, ImeAction.INSTANCE.m7112getNexteUduSuo())) {
            getFocusManager().mo4341moveFocus3ESFkO8(FocusDirection.INSTANCE.m4335getNextdhqQ8s());
            return true;
        }
        if (ImeAction.m7096equalsimpl0(imeAction, ImeAction.INSTANCE.m7114getPreviouseUduSuo())) {
            getFocusManager().mo4341moveFocus3ESFkO8(FocusDirection.INSTANCE.m4336getPreviousdhqQ8s());
            return true;
        }
        if (ImeAction.m7096equalsimpl0(imeAction, ImeAction.INSTANCE.m7110getDoneeUduSuo()) && this.keyboardController != null) {
    ...
    public void mo1202defaultKeyboardActionKlQnJC8(int imeAction) {
        m1201defaultKeyboardActionWithResultKlQnJC8(imeAction);
    }
}
