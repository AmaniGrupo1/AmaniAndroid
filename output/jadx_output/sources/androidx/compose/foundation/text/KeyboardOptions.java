...
public final class KeyboardOptions {
    ...
    private static final KeyboardOptions SecureTextField = new KeyboardOptions(0, (Boolean) false, KeyboardType.INSTANCE.m7168getPasswordPjHm6EE(), 0, (PlatformImeOptions) (null == true ? 1 : 0), (Boolean) (null == true ? 1 : 0), (LocaleList) null, 121, (DefaultConstructorMarker) null);
    ...
    public /* synthetic */ KeyboardOptions(int i, Boolean bool, int i2, int i3, PlatformImeOptions platformImeOptions, Boolean bool2, LocaleList localeList, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        int iM7144getUnspecifiedIUNYP9k = (i4 & 1) != 0 ? KeyboardCapitalization.INSTANCE.m7144getUnspecifiedIUNYP9k() : i;
        Boolean bool3 = (i4 & 2) != 0 ? null : bool;
        int iM7171getUnspecifiedPjHm6EE = (i4 & 4) != 0 ? KeyboardType.INSTANCE.m7171getUnspecifiedPjHm6EE() : i2;
        int iM7117getUnspecifiedeUduSuo = (i4 & 8) != 0 ? ImeAction.INSTANCE.m7117getUnspecifiedeUduSuo() : i3;
        PlatformImeOptions platformImeOptions2 = (i4 & 16) != 0 ? null : platformImeOptions;
        Boolean bool4 = (i4 & 32) != 0 ? null : bool2;
        this(iM7144getUnspecifiedIUNYP9k, bool3, iM7171getUnspecifiedPjHm6EE, iM7117getUnspecifiedeUduSuo, platformImeOptions2, bool4, (i4 & 64) == 0 ? localeList : null, (DefaultConstructorMarker) null);
    }
    ...
    public /* synthetic */ KeyboardOptions(int i, boolean z, int i2, int i3, PlatformImeOptions platformImeOptions, Boolean bool, LocaleList localeList, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this((i4 & 1) != 0 ? KeyboardCapitalization.INSTANCE.m7144getUnspecifiedIUNYP9k() : i, z, (i4 & 4) != 0 ? KeyboardType.INSTANCE.m7171getUnspecifiedPjHm6EE() : i2, (i4 & 8) != 0 ? ImeAction.INSTANCE.m7117getUnspecifiedeUduSuo() : i3, (i4 & 16) != 0 ? null : platformImeOptions, (i4 & 32) != 0 ? null : bool, (i4 & 64) != 0 ? null : localeList, (DefaultConstructorMarker) null);
    }
    ...
    public /* synthetic */ KeyboardOptions(int i, boolean z, int i2, int i3, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this((i4 & 1) != 0 ? KeyboardCapitalization.INSTANCE.m7144getUnspecifiedIUNYP9k() : i, (i4 & 2) != 0 ? Default.getAutoCorrectOrDefault() : z, (i4 & 4) != 0 ? KeyboardType.INSTANCE.m7171getUnspecifiedPjHm6EE() : i2, (i4 & 8) != 0 ? ImeAction.INSTANCE.m7109getDefaulteUduSuo() : i3, (DefaultConstructorMarker) null);
    }
    ...
    public /* synthetic */ KeyboardOptions(int i, boolean z, int i2, int i3, PlatformImeOptions platformImeOptions, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this((i4 & 1) != 0 ? KeyboardCapitalization.INSTANCE.m7142getNoneIUNYP9k() : i, (i4 & 2) != 0 ? Default.getAutoCorrectOrDefault() : z, (i4 & 4) != 0 ? KeyboardType.INSTANCE.m7170getTextPjHm6EE() : i2, (i4 & 8) != 0 ? ImeAction.INSTANCE.m7109getDefaulteUduSuo() : i3, (i4 & 16) != 0 ? null : platformImeOptions, (DefaultConstructorMarker) null);
    }
    ...
    private final int m1208getCapitalizationOrDefaultIUNYP9k() {
        KeyboardCapitalization keyboardCapitalizationM7129boximpl = KeyboardCapitalization.m7129boximpl(this.capitalization);
        int it = keyboardCapitalizationM7129boximpl.getValue();
        if (KeyboardCapitalization.m7132equalsimpl0(it, KeyboardCapitalization.INSTANCE.m7144getUnspecifiedIUNYP9k())) {
            keyboardCapitalizationM7129boximpl = null;
        }
        return keyboardCapitalizationM7129boximpl != null ? keyboardCapitalizationM7129boximpl.getValue() : KeyboardCapitalization.INSTANCE.m7142getNoneIUNYP9k();
    }
    ...
    private final int m1209getKeyboardTypeOrDefaultPjHm6EE() {
        KeyboardType keyboardTypeM7146boximpl = KeyboardType.m7146boximpl(this.keyboardType);
        int it = keyboardTypeM7146boximpl.getValue();
        if (KeyboardType.m7149equalsimpl0(it, KeyboardType.INSTANCE.m7171getUnspecifiedPjHm6EE())) {
            keyboardTypeM7146boximpl = null;
        }
        return keyboardTypeM7146boximpl != null ? keyboardTypeM7146boximpl.getValue() : KeyboardType.INSTANCE.m7170getTextPjHm6EE();
    }
    ...
    public final int m1216getImeActionOrDefaulteUduSuo$foundation() {
        ImeAction imeActionM7093boximpl = ImeAction.m7093boximpl(this.imeAction);
        int it = imeActionM7093boximpl.getValue();
        if (ImeAction.m7096equalsimpl0(it, ImeAction.INSTANCE.m7117getUnspecifiedeUduSuo())) {
            imeActionM7093boximpl = null;
        }
        return imeActionM7093boximpl != null ? imeActionM7093boximpl.getValue() : ImeAction.INSTANCE.m7109getDefaulteUduSuo();
    }
    ...
    private final boolean isCompletelyUnspecified() {
        return KeyboardCapitalization.m7132equalsimpl0(this.capitalization, KeyboardCapitalization.INSTANCE.m7144getUnspecifiedIUNYP9k()) && this.autoCorrectEnabled == null && KeyboardType.m7149equalsimpl0(this.keyboardType, KeyboardType.INSTANCE.m7171getUnspecifiedPjHm6EE()) && ImeAction.m7096equalsimpl0(this.imeAction, ImeAction.INSTANCE.m7117getUnspecifiedeUduSuo()) && this.platformImeOptions == null && this.showKeyboardOnFocus == null && this.hintLocales == null;
    }
    ...
    public final ImeOptions toImeOptions$foundation(boolean singleLine) {
        return new ImeOptions(singleLine, m1208getCapitalizationOrDefaultIUNYP9k(), getAutoCorrectOrDefault(), m1209getKeyboardTypeOrDefaultPjHm6EE(), m1216getImeActionOrDefaulteUduSuo$foundation(), this.platformImeOptions, getHintLocalesOrDefault(), (DefaultConstructorMarker) null);
    }
    ...
    public static /* synthetic */ KeyboardOptions m1205copyINvB4aQ$default(KeyboardOptions keyboardOptions, int i, Boolean bool, int i2, int i3, PlatformImeOptions platformImeOptions, Boolean bool2, LocaleList localeList, int i4, Object obj) {
        ...
        return keyboardOptions.m1211copyINvB4aQ(i, bool, i2, i3, platformImeOptions, bool2, (i4 & 64) != 0 ? null : localeList);
    }

    /* JADX INFO: renamed from: copy-INvB4aQ, reason: not valid java name */
    public final KeyboardOptions m1211copyINvB4aQ(int capitalization, Boolean autoCorrectEnabled, int keyboardType, int imeAction, PlatformImeOptions platformImeOptions, Boolean showKeyboardOnFocus, LocaleList hintLocales) {
    ...
    public static /* synthetic */ KeyboardOptions m1206copyINvB4aQ$default(KeyboardOptions keyboardOptions, int i, boolean z, int i2, int i3, PlatformImeOptions platformImeOptions, Boolean bool, LocaleList localeList, int i4, Object obj) {
        ...
        return keyboardOptions.m1212copyINvB4aQ(i, z, i2, i3, platformImeOptions, bool, localeList2);
    }
    ...
    /* JADX INFO: renamed from: copy-INvB4aQ, reason: not valid java name */
    public final /* synthetic */ KeyboardOptions m1212copyINvB4aQ(int capitalization, boolean autoCorrect, int keyboardType, int imeAction, PlatformImeOptions platformImeOptions, Boolean showKeyboardOnFocus, LocaleList hintLocales) {
    ...
    public static /* synthetic */ KeyboardOptions m1207copyij11fho$default(KeyboardOptions keyboardOptions, int i, boolean z, int i2, int i3, PlatformImeOptions platformImeOptions, int i4, Object obj) {
        ...
        return keyboardOptions.m1213copyij11fho(i, z, i2, i3, (i4 & 16) != 0 ? keyboardOptions.platformImeOptions : platformImeOptions);
    }

    @Deprecated(level = DeprecationLevel.HIDDEN, message = "Maintained for binary compatibility")
    /* JADX INFO: renamed from: copy-ij11fho, reason: not valid java name */
    public final /* synthetic */ KeyboardOptions m1213copyij11fho(int capitalization, boolean autoCorrect, int keyboardType, int imeAction, PlatformImeOptions platformImeOptions) {
    ...
    public final /* synthetic */ KeyboardOptions m1210copy3m2b7yw(int capitalization, boolean autoCorrect, int keyboardType, int imeAction) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof KeyboardOptions) && KeyboardCapitalization.m7132equalsimpl0(this.capitalization, ((KeyboardOptions) other).capitalization) && Intrinsics.areEqual(this.autoCorrectEnabled, ((KeyboardOptions) other).autoCorrectEnabled) && KeyboardType.m7149equalsimpl0(this.keyboardType, ((KeyboardOptions) other).keyboardType) && ImeAction.m7096equalsimpl0(this.imeAction, ((KeyboardOptions) other).imeAction) && Intrinsics.areEqual(this.platformImeOptions, ((KeyboardOptions) other).platformImeOptions) && Intrinsics.areEqual(this.showKeyboardOnFocus, ((KeyboardOptions) other).showKeyboardOnFocus) && Intrinsics.areEqual(this.hintLocales, ((KeyboardOptions) other).hintLocales);
    }

    public int hashCode() {
        int result = KeyboardCapitalization.m7133hashCodeimpl(this.capitalization);
        int i = result * 31;
        Boolean bool = this.autoCorrectEnabled;
        int result2 = i + (bool != null ? bool.hashCode() : 0);
        int result3 = ((((result2 * 31) + KeyboardType.m7150hashCodeimpl(this.keyboardType)) * 31) + ImeAction.m7097hashCodeimpl(this.imeAction)) * 31;
    ...
    public String toString() {
        return "KeyboardOptions(capitalization=" + ((Object) KeyboardCapitalization.m7134toStringimpl(this.capitalization)) + ", autoCorrectEnabled=" + this.autoCorrectEnabled + ", keyboardType=" + ((Object) KeyboardType.m7151toStringimpl(this.keyboardType)) + ", imeAction=" + ((Object) ImeAction.m7098toStringimpl(this.imeAction)) + ", platformImeOptions=" + this.platformImeOptions + "showKeyboardOnFocus=" + this.showKeyboardOnFocus + ", hintLocales=" + this.hintLocales + ')';
    }
    ...
    public final KeyboardOptions fillUnspecifiedValuesWith$foundation(KeyboardOptions other) {
        ...
        int value = keyboardCapitalizationM7129boximpl != null ? keyboardCapitalizationM7129boximpl.getValue() : other.capitalization;
        Boolean bool = this.autoCorrectEnabled;
        if (bool == null) {
        ...
        Boolean bool2 = bool;
        KeyboardType keyboardTypeM7146boximpl = KeyboardType.m7146boximpl(this.keyboardType);
        int it2 = keyboardTypeM7146boximpl.getValue();
        if (KeyboardType.m7149equalsimpl0(it2, KeyboardType.INSTANCE.m7171getUnspecifiedPjHm6EE())) {
            keyboardTypeM7146boximpl = null;
        }
        int value2 = keyboardTypeM7146boximpl != null ? keyboardTypeM7146boximpl.getValue() : other.keyboardType;
        ImeAction imeActionM7093boximpl = ImeAction.m7093boximpl(this.imeAction);
        int it3 = imeActionM7093boximpl.getValue();
        ImeAction imeAction = ImeAction.m7096equalsimpl0(it3, ImeAction.INSTANCE.m7117getUnspecifiedeUduSuo()) ? null : imeActionM7093boximpl;
