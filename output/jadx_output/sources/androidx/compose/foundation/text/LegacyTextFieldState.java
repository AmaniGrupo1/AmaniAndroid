...
public final class LegacyTextFieldState {
    ...
    private final MutableState minHeightForSingleLineField = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Dp.m7503boximpl(Dp.m7505constructorimpl(0)), null, 2, null);
    ...
    private final Function1<ImeAction, Boolean> onImeActionPerformedWithResult = new Function1() { // from class: androidx.compose.foundation.text.LegacyTextFieldState$$ExternalSyntheticLambda3
        @Override // kotlin.jvm.functions.Function1
        public final Object invoke(Object obj) {
            return Boolean.valueOf(this.f$0.keyboardActionRunner.m1203runActionKlQnJC8(((ImeAction) obj).getValue()));
        }
    };
    private final Paint highlightPaint = AndroidPaint_androidKt.Paint();
    private long selectionBackgroundColor = Color.INSTANCE.m4733getUnspecified0d7_KjU();

    /* JADX INFO: renamed from: selectionPreviewHighlightRange$delegate, reason: from kotlin metadata */
    private final MutableState selectionPreviewHighlightRange = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(TextRange.m6916boximpl(TextRange.INSTANCE.m6933getZerod9O1mEE()), null, 2, null);

    /* JADX INFO: renamed from: deletionPreviewHighlightRange$delegate, reason: from kotlin metadata */
    private final MutableState deletionPreviewHighlightRange = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(TextRange.m6916boximpl(TextRange.INSTANCE.m6933getZerod9O1mEE()), null, 2, null);
    ...
    public final float m1219getMinHeightForSingleLineFieldD9Ej5fM() {
        ...
        return ((Dp) $this$getValue$iv.getValue()).m7519unboximpl();
    }
    ...
    public final void m1223setMinHeightForSingleLineField0680j_4(float f) {
        ...
        $this$setValue$iv.setValue(Dp.m7503boximpl(f));
    }
    ...
    static final Unit onValueChange$lambda$0(LegacyTextFieldState this$0, TextFieldValue it) {
        ...
        this$0.m1225setSelectionPreviewHighlightRange5zctL8(TextRange.INSTANCE.m6933getZerod9O1mEE());
        this$0.m1222setDeletionPreviewHighlightRange5zctL8(TextRange.INSTANCE.m6933getZerod9O1mEE());
    ...
    static final Unit onImeActionPerformed$lambda$0(LegacyTextFieldState this$0, ImeAction imeAction) {
        this$0.keyboardActionRunner.m1203runActionKlQnJC8(imeAction.getValue());
        return Unit.INSTANCE;
    }
    ...
    public final void m1225setSelectionPreviewHighlightRange5zctL8(long j) {
        ...
        $this$setValue$iv.setValue(TextRange.m6916boximpl(j));
    }
    ...
    public final boolean hasHighlight() {
        return (TextRange.m6922getCollapsedimpl(m1221getSelectionPreviewHighlightRanged9O1mEE()) && TextRange.m6922getCollapsedimpl(m1218getDeletionPreviewHighlightRanged9O1mEE())) ? false : true;
    }

    /* JADX INFO: renamed from: update-fnh65Uc, reason: not valid java name */
    public final void m1226updatefnh65Uc(AnnotatedString untransformedText, AnnotatedString visualText, TextStyle textStyle, boolean softWrap, Density density, FontFamily.Resolver fontFamilyResolver, Function1<? super TextFieldValue, Unit> onValueChange, KeyboardActions keyboardActions, FocusManager focusManager, long selectionBackgroundColor) {
        ...
        TextDelegate newTextDelegate = TextDelegateKt.m1252updateTextDelegaterm0N8CA$default(this.textDelegate, visualText, textStyle, density, fontFamilyResolver, softWrap, 0, 0, 0, CollectionsKt.emptyList(), 448, null);
