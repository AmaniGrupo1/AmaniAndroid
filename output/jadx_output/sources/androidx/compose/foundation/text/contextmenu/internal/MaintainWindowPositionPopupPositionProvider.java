...
final class MaintainWindowPositionPopupPositionProvider implements PopupPositionProvider {
    ...
    public long mo373calculatePositionllwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
        ...
        if (position == null) {
            ...
            boolean zM7674equalsimpl0 = false;
            if (!(intSize == null ? false : IntSize.m7674equalsimpl0(intSize.m7680unboximpl(), windowSize)) || this.previousLayoutDirection != layoutDirection) {
                j = popupContentSize;
            } else {
                ...
                if (intSize2 == null) {
                    ...
                    j = popupContentSize;
                    zM7674equalsimpl0 = IntSize.m7674equalsimpl0(intSize2.m7680unboximpl(), j);
                }
                if (zM7674equalsimpl0) {
                    return position.m7642unboximpl();
                }
            }
        }
        long newPosition = this.popupPositionProvider.mo373calculatePositionllwVHH4(anchorBounds, windowSize, layoutDirection, j);
        this.previousWindowSize = IntSize.m7668boximpl(windowSize);
        this.previousLayoutDirection = layoutDirection;
        this.previousPopupContentSize = IntSize.m7668boximpl(popupContentSize);
        this.previousPosition = IntOffset.m7624boximpl(newPosition);
        return newPosition;
    }
}
