...
public final class ProcessText_androidKt {
    ...
    public static final void m1299addProcessedTextContextMenuItemsUAq72N0(TextContextMenuBuilderScope $this$addProcessedTextContextMenuItems_u2dUAq72N0, Context context, final boolean editable, final CharSequence text, final long j) {
        if (ComposeFoundationFlags.isSmartSelectionEnabled && !TextRange.m6922getCollapsedimpl(j)) {
            if (text.length() == 0) {
                return;
            }
            ...
            while (index$iv < size) {
                ...
                TextContextMenuBuilderScope_androidKt.item$default($this$addProcessedTextContextMenuItems_u2dUAq72N0, new ProcessTextKey(index), resolveInfo.loadLabel(packageManager).toString(), 0, new Function1() { // from class: androidx.compose.foundation.text.contextmenu.ProcessText_androidKt$$ExternalSyntheticLambda0
                    ...
                    public final Object invoke(Object obj) {
                        return ProcessText_androidKt.addProcessedTextContextMenuItems_UAq72N0$lambda$0$0(context2, resolveInfo, editable, text, j, (TextContextMenuSession) obj);
                    }
                }, 4, null);
                index$iv++;
                context2 = context;
    ...
    public static final Unit addProcessedTextContextMenuItems_UAq72N0$lambda$0$0(Context $context, ResolveInfo $resolveInfo, boolean $editable, CharSequence $text, long j, TextContextMenuSession $this$item) {
        ProcessTextApi23Impl.INSTANCE.getOnClickProcessTextItem().invoke($context, $resolveInfo, Boolean.valueOf($editable), $text, TextRange.m6916boximpl(j));
        $this$item.close();
