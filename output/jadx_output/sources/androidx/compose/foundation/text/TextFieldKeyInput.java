...
public final class TextFieldKeyInput {
    ...
    private final CommitTextCommand m1274typedCommandZmokQxo(KeyEvent event) {
        Integer numM1197consumeZmokQxo;
        if (!TextFieldKeyInput_androidKt.m1279isTypedEventZmokQxo(event) || (numM1197consumeZmokQxo = this.keyCombiner.m1197consumeZmokQxo(event)) == null) {
            return null;
        }
        int codePoint = numM1197consumeZmokQxo.intValue();
    ...
    public final boolean m1275processZmokQxo(KeyEvent event) {
        final KeyCommand command;
        CommitTextCommand it = m1274typedCommandZmokQxo(event);
        if (it != null) {
            if (!this.editable) {
                return false;
            }
        ...
        if (!KeyEventType.m5846equalsimpl0(KeyEvent_androidKt.m5854getTypeZmokQxo(event), KeyEventType.INSTANCE.m5850getKeyDownCS__XNY()) || (command = this.keyMapping.mo1200mapZmokQxo(event)) == null || (command.getEditsText() && !this.editable)) {
            return false;
        }
        ...
        switch (WhenMappings.$EnumSwitchMapping$0[$command.ordinal()]) {
            ...
            case 26:
                if (!this$0.singleLine) {
                    ...
                    $consumed.element = this$0.state.getOnImeActionPerformedWithResult().invoke(ImeAction.m7093boximpl(this$0.imeAction)).booleanValue();
                }
    ...
    public static final EditCommand process_ZmokQxo$lambda$1$2(TextFieldPreparedSelection $this$deleteIfSelectedOr) {
        ...
        return new DeleteSurroundingTextCommand(TextRange.m6923getEndimpl($this$deleteIfSelectedOr.getSelection()) - precedingCodePointIndex, 0);
    }
    ...
    public static final EditCommand process_ZmokQxo$lambda$1$3(TextFieldPreparedSelection $this$deleteIfSelectedOr) {
        ...
        if (nextCharacterIndex != -1) {
            return new DeleteSurroundingTextCommand(0, nextCharacterIndex - TextRange.m6923getEndimpl($this$deleteIfSelectedOr.getSelection()));
        }
        return null;
    }
    ...
    public static final EditCommand process_ZmokQxo$lambda$1$4(TextFieldPreparedSelection $this$deleteIfSelectedOr) {
        ...
        if (previousWordOffset != null) {
            ...
            deleteSurroundingTextCommand = new DeleteSurroundingTextCommand(TextRange.m6923getEndimpl($this$deleteIfSelectedOr.getSelection()) - it, 0);
        } else {
    ...
    public static final EditCommand process_ZmokQxo$lambda$1$5(TextFieldPreparedSelection $this$deleteIfSelectedOr) {
        ...
        if (nextWordOffset != null) {
            ...
            deleteSurroundingTextCommand = new DeleteSurroundingTextCommand(0, it - TextRange.m6923getEndimpl($this$deleteIfSelectedOr.getSelection()));
        } else {
            deleteSurroundingTextCommand = null;
        }
        return deleteSurroundingTextCommand;
    ...
    private final void commandExecutionContext(Function1<? super TextFieldPreparedSelection, Unit> block) {
        ...
        if (!TextRange.m6921equalsimpl0(preparedSelection.getSelection(), this.value.getSelection()) || !Intrinsics.areEqual(preparedSelection.getAnnotatedString(), this.value.getText())) {
