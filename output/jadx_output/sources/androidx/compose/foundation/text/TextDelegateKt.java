...
public final class TextDelegateKt {
    ...
    public static /* synthetic */ TextDelegate m1252updateTextDelegaterm0N8CA$default(TextDelegate textDelegate, AnnotatedString annotatedString, TextStyle textStyle, Density density, FontFamily.Resolver resolver, boolean z, int i, int i2, int i3, List list, int i4, Object obj) {
        ...
        if ((i4 & 64) != 0) {
            i = TextOverflow.INSTANCE.m7415getClipgIe3tQ8();
        }
        if ((i4 & 128) != 0) {
    ...
    public static final TextDelegate m1251updateTextDelegaterm0N8CA(TextDelegate current, AnnotatedString text, TextStyle style, Density density, FontFamily.Resolver fontFamilyResolver, boolean softWrap, int i, int maxLines, int minLines, List<AnnotatedString.Range<Placeholder>> list) {
        ...
        if (!Intrinsics.areEqual(current.getText(), text) || !Intrinsics.areEqual(current.getStyle(), style)) {
            ...
            if (current.getSoftWrap() != z) {
                ...
                i2 = i;
                if (!TextOverflow.m7406equalsimpl0(current.getOverflow(), i2)) {
                    resolver = fontFamilyResolver;
                    i3 = maxLines;
                    i4 = minLines;
                    list2 = list;
                    ...
                    if (current.getMaxLines() != i3) {
                        ...
                        i4 = minLines;
                        if (current.getMinLines() != i4 || !Intrinsics.areEqual(current.getDensity(), density)) {
                            resolver = fontFamilyResolver;
                            list2 = list;
                        } else {
                            list2 = list;
        ...
        return new TextDelegate(text, style, i3, i4, z, i2, density, resolver, list2, null);
    }
}
