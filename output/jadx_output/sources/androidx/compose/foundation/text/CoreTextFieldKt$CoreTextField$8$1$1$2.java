...
public final class CoreTextFieldKt$CoreTextField$8$1$1$2 implements MeasurePolicy {
    ...
    public MeasureResult mo41measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, List<? extends Measurable> list, long j) {
        ...
        try {
            ...
            Triple<Integer, Integer, TextLayoutResult> tripleM1263layout_EkL_Y$foundation = TextFieldDelegate.INSTANCE.m1263layout_EkL_Y$foundation(this.$state.getTextDelegate(), j, $this$measure_u2d3p2s80s.getLayoutDirection(), prevResult);
            int width = tripleM1263layout_EkL_Y$foundation.component1().intValue();
            int height = tripleM1263layout_EkL_Y$foundation.component2().intValue();
            TextLayoutResult result = tripleM1263layout_EkL_Y$foundation.component3();
            ...
            legacyTextFieldState2.m1223setMinHeightForSingleLineField0680j_4($this$measure_3p2s80s_u24lambda_u241.mo402toDpu2uoSUM(this.$maxLines == 1 ? TextDelegateKt.ceilToIntPx(result.getLineBottom(0)) : 0));
