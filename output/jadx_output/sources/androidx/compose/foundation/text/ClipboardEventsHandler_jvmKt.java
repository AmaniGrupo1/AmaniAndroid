...
public final class ClipboardEventsHandler_jvmKt {
    public static final void rememberClipboardEventsHandler(Function1<? super AnnotatedString, Unit> function1, Function0<AnnotatedString> function0, Function0<AnnotatedString> function02, boolean isEnabled, Composer $composer, int $changed, int i) {
        ...
        if ((i & 2) != 0) {
            Function0 onCopy = new Function0() { // from class: androidx.compose.foundation.text.ClipboardEventsHandler_jvmKt.rememberClipboardEventsHandler.2
