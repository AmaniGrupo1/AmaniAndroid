...
final class LinksTextMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo41measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, final List<? extends Measurable> list, long j) {
        return MeasureScope.layout$default($this$measure_u2d3p2s80s, Constraints.m7458getMaxWidthimpl(j), Constraints.m7457getMaxHeightimpl(j), null, new Function1() { // from class: androidx.compose.foundation.text.LinksTextMeasurePolicy$$ExternalSyntheticLambda0
    ...
    static final Unit measure_3p2s80s$lambda$0(List $measurables, LinksTextMeasurePolicy this$0, Placeable.PlacementScope $this$layout) {
        ...
        if (linksToPlace != null) {
            ...
            for (int index$iv = 0; index$iv < size; index$iv++) {
                ...
                Placeable.PlacementScope.m6207place70tqf50$default($this$layout, placeable, measureResult != null ? ((IntOffset) measureResult.invoke()).m7642unboximpl() : IntOffset.INSTANCE.m7644getZeronOccac(), 0.0f, 2, null);
            }
        }
