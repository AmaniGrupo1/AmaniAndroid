...
public final class TextSelectionDelegateKt {
    public static final long getSelectionHandleCoordinates(TextLayoutResult textLayoutResult, int offset, boolean isStart, boolean areHandlesCrossed) {
        ...
        float x = RangesKt.coerceIn(getHorizontalPosition(textLayoutResult, offset, isStart, areHandlesCrossed), 0.0f, (int) (textLayoutResult.getSize() >> 32));
        float y = RangesKt.coerceIn(textLayoutResult.getLineBottom(line), 0.0f, (int) (textLayoutResult.getSize() & 4294967295L));
