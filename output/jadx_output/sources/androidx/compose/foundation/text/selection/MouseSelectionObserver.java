...
public interface MouseSelectionObserver {
    ...
    boolean mo1513onDrag3MmeM6k(long dragPosition, SelectionAdjustment adjustment);

    void onDragDone();

    /* JADX INFO: renamed from: onExtend-k-4lQ0M */
    boolean mo1514onExtendk4lQ0M(long downPosition);

    /* JADX INFO: renamed from: onExtendDrag-k-4lQ0M */
    boolean mo1515onExtendDragk4lQ0M(long dragPosition);

    /* JADX INFO: renamed from: onStart-9KIMszo */
    boolean mo1516onStart9KIMszo(long downPosition, SelectionAdjustment adjustment, int clickCount);
}
