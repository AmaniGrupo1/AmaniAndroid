...
public final class SelectionLayoutKt {
    ...
    public static final SelectionLayout m1611getTextFieldSelectionLayoutRcvTLA(TextLayoutResult layoutResult, int rawStartHandleOffset, int rawEndHandleOffset, int rawPreviousHandleOffset, long j, boolean isStartOfSelection, boolean isStartHandle) {
        return new SingleSelectionLayout(isStartHandle, 1, 1, isStartOfSelection ? null : new Selection(new Selection.AnchorInfo(SelectionHelpersKt.getTextDirectionForOffset(layoutResult, TextRange.m6928getStartimpl(j)), TextRange.m6928getStartimpl(j), 1L), new Selection.AnchorInfo(SelectionHelpersKt.getTextDirectionForOffset(layoutResult, TextRange.m6923getEndimpl(j)), TextRange.m6923getEndimpl(j), 1L), TextRange.m6927getReversedimpl(j)), new SelectableInfo(1L, 1, rawStartHandleOffset, rawEndHandleOffset, rawPreviousHandleOffset, layoutResult));
    }
