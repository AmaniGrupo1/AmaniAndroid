...
public final class TextFieldSelectionManager_androidKt {
    ...
    static final Modifier textFieldMagnifier$lambda$0(final TextFieldSelectionManager $manager, Modifier $this$composed, Composer $composer, int $changed) {
        ...
        if (it$iv == Composer.INSTANCE.getEmpty()) {
            Object value$iv = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntSize.m7668boximpl(IntSize.INSTANCE.m7681getZeroYbymL2g()), null, 2, null);
    ...
    public static final Offset textFieldMagnifier$lambda$0$3$0(TextFieldSelectionManager $manager, MutableState $magnifierSize$delegate) {
        return Offset.m4441boximpl(TextFieldSelectionManagerKt.m1671calculateSelectionMagnifierCenterAndroidO0kMr_c($manager, textFieldMagnifier$lambda$0$1($magnifierSize$delegate)));
    }
    ...
    public static final Modifier textFieldMagnifier$lambda$0$4$0(final Density $density, final MutableState $magnifierSize$delegate, final Function0 center) {
        return Magnifier_androidKt.m333magnifierjPUL71Q$default(Modifier.INSTANCE, new Function1() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager_androidKt$$ExternalSyntheticLambda8
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
    ...
    public static final Unit textFieldMagnifier$lambda$0$4$0$1(Density $density, MutableState $magnifierSize$delegate, DpSize size) {
        int width$iv = $density.mo399roundToPx0680j_4(DpSize.m7603getWidthD9Ej5fM(size.getPackedValue()));
        int height$iv = $density.mo399roundToPx0680j_4(DpSize.m7601getHeightD9Ej5fM(size.getPackedValue()));
        textFieldMagnifier$lambda$0$2($magnifierSize$delegate, IntSize.m7671constructorimpl((((long) width$iv) << 32) | (((long) height$iv) & 4294967295L)));
    ...
    static final Unit addBasicTextFieldTextContextMenuComponents$lambda$0(final TextFieldSelectionManager $manager, final CoroutineScope $coroutineScope, TextContextMenuBuilderScope $this$addTextContextMenuComponentsWithContext, final Context context) {
        ...
        if (latestSelection != null) {
            ...
            textRangeM6916boximpl = TextRange.m6916boximpl(TextRangeKt.TextRange(offsetMapping.originalToTransformed(TextRange.m6928getStartimpl(it)), offsetMapping.originalToTransformed(TextRange.m6923getEndimpl(it))));
        }
        PlatformSelectionBehaviors_androidKt.m1600addPlatformTextContextMenuItems71BSaZU($this$addTextContextMenuComponentsWithContext, context, editable, text, textRangeM6916boximpl, $manager.getPlatformSelectionBehaviors(), new Function1() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager_androidKt$$ExternalSyntheticLambda3
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
