...
public final class PlatformSelectionBehaviors_androidKt {
    ...
    public static final boolean m1601canReuseh5sm0ck(TextClassificationResult $this$canReuse_u2dh5sm0ck, CharSequence text, long j) {
        return TextRange.m6921equalsimpl0(j, $this$canReuse_u2dh5sm0ck.m1649getSelectiond9O1mEE()) && Intrinsics.areEqual(text, $this$canReuse_u2dh5sm0ck.getText());
    }

    /* JADX INFO: renamed from: addPlatformTextContextMenuItems-71BSaZU, reason: not valid java name */
    public static final void m1600addPlatformTextContextMenuItems71BSaZU(TextContextMenuBuilderScope $this$addPlatformTextContextMenuItems_u2d71BSaZU, Context context, boolean editable, CharSequence text, TextRange selection, PlatformSelectionBehaviors platformSelectionBehaviors, Function1<? super TextContextMenuBuilderScope, Unit> function1) {
        if (Build.VERSION.SDK_INT < 28 || text == null || selection == null || platformSelectionBehaviors == null || !(platformSelectionBehaviors instanceof PlatformSelectionBehaviorsImpl)) {
            ...
            if (text != null && selection != null) {
                ProcessText_androidKt.m1299addProcessedTextContextMenuItemsUAq72N0($this$addPlatformTextContextMenuItems_u2d71BSaZU, context, editable, text, selection.getPackedValue());
                return;
            }
            return;
        }
        ...
        $this$addPlatformTextContextMenuItems_71BSaZU_u24lambda_u240.m1597addSmartSelectionTextContextMenuItemsYmzfRxQ$foundation($this$addPlatformTextContextMenuItems_u2d71BSaZU, text, selection.getPackedValue(), function1);
        ProcessText_androidKt.m1299addProcessedTextContextMenuItemsUAq72N0($this$addPlatformTextContextMenuItems_u2d71BSaZU, context, editable, text, selection.getPackedValue());
    }
}
