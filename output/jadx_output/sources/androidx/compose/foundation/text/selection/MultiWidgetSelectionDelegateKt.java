...
public final class MultiWidgetSelectionDelegateKt {
    ...
    public static final void m1586appendSelectableInfoParwq6A(SelectionLayoutBuilder $this$appendSelectableInfo_u2dParwq6A, TextLayoutResult textLayoutResult, long j, long j2, long selectableId) {
        long j3;
        ...
        Rect bounds = new Rect(0.0f, 0.0f, (int) (textLayoutResult.getSize() >> 32), (int) (4294967295L & textLayoutResult.getSize()));
        Direction currentXDirection3 = m1588getXDirection3MmeM6k(j, bounds);
        Direction currentYDirection = m1589getYDirection3MmeM6k(j, bounds);
        if ($this$appendSelectableInfo_u2dParwq6A.getIsStartHandle()) {
            ...
            j3 = selectableId;
            otherDirection = appendSelectableInfo_Parwq6A$otherDirection(currentXDirection3, currentYDirection, $this$appendSelectableInfo_u2dParwq6A, j3, previousSelection2 != null ? previousSelection2.getStart() : null);
            currentXDirection = currentXDirection3;
            currentXDirection2 = currentYDirection;
        ...
        if (isSelected(startYHandleDirection, endYHandleDirection)) {
            ...
            if ($this$appendSelectableInfo_u2dParwq6A.getIsStartHandle()) {
                int rawStartHandleOffset3 = m1587getOffsetForPosition3MmeM6k(j, textLayoutResult);
                ...
                if (previousSelection3 == null || (end = previousSelection3.getEnd()) == null) {
                    ...
                    startXHandleDirection2 = startXHandleDirection;
                    previousAdjustedOffset = getPreviousAdjustedOffset(end, $this$appendSelectableInfo_u2dParwq6A.getSelectableIdOrderingComparator(), j3, textLength);
                    rawStartHandleOffset = rawStartHandleOffset3;
                    rawStartHandleOffset2 = previousAdjustedOffset;
                }
            } else {
                startXHandleDirection2 = startXHandleDirection;
                int rawEndHandleOffset = m1587getOffsetForPosition3MmeM6k(j, textLayoutResult);
                Selection previousSelection4 = $this$appendSelectableInfo_u2dParwq6A.getPreviousSelection();
                int rawStartHandleOffset4 = (previousSelection4 == null || (start = previousSelection4.getStart()) == null) ? rawEndHandleOffset : getPreviousAdjustedOffset(start, $this$appendSelectableInfo_u2dParwq6A.getSelectableIdOrderingComparator(), j3, textLength);
                rawStartHandleOffset = rawStartHandleOffset4;
                rawStartHandleOffset2 = rawEndHandleOffset;
            }
            int rawPreviousHandleOffset = ((j2 & 9223372034707292159L) > InlineClassHelperKt.UnspecifiedPackedFloats ? 1 : ((j2 & 9223372034707292159L) == InlineClassHelperKt.UnspecifiedPackedFloats ? 0 : -1)) == 0 ? -1 : m1587getOffsetForPosition3MmeM6k(j2, textLayoutResult);
    ...
    private static final Direction m1588getXDirection3MmeM6k(long j, Rect bounds) {
    ...
    private static final Direction m1589getYDirection3MmeM6k(long j, Rect bounds) {
    ...
    private static final int m1587getOffsetForPosition3MmeM6k(long j, TextLayoutResult textLayoutResult) {
        int bits$iv$iv$iv = (int) (j & 4294967295L);
        ...
        return textLayoutResult.m6898getOffsetForPositionk4lQ0M(j);
    }
}
