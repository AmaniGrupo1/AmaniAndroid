...
public final class TextFieldSelectionManager {
    ...
    public TextFieldSelectionManager(UndoManager undoManager) {
        ...
        this.dragBeginPosition = Offset.INSTANCE.m4468getZeroF1C5BW0();
        ...
        this.touchSelectionObserver = new TextDragObserver() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$touchSelectionObserver$1
            ...
            public void mo1255onStart3MmeM6k(long startPoint, SelectionAdjustment selectionAdjustment) {
                long j;
                ...
                if (this.this$0.getEnabled() && this.this$0.getDraggingHandle() == null) {
                    ...
                    boolean z = (state == null || (layoutResult2 = state.getLayoutResult()) == null || !layoutResult2.m1292isPositionOnTextk4lQ0M(startPoint)) ? false : true;
                    ...
                    if (!z) {
                        ...
                        if (state2 != null && (layoutResult = state2.getLayoutResult()) != null) {
                            ...
                            int transformedOffset = TextLayoutResultProxy.m1290getOffsetForPosition3MmeM6k$default(layoutResult, startPoint, false, 2, null);
                            int offset = textFieldSelectionManager2.getOffsetMapping().transformedToOriginal(transformedOffset);
                            TextFieldValue newValue = textFieldSelectionManager2.m1654createTextFieldValueFDrldGo(textFieldSelectionManager2.getValue$foundation().getText(), TextRangeKt.TextRange(offset, offset));
                            ...
                            textFieldSelectionManager2.m1666setLatestSelectionOEnZFl4$foundation(TextRange.m6916boximpl(newValue.getSelection()));
                        }
                        ...
                        j = startPoint;
                        long adjustedStartSelection = this.this$0.m1658updateSelection8UEBfa8(TextFieldValue.m7173copy3r_uNRQ$default(this.this$0.getValue$foundation(), (AnnotatedString) null, TextRange.INSTANCE.m6933getZerod9O1mEE(), (TextRange) null, 5, (Object) null), j, true, false, this.selectionAdjustmentMode, true);
                        this.this$0.dragBeginSelection = TextRange.m6916boximpl(adjustedStartSelection);
                        this.runningSelection = TextRange.m6916boximpl(adjustedStartSelection);
                    }
                    this.this$0.setHandleState(HandleState.None);
                    this.this$0.dragBeginPosition = j;
                    this.this$0.m1657setCurrentDragPosition_kEHs6E(Offset.m4441boximpl(this.this$0.dragBeginPosition));
                    this.this$0.dragTotalDistance = Offset.INSTANCE.m4468getZeroF1C5BW0();
                }
            }
            ...
            */
            public void mo1254onDragk4lQ0M(long delta) {
                ...
                if (this.this$0.getEnabled()) {
                    if (!(this.this$0.getValue$foundation().getText().length() == 0)) {
                        this.this$0.dragTotalDistance = Offset.m4457plusMKHz9U(this.this$0.dragTotalDistance, delta);
                        LegacyTextFieldState state = this.this$0.getState();
                        if (state != null && (layoutResult = state.getLayoutResult()) != null) {
                            TextFieldSelectionManager textFieldSelectionManager = this.this$0;
                            textFieldSelectionManager.m1657setCurrentDragPosition_kEHs6E(Offset.m4441boximpl(Offset.m4457plusMKHz9U(textFieldSelectionManager.dragBeginPosition, textFieldSelectionManager.dragTotalDistance)));
                            if (textFieldSelectionManager.dragBeginSelection != null) {
                                layoutResult2 = layoutResult;
                            } else {
                                Offset offsetM1660getCurrentDragPosition_m7T9E = textFieldSelectionManager.m1660getCurrentDragPosition_m7T9E();
                                Intrinsics.checkNotNull(offsetM1660getCurrentDragPosition_m7T9E);
                                if (layoutResult.m1292isPositionOnTextk4lQ0M(offsetM1660getCurrentDragPosition_m7T9E.m4462unboximpl())) {
                                    layoutResult2 = layoutResult;
                                } else {
                                    int startOffset = textFieldSelectionManager.getOffsetMapping().transformedToOriginal(TextLayoutResultProxy.m1290getOffsetForPosition3MmeM6k$default(layoutResult, textFieldSelectionManager.dragBeginPosition, false, 2, null));
                                    OffsetMapping offsetMapping = textFieldSelectionManager.getOffsetMapping();
                                    Offset offsetM1660getCurrentDragPosition_m7T9E2 = textFieldSelectionManager.m1660getCurrentDragPosition_m7T9E();
                                    Intrinsics.checkNotNull(offsetM1660getCurrentDragPosition_m7T9E2);
                                    int endOffset = offsetMapping.transformedToOriginal(TextLayoutResultProxy.m1290getOffsetForPosition3MmeM6k$default(layoutResult, offsetM1660getCurrentDragPosition_m7T9E2.m4462unboximpl(), false, 2, null));
                                    ...
                                    Offset offsetM1660getCurrentDragPosition_m7T9E3 = textFieldSelectionManager.m1660getCurrentDragPosition_m7T9E();
                                    Intrinsics.checkNotNull(offsetM1660getCurrentDragPosition_m7T9E3);
                                    newSelection = textFieldSelectionManager.m1658updateSelection8UEBfa8(value$foundation, offsetM1660getCurrentDragPosition_m7T9E3.m4462unboximpl(), false, false, adjustment, true);
                                    this.runningSelection = TextRange.m6916boximpl(newSelection);
                                    if (!TextRange.m6920equalsimpl(newSelection, textFieldSelectionManager.dragBeginSelection)) {
                                        this.isLongPressSelectionOnly = false;
                                    }
                                }
                            }
                            TextRange textRange = textFieldSelectionManager.dragBeginSelection;
                            int startOffset2 = textRange != null ? TextRange.m6928getStartimpl(textRange.getPackedValue()) : layoutResult2.m1291getOffsetForPosition3MmeM6k(textFieldSelectionManager.dragBeginPosition, false);
                            Offset offsetM1660getCurrentDragPosition_m7T9E4 = textFieldSelectionManager.m1660getCurrentDragPosition_m7T9E();
                            Intrinsics.checkNotNull(offsetM1660getCurrentDragPosition_m7T9E4);
                            int endOffset2 = layoutResult2.m1291getOffsetForPosition3MmeM6k(offsetM1660getCurrentDragPosition_m7T9E4.m4462unboximpl(), false);
                            if (textFieldSelectionManager.dragBeginSelection == null && startOffset2 == endOffset2) {
                                return;
                            }
                            TextFieldValue value$foundation2 = textFieldSelectionManager.getValue$foundation();
                            Offset offsetM1660getCurrentDragPosition_m7T9E5 = textFieldSelectionManager.m1660getCurrentDragPosition_m7T9E();
                            Intrinsics.checkNotNull(offsetM1660getCurrentDragPosition_m7T9E5);
                            newSelection = textFieldSelectionManager.m1658updateSelection8UEBfa8(value$foundation2, offsetM1660getCurrentDragPosition_m7T9E5.m4462unboximpl(), false, false, this.selectionAdjustmentMode, true);
                            this.runningSelection = TextRange.m6916boximpl(newSelection);
                            if (!TextRange.m6920equalsimpl(newSelection, textFieldSelectionManager.dragBeginSelection)) {
                            }
                        }
            ...
            private final void onEnd() {
                ...
                this.this$0.m1657setCurrentDragPosition_kEHs6E(null);
                ...
                boolean collapsed = TextRange.m6922getCollapsedimpl(textRange != null ? textRange.getPackedValue() : this.this$0.getValue$foundation().getSelection());
                ...
                if (this.isLongPressSelectionOnly) {
                    this.this$0.m1656maybeSuggestSelectionOEnZFl4(this.this$0.dragBeginSelection);
                }
        ...
        this.mouseSelectionObserver = new MouseSelectionObserver() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$mouseSelectionObserver$1
                ...
                if (this.this$0.getEnabled()) {
                    if (!(this.this$0.getValue$foundation().getText().length() == 0) && (state = this.this$0.getState()) != null && state.getLayoutResult() != null) {
                        ...
                        if (clickCount >= 2) {
                            ...
                            this.initialSelection = TextRange.m6916boximpl(newSelection);
                        }
                        return true;
                    }
                    return false;
            ...
            public boolean mo1513onDrag3MmeM6k(long dragPosition, SelectionAdjustment adjustment) {
                LegacyTextFieldState state;
                if (this.this$0.getEnabled()) {
                    if (!(this.this$0.getValue$foundation().getText().length() == 0) && (state = this.this$0.getState()) != null && state.getLayoutResult() != null) {
            ...
            public final long updateMouseSelection(TextFieldValue value, long currentPosition, boolean isStartOfSelection, SelectionAdjustment adjustment) {
                long newSelection = this.this$0.m1658updateSelection8UEBfa8(value, currentPosition, isStartOfSelection, false, adjustment, false);
                if (!TextRange.m6920equalsimpl(newSelection, this.initialSelection)) {
                    this.isDoubleOrTripleClickSelectionOnly = false;
                }
                this.this$0.setHandleState(TextRange.m6922getCollapsedimpl(newSelection) ? HandleState.Cursor : HandleState.Selection);
                return newSelection;
            }
            ...
            public void onDragDone() {
                if (this.isDoubleOrTripleClickSelectionOnly) {
                    this.this$0.m1656maybeSuggestSelectionOEnZFl4(this.initialSelection);
                }
            }
        };
    }
    ...
    public final void setValue$foundation(TextFieldValue value) {
        ...
        this.latestSelection = TextRange.m6916boximpl(value.getSelection());
    }
    ...
    public final void m1656maybeSuggestSelectionOEnZFl4(TextRange selection) {
        ...
        long transformedSelection = TextRangeKt.TextRange(offsetMapping.originalToTransformed(TextRange.m6928getStartimpl(selection.getPackedValue())), offsetMapping.originalToTransformed(TextRange.m6923getEndimpl(selection.getPackedValue())));
        if ((text.length() > 0) && !TextRange.m6922getCollapsedimpl(transformedSelection) && (coroutineScope = this.coroutineScope) != null) {
    ...
    public final TextDragObserver handleDragObserver$foundation(final boolean isStartHandle) {
        return new TextDragObserver() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$handleDragObserver$1
            ...
            public void mo1253onDownk4lQ0M(long point) {
                ...
                long handleCoordinates = SelectionHandlesKt.m1608getAdjustedCoordinatesk4lQ0M(this.this$0.m1662getHandlePositiontuRUvjQ$foundation(isStartHandle));
                LegacyTextFieldState state = this.this$0.getState();
                if (state == null || (layoutResult = state.getLayoutResult()) == null) {
                    return;
                }
                long translatedPosition = layoutResult.m1294translateInnerToDecorationCoordinatesMKHz9U$foundation(handleCoordinates);
                this.this$0.dragBeginPosition = translatedPosition;
                this.this$0.m1657setCurrentDragPosition_kEHs6E(Offset.m4441boximpl(translatedPosition));
                this.this$0.dragTotalDistance = Offset.INSTANCE.m4468getZeroF1C5BW0();
                this.this$0.previousRawDragOffset = -1;
                LegacyTextFieldState state2 = this.this$0.getState();
                if (state2 != null) {
            ...
            public void mo1254onDragk4lQ0M(long delta) {
                this.this$0.dragTotalDistance = Offset.m4457plusMKHz9U(this.this$0.dragTotalDistance, delta);
                this.this$0.m1657setCurrentDragPosition_kEHs6E(Offset.m4441boximpl(Offset.m4457plusMKHz9U(this.this$0.dragBeginPosition, this.this$0.dragTotalDistance)));
                TextFieldSelectionManager textFieldSelectionManager = this.this$0;
                TextFieldValue value$foundation = this.this$0.getValue$foundation();
                Offset offsetM1660getCurrentDragPosition_m7T9E = this.this$0.m1660getCurrentDragPosition_m7T9E();
                Intrinsics.checkNotNull(offsetM1660getCurrentDragPosition_m7T9E);
                textFieldSelectionManager.m1658updateSelection8UEBfa8(value$foundation, offsetM1660getCurrentDragPosition_m7T9E.m4462unboximpl(), false, isStartHandle, SelectionAdjustment.INSTANCE.getCharacterWithWordAccelerate(), true);
                this.this$0.updateFloatingToolbar(false);
            }
    ...
    public final TextDragObserver cursorDragObserver$foundation() {
        return new TextDragObserver() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$cursorDragObserver$1
            ...
            public void mo1255onStart3MmeM6k(long startPoint, SelectionAdjustment selectionAdjustment) {
                TextLayoutResultProxy layoutResult;
                long handleCoordinates = SelectionHandlesKt.m1608getAdjustedCoordinatesk4lQ0M(this.this$0.m1662getHandlePositiontuRUvjQ$foundation(true));
                LegacyTextFieldState state = this.this$0.getState();
                if (state == null || (layoutResult = state.getLayoutResult()) == null) {
                    return;
                }
            ...
            public void mo1254onDragk4lQ0M(long delta) {
                ...
                if (state != null && (layoutResult = state.getLayoutResult()) != null) {
                    ...
                    Offset offsetM1660getCurrentDragPosition_m7T9E = textFieldSelectionManager.m1660getCurrentDragPosition_m7T9E();
                    Intrinsics.checkNotNull(offsetM1660getCurrentDragPosition_m7T9E);
                    int offset = offsetMapping.transformedToOriginal(TextLayoutResultProxy.m1290getOffsetForPosition3MmeM6k$default(layoutResult, offsetM1660getCurrentDragPosition_m7T9E.m4462unboximpl(), false, 2, null));
                    long newSelection = TextRangeKt.TextRange(offset, offset);
                    if (TextRange.m6921equalsimpl0(newSelection, textFieldSelectionManager.getValue$foundation().getSelection())) {
                        return;
                    }
                    LegacyTextFieldState state2 = textFieldSelectionManager.getState();
                    boolean z = false;
                    ...
                    textFieldSelectionManager.getOnValueChange$foundation().invoke(textFieldSelectionManager.m1654createTextFieldValueFDrldGo(textFieldSelectionManager.getValue$foundation().getText(), newSelection));
                    textFieldSelectionManager.m1666setLatestSelectionOEnZFl4$foundation(TextRange.m6916boximpl(newSelection));
                }
            }
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final void m1659deselect_kEHs6E$foundation(Offset position) {
        HandleState selectionMode;
        int newCursorOffset;
        if (!TextRange.m6922getCollapsedimpl(getValue$foundation().getSelection())) {
            LegacyTextFieldState legacyTextFieldState = this.state;
            ...
            if (position != null && layoutResult != null) {
                newCursorOffset = this.offsetMapping.transformedToOriginal(TextLayoutResultProxy.m1290getOffsetForPosition3MmeM6k$default(layoutResult, position.m4462unboximpl(), false, 2, null));
            } else {
                newCursorOffset = TextRange.m6925getMaximpl(getValue$foundation().getSelection());
            }
            TextFieldValue newValue = TextFieldValue.m7173copy3r_uNRQ$default(getValue$foundation(), (AnnotatedString) null, TextRangeKt.TextRange(newCursorOffset), (TextRange) null, 5, (Object) null);
            this.onValueChange.invoke(newValue);
            this.latestSelection = TextRange.m6916boximpl(newValue.getSelection());
        }
        if (position == null) {
    ...
    public final void m1667setSelectionPreviewHighlight5zctL8$foundation(long range) {
        LegacyTextFieldState legacyTextFieldState = this.state;
        if (legacyTextFieldState != null) {
            legacyTextFieldState.m1225setSelectionPreviewHighlightRange5zctL8(range);
        }
        LegacyTextFieldState legacyTextFieldState2 = this.state;
        if (legacyTextFieldState2 != null) {
            legacyTextFieldState2.m1222setDeletionPreviewHighlightRange5zctL8(TextRange.INSTANCE.m6933getZerod9O1mEE());
        }
    ...
    public final void m1665setDeletionPreviewHighlight5zctL8$foundation(long range) {
        LegacyTextFieldState legacyTextFieldState = this.state;
        if (legacyTextFieldState != null) {
            legacyTextFieldState.m1222setDeletionPreviewHighlightRange5zctL8(range);
        }
        LegacyTextFieldState legacyTextFieldState2 = this.state;
        if (legacyTextFieldState2 != null) {
            legacyTextFieldState2.m1225setSelectionPreviewHighlightRange5zctL8(TextRange.INSTANCE.m6933getZerod9O1mEE());
        }
        if (!TextRange.m6922getCollapsedimpl(range)) {
            exitSelectionMode$foundation();
        }
    ...
    public final void clearPreviewHighlight$foundation() {
        LegacyTextFieldState legacyTextFieldState = this.state;
        if (legacyTextFieldState != null) {
            legacyTextFieldState.m1222setDeletionPreviewHighlightRange5zctL8(TextRange.INSTANCE.m6933getZerod9O1mEE());
        }
        LegacyTextFieldState legacyTextFieldState2 = this.state;
        if (legacyTextFieldState2 != null) {
            legacyTextFieldState2.m1225setSelectionPreviewHighlightRange5zctL8(TextRange.INSTANCE.m6933getZerod9O1mEE());
    ...
    public final boolean getHasSelection() {
        return !TextRange.m6922getCollapsedimpl(getValue$foundation().getSelection());
    }
    ...
    */
    public final Object updateClipboardEntry$foundation(Continuation<? super Unit> continuation) {
        ...
        Object objHasAvailableTextToPaste;
        ...
        Object $result = textFieldSelectionManager$updateClipboardEntry$1.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        switch (textFieldSelectionManager$updateClipboardEntry$1.label) {
            case 0:
                ...
                if (z) {
                    ...
                    textFieldSelectionManager.setHasAvailableTextToPaste(((Boolean) objHasAvailableTextToPaste).booleanValue());
                }
                return Unit.INSTANCE;
            case 1:
                textFieldSelectionManager = (TextFieldSelectionManager) textFieldSelectionManager$updateClipboardEntry$1.L$0;
                ResultKt.throwOnFailure($result);
                objHasAvailableTextToPaste = $result;
                textFieldSelectionManager.setHasAvailableTextToPaste(((Boolean) objHasAvailableTextToPaste).booleanValue());
                return Unit.INSTANCE;
            default:
    ...
    public final Pair<String, TextRange> getContextTextAndSelection() {
        ...
        return new Pair<>(text, TextRange.m6916boximpl(TextRangeKt.TextRange(this.offsetMapping.originalToTransformed(TextRange.m6928getStartimpl(selection)), this.offsetMapping.originalToTransformed(TextRange.m6923getEndimpl(selection)))));
    }
    ...
    public final boolean canShowSelectAllMenuItem$foundation() {
        return TextRange.m6924getLengthimpl(getValue$foundation().getSelection()) != getValue$foundation().getText().length();
    }

    public final boolean canShowAutofillMenuItem$foundation() {
        return getEditable() && TextRange.m6922getCollapsedimpl(getValue$foundation().getSelection());
    }
    ...
    public final AnnotatedString copyWithResult$foundation(boolean cancelSelection) {
        ...
        int newCursorOffset = TextRange.m6925getMaximpl(getValue$foundation().getSelection());
        TextFieldValue newValue = m1654createTextFieldValueFDrldGo(getValue$foundation().getText(), TextRangeKt.TextRange(newCursorOffset, newCursorOffset));
        this.onValueChange.invoke(newValue);
        setHandleState(HandleState.None);
        return selectedText;
    }
    ...
    public final void paste$foundation(AnnotatedString text) {
        if (getEditable()) {
            ...
            int newCursorOffset = TextRange.m6926getMinimpl(getValue$foundation().getSelection()) + text.length();
            TextFieldValue newValue = m1654createTextFieldValueFDrldGo(newText, TextRangeKt.TextRange(newCursorOffset, newCursorOffset));
            this.onValueChange.invoke(newValue);
            setHandleState(HandleState.None);
    ...
    public final AnnotatedString cutWithResult$foundation() {
        ...
        int newCursorOffset = TextRange.m6926getMinimpl(getValue$foundation().getSelection());
        TextFieldValue newValue = m1654createTextFieldValueFDrldGo(newText, TextRangeKt.TextRange(newCursorOffset, newCursorOffset));
        this.onValueChange.invoke(newValue);
        setHandleState(HandleState.None);
        UndoManager undoManager = this.undoManager;
    ...
    public final void selectAll$foundation() {
        TextFieldValue newValue = m1654createTextFieldValueFDrldGo(getValue$foundation().getText(), TextRangeKt.TextRange(0, getValue$foundation().getText().length()));
        this.onValueChange.invoke(newValue);
        this.latestSelection = TextRange.m6916boximpl(newValue.getSelection());
        this.oldValue = TextFieldValue.m7173copy3r_uNRQ$default(this.oldValue, (AnnotatedString) null, newValue.getSelection(), (TextRange) null, 5, (Object) null);
    ...
    public final long m1662getHandlePositiontuRUvjQ$foundation(boolean isStartHandle) {
        TextLayoutResultProxy layoutResult;
        ...
        int offset = isStartHandle ? TextRange.m6928getStartimpl(selection) : TextRange.m6923getEndimpl(selection);
        return TextSelectionDelegateKt.getSelectionHandleCoordinates(textLayoutResult, this.offsetMapping.originalToTransformed(offset), isStartHandle, TextRange.m6927getReversedimpl(getValue$foundation().getSelection()));
    }
    ...
    public final long m1661getCursorPositiontuRUvjQ$foundation(Density density) {
        int offset = this.offsetMapping.originalToTransformed(TextRange.m6928getStartimpl(getValue$foundation().getSelection()));
        LegacyTextFieldState legacyTextFieldState = this.state;
        TextLayoutResultProxy layoutResult = legacyTextFieldState != null ? legacyTextFieldState.getLayoutResult() : null;
        ...
        float x = cursorRect.getLeft() + (density.mo405toPx0680j_4(TextFieldCursor_androidKt.getDefaultCursorThickness()) / 2);
    ...
    public final void m1664selectWordAtPositionIfNotAlreadySelectedk4lQ0M(long position) {
        TextLayoutResultProxy layoutResult;
        LegacyTextFieldState legacyTextFieldState = this.state;
        if (legacyTextFieldState != null && (layoutResult = legacyTextFieldState.getLayoutResult()) != null) {
            boolean isClickedPositionInsideSelection = TextLayoutHelperKt.m1288isPositionInsideSelectionuaM50fQ(layoutResult.getValue(), layoutResult.m1293translateDecorationToInnerCoordinatesMKHz9U$foundation(position), TextRange.m6916boximpl(getValue$foundation().getSelection()));
            if (!isClickedPositionInsideSelection) {
                m1658updateSelection8UEBfa8(getValue$foundation(), position, true, false, SelectionAdjustment.INSTANCE.getWord(), false);
            }
        }
    }
    ...
    public final Rect getContentRect() {
        ...
        if (it2 != null) {
            ...
            if (it2 != null) {
                int transformedStart = this.offsetMapping.originalToTransformed(TextRange.m6928getStartimpl(getValue$foundation().getSelection()));
                int transformedEnd = this.offsetMapping.originalToTransformed(TextRange.m6923getEndimpl(getValue$foundation().getSelection()));
                LegacyTextFieldState legacyTextFieldState2 = this.state;
                long startOffset = (legacyTextFieldState2 == null || (layoutCoordinates4 = legacyTextFieldState2.getLayoutCoordinates()) == null) ? Offset.INSTANCE.m4468getZeroF1C5BW0() : layoutCoordinates4.mo6152localToRootMKHz9U(m1662getHandlePositiontuRUvjQ$foundation(true));
                LegacyTextFieldState legacyTextFieldState3 = this.state;
                long endOffset = (legacyTextFieldState3 == null || (layoutCoordinates3 = legacyTextFieldState3.getLayoutCoordinates()) == null) ? Offset.INSTANCE.m4468getZeroF1C5BW0() : layoutCoordinates3.mo6152localToRootMKHz9U(m1662getHandlePositiontuRUvjQ$foundation(false));
                ...
                if (legacyTextFieldState4 != null && (layoutCoordinates2 = legacyTextFieldState4.getLayoutCoordinates()) != null) {
                    ...
                    it = it2;
                    int bits$iv$iv$iv = (int) (layoutCoordinates2.mo6152localToRootMKHz9U(Offset.m4444constructorimpl((v1$iv$iv << 32) | (v2$iv$iv & 4294967295L))) & 4294967295L);
                    startTop = Float.intBitsToFloat(bits$iv$iv$iv);
                    legacyTextFieldState = this.state;
                    if (legacyTextFieldState != null) {
                    }
                    endTop = x$iv;
                    int bits$iv$iv$iv2 = (int) (startOffset >> c);
                    int bits$iv$iv$iv3 = (int) (endOffset >> c);
                    float left = Math.min(Float.intBitsToFloat(bits$iv$iv$iv2), Float.intBitsToFloat(bits$iv$iv$iv3));
                    int bits$iv$iv$iv4 = (int) (startOffset >> c);
                    int bits$iv$iv$iv5 = (int) (endOffset >> c);
                    ...
                    int bits$iv$iv$iv7 = (int) (endOffset & j);
                    float bottom = Math.max(Float.intBitsToFloat(bits$iv$iv$iv6), Float.intBitsToFloat(bits$iv$iv$iv7)) + (Dp.m7505constructorimpl(25) * it.getTextDelegate().getDensity().getDensity());
                ...
                if (legacyTextFieldState != null || (layoutCoordinates = legacyTextFieldState.getLayoutCoordinates()) == null) {
                    endTop = x$iv;
                    int bits$iv$iv$iv22 = (int) (startOffset >> c);
                    int bits$iv$iv$iv32 = (int) (endOffset >> c);
                    float left2 = Math.min(Float.intBitsToFloat(bits$iv$iv$iv22), Float.intBitsToFloat(bits$iv$iv$iv32));
                    int bits$iv$iv$iv42 = (int) (startOffset >> c);
                    int bits$iv$iv$iv52 = (int) (endOffset >> c);
                    ...
                    int bits$iv$iv$iv72 = (int) (endOffset & j);
                    float bottom2 = Math.max(Float.intBitsToFloat(bits$iv$iv$iv62), Float.intBitsToFloat(bits$iv$iv$iv72)) + (Dp.m7505constructorimpl(25) * it.getTextDelegate().getDensity().getDensity());
                ...
                int bits$iv$iv$iv8 = (int) (layoutCoordinates.mo6152localToRootMKHz9U(Offset.m4444constructorimpl(v2$iv$iv2)) & j);
                endTop = Float.intBitsToFloat(bits$iv$iv$iv8);
                int bits$iv$iv$iv222 = (int) (startOffset >> c);
                int bits$iv$iv$iv322 = (int) (endOffset >> c);
                float left22 = Math.min(Float.intBitsToFloat(bits$iv$iv$iv222), Float.intBitsToFloat(bits$iv$iv$iv322));
                int bits$iv$iv$iv422 = (int) (startOffset >> c);
                int bits$iv$iv$iv522 = (int) (endOffset >> c);
                ...
                int bits$iv$iv$iv722 = (int) (endOffset & j);
                float bottom22 = Math.max(Float.intBitsToFloat(bits$iv$iv$iv622), Float.intBitsToFloat(bits$iv$iv$iv722)) + (Dp.m7505constructorimpl(25) * it.getTextDelegate().getDensity().getDensity());
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final long m1658updateSelection8UEBfa8(TextFieldValue value, long currentPosition, boolean isStartOfSelection, boolean isStartHandle, SelectionAdjustment adjustment, boolean isTouchBasedSelection) {
        TextLayoutResultProxy layoutResult;
        ...
        if (legacyTextFieldState5 == null || (layoutResult = legacyTextFieldState5.getLayoutResult()) == null) {
            return TextRange.INSTANCE.m6933getZerod9O1mEE();
        }
        long previousTransformedSelection = TextRangeKt.TextRange(this.offsetMapping.originalToTransformed(TextRange.m6928getStartimpl(value.getSelection())), this.offsetMapping.originalToTransformed(TextRange.m6923getEndimpl(value.getSelection())));
        int currentOffset = layoutResult.m1291getOffsetForPosition3MmeM6k(currentPosition, false);
        if (isStartHandle || isStartOfSelection) {
            rawStartHandleOffset = currentOffset;
        } else {
            rawStartHandleOffset = TextRange.m6928getStartimpl(previousTransformedSelection);
        }
        if (!isStartHandle || isStartOfSelection) {
            rawEndHandleOffset = currentOffset;
        } else {
            rawEndHandleOffset = TextRange.m6923getEndimpl(previousTransformedSelection);
        }
        SelectionLayout previousSelectionLayout = this.previousSelectionLayout;
        if (isStartOfSelection || previousSelectionLayout == null || this.previousRawDragOffset == -1) {
            rawPreviousHandleOffset = -1;
        } else {
            rawPreviousHandleOffset = this.previousRawDragOffset;
        }
        SelectionLayout selectionLayout = SelectionLayoutKt.m1611getTextFieldSelectionLayoutRcvTLA(layoutResult.getValue(), rawStartHandleOffset, rawEndHandleOffset, rawPreviousHandleOffset, previousTransformedSelection, isStartOfSelection, isStartHandle);
        if (!selectionLayout.shouldRecomputeSelection(previousSelectionLayout)) {
            return value.getSelection();
        }
        this.previousSelectionLayout = selectionLayout;
        this.previousRawDragOffset = currentOffset;
        Selection newTransformedSelection = adjustment.adjust(selectionLayout);
        long newSelection = TextRangeKt.TextRange(this.offsetMapping.transformedToOriginal(newTransformedSelection.getStart().getOffset()), this.offsetMapping.transformedToOriginal(newTransformedSelection.getEnd().getOffset()));
        if (TextRange.m6921equalsimpl0(newSelection, value.getSelection())) {
            return value.getSelection();
        }
        if (TextRange.m6927getReversedimpl(newSelection) != TextRange.m6927getReversedimpl(value.getSelection())) {
            z = true;
            boolean onlyChangeIsReversed = TextRange.m6921equalsimpl0(TextRangeKt.TextRange(TextRange.m6923getEndimpl(newSelection), TextRange.m6928getStartimpl(newSelection)), value.getSelection());
            boolean bothSelectionsCollapsed = (TextRange.m6922getCollapsedimpl(newSelection) || !TextRange.m6922getCollapsedimpl(value.getSelection())) ? false : z;
            if (isTouchBasedSelection) {
                if ((value.getText().length() > 0 ? z : false) && !onlyChangeIsReversed && !bothSelectionsCollapsed && (hapticFeedback = this.hapticFeedBack) != null) {
                    hapticFeedback.mo5466performHapticFeedbackCdsT49E(HapticFeedbackType.INSTANCE.m5483getTextHandleMove5zf0vsI());
                }
            }
            TextFieldValue newValue = m1654createTextFieldValueFDrldGo(value.getText(), newSelection);
            this.onValueChange.invoke(newValue);
            this.latestSelection = TextRange.m6916boximpl(newSelection);
            if (!isTouchBasedSelection) {
                updateFloatingToolbar(!TextRange.m6922getCollapsedimpl(newSelection));
            }
            legacyTextFieldState = this.state;
            if (legacyTextFieldState != null) {
                legacyTextFieldState.setInTouchMode(isTouchBasedSelection);
            }
            legacyTextFieldState2 = this.state;
            if (legacyTextFieldState2 != null) {
                legacyTextFieldState2.setShowSelectionHandleStart(!TextRange.m6922getCollapsedimpl(newSelection) && TextFieldSelectionManager_androidKt.isSelectionHandleInVisibleBound(this, z));
            }
            legacyTextFieldState3 = this.state;
            if (legacyTextFieldState3 != null) {
                if (TextRange.m6922getCollapsedimpl(newSelection)) {
                    z2 = false;
                } else {
                    z2 = false;
                    if (TextFieldSelectionManager_androidKt.isSelectionHandleInVisibleBound(this, false)) {
                        z2 = true;
                    }
                }
                legacyTextFieldState3.setShowSelectionHandleEnd(z2);
            }
            legacyTextFieldState4 = this.state;
            if (legacyTextFieldState4 != null) {
                if (TextRange.m6922getCollapsedimpl(newSelection)) {
                    boolean z3 = TextFieldSelectionManager_androidKt.isSelectionHandleInVisibleBound(this, true);
        ...
        TextFieldValue newValue2 = m1654createTextFieldValueFDrldGo(value.getText(), newSelection);
        this.onValueChange.invoke(newValue2);
        this.latestSelection = TextRange.m6916boximpl(newSelection);
        if (!isTouchBasedSelection) {
        }
        legacyTextFieldState = this.state;
    ...
    public final TextFieldValue m1654createTextFieldValueFDrldGo(AnnotatedString annotatedString, long selection) {
