            ...
            case 0:
                ...
                Flow flowSnapshotFlow = SnapshotStateKt.snapshotFlow(new Function0() { // from class: androidx.compose.foundation.text.selection.SelectionMagnifierKt$rememberAnimatedMagnifierPosition$1$1$$ExternalSyntheticLambda0
                    ...
                    public final Object invoke() {
                        return Offset.m4441boximpl(SelectionMagnifierKt.rememberAnimatedMagnifierPosition$lambda$1(state));
                    }
                });
                ...
                if (flowSnapshotFlow.collect(new FlowCollector() { // from class: androidx.compose.foundation.text.selection.SelectionMagnifierKt$rememberAnimatedMagnifierPosition$1$1.2
                    ...
                    public /* bridge */ /* synthetic */ Object emit(Object value, Continuation $completion) {
                        return m1612emit3MmeM6k(((Offset) value).m4462unboximpl(), $completion);
                    }
                    ...
                    public final Object m1612emit3MmeM6k(long j, Continuation<? super Unit> continuation) {
                        if ((animatable.getValue().m4462unboximpl() & 9223372034707292159L) != InlineClassHelperKt.UnspecifiedPackedFloats) {
                            if ((9223372034707292159L & j) != InlineClassHelperKt.UnspecifiedPackedFloats) {
                                int bits$iv$iv$iv = (int) (animatable.getValue().m4462unboximpl() & 4294967295L);
                                int bits$iv$iv$iv2 = (int) (4294967295L & j);
                                if (!(Float.intBitsToFloat(bits$iv$iv$iv) == Float.intBitsToFloat(bits$iv$iv$iv2))) {
                                    BuildersKt__Builders_commonKt.launch$default(animationScope, null, null, new AnonymousClass1(animatable, j, null), 3, null);
                                    return Unit.INSTANCE;
                                }
                            }
                        }
                        Object objSnapTo = animatable.snapTo(Offset.m4441boximpl(j), continuation);
                        ...
                        public final Object invokeSuspend(Object $result) {
                            ...
                            switch (this.label) {
                                case 0:
                                    ...
                                    Offset offsetM4441boximpl = Offset.m4441boximpl(this.f60$$v$c$androidxcomposeuigeometryOffset$targetValue$0);
