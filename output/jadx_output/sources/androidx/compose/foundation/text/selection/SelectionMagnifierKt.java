...
public final class SelectionMagnifierKt {
    ...
    static {
        ...
        OffsetDisplacementThreshold = Offset.m4444constructorimpl((v1$iv$iv << 32) | (4294967295L & v2$iv$iv));
        MagnifierSpringSpec = new SpringSpec<>(0.0f, 0.0f, Offset.m4441boximpl(OffsetDisplacementThreshold), 3, null);
    }
    ...
    static final AnimationVector2D UnspecifiedSafeOffsetVectorConverter$lambda$0(Offset it) {
        if (!((9223372034707292159L & it.m4462unboximpl()) != InlineClassHelperKt.UnspecifiedPackedFloats)) {
    ...
    private static final long animatedSelectionMagnifier$lambda$0$0(State<Offset> state) {
        ...
        return ((Offset) thisObj$iv).m4462unboximpl();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Offset animatedSelectionMagnifier$lambda$0$1$0(State $animatedCenter$delegate) {
        return Offset.m4441boximpl(animatedSelectionMagnifier$lambda$0$0($animatedCenter$delegate));
    }
    ...
    private static final State<Offset> rememberAnimatedMagnifierPosition(Function0<Offset> function0, Composer $composer, int $changed) {
        ...
        if (it$iv2 == Composer.INSTANCE.getEmpty()) {
            Object value$iv2 = new Animatable(Offset.m4441boximpl(rememberAnimatedMagnifierPosition$lambda$1(targetValue$delegate)), UnspecifiedSafeOffsetVectorConverter, Offset.m4441boximpl(OffsetDisplacementThreshold), null, 8, null);
