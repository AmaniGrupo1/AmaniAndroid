...
public final class SelectionRegistrarImpl implements SelectionRegistrar {
    ...
    static final int sort$lambda$0(LayoutCoordinates $containerLayoutCoordinates, Selectable a, Selectable b) {
        ...
        if (layoutCoordinatesA != null) {
            long positionATopLeft2 = $containerLayoutCoordinates.mo6150localPositionOfR5De75A(layoutCoordinatesA, Offset.INSTANCE.m4468getZeroF1C5BW0());
            j = 4294967295L;
            int bits$iv$iv$iv = (int) (positionATopLeft2 >> 32);
            c = ' ';
            positionATopLeft = positionATopLeft2;
            float x$iv = Float.intBitsToFloat(bits$iv$iv$iv) + ((int) (layoutCoordinatesA.mo6149getSizeYbymL2g() >> 32));
            int bits$iv$iv$iv2 = (int) (positionATopLeft & 4294967295L);
            float y$iv = Float.intBitsToFloat(bits$iv$iv$iv2) + ((int) (layoutCoordinatesA.mo6149getSizeYbymL2g() & 4294967295L));
            long v1$iv$iv = Float.floatToRawIntBits(x$iv);
            long v1$iv$iv2 = Float.floatToRawIntBits(y$iv);
            long v2$iv$iv = (v1$iv$iv << 32) | (v1$iv$iv2 & 4294967295L);
            positionABottomRight = Offset.m4444constructorimpl(v2$iv$iv);
        } else {
            c = ' ';
            j = 4294967295L;
            long positionATopLeft3 = Offset.INSTANCE.m4468getZeroF1C5BW0();
            positionATopLeft = positionATopLeft3;
            positionABottomRight = Offset.INSTANCE.m4468getZeroF1C5BW0();
        }
        if (layoutCoordinatesB != null) {
            long positionBTopLeft2 = $containerLayoutCoordinates.mo6150localPositionOfR5De75A(layoutCoordinatesB, Offset.INSTANCE.m4468getZeroF1C5BW0());
            int bits$iv$iv$iv3 = (int) (positionBTopLeft2 >> c);
            float fIntBitsToFloat = Float.intBitsToFloat(bits$iv$iv$iv3);
            int $i$f$unpackInt1 = (int) (layoutCoordinatesB.mo6149getSizeYbymL2g() >> c);
            float x$iv2 = fIntBitsToFloat + $i$f$unpackInt1;
            int bits$iv$iv$iv4 = (int) (positionBTopLeft2 & j);
            float y$iv2 = Float.intBitsToFloat(bits$iv$iv$iv4) + ((int) (layoutCoordinatesB.mo6149getSizeYbymL2g() & j));
            long v1$iv$iv3 = Float.floatToRawIntBits(x$iv2);
            long v2$iv$iv2 = Float.floatToRawIntBits(y$iv2);
            positionBBottomRight = Offset.m4444constructorimpl((v1$iv$iv3 << c) | (v2$iv$iv2 & j));
            positionBTopLeft = positionBTopLeft2;
        } else {
            long positionBTopLeft3 = Offset.INSTANCE.m4468getZeroF1C5BW0();
            positionBBottomRight = Offset.INSTANCE.m4468getZeroF1C5BW0();
            positionBTopLeft = positionBTopLeft3;
        }
        boolean areTextLayoutsInARow = SelectionRegistrarImplKt.m1645inARowzwwh4xc(positionATopLeft, positionABottomRight, positionBTopLeft, positionBBottomRight);
        if (areTextLayoutsInARow) {
            int bits$iv$iv$iv5 = (int) (positionATopLeft >> c);
            int bits$iv$iv$iv6 = (int) (positionBTopLeft >> c);
        ...
        int bits$iv$iv$iv7 = (int) (positionATopLeft & j);
        int bits$iv$iv$iv8 = (int) (positionBTopLeft & j);
    ...
    public void mo1644notifySelectionUpdateStartubNVwUQ(LayoutCoordinates layoutCoordinates, long startPosition, SelectionAdjustment adjustment, boolean isInTouchMode) {
        ...
        if (function4 != null) {
            function4.invoke(Boolean.valueOf(isInTouchMode), layoutCoordinates, Offset.m4441boximpl(startPosition), adjustment);
        }
    }
    ...
    public boolean mo1643notifySelectionUpdatenjBpvok(LayoutCoordinates layoutCoordinates, long newPosition, long previousPosition, boolean isStartHandle, SelectionAdjustment adjustment, boolean isInTouchMode) {
        ...
        if (function6 != null) {
            return function6.invoke(Boolean.valueOf(isInTouchMode), layoutCoordinates, Offset.m4441boximpl(newPosition), Offset.m4441boximpl(previousPosition), Boolean.valueOf(isStartHandle), adjustment).booleanValue();
        }
        return true;
    }
