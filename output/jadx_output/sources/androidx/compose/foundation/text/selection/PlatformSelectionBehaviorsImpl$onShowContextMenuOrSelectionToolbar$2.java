    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                this.label = 1;
                if (this.this$0.m1595classifyTextM8tDOmk(this.$text, this.f58$$v$c$androidxcomposeuitextTextRange$selection$0, $this$requireTextClassificationSession, this) == coroutine_suspended) {
