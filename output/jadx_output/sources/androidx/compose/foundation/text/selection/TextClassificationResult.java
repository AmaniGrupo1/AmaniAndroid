...
final /* data */ class TextClassificationResult {
    ...
    public final TextClassificationResult m1648copySbBc2M(CharSequence text, long selection, TextClassification textClassification) {
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.text, textClassificationResult.text) && TextRange.m6921equalsimpl0(this.selection, textClassificationResult.selection) && Intrinsics.areEqual(this.textClassification, textClassificationResult.textClassification);
    }

    public int hashCode() {
        return (((this.text.hashCode() * 31) + TextRange.m6929hashCodeimpl(this.selection)) * 31) + this.textClassification.hashCode();
    }

    public String toString() {
        return "TextClassificationResult(text=" + ((Object) this.text) + ", selection=" + ((Object) TextRange.m6931toStringimpl(this.selection)) + ", textClassification=" + this.textClassification + ')';
    }
