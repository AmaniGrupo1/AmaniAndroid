...
public final class MultiWidgetSelectionDelegate implements Selectable {
        ...
        synchronized (lock$iv) {
            if (this._previousTextLayoutResult != $this$lastVisibleOffset) {
                if (!$this$lastVisibleOffset.getDidOverflowHeight() || $this$lastVisibleOffset.getMultiParagraph().getDidExceedMaxLines()) {
                    ...
                    long j = 4294967295L;
                    int finalVisibleLine2 = RangesKt.coerceAtMost($this$lastVisibleOffset.getLineForVerticalPosition((int) ($this$lastVisibleOffset.getSize() & 4294967295L)), $this$lastVisibleOffset.getLineCount() - 1);
                    while (finalVisibleLine2 >= 0) {
                        float lineTop = $this$lastVisibleOffset.getLineTop(finalVisibleLine2);
                        long j2 = j;
                        int $i$f$unpackInt2 = (int) ($this$lastVisibleOffset.getSize() & j2);
    ...
    public void appendSelectableInfoToBuilder(SelectionLayoutBuilder builder) {
        ...
        long relativePosition = builder.getContainerCoordinates().mo6150localPositionOfR5De75A(layoutCoordinates, Offset.INSTANCE.m4468getZeroF1C5BW0());
        long localPosition = Offset.m4456minusMKHz9U(builder.getCurrentPosition(), relativePosition);
        if (!((9223372034707292159L & builder.getPreviousHandlePosition()) == InlineClassHelperKt.UnspecifiedPackedFloats)) {
            localPreviousHandlePosition = Offset.m4456minusMKHz9U(builder.getPreviousHandlePosition(), relativePosition);
        } else {
            localPreviousHandlePosition = Offset.INSTANCE.m4467getUnspecifiedF1C5BW0();
        }
        MultiWidgetSelectionDelegateKt.m1586appendSelectableInfoParwq6A(builder, textLayoutResult, localPosition, localPreviousHandlePosition, getSelectableId());
    }
    ...
    public long mo1584getHandlePositiondBAh8RU(Selection selection, boolean isStartHandle) {
        TextLayoutResult textLayoutResult;
    ...
    public long mo1585getRangeOfLineContainingjx7JFs(int offset) {
