...
public final /* data */ class SelectionHandleInfo {
    ...
    public final SelectionHandleInfo m1606copyubNVwUQ(Handle handle, long position, SelectionHandleAnchor anchor, boolean visible) {
    ...
    public boolean equals(Object other) {
        ...
        return this.handle == selectionHandleInfo.handle && Offset.m4449equalsimpl0(this.position, selectionHandleInfo.position) && this.anchor == selectionHandleInfo.anchor && this.visible == selectionHandleInfo.visible;
    }

    public int hashCode() {
        return (((((this.handle.hashCode() * 31) + Offset.m4454hashCodeimpl(this.position)) * 31) + this.anchor.hashCode()) * 31) + Boolean.hashCode(this.visible);
    }

    public String toString() {
        return "SelectionHandleInfo(handle=" + this.handle + ", position=" + ((Object) Offset.m4460toStringimpl(this.position)) + ", anchor=" + this.anchor + ", visible=" + this.visible + ')';
    }
