...
public final class AndroidSelectionHandles_androidKt {
    ...
    public static final void m1579SelectionHandlewLIcFTc(final OffsetProvider offsetProvider, final boolean isStartHandle, final ResolvedTextDirection direction, boolean handlesCrossed, long j, final float lineHeight, final Modifier modifier, Composer $composer, final int $changed, final int i) {
        boolean z;
        long jM7612getUnspecifiedMYxV2XQ;
        int $dirty;
        ...
        if (($changed & 24576) == 0) {
            if ((i & 16) == 0) {
                ...
                int i2 = $composer2.changed(jM7612getUnspecifiedMYxV2XQ) ? 16384 : 8192;
                $dirty2 |= i2;
            } else {
                jM7612getUnspecifiedMYxV2XQ = j;
            }
        ...
        if ($composer2.shouldExecute((533651 & $dirty2) != 533650, $dirty2 & 1)) {
            ...
            final long j2 = jM7612getUnspecifiedMYxV2XQ;
            HandlePopup(offsetProvider, handleReferencePoint, ComposableLambdaKt.rememberComposableLambda(1365123137, true, new Function2() { // from class: androidx.compose.foundation.text.selection.AndroidSelectionHandles_androidKt$$ExternalSyntheticLambda2
                ...
                public final Object invoke(Object obj, Object obj2) {
                    return AndroidSelectionHandles_androidKt.SelectionHandle_wLIcFTc$lambda$1(viewConfiguration, j2, isLeft, semanticsModifier, offsetProvider, (Composer) obj, ((Integer) obj2).intValue());
                }
            }, $composer2, 54), $composer2, ($dirty & 14) | RendererCapabilities.DECODER_SUPPORT_MASK);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            jM7612getUnspecifiedMYxV2XQ = j2;
        } else {
            $composer2.skipToGroupEnd();
        }
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            final boolean z2 = z;
            final long j3 = jM7612getUnspecifiedMYxV2XQ;
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2() { // from class: androidx.compose.foundation.text.selection.AndroidSelectionHandles_androidKt$$ExternalSyntheticLambda3
                @Override // kotlin.jvm.functions.Function2
                public final Object invoke(Object obj, Object obj2) {
                    return AndroidSelectionHandles_androidKt.SelectionHandle_wLIcFTc$lambda$2(offsetProvider, isStartHandle, direction, z2, j3, lineHeight, modifier, $changed, i, (Composer) obj, ((Integer) obj2).intValue());
                }
            });
        }
    }
    ...
    public static final Unit SelectionHandle_wLIcFTc$lambda$0$0(OffsetProvider $offsetProvider, boolean $isStartHandle, boolean $isLeft, SemanticsPropertyReceiver $this$semantics) {
        long position = $offsetProvider.mo1144provideF1C5BW0();
    ...
    static final Unit SelectionHandle_wLIcFTc$lambda$1(ViewConfiguration $viewConfiguration, final long j, final boolean $isLeft, final Modifier $semanticsModifier, final OffsetProvider $offsetProvider, Composer $composer, int $changed) {
        ...
        if (!$composer.shouldExecute(($changed & 3) != 2, $changed & 1)) {
            ...
            CompositionLocalKt.CompositionLocalProvider(CompositionLocalsKt.getLocalViewConfiguration().provides($viewConfiguration), ComposableLambdaKt.rememberComposableLambda(1260045569, true, new Function2() { // from class: androidx.compose.foundation.text.selection.AndroidSelectionHandles_androidKt$$ExternalSyntheticLambda4
                @Override // kotlin.jvm.functions.Function2
                public final Object invoke(Object obj, Object obj2) {
                    return AndroidSelectionHandles_androidKt.SelectionHandle_wLIcFTc$lambda$1$0(j, $isLeft, $semanticsModifier, $offsetProvider, (Composer) obj, ((Integer) obj2).intValue());
                }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit SelectionHandle_wLIcFTc$lambda$1$0(long j, boolean $isLeft, Modifier $semanticsModifier, final OffsetProvider $offsetProvider, Composer $composer, int $changed) {
        ...
        if ($composer.shouldExecute(($changed & 3) != 2, $changed & 1)) {
            ...
            if (j != InlineClassHelperKt.UnspecifiedPackedFloats) {
                ...
                Modifier modifier$iv = SizeKt.m860requiredSizeInqDBjuR0$default($semanticsModifier, DpSize.m7603getWidthD9Ej5fM(j), DpSize.m7601getHeightD9Ej5fM(j), 0.0f, 0.0f, 12, null);
    ...
    public static final boolean SelectionHandle_wLIcFTc$lambda$1$0$0$0$0(OffsetProvider $offsetProvider) {
        return (9223372034707292159L & $offsetProvider.mo1144provideF1C5BW0()) != InlineClassHelperKt.UnspecifiedPackedFloats;
    }
    ...
    public static final void SelectionHandleIcon(final Modifier modifier, final Function0<Boolean> function0, final boolean isLeft, Composer $composer, final int $changed) {
        ...
        if (!$composer2.shouldExecute(($dirty & 147) != 146, $dirty & 1)) {
            ...
            SpacerKt.Spacer(drawSelectionHandle(SizeKt.m866sizeVpY3zN4(modifier, SelectionHandlesKt.getHandleWidth(), SelectionHandlesKt.getHandleHeight()), function0, isLeft), $composer2, 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
    ...
    public static final Unit drawSelectionHandle$lambda$0$0$0$0(Function0 $iconVisible, boolean $isLeft, ImageBitmap $handleImage, ColorFilter $colorFilter, ContentDrawScope $this$onDrawWithContent) {
        ...
        if ($isLeft) {
            ...
            long jMo5270getCenterF1C5BW0 = $this$scale_u2dFgt4K4Q_u24default$iv.mo5270getCenterF1C5BW0();
            ...
            try {
                ...
                DrawScope.m5255drawImagegbVJVH8$default($this$scale_u2dFgt4K4Q_u24default$iv, $handleImage, 0L, 0.0f, null, $colorFilter, 0, 46, null);
            } finally {
            ...
            DrawScope.m5255drawImagegbVJVH8$default($this$onDrawWithContent, $handleImage, 0L, 0.0f, null, $colorFilter, 0, 46, null);
        }
        return Unit.INSTANCE;
    }
    ...
    public static final ImageBitmap createHandleImage(CacheDrawScope $this$createHandleImage, float radius) {
        ...
        if (imageBitmap2 == null || canvas2 == null || edge2 > imageBitmap2.getWidth() || edge2 > imageBitmap2.getHeight()) {
            ImageBitmap imageBitmap3 = ImageBitmapKt.m4933ImageBitmapx__hDU$default(edge2, edge2, ImageBitmapConfig.INSTANCE.m4927getAlpha8_sVssgQ(), false, null, 24, null);
            edge = edge2;
        ...
        long jM4512constructorimpl = Size.m4512constructorimpl((v1$iv$iv << 32) | (v2$iv$iv & 4294967295L));
        ...
        $this$draw_yzxVdVo_u24lambda_u240$iv.m5191setSizeuvyYCjk(jM4512constructorimpl);
        canvas$iv.save();
        CanvasDrawScope $this$createHandleImage_u24lambda_u240 = this_$iv;
        DrawScope.m5265drawRectnJ9OG0$default($this$createHandleImage_u24lambda_u240, Color.INSTANCE.m4723getBlack0d7_KjU(), 0L, $this$createHandleImage_u24lambda_u240.mo5271getSizeNHjbRc(), 0.0f, null, null, BlendMode.INSTANCE.m4610getClear0nO6VwU(), 58, null);
        ...
        DrawScope.m5265drawRectnJ9OG0$default($this$createHandleImage_u24lambda_u240, jColor, jM4468getZeroF1C5BW0, Size.m4512constructorimpl((v1$iv$iv2 << 32) | (v2$iv$iv2 & 4294967295L)), 0.0f, null, null, 0, 120, null);
        ...
        DrawScope.m5252drawCircleVaOC9Bg$default($this$createHandleImage_u24lambda_u240, jColor2, radius, Offset.m4444constructorimpl((v1$iv$iv3 << 32) | (v2$iv$iv3 & 4294967295L)), 0.0f, null, null, 0, 120, null);
        canvas$iv.restore();
    ...
    public static final void HandlePopup(final OffsetProvider positionProvider, final Alignment handleReferencePoint, final Function2<? super Composer, ? super Integer, Unit> function2, Composer $composer, final int $changed) {
        ...
        if (!$composer2.shouldExecute(($dirty2 & 147) != 146, $dirty2 & 1)) {
            ...
            ComposerKt.sourceInformationMarkerEnd($composer2);
            AndroidPopup_androidKt.Popup(popupPositionProvider, null, new PopupProperties(false, false, false, (SecureFlagPolicy) null, true, false, 15, (DefaultConstructorMarker) null), function2, $composer2, (($dirty2 << 3) & 7168) | RendererCapabilities.DECODER_SUPPORT_MASK, 2);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
