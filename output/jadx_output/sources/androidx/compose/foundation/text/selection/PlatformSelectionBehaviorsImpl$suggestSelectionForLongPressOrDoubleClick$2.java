    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                TextSelection.Request.Builder builder = new TextSelection.Request.Builder(this.$text, TextRange.m6926getMinimpl(this.f59$$v$c$androidxcomposeuitextTextRange$selection$0), TextRange.m6925getMaximpl(this.f59$$v$c$androidxcomposeuitextTextRange$selection$0)).setDefaultLocales(this.this$0.getAndroidLocalList());
                ...
                if (Build.VERSION.SDK_INT >= 31 && suggestedSelection2.getTextClassification() != null) {
                    ...
                    try {
                        ...
                        return TextRange.m6916boximpl(newSelection2);
                    } finally {
                ...
                this.J$0 = newSelection3;
                this.label = 2;
                if (this.this$0.m1595classifyTextM8tDOmk(this.$text, newSelection3, $this$requireTextClassificationSession, this) == coroutine_suspended) {
                    return coroutine_suspended;
                }
