...
final class SelectionGesturesKt$touchSelectionSubsequentPress$downResolution$1 extends RestrictedSuspendLambda implements Function2<AwaitPointerEventScope, Continuation<? super DownResolution>, Object> {
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                this.label = 1;
                Object objM467awaitTouchSlopOrCancellationjO51t88 = DragGestureDetectorKt.m467awaitTouchSlopOrCancellationjO51t88($this$withTimeoutOrNull, j, new Function2() { // from class: androidx.compose.foundation.text.selection.SelectionGesturesKt$touchSelectionSubsequentPress$downResolution$1$$ExternalSyntheticLambda0
                    @Override // kotlin.jvm.functions.Function2
                ...
                if (objM467awaitTouchSlopOrCancellationjO51t88 == coroutine_suspended) {
                    return coroutine_suspended;
                }
                $result = objM467awaitTouchSlopOrCancellationjO51t88;
                break;
            case 1:
        ...
        if (firstDragPastSlop != null) {
            if ((9223372034707292159L & this.$overSlop.element) != InlineClassHelperKt.UnspecifiedPackedFloats) {
    ...
    static final Unit invokeSuspend$lambda$0(Ref.LongRef $overSlop, PointerInputChange change, Offset slop) {
        change.consume();
        $overSlop.element = slop.m4462unboximpl();
