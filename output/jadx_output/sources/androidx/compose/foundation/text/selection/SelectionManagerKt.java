...
public final class SelectionManagerKt {
        ...
        while (index$iv2 < size) {
            ...
            if (startOffset == endOffset) {
                ...
                if (localCoordinates == null) {
                    ...
                    long localTopLeft = Offset.m4444constructorimpl((v1$iv$iv << 32) | (v2$iv$iv & 4294967295L));
                    float y$iv2 = bottom;
                    float x$iv2 = right2;
                    long v1$iv$iv2 = Float.floatToRawIntBits(x$iv2);
                    long v2$iv$iv2 = Float.floatToRawIntBits(y$iv2);
                    long localBottomRight = Offset.m4444constructorimpl((v1$iv$iv2 << 32) | (v2$iv$iv2 & 4294967295L));
                    long containerTopLeft = containerCoordinates.mo6150localPositionOfR5De75A(localCoordinates, localTopLeft);
                    long containerBottomRight = containerCoordinates.mo6150localPositionOfR5De75A(localCoordinates, localBottomRight);
    ...
    public static final long m1634calculateSelectionMagnifierCenterAndroidO0kMr_c(SelectionManager manager, long j) {
        ...
        switch (draggingHandle == null ? -1 : WhenMappings.$EnumSwitchMapping$0[draggingHandle.ordinal()]) {
            ...
            case 1:
                return m1636getMagnifierCenterJVtK1S4(manager, j, selection.getStart());
            case 2:
                return m1636getMagnifierCenterJVtK1S4(manager, j, selection.getEnd());
            case 3:
    ...
    private static final long m1636getMagnifierCenterJVtK1S4(SelectionManager manager, long j, Selection.AnchorInfo anchor) {
        ...
        if (selectable != null && (containerCoordinates = manager.getContainerLayoutCoordinates()) != null && (selectableCoordinates = selectable.getLayoutCoordinates()) != null && (offset = anchor.getOffset()) <= selectable.getLastVisibleOffset()) {
            Offset offsetM1624getCurrentDragPosition_m7T9E = manager.m1624getCurrentDragPosition_m7T9E();
            Intrinsics.checkNotNull(offsetM1624getCurrentDragPosition_m7T9E);
            long localDragPosition = selectableCoordinates.mo6150localPositionOfR5De75A(containerCoordinates, offsetM1624getCurrentDragPosition_m7T9E.m4462unboximpl());
            int bits$iv$iv$iv = (int) (localDragPosition >> 32);
            float dragX = Float.intBitsToFloat(bits$iv$iv$iv);
            long lineRange = selectable.mo1585getRangeOfLineContainingjx7JFs(offset);
            if (TextRange.m6922getCollapsedimpl(lineRange)) {
                lineStartX = selectable.getLineLeft(offset);
            } else {
                float lineStartX2 = selectable.getLineLeft(TextRange.m6928getStartimpl(lineRange));
                float lineEndX = selectable.getLineRight(TextRange.m6923getEndimpl(lineRange) - 1);
            ...
            if (!IntSize.m7674equalsimpl0(j, IntSize.INSTANCE.m7681getZeroYbymL2g()) && Math.abs(dragX - lineStartX) > ((int) (j >> 32)) / 2) {
                return Offset.INSTANCE.m4467getUnspecifiedF1C5BW0();
            }
            ...
            return containerCoordinates.mo6150localPositionOfR5De75A(selectableCoordinates, Offset.m4444constructorimpl((v1$iv$iv << 32) | (v2$iv$iv & 4294967295L)));
        }
        return Offset.INSTANCE.m4467getUnspecifiedF1C5BW0();
    }
    ...
    public static final Rect visibleBounds(LayoutCoordinates $this$visibleBounds) {
        ...
        return RectKt.m4490Rect0a9Yr6o($this$visibleBounds.mo6158windowToLocalMKHz9U(boundsInWindow.m4487getTopLeftF1C5BW0()), $this$visibleBounds.mo6158windowToLocalMKHz9U(boundsInWindow.m4481getBottomRightF1C5BW0()));
    }

    /* JADX INFO: renamed from: containsInclusive-Uv8p0NA, reason: not valid java name */
    public static final boolean m1635containsInclusiveUv8p0NA(Rect $this$containsInclusive_u2dUv8p0NA, long j) {
