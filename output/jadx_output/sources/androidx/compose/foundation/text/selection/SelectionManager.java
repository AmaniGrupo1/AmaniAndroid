...
public final class SelectionManager {
    ...
    private final MutableState dragBeginPosition = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m4441boximpl(Offset.INSTANCE.m4468getZeroF1C5BW0()), null, 2, null);

    /* JADX INFO: renamed from: dragTotalDistance$delegate, reason: from kotlin metadata */
    private final MutableState dragTotalDistance = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m4441boximpl(Offset.INSTANCE.m4468getZeroF1C5BW0()), null, 2, null);
    ...
    public final Modifier getModifier() {
        return addContextMenuComponents(KeyInputModifierKt.onKeyEvent(SelectionGesturesKt.updateSelectionTouchMode(FocusableKt.focusable$default(FocusChangedModifierKt.onFocusChanged(FocusRequesterModifierKt.focusRequester(OnGloballyPositionedModifierKt.onGloballyPositioned(onClearSelectionRequested(Modifier.INSTANCE, new Function0() { // from class: androidx.compose.foundation.text.selection.SelectionManager$$ExternalSyntheticLambda0
            ...
            public /* bridge */ /* synthetic */ Boolean invoke(KeyEvent keyEvent) {
                return m1633invokeZmokQxo(keyEvent.m5842unboximpl());
            }
    ...
    public final void setContainerLayoutCoordinates(LayoutCoordinates value) {
        ...
        if (getHasFocus() && getSelection() != null) {
            Offset positionInWindow = value != null ? Offset.m4441boximpl(LayoutCoordinatesKt.positionInWindow(value)) : null;
    ...
    static final Unit _init_$lambda$1(SelectionManager this$0, boolean isInTouchMode, LayoutCoordinates layoutCoordinates, Offset rawPosition, SelectionAdjustment selectionMode) {
        long $this$lambda_u241_u240 = layoutCoordinates.mo6149getSizeYbymL2g();
        Rect textRect = new Rect(0.0f, 0.0f, (int) ($this$lambda_u241_u240 >> 32), (int) (4294967295L & $this$lambda_u241_u240));
        long position = SelectionManagerKt.m1635containsInclusiveUv8p0NA(textRect, rawPosition.m4462unboximpl()) ? rawPosition.m4462unboximpl() : TextLayoutStateKt.m1453coerceIn3MmeM6k(rawPosition.m4462unboximpl(), textRect);
        long positionInContainer = this$0.m1616convertToContainerCoordinatesR5De75A(layoutCoordinates, position);
        if (((9223372034707292159L & positionInContainer) != androidx.compose.ui.geometry.InlineClassHelperKt.UnspecifiedPackedFloats ? 1 : 0) != 0) {
            ...
            this$0.m1623startSelection9KIMszo(positionInContainer, false, selectionMode);
            FocusRequester.m4357requestFocus3ESFkO8$default(this$0.focusRequester, 0, 1, null);
    ...
    static final boolean _init_$lambda$3(SelectionManager this$0, boolean isInTouchMode, LayoutCoordinates layoutCoordinates, Offset newPosition, Offset previousPosition, boolean isStartHandle, SelectionAdjustment selectionMode) {
        long newPositionInContainer = this$0.m1616convertToContainerCoordinatesR5De75A(layoutCoordinates, newPosition.m4462unboximpl());
        long previousPositionInContainer = this$0.m1616convertToContainerCoordinatesR5De75A(layoutCoordinates, previousPosition.m4462unboximpl());
        this$0.setInTouchMode(isInTouchMode);
        return this$0.m1631updateSelectionqNKwrvQ$foundation(Offset.m4441boximpl(newPositionInContainer), previousPositionInContainer, isStartHandle, selectionMode);
    }
    ...
    static final Unit _init_$lambda$4(SelectionManager this$0) {
        ...
        this$0.m1618setCurrentDragPosition_kEHs6E(null);
    ...
    static final Unit _init_$lambda$6(SelectionManager this$0, long selectableId) {
        ...
        if ((selection == null || (start = selection.getStart()) == null || selectableId != start.getSelectableId()) ? false : true) {
            this$0.m1622setStartHandlePosition_kEHs6E(null);
        }
        ...
        if ((selection2 == null || (end = selection2.getEnd()) == null || selectableId != end.getSelectableId()) ? false : true) {
            this$0.m1621setEndHandlePosition_kEHs6E(null);
        }
        if (this$0.selectionRegistrar.getSubselections().containsKey(selectableId)) {
            this$0.updateSelectionToolbar();
        }
            ...
            while (index$iv$iv < size) {
                ...
                if (subSelection$iv2 != null) {
                    ...
                    if (isLastSelectable) {
                        ...
                        selectionInSelectable.element = TextRange.m6916boximpl(selectionRange$iv);
            ...
            switch (this.label) {
                case 0:
                    ...
                    if (platformSelectionBehaviors != null) {
                        this.label = 1;
                        Object objMo1592suggestSelectionForLongPressOrDoubleClickpYaCww = platformSelectionBehaviors.mo1592suggestSelectionForLongPressOrDoubleClickpYaCww(this.$textInSelectable.element, this.$selectionInSelectable.element.getPackedValue(), this);
                        ...
                        newSelectionRange = (TextRange) $result;
                        if (newSelectionRange != null && !Intrinsics.areEqual(newSelectionRange, this.$selectionInSelectable.element) && (selectable = SelectionManager.this.selectionRegistrar.getSelectableMap$foundation().get(this.$targetSelectableId.element)) != null && selectable.getText() == this.$textInSelectable.element) {
                            textLayout = selectable.textLayoutResult();
                            if (textLayout != null) {
                                return Unit.INSTANCE;
                            }
                            Selection newSelection = new Selection(new Selection.AnchorInfo(SelectionHelpersKt.getTextDirectionForOffset(textLayout, TextRange.m6928getStartimpl(newSelectionRange.getPackedValue())), TextRange.m6928getStartimpl(newSelectionRange.getPackedValue()), this.$targetSelectableId.element), new Selection.AnchorInfo(SelectionHelpersKt.getTextDirectionForOffset(textLayout, TextRange.m6923getEndimpl(newSelectionRange.getPackedValue())), TextRange.m6923getEndimpl(newSelectionRange.getPackedValue()), this.$targetSelectableId.element), false, 4, null);
                            SelectionManager.this.selectionRegistrar.setSubselections(LongObjectMapKt.mutableLongObjectMapOf(this.$targetSelectableId.element, newSelection));
    ...
    private final void updateHandleOffsets() {
        ...
        if (startLayoutCoordinates == null) {
            ...
            long jMo1584getHandlePositiondBAh8RU = startSelectable.mo1584getHandlePositiondBAh8RU(selection, true);
            if ((jMo1584getHandlePositiondBAh8RU & 9223372034707292159L) == androidx.compose.ui.geometry.InlineClassHelperKt.UnspecifiedPackedFloats) {
                j = 9205357640488583168L;
                j2 = 9223372034707292159L;
                offsetM4441boximpl = null;
            } else {
                j = 9205357640488583168L;
                long position = containerCoordinates.mo6150localPositionOfR5De75A(handleCoordinates, jMo1584getHandlePositiondBAh8RU);
                offsetM4441boximpl = Offset.m4441boximpl(position);
                j2 = 9223372034707292159L;
                long it = offsetM4441boximpl.m4462unboximpl();
                if (!(getDraggingHandle() == Handle.SelectionStart || SelectionManagerKt.m1635containsInclusiveUv8p0NA(visibleBounds, it))) {
                    offsetM4441boximpl = null;
                }
            }
            offset = offsetM4441boximpl;
        ...
        if (endLayoutCoordinates != null) {
            ...
            long handlePosition = endSelectable.mo1584getHandlePositiondBAh8RU(selection, false);
            if (((handlePosition & j2) == j ? 1 : 0) != 0) {
                offset2 = null;
            } else {
                long position2 = containerCoordinates.mo6150localPositionOfR5De75A(handleCoordinates2, handlePosition);
                Offset offsetM4441boximpl2 = Offset.m4441boximpl(position2);
                long it2 = offsetM4441boximpl2.m4462unboximpl();
                offset2 = getDraggingHandle() == Handle.SelectionEnd || SelectionManagerKt.m1635containsInclusiveUv8p0NA(visibleBounds, it2) ? offsetM4441boximpl2 : null;
            }
        } else {
            offset2 = null;
        }
        ...
        if (lastSelectableIndex$iv != -1) {
            ...
            while (true) {
                ...
                if (subSelection$iv2 != null) {
                    ...
                    boolean isLastSelectable = isLastSelectable$iv;
                    $this$getSelectedText_u24lambda_u240.append(currentText$iv, TextRange.m6926getMinimpl(selectionRange$iv), TextRange.m6925getMaximpl(selectionRange$iv));
                    if (!isLastSelectable) {
    ...
    public final Pair<AnnotatedString, TextRange> getContextTextAndSelection$foundation() {
        ...
        if (getSelection() != null && !this.selectionRegistrar.getSelectables$foundation().isEmpty()) {
                    ...
                    if (index$iv$iv < size) {
                        ...
                        if (subSelection$iv2 == null) {
                            ...
                            if (end3 != -1) {
                                ...
                                int start5 = TextRange.m6926getMinimpl(selectionRange$iv);
                                int start6 = TextRange.m6926getMinimpl(selectionRange$iv);
                                start3 = start5;
                                text = currentText$iv;
                                lastSelectableIndex$iv2 = lastSelectableIndex$iv;
                                $this$getContextTextAndSelection_u24lambda_u240.append(text, 0, start6);
                            }
                            int start7 = TextRange.m6926getMinimpl(selectionRange$iv);
                            $this$getContextTextAndSelection_u24lambda_u240.append(text, start7, TextRange.m6925getMaximpl(selectionRange$iv));
                            if (!isLastSelectable) {
                                $this$getContextTextAndSelection_u24lambda_u240.append('\n');
                                end = end2;
                            } else {
                                int end4 = $this$getContextTextAndSelection_u24lambda_u240.getLength();
                                $this$getContextTextAndSelection_u24lambda_u240.append(text, TextRange.m6925getMaximpl(selectionRange$iv), text.length());
                                end = end4;
                            }
                            boolean shouldContinue$iv = z;
                            if (shouldContinue$iv) {
            ...
            return new Pair<>(text2, TextRange.m6916boximpl(TextRangeKt.TextRange(start2, end)));
        }
        return null;
    }
    ...
    public final void forEachSelectableWithSelection$foundation(Function4<? super Long, ? super AnnotatedString, ? super TextRange, ? super Boolean, Boolean> block) {
        ...
        while (index$iv < size) {
            ...
            if (subSelection2 == null) {
                ...
                list = listSort;
                list2 = list3;
                boolean shouldContinue = block.invoke(Long.valueOf(selectable.getSelectableId()), currentText, TextRange.m6916boximpl(selectionRange), Boolean.valueOf(isLastSelectable)).booleanValue();
                if (!shouldContinue) {
                    return;
                }
            }
    ...
    private final void updateSelectionTextToolbar() {
        ...
        if (this.showToolbar && isInTouchMode()) {
            ...
            TextToolbar.showMenu$default(textToolbar, rect, canCopy$foundation() ? new C03371(this) : null, null, null, isEntireContainerSelected$foundation() ? null : new C03382(this), null, 12, null);
            return;
        }
    ...
    static final /* synthetic */ class C03371 extends FunctionReferenceImpl implements Function0<Unit> {
        C03371(Object obj) {
    ...
    /* JADX INFO: compiled from: SelectionManager.kt */
    @Metadata(k = 3, mv = {2, 0, 0}, xi = 48)
    static final /* synthetic */ class C03382 extends FunctionReferenceImpl implements Function0<Unit> {
        C03382(Object obj) {
    ...
    public final Rect getContentRect() {
        ...
        Rect rootRect = visibleRect.m4489translatek4lQ0M(LayoutCoordinatesKt.positionInRoot(containerCoordinates));
    ...
    public final TextDragObserver handleDragObserver(final boolean isStartHandle) {
        return new TextDragObserver() { // from class: androidx.compose.foundation.text.selection.SelectionManager.handleDragObserver.1
            ...
            public void mo1253onDownk4lQ0M(long point) {
                ...
                SelectionManager selectionManager = this;
                Offset offsetM1628getStartHandlePosition_m7T9E = z ? selectionManager.m1628getStartHandlePosition_m7T9E() : selectionManager.m1627getEndHandlePosition_m7T9E();
                if (offsetM1628getStartHandlePosition_m7T9E == null) {
                    return;
                }
                offsetM1628getStartHandlePosition_m7T9E.m4462unboximpl();
                ...
                long handlePosition = selectable.mo1584getHandlePositiondBAh8RU(selection, isStartHandle);
                if ((9223372034707292159L & handlePosition) == androidx.compose.ui.geometry.InlineClassHelperKt.UnspecifiedPackedFloats) {
                    return;
                }
                long beginCoordinates = SelectionHandlesKt.m1608getAdjustedCoordinatesk4lQ0M(handlePosition);
                this.m1618setCurrentDragPosition_kEHs6E(Offset.m4441boximpl(this.requireContainerCoordinates$foundation().mo6150localPositionOfR5De75A(beginLayoutCoordinates, beginCoordinates)));
            ...
            public void mo1255onStart3MmeM6k(long startPoint, SelectionAdjustment selectionAdjustment) {
                ...
                if (value$iv != null) {
                    ...
                    if (beginLayoutCoordinates != null) {
                        ...
                        long beginCoordinates = SelectionHandlesKt.m1608getAdjustedCoordinatesk4lQ0M(handlePosition);
                        this.m1619setDragBeginPositionk4lQ0M(this.requireContainerCoordinates$foundation().mo6150localPositionOfR5De75A(beginLayoutCoordinates, beginCoordinates));
                        this.m1620setDragTotalDistancek4lQ0M(Offset.INSTANCE.m4468getZeroF1C5BW0());
                        return;
                    }
            ...
            public void mo1254onDragk4lQ0M(long delta) {
                ...
                this.m1620setDragTotalDistancek4lQ0M(Offset.m4457plusMKHz9U(this.m1626getDragTotalDistanceF1C5BW0$foundation(), delta));
                long endPosition = Offset.m4457plusMKHz9U(this.m1625getDragBeginPositionF1C5BW0$foundation(), this.m1626getDragTotalDistanceF1C5BW0$foundation());
                boolean consumed = this.m1631updateSelectionqNKwrvQ$foundation(Offset.m4441boximpl(endPosition), this.m1625getDragBeginPositionF1C5BW0$foundation(), isStartHandle, SelectionAdjustment.INSTANCE.getCharacterWithWordAccelerate());
                if (consumed) {
                    this.m1619setDragBeginPositionk4lQ0M(endPosition);
                    this.m1620setDragTotalDistancek4lQ0M(Offset.INSTANCE.m4468getZeroF1C5BW0());
                }
            }
    ...
    private final Modifier onClearSelectionRequested(Modifier $this$onClearSelectionRequested, final Function0<Unit> function0) {
        return SuspendingPointerInputFilterKt.pointerInput($this$onClearSelectionRequested, Unit.INSTANCE, new PointerInputEventHandler() { // from class: androidx.compose.foundation.text.selection.SelectionManager.onClearSelectionRequested.1
                ...
                public final Object invokeSuspend(Object $result) {
                    ...
                    switch (this.label) {
                        case 0:
                            ...
                            this.label = 1;
                            Object objAwaitPrimaryFirstDown$default = TapGestureDetectorKt.awaitPrimaryFirstDown$default($this$awaitEachGesture, false, null, this, 2, null);
                            if (objAwaitPrimaryFirstDown$default == coroutine_suspended) {
                                return coroutine_suspended;
                            }
                            $result = objAwaitPrimaryFirstDown$default;
                            PointerInputChange primaryFirstDown = (PointerInputChange) $result;
                            this.L$0 = null;
                            this.label = 2;
                            $result = DragGestureDetectorKt.awaitAllPointersUpWithSlopDetection($this$awaitEachGesture, primaryFirstDown, PointerEventPass.Initial, this);
                            if ($result == coroutine_suspended) {
                                return coroutine_suspended;
                            }
                            pointerSlopReached = ((Boolean) $result).booleanValue();
                            if (!pointerSlopReached && !this.this$0.isDraggingInProgress()) {
                                this.$block.invoke();
                            }
                            return Unit.INSTANCE;
                        case 1:
                            ...
                            PointerInputChange primaryFirstDown2 = (PointerInputChange) $result;
                            this.L$0 = null;
                            this.label = 2;
                            $result = DragGestureDetectorKt.awaitAllPointersUpWithSlopDetection($this$awaitEachGesture, primaryFirstDown2, PointerEventPass.Initial, this);
                            if ($result == coroutine_suspended) {
                            }
                            pointerSlopReached = ((Boolean) $result).booleanValue();
                            if (!pointerSlopReached) {
                                this.$block.invoke();
                            }
                            return Unit.INSTANCE;
                        case 2:
            ...
            public final Object invoke(PointerInputScope $this$pointerInput, Continuation<? super Unit> continuation) {
                Object objAwaitEachGesture = ForEachGestureKt.awaitEachGesture($this$pointerInput, new C00411(SelectionManager.this, function0, null), continuation);
    ...
    private final long m1616convertToContainerCoordinatesR5De75A(LayoutCoordinates layoutCoordinates, long offset) {
        LayoutCoordinates coordinates = this.containerLayoutCoordinates;
        if (coordinates == null || !coordinates.isAttached()) {
            return Offset.INSTANCE.m4467getUnspecifiedF1C5BW0();
        }
        return requireContainerCoordinates$foundation().mo6150localPositionOfR5De75A(layoutCoordinates, offset);
    }

    /* JADX INFO: renamed from: startSelection-9KIMszo, reason: not valid java name */
    private final void m1623startSelection9KIMszo(long position, boolean isStartHandle, SelectionAdjustment adjustment) {
        this.previousSelectionLayout = null;
        m1630updateSelectionjyLRC_s$foundation(position, Offset.INSTANCE.m4467getUnspecifiedF1C5BW0(), isStartHandle, adjustment);
    }

    /* JADX INFO: renamed from: updateSelection-qNKwrvQ$foundation, reason: not valid java name */
    public final boolean m1631updateSelectionqNKwrvQ$foundation(Offset newPosition, long previousPosition, boolean isStartHandle, SelectionAdjustment adjustment) {
        if (newPosition == null) {
            return false;
        }
        return m1630updateSelectionjyLRC_s$foundation(newPosition.m4462unboximpl(), previousPosition, isStartHandle, adjustment);
    }

    /* JADX INFO: renamed from: updateSelection-jyLRC_s$foundation, reason: not valid java name */
    public final boolean m1630updateSelectionjyLRC_s$foundation(long position, long previousHandlePosition, boolean isStartHandle, SelectionAdjustment adjustment) {
        setDraggingHandle(isStartHandle ? Handle.SelectionStart : Handle.SelectionEnd);
        m1618setCurrentDragPosition_kEHs6E(Offset.m4441boximpl(position));
        SelectionLayout selectionLayout = m1617getSelectionLayoutWko1d7g(position, previousHandlePosition, isStartHandle);
    ...
    private final SelectionLayout m1617getSelectionLayoutWko1d7g(long position, long previousHandlePosition, boolean isStartHandle) {
    ...
    public final void m1629selectWordAtPositionIfNotAlreadySelectedk4lQ0M(long position) {
        boolean isClickedPositionInsideSelection;
        LayoutCoordinates selectableLayoutCoords;
        LayoutCoordinates containerCoordinates;
        boolean zM1288isPositionInsideSelectionuaM50fQ;
        ...
        if (containerCoordinates2 != null && containerCoordinates2.isAttached()) {
            ...
            while (true) {
                if (index$iv$iv < size) {
                    ...
                    if (selection == null || (selectableLayoutCoords = selectable.getLayoutCoordinates()) == null) {
                        ...
                        zM1288isPositionInsideSelectionuaM50fQ = false;
                    } else {
                        long positionInSelectable = selectableLayoutCoords.mo6150localPositionOfR5De75A(containerCoordinates2, position);
                        ...
                        if (textLayoutResult == null) {
                            ...
                            containerCoordinates = containerCoordinates2;
                            zM1288isPositionInsideSelectionuaM50fQ = TextLayoutHelperKt.m1288isPositionInsideSelectionuaM50fQ(textLayoutResult, positionInSelectable, TextRange.m6916boximpl(selection.m1602toTextRanged9O1mEE()));
                        }
                    }
                    if (zM1288isPositionInsideSelectionuaM50fQ) {
            ...
            if (!isClickedPositionInsideSelection) {
                m1623startSelection9KIMszo(position, true, SelectionAdjustment.INSTANCE.getWord());
            }
        }
    }
}
