...
public final class SelectionManager_androidKt {
    ...
    public static final Offset selectionMagnifier$lambda$0$3$0(SelectionManager $manager, MutableState $magnifierSize$delegate) {
        return Offset.m4441boximpl(SelectionManagerKt.m1634calculateSelectionMagnifierCenterAndroidO0kMr_c($manager, selectionMagnifier$lambda$0$1($magnifierSize$delegate)));
    }
    ...
    public static final Modifier selectionMagnifier$lambda$0$4$0(final Density $density, final MutableState $magnifierSize$delegate, final Function0 center) {
        return Magnifier_androidKt.m333magnifierjPUL71Q$default(Modifier.INSTANCE, new Function1() { // from class: androidx.compose.foundation.text.selection.SelectionManager_androidKt$$ExternalSyntheticLambda9
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
    ...
    public static final Unit selectionMagnifier$lambda$0$4$0$1(Density $density, MutableState $magnifierSize$delegate, DpSize size) {
        ...
        selectionMagnifier$lambda$0$2($magnifierSize$delegate, IntSize.m7671constructorimpl((((long) width$iv) << 32) | (((long) height$iv) & 4294967295L)));
    ...
    static final Unit addSelectionContainerTextContextMenuComponents$lambda$0(final SelectionManager $selectionManager, TextContextMenuBuilderScope $this$addTextContextMenuComponentsWithContext, final Context context) {
        ...
        PlatformSelectionBehaviors_androidKt.m1600addPlatformTextContextMenuItems71BSaZU($this$addTextContextMenuComponentsWithContext, context, false, contextTextAndSelection$foundation != null ? contextTextAndSelection$foundation.getFirst() : null, contextTextAndSelection$foundation != null ? contextTextAndSelection$foundation.getSecond() : null, $selectionManager.getPlatformSelectionBehaviors(), new Function1() { // from class: androidx.compose.foundation.text.selection.SelectionManager_androidKt$$ExternalSyntheticLambda2
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
