...
public final class HandlePositionProvider implements PopupPositionProvider {
    ...
    private long prevPosition = Offset.INSTANCE.m4468getZeroF1C5BW0();
    ...
    public long mo373calculatePositionllwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
        long position = this.positionProvider.mo1144provideF1C5BW0();
        if (!((9223372034707292159L & position) != InlineClassHelperKt.UnspecifiedPackedFloats)) {
            position = this.prevPosition;
        }
        this.prevPosition = position;
        long adjustment = this.handleReferencePoint.mo4171alignKFBX0sM(popupContentSize, IntSize.INSTANCE.m7681getZeroYbymL2g(), layoutDirection);
        return IntOffset.m7637plusqkQi6aY(IntOffset.m7637plusqkQi6aY(anchorBounds.m7662getTopLeftnOccac(), IntOffsetKt.m7650roundk4lQ0M(position)), adjustment);
    }
}
