...
public abstract class BaseTextPreparedSelection<T extends BaseTextPreparedSelection<T>> {
    ...
    public final void m1582setSelection5zctL8(long j) {
        this.selection = j;
    }
    ...
    public final T deselect() {
        ...
        if (getText$foundation().length() > 0) {
            BaseTextPreparedSelection<T> baseTextPreparedSelection = this;
            baseTextPreparedSelection.setCursor(TextRange.m6923getEndimpl(baseTextPreparedSelection.selection));
        }
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type T of androidx.compose.foundation.text.selection.BaseTextPreparedSelection");
        return this;
    }
    ...
    public final T collapseLeftOr(Function1<? super T, Unit> or) {
        ...
        if (getText$foundation().length() > 0) {
            BaseTextPreparedSelection<T> baseTextPreparedSelection = this;
            if (TextRange.m6922getCollapsedimpl(baseTextPreparedSelection.selection)) {
                ...
                if (zIsLtr) {
                    baseTextPreparedSelection.setCursor(TextRange.m6926getMinimpl(j));
                } else {
                    baseTextPreparedSelection.setCursor(TextRange.m6925getMaximpl(j));
                }
            }
        }
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type T of androidx.compose.foundation.text.selection.BaseTextPreparedSelection");
    ...
    public final int getPrecedingCodePointOrEmojiStartIndex() {
        return StringHelpers_androidKt.findCodePointOrEmojiStartBefore(this.annotatedString.getText(), TextRange.m6923getEndimpl(this.selection), -1);
    }

    public final int getPrecedingCharacterIndex() {
        return StringHelpers_androidKt.findPrecedingBreak(this.annotatedString.getText(), TextRange.m6923getEndimpl(this.selection));
    }

    public final int getNextCharacterIndex() {
        return StringHelpers_androidKt.findFollowingBreak(this.annotatedString.getText(), TextRange.m6923getEndimpl(this.selection));
    }
    ...
    public final T moveCursorPrevByParagraph() {
        ...
        if (getText$foundation().length() > 0) {
            BaseTextPreparedSelection<T> baseTextPreparedSelection = this;
            int paragraphStart = StringHelpersKt.findParagraphStart(baseTextPreparedSelection.getText$foundation(), TextRange.m6926getMinimpl(baseTextPreparedSelection.selection));
            if (paragraphStart == TextRange.m6926getMinimpl(baseTextPreparedSelection.selection) && paragraphStart != 0) {
    ...
    public final T moveCursorNextByParagraph() {
        ...
        if (getText$foundation().length() > 0) {
            BaseTextPreparedSelection<T> baseTextPreparedSelection = this;
            int paragraphEnd = StringHelpersKt.findParagraphEnd(baseTextPreparedSelection.getText$foundation(), TextRange.m6925getMaximpl(baseTextPreparedSelection.selection));
            if (paragraphEnd == TextRange.m6925getMaximpl(baseTextPreparedSelection.selection) && paragraphEnd != baseTextPreparedSelection.getText$foundation().length()) {
    ...
    public final T selectMovement() {
        if (getText$foundation().length() > 0) {
            BaseTextPreparedSelection<T> baseTextPreparedSelection = this;
            baseTextPreparedSelection.selection = TextRangeKt.TextRange(TextRange.m6928getStartimpl(baseTextPreparedSelection.originalSelection), TextRange.m6923getEndimpl(baseTextPreparedSelection.selection));
        }
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type T of androidx.compose.foundation.text.selection.BaseTextPreparedSelection");
        return this;
    }
    ...
    private final int getNextWordOffsetForLayout(TextLayoutResult $this$getNextWordOffsetForLayout, int currentOffset) {
        while (currentOffset < this.originalText.length()) {
            ...
            if (TextRange.m6923getEndimpl(currentWord) <= currentOffset) {
                ...
                return this.offsetMapping.transformedToOriginal(TextRange.m6923getEndimpl(currentWord));
            }
        }
    ...
    private final int getPrevWordOffset(TextLayoutResult $this$getPrevWordOffset, int currentOffset) {
        while (currentOffset > 0) {
            long currentWord = $this$getPrevWordOffset.m6900getWordBoundaryjx7JFs(charOffset(currentOffset));
            if (TextRange.m6928getStartimpl(currentWord) >= currentOffset) {
                currentOffset--;
            } else {
                return this.offsetMapping.transformedToOriginal(TextRange.m6928getStartimpl(currentWord));
            }
        }
        return 0;
    }
    ...
    private final int jumpByLinesOffset(TextLayoutResult $this$jumpByLinesOffset, int linesAmount) {
        ...
        if ((!isLtr() || it < $this$jumpByLinesOffset.getLineRight(targetLine)) && (isLtr() || it > $this$jumpByLinesOffset.getLineLeft(targetLine))) {
            ...
            return this.offsetMapping.transformedToOriginal($this$jumpByLinesOffset.m6898getOffsetForPositionk4lQ0M(Offset.m4444constructorimpl((v1$iv$iv << 32) | (v2$iv$iv & 4294967295L))));
        }
        return $this$jumpByLinesOffset.getLineEnd(targetLine, true);
    }

    private final int transformedEndOffset() {
        return this.offsetMapping.originalToTransformed(TextRange.m6923getEndimpl(this.selection));
    }

    private final int transformedMinOffset() {
        return this.offsetMapping.originalToTransformed(TextRange.m6926getMinimpl(this.selection));
    }

    private final int transformedMaxOffset() {
        return this.offsetMapping.originalToTransformed(TextRange.m6925getMaximpl(this.selection));
    }
