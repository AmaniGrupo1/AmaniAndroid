...
public final class TextFieldDelegateKt {
    ...
    public static final long computeSizeForDefaultText(TextStyle style, Density density, FontFamily.Resolver fontFamilyResolver, String text, int maxLines) {
        Paragraph paragraph = ParagraphKt.m6807ParagraphUl8oQg4(text, style, ConstraintsKt.Constraints$default(0, 0, 0, 0, 15, null), density, fontFamilyResolver, (64 & 32) != 0 ? CollectionsKt.emptyList() : CollectionsKt.emptyList(), (64 & 64) != 0 ? CollectionsKt.emptyList() : null, (64 & 128) != 0 ? Integer.MAX_VALUE : maxLines, (64 & 256) != 0 ? TextOverflow.INSTANCE.m7415getClipgIe3tQ8() : TextOverflow.INSTANCE.m7415getClipgIe3tQ8());
    ...
    public static final Rect focusedRectInRoot(TextLayoutResult layoutResult, LayoutCoordinates layoutCoordinates, int focusOffset, Function0<IntSize> function0) {
        ...
        if (focusOffset < layoutResult.getLayoutInput().getText().length()) {
            ...
            long size = function0.invoke().m7680unboximpl();
        ...
        long globalLT = layoutCoordinates.mo6152localToRootMKHz9U(Offset.m4444constructorimpl((v1$iv$iv << 32) | (v2$iv$iv & 4294967295L)));
        ...
        long v2$iv$iv3 = Offset.m4444constructorimpl((v1$iv$iv2 << 32) | (v2$iv$iv2 & 4294967295L));
        Rect this_$iv = bbox;
        ...
        return RectKt.m4492Recttz77jQw(v2$iv$iv3, Size.m4512constructorimpl((v1$iv$iv3 << 32) | (v2$iv$iv4 & 4294967295L)));
    }
}
