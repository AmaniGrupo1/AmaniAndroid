...
final /* data */ class HorizontalScrollLayoutModifier implements LayoutModifier {
    ...
    public MeasureResult mo1198measure3p2s80s(final MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long j) {
        long childConstraints;
        int maxIntrinsicWidth = measurable.maxIntrinsicWidth(Constraints.m7457getMaxHeightimpl(j));
        if (maxIntrinsicWidth >= Constraints.m7458getMaxWidthimpl(j)) {
            childConstraints = Constraints.m7447copyZbe2FdA(j, (11 & 1) != 0 ? Constraints.m7460getMinWidthimpl(j) : 0, (11 & 2) != 0 ? Constraints.m7458getMaxWidthimpl(j) : Integer.MAX_VALUE, (11 & 4) != 0 ? Constraints.m7459getMinHeightimpl(j) : 0, (11 & 8) != 0 ? Constraints.m7457getMaxHeightimpl(j) : 0);
        } else {
            childConstraints = j;
        }
