...
public final class AndroidAutofillManager extends AutofillManager implements SemanticsListener, FocusListener {
    ...
    public final void performAutofill(SparseArray<AutofillValue> values) {
        SemanticsConfiguration semanticsConfig;
        Function1 function1;
        ...
        for (int index = 0; index < size; index++) {
            ...
            SemanticsInfo semanticsInfo = this.semanticsOwner.get$ui(itemId);
            if (semanticsInfo != null && (semanticsConfig = semanticsInfo.getSemanticsConfiguration()) != null) {
                AccessibilityAction accessibilityAction = (AccessibilityAction) SemanticsConfigurationKt.getOrNull(semanticsConfig, SemanticsActions.INSTANCE.getOnAutofillText());
                if (accessibilityAction != null && (function12 = (Function1) accessibilityAction.getAction()) != null) {
                }
                AccessibilityAction accessibilityAction2 = (AccessibilityAction) SemanticsConfigurationKt.getOrNull(semanticsConfig, SemanticsActions.INSTANCE.getOnFillData());
