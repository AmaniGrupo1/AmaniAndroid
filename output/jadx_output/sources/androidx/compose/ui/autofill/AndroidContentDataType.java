...
final class AndroidContentDataType implements ContentDataType {
    ...
    public static final /* synthetic */ AndroidContentDataType m4194boximpl(int i) {
        return new AndroidContentDataType(i);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static int m4195constructorimpl(int i) {
        return i;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m4196equalsimpl(int i, Object obj) {
        return (obj instanceof AndroidContentDataType) && i == ((AndroidContentDataType) obj).m4200unboximpl();
    }
    ...
    public boolean equals(Object obj) {
        return m4196equalsimpl(this.androidAutofillType, obj);
    }

    public int hashCode() {
        return m4198hashCodeimpl(this.androidAutofillType);
    }

    public String toString() {
        return m4199toStringimpl(this.androidAutofillType);
    }
