        ...
        try {
            switch (r1) {
                case 0:
                    ...
                    if (it != null) {
                        StateFlow durationScaleStateFlow = WindowRecomposer_androidKt.getAnimationScaleFlowFor(this.$this_createLifecycleAwareWindowRecomposer.getContext().getApplicationContext());
                        it.setScaleFactor(((Number) durationScaleStateFlow.getValue()).floatValue());
                        jobLaunch$default = BuildersKt__Builders_commonKt.launch$default($this$launch, null, null, new WindowRecomposer_androidKt$createLifecycleAwareWindowRecomposer$2$onStateChanged$1$1$1(durationScaleStateFlow, it, null), 3, null);
                    } else {
                        jobLaunch$default = null;
                    }
                    durationScaleJob = jobLaunch$default;
