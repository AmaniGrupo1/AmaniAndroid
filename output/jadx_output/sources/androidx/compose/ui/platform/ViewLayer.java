...
public final class ViewLayer extends View implements OwnedLayer, GraphicLayerInfo {
    ...
    public ViewLayer(AndroidComposeView ownerView, DrawChildContainer container, Function2<? super Canvas, ? super GraphicsLayer, Unit> function2, Function0<Unit> function0) {
        ...
        this.mTransformOrigin = TransformOrigin.INSTANCE.m5110getCenterSzJe1aQ();
    ...
    public float[] mo6517getUnderlyingMatrixsQKQjiQ() {
        return this.matrixCache.m6642calculateMatrixGrdbGEg(this);
    }
    ...
    /* JADX INFO: compiled from: ViewLayer.android.kt */
    @Metadata(d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0010\t\n\u0000\n\u0002\u0018\u0002\n\u0000\bÃ\u0002\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\u0010\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u0007H\u0007¨\u0006\b"}, d2 = {"Landroidx/compose/ui/platform/ViewLayer$UniqueDrawingIdApi29;", "", "<init>", "()V", "getUniqueDrawingId", "", "view", "Landroid/view/View;", "ui"}, k = 1, mv = {2, 0, 0}, xi = 48)
    ...
    public void updateLayerProperties(ReusableGraphicsLayerScope scope) {
        ...
        if ((maybeChangedFields & 4096) != 0) {
            ...
            setPivotX(TransformOrigin.m5105getPivotFractionXimpl(this.mTransformOrigin) * getWidth());
            setPivotY(TransformOrigin.m5106getPivotFractionYimpl(this.mTransformOrigin) * getHeight());
        }
        ...
        boolean shapeChanged = this.outlineResolver.m6672updateS_szKao(scope.getOutline(), scope.getAlpha(), clipToOutline, scope.getShadowElevation(), scope.getSize());
        ...
        if (Build.VERSION.SDK_INT >= 28) {
            if ((maybeChangedFields & 64) != 0) {
                ViewLayerVerificationHelper28.INSTANCE.setOutlineAmbientShadowColor(this, ColorKt.m4751toArgb8_81llA(scope.getAmbientShadowColor()));
            }
            if ((maybeChangedFields & 128) != 0) {
                ViewLayerVerificationHelper28.INSTANCE.setOutlineSpotShadowColor(this, ColorKt.m4751toArgb8_81llA(scope.getSpotShadowColor()));
            }
        }
        ...
        if ((32768 & maybeChangedFields) != 0 || requireLayer) {
            if (requireLayer) {
                strategy = CompositingStrategy.INSTANCE.m4788getOffscreenNrFUSI();
            } else {
                strategy = scope.getCompositingStrategy();
            }
            android.graphics.Paint paint = null;
            if (CompositingStrategy.m4782equalsimpl0(strategy, CompositingStrategy.INSTANCE.m4788getOffscreenNrFUSI())) {
                if (requireLayer) {
                    ...
                    $this$updateLayerProperties_u24lambda_u240.mo4572setBlendModes9anfk8(scope.getBlendMode());
                    paint = $this$updateLayerProperties_u24lambda_u240.getInternalPaint();
                }
                setLayerType(2, paint);
                z = true;
            } else if (CompositingStrategy.m4782equalsimpl0(strategy, CompositingStrategy.INSTANCE.m4787getModulateAlphaNrFUSI())) {
                setLayerType(0, null);
            } else {
                setLayerType(0, null);
                z = true;
    ...
    public boolean mo6519isInLayerk4lQ0M(long position) {
        ...
        if (getClipToOutline()) {
            return this.outlineResolver.m6671isInOutlinek4lQ0M(position);
        }
        return true;
    }
    ...
    public void mo6522resizeozmzZPI(long size) {
        ...
        if (width != getWidth() || height != getHeight()) {
            setPivotX(TransformOrigin.m5105getPivotFractionXimpl(this.mTransformOrigin) * width);
            setPivotY(TransformOrigin.m5106getPivotFractionYimpl(this.mTransformOrigin) * height);
            updateOutlineResolver();
    ...
    public void mo6521movegyyYBs(long position) {
        int left = IntOffset.m7633getXimpl(position);
        if (left != getLeft()) {
            offsetLeftAndRight(left - getLeft());
            this.matrixCache.invalidate();
        }
        int top = IntOffset.m7634getYimpl(position);
        if (top != getTop()) {
    ...
    public long mo6520mapOffset8S9VItk(long point, boolean inverse) {
        ...
        if (inverse) {
            return layerMatrixCache.m6644mapInverseR5De75A(this, point);
        }
        return layerMatrixCache.m6643mapR5De75A(this, point);
    }
    ...
    public void mo6523transform58bKbWc(float[] matrix) {
        androidx.compose.ui.graphics.Matrix.m4960timesAssign58bKbWc(matrix, this.matrixCache.m6642calculateMatrixGrdbGEg(this));
    }

    @Override // androidx.compose.ui.node.OwnedLayer
    /* JADX INFO: renamed from: inverseTransform-58bKbWc */
    public void mo6518inverseTransform58bKbWc(float[] matrix) {
        float[] inverse = this.matrixCache.m6641calculateInverseMatrixbWbORWo(this);
        if (inverse != null) {
            androidx.compose.ui.graphics.Matrix.m4960timesAssign58bKbWc(matrix, inverse);
        }
    }

    /* JADX INFO: compiled from: ViewLayer.android.kt */
    @Metadata(d1 = {"\u0000:\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0002\b\n\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\u0010\u0010\u001a\u001a\u00020\b2\u0006\u0010\u001b\u001a\u00020\u0006H\u0007R \u0010\u0004\u001a\u0014\u0012\u0004\u0012\u00020\u0006\u0012\u0004\u0012\u00020\u0007\u0012\u0004\u0012\u00020\b0\u0005X\u0082\u0004¢\u0006\u0002\n\u0000R\u0011\u0010\t\u001a\u00020\n¢\u0006\b\n\u0000\u001a\u0004\b\u000b\u0010\fR\u0010\u0010\r\u001a\u0004\u0018\u00010\u000eX\u0082\u000e¢\u0006\u0002\n\u0000R\u0010\u0010\u000f\u001a\u0004\u0018\u00010\u0010X\u0082\u000e¢\u0006\u0002\n\u0000R\u001e\u0010\u0013\u001a\u00020\u00122\u0006\u0010\u0011\u001a\u00020\u0012@BX\u0086\u000e¢\u0006\b\n\u0000\u001a\u0004\b\u0014\u0010\u0015R$\u0010\u0016\u001a\u00020\u00122\u0006\u0010\u0011\u001a\u00020\u0012@@X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u0017\u0010\u0015\"\u0004\b\u0018\u0010\u0019¨\u0006\u001c"}, d2 = {"Landroidx/compose/ui/platform/ViewLayer$Companion;", "", "<init>", "()V", "getMatrix", "Lkotlin/Function2;", "Landroid/view/View;", "Landroid/graphics/Matrix;", "", "OutlineProvider", "Landroid/view/ViewOutlineProvider;", "getOutlineProvider", "()Landroid/view/ViewOutlineProvider;", "updateDisplayListIfDirtyMethod", "Ljava/lang/reflect/Method;", "recreateDisplayList", "Ljava/lang/reflect/Field;", Values.VECTOR_MAP_VECTORS_KEY, "", "hasRetrievedMethod", "getHasRetrievedMethod", "()Z", "shouldUseDispatchDraw", "getShouldUseDispatchDraw", "setShouldUseDispatchDraw$ui", "(Z)V", "updateDisplayList", "view", "ui"}, k = 1, mv = {2, 0, 0}, xi = 48)
