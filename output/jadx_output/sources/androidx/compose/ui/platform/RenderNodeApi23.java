...
public final class RenderNodeApi23 implements DeviceRenderNode {
    ...
    private int internalCompositingStrategy = CompositingStrategy.INSTANCE.m4786getAutoNrFUSI();
    ...
    public void mo6619setBlendModes9anfk8(int i) {
        this.blendMode = i;
        Paint $this$setBlendMode_s9anfk8_u24lambda_u240 = obtainLayerPaint();
        $this$setBlendMode_s9anfk8_u24lambda_u240.mo4572setBlendModes9anfk8(i);
    ...
    public void mo6620setCompositingStrategyaDBOjCE(int i) {
    ...
    private final void updateLayerProperties() {
        ...
        if (zRequiresCompositingLayer) {
            m6673applyCompositingStrategyQu9p0E8(renderNode, CompositingStrategy.INSTANCE.m4788getOffscreenNrFUSI());
        } else {
            m6673applyCompositingStrategyQu9p0E8(renderNode, this.internalCompositingStrategy);
        }
    }

    private final boolean requiresCompositingLayer() {
        return CompositingStrategy.m4782equalsimpl0(getInternalCompositingStrategy(), CompositingStrategy.INSTANCE.m4788getOffscreenNrFUSI()) || requiresLayerPaint();
    }
    ...
    private final void m6673applyCompositingStrategyQu9p0E8(RenderNode $this$applyCompositingStrategy_u2dQu9p0E8, int i) {
        if (CompositingStrategy.m4782equalsimpl0(i, CompositingStrategy.INSTANCE.m4788getOffscreenNrFUSI())) {
        ...
        if (CompositingStrategy.m4782equalsimpl0(i, CompositingStrategy.INSTANCE.m4787getModulateAlphaNrFUSI())) {
    ...
    public final int getLayerType$ui() {
        return CompositingStrategy.m4782equalsimpl0(this.internalCompositingStrategy, CompositingStrategy.INSTANCE.m4788getOffscreenNrFUSI()) ? 2 : 0;
    }
    ...
    public void record(CanvasHolder canvasHolder, Path clipPath, Function1<? super Canvas, Unit> drawBlock) {
        ...
        if (clipPath != null) {
            ...
            Canvas.m4668clipPathmtrdDE$default($this$record_u24lambda_u240, clipPath, 0, 2, null);
        }
