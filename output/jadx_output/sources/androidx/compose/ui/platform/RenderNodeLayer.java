...
public final class RenderNodeLayer implements OwnedLayer, GraphicLayerInfo {
    ...
    public void updateLayerProperties(ReusableGraphicsLayerScope scope) {
        ...
        if ((maybeChangedFields & 64) != 0) {
            this.renderNode.setAmbientShadowColor(ColorKt.m4751toArgb8_81llA(scope.getAmbientShadowColor()));
        }
        if ((maybeChangedFields & 128) != 0) {
            this.renderNode.setSpotShadowColor(ColorKt.m4751toArgb8_81llA(scope.getSpotShadowColor()));
        }
        ...
        if ((maybeChangedFields & 4096) != 0) {
            this.renderNode.setPivotX(TransformOrigin.m5105getPivotFractionXimpl(this.transformOrigin) * this.renderNode.getWidth());
            this.renderNode.setPivotY(TransformOrigin.m5106getPivotFractionYimpl(this.transformOrigin) * this.renderNode.getHeight());
        }
        ...
        if ((524288 & maybeChangedFields) != 0) {
            this.renderNode.mo6619setBlendModes9anfk8(scope.getBlendMode());
        }
        if ((32768 & maybeChangedFields) != 0) {
            this.renderNode.mo6620setCompositingStrategyaDBOjCE(scope.getCompositingStrategy());
        }
    ...
    public void mo6522resizeozmzZPI(long size) {
        ...
        this.renderNode.setPivotX(TransformOrigin.m5105getPivotFractionXimpl(this.transformOrigin) * width);
        this.renderNode.setPivotY(TransformOrigin.m5106getPivotFractionYimpl(this.transformOrigin) * height);
    ...
    public void mo6521movegyyYBs(long position) {
        ...
        int newLeft = IntOffset.m7633getXimpl(position);
        int newTop = IntOffset.m7634getYimpl(position);
    ...
    public void drawLayer(Canvas canvas, GraphicsLayer parentLayer) {
        ...
        canvas.mo4548concat58bKbWc(this.matrixCache.m6642calculateMatrixGrdbGEg(this.renderNode));
    ...
    public float[] mo6517getUnderlyingMatrixsQKQjiQ() {
        return this.matrixCache.m6642calculateMatrixGrdbGEg(this.renderNode);
    }
    ...
    public long mo6520mapOffset8S9VItk(long point, boolean inverse) {
        ...
        if (inverse) {
            return layerMatrixCache.m6644mapInverseR5De75A(this.renderNode, point);
        }
        return layerMatrixCache.m6643mapR5De75A(this.renderNode, point);
    }
    ...
    public void mo6523transform58bKbWc(float[] matrix) {
        androidx.compose.ui.graphics.Matrix.m4960timesAssign58bKbWc(matrix, this.matrixCache.m6642calculateMatrixGrdbGEg(this.renderNode));
    }

    @Override // androidx.compose.ui.node.OwnedLayer
    /* JADX INFO: renamed from: inverseTransform-58bKbWc */
    public void mo6518inverseTransform58bKbWc(float[] matrix) {
        float[] inverse = this.matrixCache.m6641calculateInverseMatrixbWbORWo(this.renderNode);
        if (inverse != null) {
