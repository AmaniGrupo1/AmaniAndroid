...
public final class SemanticsUtils_androidKt {
    ...
    public static final String m6675toLegacyClassNameV4PA4sw(int i) {
        if (Role.m6695equalsimpl0(i, Role.INSTANCE.m6699getButtono7Vup1c())) {
            return "android.widget.Button";
        }
        if (Role.m6695equalsimpl0(i, Role.INSTANCE.m6701getCheckboxo7Vup1c())) {
            return "android.widget.CheckBox";
        }
        if (Role.m6695equalsimpl0(i, Role.INSTANCE.m6704getRadioButtono7Vup1c())) {
            return "android.widget.RadioButton";
        }
        if (Role.m6695equalsimpl0(i, Role.INSTANCE.m6703getImageo7Vup1c())) {
            return "android.widget.ImageView";
        }
        if (Role.m6695equalsimpl0(i, Role.INSTANCE.m6702getDropdownListo7Vup1c())) {
            return "android.widget.Spinner";
        }
        if (Role.m6695equalsimpl0(i, Role.INSTANCE.m6707getValuePickero7Vup1c())) {
