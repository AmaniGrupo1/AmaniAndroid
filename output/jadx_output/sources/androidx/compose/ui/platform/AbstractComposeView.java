...
public abstract class AbstractComposeView extends ViewGroup {
    ...
    public final int m6564getAutoClearFocusBehavior4UtRPd4() {
        ...
        return autoClearFocusBehavior != null ? autoClearFocusBehavior.getValue() : AutoClearFocusBehavior.INSTANCE.m6600getDefault4UtRPd4();
    }

    /* JADX INFO: renamed from: setAutoClearFocusBehavior-17tfJxM, reason: not valid java name */
    public final void m6565setAutoClearFocusBehavior17tfJxM(int i) {
        setTag(R.id.auto_clear_focus_behavior_tag, AutoClearFocusBehavior.m6592boximpl(i));
    }
                ...
                this.composition = Wrapper_androidKt.setContent(this, resolveParentCompositionContext(), ComposableLambdaKt.composableLambdaInstance(-656146368, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.ui.platform.AbstractComposeView.ensureCompositionCreated.1
                    ...
                    public final void invoke(Composer $composer, int $changed) {
                        ...
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventStart(-656146368, $changed, -1, "androidx.compose.ui.platform.AbstractComposeView.ensureCompositionCreated.<anonymous> (ComposeView.android.kt:264)");
                        }
