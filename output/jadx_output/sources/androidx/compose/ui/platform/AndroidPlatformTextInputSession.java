...
public final class AndroidPlatformTextInputSession implements PlatformTextInputSessionScope, CoroutineScope {
    ...
    private final AtomicReference<SessionMutex.Session<InputMethodSession>> methodSessionMutex = SessionMutex.m4185constructorimpl();
    ...
    @DebugMetadata(c = "androidx.compose.ui.platform.AndroidPlatformTextInputSession", f = "AndroidPlatformTextInputSession.android.kt", i = {}, l = {TsExtractor.TS_SYNC_BYTE}, m = "startInputMethod", n = {}, s = {}, v = 1)
    ...
    public final boolean isReadyForConnection() {
        InputMethodSession inputMethodSession = (InputMethodSession) SessionMutex.m4189getCurrentSessionimpl(this.methodSessionMutex);
    ...
    */
    public Object startInputMethod(final PlatformTextInputMethodRequest request, Continuation<?> continuation) {
        ...
        switch (anonymousClass1.label) {
            case 0:
                ...
                Function1<CoroutineScope, InputMethodSession> function1 = new Function1<CoroutineScope, InputMethodSession>() { // from class: androidx.compose.ui.platform.AndroidPlatformTextInputSession.startInputMethod.2
                    ...
                    public final InputMethodSession invoke(CoroutineScope it) {
                        PlatformTextInputMethodRequest platformTextInputMethodRequest = request;
                ...
                if (SessionMutex.m4192withSessionCancellingPreviousimpl(atomicReference, function1, anonymousClass3, anonymousClass1) == coroutine_suspended) {
