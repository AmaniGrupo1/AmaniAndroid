    ...
    public static final String getInfoStateDescriptionOrNull(SemanticsNode node, Resources resources) {
        ...
        if (toggleState != null) {
            switch (WhenMappings.$EnumSwitchMapping$0[toggleState.ordinal()]) {
                case 1:
                    if ((role == null ? false : Role.m6695equalsimpl0(role.getValue(), Role.INSTANCE.m6705getSwitcho7Vup1c())) && stateDescription == null) {
        ...
        if (bool != null) {
            ...
            if (!(role == null ? false : Role.m6695equalsimpl0(role.getValue(), Role.INSTANCE.m6706getTabo7Vup1c())) && stateDescription == null) {
                ...
                if (stateDescription == null) {
                    ...
                    if (!(maximumValue$iv$iv == 0.0f)) {
                        ...
                        if (percent != 0) {
                            ...
                            float $this$fastRoundToInt$iv = 100 * maximumValue$iv$iv;
