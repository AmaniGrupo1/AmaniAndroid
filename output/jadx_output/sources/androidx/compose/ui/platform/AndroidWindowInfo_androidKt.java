...
public final class AndroidWindowInfo_androidKt {
    public static final DerivedSize calculateWindowSize(View view) {
        ...
        if (unwrapped != null) {
            ...
            return companion.m6616fromPxSizeviCIZxY(IntSize.m7671constructorimpl((((long) width$iv) << 32) | (((long) height$iv) & 4294967295L)), AndroidDensity_androidKt.Density(unwrapped));
        }
        ...
        float fM7505constructorimpl = Dp.m7505constructorimpl($this$dp$iv);
        int $i$f$getDp = configuration.screenHeightDp;
        return companion2.m6615fromDpSizeitqla9I(DpKt.m7527DpSizeYgX7TsA(fM7505constructorimpl, Dp.m7505constructorimpl($i$f$getDp)), density);
    }
