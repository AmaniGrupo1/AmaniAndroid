...
public final /* data */ class DeviceRenderNodeData {
    ...
    public static /* synthetic */ DeviceRenderNodeData m6621copyqCc9W8c$default(DeviceRenderNodeData deviceRenderNodeData, long j, int i, int i2, int i3, int i4, int i5, int i6, float f, float f2, float f3, float f4, float f5, int i7, int i8, float f6, float f7, float f8, float f9, float f10, float f11, boolean z, boolean z2, float f12, RenderEffect renderEffect, int i9, ColorFilter colorFilter, int i10, int i11, Object obj) {
        ...
        return deviceRenderNodeData.m6624copyqCc9W8c(j3, i13, i14, i15, i16, i17, i18, f13, f14, f15, f16, f17, i19, i20, f18, f19, f20, f21, f22, f23, z3, z4, f24, renderEffect2, i21, colorFilter2, i12);
    }
    ...
    public String toString() {
        ...
        sb.append(", renderEffect=").append(this.renderEffect).append(", blendMode=").append((Object) BlendMode.m4608toStringimpl(this.blendMode)).append(", colorFilter=").append(this.colorFilter).append(", compositingStrategy=").append((Object) CompositingStrategy.m4784toStringimpl(this.compositingStrategy)).append(')');
        return sb.toString();
    }
    ...
    public final int m6625getBlendMode0nO6VwU() {
        return this.blendMode;
    }

    /* JADX INFO: renamed from: setBlendMode-s9anfk8, reason: not valid java name */
    public final void m6627setBlendModes9anfk8(int i) {
        this.blendMode = i;
    }
    ...
    public final int m6626getCompositingStrategyNrFUSI() {
        return this.compositingStrategy;
    }

    /* JADX INFO: renamed from: setCompositingStrategy-aDBOjCE, reason: not valid java name */
    public final void m6628setCompositingStrategyaDBOjCE(int i) {
