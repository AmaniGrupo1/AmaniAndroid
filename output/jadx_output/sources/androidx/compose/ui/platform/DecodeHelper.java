...
public final class DecodeHelper {
    ...
    public final SpanStyle decodeSpanStyle() {
        ...
        while (this.parcel.dataAvail() > 1) {
            ...
            if (bDecodeByte == 1) {
                ...
                mutableSpanStyle.m6658setColor8_81llA(m6609decodeColor0d7_KjU());
            } else if (bDecodeByte == 2) {
                if (dataAvailable() < 5) {
                    break;
                }
                mutableSpanStyle.m6659setFontSizeR2X_6o(m6612decodeTextUnitXSAIIZE());
                ...
                mutableSpanStyle.m6660setFontStylemLjRB2g(FontStyle.m7037boximpl(m6610decodeFontStyle_LCdwA()));
            } else if (bDecodeByte == 5) {
                if (dataAvailable() < 1) {
                    break;
                }
                mutableSpanStyle.m6661setFontSynthesistDdu0R4(FontSynthesis.m7048boximpl(m6611decodeFontSynthesisGVVA2EU()));
                ...
                mutableSpanStyle.m6662setLetterSpacingR2X_6o(m6612decodeTextUnitXSAIIZE());
            } else if (bDecodeByte == 8) {
                if (dataAvailable() < 4) {
                    break;
                }
                mutableSpanStyle.m6657setBaselineShift_isdbwI(BaselineShift.m7220boximpl(m6607decodeBaselineShifty9eOQZs()));
                ...
                mutableSpanStyle.m6656setBackground8_81llA(m6609decodeColor0d7_KjU());
    ...
    public final long m6609decodeColor0d7_KjU() {
    ...
    public final long m6612decodeTextUnitXSAIIZE() {
        long type;
        byte bDecodeByte = decodeByte();
        if (bDecodeByte == 1) {
            type = TextUnitType.INSTANCE.m7732getSpUIouoOA();
        } else {
            type = bDecodeByte == 2 ? TextUnitType.INSTANCE.m7731getEmUIouoOA() : TextUnitType.INSTANCE.m7733getUnspecifiedUIouoOA();
        }
        if (TextUnitType.m7727equalsimpl0(type, TextUnitType.INSTANCE.m7733getUnspecifiedUIouoOA())) {
            return TextUnit.INSTANCE.m7710getUnspecifiedXSAIIZE();
        }
        float value = decodeFloat();
        return TextUnitKt.m7711TextUnitanM5pPY(value, type);
    }
    ...
    public final int m6610decodeFontStyle_LCdwA() {
        byte bDecodeByte = decodeByte();
        return bDecodeByte == 0 ? FontStyle.INSTANCE.m7047getNormal_LCdwA() : bDecodeByte == 1 ? FontStyle.INSTANCE.m7046getItalic_LCdwA() : FontStyle.INSTANCE.m7047getNormal_LCdwA();
    }

    /* JADX INFO: renamed from: decodeFontSynthesis-GVVA2EU, reason: not valid java name */
    public final int m6611decodeFontSynthesisGVVA2EU() {
        byte bDecodeByte = decodeByte();
        return bDecodeByte == 0 ? FontSynthesis.INSTANCE.m7058getNoneGVVA2EU() : bDecodeByte == 1 ? FontSynthesis.INSTANCE.m7057getAllGVVA2EU() : bDecodeByte == 3 ? FontSynthesis.INSTANCE.m7059getStyleGVVA2EU() : bDecodeByte == 2 ? FontSynthesis.INSTANCE.m7060getWeightGVVA2EU() : FontSynthesis.INSTANCE.m7058getNoneGVVA2EU();
    }

    /* JADX INFO: renamed from: decodeBaselineShift-y9eOQZs, reason: not valid java name */
    private final float m6607decodeBaselineShifty9eOQZs() {
        return BaselineShift.m7221constructorimpl(decodeFloat());
    }
    ...
    private final Shadow decodeShadow() {
        long jM6609decodeColor0d7_KjU = m6609decodeColor0d7_KjU();
        float x$iv = decodeFloat();
        float y$iv = decodeFloat();
        long v1$iv$iv = Float.floatToRawIntBits(x$iv);
        long v2$iv$iv = Float.floatToRawIntBits(y$iv);
        return new Shadow(jM6609decodeColor0d7_KjU, Offset.m4444constructorimpl((v1$iv$iv << 32) | (4294967295L & v2$iv$iv)), decodeFloat(), null);
    }
    ...
    private final long m6608decodeULongsVKNKU() {
        return ULong.m8716constructorimpl(this.parcel.readLong());
    }
