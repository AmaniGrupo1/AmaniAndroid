...
public final class GraphicsLayerOwnerLayer implements OwnedLayer, GraphicLayerInfo {
    ...
    private long size = IntSize.m7671constructorimpl((((long) Integer.MAX_VALUE) << 32) | (((long) Integer.MAX_VALUE) & 4294967295L));
    private final float[] matrixCache = Matrix.m4941constructorimpl$default(null, 1, null);
    ...
    private long transformOrigin = TransformOrigin.INSTANCE.m5110getCenterSzJe1aQ();
    ...
    public void updateLayerProperties(ReusableGraphicsLayerScope scope) {
        int iM5352getModulateAlphake2Ky5w;
        ...
        if ((maybeChangedFields & 64) != 0) {
            this.graphicsLayer.m5366setAmbientShadowColor8_81llA(scope.getAmbientShadowColor());
        }
        if ((maybeChangedFields & 128) != 0) {
            this.graphicsLayer.m5372setSpotShadowColor8_81llA(scope.getSpotShadowColor());
        }
        ...
        if ((maybeChangedFields & 4096) != 0) {
            boolean zM5104equalsimpl0 = TransformOrigin.m5104equalsimpl0(this.transformOrigin, TransformOrigin.INSTANCE.m5110getCenterSzJe1aQ());
            GraphicsLayer graphicsLayer = this.graphicsLayer;
            if (zM5104equalsimpl0) {
                graphicsLayer.m5369setPivotOffsetk4lQ0M(Offset.INSTANCE.m4467getUnspecifiedF1C5BW0());
            } else {
                float x$iv = TransformOrigin.m5105getPivotFractionXimpl(this.transformOrigin) * ((int) (this.size >> 32));
                float y$iv = TransformOrigin.m5106getPivotFractionYimpl(this.transformOrigin) * ((int) (this.size & 4294967295L));
                long v1$iv$iv = Float.floatToRawIntBits(x$iv);
                long v2$iv$iv = Float.floatToRawIntBits(y$iv);
                graphicsLayer.m5369setPivotOffsetk4lQ0M(Offset.m4444constructorimpl((v1$iv$iv << 32) | (4294967295L & v2$iv$iv)));
            }
        }
        ...
        if ((524288 & maybeChangedFields) != 0) {
            this.graphicsLayer.m5367setBlendModes9anfk8(scope.getBlendMode());
        }
        if ((32768 & maybeChangedFields) != 0) {
            ...
            if (CompositingStrategy.m4782equalsimpl0(compositingStrategy, CompositingStrategy.INSTANCE.m4786getAutoNrFUSI())) {
                iM5352getModulateAlphake2Ky5w = androidx.compose.ui.graphics.layer.CompositingStrategy.INSTANCE.m5351getAutoke2Ky5w();
            } else if (CompositingStrategy.m4782equalsimpl0(compositingStrategy, CompositingStrategy.INSTANCE.m4788getOffscreenNrFUSI())) {
                iM5352getModulateAlphake2Ky5w = androidx.compose.ui.graphics.layer.CompositingStrategy.INSTANCE.m5353getOffscreenke2Ky5w();
            } else {
                if (!CompositingStrategy.m4782equalsimpl0(compositingStrategy, CompositingStrategy.INSTANCE.m4787getModulateAlphaNrFUSI())) {
                    throw new IllegalStateException("Not supported composition strategy");
                }
                iM5352getModulateAlphake2Ky5w = androidx.compose.ui.graphics.layer.CompositingStrategy.INSTANCE.m5352getModulateAlphake2Ky5w();
            }
            graphicsLayer2.m5368setCompositingStrategyWpw9cng(iM5352getModulateAlphake2Ky5w);
        }
    ...
    public boolean mo6519isInLayerk4lQ0M(long position) {
    ...
    public void mo6521movegyyYBs(long position) {
        if (this.ownerView.getIsArrEnabled()) {
            this.ownerView.voteFrameRate(FrameRateCategory.INSTANCE.m4180getHighNSsRyOo());
        }
        this.graphicsLayer.m5373setTopLeftgyyYBs(position);
        triggerRepaint();
    }

    @Override // androidx.compose.ui.node.OwnedLayer
    /* JADX INFO: renamed from: resize-ozmzZPI */
    public void mo6522resizeozmzZPI(long size) {
        if (!IntSize.m7674equalsimpl0(size, this.size)) {
            if (this.ownerView.getIsArrEnabled()) {
                this.ownerView.voteFrameRate(FrameRateCategory.INSTANCE.m4180getHighNSsRyOo());
            }
            this.size = size;
    ...
    public void updateDisplayList() {
        ...
        if (this.isDirty) {
            if (!TransformOrigin.m5104equalsimpl0(this.transformOrigin, TransformOrigin.INSTANCE.m5110getCenterSzJe1aQ()) && !IntSize.m7674equalsimpl0(this.graphicsLayer.getSize(), this.size)) {
                GraphicsLayer graphicsLayer = this.graphicsLayer;
                float x$iv = TransformOrigin.m5105getPivotFractionXimpl(this.transformOrigin) * ((int) (this.size >> 32));
                float y$iv = TransformOrigin.m5106getPivotFractionYimpl(this.transformOrigin) * ((int) (this.size & 4294967295L));
                long v1$iv$iv = Float.floatToRawIntBits(x$iv);
            ...
            this.graphicsLayer.m5365recordmLhObY(this.density, this.layoutDirection, this.size, this.recordLambda);
            setDirty(false);
        }
    }
    ...
    public long mo6520mapOffset8S9VItk(long point, boolean inverse) {
        float[] matrix;
        if (inverse) {
            matrix = m6635getInverseMatrix3i98HWw();
            if (matrix == null) {
                return Offset.INSTANCE.m4466getInfiniteF1C5BW0();
            }
        } else {
            matrix = m6636getMatrixsQKQjiQ();
        }
        if (this.isIdentity) {
            return point;
        }
        return Matrix.m4947mapMKHz9U(matrix, point);
    }

    @Override // androidx.compose.ui.node.OwnedLayer
    public void mapBounds(MutableRect rect, boolean inverse) {
        float[] matrix = inverse ? m6635getInverseMatrix3i98HWw() : m6636getMatrixsQKQjiQ();
        if (!this.isIdentity) {
            if (matrix == null) {
    ...
    public void reuseLayer(Function2<? super Canvas, ? super GraphicsLayer, Unit> drawBlock, Function0<Unit> invalidateParentLayer) {
        ...
        if (context != null) {
            ...
            Matrix.m4950resetimpl(this.matrixCache);
            float[] fArr = this.inverseMatrixCache;
            if (fArr != null) {
                Matrix.m4950resetimpl(fArr);
            }
            this.transformOrigin = TransformOrigin.INSTANCE.m5110getCenterSzJe1aQ();
            this.drawnWithEnabledZ = false;
            this.size = IntSize.m7671constructorimpl((((long) Integer.MAX_VALUE) << 32) | (((long) Integer.MAX_VALUE) & 4294967295L));
            this.outline = null;
    ...
    public void mo6523transform58bKbWc(float[] matrix) {
        Matrix.m4960timesAssign58bKbWc(matrix, m6636getMatrixsQKQjiQ());
    }

    @Override // androidx.compose.ui.node.OwnedLayer
    /* JADX INFO: renamed from: inverseTransform-58bKbWc */
    public void mo6518inverseTransform58bKbWc(float[] matrix) {
        float[] inverse = m6635getInverseMatrix3i98HWw();
        if (inverse != null) {
            Matrix.m4960timesAssign58bKbWc(matrix, inverse);
        }
    }
    ...
    private final float[] m6636getMatrixsQKQjiQ() {
        updateMatrix();
    ...
    public float[] mo6517getUnderlyingMatrixsQKQjiQ() {
        return m6636getMatrixsQKQjiQ();
    }

    /* JADX INFO: renamed from: getInverseMatrix-3i98HWw, reason: not valid java name */
    private final float[] m6635getInverseMatrix3i98HWw() {
        float[] it = this.inverseMatrixCache;
        if (it == null) {
            it = Matrix.m4941constructorimpl$default(null, 1, null);
        ...
        this.isInverseMatrixDirty = false;
        float[] matrix = m6636getMatrixsQKQjiQ();
        if (this.isIdentity) {
            return matrix;
        }
        if (InvertMatrixKt.m6639invertToJiSxe2E(matrix, it)) {
            return it;
        }
        it[(0 * 4) + 0] = Float.NaN;
        return null;
    ...
    private final void updateMatrix() {
        ...
        if (this.isMatrixDirty) {
            ...
            if ((9223372034707292159L & $this$updateMatrix_u24lambda_u240.getPivotOffset()) == androidx.compose.ui.geometry.InlineClassHelperKt.UnspecifiedPackedFloats) {
                pivotOffset = SizeKt.m4531getCenteruvyYCjk(IntSizeKt.m7688toSizeozmzZPI(this.size));
            } else {
                pivotOffset = $this$updateMatrix_u24lambda_u240.getPivotOffset();
            }
            int bits$iv$iv$iv$iv = (int) (pivotOffset >> 32);
            float x = Float.intBitsToFloat(bits$iv$iv$iv$iv);
            int bits$iv$iv$iv$iv2 = (int) (4294967295L & pivotOffset);
            float y = Float.intBitsToFloat(bits$iv$iv$iv$iv2);
            Matrix.m4952resetToPivotedTransformimpl$default(this.matrixCache, x, y, $this$updateMatrix_u24lambda_u240.getTranslationX(), $this$updateMatrix_u24lambda_u240.getTranslationY(), 0.0f, $this$updateMatrix_u24lambda_u240.getRotationX(), $this$updateMatrix_u24lambda_u240.getRotationY(), $this$updateMatrix_u24lambda_u240.getRotationZ(), $this$updateMatrix_u24lambda_u240.getScaleX(), $this$updateMatrix_u24lambda_u240.getScaleY(), 0.0f, 1040, null);
            this.isMatrixDirty = false;
            this.isIdentity = MatrixKt.m4966isIdentity58bKbWc(this.matrixCache);
        }
    }
}
