...
public final class DerivedSize {
    ...
    private static final DerivedSize Zero = new DerivedSize(IntSize.INSTANCE.m7681getZeroYbymL2g(), DpSize.INSTANCE.m7613getZeroMYxV2XQ(), null);
    ...
    public static final class Companion {
        ...
        public final DerivedSize m6616fromPxSizeviCIZxY(long pxSize, Density density) {
            return new DerivedSize(pxSize, density.mo403toDpSizekrfVVM(IntSizeKt.m7688toSizeozmzZPI(pxSize)), null);
        }

        /* JADX INFO: renamed from: fromDpSize-itqla9I, reason: not valid java name */
        public final DerivedSize m6615fromDpSizeitqla9I(long dpSize, Density density) {
            return new DerivedSize(IntSizeKt.m7687toIntSizeuvyYCjk(density.mo406toSizeXkaWNTQ(dpSize)), dpSize, null);
        }
    }
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof DerivedSize) && IntSize.m7674equalsimpl0(this.pxSize, ((DerivedSize) other).pxSize) && DpSize.m7600equalsimpl0(this.dpSize, ((DerivedSize) other).dpSize);
    }

    public int hashCode() {
        int result = IntSize.m7677hashCodeimpl(this.pxSize);
        return (result * 31) + DpSize.m7605hashCodeimpl(this.dpSize);
    }
}
