...
public final class IndirectPointerNavigationGestureDetector {
    ...
    private int primaryDirectionalMotionAxis = IndirectPointerEventPrimaryDirectionalMotionAxis.INSTANCE.m5523getNonenZO2Niw();
    ...
    public IndirectPointerNavigationGestureDetector(Context context, Function1<? super FocusDirection, Unit> function1) {
        ...
        this.gestureDetector = new GestureDetector(context, new GestureDetector.OnGestureListener() { // from class: androidx.compose.ui.platform.IndirectPointerNavigationGestureDetector$gestureDetector$1
            ...
            public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
                ...
                if (IndirectPointerEventPrimaryDirectionalMotionAxis.m5519equalsimpl0(this.this$0.getPrimaryDirectionalMotionAxis(), IndirectPointerEventPrimaryDirectionalMotionAxis.INSTANCE.m5524getXnZO2Niw())) {
                    if (Math.abs(velocityX) > Math.abs(velocityY)) {
                        int direction = velocityX > 0.0f ? FocusDirection.INSTANCE.m4335getNextdhqQ8s() : FocusDirection.INSTANCE.m4336getPreviousdhqQ8s();
                        this.this$0.onMoveFocus.invoke(FocusDirection.m4324boximpl(direction));
                    }
                } else if (IndirectPointerEventPrimaryDirectionalMotionAxis.m5519equalsimpl0(this.this$0.getPrimaryDirectionalMotionAxis(), IndirectPointerEventPrimaryDirectionalMotionAxis.INSTANCE.m5525getYnZO2Niw()) && Math.abs(velocityY) > Math.abs(velocityX)) {
                    int direction2 = velocityY > 0.0f ? FocusDirection.INSTANCE.m4335getNextdhqQ8s() : FocusDirection.INSTANCE.m4336getPreviousdhqQ8s();
                    this.this$0.onMoveFocus.invoke(FocusDirection.m4324boximpl(direction2));
                }
                return true;
            }
        });
    ...
    public final void m6638setPrimaryDirectionalMotionAxisWQKaTuc(int i) {
    ...
    public final void cancelCurrentEventStream() {
        this.primaryDirectionalMotionAxis = IndirectPointerEventPrimaryDirectionalMotionAxis.INSTANCE.m5523getNonenZO2Niw();
