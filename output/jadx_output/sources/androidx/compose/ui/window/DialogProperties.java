...
public final class DialogProperties {
    ...
    public DialogProperties(boolean dismissOnBackPress, boolean dismissOnClickOutside, SecureFlagPolicy securePolicy, boolean usePlatformDefaultWidth, boolean decorFitsSystemWindows, String windowTitle) {
    ...
    public DialogProperties(boolean dismissOnBackPress, boolean dismissOnClickOutside, boolean usePlatformDefaultWidth) {
        this(dismissOnBackPress, dismissOnClickOutside, SecureFlagPolicy.Inherit, usePlatformDefaultWidth, true, null, 32, null);
    }
    ...
    public /* synthetic */ DialogProperties(boolean dismissOnBackPress, boolean dismissOnClickOutside, SecureFlagPolicy securePolicy, boolean usePlatformDefaultWidth, boolean decorFitsSystemWindows) {
        this(dismissOnBackPress, dismissOnClickOutside, SecureFlagPolicy.Inherit, usePlatformDefaultWidth, true, "");
    }
    ...
    public /* synthetic */ DialogProperties(boolean dismissOnBackPress, boolean dismissOnClickOutside, SecureFlagPolicy securePolicy) {
        this(dismissOnBackPress, dismissOnClickOutside, securePolicy, true, true, null, 32, null);
    }
