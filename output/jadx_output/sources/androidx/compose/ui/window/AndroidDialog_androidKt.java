...
public final class AndroidDialog_androidKt {
    public static final void Dialog(Function0<Unit> function0, DialogProperties properties, final Function2<? super Composer, ? super Integer, Unit> function2, Composer $composer, final int $changed, final int i) {
        DialogProperties dialogProperties;
        final DialogProperties properties2;
        final Function0<Unit> function02 = function0;
        Composer $composer2 = $composer.startRestartGroup(826668973);
        ComposerKt.sourceInformation($composer2, "C(Dialog)P(1,2)202@8819L7,203@8858L7,204@8913L7,205@8943L28,206@8998L29,207@9064L21,207@9047L38,209@9111L330,218@9472L129,218@9447L154,227@9618L183,227@9607L194:AndroidDialog.android.kt#2oxthz");
        int $dirty = $changed;
        if (($changed & 6) == 0) {
        ...
        if ($composer2.shouldExecute(($dirty2 & 147) != 146, $dirty2 & 1)) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(826668973, $dirty2, -1, "androidx.compose.ui.window.Dialog (AndroidDialog.android.kt:201)");
            }
            ...
            ComposerKt.sourceInformationMarkerStart($composer2, -140052361, "CC(remember):AndroidDialog.android.kt#9igjgp");
            ...
            if (invalid$iv || value$iv2 == Composer.INSTANCE.getEmpty()) {
                ...
                $this$Dialog_u24lambda_u242_u240.setContent(composition, ComposableLambdaKt.composableLambdaInstance(346960332, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.ui.window.AndroidDialog_androidKt$Dialog$dialog$1$1$1
                    ...
                    public final void invoke(Composer $composer3, int $changed2) {
                        ComposerKt.sourceInformation($composer3, "C213@9362L12,213@9330L61:AndroidDialog.android.kt#2oxthz");
                        if (!$composer3.shouldExecute(($changed2 & 3) != 2, $changed2 & 1)) {
                            $composer3.skipToGroupEnd();
                            return;
                        }
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventStart(346960332, $changed2, -1, "androidx.compose.ui.window.Dialog.<anonymous>.<anonymous>.<anonymous> (AndroidDialog.android.kt:213)");
                        }
                        Modifier.Companion companion = Modifier.INSTANCE;
                        ComposerKt.sourceInformationMarkerStart($composer3, -1578568168, "CC(remember):AndroidDialog.android.kt#9igjgp");
            ...
            ComposerKt.sourceInformationMarkerEnd($composer2);
            ComposerKt.sourceInformationMarkerStart($composer2, -140041010, "CC(remember):AndroidDialog.android.kt#9igjgp");
            ...
            ComposerKt.sourceInformationMarkerStart($composer2, -140036284, "CC(remember):AndroidDialog.android.kt#9igjgp");
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.ui.window.AndroidDialog_androidKt.Dialog.3
                ...
                public final void invoke(Composer composer, int i3) {
                    AndroidDialog_androidKt.Dialog(function02, properties2, function2, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    public static final void DialogLayout(Modifier modifier, final Function2<? super Composer, ? super Integer, Unit> function2, Composer $composer, final int $changed, final int i) {
        ...
        ComposerKt.sourceInformation($composer3, "C(DialogLayout)P(1)688@28193L559,688@28146L606:AndroidDialog.android.kt#2oxthz");
        int $dirty = $changed;
        int i2 = i & 1;
        if (i2 != 0) {
            $dirty |= 6;
        ...
        if (!$composer3.shouldExecute(($dirty & 19) != 18, $dirty & 1)) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(1090521195, $dirty, -1, "androidx.compose.ui.window.DialogLayout (AndroidDialog.android.kt:687)");
            }
                ...
                Object value$iv = (MeasurePolicy) new MeasurePolicy() { // from class: androidx.compose.ui.window.AndroidDialog_androidKt$DialogLayout$1$1
                    ...
                    public final MeasureResult mo41measure3p2s80s(MeasureScope $this$Layout, List<? extends Measurable> list, long j) {
                        ...
                        while (index$iv$iv < size) {
                            ...
                            Placeable $this$measure_3p2s80s_u24lambda_u240_u240 = it.mo6141measureBRTryo0(j);
                        ...
                        if (!list.isEmpty()) {
                            ...
                            int maxWidth3 = Constraints.m7460getMinWidthimpl(j);
                            int maxHeight3 = Constraints.m7459getMinHeightimpl(j);
                            maxWidth = maxWidth3;
            ...
            ComposerKt.sourceInformationMarkerEnd($composer3);
            int $changed$iv = (($dirty >> 3) & 14) | RendererCapabilities.DECODER_SUPPORT_MASK | (($dirty << 3) & 112);
