...
public final class InputModeManagerImpl implements InputModeManager {
    ...
    private InputModeManagerImpl(int initialInputMode, Function1<? super InputMode, Boolean> function1) {
        ...
        this.inputMode = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(InputMode.m5500boximpl(initialInputMode), null, 2, null);
    }

    @Override // androidx.compose.ui.input.InputModeManager
    /* JADX INFO: renamed from: getInputMode-aOaMEAU */
    public int mo5509getInputModeaOaMEAU() {
    ...
    public void m5511setInputModeiuPiT84(int i) {
        MutableState $this$setValue$iv = this.inputMode;
        $this$setValue$iv.setValue(InputMode.m5500boximpl(i));
    }

    @Override // androidx.compose.ui.input.InputModeManager
    /* JADX INFO: renamed from: requestInputMode-iuPiT84 */
    public boolean mo5510requestInputModeiuPiT84(int inputMode) {
        return this.onRequestInputModeChange.invoke(InputMode.m5500boximpl(inputMode)).booleanValue();
    }
}
