...
public final class NestedScrollDispatcher {
    ...
    public final long m5874dispatchPreScrollOzD1aCk(long available, int source) {
        NestedScrollConnection parent$ui = getParent$ui();
        return parent$ui != null ? parent$ui.mo896onPreScrollOzD1aCk(available, source) : Offset.INSTANCE.m4468getZeroF1C5BW0();
    }

    /* JADX INFO: renamed from: dispatchPostScroll-DzOQY0M, reason: not valid java name */
    public final long m5872dispatchPostScrollDzOQY0M(long consumed, long available, int source) {
        NestedScrollConnection parent$ui = getParent$ui();
        return parent$ui != null ? parent$ui.mo573onPostScrollDzOQY0M(consumed, available, source) : Offset.INSTANCE.m4468getZeroF1C5BW0();
    }
    ...
    */
    public final Object m5873dispatchPreFlingQWom1Mo(long j, Continuation<? super Velocity> continuation) {
        NestedScrollDispatcher$dispatchPreFling$1 nestedScrollDispatcher$dispatchPreFling$1;
        long jM7754getZero9UxMQ8M;
        ...
        Object $result = nestedScrollDispatcher$dispatchPreFling$1.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        switch (nestedScrollDispatcher$dispatchPreFling$1.label) {
            case 0:
                ResultKt.throwOnFailure($result);
                NestedScrollConnection parent$ui = getParent$ui();
                if (parent$ui == null) {
                    jM7754getZero9UxMQ8M = Velocity.INSTANCE.m7754getZero9UxMQ8M();
                    return Velocity.m7734boximpl(jM7754getZero9UxMQ8M);
                }
                nestedScrollDispatcher$dispatchPreFling$1.label = 1;
                objMo895onPreFlingQWom1Mo = parent$ui.mo895onPreFlingQWom1Mo(j, nestedScrollDispatcher$dispatchPreFling$1);
                if (objMo895onPreFlingQWom1Mo == coroutine_suspended) {
                    return coroutine_suspended;
                }
                jM7754getZero9UxMQ8M = ((Velocity) objMo895onPreFlingQWom1Mo).getPackedValue();
                return Velocity.m7734boximpl(jM7754getZero9UxMQ8M);
            case 1:
                ResultKt.throwOnFailure($result);
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final Object m5871dispatchPostFlingRZ2iAVY(long j, long j2, Continuation<? super Velocity> continuation) {
        ...
        Object $result = nestedScrollDispatcher$dispatchPostFling$12.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        switch (nestedScrollDispatcher$dispatchPostFling$12.label) {
            case 0:
                ResultKt.throwOnFailure($result);
                if (getParent$ui() == null) {
                    ...
                    if (nestedScrollNode != null) {
                        ...
                        objMo572onPostFlingRZ2iAVY2 = nestedScrollNode.mo572onPostFlingRZ2iAVY(j, j2, nestedScrollDispatcher$dispatchPostFling$12);
                        if (objMo572onPostFlingRZ2iAVY2 == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                        jM7754getZero9UxMQ8M = ((Velocity) objMo572onPostFlingRZ2iAVY2).getPackedValue();
                    } else {
                        jM7754getZero9UxMQ8M = Velocity.INSTANCE.m7754getZero9UxMQ8M();
                    }
                } else {
                    ...
                    if (parent$ui != null) {
                        ...
                        objMo572onPostFlingRZ2iAVY = parent$ui.mo572onPostFlingRZ2iAVY(j, j2, nestedScrollDispatcher$dispatchPostFling$12);
                        if (objMo572onPostFlingRZ2iAVY == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                        jM7754getZero9UxMQ8M = ((Velocity) objMo572onPostFlingRZ2iAVY).getPackedValue();
                    } else {
                        jM7754getZero9UxMQ8M = Velocity.INSTANCE.m7754getZero9UxMQ8M();
                    }
                }
