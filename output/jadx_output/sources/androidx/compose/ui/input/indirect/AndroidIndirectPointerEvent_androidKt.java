...
public final class AndroidIndirectPointerEvent_androidKt {
    ...
    public static /* synthetic */ IndirectPointerEvent m5515IndirectPointerEventeAXfkT4$default(MotionEvent motionEvent, int i, MotionEvent motionEvent2, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            i = IndirectPointerEventPrimaryDirectionalMotionAxis.INSTANCE.m5523getNonenZO2Niw();
        }
        if ((i2 & 4) != 0) {
            motionEvent2 = null;
        }
        return m5514IndirectPointerEventeAXfkT4(motionEvent, i, motionEvent2);
    }

    /* JADX INFO: renamed from: IndirectPointerEvent-eAXfkT4, reason: not valid java name */
    public static final IndirectPointerEvent m5514IndirectPointerEventeAXfkT4(MotionEvent motionEvent, int i, MotionEvent previousMotionEvent) {
        int actionIndex;
        boolean z;
        ...
        for (int i2 = 0; i2 < pointerCount; i2++) {
            ...
            long pointerId = PointerId.m5990constructorimpl(motionEventPointerId);
            ...
            long position = Offset.m4444constructorimpl(v2$iv$iv2);
            ...
            if (matchedPointerIdInPreviousMotionEventIndex >= 0) {
                ...
                v2$iv$iv = Offset.m4444constructorimpl(v2$iv$iv3);
        ...
        return new AndroidIndirectPointerEvent(changes, convertActionToIndirectPointerEventType(action), i, motionEvent, null);
    }
    ...
    public static final int convertActionToIndirectPointerEventType(int actionMasked) {
        switch (actionMasked) {
            case 0:
            case 5:
                return IndirectPointerEventType.INSTANCE.m5534getPress4ZHQPSE();
            case 1:
            case 6:
                return IndirectPointerEventType.INSTANCE.m5535getRelease4ZHQPSE();
            case 2:
                return IndirectPointerEventType.INSTANCE.m5533getMove4ZHQPSE();
            case 3:
            case 4:
            default:
                return IndirectPointerEventType.INSTANCE.m5536getUnknown4ZHQPSE();
        }
    }
    ...
    public static final int indirectPrimaryDirectionalScrollAxis(MotionEvent motionEvent) {
        ...
        if (inputDevice != null) {
            ...
            if (xMotionRange != null && yMotionRange == null) {
                return IndirectPointerEventPrimaryDirectionalMotionAxis.INSTANCE.m5524getXnZO2Niw();
            }
            if (yMotionRange != null && xMotionRange == null) {
                return IndirectPointerEventPrimaryDirectionalMotionAxis.INSTANCE.m5525getYnZO2Niw();
            }
            if (xMotionRange != null && yMotionRange != null) {
        ...
        return IndirectPointerEventPrimaryDirectionalMotionAxis.INSTANCE.m5523getNonenZO2Niw();
    }
}
