...
final class PointerInputChangeEventProducer {
    ...
    public final InternalPointerEvent produce(PointerInputEvent pointerInputEvent, PositionCalculator positionCalculator) {
        ...
        while (index$iv < size) {
            ...
            PointerInputData previousData = this.previousPointerInputData.get(it.m6024getIdJ3iCeTQ());
            if (previousData == null) {
                long previousTime2 = it.getUptime();
                long previousPosition2 = it.m6026getPositionF1C5BW0();
                previousDown = false;
                ...
                long previousPosition3 = positionCalculator.mo6091screenToLocalMKHz9U(previousData.getPositionOnScreen());
                previousDown = previousDown2;
                previousTime = previousTime3;
                previousPosition = previousPosition3;
            }
            changes.put(it.m6024getIdJ3iCeTQ(), new PointerInputChange(it.m6024getIdJ3iCeTQ(), it.getUptime(), it.m6026getPositionF1C5BW0(), it.getDown(), it.getPressure(), previousTime, previousPosition, previousDown, false, it.m6029getTypeT8wyACA(), it.getHistorical(), it.m6028getScrollDeltaF1C5BW0(), it.m6025getOriginalEventPositionF1C5BW0(), null));
            boolean down = it.getDown();
            LongSparseArray<PointerInputData> longSparseArray = this.previousPointerInputData;
            if (down) {
                longSparseArray.put(it.m6024getIdJ3iCeTQ(), new PointerInputData(it.getUptime(), it.m6027getPositionOnScreenF1C5BW0(), it.getDown(), null));
            } else {
                longSparseArray.remove(it.m6024getIdJ3iCeTQ());
            }
            index$iv++;
            pointers = list;
