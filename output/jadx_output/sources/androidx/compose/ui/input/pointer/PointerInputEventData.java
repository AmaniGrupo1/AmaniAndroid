...
public final /* data */ class PointerInputEventData {
    ...
    public static /* synthetic */ PointerInputEventData m6016copyrc8HELY$default(PointerInputEventData pointerInputEventData, long j, long j2, long j3, long j4, boolean z, float f, int i, boolean z2, List list, long j5, long j6, int i2, Object obj) {
        long j7;
        long j8;
        long j9;
        long j10;
        ...
        return pointerInputEventData.m6023copyrc8HELY(j7, j12, j13, j14, z3, f2, i3, z4, list2, j10, j9);
    }
    ...
    public final PointerInputEventData m6023copyrc8HELY(long id, long uptime, long positionOnScreen, long position, boolean down, float pressure, int type, boolean activeHover, List<HistoricalChange> historical, long scrollDelta, long originalEventPosition) {
    ...
    public boolean equals(Object other) {
        ...
        return PointerId.m5992equalsimpl0(this.id, pointerInputEventData.id) && this.uptime == pointerInputEventData.uptime && Offset.m4449equalsimpl0(this.positionOnScreen, pointerInputEventData.positionOnScreen) && Offset.m4449equalsimpl0(this.position, pointerInputEventData.position) && this.down == pointerInputEventData.down && Float.compare(this.pressure, pointerInputEventData.pressure) == 0 && PointerType.m6081equalsimpl0(this.type, pointerInputEventData.type) && this.activeHover == pointerInputEventData.activeHover && Intrinsics.areEqual(this.historical, pointerInputEventData.historical) && Offset.m4449equalsimpl0(this.scrollDelta, pointerInputEventData.scrollDelta) && Offset.m4449equalsimpl0(this.originalEventPosition, pointerInputEventData.originalEventPosition);
    }

    public int hashCode() {
        return (((((((((((((((((((PointerId.m5993hashCodeimpl(this.id) * 31) + Long.hashCode(this.uptime)) * 31) + Offset.m4454hashCodeimpl(this.positionOnScreen)) * 31) + Offset.m4454hashCodeimpl(this.position)) * 31) + Boolean.hashCode(this.down)) * 31) + Float.hashCode(this.pressure)) * 31) + PointerType.m6082hashCodeimpl(this.type)) * 31) + Boolean.hashCode(this.activeHover)) * 31) + this.historical.hashCode()) * 31) + Offset.m4454hashCodeimpl(this.scrollDelta)) * 31) + Offset.m4454hashCodeimpl(this.originalEventPosition);
    }

    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("PointerInputEventData(id=").append((Object) PointerId.m5994toStringimpl(this.id)).append(", uptime=").append(this.uptime).append(", positionOnScreen=").append((Object) Offset.m4460toStringimpl(this.positionOnScreen)).append(", position=").append((Object) Offset.m4460toStringimpl(this.position)).append(", down=").append(this.down).append(", pressure=").append(this.pressure).append(", type=").append((Object) PointerType.m6083toStringimpl(this.type)).append(", activeHover=").append(this.activeHover).append(", historical=").append(this.historical).append(", scrollDelta=").append((Object) Offset.m4460toStringimpl(this.scrollDelta)).append(", originalEventPosition=").append((Object) Offset.m4460toStringimpl(this.originalEventPosition)).append(')');
        return sb.toString();
    }

    private PointerInputEventData(long id, long uptime, long positionOnScreen, long position, boolean down, float pressure, int type, boolean activeHover, List<HistoricalChange> list, long scrollDelta, long originalEventPosition) {
        this.id = id;
        this.uptime = uptime;
    ...
    public /* synthetic */ PointerInputEventData(long j, long j2, long j3, long j4, boolean z, float f, int i, boolean z2, List list, long j5, long j6, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(j, j2, j3, j4, z, f, i, (i2 & 128) != 0 ? false : z2, (i2 & 256) != 0 ? new ArrayList() : list, (i2 & 512) != 0 ? Offset.INSTANCE.m4468getZeroF1C5BW0() : j5, (i2 & 1024) != 0 ? Offset.INSTANCE.m4468getZeroF1C5BW0() : j6, null);
    }

    /* JADX INFO: renamed from: getId-J3iCeTQ, reason: not valid java name */
    public final long m6024getIdJ3iCeTQ() {
        return this.id;
    }
    ...
    public final long m6027getPositionOnScreenF1C5BW0() {
        return this.positionOnScreen;
    }

    /* JADX INFO: renamed from: getPosition-F1C5BW0, reason: not valid java name */
    public final long m6026getPositionF1C5BW0() {
        return this.position;
    }
    ...
    public final int m6029getTypeT8wyACA() {
        return this.type;
    }
    ...
    public final long m6028getScrollDeltaF1C5BW0() {
        return this.scrollDelta;
    }

    /* JADX INFO: renamed from: getOriginalEventPosition-F1C5BW0, reason: not valid java name */
    public final long m6025getOriginalEventPositionF1C5BW0() {
        return this.originalEventPosition;
    }
}
