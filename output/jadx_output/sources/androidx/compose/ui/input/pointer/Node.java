...
public final class Node extends NodeParent {
    ...
    public boolean dispatchMainEventPass(LongSparseArray<PointerInputChange> changes, LayoutCoordinates parentCoordinates, InternalPointerEvent internalPointerEvent, boolean isInBounds) {
        ...
        if (!this_$iv3.relevantChanges.isEmpty() && this_$iv3.modifierNode.getIsAttached()) {
            ...
            long size = layoutCoordinates.mo6149getSizeYbymL2g();
            ...
            while (true) {
                ...
                if (nodePop instanceof PointerInputModifierNode) {
                    ...
                    i3 = count$iv;
                    it.mo233onPointerEventH0pRuoY(event, PointerEventPass.Initial, size);
                    this_$iv = this_$iv3;
                    ...
                    if (((this_$iv$iv.getKindSet() & iM6460constructorimpl) != 0 ? 1 : 0) == 0 || !(nodePop instanceof DelegatingNode)) {
                        ...
                        while (node$iv$iv != null) {
                            ...
                            if (((next$iv.getKindSet() & iM6460constructorimpl) != 0 ? i4 : 0) == 0) {
                                this_$iv2 = this_$iv3;
            ...
            int iM6460constructorimpl2 = NodeKind.m6460constructorimpl(i5);
            ...
            while (nodePop2 != null) {
                if (nodePop2 instanceof PointerInputModifierNode) {
                    ...
                    it3.mo233onPointerEventH0pRuoY(event, PointerEventPass.Main, size);
                    $this$dispatchForKind_u2d6rFNWt0$iv = $this$dispatchForKind_u2d6rFNWt0$iv4;
                    i = iM6460constructorimpl2;
                } else {
                    Modifier.Node this_$iv$iv3 = nodePop2;
                    if (((this_$iv$iv3.getKindSet() & iM6460constructorimpl2) != 0 ? 1 : 0) == 0 || !(nodePop2 instanceof DelegatingNode)) {
                        $this$dispatchForKind_u2d6rFNWt0$iv = $this$dispatchForKind_u2d6rFNWt0$iv4;
                        i = iM6460constructorimpl2;
                    } else {
                        int count$iv3 = 0;
                        ...
                        while (node$iv$iv2 != null) {
                            ...
                            if (((next$iv2.getKindSet() & iM6460constructorimpl2) != 0 ? 1 : 0) == 0) {
    ...
    public boolean dispatchFinalEventPass(InternalPointerEvent internalPointerEvent) {
        ...
        if (!this_$iv3.relevantChanges.isEmpty() && this_$iv3.modifierNode.getIsAttached()) {
            ...
            while (true) {
                ...
                if (nodePop instanceof PointerInputModifierNode) {
                    PointerInputModifierNode it = (PointerInputModifierNode) nodePop;
                    it.mo233onPointerEventH0pRuoY(event, PointerEventPass.Final, size);
                    this_$iv = this_$iv3;
                    $i$f$dispatchIfNeeded = $i$f$dispatchIfNeeded3;
                } else {
                    Modifier.Node this_$iv$iv = nodePop;
    ...
    */
    public boolean buildCache(LongSparseArray<PointerInputChange> changes, LayoutCoordinates parentCoordinates, InternalPointerEvent internalPointerEvent, boolean isInBounds) {
        ...
        while (true) {
            ...
            if (nodePop instanceof PointerInputModifierNode) {
                ...
                Modifier.Node this_$iv$iv = nodePop;
                if (((this_$iv$iv.getKindSet() & iM6460constructorimpl) != 0 ? i4 : 0) == 0 || !(nodePop instanceof DelegatingNode)) {
                    childChanged = childChanged3;
                    $this$dispatchForKind_u2d6rFNWt0$iv = $this$dispatchForKind_u2d6rFNWt0$iv3;
                } else {
                    int count$iv = 0;
            ...
            if (this.pointerIds.contains(keyValue)) {
                ...
                if ((((v$iv + InlineClassHelperKt.DualLoadedSignificand) & (-9223372034707292160L)) == 0 ? 1 : i) != 0) {
                    ...
                    if ((((v$iv2 + InlineClassHelperKt.DualLoadedSignificand) & (-9223372034707292160L)) == 0 ? 1 : i) != 0) {
                        ...
                        int j3 = 0;
                        while (j3 < size2) {
                            Object item$iv = historical2.get(j3);
                            ...
                            if ((((v$iv3 + InlineClassHelperKt.DualLoadedSignificand) & (-9223372034707292160L)) == 0 ? 1 : 0) != 0) {
                                ...
                                LayoutCoordinates layoutCoordinates = this.coordinates;
                                Intrinsics.checkNotNull(layoutCoordinates);
                                historical.add(new HistoricalChange(uptimeMillis, layoutCoordinates.mo6150localPositionOfR5De75A(parentCoordinates, historicalPosition), it.getOriginalEventPosition(), null));
                            } else {
                                i3 = size2;
                            }
                            j3 = index$iv + 1;
                        ...
                        LayoutCoordinates layoutCoordinates2 = this.coordinates;
                        Intrinsics.checkNotNull(layoutCoordinates2);
                        long jMo6150localPositionOfR5De75A = layoutCoordinates2.mo6150localPositionOfR5De75A(parentCoordinates, prevPosition);
                        LayoutCoordinates layoutCoordinates3 = this.coordinates;
                        Intrinsics.checkNotNull(layoutCoordinates3);
                        longSparseArray.put(keyValue, PointerInputChange.m5999copyOHpmEuE$default(change, 0L, 0L, layoutCoordinates3.mo6150localPositionOfR5De75A(parentCoordinates, currentPosition), false, 0L, jMo6150localPositionOfR5De75A, false, 0, historical, 0L, 731, null));
                    } else {
                        j = j2;
                        i2 = size;
                    }
        ...
        while (true) {
            ...
            long pointerId = this.pointerIds.m6111get_I2yYro(i6);
        ...
        while (true) {
            ...
            it$iv = item$iv$iv;
            if (internalPointerEvent.m5925activeHoverEvent0FcD4WY(((PointerInputChange) it$iv).getId())) {
                break;
            }
            index$iv$iv++;
        }
        ...
        if (activeHoverChange != null) {
            if (isInBounds) {
                ...
                if (this.isIn) {
                    ...
                    long size5 = layoutCoordinates4.mo6149getSizeYbymL2g();
                    z2 = true;
                    this.isIn = !PointerEventKt.m5954isOutOfBoundsO0kMr_c(activeHoverChange, size5);
                } else {
                    z2 = true;
                }
            } else {
            ...
            if (this.isIn != this.wasIn && (PointerEventType.m5959equalsimpl0(event.getType(), PointerEventType.INSTANCE.m5965getMove7fucELk()) || PointerEventType.m5959equalsimpl0(event.getType(), PointerEventType.INSTANCE.m5963getEnter7fucELk()) || PointerEventType.m5959equalsimpl0(event.getType(), PointerEventType.INSTANCE.m5964getExit7fucELk()))) {
                event.m5953setTypeEhbLWgg$ui(this.isIn ? PointerEventType.INSTANCE.m5963getEnter7fucELk() : PointerEventType.INSTANCE.m5964getExit7fucELk());
            } else if (PointerEventType.m5959equalsimpl0(event.getType(), PointerEventType.INSTANCE.m5963getEnter7fucELk()) && this.wasIn && !this.hasExited) {
                event.m5953setTypeEhbLWgg$ui(PointerEventType.INSTANCE.m5965getMove7fucELk());
            } else if (PointerEventType.m5959equalsimpl0(event.getType(), PointerEventType.INSTANCE.m5964getExit7fucELk()) && this.isIn && activeHoverChange.getPressed()) {
                event.m5953setTypeEhbLWgg$ui(PointerEventType.INSTANCE.m5965getMove7fucELk());
            }
        } else {
            z = false;
        ...
        boolean changed = (childChanged4 || !PointerEventType.m5959equalsimpl0(event.getType(), PointerEventType.INSTANCE.m5965getMove7fucELk()) || hasPositionChanged(this.pointerEvent, event)) ? z2 : z;
    ...
    private final boolean hasPositionChanged(PointerEvent oldEvent, PointerEvent newEvent) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (!Offset.m4449equalsimpl0(old.getPosition(), current.getPosition())) {
                return true;
            }
        }
        return false;
    ...
    public void cleanUpHits(InternalPointerEvent internalPointerEvent) {
        ...
        while (true) {
            ...
            if (index$iv >= size) {
                this.isIn = false;
                this.hasExited = PointerEventType.m5959equalsimpl0(event2.getType(), PointerEventType.INSTANCE.m5964getExit7fucELk());
                return;
            }
            ...
            boolean nonHoverEventStream = !internalPointerEvent.m5925activeHoverEvent0FcD4WY(change.getId());
