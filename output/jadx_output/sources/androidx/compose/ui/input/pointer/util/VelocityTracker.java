...
public final class VelocityTracker {
    ...
    public final void m6114addPositionUv8p0NA(long timeMillis, long position) {
        this.platformVelocityTracker.mo6105addPositionUv8p0NA(timeMillis, position);
    }

    /* JADX INFO: renamed from: calculateVelocity-9UxMQ8M, reason: not valid java name */
    public final long m6115calculateVelocity9UxMQ8M() {
        return m6116calculateVelocityAH228Gc(VelocityKt.Velocity(Float.MAX_VALUE, Float.MAX_VALUE));
    }

    /* JADX INFO: renamed from: calculateVelocity-AH228Gc, reason: not valid java name */
    public final long m6116calculateVelocityAH228Gc(long maximumVelocity) {
        return this.platformVelocityTracker.mo6106calculateVelocityAH228Gc(maximumVelocity);
    }
