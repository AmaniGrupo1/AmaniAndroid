...
public final class SuspendingPointerInputModifierNodeImpl extends Modifier.Node implements SuspendingPointerInputModifierNode, PointerInputScope, Density {
    ...
    public SuspendingPointerInputModifierNodeImpl(Object key1, Object key2, Object[] keys, PointerInputEventHandler pointerInputEventHandler) {
        ...
        this.boundsSize = IntSize.INSTANCE.m7681getZeroYbymL2g();
    }
    ...
    public long mo395getExtendedTouchPaddingNHjbRc() {
        long minimumTouchTargetSize = mo406toSizeXkaWNTQ(getViewConfiguration().mo6376getMinimumTouchTargetSizeMYxV2XQ());
        ...
        return Size.m4512constructorimpl(v2$iv$iv);
    }
    ...
    public <R> Object awaitPointerEventScope(Function2<? super AwaitPointerEventScope, ? super Continuation<? super R>, ? extends Object> function2, Continuation<? super R> continuation) {
        ...
        synchronized (lock$iv) {
            ...
            continuationCreateCoroutine.resumeWith(Result.m8542constructorimpl(Unit.INSTANCE));
    ...
    final class PointerEventHandlerCoroutine<R> implements AwaitPointerEventScope, Density, Continuation<R> {
        ...
        public long mo5906getSizeYbymL2g() {
        ...
        @Override // androidx.compose.ui.input.pointer.AwaitPointerEventScope
        /* JADX INFO: renamed from: getExtendedTouchPadding-NH-jbRc */
        public long mo5905getExtendedTouchPaddingNHjbRc() {
        ...
        public final void offerPointerEvent(PointerEvent event, PointerEventPass pass) {
            ...
            if (pass == this.awaitPass && (cancellableContinuation = this.pointerAwaiter) != null) {
                ...
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuation.resumeWith(Result.m8542constructorimpl(event));
            }
        }
        ...
        */
        public <T> Object withTimeoutOrNull(long timeMillis, Function2<? super AwaitPointerEventScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
            ...
            Object $result = suspendingPointerInputModifierNodeImpl$PointerEventHandlerCoroutine$withTimeoutOrNull$1.result;
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            try {
                switch (suspendingPointerInputModifierNodeImpl$PointerEventHandlerCoroutine$withTimeoutOrNull$1.label) {
                    case 0:
                        ResultKt.throwOnFailure($result);
                        suspendingPointerInputModifierNodeImpl$PointerEventHandlerCoroutine$withTimeoutOrNull$1.label = 1;
                        objWithTimeout = withTimeout(timeMillis, function2, suspendingPointerInputModifierNodeImpl$PointerEventHandlerCoroutine$withTimeoutOrNull$1);
        ...
        */
        public <T> Object withTimeout(long j, Function2<? super AwaitPointerEventScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
            ...
            SuspendingPointerInputModifierNodeImpl$PointerEventHandlerCoroutine$withTimeout$1 suspendingPointerInputModifierNodeImpl$PointerEventHandlerCoroutine$withTimeout$12 = suspendingPointerInputModifierNodeImpl$PointerEventHandlerCoroutine$withTimeout$1;
            Object obj = suspendingPointerInputModifierNodeImpl$PointerEventHandlerCoroutine$withTimeout$12.result;
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            try {
                switch (suspendingPointerInputModifierNodeImpl$PointerEventHandlerCoroutine$withTimeout$12.label) {
                    case 0:
                        ResultKt.throwOnFailure(obj);
                        if (j <= 0 && (cancellableContinuation = this.pointerAwaiter) != null) {
                            Result.Companion companion = Result.INSTANCE;
                            cancellableContinuation.resumeWith(Result.m8542constructorimpl(ResultKt.createFailure(new PointerEventTimeoutCancellationException(j))));
                        }
                        ...
                        suspendingPointerInputModifierNodeImpl$PointerEventHandlerCoroutine$withTimeout$12.L$0 = jobLaunch$default;
                        suspendingPointerInputModifierNodeImpl$PointerEventHandlerCoroutine$withTimeout$12.label = 1;
                        objInvoke = function2.invoke(this, suspendingPointerInputModifierNodeImpl$PointerEventHandlerCoroutine$withTimeout$12);
                        j = jobLaunch$default;
                        ...
                        break;
                    case 1:
                        Job job = (Job) suspendingPointerInputModifierNodeImpl$PointerEventHandlerCoroutine$withTimeout$12.L$0;
                        ResultKt.throwOnFailure(obj);
                        objInvoke = obj;
                        j = job;
                        break;
