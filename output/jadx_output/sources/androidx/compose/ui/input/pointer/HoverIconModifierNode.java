...
public abstract class HoverIconModifierNode extends Modifier.Node implements TraversableNode, PointerInputModifierNode, CompositionLocalConsumerModifierNode {
    ...
    public abstract boolean mo5924isRelevantPointerTypeuerMTgs(int pointerType);
    ...
    public void mo233onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long bounds) {
        ...
        while (true) {
            if (index$iv$iv < size) {
                ...
                if (mo5924isRelevantPointerTypeuerMTgs(it.getType())) {
                    z = true;
                    break;
                }
                index$iv$iv++;
        ...
        if (z) {
            if (PointerEventType.m5959equalsimpl0(pointerEvent.getType(), PointerEventType.INSTANCE.m5963getEnter7fucELk())) {
                onEnter();
            } else if (PointerEventType.m5959equalsimpl0(pointerEvent.getType(), PointerEventType.INSTANCE.m5964getExit7fucELk())) {
                onExit();
            }
        }
    }
    ...
    public long mo1322getTouchBoundsExpansionRZrCHBk() {
        ...
        return dpTouchBoundsExpansion != null ? dpTouchBoundsExpansion.m6350roundToTouchBoundsExpansionTW6G1oQ(DelegatableNodeKt.requireDensity(this)) : TouchBoundsExpansion.INSTANCE.m6561getNoneRZrCHBk();
    }
