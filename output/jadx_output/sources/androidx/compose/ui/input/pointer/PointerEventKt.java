...
public final class PointerEventKt {
    ...
    public static final boolean positionChanged(PointerInputChange $this$positionChanged) {
        return !Offset.m4449equalsimpl0(positionChangeInternal($this$positionChanged, false), Offset.INSTANCE.m4468getZeroF1C5BW0());
    }

    public static final boolean positionChangedIgnoreConsumed(PointerInputChange $this$positionChangedIgnoreConsumed) {
        return true ^ Offset.m4449equalsimpl0(positionChangeInternal($this$positionChangedIgnoreConsumed, true), Offset.INSTANCE.m4468getZeroF1C5BW0());
    }
    ...
    private static final long positionChangeInternal(PointerInputChange $this$positionChangeInternal, boolean ignoreConsumed) {
        ...
        return (ignoreConsumed || !$this$positionChangeInternal.isConsumed()) ? offset : Offset.INSTANCE.m4468getZeroF1C5BW0();
    }
    ...
    public static final void consumePositionChange(PointerInputChange $this$consumePositionChange) {
        if (!Offset.m4449equalsimpl0(positionChange($this$consumePositionChange), Offset.INSTANCE.m4468getZeroF1C5BW0())) {
    ...
    public static final boolean m5954isOutOfBoundsO0kMr_c(PointerInputChange $this$isOutOfBounds_u2dO0kMr_c, long j) {
        ...
        int width = (int) (j >> 32);
        int height = (int) (4294967295L & j);
        return (y < 0.0f) | (x < 0.0f) | (x > ((float) width)) | (y > ((float) height));
    }

    /* JADX INFO: renamed from: isOutOfBounds-jwHxaWs, reason: not valid java name */
    public static final boolean m5955isOutOfBoundsjwHxaWs(PointerInputChange pointerInputChange, long j, long j2) {
        boolean zM6081equalsimpl0 = PointerType.m6081equalsimpl0(pointerInputChange.getType(), PointerType.INSTANCE.m6088getTouchT8wyACA());
        ...
        float fIntBitsToFloat3 = Float.intBitsToFloat((int) (j2 >> 32)) * (zM6081equalsimpl0 ? 1.0f : 0.0f);
        float f = ((int) (j >> 32)) + fIntBitsToFloat3;
        float fIntBitsToFloat4 = Float.intBitsToFloat((int) (j2 & 4294967295L)) * (zM6081equalsimpl0 ? 1.0f : 0.0f);
