...
public final class PointerEvent_androidKt {
    public static final int EmptyPointerKeyboardModifiers() {
        return PointerKeyboardModifiers.m6072constructorimpl(0);
    }

    /* JADX INFO: renamed from: isPrimaryPressed-aHzCx-E, reason: not valid java name */
    public static final boolean m5983isPrimaryPressedaHzCxE(int i) {
        return (i & 33) != 0;
    }

    /* JADX INFO: renamed from: isSecondaryPressed-aHzCx-E, reason: not valid java name */
    public static final boolean m5985isSecondaryPressedaHzCxE(int i) {
        return (i & 66) != 0;
    }

    /* JADX INFO: renamed from: isTertiaryPressed-aHzCx-E, reason: not valid java name */
    public static final boolean m5988isTertiaryPressedaHzCxE(int i) {
        return (i & 4) != 0;
    }

    /* JADX INFO: renamed from: isBackPressed-aHzCx-E, reason: not valid java name */
    public static final boolean m5975isBackPressedaHzCxE(int i) {
        return (i & 8) != 0;
    }

    /* JADX INFO: renamed from: isForwardPressed-aHzCx-E, reason: not valid java name */
    public static final boolean m5978isForwardPressedaHzCxE(int i) {
        return (i & 16) != 0;
    }

    /* JADX INFO: renamed from: isPressed-bNIWhpI, reason: not valid java name */
    public static final boolean m5982isPressedbNIWhpI(int i, int buttonIndex) {
        switch (buttonIndex) {
            case 0:
                return m5983isPrimaryPressedaHzCxE(i);
            case 1:
                return m5985isSecondaryPressedaHzCxE(i);
            case 2:
            case 3:
            case 4:
                return ((1 << buttonIndex) & i) != 0;
            default:
                return ((1 << (buttonIndex + 2)) & i) != 0;
        }
    }

    /* JADX INFO: renamed from: getAreAnyPressed-aHzCx-E, reason: not valid java name */
    public static final boolean m5970getAreAnyPressedaHzCxE(int i) {
        return i != 0;
    }

    /* JADX INFO: renamed from: indexOfFirstPressed-aHzCx-E, reason: not valid java name */
    public static final int m5971indexOfFirstPressedaHzCxE(int i) {
        if (i == 0) {
            return -1;
        }
        int index = 0;
        for (int shifted = ((i & 96) >>> 5) | (i & (-97)); (shifted & 1) == 0; shifted >>>= 1) {
            index++;
        }
        return index;
    }
    ...
    public static final int m5972indexOfLastPressedaHzCxE(int i) {
        int index = -1;
        for (int shifted = ((i & 96) >>> 5) | (i & (-97)); shifted != 0; shifted >>>= 1) {
            index++;
        }
        return index;
    }
