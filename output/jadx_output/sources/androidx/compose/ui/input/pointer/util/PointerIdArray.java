...
public final class PointerIdArray {
    ...
    public final long m6111get_I2yYro(int index) {
        return PointerId.m5990constructorimpl(this.internalArray[index]);
    }

    /* JADX INFO: renamed from: remove-0FcD4WY, reason: not valid java name */
    public final boolean m6112remove0FcD4WY(long pointerId) {
    ...
    public final boolean m6109add0FcD4WY(long pointerId) {
    ...
    public final void m6113setDmW0f2w(int index, long pointerId) {
        set(index, pointerId);
    }
    ...
    public final boolean m6110contains0FcD4WY(long pointerId) {
