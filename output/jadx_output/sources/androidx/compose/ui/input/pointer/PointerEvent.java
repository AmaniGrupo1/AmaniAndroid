...
public final class PointerEvent {
    ...
    public PointerEvent(List<PointerInputChange> list, InternalPointerEvent internalPointerEvent) {
        ...
        this.buttons = PointerButtons.m5943constructorimpl(motionEvent2 != null ? motionEvent2.getButtonState() : 0);
        MotionEvent motionEvent3 = getMotionEvent();
        this.keyboardModifiers = PointerKeyboardModifiers.m6072constructorimpl(motionEvent3 != null ? motionEvent3.getMetaState() : 0);
        this.type = m5949calculatePointerEventType7fucELk();
    }
    ...
    public final void m5953setTypeEhbLWgg$ui(int i) {
        this.type = i;
    }

    /* JADX INFO: renamed from: calculatePointerEventType-7fucELk, reason: not valid java name */
    private final int m5949calculatePointerEventType7fucELk() {
        MotionEvent motionEvent = getMotionEvent();
        if (motionEvent != null) {
            switch (motionEvent.getActionMasked()) {
            }
            return PointerEventType.INSTANCE.m5966getPress7fucELk();
        }
        ...
        for (int index$iv = 0; index$iv < size; index$iv++) {
            ...
            if (PointerEventKt.changedToUpIgnoreConsumed(it)) {
                return PointerEventType.INSTANCE.m5967getRelease7fucELk();
            }
            if (PointerEventKt.changedToDownIgnoreConsumed(it)) {
                return PointerEventType.INSTANCE.m5966getPress7fucELk();
            }
        }
        return PointerEventType.INSTANCE.m5965getMove7fucELk();
    }
    ...
    public final PointerEvent copy(List<PointerInputChange> changes, MotionEvent motionEvent) {
        ...
        while (index$iv < size) {
            ...
            if (internalPointerEvent != null) {
                ...
                if (internalPointerEvent.m5925activeHoverEvent0FcD4WY(change.getId())) {
                    z = true;
                }
            } else {
                list = list2;
