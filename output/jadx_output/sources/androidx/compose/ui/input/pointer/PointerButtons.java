...
public final class PointerButtons {
    ...
    public static final /* synthetic */ PointerButtons m5942boximpl(int i) {
    ...
    public static boolean m5944equalsimpl(int i, Object obj) {
        return (obj instanceof PointerButtons) && i == ((PointerButtons) obj).getPackedValue();
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m5945equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
    public static int m5946hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m5947toStringimpl(int i) {
        return "PointerButtons(packedValue=" + i + ')';
    }

    public boolean equals(Object other) {
        return m5944equalsimpl(this.packedValue, other);
    }

    public int hashCode() {
        return m5946hashCodeimpl(this.packedValue);
    }

    public String toString() {
        return m5947toStringimpl(this.packedValue);
    }
