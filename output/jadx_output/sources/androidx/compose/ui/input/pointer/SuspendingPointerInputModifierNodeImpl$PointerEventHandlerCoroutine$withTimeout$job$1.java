    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                this.label = 1;
                if (DelayKt.delay(this.$timeMillis - 8, this) == coroutine_suspended) {
                ...
                if (cancellableContinuation != null) {
                    ...
                    cancellableContinuation.resumeWith(Result.m8542constructorimpl(ResultKt.createFailure(new PointerEventTimeoutCancellationException(this.$timeMillis))));
                }
