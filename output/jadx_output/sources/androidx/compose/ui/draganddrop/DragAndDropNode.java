...
public final class DragAndDropNode extends Modifier.Node implements TraversableNode, DragAndDropModifierNode, DragAndDropSourceModifierNode, DragAndDropTargetModifierNode, DragAndDropTarget {
    ...
    public final void m4206setSizeozmzZPI$ui(long j) {
        this.size = j;
    }
    ...
    public void mo4205requestDragAndDropTransferk4lQ0M(long offset) {
        boolean value$iv = this.onStartTransfer != null;
        if (!value$iv) {
            InlineClassHelperKt.throwIllegalStateException("Check failed.");
        }
        getDragAndDropManager().mo4201requestDragAndDropTransferUv8p0NA(this, offset);
    }

    /* JADX INFO: renamed from: startDragAndDropTransfer-d-4ec7I, reason: not valid java name */
    public final void m4207startDragAndDropTransferd4ec7I(final DragAndDropStartTransferScope $this$startDragAndDropTransfer_u2dd_u2d4ec7I, final long j, final Function0<Boolean> function0) {
        ...
        DragAndDropNodeKt.traverseSelfAndDescendants(this, new Function1<DragAndDropNode, TraversableNode.Companion.TraverseDescendantsAction>() { // from class: androidx.compose.ui.draganddrop.DragAndDropNode$startDragAndDropTransfer$1
            ...
            public final TraversableNode.Companion.TraverseDescendantsAction invoke(DragAndDropNode currentNode) {
                if (currentNode.getIsAttached()) {
                    ...
                    if (!Offset.m4449equalsimpl0(j, Offset.INSTANCE.m4467getUnspecifiedF1C5BW0())) {
                        LayoutCoordinates currentCoordinates = DelegatableNodeKt.requireLayoutNode(currentNode).getCoordinates();
                        long localPosition = currentCoordinates.mo6150localPositionOfR5De75A(nodeCoordinates, j);
                        if (!SizeKt.m4542toRectuvyYCjk(IntSizeKt.m7688toSizeozmzZPI(currentNode.getSize())).m4478containsk4lQ0M(localPosition)) {
                            return TraversableNode.Companion.TraverseDescendantsAction.ContinueTraversal;
                        }
                        onStartTransfer.invoke($this$startDragAndDropTransfer_u2dd_u2d4ec7I, Offset.m4441boximpl(localPosition));
                    } else {
                        onStartTransfer.invoke($this$startDragAndDropTransfer_u2dd_u2d4ec7I, Offset.m4441boximpl(Offset.INSTANCE.m4467getUnspecifiedF1C5BW0()));
                    }
    ...
    public void mo4203drag12SF9DM(final DragAndDropTransferData transferData, final long decorationSize, final Function1<? super DrawScope, Unit> drawDragDecoration) {
        boolean value$iv = this.onStartTransfer == null;
        if (!value$iv) {
            InlineClassHelperKt.throwIllegalStateException("Check failed.");
        }
        this.onStartTransfer = new Function2<DragAndDropStartTransferScope, Offset, Unit>() { // from class: androidx.compose.ui.draganddrop.DragAndDropNode$drag$1
            ...
            public /* bridge */ /* synthetic */ Unit invoke(DragAndDropStartTransferScope dragAndDropStartTransferScope, Offset offset) {
                m4208invokeUv8p0NA(dragAndDropStartTransferScope, offset.m4462unboximpl());
                return Unit.INSTANCE;
            }

            /* JADX INFO: renamed from: invoke-Uv8p0NA, reason: not valid java name */
            public final void m4208invokeUv8p0NA(DragAndDropStartTransferScope dragAndDropStartTransferScope, long j) {
                dragAndDropStartTransferScope.mo4202startDragAndDropTransfer12SF9DM(transferData, decorationSize, drawDragDecoration);
            }
        };
        getDragAndDropManager().mo4201requestDragAndDropTransferUv8p0NA(this, Offset.INSTANCE.m4467getUnspecifiedF1C5BW0());
    ...
    public void onMoved(final DragAndDropEvent event) {
        ...
        boolean z = false;
        if (currentChildNode != null && DragAndDropNodeKt.m4210containsUv8p0NA(currentChildNode, DragAndDrop_androidKt.getPositionInRoot(event))) {
            z = true;
        }
        if (z) {
            ...
            if ($this$firstDescendantOrNull$iv.getNode().getIsAttached()) {
                ...
                TraversableNodeKt.traverseDescendants($this$firstDescendantOrNull$iv, new Function1<DragAndDropNode, TraversableNode.Companion.TraverseDescendantsAction>() { // from class: androidx.compose.ui.draganddrop.DragAndDropNode$onMoved$$inlined$firstDescendantOrNull$1
                    ...
                    public final TraversableNode.Companion.TraverseDescendantsAction invoke(DragAndDropNode dragAndDropNode) {
                        ...
                        if (this.getDragAndDropManager().isInterestedTarget(child) && DragAndDropNodeKt.m4210containsUv8p0NA(child, DragAndDrop_androidKt.getPositionInRoot(event))) {
