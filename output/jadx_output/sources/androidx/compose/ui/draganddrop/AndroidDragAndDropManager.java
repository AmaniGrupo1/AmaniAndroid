...
public final class AndroidDragAndDropManager implements View.OnDragListener, DragAndDropManager {
    ...
    public void mo4201requestDragAndDropTransferUv8p0NA(DragAndDropNode node, long offset) {
        final Ref.BooleanRef isTransferStarted = new Ref.BooleanRef();
        node.m4207startDragAndDropTransferd4ec7I(new DragAndDropStartTransferScope() { // from class: androidx.compose.ui.draganddrop.AndroidDragAndDropManager$requestDragAndDropTransfer$dragAndDropSourceScope$1
            ...
            public boolean mo4202startDragAndDropTransfer12SF9DM(DragAndDropTransferData transferData, long decorationSize, Function1<? super DrawScope, Unit> drawDragDecoration) {
                isTransferStarted.element = ((Boolean) this.startDrag.invoke(transferData, Size.m4509boximpl(decorationSize), drawDragDecoration)).booleanValue();
