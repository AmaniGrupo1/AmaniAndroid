...
public interface MultiContentMeasurePolicy {
    ...
    MeasureResult mo762measure3p2s80s(MeasureScope measureScope, List<? extends List<? extends Measurable>> list, long j);
    ...
    default int minIntrinsicWidth(IntrinsicMeasureScope $this$minIntrinsicWidth, List<? extends List<? extends IntrinsicMeasurable>> list, int height) {
        ...
        MeasureResult layoutResult = mo762measure3p2s80s(layoutReceiver, mapped, constraints);
