...
public final class InsetsListener extends WindowInsetsAnimationCompat.Callback implements Runnable, OnApplyWindowInsetsListener, View.OnAttachStateChangeListener {
    ...
    public WindowInsetsAnimationCompat.BoundsCompat onStart(WindowInsetsAnimationCompat animation, WindowInsetsAnimationCompat.BoundsCompat bounds) throws Throwable {
        ...
        if (animation.getDurationMillis() > 0 && insets != null) {
            ...
            if (rulers != null) {
                ...
                long target = ValueInsets.m6275constructorimpl((((long) insets$iv.left) << 48) | (((long) insets$iv.top) << 32) | (((long) insets$iv.right) << 16) | ((long) insets$iv.bottom));
                long current = insetsValue.getCurrent();
                if (!ValueInsets.m6277equalsimpl0(target, current)) {
                    insetsValue.m6292setSourceValueInsetsYnlvx88(current);
                    insetsValue.m6293setTargetValueInsetsYnlvx88(target);
    ...
    private final void stopAnimationForRuler(WindowWindowInsetsAnimationValues insetsValue) {
        ...
        insetsValue.m6292setSourceValueInsetsYnlvx88(ValueInsets_androidKt.getUnsetValueInsets());
        insetsValue.m6293setTargetValueInsetsYnlvx88(ValueInsets_androidKt.getUnsetValueInsets());
    }
    ...
    private final void updateInsets(WindowInsetsCompat insets) throws Throwable {
                ...
                if ((((~slot$iv$iv) << 7) & slot$iv$iv & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (j$iv$iv < bitCount$iv$iv) {
                        ...
                        if ($i$f$isFull != 0) {
                            ...
                            long insetsValue = ValueInsets.m6275constructorimpl((((long) insets$iv.left) << 48) | (((long) insets$iv.top) << 32) | (((long) insets$iv.right) << 16) | ((long) insets$iv.bottom));
                            WindowWindowInsetsAnimationValues windowWindowInsetsAnimationValues = this.insetsValues.get(rulers);
                            Intrinsics.checkNotNull(windowWindowInsetsAnimationValues);
                            WindowWindowInsetsAnimationValues values = windowWindowInsetsAnimationValues;
                            k$iv2 = k$iv3;
                            v$iv2 = v$iv3;
                            if (!ValueInsets.m6277equalsimpl0(insetsValue, values.getCurrent())) {
                                values.m6290setCurrentYnlvx88(insetsValue);
                                changed2 = true;
                                if (!ValueInsets.m6277equalsimpl0(insetsValue, ValueInsets_androidKt.getZeroValueInsets())) {
                                    hasInsets2 = true;
                                }
                            }
                            if (type != WindowInsetsCompat.Type.ime()) {
                                Insets insets$iv2 = insets.getInsetsIgnoringVisibility(type);
                                long insetsValue2 = ValueInsets.m6275constructorimpl((((long) insets$iv2.left) << 48) | (((long) insets$iv2.top) << 32) | (((long) insets$iv2.right) << 16) | ((long) insets$iv2.bottom));
                                if (!ValueInsets.m6277equalsimpl0(values.getMaximum(), insetsValue2)) {
                                    values.m6291setMaximumYnlvx88(insetsValue2);
                                    changed2 = true;
                                    if (!ValueInsets.m6277equalsimpl0(insetsValue2, ValueInsets_androidKt.getZeroValueInsets())) {
                                        hasInsets2 = true;
                                    }
                                }
                            }
        ...
        if (cutout == null) {
            ...
            waterfall = ValueInsets.m6275constructorimpl((((long) insets$iv3.left) << 48) | (((long) insets$iv3.top) << 32) | (((long) insets$iv3.right) << c) | ((long) insets$iv3.bottom));
        }
        ...
        waterfallInsets.setVisible(!ValueInsets.m6277equalsimpl0(waterfall, ValueInsets_androidKt.getZeroValueInsets()));
        if (!ValueInsets.m6277equalsimpl0(waterfallInsets.getCurrent(), waterfall)) {
            waterfallInsets.m6290setCurrentYnlvx88(waterfall);
            waterfallInsets.m6291setMaximumYnlvx88(waterfall);
            changed = true;
            if (!ValueInsets.m6277equalsimpl0(waterfall, ValueInsets_androidKt.getZeroValueInsets())) {
                hasInsets = true;
            }
        }
        if (cutout != null) {
