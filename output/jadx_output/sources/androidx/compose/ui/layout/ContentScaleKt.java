...
public final class ContentScaleKt {
    ...
    public static final float m6138computeFillMaxDimensioniLBOSCw(long j, long j2) {
        ...
        int bits$iv$iv$iv$iv2 = (int) (j >> 32);
        float widthScale = Float.intBitsToFloat(bits$iv$iv$iv$iv) / Float.intBitsToFloat(bits$iv$iv$iv$iv2);
        int bits$iv$iv$iv$iv3 = (int) (j2 & 4294967295L);
        int bits$iv$iv$iv$iv4 = (int) (j & 4294967295L);
    ...
    private static final float m6140computeFillWidthiLBOSCw(long j, long j2) {
    ...
    private static final float m6137computeFillHeightiLBOSCw(long j, long j2) {
