...
public interface MeasurePolicy {
    ...
    MeasureResult mo41measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j);
    ...
    default int minIntrinsicWidth(IntrinsicMeasureScope $this$minIntrinsicWidth, List<? extends IntrinsicMeasurable> list, int height) {
        ...
        MeasureResult layoutResult = mo41measure3p2s80s(layoutReceiver, mapped, constraints);
