...
public interface LayoutCoordinates {
    ...
    long mo6150localPositionOfR5De75A(LayoutCoordinates sourceCoordinates, long relativeToSource);

    /* JADX INFO: renamed from: localToRoot-MK-Hz9U, reason: not valid java name */
    long mo6152localToRootMKHz9U(long relativeToLocal);

    /* JADX INFO: renamed from: localToWindow-MK-Hz9U, reason: not valid java name */
    long mo6154localToWindowMKHz9U(long relativeToLocal);

    /* JADX INFO: renamed from: windowToLocal-MK-Hz9U, reason: not valid java name */
    long mo6158windowToLocalMKHz9U(long relativeToWindow);
    ...
    public static final class DefaultImpls {
        ...
        public static long m6162screenToLocalMKHz9U(LayoutCoordinates $this, long j) {
            return LayoutCoordinates.super.mo6155screenToLocalMKHz9U(j);
        }

        @Deprecated
        /* JADX INFO: renamed from: localToScreen-MK-Hz9U, reason: not valid java name */
        public static long m6161localToScreenMKHz9U(LayoutCoordinates $this, long j) {
            return LayoutCoordinates.super.mo6153localToScreenMKHz9U(j);
        }

        @Deprecated
        /* JADX INFO: renamed from: localPositionOf-S_NoaFU, reason: not valid java name */
        public static long m6159localPositionOfS_NoaFU(LayoutCoordinates $this, LayoutCoordinates sourceCoordinates, long j, boolean includeMotionFrameOfReference) {
            return LayoutCoordinates.super.mo6151localPositionOfS_NoaFU(sourceCoordinates, j, includeMotionFrameOfReference);
        }

        @Deprecated
        /* JADX INFO: renamed from: transformFrom-EL8BTi8, reason: not valid java name */
        public static void m6163transformFromEL8BTi8(LayoutCoordinates $this, LayoutCoordinates sourceCoordinates, float[] fArr) {
            LayoutCoordinates.super.mo6156transformFromEL8BTi8(sourceCoordinates, fArr);
        }

        @Deprecated
        /* JADX INFO: renamed from: transformToScreen-58bKbWc, reason: not valid java name */
        public static void m6164transformToScreen58bKbWc(LayoutCoordinates $this, float[] fArr) {
            LayoutCoordinates.super.mo6157transformToScreen58bKbWc(fArr);
        }
    }
    ...
    /* JADX INFO: renamed from: screenToLocal-MK-Hz9U, reason: not valid java name */
    default long mo6155screenToLocalMKHz9U(long relativeToScreen) {
        return Offset.INSTANCE.m4467getUnspecifiedF1C5BW0();
    }

    /* JADX INFO: renamed from: localToScreen-MK-Hz9U, reason: not valid java name */
    default long mo6153localToScreenMKHz9U(long relativeToLocal) {
        return Offset.INSTANCE.m4467getUnspecifiedF1C5BW0();
    }

    /* JADX INFO: renamed from: localPositionOf-S_NoaFU$default, reason: not valid java name */
    static /* synthetic */ long m6148localPositionOfS_NoaFU$default(LayoutCoordinates layoutCoordinates, LayoutCoordinates layoutCoordinates2, long j, boolean z, int i, Object obj) {
        if (obj != null) {
        ...
        return layoutCoordinates.mo6151localPositionOfS_NoaFU(layoutCoordinates2, j, z);
    }

    /* JADX INFO: renamed from: localPositionOf-S_NoaFU, reason: not valid java name */
    default long mo6151localPositionOfS_NoaFU(LayoutCoordinates sourceCoordinates, long relativeToSource, boolean includeMotionFrameOfReference) {
    ...
    /* JADX INFO: renamed from: transformFrom-EL8BTi8, reason: not valid java name */
    default void mo6156transformFromEL8BTi8(LayoutCoordinates sourceCoordinates, float[] matrix) {
        InlineClassHelperKt.throwUnsupportedOperationException("transformFrom is not implemented on this LayoutCoordinates");
    }

    /* JADX INFO: renamed from: transformToScreen-58bKbWc, reason: not valid java name */
    default void mo6157transformToScreen58bKbWc(float[] matrix) {
