...
public final class OnSizeChangedNode extends Modifier.Node implements LayoutAwareModifierNode {
    ...
    private long previousSize = IntSize.m7671constructorimpl((((long) Integer.MIN_VALUE) << 32) | (((long) Integer.MIN_VALUE) & 4294967295L));
    ...
    public final void update(Function1<? super IntSize, Unit> onSizeChanged) {
        ...
        this.previousSize = IntSize.m7671constructorimpl((((long) Integer.MIN_VALUE) << 32) | (((long) Integer.MIN_VALUE) & 4294967295L));
    }

    @Override // androidx.compose.ui.node.LayoutAwareModifierNode
    /* JADX INFO: renamed from: onRemeasured-ozmzZPI */
    public void mo394onRemeasuredozmzZPI(long size) {
        if (!IntSize.m7674equalsimpl0(this.previousSize, size)) {
            this.onSizeChanged.invoke(IntSize.m7668boximpl(size));
