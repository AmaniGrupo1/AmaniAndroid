...
public interface ApproachLayoutModifierNode extends LayoutModifierNode {
    ...
    boolean mo75isMeasurementApproachInProgressozmzZPI(long lookaheadSize);
    ...
    default MeasureResult mo69measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long j) {
    ...
    default int minApproachIntrinsicWidth(ApproachIntrinsicMeasureScope $this$minApproachIntrinsicWidth, IntrinsicMeasurable measurable, int height) {
        ...
        if (lookaheadDelegate.getHasMeasureResult()) {
            return NodeMeasuringIntrinsics.INSTANCE.minWidth$ui(new NodeMeasuringIntrinsics.ApproachMeasureBlock() { // from class: androidx.compose.ui.layout.ApproachLayoutModifierNode.minApproachIntrinsicWidth.1
                ...
                /* JADX INFO: renamed from: measure-3p2s80s */
                public final MeasureResult mo6120measure3p2s80s(ApproachMeasureScope $this$ApproachMeasureBlock, Measurable intrinsicMeasurable, long j) {
                    return ApproachLayoutModifierNode.this.mo74approachMeasure3p2s80s($this$ApproachMeasureBlock, intrinsicMeasurable, j);
                }
