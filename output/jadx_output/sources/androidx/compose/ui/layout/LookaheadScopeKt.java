...
public final class LookaheadScopeKt {
    ...
    public static final void LookaheadScope(final Function3<? super LookaheadScope, ? super Composer, ? super Integer, Unit> function3, Composer composer, final int i) {
        ...
        if (!composerStartRestartGroup.shouldExecute((i2 & 3) != 2, i2 & 1)) {
            ...
            Updater.m3972initimpl(composerM3967constructorimpl, new Function1<LayoutNode, Unit>() { // from class: androidx.compose.ui.layout.LookaheadScopeKt$LookaheadScope$2$1
            ...
            Updater.m3975setimpl(composerM3967constructorimpl, lookaheadScopeImpl2, new Function2<LayoutNode, LookaheadScopeImpl, Unit>() { // from class: androidx.compose.ui.layout.LookaheadScopeKt$LookaheadScope$2$2
                @Override // kotlin.jvm.functions.Function2
    ...
    public static final long m6172localLookaheadPositionOfFgt4K4Q(LookaheadScope $this$localLookaheadPositionOf_u2dFgt4K4Q, LayoutCoordinates coordinates, LayoutCoordinates sourceCoordinates, long j, boolean includeMotionFrameOfReference) {
        ...
        if (lookaheadCoords instanceof LookaheadLayoutCoordinates) {
            return ((LookaheadLayoutCoordinates) lookaheadCoords).mo6151localPositionOfS_NoaFU(source, j, includeMotionFrameOfReference);
        }
        if (!(source instanceof LookaheadLayoutCoordinates)) {
            return lookaheadCoords.mo6151localPositionOfS_NoaFU(lookaheadCoords, j, includeMotionFrameOfReference);
        }
        return Offset.m4444constructorimpl((-9223372034707292160L) ^ ((LookaheadLayoutCoordinates) source).mo6151localPositionOfS_NoaFU(lookaheadCoords, j, includeMotionFrameOfReference));
    }
}
