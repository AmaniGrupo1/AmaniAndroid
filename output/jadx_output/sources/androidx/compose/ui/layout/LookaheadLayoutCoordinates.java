...
public final class LookaheadLayoutCoordinates implements LayoutCoordinates {
    ...
    public long mo6149getSizeYbymL2g() {
    ...
    private final long m6170getLookaheadOffsetF1C5BW0() {
        LookaheadDelegate it = LookaheadLayoutCoordinatesKt.getRootLookaheadDelegate(this.lookaheadDelegate);
        return Offset.m4456minusMKHz9U(mo6150localPositionOfR5De75A(it.getCoordinates(), Offset.INSTANCE.m4468getZeroF1C5BW0()), getCoordinator().mo6150localPositionOfR5De75A(it.getCoordinator(), Offset.INSTANCE.m4468getZeroF1C5BW0()));
    }

    @Override // androidx.compose.ui.layout.LayoutCoordinates
    /* JADX INFO: renamed from: screenToLocal-MK-Hz9U */
    public long mo6155screenToLocalMKHz9U(long relativeToScreen) {
        return Offset.m4457plusMKHz9U(getCoordinator().mo6155screenToLocalMKHz9U(relativeToScreen), m6170getLookaheadOffsetF1C5BW0());
    }

    @Override // androidx.compose.ui.layout.LayoutCoordinates
    /* JADX INFO: renamed from: localToScreen-MK-Hz9U */
    public long mo6153localToScreenMKHz9U(long relativeToLocal) {
        return getCoordinator().mo6153localToScreenMKHz9U(Offset.m4457plusMKHz9U(relativeToLocal, m6170getLookaheadOffsetF1C5BW0()));
    }

    @Override // androidx.compose.ui.layout.LayoutCoordinates
    /* JADX INFO: renamed from: windowToLocal-MK-Hz9U */
    public long mo6158windowToLocalMKHz9U(long relativeToWindow) {
        return Offset.m4457plusMKHz9U(getCoordinator().mo6158windowToLocalMKHz9U(relativeToWindow), m6170getLookaheadOffsetF1C5BW0());
    }

    @Override // androidx.compose.ui.layout.LayoutCoordinates
    /* JADX INFO: renamed from: localToWindow-MK-Hz9U */
    public long mo6154localToWindowMKHz9U(long relativeToLocal) {
        return getCoordinator().mo6154localToWindowMKHz9U(Offset.m4457plusMKHz9U(relativeToLocal, m6170getLookaheadOffsetF1C5BW0()));
    }

    @Override // androidx.compose.ui.layout.LayoutCoordinates
    /* JADX INFO: renamed from: localToRoot-MK-Hz9U */
    public long mo6152localToRootMKHz9U(long relativeToLocal) {
        return getCoordinator().mo6152localToRootMKHz9U(Offset.m4457plusMKHz9U(relativeToLocal, m6170getLookaheadOffsetF1C5BW0()));
    }
    ...
    public long mo6151localPositionOfS_NoaFU(LayoutCoordinates sourceCoordinates, long relativeToSource, boolean includeMotionFrameOfReference) {
        if (!(sourceCoordinates instanceof LookaheadLayoutCoordinates)) {
            ...
            long jMo6151localPositionOfS_NoaFU = mo6151localPositionOfS_NoaFU(rootDelegate.getLookaheadLayoutCoordinates(), relativeToSource, includeMotionFrameOfReference);
            long position = rootDelegate.getPosition();
            float x$iv$iv = IntOffset.m7633getXimpl(position);
            float y$iv$iv = IntOffset.m7634getYimpl(position);
            ...
            long localLookaheadPos = Offset.m4456minusMKHz9U(jMo6151localPositionOfS_NoaFU, Offset.m4444constructorimpl(v2$iv$iv$iv));
            ...
            long localPos = rootDelegateCoordinates.mo6151localPositionOfS_NoaFU(sourceCoordinates, Offset.INSTANCE.m4468getZeroF1C5BW0(), includeMotionFrameOfReference);
            return Offset.m4457plusMKHz9U(localLookaheadPos, localPos);
        }
        ...
        if (ancestor != null) {
            long sourceInCommonAncestor = IntOffset.m7637plusqkQi6aY(source.m6400positionIniSbpLlY$ui(ancestor, !includeMotionFrameOfReference), IntOffsetKt.m7650roundk4lQ0M(relativeToSource));
            long lookaheadPosInAncestor = this.lookaheadDelegate.m6400positionIniSbpLlY$ui(ancestor, !includeMotionFrameOfReference);
            long jM7636minusqkQi6aY = IntOffset.m7636minusqkQi6aY(sourceInCommonAncestor, lookaheadPosInAncestor);
            float x$iv$iv2 = IntOffset.m7633getXimpl(jM7636minusqkQi6aY);
            float y$iv$iv2 = IntOffset.m7634getYimpl(jM7636minusqkQi6aY);
            ...
            return Offset.m4444constructorimpl(v2$iv$iv$iv2);
        }
        LookaheadDelegate sourceRoot = LookaheadLayoutCoordinatesKt.getRootLookaheadDelegate(source);
        long sourcePosition = IntOffset.m7637plusqkQi6aY(IntOffset.m7637plusqkQi6aY(source.m6400positionIniSbpLlY$ui(sourceRoot, !includeMotionFrameOfReference), sourceRoot.getPosition()), IntOffsetKt.m7650roundk4lQ0M(relativeToSource));
        LookaheadDelegate rootDelegate2 = LookaheadLayoutCoordinatesKt.getRootLookaheadDelegate(this.lookaheadDelegate);
        long lookaheadPosition = IntOffset.m7637plusqkQi6aY(this.lookaheadDelegate.m6400positionIniSbpLlY$ui(rootDelegate2, !includeMotionFrameOfReference), rootDelegate2.getPosition());
        long jM7636minusqkQi6aY2 = IntOffset.m7636minusqkQi6aY(sourcePosition, lookaheadPosition);
        float x$iv$iv3 = IntOffset.m7633getXimpl(jM7636minusqkQi6aY2);
        float y$iv$iv3 = IntOffset.m7634getYimpl(jM7636minusqkQi6aY2);
        long v1$iv$iv$iv5 = Float.floatToRawIntBits(x$iv$iv3);
        long v2$iv$iv$iv3 = Float.floatToRawIntBits(y$iv$iv3);
        long relativePosition = Offset.m4444constructorimpl((v1$iv$iv$iv5 << 32) | (v2$iv$iv$iv3 & 4294967295L));
        ...
        return wrappedBy.mo6151localPositionOfS_NoaFU(wrappedBy2, relativePosition, includeMotionFrameOfReference);
    }
    ...
    public void mo6156transformFromEL8BTi8(LayoutCoordinates sourceCoordinates, float[] matrix) {
        getCoordinator().mo6156transformFromEL8BTi8(sourceCoordinates, matrix);
    }

    @Override // androidx.compose.ui.layout.LayoutCoordinates
    /* JADX INFO: renamed from: transformToScreen-58bKbWc */
    public void mo6157transformToScreen58bKbWc(float[] matrix) {
        getCoordinator().mo6157transformToScreen58bKbWc(matrix);
    }
