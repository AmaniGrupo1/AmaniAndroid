...
public final class SubcomposeLayoutKt {
    ...
    public static final void SubcomposeLayout(final Modifier modifier, Function2<? super SubcomposeMeasureScope, ? super Constraints, ? extends MeasureResult> function2, Composer $composer, final int $changed, final int i) {
        ...
        ComposerKt.sourceInformation($composer2, "C(SubcomposeLayout)P(1)97@4796L36,96@4762L145:SubcomposeLayout.kt#80mrfh");
        int $dirty = $changed;
        int i2 = i & 1;
        if (i2 != 0) {
            $dirty |= 6;
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.ui.layout.SubcomposeLayoutKt.SubcomposeLayout.2
                ...
                public final void invoke(Composer composer, int i3) {
                    SubcomposeLayoutKt.SubcomposeLayout(modifier, function22, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    public static final void SubcomposeLayout(final SubcomposeLayoutState state, Modifier modifier, final Function2<? super SubcomposeMeasureScope, ? super Constraints, ? extends MeasureResult> function2, Composer $composer, final int $changed, final int i) {
        ...
        ComposerKt.sourceInformation($composer2, "C(SubcomposeLayout)P(2,1)129@6259L27,130@6327L28,133@6483L492:SubcomposeLayout.kt#80mrfh");
        int $dirty = $changed;
        if (($changed & 6) == 0) {
        ...
        if (!$composer2.shouldExecute(($dirty2 & 147) != 146, $dirty2 & 1)) {
            ...
            Composer $this$SubcomposeLayout_u24lambda_u241 = Updater.m3967constructorimpl($composer2);
            Updater.m3975setimpl($this$SubcomposeLayout_u24lambda_u241, state, state.getSetRoot$ui());
            Updater.m3975setimpl($this$SubcomposeLayout_u24lambda_u241, compositionContext, state.getSetCompositionContext$ui());
            Updater.m3975setimpl($this$SubcomposeLayout_u24lambda_u241, function2, state.getSetMeasurePolicy$ui());
            Updater.m3975setimpl($this$SubcomposeLayout_u24lambda_u241, localMap, ComposeUiNode.INSTANCE.getSetResolvedCompositionLocals());
            Updater.m3973reconcileimpl($this$SubcomposeLayout_u24lambda_u241, ComposeUiNode.INSTANCE.getApplyOnDeactivatedNodeAssertion());
            Updater.m3975setimpl($this$SubcomposeLayout_u24lambda_u241, materialized, ComposeUiNode.INSTANCE.getSetModifier());
            Modifier modifier5 = modifier4;
            Updater.m3971initimpl($this$SubcomposeLayout_u24lambda_u241, Integer.valueOf(compositeKeyHash), ComposeUiNode.INSTANCE.getSetCompositeKeyHash());
            $composer2.endNode();
            ComposerKt.sourceInformationMarkerEnd($composer2);
            if ($composer2.getSkipping()) {
                $composer2.startReplaceGroup(-1266202711);
            } else {
                $composer2.startReplaceGroup(-1259244916);
                ComposerKt.sourceInformation($composer2, "146@7032L34,146@7021L45");
                ComposerKt.sourceInformationMarkerStart($composer2, 1899042491, "CC(remember):SubcomposeLayout.kt#9igjgp");
