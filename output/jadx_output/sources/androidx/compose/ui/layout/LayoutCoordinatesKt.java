...
public final class LayoutCoordinatesKt {
    public static final long positionInRoot(LayoutCoordinates $this$positionInRoot) {
        return $this$positionInRoot.mo6152localToRootMKHz9U(Offset.INSTANCE.m4468getZeroF1C5BW0());
    }

    public static final long positionInWindow(LayoutCoordinates $this$positionInWindow) {
        return $this$positionInWindow.mo6154localToWindowMKHz9U(Offset.INSTANCE.m4468getZeroF1C5BW0());
    }

    public static final long positionOnScreen(LayoutCoordinates $this$positionOnScreen) {
        return $this$positionOnScreen.mo6153localToScreenMKHz9U(Offset.INSTANCE.m4468getZeroF1C5BW0());
    }
    ...
    public static final Rect boundsInWindow(LayoutCoordinates $this$boundsInWindow, boolean clipBounds) {
        ...
        float rootWidth = (int) (root.mo6149getSizeYbymL2g() >> 32);
        float rootHeight = (int) (root.mo6149getSizeYbymL2g() & 4294967295L);
        ...
        if (!(maximumValue$iv$iv == maximumValue$iv$iv2)) {
            if (!($this$fastCoerceAtLeast$iv$iv == maximumValue$iv$iv3)) {
                ...
                long topLeft = root.mo6154localToWindowMKHz9U(Offset.m4444constructorimpl((v1$iv$iv << 32) | (v2$iv$iv & 4294967295L)));
                ...
                long topRight = root.mo6154localToWindowMKHz9U(Offset.m4444constructorimpl(v2$iv$iv2));
                ...
                long bottomRight = root.mo6154localToWindowMKHz9U(Offset.m4444constructorimpl(v2$iv$iv3));
                ...
                long bottomLeft = root.mo6154localToWindowMKHz9U(Offset.m4444constructorimpl(v2$iv$iv4));
    ...
    public static final long positionInParent(LayoutCoordinates $this$positionInParent) {
        ...
        return parentLayoutCoordinates != null ? parentLayoutCoordinates.mo6150localPositionOfR5De75A($this$positionInParent, Offset.INSTANCE.m4468getZeroF1C5BW0()) : Offset.INSTANCE.m4468getZeroF1C5BW0();
    }
    ...
    public static final Rect boundsInParent(LayoutCoordinates $this$boundsInParent) {
        ...
        return (parentLayoutCoordinates == null || (rectLocalBoundingBoxOf$default = LayoutCoordinates.localBoundingBoxOf$default(parentLayoutCoordinates, $this$boundsInParent, false, 2, null)) == null) ? new Rect(0.0f, 0.0f, (int) ($this$boundsInParent.mo6149getSizeYbymL2g() >> 32), (int) (4294967295L & $this$boundsInParent.mo6149getSizeYbymL2g())) : rectLocalBoundingBoxOf$default;
    }
