...
public final class LayoutNodeSubcompositionsState implements ComposeNodeLifecycleCallback {
        ...
        return new LayoutNode.NoIntrinsicsMeasurePolicy(this.NoIntrinsicsMessage) { // from class: androidx.compose.ui.layout.LayoutNodeSubcompositionsState.createMeasurePolicy.1
            ...
            public MeasureResult mo41measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, List<? extends Measurable> list, long j) {
                ...
                if ($this$measure_u2d3p2s80s.isLookingAhead() || LayoutNodeSubcompositionsState.this.root.getLookaheadRoot() == null) {
                    ...
                    final MeasureResult result = block.invoke(LayoutNodeSubcompositionsState.this.scope, Constraints.m7445boximpl(j));
                ...
                final MeasureResult result2 = block.invoke(LayoutNodeSubcompositionsState.this.approachMeasureScope, Constraints.m7445boximpl(j));
    ...
    */
    public final void disposeUnusedSlotsInApproach() {
        ...
        int $i$f$removeIf3 = 0;
        MutableScatterMap<Object, SubcomposeLayoutState.PrecomposedSlotHandle> this_$iv$iv3 = mutableScatterMap;
            ...
            if ($this$maskEmptyOrDeleted$iv$iv$iv == -9187201950435737472L) {
                ...
                while (j$iv$iv < bitCount$iv$iv) {
                    ...
                    if (!(value$iv$iv$iv < 128)) {
                        ...
                        int index$iv$iv = (i$iv$iv << 3) + j$iv$iv;
                        i = i2;
                        Object slotId = mutableScatterMap.keys[index$iv$iv];
                        $i$f$removeIf2 = $i$f$removeIf3;
                        SubcomposeLayoutState.PrecomposedSlotHandle handle = (SubcomposeLayoutState.PrecomposedSlotHandle) mutableScatterMap.values[index$iv$iv];
                        int id = this.slotIdsOfCompositionsNeededInApproach.indexOf(slotId);
                        if (id >= 0) {
                            this_$iv$iv2 = this_$iv$iv3;
                            if (id < this.currentApproachIndex) {
                                z = false;
                                $i$f$forEachIndexed2 = $i$f$forEachIndexed3;
                            }
                            if (!z) {
                        ...
                        if (id >= 0) {
                            $i$f$forEachIndexed2 = $i$f$forEachIndexed3;
                            this.slotIdsOfCompositionsNeededInApproach.set(id, SubcomposeLayoutKt.UnspecifiedSlotId);
                        } else {
                            $i$f$forEachIndexed2 = $i$f$forEachIndexed3;
                        }
    ...
    public final SubcomposeLayoutState.PrecomposedSlotHandle createPrecomposedSlotHandle(final Object slotId) {
        ...
        return new SubcomposeLayoutState.PrecomposedSlotHandle() { // from class: androidx.compose.ui.layout.LayoutNodeSubcompositionsState.createPrecomposedSlotHandle.2
            ...
            public void mo6169premeasure0kLqBqw(int index, long constraints) {
                ...
                if (node != null && node.isAttached()) {
                    ...
                    this_$iv.ignoreRemeasureRequests = true;
                    LayoutNodeKt.requireOwner(node).mo6527measureAndLayout0kLqBqw(node.getChildren$ui().get(index), constraints);
                    Unit unit = Unit.INSTANCE;
                    this_$iv.ignoreRemeasureRequests = false;
            ...
            public long mo6168getSizeYEO4UFw(int index) {
                LayoutNode node = (LayoutNode) LayoutNodeSubcompositionsState.this.precomposeMap.get(slotId);
                if (node != null && node.isAttached()) {
                    int size = node.getChildren$ui().size();
                    if (index < 0 || index >= size) {
    ...
    public final SubcomposeLayoutState.PausedPrecomposition precomposePaused(final Object slotId, Function2<? super Composer, ? super Integer, Unit> content) throws Throwable {
        ...
        return new PausedPrecompositionImpl() { // from class: androidx.compose.ui.layout.LayoutNodeSubcompositionsState.precomposePaused.2
            ...
            @Override // androidx.compose.ui.layout.SubcomposeLayoutState.PausedPrecomposition
            public boolean resume(ShouldPauseCallback shouldPause) throws Throwable {
                NodeState nodeState = getNodeState();
    ...
    static final class NodeState {
        ...
        public final void m6167recordFsph7yY(int op) {
