...
public final class TestModifierUpdaterKt {
    ...
    public static final void TestModifierUpdaterLayout(final Function1<? super TestModifierUpdater, Unit> function1, Composer $composer, final int $changed) {
        ...
        ComposerKt.sourceInformation($composer2, "C(TestModifierUpdaterLayout)49@1770L27,50@1833L102,53@1940L280:TestModifierUpdater.kt#80mrfh");
        int $dirty = $changed;
        if (($changed & 6) == 0) {
        ...
        if (!$composer2.shouldExecute(($dirty & 3) != 2, $dirty & 1)) {
            ...
            if (it$iv == Composer.INSTANCE.getEmpty()) {
                Object value$iv = (MeasurePolicy) new MeasurePolicy() { // from class: androidx.compose.ui.layout.TestModifierUpdaterKt$TestModifierUpdaterLayout$measurePolicy$1$1
                    ...
                    public final MeasureResult mo41measure3p2s80s(MeasureScope $this$MeasurePolicy, List<? extends Measurable> list, long constraints) {
                        return MeasureScope.layout$default($this$MeasurePolicy, Constraints.m7458getMaxWidthimpl(constraints), Constraints.m7457getMaxHeightimpl(constraints), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.layout.TestModifierUpdaterKt$TestModifierUpdaterLayout$measurePolicy$1$1.1
            ...
            Composer $this$TestModifierUpdaterLayout_u24lambda_u241 = Updater.m3967constructorimpl($composer2);
            Updater.m3975setimpl($this$TestModifierUpdaterLayout_u24lambda_u241, measurePolicy, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
            Updater.m3971initimpl($this$TestModifierUpdaterLayout_u24lambda_u241, Integer.valueOf(compositeKeyHash), ComposeUiNode.INSTANCE.getSetCompositeKeyHash());
            Updater.m3972initimpl($this$TestModifierUpdaterLayout_u24lambda_u241, new Function1<LayoutNode, Unit>() { // from class: androidx.compose.ui.layout.TestModifierUpdaterKt$TestModifierUpdaterLayout$1$1
