...
final class ApproachLayoutModifierNodeImpl extends Modifier.Node implements ApproachLayoutModifierNode {
    ...
    public boolean mo75isMeasurementApproachInProgressozmzZPI(long lookaheadSize) {
        return this.isMeasurementApproachInProgress.invoke(IntSize.m7668boximpl(lookaheadSize)).booleanValue();
    }
    ...
    public MeasureResult mo74approachMeasure3p2s80s(ApproachMeasureScope $this$approachMeasure_u2d3p2s80s, Measurable measurable, long j) {
        return this.measureBlock.invoke($this$approachMeasure_u2d3p2s80s, measurable, Constraints.m7445boximpl(j));
    }
}
