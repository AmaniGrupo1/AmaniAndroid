...
@Metadata(d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\b\n\u0002\b\u0005\n\u0002\u0010\u000b\n\u0002\b\u0003\n\u0002\u0010\u000e\n\u0002\b\u0002\b\u0083@\u0018\u0000 \u000e2\u00020\u0001:\u0001\u000eB\u000f\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0004\b\u0004\u0010\u0005J\u0013\u0010\b\u001a\u00020\t2\b\u0010\n\u001a\u0004\u0018\u00010\u0001HÖ\u0003J\t\u0010\u000b\u001a\u00020\u0003HÖ\u0001J\t\u0010\f\u001a\u00020\rHÖ\u0001R\u0011\u0010\u0002\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\u0006\u0010\u0007\u0088\u0001\u0002¨\u0006\u000f"}, d2 = {"Landroidx/compose/ui/layout/SLOperation;", "", Values.VECTOR_MAP_VECTORS_KEY, "", "constructor-impl", "(I)I", "getValue", "()I", "equals", "", "other", "hashCode", "toString", "", "Companion", "ui"}, k = 1, mv = {2, 0, 0}, xi = 48)
@JvmInline
final class SLOperation {
    ...
    private static final int CancelPausedPrecomposition = m6224constructorimpl(0);
    private static final int ReuseForceSyncDeactivation = m6224constructorimpl(1);
    private static final int ReuseScheduleOutOfFrameDeactivation = m6224constructorimpl(2);
    private static final int ReuseSyncDeactivation = m6224constructorimpl(3);
    private static final int ReuseDeactivationViaHost = m6224constructorimpl(4);
    private static final int TookFromPrecomposeMap = m6224constructorimpl(5);
    private static final int Subcompose = m6224constructorimpl(6);
    private static final int SubcomposeNew = m6224constructorimpl(7);
    private static final int SubcomposePausable = m6224constructorimpl(8);
    private static final int SubcomposeForceReuse = m6224constructorimpl(9);
    private static final int DeactivateOutOfFrame = m6224constructorimpl(10);
    private static final int DeactivateOutOfFrameCancelled = m6224constructorimpl(11);
    private static final int SlotToReusedFromOnDeactivate = m6224constructorimpl(12);
    private static final int SlotToReusedFromOnReuse = m6224constructorimpl(13);
    private static final int Reused = m6224constructorimpl(14);
    private static final int ResumePaused = m6224constructorimpl(15);
    private static final int PausePaused = m6224constructorimpl(16);
    private static final int ApplyPaused = m6224constructorimpl(17);

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ SLOperation m6223boximpl(int i) {
        return new SLOperation(i);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static int m6224constructorimpl(int i) {
        return i;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m6225equalsimpl(int i, Object obj) {
        return (obj instanceof SLOperation) && i == ((SLOperation) obj).m6229unboximpl();
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m6226equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
    public static int m6227hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m6228toStringimpl(int i) {
        return "SLOperation(value=" + i + ')';
    }

    public boolean equals(Object other) {
        return m6225equalsimpl(this.value, other);
    }

    public int hashCode() {
        return m6227hashCodeimpl(this.value);
    }

    public String toString() {
        return m6228toStringimpl(this.value);
    }

    /* JADX INFO: renamed from: unbox-impl, reason: not valid java name */
    public final /* synthetic */ int m6229unboximpl() {
        return this.value;
    }
    ...
    public static final class Companion {
        ...
        public final int m6231getCancelPausedPrecompositionNjRlDlw() {
        ...
        public final int m6237getReuseForceSyncDeactivationNjRlDlw() {
        ...
        public final int m6238getReuseScheduleOutOfFrameDeactivationNjRlDlw() {
        ...
        public final int m6239getReuseSyncDeactivationNjRlDlw() {
        ...
        public final int m6236getReuseDeactivationViaHostNjRlDlw() {
        ...
        public final int m6233getDeactivateOutOfFrameCancelledNjRlDlw() {
        ...
        public final int m6241getSlotToReusedFromOnDeactivateNjRlDlw() {
