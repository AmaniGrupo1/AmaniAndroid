...
public final class SemanticsPropertiesKt {
    ...
    public static final void m6717setLiveRegionhR3wRGc(SemanticsPropertyReceiver $this$liveRegion, int i) {
        SemanticsProperties.INSTANCE.getLiveRegion().setValue($this$liveRegion, $$delegatedProperties[3], LiveRegionMode.m6683boximpl(i));
    }
    ...
    public static final void m6718setRolekuIjeqM(SemanticsPropertyReceiver $this$role, int i) {
        SemanticsProperties.INSTANCE.getRole().setValue($this$role, $$delegatedProperties[14], Role.m6692boximpl(i));
    }
    ...
    public static final void m6719setTextSelectionRangeFDrldGo(SemanticsPropertyReceiver $this$textSelectionRange, long j) {
        SemanticsProperties.INSTANCE.getTextSelectionRange().setValue($this$textSelectionRange, $$delegatedProperties[20], TextRange.m6916boximpl(j));
    }

    @Deprecated(message = "Pass the ImeAction to onImeAction instead.")
    public static final int getImeAction(SemanticsPropertyReceiver $this$imeAction) {
        return SemanticsProperties.INSTANCE.getImeAction().getValue($this$imeAction, $$delegatedProperties[21]).getValue();
    }

    @Deprecated(message = "Pass the ImeAction to onImeAction instead.")
    /* JADX INFO: renamed from: setImeAction-4L7nppU, reason: not valid java name */
    public static final void m6716setImeAction4L7nppU(SemanticsPropertyReceiver $this$imeAction, int i) {
        SemanticsProperties.INSTANCE.getImeAction().setValue($this$imeAction, $$delegatedProperties[21], ImeAction.m7093boximpl(i));
    }

    public static final boolean getSelected(SemanticsPropertyReceiver $this$selected) {
        return SemanticsProperties.INSTANCE.getSelected().getValue($this$selected, $$delegatedProperties[22]).booleanValue();
    }

    public static final void setSelected(SemanticsPropertyReceiver $this$selected, boolean z) {
        SemanticsProperties.INSTANCE.getSelected().setValue($this$selected, $$delegatedProperties[22], Boolean.valueOf(z));
    }

    public static final CollectionInfo getCollectionInfo(SemanticsPropertyReceiver $this$collectionInfo) {
        return SemanticsProperties.INSTANCE.getCollectionInfo().getValue($this$collectionInfo, $$delegatedProperties[23]);
    }

    public static final void setCollectionInfo(SemanticsPropertyReceiver $this$collectionInfo, CollectionInfo collectionInfo) {
        SemanticsProperties.INSTANCE.getCollectionInfo().setValue($this$collectionInfo, $$delegatedProperties[23], collectionInfo);
    }

    public static final CollectionItemInfo getCollectionItemInfo(SemanticsPropertyReceiver $this$collectionItemInfo) {
        return SemanticsProperties.INSTANCE.getCollectionItemInfo().getValue($this$collectionItemInfo, $$delegatedProperties[24]);
    }
    ...
    public static final void setCollectionItemInfo(SemanticsPropertyReceiver $this$collectionItemInfo, CollectionItemInfo collectionItemInfo) {
        SemanticsProperties.INSTANCE.getCollectionItemInfo().setValue($this$collectionItemInfo, $$delegatedProperties[24], collectionItemInfo);
    }

    public static final ToggleableState getToggleableState(SemanticsPropertyReceiver $this$toggleableState) {
        return SemanticsProperties.INSTANCE.getToggleableState().getValue($this$toggleableState, $$delegatedProperties[25]);
    }
    ...
    public static final void setToggleableState(SemanticsPropertyReceiver $this$toggleableState, ToggleableState toggleableState) {
        SemanticsProperties.INSTANCE.getToggleableState().setValue($this$toggleableState, $$delegatedProperties[25], toggleableState);
    }

    public static final boolean isEditable(SemanticsPropertyReceiver $this$isEditable) {
        return SemanticsProperties.INSTANCE.getIsEditable().getValue($this$isEditable, $$delegatedProperties[26]).booleanValue();
    }

    public static final void setEditable(SemanticsPropertyReceiver $this$isEditable, boolean z) {
        SemanticsProperties.INSTANCE.getIsEditable().setValue($this$isEditable, $$delegatedProperties[26], Boolean.valueOf(z));
    }
    ...
    public static final int getMaxTextLength(SemanticsPropertyReceiver $this$maxTextLength) {
        return SemanticsProperties.INSTANCE.getMaxTextLength().getValue($this$maxTextLength, $$delegatedProperties[27]).intValue();
    }

    public static final void setMaxTextLength(SemanticsPropertyReceiver $this$maxTextLength, int i) {
        SemanticsProperties.INSTANCE.getMaxTextLength().setValue($this$maxTextLength, $$delegatedProperties[27], Integer.valueOf(i));
    }

    public static final Shape getShape(SemanticsPropertyReceiver $this$shape) {
        return SemanticsProperties.INSTANCE.getShape().getValue($this$shape, $$delegatedProperties[28]);
    }

    public static final void setShape(SemanticsPropertyReceiver $this$shape, Shape shape) {
        SemanticsProperties.INSTANCE.getShape().setValue($this$shape, $$delegatedProperties[28], shape);
    }
    ...
    public static final List<CustomAccessibilityAction> getCustomActions(SemanticsPropertyReceiver $this$customActions) {
        return SemanticsActions.INSTANCE.getCustomActions().getValue($this$customActions, $$delegatedProperties[29]);
    }
    ...
    public static final void setCustomActions(SemanticsPropertyReceiver $this$customActions, List<CustomAccessibilityAction> list) {
        SemanticsActions.INSTANCE.getCustomActions().setValue($this$customActions, $$delegatedProperties[29], list);
    }
    ...
    public static /* synthetic */ void m6715onImeAction9UiTYpY$default(SemanticsPropertyReceiver semanticsPropertyReceiver, int i, String str, Function0 function0, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            str = null;
        }
        m6714onImeAction9UiTYpY(semanticsPropertyReceiver, i, str, function0);
    }

    /* JADX INFO: renamed from: onImeAction-9UiTYpY, reason: not valid java name */
    public static final void m6714onImeAction9UiTYpY(SemanticsPropertyReceiver $this$onImeAction_u2d9UiTYpY, int i, String label, Function0<Boolean> function0) {
        $this$onImeAction_u2d9UiTYpY.set(SemanticsProperties.INSTANCE.getImeAction(), ImeAction.m7093boximpl(i));
