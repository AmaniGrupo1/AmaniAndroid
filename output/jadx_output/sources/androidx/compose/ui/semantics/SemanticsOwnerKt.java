...
public final class SemanticsOwnerKt {
    ...
    public static final IntObjectMap<SemanticsNodeWithAdjustedBounds> getAllUncoveredSemanticsNodesToIntObjectMap(SemanticsOwner $this$getAllUncoveredSemanticsNodesToIntObjectMap, int customRootNodeId, Function1<? super SemanticsNode, Boolean> function1) throws Throwable {
        ...
        try {
            ...
            try {
                ...
                getAllUncoveredSemanticsNodesToIntObjectMap$lambda$0$findAllSemanticNodesRecursive(unaccountedSpace, root, customRootNodeId, nodes, function1, root, SemanticsRegion_androidKt.SemanticsRegion());
    ...
    private static final void getAllUncoveredSemanticsNodesToIntObjectMap$lambda$0$findAllSemanticNodesRecursive(SemanticsRegion unaccountedSpace, SemanticsNode root, int $customRootNodeId, MutableIntObjectMap<SemanticsNodeWithAdjustedBounds> mutableIntObjectMap, Function1<? super SemanticsNode, Boolean> function1, SemanticsNode currentNode, SemanticsRegion region) {
        int id;
        ...
        if (!unaccountedSpace.isEmpty() || currentNode.getId() == root.getId()) {
            ...
            if (semanticsRegion.intersect(unaccountedSpace)) {
                ...
                while (-1 < i) {
                    if (!function1.invoke(replacedChildren$ui.get(i)).booleanValue()) {
                        getAllUncoveredSemanticsNodesToIntObjectMap$lambda$0$findAllSemanticNodesRecursive(unaccountedSpace, root, $customRootNodeId, mutableIntObjectMap2, function1, replacedChildren$ui.get(i), semanticsRegion);
                    }
                    i--;
            ...
            if (currentNode.getIsFake()) {
                ...
                mutableIntObjectMap2.set(virtualViewId, new SemanticsNodeWithAdjustedBounds(currentNode, IntRectKt.roundToIntRect(boundsForFakeNode)));
                return;
            }
