...
public final class SemanticsNode {
    ...
    public final long m6712getSizeYbymL2g() {
        NodeCoordinator nodeCoordinatorFindCoordinatorToGetBounds$ui = findCoordinatorToGetBounds$ui();
        return nodeCoordinatorFindCoordinatorToGetBounds$ui != null ? nodeCoordinatorFindCoordinatorToGetBounds$ui.mo6149getSizeYbymL2g() : IntSize.INSTANCE.m7681getZeroYbymL2g();
    }
    ...
    public final long m6709getPositionInRootF1C5BW0() {
        NodeCoordinator it = findCoordinatorToGetBounds$ui();
        if (it != null) {
            if (!it.isAttached()) {
                it = null;
    ...
    public final long m6710getPositionInWindowF1C5BW0() {
        NodeCoordinator it = findCoordinatorToGetBounds$ui();
        if (it != null) {
            if (!it.isAttached()) {
                it = null;
    ...
    public final long m6711getPositionOnScreenF1C5BW0() {
        NodeCoordinator it = findCoordinatorToGetBounds$ui();
        if (it != null) {
            if (!it.isAttached()) {
                it = null;
    ...
    private final Rect boundsInImportantForBoundsAncestor(LayoutCoordinates nodeCoordinates) {
        ...
        NodeCoordinator parentCoordinatorForBounds = semanticsModifierNode != null ? DelegatableNodeKt.m6312requireCoordinator64DMado(semanticsModifierNode, NodeKind.m6460constructorimpl(i)) : null;
    ...
    private final void fillOneLayerOfSemanticsWrappers(LayoutNode $this$fillOneLayerOfSemanticsWrappers, List<SemanticsNode> list, boolean includeDeactivatedNodes) {
        ...
        for (int i$iv = 0; i$iv < size$iv; i$iv++) {
            ...
            if (child.isAttached() && (includeDeactivatedNodes || !child.getIsDeactivated())) {
                if (child.getNodes().m6421hasH91voCI$ui(NodeKind.m6460constructorimpl(8))) {
    ...
    public final SemanticsNode getParent() {
        ...
        if (node == null) {
            ...
            while (true) {
                ...
                if (it2.getNodes().m6421hasH91voCI$ui(NodeKind.m6460constructorimpl(8))) {
                    break;
                }
    ...
    public final NodeCoordinator findCoordinatorToGetBounds$ui() {
        NodeCoordinator nodeCoordinatorM6312requireCoordinator64DMado;
        if (this.isFake) {
            SemanticsNode parent = getParent();
            if (parent != null) {
        ...
        if (semanticsModifierNodeFindSemanticsModifierNodeToGetBounds != null && (nodeCoordinatorM6312requireCoordinator64DMado = DelegatableNodeKt.m6312requireCoordinator64DMado(semanticsModifierNodeFindSemanticsModifierNodeToGetBounds, NodeKind.m6460constructorimpl(8))) != null) {
            return nodeCoordinatorM6312requireCoordinator64DMado;
        }
    ...
    private final SemanticsModifierNode findSemanticsModifierNodeToGetBounds() {
        ...
        if (isMergingSemanticsOfDescendants) {
            ...
            int iM6460constructorimpl = NodeKind.m6460constructorimpl(8);
            if ((this_$iv5.getAggregateChildKindSet() & iM6460constructorimpl) != 0) {
            ...
            int iM6460constructorimpl2 = NodeKind.m6460constructorimpl(8);
            if ((this_$iv6.getAggregateChildKindSet() & iM6460constructorimpl2) != 0) {
                Modifier.Node node$iv$iv$iv$iv = this_$iv6.getHead();
                loop3: while (node$iv$iv$iv$iv != null) {
                    Modifier.Node it$iv$iv$iv = node$iv$iv$iv$iv;
                    if ((it$iv$iv$iv.getKindSet() & iM6460constructorimpl2) != 0) {
                        ...
                        while (nodePop2 != null) {
                            ...
                            if (nodePop2 instanceof SemanticsModifierNode) {
                                ...
                                if (((this_$iv$iv$iv$iv.getKindSet() & iM6460constructorimpl2) != 0 ? 1 : 0) == 0 || !(nodePop2 instanceof DelegatingNode)) {
                                    i2 = iM6460constructorimpl2;
                                } else {
                                    ...
                                    while (node$iv$iv$iv$iv2 != null) {
                                        Modifier.Node next$iv$iv$iv = node$iv$iv$iv$iv2;
                                        if (((next$iv$iv$iv.getKindSet() & iM6460constructorimpl2) != 0 ? 1 : 0) != 0) {
                                            count$iv$iv$iv2++;
                    ...
                    if ((it$iv$iv$iv.getAggregateChildKindSet() & iM6460constructorimpl2) == 0) {
                        break;
                    }
                    node$iv$iv$iv$iv = node$iv$iv$iv$iv.getChild();
                    this_$iv6 = this_$iv;
    ...
    private final void emitFakeNodes(List<SemanticsNode> unmergedChildren) {
        ...
        if (nodeRole != null && this.unmergedConfig.getIsMergingSemanticsOfDescendants() && !unmergedChildren.isEmpty()) {
            SemanticsNode fakeNode = m6708fakeSemanticsNodeypyhhiA(nodeRole, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.ui.semantics.SemanticsNode$emitFakeNodes$fakeNode$1
                {
                    super(1);
                }
                ...
                public final void invoke2(SemanticsPropertyReceiver $this$fakeSemanticsNode) {
                    SemanticsPropertiesKt.m6718setRolekuIjeqM($this$fakeSemanticsNode, nodeRole.getValue());
                }
            });
        ...
        if (this.unmergedConfig.contains(SemanticsProperties.INSTANCE.getContentDescription()) && !unmergedChildren.isEmpty() && this.unmergedConfig.getIsMergingSemanticsOfDescendants()) {
            ...
            if (contentDescription != null) {
                SemanticsNode fakeNode2 = m6708fakeSemanticsNodeypyhhiA(null, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.ui.semantics.SemanticsNode$emitFakeNodes$fakeNode$2
    ...
    private final SemanticsNode m6708fakeSemanticsNodeypyhhiA(Role role, Function1<? super SemanticsPropertyReceiver, Unit> properties) {
