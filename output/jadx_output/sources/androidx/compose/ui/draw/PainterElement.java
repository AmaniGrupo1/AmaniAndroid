...
final /* data */ class PainterElement extends ModifierNodeElement<PainterModifier> {
    ...
    public void update(PainterModifier node) {
        boolean intrinsicsChanged = node.getSizeToIntrinsics() != this.sizeToIntrinsics || (this.sizeToIntrinsics && !Size.m4517equalsimpl0(node.getPainter().mo5391getIntrinsicSizeNHjbRc(), this.painter.mo5391getIntrinsicSizeNHjbRc()));
