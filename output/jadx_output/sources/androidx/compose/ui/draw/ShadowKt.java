...
public final class ShadowKt {
    ...
    public static /* synthetic */ Modifier m4297shadowziNgDLE$default(Modifier modifier, float f, Shape shape, boolean z, int i, Object obj) {
        if ((i & 2) != 0) {
        ...
        return m4296shadowziNgDLE(modifier, f, shape, z);
    }
    ...
    public static final /* synthetic */ Modifier m4296shadowziNgDLE(Modifier $this$shadow_u2dziNgDLE, float f, Shape shape, boolean clip) {
        return m4294shadows4CzXII($this$shadow_u2dziNgDLE, f, shape, clip, GraphicsLayerScopeKt.getDefaultShadowColor(), GraphicsLayerScopeKt.getDefaultShadowColor());
    }

    /* JADX INFO: renamed from: shadow-s4CzXII$default, reason: not valid java name */
    public static /* synthetic */ Modifier m4295shadows4CzXII$default(Modifier modifier, float f, Shape shape, boolean z, long j, long j2, int i, Object obj) {
        boolean z2;
        ...
        return m4294shadows4CzXII(modifier, f, rectangleShape, z2, (i & 8) != 0 ? GraphicsLayerScopeKt.getDefaultShadowColor() : j, (i & 16) != 0 ? GraphicsLayerScopeKt.getDefaultShadowColor() : j2);
    }

    /* JADX INFO: renamed from: shadow-s4CzXII, reason: not valid java name */
    public static final Modifier m4294shadows4CzXII(Modifier $this$shadow_u2ds4CzXII, float f, Shape shape, boolean clip, long j, long j2) {
        int $this$dp$iv = Dp.m7504compareTo0680j_4(f, Dp.m7505constructorimpl(0));
        if ($this$dp$iv > 0 || clip) {
            return $this$shadow_u2ds4CzXII.then(new ShadowGraphicsLayerElement(f, shape, clip, j, j2, null));
        }
    ...
    public static final void resetShadow(ShadowScope $this$resetShadow) {
        ...
        $this$resetShadow.mo4216setOffsetk4lQ0M(Offset.INSTANCE.m4468getZeroF1C5BW0());
        $this$resetShadow.mo4215setColor8_81llA(Color.INSTANCE.m4723getBlack0d7_KjU());
        $this$resetShadow.setBrush(null);
        $this$resetShadow.setAlpha(1.0f);
        $this$resetShadow.mo4214setBlendModes9anfk8(BlendMode.INSTANCE.m4637getSrcOver0nO6VwU());
    }
}
