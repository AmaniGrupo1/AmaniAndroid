...
public final /* data */ class ShadowGraphicsLayerElement extends ModifierNodeElement<BlockGraphicsLayerModifier> {
    ...
    public static /* synthetic */ ShadowGraphicsLayerElement m4286copygNMxBKI$default(ShadowGraphicsLayerElement shadowGraphicsLayerElement, float f, Shape shape, boolean z, long j, long j2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        long j3 = j2;
        boolean z2 = z;
        return shadowGraphicsLayerElement.m4290copygNMxBKI(f, shape, z2, j, j3);
    }
    ...
    public final ShadowGraphicsLayerElement m4290copygNMxBKI(float elevation, Shape shape, boolean clip, long ambientColor, long spotColor) {
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m7510equalsimpl0(this.elevation, shadowGraphicsLayerElement.elevation) && Intrinsics.areEqual(this.shape, shadowGraphicsLayerElement.shape) && this.clip == shadowGraphicsLayerElement.clip && Color.m4698equalsimpl0(this.ambientColor, shadowGraphicsLayerElement.ambientColor) && Color.m4698equalsimpl0(this.spotColor, shadowGraphicsLayerElement.spotColor);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (((((((Dp.m7511hashCodeimpl(this.elevation) * 31) + this.shape.hashCode()) * 31) + Boolean.hashCode(this.clip)) * 31) + Color.m4704hashCodeimpl(this.ambientColor)) * 31) + Color.m4704hashCodeimpl(this.spotColor);
    }

    public String toString() {
        return "ShadowGraphicsLayerElement(elevation=" + ((Object) Dp.m7516toStringimpl(this.elevation)) + ", shape=" + this.shape + ", clip=" + this.clip + ", ambientColor=" + ((Object) Color.m4705toStringimpl(this.ambientColor)) + ", spotColor=" + ((Object) Color.m4705toStringimpl(this.spotColor)) + ')';
    }
    ...
    public final float m4292getElevationD9Ej5fM() {
        return this.elevation;
    }
    ...
    public final long m4291getAmbientColor0d7_KjU() {
        return this.ambientColor;
    }

    /* JADX INFO: renamed from: getSpotColor-0d7_KjU, reason: not valid java name */
    public final long m4293getSpotColor0d7_KjU() {
        return this.spotColor;
    }
    ...
    private final Function1<GraphicsLayerScope, Unit> createBlock() {
        return new Function1<GraphicsLayerScope, Unit>() { // from class: androidx.compose.ui.draw.ShadowGraphicsLayerElement.createBlock.1
            ...
            public final void invoke2(GraphicsLayerScope graphicsLayerScope) {
                graphicsLayerScope.setShadowElevation(graphicsLayerScope.mo405toPx0680j_4(ShadowGraphicsLayerElement.this.m4292getElevationD9Ej5fM()));
                ...
                graphicsLayerScope.mo4894setAmbientShadowColor8_81llA(ShadowGraphicsLayerElement.this.m4291getAmbientColor0d7_KjU());
                graphicsLayerScope.mo4897setSpotShadowColor8_81llA(ShadowGraphicsLayerElement.this.m4293getSpotColor0d7_KjU());
            }
        };
    }
    ...
    public void inspectableProperties(InspectorInfo $this$inspectableProperties) {
        ...
        $this$inspectableProperties.getProperties().set("elevation", Dp.m7503boximpl(this.elevation));
        ...
        $this$inspectableProperties.getProperties().set("ambientColor", Color.m4687boximpl(this.ambientColor));
        $this$inspectableProperties.getProperties().set("spotColor", Color.m4687boximpl(this.spotColor));
    }
}
