...
public final class Offset {
    ...
    private static final long Zero = m4444constructorimpl(0);
    private static final long Infinite = m4444constructorimpl(InlineClassHelperKt.DualFloatInfinityBase);
    private static final long Unspecified = m4444constructorimpl(InlineClassHelperKt.UnspecifiedPackedFloats);

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ Offset m4441boximpl(long j) {
        return new Offset(j);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static long m4444constructorimpl(long j) {
        return j;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m4448equalsimpl(long j, Object obj) {
        return (obj instanceof Offset) && j == ((Offset) obj).m4462unboximpl();
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m4449equalsimpl0(long j, long j2) {
        return j == j2;
    }
    ...
    public boolean equals(Object other) {
        return m4448equalsimpl(this.packedValue, other);
    }
    ...
    public final /* synthetic */ long m4462unboximpl() {
    ...
    public static /* synthetic */ long m4446copydBAh8RU$default(long value$iv, float f, float f2, int i, Object obj) {
        ...
        return m4445copydBAh8RU(value$iv, f, f2);
    }

    /* JADX INFO: renamed from: copy-dBAh8RU, reason: not valid java name */
    public static final long m4445copydBAh8RU(long j, float x, float y) {
        long v1$iv = Float.floatToRawIntBits(x);
        long v2$iv = Float.floatToRawIntBits(y);
        return m4444constructorimpl((v1$iv << 32) | (4294967295L & v2$iv));
    }
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ void m4463getInfiniteF1C5BW0$annotations() {
        }

        /* JADX INFO: renamed from: getUnspecified-F1C5BW0$annotations, reason: not valid java name */
        public static /* synthetic */ void m4464getUnspecifiedF1C5BW0$annotations() {
        }

        /* JADX INFO: renamed from: getZero-F1C5BW0$annotations, reason: not valid java name */
        public static /* synthetic */ void m4465getZeroF1C5BW0$annotations() {
        }
    ...
    public static final float m4450getDistanceimpl(long j) {
        int bits$iv$iv = (int) (j >> 32);
    ...
    public static final float m4451getDistanceSquaredimpl(long j) {
        int bits$iv$iv = (int) (j >> 32);
        float x = Float.intBitsToFloat(bits$iv$iv);
        int bits$iv$iv2 = (int) (4294967295L & j);
        float y = Float.intBitsToFloat(bits$iv$iv2);
    ...
    public static final long m4461unaryMinusF1C5BW0(long j) {
        return m4444constructorimpl((-9223372034707292160L) ^ j);
    }

    /* JADX INFO: renamed from: minus-MK-Hz9U, reason: not valid java name */
    public static final long m4456minusMKHz9U(long j, long j2) {
        int bits$iv$iv = (int) (j >> 32);
    ...
    public static final long m4457plusMKHz9U(long j, long j2) {
        int bits$iv$iv = (int) (j >> 32);
        int bits$iv$iv2 = (int) (j2 >> 32);
        float val1$iv = Float.intBitsToFloat(bits$iv$iv) + Float.intBitsToFloat(bits$iv$iv2);
        int bits$iv$iv3 = (int) (j & 4294967295L);
    ...
    public static final long m4459timestuRUvjQ(long j, float operand) {
        int bits$iv$iv = (int) (j >> 32);
    ...
    public static final long m4447divtuRUvjQ(long j, float operand) {
        int bits$iv$iv = (int) (j >> 32);
        float val1$iv = Float.intBitsToFloat(bits$iv$iv) / operand;
        int bits$iv$iv2 = (int) (j & 4294967295L);
        float val2$iv = Float.intBitsToFloat(bits$iv$iv2) / operand;
    ...
    public static final long m4458remtuRUvjQ(long j, float operand) {
        int bits$iv$iv = (int) (j >> 32);
        float val1$iv = Float.intBitsToFloat(bits$iv$iv) % operand;
        int bits$iv$iv2 = (int) (j & 4294967295L);
        float val2$iv = Float.intBitsToFloat(bits$iv$iv2) % operand;
    ...
    public String toString() {
        return m4460toStringimpl(this.packedValue);
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m4460toStringimpl(long j) {
