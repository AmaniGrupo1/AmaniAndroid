...
final /* data */ class GraphicsLayerElement extends ModifierNodeElement<SimpleGraphicsLayerModifier> {
    ...
    public static /* synthetic */ GraphicsLayerElement m4845copycp5nf6A$default(GraphicsLayerElement graphicsLayerElement, float f, float f2, float f3, float f4, float f5, float f6, float f7, float f8, float f9, float f10, long j, Shape shape, boolean z, RenderEffect renderEffect, long j2, long j3, int i, int i2, ColorFilter colorFilter, int i3, Object obj) {
        ...
        return graphicsLayerElement.m4851copycp5nf6A(f21, f12, f13, f14, f15, f16, f17, f18, f19, f20, j4, shape2, z2, renderEffect2, j5, j6, i4, i6, colorFilter2);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Float.compare(this.scaleX, graphicsLayerElement.scaleX) == 0 && Float.compare(this.scaleY, graphicsLayerElement.scaleY) == 0 && Float.compare(this.alpha, graphicsLayerElement.alpha) == 0 && Float.compare(this.translationX, graphicsLayerElement.translationX) == 0 && Float.compare(this.translationY, graphicsLayerElement.translationY) == 0 && Float.compare(this.shadowElevation, graphicsLayerElement.shadowElevation) == 0 && Float.compare(this.rotationX, graphicsLayerElement.rotationX) == 0 && Float.compare(this.rotationY, graphicsLayerElement.rotationY) == 0 && Float.compare(this.rotationZ, graphicsLayerElement.rotationZ) == 0 && Float.compare(this.cameraDistance, graphicsLayerElement.cameraDistance) == 0 && TransformOrigin.m5104equalsimpl0(this.transformOrigin, graphicsLayerElement.transformOrigin) && Intrinsics.areEqual(this.shape, graphicsLayerElement.shape) && this.clip == graphicsLayerElement.clip && Intrinsics.areEqual(this.renderEffect, graphicsLayerElement.renderEffect) && Color.m4698equalsimpl0(this.ambientShadowColor, graphicsLayerElement.ambientShadowColor) && Color.m4698equalsimpl0(this.spotShadowColor, graphicsLayerElement.spotShadowColor) && CompositingStrategy.m4782equalsimpl0(this.compositingStrategy, graphicsLayerElement.compositingStrategy) && BlendMode.m4606equalsimpl0(this.blendMode, graphicsLayerElement.blendMode) && Intrinsics.areEqual(this.colorFilter, graphicsLayerElement.colorFilter);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (((((((((((((((((((((((((((((((((((Float.hashCode(this.scaleX) * 31) + Float.hashCode(this.scaleY)) * 31) + Float.hashCode(this.alpha)) * 31) + Float.hashCode(this.translationX)) * 31) + Float.hashCode(this.translationY)) * 31) + Float.hashCode(this.shadowElevation)) * 31) + Float.hashCode(this.rotationX)) * 31) + Float.hashCode(this.rotationY)) * 31) + Float.hashCode(this.rotationZ)) * 31) + Float.hashCode(this.cameraDistance)) * 31) + TransformOrigin.m5107hashCodeimpl(this.transformOrigin)) * 31) + this.shape.hashCode()) * 31) + Boolean.hashCode(this.clip)) * 31) + (this.renderEffect == null ? 0 : this.renderEffect.hashCode())) * 31) + Color.m4704hashCodeimpl(this.ambientShadowColor)) * 31) + Color.m4704hashCodeimpl(this.spotShadowColor)) * 31) + CompositingStrategy.m4783hashCodeimpl(this.compositingStrategy)) * 31) + BlendMode.m4607hashCodeimpl(this.blendMode)) * 31) + (this.colorFilter != null ? this.colorFilter.hashCode() : 0);
    }

    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("GraphicsLayerElement(scaleX=").append(this.scaleX).append(", scaleY=").append(this.scaleY).append(", alpha=").append(this.alpha).append(", translationX=").append(this.translationX).append(", translationY=").append(this.translationY).append(", shadowElevation=").append(this.shadowElevation).append(", rotationX=").append(this.rotationX).append(", rotationY=").append(this.rotationY).append(", rotationZ=").append(this.rotationZ).append(", cameraDistance=").append(this.cameraDistance).append(", transformOrigin=").append((Object) TransformOrigin.m5108toStringimpl(this.transformOrigin)).append(", shape=");
        sb.append(this.shape).append(", clip=").append(this.clip).append(", renderEffect=").append(this.renderEffect).append(", ambientShadowColor=").append((Object) Color.m4705toStringimpl(this.ambientShadowColor)).append(", spotShadowColor=").append((Object) Color.m4705toStringimpl(this.spotShadowColor)).append(", compositingStrategy=").append((Object) CompositingStrategy.m4784toStringimpl(this.compositingStrategy)).append(", blendMode=").append((Object) BlendMode.m4608toStringimpl(this.blendMode)).append(", colorFilter=").append(this.colorFilter).append(')');
        return sb.toString();
    }
    ...
    public final long m4856getTransformOriginSzJe1aQ() {
        return this.transformOrigin;
    }
    ...
    public void update(SimpleGraphicsLayerModifier node) {
        ...
        node.m5052setTransformOrigin__ExYCQ(this.transformOrigin);
        node.setShape(this.shape);
        node.setClip(this.clip);
        node.setRenderEffect(this.renderEffect);
        node.m5048setAmbientShadowColor8_81llA(this.ambientShadowColor);
        node.m5051setSpotShadowColor8_81llA(this.spotShadowColor);
        node.m5050setCompositingStrategyaDBOjCE(this.compositingStrategy);
        node.m5049setBlendModes9anfk8(this.blendMode);
    ...
    public void inspectableProperties(InspectorInfo $this$inspectableProperties) {
        ...
        $this$inspectableProperties.getProperties().set("transformOrigin", TransformOrigin.m5097boximpl(this.transformOrigin));
        ...
        $this$inspectableProperties.getProperties().set("ambientShadowColor", Color.m4687boximpl(this.ambientShadowColor));
        $this$inspectableProperties.getProperties().set("spotShadowColor", Color.m4687boximpl(this.spotShadowColor));
        $this$inspectableProperties.getProperties().set("compositingStrategy", CompositingStrategy.m4779boximpl(this.compositingStrategy));
        $this$inspectableProperties.getProperties().set("blendMode", BlendMode.m4603boximpl(this.blendMode));
