...
public final class AndroidColorFilter_androidKt {
    ...
    public static final android.graphics.ColorFilter m4559actualTintColorFilterxETnrds(long j, int i) {
        if (Build.VERSION.SDK_INT >= 29) {
            android.graphics.ColorFilter androidColorFilter = BlendModeColorFilterHelper.INSTANCE.m4641BlendModeColorFilterxETnrds(j, i);
            return androidColorFilter;
        }
        android.graphics.ColorFilter androidColorFilter2 = new PorterDuffColorFilter(ColorKt.m4751toArgb8_81llA(j), AndroidBlendMode_androidKt.m4545toPorterDuffModes9anfk8(i));
        return androidColorFilter2;
    }

    /* JADX INFO: renamed from: actualColorMatrixColorFilter-jHG-Opc, reason: not valid java name */
    public static final android.graphics.ColorFilter m4557actualColorMatrixColorFilterjHGOpc(float[] fArr) {
    ...
    public static final android.graphics.ColorFilter m4558actualLightingColorFilterOWjLjI(long j, long j2) {
        return new android.graphics.LightingColorFilter(ColorKt.m4751toArgb8_81llA(j), ColorKt.m4751toArgb8_81llA(j2));
    }
    ...
    public static final float[] actualColorMatrixFromFilter(android.graphics.ColorFilter filter) {
        if ((filter instanceof android.graphics.ColorMatrixColorFilter) && supportsColorMatrixQuery()) {
            return ColorMatrixFilterHelper.INSTANCE.m4776getColorMatrix8unuwjk((android.graphics.ColorMatrixColorFilter) filter);
        }
