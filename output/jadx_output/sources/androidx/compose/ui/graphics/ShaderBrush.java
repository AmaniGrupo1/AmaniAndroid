...
public abstract class ShaderBrush extends Brush {
    ...
    public abstract Shader mo4666createShaderuvyYCjk(long size);

    public ShaderBrush() {
        super(null);
        this.createdSize = Size.INSTANCE.m4529getUnspecifiedNHjbRc();
    }
    ...
    public final void m5027setTransformQ8lPUPs(float[] value) {
        this.transform = value;
        TransformShader transformShader = this.internalTransformShader;
        if (transformShader != null) {
            transformShader.m5111transformQ8lPUPs(value);
        }
    }
    ...
    public final void mo4642applyToPq9zytI(long size, Paint p, float alpha) {
        TransformShader transformShader = this.internalTransformShader;
        if (transformShader == null || !Size.m4517equalsimpl0(this.createdSize, size)) {
            if (Size.m4523isEmptyimpl(size)) {
                ...
                if (this.transform != null) {
                    $this$applyTo_Pq9zytI_u24lambda_u240.m5111transformQ8lPUPs(this.transform);
                }
                $this$applyTo_Pq9zytI_u24lambda_u240.setShader(mo4666createShaderuvyYCjk(size));
                transformShader = $this$applyTo_Pq9zytI_u24lambda_u240;
                this.internalTransformShader = transformShader;
                this.createdSize = size;
            }
        }
        if (!Color.m4698equalsimpl0(p.mo4567getColor0d7_KjU(), Color.INSTANCE.m4723getBlack0d7_KjU())) {
            p.mo4573setColor8_81llA(Color.INSTANCE.m4723getBlack0d7_KjU());
        }
