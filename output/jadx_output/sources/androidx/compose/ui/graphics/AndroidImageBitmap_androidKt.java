...
public final class AndroidImageBitmap_androidKt {
    ...
    public static final ImageBitmap m4562ActualImageBitmapx__hDU(int width, int height, int i, boolean hasAlpha, ColorSpace colorSpace) {
        Bitmap bitmap;
        Bitmap.Config bitmapConfig = m4563toBitmapConfig1JJdX4A(i);
        if (Build.VERSION.SDK_INT < 26) {
            bitmap = Bitmap.createBitmap((DisplayMetrics) null, width, height, bitmapConfig);
            bitmap.setHasAlpha(hasAlpha);
        } else {
            bitmap = Bitmap.createBitmap((DisplayMetrics) null, width, height, m4563toBitmapConfig1JJdX4A(i), hasAlpha, AndroidColorSpace_androidKt.toAndroidColorSpace(colorSpace));
        }
    ...
    public static final Bitmap.Config m4563toBitmapConfig1JJdX4A(int i) {
        if (ImageBitmapConfig.m4923equalsimpl0(i, ImageBitmapConfig.INSTANCE.m4928getArgb8888_sVssgQ())) {
            return Bitmap.Config.ARGB_8888;
        }
        if (ImageBitmapConfig.m4923equalsimpl0(i, ImageBitmapConfig.INSTANCE.m4927getAlpha8_sVssgQ())) {
            return Bitmap.Config.ALPHA_8;
        }
        if (ImageBitmapConfig.m4923equalsimpl0(i, ImageBitmapConfig.INSTANCE.m4931getRgb565_sVssgQ())) {
            return Bitmap.Config.RGB_565;
        }
        if (Build.VERSION.SDK_INT >= 26 && ImageBitmapConfig.m4923equalsimpl0(i, ImageBitmapConfig.INSTANCE.m4929getF16_sVssgQ())) {
            return Bitmap.Config.RGBA_F16;
        }
        if (Build.VERSION.SDK_INT >= 26 && ImageBitmapConfig.m4923equalsimpl0(i, ImageBitmapConfig.INSTANCE.m4930getGpu_sVssgQ())) {
    ...
    public static final int toImageConfig(Bitmap.Config $this$toImageConfig) {
        if ($this$toImageConfig == Bitmap.Config.ALPHA_8) {
            return ImageBitmapConfig.INSTANCE.m4927getAlpha8_sVssgQ();
        }
        if ($this$toImageConfig == Bitmap.Config.RGB_565) {
            return ImageBitmapConfig.INSTANCE.m4931getRgb565_sVssgQ();
        }
        if ($this$toImageConfig == Bitmap.Config.ARGB_4444) {
            return ImageBitmapConfig.INSTANCE.m4928getArgb8888_sVssgQ();
        }
        if (Build.VERSION.SDK_INT >= 26 && $this$toImageConfig == Bitmap.Config.RGBA_F16) {
            return ImageBitmapConfig.INSTANCE.m4929getF16_sVssgQ();
        }
        if (Build.VERSION.SDK_INT >= 26 && $this$toImageConfig == Bitmap.Config.HARDWARE) {
            return ImageBitmapConfig.INSTANCE.m4930getGpu_sVssgQ();
        }
        return ImageBitmapConfig.INSTANCE.m4928getArgb8888_sVssgQ();
    }
}
