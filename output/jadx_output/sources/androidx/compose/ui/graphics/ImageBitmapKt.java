...
public final class ImageBitmapKt {
    ...
    public static /* synthetic */ ImageBitmap m4933ImageBitmapx__hDU$default(int i, int i2, int i3, boolean z, ColorSpace colorSpace, int i4, Object obj) {
        if ((i4 & 4) != 0) {
            i3 = ImageBitmapConfig.INSTANCE.m4928getArgb8888_sVssgQ();
        }
        if ((i4 & 8) != 0) {
            z = true;
        }
        ...
        return m4932ImageBitmapx__hDU(i, i2, i3, z, colorSpace);
    }

    /* JADX INFO: renamed from: ImageBitmap-x__-hDU, reason: not valid java name */
    public static final ImageBitmap m4932ImageBitmapx__hDU(int width, int height, int i, boolean hasAlpha, ColorSpace colorSpace) {
        return AndroidImageBitmap_androidKt.m4562ActualImageBitmapx__hDU(width, height, i, hasAlpha, colorSpace);
    }
