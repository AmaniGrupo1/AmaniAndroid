...
public final class AndroidPaint implements Paint {
    ...
    public AndroidPaint(android.graphics.Paint internalPaint) {
        ...
        this._blendMode = BlendMode.INSTANCE.m4637getSrcOver0nO6VwU();
    }
    ...
    public long mo4567getColor0d7_KjU() {
    ...
    public void mo4573setColor8_81llA(long j) {
        AndroidPaint_androidKt.m4579setNativeColor4WTKRHQ(this.internalPaint, j);
    }
    ...
    public void mo4572setBlendModes9anfk8(int i) {
        if (!BlendMode.m4606equalsimpl0(this._blendMode, i)) {
            this._blendMode = i;
            AndroidPaint_androidKt.m4578setNativeBlendModeGB0RdKg(this.internalPaint, i);
        }
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* JADX INFO: renamed from: getStyle-TiuSbCo, reason: not valid java name */
    public int mo4571getStyleTiuSbCo() {
    ...
    public void mo4577setStylek9PVt8s(int i) {
        AndroidPaint_androidKt.m4583setNativeStyle5YerkU(this.internalPaint, i);
    }
    ...
    public int mo4569getStrokeCapKaPHkGw() {
    ...
    public void mo4575setStrokeCapBeK7IIE(int i) {
        AndroidPaint_androidKt.m4581setNativeStrokeCapCSYIeUk(this.internalPaint, i);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* JADX INFO: renamed from: getStrokeJoin-LxFBmk8, reason: not valid java name */
    public int mo4570getStrokeJoinLxFBmk8() {
    ...
    public void mo4576setStrokeJoinWw9F2mQ(int i) {
        AndroidPaint_androidKt.m4582setNativeStrokeJoinkLtJ_vA(this.internalPaint, i);
    }
    ...
    public int mo4568getFilterQualityfv9h1I() {
    ...
    public void mo4574setFilterQualityvDHp3xo(int i) {
        AndroidPaint_androidKt.m4580setNativeFilterQuality50PEsBU(this.internalPaint, i);
    }
