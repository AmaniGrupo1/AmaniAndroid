...
public final class PathHitTester {
    ...
    public final boolean m4995containsk4lQ0M(long position) {
        boolean z;
        int i;
        boolean isInverse = false;
        if (!this.path.isEmpty() && this.bounds.m4478containsk4lQ0M(position)) {
            ...
            boolean isEvenOdd = PathFillType.m4989equalsimpl0(this.path.mo4585getFillTypeRgk1Os(), PathFillType.INSTANCE.m4993getEvenOddRgk1Os());
            if (isEvenOdd) {
                winding &= 1;
            }
            if (winding != 0) {
