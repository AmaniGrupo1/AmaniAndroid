...
public abstract class Brush {
    ...
    public abstract void mo4642applyToPq9zytI(long size, Paint p, float alpha);

    private Brush() {
        this.intrinsicSize = Size.INSTANCE.m4529getUnspecifiedNHjbRc();
    }
    ...
    public static final class Companion {
        ...
        public final Brush m4658linearGradientmHitzGk(Pair<Float, Color>[] colorStops, long start, long end, int tileMode) {
            int length = colorStops.length;
            ArrayList arrayList = new ArrayList(length);
            for (int i = 0; i < length; i++) {
                int i2 = i;
                arrayList.add(Color.m4687boximpl(colorStops[i2].getSecond().m4707unboximpl()));
            }
        ...
        /* JADX INFO: renamed from: linearGradient-mHitzGk, reason: not valid java name */
        public final Brush m4657linearGradientmHitzGk(List<Color> colors, long start, long end, int tileMode) {
        ...
        public static /* synthetic */ Brush m4644horizontalGradient8A3gB4$default(Companion companion, List list, float f, float f2, int i, int i2, Object obj) {
            if ((i2 & 2) != 0) {
                f = 0.0f;
            }
            if ((i2 & 4) != 0) {
            ...
            if ((i2 & 8) != 0) {
                i = TileMode.INSTANCE.m5092getClamp3opZhB0();
            }
            return companion.m4655horizontalGradient8A3gB4((List<Color>) list, f, f2, i);
        }

        /* JADX INFO: renamed from: horizontalGradient-8A-3gB4, reason: not valid java name */
        public final Brush m4655horizontalGradient8A3gB4(List<Color> colors, float startX, float endX, int tileMode) {
            ...
            return m4657linearGradientmHitzGk(colors, jM4444constructorimpl, Offset.m4444constructorimpl((v1$iv$iv2 << 32) | (v2$iv$iv2 & 4294967295L)), tileMode);
        }

        /* JADX INFO: renamed from: horizontalGradient-8A-3gB4$default, reason: not valid java name */
        public static /* synthetic */ Brush m4645horizontalGradient8A3gB4$default(Companion companion, Pair[] pairArr, float f, float f2, int i, int i2, Object obj) {
            if ((i2 & 2) != 0) {
                f = 0.0f;
            }
            if ((i2 & 4) != 0) {
            ...
            return companion.m4656horizontalGradient8A3gB4((Pair<Float, Color>[]) pairArr, f, f2, i);
        }

        /* JADX INFO: renamed from: horizontalGradient-8A-3gB4, reason: not valid java name */
        public final Brush m4656horizontalGradient8A3gB4(Pair<Float, Color>[] colorStops, float startX, float endX, int tileMode) {
            ...
            long v1$iv$iv2 = Float.floatToRawIntBits(endX);
            long v2$iv$iv2 = Float.floatToRawIntBits(0.0f);
            return m4658linearGradientmHitzGk(pairArr, jM4444constructorimpl, Offset.m4444constructorimpl((v1$iv$iv2 << 32) | (4294967295L & v2$iv$iv2)), tileMode);
        }

        /* JADX INFO: renamed from: verticalGradient-8A-3gB4$default, reason: not valid java name */
        public static /* synthetic */ Brush m4652verticalGradient8A3gB4$default(Companion companion, List list, float f, float f2, int i, int i2, Object obj) {
            if ((i2 & 2) != 0) {
                f = 0.0f;
            }
            if ((i2 & 4) != 0) {
            ...
            return companion.m4663verticalGradient8A3gB4((List<Color>) list, f, f2, i);
        }

        /* JADX INFO: renamed from: verticalGradient-8A-3gB4, reason: not valid java name */
        public final Brush m4663verticalGradient8A3gB4(List<Color> colors, float startY, float endY, int tileMode) {
        ...
        /* JADX INFO: renamed from: verticalGradient-8A-3gB4$default, reason: not valid java name */
        public static /* synthetic */ Brush m4653verticalGradient8A3gB4$default(Companion companion, Pair[] pairArr, float f, float f2, int i, int i2, Object obj) {
            if ((i2 & 2) != 0) {
                f = 0.0f;
            }
            if ((i2 & 4) != 0) {
            ...
            return companion.m4664verticalGradient8A3gB4((Pair<Float, Color>[]) pairArr, f, f2, i);
        }

        /* JADX INFO: renamed from: verticalGradient-8A-3gB4, reason: not valid java name */
        public final Brush m4664verticalGradient8A3gB4(Pair<Float, Color>[] colorStops, float startY, float endY, int tileMode) {
            Pair<Float, Color>[] pairArr = (Pair[]) Arrays.copyOf(colorStops, colorStops.length);
            long v1$iv$iv = Float.floatToRawIntBits(0.0f);
            long v2$iv$iv = Float.floatToRawIntBits(startY);
            long jM4444constructorimpl = Offset.m4444constructorimpl((v1$iv$iv << 32) | (v2$iv$iv & 4294967295L));
        ...
        public final Brush m4660radialGradientP_VxKs(Pair<Float, Color>[] colorStops, long center, float radius, int tileMode) {
            int length = colorStops.length;
            ArrayList arrayList = new ArrayList(length);
            for (int i = 0; i < length; i++) {
                int i2 = i;
        ...
        /* JADX INFO: renamed from: radialGradient-P_Vx-Ks, reason: not valid java name */
        public final Brush m4659radialGradientP_VxKs(List<Color> colors, long center, float radius, int tileMode) {
        ...
        public static /* synthetic */ Brush m4651sweepGradientUv8p0NA$default(Companion companion, Pair[] pairArr, long j, int i, Object obj) {
            if ((i & 2) != 0) {
                j = Offset.INSTANCE.m4467getUnspecifiedF1C5BW0();
            }
            return companion.m4662sweepGradientUv8p0NA((Pair<Float, Color>[]) pairArr, j);
        }

        /* JADX INFO: renamed from: sweepGradient-Uv8p0NA, reason: not valid java name */
        public final Brush m4662sweepGradientUv8p0NA(Pair<Float, Color>[] colorStops, long center) {
            int length = colorStops.length;
            ArrayList arrayList = new ArrayList(length);
            for (int i = 0; i < length; i++) {
                int i2 = i;
        ...
        /* JADX INFO: renamed from: sweepGradient-Uv8p0NA$default, reason: not valid java name */
        public static /* synthetic */ Brush m4650sweepGradientUv8p0NA$default(Companion companion, List list, long j, int i, Object obj) {
            if ((i & 2) != 0) {
                j = Offset.INSTANCE.m4467getUnspecifiedF1C5BW0();
            }
            return companion.m4661sweepGradientUv8p0NA((List<Color>) list, j);
        }

        /* JADX INFO: renamed from: sweepGradient-Uv8p0NA, reason: not valid java name */
        public final Brush m4661sweepGradientUv8p0NA(List<Color> colors, long center) {
            return new SweepGradient(center, colors, null, null);
        }

        /* JADX INFO: renamed from: composite-7EN7VTw, reason: not valid java name */
        public final Brush m4654composite7EN7VTw(Brush dstBrush, Brush srcBrush, int blendMode) {
