...
public abstract class Painter {
    ...
    public abstract long mo5391getIntrinsicSizeNHjbRc();
    ...
    public static /* synthetic */ void m5396drawx_KDEd0$default(Painter painter, DrawScope drawScope, long j, float f, ColorFilter colorFilter, int i, Object obj) throws Throwable {
        if (obj != null) {
        ...
        painter.m5397drawx_KDEd0(drawScope, j, f2, colorFilter);
    }

    /* JADX INFO: renamed from: draw-x_KDEd0, reason: not valid java name */
    public final void m5397drawx_KDEd0(DrawScope $this$draw_u2dx_KDEd0, long j, float alpha, ColorFilter colorFilter) throws Throwable {
        float right$iv;
        configureAlpha(alpha);
        configureColorFilter(colorFilter);
        configureLayoutDirection($this$draw_u2dx_KDEd0.getLayoutDirection());
        int bits$iv$iv$iv = (int) ($this$draw_u2dx_KDEd0.mo5271getSizeNHjbRc() >> 32);
        int bits$iv$iv$iv2 = (int) (j >> 32);
        float right$iv2 = Float.intBitsToFloat(bits$iv$iv$iv) - Float.intBitsToFloat(bits$iv$iv$iv2);
        int bits$iv$iv$iv3 = (int) ($this$draw_u2dx_KDEd0.mo5271getSizeNHjbRc() & 4294967295L);
                ...
                if (Float.intBitsToFloat(bits$iv$iv$iv5) > 0.0f) {
                    ...
                    try {
                        if (Float.intBitsToFloat(bits$iv$iv$iv6) <= 0.0f) {
                            ...
                            Rect layerRect = RectKt.m4492Recttz77jQw(jM4468getZeroF1C5BW0, Size.m4512constructorimpl(v2$iv$iv));
