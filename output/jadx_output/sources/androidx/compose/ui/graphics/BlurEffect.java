...
public final class BlurEffect extends RenderEffect {
    ...
    public /* synthetic */ BlurEffect(RenderEffect renderEffect, float f, float f2, int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        ...
        this(renderEffect, f, f3, iM5092getClamp3opZhB0, null);
    }

    @Override // androidx.compose.ui.graphics.RenderEffect
    /* JADX INFO: renamed from: createRenderEffect */
    protected android.graphics.RenderEffect getAndroidRenderEffect() {
        return RenderEffectVerificationHelper.INSTANCE.m5023createBlurEffect8A3gB4(this.renderEffect, this.radiusX, this.radiusY, this.edgeTreatment);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (this.radiusX == ((BlurEffect) other).radiusX) {
            return ((this.radiusY > ((BlurEffect) other).radiusY ? 1 : (this.radiusY == ((BlurEffect) other).radiusY ? 0 : -1)) == 0) && TileMode.m5088equalsimpl0(this.edgeTreatment, ((BlurEffect) other).edgeTreatment) && Intrinsics.areEqual(this.renderEffect, ((BlurEffect) other).renderEffect);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (((((result * 31) + Float.hashCode(this.radiusX)) * 31) + Float.hashCode(this.radiusY)) * 31) + TileMode.m5089hashCodeimpl(this.edgeTreatment);
    }

    public String toString() {
        return "BlurEffect(renderEffect=" + this.renderEffect + ", radiusX=" + this.radiusX + ", radiusY=" + this.radiusY + ", edgeTreatment=" + ((Object) TileMode.m5090toStringimpl(this.edgeTreatment)) + ')';
    }
}
