...
public final class CompositeShaderBrush extends ShaderBrush {
    ...
    public Shader mo4666createShaderuvyYCjk(long size) {
        return ShaderKt.m5028CompositeShader7EN7VTw(this.dstBrush.mo4666createShaderuvyYCjk(size), this.srcBrush.mo4666createShaderuvyYCjk(size), this.blendMode);
    }
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof CompositeShaderBrush) && Intrinsics.areEqual(this.dstBrush, ((CompositeShaderBrush) other).dstBrush) && Intrinsics.areEqual(this.srcBrush, ((CompositeShaderBrush) other).srcBrush) && BlendMode.m4606equalsimpl0(this.blendMode, ((CompositeShaderBrush) other).blendMode);
    }

    public int hashCode() {
        int result = this.dstBrush.hashCode();
        return (((result * 31) + this.srcBrush.hashCode()) * 31) + BlendMode.m4607hashCodeimpl(this.blendMode);
    }

    public String toString() {
        return "CompositeShaderBrush(dstBrush=" + this.dstBrush + ", srcBrush=" + this.srcBrush + ", blendMode=" + ((Object) BlendMode.m4608toStringimpl(this.blendMode)) + ')';
    }
}
