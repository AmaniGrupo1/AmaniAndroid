...
public final class AndroidCanvas implements Canvas {
    ...
    public void mo4548concat58bKbWc(float[] matrix) {
        if (!MatrixKt.m4966isIdentity58bKbWc(matrix)) {
            android.graphics.Matrix frameworkMatrix = new android.graphics.Matrix();
            AndroidMatrixConversions_androidKt.m4564setFromEL8BTi8(frameworkMatrix, matrix);
    ...
    public void mo4547clipRectN_I0leg(float left, float top, float right, float bottom, int clipOp) {
        this.internalCanvas.clipRect(left, top, right, bottom, m4556toRegionOp7u2Bmg(clipOp));
    }

    @Override // androidx.compose.ui.graphics.Canvas
    /* JADX INFO: renamed from: clipPath-mtrdD-E, reason: not valid java name */
    public void mo4546clipPathmtrdDE(Path path, int clipOp) {
        android.graphics.Canvas canvas = this.internalCanvas;
        if (path instanceof AndroidPath) {
            canvas.clipPath(((AndroidPath) path).getInternalPath(), m4556toRegionOp7u2Bmg(clipOp));
            return;
        }
    ...
    public final Region.Op m4556toRegionOp7u2Bmg(int i) {
        return ClipOp.m4681equalsimpl0(i, ClipOp.INSTANCE.m4685getDifferencertfAjoo()) ? Region.Op.DIFFERENCE : Region.Op.INTERSECT;
    }

    @Override // androidx.compose.ui.graphics.Canvas
    /* JADX INFO: renamed from: drawLine-Wko1d7g, reason: not valid java name */
    public void mo4552drawLineWko1d7g(long p1, long p2, Paint paint) {
        ...
        this.internalCanvas.drawLine(Float.intBitsToFloat(bits$iv$iv$iv), Float.intBitsToFloat(bits$iv$iv$iv2), Float.intBitsToFloat(bits$iv$iv$iv3), Float.intBitsToFloat(bits$iv$iv$iv4), paint.getInternalPaint());
    }
    ...
    public void mo4549drawCircle9KIMszo(long center, float radius, Paint paint) {
        int bits$iv$iv$iv = (int) (center >> 32);
        int bits$iv$iv$iv2 = (int) (4294967295L & center);
        this.internalCanvas.drawCircle(Float.intBitsToFloat(bits$iv$iv$iv), Float.intBitsToFloat(bits$iv$iv$iv2), radius, paint.getInternalPaint());
    }
    ...
    public void mo4550drawImaged4ec7I(ImageBitmap image, long topLeftOffset, Paint paint) {
        int bits$iv$iv$iv = (int) (topLeftOffset >> 32);
        int bits$iv$iv$iv2 = (int) (4294967295L & topLeftOffset);
        this.internalCanvas.drawBitmap(AndroidImageBitmap_androidKt.asAndroidBitmap(image), Float.intBitsToFloat(bits$iv$iv$iv), Float.intBitsToFloat(bits$iv$iv$iv2), paint.getInternalPaint());
    }

    @Override // androidx.compose.ui.graphics.Canvas
    /* JADX INFO: renamed from: drawImageRect-HPBpro0, reason: not valid java name */
    public void mo4551drawImageRectHPBpro0(ImageBitmap image, long srcOffset, long srcSize, long dstOffset, long dstSize, Paint paint) {
        ...
        $this$drawImageRect_HPBpro0_u24lambda_u240.left = IntOffset.m7633getXimpl(srcOffset);
        $this$drawImageRect_HPBpro0_u24lambda_u240.top = IntOffset.m7634getYimpl(srcOffset);
        $this$drawImageRect_HPBpro0_u24lambda_u240.right = IntOffset.m7633getXimpl(srcOffset) + ((int) (srcSize >> 32));
        $this$drawImageRect_HPBpro0_u24lambda_u240.bottom = IntOffset.m7634getYimpl(srcOffset) + ((int) (srcSize & 4294967295L));
        ...
        $this$drawImageRect_HPBpro0_u24lambda_u241.left = IntOffset.m7633getXimpl(dstOffset);
        $this$drawImageRect_HPBpro0_u24lambda_u241.top = IntOffset.m7634getYimpl(dstOffset);
        $this$drawImageRect_HPBpro0_u24lambda_u241.right = IntOffset.m7633getXimpl(dstOffset) + ((int) (dstSize >> 32));
        $this$drawImageRect_HPBpro0_u24lambda_u241.bottom = IntOffset.m7634getYimpl(dstOffset) + ((int) (dstSize & 4294967295L));
    ...
    public void mo4553drawPointsO7TthRY(int pointMode, List<Offset> points, Paint paint) {
        if (!PointMode.m5012equalsimpl0(pointMode, PointMode.INSTANCE.m5016getLinesr_lszbg())) {
            if (!PointMode.m5012equalsimpl0(pointMode, PointMode.INSTANCE.m5018getPolygonr_lszbg())) {
                if (PointMode.m5012equalsimpl0(pointMode, PointMode.INSTANCE.m5017getPointsr_lszbg())) {
    ...
    private final void drawPoints(List<Offset> points, Paint paint) {
        ...
        while (index$iv < size) {
            ...
            long point = ((Offset) item$iv).m4462unboximpl();
            ...
            this.internalCanvas.drawPoint(Float.intBitsToFloat(bits$iv$iv$iv), Float.intBitsToFloat(bits$iv$iv$iv2), paint.getInternalPaint());
            index$iv++;
            list = list2;
    ...
    private final void drawLines(List<Offset> points, Paint paint, int stepBy) {
        ...
        if (list.size() >= 2) {
            ...
            int i = 0;
            while (i < list.size() - 1) {
                long p1 = list.get(i).m4462unboximpl();
                long p2 = list.get(i + 1).m4462unboximpl();
                android.graphics.Canvas canvas = this.internalCanvas;
                int bits$iv$iv$iv = (int) (p1 >> 32);
    ...
    public void mo4554drawRawPointsO7TthRY(int pointMode, float[] points, Paint paint) {
    ...
    public void mo4555drawVerticesTPEHhCM(Vertices vertices, int blendMode, Paint paint) {
        this.internalCanvas.drawVertices(AndroidVertexMode_androidKt.m4601toAndroidVertexModeJOOmi9M(vertices.getVertexMode()), vertices.getPositions().length, vertices.getPositions(), 0, vertices.getTextureCoordinates(), 0, vertices.getColors(), 0, vertices.getIndices(), 0, vertices.getIndices().length, paint.getInternalPaint());
    }
}
