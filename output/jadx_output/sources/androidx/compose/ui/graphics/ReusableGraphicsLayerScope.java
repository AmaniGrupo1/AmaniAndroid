...
public final class ReusableGraphicsLayerScope implements GraphicsLayerScope {
    ...
    private int compositingStrategy = CompositingStrategy.INSTANCE.m4786getAutoNrFUSI();
    private long size = Size.INSTANCE.m4529getUnspecifiedNHjbRc();
    ...
    public void mo4894setAmbientShadowColor8_81llA(long j) {
        if (!Color.m4698equalsimpl0(this.ambientShadowColor, j)) {
    ...
    public void mo4897setSpotShadowColor8_81llA(long j) {
        if (!Color.m4698equalsimpl0(this.spotShadowColor, j)) {
    ...
    public void mo4898setTransformOrigin__ExYCQ(long j) {
        if (!TransformOrigin.m5104equalsimpl0(this.transformOrigin, j)) {
    ...
    public void mo4896setCompositingStrategyaDBOjCE(int i) {
        if (!CompositingStrategy.m4782equalsimpl0(this.compositingStrategy, i)) {
    ...
    public void m5025setSizeuvyYCjk(long j) {
        this.size = j;
    }
    ...
    public void mo4895setBlendModes9anfk8(int i) {
    ...
    public final void reset() {
        ...
        mo4894setAmbientShadowColor8_81llA(GraphicsLayerScopeKt.getDefaultShadowColor());
        mo4897setSpotShadowColor8_81llA(GraphicsLayerScopeKt.getDefaultShadowColor());
        setRotationX(0.0f);
        setRotationY(0.0f);
        setRotationZ(0.0f);
        setCameraDistance(8.0f);
        mo4898setTransformOrigin__ExYCQ(TransformOrigin.INSTANCE.m5110getCenterSzJe1aQ());
        setShape(RectangleShapeKt.getRectangleShape());
        setClip(false);
        setRenderEffect(null);
        setColorFilter(null);
        mo4895setBlendModes9anfk8(BlendMode.INSTANCE.m4637getSrcOver0nO6VwU());
        mo4896setCompositingStrategyaDBOjCE(CompositingStrategy.INSTANCE.m4786getAutoNrFUSI());
        m5025setSizeuvyYCjk(Size.INSTANCE.m4529getUnspecifiedNHjbRc());
        this.outline = null;
        this.mutatedFields = 0;
    }

    public final void updateOutline$ui() {
        this.outline = getShape().mo320createOutlinePq9zytI(getSize(), this.layoutDirection, this.graphicsDensity);
    }
}
