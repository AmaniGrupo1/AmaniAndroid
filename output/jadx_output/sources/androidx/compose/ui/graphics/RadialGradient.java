...
public final class RadialGradient extends ShaderBrush implements Interpolatable {
    ...
    public /* synthetic */ RadialGradient(List list, List list2, long j, float f, int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        ...
        this(list, list3, j, f, iM5092getClamp3opZhB0, null);
    }
    ...
    public Shader mo4666createShaderuvyYCjk(long size) {
        ...
        float centerY;
        if ((9223372034707292159L & this.center) == androidx.compose.ui.geometry.InlineClassHelperKt.UnspecifiedPackedFloats) {
            long drawCenter = SizeKt.m4531getCenteruvyYCjk(size);
            ...
            f = Float.POSITIVE_INFINITY;
            j = 4294967295L;
            int bits$iv$iv$iv3 = (int) (this.center >> 32);
            if (Float.intBitsToFloat(bits$iv$iv$iv3) == Float.POSITIVE_INFINITY) {
                ...
                int bits$iv$iv$iv5 = (int) (this.center >> 32);
                fIntBitsToFloat = Float.intBitsToFloat(bits$iv$iv$iv5);
            }
            centerX = fIntBitsToFloat;
            int bits$iv$iv$iv6 = (int) (this.center & 4294967295L);
            if (Float.intBitsToFloat(bits$iv$iv$iv6) == Float.POSITIVE_INFINITY) {
                ...
                int bits$iv$iv$iv8 = (int) (this.center & 4294967295L);
        ...
        return ShaderKt.m5033RadialGradientShader8uybcMk(Offset.m4444constructorimpl((v1$iv$iv << 32) | (v2$iv$iv & j)), (this.radius > f ? 1 : (this.radius == f ? 0 : -1)) == 0 ? Size.m4520getMinDimensionimpl(size) / 2 : this.radius, list, list2, this.tileMode);
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RadialGradient) && Intrinsics.areEqual(this.colors, ((RadialGradient) other).colors) && Intrinsics.areEqual(this.stops, ((RadialGradient) other).stops) && Offset.m4449equalsimpl0(this.center, ((RadialGradient) other).center)) {
            return ((this.radius > ((RadialGradient) other).radius ? 1 : (this.radius == ((RadialGradient) other).radius ? 0 : -1)) == 0) && TileMode.m5088equalsimpl0(this.tileMode, ((RadialGradient) other).tileMode);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (((((result2 * 31) + Offset.m4454hashCodeimpl(this.center)) * 31) + Float.hashCode(this.radius)) * 31) + TileMode.m5089hashCodeimpl(this.tileMode);
    }

    public String toString() {
        String centerValue = ((9223372034707292159L & this.center) > androidx.compose.ui.geometry.InlineClassHelperKt.UnspecifiedPackedFloats ? 1 : ((9223372034707292159L & this.center) == androidx.compose.ui.geometry.InlineClassHelperKt.UnspecifiedPackedFloats ? 0 : -1)) != 0 ? "center=" + ((Object) Offset.m4460toStringimpl(this.center)) + ", " : "";
        float $this$fastIsFinite$iv = this.radius;
        String radiusValue = (Float.floatToRawIntBits($this$fastIsFinite$iv) & Integer.MAX_VALUE) < 2139095040 ? "radius=" + this.radius + ", " : "";
        return "RadialGradient(colors=" + this.colors + ", stops=" + this.stops + ", " + centerValue + radiusValue + "tileMode=" + ((Object) TileMode.m5090toStringimpl(this.tileMode)) + ')';
    }
    ...
    public Object lerp(Object other, float t) {
        ...
        return new RadialGradient(BrushKt.lerpColorList(this.colors, ((RadialGradient) other2).colors, t), BrushKt.lerpNullableFloatList(this.stops, ((RadialGradient) other2).stops, t), OffsetKt.m4475lerpWko1d7g(this.center, ((RadialGradient) other2).center, t), MathHelpersKt.lerp(this.radius, ((RadialGradient) other2).radius, t), t < 0.5f ? this.tileMode : ((RadialGradient) other2).tileMode, null);
    }
}
