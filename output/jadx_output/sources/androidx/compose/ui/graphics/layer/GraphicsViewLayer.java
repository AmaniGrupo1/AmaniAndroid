...
public final class GraphicsViewLayer implements GraphicsLayerImpl {
    ...
    public GraphicsViewLayer(DrawChildContainer layerContainer, long ownerId, CanvasHolder canvasHolder, CanvasDrawScope canvasDrawScope) {
        ...
        this.blendMode = BlendMode.INSTANCE.m4637getSrcOver0nO6VwU();
        this.compositingStrategy = CompositingStrategy.INSTANCE.m5351getAutoke2Ky5w();
        this.alpha = 1.0f;
        this.pivotOffset = Offset.INSTANCE.m4468getZeroF1C5BW0();
        this.scaleX = 1.0f;
        this.scaleY = 1.0f;
        this.ambientShadowColor = Color.INSTANCE.m4723getBlack0d7_KjU();
        this.spotShadowColor = Color.INSTANCE.m4723getBlack0d7_KjU();
    ...
    public void mo5380setBlendModes9anfk8(int i) {
        this.blendMode = i;
        Paint $this$setBlendMode_s9anfk8_u24lambda_u240 = obtainLayerPaint();
        $this$setBlendMode_s9anfk8_u24lambda_u240.setXfermode(new PorterDuffXfermode(AndroidBlendMode_androidKt.m4545toPorterDuffModes9anfk8(i)));
    ...
    public void mo5381setCompositingStrategyWpw9cng(int i) {
        this.compositingStrategy = i;
        updateLayerProperties();
    }

    /* JADX INFO: renamed from: applyCompositingLayer-Wpw9cng, reason: not valid java name */
    private final void m5388applyCompositingLayerWpw9cng(int compositingStrategy) {
        ViewLayer viewLayer = this.viewLayer;
        boolean z = true;
        if (CompositingStrategy.m5347equalsimpl0(compositingStrategy, CompositingStrategy.INSTANCE.m5353getOffscreenke2Ky5w())) {
            this.viewLayer.setLayerType(2, this.layerPaint);
        } else {
            boolean zM5347equalsimpl0 = CompositingStrategy.m5347equalsimpl0(compositingStrategy, CompositingStrategy.INSTANCE.m5352getModulateAlphake2Ky5w());
            ViewLayer viewLayer2 = this.viewLayer;
            if (zM5347equalsimpl0) {
    ...
    private final void updateLayerProperties() {
        if (requiresCompositingLayer()) {
            m5388applyCompositingLayerWpw9cng(CompositingStrategy.INSTANCE.m5353getOffscreenke2Ky5w());
        } else {
            m5388applyCompositingLayerWpw9cng(getCompositingStrategy());
        }
    }
    ...
    private final boolean requiresCompositingLayer() {
        return CompositingStrategy.m5347equalsimpl0(getCompositingStrategy(), CompositingStrategy.INSTANCE.m5353getOffscreenke2Ky5w()) || requiresLayerPaint();
    }

    private final boolean requiresLayerPaint() {
        return (BlendMode.m4606equalsimpl0(getBlendMode(), BlendMode.INSTANCE.m4637getSrcOver0nO6VwU()) && getColorFilter() == null) ? false : true;
    }
    ...
    public void mo5383setPivotOffsetk4lQ0M(long j) {
        this.pivotOffset = j;
    ...
    public void mo5379setAmbientShadowColor8_81llA(long j) {
        if (Build.VERSION.SDK_INT >= 28) {
            this.ambientShadowColor = j;
            ViewLayerVerificationHelper28.INSTANCE.setOutlineAmbientShadowColor(this.viewLayer, ColorKt.m4751toArgb8_81llA(j));
        }
    }
    ...
    public void mo5385setSpotShadowColor8_81llA(long j) {
        if (Build.VERSION.SDK_INT >= 28) {
            this.spotShadowColor = j;
            ViewLayerVerificationHelper28.INSTANCE.setOutlineSpotShadowColor(this.viewLayer, ColorKt.m4751toArgb8_81llA(j));
        }
    }
    ...
    public void mo5384setPositionH0pRuoY(int x, int y, long size) {
        if (!IntSize.m7674equalsimpl0(this.size, size)) {
            if (getClip()) {
                this.clipBoundsInvalidated = true;
            }
    ...
    public void mo5382setOutlineO0kMr_c(Outline outline, long outlineSize) {
    ...
    public void record(Density density, LayoutDirection layoutDirection, GraphicsLayer layer, Function1<? super DrawScope, Unit> block) throws Throwable {
        ...
        Canvas pictureCanvas = p2.beginRecording((int) (this.size >> 32), (int) (4294967295L & this.size));
        try {
                ...
                if (drawScope != null) {
                    ...
                    try {
                        try {
                            ...
                            drawContext.mo5193setSizeuvyYCjk(prevSize$iv);
                            p = p2;
                            ...
                            drawContext2.mo5193setSizeuvyYCjk(prevSize$iv);
