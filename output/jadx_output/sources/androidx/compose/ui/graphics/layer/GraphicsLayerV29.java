...
public final class GraphicsLayerV29 implements GraphicsLayerImpl {
    ...
    public GraphicsLayerV29(long ownerId, CanvasHolder canvasHolder, CanvasDrawScope canvasDrawScope) {
        ...
        this.size = Size.INSTANCE.m4530getZeroNHjbRc();
        this.renderNode.setClipToBounds(false);
        m5387applyCompositingStrategyZ1X6vPc(this.renderNode, CompositingStrategy.INSTANCE.m5351getAutoke2Ky5w());
        this.alpha = 1.0f;
    ...
    public void mo5380setBlendModes9anfk8(int i) {
        ...
        $this$setBlendMode_s9anfk8_u24lambda_u240.setBlendMode(AndroidBlendMode_androidKt.m4544toAndroidBlendModes9anfk8(i));
    ...
    public void mo5379setAmbientShadowColor8_81llA(long j) {
        ...
        this.renderNode.setAmbientShadowColor(ColorKt.m4751toArgb8_81llA(j));
    }
    ...
    public void mo5385setSpotShadowColor8_81llA(long j) {
        ...
        this.renderNode.setSpotShadowColor(ColorKt.m4751toArgb8_81llA(j));
    }
    ...
    private final void m5387applyCompositingStrategyZ1X6vPc(RenderNode $this$applyCompositingStrategy_u2dZ1X6vPc, int i) {
        if (CompositingStrategy.m5347equalsimpl0(i, CompositingStrategy.INSTANCE.m5353getOffscreenke2Ky5w())) {
        ...
        boolean zM5347equalsimpl0 = CompositingStrategy.m5347equalsimpl0(i, CompositingStrategy.INSTANCE.m5352getModulateAlphake2Ky5w());
    ...
    private final void updateLayerProperties() {
        ...
        if (zRequiresCompositingLayer) {
            m5387applyCompositingStrategyZ1X6vPc(renderNode, CompositingStrategy.INSTANCE.m5353getOffscreenke2Ky5w());
        } else {
            m5387applyCompositingStrategyZ1X6vPc(renderNode, getCompositingStrategy());
        }
    }
    ...
    public void mo5384setPositionH0pRuoY(int x, int y, long size) {
        ...
        this.size = IntSizeKt.m7688toSizeozmzZPI(size);
    }
    ...
    public void record(Density density, LayoutDirection layoutDirection, GraphicsLayer layer, Function1<? super DrawScope, Unit> block) {
        ...
        try {
            ...
            it.mo5193setSizeuvyYCjk(this.size);
    ...
    private final boolean requiresCompositingLayer() {
        return CompositingStrategy.m5347equalsimpl0(getCompositingStrategy(), CompositingStrategy.INSTANCE.m5353getOffscreenke2Ky5w()) || requiresLayerPaint() || getRenderEffect() != null;
    }
