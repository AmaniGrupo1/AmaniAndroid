...
public final class GraphicsLayerV23 implements GraphicsLayerImpl {
    ...
    public GraphicsLayerV23(View ownerView, long ownerId, CanvasHolder canvasHolder, CanvasDrawScope canvasDrawScope) {
        ...
        this.outlineSize = IntSize.INSTANCE.m7681getZeroYbymL2g();
        ...
        this.renderNode.setClipToBounds(false);
        m5386applyCompositingStrategyWpw9cng(CompositingStrategy.INSTANCE.m5351getAutoke2Ky5w());
    ...
    private final void m5386applyCompositingStrategyWpw9cng(int compositingStrategy) {
        ...
        } else if (CompositingStrategy.m5347equalsimpl0(compositingStrategy, CompositingStrategy.INSTANCE.m5352getModulateAlphake2Ky5w())) {
    ...
    private final boolean requiresCompositingLayer() {
        return (!CompositingStrategy.m5347equalsimpl0(getCompositingStrategy(), CompositingStrategy.INSTANCE.m5353getOffscreenke2Ky5w()) && BlendMode.m4606equalsimpl0(getBlendMode(), BlendMode.INSTANCE.m4637getSrcOver0nO6VwU()) && getColorFilter() == null) ? false : true;
    }

    private final void updateLayerProperties() {
        if (requiresCompositingLayer()) {
            m5386applyCompositingStrategyWpw9cng(CompositingStrategy.INSTANCE.m5353getOffscreenke2Ky5w());
        } else {
            m5386applyCompositingStrategyWpw9cng(getCompositingStrategy());
        }
    }
    ...
    public void mo5379setAmbientShadowColor8_81llA(long j) {
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            RenderNodeVerificationHelper28.INSTANCE.setAmbientShadowColor(this.renderNode, ColorKt.m4751toArgb8_81llA(j));
        }
    }
    ...
    public void mo5385setSpotShadowColor8_81llA(long j) {
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            RenderNodeVerificationHelper28.INSTANCE.setSpotShadowColor(this.renderNode, ColorKt.m4751toArgb8_81llA(j));
        }
    }
    ...
    public void record(Density density, LayoutDirection layoutDirection, GraphicsLayer layer, Function1<? super DrawScope, Unit> block) {
        Canvas canvasStart = this.renderNode.start(Math.max((int) (this.size >> 32), (int) (this.outlineSize >> 32)), Math.max((int) (this.size & 4294967295L), (int) (4294967295L & this.outlineSize)));
        try {
