...
public final class AndroidPath implements Path {
    ...
    public int mo4585getFillTypeRgk1Os() {
        if (this.internalPath.getFillType() == Path.FillType.EVEN_ODD) {
            return PathFillType.INSTANCE.m4993getEvenOddRgk1Os();
        }
        return PathFillType.INSTANCE.m4994getNonZeroRgk1Os();
    }

    @Override // androidx.compose.ui.graphics.Path
    /* JADX INFO: renamed from: setFillType-oQ8Xj4U, reason: not valid java name */
    public void mo4587setFillTypeoQ8Xj4U(int i) {
        Path.FillType fillType;
        android.graphics.Path path = this.internalPath;
        if (PathFillType.m4989equalsimpl0(i, PathFillType.INSTANCE.m4993getEvenOddRgk1Os())) {
    ...
    public void addRoundRect(RoundRect roundRect, Path.Direction direction) {
        ...
        int bits$iv$iv$iv2 = (int) (roundRect.m4502getTopLeftCornerRadiuskKHJgLs() & 4294967295L);
        $this$addRoundRect_u24lambda_u240[1] = Float.intBitsToFloat(bits$iv$iv$iv2);
        int bits$iv$iv$iv3 = (int) (roundRect.m4503getTopRightCornerRadiuskKHJgLs() >> 32);
        $this$addRoundRect_u24lambda_u240[2] = Float.intBitsToFloat(bits$iv$iv$iv3);
        int bits$iv$iv$iv4 = (int) (roundRect.m4503getTopRightCornerRadiuskKHJgLs() & 4294967295L);
        $this$addRoundRect_u24lambda_u240[3] = Float.intBitsToFloat(bits$iv$iv$iv4);
        int bits$iv$iv$iv5 = (int) (roundRect.m4501getBottomRightCornerRadiuskKHJgLs() >> 32);
        $this$addRoundRect_u24lambda_u240[4] = Float.intBitsToFloat(bits$iv$iv$iv5);
        int bits$iv$iv$iv6 = (int) (roundRect.m4501getBottomRightCornerRadiuskKHJgLs() & 4294967295L);
        $this$addRoundRect_u24lambda_u240[5] = Float.intBitsToFloat(bits$iv$iv$iv6);
        int bits$iv$iv$iv7 = (int) (roundRect.m4500getBottomLeftCornerRadiuskKHJgLs() >> 32);
        $this$addRoundRect_u24lambda_u240[6] = Float.intBitsToFloat(bits$iv$iv$iv7);
        int bits$iv$iv$iv8 = (int) (roundRect.m4500getBottomLeftCornerRadiuskKHJgLs() & 4294967295L);
    ...
    public void mo4584addPathUv8p0NA(Path path, long offset) {
    ...
    public void mo4589translatek4lQ0M(long offset) {
    ...
    public void mo4588transform58bKbWc(float[] matrix) {
        if (this.mMatrix == null) {
            this.mMatrix = new android.graphics.Matrix();
        }
        android.graphics.Matrix matrix2 = this.mMatrix;
        Intrinsics.checkNotNull(matrix2);
        AndroidMatrixConversions_androidKt.m4564setFromEL8BTi8(matrix2, matrix);
        android.graphics.Path path = this.internalPath;
        android.graphics.Matrix matrix3 = this.mMatrix;
        Intrinsics.checkNotNull(matrix3);
        path.transform(matrix3);
    ...
    public boolean mo4586opN5in7k0(Path path1, Path path2, int operation) {
        Path.Op op;
        if (PathOperation.m4999equalsimpl0(operation, PathOperation.INSTANCE.m5003getDifferenceb3I0S0c())) {
            op = Path.Op.DIFFERENCE;
        } else if (PathOperation.m4999equalsimpl0(operation, PathOperation.INSTANCE.m5004getIntersectb3I0S0c())) {
            op = Path.Op.INTERSECT;
        } else if (PathOperation.m4999equalsimpl0(operation, PathOperation.INSTANCE.m5005getReverseDifferenceb3I0S0c())) {
            op = Path.Op.REVERSE_DIFFERENCE;
        } else {
            op = PathOperation.m4999equalsimpl0(operation, PathOperation.INSTANCE.m5006getUnionb3I0S0c()) ? Path.Op.UNION : Path.Op.XOR;
        }
        android.graphics.Path path = this.internalPath;
