...
public final class Float16Kt {
    ...
    public static final short m4844minAoSsdG0(short s, short s2) {
        if (Float16.m4816isNaNimpl(s) || Float16.m4816isNaNimpl(s2)) {
            return Float16.Companion.m4838getNaNslo4al4();
        }
        return Float16.m4803compareTo41bOqos(s, s2) <= 0 ? s : s2;
    }

    /* JADX INFO: renamed from: max-AoSsdG0, reason: not valid java name */
    public static final short m4843maxAoSsdG0(short s, short s2) {
        if (Float16.m4816isNaNimpl(s) || Float16.m4816isNaNimpl(s2)) {
            return Float16.Companion.m4838getNaNslo4al4();
        }
        return Float16.m4803compareTo41bOqos(s, s2) >= 0 ? s : s2;
