...
public final class SweepGradient extends ShaderBrush implements Interpolatable {
    ...
    public Shader mo4666createShaderuvyYCjk(long size) {
        float x$iv;
        float y$iv;
        long jM4444constructorimpl;
        if ((9223372034707292159L & this.center) == androidx.compose.ui.geometry.InlineClassHelperKt.UnspecifiedPackedFloats) {
            jM4444constructorimpl = SizeKt.m4531getCenteruvyYCjk(size);
        } else {
            int bits$iv$iv$iv = (int) (this.center >> 32);
            ...
            int bits$iv$iv$iv4 = (int) (this.center & 4294967295L);
            ...
            jM4444constructorimpl = Offset.m4444constructorimpl((v1$iv$iv << 32) | (4294967295L & v2$iv$iv));
        }
        return ShaderKt.m5035SweepGradientShader9KIMszo(jM4444constructorimpl, this.colors, this.stops);
    }
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof SweepGradient) && Offset.m4449equalsimpl0(this.center, ((SweepGradient) other).center) && Intrinsics.areEqual(this.colors, ((SweepGradient) other).colors) && Intrinsics.areEqual(this.stops, ((SweepGradient) other).stops);
    }

    public int hashCode() {
        int result = Offset.m4454hashCodeimpl(this.center);
    ...
    public Object lerp(Object other, float t) {
        ...
        if (other != null) {
            ...
            other2 = new SolidColor(Color.INSTANCE.m4732getTransparent0d7_KjU(), null);
        }
        ...
        if (other2 instanceof SweepGradient) {
            return new SweepGradient(OffsetKt.m4475lerpWko1d7g(this.center, ((SweepGradient) other2).center, t), BrushKt.lerpColorList(this.colors, ((SweepGradient) other2).colors, t), BrushKt.lerpNullableFloatList(this.stops, ((SweepGradient) other2).stops, t), null);
        }
        return obj;
    }
}
