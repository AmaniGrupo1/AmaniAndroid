...
public final class Stroke extends DrawStyle {
    ...
    private static final int DefaultCap = StrokeCap.INSTANCE.m5071getButtKaPHkGw();
    private static final int DefaultJoin = StrokeJoin.INSTANCE.m5082getMiterLxFBmk8();
    ...
    public boolean equals(Object other) {
        ...
        if (this.width == ((Stroke) other).width) {
            return ((this.miter > ((Stroke) other).miter ? 1 : (this.miter == ((Stroke) other).miter ? 0 : -1)) == 0) && StrokeCap.m5067equalsimpl0(this.cap, ((Stroke) other).cap) && StrokeJoin.m5077equalsimpl0(this.join, ((Stroke) other).join) && Intrinsics.areEqual(this.pathEffect, ((Stroke) other).pathEffect);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        int result2 = ((((((result * 31) + Float.hashCode(this.miter)) * 31) + StrokeCap.m5068hashCodeimpl(this.cap)) * 31) + StrokeJoin.m5078hashCodeimpl(this.join)) * 31;
        PathEffect pathEffect = this.pathEffect;
        return result2 + (pathEffect != null ? pathEffect.hashCode() : 0);
    }

    public String toString() {
        return "Stroke(width=" + this.width + ", miter=" + this.miter + ", cap=" + ((Object) StrokeCap.m5069toStringimpl(this.cap)) + ", join=" + ((Object) StrokeJoin.m5079toStringimpl(this.join)) + ", pathEffect=" + this.pathEffect + ')';
    }
}
