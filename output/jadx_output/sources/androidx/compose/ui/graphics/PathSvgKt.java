...
public final class PathSvgKt {
    ...
    public static final String toSvg(Path $this$toSvg, boolean asDocument) {
        ...
        if (asDocument) {
            ...
            StringBuilder sbAppend = $this$toSvg_u24lambda_u240.append("viewBox=\"" + bounds.getLeft() + ' ' + bounds.getTop() + ' ' + (bounds.getRight() - bounds.getLeft()) + ' ' + (bounds.getBottom() - bounds.getTop()) + "\">");
        ...
        if (iterator.hasNext()) {
            if (asDocument) {
                if (PathFillType.m4989equalsimpl0($this$toSvg.mo4585getFillTypeRgk1Os(), PathFillType.INSTANCE.m4993getEvenOddRgk1Os())) {
            ...
            if (asDocument) {
                StringBuilder sbAppend2 = $this$toSvg_u24lambda_u240.append("\"/>");
                Intrinsics.checkNotNullExpressionValue(sbAppend2, "append(...)");
                Intrinsics.checkNotNullExpressionValue(sbAppend2.append('\n'), "append(...)");
            }
        }
        if (asDocument) {
            StringBuilder sbAppend3 = $this$toSvg_u24lambda_u240.append("</svg>");
            Intrinsics.checkNotNullExpressionValue(sbAppend3, "append(...)");
            Intrinsics.checkNotNullExpressionValue(sbAppend3.append('\n'), "append(...)");
        }
        String string = $this$toSvg_u24lambda_u240.toString();
