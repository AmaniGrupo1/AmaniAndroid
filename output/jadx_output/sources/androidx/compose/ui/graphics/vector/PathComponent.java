...
public final class PathComponent extends VNode {
    ...
    public final void m5435setPathFillTypeoQ8Xj4U(int i) {
        this.pathFillType = i;
        this.renderPath.mo4587setFillTypeoQ8Xj4U(i);
        invalidate();
    }
    ...
    public final void m5436setStrokeLineCapBeK7IIE(int i) {
    ...
    public final void m5437setStrokeLineJoinWw9F2mQ(int i) {
    ...
    private final void updateRenderPath() {
        ...
        if (Intrinsics.areEqual(this.renderPath, this.path)) {
            ...
            int fillType = this.renderPath.mo4585getFillTypeRgk1Os();
            this.renderPath.rewind();
            this.renderPath.mo4587setFillTypeoQ8Xj4U(fillType);
        }
        ...
        if (start > end) {
            ...
            Path.m4981addPathUv8p0NA$default(this.renderPath, dstPath, 0L, 2, null);
            dstPath.reset();
    ...
    public void draw(DrawScope $this$draw) {
        ...
        Brush it = this.fill;
        if (it != null) {
            DrawScope.m5260drawPathGBMwjPU$default($this$draw, this.renderPath, it, this.fillAlpha, null, null, 0, 56, null);
        }
        ...
        if (it2 != null) {
            ...
            DrawScope.m5260drawPathGBMwjPU$default($this$draw, this.renderPath, it2, this.strokeAlpha, targetStroke, null, 0, 48, null);
        }
    }
