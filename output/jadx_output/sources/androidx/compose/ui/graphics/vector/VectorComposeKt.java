...
public final class VectorComposeKt {
    public static final void Group(String name, float rotation, float pivotX, float pivotY, float scaleX, float scaleY, float translationX, float translationY, List<? extends PathNode> list, final Function2<? super Composer, ? super Integer, Unit> function2, Composer $composer, final int $changed, final int i) {
        ...
        if (($changed & 100663296) == 0) {
            $dirty2 |= ((i & 256) == 0 && $composer2.changedInstance(list)) ? 67108864 : 33554432;
        }
        ...
        if ($composer2.shouldExecute(($dirty2 & 306783379) != 306783378, $dirty3 & 1)) {
            ...
            Composer $this$Group_u24lambda_u241 = Updater.m3967constructorimpl($composer2);
            Updater.m3975setimpl($this$Group_u24lambda_u241, name2, new Function2<GroupComponent, String, Unit>() { // from class: androidx.compose.ui.graphics.vector.VectorComposeKt$Group$2$1
            ...
            Updater.m3975setimpl($this$Group_u24lambda_u241, Float.valueOf(rotation2), new Function2<GroupComponent, Float, Unit>() { // from class: androidx.compose.ui.graphics.vector.VectorComposeKt$Group$2$2
                @Override // kotlin.jvm.functions.Function2
            ...
            Updater.m3975setimpl($this$Group_u24lambda_u241, Float.valueOf(pivotX2), new Function2<GroupComponent, Float, Unit>() { // from class: androidx.compose.ui.graphics.vector.VectorComposeKt$Group$2$3
                @Override // kotlin.jvm.functions.Function2
                public /* bridge */ /* synthetic */ Unit invoke(GroupComponent groupComponent, Float f) {
                    invoke(groupComponent, f.floatValue());
                    return Unit.INSTANCE;
            ...
            Updater.m3975setimpl($this$Group_u24lambda_u241, Float.valueOf(pivotY2), new Function2<GroupComponent, Float, Unit>() { // from class: androidx.compose.ui.graphics.vector.VectorComposeKt$Group$2$4
                @Override // kotlin.jvm.functions.Function2
                public /* bridge */ /* synthetic */ Unit invoke(GroupComponent groupComponent, Float f) {
                    invoke(groupComponent, f.floatValue());
                    return Unit.INSTANCE;
            ...
            Updater.m3975setimpl($this$Group_u24lambda_u241, Float.valueOf(scaleX2), new Function2<GroupComponent, Float, Unit>() { // from class: androidx.compose.ui.graphics.vector.VectorComposeKt$Group$2$5
                @Override // kotlin.jvm.functions.Function2
                public /* bridge */ /* synthetic */ Unit invoke(GroupComponent groupComponent, Float f) {
                    invoke(groupComponent, f.floatValue());
                    return Unit.INSTANCE;
            ...
            Updater.m3975setimpl($this$Group_u24lambda_u241, Float.valueOf(scaleY4), new Function2<GroupComponent, Float, Unit>() { // from class: androidx.compose.ui.graphics.vector.VectorComposeKt$Group$2$6
                @Override // kotlin.jvm.functions.Function2
                public /* bridge */ /* synthetic */ Unit invoke(GroupComponent groupComponent, Float f) {
                    invoke(groupComponent, f.floatValue());
                    return Unit.INSTANCE;
            ...
            Updater.m3975setimpl($this$Group_u24lambda_u241, Float.valueOf(translationX3), new Function2<GroupComponent, Float, Unit>() { // from class: androidx.compose.ui.graphics.vector.VectorComposeKt$Group$2$7
                @Override // kotlin.jvm.functions.Function2
                public /* bridge */ /* synthetic */ Unit invoke(GroupComponent groupComponent, Float f) {
                    invoke(groupComponent, f.floatValue());
                    return Unit.INSTANCE;
            ...
            Updater.m3975setimpl($this$Group_u24lambda_u241, Float.valueOf(translationY4), new Function2<GroupComponent, Float, Unit>() { // from class: androidx.compose.ui.graphics.vector.VectorComposeKt$Group$2$8
                @Override // kotlin.jvm.functions.Function2
                public /* bridge */ /* synthetic */ Unit invoke(GroupComponent groupComponent, Float f) {
                    invoke(groupComponent, f.floatValue());
                    return Unit.INSTANCE;
            ...
            Updater.m3975setimpl($this$Group_u24lambda_u241, emptyPath, new Function2<GroupComponent, List<? extends PathNode>, Unit>() { // from class: androidx.compose.ui.graphics.vector.VectorComposeKt$Group$2$9
                @Override // kotlin.jvm.functions.Function2
    ...
    public static final void m5441Path9cdaXJ4(final List<? extends PathNode> list, int i, String name, Brush fill, float fillAlpha, Brush stroke, float strokeAlpha, float strokeLineWidth, int i2, int i3, float strokeLineMiter, float trimPathStart, float trimPathEnd, float trimPathOffset, Composer $composer, final int $changed, final int $changed1, final int i4) {
        int i5;
        String str;
        Brush brush;
        float f;
        ...
        if (i16 != 0) {
            ...
            i5 = i;
            $dirty2 |= $composer3.changed(i5) ? 32 : 16;
        } else {
            i5 = i;
        }
        int i17 = i4 & 4;
        ...
        if (i23 != 0) {
            ...
            i7 = i23;
            $dirty2 |= $composer3.changed(i2) ? 67108864 : 33554432;
        } else {
            i7 = i23;
        }
        int i24 = i4 & 512;
        if (i24 != 0) {
            ...
            i8 = i24;
            $dirty2 |= $composer3.changed(i3) ? C.BUFFER_FLAG_LAST_SAMPLE : 268435456;
        } else {
            i8 = i24;
        }
        int i25 = i4 & 1024;
        ...
        if (!$composer3.shouldExecute((($dirty2 & 306783379) == 306783378 && ($dirty12 & 1171) == 1170) ? false : true, $dirty2 & 1)) {
            ...
            Composer $this$Path_9cdaXJ4_u24lambda_u241 = Updater.m3967constructorimpl($composer2);
            Updater.m3975setimpl($this$Path_9cdaXJ4_u24lambda_u241, name3, new Function2<PathComponent, String, Unit>() { // from class: androidx.compose.ui.graphics.vector.VectorComposeKt$Path$2$1
                @Override // kotlin.jvm.functions.Function2
            ...
            Updater.m3975setimpl($this$Path_9cdaXJ4_u24lambda_u241, list, new Function2<PathComponent, List<? extends PathNode>, Unit>() { // from class: androidx.compose.ui.graphics.vector.VectorComposeKt$Path$2$2
                @Override // kotlin.jvm.functions.Function2
            ...
            Updater.m3975setimpl($this$Path_9cdaXJ4_u24lambda_u241, PathFillType.m4986boximpl(i15), new Function2<PathComponent, PathFillType, Unit>() { // from class: androidx.compose.ui.graphics.vector.VectorComposeKt$Path$2$3
                @Override // kotlin.jvm.functions.Function2
                public /* bridge */ /* synthetic */ Unit invoke(PathComponent pathComponent, PathFillType pathFillType) {
                    m5443invokepweu1eQ(pathComponent, pathFillType.getValue());
                    return Unit.INSTANCE;
                }

                /* JADX INFO: renamed from: invoke-pweu1eQ, reason: not valid java name */
                public final void m5443invokepweu1eQ(PathComponent $this$set, int i29) {
                    $this$set.m5435setPathFillTypeoQ8Xj4U(i29);
                }
            });
            Updater.m3975setimpl($this$Path_9cdaXJ4_u24lambda_u241, fill3, new Function2<PathComponent, Brush, Unit>() { // from class: androidx.compose.ui.graphics.vector.VectorComposeKt$Path$2$4
                @Override // kotlin.jvm.functions.Function2
            ...
            Updater.m3975setimpl($this$Path_9cdaXJ4_u24lambda_u241, Float.valueOf(fillAlpha4), new Function2<PathComponent, Float, Unit>() { // from class: androidx.compose.ui.graphics.vector.VectorComposeKt$Path$2$5
                @Override // kotlin.jvm.functions.Function2
            ...
            Updater.m3975setimpl($this$Path_9cdaXJ4_u24lambda_u241, stroke3, new Function2<PathComponent, Brush, Unit>() { // from class: androidx.compose.ui.graphics.vector.VectorComposeKt$Path$2$6
                @Override // kotlin.jvm.functions.Function2
                public /* bridge */ /* synthetic */ Unit invoke(PathComponent pathComponent, Brush brush3) {
                    invoke2(pathComponent, brush3);
                    return Unit.INSTANCE;
            ...
            Updater.m3975setimpl($this$Path_9cdaXJ4_u24lambda_u241, Float.valueOf(strokeAlpha2), new Function2<PathComponent, Float, Unit>() { // from class: androidx.compose.ui.graphics.vector.VectorComposeKt$Path$2$7
                @Override // kotlin.jvm.functions.Function2
                public /* bridge */ /* synthetic */ Unit invoke(PathComponent pathComponent, Float f2) {
                    invoke(pathComponent, f2.floatValue());
                    return Unit.INSTANCE;
            ...
            Updater.m3975setimpl($this$Path_9cdaXJ4_u24lambda_u241, Float.valueOf(strokeLineWidth2), new Function2<PathComponent, Float, Unit>() { // from class: androidx.compose.ui.graphics.vector.VectorComposeKt$Path$2$8
                @Override // kotlin.jvm.functions.Function2
                public /* bridge */ /* synthetic */ Unit invoke(PathComponent pathComponent, Float f2) {
                    invoke(pathComponent, f2.floatValue());
                    return Unit.INSTANCE;
            ...
            Updater.m3975setimpl($this$Path_9cdaXJ4_u24lambda_u241, StrokeJoin.m5074boximpl(defaultStrokeLineJoin), new Function2<PathComponent, StrokeJoin, Unit>() { // from class: androidx.compose.ui.graphics.vector.VectorComposeKt$Path$2$9
                @Override // kotlin.jvm.functions.Function2
                public /* bridge */ /* synthetic */ Unit invoke(PathComponent pathComponent, StrokeJoin strokeJoin) {
                    m5444invokekLtJ_vA(pathComponent, strokeJoin.getValue());
                    return Unit.INSTANCE;
                }

                /* JADX INFO: renamed from: invoke-kLtJ_vA, reason: not valid java name */
                public final void m5444invokekLtJ_vA(PathComponent $this$set, int i29) {
                    $this$set.m5437setStrokeLineJoinWw9F2mQ(i29);
                }
            });
            Updater.m3975setimpl($this$Path_9cdaXJ4_u24lambda_u241, StrokeCap.m5064boximpl(defaultStrokeLineCap), new Function2<PathComponent, StrokeCap, Unit>() { // from class: androidx.compose.ui.graphics.vector.VectorComposeKt$Path$2$10
                @Override // kotlin.jvm.functions.Function2
                public /* bridge */ /* synthetic */ Unit invoke(PathComponent pathComponent, StrokeCap strokeCap) {
                    m5442invokeCSYIeUk(pathComponent, strokeCap.getValue());
                    return Unit.INSTANCE;
                }

                /* JADX INFO: renamed from: invoke-CSYIeUk, reason: not valid java name */
                public final void m5442invokeCSYIeUk(PathComponent $this$set, int i29) {
                    $this$set.m5436setStrokeLineCapBeK7IIE(i29);
                }
            });
            Updater.m3975setimpl($this$Path_9cdaXJ4_u24lambda_u241, Float.valueOf(strokeLineMiter4), new Function2<PathComponent, Float, Unit>() { // from class: androidx.compose.ui.graphics.vector.VectorComposeKt$Path$2$11
                @Override // kotlin.jvm.functions.Function2
                public /* bridge */ /* synthetic */ Unit invoke(PathComponent pathComponent, Float f2) {
                    invoke(pathComponent, f2.floatValue());
                    return Unit.INSTANCE;
            ...
            Updater.m3975setimpl($this$Path_9cdaXJ4_u24lambda_u241, Float.valueOf(trimPathStart3), new Function2<PathComponent, Float, Unit>() { // from class: androidx.compose.ui.graphics.vector.VectorComposeKt$Path$2$12
                @Override // kotlin.jvm.functions.Function2
                public /* bridge */ /* synthetic */ Unit invoke(PathComponent pathComponent, Float f2) {
                    invoke(pathComponent, f2.floatValue());
                    return Unit.INSTANCE;
            ...
            Updater.m3975setimpl($this$Path_9cdaXJ4_u24lambda_u241, Float.valueOf(trimPathEnd2), new Function2<PathComponent, Float, Unit>() { // from class: androidx.compose.ui.graphics.vector.VectorComposeKt$Path$2$13
                @Override // kotlin.jvm.functions.Function2
                public /* bridge */ /* synthetic */ Unit invoke(PathComponent pathComponent, Float f2) {
                    invoke(pathComponent, f2.floatValue());
                    return Unit.INSTANCE;
            ...
            Updater.m3975setimpl($this$Path_9cdaXJ4_u24lambda_u241, Float.valueOf(trimPathOffset3), new Function2<PathComponent, Float, Unit>() { // from class: androidx.compose.ui.graphics.vector.VectorComposeKt$Path$2$14
                @Override // kotlin.jvm.functions.Function2
                public /* bridge */ /* synthetic */ Unit invoke(PathComponent pathComponent, Float f2) {
                    invoke(pathComponent, f2.floatValue());
                    return Unit.INSTANCE;
            ...
            i13 = defaultStrokeLineCap;
            i14 = defaultStrokeLineJoin;
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.ui.graphics.vector.VectorComposeKt$Path$3
                ...
                public final void invoke(Composer composer, int i29) {
                    VectorComposeKt.m5441Path9cdaXJ4(list, i12, name2, fill2, fillAlpha2, stroke2, strokeAlpha3, fillAlpha3, i13, i14, strokeLineMiter3, trimPathStart2, strokeLineMiter2, strokeAlpha4, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), RecomposeScopeImplKt.updateChangedFlags($changed1), i4);
                }
            });
        }
    }
