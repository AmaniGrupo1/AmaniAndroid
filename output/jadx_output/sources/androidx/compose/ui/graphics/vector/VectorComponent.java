...
public final class VectorComponent extends VNode {
    ...
    public VectorComponent(GroupComponent root) {
        ...
        this.viewportSize = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Size.m4509boximpl(Size.INSTANCE.m4530getZeroNHjbRc()), null, 2, null);
        this.previousDrawSize = Size.INSTANCE.m4529getUnspecifiedNHjbRc();
        ...
        this.drawVectorBlock = new Function1<DrawScope, Unit>() { // from class: androidx.compose.ui.graphics.vector.VectorComponent$drawVectorBlock$1
            ...
            public final void invoke2(DrawScope drawScope) {
                ...
                try {
                    ...
                    $this$scale_Fgt4K4Q_u24lambda_u240$iv.mo5199scale0AR0LA0(scaleX$iv, scaleY$iv, jM4468getZeroF1C5BW0);
    ...
    public final int m5438getCacheBitmapConfig_sVssgQ$ui() {
        ImageBitmap mCachedImage = this.cacheDrawScope.getMCachedImage();
        return mCachedImage != null ? mCachedImage.mo4561getConfig_sVssgQ() : ImageBitmapConfig.INSTANCE.m4928getArgb8888_sVssgQ();
    }
    ...
    public final long m5439getViewportSizeNHjbRc$ui() {
    ...
    public final void m5440setViewportSizeuvyYCjk$ui(long j) {
    ...
    */
    public final void draw(DrawScope $this$draw, float alpha, ColorFilter colorFilter) {
        ...
        if (this.root.getIsTintable()) {
            isOneColor = ((this.root.getTintColor() > 16L ? 1 : (this.root.getTintColor() == 16L ? 0 : -1)) != 0 ? 1 : 0) != 0;
        }
        int targetImageConfig = (isOneColor && VectorKt.tintableWithAlphaMask(getIntrinsicColorFilter$ui()) && VectorKt.tintableWithAlphaMask(colorFilter)) ? ImageBitmapConfig.INSTANCE.m4927getAlpha8_sVssgQ() : ImageBitmapConfig.INSTANCE.m4928getArgb8888_sVssgQ();
        if (this.isDirty || !Size.m4517equalsimpl0(this.previousDrawSize, $this$draw.mo5271getSizeNHjbRc()) || !ImageBitmapConfig.m4923equalsimpl0(targetImageConfig, m5438getCacheBitmapConfig_sVssgQ$ui())) {
            this.tintFilter = ImageBitmapConfig.m4923equalsimpl0(targetImageConfig, ImageBitmapConfig.INSTANCE.m4927getAlpha8_sVssgQ()) ? ColorFilter.Companion.m4738tintxETnrds$default(ColorFilter.INSTANCE, VectorKt.m5446toOpaque8_81llA(this.root.getTintColor()), 0, 2, null) : null;
            int bits$iv$iv$iv = (int) ($this$draw.mo5271getSizeNHjbRc() >> 32);
            float fIntBitsToFloat = Float.intBitsToFloat(bits$iv$iv$iv);
            int bits$iv$iv$iv2 = (int) (m5439getViewportSizeNHjbRc$ui() >> 32);
            this.rootScaleX = fIntBitsToFloat / Float.intBitsToFloat(bits$iv$iv$iv2);
            int bits$iv$iv$iv3 = (int) ($this$draw.mo5271getSizeNHjbRc() & 4294967295L);
            float fIntBitsToFloat2 = Float.intBitsToFloat(bits$iv$iv$iv3);
            int bits$iv$iv$iv4 = (int) (m5439getViewportSizeNHjbRc$ui() & 4294967295L);
            this.rootScaleY = fIntBitsToFloat2 / Float.intBitsToFloat(bits$iv$iv$iv4);
            DrawCache drawCache = this.cacheDrawScope;
            int bits$iv$iv$iv5 = (int) ($this$draw.mo5271getSizeNHjbRc() >> 32);
            int width$iv = (int) Math.ceil(Float.intBitsToFloat(bits$iv$iv$iv5));
            int bits$iv$iv$iv6 = (int) ($this$draw.mo5271getSizeNHjbRc() & 4294967295L);
            int height$iv = (int) Math.ceil(Float.intBitsToFloat(bits$iv$iv$iv6));
            drawCache.m5421drawCachedImageFqjB98A(targetImageConfig, IntSize.m7671constructorimpl((((long) width$iv) << 32) | (((long) height$iv) & 4294967295L)), $this$draw, $this$draw.getLayoutDirection(), this.drawVectorBlock);
            this.isDirty = false;
            this.previousDrawSize = $this$draw.mo5271getSizeNHjbRc();
        }
        ColorFilter targetFilter = colorFilter != null ? colorFilter : getIntrinsicColorFilter$ui() != null ? getIntrinsicColorFilter$ui() : this.tintFilter;
        this.cacheDrawScope.drawInto($this$draw, alpha, targetFilter);
    }
    ...
    public String toString() {
        ...
        int bits$iv$iv$iv = (int) (m5439getViewportSizeNHjbRc$ui() >> 32);
        ...
        int bits$iv$iv$iv2 = (int) (4294967295L & m5439getViewportSizeNHjbRc$ui());
