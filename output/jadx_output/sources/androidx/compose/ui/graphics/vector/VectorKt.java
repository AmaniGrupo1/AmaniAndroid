...
public final class VectorKt {
    ...
    private static final int DefaultStrokeLineCap = StrokeCap.INSTANCE.m5071getButtKaPHkGw();
    private static final int DefaultStrokeLineJoin = StrokeJoin.INSTANCE.m5082getMiterLxFBmk8();
    private static final int DefaultTintBlendMode = BlendMode.INSTANCE.m4635getSrcIn0nO6VwU();
    private static final long DefaultTintColor = Color.INSTANCE.m4732getTransparent0d7_KjU();
    private static final int DefaultFillType = PathFillType.INSTANCE.m4994getNonZeroRgk1Os();
    ...
    public static final boolean m5445rgbEqualOWjLjI(long j, long j2) {
        if (Color.m4703getRedimpl(j) == Color.m4703getRedimpl(j2)) {
            if (Color.m4702getGreenimpl(j) == Color.m4702getGreenimpl(j2)) {
                if (Color.m4700getBlueimpl(j) == Color.m4700getBlueimpl(j2)) {
                    return true;
                }
            }
        }
    ...
    public static final long m5446toOpaque8_81llA(long j) {
        if (Color.m4699getAlphaimpl(j) == 1.0f) {
            return j;
        }
        return Color.m4695copywmQWz5c(j, (14 & 1) != 0 ? Color.m4699getAlphaimpl(j) : 1.0f, (14 & 2) != 0 ? Color.m4703getRedimpl(j) : 0.0f, (14 & 4) != 0 ? Color.m4702getGreenimpl(j) : 0.0f, (14 & 8) != 0 ? Color.m4700getBlueimpl(j) : 0.0f);
    }

    public static final boolean tintableWithAlphaMask(ColorFilter $this$tintableWithAlphaMask) {
        return $this$tintableWithAlphaMask instanceof BlendModeColorFilter ? BlendMode.m4606equalsimpl0(((BlendModeColorFilter) $this$tintableWithAlphaMask).getBlendMode(), BlendMode.INSTANCE.m4635getSrcIn0nO6VwU()) || BlendMode.m4606equalsimpl0(((BlendModeColorFilter) $this$tintableWithAlphaMask).getBlendMode(), BlendMode.INSTANCE.m4637getSrcOver0nO6VwU()) : $this$tintableWithAlphaMask == null;
    }
}
