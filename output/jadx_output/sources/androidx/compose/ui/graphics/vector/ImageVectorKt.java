...
public final class ImageVectorKt {
    ...
    public static /* synthetic */ ImageVector.Builder m5431pathR_LF3I$default(ImageVector.Builder $this$path_u2dR_LF_u2d3I_u24default, String name, Brush fill, float fillAlpha, Brush stroke, float strokeAlpha, float strokeLineWidth, int i, int i2, float strokeLineMiter, int i3, Function1 pathBuilder, int i4, Object obj) {
        ...
        float strokeLineMiter2 = (i4 & 256) != 0 ? 4.0f : strokeLineMiter;
        ...
        return ImageVector.Builder.m5428addPathoIyEayM$default($this$path_u2dR_LF_u2d3I_u24default, $this$PathData_u24lambda_u240$iv.getNodes(), defaultFillType, name2, fill2, fillAlpha2, stroke2, strokeAlpha2, strokeLineWidth2, defaultStrokeLineCap, defaultStrokeLineJoin, strokeLineMiter2, 0.0f, 0.0f, 0.0f, 14336, null);
    }

    /* JADX INFO: renamed from: path-R_LF-3I, reason: not valid java name */
    public static final ImageVector.Builder m5430pathR_LF3I(ImageVector.Builder $this$path_u2dR_LF_u2d3I, String name, Brush fill, float fillAlpha, Brush stroke, float strokeAlpha, float strokeLineWidth, int i, int i2, float strokeLineMiter, int i3, Function1<? super PathBuilder, Unit> function1) {
        PathBuilder $this$PathData_u24lambda_u240$iv = new PathBuilder();
        function1.invoke($this$PathData_u24lambda_u240$iv);
        return ImageVector.Builder.m5428addPathoIyEayM$default($this$path_u2dR_LF_u2d3I, $this$PathData_u24lambda_u240$iv.getNodes(), i3, name, fill, fillAlpha, stroke, strokeAlpha, strokeLineWidth, i, i2, strokeLineMiter, 0.0f, 0.0f, 0.0f, 14336, null);
    }
