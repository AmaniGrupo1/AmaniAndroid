...
public final class VectorPainter extends Painter {
    ...
    public VectorPainter(GroupComponent root) {
        this.size = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Size.m4509boximpl(Size.INSTANCE.m4530getZeroNHjbRc()), null, 2, null);
    ...
    public final long m5448getSizeNHjbRc$ui() {
    ...
    public final void m5450setSizeuvyYCjk$ui(long j) {
    ...
    public final long m5449getViewportSizeNHjbRc$ui() {
        return this.vector.m5439getViewportSizeNHjbRc$ui();
    }

    /* JADX INFO: renamed from: setViewportSize-uvyYCjk$ui, reason: not valid java name */
    public final void m5451setViewportSizeuvyYCjk$ui(long j) {
        this.vector.m5440setViewportSizeuvyYCjk$ui(j);
    }
    ...
    public final int m5447getBitmapConfig_sVssgQ$ui() {
        return this.vector.m5438getCacheBitmapConfig_sVssgQ$ui();
    }
    ...
    protected void onDraw(DrawScope $this$onDraw) throws Throwable {
        ...
        if (!getAutoMirror$ui() || $this$onDraw.getLayoutDirection() != LayoutDirection.Rtl) {
            ...
            long jMo5270getCenterF1C5BW0 = $this$onDraw.mo5270getCenterF1C5BW0();
            DrawContext $this$withTransform_u24lambda_u240$iv$iv$iv = $this$onDraw.getDrawContext();
            long previousSize$iv$iv$iv = $this$withTransform_u24lambda_u240$iv$iv$iv.mo5192getSizeNHjbRc();
            ...
            try {
                ...
                $this$scale_Fgt4K4Q_u24lambda_u240$iv$iv.mo5199scale0AR0LA0(-1.0f, 1.0f, jMo5270getCenterF1C5BW0);
                try {
                    $this$onDraw_u24lambda_u240.draw($this$onDraw, this.currentAlpha, filter);
                    $this$withTransform_u24lambda_u240$iv$iv$iv.getCanvas().restore();
                    $this$withTransform_u24lambda_u240$iv$iv$iv.mo5193setSizeuvyYCjk(previousSize$iv$iv$iv);
                } catch (Throwable th) {
                    th = th;
                    $this$withTransform_u24lambda_u240$iv$iv$iv.getCanvas().restore();
                    $this$withTransform_u24lambda_u240$iv$iv$iv.mo5193setSizeuvyYCjk(previousSize$iv$iv$iv);
