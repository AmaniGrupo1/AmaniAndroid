...
public final class FastFloatParserKt {
    ...
    public static final long nextFloat(String s, int start, int end) {
        ...
        int index = start;
        char c6 = s.charAt(index);
        boolean isNegative = c6 == '-';
        if (isNegative) {
            index++;
            if (index == end) {
                return (4294967295L & ((long) Float.floatToRawIntBits(Float.NaN))) | (((long) index) << 32);
            }
            c6 = s.charAt(index);
            j = 4294967295L;
            if (!(((char) (c6 + 65488)) < '\n') && c6 != '.') {
                return (((long) index) << 32) | (((long) Float.floatToRawIntBits(Float.NaN)) & 4294967295L);
            }
        } else {
            j = 4294967295L;
        }
        ...
        while (true) {
            ...
            index++;
            c6 = index < dataLength ? s.charAt(index) : (char) 0;
            c5 = c;
        }
        int significandEndIndex2 = index;
        int digitCount = index - significandStartIndex;
        int exponent = 0;
        int exponentStartIndex = index;
        int exponentEndIndex3 = index;
        if (index == end || c6 != '.') {
            c2 = '0';
        ...
        if ((c6 | ' ') == 101) {
            index++;
            char c7 = index < dataLength ? s.charAt(index) : (char) 0;
            boolean isExponentNegative = c7 == '-';
            if (isExponentNegative || c7 == '+') {
                index++;
            }
            char c8 = s.charAt(index);
            while (true) {
                if (index == end) {
                    c4 = c8;
                    break;
                }
                char $this$isDigit$iv3 = c8;
                c4 = c8;
                char $this$isDigit$iv4 = ((char) ($this$isDigit$iv3 + 65488)) < '\n' ? (char) 1 : (char) 0;
                if ($this$isDigit$iv4 == 0) {
                    break;
                }
                ...
                index++;
                c8 = index < dataLength ? s.charAt(index) : (char) 0;
            }
        ...
        if (digitCount > 19) {
            ...
            if (digitCount > 19) {
                ...
                while (true) {
                    ...
                    tooManyDigits = tooManyDigits2;
                    significandEndIndex = significandEndIndex2;
                    if (Long.compare(ULong.m8716constructorimpl(significand10) ^ Long.MIN_VALUE, 1000000000000000000L ^ Long.MIN_VALUE) >= 0) {
                        break;
                    }
                ...
                if (Long.compare(ULong.m8716constructorimpl(significand10) ^ Long.MIN_VALUE, 1000000000000000000L ^ Long.MIN_VALUE) >= 0) {
                    ...
                    for (j2 = 1000000000000000000L; retryIndex3 != exponentEndIndex && Long.compare(ULong.m8716constructorimpl(significand10) ^ Long.MIN_VALUE, j2 ^ Long.MIN_VALUE) < 0; j2 = 1000000000000000000L) {
                        significand10 = (significand10 * 10) + ((long) (c6 - '0'));
                        retryIndex3++;
        ...
        if (!(-10 <= exponent && exponent < 11) || tooManyDigits) {
            ...
            if (Long.compare(ULong.m8716constructorimpl(significand) ^ Long.MIN_VALUE, ULong.m8716constructorimpl(16777216L) ^ Long.MIN_VALUE) <= 0) {
                float f = significand;
        ...
        if (!(-126 <= exponent && exponent < 128)) {
            String strSubstring = s.substring(start, index);
        ...
        long significandFactor = ULongArray.m8776getsVKNKU(Mantissa64, exponent + 325);
        ...
        if ((upper & 511) == 511 || ((upper & 511) == 0 && (mantissa & 3) == 1)) {
            String strSubstring2 = s.substring(start, index);
        ...
        if (mantissa2 >= NumberComparisonHelper.MAX_SAFE_LONG) {
            mantissa2 = 4503599627370496L;
            lz2--;
        }
        long mantissa3 = mantissa2 & (-4503599627370497L);
        long adjustedExponent = ((((long) exponent) * 217706) >> 16) + ((long) 1024) + ((long) 63);
        ...
        String strSubstring3 = s.substring(start, index);
