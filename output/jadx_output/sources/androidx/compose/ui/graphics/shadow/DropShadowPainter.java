...
public final class DropShadowPainter extends Painter {
    ...
    protected void onDraw(DrawScope $this$onDraw) {
        DropShadowRenderer renderer = this.renderCreator.mo5398obtainDropShadowRenderereZhPAX0(this.shape, $this$onDraw.mo5271getSizeNHjbRc(), $this$onDraw.getLayoutDirection(), $this$onDraw, this.shadow);
        float left$iv = $this$onDraw.mo405toPx0680j_4(DpOffset.m7566getXD9Ej5fM(this.shadow.getOffset()));
        float top$iv = $this$onDraw.mo405toPx0680j_4(DpOffset.m7568getYD9Ej5fM(this.shadow.getOffset()));
        $this$onDraw.getDrawContext().getTransform().translate(left$iv, top$iv);
        try {
            renderer.m5420drawShadowerFMhIw($this$onDraw, this.colorFilter, $this$onDraw.mo5271getSizeNHjbRc(), renderer.getShadow().getColor(), renderer.getShadow().getBrush(), RangesKt.coerceIn(this.alpha * renderer.getShadow().getAlpha(), 0.0f, 1.0f), renderer.getShadow().getBlendMode());
        } finally {
            $this$onDraw.getDrawContext().getTransform().translate(-left$iv, -top$iv);
        }
    }
