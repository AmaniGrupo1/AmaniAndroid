...
public final class InnerShadowPainter extends Painter {
    ...
    protected void onDraw(DrawScope $this$onDraw) {
        InnerShadowRenderer renderer = this.renderCreator.mo5399obtainInnerShadowRenderereZhPAX0(this.shape, $this$onDraw.mo5271getSizeNHjbRc(), $this$onDraw.getLayoutDirection(), $this$onDraw, this.shadow);
        renderer.m5420drawShadowerFMhIw($this$onDraw, this.colorFilter, $this$onDraw.mo5271getSizeNHjbRc(), this.shadow.getColor(), this.shadow.getBrush(), RangesKt.coerceIn(this.alpha * this.shadow.getAlpha(), 0.0f, 1.0f), this.shadow.getBlendMode());
    }
