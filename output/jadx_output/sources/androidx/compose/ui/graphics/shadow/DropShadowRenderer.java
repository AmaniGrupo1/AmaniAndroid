...
public final class DropShadowRenderer extends ShadowRenderer {
    ...
    protected void mo5409buildShadow_SMYjrA(DrawScope $this$buildShadow_u2d_SMYjrA, long j, long j2, Path path) {
        ...
        ImageBitmap imageBitmapM5408createOuterShadowBitmapD_oqF2M;
        ...
        if (path != null) {
            ...
            imageBitmapM5408createOuterShadowBitmapD_oqF2M = dropShadowRenderer.m5407createOuterShadowBitmapCqks5Fs(j, path, radius, spread);
        } else {
            dropShadowRenderer = this;
            imageBitmapM5408createOuterShadowBitmapD_oqF2M = dropShadowRenderer.m5408createOuterShadowBitmapD_oqF2M(j, radius, spread, j2);
        }
        dropShadowRenderer.shadowBitmap = imageBitmapM5408createOuterShadowBitmapD_oqF2M;
    }
    ...
    private final Brush obtainCompositeBrush(ImageBitmap shadowBitmap, Brush brush) {
        ...
        if (shader == null || !Intrinsics.areEqual(shader.getSrcBrush(), brush)) {
            ...
            ShaderBrush ShaderBrush2 = BrushKt.ShaderBrush(ShaderKt.m5030ImageShaderF49vj9s$default(shadowBitmap, 0, 0, 6, null));
            if (brush instanceof ShaderBrush) {
                float width$iv = shadowBitmap.getWidth();
                float height$iv = shadowBitmap.getHeight();
                long v1$iv$iv = Float.floatToRawIntBits(width$iv);
                long v2$iv$iv = Float.floatToRawIntBits(height$iv);
                ShaderBrush = BrushKt.ShaderBrush(((ShaderBrush) brush).mo4666createShaderuvyYCjk(Size.m4512constructorimpl((v1$iv$iv << 32) | (v2$iv$iv & 4294967295L))));
            } else {
                ShaderBrush = brush;
            }
            Brush brushM4654composite7EN7VTw = companion.m4654composite7EN7VTw(ShaderBrush2, ShaderBrush, BlendMode.INSTANCE.m4635getSrcIn0nO6VwU());
            Intrinsics.checkNotNull(brushM4654composite7EN7VTw, "null cannot be cast to non-null type androidx.compose.ui.graphics.CompositeShaderBrush");
            shader = (CompositeShaderBrush) brushM4654composite7EN7VTw;
    ...
    protected void mo5410onDrawShadowMLmccfk(DrawScope $this$onDrawShadow_u2dMLmccfk, long j, long j2, Path path, float alpha, ColorFilter colorFilter, Brush brush, int i) {
        ...
        if (shadowBitmap != null) {
            float offset = -($this$onDrawShadow_u2dMLmccfk.mo405toPx0680j_4(this.shadow.getRadius()) + $this$onDrawShadow_u2dMLmccfk.mo405toPx0680j_4(this.shadow.getSpread()));
            if (brush == null || colorFilter != null) {
                long v1$iv$iv = Float.floatToRawIntBits(offset);
                long v2$iv$iv = Float.floatToRawIntBits(offset);
                DrawScope.m5255drawImagegbVJVH8$default($this$onDrawShadow_u2dMLmccfk, shadowBitmap, Offset.m4444constructorimpl((v1$iv$iv << 32) | (v2$iv$iv & 4294967295L)), alpha, null, colorFilter, i, 8, null);
                return;
            }
            ...
            try {
                ...
                DrawScope.m5264drawRectAsUm42w$default($this$onDrawShadow_u2dMLmccfk, shaderBrush, 0L, Size.m4512constructorimpl((v1$iv$iv2 << 32) | (v2$iv$iv2 & 4294967295L)), alpha, null, null, i, 50, null);
            } finally {
                $this$onDrawShadow_u2dMLmccfk.getDrawContext().getTransform().translate(-offset, -offset);
            }
        }
    ...
    private final ImageBitmap m5407createOuterShadowBitmapCqks5Fs(long size, Path path, float radius, float spread) {
        ...
        ImageBitmap shadowBitmap = ImageBitmapKt.m4933ImageBitmapx__hDU$default((int) Math.ceil(shadowWidth), (int) Math.ceil(shadowHeight), ImageBitmapConfig.INSTANCE.m4927getAlpha8_sVssgQ(), false, null, 24, null);
        ...
        if (spread <= 0.0f) {
            ...
            BlurKt.m5405configureShadowFoewPVk(paint, (3 & 1) != 0 ? Color.INSTANCE.m4723getBlack0d7_KjU() : 0L, (3 & 2) != 0 ? BlendMode.INSTANCE.m4637getSrcOver0nO6VwU() : 0, (3 & 4) != 0 ? null : blurMaskFilterBlurFilter, (3 & 8) != 0 ? PaintingStyle.INSTANCE.m4978getFillTiuSbCo() : 0);
            ...
            int iM4979getStrokeTiuSbCo = PaintingStyle.INSTANCE.m4979getStrokeTiuSbCo();
            if (radius > 0.0f) {
                blurMaskFilterBlurFilter2 = Blur_androidKt.BlurFilter(radius);
            } else {
                blurMaskFilterBlurFilter2 = null;
            }
            Paint $this$createOuterShadowBitmap_Cqks5Fs_u24lambda_u240_u240 = BlurKt.m5405configureShadowFoewPVk(paint2, (3 & 1) != 0 ? Color.INSTANCE.m4723getBlack0d7_KjU() : 0L, (3 & 2) != 0 ? BlendMode.INSTANCE.m4637getSrcOver0nO6VwU() : 0, (3 & 4) != 0 ? null : blurMaskFilterBlurFilter2, (3 & 8) != 0 ? PaintingStyle.INSTANCE.m4978getFillTiuSbCo() : iM4979getStrokeTiuSbCo);
    ...
    private final ImageBitmap m5408createOuterShadowBitmapD_oqF2M(long size, float shadowRadius, float spread, long cornerRadius) {
        BlurMaskFilter blurMaskFilterBlurFilter;
        float f = 2;
        ...
        shadowCanvas.drawRoundRect(shadowRadius, shadowRadius, f2, f3, fIntBitsToFloat, fIntBitsToFloat2, BlurKt.m5405configureShadowFoewPVk(paint, (3 & 1) != 0 ? Color.INSTANCE.m4723getBlack0d7_KjU() : 0L, (3 & 2) != 0 ? BlendMode.INSTANCE.m4637getSrcOver0nO6VwU() : 0, (3 & 4) != 0 ? null : blurMaskFilterBlurFilter, (3 & 8) != 0 ? PaintingStyle.INSTANCE.m4978getFillTiuSbCo() : 0));
        return shadowBitmap;
    }
}
