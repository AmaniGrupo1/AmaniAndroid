...
final class AndroidShadowContext implements PlatformShadowContext, DropShadowRendererProvider, InnerShadowRendererProvider {
    ...
    public static final /* data */ class ShadowKey {
        ...
        public static /* synthetic */ ShadowKey m5400copyeZhPAX0$default(ShadowKey shadowKey, Shape shape, long j, LayoutDirection layoutDirection, float f, Shadow shadow, int i, Object obj) {
            if ((i & 1) != 0) {
            ...
            return shadowKey.m5402copyeZhPAX0(shape, j, layoutDirection2, f, shadow2);
        }
        ...
        public final ShadowKey m5402copyeZhPAX0(Shape shape, long size, LayoutDirection layoutDirection, float density, Shadow shadow) {
        ...
        public boolean equals(Object other) {
            ...
            return Intrinsics.areEqual(this.shape, shadowKey.shape) && Size.m4517equalsimpl0(this.size, shadowKey.size) && this.layoutDirection == shadowKey.layoutDirection && Float.compare(this.density, shadowKey.density) == 0 && Intrinsics.areEqual(this.shadow, shadowKey.shadow);
        }

        public int hashCode() {
            return (((((((this.shape.hashCode() * 31) + Size.m4522hashCodeimpl(this.size)) * 31) + this.layoutDirection.hashCode()) * 31) + Float.hashCode(this.density)) * 31) + (this.shadow == null ? 0 : this.shadow.hashCode());
        }

        public String toString() {
            return "ShadowKey(shape=" + this.shape + ", size=" + ((Object) Size.m4525toStringimpl(this.size)) + ", layoutDirection=" + this.layoutDirection + ", density=" + this.density + ", shadow=" + this.shadow + ')';
        }
        ...
        public /* synthetic */ ShadowKey(Shape shape, long j, LayoutDirection layoutDirection, float f, Shadow shadow, int i, DefaultConstructorMarker defaultConstructorMarker) {
            this((i & 1) != 0 ? RectangleShapeKt.getRectangleShape() : shape, (i & 2) != 0 ? Size.INSTANCE.m4530getZeroNHjbRc() : j, (i & 4) != 0 ? LayoutDirection.Ltr : layoutDirection, (i & 8) != 0 ? 1.0f : f, (i & 16) != 0 ? null : shadow, null);
        }
        ...
        public final long m5403getSizeNHjbRc() {
            return this.size;
        }

        /* JADX INFO: renamed from: setSize-uvyYCjk, reason: not valid java name */
        public final void m5404setSizeuvyYCjk(long j) {
            this.size = j;
        }
    ...
    public DropShadowRenderer mo5398obtainDropShadowRenderereZhPAX0(Shape shape, long size, LayoutDirection layoutDirection, Density density, Shadow shadow) throws Throwable {
        ...
        synchronized (this) {
            try {
                ...
                try {
                    ...
                    try {
                        $this$obtainDropShadowRenderer_eZhPAX0_u24lambda_u240_u240.m5404setSizeuvyYCjk(size);
                    } catch (Throwable th) {
                        th = th;
                        throw th;
                    }
            ...
            try {
                ...
                if (renderer == null) {
                    Outline outline = shape.mo320createOutlinePq9zytI(size, layoutDirection, density);
                    try {
                        renderer = new DropShadowRenderer(shadow, outline);
                        obtainDropShadowCache().set(ShadowKey.m5400copyeZhPAX0$default($this$obtainDropShadowRenderer_eZhPAX0_u24lambda_u240_u240, null, 0L, null, 0.0f, null, 31, null), renderer);
                    } catch (Throwable th4) {
                        th = th4;
                        throw th;
                    }
    ...
    public InnerShadowRenderer mo5399obtainInnerShadowRenderereZhPAX0(Shape shape, long size, LayoutDirection layoutDirection, Density density, Shadow shadow) throws Throwable {
        synchronized (this) {
            try {
                ShadowKey $this$obtainInnerShadowRenderer_eZhPAX0_u24lambda_u240_u240 = obtainShadowKey();
                try {
                    $this$obtainInnerShadowRenderer_eZhPAX0_u24lambda_u240_u240.setShape(shape);
                    try {
                        $this$obtainInnerShadowRenderer_eZhPAX0_u24lambda_u240_u240.m5404setSizeuvyYCjk(size);
                        try {
                            ...
                            if (renderer == null) {
                                ...
                                obtainInnerShadowCache().set(ShadowKey.m5400copyeZhPAX0$default($this$obtainInnerShadowRenderer_eZhPAX0_u24lambda_u240_u240, null, 0L, null, 0.0f, null, 31, null), renderer);
                            }
                            return renderer;
                        } catch (Throwable th) {
                            th = th;
