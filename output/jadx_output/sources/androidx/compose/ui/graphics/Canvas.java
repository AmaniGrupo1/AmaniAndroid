...
public interface Canvas {
    ...
    void mo4546clipPathmtrdDE(Path path, int clipOp);

    /* JADX INFO: renamed from: clipRect-N_I0leg */
    void mo4547clipRectN_I0leg(float left, float top, float right, float bottom, int clipOp);

    /* JADX INFO: renamed from: concat-58bKbWc */
    void mo4548concat58bKbWc(float[] matrix);
    ...
    void mo4549drawCircle9KIMszo(long center, float radius, Paint paint);

    /* JADX INFO: renamed from: drawImage-d-4ec7I */
    void mo4550drawImaged4ec7I(ImageBitmap image, long topLeftOffset, Paint paint);

    /* JADX INFO: renamed from: drawImageRect-HPBpro0 */
    void mo4551drawImageRectHPBpro0(ImageBitmap image, long srcOffset, long srcSize, long dstOffset, long dstSize, Paint paint);

    /* JADX INFO: renamed from: drawLine-Wko1d7g */
    void mo4552drawLineWko1d7g(long p1, long p2, Paint paint);
    ...
    void mo4553drawPointsO7TthRY(int pointMode, List<Offset> points, Paint paint);

    /* JADX INFO: renamed from: drawRawPoints-O7TthRY */
    void mo4554drawRawPointsO7TthRY(int pointMode, float[] points, Paint paint);
    ...
    void mo4555drawVerticesTPEHhCM(Vertices vertices, int blendMode, Paint paint);
    ...
    public static final class DefaultImpls {
        ...
        public static void m4675clipRectmtrdDE(Canvas $this, Rect rect, int i) {
            Canvas.super.m4672clipRectmtrdDE(rect, i);
        }
    ...
    static /* synthetic */ void m4670clipRectmtrdDE$default(Canvas canvas, Rect rect, int i, int i2, Object obj) {
        if (obj != null) {
        ...
        canvas.m4672clipRectmtrdDE(rect, i);
    }

    /* JADX INFO: renamed from: clipRect-mtrdD-E, reason: not valid java name */
    default void m4672clipRectmtrdDE(Rect rect, int clipOp) {
        mo4547clipRectN_I0leg(rect.getLeft(), rect.getTop(), rect.getRight(), rect.getBottom(), clipOp);
    }

    /* JADX INFO: renamed from: clipRect-N_I0leg$default, reason: not valid java name */
    static /* synthetic */ void m4669clipRectN_I0leg$default(Canvas canvas, float f, float f2, float f3, float f4, int i, int i2, Object obj) {
        int iM4686getIntersectrtfAjoo;
        if (obj != null) {
            throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: clipRect-N_I0leg");
        }
        if ((i2 & 16) == 0) {
            iM4686getIntersectrtfAjoo = i;
        } else {
            iM4686getIntersectrtfAjoo = ClipOp.INSTANCE.m4686getIntersectrtfAjoo();
        }
        canvas.mo4547clipRectN_I0leg(f, f2, f3, f4, iM4686getIntersectrtfAjoo);
    }

    /* JADX INFO: renamed from: clipPath-mtrdD-E$default, reason: not valid java name */
    static /* synthetic */ void m4668clipPathmtrdDE$default(Canvas canvas, Path path, int i, int i2, Object obj) {
        if (obj != null) {
        ...
        canvas.mo4546clipPathmtrdDE(path, i);
    }
    ...
    static /* synthetic */ void m4671drawImageRectHPBpro0$default(Canvas canvas, ImageBitmap imageBitmap, long j, long j2, long j3, long j4, Paint paint, int i, Object obj) {
        long jM7671constructorimpl;
        if (obj != null) {
            throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: drawImageRect-HPBpro0");
        }
        long jM7644getZeronOccac = (i & 2) != 0 ? IntOffset.INSTANCE.m7644getZeronOccac() : j;
        if ((i & 4) != 0) {
        ...
        canvas.mo4551drawImageRectHPBpro0(imageBitmap, jM7644getZeronOccac, jM7671constructorimpl, (i & 8) != 0 ? IntOffset.INSTANCE.m7644getZeronOccac() : j3, (i & 16) != 0 ? jM7671constructorimpl : j4, paint);
    }
}
