...
@Metadata(d1 = {"\u00000\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0014\n\u0002\b\u000b\n\u0002\u0010\u0007\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\b\u0006\b\u0017\u0018\u0000  2\u00020\u0001:\u0002\u001f B;\b\u0000\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0003\u0012\u0006\u0010\u0005\u001a\u00020\u0003\u0012\u0006\u0010\u0006\u001a\u00020\u0003\u0012\u0006\u0010\u0007\u001a\u00020\b\u0012\b\u0010\t\u001a\u0004\u0018\u00010\n¢\u0006\u0004\b\u000b\u0010\fB!\b\u0010\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0003\u0012\u0006\u0010\r\u001a\u00020\b¢\u0006\u0004\b\u000b\u0010\u000eJ \u0010\t\u001a\u00020\n2\u0006\u0010\u0015\u001a\u00020\u00162\u0006\u0010\u0017\u001a\u00020\u00162\u0006\u0010\u0018\u001a\u00020\u0016H\u0007J\u0012\u0010\t\u001a\u00020\n2\b\b\u0001\u0010\u0019\u001a\u00020\nH\u0017J\u0017\u0010\u001a\u001a\u00020\u001b2\u0006\u0010\u001c\u001a\u00020\u001bH\u0010¢\u0006\u0004\b\u001d\u0010\u001eR\u0011\u0010\u0002\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\u000f\u0010\u0010R\u0011\u0010\u0004\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\u0011\u0010\u0010R\u000e\u0010\u0005\u001a\u00020\u0003X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0006\u001a\u00020\u0003X\u0082\u0004¢\u0006\u0002\n\u0000R\u0013\u0010\u0007\u001a\u00020\b¢\u0006\n\n\u0002\u0010\u0014\u001a\u0004\b\u0012\u0010\u0013R\u0010\u0010\t\u001a\u0004\u0018\u00010\nX\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006!"}, d2 = {"Landroidx/compose/ui/graphics/colorspace/Connector;", "", "source", "Landroidx/compose/ui/graphics/colorspace/ColorSpace;", "destination", "transformSource", "transformDestination", "renderIntent", "Landroidx/compose/ui/graphics/colorspace/RenderIntent;", "transform", "", "<init>", "(Landroidx/compose/ui/graphics/colorspace/ColorSpace;Landroidx/compose/ui/graphics/colorspace/ColorSpace;Landroidx/compose/ui/graphics/colorspace/ColorSpace;Landroidx/compose/ui/graphics/colorspace/ColorSpace;I[FLkotlin/jvm/internal/DefaultConstructorMarker;)V", "intent", "(Landroidx/compose/ui/graphics/colorspace/ColorSpace;Landroidx/compose/ui/graphics/colorspace/ColorSpace;ILkotlin/jvm/internal/DefaultConstructorMarker;)V", "getSource", "()Landroidx/compose/ui/graphics/colorspace/ColorSpace;", "getDestination", "getRenderIntent-uksYyKA", "()I", "I", "r", "", "g", "b", "v", "transformToColor", "Landroidx/compose/ui/graphics/Color;", TtmlNode.ATTR_TTS_COLOR, "transformToColor-l2rxGTc$ui_graphics", "(J)J", "RgbConnector", "Companion", "ui-graphics"}, k = 1, mv = {2, 0, 0}, xi = 48)
public class Connector {
    ...
    private Connector(ColorSpace source, ColorSpace destination, int intent) {
        ...
        ColorSpace colorSpaceAdapt$default2 = ColorModel.m5127equalsimpl0(source.getModel(), ColorModel.INSTANCE.m5134getRgbxdoWZVw()) ? ColorSpaceKt.adapt$default(source, Illuminant.INSTANCE.getD50(), null, 2, null) : source;
        if (ColorModel.m5127equalsimpl0(destination.getModel(), ColorModel.INSTANCE.m5134getRgbxdoWZVw())) {
        ...
        this(source, destination, colorSpaceAdapt$default2, colorSpaceAdapt$default, intent, INSTANCE.m5144computeTransformYBCOT_4(source, destination, intent), null);
    }
    ...
    public long mo5142transformToColorl2rxGTc$ui_graphics(long color) {
        float x;
        float x2;
        float y;
        float r = Color.m4703getRedimpl(color);
        float g = Color.m4702getGreenimpl(color);
        float b = Color.m4700getBlueimpl(color);
        float fM4699getAlphaimpl = Color.m4699getAlphaimpl(color);
    ...
    public static final class RgbConnector extends Connector {
        ...
        private RgbConnector(Rgb mSource, Rgb mDestination, int intent) {
            ...
            this.mTransform = m5145computeTransformYBCOT_4(this.mSource, this.mDestination, intent);
        }
        ...
        public long mo5142transformToColorl2rxGTc$ui_graphics(long color) {
            ...
            float g = Color.m4702getGreenimpl(color);
            float b = Color.m4700getBlueimpl(color);
            float a = Color.m4699getAlphaimpl(color);
        ...
        private final float[] m5145computeTransformYBCOT_4(Rgb source, Rgb destination, int intent) {
            ...
            if (RenderIntent.m5150equalsimpl0(intent, RenderIntent.INSTANCE.m5154getAbsoluteuksYyKA())) {
    ...
    public static final class Companion {
        ...
        /* JADX INFO: renamed from: computeTransform-YBCOT_4, reason: not valid java name */
        public final float[] m5144computeTransformYBCOT_4(ColorSpace source, ColorSpace destination, int intent) {
            if (!RenderIntent.m5150equalsimpl0(intent, RenderIntent.INSTANCE.m5154getAbsoluteuksYyKA())) {
                return null;
            }
            boolean srcRGB = ColorModel.m5127equalsimpl0(source.getModel(), ColorModel.INSTANCE.m5134getRgbxdoWZVw());
            boolean dstRGB = ColorModel.m5127equalsimpl0(destination.getModel(), ColorModel.INSTANCE.m5134getRgbxdoWZVw());
            if (srcRGB && dstRGB) {
                return null;
            }
            if (!srcRGB && !dstRGB) {
        ...
        public final Connector identity$ui_graphics(final ColorSpace source) {
            final int iM5156getRelativeuksYyKA = RenderIntent.INSTANCE.m5156getRelativeuksYyKA();
            return new Connector(source, iM5156getRelativeuksYyKA) { // from class: androidx.compose.ui.graphics.colorspace.Connector$Companion$identity$1
                {
                    super(source, source, iM5156getRelativeuksYyKA, null);
                }
