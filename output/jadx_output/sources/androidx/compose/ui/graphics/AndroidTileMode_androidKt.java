...
public final class AndroidTileMode_androidKt {
    ...
    public static final boolean m4599isSupported0vamqd0(int i) {
        return Build.VERSION.SDK_INT >= 31 || !TileMode.m5088equalsimpl0(i, TileMode.INSTANCE.m5093getDecal3opZhB0());
    }

    /* JADX INFO: renamed from: toAndroidTileMode-0vamqd0, reason: not valid java name */
    public static final Shader.TileMode m4600toAndroidTileMode0vamqd0(int i) {
        if (TileMode.m5088equalsimpl0(i, TileMode.INSTANCE.m5092getClamp3opZhB0())) {
            return Shader.TileMode.CLAMP;
        }
        if (TileMode.m5088equalsimpl0(i, TileMode.INSTANCE.m5095getRepeated3opZhB0())) {
            return Shader.TileMode.REPEAT;
        }
        if (TileMode.m5088equalsimpl0(i, TileMode.INSTANCE.m5094getMirror3opZhB0())) {
            return Shader.TileMode.MIRROR;
        }
        if (TileMode.m5088equalsimpl0(i, TileMode.INSTANCE.m5093getDecal3opZhB0())) {
    ...
    public static final int toComposeTileMode(Shader.TileMode $this$toComposeTileMode) {
        switch (WhenMappings.$EnumSwitchMapping$0[$this$toComposeTileMode.ordinal()]) {
            case 1:
                return TileMode.INSTANCE.m5092getClamp3opZhB0();
            case 2:
                return TileMode.INSTANCE.m5094getMirror3opZhB0();
            case 3:
                return TileMode.INSTANCE.m5095getRepeated3opZhB0();
            default:
                if (Build.VERSION.SDK_INT >= 31 && $this$toComposeTileMode == Shader.TileMode.DECAL) {
                    return TileModeVerificationHelper.INSTANCE.m5096getComposeTileModeDecal3opZhB0();
                }
                return TileMode.INSTANCE.m5092getClamp3opZhB0();
        }
    }
