...
public final class BeyondBoundsLayoutKt {
    ...
    public static final <T> T m4322searchBeyondBoundsOMvw8(FocusTargetNode focusTargetNode, int i, Function1<? super BeyondBoundsLayout.BeyondBoundsScope, ? extends T> function1) {
        T t;
        Modifier.Node node;
        int iM6130getBeforehoxUOeE;
                ...
                while (parent != null) {
                    if ((parent.getKindSet() & i16) != 0) {
                        ...
                        while (nodePop != null) {
                            ...
                            if (((nodePop.getKindSet() & i17) != 0) && (nodePop instanceof DelegatingNode)) {
                                int i18 = 0;
                                ...
                                while (delegate != null) {
                                    ...
                                    iM6460constructorimpl = i11;
                                    i15 = i12;
                                    i16 = i13;
                                }
                                i8 = iM6460constructorimpl;
                                i9 = i15;
                                i10 = i16;
                                if (i18 == 1) {
        ...
        if (FocusDirection.m4327equalsimpl0(i, FocusDirection.INSTANCE.m4338getUpdhqQ8s())) {
            iM6130getBeforehoxUOeE = BeyondBoundsLayout.LayoutDirection.INSTANCE.m6128getAbovehoxUOeE();
        } else if (FocusDirection.m4327equalsimpl0(i, FocusDirection.INSTANCE.m4331getDowndhqQ8s())) {
            iM6130getBeforehoxUOeE = BeyondBoundsLayout.LayoutDirection.INSTANCE.m6131getBelowhoxUOeE();
        } else if (FocusDirection.m4327equalsimpl0(i, FocusDirection.INSTANCE.m4334getLeftdhqQ8s())) {
            iM6130getBeforehoxUOeE = BeyondBoundsLayout.LayoutDirection.INSTANCE.m6132getLefthoxUOeE();
        } else if (FocusDirection.m4327equalsimpl0(i, FocusDirection.INSTANCE.m4337getRightdhqQ8s())) {
            iM6130getBeforehoxUOeE = BeyondBoundsLayout.LayoutDirection.INSTANCE.m6133getRighthoxUOeE();
        } else if (FocusDirection.m4327equalsimpl0(i, FocusDirection.INSTANCE.m4335getNextdhqQ8s())) {
            iM6130getBeforehoxUOeE = BeyondBoundsLayout.LayoutDirection.INSTANCE.m6129getAfterhoxUOeE();
        } else {
            if (!FocusDirection.m4327equalsimpl0(i, FocusDirection.INSTANCE.m4336getPreviousdhqQ8s())) {
                throw new IllegalStateException("Unsupported direction for beyond bounds layout".toString());
            }
            iM6130getBeforehoxUOeE = BeyondBoundsLayout.LayoutDirection.INSTANCE.m6130getBeforehoxUOeE();
        }
        return (T) beyondBoundsLayoutParent.mo973layouto7g1Pn8(iM6130getBeforehoxUOeE, function1);
    }
}
