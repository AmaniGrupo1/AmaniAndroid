...
public interface FocusOwner extends FocusManager {
    ...
    boolean mo4343clearFocusI7lrPNg(boolean force, boolean refreshFocusEvents, boolean clearOwnerFocus, int focusDirection);
    ...
    boolean mo4344dispatchInterceptedSoftKeyboardEventZmokQxo(KeyEvent keyEvent);

    /* JADX INFO: renamed from: dispatchKeyEvent-YhN2O0w, reason: not valid java name */
    boolean mo4345dispatchKeyEventYhN2O0w(KeyEvent keyEvent, Function0<Boolean> onFocusedItem);
    ...
    Boolean mo4346focusSearchULY8qGw(int focusDirection, Rect focusedRect, Function1<? super FocusTargetNode, Boolean> onFound);
    ...
    boolean mo4347moveFocusaToIllA(int focusDirection, boolean wrapAroundForOneDimensionalFocus);

    void releaseFocus();

    /* JADX INFO: renamed from: requestOwnerFocus-7o62pno, reason: not valid java name */
    boolean mo4348requestOwnerFocus7o62pno(FocusDirection focusDirection, Rect previouslyFocusedRect);

    /* JADX INFO: renamed from: resetFocus-3ESFkO8, reason: not valid java name */
    boolean mo4349resetFocus3ESFkO8(int focusDirection);
    ...
    boolean mo4350takeFocusaToIllA(int focusDirection, Rect previouslyFocusedRect);

    /* JADX WARN: Multi-variable type inference failed */
    /* JADX INFO: renamed from: dispatchKeyEvent-YhN2O0w$default, reason: not valid java name */
    static /* synthetic */ boolean m4342dispatchKeyEventYhN2O0w$default(FocusOwner focusOwner, KeyEvent keyEvent, Function0 function0, int i, Object obj) {
        if (obj != null) {
        ...
        return focusOwner.mo4345dispatchKeyEventYhN2O0w(keyEvent, function0);
    }
