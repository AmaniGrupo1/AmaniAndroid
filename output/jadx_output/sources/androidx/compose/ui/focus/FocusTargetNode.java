...
public final class FocusTargetNode extends Modifier.Node implements CompositionLocalConsumerModifierNode, LayoutAwareModifierNode, FocusTargetModifierNode, ObserverModifierNode, ModifierLocalModifierNode {
    ...
    public /* synthetic */ FocusTargetNode(int i, boolean z, Function2 function2, Function1 function1, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this((i2 & 1) != 0 ? Focusability.INSTANCE.m4386getAlwaysLCbbffg() : i, (i2 & 2) != 0 ? false : z, (i2 & 4) != 0 ? null : function2, (i2 & 8) != 0 ? null : function1, null);
    }
                                    ...
                                    if (nodePop instanceof FocusTargetNode) {
                                        ...
                                        if (((this_$iv$iv$iv.getKindSet() & iM6460constructorimpl) != 0 ? 1 : 0) != 0 && (nodePop instanceof DelegatingNode)) {
                                            ...
                                            while (node$iv$iv$iv != null) {
                                                ...
                                                if (((next$iv$iv.getKindSet() & iM6460constructorimpl) != 0 ? i : 0) != 0) {
                                                    count$iv$iv2++;
                                                    if (count$iv$iv2 == i) {
                                                        nodePop = next$iv$iv;
                                                    } else {
    ...
    public /* synthetic */ boolean requestFocus() {
        return mo4361requestFocus3ESFkO8(FocusDirection.INSTANCE.m4332getEnterdhqQ8s());
    }

    @Override // androidx.compose.ui.focus.FocusTargetModifierNode
    /* JADX INFO: renamed from: requestFocus-3ESFkO8 */
    public boolean mo4361requestFocus3ESFkO8(final int focusDirection) {
        ...
        try {
            if (ComposeUiFlags.isRequestFocusOnNonFocusableFocusTargetEnabled) {
                if (fetchFocusProperties$ui().getCanFocus()) {
                    zM4398findChildCorrespondingToFocusEnterOMvw8 = m4366assignFocus3ESFkO8(focusDirection);
                } else {
                    zM4398findChildCorrespondingToFocusEnterOMvw8 = TwoDimensionalFocusSearchKt.m4398findChildCorrespondingToFocusEnterOMvw8(this, focusDirection, new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.focus.FocusTargetNode$requestFocus$1$1
                        ...
                        public final Boolean invoke(FocusTargetNode it) {
                            return Boolean.valueOf(it.m4366assignFocus3ESFkO8(focusDirection));
                        }
                    });
                }
            } else {
                zM4398findChildCorrespondingToFocusEnterOMvw8 = fetchFocusProperties$ui().getCanFocus() && m4366assignFocus3ESFkO8(focusDirection);
            }
            return zM4398findChildCorrespondingToFocusEnterOMvw8;
        } finally {
            Trace.endSection();
        }
    }
    ...
    public final boolean m4366assignFocus3ESFkO8(int focusDirection) {
        switch (WhenMappings.$EnumSwitchMapping$0[FocusTransactionsKt.m4373performCustomRequestFocusMxy_nc0(this, focusDirection).ordinal()]) {
            case 1:
    ...
    public void mo4362setFocusabilityjosRg5g(int i) {
        if (!Focusability.m4382equalsimpl0(this.focusability, i)) {
            this.focusability = i;
            if (getIsAttached() && this == DelegatableNodeKt.requireOwner(this).getFocusOwner().getActiveFocusTargetNode() && !Focusability.m4379canFocusimpl$ui(this.focusability, this)) {
    ...
    public void onReset() {
        if (getFocusState().isFocused()) {
            DelegatableNodeKt.requireOwner(this).getFocusOwner().mo4343clearFocusI7lrPNg(true, true, true, FocusDirection.INSTANCE.m4333getExitdhqQ8s());
        }
    }
    ...
    public void onDetach() {
        ...
        switch (WhenMappings.$EnumSwitchMapping$1[getFocusState().ordinal()]) {
            ...
            case 2:
                ...
                focusOwner.mo4343clearFocusI7lrPNg(true, true, false, FocusDirection.INSTANCE.m4333getExitdhqQ8s());
                if (this.isInteropViewHost) {
                    focusOwner.mo4348requestOwnerFocus7o62pno(null, null);
                }
            ...
            case 3:
                ...
                if (z) {
                    focusOwner2.mo4348requestOwnerFocus7o62pno(null, null);
    ...
    public final FocusProperties fetchFocusProperties$ui() {
        ...
        properties3.setCanFocus(Focusability.m4379canFocusimpl$ui(getFocusability(), this));
        FocusTargetNode $this$visitSelfAndAncestors_u2d5BbP62I$iv3 = this;
        int iM6460constructorimpl = NodeKind.m6460constructorimpl(2048);
        int iM6460constructorimpl2 = NodeKind.m6460constructorimpl(1024);
        Modifier.Node self$iv = $this$visitSelfAndAncestors_u2d5BbP62I$iv3.getNode();
        int mask$iv$iv = iM6460constructorimpl | iM6460constructorimpl2;
            ...
            if ((head$iv$iv.getAggregateChildKindSet() & mask$iv$iv) != 0) {
                while (node$iv$iv != null) {
                    if ((node$iv$iv.getKindSet() & mask$iv$iv) != 0) {
                        Modifier.Node it$iv = node$iv$iv;
                        if (it$iv != self$iv) {
                            if (((it$iv.getKindSet() & iM6460constructorimpl2) != 0 ? 1 : 0) != 0) {
                                properties = properties3;
                                break loop0;
                            }
                        }
                        if (((it$iv.getKindSet() & iM6460constructorimpl) != 0 ? 1 : 0) != 0) {
                            ...
                            while (this_$iv$iv$iv2 != null) {
                                ...
                                if (this_$iv$iv$iv2 instanceof FocusPropertiesModifierNode) {
                                    ...
                                    $this$visitSelfAndAncestors_u2d5BbP62I$iv2 = $this$visitSelfAndAncestors_u2d5BbP62I$iv3;
                                    if (((this_$iv$iv$iv2.getKindSet() & i7) != 0 ? 1 : 0) == 0 || !(this_$iv$iv$iv2 instanceof DelegatingNode)) {
                                        i3 = iM6460constructorimpl;
                                        i4 = iM6460constructorimpl2;
                                    } else {
                                        int count$iv$iv2 = 0;
    ...
    public final Rect fetchFocusRect$ui(LayoutCoordinates relativeCoordinates) {
        ...
        return customRect != FocusProperties.INSTANCE.getUnsetFocusRect() ? relativeCoordinates == null ? customRect : customRect.m4489translatek4lQ0M(LayoutCoordinates.m6148localPositionOfS_NoaFU$default(relativeCoordinates, DelegatableNodeKt.requireLayoutCoordinates(this), 0L, false, 6, null)) : (relativeCoordinates == null || (rectLocalBoundingBoxOf = relativeCoordinates.localBoundingBoxOf(DelegatableNodeKt.requireLayoutCoordinates(this), false)) == null) ? RectKt.m4492Recttz77jQw(Offset.INSTANCE.m4468getZeroF1C5BW0(), IntSizeKt.m7688toSizeozmzZPI(DelegatableNodeKt.requireLayoutCoordinates(this).mo6149getSizeYbymL2g())) : rectLocalBoundingBoxOf;
    }

    /* JADX INFO: renamed from: fetchCustomEnterOrExit-ULY8qGw, reason: not valid java name */
    private final void m4367fetchCustomEnterOrExitULY8qGw(int focusDirection, Function1<? super FocusRequester, Unit> block, Function2<? super FocusProperties, ? super FocusEnterExitScope, Unit> enterOrExit) {
    ...
    public final void m4368fetchCustomEnteraToIllA$ui(int focusDirection, Function1<? super FocusRequester, Unit> block) {
    ...
    public final void m4369fetchCustomExitaToIllA$ui(int focusDirection, Function1<? super FocusRequester, Unit> block) {
    ...
    public final void dispatchFocusCallbacks$ui(FocusState previousState, FocusState newState) {
        ...
        int iM6460constructorimpl = NodeKind.m6460constructorimpl(4096);
        int iM6460constructorimpl2 = NodeKind.m6460constructorimpl(1024);
                        ...
                        if (((it$iv.getKindSet() & iM6460constructorimpl) != 0 ? 1 : 0) != 0) {
                            ...
                            while (it$iv2 != null) {
                                ...
                                if (it$iv2 instanceof FocusEventModifierNode) {
                                    ...
                                    if (((this_$iv$iv$iv.getKindSet() & iM6460constructorimpl) != 0 ? 1 : 0) == 0 || !(it$iv2 instanceof DelegatingNode)) {
                                        activeNode2 = activeNode4;
                                    } else {
                                        int count$iv$iv = 0;
