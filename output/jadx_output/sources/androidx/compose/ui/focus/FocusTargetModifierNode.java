...
public interface FocusTargetModifierNode extends DelegatableNode {
    ...
    int mo4360getFocusabilityLCbbffg();
    ...
    boolean mo4361requestFocus3ESFkO8(int focusDirection);

    /* JADX INFO: renamed from: setFocusability-josRg5g, reason: not valid java name */
    void mo4362setFocusabilityjosRg5g(int i);

    /* JADX INFO: renamed from: requestFocus-3ESFkO8$default, reason: not valid java name */
    static /* synthetic */ boolean m4359requestFocus3ESFkO8$default(FocusTargetModifierNode focusTargetModifierNode, int i, int i2, Object obj) {
        if (obj != null) {
        ...
        return focusTargetModifierNode.mo4361requestFocus3ESFkO8(i);
    }
}
