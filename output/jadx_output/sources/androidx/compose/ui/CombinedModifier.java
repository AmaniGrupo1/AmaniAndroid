...
public final class CombinedModifier implements Modifier {
    ...
    public String toString() {
        return AbstractJsonLexerKt.BEGIN_LIST + ((String) foldIn("", new Function2<String, Modifier.Element, String>() { // from class: androidx.compose.ui.CombinedModifier.toString.1
