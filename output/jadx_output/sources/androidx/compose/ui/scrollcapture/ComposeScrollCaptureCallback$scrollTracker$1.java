    ...
    public final Object invokeSuspend(Object obj) {
        ...
        switch (this.label) {
            case 0:
                ...
                Offset offsetM4441boximpl = Offset.m4441boximpl(Offset.m4444constructorimpl((v1$iv$iv << 32) | (v2$iv$iv & 4294967295L)));
                this.Z$0 = reverseScrolling;
                this.label = 1;
                Object objInvoke = scrollCaptureScrollByAction.invoke(offsetM4441boximpl, this);
        ...
        long jM4462unboximpl = ((Offset) $result).m4462unboximpl();
        if (reverseScrolling) {
            int bits$iv$iv$iv = (int) (jM4462unboximpl & j);
            fIntBitsToFloat = -Float.intBitsToFloat(bits$iv$iv$iv);
        } else {
            int bits$iv$iv$iv2 = (int) (jM4462unboximpl & j);
