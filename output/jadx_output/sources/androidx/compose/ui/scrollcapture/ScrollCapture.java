...
public final class ScrollCapture implements ComposeScrollCaptureCallback.ScrollCaptureSessionListener {
    ...
    public final void onScrollCaptureSearch(View view, SemanticsOwner semanticsOwner, CoroutineContext coroutineContext, Consumer<ScrollCaptureTarget> targets) {
        ...
        long windowOffsetOfCandidate = candidate.getViewportBoundsInWindow().m7662getTopLeftnOccac();
        ScrollCaptureTarget $this$onScrollCaptureSearch_u24lambda_u241 = new ScrollCaptureTarget(view, RectHelper_androidKt.toAndroidRect(IntRectKt.roundToIntRect(localVisibleRectOfCandidate)), new Point(IntOffset.m7633getXimpl(windowOffsetOfCandidate), IntOffset.m7634getYimpl(windowOffsetOfCandidate)), callback);
