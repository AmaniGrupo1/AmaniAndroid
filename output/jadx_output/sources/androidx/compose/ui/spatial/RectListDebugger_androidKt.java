...
public final class RectListDebugger_androidKt {
    public static final void RectListDebugger(Modifier modifier, Composer $composer, final int $changed, final int i) {
        ...
        ComposerKt.sourceInformation($composer3, "C(RectListDebugger)39@1564L78:RectListDebugger.android.kt#2zyoiz");
        int $dirty = $changed;
        int i2 = i & 1;
        if (i2 != 0) {
            $dirty |= 6;
        ...
        if (!$composer3.shouldExecute(($dirty & 3) != 2, $dirty & 1)) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(949081399, $dirty, -1, "androidx.compose.ui.spatial.RectListDebugger (RectListDebugger.android.kt:38)");
            }
