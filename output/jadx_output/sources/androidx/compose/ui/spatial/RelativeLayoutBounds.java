...
public final class RelativeLayoutBounds {
    ...
    public final long m6728getPositionInRootnOccac() {
        return IntOffset.m7627constructorimpl(this.topLeft);
    }

    /* JADX INFO: renamed from: getPositionInWindow-nOcc-ac, reason: not valid java name */
    public final long m6730getPositionInWindownOccac() {
        int x = IntOffset.m7633getXimpl(this.screenOffset) - IntOffset.m7633getXimpl(this.windowOffset);
        int y = IntOffset.m7634getYimpl(this.screenOffset) - IntOffset.m7634getYimpl(this.windowOffset);
    ...
    public final long m6729getPositionInScreennOccac() {
        int x = IntOffset.m7633getXimpl(this.screenOffset);
        int y = IntOffset.m7634getYimpl(this.screenOffset);
        long xy$iv = this.topLeft;
        int l = (int) (xy$iv >> 32);
        long xy$iv2 = this.topLeft;
        int t = (int) xy$iv2;
    ...
    public final IntRect getBoundsInWindow() {
        ...
        if (this.viewToWindowMatrix != null) {
            return IntRectKt.roundToIntRect(Matrix.m4948mapimpl(this.viewToWindowMatrix, new Rect(l, t, $i$f$unpackX, b)));
        }
        int x = IntOffset.m7633getXimpl(this.screenOffset) - IntOffset.m7633getXimpl(this.windowOffset);
        int y = IntOffset.m7634getYimpl(this.screenOffset) - IntOffset.m7634getYimpl(this.windowOffset);
    ...
    public final IntRect getBoundsInScreen() {
        if (this.viewToWindowMatrix != null) {
            ...
            return new IntRect(windowRect.getLeft() + IntOffset.m7633getXimpl(offset), windowRect.getTop() + IntOffset.m7634getYimpl(offset), windowRect.getRight() + IntOffset.m7633getXimpl(offset), windowRect.getBottom() + IntOffset.m7634getYimpl(offset));
        }
        long xy$iv = this.topLeft;
        int l = (int) (xy$iv >> 32);
        long xy$iv2 = this.topLeft;
    ...
    public final float m6727fractionVisibleInWindowWithInsetsE1MhUcY(long topLeftInset, long bottomRightInset) {
        long windowSize = this.windowSize;
        int x = IntOffset.m7633getXimpl(this.windowOffset);
        int y = IntOffset.m7634getYimpl(this.windowOffset);
        return fractionVisibleInRect(IntOffset.m7633getXimpl(topLeftInset) + x, IntOffset.m7634getYimpl(topLeftInset) + y, (((int) (windowSize >> 32)) + x) - IntOffset.m7633getXimpl(bottomRightInset), (((int) windowSize) + y) - IntOffset.m7634getYimpl(bottomRightInset));
    }
    ...
    */
    public boolean equals(Object other) {
        ...
        if (this.topLeft != ((RelativeLayoutBounds) other).topLeft || this.bottomRight != ((RelativeLayoutBounds) other).bottomRight || this.windowSize != ((RelativeLayoutBounds) other).windowSize || !IntOffset.m7632equalsimpl0(this.windowOffset, ((RelativeLayoutBounds) other).windowOffset) || !IntOffset.m7632equalsimpl0(this.screenOffset, ((RelativeLayoutBounds) other).screenOffset)) {
            return false;
        }
        ...
        if (fArr == null) {
            if (fArr2 == null) {
                zM4943equalsimpl0 = true;
            } else {
                zM4943equalsimpl0 = false;
            }
        } else if (fArr2 != null) {
            zM4943equalsimpl0 = Matrix.m4943equalsimpl0(fArr, fArr2);
        }
        if (zM4943equalsimpl0 && Intrinsics.areEqual(this.node, ((RelativeLayoutBounds) other).node)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        int result2 = ((((((((result * 31) + Long.hashCode(this.bottomRight)) * 31) + Long.hashCode(this.windowSize)) * 31) + IntOffset.m7635hashCodeimpl(this.windowOffset)) * 31) + IntOffset.m7635hashCodeimpl(this.screenOffset)) * 31;
        float[] fArr = this.viewToWindowMatrix;
        return ((result2 + (fArr != null ? Matrix.m4945hashCodeimpl(fArr) : 0)) * 31) + this.node.hashCode();
    }
}
