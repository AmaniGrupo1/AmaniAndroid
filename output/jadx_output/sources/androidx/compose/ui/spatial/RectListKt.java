...
public final class RectListKt {
    ...
    private static final long EverythingButLastChildOffset = ULong.m8716constructorimpl(ULong.m8716constructorimpl(ULong.m8716constructorimpl(1023) << 50) ^ (-1));
    private static final long EverythingButParentId = ULong.m8716constructorimpl((-1) ^ ULong.m8716constructorimpl(ULong.m8716constructorimpl(33554431) << 25));
    private static final long TombStone = ((long) ((-1) & 33554431)) | ((((long) ((-1) & 33554431)) << 25) | ((((long) Math.min(0, 1023)) << 50) | 0));
    ...
    public static final long metaMarkFlags(long meta, boolean focusable, boolean gesturable) {
        return ((-2305843009213693953L) & meta & (-4611686018427387905L)) | (((long) (focusable ? 1 : 0)) * LockFreeTaskQueueCore.CLOSED_MASK) | (((long) (gesturable ? 1 : 0)) * 4611686018427387904L);
    }
