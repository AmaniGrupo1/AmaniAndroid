...
public final class RectList {
    ...
    public final void insert(int value, int l, int t, int r, int b, int parentId, boolean focusable, boolean gesturable, boolean hasCallbacks, int parentIndexInRectList) {
        ...
        items[currentSize$iv + 2] = (((long) (gesturable ? 1 : 0)) << 62) | (((long) (hasCallbacks ? 1 : 0)) << 63) | (((long) (focusable ? 1 : 0)) << 61) | (((long) 1) << 60) | (((long) Math.min(0, 1023)) << 50) | (((long) (parentId & 33554431)) << 25) | ((long) (value2 & 33554431));
        if (parentId < 0) {
            return;
        }
    ...
    public final boolean updateFlagsFor(int value, boolean focusable, boolean gesturable) {
        ...
        for (int i = 0; i < items.length - 2 && i < size; i += 3) {
            ...
            if ($i$f$unpackMetaValue == value2) {
                items[i + 2] = (((long) (focusable ? 1 : 0)) * LockFreeTaskQueueCore.CLOSED_MASK) | ((-2305843009213693953L) & meta & (-4611686018427387905L)) | (((long) (gesturable ? 1 : 0)) * 4611686018427387904L);
                return true;
            }
        }
        return false;
    ...
    */
    public final void moveBasedOnParentOffset(int value, int parentId, int offsetFromParentX, int offsetFromParentY, int width, int height) {
        ...
        int i2;
        int i3 = 33554431;
        int value3 = value & 33554431;
        long[] items2 = this.items;
        int size2 = this.itemsSize;
        int i4 = 0;
        while (i4 < items2.length - 2 && i4 < size2) {
            if ((((int) items2[i4 + 2]) & i3) != parentId) {
                i = i3;
                value2 = value3;
                items = items2;
                size = size2;
            } else {
                long parentLT = items2[i4 + 0];
                int $i$f$unpackX = (int) (parentLT >> 32);
                int parentY = (int) parentLT;
                int l = $i$f$unpackX + offsetFromParentX;
                int t = parentY + offsetFromParentY;
                int r = l + width;
                int b = t + height;
                int i5 = i4 + 3;
                while (true) {
                    i = i3;
                    if (i5 >= items2.length - 2) {
                        value2 = value3;
                        items = items2;
                        size = size2;
                        i2 = i5;
                    ...
                    long meta = items2[i5 + 2];
                    long[] items3 = items2;
                    int size3 = size2;
                    int $i$f$unpackMetaValue = (int) meta;
                    if (($i$f$unpackMetaValue & i) == value3) {
                        long oldLT = items3[i5 + 0];
                        int oldL = (int) (oldLT >> 32);
                        int deltaX = l - oldL;
                        int oldT = t - ((int) oldLT);
                        int x$iv = i5;
                        items3[i5 + 0] = (((long) l) << 32) | (((long) t) & 4294967295L);
                        items3[x$iv + 1] = (((long) r) << 32) | (((long) b) & 4294967295L);
                        long meta$iv = meta | (((meta >> 63) & 1) << 60);
                        items3[x$iv + 2] = meta$iv;
                        if (deltaX != 0 || oldT != 0) {
                            int parentId$iv = x$iv + 3;
                            long meta$iv2 = parentId$iv & i;
                            updateSubhierarchy((meta & RectListKt.getEverythingButParentId()) | (meta$iv2 << 25), deltaX, oldT);
                            return;
                        }
                        return;
                    }
    ...
    public final String debugString() {
        ...
        while (r < items.length - 2 && r < size) {
            ...
            StringBuilder sbAppend = $this$debugString_u24lambda_u240.append("id=" + id + ", rect=[" + l + AbstractJsonLexerKt.COMMA + $i$f$unpackY + AbstractJsonLexerKt.COMMA + r2 + AbstractJsonLexerKt.COMMA + b + "], parent=" + parentId + ", lastChildOffset=" + lastChildOffset + ", updated=" + updated + ", focusable=" + focusable + ", gesturable=" + gesturable);
        ...
        String string = $this$debugString_u24lambda_u240.toString();
