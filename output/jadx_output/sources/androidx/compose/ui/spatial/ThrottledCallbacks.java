...
public final class ThrottledCallbacks {
    ...
    private long windowOffset = IntOffset.INSTANCE.m7644getZeronOccac();
    private long screenOffset = IntOffset.INSTANCE.m7644getZeronOccac();
    ...
    public final class Entry implements DelegatableNode.RegistrationHandle {
        ...
        public final void m6740fire9b9wPM(long topLeft, long bottomRight, long windowOffset, long screenOffset, float[] viewToWindowMatrix) {
            RelativeLayoutBounds rect = ThrottledCallbacksKt.m6741rectInfoForDg36KO4(this.node, topLeft, bottomRight, windowOffset, screenOffset, ThrottledCallbacks.this.getWindowSize(), viewToWindowMatrix);
            if (rect == null) {
                return;
            }
    ...
    public final void m6738setWindowOffsetgyyYBs(long j) {
        this.windowOffset = j;
    }
    ...
    public final void m6736setScreenOffsetgyyYBs(long j) {
        this.screenOffset = j;
    }
    ...
    public final void m6737setViewToWindowMatrixQ8lPUPs(float[] fArr) {
        this.viewToWindowMatrix = fArr;
    }

    /* JADX INFO: renamed from: updateOffsets-LDcG7Xg, reason: not valid java name */
    public final boolean m6739updateOffsetsLDcG7Xg(long screen, long window, float[] matrix, int windowWidth, int windowHeight) {
        boolean updated = false;
        if (!IntOffset.m7632equalsimpl0(window, this.windowOffset)) {
            this.windowOffset = window;
            updated = true;
        }
        if (!IntOffset.m7632equalsimpl0(screen, this.screenOffset)) {
                ...
                while (j$iv$iv$iv < bitCount$iv$iv$iv2) {
                    ...
                    if (value$iv$iv$iv$iv < 128) {
                        ...
                        while (entry$iv != null) {
                            ...
                            m6732fireWY9HvpM(entry, windowOffset4, screenOffset, viewToWindowMatrix, currentMillis);
    ...
    public final void fireGlobalChangeEntries(long currentMillis) {
        ...
        while (node$iv != null) {
            ...
            long offsetFromRoot = LayoutNodeKt.requireOwner(node).getRectManager().m6721getOffsetFromRectListForBjo55l4(node);
            long lastSize = node.getLastSize();
            entry2.setTopLeft(offsetFromRoot);
            long windowOffset2 = windowOffset;
            long windowOffset3 = lastSize >> 32;
            int x$iv = IntOffset.m7633getXimpl(offsetFromRoot) + ((int) windowOffset3);
            int y$iv = IntOffset.m7634getYimpl(offsetFromRoot) + ((int) (lastSize & 4294967295L));
            long screenOffset2 = screenOffset;
            long screenOffset3 = x$iv;
            entry2.setBottomRight((screenOffset3 << 32) | (((long) y$iv) & 4294967295L));
            screenOffset = screenOffset2;
            windowOffset = windowOffset2;
            throttledCallbacks.m6732fireWY9HvpM(entry2, windowOffset, screenOffset, viewToWindowMatrix, currentMillis);
    ...
    public final void triggerDebounced(long currentMillis) {
                    ...
                    while (j$iv$iv$iv2 < bitCount$iv$iv$iv2) {
                        ...
                        if (!(value$iv$iv$iv$iv < 128)) {
                            ...
                            while (entry$iv != null) {
                                ...
                                minDeadline = m6731debounceEntryb8qMvQI(entry, windowOffset4, screenOffset, viewToWindowMatrix, currentMillis, minDeadline);
                                entry$iv = entry$iv.getNext();
        ...
        if (entry2 != null) {
            ...
            for (Entry node$iv = entry2; node$iv != null; node$iv = node$iv.getNext()) {
                ...
                minDeadline2 = throttledCallbacks.m6731debounceEntryb8qMvQI(entry3, windowOffset2, screenOffset, viewToWindowMatrix, currentMillis, minDeadline2);
            }
    ...
    public final void fireWithUpdatedRect$ui(Entry entry, long topLeft, long bottomRight, long currentMillis) {
        ...
        if (pastThrottleDeadline && canInvoke) {
            ...
            entry.m6740fire9b9wPM(topLeft, bottomRight, this.windowOffset, this.screenOffset, this.viewToWindowMatrix);
    ...
    private final void m6732fireWY9HvpM(Entry entry, long windowOffset, long screenOffset, float[] viewToWindowMatrix, long currentMillis) {
        long lastInvokeMillis = entry.getLastInvokeMillis();
        ...
        if (throttleOkay && debounceOkay) {
            entry.setLastInvokeMillis(currentMillis);
            entry.m6740fire9b9wPM(entry.getTopLeft(), entry.getBottomRight(), windowOffset, screenOffset, viewToWindowMatrix);
        }
        if (!debounceOkay) {
            long currentMinDeadline = this.minDebounceDeadline;
    ...
    private final long m6731debounceEntryb8qMvQI(Entry entry, long windowOffset, long screenOffset, float[] viewToWindowMatrix, long currentMillis, long minDeadline) {
        ...
        if (currentMillis - entry.getLastUninvokedFireMillis() >= entry.getDebounceMillis()) {
            ...
            entry.m6740fire9b9wPM(topLeft, bottomRight, windowOffset, screenOffset, viewToWindowMatrix);
            return minDeadline;
        }
    ...
    public final boolean multiRemove(MutableIntObjectMap<Entry> mutableIntObjectMap, int key, Entry value) {
        ...
        if (Intrinsics.areEqual(result, value)) {
            ...
            if (next != null) {
                ...
                LayoutNode layoutNode = DelegatableNodeKt.requireLayoutNode(value.getNode().getNode());
                if (layoutNode.getAddedToRectList()) {
                    LayoutNodeKt.requireOwner(layoutNode).getRectManager().unsetHasCallbacksFor(layoutNode);
                }
            }
            return true;
        }
