...
public class AndroidViewHolder extends ViewGroup implements NestedScrollingParent3, ComposeNodeLifecycleCallback, OwnerScope, OnApplyWindowInsetsListener {
    ...
    public AndroidViewHolder(Context context, CompositionContext parentContext, int compositeKeyHash, NestedScrollDispatcher dispatcher, View view, Owner owner) {
        ...
        final Modifier coreModifier = OnGloballyPositionedModifierKt.onGloballyPositioned(DrawModifierKt.drawBehind(PointerInteropFilter_androidKt.pointerInteropFilter(SemanticsModifierKt.semantics(NestedScrollModifierKt.nestedScroll(Modifier.INSTANCE, AndroidViewHolder_androidKt.NoOpScrollConnection, $this$layoutNode_u24lambda_u240.dispatcher), true, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.ui.viewinterop.AndroidViewHolder$layoutNode$1$coreModifier$1
        ...
        }), $this$layoutNode_u24lambda_u240), new Function1<DrawScope, Unit>() { // from class: androidx.compose.ui.viewinterop.AndroidViewHolder$layoutNode$1$coreModifier$2
            ...
            public final void invoke2(LayoutCoordinates it) {
                ...
                this.$this_run.size = it.mo6149getSizeYbymL2g();
                WindowInsetsCompat previouslyDispatchedInsets = this.$this_run.insets;
                if (previouslyDispatchedInsets != null) {
                    if ((previousX == this.$this_run.position[0] && previousY == this.$this_run.position[1] && IntSize.m7674equalsimpl0(oldSize, this.$this_run.size)) || (translatedInsets = this.$this_run.insetToLayoutPosition(previouslyDispatchedInsets).toWindowInsets()) == null) {
                        return;
                    }
        ...
        layoutNode.setCompositeKeyHash($this$layoutNode_u24lambda_u240.compositeKeyHash);
        layoutNode.setModifier($this$layoutNode_u24lambda_u240.modifier.then(coreModifier));
        $this$layoutNode_u24lambda_u240.onModifierChanged = new Function1<Modifier, Unit>() { // from class: androidx.compose.ui.viewinterop.AndroidViewHolder$layoutNode$1$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
        ...
        layoutNode.setDensity($this$layoutNode_u24lambda_u240.density);
        $this$layoutNode_u24lambda_u240.onDensityChanged = new Function1<Density, Unit>() { // from class: androidx.compose.ui.viewinterop.AndroidViewHolder$layoutNode$1$2
            {
                super(1);
            }
        ...
        layoutNode.setMeasurePolicy(new MeasurePolicy() { // from class: androidx.compose.ui.viewinterop.AndroidViewHolder$layoutNode$1$5
            ...
            public MeasureResult mo41measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, List<? extends Measurable> list, long j) {
                if (this.$this_run.getChildCount() == 0) {
                    return MeasureScope.layout$default($this$measure_u2d3p2s80s, Constraints.m7460getMinWidthimpl(j), Constraints.m7459getMinHeightimpl(j), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.viewinterop.AndroidViewHolder$layoutNode$1$5$measure$1
                        @Override // kotlin.jvm.functions.Function1
                ...
                if (Constraints.m7460getMinWidthimpl(j) != 0) {
                    this.$this_run.getChildAt(0).setMinimumWidth(Constraints.m7460getMinWidthimpl(j));
                }
                if (Constraints.m7459getMinHeightimpl(j) != 0) {
                    this.$this_run.getChildAt(0).setMinimumHeight(Constraints.m7459getMinHeightimpl(j));
                }
                AndroidViewHolder androidViewHolder = this.$this_run;
                ...
                int iObtainMeasureSpec = androidViewHolder2.obtainMeasureSpec(iM7460getMinWidthimpl, iM7458getMaxWidthimpl, layoutParams.width);
                ...
                androidViewHolder.measure(iObtainMeasureSpec, androidViewHolder3.obtainMeasureSpec(iM7459getMinHeightimpl, iM7457getMaxHeightimpl, layoutParams2.height));
            ...
            private final int intrinsicHeight(int width) {
                ...
                ViewGroup.LayoutParams layoutParams = this.$this_run.getLayoutParams();
                Intrinsics.checkNotNull(layoutParams);
                androidViewHolder.measure(androidViewHolder2.obtainMeasureSpec(0, width, layoutParams.width), View.MeasureSpec.makeMeasureSpec(0, 0));
    ...
    public void onNestedScroll(View target, int dxConsumed, int dyConsumed, int dxUnconsumed, int dyUnconsumed, int type, int[] consumed) {
        if (isNestedScrollingEnabled()) {
            ...
            long jM4444constructorimpl2 = Offset.m4444constructorimpl((v1$iv$iv2 << 32) | (v2$iv$iv2 & 4294967295L));
            int $i$f$Offset = AndroidViewHolder_androidKt.toNestedScrollSource(type);
            long consumedByParent = nestedScrollDispatcher.m5872dispatchPostScrollDzOQY0M(jM4444constructorimpl, jM4444constructorimpl2, $i$f$Offset);
    ...
    public void onNestedScroll(View target, int dxConsumed, int dyConsumed, int dxUnconsumed, int dyUnconsumed, int type) {
        if (isNestedScrollingEnabled()) {
            ...
            long v1$iv$iv2 = Float.floatToRawIntBits(x$iv2);
            long v2$iv$iv2 = Float.floatToRawIntBits(y$iv2);
            long jM4444constructorimpl2 = Offset.m4444constructorimpl((v1$iv$iv2 << 32) | (4294967295L & v2$iv$iv2));
            int $i$f$Offset = AndroidViewHolder_androidKt.toNestedScrollSource(type);
            nestedScrollDispatcher.m5872dispatchPostScrollDzOQY0M(jM4444constructorimpl, jM4444constructorimpl2, $i$f$Offset);
        }
    }
    ...
    public void onNestedPreScroll(View target, int dx, int dy, int[] consumed, int type) {
        if (isNestedScrollingEnabled()) {
            ...
            long jM4444constructorimpl = Offset.m4444constructorimpl((v1$iv$iv << 32) | (v2$iv$iv & 4294967295L));
            int $i$f$Offset = AndroidViewHolder_androidKt.toNestedScrollSource(type);
            long consumedByParent = nestedScrollDispatcher.m5874dispatchPreScrollOzD1aCk(jM4444constructorimpl, $i$f$Offset);
            int bits$iv$iv$iv = (int) (consumedByParent >> 32);
            consumed[0] = NestedScrollInteropConnectionKt.composeToViewOffset(Float.intBitsToFloat(bits$iv$iv$iv));
            int bits$iv$iv$iv2 = (int) (consumedByParent & 4294967295L);
            consumed[1] = NestedScrollInteropConnectionKt.composeToViewOffset(Float.intBitsToFloat(bits$iv$iv$iv2));
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    if (!z) {
                        this.label = 1;
                        Object objM5871dispatchPostFlingRZ2iAVY = androidViewHolder.dispatcher.m5871dispatchPostFlingRZ2iAVY(Velocity.INSTANCE.m7754getZero9UxMQ8M(), this.$viewVelocity, this);
                        if (objM5871dispatchPostFlingRZ2iAVY == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                        $result = objM5871dispatchPostFlingRZ2iAVY;
                        ((Velocity) $result).getPackedValue();
                        return Unit.INSTANCE;
                    }
                    this.label = 2;
                    Object objM5871dispatchPostFlingRZ2iAVY2 = androidViewHolder.dispatcher.m5871dispatchPostFlingRZ2iAVY(this.$viewVelocity, Velocity.INSTANCE.m7754getZero9UxMQ8M(), this);
                    if (objM5871dispatchPostFlingRZ2iAVY2 == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    $result = objM5871dispatchPostFlingRZ2iAVY2;
                    ((Velocity) $result).getPackedValue();
                    return Unit.INSTANCE;
                case 1:
                    ResultKt.throwOnFailure($result);
    ...
    public boolean onNestedPreFling(View target, float velocityX, float velocityY) {
        ...
        BuildersKt__Builders_commonKt.launch$default(this.dispatcher.getCoroutineScope(), null, null, new C05791(toBeConsumed, null), 3, null);
        return false;
    }
    ...
    static final class C05791 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C05791(long j, Continuation<? super C05791> continuation) {
            super(2, continuation);
            this.$toBeConsumed = j;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return AndroidViewHolder.this.new C05791(this.$toBeConsumed, continuation);
        }
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            switch (this.label) {
                case 0:
                    ResultKt.throwOnFailure($result);
                    this.label = 1;
                    if (AndroidViewHolder.this.dispatcher.m5873dispatchPreFlingQWom1Mo(this.$toBeConsumed, this) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    break;
                case 1:
    ...
    public final WindowInsetsCompat insetToLayoutPosition(WindowInsetsCompat insets) {
        ...
        long topLeft$iv = IntOffsetKt.m7650roundk4lQ0M(LayoutCoordinatesKt.positionInRoot(coordinates$iv));
        int $this$fastCoerceAtLeast$iv$iv = IntOffset.m7633getXimpl(topLeft$iv);
        if ($this$fastCoerceAtLeast$iv$iv < 0) {
            $this$fastCoerceAtLeast$iv$iv = 0;
        }
        int $this$fastCoerceAtLeast$iv$iv2 = IntOffset.m7634getYimpl(topLeft$iv);
        if ($this$fastCoerceAtLeast$iv$iv2 < 0) {
            $this$fastCoerceAtLeast$iv$iv2 = 0;
        }
        long jMo6149getSizeYbymL2g = LayoutCoordinatesKt.findRootCoordinates(coordinates$iv).mo6149getSizeYbymL2g();
        int rootWidth$iv = (int) (jMo6149getSizeYbymL2g >> 32);
        int rootHeight$iv = (int) (jMo6149getSizeYbymL2g & 4294967295L);
        long jMo6149getSizeYbymL2g2 = coordinates$iv.mo6149getSizeYbymL2g();
        int width$iv = (int) (jMo6149getSizeYbymL2g2 >> 32);
        int height$iv = (int) (jMo6149getSizeYbymL2g2 & 4294967295L);
        ...
        long bottomRight$iv = IntOffsetKt.m7650roundk4lQ0M(coordinates$iv.mo6152localToRootMKHz9U(Offset.m4444constructorimpl((v1$iv$iv$iv << 32) | (v2$iv$iv$iv & 4294967295L))));
        int $this$fastCoerceAtLeast$iv$iv3 = rootWidth$iv - IntOffset.m7633getXimpl(bottomRight$iv);
        if ($this$fastCoerceAtLeast$iv$iv3 < 0) {
            $this$fastCoerceAtLeast$iv$iv3 = 0;
        }
        int $this$fastCoerceAtLeast$iv$iv4 = rootHeight$iv - IntOffset.m7634getYimpl(bottomRight$iv);
    ...
    private final <T> T insetValue(T value, Function4<? super Integer, ? super Integer, ? super Integer, ? super Integer, ? extends T> block) {
        ...
        long topLeft = IntOffsetKt.m7650roundk4lQ0M(LayoutCoordinatesKt.positionInRoot(coordinates));
        int $this$fastCoerceAtLeast$iv = IntOffset.m7633getXimpl(topLeft);
        if ($this$fastCoerceAtLeast$iv < 0) {
            $this$fastCoerceAtLeast$iv = 0;
        }
        int $this$fastCoerceAtLeast$iv2 = IntOffset.m7634getYimpl(topLeft);
        if ($this$fastCoerceAtLeast$iv2 < 0) {
            $this$fastCoerceAtLeast$iv2 = 0;
        }
        long jMo6149getSizeYbymL2g = LayoutCoordinatesKt.findRootCoordinates(coordinates).mo6149getSizeYbymL2g();
        int rootWidth = (int) (jMo6149getSizeYbymL2g >> 32);
        int rootHeight = (int) (jMo6149getSizeYbymL2g & 4294967295L);
        long jMo6149getSizeYbymL2g2 = coordinates.mo6149getSizeYbymL2g();
        int width = (int) (jMo6149getSizeYbymL2g2 >> 32);
        int height = (int) (jMo6149getSizeYbymL2g2 & 4294967295L);
        float x$iv = width;
        float y$iv = height;
        long v1$iv$iv = Float.floatToRawIntBits(x$iv);
        long v2$iv$iv = Float.floatToRawIntBits(y$iv);
        long bottomRight = IntOffsetKt.m7650roundk4lQ0M(coordinates.mo6152localToRootMKHz9U(Offset.m4444constructorimpl((v1$iv$iv << 32) | (4294967295L & v2$iv$iv))));
        int $this$fastCoerceAtLeast$iv3 = rootWidth - IntOffset.m7633getXimpl(bottomRight);
        if ($this$fastCoerceAtLeast$iv3 < 0) {
            $this$fastCoerceAtLeast$iv3 = 0;
        }
        int $this$fastCoerceAtLeast$iv4 = rootHeight - IntOffset.m7634getYimpl(bottomRight);
