...
public final class ConstraintsKt {
    ...
    public static final long createConstraints(int minWidth, int maxWidth, int minHeight, int maxHeight) {
        ...
        return Constraints.m7446constructorimpl(value);
    }
    ...
    public static final long m7473constrainN9IONVI(long j, long j2) {
        ...
        int $this$fastCoerceIn$iv = Constraints.m7460getMinWidthimpl(j2);
        ...
        int $this$fastCoerceIn$iv2 = Constraints.m7458getMaxWidthimpl(j2);
        ...
        int $this$fastCoerceIn$iv3 = Constraints.m7459getMinHeightimpl(j2);
        ...
        int $this$fastCoerceIn$iv4 = Constraints.m7457getMaxHeightimpl(j2);
    ...
    public static final long m7472constrain4WqzIAM(long j, long j2) {
        int $this$fastCoerceIn$iv = (int) (j2 >> 32);
        int minimumValue$iv = Constraints.m7460getMinWidthimpl(j);
        int maximumValue$iv = Constraints.m7458getMaxWidthimpl(j);
        int $this$fastCoerceAtLeast$iv$iv = $this$fastCoerceIn$iv;
        ...
        int $this$fastCoerceIn$iv2 = (int) (j2 & 4294967295L);
        int minimumValue$iv2 = Constraints.m7459getMinHeightimpl(j);
        int maximumValue$iv2 = Constraints.m7457getMaxHeightimpl(j);
        int $this$fastCoerceAtLeast$iv$iv2 = $this$fastCoerceIn$iv2;
        ...
        return IntSize.m7671constructorimpl((((long) val1$iv$iv) << 32) | (4294967295L & ((long) val2$iv$iv)));
    }

    /* JADX INFO: renamed from: constrainWidth-K40F9xA, reason: not valid java name */
    public static final int m7475constrainWidthK40F9xA(long j, int width) {
        int minimumValue$iv = Constraints.m7460getMinWidthimpl(j);
        int maximumValue$iv = Constraints.m7458getMaxWidthimpl(j);
    ...
    public static final int m7474constrainHeightK40F9xA(long j, int height) {
    ...
    public static final boolean m7476isSatisfiedBy4WqzIAM(long j, long j2) {
        int i = (int) (j2 >> 32);
        if (Constraints.m7460getMinWidthimpl(j) <= i && i <= Constraints.m7458getMaxWidthimpl(j)) {
            int i2 = (int) (4294967295L & j2);
            if (Constraints.m7459getMinHeightimpl(j) <= i2 && i2 <= Constraints.m7457getMaxHeightimpl(j)) {
                return true;
            }
        }
        return false;
    ...
    public static /* synthetic */ long m7478offsetNN6EwU$default(long j, int i, int i2, int i3, Object obj) {
        if ((i3 & 1) != 0) {
            i = 0;
        }
        if ((i3 & 2) != 0) {
        ...
        return m7477offsetNN6EwU(j, i, i2);
    }

    /* JADX INFO: renamed from: offset-NN6Ew-U, reason: not valid java name */
    public static final long m7477offsetNN6EwU(long j, int horizontal, int vertical) {
        int $this$fastCoerceAtLeast$iv$iv;
        int $this$fastCoerceAtLeast$iv$iv2;
        int $this$fastCoerceAtLeast$iv = Constraints.m7460getMinWidthimpl(j) + horizontal;
        if ($this$fastCoerceAtLeast$iv < 0) {
            $this$fastCoerceAtLeast$iv = 0;
        }
        int max$iv = Constraints.m7458getMaxWidthimpl(j);
        ...
        int $this$fastCoerceAtLeast$iv2 = Constraints.m7459getMinHeightimpl(j) + vertical;
        if ($this$fastCoerceAtLeast$iv2 < 0) {
            $this$fastCoerceAtLeast$iv2 = 0;
        }
        int max$iv2 = Constraints.m7457getMaxHeightimpl(j);
