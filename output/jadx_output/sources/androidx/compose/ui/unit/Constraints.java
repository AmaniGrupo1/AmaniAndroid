...
public final class Constraints {
    ...
    public static final /* synthetic */ Constraints m7445boximpl(long j) {
    ...
    public static int m7461hashCodeimpl(long j) {
    ...
    public boolean equals(Object other) {
        return m7450equalsimpl(this.value, other);
    }

    public int hashCode() {
        return m7461hashCodeimpl(this.value);
    }
    ...
    private static final int m7452getFocusIndeximpl(long j) {
        return (int) (3 & j);
    }

    /* JADX INFO: renamed from: getMinWidth-impl, reason: not valid java name */
    public static final int m7460getMinWidthimpl(long j) {
        int index$iv = (int) (3 & j);
    ...
    public static final int m7458getMaxWidthimpl(long j) {
        int index$iv = (int) (3 & j);
        int bitOffset$iv = ((index$iv & 1) << 1) + (((index$iv & 2) >> 1) * 3);
        int mask = (1 << (bitOffset$iv + 13)) - 1;
        int width = ((int) (j >> 33)) & mask;
        if (width == 0) {
    ...
    public static final boolean m7454getHasBoundedWidthimpl(long j) {
        int index$iv = (int) (3 & j);
        int bitOffset$iv = ((index$iv & 1) << 1) + (((index$iv & 2) >> 1) * 3);
        int mask = (1 << (bitOffset$iv + 13)) - 1;
        return (((int) (j >> 33)) & mask) != 0;
    }

    /* JADX INFO: renamed from: getHasBoundedHeight-impl, reason: not valid java name */
    public static final boolean m7453getHasBoundedHeightimpl(long j) {
        int index$iv = (int) (3 & j);
        int bitOffset = ((index$iv & 1) << 1) + (((index$iv & 2) >> 1) * 3);
        int mask = (1 << (18 - bitOffset)) - 1;
        int bitOffset$iv = bitOffset + 15;
        int offset = bitOffset$iv + 31;
        return (((int) (j >> offset)) & mask) != 0;
    }

    /* JADX INFO: renamed from: getHasFixedWidth-impl, reason: not valid java name */
    public static final boolean m7456getHasFixedWidthimpl(long j) {
        int index$iv = (int) (3 & j);
        int bitOffset$iv = ((index$iv & 1) << 1) + (((index$iv & 2) >> 1) * 3);
        int mask = (1 << (bitOffset$iv + 13)) - 1;
        int minWidth = ((int) (j >> 2)) & mask;
        int it = ((int) (j >> 33)) & mask;
        int maxWidth = it == 0 ? Integer.MAX_VALUE : it - 1;
        return minWidth == maxWidth;
    }

    /* JADX INFO: renamed from: getHasFixedHeight-impl, reason: not valid java name */
    public static final boolean m7455getHasFixedHeightimpl(long j) {
        int index$iv = (int) (3 & j);
        int bitOffset = ((index$iv & 1) << 1) + (((index$iv & 2) >> 1) * 3);
        int mask = (1 << (18 - bitOffset)) - 1;
        int offset = bitOffset + 15;
        int minHeight = ((int) (j >> offset)) & mask;
        int it = ((int) (j >> (offset + 31))) & mask;
        int maxHeight = it == 0 ? Integer.MAX_VALUE : it - 1;
        return minHeight == maxHeight;
    }

    /* JADX INFO: renamed from: isZero-impl, reason: not valid java name */
    public static final boolean m7462isZeroimpl(long j) {
        int index$iv = (int) (3 & j);
        int bitOffset = ((index$iv & 1) << 1) + (((index$iv & 2) >> 1) * 3);
        int maxWidth = (((int) (j >> 33)) & ((1 << (bitOffset + 13)) - 1)) - 1;
        int bitOffset$iv = bitOffset + 15;
        int offset = bitOffset$iv + 31;
        int maxHeight = (((int) (j >> offset)) & ((1 << (18 - bitOffset)) - 1)) - 1;
        return (maxHeight == 0) | (maxWidth == 0);
    }

    /* JADX INFO: renamed from: copy-Zbe2FdA, reason: not valid java name */
    public static final long m7447copyZbe2FdA(long j, int minWidth, int maxWidth, int minHeight, int maxHeight) {
    ...
    public static final long m7449copyMaxDimensionsmsEJaDk(long j) {
        return m7446constructorimpl(ConstraintsKt.MaxDimensionsAndFocusMask & j);
    }

    public String toString() {
        return m7463toStringimpl(this.value);
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m7463toStringimpl(long j) {
        int maxWidth = m7458getMaxWidthimpl(j);
        String maxWidthStr = maxWidth == Integer.MAX_VALUE ? "Infinity" : String.valueOf(maxWidth);
        int maxHeight = m7457getMaxHeightimpl(j);
        String maxHeightStr = maxHeight != Integer.MAX_VALUE ? String.valueOf(maxHeight) : "Infinity";
        return "Constraints(minWidth = " + m7460getMinWidthimpl(j) + ", maxWidth = " + maxWidthStr + ", minHeight = " + m7459getMinHeightimpl(j) + ", maxHeight = " + maxHeightStr + ')';
    }
    ...
    public static final class Companion {
        ...
        public final long m7468fixedJhjzzOo(int width, int height) {
        ...
        public final long m7470fixedWidthOenEA2s(int width) {
        ...
        public final long m7469fixedHeightOenEA2s(int height) {
        ...
        public static /* synthetic */ long m7465restrictConstraintsxF2OJ5Q$default(Companion companion, int i, int i2, int i3, int i4, boolean z, int i5, Object obj) {
            boolean z2;
            if ((i5 & 16) == 0) {
                z2 = z;
            } else {
            ...
            return companion.m7471restrictConstraintsxF2OJ5Q(i, i2, i3, i4, z2);
        }
        ...
        public final long m7471restrictConstraintsxF2OJ5Q(int minWidth, int maxWidth, int minHeight, int maxHeight, boolean prioritizeWidth) {
            if (prioritizeWidth) {
                return m7467fitPrioritizingWidthZbe2FdA(minWidth, maxWidth, minHeight, maxHeight);
            }
            return m7466fitPrioritizingHeightZbe2FdA(minWidth, maxWidth, minHeight, maxHeight);
        }

        /* JADX INFO: renamed from: fitPrioritizingWidth-Zbe2FdA, reason: not valid java name */
        public final long m7467fitPrioritizingWidthZbe2FdA(int minWidth, int maxWidth, int minHeight, int maxHeight) {
            int maxW;
            ...
            if (size$iv >= 8191) {
                if (size$iv < 32767) {
                    maxAllowed = WavUtil.TYPE_WAVE_FORMAT_EXTENSIBLE;
        ...
        public final long m7466fitPrioritizingHeightZbe2FdA(int minWidth, int maxWidth, int minHeight, int maxHeight) {
            int maxH;
            int maxAllowed = 262142;
