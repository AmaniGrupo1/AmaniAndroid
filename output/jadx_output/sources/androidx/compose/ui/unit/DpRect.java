...
public final /* data */ class DpRect {
    ...
    public static /* synthetic */ DpRect m7577copya9UjIt4$default(DpRect dpRect, float f, float f2, float f3, float f4, int i, Object obj) {
        if ((i & 1) != 0) {
            f = dpRect.left;
        }
        if ((i & 2) != 0) {
    ...
    public final DpRect m7586copya9UjIt4(float left, float top, float right, float bottom) {
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m7510equalsimpl0(this.left, dpRect.left) && Dp.m7510equalsimpl0(this.top, dpRect.top) && Dp.m7510equalsimpl0(this.right, dpRect.right) && Dp.m7510equalsimpl0(this.bottom, dpRect.bottom);
    }

    public int hashCode() {
        return (((((Dp.m7511hashCodeimpl(this.left) * 31) + Dp.m7511hashCodeimpl(this.top)) * 31) + Dp.m7511hashCodeimpl(this.right)) * 31) + Dp.m7511hashCodeimpl(this.bottom);
    }

    public String toString() {
        return "DpRect(left=" + ((Object) Dp.m7516toStringimpl(this.left)) + ", top=" + ((Object) Dp.m7516toStringimpl(this.top)) + ", right=" + ((Object) Dp.m7516toStringimpl(this.right)) + ", bottom=" + ((Object) Dp.m7516toStringimpl(this.bottom)) + ')';
    }
    ...
    public final float m7588getLeftD9Ej5fM() {
        return this.left;
    }

    /* JADX INFO: renamed from: getTop-D9Ej5fM, reason: not valid java name */
    public final float m7590getTopD9Ej5fM() {
        return this.top;
    }

    /* JADX INFO: renamed from: getRight-D9Ej5fM, reason: not valid java name */
    public final float m7589getRightD9Ej5fM() {
        return this.right;
    }

    /* JADX INFO: renamed from: getBottom-D9Ej5fM, reason: not valid java name */
    public final float m7587getBottomD9Ej5fM() {
        return this.bottom;
    }

    private DpRect(long origin, long size) {
        this(DpOffset.m7566getXD9Ej5fM(origin), DpOffset.m7568getYD9Ej5fM(origin), Dp.m7505constructorimpl(DpOffset.m7566getXD9Ej5fM(origin) + DpSize.m7603getWidthD9Ej5fM(size)), Dp.m7505constructorimpl(DpOffset.m7568getYD9Ej5fM(origin) + DpSize.m7601getHeightD9Ej5fM(size)), null);
    }
}
