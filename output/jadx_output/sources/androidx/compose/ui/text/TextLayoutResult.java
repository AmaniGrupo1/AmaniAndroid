...
public final class TextLayoutResult {
    ...
    public final boolean getDidOverflowHeight() {
        return this.multiParagraph.getDidExceedMaxLines() || ((float) ((int) (4294967295L & this.size))) < this.multiParagraph.getHeight();
    }
    ...
    public final int m6898getOffsetForPositionk4lQ0M(long position) {
        return this.multiParagraph.m6789getOffsetForPositionk4lQ0M(position);
    }
    ...
    public final long m6900getWordBoundaryjx7JFs(int offset) {
        return this.multiParagraph.m6791getWordBoundaryjx7JFs(offset);
    }
    ...
    public static /* synthetic */ TextLayoutResult m6896copyO0kMr_c$default(TextLayoutResult textLayoutResult, TextLayoutInput textLayoutInput, long j, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return textLayoutResult.m6897copyO0kMr_c(textLayoutInput, j);
    }

    /* JADX INFO: renamed from: copy-O0kMr_c, reason: not valid java name */
    public final TextLayoutResult m6897copyO0kMr_c(TextLayoutInput layoutInput, long size) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof TextLayoutResult) || !Intrinsics.areEqual(this.layoutInput, ((TextLayoutResult) other).layoutInput) || !Intrinsics.areEqual(this.multiParagraph, ((TextLayoutResult) other).multiParagraph) || !IntSize.m7674equalsimpl0(this.size, ((TextLayoutResult) other).size)) {
            return false;
        }
    ...
    public int hashCode() {
        ...
        return (((((((((result * 31) + this.multiParagraph.hashCode()) * 31) + IntSize.m7677hashCodeimpl(this.size)) * 31) + Float.hashCode(this.firstBaseline)) * 31) + Float.hashCode(this.lastBaseline)) * 31) + this.placeholderRects.hashCode();
    }

    public String toString() {
        return "TextLayoutResult(layoutInput=" + this.layoutInput + ", multiParagraph=" + this.multiParagraph + ", size=" + ((Object) IntSize.m7679toStringimpl(this.size)) + ", firstBaseline=" + this.firstBaseline + ", lastBaseline=" + this.lastBaseline + ", placeholderRects=" + this.placeholderRects + ')';
    }
}
