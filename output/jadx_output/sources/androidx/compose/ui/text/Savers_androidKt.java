...
public final class Savers_androidKt {
    private static final Saver<PlatformParagraphStyle, Object> PlatformParagraphStyleSaver = SaverKt.Saver(new Function2() { // from class: androidx.compose.ui.text.Savers_androidKt$$ExternalSyntheticLambda0
        ...
        public final Object invoke(Object obj, Object obj2) {
            ...
            return CollectionsKt.arrayListOf(SaversKt.save(Boolean.valueOf(platformParagraphStyle.getIncludeFontPadding())), SaversKt.save(EmojiSupportMatch.m6775boximpl(platformParagraphStyle.getEmojiSupportMatch()), Savers_androidKt.getSaver(EmojiSupportMatch.INSTANCE), (SaverScope) obj));
        }
    ...
    private static final Saver<TextMotion, Object> TextMotionSaver = SaverKt.Saver(new Function2() { // from class: androidx.compose.ui.text.Savers_androidKt$$ExternalSyntheticLambda6
        ...
        public final Object invoke(Object obj, Object obj2) {
            ...
            return CollectionsKt.arrayListOf(SaversKt.save(TextMotion.Linearity.m7393boximpl(textMotion.getLinearity()), Savers_androidKt.getSaver(TextMotion.Linearity.INSTANCE), (SaverScope) obj), SaversKt.save(Boolean.valueOf(textMotion.getSubpixelTextPositioning())));
        }
    ...
    static final EmojiSupportMatch emojiSupportMatchSaver$lambda$1(Object it) {
        ...
        return EmojiSupportMatch.m6775boximpl(EmojiSupportMatch.m6776constructorimpl(((Integer) it).intValue()));
    }
    ...
    static final LineBreak LineBreakSaver$lambda$1(Object it) {
        Intrinsics.checkNotNull(it, "null cannot be cast to non-null type kotlin.Int");
        return LineBreak.m7256boximpl(LineBreak.m7257constructorimpl(((Integer) it).intValue()));
    }
    ...
    static final TextMotion.Linearity TextMotionLinearitySaver$lambda$1(Object it) {
        Intrinsics.checkNotNull(it, "null cannot be cast to non-null type kotlin.Int");
        return TextMotion.Linearity.m7393boximpl(TextMotion.Linearity.m7394constructorimpl(((Integer) it).intValue()));
    }
}
