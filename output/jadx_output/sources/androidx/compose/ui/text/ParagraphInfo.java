...
public final /* data */ class ParagraphInfo {
    ...
    public final long m6804toLocalMKHz9U(long j) {
    ...
    public final Rect toGlobal(Rect $this$toGlobal) {
        ...
        long v2$iv$iv = Float.floatToRawIntBits(y$iv);
        return $this$toGlobal.m4489translatek4lQ0M(Offset.m4444constructorimpl((v1$iv$iv << 32) | (4294967295L & v2$iv$iv)));
    }
    ...
    public final Rect toLocal(Rect $this$toLocal) {
        ...
        long v1$iv$iv = Float.floatToRawIntBits(0.0f);
        long v2$iv$iv = Float.floatToRawIntBits(y$iv);
        return $this$toLocal.m4489translatek4lQ0M(Offset.m4444constructorimpl((v1$iv$iv << 32) | (4294967295L & v2$iv$iv)));
    }
    ...
    public final Path toGlobal(Path $this$toGlobal) {
        ...
        long v1$iv$iv = Float.floatToRawIntBits(0.0f);
        long v2$iv$iv = Float.floatToRawIntBits(y$iv);
        $this$toGlobal.mo4589translatek4lQ0M(Offset.m4444constructorimpl((v1$iv$iv << 32) | (4294967295L & v2$iv$iv)));
        return $this$toGlobal;
    }

    /* JADX INFO: renamed from: toGlobal-xdX6-G0$default, reason: not valid java name */
    public static /* synthetic */ long m6802toGlobalxdX6G0$default(ParagraphInfo paragraphInfo, long j, boolean z, int i, Object obj) {
        if ((i & 1) != 0) {
            z = true;
        }
        return paragraphInfo.m6803toGlobalxdX6G0(j, z);
    }

    /* JADX INFO: renamed from: toGlobal-xdX6-G0, reason: not valid java name */
    public final long m6803toGlobalxdX6G0(long j, boolean treatZeroAsNull) {
        if (treatZeroAsNull && TextRange.m6921equalsimpl0(j, TextRange.INSTANCE.m6933getZerod9O1mEE())) {
            return TextRange.INSTANCE.m6933getZerod9O1mEE();
        }
        return TextRangeKt.TextRange(toGlobalIndex(TextRange.m6928getStartimpl(j)), toGlobalIndex(TextRange.m6923getEndimpl(j)));
    }
}
