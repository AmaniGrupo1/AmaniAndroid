...
public final class ParagraphKt {
    ...
    public static final Paragraph Paragraph(String text, TextStyle style, float width, Density density, FontFamily.Resolver fontFamilyResolver, List<AnnotatedString.Range<SpanStyle>> list, List<AnnotatedString.Range<Placeholder>> list2, int maxLines, boolean ellipsis) {
        ...
        return androidx.compose.ui.text.platform.AndroidParagraph_androidKt.m7189ActualParagraphXGqx6AY(text, style, list, list2, maxLines, ellipsis ? companion.m7416getEllipsisgIe3tQ8() : companion.m7415getClipgIe3tQ8(), ConstraintsKt.Constraints$default(0, ceilToInt(width), 0, 0, 13, null), density, fontFamilyResolver);
    }
    ...
    public static final /* synthetic */ Paragraph m6805ParagraphUdtVg6A(String text, TextStyle style, long j, Density density, FontFamily.Resolver fontFamilyResolver, List spanStyles, List placeholders, int maxLines, boolean ellipsis) {
        TextOverflow.Companion companion = TextOverflow.INSTANCE;
        return androidx.compose.ui.text.platform.AndroidParagraph_androidKt.m7189ActualParagraphXGqx6AY(text, style, spanStyles, placeholders, maxLines, ellipsis ? companion.m7416getEllipsisgIe3tQ8() : companion.m7415getClipgIe3tQ8(), j, density, fontFamilyResolver);
    }

    /* JADX INFO: renamed from: Paragraph-Ul8oQg4, reason: not valid java name */
    public static final Paragraph m6807ParagraphUl8oQg4(String text, TextStyle style, long j, Density density, FontFamily.Resolver fontFamilyResolver, List<AnnotatedString.Range<SpanStyle>> list, List<AnnotatedString.Range<Placeholder>> list2, int maxLines, int i) {
        return androidx.compose.ui.text.platform.AndroidParagraph_androidKt.m7189ActualParagraphXGqx6AY(text, style, list, list2, maxLines, i, j, density, fontFamilyResolver);
    }
    ...
    public static final Paragraph Paragraph(ParagraphIntrinsics paragraphIntrinsics, int maxLines, boolean ellipsis, float width) {
        TextOverflow.Companion companion = TextOverflow.INSTANCE;
        return androidx.compose.ui.text.platform.AndroidParagraph_androidKt.m7188ActualParagraph4FmOz70(paragraphIntrinsics, maxLines, ellipsis ? companion.m7416getEllipsisgIe3tQ8() : companion.m7415getClipgIe3tQ8(), ConstraintsKt.Constraints$default(0, ceilToInt(width), 0, 0, 13, null));
    }

    /* JADX INFO: renamed from: Paragraph-_EkL_-Y$default, reason: not valid java name */
    public static /* synthetic */ Paragraph m6810Paragraph_EkL_Y$default(ParagraphIntrinsics paragraphIntrinsics, long j, int i, boolean z, int i2, Object obj) {
        if ((i2 & 4) != 0) {
            i = Integer.MAX_VALUE;
        }
        if ((i2 & 8) != 0) {
        ...
        return m6809Paragraph_EkL_Y(paragraphIntrinsics, j, i, z);
    }
    ...
    public static final /* synthetic */ Paragraph m6809Paragraph_EkL_Y(ParagraphIntrinsics paragraphIntrinsics, long j, int maxLines, boolean ellipsis) {
        TextOverflow.Companion companion = TextOverflow.INSTANCE;
        return androidx.compose.ui.text.platform.AndroidParagraph_androidKt.m7188ActualParagraph4FmOz70(paragraphIntrinsics, maxLines, ellipsis ? companion.m7416getEllipsisgIe3tQ8() : companion.m7415getClipgIe3tQ8(), j);
    }

    /* JADX INFO: renamed from: Paragraph-czeN-Hc$default, reason: not valid java name */
    public static /* synthetic */ Paragraph m6812ParagraphczeNHc$default(ParagraphIntrinsics paragraphIntrinsics, long j, int i, int i2, int i3, Object obj) {
        if ((i3 & 4) != 0) {
            i = Integer.MAX_VALUE;
        }
        if ((i3 & 8) != 0) {
            i2 = TextOverflow.INSTANCE.m7415getClipgIe3tQ8();
        }
        return m6811ParagraphczeNHc(paragraphIntrinsics, j, i, i2);
    }

    /* JADX INFO: renamed from: Paragraph-czeN-Hc, reason: not valid java name */
    public static final Paragraph m6811ParagraphczeNHc(ParagraphIntrinsics paragraphIntrinsics, long j, int maxLines, int i) {
        return androidx.compose.ui.text.platform.AndroidParagraph_androidKt.m7188ActualParagraph4FmOz70(paragraphIntrinsics, maxLines, i, j);
    }
