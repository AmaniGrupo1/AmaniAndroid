...
public final class MultiParagraph {
    ...
    private MultiParagraph(MultiParagraphIntrinsics intrinsics, long constraints, int maxLines, int overflow) {
        ...
        int i = 0;
        boolean value$iv = Constraints.m7460getMinWidthimpl(constraints) == 0 && Constraints.m7459getMinHeightimpl(constraints) == 0;
        if (!value$iv) {
        ...
        while (index < size) {
            ...
            Paragraph paragraph = ParagraphKt.m6811ParagraphczeNHc(paragraphInfo.getIntrinsics(), ConstraintsKt.Constraints$default(0, Constraints.m7458getMaxWidthimpl(constraints), 0, Constraints.m7453getHasBoundedHeightimpl(constraints) ? RangesKt.coerceAtLeast(Constraints.m7457getMaxHeightimpl(constraints) - ParagraphKt.ceilToInt(currentHeight), i) : Constraints.m7457getMaxHeightimpl(constraints), 5, null), this.maxLines - currentLineCount, overflow);
        ...
        this.width = Constraints.m7458getMaxWidthimpl(constraints);
    ...
    public /* synthetic */ MultiParagraph(MultiParagraphIntrinsics multiParagraphIntrinsics, long j, int i, int i2, int i3, DefaultConstructorMarker defaultConstructorMarker) {
        ...
        if ((i3 & 8) == 0) {
            iM7415getClipgIe3tQ8 = i2;
        } else {
            iM7415getClipgIe3tQ8 = TextOverflow.INSTANCE.m7415getClipgIe3tQ8();
        }
        this(multiParagraphIntrinsics, j, i4, iM7415getClipgIe3tQ8, (DefaultConstructorMarker) null);
    }
    ...
    private MultiParagraph(MultiParagraphIntrinsics intrinsics, long constraints, int maxLines, boolean ellipsis) {
        ...
        this(intrinsics, constraints, maxLines, ellipsis ? companion.m7416getEllipsisgIe3tQ8() : companion.m7415getClipgIe3tQ8(), (DefaultConstructorMarker) null);
    }
    ...
    public MultiParagraph(MultiParagraphIntrinsics intrinsics, int maxLines, boolean ellipsis, float width) {
        ...
        TextOverflow.Companion companion = TextOverflow.INSTANCE;
        this(intrinsics, jConstraints$default, maxLines, ellipsis ? companion.m7416getEllipsisgIe3tQ8() : companion.m7415getClipgIe3tQ8(), (DefaultConstructorMarker) null);
    }
    ...
    public MultiParagraph(AnnotatedString annotatedString, TextStyle style, List<AnnotatedString.Range<Placeholder>> list, int maxLines, boolean ellipsis, float width, Density density, Font.ResourceLoader resourceLoader) {
        ...
        TextOverflow.Companion companion = TextOverflow.INSTANCE;
        this(multiParagraphIntrinsics, ConstraintsKt.Constraints$default(0, ParagraphKt.ceilToInt(width), 0, 0, 13, null), maxLines, ellipsis ? companion.m7416getEllipsisgIe3tQ8() : companion.m7415getClipgIe3tQ8(), (DefaultConstructorMarker) null);
    }
    ...
    private MultiParagraph(AnnotatedString annotatedString, TextStyle style, long constraints, Density density, FontFamily.Resolver fontFamilyResolver, List<AnnotatedString.Range<Placeholder>> list, int maxLines, boolean ellipsis) {
        MultiParagraphIntrinsics multiParagraphIntrinsics = new MultiParagraphIntrinsics(annotatedString, style, list, density, fontFamilyResolver);
        TextOverflow.Companion companion = TextOverflow.INSTANCE;
        this(multiParagraphIntrinsics, constraints, maxLines, ellipsis ? companion.m7416getEllipsisgIe3tQ8() : companion.m7415getClipgIe3tQ8(), (DefaultConstructorMarker) null);
    }
    ...
    public /* synthetic */ MultiParagraph(AnnotatedString annotatedString, TextStyle textStyle, long j, Density density, FontFamily.Resolver resolver, List list, int i, int i2, int i3, DefaultConstructorMarker defaultConstructorMarker) {
        this(annotatedString, textStyle, j, density, resolver, (i3 & 32) != 0 ? CollectionsKt.emptyList() : list, (i3 & 64) != 0 ? Integer.MAX_VALUE : i, (i3 & 128) != 0 ? TextOverflow.INSTANCE.m7415getClipgIe3tQ8() : i2, (DefaultConstructorMarker) null);
    }
    ...
    public final /* synthetic */ void m6793paintRPmYEkk(Canvas canvas, long color, Shadow shadow, TextDecoration decoration) {
        canvas.save();
        ...
        for (int index$iv = 0; index$iv < size; index$iv++) {
            ...
            Paragraph.m6796paintLG529CI$default(it.getParagraph(), canvas, color, shadow, decoration, null, 0, 48, null);
    ...
    public final void m6792paintLG529CI(Canvas canvas, long color, Shadow shadow, TextDecoration decoration, DrawStyle drawStyle, int blendMode) {
        canvas.save();
        List<ParagraphInfo> list = this.paragraphInfoList;
        int size = list.size();
        for (int index$iv = 0; index$iv < size; index$iv++) {
            Object item$iv = list.get(index$iv);
            ParagraphInfo it = (ParagraphInfo) item$iv;
            it.getParagraph().mo6748paintLG529CI(canvas, color, shadow, decoration, drawStyle, blendMode);
            canvas.translate(0.0f, it.getParagraph().getHeight());
        }
        canvas.restore();
    }
    ...
    public final void m6794painthn5TExg(Canvas canvas, Brush brush, float alpha, Shadow shadow, TextDecoration decoration, DrawStyle drawStyle, int blendMode) {
        AndroidMultiParagraphDraw_androidKt.m7183drawMultiParagraph7AXcY_I(this, canvas, brush, alpha, shadow, decoration, drawStyle, blendMode);
    }
    ...
    public final Path getPathForRange(final int start, final int end) {
        ...
        MultiParagraphKt.m6795findParagraphsByRangeSbBc2M(this.paragraphInfoList, TextRangeKt.TextRange(start, end), new Function1() { // from class: androidx.compose.ui.text.MultiParagraph$$ExternalSyntheticLambda1
    ...
    static final Unit getPathForRange$lambda$1(Path $path, int $start, int $end, ParagraphInfo paragraphInfo) {
        Path.m4981addPathUv8p0NA$default($path, paragraphInfo.toGlobal(paragraphInfo.getParagraph().getPathForRange(paragraphInfo.toLocalIndex($start), paragraphInfo.toLocalIndex($end))), 0L, 2, null);
    ...
    public final int m6789getOffsetForPositionk4lQ0M(long position) {
        ...
        return $this$getOffsetForPosition_k_4lQ0M_u24lambda_u240.toGlobalIndex($this$getOffsetForPosition_k_4lQ0M_u24lambda_u240.getParagraph().mo6744getOffsetForPositionk4lQ0M($this$getOffsetForPosition_k_4lQ0M_u24lambda_u240.m6804toLocalMKHz9U(position)));
    }

    /* JADX INFO: renamed from: getRangeForRect-8-6BmAI, reason: not valid java name */
    public final long m6790getRangeForRect86BmAI(Rect rect, int granularity, TextInclusionStrategy inclusionStrategy) {
        ...
        if (this.paragraphInfoList.get(firstParagraph).getBottom() >= rect.getBottom() || firstParagraph == CollectionsKt.getLastIndex(this.paragraphInfoList)) {
            ...
            return ParagraphInfo.m6802toGlobalxdX6G0$default($this$getRangeForRect_8_6BmAI_u24lambda_u240, $this$getRangeForRect_8_6BmAI_u24lambda_u240.getParagraph().mo6746getRangeForRect86BmAI($this$getRangeForRect_8_6BmAI_u24lambda_u240.toLocal(rect), granularity, inclusionStrategy), false, 1, null);
        }
        int lastParagraph = MultiParagraphKt.findParagraphByY(this.paragraphInfoList, rect.getBottom());
        long startRange = TextRange.INSTANCE.m6933getZerod9O1mEE();
        while (TextRange.m6921equalsimpl0(startRange, TextRange.INSTANCE.m6933getZerod9O1mEE()) && firstParagraph <= lastParagraph) {
            ParagraphInfo $this$getRangeForRect_8_6BmAI_u24lambda_u241 = this.paragraphInfoList.get(firstParagraph);
            startRange = ParagraphInfo.m6802toGlobalxdX6G0$default($this$getRangeForRect_8_6BmAI_u24lambda_u241, $this$getRangeForRect_8_6BmAI_u24lambda_u241.getParagraph().mo6746getRangeForRect86BmAI($this$getRangeForRect_8_6BmAI_u24lambda_u241.toLocal(rect), granularity, inclusionStrategy), false, 1, null);
            firstParagraph++;
        }
        if (TextRange.m6921equalsimpl0(startRange, TextRange.INSTANCE.m6933getZerod9O1mEE())) {
            return TextRange.INSTANCE.m6933getZerod9O1mEE();
        }
        long endRange = TextRange.INSTANCE.m6933getZerod9O1mEE();
        while (TextRange.m6921equalsimpl0(endRange, TextRange.INSTANCE.m6933getZerod9O1mEE()) && firstParagraph <= lastParagraph) {
            ParagraphInfo $this$getRangeForRect_8_6BmAI_u24lambda_u242 = this.paragraphInfoList.get(lastParagraph);
            endRange = ParagraphInfo.m6802toGlobalxdX6G0$default($this$getRangeForRect_8_6BmAI_u24lambda_u242, $this$getRangeForRect_8_6BmAI_u24lambda_u242.getParagraph().mo6746getRangeForRect86BmAI($this$getRangeForRect_8_6BmAI_u24lambda_u242.toLocal(rect), granularity, inclusionStrategy), false, 1, null);
            lastParagraph--;
        }
        return TextRange.m6921equalsimpl0(endRange, TextRange.INSTANCE.m6933getZerod9O1mEE()) ? startRange : TextRangeKt.TextRange(TextRange.m6928getStartimpl(startRange), TextRange.m6923getEndimpl(endRange));
    }
    ...
    public final float[] m6788fillBoundingBoxes8ffj60Q(final long range, final float[] array, int arrayStart) {
        requireIndexInRange(TextRange.m6926getMinimpl(range));
        requireIndexInRangeInclusiveEnd(TextRange.m6925getMaximpl(range));
        ...
        MultiParagraphKt.m6795findParagraphsByRangeSbBc2M(this.paragraphInfoList, range, new Function1() { // from class: androidx.compose.ui.text.MultiParagraph$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
    ...
    static final Unit fillBoundingBoxes_8ffj60Q$lambda$0(long j, float[] $array, Ref.IntRef $currentArrayStart, Ref.FloatRef $currentHeight, ParagraphInfo paragraphInfo) {
        int paragraphStart = paragraphInfo.getStartIndex() > TextRange.m6926getMinimpl(j) ? paragraphInfo.getStartIndex() : TextRange.m6926getMinimpl(j);
        int paragraphEnd = paragraphInfo.getEndIndex() < TextRange.m6925getMaximpl(j) ? paragraphInfo.getEndIndex() : TextRange.m6925getMaximpl(j);
        long finalRange = TextRangeKt.TextRange(paragraphInfo.toLocalIndex(paragraphStart), paragraphInfo.toLocalIndex(paragraphEnd));
        paragraphInfo.getParagraph().mo6742fillBoundingBoxes8ffj60Q(finalRange, $array, $currentArrayStart.element);
        int currentArrayEnd = $currentArrayStart.element + (TextRange.m6924getLengthimpl(finalRange) * 4);
    ...
    public final long m6791getWordBoundaryjx7JFs(int offset) {
        int paragraphIndex;
        requireIndexInRangeInclusiveEnd(offset);
        int length = getAnnotatedString().length();
        List<ParagraphInfo> list = this.paragraphInfoList;
        ...
        return $this$getWordBoundary__jx7JFs_u24lambda_u240.m6803toGlobalxdX6G0($this$getWordBoundary__jx7JFs_u24lambda_u240.getParagraph().mo6747getWordBoundaryjx7JFs($this$getWordBoundary__jx7JFs_u24lambda_u240.toLocalIndex(offset)), false);
    }
