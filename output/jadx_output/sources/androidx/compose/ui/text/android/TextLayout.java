...
public final class TextLayout {
    ...
    */
    public TextLayout(CharSequence charSequence, float f, TextPaint textPaint, int i, TextUtils.TruncateAt truncateAt, int i2, float f2, float f3, boolean z, boolean z2, int i3, int i4, int i5, int i6, int i7, int i8, int[] iArr, int[] iArr2, LayoutIntrinsics layoutIntrinsics) throws Throwable {
        ...
        boolean z5;
        LineHeightStyleSpan[] lineHeightStyleSpanArr2;
        long jVerticalPaddings;
        LineHeightStyleSpan lineHeightStyleSpan;
        LineHeightStyleSpan lineHeightStyleSpan2;
        ?? obj = new Object();
        obj.textPaint = textPaint;
        obj.ellipsize = truncateAt;
        obj.includePadding = z;
        obj.fallbackLineSpacing = z2;
        ...
        try {
            boringMetrics = obj.layoutIntrinsics.getBoringMetrics();
        ...
        if (boringMetrics != null) {
            try {
                if (obj.layoutIntrinsics.getMaxIntrinsicWidth() > f || z7) {
                    z3 = true;
                    z4 = false;
                    i9 = iCeil;
                } else {
                    obj.isBoringLayout = true;
                    try {
                        z3 = true;
                        try {
                            boringLayoutCreate = BoringLayoutFactory.INSTANCE.create(charSequence, obj.textPaint, iCeil, boringMetrics, alignment, obj.includePadding, obj.fallbackLineSpacing, obj.ellipsize, iCeil);
                            i10 = i3;
                            textDirectionHeuristic = textDirectionHeuristic2;
                            textLayout = obj;
                            textLayout.layout = boringLayoutCreate;
                            Trace.endSection();
                            textLayout.lineCount = Math.min(textLayout.layout.getLineCount(), i10);
                            int i11 = textLayout.lineCount - 1;
                            textLayout.didExceedMaxLines = textLayout.lineCount >= i10 ? false : (textLayout.layout.getEllipsisCount(i11) > 0 || textLayout.layout.getLineEnd(i11) != charSequence.length()) ? z3 : false;
                            textLayout.lineHeightSpans = TextLayout_androidKt.getLineHeightSpans(textLayout);
                            lineHeightStyleSpanArr = textLayout.lineHeightSpans;
                            if (lineHeightStyleSpanArr != null || (lineHeightStyleSpan2 = (LineHeightStyleSpan) ArraysKt.firstOrNull(lineHeightStyleSpanArr)) == null) {
                                z5 = false;
                            } else {
                                z5 = (lineHeightStyleSpan2.getTrimFirstLineTop() && LineHeightStyle.Mode.m7331equalsimpl0(lineHeightStyleSpan2.getMode(), LineHeightStyle.Mode.INSTANCE.m7337getTightlzQqcRY())) ? z3 : false;
                            }
                            lineHeightStyleSpanArr2 = textLayout.lineHeightSpans;
                            if (lineHeightStyleSpanArr2 != null || (lineHeightStyleSpan = (LineHeightStyleSpan) ArraysKt.firstOrNull(lineHeightStyleSpanArr2)) == null || !lineHeightStyleSpan.getTrimLastLineBottom() || !LineHeightStyle.Mode.m7331equalsimpl0(lineHeightStyleSpan.getMode(), LineHeightStyle.Mode.INSTANCE.m7337getTightlzQqcRY())) {
                                z3 = false;
                            }
                            if (z5 || !z3) {
                                long verticalPaddings = TextLayout_androidKt.getVerticalPaddings(textLayout);
                                jVerticalPaddings = TextLayout_androidKt.VerticalPaddings(!z5 ? 0 : VerticalPaddings.m6980getTopPaddingimpl(verticalPaddings), !z3 ? 0 : VerticalPaddings.m6979getBottomPaddingimpl(verticalPaddings));
                            } else {
                                jVerticalPaddings = TextLayout_androidKt.ZeroVerticalPadding;
                            }
                            LineHeightStyleSpan[] lineHeightStyleSpanArr3 = textLayout.lineHeightSpans;
                            long lineHeightPaddings = lineHeightStyleSpanArr3 == null ? TextLayout_androidKt.getLineHeightPaddings(lineHeightStyleSpanArr3) : TextLayout_androidKt.ZeroVerticalPadding;
                            textLayout.topPadding = Math.max(VerticalPaddings.m6980getTopPaddingimpl(jVerticalPaddings), VerticalPaddings.m6980getTopPaddingimpl(lineHeightPaddings));
                            textLayout.bottomPadding = Math.max(VerticalPaddings.m6979getBottomPaddingimpl(jVerticalPaddings), VerticalPaddings.m6979getBottomPaddingimpl(lineHeightPaddings));
                            Paint.FontMetricsInt lastLineMetrics = TextLayout_androidKt.getLastLineMetrics(textLayout, textLayout.textPaint, textDirectionHeuristic, textLayout.lineHeightSpans);
                            textLayout.lastLineExtra = lastLineMetrics == null ? lastLineMetrics.bottom - ((int) textLayout.getLineHeight(i11)) : 0;
                            textLayout.lastLineFontMetrics = lastLineMetrics;
                            textLayout.leftPadding = IndentationFixSpan_androidKt.getEllipsizedLeftPadding$default(textLayout.layout, i11, null, 2, null);
                            textLayout.rightPadding = IndentationFixSpan_androidKt.getEllipsizedRightPadding$default(textLayout.layout, i11, null, 2, null);
                        } catch (Throwable th2) {
                            th = th2;
                        }
                    } catch (Throwable th3) {
        ...
        z4 = false;
        i9 = iCeil;
        obj.isBoringLayout = z4;
        StaticLayoutFactory staticLayoutFactory = StaticLayoutFactory.INSTANCE;
        TextPaint textPaint2 = obj.textPaint;
        int length2 = charSequence.length();
        TextUtils.TruncateAt truncateAt2 = obj.ellipsize;
        TextLayout textLayout2 = this;
        i10 = i3;
        textDirectionHeuristic = textDirectionHeuristic2;
        boringLayoutCreate = staticLayoutFactory.create(charSequence, textPaint2, i9, 0, length2, textDirectionHeuristic, alignment, i10, truncateAt2, (int) Math.ceil(f), f2, f3, i8, textLayout2.includePadding, textLayout2.fallbackLineSpacing, i4, i5, i6, i7, iArr, iArr2);
        textLayout = textLayout2;
        textLayout.layout = boringLayoutCreate;
        Trace.endSection();
        textLayout.lineCount = Math.min(textLayout.layout.getLineCount(), i10);
        int i112 = textLayout.lineCount - 1;
        textLayout.didExceedMaxLines = textLayout.lineCount >= i10 ? false : (textLayout.layout.getEllipsisCount(i112) > 0 || textLayout.layout.getLineEnd(i112) != charSequence.length()) ? z3 : false;
        textLayout.lineHeightSpans = TextLayout_androidKt.getLineHeightSpans(textLayout);
        lineHeightStyleSpanArr = textLayout.lineHeightSpans;
        ...
        lineHeightStyleSpanArr2 = textLayout.lineHeightSpans;
        z3 = lineHeightStyleSpanArr2 != null ? false : false;
        if (z5) {
            long verticalPaddings2 = TextLayout_androidKt.getVerticalPaddings(textLayout);
            jVerticalPaddings = TextLayout_androidKt.VerticalPaddings(!z5 ? 0 : VerticalPaddings.m6980getTopPaddingimpl(verticalPaddings2), !z3 ? 0 : VerticalPaddings.m6979getBottomPaddingimpl(verticalPaddings2));
        }
        LineHeightStyleSpan[] lineHeightStyleSpanArr32 = textLayout.lineHeightSpans;
        if (lineHeightStyleSpanArr32 == null) {
        }
        textLayout.topPadding = Math.max(VerticalPaddings.m6980getTopPaddingimpl(jVerticalPaddings), VerticalPaddings.m6980getTopPaddingimpl(lineHeightPaddings));
        textLayout.bottomPadding = Math.max(VerticalPaddings.m6979getBottomPaddingimpl(jVerticalPaddings), VerticalPaddings.m6979getBottomPaddingimpl(lineHeightPaddings));
        Paint.FontMetricsInt lastLineMetrics2 = TextLayout_androidKt.getLastLineMetrics(textLayout, textLayout.textPaint, textDirectionHeuristic, textLayout.lineHeightSpans);
        textLayout.lastLineExtra = lastLineMetrics2 == null ? lastLineMetrics2.bottom - ((int) textLayout.getLineHeight(i112)) : 0;
        textLayout.lastLineFontMetrics = lastLineMetrics2;
        textLayout.leftPadding = IndentationFixSpan_androidKt.getEllipsizedLeftPadding$default(textLayout.layout, i112, null, 2, null);
        textLayout.rightPadding = IndentationFixSpan_androidKt.getEllipsizedRightPadding$default(textLayout.layout, i112, null, 2, null);
    }
