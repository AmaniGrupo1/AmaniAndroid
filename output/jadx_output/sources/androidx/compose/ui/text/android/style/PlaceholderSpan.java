...
public final class PlaceholderSpan extends ReplacementSpan {
    ...
    public PlaceholderSpan(float width, int widthUnit, float height, int heightUnit, Density density, int verticalAlign) {
        float fMo404toPxR2X_6o;
        float fMo404toPxR2X_6o2;
        if (widthUnit != 0) {
            fMo404toPxR2X_6o = 0.0f;
        } else {
            fMo404toPxR2X_6o = density.mo404toPxR2X_6o(TextUnitKt.getSp(width));
        }
        if (heightUnit != 0) {
            fMo404toPxR2X_6o2 = 0.0f;
        } else {
            fMo404toPxR2X_6o2 = density.mo404toPxR2X_6o(TextUnitKt.getSp(height));
        }
        this(width, widthUnit, height, heightUnit, fMo404toPxR2X_6o, fMo404toPxR2X_6o2, verticalAlign);
    }
