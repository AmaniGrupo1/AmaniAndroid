...
public final class LineHeightStyleSpan implements android.text.style.LineHeightSpan {
    ...
    public void chooseHeight(CharSequence text, int start, int end, int spanStartVertical, int lineHeight, Paint.FontMetricsInt fontMetricsInt) {
        ...
        if (isFirstLine && isLastLine && this.trimFirstLineTop && this.trimLastLineBottom && !LineHeightStyle.Mode.m7331equalsimpl0(this.mode, LineHeightStyle.Mode.INSTANCE.m7337getTightlzQqcRY())) {
            return;
        }
    ...
    private final void calculateTargetMetrics(Paint.FontMetricsInt fontMetricsInt) {
        ...
        if (LineHeightStyle.Mode.m7331equalsimpl0(this.mode, LineHeightStyle.Mode.INSTANCE.m7336getMinimumlzQqcRY()) && diff <= 0) {
        ...
        if (LineHeightStyle.Mode.m7331equalsimpl0(this.mode, LineHeightStyle.Mode.INSTANCE.m7335getFixedlzQqcRY()) || diff >= 0) {
        ...
        if (LineHeightStyle.Mode.m7331equalsimpl0(this.mode, LineHeightStyle.Mode.INSTANCE.m7337getTightlzQqcRY())) {
