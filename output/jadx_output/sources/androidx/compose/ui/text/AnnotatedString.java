...
public final class AnnotatedString implements CharSequence {
    ...
    public final AnnotatedString m6763subSequence5zctL8(long range) {
        return subSequence(TextRange.m6926getMinimpl(range), TextRange.m6925getMaximpl(range));
    }
    ...
    */
    public final List<Range<String>> getStringAnnotations(String tag, int start, int end) {
        List<Range<? extends Annotation>> list;
        boolean z;
        List<Range<? extends Annotation>> list2 = this.annotations;
        if (list2 == null) {
        ...
        while (index$iv$iv < size) {
            ...
            if ((range.getItem() instanceof StringAnnotation) && Intrinsics.areEqual(tag, range.getTag())) {
                list = list2;
                z = AnnotatedStringKt.intersect(start, end, range.getStart(), range.getEnd());
                if (!z) {
    ...
    */
    ...
    public static final class Builder implements Appendable {
        ...
        public final void addStringAnnotation(String tag, String annotation, int start, int end) {
            this.annotations.add(new MutableRange<>(StringAnnotation.m6876boximpl(StringAnnotation.m6877constructorimpl(annotation)), start, end, tag));
        }
        ...
        public final void m6765addBulletr9BaKPg(Bullet bullet, long indentation, int start, int end) {
        ...
        public static /* synthetic */ Object m6764withBulletListo2QH7mI$default(Builder builder, long j, Bullet bullet, Function1 function1, int i, Object obj) {
            if ((i & 1) != 0) {
                j = Bullet.INSTANCE.m6772getDefaultIndentationXSAIIZE();
            }
            if ((i & 2) != 0) {
                bullet = Bullet.INSTANCE.getDefault();
            }
            return builder.m6766withBulletListo2QH7mI(j, bullet, function1);
        }

        /* JADX INFO: renamed from: withBulletList-o2QH7mI, reason: not valid java name */
        public final <R> R m6766withBulletListo2QH7mI(long indentation, Bullet bullet, Function1<? super BulletScope, ? extends R> block) throws Throwable {
            long sp;
            ...
            if (pair != null) {
                ...
                boolean value$iv = TextUnitType.m7727equalsimpl0(TextUnit.m7698getTypeUIouoOA(it), TextUnit.m7698getTypeUIouoOA(indentation));
                if (!value$iv) {
                    InlineClassHelperKt.throwIllegalStateException("Indentation unit types of nested bullet lists must match. Current " + ((Object) TextUnit.m7706toStringimpl(it)) + " and previous is " + ((Object) TextUnit.m7706toStringimpl(indentation)));
                }
                long jM7698getTypeUIouoOA = TextUnit.m7698getTypeUIouoOA(indentation);
                sp = TextUnitType.m7727equalsimpl0(jM7698getTypeUIouoOA, TextUnitType.INSTANCE.m7732getSpUIouoOA()) ? TextUnitKt.getSp(TextUnit.m7699getValueimpl(indentation) + TextUnit.m7699getValueimpl(it)) : TextUnitType.m7727equalsimpl0(jM7698getTypeUIouoOA, TextUnitType.INSTANCE.m7731getEmUIouoOA()) ? TextUnitKt.getEm(TextUnit.m7699getValueimpl(indentation) + TextUnit.m7699getValueimpl(it)) : indentation;
            } else {
                sp = indentation;
            }
            ...
            this.bulletScope.getBulletListSettingStack$ui_text().add(new Pair<>(TextUnit.m7689boximpl(adjustedIndentation), bullet));
            try {
                try {
        ...
        public final <R> R withBulletListItem(BulletScope $this$withBulletListItem, Bullet bullet, Function1<? super Builder, ? extends R> function1) throws Throwable {
            ...
            long itemIndentation = lastItemInStack != null ? ((TextUnit) lastItemInStack.getFirst()).getPackedValue() : Bullet.INSTANCE.m6772getDefaultIndentationXSAIIZE();
            if (bullet != null) {
                bullet2 = bullet;
        ...
        public final int pushStringAnnotation(String tag, String annotation) {
            MutableRange<? extends Annotation> mutableRange = new MutableRange<>(StringAnnotation.m6876boximpl(StringAnnotation.m6877constructorimpl(annotation)), this.text.length(), 0, tag, 4, null);
            this.styleStack.add(mutableRange);
            this.annotations.add(mutableRange);
            return this.styleStack.size() - 1;
        }
