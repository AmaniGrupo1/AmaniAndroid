...
public final class TextMeasurer {
    ...
    public static /* synthetic */ TextLayoutResult m6902measurexDpz5zY$default(TextMeasurer textMeasurer, AnnotatedString annotatedString, TextStyle textStyle, int i, boolean z, int i2, List list, long j, LayoutDirection layoutDirection, Density density, FontFamily.Resolver resolver, boolean z2, int i3, Object obj) {
        return textMeasurer.m6904measurexDpz5zY(annotatedString, (i3 & 2) != 0 ? TextStyle.INSTANCE.getDefault() : textStyle, (i3 & 4) != 0 ? TextOverflow.INSTANCE.m7415getClipgIe3tQ8() : i, (i3 & 8) != 0 ? true : z, (i3 & 16) != 0 ? Integer.MAX_VALUE : i2, (i3 & 32) != 0 ? CollectionsKt.emptyList() : list, (i3 & 64) != 0 ? ConstraintsKt.Constraints$default(0, 0, 0, 0, 15, null) : j, (i3 & 128) != 0 ? textMeasurer.defaultLayoutDirection : layoutDirection, (i3 & 256) != 0 ? textMeasurer.defaultDensity : density, (i3 & 512) != 0 ? textMeasurer.defaultFontFamilyResolver : resolver, (i3 & 1024) != 0 ? false : z2);
    }

    /* JADX INFO: renamed from: measure-xDpz5zY, reason: not valid java name */
    public final TextLayoutResult m6904measurexDpz5zY(AnnotatedString text, TextStyle style, int overflow, boolean softWrap, int maxLines, List<AnnotatedString.Range<Placeholder>> placeholders, long constraints, LayoutDirection layoutDirection, Density density, FontFamily.Resolver fontFamilyResolver, boolean skipCache) {
        ...
        if (cacheResult != null) {
            ...
            return cacheResult.m6897copyO0kMr_c(requestedTextLayoutInput, ConstraintsKt.m7472constrain4WqzIAM(constraints, IntSize.m7671constructorimpl((((long) width$iv) << 32) | (((long) height$iv) & 4294967295L))));
        }
    ...
    public final TextLayoutResult m6903measurewNUYSr0(String text, TextStyle style, int overflow, boolean softWrap, int maxLines, long constraints, LayoutDirection layoutDirection, Density density, FontFamily.Resolver fontFamilyResolver, boolean skipCache) {
        return m6902measurexDpz5zY$default(this, new AnnotatedString(text, null, 2, null), style, overflow, softWrap, maxLines, null, constraints, layoutDirection, density, fontFamilyResolver, skipCache, 32, null);
    }
    ...
    public static final class Companion {
        ...
        public final TextLayoutResult layout(TextLayoutInput textLayoutInput) {
            ...
            int minWidth = Constraints.m7460getMinWidthimpl(textLayoutInput.getConstraints());
            boolean widthMatters = textLayoutInput.getSoftWrap() || TextMeasurerKt.m6906isEllipsisMW5ApA(textLayoutInput.getOverflow());
            if (widthMatters && Constraints.m7454getHasBoundedWidthimpl(textLayoutInput.getConstraints())) {
                iM7458getMaxWidthimpl = Constraints.m7458getMaxWidthimpl(textLayoutInput.getConstraints());
            } else {
                iM7458getMaxWidthimpl = Integer.MAX_VALUE;
            }
            int maxWidth = iM7458getMaxWidthimpl;
            boolean overwriteMaxLines = !textLayoutInput.getSoftWrap() && TextMeasurerKt.m6906isEllipsisMW5ApA(textLayoutInput.getOverflow());
            ...
            int width = iCoerceIn;
            MultiParagraph multiParagraph = new MultiParagraph(nonNullIntrinsics, Constraints.INSTANCE.m7467fitPrioritizingWidthZbe2FdA(0, width, 0, Constraints.m7457getMaxHeightimpl(textLayoutInput.getConstraints())), finalMaxLines, textLayoutInput.getOverflow(), (DefaultConstructorMarker) null);
            int width$iv = (int) Math.ceil(multiParagraph.getWidth());
            int height$iv = (int) Math.ceil(multiParagraph.getHeight());
            return new TextLayoutResult(textLayoutInput, multiParagraph, ConstraintsKt.m7472constrain4WqzIAM(textLayoutInput.getConstraints(), IntSize.m7671constructorimpl((((long) width$iv) << 32) | (((long) height$iv) & 4294967295L))), null);
        }
    }
}
