...
public final class ParagraphStyle implements AnnotatedString.Annotation {
    ...
    public static /* synthetic */ void m6818getHyphensEaSxIns$annotations() {
    }

    @Deprecated(level = DeprecationLevel.WARNING, message = "Kept for backwards compatibility.")
    /* JADX INFO: renamed from: getLineBreak-LgCVezo$annotations, reason: not valid java name */
    public static /* synthetic */ void m6819getLineBreakLgCVezo$annotations() {
    }

    @Deprecated(level = DeprecationLevel.WARNING, message = "Kept for backwards compatibility.")
    /* JADX INFO: renamed from: getTextAlign-buA522U$annotations, reason: not valid java name */
    public static /* synthetic */ void m6820getTextAlignbuA522U$annotations() {
    }

    @Deprecated(level = DeprecationLevel.WARNING, message = "Kept for backwards compatibility.")
    /* JADX INFO: renamed from: getTextDirection-mmuk1to$annotations, reason: not valid java name */
    public static /* synthetic */ void m6821getTextDirectionmmuk1to$annotations() {
    }
    ...
    private ParagraphStyle(int textAlign, int textDirection, long lineHeight, TextIndent textIndent, PlatformParagraphStyle platformStyle, LineHeightStyle lineHeightStyle, int lineBreak, int hyphens, TextMotion textMotion) {
        ...
        if (TextUnit.m7696equalsimpl0(this.lineHeight, TextUnit.INSTANCE.m7710getUnspecifiedXSAIIZE())) {
            return;
        }
        boolean value$iv = TextUnit.m7699getValueimpl(this.lineHeight) >= 0.0f;
        if (value$iv) {
            return;
        }
        InlineClassHelperKt.throwIllegalStateException("lineHeight can't be negative (" + TextUnit.m7699getValueimpl(this.lineHeight) + ')');
    }
    ...
    public /* synthetic */ ParagraphStyle(int i, int i2, long j, TextIndent textIndent, PlatformParagraphStyle platformParagraphStyle, LineHeightStyle lineHeightStyle, int i3, int i4, TextMotion textMotion, int i5, DefaultConstructorMarker defaultConstructorMarker) {
        int iM7364getUnspecifiede0LSkKk = (i5 & 1) != 0 ? TextAlign.INSTANCE.m7364getUnspecifiede0LSkKk() : i;
        int iM7380getUnspecifieds_7Xco = (i5 & 2) != 0 ? TextDirection.INSTANCE.m7380getUnspecifieds_7Xco() : i2;
        long jM7710getUnspecifiedXSAIIZE = (i5 & 4) != 0 ? TextUnit.INSTANCE.m7710getUnspecifiedXSAIIZE() : j;
        ...
        int iM7276getUnspecifiedrAG3T2k = (i5 & 64) != 0 ? LineBreak.INSTANCE.m7276getUnspecifiedrAG3T2k() : i3;
        int iM7252getUnspecifiedvmbZdU8 = (i5 & 128) != 0 ? Hyphens.INSTANCE.m7252getUnspecifiedvmbZdU8() : i4;
        this(iM7364getUnspecifiede0LSkKk, iM7380getUnspecifieds_7Xco, jM7710getUnspecifiedXSAIIZE, textIndent2, platformParagraphStyle2, lineHeightStyle2, iM7276getUnspecifiedrAG3T2k, iM7252getUnspecifiedvmbZdU8, (i5 & 256) == 0 ? textMotion : null, (DefaultConstructorMarker) null);
    }
    ...
    public final TextAlign m6832getTextAlignbuA522U() {
        return TextAlign.m7351boximpl(this.textAlign);
    }

    /* JADX INFO: renamed from: getTextDirection-mmuk1to, reason: not valid java name */
    public final TextDirection m6834getTextDirectionmmuk1to() {
        return TextDirection.m7368boximpl(this.textDirection);
    }

    /* JADX INFO: renamed from: getHyphens-EaSxIns, reason: not valid java name */
    public final Hyphens m6827getHyphensEaSxIns() {
        return Hyphens.m7243boximpl(this.hyphens);
    }

    /* JADX INFO: renamed from: getLineBreak-LgCVezo, reason: not valid java name */
    public final LineBreak m6829getLineBreakLgCVezo() {
        return LineBreak.m7256boximpl(this.lineBreak);
    }
    ...
    public /* synthetic */ ParagraphStyle(TextAlign textAlign, TextDirection textDirection, long j, TextIndent textIndent, PlatformParagraphStyle platformParagraphStyle, LineHeightStyle lineHeightStyle, LineBreak lineBreak, Hyphens hyphens, TextMotion textMotion, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? null : textAlign, (i & 2) != 0 ? null : textDirection, (i & 4) != 0 ? TextUnit.INSTANCE.m7710getUnspecifiedXSAIIZE() : j, (i & 8) != 0 ? null : textIndent, (i & 16) != 0 ? null : platformParagraphStyle, (i & 32) != 0 ? null : lineHeightStyle, (i & 64) != 0 ? null : lineBreak, (i & 128) != 0 ? null : hyphens, (i & 256) == 0 ? textMotion : null, (DefaultConstructorMarker) null);
    }
    ...
    public /* synthetic */ ParagraphStyle(TextAlign textAlign, TextDirection textDirection, long j, TextIndent textIndent, PlatformParagraphStyle platformParagraphStyle, LineHeightStyle lineHeightStyle, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? null : textAlign, (i & 2) != 0 ? null : textDirection, (i & 4) != 0 ? TextUnit.INSTANCE.m7710getUnspecifiedXSAIIZE() : j, (i & 8) != 0 ? null : textIndent, (i & 16) != 0 ? null : platformParagraphStyle, (i & 32) != 0 ? null : lineHeightStyle, null);
    }
    ...
    public /* synthetic */ ParagraphStyle(TextAlign textAlign, TextDirection textDirection, long j, TextIndent textIndent, PlatformParagraphStyle platformParagraphStyle, LineHeightStyle lineHeightStyle, LineBreak lineBreak, Hyphens hyphens, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? null : textAlign, (i & 2) != 0 ? null : textDirection, (i & 4) != 0 ? TextUnit.INSTANCE.m7710getUnspecifiedXSAIIZE() : j, (i & 8) != 0 ? null : textIndent, (i & 16) != 0 ? null : platformParagraphStyle, (i & 32) != 0 ? null : lineHeightStyle, (i & 64) != 0 ? null : lineBreak, (i & 128) == 0 ? hyphens : null, (DefaultConstructorMarker) null);
    }
    ...
    private ParagraphStyle(TextAlign textAlign, TextDirection textDirection, long lineHeight, TextIndent textIndent, PlatformParagraphStyle platformStyle, LineHeightStyle lineHeightStyle, LineBreak lineBreak, Hyphens hyphens) {
        this(textAlign != null ? textAlign.m7357unboximpl() : TextAlign.INSTANCE.m7364getUnspecifiede0LSkKk(), textDirection != null ? textDirection.m7374unboximpl() : TextDirection.INSTANCE.m7380getUnspecifieds_7Xco(), lineHeight, textIndent, platformStyle, lineHeightStyle, lineBreak != null ? lineBreak.getMask() : LineBreak.INSTANCE.m7276getUnspecifiedrAG3T2k(), hyphens != null ? hyphens.m7249unboximpl() : Hyphens.INSTANCE.m7252getUnspecifiedvmbZdU8(), (TextMotion) null, (DefaultConstructorMarker) null);
    }
    ...
    public final ParagraphStyle merge(ParagraphStyle other) {
        return other == null ? this : ParagraphStyleKt.m6836fastMergej5T8yCg(this, other.textAlign, other.textDirection, other.lineHeight, other.textIndent, other.platformStyle, other.lineHeightStyle, other.lineBreak, other.hyphens, other.textMotion);
    }
    ...
    public static /* synthetic */ ParagraphStyle m6813copyElsmlbk$default(ParagraphStyle paragraphStyle, TextAlign textAlign, TextDirection textDirection, long j, TextIndent textIndent, int i, Object obj) {
        if ((i & 1) != 0) {
            textAlign = TextAlign.m7351boximpl(paragraphStyle.textAlign);
        }
        if ((i & 2) != 0) {
            textDirection = TextDirection.m7368boximpl(paragraphStyle.textDirection);
        }
        if ((i & 4) != 0) {
            j = paragraphStyle.lineHeight;
        }
        return paragraphStyle.m6822copyElsmlbk(textAlign, textDirection, j, (i & 8) != 0 ? paragraphStyle.textIndent : textIndent);
    }
    ...
    public final /* synthetic */ ParagraphStyle m6822copyElsmlbk(TextAlign textAlign, TextDirection textDirection, long lineHeight, TextIndent textIndent) {
        return new ParagraphStyle(textAlign != null ? textAlign.m7357unboximpl() : TextAlign.INSTANCE.m7364getUnspecifiede0LSkKk(), textDirection != null ? textDirection.m7374unboximpl() : TextDirection.INSTANCE.m7380getUnspecifieds_7Xco(), lineHeight, textIndent, this.platformStyle, this.lineHeightStyle, this.lineBreak, this.hyphens, this.textMotion, (DefaultConstructorMarker) null);
    }

    /* JADX INFO: renamed from: copy-xPh5V4g$default, reason: not valid java name */
    public static /* synthetic */ ParagraphStyle m6816copyxPh5V4g$default(ParagraphStyle paragraphStyle, TextAlign textAlign, TextDirection textDirection, long j, TextIndent textIndent, PlatformParagraphStyle platformParagraphStyle, LineHeightStyle lineHeightStyle, int i, Object obj) {
        if ((i & 1) != 0) {
            textAlign = TextAlign.m7351boximpl(paragraphStyle.textAlign);
        }
        if ((i & 2) != 0) {
        ...
        return paragraphStyle.m6825copyxPh5V4g(textAlign, textDirection, j, textIndent, platformParagraphStyle, (i & 32) != 0 ? paragraphStyle.lineHeightStyle : lineHeightStyle);
    }

    @Deprecated(level = DeprecationLevel.HIDDEN, message = "ParagraphStyle copy constructors that do not take new stable parameters like LineHeightStyle, LineBreak, Hyphens are deprecated. Please use the new stable copy constructor.")
    /* JADX INFO: renamed from: copy-xPh5V4g, reason: not valid java name */
    public final /* synthetic */ ParagraphStyle m6825copyxPh5V4g(TextAlign textAlign, TextDirection textDirection, long lineHeight, TextIndent textIndent, PlatformParagraphStyle platformStyle, LineHeightStyle lineHeightStyle) {
    ...
    public static /* synthetic */ ParagraphStyle m6815copyciSxzs0$default(ParagraphStyle paragraphStyle, TextAlign textAlign, TextDirection textDirection, long j, TextIndent textIndent, PlatformParagraphStyle platformParagraphStyle, LineHeightStyle lineHeightStyle, LineBreak lineBreak, Hyphens hyphens, int i, Object obj) {
        ...
        if ((i & 64) != 0) {
            lineBreak = LineBreak.m7256boximpl(paragraphStyle.lineBreak);
        }
        return paragraphStyle.m6824copyciSxzs0(textAlign, textDirection, j, textIndent, platformParagraphStyle, lineHeightStyle, lineBreak, (i & 128) != 0 ? Hyphens.m7243boximpl(paragraphStyle.hyphens) : hyphens);
    }
    ...
    public final /* synthetic */ ParagraphStyle m6824copyciSxzs0(TextAlign textAlign, TextDirection textDirection, long lineHeight, TextIndent textIndent, PlatformParagraphStyle platformStyle, LineHeightStyle lineHeightStyle, LineBreak lineBreak, Hyphens hyphens) {
        return new ParagraphStyle(textAlign != null ? textAlign.m7357unboximpl() : TextAlign.INSTANCE.m7364getUnspecifiede0LSkKk(), textDirection != null ? textDirection.m7374unboximpl() : TextDirection.INSTANCE.m7380getUnspecifieds_7Xco(), lineHeight, textIndent, platformStyle, lineHeightStyle, lineBreak != null ? lineBreak.getMask() : LineBreak.INSTANCE.m7276getUnspecifiedrAG3T2k(), hyphens != null ? hyphens.m7249unboximpl() : Hyphens.INSTANCE.m7252getUnspecifiedvmbZdU8(), this.textMotion, (DefaultConstructorMarker) null);
    }

    /* JADX INFO: renamed from: copy-NH1kkwU$default, reason: not valid java name */
    public static /* synthetic */ ParagraphStyle m6814copyNH1kkwU$default(ParagraphStyle paragraphStyle, TextAlign textAlign, TextDirection textDirection, long j, TextIndent textIndent, PlatformParagraphStyle platformParagraphStyle, LineHeightStyle lineHeightStyle, LineBreak lineBreak, Hyphens hyphens, TextMotion textMotion, int i, Object obj) {
        if ((i & 1) != 0) {
            textAlign = TextAlign.m7351boximpl(paragraphStyle.textAlign);
        }
        if ((i & 2) != 0) {
        ...
        if ((i & 128) != 0) {
            hyphens = Hyphens.m7243boximpl(paragraphStyle.hyphens);
        }
        TextMotion textMotion2 = (i & 256) != 0 ? paragraphStyle.textMotion : textMotion;
        Hyphens hyphens2 = hyphens;
        LineHeightStyle lineHeightStyle2 = lineHeightStyle;
        TextIndent textIndent2 = textIndent;
        return paragraphStyle.m6823copyNH1kkwU(textAlign, textDirection, j, textIndent2, platformParagraphStyle, lineHeightStyle2, lineBreak, hyphens2, textMotion2);
    }
    ...
    public final /* synthetic */ ParagraphStyle m6823copyNH1kkwU(TextAlign textAlign, TextDirection textDirection, long lineHeight, TextIndent textIndent, PlatformParagraphStyle platformStyle, LineHeightStyle lineHeightStyle, LineBreak lineBreak, Hyphens hyphens, TextMotion textMotion) {
        return new ParagraphStyle(textAlign != null ? textAlign.m7357unboximpl() : TextAlign.INSTANCE.m7364getUnspecifiede0LSkKk(), textDirection != null ? textDirection.m7374unboximpl() : TextDirection.INSTANCE.m7380getUnspecifieds_7Xco(), lineHeight, textIndent, platformStyle, lineHeightStyle, lineBreak != null ? lineBreak.getMask() : LineBreak.INSTANCE.m7276getUnspecifiedrAG3T2k(), hyphens != null ? hyphens.m7249unboximpl() : Hyphens.INSTANCE.m7252getUnspecifiedvmbZdU8(), textMotion, (DefaultConstructorMarker) null);
    }

    /* JADX INFO: renamed from: copy-ykzQM6k$default, reason: not valid java name */
    public static /* synthetic */ ParagraphStyle m6817copyykzQM6k$default(ParagraphStyle paragraphStyle, int i, int i2, long j, TextIndent textIndent, PlatformParagraphStyle platformParagraphStyle, LineHeightStyle lineHeightStyle, int i3, int i4, TextMotion textMotion, int i5, Object obj) {
        if ((i5 & 1) != 0) {
        ...
        LineHeightStyle lineHeightStyle2 = lineHeightStyle;
        TextIndent textIndent2 = textIndent;
        return paragraphStyle.m6826copyykzQM6k(i, i2, j, textIndent2, platformParagraphStyle, lineHeightStyle2, i3, i6, textMotion2);
    }

    /* JADX INFO: renamed from: copy-ykzQM6k, reason: not valid java name */
    public final ParagraphStyle m6826copyykzQM6k(int textAlign, int textDirection, long lineHeight, TextIndent textIndent, PlatformParagraphStyle platformStyle, LineHeightStyle lineHeightStyle, int lineBreak, int hyphens, TextMotion textMotion) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof ParagraphStyle) && TextAlign.m7354equalsimpl0(this.textAlign, ((ParagraphStyle) other).textAlign) && TextDirection.m7371equalsimpl0(this.textDirection, ((ParagraphStyle) other).textDirection) && TextUnit.m7696equalsimpl0(this.lineHeight, ((ParagraphStyle) other).lineHeight) && Intrinsics.areEqual(this.textIndent, ((ParagraphStyle) other).textIndent) && Intrinsics.areEqual(this.platformStyle, ((ParagraphStyle) other).platformStyle) && Intrinsics.areEqual(this.lineHeightStyle, ((ParagraphStyle) other).lineHeightStyle) && LineBreak.m7262equalsimpl0(this.lineBreak, ((ParagraphStyle) other).lineBreak) && Hyphens.m7246equalsimpl0(this.hyphens, ((ParagraphStyle) other).hyphens) && Intrinsics.areEqual(this.textMotion, ((ParagraphStyle) other).textMotion);
    }

    public int hashCode() {
        int result = TextAlign.m7355hashCodeimpl(this.textAlign);
        int result2 = ((((result * 31) + TextDirection.m7372hashCodeimpl(this.textDirection)) * 31) + TextUnit.m7700hashCodeimpl(this.lineHeight)) * 31;
        ...
        int result5 = (((((result4 + (lineHeightStyle != null ? lineHeightStyle.hashCode() : 0)) * 31) + LineBreak.m7266hashCodeimpl(this.lineBreak)) * 31) + Hyphens.m7247hashCodeimpl(this.hyphens)) * 31;
        TextMotion textMotion = this.textMotion;
        return result5 + (textMotion != null ? textMotion.hashCode() : 0);
    }

    public String toString() {
        return "ParagraphStyle(textAlign=" + ((Object) TextAlign.m7356toStringimpl(this.textAlign)) + ", textDirection=" + ((Object) TextDirection.m7373toStringimpl(this.textDirection)) + ", lineHeight=" + ((Object) TextUnit.m7706toStringimpl(this.lineHeight)) + ", textIndent=" + this.textIndent + ", platformStyle=" + this.platformStyle + ", lineHeightStyle=" + this.lineHeightStyle + ", lineBreak=" + ((Object) LineBreak.m7267toStringimpl(this.lineBreak)) + ", hyphens=" + ((Object) Hyphens.m7248toStringimpl(this.hyphens)) + ", textMotion=" + this.textMotion + ')';
    }
}
