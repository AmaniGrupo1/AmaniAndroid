...
public final class Bullet implements AnnotatedString.Annotation {
    ...
    public static /* synthetic */ Bullet m6767copyw_4Rhrw$default(Bullet bullet, Shape shape, long j, long j2, long j3, Brush brush, float f, DrawStyle drawStyle, int i, Object obj) {
        if ((i & 1) != 0) {
            shape = bullet.shape;
        }
        if ((i & 2) != 0) {
        ...
        long j4 = j3;
        return bullet.m6768copyw_4Rhrw(shape, j, j2, j4, brush, f, (i & 64) != 0 ? bullet.drawStyle : drawStyle);
    }

    /* JADX INFO: renamed from: copy-w_4Rhrw, reason: not valid java name */
    public final Bullet m6768copyw_4Rhrw(Shape shape, long width, long height, long padding, Brush brush, float alpha, DrawStyle drawStyle) {
    ...
    public boolean equals(Object other) {
        ...
        if (other == null || !(other instanceof Bullet) || !Intrinsics.areEqual(this.shape, ((Bullet) other).shape) || !TextUnit.m7696equalsimpl0(this.size, ((Bullet) other).size) || !TextUnit.m7696equalsimpl0(this.height, ((Bullet) other).height) || !TextUnit.m7696equalsimpl0(this.padding, ((Bullet) other).padding) || !Intrinsics.areEqual(this.brush, ((Bullet) other).brush)) {
            return false;
        }
    ...
    public int hashCode() {
        ...
        int result2 = ((((((result * 31) + TextUnit.m7700hashCodeimpl(this.size)) * 31) + TextUnit.m7700hashCodeimpl(this.height)) * 31) + TextUnit.m7700hashCodeimpl(this.padding)) * 31;
        Brush brush = this.brush;
        return ((((result2 + (brush != null ? brush.hashCode() : 0)) * 31) + Float.hashCode(this.alpha)) * 31) + this.drawStyle.hashCode();
    }

    public String toString() {
        return "Bullet(shape=" + this.shape + ", size=(" + ((Object) TextUnit.m7706toStringimpl(this.size)) + ", " + ((Object) TextUnit.m7706toStringimpl(this.height)) + "), padding=" + ((Object) TextUnit.m7706toStringimpl(this.padding)) + ", brush=" + this.brush + ", alpha=" + this.alpha + ", drawStyle=" + this.drawStyle + ')';
    }
