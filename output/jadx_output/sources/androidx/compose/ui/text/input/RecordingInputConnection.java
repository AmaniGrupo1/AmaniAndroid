...
public final class RecordingInputConnection implements InputConnection {
    ...
    public CharSequence getSelectedText(int flags) {
        if (TextRange.m6922getCollapsedimpl(this.mTextFieldValue.getSelection())) {
            return null;
        }
    ...
    public boolean performEditorAction(int editorAction) {
        ...
        if (applying$iv) {
            ...
            this.eventCallback.mo7128onImeActionKlQnJC8(imeAction);
            return true;
        }
        return applying$iv;
    }
    ...
    public int getCursorCapsMode(int reqModes) {
        return TextUtils.getCapsMode(this.mTextFieldValue.getText(), TextRange.m6926getMinimpl(this.mTextFieldValue.getSelection()), reqModes);
    }
