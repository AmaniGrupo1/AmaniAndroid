...
public final class TextFieldValue {
    ...
    private static final Saver<TextFieldValue, Object> Saver = SaverKt.Saver(new Function2() { // from class: androidx.compose.ui.text.input.TextFieldValue$$ExternalSyntheticLambda0
        ...
        public final Object invoke(Object obj, Object obj2) {
            ...
            return CollectionsKt.arrayListOf(SaversKt.save(textFieldValue.text, SaversKt.getAnnotatedStringSaver(), saverScope), SaversKt.save(TextRange.m6916boximpl(textFieldValue.selection), SaversKt.getSaver(TextRange.INSTANCE), saverScope));
        }
    ...
    private TextFieldValue(AnnotatedString annotatedString, long selection, TextRange composition) {
        ...
        this.selection = TextRangeKt.m6934coerceIn8ffj60Q(selection, 0, getText().length());
        this.composition = composition != null ? TextRange.m6916boximpl(TextRangeKt.m6934coerceIn8ffj60Q(composition.getPackedValue(), 0, getText().length())) : null;
    }
    ...
    public /* synthetic */ TextFieldValue(AnnotatedString annotatedString, long j, TextRange textRange, int i, DefaultConstructorMarker defaultConstructorMarker) {
        long jM6933getZerod9O1mEE;
        TextRange textRange2;
        if ((i & 2) == 0) {
            jM6933getZerod9O1mEE = j;
        } else {
            jM6933getZerod9O1mEE = TextRange.INSTANCE.m6933getZerod9O1mEE();
        }
        if ((i & 4) == 0) {
        ...
        this(annotatedString, jM6933getZerod9O1mEE, textRange2, (DefaultConstructorMarker) null);
    }
    ...
    public /* synthetic */ TextFieldValue(String str, long j, TextRange textRange, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? "" : str, (i & 2) != 0 ? TextRange.INSTANCE.m6933getZerod9O1mEE() : j, (i & 4) != 0 ? null : textRange, (DefaultConstructorMarker) null);
    }
    ...
    public static /* synthetic */ TextFieldValue m7173copy3r_uNRQ$default(TextFieldValue textFieldValue, AnnotatedString annotatedString, long j, TextRange textRange, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return textFieldValue.m7175copy3r_uNRQ(annotatedString, j, textRange);
    }

    /* JADX INFO: renamed from: copy-3r_uNRQ, reason: not valid java name */
    public final TextFieldValue m7175copy3r_uNRQ(AnnotatedString annotatedString, long selection, TextRange composition) {
        return new TextFieldValue(annotatedString, selection, composition, (DefaultConstructorMarker) null);
    }

    /* JADX INFO: renamed from: copy-3r_uNRQ$default, reason: not valid java name */
    public static /* synthetic */ TextFieldValue m7174copy3r_uNRQ$default(TextFieldValue textFieldValue, String str, long j, TextRange textRange, int i, Object obj) {
        if ((i & 2) != 0) {
            j = textFieldValue.selection;
        }
        if ((i & 4) != 0) {
        ...
        return textFieldValue.m7176copy3r_uNRQ(str, j, textRange);
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* JADX INFO: renamed from: copy-3r_uNRQ, reason: not valid java name */
    public final TextFieldValue m7176copy3r_uNRQ(String text, long selection, TextRange composition) {
    ...
    public boolean equals(Object other) {
        ...
        if (other instanceof TextFieldValue) {
            return TextRange.m6921equalsimpl0(this.selection, ((TextFieldValue) other).selection) && Intrinsics.areEqual(this.composition, ((TextFieldValue) other).composition) && Intrinsics.areEqual(this.text, ((TextFieldValue) other).text);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        int result2 = ((result * 31) + TextRange.m6929hashCodeimpl(this.selection)) * 31;
        TextRange textRange = this.composition;
        return result2 + (textRange != null ? TextRange.m6929hashCodeimpl(textRange.getPackedValue()) : 0);
    }

    public String toString() {
        return "TextFieldValue(text='" + ((Object) this.text) + "', selection=" + ((Object) TextRange.m6931toStringimpl(this.selection)) + ", composition=" + this.composition + ')';
    }
