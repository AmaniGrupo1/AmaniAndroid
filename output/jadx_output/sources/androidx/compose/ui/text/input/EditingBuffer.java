...
public final class EditingBuffer {
    ...
    private EditingBuffer(AnnotatedString text, long selection) {
        ...
        this.selectionStart = TextRange.m6926getMinimpl(selection);
        this.selectionEnd = TextRange.m6925getMaximpl(selection);
        this.compositionStart = -1;
        this.compositionEnd = -1;
        int start = TextRange.m6926getMinimpl(selection);
        int end = TextRange.m6925getMaximpl(selection);
    ...
    public final TextRange m7090getCompositionMzsxiRA$ui_text() {
        if (hasComposition$ui_text()) {
            return TextRange.m6916boximpl(TextRangeKt.TextRange(this.compositionStart, this.compositionEnd));
        }
        return null;
    }

    /* JADX INFO: renamed from: getSelection-d9O1mEE$ui_text, reason: not valid java name */
    public final long m7091getSelectiond9O1mEE$ui_text() {
    ...
    public final void delete$ui_text(int start, int end) {
        ...
        long newSelection = EditingBufferKt.m7092updateRangeAfterDeletepWDy79M(TextRangeKt.TextRange(this.selectionStart, this.selectionEnd), deleteRange);
        setSelectionStart(TextRange.m6926getMinimpl(newSelection));
        setSelectionEnd(TextRange.m6925getMaximpl(newSelection));
        if (hasComposition$ui_text()) {
            long compositionRange = TextRangeKt.TextRange(this.compositionStart, this.compositionEnd);
            long newComposition = EditingBufferKt.m7092updateRangeAfterDeletepWDy79M(compositionRange, deleteRange);
            if (TextRange.m6922getCollapsedimpl(newComposition)) {
                commitComposition$ui_text();
            } else {
                this.compositionStart = TextRange.m6926getMinimpl(newComposition);
                this.compositionEnd = TextRange.m6925getMaximpl(newComposition);
            }
        }
    }
