    ...
    public void updateDrawState(TextPaint textPaint) {
        if (textPaint != null) {
            ...
            if (!Intrinsics.areEqual(drawStyle, Fill.INSTANCE)) {
                ...
                textPaint.setStrokeJoin(DrawStyleSpan_androidKt.m7217toAndroidJoinWw9F2mQ(((Stroke) this.drawStyle).getJoin()));
                textPaint.setStrokeCap(DrawStyleSpan_androidKt.m7216toAndroidCapBeK7IIE(((Stroke) this.drawStyle).getCap()));
