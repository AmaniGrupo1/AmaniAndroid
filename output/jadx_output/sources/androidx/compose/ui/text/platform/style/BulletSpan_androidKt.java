...
public final class BulletSpan_androidKt {
    ...
    public static final void setDrawStyle(Paint $this$setDrawStyle, DrawStyle value) {
        if (!Intrinsics.areEqual(value, Fill.INSTANCE)) {
            ...
            $this$setDrawStyle.setStrokeCap(DrawStyleSpan_androidKt.m7216toAndroidCapBeK7IIE(((Stroke) value).getCap()));
            $this$setDrawStyle.setStrokeJoin(DrawStyleSpan_androidKt.m7217toAndroidJoinWw9F2mQ(((Stroke) value).getJoin()));
    ...
    public static final void draw(Outline $this$draw, Canvas canvas, Paint paint, float xStart, float yCenter, int dir) {
        ...
        if ($this$draw instanceof Outline.Rounded) {
            ...
            int bits$iv$iv$iv = (int) (((Outline.Rounded) $this$draw).getRoundRect().m4502getTopLeftCornerRadiuskKHJgLs() >> 32);
    ...
    public static final void m7214setBrushAndDrawyzxVdVo(Paint $this$setBrushAndDraw_u2dyzxVdVo, Brush brush, float alpha, long j, Function0<Unit> function0) {
        ...
        if (brush instanceof SolidColor) {
            ...
            $this$setBrushAndDraw_u2dyzxVdVo.setColor(ColorKt.m4751toArgb8_81llA(((SolidColor) brush).getValue()));
            function0.invoke();
        ...
        $this$setBrushAndDraw_u2dyzxVdVo.setShader(((ShaderBrush) brush).mo4666createShaderuvyYCjk(j));
        function0.invoke();
