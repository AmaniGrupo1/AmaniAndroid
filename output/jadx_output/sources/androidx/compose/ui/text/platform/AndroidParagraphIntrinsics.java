...
public final class AndroidParagraphIntrinsics implements ParagraphIntrinsics {
    ...
    public AndroidParagraphIntrinsics(String text, TextStyle style, List<? extends AnnotatedString.Range<? extends AnnotatedString.Annotation>> list, List<AnnotatedString.Range<Placeholder>> list2, FontFamily.Resolver fontFamilyResolver, Density density) {
        ...
        this.textDirectionHeuristic = AndroidParagraphIntrinsics_androidKt.m7186resolveTextDirectionHeuristicsHklW4sA(this.style.m6971getTextDirections_7Xco(), this.style.getLocaleList());
    ...
    static final Typeface _init_$lambda$0(AndroidParagraphIntrinsics this$0, FontFamily fontFamily, FontWeight fontWeight, FontStyle fontStyle, FontSynthesis fontSynthesis) {
        State<Object> stateMo7013resolveDPcqOEQ = this$0.fontFamilyResolver.mo7013resolveDPcqOEQ(fontFamily, fontWeight, fontStyle.m7043unboximpl(), fontSynthesis.m7056unboximpl());
        if (!(stateMo7013resolveDPcqOEQ instanceof TypefaceResult.Immutable)) {
            TypefaceDirtyTrackerLinkedList newHead = new TypefaceDirtyTrackerLinkedList(stateMo7013resolveDPcqOEQ, this$0.resolvedTypefaces);
            this$0.resolvedTypefaces = newHead;
            return newHead.getTypeface();
        }
        Object value = ((TypefaceResult.Immutable) stateMo7013resolveDPcqOEQ).getValue();
