...
public final class AndroidParagraphIntrinsics_androidKt {
    ...
    public static /* synthetic */ int m7187resolveTextDirectionHeuristicsHklW4sA$default(int i, LocaleList localeList, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            localeList = null;
        }
        return m7186resolveTextDirectionHeuristicsHklW4sA(i, localeList);
    }

    /* JADX INFO: renamed from: resolveTextDirectionHeuristics-HklW4sA, reason: not valid java name */
    public static final int m7186resolveTextDirectionHeuristicsHklW4sA(int i, LocaleList localeList) {
        Locale currentLocale;
        if (TextDirection.m7371equalsimpl0(i, TextDirection.INSTANCE.m7376getContentOrLtrs_7Xco())) {
            return 2;
        }
        if (TextDirection.m7371equalsimpl0(i, TextDirection.INSTANCE.m7377getContentOrRtls_7Xco())) {
            return 3;
        }
        if (TextDirection.m7371equalsimpl0(i, TextDirection.INSTANCE.m7378getLtrs_7Xco())) {
            return 0;
        }
        if (TextDirection.m7371equalsimpl0(i, TextDirection.INSTANCE.m7379getRtls_7Xco())) {
            return 1;
        }
        if (TextDirection.m7371equalsimpl0(i, TextDirection.INSTANCE.m7375getContents_7Xco()) || TextDirection.m7371equalsimpl0(i, TextDirection.INSTANCE.m7380getUnspecifieds_7Xco())) {
    ...
    public static final boolean getHasEmojiCompat(TextStyle $this$hasEmojiCompat) {
        ...
        return !(((platformStyle == null || (paragraphSyle = platformStyle.getParagraphSyle()) == null) ? null : EmojiSupportMatch.m6775boximpl(paragraphSyle.getEmojiSupportMatch())) == null ? false : EmojiSupportMatch.m6778equalsimpl0(r0.getValue(), EmojiSupportMatch.INSTANCE.m6784getNone_3YsG6Y()));
    }
}
