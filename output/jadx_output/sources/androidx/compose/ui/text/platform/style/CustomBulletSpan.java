...
public final class CustomBulletSpan implements LeadingMarginSpan {
    ...
    public void drawLeadingMargin(final Canvas c, final Paint p, int x, final int dir, int top, int baseline, int bottom, CharSequence text, int start, int end, boolean first, Layout layout) {
        ...
        if (((Spanned) text).getSpanStart(this) == start && p != null) {
            ...
            final long bulletSize = Size.m4512constructorimpl((v1$iv$iv << 32) | (v2$iv$iv & 4294967295L));
            BulletSpan_androidKt.m7214setBrushAndDrawyzxVdVo(p, this.brush, this.alpha, bulletSize, new Function0() { // from class: androidx.compose.ui.text.platform.style.CustomBulletSpan$$ExternalSyntheticLambda0
    ...
    public static final Unit drawLeadingMargin$lambda$0$0(CustomBulletSpan this$0, long $bulletSize, int $dir, Canvas $c, Paint $paint, int $xStart, float $yCenter) {
        Outline outline = this$0.shape.mo320createOutlinePq9zytI($bulletSize, $dir > 0 ? LayoutDirection.Ltr : LayoutDirection.Rtl, this$0.density);
