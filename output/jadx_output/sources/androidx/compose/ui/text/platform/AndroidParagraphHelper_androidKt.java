...
public final class AndroidParagraphHelper_androidKt {
    ...
    public static final CharSequence createCharSequence(String text, float contextFontSize, TextStyle contextTextStyle, List<? extends AnnotatedString.Range<? extends AnnotatedString.Annotation>> list, List<AnnotatedString.Range<Placeholder>> list2, Density density, Function4<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> function4, boolean useEmojiCompat) {
        ...
        if (useEmojiCompat && EmojiCompat.isConfigured()) {
            ...
            EmojiSupportMatch emojiSupportMatch = (platformStyle == null || (paragraphSyle = platformStyle.getParagraphSyle()) == null) ? null : EmojiSupportMatch.m6775boximpl(paragraphSyle.getEmojiSupportMatch());
            if (emojiSupportMatch == null ? false : EmojiSupportMatch.m6778equalsimpl0(emojiSupportMatch.getValue(), EmojiSupportMatch.INSTANCE.m6782getAll_3YsG6Y())) {
                i = 1;
            } else {
                i = 0;
            }
        ...
        if (list.isEmpty() && list2.isEmpty() && Intrinsics.areEqual(contextTextStyle.getTextIndent(), TextIndent.INSTANCE.getNone())) {
            if (TextUnit.m7697getRawTypeimpl(contextTextStyle.m6967getLineHeightXSAIIZE()) == 0) {
                return currentText;
            }
        }
        ...
        if (isIncludeFontPaddingEnabled(contextTextStyle) && contextTextStyle.getLineHeightStyle() == null) {
            SpannableExtensions_androidKt.m7211setLineHeightr9BaKPg(spannableString, contextTextStyle.m6967getLineHeightXSAIIZE(), contextFontSize, density);
        } else {
            ...
            SpannableExtensions_androidKt.m7210setLineHeightKmRG4DE(spannableString, contextTextStyle.m6967getLineHeightXSAIIZE(), contextFontSize, density, lineHeightStyle2);
        }
