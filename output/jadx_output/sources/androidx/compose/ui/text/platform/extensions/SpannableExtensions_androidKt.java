...
public final class SpannableExtensions_androidKt {
    ...
    public static final void setTextIndent(Spannable $this$setTextIndent, TextIndent textIndent, float contextFontSize, Density density) {
        float firstLine;
        if (textIndent != null) {
            if (!TextUnit.m7696equalsimpl0(textIndent.getFirstLine(), TextUnitKt.getSp(0)) || !TextUnit.m7696equalsimpl0(textIndent.getRestLine(), TextUnitKt.getSp(0))) {
                if (!(TextUnit.m7697getRawTypeimpl(textIndent.getFirstLine()) == 0)) {
                    if (!(TextUnit.m7697getRawTypeimpl(textIndent.getRestLine()) == 0)) {
                        long jM7698getTypeUIouoOA = TextUnit.m7698getTypeUIouoOA(textIndent.getFirstLine());
                        float restLine = 0.0f;
                        if (TextUnitType.m7727equalsimpl0(jM7698getTypeUIouoOA, TextUnitType.INSTANCE.m7732getSpUIouoOA())) {
                            firstLine = density.mo404toPxR2X_6o(textIndent.getFirstLine());
                        } else {
                            firstLine = TextUnitType.m7727equalsimpl0(jM7698getTypeUIouoOA, TextUnitType.INSTANCE.m7731getEmUIouoOA()) ? TextUnit.m7699getValueimpl(textIndent.getFirstLine()) * contextFontSize : 0.0f;
                        }
                        long jM7698getTypeUIouoOA2 = TextUnit.m7698getTypeUIouoOA(textIndent.getRestLine());
                        if (TextUnitType.m7727equalsimpl0(jM7698getTypeUIouoOA2, TextUnitType.INSTANCE.m7732getSpUIouoOA())) {
                            restLine = density.mo404toPxR2X_6o(textIndent.getRestLine());
                        } else if (TextUnitType.m7727equalsimpl0(jM7698getTypeUIouoOA2, TextUnitType.INSTANCE.m7731getEmUIouoOA())) {
                            restLine = TextUnit.m7699getValueimpl(textIndent.getRestLine()) * contextFontSize;
                        }
    ...
    public static final void setBulletSpans(Spannable $this$setBulletSpans, List<? extends AnnotatedString.Range<? extends AnnotatedString.Annotation>> list, float contextFontSize, Density density, TextIndent textIndent) {
        ...
        float fM7699getValueimpl = 0.0f;
        if (textIndent != null) {
            long jM7698getTypeUIouoOA = TextUnit.m7698getTypeUIouoOA(textIndent.getFirstLine());
            if (TextUnitType.m7727equalsimpl0(jM7698getTypeUIouoOA, TextUnitType.INSTANCE.m7732getSpUIouoOA())) {
                fM7699getValueimpl = density.mo404toPxR2X_6o(textIndent.getFirstLine());
            } else if (TextUnitType.m7727equalsimpl0(jM7698getTypeUIouoOA, TextUnitType.INSTANCE.m7731getEmUIouoOA())) {
                fM7699getValueimpl = TextUnit.m7699getValueimpl(textIndent.getFirstLine()) * contextFontSize;
            }
            textIndentPx = fM7699getValueimpl;
        } else {
            textIndentPx = 0.0f;
        }
        int size = list.size();
        ...
        while (index$iv < size) {
            ...
            if (bullet != null) {
                ...
                float bulletWidthPx = m7204resolveBulletTextUnitToPxo2QH7mI(bullet2.getSize(), contextFontSize, density2);
                float bulletHeightPx = m7204resolveBulletTextUnitToPxo2QH7mI(bullet2.getHeight(), contextFontSize, density2);
                float gapWidthPx = m7204resolveBulletTextUnitToPxo2QH7mI(bullet2.getPadding(), contextFontSize, density2);
    ...
    private static final float m7204resolveBulletTextUnitToPxo2QH7mI(long j, float contextFontSize, Density density) {
        if (TextUnit.m7696equalsimpl0(j, TextUnit.INSTANCE.m7710getUnspecifiedXSAIIZE())) {
            return contextFontSize;
        }
        long jM7698getTypeUIouoOA = TextUnit.m7698getTypeUIouoOA(j);
        if (TextUnitType.m7727equalsimpl0(jM7698getTypeUIouoOA, TextUnitType.INSTANCE.m7732getSpUIouoOA())) {
            return density.mo404toPxR2X_6o(j);
        }
        if (TextUnitType.m7727equalsimpl0(jM7698getTypeUIouoOA, TextUnitType.INSTANCE.m7731getEmUIouoOA())) {
            return TextUnit.m7699getValueimpl(j) * contextFontSize;
        }
        return Float.NaN;
    }

    /* JADX INFO: renamed from: setLineHeight-KmRG4DE, reason: not valid java name */
    public static final void m7210setLineHeightKmRG4DE(Spannable $this$setLineHeight_u2dKmRG4DE, long j, float contextFontSize, Density density, LineHeightStyle lineHeightStyle) {
        float resolvedLineHeight = m7205resolveLineHeightInPxo2QH7mI(j, contextFontSize, density);
        if (!Float.isNaN(resolvedLineHeight)) {
            ...
            setSpan($this$setLineHeight_u2dKmRG4DE, new LineHeightStyleSpan(resolvedLineHeight, 0, endIndex, LineHeightStyle.Trim.m7343isTrimFirstLineTopimpl$ui_text(lineHeightStyle.getTrim()), LineHeightStyle.Trim.m7344isTrimLastLineBottomimpl$ui_text(lineHeightStyle.getTrim()), lineHeightStyle.getAlignment(), lineHeightStyle.getMode(), null), 0, $this$setLineHeight_u2dKmRG4DE.length());
        }
    }

    /* JADX INFO: renamed from: setLineHeight-r9BaKPg, reason: not valid java name */
    public static final void m7211setLineHeightr9BaKPg(Spannable $this$setLineHeight_u2dr9BaKPg, long j, float contextFontSize, Density density) {
        float resolvedLineHeight = m7205resolveLineHeightInPxo2QH7mI(j, contextFontSize, density);
        if (!Float.isNaN(resolvedLineHeight)) {
    ...
    private static final float m7205resolveLineHeightInPxo2QH7mI(long j, float contextFontSize, Density density) {
        long jM7698getTypeUIouoOA = TextUnit.m7698getTypeUIouoOA(j);
        if (TextUnitType.m7727equalsimpl0(jM7698getTypeUIouoOA, TextUnitType.INSTANCE.m7732getSpUIouoOA())) {
            if (!isNonLinearFontScalingActive(density)) {
                return density.mo404toPxR2X_6o(j);
            }
            long fontSizeSp = density.mo408toSpkPz2Gy4(contextFontSize);
            float lineHeightMultiplier = TextUnit.m7699getValueimpl(j) / TextUnit.m7699getValueimpl(fontSizeSp);
        ...
        if (hasLetterSpacing) {
            ...
            for (int i2 = 0; i2 < size2; i2++) {
                ...
                if (style instanceof SpanStyle) {
                    ...
                    if (start2 >= 0 && start2 < $this$setSpanStyles.length() && end2 > start2 && end2 <= $this$setSpanStyles.length() && (it = m7203createLetterSpacingSpaneAf_CNQ(((SpanStyle) style).getLetterSpacing(), density)) != null) {
    ...
    private static final void setSpanStyle(Spannable $this$setSpanStyle, SpanStyle style, int start, int end, Density density) {
        m7207setBaselineShift0ocSgnM($this$setSpanStyle, style.getBaselineShift(), start, end);
        m7208setColorRPmYEkk($this$setSpanStyle, style.m6869getColor0d7_KjU(), start, end);
        ...
        m7209setFontSizeKmRG4DE($this$setSpanStyle, style.getFontSize(), density, start, end);
        ...
        m7206setBackgroundRPmYEkk($this$setSpanStyle, style.getBackground(), start, end);
    ...
    static final Unit setFontAttributes$lambda$2(Spannable $this_setFontAttributes, Function4 $resolveTypeface, SpanStyle spanStyle, int start, int end) {
        ...
        $this_setFontAttributes.setSpan(new TypefaceSpan((Typeface) $resolveTypeface.invoke(fontFamily, fontWeight, fontStyleM7037boximpl, FontSynthesis.m7048boximpl(fontSynthesis != null ? fontSynthesis.m7056unboximpl() : FontSynthesis.INSTANCE.m7057getAllGVVA2EU()))), start, end, 33);
    ...
    private static final MetricAffectingSpan m7203createLetterSpacingSpaneAf_CNQ(long j, Density density) {
        long jM7698getTypeUIouoOA = TextUnit.m7698getTypeUIouoOA(j);
        if (TextUnitType.m7727equalsimpl0(jM7698getTypeUIouoOA, TextUnitType.INSTANCE.m7732getSpUIouoOA())) {
            return new LetterSpacingSpanPx(density.mo404toPxR2X_6o(j));
        }
        if (TextUnitType.m7727equalsimpl0(jM7698getTypeUIouoOA, TextUnitType.INSTANCE.m7731getEmUIouoOA())) {
            return new LetterSpacingSpanEm(TextUnit.m7699getValueimpl(j));
        }
        return null;
    }

    private static final boolean getNeedsLetterSpacingSpan(SpanStyle $this$needsLetterSpacingSpan) {
        return TextUnitType.m7727equalsimpl0(TextUnit.m7698getTypeUIouoOA($this$needsLetterSpacingSpan.getLetterSpacing()), TextUnitType.INSTANCE.m7732getSpUIouoOA()) || TextUnitType.m7727equalsimpl0(TextUnit.m7698getTypeUIouoOA($this$needsLetterSpacingSpan.getLetterSpacing()), TextUnitType.INSTANCE.m7731getEmUIouoOA());
    }

    private static final void setShadow(Spannable $this$setShadow, Shadow shadow, int start, int end) {
        if (shadow != null) {
            int iM4751toArgb8_81llA = ColorKt.m4751toArgb8_81llA(shadow.getColor());
            int bits$iv$iv$iv = (int) (shadow.getOffset() >> 32);
            float fIntBitsToFloat = Float.intBitsToFloat(bits$iv$iv$iv);
            int bits$iv$iv$iv2 = (int) (4294967295L & shadow.getOffset());
            setSpan($this$setShadow, new ShadowSpan(iM4751toArgb8_81llA, fIntBitsToFloat, Float.intBitsToFloat(bits$iv$iv$iv2), TextPaintExtensions_androidKt.correctBlurRadius(shadow.getBlurRadius())), start, end);
        }
    }
    ...
    public static final void m7206setBackgroundRPmYEkk(Spannable $this$setBackground_u2dRPmYEkk, long j, int start, int end) {
        if (j != 16) {
            setSpan($this$setBackground_u2dRPmYEkk, new BackgroundColorSpan(ColorKt.m4751toArgb8_81llA(j)), start, end);
        }
    }
    ...
    public static final void m7209setFontSizeKmRG4DE(Spannable $this$setFontSize_u2dKmRG4DE, long j, Density density, int start, int end) {
        long jM7698getTypeUIouoOA = TextUnit.m7698getTypeUIouoOA(j);
        if (TextUnitType.m7727equalsimpl0(jM7698getTypeUIouoOA, TextUnitType.INSTANCE.m7732getSpUIouoOA())) {
            setSpan($this$setFontSize_u2dKmRG4DE, new AbsoluteSizeSpan(MathKt.roundToInt(density.mo404toPxR2X_6o(j)), false), start, end);
        } else if (TextUnitType.m7727equalsimpl0(jM7698getTypeUIouoOA, TextUnitType.INSTANCE.m7731getEmUIouoOA())) {
            setSpan($this$setFontSize_u2dKmRG4DE, new RelativeSizeSpan(TextUnit.m7699getValueimpl(j)), start, end);
        }
    }
    ...
    public static final void m7208setColorRPmYEkk(Spannable $this$setColor_u2dRPmYEkk, long j, int start, int end) {
        if (j != 16) {
            setSpan($this$setColor_u2dRPmYEkk, new ForegroundColorSpan(ColorKt.m4751toArgb8_81llA(j)), start, end);
        }
    }

    /* JADX INFO: renamed from: setBaselineShift-0ocSgnM, reason: not valid java name */
    private static final void m7207setBaselineShift0ocSgnM(Spannable $this$setBaselineShift_u2d0ocSgnM, BaselineShift baselineShift, int start, int end) {
        if (baselineShift != null) {
            float it = baselineShift.m7226unboximpl();
    ...
    private static final void setBrush(Spannable $this$setBrush, Brush brush, float alpha, int start, int end) {
        if (brush != null) {
            if (brush instanceof SolidColor) {
                m7208setColorRPmYEkk($this$setBrush, ((SolidColor) brush).getValue(), start, end);
            } else {
    ...
    private static final boolean hasFontAttributes(TextStyle $this$hasFontAttributes) {
        return TextPaintExtensions_androidKt.hasFontAttributes($this$hasFontAttributes.toSpanStyle()) || $this$hasFontAttributes.m6961getFontSynthesisZQGJjVo() != null;
    }
