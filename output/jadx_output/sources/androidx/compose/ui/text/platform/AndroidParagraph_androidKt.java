...
public final class AndroidParagraph_androidKt {
    ...
    public static final Paragraph ActualParagraph(String text, TextStyle style, List<? extends AnnotatedString.Range<? extends AnnotatedString.Annotation>> list, List<AnnotatedString.Range<Placeholder>> list2, int maxLines, boolean ellipsis, float width, Density density, Font.ResourceLoader resourceLoader) {
        ...
        return new AndroidParagraph(androidParagraphIntrinsics, maxLines, ellipsis ? companion.m7416getEllipsisgIe3tQ8() : companion.m7415getClipgIe3tQ8(), ConstraintsKt.Constraints$default(0, ParagraphKt.ceilToInt(width), 0, 0, 13, null), null);
    }

    /* JADX INFO: renamed from: ActualParagraph-XGqx6AY, reason: not valid java name */
    public static final Paragraph m7189ActualParagraphXGqx6AY(String text, TextStyle style, List<? extends AnnotatedString.Range<? extends AnnotatedString.Annotation>> list, List<AnnotatedString.Range<Placeholder>> list2, int maxLines, int i, long j, Density density, FontFamily.Resolver fontFamilyResolver) {
        return new AndroidParagraph(new AndroidParagraphIntrinsics(text, style, list, list2, fontFamilyResolver, density), maxLines, i, j, null);
    }

    /* JADX INFO: renamed from: ActualParagraph-4FmOz70, reason: not valid java name */
    public static final Paragraph m7188ActualParagraph4FmOz70(ParagraphIntrinsics paragraphIntrinsics, int maxLines, int i, long j) {
        ...
        return new AndroidParagraph((AndroidParagraphIntrinsics) paragraphIntrinsics, maxLines, i, j, null);
    }
}
