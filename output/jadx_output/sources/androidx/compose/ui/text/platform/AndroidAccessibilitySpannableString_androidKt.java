...
public final class AndroidAccessibilitySpannableString_androidKt {
    public static final SpannableString toAccessibilitySpannableString(AnnotatedString $this$toAccessibilitySpannableString, Density density, FontFamily.Resolver fontFamilyResolver, URLSpanCache urlSpanCache) {
        ...
        if (spanStylesOrNull$ui_text != null) {
            ...
            for (int index$iv = 0; index$iv < size; index$iv++) {
                ...
                SpanStyle noFontStyle = SpanStyle.m6860copyGSF8kmg$default(style, 0L, 0L, null, null, null, null, null, 0L, null, null, null, 0L, null, null, null, null, 65503, null);
    ...
    private static final void setSpanStyle(SpannableString $this$setSpanStyle, SpanStyle spanStyle, int start, int end, Density density, FontFamily.Resolver fontFamilyResolver) {
        SpannableExtensions_androidKt.m7208setColorRPmYEkk($this$setSpanStyle, spanStyle.m6869getColor0d7_KjU(), start, end);
        SpannableExtensions_androidKt.m7209setFontSizeKmRG4DE($this$setSpanStyle, spanStyle.getFontSize(), density, start, end);
        if (spanStyle.getFontWeight() != null || spanStyle.getFontStyle() != null) {
            ...
            int fontStyle2 = fontStyle != null ? fontStyle.m7043unboximpl() : FontStyle.INSTANCE.m7047getNormal_LCdwA();
            $this$setSpanStyle.setSpan(new StyleSpan(AndroidFontUtils_androidKt.m6992getAndroidTypefaceStyleFO1MlWM(fontWeight, fontStyle2)), start, end, 33);
        }
        if (spanStyle.getFontFamily() != null) {
            if (spanStyle.getFontFamily() instanceof GenericFontFamily) {
                ...
                Object value = FontFamily.Resolver.m7012resolveDPcqOEQ$default(fontFamilyResolver, fontFamily, null, 0, fontSynthesis != null ? fontSynthesis.m7056unboximpl() : FontSynthesis.INSTANCE.m7057getAllGVVA2EU(), 6, null).getValue();
        ...
        SpannableExtensions_androidKt.m7206setBackgroundRPmYEkk($this$setSpanStyle, spanStyle.getBackground(), start, end);
    }
