...
public final class FontMatcher {
    ...
    public final List<Font> m7036matchFontRetOiIg(List<? extends Font> fontList, FontWeight fontWeight, int fontStyle) {
        ...
        while (true) {
            ...
            Font it = font;
            if (Intrinsics.areEqual(it.getWeight(), fontWeight) && FontStyle.m7040equalsimpl0(it.getStyle(), fontStyle)) {
                z = true;
            }
            if (z) {
                target$iv.add(font);
        ...
        for (int index$iv$iv2 = 0; index$iv$iv2 < size2; index$iv$iv2++) {
            ...
            if (FontStyle.m7040equalsimpl0(it3.getStyle(), fontStyle)) {
                target$iv2.add(it3);
            }
        }
    ...
    /* JADX INFO: renamed from: matchFont-RetOiIg, reason: not valid java name */
    public final List<Font> m7034matchFontRetOiIg(FontFamily fontFamily, FontWeight fontWeight, int fontStyle) {
        if (!(fontFamily instanceof FontListFontFamily)) {
            throw new IllegalArgumentException("Only FontFamily instances that presents a list of Fonts can be used");
        }
        return m7035matchFontRetOiIg((FontListFontFamily) fontFamily, fontWeight, fontStyle);
    }

    /* JADX INFO: renamed from: matchFont-RetOiIg, reason: not valid java name */
    public final List<Font> m7035matchFontRetOiIg(FontListFontFamily fontFamily, FontWeight fontWeight, int fontStyle) {
        return m7036matchFontRetOiIg(fontFamily.getFonts(), fontWeight, fontStyle);
    }
}
