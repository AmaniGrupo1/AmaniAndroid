...
public final class PlatformFontFamilyTypefaceAdapter implements FontFamilyTypefaceAdapter {
    ...
    public TypefaceResult resolve(TypefaceRequest typefaceRequest, PlatformFontLoader platformFontLoader, Function1<? super TypefaceResult.Immutable, Unit> onAsyncCompletion, Function1<? super TypefaceRequest, ? extends Object> createDefaultTypeface) {
        ...
        if (fontFamily == null || (fontFamily instanceof DefaultFontFamily)) {
            result = this.platformTypefaceResolver.mo7068createDefaultFO1MlWM(typefaceRequest.getFontWeight(), typefaceRequest.m7086getFontStyle_LCdwA());
        } else if (fontFamily instanceof GenericFontFamily) {
            result = this.platformTypefaceResolver.mo7069createNamedRetOiIg((GenericFontFamily) typefaceRequest.getFontFamily(), typefaceRequest.getFontWeight(), typefaceRequest.m7086getFontStyle_LCdwA());
        } else {
            ...
            result = ((AndroidTypeface) typeface).mo7181getNativeTypefacePYhJU0U(typefaceRequest.getFontWeight(), typefaceRequest.m7086getFontStyle_LCdwA(), typefaceRequest.m7087getFontSynthesisGVVA2EU());
        }
