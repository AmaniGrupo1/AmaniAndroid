...
public final class Font extends AndroidPreloadedFont {
    ...
    public /* synthetic */ Font(AssetManager assetManager, String str, FontWeight fontWeight, int i, FontVariation.Settings settings, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        ...
        if ((i2 & 8) == 0) {
            iM7047getNormal_LCdwA = i;
        } else {
            iM7047getNormal_LCdwA = FontStyle.INSTANCE.m7047getNormal_LCdwA();
        }
        this(assetManager, str, normal, iM7047getNormal_LCdwA, settings, null);
    }
    ...
    public String toString() {
        return "Font(assetManager, path=" + this.path + ", weight=" + getWeight() + ", style=" + ((Object) FontStyle.m7042toStringimpl(getStyle())) + ')';
    }
