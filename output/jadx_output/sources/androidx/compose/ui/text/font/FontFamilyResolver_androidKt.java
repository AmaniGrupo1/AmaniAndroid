...
public final class FontFamilyResolver_androidKt {
    ...
    public static /* synthetic */ State m7015resolveAsTypefaceWqqsr6A$default(FontFamily.Resolver resolver, FontFamily fontFamily, FontWeight fontWeight, int i, int i2, int i3, Object obj) {
        if ((i3 & 1) != 0) {
            fontFamily = null;
        }
        if ((i3 & 2) != 0) {
        ...
        if ((i3 & 8) != 0) {
            i2 = FontSynthesis.INSTANCE.m7057getAllGVVA2EU();
        }
        return m7014resolveAsTypefaceWqqsr6A(resolver, fontFamily, fontWeight, i, i2);
    }

    /* JADX INFO: renamed from: resolveAsTypeface-Wqqsr6A, reason: not valid java name */
    public static final State<android.graphics.Typeface> m7014resolveAsTypefaceWqqsr6A(FontFamily.Resolver $this$resolveAsTypeface_u2dWqqsr6A, FontFamily fontFamily, FontWeight fontWeight, int i, int i2) {
        State stateMo7013resolveDPcqOEQ = $this$resolveAsTypeface_u2dWqqsr6A.mo7013resolveDPcqOEQ(fontFamily, fontWeight, i, i2);
        Intrinsics.checkNotNull(stateMo7013resolveDPcqOEQ, "null cannot be cast to non-null type androidx.compose.runtime.State<android.graphics.Typeface>");
        return stateMo7013resolveDPcqOEQ;
    }
}
