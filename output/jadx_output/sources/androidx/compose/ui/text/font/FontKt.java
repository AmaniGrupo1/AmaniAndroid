...
public final class FontKt {
    ...
    public static /* synthetic */ Font m7019FontRetOiIg$default(int i, FontWeight fontWeight, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            fontWeight = FontWeight.INSTANCE.getNormal();
        }
        if ((i3 & 4) != 0) {
            i2 = FontStyle.INSTANCE.m7047getNormal_LCdwA();
        }
        return m7018FontRetOiIg(i, fontWeight, i2);
    }
    ...
    public static final /* synthetic */ Font m7018FontRetOiIg(int resId, FontWeight weight, int i) {
        return new ResourceFont(resId, weight, i, null, FontLoadingStrategy.INSTANCE.m7032getBlockingPKNRLFQ(), 8, null);
    }

    /* JADX INFO: renamed from: Font-YpTlLL0$default, reason: not valid java name */
    public static /* synthetic */ Font m7021FontYpTlLL0$default(int i, FontWeight fontWeight, int i2, int i3, int i4, Object obj) {
        if ((i4 & 2) != 0) {
            fontWeight = FontWeight.INSTANCE.getNormal();
        }
        if ((i4 & 4) != 0) {
        ...
        if ((i4 & 8) != 0) {
            i3 = FontLoadingStrategy.INSTANCE.m7032getBlockingPKNRLFQ();
        }
        return m7020FontYpTlLL0(i, fontWeight, i2, i3);
    }

    /* JADX INFO: renamed from: Font-YpTlLL0, reason: not valid java name */
    public static final Font m7020FontYpTlLL0(int resId, FontWeight weight, int i, int i2) {
        return new ResourceFont(resId, weight, i, new FontVariation.Settings(new FontVariation.Setting[0]), i2, null);
    }

    /* JADX INFO: renamed from: Font-F3nL8kk$default, reason: not valid java name */
    public static /* synthetic */ Font m7017FontF3nL8kk$default(int i, FontWeight fontWeight, int i2, int i3, FontVariation.Settings settings, int i4, Object obj) {
        if ((i4 & 2) != 0) {
            fontWeight = FontWeight.INSTANCE.getNormal();
        }
        if ((i4 & 4) != 0) {
        ...
        if ((i4 & 16) != 0) {
            settings = FontVariation.INSTANCE.m7063Settings6EWAqTQ(fontWeight, i2, new FontVariation.Setting[0]);
        }
        return m7016FontF3nL8kk(i, fontWeight, i2, i3, settings);
    }

    /* JADX INFO: renamed from: Font-F3nL8kk, reason: not valid java name */
    public static final Font m7016FontF3nL8kk(int resId, FontWeight weight, int i, int i2, FontVariation.Settings variationSettings) {
        return new ResourceFont(resId, weight, i, variationSettings, i2, null);
    }
