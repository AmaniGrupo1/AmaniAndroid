...
public final class FontSynthesis_androidKt {
    ...
    public static final Object m7062synthesizeTypefaceFxwP2eA(int i, Object typeface, Font font, FontWeight requestedWeight, int i2) {
        int finalFontWeight;
        boolean finalFontStyle;
        if (!(typeface instanceof android.graphics.Typeface)) {
            return typeface;
        }
        boolean synthesizeWeight = FontSynthesis.m7054isWeightOnimpl$ui_text(i) && !Intrinsics.areEqual(font.getWeight(), requestedWeight) && requestedWeight.compareTo(AndroidFontUtils_androidKt.getAndroidBold(FontWeight.INSTANCE)) >= 0 && font.getWeight().compareTo(AndroidFontUtils_androidKt.getAndroidBold(FontWeight.INSTANCE)) < 0;
        boolean synthesizeStyle = FontSynthesis.m7053isStyleOnimpl$ui_text(i) && !FontStyle.m7040equalsimpl0(i2, font.getStyle());
        if (!synthesizeStyle && !synthesizeWeight) {
            return typeface;
        }
        if (Build.VERSION.SDK_INT < 28) {
            int targetStyle = AndroidFontUtils_androidKt.getAndroidTypefaceStyle(synthesizeWeight, synthesizeStyle && FontStyle.m7040equalsimpl0(i2, FontStyle.INSTANCE.m7046getItalic_LCdwA()));
        ...
        if (synthesizeStyle) {
            finalFontStyle = FontStyle.m7040equalsimpl0(i2, FontStyle.INSTANCE.m7046getItalic_LCdwA());
        } else {
            finalFontStyle = FontStyle.m7040equalsimpl0(font.getStyle(), FontStyle.INSTANCE.m7046getItalic_LCdwA());
        }
