...
public final class FontListFontFamilyTypefaceAdapter implements FontFamilyTypefaceAdapter {
    ...
    public final Object preload(FontFamily family, PlatformFontLoader resourceLoader, Continuation<? super Unit> continuation) {
        ...
        while (index$iv$iv < size) {
            ...
            if (FontLoadingStrategy.m7027equalsimpl0(((Font) item$iv$iv).getLoadingStrategy(), FontLoadingStrategy.INSTANCE.m7031getAsyncPKNRLFQ())) {
                Font it = (Font) item$iv$iv;
                target$iv.add(TuplesKt.to(it.getWeight(), FontStyle.m7037boximpl(it.getStyle())));
            }
            index$iv$iv++;
            fonts2 = list;
        }
        ...
        while (index$iv < size3) {
            ...
            int fontStyle = ((FontStyle) pair.component2()).m7043unboximpl();
            List<Font> listM7036matchFontRetOiIg = fontMatcher.m7036matchFontRetOiIg(fonts, fontWeight, fontStyle);
            List<Font> list2 = fonts;
            TypefaceRequest typeRequest = new TypefaceRequest(family, fontWeight, fontStyle, FontSynthesis.INSTANCE.m7057getAllGVVA2EU(), resourceLoader.getCacheKey(), null);
            List asyncFontsToLoad = (List) FontListFontFamilyTypefaceAdapterKt.firstImmediatelyAvailable(listM7036matchFontRetOiIg, typeRequest, this.asyncTypefaceCache, resourceLoader, new Function1() { // from class: androidx.compose.ui.text.font.FontListFontFamilyTypefaceAdapter$$ExternalSyntheticLambda0
    ...
    public TypefaceResult resolve(TypefaceRequest typefaceRequest, PlatformFontLoader platformFontLoader, Function1<? super TypefaceResult.Immutable, Unit> onAsyncCompletion, Function1<? super TypefaceRequest, ? extends Object> createDefaultTypeface) {
        ...
        Pair pairFirstImmediatelyAvailable = FontListFontFamilyTypefaceAdapterKt.firstImmediatelyAvailable(fontMatcher.m7036matchFontRetOiIg(((FontListFontFamily) typefaceRequest.getFontFamily()).getFonts(), typefaceRequest.getFontWeight(), typefaceRequest.m7086getFontStyle_LCdwA()), typefaceRequest, this.asyncTypefaceCache, platformFontLoader, createDefaultTypeface);
