...
public interface PlatformResolveInterceptor {
    ...
    default int m7066interceptFontStyleT2F_aPo(int fontStyle) {
        return fontStyle;
    }

    /* JADX INFO: renamed from: interceptFontSynthesis-Mscr08Y, reason: not valid java name */
    default int m7067interceptFontSynthesisMscr08Y(int fontSynthesis) {
