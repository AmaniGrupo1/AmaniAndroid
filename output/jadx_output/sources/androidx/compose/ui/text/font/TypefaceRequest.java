...
public final /* data */ class TypefaceRequest {
    ...
    public static /* synthetic */ TypefaceRequest m7082copye1PVR60$default(TypefaceRequest typefaceRequest, FontFamily fontFamily, FontWeight fontWeight, int i, int i2, Object obj, int i3, Object obj2) {
        if ((i3 & 1) != 0) {
        ...
        Object obj3 = obj;
        int i4 = i;
        return typefaceRequest.m7085copye1PVR60(fontFamily, fontWeight, i4, i2, obj3);
    }
    ...
    public final TypefaceRequest m7085copye1PVR60(FontFamily fontFamily, FontWeight fontWeight, int fontStyle, int fontSynthesis, Object resourceLoaderCacheKey) {
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.fontFamily, typefaceRequest.fontFamily) && Intrinsics.areEqual(this.fontWeight, typefaceRequest.fontWeight) && FontStyle.m7040equalsimpl0(this.fontStyle, typefaceRequest.fontStyle) && FontSynthesis.m7051equalsimpl0(this.fontSynthesis, typefaceRequest.fontSynthesis) && Intrinsics.areEqual(this.resourceLoaderCacheKey, typefaceRequest.resourceLoaderCacheKey);
    }

    public int hashCode() {
        return ((((((((this.fontFamily == null ? 0 : this.fontFamily.hashCode()) * 31) + this.fontWeight.hashCode()) * 31) + FontStyle.m7041hashCodeimpl(this.fontStyle)) * 31) + FontSynthesis.m7052hashCodeimpl(this.fontSynthesis)) * 31) + (this.resourceLoaderCacheKey != null ? this.resourceLoaderCacheKey.hashCode() : 0);
    }

    public String toString() {
        return "TypefaceRequest(fontFamily=" + this.fontFamily + ", fontWeight=" + this.fontWeight + ", fontStyle=" + ((Object) FontStyle.m7042toStringimpl(this.fontStyle)) + ", fontSynthesis=" + ((Object) FontSynthesis.m7055toStringimpl(this.fontSynthesis)) + ", resourceLoaderCacheKey=" + this.resourceLoaderCacheKey + ')';
    }
    ...
    public final int m7086getFontStyle_LCdwA() {
        return this.fontStyle;
    }

    /* JADX INFO: renamed from: getFontSynthesis-GVVA2EU, reason: not valid java name */
    public final int m7087getFontSynthesisGVVA2EU() {
        return this.fontSynthesis;
    }
