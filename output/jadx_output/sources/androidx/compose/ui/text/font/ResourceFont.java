...
public final class ResourceFont implements Font {
    ...
    public static /* synthetic */ void m7079getLoadingStrategyPKNRLFQ$annotations() {
    }
    ...
    public /* synthetic */ ResourceFont(int i, FontWeight fontWeight, int i2, FontVariation.Settings settings, int i3, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        ...
        int iM7047getNormal_LCdwA = (i4 & 4) != 0 ? FontStyle.INSTANCE.m7047getNormal_LCdwA() : i2;
        this(i, normal, iM7047getNormal_LCdwA, (i4 & 8) != 0 ? FontVariation.INSTANCE.m7063Settings6EWAqTQ(normal, iM7047getNormal_LCdwA, new FontVariation.Setting[0]) : settings, (i4 & 16) != 0 ? FontLoadingStrategy.INSTANCE.m7031getAsyncPKNRLFQ() : i3, null);
    }
    ...
    public static /* synthetic */ ResourceFont m7078copyRetOiIg$default(ResourceFont resourceFont, int i, FontWeight fontWeight, int i2, int i3, Object obj) {
        if ((i3 & 1) != 0) {
        ...
        return resourceFont.m7081copyRetOiIg(i, fontWeight, i2);
    }

    /* JADX INFO: renamed from: copy-RetOiIg, reason: not valid java name */
    public final ResourceFont m7081copyRetOiIg(int resId, FontWeight weight, int style) {
        return m7077copyF3nL8kk$default(this, resId, weight, style, getLoadingStrategy(), null, 16, null);
    }

    /* JADX INFO: renamed from: copy-F3nL8kk$default, reason: not valid java name */
    public static /* synthetic */ ResourceFont m7077copyF3nL8kk$default(ResourceFont resourceFont, int i, FontWeight fontWeight, int i2, int i3, FontVariation.Settings settings, int i4, Object obj) {
        if ((i4 & 1) != 0) {
            i = resourceFont.resId;
        }
        if ((i4 & 2) != 0) {
        ...
        return resourceFont.m7080copyF3nL8kk(i, fontWeight, i2, i3, (i4 & 16) != 0 ? resourceFont.variationSettings : settings);
    }

    /* JADX INFO: renamed from: copy-F3nL8kk, reason: not valid java name */
    public final ResourceFont m7080copyF3nL8kk(int resId, FontWeight weight, int style, int loadingStrategy, FontVariation.Settings variationSettings) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof ResourceFont) && this.resId == ((ResourceFont) other).resId && Intrinsics.areEqual(getWeight(), ((ResourceFont) other).getWeight()) && FontStyle.m7040equalsimpl0(getStyle(), ((ResourceFont) other).getStyle()) && Intrinsics.areEqual(this.variationSettings, ((ResourceFont) other).variationSettings) && FontLoadingStrategy.m7027equalsimpl0(getLoadingStrategy(), ((ResourceFont) other).getLoadingStrategy());
    }

    public int hashCode() {
        int result = this.resId;
        return (((((((result * 31) + getWeight().hashCode()) * 31) + FontStyle.m7041hashCodeimpl(getStyle())) * 31) + FontLoadingStrategy.m7028hashCodeimpl(getLoadingStrategy())) * 31) + this.variationSettings.hashCode();
    }

    public String toString() {
        return "ResourceFont(resId=" + this.resId + ", weight=" + getWeight() + ", style=" + ((Object) FontStyle.m7042toStringimpl(getStyle())) + ", loadingStrategy=" + ((Object) FontLoadingStrategy.m7029toStringimpl(getLoadingStrategy())) + ')';
    }
}
