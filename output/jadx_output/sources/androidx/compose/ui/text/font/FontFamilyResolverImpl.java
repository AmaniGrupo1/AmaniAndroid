...
public final class FontFamilyResolverImpl implements FontFamily.Resolver {
    ...
    @DebugMetadata(c = "androidx.compose.ui.text.font.FontFamilyResolverImpl", f = "FontFamilyResolver.kt", i = {0}, l = {MotionEventCompat.AXIS_GENERIC_12}, m = "preload", n = {TtmlNode.ATTR_TTS_FONT_FAMILY}, s = {"L$0"}, v = 1)
    ...
    public FontFamilyResolverImpl(PlatformFontLoader platformFontLoader, PlatformResolveInterceptor platformResolveInterceptor, TypefaceRequestCache typefaceRequestCache, FontListFontFamilyTypefaceAdapter fontListFontFamilyTypefaceAdapter, PlatformFontFamilyTypefaceAdapter platformFamilyTypefaceAdapter) {
        ...
        this.createDefaultTypeface = new Function1() { // from class: androidx.compose.ui.text.font.FontFamilyResolverImpl$$ExternalSyntheticLambda2
            ...
            public final Object invoke(Object obj) {
                return this.f$0.resolve(TypefaceRequest.m7082copye1PVR60$default((TypefaceRequest) obj, null, null, 0, 0, null, 30, null)).getValue();
            }
        };
    }
    ...
    */
    public Object preload(FontFamily fontFamily, Continuation<? super Unit> continuation) {
        ...
        switch (anonymousClass1.label) {
            ...
            case 1:
                fontFamilyResolverImpl = this;
                fontFamily2 = (FontFamily) anonymousClass1.L$0;
                ResultKt.throwOnFailure($result);
                break;
            default:
        ...
        while (index$iv$iv < size) {
            ...
            target$iv.add(new TypefaceRequest(fontFamilyResolverImpl.platformResolveInterceptor.interceptFontFamily(fontFamily2), fontFamilyResolverImpl.platformResolveInterceptor.interceptFontWeight(it.getWeight()), fontFamilyResolverImpl.platformResolveInterceptor.m7066interceptFontStyleT2F_aPo(it.getStyle()), FontSynthesis.INSTANCE.m7057getAllGVVA2EU(), fontFamilyResolverImpl.platformFontLoader.getCacheKey(), null));
            index$iv$iv++;
            anonymousClass1 = anonymousClass1;
        }
        List typeRequests = target$iv;
        fontFamilyResolverImpl.typefaceRequestCache.preWarmCache(typeRequests, new Function1() { // from class: androidx.compose.ui.text.font.FontFamilyResolverImpl$$ExternalSyntheticLambda3
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return FontFamilyResolverImpl.preload$lambda$1(this.f$0, (TypefaceRequest) obj);
            }
        });
        return Unit.INSTANCE;
    }
    ...
    public State<Object> mo7013resolveDPcqOEQ(FontFamily fontFamily, FontWeight fontWeight, int fontStyle, int fontSynthesis) {
        return resolve(new TypefaceRequest(this.platformResolveInterceptor.interceptFontFamily(fontFamily), this.platformResolveInterceptor.interceptFontWeight(fontWeight), this.platformResolveInterceptor.m7066interceptFontStyleT2F_aPo(fontStyle), this.platformResolveInterceptor.m7067interceptFontSynthesisMscr08Y(fontSynthesis), this.platformFontLoader.getCacheKey(), null));
    }
