...
public final class FontWeight implements Comparable<FontWeight> {
    ...
    private static final FontWeight W400 = new FontWeight(LogSeverity.WARNING_VALUE);
    private static final FontWeight W500 = new FontWeight(LogSeverity.ERROR_VALUE);
    private static final FontWeight W600 = new FontWeight(600);
    private static final FontWeight W700 = new FontWeight(LogSeverity.ALERT_VALUE);
    private static final FontWeight W800 = new FontWeight(LogSeverity.EMERGENCY_VALUE);
