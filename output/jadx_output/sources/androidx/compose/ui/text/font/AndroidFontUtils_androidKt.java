...
public final class AndroidFontUtils_androidKt {
    ...
    public static final int m6992getAndroidTypefaceStyleFO1MlWM(FontWeight fontWeight, int i) {
        boolean isBold = fontWeight.compareTo(getAndroidBold(FontWeight.INSTANCE)) >= 0;
        boolean isItalic = FontStyle.m7040equalsimpl0(i, FontStyle.INSTANCE.m7046getItalic_LCdwA());
