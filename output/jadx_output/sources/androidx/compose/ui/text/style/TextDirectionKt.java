...
public final class TextDirectionKt {
    ...
    public static final boolean m7382isSpecifiedHejc4pk(int i) {
        return i != 0;
    }

    /* JADX INFO: renamed from: takeOrElse-HklW4sA, reason: not valid java name */
    public static final int m7383takeOrElseHklW4sA(int i, Function0<TextDirection> function0) {
        return i != 0 ? i : function0.invoke().m7374unboximpl();
    }
}
