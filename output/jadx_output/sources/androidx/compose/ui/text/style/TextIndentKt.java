...
public final class TextIndentKt {
    public static final TextIndent lerp(TextIndent start, TextIndent stop, float fraction) {
        return new TextIndent(SpanStyleKt.m6875lerpTextUnitInheritableC3pnCVY(start.getFirstLine(), stop.getFirstLine(), fraction), SpanStyleKt.m6875lerpTextUnitInheritableC3pnCVY(start.getRestLine(), stop.getRestLine(), fraction), null);
    }
}
