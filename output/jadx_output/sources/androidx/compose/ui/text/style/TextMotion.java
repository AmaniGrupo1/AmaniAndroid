...
public final class TextMotion {
    ...
    static {
        ...
        Static = new TextMotion(Linearity.INSTANCE.m7400getFontHinting4e0Vf04(), false, defaultConstructorMarker);
        Animated = new TextMotion(Linearity.INSTANCE.m7401getLinear4e0Vf04(), true, defaultConstructorMarker);
    }

    /* JADX INFO: renamed from: copy-JdDtMQo$ui_text$default, reason: not valid java name */
    public static /* synthetic */ TextMotion m7390copyJdDtMQo$ui_text$default(TextMotion textMotion, int i, boolean z, int i2, Object obj) {
        if ((i2 & 1) != 0) {
        ...
        return textMotion.m7391copyJdDtMQo$ui_text(i, z);
    }

    /* JADX INFO: renamed from: copy-JdDtMQo$ui_text, reason: not valid java name */
    public final TextMotion m7391copyJdDtMQo$ui_text(int linearity, boolean subpixelTextPositioning) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof TextMotion) && Linearity.m7396equalsimpl0(this.linearity, ((TextMotion) other).linearity) && this.subpixelTextPositioning == ((TextMotion) other).subpixelTextPositioning;
    }

    public int hashCode() {
        int result = Linearity.m7397hashCodeimpl(this.linearity);
    ...
    /* JADX INFO: compiled from: TextMotion.android.kt */
    @Metadata(d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\b\n\u0002\b\u0003\n\u0002\u0010\u000e\n\u0002\b\u0003\n\u0002\u0010\u000b\n\u0002\b\u0007\b\u0081@\u0018\u0000 \u00112\u00020\u0001:\u0001\u0011B\u0011\b\u0000\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0004\b\u0004\u0010\u0005J\u000f\u0010\u0006\u001a\u00020\u0007H\u0016¢\u0006\u0004\b\b\u0010\tJ\u001a\u0010\n\u001a\u00020\u000b2\b\u0010\f\u001a\u0004\u0018\u00010\u0001HÖ\u0003¢\u0006\u0004\b\r\u0010\u000eJ\u0010\u0010\u000f\u001a\u00020\u0003HÖ\u0001¢\u0006\u0004\b\u0010\u0010\u0005R\u000e\u0010\u0002\u001a\u00020\u0003X\u0080\u0004¢\u0006\u0002\n\u0000\u0088\u0001\u0002\u0092\u0001\u00020\u0003¨\u0006\u0012"}, d2 = {"Landroidx/compose/ui/text/style/TextMotion$Linearity;", "", Values.VECTOR_MAP_VECTORS_KEY, "", "constructor-impl", "(I)I", "toString", "", "toString-impl", "(I)Ljava/lang/String;", "equals", "", "other", "equals-impl", "(ILjava/lang/Object;)Z", "hashCode", "hashCode-impl", "Companion", "ui-text"}, k = 1, mv = {2, 0, 0}, xi = 48)
    @JvmInline
    public static final class Linearity {
        ...
        private static final int Linear = m7394constructorimpl(1);
        private static final int FontHinting = m7394constructorimpl(2);
        private static final int None = m7394constructorimpl(3);

        /* JADX INFO: renamed from: box-impl, reason: not valid java name */
        public static final /* synthetic */ Linearity m7393boximpl(int i) {
            return new Linearity(i);
        }

        /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
        public static int m7394constructorimpl(int i) {
            return i;
        }

        /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
        public static boolean m7395equalsimpl(int i, Object obj) {
            return (obj instanceof Linearity) && i == ((Linearity) obj).getValue();
        }

        /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
        public static final boolean m7396equalsimpl0(int i, int i2) {
            return i == i2;
        }

        /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
        public static int m7397hashCodeimpl(int i) {
            return Integer.hashCode(i);
        }

        public boolean equals(Object obj) {
            return m7395equalsimpl(this.value, obj);
        }

        public int hashCode() {
            return m7397hashCodeimpl(this.value);
        }
        ...
        public String toString() {
            return m7398toStringimpl(this.value);
        }

        /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
        public static String m7398toStringimpl(int i) {
            return m7396equalsimpl0(i, Linear) ? "Linearity.Linear" : m7396equalsimpl0(i, FontHinting) ? "Linearity.FontHinting" : m7396equalsimpl0(i, None) ? "Linearity.None" : "Invalid";
        }
    }
}
