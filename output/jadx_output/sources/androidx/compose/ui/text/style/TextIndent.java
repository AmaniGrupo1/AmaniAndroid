...
public final class TextIndent {
    ...
    public static /* synthetic */ TextIndent m7386copyNB67dxo$default(TextIndent textIndent, long j, long j2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return textIndent.m7387copyNB67dxo(j, j2);
    }

    /* JADX INFO: renamed from: copy-NB67dxo, reason: not valid java name */
    public final TextIndent m7387copyNB67dxo(long firstLine, long restLine) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof TextIndent) && TextUnit.m7696equalsimpl0(this.firstLine, ((TextIndent) other).firstLine) && TextUnit.m7696equalsimpl0(this.restLine, ((TextIndent) other).restLine);
    }

    public int hashCode() {
        int result = TextUnit.m7700hashCodeimpl(this.firstLine);
        return (result * 31) + TextUnit.m7700hashCodeimpl(this.restLine);
    }

    public String toString() {
        return "TextIndent(firstLine=" + ((Object) TextUnit.m7706toStringimpl(this.firstLine)) + ", restLine=" + ((Object) TextUnit.m7706toStringimpl(this.restLine)) + ')';
    }
}
