...
final class CircleShape implements Shape {
    ...
    public Outline mo320createOutlinePq9zytI(long size, LayoutDirection layoutDirection, Density density) {
        float x$iv = Size.m4520getMinDimensionimpl(size) / 2.0f;
        ...
        return new Outline.Rounded(RoundRectKt.m4504RoundRectZAM2FJo(SizeKt.m4542toRectuvyYCjk(size), jM4406constructorimpl, jM4406constructorimpl, jM4406constructorimpl, jM4406constructorimpl));
    }
}
