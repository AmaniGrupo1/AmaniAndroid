...
public final class SaversKt {
    ...
    private static final Saver<ParagraphStyle, Object> ParagraphStyleSaver = SaverKt.Saver(new Function2() { // from class: androidx.compose.ui.text.SaversKt$$ExternalSyntheticLambda5
        ...
        public final Object invoke(Object obj, Object obj2) {
            ...
            return CollectionsKt.arrayListOf(SaversKt.save(TextAlign.m7351boximpl(paragraphStyle.getTextAlign()), SaversKt.getSaver(TextAlign.INSTANCE), saverScope), SaversKt.save(TextDirection.m7368boximpl(paragraphStyle.getTextDirection()), SaversKt.getSaver(TextDirection.INSTANCE), saverScope), SaversKt.save(TextUnit.m7689boximpl(paragraphStyle.getLineHeight()), SaversKt.getSaver(TextUnit.INSTANCE), saverScope), SaversKt.save(paragraphStyle.getTextIndent(), SaversKt.getSaver(TextIndent.INSTANCE), saverScope), SaversKt.save(paragraphStyle.getPlatformStyle(), Savers_androidKt.getSaver(PlatformParagraphStyle.INSTANCE), saverScope), SaversKt.save(paragraphStyle.getLineHeightStyle(), SaversKt.getSaver(LineHeightStyle.INSTANCE), saverScope), SaversKt.save(LineBreak.m7256boximpl(paragraphStyle.getLineBreak()), Savers_androidKt.getSaver(LineBreak.INSTANCE), saverScope), SaversKt.save(Hyphens.m7243boximpl(paragraphStyle.getHyphens()), SaversKt.getSaver(Hyphens.INSTANCE), saverScope), SaversKt.save(paragraphStyle.getTextMotion(), Savers_androidKt.getSaver(TextMotion.INSTANCE), saverScope));
        }
    ...
    private static final Saver<SpanStyle, Object> SpanStyleSaver = SaverKt.Saver(new Function2() { // from class: androidx.compose.ui.text.SaversKt$$ExternalSyntheticLambda7
        ...
        public final Object invoke(Object obj, Object obj2) {
            ...
            return CollectionsKt.arrayListOf(SaversKt.save(Color.m4687boximpl(spanStyle.m6869getColor0d7_KjU()), SaversKt.getSaver(Color.INSTANCE), saverScope), SaversKt.save(TextUnit.m7689boximpl(spanStyle.getFontSize()), SaversKt.getSaver(TextUnit.INSTANCE), saverScope), SaversKt.save(spanStyle.getFontWeight(), SaversKt.getSaver(FontWeight.INSTANCE), saverScope), SaversKt.save(spanStyle.getFontStyle(), SaversKt.getSaver(FontStyle.INSTANCE), saverScope), SaversKt.save(spanStyle.getFontSynthesis(), SaversKt.getSaver(FontSynthesis.INSTANCE), saverScope), SaversKt.save(-1), SaversKt.save(spanStyle.getFontFeatureSettings()), SaversKt.save(TextUnit.m7689boximpl(spanStyle.getLetterSpacing()), SaversKt.getSaver(TextUnit.INSTANCE), saverScope), SaversKt.save(spanStyle.getBaselineShift(), SaversKt.getSaver(BaselineShift.INSTANCE), saverScope), SaversKt.save(spanStyle.getTextGeometricTransform(), SaversKt.getSaver(TextGeometricTransform.INSTANCE), saverScope), SaversKt.save(spanStyle.getLocaleList(), SaversKt.getSaver(LocaleList.INSTANCE), saverScope), SaversKt.save(Color.m4687boximpl(spanStyle.getBackground()), SaversKt.getSaver(Color.INSTANCE), saverScope), SaversKt.save(spanStyle.getTextDecoration(), SaversKt.getSaver(TextDecoration.INSTANCE), saverScope), SaversKt.save(spanStyle.getShadow(), SaversKt.getSaver(Shadow.INSTANCE), saverScope));
        }
    ...
    private static final Saver<TextIndent, Object> TextIndentSaver = SaverKt.Saver(new Function2() { // from class: androidx.compose.ui.text.SaversKt$$ExternalSyntheticLambda16
        ...
        public final Object invoke(Object obj, Object obj2) {
            ...
            return CollectionsKt.arrayListOf(SaversKt.save(TextUnit.m7689boximpl(textIndent.getFirstLine()), SaversKt.getSaver(TextUnit.INSTANCE), saverScope), SaversKt.save(TextUnit.m7689boximpl(textIndent.getRestLine()), SaversKt.getSaver(TextUnit.INSTANCE), saverScope));
        }
    ...
    private static final Saver<BaselineShift, Object> BaselineShiftSaver = SaverKt.Saver(new Function2() { // from class: androidx.compose.ui.text.SaversKt$$ExternalSyntheticLambda20
        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(Object obj, Object obj2) {
            return Float.valueOf(((BaselineShift) obj2).m7226unboximpl());
        }
    ...
    private static final Saver<TextRange, Object> TextRangeSaver = SaverKt.Saver(new Function2() { // from class: androidx.compose.ui.text.SaversKt$$ExternalSyntheticLambda23
        ...
        public final Object invoke(Object obj, Object obj2) {
            ...
            return CollectionsKt.arrayListOf(SaversKt.save(Integer.valueOf(TextRange.m6928getStartimpl(textRange.getPackedValue()))), SaversKt.save(Integer.valueOf(TextRange.m6923getEndimpl(textRange.getPackedValue()))));
        }
    ...
    private static final Saver<Shadow, Object> ShadowSaver = SaverKt.Saver(new Function2() { // from class: androidx.compose.ui.text.SaversKt$$ExternalSyntheticLambda25
        ...
        public final Object invoke(Object obj, Object obj2) {
            ...
            return CollectionsKt.arrayListOf(SaversKt.save(Color.m4687boximpl(shadow.getColor()), SaversKt.getSaver(Color.INSTANCE), saverScope), SaversKt.save(Offset.m4441boximpl(shadow.getOffset()), SaversKt.getSaver(Offset.INSTANCE), saverScope), SaversKt.save(Float.valueOf(shadow.getBlurRadius())));
        }
    ...
    private static final NonNullValueClassSaver<Color, Object> ColorSaver = NonNullValueClassSaver(new Function2<SaverScope, Color, Object>() { // from class: androidx.compose.ui.text.SaversKt$ColorSaver$1
        ...
        public /* bridge */ /* synthetic */ Object invoke(SaverScope saverScope, Color color) {
            return m6857invoke4WTKRHQ(saverScope, color.m4707unboximpl());
        }

        /* JADX INFO: renamed from: invoke-4WTKRHQ, reason: not valid java name */
        public final Object m6857invoke4WTKRHQ(SaverScope $this$NonNullValueClassSaver, long j) {
            if (j == 16) {
                return false;
            }
            return Integer.valueOf(ColorKt.m4751toArgb8_81llA(j));
        }
        ...
        public final Color invoke(Object it) {
            if (Intrinsics.areEqual(it, (Object) false)) {
                return Color.m4687boximpl(Color.INSTANCE.m4733getUnspecified0d7_KjU());
            }
            Intrinsics.checkNotNull(it, "null cannot be cast to non-null type kotlin.Int");
            return Color.m4687boximpl(ColorKt.Color(((Integer) it).intValue()));
        }
    });
    private static final NonNullValueClassSaver<TextAlign, Object> TextAlignSaver = NonNullValueClassSaver(new Function2() { // from class: androidx.compose.ui.text.SaversKt$$ExternalSyntheticLambda27
        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(Object obj, Object obj2) {
            return Integer.valueOf(((TextAlign) obj2).m7357unboximpl());
        }
    ...
    private static final NonNullValueClassSaver<TextDirection, Object> TextDirectionSaver = NonNullValueClassSaver(new Function2() { // from class: androidx.compose.ui.text.SaversKt$$ExternalSyntheticLambda29
        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(Object obj, Object obj2) {
            return Integer.valueOf(((TextDirection) obj2).m7374unboximpl());
        }
    ...
    private static final NonNullValueClassSaver<Hyphens, Object> HyphensSaver = NonNullValueClassSaver(new Function2() { // from class: androidx.compose.ui.text.SaversKt$$ExternalSyntheticLambda31
        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(Object obj, Object obj2) {
            return Integer.valueOf(((Hyphens) obj2).m7249unboximpl());
        }
    ...
    private static final Saver<FontStyle, Object> FontStyleSaver = SaverKt.Saver(new Function2() { // from class: androidx.compose.ui.text.SaversKt$$ExternalSyntheticLambda34
        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(Object obj, Object obj2) {
            return SaversKt.save(Integer.valueOf(((FontStyle) obj2).m7043unboximpl()));
        }
    ...
    private static final Saver<FontSynthesis, Object> FontSynthesisSaver = SaverKt.Saver(new Function2() { // from class: androidx.compose.ui.text.SaversKt$$ExternalSyntheticLambda36
        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(Object obj, Object obj2) {
            return Integer.valueOf(((FontSynthesis) obj2).m7056unboximpl());
        }
    ...
    private static final Saver<LineHeightStyle, Object> LineHeightStyleSaver = SaverKt.Saver(new Function2() { // from class: androidx.compose.ui.text.SaversKt$$ExternalSyntheticLambda49
        ...
        public final Object invoke(Object obj, Object obj2) {
            ...
            return CollectionsKt.arrayListOf(SaversKt.save(LineHeightStyle.Alignment.m7317boximpl(lineHeightStyle.getAlignment()), SaversKt.getSaver(LineHeightStyle.Alignment.INSTANCE), saverScope), SaversKt.save(LineHeightStyle.Trim.m7338boximpl(lineHeightStyle.getTrim()), SaversKt.getSaver(LineHeightStyle.Trim.INSTANCE), saverScope), SaversKt.save(LineHeightStyle.Mode.m7328boximpl(lineHeightStyle.getMode()), SaversKt.getSaver(LineHeightStyle.Mode.INSTANCE), saverScope));
        }
    ...
    static final Object AnnotationRangeSaver$lambda$0(SaverScope $this$Saver, AnnotatedString.Range it) {
        ...
        switch (WhenMappings.$EnumSwitchMapping$0[marker.ordinal()]) {
            ...
            case 7:
                ...
                item = save(((StringAnnotation) item9).m6882unboximpl());
                break;
            default:
    ...
    static final AnnotatedString.Range AnnotationRangeSaver$lambda$1(Object obj) {
        ...
        switch (WhenMappings.$EnumSwitchMapping$0[annotationType.ordinal()]) {
            ...
            case 7:
                ...
                return new AnnotatedString.Range(StringAnnotation.m6876boximpl(StringAnnotation.m6877constructorimpl(str2)), iIntValue, iIntValue2, str);
            default:
                throw new NoWhenBranchMatchedException();
        }
    }
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: ModVisitor
        jadx.core.utils.exceptions.JadxRuntimeException: Can't remove SSA var: r2v0 androidx.compose.ui.text.ParagraphStyle, still in use, count: 3, list:
          ...
          (r2v0 androidx.compose.ui.text.ParagraphStyle) from 0x0163: MOVE (r18v1 androidx.compose.ui.text.ParagraphStyle) = (r2v0 androidx.compose.ui.text.ParagraphStyle) (LINE:709)
    ...
    static final BaselineShift BaselineShiftSaver$lambda$1(Object it) {
        ...
        return BaselineShift.m7220boximpl(BaselineShift.m7221constructorimpl(((Float) it).floatValue()));
    }
    ...
    static final TextRange TextRangeSaver$lambda$1(Object it) {
        ...
        return TextRange.m6916boximpl(TextRangeKt.TextRange(iIntValue, ((Number) it$iv2).intValue()));
    }
    ...
    static final Shadow ShadowSaver$lambda$1(Object it) {
        ...
        long jM4707unboximpl = colorRestore.m4707unboximpl();
        Object value$iv2 = list.get(1);
        ...
        long jM4462unboximpl = offsetRestore.m4462unboximpl();
        Object value$iv3 = list.get(2);
        Object it$iv = value$iv3 != null ? (Float) value$iv3 : null;
        Intrinsics.checkNotNull(it$iv);
        return new Shadow(jM4707unboximpl, jM4462unboximpl, ((Number) it$iv).floatValue(), null);
    }
    ...
    static final TextAlign TextAlignSaver$lambda$1(Object it) {
        Intrinsics.checkNotNull(it, "null cannot be cast to non-null type kotlin.Int");
        return TextAlign.m7351boximpl(TextAlign.m7352constructorimpl(((Integer) it).intValue()));
    }
    ...
    static final TextDirection TextDirectionSaver$lambda$1(Object it) {
        Intrinsics.checkNotNull(it, "null cannot be cast to non-null type kotlin.Int");
        return TextDirection.m7368boximpl(TextDirection.m7369constructorimpl(((Integer) it).intValue()));
    }
    ...
    static final Hyphens HyphensSaver$lambda$1(Object it) {
        Intrinsics.checkNotNull(it, "null cannot be cast to non-null type kotlin.Int");
        return Hyphens.m7243boximpl(Hyphens.m7244constructorimpl(((Integer) it).intValue()));
    }
    ...
    static final FontStyle FontStyleSaver$lambda$1(Object it) {
        Intrinsics.checkNotNull(it, "null cannot be cast to non-null type kotlin.Int");
        return FontStyle.m7037boximpl(FontStyle.m7038constructorimpl(((Integer) it).intValue()));
    }
    ...
    static final FontSynthesis FontSynthesisSaver$lambda$1(Object it) {
        Intrinsics.checkNotNull(it, "null cannot be cast to non-null type kotlin.Int");
        return FontSynthesis.m7048boximpl(FontSynthesis.m7049constructorimpl(((Integer) it).intValue()));
    }
    ...
    static final Object TextUnitSaver$lambda$0(SaverScope $this$NonNullValueClassSaver, TextUnit it) {
        if (it == null ? false : TextUnit.m7696equalsimpl0(it.getPackedValue(), TextUnit.INSTANCE.m7710getUnspecifiedXSAIIZE())) {
            return (Serializable) false;
        }
        return CollectionsKt.arrayListOf(save(Float.valueOf(TextUnit.m7699getValueimpl(it.getPackedValue()))), save(TextUnitType.m7724boximpl(TextUnit.m7698getTypeUIouoOA(it.getPackedValue())), getSaver(TextUnitType.INSTANCE), $this$NonNullValueClassSaver));
    }

    static final TextUnit TextUnitSaver$lambda$1(Object it) {
        if (Intrinsics.areEqual(it, (Object) false)) {
            return TextUnit.m7689boximpl(TextUnit.INSTANCE.m7710getUnspecifiedXSAIIZE());
        }
        Intrinsics.checkNotNull(it, "null cannot be cast to non-null type kotlin.collections.List<kotlin.Any>");
        List list = (List) it;
        Object value$iv = list.get(0);
        ...
        return TextUnit.m7689boximpl(TextUnitKt.m7711TextUnitanM5pPY(fFloatValue, textUnitTypeRestore.getType()));
    }
    ...
    static final Object TextUnitTypeSaver$lambda$0(SaverScope $this$NonNullValueClassSaver, TextUnitType it) {
        ...
        if (TextUnitType.m7727equalsimpl0(type, TextUnitType.INSTANCE.m7731getEmUIouoOA())) {
            return 0;
        }
        return TextUnitType.m7727equalsimpl0(type, TextUnitType.INSTANCE.m7732getSpUIouoOA()) ? 1 : false;
    }

    static final TextUnitType TextUnitTypeSaver$lambda$1(Object it) {
        return Intrinsics.areEqual(it, (Object) 0) ? TextUnitType.m7724boximpl(TextUnitType.INSTANCE.m7731getEmUIouoOA()) : Intrinsics.areEqual(it, (Object) 1) ? TextUnitType.m7724boximpl(TextUnitType.INSTANCE.m7732getSpUIouoOA()) : TextUnitType.m7724boximpl(TextUnitType.INSTANCE.m7733getUnspecifiedUIouoOA());
    }
    ...
    static final Object OffsetSaver$lambda$0(SaverScope $this$NonNullValueClassSaver, Offset it) {
        if (it == null ? false : Offset.m4449equalsimpl0(it.m4462unboximpl(), Offset.INSTANCE.m4467getUnspecifiedF1C5BW0())) {
            return (Serializable) false;
        }
    ...
    static final Offset OffsetSaver$lambda$1(Object it) {
        if (Intrinsics.areEqual(it, (Object) false)) {
            return Offset.m4441boximpl(Offset.INSTANCE.m4467getUnspecifiedF1C5BW0());
        }
        Intrinsics.checkNotNull(it, "null cannot be cast to non-null type kotlin.collections.List<kotlin.Any?>");
        List list = (List) it;
        Object value$iv = list.get(0);
    ...
    static final LineHeightStyle.Alignment LineHeightStyleAlignmentSaver$lambda$1(Object it) {
        Intrinsics.checkNotNull(it, "null cannot be cast to non-null type kotlin.Float");
        return LineHeightStyle.Alignment.m7317boximpl(LineHeightStyle.Alignment.m7318constructorimpl(((Float) it).floatValue()));
    }
    ...
    static final LineHeightStyle.Trim LineHeightStyleTrimSaver$lambda$1(Object it) {
        Intrinsics.checkNotNull(it, "null cannot be cast to non-null type kotlin.Int");
        return LineHeightStyle.Trim.m7338boximpl(LineHeightStyle.Trim.m7339constructorimpl(((Integer) it).intValue()));
    }
    ...
    static final LineHeightStyle.Mode LineHeightStyleModeSaver$lambda$1(Object it) {
        Intrinsics.checkNotNull(it, "null cannot be cast to non-null type kotlin.Int");
        return LineHeightStyle.Mode.m7328boximpl(LineHeightStyle.Mode.m7329constructorimpl(((Integer) it).intValue()));
    }
}
