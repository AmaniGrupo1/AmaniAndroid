...
public final class LayoutModifierNodeKt {
    ...
    public static final void invalidateLayer(LayoutModifierNode $this$invalidateLayer) {
        DelegatableNodeKt.m6312requireCoordinator64DMado($this$invalidateLayer, NodeKind.m6460constructorimpl(2)).invalidateLayer();
    }
    ...
    public static final void updateLayerBlock(LayoutModifierNode $this$updateLayerBlock, Function1<? super GraphicsLayerScope, Unit> function1) {
        ...
        if ($this$updateLayerBlock.getNode().getIsAttached() && (wrapped = DelegatableNodeKt.m6312requireCoordinator64DMado($this$updateLayerBlock, NodeKind.m6460constructorimpl(2)).getWrapped()) != null) {
