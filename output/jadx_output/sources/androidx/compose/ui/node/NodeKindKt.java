...
public final class NodeKindKt {
    ...
    public static final int m6470or64DMado(int $this$or_u2d64DMado, int i) {
        return $this$or_u2d64DMado | i;
    }

    /* JADX INFO: renamed from: contains-64DMado, reason: not valid java name */
    public static final boolean m6468contains64DMado(int $this$contains_u2d64DMado, int i) {
        return ($this$contains_u2d64DMado & i) != 0;
    }

    /* JADX INFO: renamed from: getIncludeSelfInTraversal-H91voCI, reason: not valid java name */
    public static final boolean m6469getIncludeSelfInTraversalH91voCI(int i) {
        return ((NodeKind.m6460constructorimpl(128) & i) != 0) | ((NodeKind.m6460constructorimpl(4194304) & i) != 0);
    }

    public static final int calculateNodeKindSetFrom(Modifier.Element element) {
        int mask = NodeKind.m6460constructorimpl(1);
        if (element instanceof LayoutModifier) {
            mask = NodeKind.m6460constructorimpl(2) | mask;
        }
        if (element instanceof DrawModifier) {
            int $this$or_u2d64DMado$iv = mask;
            mask = NodeKind.m6460constructorimpl(4) | $this$or_u2d64DMado$iv;
        }
        if (element instanceof SemanticsModifier) {
            int $this$or_u2d64DMado$iv2 = mask;
            mask = NodeKind.m6460constructorimpl(8) | $this$or_u2d64DMado$iv2;
        }
        if (element instanceof PointerInputModifier) {
            int $this$or_u2d64DMado$iv3 = mask;
            mask = NodeKind.m6460constructorimpl(16) | $this$or_u2d64DMado$iv3;
        }
        if ((element instanceof ModifierLocalConsumer) || (element instanceof ModifierLocalProvider)) {
            int $this$or_u2d64DMado$iv4 = mask;
            mask = NodeKind.m6460constructorimpl(32) | $this$or_u2d64DMado$iv4;
        }
        if (element instanceof FocusEventModifier) {
            int $this$or_u2d64DMado$iv5 = mask;
            mask = NodeKind.m6460constructorimpl(4096) | $this$or_u2d64DMado$iv5;
        }
        if (element instanceof FocusOrderModifier) {
            int $this$or_u2d64DMado$iv6 = mask;
            mask = NodeKind.m6460constructorimpl(2048) | $this$or_u2d64DMado$iv6;
        }
        if (element instanceof OnGloballyPositionedModifier) {
            int $this$or_u2d64DMado$iv7 = mask;
            mask = NodeKind.m6460constructorimpl(256) | $this$or_u2d64DMado$iv7;
        }
        if (element instanceof ParentDataModifier) {
            int $this$or_u2d64DMado$iv8 = mask;
            mask = NodeKind.m6460constructorimpl(64) | $this$or_u2d64DMado$iv8;
        }
        if (element instanceof OnPlacedModifier) {
            int $this$or_u2d64DMado$iv9 = mask;
            mask = NodeKind.m6460constructorimpl(4194304) | $this$or_u2d64DMado$iv9;
        }
        if (element instanceof OnRemeasuredModifier) {
            int $this$or_u2d64DMado$iv10 = mask;
            mask = NodeKind.m6460constructorimpl(128) | $this$or_u2d64DMado$iv10;
        }
        if (element instanceof BringIntoViewModifierNode) {
            int $this$or_u2d64DMado$iv11 = mask;
            return NodeKind.m6460constructorimpl(524288) | $this$or_u2d64DMado$iv11;
        }
        return mask;
    }
    ...
    public static final int calculateNodeKindSetFrom(Modifier.Node node) {
        ...
        if (node instanceof ParentDataModifierNode) {
            int $this$or_u2d64DMado$iv5 = mask;
            mask = NodeKind.m6460constructorimpl(64) | $this$or_u2d64DMado$iv5;
        }
        if (node instanceof OnPlacedNode) {
            int $this$or_u2d64DMado$iv6 = mask;
            mask = NodeKind.m6460constructorimpl(4194304) | $this$or_u2d64DMado$iv6;
        } else if (node instanceof OnSizeChangedNode) {
            int $this$or_u2d64DMado$iv7 = mask;
            mask = NodeKind.m6460constructorimpl(128) | $this$or_u2d64DMado$iv7;
        } else if (node instanceof LayoutAwareModifierNode) {
            int $this$or_u2d64DMado$iv8 = mask;
            mask = NodeKind.m6460constructorimpl(4194304) | NodeKind.m6460constructorimpl(128) | $this$or_u2d64DMado$iv8;
        }
        if (node instanceof GlobalPositionAwareModifierNode) {
            int $this$or_u2d64DMado$iv9 = mask;
            mask = NodeKind.m6460constructorimpl(256) | $this$or_u2d64DMado$iv9;
        }
        if (node instanceof ApproachLayoutModifierNode) {
            int $this$or_u2d64DMado$iv10 = mask;
            mask = NodeKind.m6460constructorimpl(512) | $this$or_u2d64DMado$iv10;
        }
        if (node instanceof FocusTargetNode) {
            int $this$or_u2d64DMado$iv11 = mask;
            mask = NodeKind.m6460constructorimpl(1024) | $this$or_u2d64DMado$iv11;
        }
        if (node instanceof FocusPropertiesModifierNode) {
            int $this$or_u2d64DMado$iv12 = mask;
            mask = NodeKind.m6460constructorimpl(2048) | $this$or_u2d64DMado$iv12;
        }
        if (node instanceof FocusEventModifierNode) {
            int $this$or_u2d64DMado$iv13 = mask;
            mask = NodeKind.m6460constructorimpl(4096) | $this$or_u2d64DMado$iv13;
        }
        if (node instanceof KeyInputModifierNode) {
            int $this$or_u2d64DMado$iv14 = mask;
            mask = NodeKind.m6460constructorimpl(8192) | $this$or_u2d64DMado$iv14;
        }
        if (node instanceof RotaryInputModifierNode) {
            int $this$or_u2d64DMado$iv15 = mask;
            mask = NodeKind.m6460constructorimpl(16384) | $this$or_u2d64DMado$iv15;
        }
        if (node instanceof CompositionLocalConsumerModifierNode) {
            int $this$or_u2d64DMado$iv16 = mask;
            mask = NodeKind.m6460constructorimpl(32768) | $this$or_u2d64DMado$iv16;
        }
        if (node instanceof SoftKeyboardInterceptionModifierNode) {
            int $this$or_u2d64DMado$iv17 = mask;
            mask = NodeKind.m6460constructorimpl(131072) | $this$or_u2d64DMado$iv17;
        }
        if (node instanceof TraversableNode) {
            int $this$or_u2d64DMado$iv18 = mask;
            mask = NodeKind.m6460constructorimpl(262144) | $this$or_u2d64DMado$iv18;
        }
        if (node instanceof BringIntoViewModifierNode) {
            int $this$or_u2d64DMado$iv19 = mask;
            mask = NodeKind.m6460constructorimpl(524288) | $this$or_u2d64DMado$iv19;
        }
        if (node instanceof UnplacedAwareModifierNode) {
            int $this$or_u2d64DMado$iv20 = mask;
            mask = NodeKind.m6460constructorimpl(1048576) | $this$or_u2d64DMado$iv20;
        }
        if (node instanceof IndirectPointerInputModifierNode) {
            int $this$or_u2d64DMado$iv21 = mask;
            mask = NodeKind.m6460constructorimpl(2097152) | $this$or_u2d64DMado$iv21;
        }
        if (node instanceof BeyondBoundsLayoutProviderModifierNode) {
            int $this$or_u2d64DMado$iv22 = mask;
            mask = NodeKind.m6460constructorimpl(8388608) | $this$or_u2d64DMado$iv22;
        }
        int i = mask;
    ...
    private static final void autoInvalidateNodeSelf(Modifier.Node node, int selfKindSet, int phase) {
        if (phase != 0 || node.getShouldAutoInvalidate()) {
            if (((selfKindSet & NodeKind.m6460constructorimpl(2)) != 0 ? 1 : 0) != 0 && (node instanceof LayoutModifierNode)) {
                LayoutModifierNodeKt.invalidateMeasurement((LayoutModifierNode) node);
                if (phase == 2) {
                    NodeCoordinator coordinator = DelegatableNodeKt.m6312requireCoordinator64DMado(node, NodeKind.m6460constructorimpl(2));
                    coordinator.onRelease();
                }
            }
            if (((selfKindSet & NodeKind.m6460constructorimpl(128)) != 0 ? 1 : 0) != 0 && phase != 2) {
                DelegatableNodeKt.requireLayoutNode(node).invalidateMeasurements$ui();
            }
            if (((selfKindSet & NodeKind.m6460constructorimpl(4194304)) != 0 ? 1 : 0) != 0 && phase != 2) {
                LayoutNode.requestRelayout$ui$default(DelegatableNodeKt.requireLayoutNode(node), false, 1, null);
            }
            if (((selfKindSet & NodeKind.m6460constructorimpl(256)) != 0 ? 1 : 0) != 0 && (node instanceof GlobalPositionAwareModifierNode)) {
                switch (phase) {
                    case 1:
            ...
            if (((selfKindSet & NodeKind.m6460constructorimpl(4)) != 0 ? 1 : 0) != 0 && (node instanceof DrawModifierNode)) {
                DrawModifierNodeKt.invalidateDraw((DrawModifierNode) node);
            }
            if (((selfKindSet & NodeKind.m6460constructorimpl(8)) != 0 ? 1 : 0) != 0 && (node instanceof SemanticsModifierNode)) {
                DelegatableNodeKt.requireLayoutNode(node).setSemanticsInvalidated$ui(true);
            }
            if (((selfKindSet & NodeKind.m6460constructorimpl(64)) != 0 ? 1 : 0) != 0 && (node instanceof ParentDataModifierNode)) {
                ParentDataModifierNodeKt.invalidateParentData((ParentDataModifierNode) node);
            }
            if (((selfKindSet & NodeKind.m6460constructorimpl(2048)) != 0 ? 1 : 0) != 0 && (node instanceof FocusPropertiesModifierNode) && specifiesCanFocusProperty((FocusPropertiesModifierNode) node)) {
                FocusPropertiesModifierNodeKt.invalidateFocusProperties((FocusPropertiesModifierNode) node);
            }
            if (((selfKindSet & NodeKind.m6460constructorimpl(4096)) != 0) && (node instanceof FocusEventModifierNode)) {
