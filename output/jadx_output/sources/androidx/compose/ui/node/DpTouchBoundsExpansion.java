...
public final /* data */ class DpTouchBoundsExpansion {
    ...
    public static /* synthetic */ DpTouchBoundsExpansion m6340copylDy3nrA$default(DpTouchBoundsExpansion dpTouchBoundsExpansion, float f, float f2, float f3, float f4, boolean z, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        boolean z2 = z;
        float f5 = f3;
        return dpTouchBoundsExpansion.m6345copylDy3nrA(f, f2, f5, f4, z2);
    }
    ...
    public final DpTouchBoundsExpansion m6345copylDy3nrA(float start, float top, float end, float bottom, boolean isLayoutDirectionAware) {
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m7510equalsimpl0(this.start, dpTouchBoundsExpansion.start) && Dp.m7510equalsimpl0(this.top, dpTouchBoundsExpansion.top) && Dp.m7510equalsimpl0(this.end, dpTouchBoundsExpansion.end) && Dp.m7510equalsimpl0(this.bottom, dpTouchBoundsExpansion.bottom) && this.isLayoutDirectionAware == dpTouchBoundsExpansion.isLayoutDirectionAware;
    }

    public int hashCode() {
        return (((((((Dp.m7511hashCodeimpl(this.start) * 31) + Dp.m7511hashCodeimpl(this.top)) * 31) + Dp.m7511hashCodeimpl(this.end)) * 31) + Dp.m7511hashCodeimpl(this.bottom)) * 31) + Boolean.hashCode(this.isLayoutDirectionAware);
    }

    public String toString() {
        return "DpTouchBoundsExpansion(start=" + ((Object) Dp.m7516toStringimpl(this.start)) + ", top=" + ((Object) Dp.m7516toStringimpl(this.top)) + ", end=" + ((Object) Dp.m7516toStringimpl(this.end)) + ", bottom=" + ((Object) Dp.m7516toStringimpl(this.bottom)) + ", isLayoutDirectionAware=" + this.isLayoutDirectionAware + ')';
    }
    ...
    public final long m6350roundToTouchBoundsExpansionTW6G1oQ(Density density) {
        return TouchBoundsExpansion.m6548constructorimpl(TouchBoundsExpansion.INSTANCE.pack$ui(density.mo399roundToPx0680j_4(this.start), density.mo399roundToPx0680j_4(this.top), density.mo399roundToPx0680j_4(this.end), density.mo399roundToPx0680j_4(this.bottom), this.isLayoutDirectionAware));
    }

    /* JADX INFO: compiled from: TouchBoundsExpansion.kt */
    @Metadata(d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0006\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J5\u0010\u0004\u001a\u00020\u00052\b\b\u0002\u0010\u0006\u001a\u00020\u00072\b\b\u0002\u0010\b\u001a\u00020\u00072\b\b\u0002\u0010\t\u001a\u00020\u00072\b\b\u0002\u0010\n\u001a\u00020\u0007¢\u0006\u0004\b\u000b\u0010\f¨\u0006\r"}, d2 = {"Landroidx/compose/ui/node/DpTouchBoundsExpansion$Companion;", "", "<init>", "()V", "Absolute", "Landroidx/compose/ui/node/DpTouchBoundsExpansion;", TtmlNode.LEFT, "Landroidx/compose/ui/unit/Dp;", "top", TtmlNode.RIGHT, "bottom", "Absolute-a9UjIt4", "(FFFF)Landroidx/compose/ui/node/DpTouchBoundsExpansion;", "ui"}, k = 1, mv = {2, 0, 0}, xi = 48)
    public static final class Companion {
        ...
        public static /* synthetic */ DpTouchBoundsExpansion m6351Absolutea9UjIt4$default(Companion companion, float f, float f2, float f3, float f4, int i, Object obj) {
            if ((i & 1) != 0) {
            ...
            return companion.m6352Absolutea9UjIt4(f, f2, f3, f4);
        }

        /* JADX INFO: renamed from: Absolute-a9UjIt4, reason: not valid java name */
        public final DpTouchBoundsExpansion m6352Absolutea9UjIt4(float left, float top, float right, float bottom) {
