...
public final class LayoutNode implements ComposeNodeLifecycleCallback, Remeasurement, OwnerScope, LayoutInfo, SemanticsInfo, ComposeUiNode, InteroperableComposeUiNode, Owner.OnLayoutCompletedListener {
    ...
    private static final NoIntrinsicsMeasurePolicy ErrorMeasurePolicy = new NoIntrinsicsMeasurePolicy() { // from class: androidx.compose.ui.node.LayoutNode$Companion$ErrorMeasurePolicy$1
        ...
        public /* bridge */ /* synthetic */ MeasureResult mo41measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, List measurables, long j) {
            return (MeasureResult) m6377measure3p2s80s($this$measure_u2d3p2s80s, (List<? extends Measurable>) measurables, j);
        }

        /* JADX INFO: renamed from: measure-3p2s80s, reason: not valid java name */
        public Void m6377measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, List<? extends Measurable> list, long j) {
    ...
    private static final ViewConfiguration DummyViewConfiguration = new ViewConfiguration() { // from class: androidx.compose.ui.node.LayoutNode$Companion$DummyViewConfiguration$1
        ...
        public long mo6376getMinimumTouchTargetSizeMYxV2XQ() {
            return DpSize.INSTANCE.m7613getZeroMYxV2XQ();
        }
    };
    ...
    public LayoutNode(boolean isVirtual, int semanticsId) {
        ...
        this.lastOffsetFromParent = IntOffset.INSTANCE.m7643getMaxnOccac();
        this.lastSize = IntSize.INSTANCE.m7681getZeroYbymL2g();
        this.outerToInnerOffset = IntOffset.INSTANCE.m7643getMaxnOccac();
    ...
    public final void m6373setLastOffsetFromParentgyyYBs$ui(long j) {
    ...
    public final void m6374setLastSizeozmzZPI$ui(long j) {
        this.lastSize = j;
    }
    ...
    public final void m6375setOuterToInnerOffsetgyyYBs$ui(long j) {
    ...
    public SemanticsConfiguration getSemanticsConfiguration() {
        if (!isAttached() || getIsDeactivated() || !this.nodes.m6421hasH91voCI$ui(NodeKind.m6460constructorimpl(8))) {
            return null;
        }
    ...
    private final SemanticsConfiguration calculateSemanticsConfiguration() {
        ...
        Function0<Unit> function0 = new Function0<Unit>() { // from class: androidx.compose.ui.node.LayoutNode.calculateSemanticsConfiguration.1
            ...
            /* JADX WARN: Type inference failed for: r1v11, types: [T, androidx.compose.ui.semantics.SemanticsConfiguration] */
            /* JADX INFO: renamed from: invoke, reason: avoid collision after fix types in other method */
            public final void invoke2() {
                int i;
                boolean z;
                ...
                int count$iv$iv2 = NodeKind.m6460constructorimpl(8);
                Ref.ObjectRef<SemanticsConfiguration> objectRef = config;
                if ((this_$iv2.getAggregateChildKindSet() & count$iv$iv2) == 0) {
                    return;
                }
    ...
    */
    public final void attach$ui(Owner owner) {
        boolean value$iv;
        LayoutNode layoutNode;
        boolean value$iv2 = this.owner == null;
        if (!value$iv2) {
        ...
        if (!value$iv) {
            StringBuilder sbAppend = new StringBuilder().append("Attaching to a different owner(").append(owner).append(") than the parent's owner(");
            LayoutNode parent$ui = getParent$ui();
        ...
        getOuterCoordinator$ui().setWrappedBy$ui(parent != null ? parent.getInnerCoordinator$ui() : null);
        this.owner = owner;
        this.depth = (parent != null ? parent.depth : -1) + 1;
        Modifier it = this.pendingModifier;
        if (it != null) {
            applyModifier(it);
        }
        this.pendingModifier = null;
        if (!ComposeUiFlags.isSemanticAutofillEnabled && this.nodes.m6421hasH91voCI$ui(NodeKind.m6460constructorimpl(8))) {
        ...
        if (this.isVirtualLookaheadRoot) {
            ...
            if (this.lookaheadRoot == null && this.nodes.m6421hasH91voCI$ui(NodeKind.m6460constructorimpl(512))) {
                setLookaheadRoot(this);
            }
        }
        if (!getIsDeactivated()) {
        ...
        if (ComposeUiFlags.isSemanticAutofillEnabled && !getIsDeactivated() && this.nodes.m6421hasH91voCI$ui(NodeKind.m6460constructorimpl(8))) {
            invalidateSemantics$ui();
        }
    ...
    public final boolean getHasFixedInnerContentConstraints$ui() {
        long innerContentConstraints = getInnerCoordinator$ui().m6444getLastMeasurementConstraintsmsEJaDk$ui();
        return Constraints.m7456getHasFixedWidthimpl(innerContentConstraints) && Constraints.m7455getHasFixedHeightimpl(innerContentConstraints);
    }
    ...
    public static abstract class NoIntrinsicsMeasurePolicy implements MeasurePolicy {
        ...
        public /* bridge */ /* synthetic */ int maxIntrinsicHeight(IntrinsicMeasureScope $this$maxIntrinsicHeight, List measurables, int width) {
            return ((Number) m6378maxIntrinsicHeight($this$maxIntrinsicHeight, (List<? extends IntrinsicMeasurable>) measurables, width)).intValue();
        }

        @Override // androidx.compose.ui.layout.MeasurePolicy
        public /* bridge */ /* synthetic */ int maxIntrinsicWidth(IntrinsicMeasureScope $this$maxIntrinsicWidth, List measurables, int height) {
            return ((Number) m6379maxIntrinsicWidth($this$maxIntrinsicWidth, (List<? extends IntrinsicMeasurable>) measurables, height)).intValue();
        }

        @Override // androidx.compose.ui.layout.MeasurePolicy
        public /* bridge */ /* synthetic */ int minIntrinsicHeight(IntrinsicMeasureScope $this$minIntrinsicHeight, List measurables, int width) {
            return ((Number) m6380minIntrinsicHeight($this$minIntrinsicHeight, (List<? extends IntrinsicMeasurable>) measurables, width)).intValue();
        }

        @Override // androidx.compose.ui.layout.MeasurePolicy
        public /* bridge */ /* synthetic */ int minIntrinsicWidth(IntrinsicMeasureScope $this$minIntrinsicWidth, List measurables, int height) {
            return ((Number) m6381minIntrinsicWidth($this$minIntrinsicWidth, (List<? extends IntrinsicMeasurable>) measurables, height)).intValue();
        }

        /* JADX INFO: renamed from: minIntrinsicWidth, reason: collision with other method in class */
        public Void m6381minIntrinsicWidth(IntrinsicMeasureScope $this$minIntrinsicWidth, List<? extends IntrinsicMeasurable> list, int height) {
            throw new IllegalStateException(this.error.toString());
        }

        /* JADX INFO: renamed from: minIntrinsicHeight, reason: collision with other method in class */
        public Void m6380minIntrinsicHeight(IntrinsicMeasureScope $this$minIntrinsicHeight, List<? extends IntrinsicMeasurable> list, int width) {
            throw new IllegalStateException(this.error.toString());
        }

        /* JADX INFO: renamed from: maxIntrinsicWidth, reason: collision with other method in class */
        public Void m6379maxIntrinsicWidth(IntrinsicMeasureScope $this$maxIntrinsicWidth, List<? extends IntrinsicMeasurable> list, int height) {
            throw new IllegalStateException(this.error.toString());
        }

        /* JADX INFO: renamed from: maxIntrinsicHeight, reason: collision with other method in class */
        public Void m6378maxIntrinsicHeight(IntrinsicMeasureScope $this$maxIntrinsicHeight, List<? extends IntrinsicMeasurable> list, int width) {
            throw new IllegalStateException(this.error.toString());
        }
    }
    ...
    public void setViewConfiguration(ViewConfiguration value) {
        ...
        if (!Intrinsics.areEqual(this.viewConfiguration, value)) {
            ...
            if ((this_$iv4.getAggregateChildKindSet() & iM6460constructorimpl) == 0) {
                return;
            }
            Modifier.Node node$iv$iv$iv = this_$iv4.getHead();
            while (node$iv$iv$iv != null) {
                Modifier.Node it$iv$iv = node$iv$iv$iv;
                if ((it$iv$iv.getKindSet() & iM6460constructorimpl) == 0) {
                    this_$iv = this_$iv4;
                } else {
                    ...
                    while (nodePop != null) {
                        if (nodePop instanceof PointerInputModifierNode) {
                            ...
                            Modifier.Node this_$iv$iv$iv = nodePop;
                            if (!((this_$iv$iv$iv.getKindSet() & iM6460constructorimpl) != 0) || !(nodePop instanceof DelegatingNode)) {
                                this_$iv2 = this_$iv4;
                            } else {
                                int count$iv$iv2 = 0;
                                DelegatingNode this_$iv$iv$iv2 = (DelegatingNode) nodePop;
                ...
                if ((it$iv$iv.getAggregateChildKindSet() & iM6460constructorimpl) == 0) {
                    return;
                }
    ...
    public void setCompositionLocalMap(CompositionLocalMap value) {
        ...
        int iM6460constructorimpl = NodeKind.m6460constructorimpl(32768);
        if ((this_$iv3.getAggregateChildKindSet() & iM6460constructorimpl) == 0) {
            return;
        }
    ...
    private final void applyModifier(Modifier modifier) {
        boolean hadPointerInput = this.nodes.m6421hasH91voCI$ui(NodeKind.m6460constructorimpl(16));
        boolean hadFocusTarget = this.nodes.m6421hasH91voCI$ui(NodeKind.m6460constructorimpl(1024));
        this._modifier = modifier;
        this.nodes.updateFrom$ui(modifier);
        boolean hasPointerInput = this.nodes.m6421hasH91voCI$ui(NodeKind.m6460constructorimpl(16));
        boolean hasFocusTarget = this.nodes.m6421hasH91voCI$ui(NodeKind.m6460constructorimpl(1024));
        this.layoutDelegate.updateParentData();
        if (this.lookaheadRoot == null && this.nodes.m6421hasH91voCI$ui(NodeKind.m6460constructorimpl(512))) {
            setLookaheadRoot(this);
        }
    ...
    public static /* synthetic */ void m6362hitTest6fMxITs$ui$default(LayoutNode layoutNode, long j, HitTestResult hitTestResult, int i, boolean z, int i2, Object obj) {
        int iM6089getUnknownT8wyACA;
        boolean z2;
        if ((i2 & 4) == 0) {
            iM6089getUnknownT8wyACA = i;
        } else {
            iM6089getUnknownT8wyACA = PointerType.INSTANCE.m6089getUnknownT8wyACA();
        }
        if ((i2 & 8) == 0) {
            z2 = z;
        } else {
        ...
        layoutNode.m6369hitTest6fMxITs$ui(j, hitTestResult, iM6089getUnknownT8wyACA, z2);
    }

    /* JADX INFO: renamed from: hitTest-6fMxITs$ui, reason: not valid java name */
    public final void m6369hitTest6fMxITs$ui(long pointerPosition, HitTestResult hitTestResult, int pointerType, boolean isInLayer) {
        long positionInWrapped = NodeCoordinator.m6429fromParentPosition8S9VItk$default(getOuterCoordinator$ui(), pointerPosition, false, 2, null);
        getOuterCoordinator$ui().m6447hitTestqzLsGqo(NodeCoordinator.INSTANCE.getPointerInputSource(), positionInWrapped, hitTestResult, pointerType, isInLayer);
    }

    /* JADX INFO: renamed from: hitTestSemantics-6fMxITs$ui$default, reason: not valid java name */
    public static /* synthetic */ void m6363hitTestSemantics6fMxITs$ui$default(LayoutNode layoutNode, long j, HitTestResult hitTestResult, int i, boolean z, int i2, Object obj) {
        ...
        layoutNode.m6370hitTestSemantics6fMxITs$ui(j, hitTestResult, iM6088getTouchT8wyACA, z2);
    }

    /* JADX INFO: renamed from: hitTestSemantics-6fMxITs$ui, reason: not valid java name */
    public final void m6370hitTestSemantics6fMxITs$ui(long pointerPosition, HitTestResult hitSemanticsEntities, int pointerType, boolean isInLayer) {
        long positionInWrapped = NodeCoordinator.m6429fromParentPosition8S9VItk$default(getOuterCoordinator$ui(), pointerPosition, false, 2, null);
        getOuterCoordinator$ui().m6447hitTestqzLsGqo(NodeCoordinator.INSTANCE.getSemanticsSource(), positionInWrapped, hitSemanticsEntities, PointerType.INSTANCE.m6088getTouchT8wyACA(), isInLayer);
    }
    ...
    public final void dispatchOnPositionedCallbacks$ui() {
        ...
        NodeChain this_$iv3 = this.nodes;
        int i4 = 256;
        int iM6460constructorimpl = NodeKind.m6460constructorimpl(256);
        if ((this_$iv3.getAggregateChildKindSet() & iM6460constructorimpl) == 0) {
            return;
        }
        Modifier.Node node$iv$iv$iv = this_$iv3.getHead();
            ...
            if ((it$iv$iv.getKindSet() & iM6460constructorimpl) != 0) {
                ...
                while (this_$iv$iv$iv2 != null) {
                    if (this_$iv$iv$iv2 instanceof GlobalPositionAwareModifierNode) {
                        ...
                        it.onGloballyPositioned(DelegatableNodeKt.m6312requireCoordinator64DMado(it, NodeKind.m6460constructorimpl(i2)));
                    } else {
                        this_$iv2 = this_$iv3;
                        i3 = iM6460constructorimpl;
                        int i6 = 1;
                        if (((this_$iv$iv$iv2.getKindSet() & i5) != 0) && (this_$iv$iv$iv2 instanceof DelegatingNode)) {
                            int count$iv$iv2 = 0;
                            DelegatingNode this_$iv$iv$iv3 = (DelegatingNode) this_$iv$iv$iv2;
                            Modifier.Node node$iv$iv$iv2 = this_$iv$iv$iv3.getDelegate();
                            while (node$iv$iv$iv2 != null) {
                                Modifier.Node next$iv$iv = node$iv$iv$iv2;
                                if (((next$iv$iv.getKindSet() & i5) != 0 ? i6 : 0) == 0) {
    ...
    public static /* synthetic */ boolean m6364lookaheadRemeasure_Sx5XlM$ui$default(LayoutNode layoutNode, Constraints constraints, int i, Object obj) {
        if ((i & 1) != 0) {
            constraints = layoutNode.layoutDelegate.m6385getLastLookaheadConstraintsDWUhwKw();
        }
        return layoutNode.m6371lookaheadRemeasure_Sx5XlM$ui(constraints);
    }

    /* JADX INFO: renamed from: lookaheadRemeasure-_Sx5XlM$ui, reason: not valid java name */
    public final boolean m6371lookaheadRemeasure_Sx5XlM$ui(Constraints constraints) {
        if (constraints != null && this.lookaheadRoot != null) {
            LookaheadPassDelegate lookaheadPassDelegate$ui = getLookaheadPassDelegate$ui();
            Intrinsics.checkNotNull(lookaheadPassDelegate$ui);
            return lookaheadPassDelegate$ui.m6405remeasureBRTryo0(constraints.getValue());
        }
        return false;
    }

    /* JADX INFO: renamed from: remeasure-_Sx5XlM$ui$default, reason: not valid java name */
    public static /* synthetic */ boolean m6365remeasure_Sx5XlM$ui$default(LayoutNode layoutNode, Constraints constraints, int i, Object obj) {
        if ((i & 1) != 0) {
            constraints = layoutNode.layoutDelegate.m6384getLastConstraintsDWUhwKw();
        }
        return layoutNode.m6372remeasure_Sx5XlM$ui(constraints);
    }

    /* JADX INFO: renamed from: remeasure-_Sx5XlM$ui, reason: not valid java name */
    public final boolean m6372remeasure_Sx5XlM$ui(Constraints constraints) {
        if (constraints != null) {
            if (this.intrinsicsUsageByParent == UsageByParent.NotUsed) {
                clearSubtreeIntrinsicsUsage$ui();
            }
            return getMeasurePassDelegate$ui().m6416remeasureBRTryo0(constraints.getValue());
        }
        return false;
    }
                ...
                if ((it$iv$iv.getKindSet() & iM6460constructorimpl) != 0) {
                    ...
                    while (nodePop != null) {
                        if (nodePop instanceof LayoutModifierNode) {
                            ...
                            this_$iv2 = this_$iv3;
                            OwnedLayer layer = DelegatableNodeKt.m6312requireCoordinator64DMado(it, NodeKind.m6460constructorimpl(i2)).getLayer();
                            if (layer != null) {
                                layer.invalidate();
                            }
                            i3 = iM6460constructorimpl;
                            ...
                            if (((this_$iv$iv$iv.getKindSet() & i6) != 0) && (nodePop instanceof DelegatingNode)) {
                                ...
                                while (node$iv$iv$iv2 != null) {
                                    Modifier.Node next$iv$iv = node$iv$iv$iv2;
                                    if (((next$iv$iv.getKindSet() & i6) != 0 ? i7 : 0) != 0) {
                                        count$iv$iv2++;
                                        if (count$iv$iv2 == i7) {
                                            nodePop = next$iv$iv;
    ...
    public void forceRemeasure() {
        ...
        Constraints lastConstraints = layoutNode.layoutDelegate.m6384getLastConstraintsDWUhwKw();
        Owner owner = layoutNode.owner;
        if (lastConstraints != null) {
            if (owner != null) {
                owner.mo6527measureAndLayout0kLqBqw(this, lastConstraints.getValue());
            }
        } else if (owner != null) {
    ...
    public void onLayoutComplete() {
        ...
        int count$iv$iv2 = NodeKind.m6460constructorimpl(4194304);
        int i6 = 0;
        boolean includeTail$iv$iv = NodeKindKt.m6469getIncludeSelfInTraversalH91voCI(count$iv$iv2);
                        ...
                        if (nodePop instanceof LayoutAwareModifierNode) {
                            ...
                            if (!((this_$iv$iv$iv.getKindSet() & i7) != 0) || !(nodePop instanceof DelegatingNode)) {
                                ...
                                while (node$iv$iv$iv != null) {
                                    ...
                                    if (((next$iv$iv.getKindSet() & i7) != 0 ? i8 : 0) == 0) {
                                        i5 = i6;
                                    } else {
                                        count$iv$iv3++;
                                        if (count$iv$iv3 == i8) {
