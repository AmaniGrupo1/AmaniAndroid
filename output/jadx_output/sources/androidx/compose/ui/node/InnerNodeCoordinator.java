...
public final class InnerNodeCoordinator extends NodeCoordinator {
    ...
    private final class LookaheadDelegateImpl extends LookaheadDelegate {
        ...
        public Placeable mo6141measureBRTryo0(long constraints) {
            ...
            MeasureResult measureResult = $this$measure_BRTryo0_u24lambda_u240_u241.mo41measure3p2s80s(this, getLayoutNode().getChildLookaheadMeasurables$ui(), constraints);
    ...
    public Placeable mo6141measureBRTryo0(long constraints) {
        ...
        if (getForceMeasureWithLookaheadConstraints()) {
            ...
            constraints2 = lookaheadDelegate.m6396getConstraintsmsEJaDk$ui();
        } else {
            constraints2 = constraints;
        }
        InnerNodeCoordinator this_$iv = this;
        long j = constraints2;
        this_$iv.m6206setMeasurementConstraintsBRTryo0(j);
        MutableVector<LayoutNode> mutableVector = getLayoutNode().get_children$ui();
        int i$iv$iv = 0;
        Object[] content$iv$iv = mutableVector.content;
        int size$iv$iv = mutableVector.getSize();
        ...
        MeasurePolicy $this$measure_BRTryo0_u24lambda_u240_u241 = getLayoutNode().getMeasurePolicy();
        setMeasureResult$ui($this$measure_BRTryo0_u24lambda_u240_u241.mo41measure3p2s80s(this, getLayoutNode().getChildMeasurables$ui(), constraints2));
        onMeasured();
        return this;
    }
    ...
    */
    public void mo6358hitTestChildqzLsGqo(NodeCoordinator.HitTestSource hitTestSource, long pointerPosition, HitTestResult hitTestResult, int pointerType, boolean isInLayer) {
        int i;
        ...
        boolean inLayer2 = isInLayer;
        NodeCoordinator.HitTestSource hitTestSource2 = hitTestSource;
        if (!hitTestSource2.shouldHitTestChildren(getLayoutNode())) {
            i = pointerType;
        } else {
            if (m6454withinLayerBoundsk4lQ0M(j)) {
                i = pointerType;
                hitTestChildren = true;
            } else {
                i = pointerType;
                if (PointerType.m6081equalsimpl0(i, PointerType.INSTANCE.m6088getTouchT8wyACA())) {
                    float $this$fastIsFinite$iv = m6442distanceInMinimumTouchTargettz77jQw(j, m6445getMinimumTouchTargetSizeNHjbRc());
            ...
            if (!hitTestChildren) {
                int depth$iv = hitTestResult.hitDepth;
                MutableVector<LayoutNode> zSortedChildren = getLayoutNode().getZSortedChildren();
                Object[] content$iv2 = zSortedChildren.content;
                int i$iv = zSortedChildren.getSize() - 1;
                while (i$iv >= 0) {
                    LayoutNode child = (LayoutNode) content$iv2[i$iv];
                    if (child.isPlaced()) {
                        int i2 = i;
                        inLayer = inLayer2;
                        content$iv = content$iv2;
                        hitTestSource2.mo6455childHitTestqzLsGqo(child, j, hitTestResult, i2, inLayer);
                        boolean wasHit2 = hitTestResult.hasHit();
                        if (!wasHit2) {
                            continueHitTest = true;
                        } else if (child.getOuterCoordinator$ui().shouldSharePointerInputWithSiblings()) {
                ...
                hitTestResult.hitDepth = depth$iv;
                return;
            }
            return;
        }
    ...
    static {
        ...
        paint.mo4573setColor8_81llA(Color.INSTANCE.m4731getRed0d7_KjU());
