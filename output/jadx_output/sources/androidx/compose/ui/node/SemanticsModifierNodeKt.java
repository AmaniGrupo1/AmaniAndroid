...
public final class SemanticsModifierNodeKt {
    ...
    public static final Rect touchBoundsInRoot(Modifier.Node $this$touchBoundsInRoot, boolean useMinimumTouchTarget) {
        ...
        if (!useMinimumTouchTarget) {
            return LayoutCoordinatesKt.boundsInRoot(DelegatableNodeKt.m6312requireCoordinator64DMado($this$touchBoundsInRoot, NodeKind.m6460constructorimpl(8)));
        }
        return DelegatableNodeKt.m6312requireCoordinator64DMado($this$touchBoundsInRoot, NodeKind.m6460constructorimpl(8)).touchBoundsInRoot();
    }
}
