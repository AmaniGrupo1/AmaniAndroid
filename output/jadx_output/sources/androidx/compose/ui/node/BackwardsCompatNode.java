...
public final class BackwardsCompatNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, SemanticsModifierNode, PointerInputModifierNode, ModifierLocalModifierNode, ModifierLocalReadScope, ParentDataModifierNode, LayoutAwareModifierNode, GlobalPositionAwareModifierNode, FocusEventModifierNode, FocusPropertiesModifierNode, FocusRequesterModifierNode, OwnerScope, BuildDrawCacheParams {
    ...
    private final void unInitializeModifier() {
        ...
        if ((this_$iv.getKindSet() & NodeKind.m6460constructorimpl(32)) != 0) {
        ...
        if ((this_$iv2.getKindSet() & NodeKind.m6460constructorimpl(8)) != 0) {
    ...
    private final void initializeModifier(boolean duringAttach) {
        ...
        BackwardsCompatNode this_$iv2 = this;
        if ((this_$iv2.getKindSet() & NodeKind.m6460constructorimpl(4)) != 0) {
        ...
        if ((this_$iv3.getKindSet() & NodeKind.m6460constructorimpl(2)) != 0) {
        ...
        if (((this_$iv4.getKindSet() & NodeKind.m6460constructorimpl(128)) != 0) && (element instanceof OnRemeasuredModifier)) {
        ...
        if (((this_$iv5.getKindSet() & NodeKind.m6460constructorimpl(4194304)) != 0) && (element instanceof OnPlacedModifier)) {
                ...
                DelegatableNodeKt.requireOwner(this).registerOnLayoutCompletedListener(new Owner.OnLayoutCompletedListener() { // from class: androidx.compose.ui.node.BackwardsCompatNode.initializeModifier.3
                    ...
                    public void onLayoutComplete() {
                        if (BackwardsCompatNode.this.lastOnPlacedCoordinates == null) {
                            BackwardsCompatNode.this.onPlaced(DelegatableNodeKt.m6312requireCoordinator64DMado(BackwardsCompatNode.this, NodeKind.m6460constructorimpl(4194304)));
                        }
                    }
                });
            }
        ...
        if (((this_$iv6.getKindSet() & NodeKind.m6460constructorimpl(256)) != 0) && (element instanceof OnGloballyPositionedModifier)) {
        ...
        if (((this_$iv7.getKindSet() & NodeKind.m6460constructorimpl(16)) != 0) && (element instanceof PointerInputModifier)) {
        ...
        if ((this_$iv8.getKindSet() & NodeKind.m6460constructorimpl(8)) != 0) {
            DelegatableNodeKt.requireOwner(this).onSemanticsChange();
        }
    }
    ...
    public long mo4230getSizeNHjbRc() {
        return IntSizeKt.m7688toSizeozmzZPI(DelegatableNodeKt.m6312requireCoordinator64DMado(this, NodeKind.m6460constructorimpl(128)).mo6149getSizeYbymL2g());
    }
                    ...
                    if ((parent.getKindSet() & iM6460constructorimpl) != 0) {
                        ...
                        while (nodePop != null) {
                            ...
                            if (nodePop instanceof ModifierLocalModifierNode) {
                                ...
                                modifierLocal3 = modifierLocal4;
                                int i2 = 1;
                                if (((nodePop.getKindSet() & iM6460constructorimpl) != 0 ? 1 : 0) != 0 && (nodePop instanceof DelegatingNode)) {
                                    int i3 = 0;
                                    Modifier.Node delegate = ((DelegatingNode) nodePop).getDelegate();
                                    while (delegate != null) {
                                        Modifier.Node node2 = delegate;
                                        if (((node2.getKindSet() & iM6460constructorimpl) != 0 ? i2 : 0) != 0) {
                                            i3++;
                                            if (i3 == i2) {
                                                nodePop = node2;
                                            } else {
    ...
    public MeasureResult mo69measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long j) {
        ...
        return $this$measure_3p2s80s_u24lambda_u240.mo1198measure3p2s80s($this$measure_u2d3p2s80s, measurable, j);
    }
    ...
    public void mo233onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long bounds) {
        ...
        $this$onPointerEvent_H0pRuoY_u24lambda_u240.getPointerInputFilter().mo6033onPointerEventH0pRuoY(pointerEvent, pass, bounds);
    }
    ...
    public void mo394onRemeasuredozmzZPI(long size) {
        ...
        if (element instanceof OnRemeasuredModifier) {
            ((OnRemeasuredModifier) element).m6197onRemeasuredozmzZPI(size);
        }
    }
