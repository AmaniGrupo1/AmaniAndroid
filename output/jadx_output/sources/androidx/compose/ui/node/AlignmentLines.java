...
public abstract class AlignmentLines {
    ...
    protected abstract long mo6295calculatePositionInParentR5De75A(NodeCoordinator nodeCoordinator, long j);
    ...
    public final void addAlignmentLine(AlignmentLine alignmentLine, int initialPosition, NodeCoordinator initialCoordinator) {
        ...
        char c = ' ';
        long position = Offset.m4444constructorimpl((v1$iv$iv << 32) | (v2$iv$iv & 4294967295L));
        NodeCoordinator coordinator = initialCoordinator;
        while (true) {
            position = mo6295calculatePositionInParentR5De75A(coordinator, position);
            ...
            if (getAlignmentLinesMap(coordinator).containsKey(alignmentLine)) {
                ...
                position = Offset.m4444constructorimpl((v1$iv$iv2 << c2) | (v2$iv$iv2 & 4294967295L));
                c = c2;
            }
        }
        char c3 = c;
