...
public interface LayoutModifierNode extends DelegatableNode {
    ...
    MeasureResult mo69measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j);
    ...
    default int minIntrinsicWidth(IntrinsicMeasureScope $this$minIntrinsicWidth, IntrinsicMeasurable measurable, int height) {
        return NodeMeasuringIntrinsics.INSTANCE.minWidth$ui(new NodeMeasuringIntrinsics.MeasureBlock() { // from class: androidx.compose.ui.node.LayoutModifierNode.minIntrinsicWidth.1
            ...
            /* JADX INFO: renamed from: measure-3p2s80s */
            public final MeasureResult mo6359measure3p2s80s(MeasureScope $this$minWidth, Measurable intrinsicMeasurable, long j) {
                return LayoutModifierNode.this.mo69measure3p2s80s($this$minWidth, intrinsicMeasurable, j);
            }
    ...
    default int minIntrinsicHeight(IntrinsicMeasureScope $this$minIntrinsicHeight, IntrinsicMeasurable measurable, int width) {
        return NodeMeasuringIntrinsics.INSTANCE.minHeight$ui(new NodeMeasuringIntrinsics.MeasureBlock() { // from class: androidx.compose.ui.node.LayoutModifierNode.minIntrinsicHeight.1
            @Override // androidx.compose.ui.node.NodeMeasuringIntrinsics.MeasureBlock
            /* JADX INFO: renamed from: measure-3p2s80s */
            public final MeasureResult mo6359measure3p2s80s(MeasureScope $this$minHeight, Measurable intrinsicMeasurable, long j) {
                return LayoutModifierNode.this.mo69measure3p2s80s($this$minHeight, intrinsicMeasurable, j);
            }
    ...
    default int maxIntrinsicWidth(IntrinsicMeasureScope $this$maxIntrinsicWidth, IntrinsicMeasurable measurable, int height) {
        return NodeMeasuringIntrinsics.INSTANCE.maxWidth$ui(new NodeMeasuringIntrinsics.MeasureBlock() { // from class: androidx.compose.ui.node.LayoutModifierNode.maxIntrinsicWidth.1
            @Override // androidx.compose.ui.node.NodeMeasuringIntrinsics.MeasureBlock
            /* JADX INFO: renamed from: measure-3p2s80s */
            public final MeasureResult mo6359measure3p2s80s(MeasureScope $this$maxWidth, Measurable intrinsicMeasurable, long j) {
                return LayoutModifierNode.this.mo69measure3p2s80s($this$maxWidth, intrinsicMeasurable, j);
            }
    ...
    default int maxIntrinsicHeight(IntrinsicMeasureScope $this$maxIntrinsicHeight, IntrinsicMeasurable measurable, int width) {
        return NodeMeasuringIntrinsics.INSTANCE.maxHeight$ui(new NodeMeasuringIntrinsics.MeasureBlock() { // from class: androidx.compose.ui.node.LayoutModifierNode.maxIntrinsicHeight.1
            ...
            public final MeasureResult mo6359measure3p2s80s(MeasureScope $this$maxHeight, Measurable intrinsicMeasurable, long j) {
                return LayoutModifierNode.this.mo69measure3p2s80s($this$maxHeight, intrinsicMeasurable, j);
            }
