...
public interface OwnedLayer {
    ...
    float[] mo6517getUnderlyingMatrixsQKQjiQ();

    void invalidate();

    /* JADX INFO: renamed from: inverseTransform-58bKbWc, reason: not valid java name */
    void mo6518inverseTransform58bKbWc(float[] matrix);
    ...
    void mo6523transform58bKbWc(float[] matrix);
