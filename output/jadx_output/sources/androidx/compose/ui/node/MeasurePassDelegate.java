...
public final class MeasurePassDelegate extends Placeable implements Measurable, AlignmentLinesOwner, MotionReferencePlacementDelegate {
    ...
    private long lastPosition = IntOffset.INSTANCE.m7644getZeronOccac();
    ...
    private final Function0<Unit> performMeasureBlock = new Function0<Unit>() { // from class: androidx.compose.ui.node.MeasurePassDelegate$performMeasureBlock$1
        ...
        public final void invoke2() {
            this.this$0.getOuterCoordinator().mo6141measureBRTryo0(this.this$0.performMeasureConstraints);
        }
    };
    ...
    private long placeOuterCoordinatorPosition = IntOffset.INSTANCE.m7644getZeronOccac();
    private final Function0<Unit> placeOuterCoordinatorBlock = new Function0<Unit>() { // from class: androidx.compose.ui.node.MeasurePassDelegate$placeOuterCoordinatorBlock$1
        ...
        public final void invoke2() {
            ...
            if (layer != null) {
                $this$invoke_u24lambda_u240.m6222placeWithLayeraW9wM(measurePassDelegate.getOuterCoordinator(), measurePassDelegate.placeOuterCoordinatorPosition, layer, measurePassDelegate.placeOuterCoordinatorZIndex);
            } else if (function1 == null) {
                $this$invoke_u24lambda_u240.m6213place70tqf50(measurePassDelegate.getOuterCoordinator(), measurePassDelegate.placeOuterCoordinatorPosition, measurePassDelegate.placeOuterCoordinatorZIndex);
            } else {
                $this$invoke_u24lambda_u240.m6221placeWithLayeraW9wM(measurePassDelegate.getOuterCoordinator(), measurePassDelegate.placeOuterCoordinatorPosition, measurePassDelegate.placeOuterCoordinatorZIndex, function1);
            }
        }
    };
    ...
    public final Constraints m6413getLastConstraintsDWUhwKw() {
        if (this.measuredOnce) {
            return Constraints.m7445boximpl(getMeasurementConstraints());
        }
        return null;
    }
    ...
    private final void markNodeAndSubtreeAsPlaced() {
        ...
        if (!wasPlaced) {
            ...
            LayoutNodeKt.requireOwner($this$markNodeAndSubtreeAsPlaced_u24lambda_u240).getRectManager().onLayoutPositionChanged(getLayoutNode(), true);
    ...
    public final void m6415performMeasureBRTryo0$ui(long constraints) {
    ...
    public Placeable mo6141measureBRTryo0(long constraints) throws Throwable {
        ...
        if (LayoutNodeLayoutDelegateKt.isOutMostLookaheadRoot(getLayoutNode())) {
            ...
            $this$measure_BRTryo0_u24lambda_u240.mo6141measureBRTryo0(constraints);
        }
        trackMeasurementByParent(getLayoutNode());
        m6416remeasureBRTryo0(constraints);
        return this;
    }

    /* JADX INFO: renamed from: remeasure-BRTryo0, reason: not valid java name */
    public final boolean m6416remeasureBRTryo0(long constraints) throws Throwable {
        ...
        try {
            ...
            if (!getLayoutNode().getMeasurePending$ui()) {
                try {
                    if (Constraints.m7451equalsimpl0(getMeasurementConstraints(), constraints)) {
            ...
            try {
                ...
                long outerPreviousMeasuredSize = getOuterCoordinator().mo6149getSizeYbymL2g();
                ...
                setLayoutState(LayoutNode.LayoutState.Measuring);
                this.measurePending = false;
                OwnerSnapshotObserver this_$iv$iv = LayoutNodeKt.requireOwner(getLayoutNode()).getSnapshotObserver();
                LayoutNode node$iv$iv = getLayoutNode();
                Function0<Unit> performMeasureBlock$ui = getPerformMeasureBlock$ui();
                LayoutNode layoutNode = node$iv$iv;
                Function1 onChanged$iv$iv$iv = this_$iv$iv.onCommitAffectingMeasure;
                try {
                    ...
                    boolean sizeChanged = (IntSize.m7674equalsimpl0(getOuterCoordinator().mo6149getSizeYbymL2g(), outerPreviousMeasuredSize) && getOuterCoordinator().getWidth() == getWidth() && getOuterCoordinator().getHeight() == getHeight()) ? false : true;
                    int width$iv = getOuterCoordinator().getWidth();
                    int height$iv = getOuterCoordinator().getHeight();
                    m6205setMeasuredSizeozmzZPI(IntSize.m7671constructorimpl((((long) height$iv) & 4294967295L) | (((long) width$iv) << 32)));
                    return sizeChanged;
                } catch (Throwable th3) {
                    e$iv = th3;
                    layoutNode$iv.rethrowWithComposeStackTrace(e$iv);
    ...
    public void mo6142placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) throws Throwable {
        m6412placeSelfMLgxB_4(position, zIndex, layerBlock, null);
    }

    /* JADX INFO: Access modifiers changed from: protected */
    @Override // androidx.compose.ui.layout.Placeable
    /* JADX INFO: renamed from: placeAt-f8xVGno */
    public void mo6204placeAtf8xVGno(long position, float zIndex, GraphicsLayer layer) throws Throwable {
        m6412placeSelfMLgxB_4(position, zIndex, null, layer);
    }
    ...
    private final void m6412placeSelfMLgxB_4(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock, GraphicsLayer layer) throws Throwable {
        Placeable.PlacementScope scope;
        LayoutNode layoutNode$iv = getLayoutNode();
        try {
        ...
        try {
            boolean z = false;
            if (!IntOffset.m7632equalsimpl0(position, this.lastPosition) || this.needsCoordinatesUpdate) {
            ...
            if (lookaheadPassDelegate2 != null && lookaheadPassDelegate2.getNeedsToBePlacedInApproach()) {
                ...
                Placeable.PlacementScope $this$placeSelf_MLgxB_4_u24lambda_u240_u240 = scope;
                LookaheadPassDelegate it = getLookaheadPassDelegate();
                Intrinsics.checkNotNull(it);
                LayoutNode $this$placeSelf_MLgxB_4_u24lambda_u240_u240_u240_u240 = getLayoutNode().getParent$ui();
                if ($this$placeSelf_MLgxB_4_u24lambda_u240_u240_u240_u240 != null) {
                    $this$placeSelf_MLgxB_4_u24lambda_u240_u240_u240_u240.getLayoutDelegate().setNextChildLookaheadPlaceOrder$ui(0);
                }
                it.setPlaceOrder$ui(Integer.MAX_VALUE);
                Placeable.PlacementScope.place$default($this$placeSelf_MLgxB_4_u24lambda_u240_u240, it, IntOffset.m7633getXimpl(position), IntOffset.m7634getYimpl(position), 0.0f, 4, null);
            }
            ...
            m6411placeOuterCoordinatorMLgxB_4(position, zIndex, layerBlock, layer);
    ...
    private final void m6411placeOuterCoordinatorMLgxB_4(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock, GraphicsLayer layer) {
        boolean value$iv = !getLayoutNode().getIsDeactivated();
        if (!value$iv) {
        ...
        if (this.layoutPending || !this.isPlaced) {
            ...
            getOuterCoordinator().m6450placeSelfApparentToRealOffsetMLgxB_4(position, zIndex, layerBlock, layer);
            onNodePlaced$ui();
        }
        setLayoutState(LayoutNode.LayoutState.Idle);
    ...
    public final void replace() {
        ...
        try {
            ...
            try {
                measurePassDelegate.m6411placeOuterCoordinatorMLgxB_4(this.lastPosition, this.lastZIndex, this.lastLayerBlock, this.lastExplicitLayer);
                if (value$iv2 && !measurePassDelegate.onNodePlacedCalled && (parent$ui = getLayoutNode().getParent$ui()) != null) {
        ...
        if (this.layoutNodeLayoutDelegate.getChildrenAccessingCoordinatesDuringPlacement() > 0) {
            ...
            for (int i$iv$iv = 0; i$iv$iv < size$iv$iv; i$iv$iv++) {
                ...
                if (accessed && !childLayoutDelegate.getLayoutPending$ui()) {
                    LayoutNode.requestRelayout$ui$default(child, false, 1, null);
                }
    ...
    private final void onBeforeLayoutChildren() {
        ...
        for (int i$iv$iv = 0; i$iv$iv < size$iv$iv; i$iv$iv++) {
            LayoutNode it = (LayoutNode) content$iv$iv[i$iv$iv];
            if (it.getMeasurePending$ui() && it.getMeasuredByParent$ui() == LayoutNode.UsageByParent.InMeasureBlock && LayoutNode.m6365remeasure_Sx5XlM$ui$default(it, null, 1, null)) {
                LayoutNode.requestRemeasure$ui$default(getLayoutNode(), false, false, false, 7, null);
            }
        }
    }
