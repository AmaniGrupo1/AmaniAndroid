...
public abstract class LookaheadDelegate extends LookaheadCapablePlaceable implements Measurable {
    ...
    public void m6401setPositiongyyYBs(long j) {
        this.position = j;
    }
    ...
    public final long m6397getSizeYbymL2g$ui() {
    ...
    public final long m6396getConstraintsmsEJaDk$ui() {
    ...
    public final void set_measureResult(MeasureResult result) {
        if (result != null) {
            ...
            m6205setMeasuredSizeozmzZPI(IntSize.m7671constructorimpl((((long) width$iv) << 32) | (((long) height$iv) & 4294967295L)));
        } else {
            LookaheadDelegate $this$_set__measureResult__u24lambda_u241 = this;
            $this$_set__measureResult__u24lambda_u241.m6205setMeasuredSizeozmzZPI(IntSize.INSTANCE.m7681getZeroYbymL2g());
        }
    ...
    public void replace$ui() {
        mo6142placeAtf8xVGno(getPosition(), 0.0f, (Function1<? super GraphicsLayerScope, Unit>) null);
    }

    /* JADX INFO: Access modifiers changed from: protected */
    @Override // androidx.compose.ui.layout.Placeable
    /* JADX INFO: renamed from: placeAt-f8xVGno */
    public final void mo6142placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
        m6395placeSelfgyyYBs(position);
    ...
    private final void m6395placeSelfgyyYBs(long position) {
        if (!IntOffset.m7632equalsimpl0(getPosition(), position)) {
            m6401setPositiongyyYBs(position);
    ...
    public final void m6399placeSelfApparentToRealOffsetgyyYBs$ui(long position) {
        m6395placeSelfgyyYBs(IntOffset.m7637plusqkQi6aY(position, getApparentToRealOffset()));
    }
    ...
    public final Placeable m6398performingMeasureK40F9xA(long constraints, Function0<? extends MeasureResult> block) {
    ...
    public final long m6400positionIniSbpLlY$ui(LookaheadDelegate ancestor, boolean excludingAgnosticOffset) {
        long aggregatedOffset = IntOffset.INSTANCE.m7644getZeronOccac();
        ...
        while (!Intrinsics.areEqual(lookaheadDelegate, ancestor)) {
            if (!lookaheadDelegate.getIsPlacedUnderMotionFrameOfReference() || !excludingAgnosticOffset) {
                aggregatedOffset = IntOffset.m7637plusqkQi6aY(aggregatedOffset, lookaheadDelegate.getPosition());
            }
