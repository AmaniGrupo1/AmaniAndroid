...
public final class LookaheadPassDelegate extends Placeable implements Measurable, AlignmentLinesOwner, MotionReferencePlacementDelegate {
    ...
    private final Function0<Unit> performMeasureBlock = new Function0<Unit>() { // from class: androidx.compose.ui.node.LookaheadPassDelegate$performMeasureBlock$1
        ...
        public final void invoke2() {
            ...
            lookaheadDelegate.mo6141measureBRTryo0(this.this$0.performMeasureConstraints);
        }
    };
    private final Function0<Unit> layoutModifierBlock = new Function0<Unit>() { // from class: androidx.compose.ui.node.LookaheadPassDelegate$layoutModifierBlock$1
        ...
        public final void invoke2() {
            ...
            Placeable.PlacementScope.m6207place70tqf50$default($this$invoke_u24lambda_u240, lookaheadDelegate2, lookaheadPassDelegate2.lastPosition, 0.0f, 2, null);
        }
    };
    ...
    */
    public Placeable mo6141measureBRTryo0(long constraints) throws Throwable {
        ...
        m6405remeasureBRTryo0(constraints);
        return this;
    }
    ...
    public final void m6404performMeasureBRTryo0$ui(long constraints) {
    ...
    public final boolean m6405remeasureBRTryo0(long constraints) throws Throwable {
        char c;
        long j;
        ...
        try {
            ...
            this.lookaheadConstraints = Constraints.m7445boximpl(constraints);
            ...
            if (this.measuredOnce) {
                ...
                c = ' ';
                j = 4294967295L;
                lastLookaheadSize = IntSize.m7671constructorimpl((((long) Integer.MIN_VALUE) & 4294967295L) | (((long) Integer.MIN_VALUE) << 32));
            }
            ...
            this.layoutNodeLayoutDelegate.m6386performLookaheadMeasureBRTryo0$ui(constraints);
            ...
            m6205setMeasuredSizeozmzZPI(IntSize.m7671constructorimpl((((long) width$iv) << c) | (((long) height$iv) & j)));
    ...
    public void mo6142placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) throws Throwable {
        m6402placeSelfMLgxB_4(position, zIndex, layerBlock, null);
    }
    ...
    public void mo6204placeAtf8xVGno(long position, float zIndex, GraphicsLayer layer) throws Throwable {
        m6402placeSelfMLgxB_4(position, zIndex, null, layer);
    }
    ...
    private final void m6402placeSelfMLgxB_4(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock, GraphicsLayer layer) throws Throwable {
        LayoutNode layoutNode$iv = getLayoutNode();
        try {
            LayoutNode parent$ui = getLayoutNode().getParent$ui();
            ...
            if (!IntOffset.m7632equalsimpl0(position, this.lastPosition)) {
            ...
            if (!getLayoutPending() && isPlaced$ui()) {
                LookaheadDelegate lookaheadDelegate = getOuterCoordinator().getLookaheadDelegate();
                Intrinsics.checkNotNull(lookaheadDelegate);
                lookaheadDelegate.m6399placeSelfApparentToRealOffsetgyyYBs$ui(position);
                onNodePlaced$ui();
            } else {
    ...
    private final void onBeforeLayoutChildren() {
        ...
        for (int i$iv$iv = 0; i$iv$iv < size$iv$iv; i$iv$iv++) {
            ...
            if (it.getLookaheadMeasurePending$ui() && it.getMeasuredByParentInLookahead$ui() == LayoutNode.UsageByParent.InMeasureBlock) {
                LookaheadPassDelegate lookaheadPassDelegate = it.getLayoutDelegate().getLookaheadPassDelegate();
                Intrinsics.checkNotNull(lookaheadPassDelegate);
                Constraints constraintsM6385getLastLookaheadConstraintsDWUhwKw = it.getLayoutDelegate().m6385getLastLookaheadConstraintsDWUhwKw();
                Intrinsics.checkNotNull(constraintsM6385getLastLookaheadConstraintsDWUhwKw);
                if (lookaheadPassDelegate.m6405remeasureBRTryo0(constraintsM6385getLastLookaheadConstraintsDWUhwKw.getValue())) {
                    LayoutNode.requestLookaheadRemeasure$ui$default(getLayoutNode(), false, false, false, 7, null);
                }
            }
        }
    ...
    public final void replace() {
        ...
        try {
            ...
            try {
                lookaheadPassDelegate.m6402placeSelfMLgxB_4(this.lastPosition, 0.0f, this.lastLayerBlock, this.lastExplicitLayer);
                if (wasPlacedBefore && !lookaheadPassDelegate.onNodePlacedCalled && (parent$ui = getLayoutNode().getParent$ui()) != null) {
