...
public final class LayoutNodeLayoutDelegate {
    ...
    public final Constraints m6384getLastConstraintsDWUhwKw() {
        return this.measurePassDelegate.m6413getLastConstraintsDWUhwKw();
    }

    /* JADX INFO: renamed from: getLastLookaheadConstraints-DWUhwKw, reason: not valid java name */
    public final Constraints m6385getLastLookaheadConstraintsDWUhwKw() {
    ...
    public final void m6386performLookaheadMeasureBRTryo0$ui(long constraints) {
        LookaheadPassDelegate lookaheadPassDelegate = this.lookaheadPassDelegate;
        if (lookaheadPassDelegate != null) {
            lookaheadPassDelegate.m6404performMeasureBRTryo0$ui(constraints);
        }
    }
