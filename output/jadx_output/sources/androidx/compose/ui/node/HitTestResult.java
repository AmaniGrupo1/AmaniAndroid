...
public final class HitTestResult implements List<Modifier.Node>, KMappedMarker {
    ...
    public /* bridge */ /* synthetic */ Object m6354removeFirst() {
        throw new UnsupportedOperationException("Operation is not supported for read-only collection");
    }
    ...
    public /* bridge */ /* synthetic */ Object m6355removeLast() {
        throw new UnsupportedOperationException("Operation is not supported for read-only collection");
    }
    ...
    public final boolean hasHit() {
        long distance = m6353findBestHitDistancefn2tFes();
        return DistanceAndFlags.m6334getDistanceimpl(distance) < 0.0f && DistanceAndFlags.m6337isInLayerimpl(distance) && !DistanceAndFlags.m6336isInExpandedBoundsimpl(distance);
    }
    ...
    public final boolean isHitInMinimumTouchTargetBetter(float distanceFromEdge, boolean isInLayer) {
        ...
        long bestDistance = m6353findBestHitDistancefn2tFes();
        return DistanceAndFlags.m6330compareTo9YPOF3E(bestDistance, distanceAndFlags) > 0;
    }

    /* JADX INFO: renamed from: findBestHitDistance-fn2tFes, reason: not valid java name */
    private final long m6353findBestHitDistancefn2tFes() {
        ...
        if (i <= lastIndex) {
            while (true) {
                long distance = DistanceAndFlags.m6331constructorimpl(this.distanceFromEdgeAndFlags.get(i));
                bestDistance = DistanceAndFlags.m6330compareTo9YPOF3E(distance, bestDistance) < 0 ? distance : bestDistance;
                if (DistanceAndFlags.m6334getDistanceimpl(bestDistance) >= 0.0f || !DistanceAndFlags.m6337isInLayerimpl(bestDistance)) {
                    if (i == lastIndex) {
                        break;
                    }
                    i++;
    ...
    public final void hitExpandedTouchBounds(Modifier.Node node, boolean isInLayer, Function0<Unit> childHitTest) {
        ...
        long previousDistance = m6353findBestHitDistancefn2tFes();
        int previousHitDepth = this.hitDepth;
        if (!DistanceAndFlags.m6336isInExpandedBoundsimpl(previousDistance)) {
            if (DistanceAndFlags.m6334getDistanceimpl(previousDistance) > 0.0f) {
        ...
        long newDistance = m6353findBestHitDistancefn2tFes();
        if (DistanceAndFlags.m6334getDistanceimpl(newDistance) < 0.0f) {
    ...
    public final void speculativeHit(Modifier.Node node, float distanceFromEdge, boolean isInLayer, Function0<Unit> childHitTest) {
        ...
        if (this.hitDepth == CollectionsKt.getLastIndex(this)) {
            ...
            childHitTest.invoke();
            this.hitDepth = startDepth$iv$iv;
            if (this.hitDepth + 1 == CollectionsKt.getLastIndex(this) || DistanceAndFlags.m6336isInExpandedBoundsimpl(m6353findBestHitDistancefn2tFes())) {
        ...
        long newBestDistance = m6353findBestHitDistancefn2tFes();
        if (this.hitDepth + 1 >= CollectionsKt.getLastIndex(this) || DistanceAndFlags.m6330compareTo9YPOF3E(previousDistance, newBestDistance) <= 0) {
            removeNodesInRange(this.hitDepth + 1, size());
        } else {
            int startIndex = previousHitDepth + 1;
            boolean zM6336isInExpandedBoundsimpl = DistanceAndFlags.m6336isInExpandedBoundsimpl(newBestDistance);
            int i = this.hitDepth;
            if (zM6336isInExpandedBoundsimpl) {
                endIndex = i + 2;
            } else {
                endIndex = i + 1;
            }
    ...
    private final class SubList implements List<Modifier.Node>, KMappedMarker {
        ...
        /* JADX INFO: renamed from: removeFirst, reason: collision with other method in class */
        public /* bridge */ /* synthetic */ Object m6356removeFirst() {
            throw new UnsupportedOperationException("Operation is not supported for read-only collection");
        }
        ...
        /* JADX INFO: renamed from: removeLast, reason: collision with other method in class */
        public /* bridge */ /* synthetic */ Object m6357removeLast() {
            throw new UnsupportedOperationException("Operation is not supported for read-only collection");
        }
