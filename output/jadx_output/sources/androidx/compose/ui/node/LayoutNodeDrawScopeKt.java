...
public final class LayoutNodeDrawScopeKt {
    ...
    public static final Modifier.Node nextDrawNode(DelegatableNode $this$nextDrawNode) {
        ...
        int iM6460constructorimpl2 = NodeKind.m6460constructorimpl(2);
        Modifier.Node child = $this$nextDrawNode.getNode().getChild();
        if (child == null || (child.getAggregateChildKindSet() & iM6460constructorimpl) == 0) {
            return null;
        }
        for (Modifier.Node next = child; next != null && (next.getKindSet() & iM6460constructorimpl2) == 0; next = next.getChild()) {
            if ((next.getKindSet() & iM6460constructorimpl) != 0) {
                return next;
            }
        }
        return null;
