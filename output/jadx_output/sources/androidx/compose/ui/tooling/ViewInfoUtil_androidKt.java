...
@Metadata(d1 = {"\u0000\"\n\u0000\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\b\n\u0000\u001a.\u0010\u0000\u001a\b\u0012\u0004\u0012\u00020\u00020\u0001*\b\u0012\u0004\u0012\u00020\u00020\u00012\u0014\b\u0002\u0010\u0003\u001a\u000e\u0012\u0004\u0012\u00020\u0002\u0012\u0004\u0012\u00020\u00050\u0004H\u0002\u001a2\u0010\u0006\u001a\u00020\u0007*\b\u0012\u0004\u0012\u00020\u00020\u00012\b\b\u0002\u0010\b\u001a\u00020\t2\u0014\b\u0002\u0010\u0003\u001a\u000e\u0012\u0004\u0012\u00020\u0002\u0012\u0004\u0012\u00020\u00050\u0004H\u0000¨\u0006\n"}, d2 = {"filterTree", "", "Landroidx/compose/ui/tooling/ViewInfo;", "filter", "Lkotlin/Function1;", "", "toDebugString", "", "indentation", "", "ui-tooling"}, k = 2, mv = {2, 0, 0}, xi = 48)
    ...
    public static final String toDebugString(List<ViewInfo> list, int indentation, Function1<? super ViewInfo, Boolean> function1) {
        ...
        for (Object element$iv : $this$forEach$iv) {
            ...
            if (it.getLocation() != null) {
                StringBuilder sbAppend = builder.append(indentString + '|' + it.getFileName() + AbstractJsonLexerKt.COLON + it.getLineNumber());
                Intrinsics.checkNotNullExpressionValue(sbAppend, "append(...)");
                Intrinsics.checkNotNullExpressionValue(sbAppend.append('\n'), "append(...)");
            } else {
                StringBuilder sbAppend2 = builder.append(indentString + "|<root>");
            ...
            if (childrenString.length() > 0) {
                StringBuilder sbAppend3 = builder.append(childrenString);
