        ...
        while (i < totalParams) {
            if (i >= 0 && i < realParams) {
                if (i >= 0) {
                    ...
                    defaultValue = !z2 ? objArr[i] : INSTANCE.getDefaultValue($this$invokeComposableMethod.getParameterTypes()[i]);
                } else {
                    z = false;
                }
                z2 = z;
