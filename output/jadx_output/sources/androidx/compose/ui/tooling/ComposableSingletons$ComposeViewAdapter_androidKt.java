...
public final class ComposableSingletons$ComposeViewAdapter_androidKt {
    ...
    private static Function2<Composer, Integer, Unit> f155lambda$1163195098 = ComposableLambdaKt.composableLambdaInstance(-1163195098, false, new Function2() { // from class: androidx.compose.ui.tooling.ComposableSingletons$ComposeViewAdapter_androidKt$$ExternalSyntheticLambda0
    ...
    public final Function2<Composer, Integer, Unit> m7420getLambda$1163195098$ui_tooling() {
        return f155lambda$1163195098;
    }
    ...
    static final Unit lambda__1163195098$lambda$0(Composer $composer, int $changed) {
        ...
        if ($composer.shouldExecute(($changed & 3) != 2, $changed & 1)) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1163195098, $changed, -1, "androidx.compose.ui.tooling.ComposableSingletons$ComposeViewAdapter_androidKt.lambda$-1163195098.<anonymous> (ComposeViewAdapter.android.kt:81)");
            }
            if (ComposerKt.isTraceInProgress()) {
    ...
    static final Unit lambda_2086912010$lambda$0(Composer $composer, int $changed) {
        ...
        if ($composer.shouldExecute(($changed & 3) != 2, $changed & 1)) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(2086912010, $changed, -1, "androidx.compose.ui.tooling.ComposableSingletons$ComposeViewAdapter_androidKt.lambda$2086912010.<anonymous> (ComposeViewAdapter.android.kt:162)");
            }
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
