...
public final class ComposeViewAdapter extends FrameLayout {
    ...
    public ComposeViewAdapter(Context context, AttributeSet attrs) {
        ...
        $this$debugBoundsPaint_u24lambda_u240.setColor(ColorKt.m4751toArgb8_81llA(Color.INSTANCE.m4731getRed0d7_KjU()));
    ...
    private final void processViewInfos() {
        ...
        }, new C05782(this), new Function3() { // from class: androidx.compose.ui.tooling.ComposeViewAdapter$$ExternalSyntheticLambda2
    ...
    static final /* synthetic */ class C05782 extends FunctionReferenceImpl implements Function4<CompositionGroup, SourceContext, List<? extends ViewInfo>, List<? extends ViewInfo>, ViewInfo> {
        C05782(Object obj) {
    ...
    private final void findDesignInfoProviders() {
        ...
        for (Object element$iv$iv : $this$flatMap$iv) {
            ...
            Iterable $this$mapNotNull$iv = PreviewUtils_androidKt.findAll(rootGroup, new Function1() { // from class: androidx.compose.ui.tooling.ComposeViewAdapter$$ExternalSyntheticLambda5
                @Override // kotlin.jvm.functions.Function1
                public final Object invoke(Object obj) {
    ...
    private final void WrapPreview(final Function2<? super Composer, ? super Integer, Unit> function2, Composer $composer, final int $changed) {
        ...
        ComposerKt.sourceInformation($composer2, "C(WrapPreview)N(content)415@16135L61,410@15768L428:ComposeViewAdapter.android.kt#hevd2p");
        int $dirty = $changed;
        if (($changed & 6) == 0) {
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2() { // from class: androidx.compose.ui.tooling.ComposeViewAdapter$$ExternalSyntheticLambda10
                @Override // kotlin.jvm.functions.Function2
                public final Object invoke(Object obj, Object obj2) {
    ...
    static final Unit WrapPreview$lambda$0(ComposeViewAdapter this$0, Function2 $content, Composer $composer, int $changed) {
        ...
        if (!$composer.shouldExecute(($changed & 3) != 2, $changed & 1)) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-874838087, $changed, -1, "androidx.compose.ui.tooling.ComposeViewAdapter.WrapPreview.<anonymous> (ComposeViewAdapter.android.kt:416)");
            }
    ...
    public static /* synthetic */ void init$ui_tooling$default(ComposeViewAdapter composeViewAdapter, String str, String str2, Class cls, int i, boolean z, boolean z2, long j, boolean z3, String str3, Function0 function0, Function0 function02, int i2, Object obj) {
        composeViewAdapter.init$ui_tooling(str, str2, (i2 & 4) != 0 ? null : cls, (i2 & 8) != 0 ? 0 : i, (i2 & 16) != 0 ? false : z, (i2 & 32) != 0 ? false : z2, (i2 & 64) != 0 ? -1L : j, (i2 & 128) != 0 ? false : z3, (i2 & 256) != 0 ? null : str3, (i2 & 512) != 0 ? new Function0() { // from class: androidx.compose.ui.tooling.ComposeViewAdapter$$ExternalSyntheticLambda6
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                return Unit.INSTANCE;
            }
        } : function0, (i2 & 1024) != 0 ? new Function0() { // from class: androidx.compose.ui.tooling.ComposeViewAdapter$$ExternalSyntheticLambda7
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                return Unit.INSTANCE;
            }
    ...
    public final void init$ui_tooling(final String className, final String methodName, final Class<? extends PreviewParameterProvider<?>> parameterProvider, final int parameterProviderIndex, boolean debugPaintBounds, boolean debugViewInfos, final long animationClockStartTime, boolean lookForDesignInfoProviders, String designInfoProvidersArgument, final Function0<Unit> onCommit, Function0<Unit> onDraw) {
        ...
        this.onDraw = onDraw;
        this.previewComposition = ComposableLambdaKt.composableLambdaInstance(-658298446, true, new Function2() { // from class: androidx.compose.ui.tooling.ComposeViewAdapter$$ExternalSyntheticLambda11
            @Override // kotlin.jvm.functions.Function2
            public final Object invoke(Object obj, Object obj2) {
    ...
    static final Unit init$lambda$2(Function0 $onCommit, final ComposeViewAdapter this$0, final String $className, final String $methodName, final Class $parameterProvider, final int $parameterProviderIndex, final long $animationClockStartTime, Composer $composer, int $changed) {
        ComposerKt.sourceInformation($composer, "C465@18536L20,467@18586L2933,467@18574L2945:ComposeViewAdapter.android.kt#hevd2p");
        if (!$composer.shouldExecute(($changed & 3) != 2, $changed & 1)) {
            $composer.skipToGroupEnd();
        } else {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-658298446, $changed, -1, "androidx.compose.ui.tooling.ComposeViewAdapter.init.<anonymous> (ComposeViewAdapter.android.kt:465)");
            }
            EffectsKt.SideEffect($onCommit, $composer, 0);
            this$0.WrapPreview(ComposableLambdaKt.rememberComposableLambda(-1310372571, true, new Function2() { // from class: androidx.compose.ui.tooling.ComposeViewAdapter$$ExternalSyntheticLambda8
                @Override // kotlin.jvm.functions.Function2
                public final Object invoke(Object obj, Object obj2) {
                    return ComposeViewAdapter.init$lambda$2$0($className, $methodName, $parameterProvider, $parameterProviderIndex, this$0, $animationClockStartTime, (Composer) obj, ((Integer) obj2).intValue());
                }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit init$lambda$2$0(final String $className, final String $methodName, final Class $parameterProvider, final int $parameterProviderIndex, final ComposeViewAdapter this$0, long $animationClockStartTime, final Composer $composer, int $changed) {
        ComposerKt.sourceInformation($composer, "C474@18975L1161:ComposeViewAdapter.android.kt#hevd2p");
        if (!$composer.shouldExecute(($changed & 3) != 2, $changed & 1)) {
            $composer.skipToGroupEnd();
        } else {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1310372571, $changed, -1, "androidx.compose.ui.tooling.ComposeViewAdapter.init.<anonymous>.<anonymous> (ComposeViewAdapter.android.kt:468)");
            }
            ComposerKt.sourceInformationMarkerStart($composer, -842609394, "CC(remember):ComposeViewAdapter.android.kt#9igjgp");
            boolean invalid$iv = $composer.changed($className) | $composer.changed($methodName) | $composer.changedInstance($composer) | $composer.changedInstance($parameterProvider) | $composer.changed($parameterProviderIndex) | $composer.changedInstance(this$0);
            Object it$iv = $composer.rememberedValue();
            if (invalid$iv || it$iv == Composer.INSTANCE.getEmpty()) {
                Object value$iv = new Function0() { // from class: androidx.compose.ui.tooling.ComposeViewAdapter$$ExternalSyntheticLambda3
                    @Override // kotlin.jvm.functions.Function0
                    public final Object invoke() {
                        return ComposeViewAdapter.init$lambda$2$0$0$0($className, $methodName, $composer, $parameterProvider, $parameterProviderIndex, this$0);
                    }
                };
                $composer.updateRememberedValue(value$iv);
                it$iv = value$iv;
            }
            Function0 composable = (Function0) it$iv;
            ...
            if ($animationClockStartTime >= 0) {
                ...
                if (invalid$iv2 || it$iv2 == Composer.INSTANCE.getEmpty()) {
                    Object value$iv2 = new Function0() { // from class: androidx.compose.ui.tooling.ComposeViewAdapter$$ExternalSyntheticLambda4
                        @Override // kotlin.jvm.functions.Function0
                        public final Object invoke() {
                ...
                ComposerKt.sourceInformationMarkerEnd($composer);
                this$0.setClock$ui_tooling(new PreviewAnimationClock((Function0) it$iv2));
            } else {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit init$lambda$2$0$0$0(String $className, String $methodName, Composer $composer, Class $parameterProvider, int $parameterProviderIndex, ComposeViewAdapter this$0) {
        Throwable cause;
        try {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit init$lambda$2$0$1$0(ComposeViewAdapter this$0) throws Throwable {
    ...
    private final void init(AttributeSet attrs) {
        ...
        Class<? extends PreviewParameterProvider<?>> clsAsPreviewProviderClass = attributeValue != null ? PreviewUtils_androidKt.asPreviewProviderClass(attributeValue) : null;
        try {
        ...
        init$ui_tooling$default(this, className, methodName, clsAsPreviewProviderClass, parameterProviderIndex, attributeBooleanValue, attributeBooleanValue2, animationClockStartTime, attributeBooleanValue3, methodName2, null, null, 1536, null);
    }
}
