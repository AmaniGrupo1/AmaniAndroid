...
public final class TransitionClock<T> implements ComposeAnimationClock<TransitionBasedAnimation<T>, TargetState<T>> {
    ...
    private TargetState<T> state = new TargetState<>(getAnimation().m7425getAnimationObject().getCurrentState(), getAnimation().m7425getAnimationObject().getTargetState());
    ...
    public List<ComposeAnimatedProperty> getAnimatedProperties() {
        Iterable $this$mapNotNull$iv = Utils_androidKt.allAnimations(getAnimation().m7425getAnimationObject());
    ...
    public long getMaxDurationPerIteration() {
        return Utils_androidKt.nanosToMillis(getAnimation().m7425getAnimationObject().getTotalDurationNanos());
    }
    ...
    public List<TransitionInfo> getTransitions(long stepMillis) {
        Iterable $this$map$iv = Utils_androidKt.allAnimations(getAnimation().m7425getAnimationObject());
    ...
    public void setClockTime(long animationTimeNanos) {
        ...
        getAnimation().m7425getAnimationObject().seek(getState().getInitial(), getState().getTarget(), animationTimeNanos);
    }
}
