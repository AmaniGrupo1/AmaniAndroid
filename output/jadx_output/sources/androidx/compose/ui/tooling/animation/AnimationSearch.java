...
public final class AnimationSearch {
    ...
    private final TransitionSearch transitionSearch = new TransitionSearch(new Function1() { // from class: androidx.compose.ui.tooling.animation.AnimationSearch$$ExternalSyntheticLambda4
        ...
        public final Object invoke(Object obj) {
            return AnimationSearch.transitionSearch$lambda$0(this.f$0, (Transition) obj);
        }
    });
    private final AnimatedContentSearch animatedContentSearch = new AnimatedContentSearch(new Function1() { // from class: androidx.compose.ui.tooling.animation.AnimationSearch$$ExternalSyntheticLambda5
        @Override // kotlin.jvm.functions.Function1
        public final Object invoke(Object obj) {
            return AnimationSearch.animatedContentSearch$lambda$0(this.f$0, (Transition) obj);
        }
    });
    private final AnimatedVisibilitySearch animatedVisibilitySearch = new AnimatedVisibilitySearch(new Function1() { // from class: androidx.compose.ui.tooling.animation.AnimationSearch$$ExternalSyntheticLambda6
        @Override // kotlin.jvm.functions.Function1
        public final Object invoke(Object obj) {
            return AnimationSearch.animatedVisibilitySearch$lambda$0(this.f$0, (Transition) obj);
        }
    });
    ...
    static final Unit transitionSearch$lambda$0(AnimationSearch this$0, Transition it) {
        this$0.clock.invoke().trackTransition(it);
        return Unit.INSTANCE;
    }

    static final Unit animatedContentSearch$lambda$0(AnimationSearch this$0, Transition it) {
        this$0.clock.invoke().trackAnimatedContent(it);
        return Unit.INSTANCE;
    }

    static final Unit animatedVisibilitySearch$lambda$0(AnimationSearch this$0, Transition it) {
    ...
    private final Collection<AnimateXAsStateSearch> animateXAsStateSearch() {
        if (AnimateXAsStateComposeAnimation.INSTANCE.getApiAvailable()) {
            return SetsKt.setOf(new AnimateXAsStateSearch(new Function1() { // from class: androidx.compose.ui.tooling.animation.AnimationSearch$$ExternalSyntheticLambda7
                @Override // kotlin.jvm.functions.Function1
                public final Object invoke(Object obj) {
                    return AnimationSearch.animateXAsStateSearch$lambda$0(this.f$0, (AnimationSearch.AnimateXAsStateSearchInfo) obj);
                }
            }));
        }
    ...
    private final Set<InfiniteTransitionSearch> infiniteTransitionSearch() {
        if (InfiniteTransitionComposeAnimation.INSTANCE.getApiAvailable()) {
            return SetsKt.setOf(new InfiniteTransitionSearch(new Function1() { // from class: androidx.compose.ui.tooling.animation.AnimationSearch$$ExternalSyntheticLambda8
                @Override // kotlin.jvm.functions.Function1
                public final Object invoke(Object obj) {
                    return AnimationSearch.infiniteTransitionSearch$lambda$0(this.f$0, (AnimationSearch.InfiniteTransitionSearchInfo) obj);
                }
            }));
        }
    ...
    public final boolean searchAny(Collection<? extends Group> slotTrees) {
        ...
        for (Object element$iv : $this$any$iv) {
            ...
            List<Group> listFindAll = PreviewUtils_androidKt.findAll(tree, new Function1() { // from class: androidx.compose.ui.tooling.animation.AnimationSearch$$ExternalSyntheticLambda9
                @Override // kotlin.jvm.functions.Function1
                public final Object invoke(Object obj) {
    ...
    public static final class InfiniteTransitionSearch extends Search<InfiniteTransitionSearchInfo> {
        ...
        private final List<InfiniteTransitionSearchInfo> findAnimations(Collection<? extends Group> groups) {
            Object infiniteTransitionSearchInfo;
            Object obj;
            long j;
            ...
            ArrayList<CallGroup> arrayList4 = arrayList2;
            for (CallGroup callGroup : arrayList4) {
                CallGroup callGroup2 = callGroup;
                int i2 = i;
                Collection<Object> data = callGroup2.getData();
                Collection<Group> children = callGroup2.getChildren();
                ArrayList arrayList5 = arrayList2;
                ArrayList arrayList6 = new ArrayList();
                Iterator<T> it2 = children.iterator();
                while (it2.hasNext()) {
                    CollectionsKt.addAll(arrayList6, ((Group) it2.next()).getData());
                    arrayList4 = arrayList4;
                }
                ArrayList arrayList7 = arrayList4;
                List listPlus = CollectionsKt.plus((Collection) data, (Iterable) arrayList6);
                ...
                MutableState<State<Long>> mutableStateFindToolingOverride = findToolingOverride(callGroup);
                if (infiniteTransition != null && mutableStateFindToolingOverride != null) {
                    if (mutableStateFindToolingOverride.getValue() == null) {
                        j = 0;
                        mutableStateFindToolingOverride.setValue(new ToolingState(0L));
                    } else {
                        j = 0;
                    }
                    Object value = mutableStateFindToolingOverride.getValue();
                    infiniteTransitionSearchInfo = value instanceof ToolingState ? (ToolingState) value : null;
                    infiniteTransitionSearchInfo = new InfiniteTransitionSearchInfo(infiniteTransition, infiniteTransitionSearchInfo == null ? new ToolingState(Long.valueOf(j)) : infiniteTransitionSearchInfo);
                }
    ...
    /* JADX INFO: compiled from: AnimationSearch.android.kt */
    @Metadata(d1 = {"\u0000:\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\r\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u000e\n\u0000\b\u0087\b\u0018\u0000*\u0004\b\u0000\u0010\u0001*\b\b\u0001\u0010\u0002*\u00020\u00032\u00020\u0004B7\u0012\u0012\u0010\u0005\u001a\u000e\u0012\u0004\u0012\u00028\u0000\u0012\u0004\u0012\u00028\u00010\u0006\u0012\f\u0010\u0007\u001a\b\u0012\u0004\u0012\u00028\u00000\b\u0012\f\u0010\t\u001a\b\u0012\u0004\u0012\u00028\u00000\n¢\u0006\u0004\b\u000b\u0010\fJ\u0015\u0010\u0013\u001a\u000e\u0012\u0004\u0012\u00028\u0000\u0012\u0004\u0012\u00028\u00010\u0006HÆ\u0003J\u000f\u0010\u0014\u001a\b\u0012\u0004\u0012\u00028\u00000\bHÆ\u0003J\u000f\u0010\u0015\u001a\b\u0012\u0004\u0012\u00028\u00000\nHÆ\u0003JK\u0010\u0016\u001a\u000e\u0012\u0004\u0012\u00028\u0000\u0012\u0004\u0012\u00028\u00010\u00002\u0014\b\u0002\u0010\u0005\u001a\u000e\u0012\u0004\u0012\u00028\u0000\u0012\u0004\u0012\u00028\u00010\u00062\u000e\b\u0002\u0010\u0007\u001a\b\u0012\u0004\u0012\u00028\u00000\b2\u000e\b\u0002\u0010\t\u001a\b\u0012\u0004\u0012\u00028\u00000\nHÆ\u0001J\u0013\u0010\u0017\u001a\u00020\u00182\b\u0010\u0019\u001a\u0004\u0018\u00010\u0004HÖ\u0003J\t\u0010\u001a\u001a\u00020\u001bHÖ\u0001J\t\u0010\u001c\u001a\u00020\u001dHÖ\u0001R\u001d\u0010\u0005\u001a\u000e\u0012\u0004\u0012\u00028\u0000\u0012\u0004\u0012\u00028\u00010\u0006¢\u0006\b\n\u0000\u001a\u0004\b\r\u0010\u000eR\u0017\u0010\u0007\u001a\b\u0012\u0004\u0012\u00028\u00000\b¢\u0006\b\n\u0000\u001a\u0004\b\u000f\u0010\u0010R\u0017\u0010\t\u001a\b\u0012\u0004\u0012\u00028\u00000\n¢\u0006\b\n\u0000\u001a\u0004\b\u0011\u0010\u0012¨\u0006\u001e"}, d2 = {"Landroidx/compose/ui/tooling/animation/AnimationSearch$AnimateXAsStateSearchInfo;", ExifInterface.GPS_DIRECTION_TRUE, ExifInterface.GPS_MEASUREMENT_INTERRUPTED, "Landroidx/compose/animation/core/AnimationVector;", "", "animatable", "Landroidx/compose/animation/core/Animatable;", "animationSpec", "Landroidx/compose/animation/core/AnimationSpec;", "toolingState", "Landroidx/compose/ui/tooling/animation/ToolingState;", "<init>", "(Landroidx/compose/animation/core/Animatable;Landroidx/compose/animation/core/AnimationSpec;Landroidx/compose/ui/tooling/animation/ToolingState;)V", "getAnimatable", "()Landroidx/compose/animation/core/Animatable;", "getAnimationSpec", "()Landroidx/compose/animation/core/AnimationSpec;", "getToolingState", "()Landroidx/compose/ui/tooling/animation/ToolingState;", "component1", "component2", "component3", "copy", "equals", "", "other", "hashCode", "", "toString", "", "ui-tooling"}, k = 1, mv = {2, 0, 0}, xi = 48)
    ...
    public static final class AnimateXAsStateSearch extends Search<AnimateXAsStateSearchInfo<?, ?>> {
        ...
        private final <T> List<AnimateXAsStateSearchInfo<T, AnimationVector>> findAnimations(Collection<? extends Group> groups) {
            ...
            Iterator<T> it = groups.iterator();
            while (it.hasNext()) {
                CallGroup animationGroup = animateXAsStateSearch.toAnimationGroup((Group) it.next());
                if (animationGroup != null) {
                    arrayList2.add(animationGroup);
                }
            }
            ArrayList<CallGroup> arrayList3 = arrayList2;
            int i = 0;
            ArrayList arrayList4 = new ArrayList();
            for (CallGroup callGroup : arrayList3) {
                Animatable<T, AnimationVector> animatableFindAnimatable = animateXAsStateSearch.findAnimatable(callGroup);
                AnimationSpec<T> animationSpecFindAnimationSpec = animateXAsStateSearch.findAnimationSpec(callGroup);
                int i2 = i;
                MutableState<State<T>> mutableStateFindToolingOverride = animateXAsStateSearch.findToolingOverride(callGroup);
                if (animatableFindAnimatable == null || animationSpecFindAnimationSpec == null || mutableStateFindToolingOverride == null) {
                    arrayList = arrayList3;
                } else {
                    if (mutableStateFindToolingOverride.getValue() == null) {
                        arrayList = arrayList3;
                        mutableStateFindToolingOverride.setValue(new ToolingState(animatableFindAnimatable.getValue()));
                    } else {
                        arrayList = arrayList3;
                    }
                    Object value = mutableStateFindToolingOverride.getValue();
                    animateXAsStateSearchInfo = value instanceof ToolingState ? (ToolingState) value : null;
                    animateXAsStateSearchInfo = new AnimateXAsStateSearchInfo(animatableFindAnimatable, animationSpecFindAnimationSpec, animateXAsStateSearchInfo == null ? new ToolingState(animatableFindAnimatable.getValue()) : animateXAsStateSearchInfo);
                }
                if (animateXAsStateSearchInfo != null) {
                    arrayList4.add(animateXAsStateSearchInfo);
                }
