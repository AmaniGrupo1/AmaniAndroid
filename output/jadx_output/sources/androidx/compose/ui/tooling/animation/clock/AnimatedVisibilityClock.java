...
public final class AnimatedVisibilityClock implements ComposeAnimationClock<AnimatedVisibilityComposeAnimation, AnimatedVisibilityState> {
    ...
    public AnimatedVisibilityClock(AnimatedVisibilityComposeAnimation animation) {
        String strM7443getEnterjXw82LU;
        this.animation = animation;
        if (getAnimation().m7426getAnimationObject().getCurrentState().booleanValue()) {
            strM7443getEnterjXw82LU = AnimatedVisibilityState.INSTANCE.m7444getExitjXw82LU();
        } else {
            strM7443getEnterjXw82LU = AnimatedVisibilityState.INSTANCE.m7443getEnterjXw82LU();
        }
        this.state = strM7443getEnterjXw82LU;
    }
    ...
    public /* bridge */ /* synthetic */ ComposeAnimationState getState() {
        return AnimatedVisibilityState.m7436boximpl(getState());
    }

    @Override // androidx.compose.ui.tooling.animation.clock.ComposeAnimationClock
    public /* bridge */ /* synthetic */ void setState(ComposeAnimationState composeAnimationState) {
        m7435setState7IW2chM(((AnimatedVisibilityState) composeAnimationState).m7442unboximpl());
    }
    ...
    public void m7435setState7IW2chM(String str) {
        this.state = str;
    ...
    public void setStateParameters(Object par1, Object par2) {
        ...
        m7435setState7IW2chM(((AnimatedVisibilityState) par1).m7442unboximpl());
    }
    ...
    public void setClockTime(long animationTimeNanos) {
        ...
        Transition<Boolean> transitionM7426getAnimationObject = getAnimation().m7426getAnimationObject();
        Pair<Boolean, Boolean> pairM7433toCurrentTargetPair7IW2chM = m7433toCurrentTargetPair7IW2chM(getState());
        boolean current = pairM7433toCurrentTargetPair7IW2chM.component1().booleanValue();
        boolean target = pairM7433toCurrentTargetPair7IW2chM.component2().booleanValue();
        transitionM7426getAnimationObject.seek(Boolean.valueOf(current), Boolean.valueOf(target), animationTimeNanos);
    }
    ...
    private final Pair<Boolean, Boolean> m7433toCurrentTargetPair7IW2chM(String str) {
        return AnimatedVisibilityState.m7439equalsimpl0(str, AnimatedVisibilityState.INSTANCE.m7443getEnterjXw82LU()) ? TuplesKt.to(false, true) : TuplesKt.to(true, false);
    }
}
