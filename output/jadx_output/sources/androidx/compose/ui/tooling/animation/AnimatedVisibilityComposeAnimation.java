...
public final class AnimatedVisibilityComposeAnimation implements ComposeAnimation {
    ...
    private final Set<AnimatedVisibilityState> states = SetsKt.setOf((Object[]) new AnimatedVisibilityState[]{AnimatedVisibilityState.m7436boximpl(AnimatedVisibilityState.INSTANCE.m7443getEnterjXw82LU()), AnimatedVisibilityState.m7436boximpl(AnimatedVisibilityState.INSTANCE.m7444getExitjXw82LU())});
    ...
    public Transition<Boolean> m7426getAnimationObject() {
    ...
    public final Transition<Object> getChildTransition() {
        Object orNull = CollectionsKt.getOrNull(m7426getAnimationObject().getTransitions(), 0);
