...
public final class SlotTreeKt {
    ...
    public static final IntRect boundsOfLayoutNode(LayoutInfo node) {
        ...
        long size = coordinates.mo6149getSizeYbymL2g();
    ...
    */
    private static final List<ParameterInformation> extractFromIndyLambdaFields(List<Field> list, Object block, List<ParameterSourceInformation> list2) {
        boolean z;
        ...
        List sortedFields = CollectionsKt.sortedWith($this$sortedBy$iv, new Comparator() { // from class: androidx.compose.ui.tooling.data.SlotTreeKt$extractFromIndyLambdaFields$$inlined$sortedBy$1
            /* JADX WARN: Multi-variable type inference failed */
            @Override // java.util.Comparator
            public final int compare(T t, T t2) {
                Field it = (Field) t;
                Integer intOrNull = StringsKt.toIntOrNull(StringsKt.substringAfter$default(it.getName(), "f$", (String) null, 2, (Object) null));
                Integer numValueOf = Integer.valueOf(intOrNull != null ? intOrNull.intValue() : Integer.MAX_VALUE);
                Field it2 = (Field) t2;
                Integer intOrNull2 = StringsKt.toIntOrNull(StringsKt.substringAfter$default(it2.getName(), "f$", (String) null, 2, (Object) null));
                return ComparisonsKt.compareValues(numValueOf, Integer.valueOf(intOrNull2 != null ? intOrNull2.intValue() : Integer.MAX_VALUE));
            }
        });
        if (!list2.isEmpty()) {
            List<ParameterSourceInformation> $this$any$iv = list2;
            if (!($this$any$iv instanceof Collection) || !$this$any$iv.isEmpty()) {
                Iterator it = $this$any$iv.iterator();
                while (true) {
                    if (it.hasNext()) {
                        Object element$iv2 = it.next();
                        ParameterSourceInformation it2 = (ParameterSourceInformation) element$iv2;
                        if (it2.getName() != null) {
                            z2 = true;
                            break;
                        }
        ...
        boolean hasParameterNames = z;
        if (hasParameterNames) {
            iterableTake = CollectionsKt.take(sortedFields, list2.size());
        } else {
            iterableTake = sortedFields;
        }
        Iterable realFields = iterableTake;
        int changedIndex = hasParameterNames ? list2.size() : sortedFields.size();
        Field field = (Field) CollectionsKt.getOrNull(sortedFields, changedIndex);
        Object obj2 = field != null ? field.get(obj) : null;
        Integer num = obj2 instanceof Integer ? (Integer) obj2 : null;
        int changed = num != null ? num.intValue() : 0;
        Field field2 = (Field) CollectionsKt.getOrNull(sortedFields, changedIndex + 1);
        Object obj3 = field2 != null ? field2.get(obj) : null;
        Integer num2 = obj3 instanceof Integer ? (Integer) obj3 : null;
        int defaults = num2 != null ? num2.intValue() : 0;
        Iterable $this$mapIndexed$iv = realFields;
        ...
        for (Object item$iv$iv : $this$mapIndexed$iv) {
            ...
            List<ParameterSourceInformation> $this$firstOrNull$iv = list2;
            Iterator it3 = $this$firstOrNull$iv.iterator();
            while (true) {
                if (it3.hasNext()) {
                    element$iv = it3.next();
                    ParameterSourceInformation it4 = (ParameterSourceInformation) element$iv;
                    if (it4.getSortedIndex() == index$iv$iv) {
                        break;
                    }
                } else {
                    element$iv = null;
            ...
            destination$iv$iv.add(buildParameterInfo(field3, obj, index$iv$iv, defaults, changed, (ParameterSourceInformation) element$iv));
            obj = block;
    ...
    */
    private static final List<ParameterInformation> extractFromLegacyFields(List<Field> list, Object block, List<ParameterSourceInformation> list2) throws IllegalAccessException {
        ...
        if (!list2.isEmpty()) {
            ...
            if (!($this$any$iv instanceof Collection) || !$this$any$iv.isEmpty()) {
                ...
                while (true) {
                    ...
                    ParameterSourceInformation it2 = (ParameterSourceInformation) element$iv;
                    if (it2.getName() != null) {
                        z2 = true;
                        break;
                    }
        ...
        boolean hasParameterNames = z;
        if (hasParameterNames) {
            List<ParameterSourceInformation> $this$sortedBy$iv = list2;
            listSortedWith = CollectionsKt.sortedWith($this$sortedBy$iv, new Comparator() { // from class: androidx.compose.ui.tooling.data.SlotTreeKt$extractFromLegacyFields$$inlined$sortedBy$1
                /* JADX WARN: Multi-variable type inference failed */
                @Override // java.util.Comparator
                public final int compare(T t, T t2) {
                    ParameterSourceInformation it3 = (ParameterSourceInformation) t;
                    ParameterSourceInformation it4 = (ParameterSourceInformation) t2;
        ...
        List<ParameterSourceInformation> list3 = listSortedWith;
        List<Field> $this$sortedBy$iv2 = list;
        List listSortedWith2 = CollectionsKt.sortedWith($this$sortedBy$iv2, new Comparator() { // from class: androidx.compose.ui.tooling.data.SlotTreeKt$extractFromLegacyFields$$inlined$sortedBy$2
            /* JADX WARN: Multi-variable type inference failed */
            @Override // java.util.Comparator
            public final int compare(T t, T t2) {
                Field it3 = (Field) t;
                Field it4 = (Field) t2;
                return ComparisonsKt.compareValues(SlotTreeKt.extractFromLegacyFields$extractedName(it3), SlotTreeKt.extractFromLegacyFields$extractedName(it4));
            }
        });
        List $this$mapIndexedNotNull$iv = listSortedWith2;
        ...
        for (Object item$iv$iv$iv : $this$mapIndexedNotNull$iv) {
            ...
            ParameterSourceInformation paramMeta = (ParameterSourceInformation) CollectionsKt.getOrNull(list3, index$iv$iv);
            if (paramMeta == null) {
                paramMeta = new ParameterSourceInformation(index$iv$iv, null, null, 6, null);
            }
            int sortedIndex = paramMeta.getSortedIndex();
            if (sortedIndex >= list.size()) {
                parameterInformationBuildParameterInfo = null;
            } else {
                Field field = (Field) listSortedWith2.get(sortedIndex);
                if (paramMeta.getName() == null) {
                    index = index$iv$iv;
                    paramMeta = new ParameterSourceInformation(sortedIndex, extractFromLegacyFields$extractedName(field), paramMeta.getInlineClass());
                } else {
                    index = index$iv$iv;
                }
                parameterInformationBuildParameterInfo = buildParameterInfo(field, block, index, defaults, changed, paramMeta);
            }
