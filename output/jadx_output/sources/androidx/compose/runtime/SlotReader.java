...
public final class SlotReader {
    ...
    public final boolean hasObjectKey(int index) {
        ...
        return ($this$hasObjectKey$iv[(index * 5) + 1] & C.BUFFER_FLAG_LAST_SAMPLE) != 0;
    }
    ...
    public final boolean getHasObjectKey() {
        ...
        int[] $this$hasObjectKey$iv = this.groups;
        int address$iv = this.current;
        return ($this$hasObjectKey$iv[(address$iv * 5) + 1] & C.BUFFER_FLAG_LAST_SAMPLE) != 0;
    }
    ...
    public final boolean hasMark(int index) {
        ...
        return ($this$hasMark$iv[(index * 5) + 1] & C.BUFFER_FLAG_FIRST_SAMPLE) != 0;
    }
    ...
    private final Object objectKey(int[] $this$objectKey, int index) {
        if (($this$objectKey[(index * 5) + 1] & C.BUFFER_FLAG_LAST_SAMPLE) != 0) {
