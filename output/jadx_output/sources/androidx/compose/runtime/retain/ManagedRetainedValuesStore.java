...
public final class ManagedRetainedValuesStore implements RetainedValuesStore {
    ...
    private final MutableScatterMap<Object, Object> keptExitedValues = SafeMultiValueMap.m4119constructorimpl$default(null, 1, null);
    ...
    public void onContentExitComposition() {
        ...
        boolean value$iv2 = SafeMultiValueMap.m4126isEmptyimpl(this.keptExitedValues);
        if (!value$iv2) {
    ...
    private final void purgeUnusedExitedValues() {
        ...
        int i2 = 0;
        MutableScatterMap this_$iv$iv3 = mutableScatterMap;
        ...
        SafeMultiValueMap.m4117clearimpl(this.keptExitedValues);
    }

    @Override // androidx.compose.runtime.retain.RetainedValuesStore
    public Object consumeExitedValueOrDefault(Object key, Object defaultValue) {
        return SafeMultiValueMap.m4130removeLastimpl(this.keptExitedValues, key, defaultValue);
    }

    @Override // androidx.compose.runtime.retain.RetainedValuesStore
    public void saveExitingValue(Object key, Object value) {
        if (isRetainingExitedValues()) {
            SafeMultiValueMap.m4115addimpl(this.keptExitedValues, key, value);
