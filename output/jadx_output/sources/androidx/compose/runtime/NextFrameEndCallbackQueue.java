...
public final class NextFrameEndCallbackQueue {
    ...
    private final AtomicInt isFrameOngoing = AtomicBoolean.m4103constructorimpl(false);
    ...
    static final Unit onNewAwaiters$lambda$0(NextFrameEndCallbackQueue this$0, Function0 $onNewAwaiters) {
        if (!AtomicBoolean.m4107getimpl(this$0.isFrameOngoing)) {
    ...
    public final void markFrameStarted() {
        AtomicBoolean.m4110setimpl(this.isFrameOngoing, true);
    }

    public final void markFrameComplete() {
        AtomicBoolean.m4110setimpl(this.isFrameOngoing, false);
