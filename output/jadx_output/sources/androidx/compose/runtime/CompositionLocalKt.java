...
public final class CompositionLocalKt {
    ...
    public static final void CompositionLocalProvider(final ProvidedValue<?>[] providedValueArr, final Function2<? super Composer, ? super Integer, Unit> function2, Composer $composer, final int $changed) {
        ...
        ComposerKt.sourceInformation($composer2, "C(CompositionLocalProvider)N(values,content)377@17073L9:CompositionLocal.kt#9igjgp");
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(415205898, $changed, -1, "androidx.compose.runtime.CompositionLocalProvider (CompositionLocal.kt:375)");
        }
    ...
    public static final void CompositionLocalProvider(final ProvidedValue<?> providedValue, final Function2<? super Composer, ? super Integer, Unit> function2, Composer $composer, final int $changed) {
        ...
        ComposerKt.sourceInformation($composer2, "C(CompositionLocalProvider)N(value,content)397@17814L9:CompositionLocal.kt#9igjgp");
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-149765515, $changed, -1, "androidx.compose.runtime.CompositionLocalProvider (CompositionLocal.kt:395)");
        }
    ...
    public static final void CompositionLocalProvider(final CompositionLocalContext context, final Function2<? super Composer, ? super Integer, Unit> function2, Composer $composer, final int $changed) {
        ...
        ComposerKt.sourceInformation($composer2, "C(CompositionLocalProvider)N(context,content)417@18471L145:CompositionLocal.kt#9igjgp");
        int $dirty = $changed;
        if (($changed & 6) == 0) {
        ...
        if ($composer2.shouldExecute(($dirty & 19) != 18, $dirty & 1)) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1162003659, $dirty, -1, "androidx.compose.runtime.CompositionLocalProvider (CompositionLocal.kt:416)");
            }
