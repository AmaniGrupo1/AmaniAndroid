...
public final class SnapshotKt {
    ...
    */
    public static final <T> T advanceGlobalSnapshot(Function1<? super SnapshotIdSet, ? extends T> function1) throws Throwable {
        GlobalSnapshot globalSnapshot2 = globalSnapshot;
        synchronized (getLock()) {
            try {
                MutableScatterSet<StateObject> modified$runtime = globalSnapshot2.getModified$runtime();
                if (modified$runtime != null) {
                    ...
                    T t2 = (T) resetGlobalSnapshotLocked(globalSnapshot2, function1);
                    if (modified$runtime != null) {
                    }
                    MutableScatterSet mutableScatterSet5 = null;
                    synchronized (getLock()) {
                    }
                }
            } catch (Throwable th5) {
    ...
    public static final <T extends StateRecord> T writableRecord(T t, StateObject stateObject, Snapshot snapshot) {
        ...
        if (snapshot.getReadOnly()) {
            snapshot.mo4144recordModified$runtime(stateObject);
        }
    ...
    */
    public static final SnapshotIdSet addRange(SnapshotIdSet $this$addRange, long from, long until) {
        ...
        long invalidId = from;
        while (Intrinsics.compare($this$compareTo$iv, until) < 0) {
            result = result.set(invalidId);
            long $this$plus$iv = invalidId;
            invalidId = $this$plus$iv + ((long) 1);
        }
        return result;
    }
}
