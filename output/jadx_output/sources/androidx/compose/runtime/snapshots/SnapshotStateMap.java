    ...
    public V put(K key, V value) {
        ...
        do {
            ...
            synchronized (lock$iv$iv$iv$iv$iv) {
                ...
                zAttemptUpdate = attemptUpdate($this$mutate_u24lambda_u241$iv, currentModification$iv, persistentMapBuild);
            }
            SnapshotKt.notifyWrite(current, state$iv$iv$iv);
        ...
        while (true) {
            ...
            synchronized (lock$iv$iv$iv$iv$iv) {
                try {
                    ...
                    int $i$f$removeIf$runtime2 = $i$f$removeIf$runtime;
                    try {
                        ...
                        boolean zAttemptUpdate = attemptUpdate($this$mutate_u24lambda_u241$iv, currentModification$iv, persistentMapBuild);
                        SnapshotKt.notifyWrite(current, state$iv$iv$iv);
                        if (zAttemptUpdate) {
                            break;
                        }
        ...
        while (true) {
            ...
            synchronized (lock$iv$iv$iv$iv) {
                try {
                    ...
                    StateMapStateRecord $this$mutate_u24lambda_u241 = (StateMapStateRecord) SnapshotKt.writableRecord($this$writable$iv$iv, state$iv$iv, current2);
                    int $i$f$mutate2 = $i$f$mutate;
                    try {
                        boolean zAttemptUpdate = attemptUpdate($this$mutate_u24lambda_u241, currentModification, persistentMapBuild);
