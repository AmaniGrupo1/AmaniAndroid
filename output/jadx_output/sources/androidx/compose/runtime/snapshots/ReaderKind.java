...
public final class ReaderKind {
    ...
    public static final /* synthetic */ ReaderKind m4145boximpl(int i) {
    ...
    public static boolean m4148equalsimpl(int i, Object obj) {
        return (obj instanceof ReaderKind) && i == ((ReaderKind) obj).m4154unboximpl();
    }
    ...
    public boolean equals(Object other) {
        return m4148equalsimpl(this.mask, other);
    }

    public int hashCode() {
        return m4150hashCodeimpl(this.mask);
    }

    public String toString() {
        return m4152toStringimpl(this.mask);
    }
    ...
    public static /* synthetic */ int m4147constructorimpl$default(int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        if ((i2 & 1) != 0) {
            i = 0;
        }
        return m4146constructorimpl(i);
    }
    ...
    public static final int m4153withReadIn3QSx2Dw(int i, int i2) {
        return m4146constructorimpl(i | i2);
    }

    /* JADX INFO: renamed from: isReadIn-h_f27i8, reason: not valid java name */
    public static final boolean m4151isReadInh_f27i8(int i, int i2) {
        return (i & i2) != 0;
    }
    ...
    public static final class Companion {
        ...
        public final int m4155getComposition6f8NoZ8() {
            return ReaderKind.m4146constructorimpl(1);
        }

        /* JADX INFO: renamed from: getSnapshotStateObserver-6f8NoZ8, reason: not valid java name */
        public final int m4157getSnapshotStateObserver6f8NoZ8() {
            return ReaderKind.m4146constructorimpl(2);
        }

        /* JADX INFO: renamed from: getSnapshotFlow-6f8NoZ8, reason: not valid java name */
        public final int m4156getSnapshotFlow6f8NoZ8() {
            return ReaderKind.m4146constructorimpl(4);
        }
    }
}
