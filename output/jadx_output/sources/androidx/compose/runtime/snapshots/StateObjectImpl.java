...
public abstract class StateObjectImpl implements StateObject {
    ...
    public final void m4159recordReadInh_f27i8$runtime(int reader) {
        int old;
        do {
            old = ReaderKind.m4146constructorimpl(this.readerKind.get());
            if ((old & reader) != 0) {
                return;
            }
        } while (!this.readerKind.compareAndSet(old, ReaderKind.m4146constructorimpl(old | reader)));
    }

    /* JADX INFO: renamed from: isReadIn-h_f27i8$runtime, reason: not valid java name */
    public final boolean m4158isReadInh_f27i8$runtime(int reader) {
        return (ReaderKind.m4146constructorimpl(this.readerKind.get()) & reader) != 0;
    }
}
