...
public abstract class Snapshot {
    ...
    public abstract void mo4142nestedActivated$runtime(Snapshot snapshot);

    /* JADX INFO: renamed from: nestedDeactivated$runtime */
    public abstract void mo4143nestedDeactivated$runtime(Snapshot snapshot);

    public abstract void notifyObjectsInitialized$runtime();

    /* JADX INFO: renamed from: recordModified$runtime */
    public abstract void mo4144recordModified$runtime(StateObject state);
            ...
            if (previous instanceof TransparentObserverMutableSnapshot) {
                ...
                if ($this$canBeReused$iv.getThreadId() == Thread_jvmKt.currentThreadId()) {
                    ...
                    if (previous instanceof TransparentObserverSnapshot) {
                        TransparentObserverSnapshot $this$canBeReused$iv2 = (TransparentObserverSnapshot) previous;
                        if ($this$canBeReused$iv2.getThreadId$runtime() == Thread_jvmKt.currentThreadId()) {
