...
public final class SnapshotStateListKt {
    ...
    public static final <T> boolean mutateBoolean(SnapshotStateList<T> snapshotStateList, Function1<? super List<T>, Boolean> function1) throws Throwable {
        ...
        SnapshotStateList $this$mutate$iv2 = snapshotStateList;
        while (true) {
            ...
            SnapshotStateList snapshotStateList2 = $this$mutate$iv2;
    ...
    public static final <R, T> R mutate(SnapshotStateList<T> snapshotStateList, Function1<? super List<T>, ? extends R> function1) throws Throwable {
        ...
        R rInvoke;
        Snapshot current;
        StateListStateRecord $this$mutate_u24lambda_u241;
        int $i$f$mutate;
        int $i$f$mutate2 = 0;
        while (true) {
            Object lock$iv = sync;
            ...
            synchronized (lock$iv$iv$iv$iv) {
                try {
                    current = Snapshot.INSTANCE.getCurrent();
                    $this$mutate_u24lambda_u241 = (StateListStateRecord) SnapshotKt.writableRecord($this$writable$iv$iv, state$iv$iv, current);
    ...
    public static /* synthetic */ void update$default(SnapshotStateList $this$update_u24default, boolean structural, Function1 block, int i, Object obj) throws Throwable {
        ...
        int $i$f$update = 0;
        boolean structural$iv = structural2;
        while (true) {
            Object lock$iv$iv = sync;
            synchronized (lock$iv$iv) {
                try {
            ...
            synchronized (lock$iv$iv$iv$iv$iv) {
                try {
                    ...
                    boolean structural3 = structural2;
        ...
        while (true) {
            ...
            synchronized (lock$iv$iv$iv$iv) {
                try {
                    ...
                    StateListStateRecord $this$conditionalUpdate_u24lambda_u240_u241 = (StateListStateRecord) SnapshotKt.writableRecord($this$writable$iv$iv, state$iv$iv, current2);
