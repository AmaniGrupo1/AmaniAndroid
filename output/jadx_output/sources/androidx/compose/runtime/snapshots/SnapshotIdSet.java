...
public final class SnapshotIdSet implements Iterable<Long>, KMappedMarker {
            ...
            if (other$iv3 < 0) {
                ...
                if (other$iv4 >= 0) {
                    ...
                    if (other$iv5 < 0) {
                        ...
                        if (other$iv6 < 0) {
                            long[] array2 = this.belowBound;
                            if (array2 == null) {
                                return new SnapshotIdSet(this.upperSet, this.lowerSet, this.lowerBound, new long[]{id});
                            }
                            int location = SnapshotId_jvmKt.binarySearch(array2, id);
                            if (location < 0) {
                                int insertLocation = -(location + 1);
                                long[] newBelowBound = SnapshotId_jvmKt.withIdInsertedAt(array2, insertLocation, id);
                            ...
                            long $this$div$iv = id + ((long) 1);
                            long $this$times$iv = $this$div$iv / ((long) 64);
                            long it = $this$times$iv * ((long) 64);
                            if (Intrinsics.compare(it, 0) < 0) {
                                long $this$plus$iv = Long.MAX_VALUE - ((long) 128);
                                it = $this$plus$iv + ((long) 1);
                            }
                            long newUpperSet2 = newUpperSet;
                            while (true) {
                                long other$iv7 = it;
                                long $this$compareTo$iv = newLowerBound4;
                                if (Intrinsics.compare($this$compareTo$iv, other$iv7) >= 0) {
                                ...
                                if (newLowerSet2 != 0) {
                                    ...
                                    while (i < 64) {
                                        ...
                                        if (((1 << bitOffset) & newLowerSet2) != 0) {
                                            ...
                                            snapshotIdArrayBuilder.add($this$plus$iv2 + ((long) bitOffset));
                                        } else {
                                            newLowerBound3 = newLowerBound4;
                                        }
                                        i++;
                                ...
                                if (newUpperSet2 == 0) {
                                    long newLowerBound5 = it;
                                    newLowerBound = newLowerBound5;
                                    newLowerSet = 0;
                                    break;
                                }
                                ...
                                newLowerBound4 = $this$plus$iv3 + ((long) 64);
                            }
                            if (snapshotIdArrayBuilder == null || (array = snapshotIdArrayBuilder.toArray()) == null) {
                                array = this.belowBound;
                            }
                            return new SnapshotIdSet(newUpperSet2, newLowerSet, newLowerBound, array).set(id);
                        }
                    }
                }
            }
    ...
    */
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    long[] $this$forEach$iv2 = SnapshotIdSet.this.belowBound;
                    if ($this$forEach$iv2 != null) {
                        ...
                        if (i < $i$f$forEach) {
                            long it = $this$forEach$iv[i];
                            Long lBoxLong = Boxing.boxLong(it);
                            anonymousClass1.L$0 = $this$sequence;
                            anonymousClass1.L$1 = $this$forEach$iv;
                            anonymousClass1.I$0 = i;
                            anonymousClass1.I$1 = $i$f$forEach;
                            anonymousClass1.label = 1;
                            if ($this$sequence.yield(lBoxLong, anonymousClass1) == coroutine_suspended) {
                            ...
                            if (i < $i$f$forEach) {
                                ...
                                if (SnapshotIdSet.this.lowerSet != 0) {
                                    j2 = 0;
                                    if (SnapshotIdSet.this.upperSet != j2) {
                                    }
                                    return Unit.INSTANCE;
                                }
                                SequenceScope sequenceScope = $this$sequence4;
                                index = 0;
                                ...
                                if (index >= 64) {
                                    ...
                                    if (SnapshotIdSet.this.upperSet != j2) {
                                        SequenceScope sequenceScope2 = $this$sequence4;
                                        index2 = 0;
                                        anonymousClass13 = anonymousClass1;
                                        $this$sequence3 = sequenceScope2;
                                        if (index2 < 64) {
                                            if ((SnapshotIdSet.this.upperSet & (j << index2)) != j2) {
                                                long $this$plus$iv = SnapshotIdSet.this.lowerBound;
                                                int other$iv = index2;
                                                anonymousClass13.L$0 = $this$sequence3;
                                                anonymousClass13.L$1 = null;
                                                anonymousClass13.I$0 = index2;
                                                anonymousClass13.label = 3;
                                                if ($this$sequence3.yield(Boxing.boxLong($this$plus$iv + ((long) other$iv) + ((long) 64)), anonymousClass13) == coroutine_suspended) {
                                                    return coroutine_suspended;
                                                }
                                            }
                                            index2++;
                                ...
                                if ((SnapshotIdSet.this.lowerSet & (j << index)) != j4) {
                                    long $this$plus$iv2 = SnapshotIdSet.this.lowerBound;
                                    int other$iv2 = index;
                                    j3 = j4;
                                    anonymousClass1.L$0 = $this$sequence2;
                                    anonymousClass1.L$1 = null;
                                    anonymousClass1.I$0 = index;
                                    anonymousClass1.label = 2;
                                    if ($this$sequence2.yield(Boxing.boxLong($this$plus$iv2 + ((long) other$iv2)), anonymousClass1) == coroutine_suspended) {
                                        return coroutine_suspended;
                                    }
                                } else {
                                    j3 = j4;
                    ...
                    break;
                case 1:
                    $i$f$forEach = this.I$1;
                    i = this.I$0;
                    $this$forEach$iv = (long[]) this.L$1;
                ...
                case 2:
                    index = this.I$0;
                    SequenceScope $this$sequence5 = (SequenceScope) this.L$0;
                    ResultKt.throwOnFailure($result);
                    j3 = 0;
                ...
                case 3:
                    index2 = this.I$0;
                    $this$sequence3 = (SequenceScope) this.L$0;
                    ResultKt.throwOnFailure($result);
    ...
    public String toString() {
        ...
        return sbAppend.append(ListUtilsKt.fastJoinToString$default((List) destination$iv$iv, null, null, null, 0, null, null, 63, null)).append(AbstractJsonLexerKt.END_LIST).toString();
    }
