...
public final class Operations extends OperationsDebugStringFormattable {
    ...
    public final void push(Operation operation, Function1<? super WriteScope, Unit> args) {
        pushOp(operation);
        args.invoke(WriteScope.m4028boximpl(WriteScope.m4029constructorimpl(this)));
    ...
    private final String exceptionMessageForOperationPushWithScope(Operation operation) {
        ...
        while (i2 < objects) {
            ...
            if ((this.pushedObjectMask & (i << arg2)) == 0) {
                ...
                $this$exceptionMessageForOperationPushWithScope_u24lambda_u241.append(operation.mo3980objectParamName31yXWZQ(Operation.ObjectParameter.m4006constructorimpl(arg2)));
                missingObjectCount++;
            }
            i2++;
            i = 1;
    ...
    public static final class WriteScope {
        ...
        public static final Operation m4032getOperationimpl(Operations operations) {
            return operations.opCodes[operations.opCodesSize - 1];
        }

        /* JADX INFO: renamed from: setInt-impl, reason: not valid java name */
        public static final void m4034setIntimpl(Operations operations, int parameter, int value) {
            operations.intArgs[(operations.intArgsSize - operations.opCodes[operations.opCodesSize - 1].getInts()) + parameter] = value;
        }

        /* JADX INFO: renamed from: setInts-impl, reason: not valid java name */
        public static final void m4035setIntsimpl(Operations operations, int parameter1, int value1, int parameter2, int value2) {
            int base = operations.intArgsSize - operations.opCodes[operations.opCodesSize - 1].getInts();
            int[] intArgs = operations.intArgs;
            intArgs[base + parameter1] = value1;
            intArgs[base + parameter2] = value2;
        }

        /* JADX INFO: renamed from: setInts-impl, reason: not valid java name */
        public static final void m4036setIntsimpl(Operations operations, int parameter1, int value1, int parameter2, int value2, int parameter3, int value3) {
            int base = operations.intArgsSize - operations.opCodes[operations.opCodesSize - 1].getInts();
            int[] intArgs = operations.intArgs;
            intArgs[base + parameter1] = value1;
            intArgs[base + parameter2] = value2;
        ...
        public static final <T> void m4037setObjectDKhxnng(Operations operations, int i, T t) {
        ...
        public static final <T, U> void m4038setObjects4uCC6AY(Operations operations, int i, T t, int i2, U u) {
            int base = operations.objectArgsSize - operations.opCodes[operations.opCodesSize - 1].getObjects();
            Object[] objectArgs = operations.objectArgs;
            objectArgs[base + i] = t;
            objectArgs[base + i2] = u;
        }

        /* JADX INFO: renamed from: setObjects-t7hvbck, reason: not valid java name */
        public static final <T, U, V> void m4040setObjectst7hvbck(Operations operations, int i, T t, int i2, U u, int i3, V v) {
            int base = operations.objectArgsSize - operations.opCodes[operations.opCodesSize - 1].getObjects();
            Object[] objectArgs = operations.objectArgs;
            objectArgs[base + i] = t;
            objectArgs[base + i2] = u;
            objectArgs[base + i3] = v;
        }

        /* JADX INFO: renamed from: setObjects-OGa0p1M, reason: not valid java name */
        public static final <T, U, V, W> void m4039setObjectsOGa0p1M(Operations operations, int i, T t, int i2, U u, int i3, V v, int i4, W w) {
            int base = operations.objectArgsSize - operations.opCodes[operations.opCodesSize - 1].getObjects();
            Object[] objectArgs = operations.objectArgs;
            objectArgs[base + i] = t;
            objectArgs[base + i2] = u;
            objectArgs[base + i3] = v;
            objectArgs[base + i4] = w;
        }
    }
    ...
    public final class OpIterator implements OperationArgContainer {
        ...
        public <T> T mo4026getObject31yXWZQ(int parameter) {
        ...
        public final String currentOperationDebugString() {
            ...
            String string = $this$currentOperationDebugString_u24lambda_u240.toString();
    ...
    public String toDebugString(String linePrefix) {
        ...
        if (isNotEmpty()) {
            ...
            while (true) {
                ...
                StringBuilder sbAppend = $this$toDebugString_u24lambda_u240.append(currentOpToDebugString(iterator$iv, linePrefix));
    ...
    public final String currentOpToDebugString(OpIterator $this$currentOpToDebugString, String linePrefix) {
        ...
        for (int i2 = 0; i2 < ints; i2++) {
            ...
            Intrinsics.checkNotNullExpressionValue($this$currentOpToDebugString_u24lambda_u240.append('\n'), "append(...)");
        ...
        while (offset2 < objects) {
            ...
            int param = Operation.ObjectParameter.m4006constructorimpl(offset2);
            int i3 = i;
            String name2 = operation.mo3980objectParamName31yXWZQ(param);
            if (isFirstParam) {
                isFirstParam = false;
            } else {
                $this$currentOpToDebugString_u24lambda_u240.append(", ");
            ...
            $this$currentOpToDebugString_u24lambda_u240.append(" = ");
            $this$currentOpToDebugString_u24lambda_u240.append(formatOpArgumentToString($this$currentOpToDebugString.mo4026getObject31yXWZQ(param), argLinePrefix));
            offset2++;
        ...
        $this$currentOpToDebugString_u24lambda_u240.append(")");
        String string = $this$currentOpToDebugString_u24lambda_u240.toString();
        Intrinsics.checkNotNullExpressionValue(string, "toString(...)");
        return string;
    }
