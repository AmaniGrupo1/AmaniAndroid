...
public final class OperationKt {
    ...
    private static final void withCurrentStackTrace(OperationErrorContext errorContext, SlotWriter writer, Anchor location, Function0<Unit> function0) throws Throwable {
        try {
            function0.invoke();
        } catch (Throwable e) {
    ...
    static final ComposeStackTrace attachComposeStackTrace$lambda$0(Anchor $anchor, SlotWriter $writer, OperationErrorContext $errorContext) {
        ...
        return new ComposeStackTrace(CollectionsKt.plus((Collection) trace, (Iterable) listPlus));
    }
