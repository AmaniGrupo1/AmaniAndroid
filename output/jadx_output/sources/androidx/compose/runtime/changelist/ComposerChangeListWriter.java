...
public final class ComposerChangeListWriter {
    ...
    private final ArrayList<Object> pendingDownNodes = Stack.m3952constructorimpl$default(null, 1, null);
    ...
    public final void moveUp() {
        realizeNodeMovementOperations();
        if (Stack.m3958isNotEmptyimpl(this.pendingDownNodes)) {
            Stack.m3961popimpl(this.pendingDownNodes);
            return;
        }
    ...
    public final void moveDown(Object node) {
        realizeNodeMovementOperations();
        Stack.m3962pushimpl(this.pendingDownNodes, node);
    }
    ...
    private final void pushPendingUpsAndDowns() {
        ...
        if (Stack.m3958isNotEmptyimpl(this.pendingDownNodes)) {
            this.changeList.pushDowns(Stack.m3963toArrayimpl(this.pendingDownNodes));
            Stack.m3950clearimpl(this.pendingDownNodes);
        }
    }
