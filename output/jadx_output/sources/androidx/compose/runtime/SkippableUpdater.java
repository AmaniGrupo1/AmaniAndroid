...
public final class SkippableUpdater<T> {
    ...
    public static final /* synthetic */ SkippableUpdater m3940boximpl(Composer composer) {
        return new SkippableUpdater(composer);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static <T> Composer m3941constructorimpl(Composer composer) {
        return composer;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m3942equalsimpl(Composer composer, Object obj) {
        return (obj instanceof SkippableUpdater) && Intrinsics.areEqual(composer, ((SkippableUpdater) obj).getComposer());
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m3943equalsimpl0(Composer composer, Composer composer2) {
    ...
    public static int m3944hashCodeimpl(Composer composer) {
        return composer.hashCode();
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m3945toStringimpl(Composer composer) {
        return "SkippableUpdater(composer=" + composer + ')';
    }

    public boolean equals(Object other) {
        return m3942equalsimpl(this.composer, other);
    }

    public int hashCode() {
        return m3944hashCodeimpl(this.composer);
    }

    public String toString() {
        return m3945toStringimpl(this.composer);
    }
    ...
    public static final void m3946updateimpl(Composer composer, Function1<? super Updater<T>, Unit> function1) {
