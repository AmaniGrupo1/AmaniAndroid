...
public final class SlotWriter {
    ...
    public final Object groupObjectKey(int index) {
        ...
        if (($this$hasObjectKey$iv[(address * 5) + 1] & C.BUFFER_FLAG_LAST_SAMPLE) != 0) {
    ...
    public final boolean hasObjectKey(int index) {
        int address = groupIndexToAddress(index);
        int[] $this$hasObjectKey$iv = this.groups;
        return ($this$hasObjectKey$iv[(address * 5) + 1] & C.BUFFER_FLAG_LAST_SAMPLE) != 0;
    }
    ...
    private final void startGroup(int key, Object objectKey, boolean isNode, Object aux) {
        ...
        if (objArr != false) {
            ...
            if (i2 >= 0 && (groupSourceInformationSourceInformationOf$runtime = sourceInformationOf$runtime(i2)) != null) {
                groupSourceInformationSourceInformationOf$runtime.reportGroup(this, i3);
            }
        } else {
    ...
    public final boolean removeGroup() {
        ...
        if (it != null) {
            while (PrioritySet.m3934isNotEmptyimpl(it) && PrioritySet.m3935peekimpl(it) >= oldGroup) {
                PrioritySet.m3936takeMaximpl(it);
            }
        }
    ...
    public final void forAllDataInRememberOrder(int group, Function2<? super Integer, Object, Unit> block) {
        ...
        while (current$iv < end$iv2) {
            ...
            while (slotIndex < iDataIndex) {
                ...
                if ((value instanceof RememberObserverHolder) && (after = ((RememberObserverHolder) value).getAfterGroupIndex()) >= 0) {
    ...
    private final int childGroupAtIndex(int parent, int index) {
        ...
        while (childGroup < end && current < index) {
            ...
            if (childGroup < end) {
                int[] $this$hasObjectKey$iv = this.groups;
                if (!(($this$hasObjectKey$iv[(childAddress * 5) + 1] & C.BUFFER_FLAG_LAST_SAMPLE) != 0)) {
                    current++;
                }
            }
        }
        ...
        public final List<Anchor> moveGroup(SlotWriter fromWriter, int fromIndex, SlotWriter toWriter, boolean updateFromCursor, boolean updateToCursor, boolean removeSourceGroup) {
            ...
            if (!arrayListEmptyList.isEmpty()) {
                ...
                if (sourceSourceInformationMap2 == null || destinationSourceInformation == null) {
                    ...
                    List<Anchor> list2 = arrayListEmptyList;
                    list = arrayListEmptyList;
                    int size = list2.size();
                    int startAnchors2 = 0;
    ...
    */
    public final List<Anchor> moveIntoGroupFrom(int offset, SlotTable table, int index) throws Throwable {
        boolean value$iv;
        boolean normalClose$iv;
        if (this.insertCount <= 0) {
            value$iv = groupSize(this.currentGroup + offset) == 1;
        }
        boolean value$iv$iv = value$iv;
        if (!value$iv$iv) {
            ComposerKt.composeImmediateRuntimeError("Check failed");
    ...
    public final void markGroup(int group) {
        ...
        if (!(($this$hasMark$iv[(groupAddress * 5) + 1] & C.BUFFER_FLAG_FIRST_SAMPLE) != 0)) {
    ...
    private final void recalculateMarks() {
        ...
        if (set != null) {
            while (PrioritySet.m3934isNotEmptyimpl(set)) {
                m3948updateContainsMarkNowXpTMRCE(PrioritySet.m3936takeMaximpl(set), set);
            }
        }
    }
    ...
    public final void updateContainsMark(int group) {
        if (group >= 0) {
            MutableIntList it = this.pendingRecalculateMarks;
            if (it == null) {
                it = PrioritySet.m3929constructorimpl$default(null, 1, null);
                this.pendingRecalculateMarks = it;
            }
            PrioritySet.m3926addimpl(it, group);
        }
    }

    /* JADX INFO: renamed from: updateContainsMarkNow-XpTMRCE, reason: not valid java name */
    private final void m3948updateContainsMarkNowXpTMRCE(int group, MutableIntList set) {
        int groupAddress = groupIndexToAddress(group);
        ...
        if (markChanges) {
            ...
            if (parent >= 0) {
                PrioritySet.m3926addimpl(set, parent);
            }
        }
    }
    ...
    public final String toDebugString() {
        ...
        StringBuilder sbAppend = $this$toDebugString_u24lambda_u240.append(toString());
        Intrinsics.checkNotNullExpressionValue(sbAppend, "append(...)");
        Intrinsics.checkNotNullExpressionValue(sbAppend.append('\n'), "append(...)");
        StringBuilder sbAppend2 = $this$toDebugString_u24lambda_u240.append("  parent:    " + this.parent);
        Intrinsics.checkNotNullExpressionValue(sbAppend2, "append(...)");
        Intrinsics.checkNotNullExpressionValue(sbAppend2.append('\n'), "append(...)");
        StringBuilder sbAppend3 = $this$toDebugString_u24lambda_u240.append("  current:   " + this.currentGroup);
        Intrinsics.checkNotNullExpressionValue(sbAppend3, "append(...)");
        Intrinsics.checkNotNullExpressionValue(sbAppend3.append('\n'), "append(...)");
        StringBuilder sbAppend4 = $this$toDebugString_u24lambda_u240.append("  group gap: " + this.groupGapStart + '-' + (this.groupGapStart + this.groupGapLen) + '(' + this.groupGapLen + ')');
        Intrinsics.checkNotNullExpressionValue(sbAppend4, "append(...)");
        Intrinsics.checkNotNullExpressionValue(sbAppend4.append('\n'), "append(...)");
        StringBuilder sbAppend5 = $this$toDebugString_u24lambda_u240.append("  slots gap: " + this.slotsGapStart + '-' + (this.slotsGapStart + this.slotsGapLen) + '(' + this.slotsGapLen + ')');
        Intrinsics.checkNotNullExpressionValue(sbAppend5, "append(...)");
        Intrinsics.checkNotNullExpressionValue(sbAppend5.append('\n'), "append(...)");
        StringBuilder sbAppend6 = $this$toDebugString_u24lambda_u240.append("  gap owner: " + this.slotsGapOwner);
