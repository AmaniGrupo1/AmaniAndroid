...
public final class RememberSerializableKt {
    ...
    public static final /* synthetic */ <T> T m4139rememberSerializable(Object[] objArr, SavedStateConfiguration savedStateConfiguration, Function0<? extends T> function0, Composer composer, int i, int i2) {
        ...
        T t = (T) m4140rememberSerializable(objArrCopyOf, (KSerializer) SerializersKt.serializer(serializersModule, (KType) null), savedStateConfiguration2, (Function0) function0, composer, ((i << 3) & 896) | ((i << 3) & 7168), 0);
        ComposerKt.sourceInformationMarkerEnd(composer);
        return t;
    }

    /* JADX INFO: renamed from: rememberSerializable, reason: collision with other method in class */
    public static final <T> T m4140rememberSerializable(Object[] objArr, KSerializer<T> kSerializer, SavedStateConfiguration savedStateConfiguration, Function0<? extends T> function0, Composer composer, int i, int i2) {
        ...
        T t = (T) RememberSaveableKt.m4137rememberSaveable(Arrays.copyOf(objArr, objArr.length), SerializableSaverKt.serializableSaver(kSerializer, savedStateConfiguration), (String) null, (Function0) function0, composer, (i & 7168) | RendererCapabilities.DECODER_SUPPORT_MASK, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static final <T> MutableState<T> rememberSerializable(Object[] inputs, KSerializer<T> kSerializer, SavedStateConfiguration configuration, Function0<? extends MutableState<T>> function0, Composer $composer, int $changed, int i) {
        ...
        MutableState<T> mutableState = (MutableState) RememberSaveableKt.m4137rememberSaveable(Arrays.copyOf(inputs, inputs.length), saver, (String) null, (Function0) function0, $composer, ($changed & 7168) | RendererCapabilities.DECODER_SUPPORT_MASK, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd($composer);
