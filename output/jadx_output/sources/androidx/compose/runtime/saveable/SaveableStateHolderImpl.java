...
final class SaveableStateHolderImpl implements SaveableStateHolder {
    ...
    */
    public void SaveableStateProvider(final Object key, final Function2<? super Composer, ? super Integer, Unit> function2, Composer $composer, final int $changed) {
        Composer $composer2;
        int $dirty;
        Composer $composer3 = $composer.startRestartGroup(533563200);
        ComposerKt.sourceInformation($composer3, "C(SaveableStateProvider)N(key,content)71@3248L1083:SaveableStateHolder.kt#r2ddri");
        int $dirty2 = $changed;
        if (($changed & 6) == 0) {
            $dirty2 |= $composer3.changedInstance(key) ? 4 : 2;
        }
        if (($changed & 48) == 0) {
            $dirty2 |= $composer3.changedInstance(function2) ? 32 : 16;
        }
        if (($changed & RendererCapabilities.DECODER_SUPPORT_MASK) == 0) {
            $dirty2 |= $composer3.changedInstance(this) ? 256 : 128;
        }
        if (!$composer3.shouldExecute(($dirty2 & 147) != 146, $dirty2 & 1)) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(533563200, $dirty2, -1, "androidx.compose.runtime.saveable.SaveableStateHolderImpl.SaveableStateProvider (SaveableStateHolder.kt:70)");
            }
            int $changed$iv = $dirty2 & 14;
            ComposerKt.sourceInformationMarkerStart($composer3, 1800201264, "CC(ReusableContent)N(key,content)143@5486L9:Composables.kt#9igjgp");
            $composer3.startReusableGroup(ComposerKt.reuseKey, key);
            int i = ($changed$iv >> 3) & 14;
            ComposerKt.sourceInformationMarkerStart($composer3, -1512655177, "C72@3298L408,81@3719L200,86@3955L366,86@3932L389:SaveableStateHolder.kt#r2ddri");
            ComposerKt.sourceInformationMarkerStart($composer3, 366846518, "CC(remember):SaveableStateHolder.kt#9igjgp");
            ...
            if (it$iv == Composer.INSTANCE.getEmpty()) {
                ...
                $dirty = $dirty2;
                Object value$iv = new SaveableStateRegistryWrapper(SaveableStateRegistryKt.SaveableStateRegistry(this.savedStates.get(key), this.canBeSaved));
                $composer3.updateRememberedValue(value$iv);
                it$iv = value$iv;
            } else {
                $dirty = $dirty2;
            }
            final SaveableStateRegistryWrapper registry = (SaveableStateRegistryWrapper) it$iv;
            ComposerKt.sourceInformationMarkerEnd($composer3);
            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{SaveableStateRegistryKt.getLocalSaveableStateRegistry().provides(registry), LocalSavedStateRegistryOwnerKt.getLocalSavedStateRegistryOwner().provides(registry)}, function2, $composer3, ProvidedValue.$stable | ($dirty & 112));
            Unit unit = Unit.INSTANCE;
            ComposerKt.sourceInformationMarkerStart($composer3, 366867500, "CC(remember):SaveableStateHolder.kt#9igjgp");
            boolean invalid$iv = $composer3.changedInstance(this) | $composer3.changedInstance(key) | $composer3.changedInstance(registry);
            ...
            if (!invalid$iv) {
                ...
                ComposerKt.sourceInformationMarkerEnd($composer3);
                EffectsKt.DisposableEffect(unit, (Function1<? super DisposableEffectScope, ? extends DisposableEffectResult>) it$iv2, $composer3, 6);
                ComposerKt.sourceInformationMarkerEnd($composer3);
            ...
            Object value$iv2 = new Function1() { // from class: androidx.compose.runtime.saveable.SaveableStateHolderImpl$$ExternalSyntheticLambda1
                @Override // kotlin.jvm.functions.Function1
                public final Object invoke(Object obj) {
                    return SaveableStateHolderImpl.SaveableStateProvider$lambda$0$1$0(this.f$0, key, registry, (DisposableEffectScope) obj);
                }
            };
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2() { // from class: androidx.compose.runtime.saveable.SaveableStateHolderImpl$$ExternalSyntheticLambda2
                @Override // kotlin.jvm.functions.Function2
                public final Object invoke(Object obj, Object obj2) {
                    return SaveableStateHolderImpl.SaveableStateProvider$lambda$1(this.f$0, key, function2, $changed, (Composer) obj, ((Integer) obj2).intValue());
                }
            });
        }
    }
