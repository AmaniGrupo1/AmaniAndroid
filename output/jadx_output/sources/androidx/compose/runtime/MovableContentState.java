...
public final class MovableContentState {
    ...
    public final ScatterMap<MovableContentStateReference, MovableContentState> extractNestedStates$runtime(Applier<?> applier, ObjectList<MovableContentStateReference> references) throws Throwable {
        boolean z;
        ...
        ObjectList referencesToExtract = ExtensionsKt.sortedBy(objectList, new Function1() { // from class: androidx.compose.runtime.MovableContentState$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return Integer.valueOf(this.f$0.slotTable.anchorIndex(((MovableContentStateReference) obj).getAnchor()));
            }
        });
    ...
    private static final void extractNestedStates$lambda$2$openParent(SlotWriter $writer, int parent) {
        ...
        while ($writer.getCurrentGroup() != parent && !$writer.isGroupEnd()) {
            if (parent < ComposerKt.getNextGroup($writer)) {
                $writer.startGroup();
            } else {
                $writer.skipGroup();
            }
