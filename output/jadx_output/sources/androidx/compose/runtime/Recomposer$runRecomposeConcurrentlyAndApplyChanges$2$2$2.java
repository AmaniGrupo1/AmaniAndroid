    ...
    public final Object invokeSuspend(Object obj) {
        ...
        switch (this.label) {
            case 0:
                ...
                ControlledComposition changedComposition = this.this$0.performRecompose(this.$composition, null);
                Object lock$iv = this.this$0.stateLock;
                Recomposer recomposer = this.this$0;
                synchronized (lock$iv) {
                    if (changedComposition != null) {
                        try {
                            recomposer.compositionsAwaitingApply.add(changedComposition);
                        } catch (Throwable th) {
                            throw th;
                        }
                    }
