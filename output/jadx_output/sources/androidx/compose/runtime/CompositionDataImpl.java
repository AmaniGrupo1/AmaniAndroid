...
public final class CompositionDataImpl implements CompositionData, CompositionInstance {
    ...
    public CompositionGroup findContextGroup() {
        ...
        if (parent == null || (parentSlotTable = getSlotTable(parent)) == null || (context = getContext(this.composition)) == null || (numFindSubcompositionContextGroup = ComposeStackTraceBuilderKt.findSubcompositionContextGroup(parentSlotTable, context)) == null) {
            return null;
        }
