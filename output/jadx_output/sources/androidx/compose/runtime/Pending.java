...
final class Pending {
    ...
    public Pending(List<KeyInfo> list, int startIndex) {
        ...
        Pending $this$groupInfos_u24lambda_u240 = this;
        ...
        this.keyMap = LazyKt.lazy(new Function0<MultiValueMap<Object, KeyInfo>>() { // from class: androidx.compose.runtime.Pending$keyMap$2
            ...
            public /* bridge */ /* synthetic */ MultiValueMap<Object, KeyInfo> invoke() {
                return MultiValueMap.m4044boximpl(m3925invokefVlnmYg());
            }

            /* JADX INFO: renamed from: invoke-fVlnmYg, reason: not valid java name */
            public final MutableScatterMap<Object, Object> m3925invokefVlnmYg() {
                ...
                for (int index2 = 0; index2 < size2; index2++) {
                    ...
                    MultiValueMap.m4043addimpl(mutableScatterMapMultiMap, ComposerImplKt.getJoinedKey(keyInfo2), keyInfo2);
                }
    ...
    public final MutableScatterMap<Object, Object> m3924getKeyMapfVlnmYg() {
    ...
    public final KeyInfo getNext(int key, Object dataKey) {
        ...
        return (KeyInfo) MultiValueMap.m4057removeFirstimpl(m3924getKeyMapfVlnmYg(), joinedKey);
    }
                        ...
                        if (!(value$iv$iv$iv < 128)) {
                            ...
                            if (i2 <= position) {
                                ...
                                if (z) {
                                    ...
                                    group.setNodeIndex((position - i2) + to);
                                }
                            } else {
                                this_$iv$iv2 = this_$iv$iv3;
                            }
                ...
                if ((((~slot$iv$iv2) << 7) & slot$iv$iv2 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (j$iv$iv3 < bitCount$iv$iv2) {
                        ...
                        if (!(value$iv$iv$iv2 < 128)) {
                            ...
                            if (i2 <= position2 && position2 < from + count) {
