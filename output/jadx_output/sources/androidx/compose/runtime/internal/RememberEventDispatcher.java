...
public final class RememberEventDispatcher implements RememberManager {
    ...
    public void rememberPausingScope(RecomposeScopeImpl scope) {
        ...
        this.currentRememberingList.add(new RememberObserverHolder(pausedPlaceholder, -1));
    }
    ...
    public void startResumingScope(RecomposeScopeImpl scope) {
        ...
        if (placeholder != null) {
            ArrayList<MutableVector<RememberObserverHolder>> arrayListM3952constructorimpl$default = this.nestedRemembersLists;
            if (arrayListM3952constructorimpl$default == null) {
                arrayListM3952constructorimpl$default = Stack.m3952constructorimpl$default(null, 1, null);
                this.nestedRemembersLists = arrayListM3952constructorimpl$default;
            }
            Stack.m3962pushimpl(arrayListM3952constructorimpl$default, this.currentRememberingList);
    ...
    public void endResumingScope(RecomposeScopeImpl scope) {
        ...
        if (mutableScatterMap != null) {
            ...
            if (placeholder != null) {
                ...
                if (arrayList != null && (mutableVector = (MutableVector) Stack.m3961popimpl(arrayList)) != null) {
