...
public final class AwaiterQueue<A extends Awaiter> {
    ...
    private final AtomicInt pendingAwaitersCountUnlocked = AtomicAwaitersCount.m4086constructorimpl();
    ...
    public final boolean getHasAwaiters() {
        int $this$count$iv$iv = this.pendingAwaitersCountUnlocked.get();
    ...
    public final CancellationHandle addAwaiter(final A awaiter, Function0<Unit> onFirstAwaiter) {
        ...
        synchronized (lock$iv) {
            ...
            while (true) {
                int it$iv2 = atomicInt.get();
                int i2 = i;
                it$iv = it$iv2 + 1;
                if (atomicInt.compareAndSet(it$iv2, it$iv)) {
                    break;
                }
                i = i2;
            }
    ...
    static final Unit addAwaiter$lambda$1(Awaiter $awaiter, AwaiterQueue this$0, Ref.IntRef $awaitersVersion) {
        ...
        int newValue$iv$iv;
        $awaiter.cancel();
        AtomicInt atomicInt = this$0.pendingAwaitersCountUnlocked;
        int version$iv = $awaitersVersion.element;
        do {
            oldValue$iv$iv = atomicInt.get();
        ...
        } while (!atomicInt.compareAndSet(oldValue$iv$iv, newValue$iv$iv));
    ...
    public final void flushAndDispatchAwaiters(Function1<? super A, Unit> resume) throws Throwable {
        ...
        synchronized (this.lock) {
            try {
                ...
                do {
                    i = atomicInt.get();
                } while (!atomicInt.compareAndSet(i, AtomicAwaitersCount.m4097packimpl(atomicInt, ((i >>> 27) & 15) + 1, 0)));
    ...
    public final void fail(Throwable cause) {
        ...
        synchronized (lock$iv) {
            ...
            do {
                ...
                newValue$iv$iv = AtomicAwaitersCount.m4097packimpl(atomicInt, $this$version$iv$iv + 1, 0);
            } while (!atomicInt.compareAndSet(oldValue$iv$iv, newValue$iv$iv));
            Unit unit = Unit.INSTANCE;
        }
    }
