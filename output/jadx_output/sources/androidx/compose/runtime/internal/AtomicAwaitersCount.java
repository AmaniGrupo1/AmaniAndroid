...
final class AtomicAwaitersCount {
    ...
    public static final /* synthetic */ AtomicAwaitersCount m4085boximpl(AtomicInt atomicInt) {
        return new AtomicAwaitersCount(atomicInt);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    private static AtomicInt m4087constructorimpl(AtomicInt atomicInt) {
        return atomicInt;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m4089equalsimpl(AtomicInt atomicInt, Object obj) {
        return (obj instanceof AtomicAwaitersCount) && Intrinsics.areEqual(atomicInt, ((AtomicAwaitersCount) obj).getValue());
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m4090equalsimpl0(AtomicInt atomicInt, AtomicInt atomicInt2) {
        return Intrinsics.areEqual(atomicInt, atomicInt2);
    }

    /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
    public static int m4094hashCodeimpl(AtomicInt atomicInt) {
        return atomicInt.hashCode();
    }

    public boolean equals(Object other) {
        return m4089equalsimpl(this.value, other);
    }
    ...
    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static AtomicInt m4086constructorimpl() {
        return m4087constructorimpl(new AtomicInt(0));
    }

    /* JADX INFO: renamed from: hasAwaiters-impl, reason: not valid java name */
    public static final boolean m4093hasAwaitersimpl(AtomicInt atomicInt) {
        int $this$count$iv = atomicInt.get();
        return ($this$count$iv & 134217727) > 0;
    }

    /* JADX INFO: renamed from: incrementVersionAndResetCount-impl, reason: not valid java name */
    public static final void m4096incrementVersionAndResetCountimpl(AtomicInt atomicInt) {
        int oldValue$iv;
        int it;
        do {
            oldValue$iv = atomicInt.get();
            int $this$version$iv = (oldValue$iv >>> 27) & 15;
            it = m4097packimpl(atomicInt, $this$version$iv + 1, 0);
        } while (!atomicInt.compareAndSet(oldValue$iv, it));
    }

    /* JADX INFO: renamed from: incrementCountAndGetVersion-impl, reason: not valid java name */
    public static final int m4095incrementCountAndGetVersionimpl(AtomicInt atomicInt, Function0<Unit> function0) {
        int oldValue$iv;
        int it;
        do {
            oldValue$iv = atomicInt.get();
    ...
    public static final void m4088decrementCountimpl(AtomicInt atomicInt, int version) {
        int oldValue$iv;
        int newValue$iv;
        do {
            oldValue$iv = atomicInt.get();
            ...
            newValue$iv = value;
        } while (!atomicInt.compareAndSet(oldValue$iv, newValue$iv));
    }

    /* JADX INFO: renamed from: update-impl, reason: not valid java name */
    private static final int m4099updateimpl(AtomicInt atomicInt, Function1<? super Integer, Integer> function1) {
        int oldValue;
        int newValue;
        do {
    ...
    public static final int m4097packimpl(AtomicInt atomicInt, int version, int count) {
    ...
    private static final int m4092getVersionimpl(AtomicInt atomicInt, int $this$version) {
        return ($this$version >>> 27) & 15;
    }

    /* JADX INFO: renamed from: getCount-impl, reason: not valid java name */
    private static final int m4091getCountimpl(AtomicInt atomicInt, int $this$count) {
        return 134217727 & $this$count;
    }

    public String toString() {
        return m4098toStringimpl(this.value);
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m4098toStringimpl(AtomicInt atomicInt) {
