...
public final class BroadcastFrameClock implements MonotonicFrameClock {
    ...
    static final class FrameAwaiter<R> extends AwaiterQueue.Awaiter {
        ...
        public void resumeWithException(Throwable exception) {
            ...
            if (cancellableContinuation != null) {
                ...
                cancellableContinuation.resumeWith(Result.m8542constructorimpl(ResultKt.createFailure(exception)));
            }
        }
        ...
        public final void resume(long timeNanos) {
            ...
            if (function1 != null && (cancellableContinuation = this.continuation) != null) {
                try {
                    ...
                    objM8542constructorimpl = Result.m8542constructorimpl(function1.invoke(Long.valueOf(timeNanos)));
                } catch (Throwable th) {
                    Result.Companion companion2 = Result.INSTANCE;
                    objM8542constructorimpl = Result.m8542constructorimpl(ResultKt.createFailure(th));
                }
                cancellableContinuation.resumeWith(objM8542constructorimpl);
            }
        }
    }
    ...
    public <R> Object withFrameNanos(Function1<? super Long, ? extends R> function1, Continuation<? super R> continuation) {
        ...
        final CancellationHandle cancellationHandle = this.queue.addAwaiter(new FrameAwaiter(function1, co2), this.onNewAwaiters);
        co2.invokeOnCancellation(new Function1<Throwable, Unit>() { // from class: androidx.compose.runtime.BroadcastFrameClock$withFrameNanos$2$1
            @Override // kotlin.jvm.functions.Function1
