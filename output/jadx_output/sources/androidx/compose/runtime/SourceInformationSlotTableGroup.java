...
final class SourceInformationSlotTableGroup implements CompositionGroup, Iterable<CompositionGroup>, KMappedMarker {
    ...
    public SourceInformationSlotTableGroup(SlotTable table, int parent, GroupSourceInformation sourceInformation, SourceInformationGroupPath identityPath) {
        this.table = table;
        this.parent = parent;
