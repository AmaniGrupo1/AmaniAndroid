...
final class ProduceFrameSignal {
        ...
        synchronized (lock) {
            ...
            synchronized (lock) {
                if (this.pendingFrameContinuation == RecomposerKt.ProduceAnotherFrame) {
                    ...
                    this.pendingFrameContinuation = co2;
    ...
    public final Continuation<Unit> requestFrameLocked() {
        Object co2 = this.pendingFrameContinuation;
        if (co2 instanceof Continuation) {
            this.pendingFrameContinuation = RecomposerKt.FramePending;
            return (Continuation) co2;
        }
        if (Intrinsics.areEqual(co2, RecomposerKt.ProduceAnotherFrame) || Intrinsics.areEqual(co2, RecomposerKt.FramePending)) {
            return null;
        }
        if (co2 == null) {
        ...
        throw new IllegalStateException(("invalid pendingFrameContinuation " + co2).toString());
    }
}
