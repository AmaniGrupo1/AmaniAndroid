...
public final class TrieNode<K, V> {
    ...
    private final TrieNode<K, V> mutableCollisionPutAll(TrieNode<K, V> otherNode, DeltaCounter intersectionCounter, MutabilityOwnership owner) {
        CommonFunctionsKt.m4083assert(this.nodeMap == 0);
        CommonFunctionsKt.m4083assert(this.dataMap == 0);
        CommonFunctionsKt.m4083assert(otherNode.nodeMap == 0);
        CommonFunctionsKt.m4083assert(otherNode.dataMap == 0);
