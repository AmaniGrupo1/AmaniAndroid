...
final class MinimumInteractiveComponentSizeModifier implements LayoutModifier {
    ...
    public MeasureResult mo1198measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        ...
        final int width = Math.max(placeable.getWidth(), $this$measure_u2d3p2s80s.mo399roundToPx0680j_4(DpSize.m7603getWidthD9Ej5fM(this.size)));
        final int height = Math.max(placeable.getHeight(), $this$measure_u2d3p2s80s.mo399roundToPx0680j_4(DpSize.m7601getHeightD9Ej5fM(this.size)));
        return MeasureScope.layout$default($this$measure_u2d3p2s80s, width, height, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material.MinimumInteractiveComponentSizeModifier$measure$1
    ...
    public boolean equals(Object other) {
        ...
        return DpSize.m7600equalsimpl0(this.size, otherModifier.size);
    }

    public int hashCode() {
        return DpSize.m7605hashCodeimpl(this.size);
    }
}
