...
public final class RippleKt {
    ...
    public static /* synthetic */ IndicationNodeFactory m1908rippleH2RKhps$default(boolean z, float f, long j, int i, Object obj) {
        if ((i & 1) != 0) {
            z = true;
        }
        if ((i & 2) != 0) {
        ...
        return m1907rippleH2RKhps(z, f, j);
    }

    /* JADX INFO: renamed from: ripple-H2RKhps, reason: not valid java name */
    public static final IndicationNodeFactory m1907rippleH2RKhps(boolean bounded, float radius, long color) {
    ...
    public static /* synthetic */ IndicationNodeFactory m1910ripplewH6b6FI$default(ColorProducer colorProducer, boolean z, float f, int i, Object obj) {
        if ((i & 2) != 0) {
            z = true;
        }
        if ((i & 4) != 0) {
        ...
        return m1909ripplewH6b6FI(colorProducer, z, f);
    }

    /* JADX INFO: renamed from: ripple-wH6b6FI, reason: not valid java name */
    public static final IndicationNodeFactory m1909ripplewH6b6FI(ColorProducer color, boolean bounded, float radius) {
        return new RippleNodeFactory(bounded, radius, color, (DefaultConstructorMarker) null);
    }
    ...
    public static final Indication m1911rippleOrFallbackImplementation9IZ8Weo(boolean bounded, float radius, long color, Composer $composer, int $changed, int i) {
        float radius2;
        long color2;
        Composer $composer2;
        IndicationNodeFactory indicationNodeFactoryM1907rippleH2RKhps;
        ...
        if (((Boolean) objConsume).booleanValue()) {
            ...
            $composer2 = $composer;
            indicationNodeFactoryM1907rippleH2RKhps = androidx.compose.material.ripple.RippleKt.m2030rememberRipple9IZ8Weo(bounded2, radius2, color2, $composer2, ($changed & 14) | ($changed & 112) | ($changed & 896), 0);
            $composer2.endReplaceGroup();
        } else {
            $composer2 = $composer;
            $composer2.startReplaceGroup(96503175);
            $composer2.endReplaceGroup();
            indicationNodeFactoryM1907rippleH2RKhps = m1907rippleH2RKhps(bounded2, radius2, color2);
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd($composer2);
        return indicationNodeFactoryM1907rippleH2RKhps;
    }
}
