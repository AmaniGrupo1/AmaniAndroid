...
final class DefaultChipColors implements ChipColors {
    ...
    public State<Color> backgroundColor(boolean enabled, Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1593588247, $changed, -1, "androidx.compose.material.DefaultChipColors.backgroundColor (Chip.kt:599)");
        }
        State<Color> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m4687boximpl(enabled ? this.backgroundColor : this.disabledBackgroundColor), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public State<Color> contentColor(boolean enabled, Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(483145880, $changed, -1, "androidx.compose.material.DefaultChipColors.contentColor (Chip.kt:604)");
        }
        State<Color> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m4687boximpl(enabled ? this.contentColor : this.disabledContentColor), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceGroup();
    ...
    public State<Color> leadingIconContentColor(boolean enabled, Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1955749013, $changed, -1, "androidx.compose.material.DefaultChipColors.leadingIconContentColor (Chip.kt:609)");
        }
        State<Color> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m4687boximpl(enabled ? this.leadingIconContentColor : this.disabledLeadingIconContentColor), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceGroup();
    ...
    public boolean equals(Object other) {
        ...
        if (Color.m4698equalsimpl0(this.backgroundColor, ((DefaultChipColors) other).backgroundColor) && Color.m4698equalsimpl0(this.contentColor, ((DefaultChipColors) other).contentColor) && Color.m4698equalsimpl0(this.leadingIconContentColor, ((DefaultChipColors) other).leadingIconContentColor) && Color.m4698equalsimpl0(this.disabledBackgroundColor, ((DefaultChipColors) other).disabledBackgroundColor) && Color.m4698equalsimpl0(this.disabledContentColor, ((DefaultChipColors) other).disabledContentColor) && Color.m4698equalsimpl0(this.disabledLeadingIconContentColor, ((DefaultChipColors) other).disabledLeadingIconContentColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (((((((((result * 31) + Color.m4704hashCodeimpl(this.contentColor)) * 31) + Color.m4704hashCodeimpl(this.leadingIconContentColor)) * 31) + Color.m4704hashCodeimpl(this.disabledBackgroundColor)) * 31) + Color.m4704hashCodeimpl(this.disabledContentColor)) * 31) + Color.m4704hashCodeimpl(this.disabledLeadingIconContentColor);
    }
}
