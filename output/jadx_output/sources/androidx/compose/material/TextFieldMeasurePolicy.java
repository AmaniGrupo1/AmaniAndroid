...
final class TextFieldMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo41measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, List<? extends Measurable> list, long constraints) {
        ...
        final int topPadding = measureScope.mo399roundToPx0680j_4(TextFieldKt.getTextFieldTopPadding());
        ...
        Placeable leadingPlaceable3 = measurable != null ? measurable.mo6141measureBRTryo0(looseConstraints3) : null;
        ...
        if (measurable2 != null) {
            ...
            leadingPlaceable2 = measurable2.mo6141measureBRTryo0(ConstraintsKt.m7478offsetNN6EwU$default(looseConstraints2, -occupiedSpaceHorizontally3, 0, 2, null));
        } else {
            looseConstraints2 = looseConstraints;
        ...
        long labelConstraints = ConstraintsKt.m7477offsetNN6EwU(looseConstraints2, -occupiedSpaceHorizontally4, occupiedSpaceHorizontally5);
        int index$iv$iv3 = 0;
        int size3 = list.size();
        while (true) {
            ...
            int i = size3;
            long looseConstraints4 = looseConstraints2;
            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(it4), "Label")) {
                break;
            }
            index$iv$iv3++;
            size3 = i;
            looseConstraints2 = looseConstraints4;
        }
        ...
        while (occupiedSpaceHorizontally6 < size4) {
            ...
            Object item$iv$iv = list3.get(occupiedSpaceHorizontally6);
            ...
            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(it5), "TextField")) {
                ...
                final int width = TextFieldKt.m1999calculateWidthVsPV1Ek(TextFieldImplKt.widthOrZero(leadingPlaceable), TextFieldImplKt.widthOrZero(leadingPlaceable2), textFieldPlaceable.getWidth(), TextFieldImplKt.widthOrZero(labelPlaceable2), TextFieldImplKt.widthOrZero(placeholderPlaceable), constraints);
                final int height = TextFieldKt.m1998calculateHeightO3s9Psw(textFieldPlaceable.getHeight(), labelPlaceable2 != null, effectiveLabelBaseline, TextFieldImplKt.heightOrZero(leadingPlaceable), TextFieldImplKt.heightOrZero(leadingPlaceable2), TextFieldImplKt.heightOrZero(placeholderPlaceable), constraints, measureScope.getDensity(), textFieldMeasurePolicy.paddingValues);
                ...
                return MeasureScope.layout$default($this$measure_u2d3p2s80s, width, height, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material.TextFieldMeasurePolicy$measure$1
                    ...
                    public final void invoke2(Placeable.PlacementScope $this$layout) {
                        if (labelPlaceable2 == null) {
                            TextFieldKt.placeWithoutLabel($this$layout, width, height, textFieldPlaceable, placeholderPlaceable2, leadingPlaceable4, leadingPlaceable2, textFieldMeasurePolicy.singleLine, measureScope.getDensity(), textFieldMeasurePolicy.paddingValues);
                        } else {
                            int labelEndPosition = RangesKt.coerceAtLeast(topPaddingValue - lastBaseline, 0);
                            TextFieldKt.placeWithLabel($this$layout, width, height, textFieldPlaceable, labelPlaceable2, placeholderPlaceable2, leadingPlaceable4, leadingPlaceable2, textFieldMeasurePolicy.singleLine, labelEndPosition, effectiveLabelBaseline + topPadding, textFieldMeasurePolicy.animationProgress, measureScope.getDensity());
                        }
                    }
                }, 4, null);
            }
    ...
    private final int intrinsicWidth(List<? extends IntrinsicMeasurable> measurables, int height, Function2<? super IntrinsicMeasurable, ? super Integer, Integer> intrinsicMeasurer) {
        ...
        for (int index$iv$iv = 0; index$iv$iv < size; index$iv$iv++) {
            ...
            if (Intrinsics.areEqual(TextFieldImplKt.getLayoutId((IntrinsicMeasurable) item$iv$iv), "TextField")) {
                ...
                return TextFieldKt.m1999calculateWidthVsPV1Ek(leadingWidth, trailingWidth, textFieldWidth, labelWidth, placeholderWidth, TextFieldImplKt.getZeroConstraints());
            }
        }
        throw new NoSuchElementException("Collection contains no element matching the predicate.");
    }
    ...
    private final int intrinsicHeight(IntrinsicMeasureScope $this$intrinsicHeight, List<? extends IntrinsicMeasurable> list, int width, Function2<? super IntrinsicMeasurable, ? super Integer, Integer> function2) {
        ...
        while (index$iv$iv4 < size4) {
            ...
            if (Intrinsics.areEqual(TextFieldImplKt.getLayoutId((IntrinsicMeasurable) item$iv$iv), "TextField")) {
                ...
                return TextFieldKt.m1998calculateHeightO3s9Psw(textFieldHeight, labelHeight > 0, labelHeight, leadingHeight, trailingHeight, placeholderHeight, TextFieldImplKt.getZeroConstraints(), $this$intrinsicHeight.getDensity(), this.paddingValues);
            }
            index$iv$iv4++;
            list2 = list3;
        }
