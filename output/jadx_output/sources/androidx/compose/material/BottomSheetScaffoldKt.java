...
public final class BottomSheetScaffoldKt {
    ...
    public static final BottomSheetState rememberBottomSheetState(final BottomSheetValue initialValue, final AnimationSpec<Float> animationSpec, final Function1<? super BottomSheetValue, Boolean> function1, Composer $composer, int $changed, int i) {
        ...
        boolean invalid$iv = (((($changed & 14) ^ 6) > 4 && $composer.changed(initialValue)) || ($changed & 6) == 4) | $composer.changed(density) | $composer.changedInstance(animationSpec) | (((($changed & 896) ^ RendererCapabilities.DECODER_SUPPORT_MASK) > 256 && $composer.changed(function1)) || ($changed & RendererCapabilities.DECODER_SUPPORT_MASK) == 256);
        ...
        ComposerKt.sourceInformationMarkerEnd($composer);
        BottomSheetState bottomSheetState = (BottomSheetState) RememberSaveableKt.m4137rememberSaveable(objArr, (Saver) Saver, (String) null, (Function0) value$iv, $composer, 0, 4);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static final void m1720BottomSheetScaffoldHnlDQGw(final Function3<? super ColumnScope, ? super Composer, ? super Integer, Unit> function3, Modifier modifier, BottomSheetScaffoldState scaffoldState, Function2<? super Composer, ? super Integer, Unit> function2, Function3<? super SnackbarHostState, ? super Composer, ? super Integer, Unit> function32, Function2<? super Composer, ? super Integer, Unit> function22, int floatingActionButtonPosition, boolean sheetGesturesEnabled, Shape sheetShape, float sheetElevation, long sheetBackgroundColor, long sheetContentColor, float sheetPeekHeight, long backgroundColor, long contentColor, final Function3<? super PaddingValues, ? super Composer, ? super Integer, Unit> function33, Composer $composer, final int $changed, final int $changed1, final int i) {
        ...
        if (i6 != 0) {
            $dirty3 |= 24576;
            function3M1786getLambda1$material_release = function32;
        } else if (($changed & 24576) == 0) {
            function3M1786getLambda1$material_release = function32;
            $dirty3 |= $composer3.changedInstance(function3M1786getLambda1$material_release) ? 16384 : 8192;
        } else {
            function3M1786getLambda1$material_release = function32;
        }
        int i7 = i & 32;
        ...
        if (($changed & 100663296) == 0) {
            $dirty3 |= ((i & 256) == 0 && $composer3.changed(sheetShape)) ? 67108864 : 33554432;
        }
        if (($changed & 805306368) == 0) {
            $dirty3 |= ((i & 512) == 0 && $composer3.changed(sheetElevation)) ? C.BUFFER_FLAG_LAST_SAMPLE : 268435456;
        }
        if (($changed1 & 6) == 0) {
            if ((i & 1024) == 0) {
                $dirty15 = $changed1;
        ...
        int $dirty18 = $dirty1;
        int $dirty19 = $changed1 & RendererCapabilities.DECODER_SUPPORT_MASK;
        if ($dirty19 == 0) {
        ...
        if ((306783379 & $dirty3) == 306783378 && ($dirty12 & 74899) == 74898 && $composer3.getSkipping()) {
            ...
            function34 = function3M1786getLambda1$material_release;
            ...
            if (($changed & 1) == 0 || $composer3.getDefaultsInvalid()) {
                ...
                Function2<? super Composer, ? super Integer, Unit> function28 = i4 != 0 ? null : function23;
                if (i6 != 0) {
                    function3M1786getLambda1$material_release = ComposableSingletons$BottomSheetScaffoldKt.INSTANCE.m1786getLambda1$material_release();
                }
                if (i7 != 0) {
                    function24 = null;
                }
                ...
                if ((i & 512) != 0) {
                    sheetElevation2 = BottomSheetScaffoldDefaults.INSTANCE.m1717getSheetElevationD9Ej5fM();
                    $dirty3 &= -1879048193;
                } else {
                ...
                if ((i & 1024) != 0) {
                    ...
                    sheetBackgroundColor2 = MaterialTheme.INSTANCE.getColors($composer3, 6).m1763getSurface0d7_KjU();
                } else {
                    function25 = function24;
                    sheetBackgroundColor2 = sheetBackgroundColor;
                }
                if ((i & 2048) != 0) {
                    sheetContentColor2 = ColorsKt.m1777contentColorForek8zF_U(sheetBackgroundColor2, $composer3, $dirty12 & 14);
                    $dirty13 = $dirty12 & (-113);
                } else {
                    sheetContentColor2 = sheetContentColor;
                    $dirty13 = $dirty12;
                }
                Function2<? super Composer, ? super Integer, Unit> function29 = function28;
                if ((i & 4096) != 0) {
                    sheetPeekHeight2 = BottomSheetScaffoldDefaults.INSTANCE.m1718getSheetPeekHeightD9Ej5fM();
                    $dirty13 &= -897;
                } else {
                ...
                if ((i & 16384) != 0) {
                    long contentColor4 = ColorsKt.m1777contentColorForek8zF_U(backgroundColor2, $composer3, ($dirty13 >> 9) & 14);
            ...
            final Function3<? super SnackbarHostState, ? super Composer, ? super Integer, Unit> function35 = function3M1786getLambda1$material_release;
            ...
            SurfaceKt.m1941SurfaceFjzlyU(SizeKt.fillMaxSize$default(modifier2, 0.0f, 1, null), null, backgroundColor4, contentColor5, null, 0.0f, ComposableLambdaKt.rememberComposableLambda(-131096268, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.BottomSheetScaffoldKt$BottomSheetScaffold$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
                    super(2);
                    ...
                    if (($changed2 & 3) != 2 || !$composer4.getSkipping()) {
                        ...
                        ComposableLambda composableLambdaRememberComposableLambda = ComposableLambdaKt.rememberComposableLambda(1143451324, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.BottomSheetScaffoldKt$BottomSheetScaffold$1.1
                            ...
                            public final void invoke(Composer $composer5, int $changed3) {
                                ...
                                function36.invoke(PaddingKt.m815PaddingValuesa9UjIt4$default(0.0f, 0.0f, 0.0f, f, 7, null), $composer5, 0);
                                if (ComposerKt.isTraceInProgress()) {
                                    ComposerKt.traceEventEnd();
                                }
                            }
                        ...
                        ComposableLambda composableLambdaRememberComposableLambda2 = ComposableLambdaKt.rememberComposableLambda(1856649243, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.BottomSheetScaffoldKt$BottomSheetScaffold$1.2
                            ...
                            public final void invoke(Composer $composer5, int $changed3) {
                                ...
                                BottomSheetScaffoldKt.m1719BottomSheetdAqlCkY(bottomSheetScaffoldState.getBottomSheetState(), z, shape, f3, j2, j3, f2, SizeKt.m855requiredHeightInVpY3zN4$default(SizeKt.fillMaxWidth$default(nestedScroll, 0.0f, 1, null), f2, 0.0f, 2, null), function37, $composer5, 0, 0);
                                if (ComposerKt.isTraceInProgress()) {
                                    ComposerKt.traceEventEnd();
                                }
                            }
                        ...
                        ComposableLambda composableLambdaRememberComposableLambda3 = ComposableLambdaKt.rememberComposableLambda(-1011922215, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.BottomSheetScaffoldKt$BottomSheetScaffold$1.3
                            ...
                            public final void invoke(Composer $composer5, int $changed3) {
                                ...
                                function38.invoke(bottomSheetScaffoldState2.getSnackbarHostState(), $composer5, 0);
                                if (ComposerKt.isTraceInProgress()) {
                                    ComposerKt.traceEventEnd();
                                }
                            }
                        ...
                        BottomSheetScaffoldKt.m1721BottomSheetScaffoldLayoutHJHHjMs(function212, composableLambdaRememberComposableLambda, composableLambdaRememberComposableLambda2, function214, composableLambdaRememberComposableLambda3, f4, (Function0) value$iv, floatingActionButtonPosition4, bottomSheetState, $composer4, 25008);
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                            return;
                        }
    ...
    public static final void m1719BottomSheetdAqlCkY(final BottomSheetState state, final boolean sheetGesturesEnabled, final Shape sheetShape, final float sheetElevation, final long sheetBackgroundColor, final long sheetContentColor, final float sheetPeekHeight, Modifier modifier, final Function3<? super ColumnScope, ? super Composer, ? super Integer, Unit> function3, Composer $composer, final int $changed, final int i) {
        ...
        if ((i & 256) != 0) {
            ...
            $dirty |= $composer3.changedInstance(function3) ? 67108864 : 33554432;
        }
        int $dirty2 = $dirty;
        if ((38347923 & $dirty2) == 38347922 && $composer3.getSkipping()) {
            ...
            final float peekHeightPx = $this$BottomSheet_dAqlCkY_u24lambda_u243.mo405toPx0680j_4(sheetPeekHeight);
            ...
            if (invalid$iv || value$iv2 == Composer.INSTANCE.getEmpty()) {
                value$iv2 = (Function2) new Function2<IntSize, Constraints, Pair<? extends DraggableAnchors<BottomSheetValue>, ? extends BottomSheetValue>>() { // from class: androidx.compose.material.BottomSheetScaffoldKt$BottomSheet$1$1
                    ...
                    public /* bridge */ /* synthetic */ Pair<? extends DraggableAnchors<BottomSheetValue>, ? extends BottomSheetValue> invoke(IntSize intSize, Constraints constraints) {
                        return m1724invokeGpV2Q24(intSize.m7680unboximpl(), constraints.getValue());
                    }

                    /* JADX INFO: renamed from: invoke-GpV2Q24, reason: not valid java name */
                    public final Pair<DraggableAnchors<BottomSheetValue>, BottomSheetValue> m1724invokeGpV2Q24(long sheetSize, long constraints) {
                        ...
                        switch (WhenMappings.$EnumSwitchMapping$0[state.getAnchoredDraggableState$material_release().getTargetValue().ordinal()]) {
                            case 1:
                                ...
                                break;
                            case 2:
                                newTarget = !newAnchors.hasAnchorFor(BottomSheetValue.Expanded) ? BottomSheetValue.Collapsed : BottomSheetValue.Expanded;
                                break;
                            default:
                            ...
                            if (state.isCollapsed()) {
                                ...
                                SemanticsPropertiesKt.expand$default($this$semantics, null, new Function0<Boolean>() { // from class: androidx.compose.material.BottomSheetScaffoldKt$BottomSheet$2$1.1
                                    ...
                                    static final class C00471 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                                        ...
                                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                        C00471(BottomSheetState bottomSheetState, Continuation<? super C00471> continuation) {
                                        ...
                                        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                                            return new C00471(this.$state, continuation);
                                        }
                                    ...
                                    public final Boolean invoke() {
                                        if (bottomSheetState.getAnchoredDraggableState$material_release().getConfirmValueChange$material_release().invoke(BottomSheetValue.Expanded).booleanValue()) {
                                            BuildersKt__Builders_commonKt.launch$default(coroutineScope, null, null, new C00471(bottomSheetState, null), 3, null);
                                        }
                                        return true;
                                    }
                                }, 1, null);
            ...
            ComposerKt.sourceInformationMarkerEnd($composer3);
            SurfaceKt.m1941SurfaceFjzlyU(SemanticsModifierKt.semantics$default(modifierAnchoredDraggable, false, (Function1) value$iv, 1, null), sheetShape, sheetBackgroundColor, sheetContentColor, null, sheetElevation, ComposableLambdaKt.rememberComposableLambda(2055704138, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.BottomSheetScaffoldKt$BottomSheet$3
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
                    super(2);
                ...
                */
                public final void invoke(Composer $composer4, int $changed2) {
                    int $changed$iv;
                    ComposerKt.sourceInformation($composer4, "C461@18854L25:BottomSheetScaffold.kt#jmzs0o");
                    if (($changed2 & 3) == 2 && $composer4.getSkipping()) {
                        $composer4.skipToGroupEnd();
                        return;
                    }
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventStart(2055704138, $changed2, -1, "androidx.compose.material.BottomSheet.<anonymous> (BottomSheetScaffold.kt:461)");
                    }
                    ...
                    if (!$this$Layout_u24lambda_u240$iv$iv.getInserting()) {
                        ...
                        function32.invoke(ColumnScopeInstance.INSTANCE, $composer4, Integer.valueOf((($changed$iv >> 6) & 112) | 6));
                        ComposerKt.sourceInformationMarkerEnd($composer4);
                        $composer4.endNode();
                        ComposerKt.sourceInformationMarkerEnd($composer4);
                        ComposerKt.sourceInformationMarkerEnd($composer4);
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.BottomSheetScaffoldKt$BottomSheet$4
                ...
                public final void invoke(Composer composer, int i4) {
                    BottomSheetScaffoldKt.m1719BottomSheetdAqlCkY(state, sheetGesturesEnabled, sheetShape, sheetElevation, sheetBackgroundColor, sheetContentColor, sheetPeekHeight, modifier2, function3, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public static final void m1721BottomSheetScaffoldLayoutHJHHjMs(final Function2<? super Composer, ? super Integer, Unit> function2, final Function2<? super Composer, ? super Integer, Unit> function22, final Function2<? super Composer, ? super Integer, Unit> function23, final Function2<? super Composer, ? super Integer, Unit> function24, final Function2<? super Composer, ? super Integer, Unit> function25, final float sheetPeekHeight, final Function0<Float> function0, final int floatingActionButtonPosition, final BottomSheetState sheetState, Composer $composer, final int $changed) {
        int $changed$iv;
        Object value$iv$iv;
        int compositeKeyHash$iv$iv;
        Function0<ComposeUiNode> function02;
        Composer $this$Layout_u24lambda_u240$iv$iv;
        Composer $composer2 = $composer.startRestartGroup(1411837005);
        ComposerKt.sourceInformation($composer2, "C(BottomSheetScaffoldLayout)P(8!3,7,5:c#ui.unit.Dp,4,3:c#material.FabPosition)509@20078L2668,501@19867L2879:BottomSheetScaffold.kt#jmzs0o");
        int $dirty = $changed;
        if (($changed & 6) == 0) {
        ...
        if ((12582912 & $changed) == 0) {
            $dirty |= $composer2.changed(floatingActionButtonPosition) ? 8388608 : 4194304;
        }
        ...
        if ((38347923 & $dirty) == 38347922 && $composer2.getSkipping()) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(1411837005, $dirty, -1, "androidx.compose.material.BottomSheetScaffoldLayout (BottomSheetScaffold.kt:500)");
            }
            Function2[] function2Arr = new Function2[5];
            function2Arr[0] = function2 == null ? ComposableSingletons$BottomSheetScaffoldKt.INSTANCE.m1787getLambda2$material_release() : function2;
            function2Arr[1] = function22;
            function2Arr[2] = function23;
            function2Arr[3] = function24 == null ? ComposableSingletons$BottomSheetScaffoldKt.INSTANCE.m1788getLambda3$material_release() : function24;
            function2Arr[4] = function25;
            List contents$iv = CollectionsKt.listOf((Object[]) function2Arr);
            ComposerKt.sourceInformationMarkerStart($composer2, 539800922, "CC(remember):BottomSheetScaffold.kt#9igjgp");
            boolean invalid$iv = ((3670016 & $dirty) == 1048576) | ((29360128 & $dirty) == 8388608) | ((458752 & $dirty) == 131072) | ((234881024 & $dirty) == 67108864);
            MultiContentMeasurePolicy value$iv = $composer2.rememberedValue();
            if (invalid$iv || value$iv == Composer.INSTANCE.getEmpty()) {
                value$iv = new MultiContentMeasurePolicy() { // from class: androidx.compose.material.BottomSheetScaffoldKt$BottomSheetScaffoldLayout$1$1
                    ...
                    public final MeasureResult mo762measure3p2s80s(final MeasureScope $this$Layout, List<? extends List<? extends Measurable>> list, long constraints) {
                        ...
                        List<? extends Measurable> list8 = list2;
                        int $i$f$fastMap = 0;
                        List target$iv2 = new ArrayList(list8.size());
                        int index$iv$iv2 = 0;
                        ...
                        List target$iv4 = new ArrayList(list5.size());
                        int index$iv$iv4 = 0;
                        int size4 = list5.size();
                        while (index$iv$iv4 < size4) {
                            Object item$iv$iv4 = list5.get(index$iv$iv4);
                        ...
                        List<? extends Measurable> list10 = list7;
                        int $i$f$fastMap3 = 0;
                        List target$iv5 = new ArrayList(list10.size());
                        int index$iv$iv5 = 0;
                        int size5 = list10.size();
                        while (index$iv$iv5 < size5) {
                            Object item$iv$iv5 = list10.get(index$iv$iv5);
                        ...
                        final int i2 = floatingActionButtonPosition;
                        final float f = sheetPeekHeight;
                        final BottomSheetState bottomSheetState = sheetState;
                        return MeasureScope.layout$default($this$Layout, layoutWidth, layoutHeight, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material.BottomSheetScaffoldKt$BottomSheetScaffoldLayout$1$1.1
                            ...
                            public final void invoke2(Placeable.PlacementScope $this$layout) {
                                ...
                                int fabOffsetY;
                                int snackbarOffsetY;
                                int sheetOffsetY = MathKt.roundToInt(function03.invoke().floatValue());
                                int i4 = i2;
                                if (FabPosition.m1834equalsimpl0(i4, FabPosition.INSTANCE.m1840getStart5ygKITE())) {
                                    i3 = $this$Layout.mo399roundToPx0680j_4(BottomSheetScaffoldKt.FabSpacing);
                                } else {
                                    boolean zM1834equalsimpl0 = FabPosition.m1834equalsimpl0(i4, FabPosition.INSTANCE.m1838getCenter5ygKITE());
                                    int i5 = layoutWidth;
                                    i3 = zM1834equalsimpl0 ? (i5 - fabWidth) / 2 : (i5 - fabWidth) - $this$Layout.mo399roundToPx0680j_4(BottomSheetScaffoldKt.FabSpacing);
                                }
                                int fabOffsetX = i3;
                                float f2 = $this$Layout.mo405toPx0680j_4(f);
                                float f3 = fabHeight / 2;
                                int i6 = fabHeight;
                                if (f2 < f3) {
                                    fabOffsetY = (sheetOffsetY - i6) - $this$Layout.mo399roundToPx0680j_4(BottomSheetScaffoldKt.FabSpacing);
                                } else {
                                    fabOffsetY = sheetOffsetY - (i6 / 2);
                                }
                                ...
                                List<Placeable> list11 = bodyPlaceables;
                                int i7 = topBarHeight;
                                int size6 = list11.size();
                                for (int index$iv = 0; index$iv < size6; index$iv++) {
                                    Object item$iv = list11.get(index$iv);
                                    Placeable it16 = (Placeable) item$iv;
                                    Placeable.PlacementScope.placeRelative$default($this$layout, it16, 0, i7, 0.0f, 4, null);
                                }
                                List<Placeable> list12 = topBarPlaceables;
                                int size7 = list12.size();
                                for (int index$iv2 = 0; index$iv2 < size7; index$iv2++) {
                                    Object item$iv2 = list12.get(index$iv2);
                                    Placeable it17 = (Placeable) item$iv2;
                                    Placeable.PlacementScope.placeRelative$default($this$layout, it17, 0, 0, 0.0f, 4, null);
                                }
                                List<Placeable> list13 = sheetPlaceables;
                                int size8 = list13.size();
                                for (int index$iv3 = 0; index$iv3 < size8; index$iv3++) {
                                    Object item$iv3 = list13.get(index$iv3);
                                    Placeable it18 = (Placeable) item$iv3;
                                    Placeable.PlacementScope.placeRelative$default($this$layout, it18, 0, 0, 0.0f, 4, null);
                                }
                                List<Placeable> list14 = fabPlaceable;
                                int size9 = list14.size();
                                for (int index$iv4 = 0; index$iv4 < size9; index$iv4++) {
                                    Object item$iv4 = list14.get(index$iv4);
                                    Placeable it19 = (Placeable) item$iv4;
                                    Placeable.PlacementScope.placeRelative$default($this$layout, it19, fabOffsetX, fabOffsetY, 0.0f, 4, null);
                                }
                                List<Placeable> list15 = snackbarPlaceables;
                                int size10 = list15.size();
                                for (int index$iv5 = 0; index$iv5 < size10; index$iv5++) {
                                    Object item$iv5 = list15.get(index$iv5);
                                    Placeable it20 = (Placeable) item$iv5;
                                    Placeable.PlacementScope.placeRelative$default($this$layout, it20, snackbarOffsetX, snackbarOffsetY, 0.0f, 4, null);
                                }
                            }
                        }, 4, null);
                    }
            ...
            if (invalid$iv$iv) {
                ...
                Function0<ComposeUiNode> constructor = ComposeUiNode.INSTANCE.getConstructor();
                int $i$f$Layout = $changed$iv$iv << 6;
                int $changed$iv$iv$iv = ($i$f$Layout & 896) | 6;
            ...
            MeasurePolicy measurePolicy$iv$iv2 = (MeasurePolicy) value$iv$iv;
            ComposerKt.sourceInformationMarkerEnd($composer2);
            int $changed$iv$iv2 = $changed$iv & 112;
            ComposerKt.sourceInformationMarkerStart($composer2, -1323940314, "CC(Layout)P(!1,2)78@3182L23,81@3333L411:Layout.kt#80mrfh");
            compositeKeyHash$iv$iv = ComposablesKt.getCurrentCompositeKeyHash($composer2, 0);
            CompositionLocalMap localMap$iv$iv2 = $composer2.getCurrentCompositionLocalMap();
            Modifier materialized$iv$iv2 = ComposedModifierKt.materializeModifier($composer2, modifier$iv);
            Function0<ComposeUiNode> constructor2 = ComposeUiNode.INSTANCE.getConstructor();
            int $i$f$Layout2 = $changed$iv$iv2 << 6;
            int $changed$iv$iv$iv2 = ($i$f$Layout2 & 896) | 6;
            ComposerKt.sourceInformationMarkerStart($composer2, -692256719, "CC(ReusableComposeNode)P(1,2)376@14062L9:Composables.kt#9igjgp");
            if (!($composer2.getApplier() instanceof Applier)) {
            }
            $composer2.startReusableNode();
            ...
            $this$Layout_u24lambda_u240$iv$iv = Updater.m3967constructorimpl($composer2);
            Updater.m3975setimpl($this$Layout_u24lambda_u240$iv$iv, measurePolicy$iv$iv2, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
            ...
            function2CombineAsVirtualLayouts.invoke($composer2, Integer.valueOf(($changed$iv$iv$iv2 >> 6) & 14));
            $composer2.endNode();
            ComposerKt.sourceInformationMarkerEnd($composer2);
            ComposerKt.sourceInformationMarkerEnd($composer2);
            ComposerKt.sourceInformationMarkerEnd($composer2);
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.BottomSheetScaffoldKt$BottomSheetScaffoldLayout$2
                ...
                public final void invoke(Composer composer, int i) {
                    BottomSheetScaffoldKt.m1721BottomSheetScaffoldLayoutHJHHjMs(function2, function22, function23, function24, function25, sheetPeekHeight, function0, floatingActionButtonPosition, sheetState, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1));
                }
            });
        }
    }
    ...
    public static final class AnonymousClass1 implements NestedScrollConnection {
        ...
        */
        public Object mo895onPreFlingQWom1Mo(long available, Continuation<? super Velocity> continuation) {
            ...
            Object $result = bottomSheetScaffoldKt$ConsumeSwipeWithinBottomSheetBoundsNestedScrollConnection$1$onPreFling$1.result;
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            switch (bottomSheetScaffoldKt$ConsumeSwipeWithinBottomSheetBoundsNestedScrollConnection$1$onPreFling$1.label) {
                case 0:
                    ResultKt.throwOnFailure($result);
                    ...
                    if (toFling < 0.0f && currentOffset > this.$state.getAnchors().minAnchor()) {
                        ...
                        bottomSheetScaffoldKt$ConsumeSwipeWithinBottomSheetBoundsNestedScrollConnection$1$onPreFling$1.J$0 = available;
                        bottomSheetScaffoldKt$ConsumeSwipeWithinBottomSheetBoundsNestedScrollConnection$1$onPreFling$1.label = 1;
                        if (anchoredDraggableState.settle(toFling, bottomSheetScaffoldKt$ConsumeSwipeWithinBottomSheetBoundsNestedScrollConnection$1$onPreFling$1) == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                    } else {
                    ...
                    break;
                case 1:
                    available = bottomSheetScaffoldKt$ConsumeSwipeWithinBottomSheetBoundsNestedScrollConnection$1$onPreFling$1.J$0;
                    ResultKt.throwOnFailure($result);
                    break;
                default:
                    throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
