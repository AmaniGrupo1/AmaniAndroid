...
public final class CompatRippleTheme implements RippleTheme {
    ...
    public long mo1782defaultColorWaAFU9c(Composer $composer, int $changed) {
        ...
        long jM1906rippleColor5vOe2sY = rippleDefaults.m1906rippleColor5vOe2sY(((Color) objConsume).m4707unboximpl(), MaterialTheme.INSTANCE.getColors($composer, 6).isLight());
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceGroup();
        return jM1906rippleColor5vOe2sY;
    }
    ...
    public RippleAlpha rippleAlpha(Composer $composer, int $changed) {
        ...
        Object objConsume = $composer.consume(localContentColor);
        ComposerKt.sourceInformationMarkerEnd($composer);
        RippleAlpha rippleAlphaM1905rippleAlphaDxMtmZc = rippleDefaults.m1905rippleAlphaDxMtmZc(((Color) objConsume).m4707unboximpl(), MaterialTheme.INSTANCE.getColors($composer, 6).isLight());
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceGroup();
        return rippleAlphaM1905rippleAlphaDxMtmZc;
    }
}
