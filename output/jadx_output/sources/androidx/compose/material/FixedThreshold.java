...
public final /* data */ class FixedThreshold implements ThresholdConfig {
    ...
    public static /* synthetic */ FixedThreshold m1842copy0680j_4$default(FixedThreshold fixedThreshold, float f, int i, Object obj) {
        if ((i & 1) != 0) {
            f = fixedThreshold.offset;
        }
        return fixedThreshold.m1843copy0680j_4(f);
    }

    /* JADX INFO: renamed from: copy-0680j_4, reason: not valid java name */
    public final FixedThreshold m1843copy0680j_4(float offset) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof FixedThreshold) && Dp.m7510equalsimpl0(this.offset, ((FixedThreshold) other).offset);
    }

    public int hashCode() {
        return Dp.m7511hashCodeimpl(this.offset);
    }

    public String toString() {
        return "FixedThreshold(offset=" + ((Object) Dp.m7516toStringimpl(this.offset)) + ')';
    }
    ...
    public float computeThreshold(Density $this$computeThreshold, float fromValue, float toValue) {
        return ($this$computeThreshold.mo405toPx0680j_4(this.offset) * Math.signum(toValue - fromValue)) + fromValue;
    }
}
