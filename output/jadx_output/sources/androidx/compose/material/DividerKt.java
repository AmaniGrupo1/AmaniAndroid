...
@Metadata(d1 = {"\u0000\"\n\u0000\n\u0002\u0010\u0007\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0004\u001a:\u0010\u0002\u001a\u00020\u00032\b\b\u0002\u0010\u0004\u001a\u00020\u00052\b\b\u0002\u0010\u0006\u001a\u00020\u00072\b\b\u0002\u0010\b\u001a\u00020\t2\b\b\u0002\u0010\n\u001a\u00020\tH\u0007ø\u0001\u0000¢\u0006\u0004\b\u000b\u0010\f\"\u000e\u0010\u0000\u001a\u00020\u0001X\u0082T¢\u0006\u0002\n\u0000\u0082\u0002\u0007\n\u0005\b¡\u001e0\u0001¨\u0006\r"}, d2 = {"DividerAlpha", "", "Divider", "", "modifier", "Landroidx/compose/ui/Modifier;", TtmlNode.ATTR_TTS_COLOR, "Landroidx/compose/ui/graphics/Color;", "thickness", "Landroidx/compose/ui/unit/Dp;", "startIndent", "Divider-oMI9zvI", "(Landroidx/compose/ui/Modifier;JFFLandroidx/compose/runtime/Composer;II)V", "material_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
public final class DividerKt {
    private static final float DividerAlpha = 0.12f;

    /* JADX INFO: renamed from: Divider-oMI9zvI, reason: not valid java name */
    public static final void m1803DivideroMI9zvI(Modifier modifier, long color, float thickness, float startIndent, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        long j;
        float thickness2;
        float startIndent2;
        ...
        if (($dirty & 1171) == 1170 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if ((i & 2) != 0) {
                    long jM1758getOnSurface0d7_KjU = MaterialTheme.INSTANCE.getColors($composer2, 6).m1758getOnSurface0d7_KjU();
                    color2 = Color.m4695copywmQWz5c(jM1758getOnSurface0d7_KjU, (14 & 1) != 0 ? Color.m4699getAlphaimpl(jM1758getOnSurface0d7_KjU) : 0.12f, (14 & 2) != 0 ? Color.m4703getRedimpl(jM1758getOnSurface0d7_KjU) : 0.0f, (14 & 4) != 0 ? Color.m4702getGreenimpl(jM1758getOnSurface0d7_KjU) : 0.0f, (14 & 8) != 0 ? Color.m4700getBlueimpl(jM1758getOnSurface0d7_KjU) : 0.0f);
                    $dirty &= -113;
                } else {
                    color2 = j;
                }
                if (i5 != 0) {
                    thickness2 = Dp.m7505constructorimpl(1);
                }
                if (i6 != 0) {
                    startIndent2 = Dp.m7505constructorimpl(0);
                }
            } else {
                $composer2.skipToGroupEnd();
                if ((i & 2) != 0) {
            ...
            if (startIndent2 == 0.0f) {
                ...
                i2 = 1;
                indentMod = PaddingKt.m822paddingqDBjuR0$default(Modifier.INSTANCE, startIndent2, 0.0f, 0.0f, 0.0f, 14, null);
            }
            ...
            BoxKt.Box(BackgroundKt.m264backgroundbw27NRU$default(SizeKt.m850height3ABfNKs(SizeKt.fillMaxWidth$default(modifier3.then(indentMod), 0.0f, i2, null), targetThickness), color2, null, 2, null), $composer2, 0);
            if (ComposerKt.isTraceInProgress()) {
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.DividerKt$Divider$1
                ...
                public final void invoke(Composer composer, int i7) {
                    DividerKt.m1803DivideroMI9zvI(modifier4, color3, thickness3, startIndent3, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
