...
final class DefaultSelectableChipColors implements SelectableChipColors {
    ...
    public State<Color> backgroundColor(boolean enabled, boolean selected, Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-403836585, $changed, -1, "androidx.compose.material.DefaultSelectableChipColors.backgroundColor (Chip.kt:661)");
        }
        if (enabled) {
        ...
        State<Color> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m4687boximpl(target), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public State<Color> contentColor(boolean enabled, boolean selected, Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(2025240134, $changed, -1, "androidx.compose.material.DefaultSelectableChipColors.contentColor (Chip.kt:671)");
        }
        if (enabled) {
    ...
    public State<Color> leadingIconColor(boolean enabled, boolean selected, Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(189838188, $changed, -1, "androidx.compose.material.DefaultSelectableChipColors.leadingIconColor (Chip.kt:681)");
        }
        if (enabled) {
    ...
    public boolean equals(Object other) {
        ...
        if (Color.m4698equalsimpl0(this.backgroundColor, ((DefaultSelectableChipColors) other).backgroundColor) && Color.m4698equalsimpl0(this.contentColor, ((DefaultSelectableChipColors) other).contentColor) && Color.m4698equalsimpl0(this.leadingIconColor, ((DefaultSelectableChipColors) other).leadingIconColor) && Color.m4698equalsimpl0(this.disabledBackgroundColor, ((DefaultSelectableChipColors) other).disabledBackgroundColor) && Color.m4698equalsimpl0(this.disabledContentColor, ((DefaultSelectableChipColors) other).disabledContentColor) && Color.m4698equalsimpl0(this.disabledLeadingIconColor, ((DefaultSelectableChipColors) other).disabledLeadingIconColor) && Color.m4698equalsimpl0(this.selectedBackgroundColor, ((DefaultSelectableChipColors) other).selectedBackgroundColor) && Color.m4698equalsimpl0(this.selectedContentColor, ((DefaultSelectableChipColors) other).selectedContentColor) && Color.m4698equalsimpl0(this.selectedLeadingIconColor, ((DefaultSelectableChipColors) other).selectedLeadingIconColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        int result = Color.m4704hashCodeimpl(this.backgroundColor);
        return (((((((((((((((result * 31) + Color.m4704hashCodeimpl(this.contentColor)) * 31) + Color.m4704hashCodeimpl(this.leadingIconColor)) * 31) + Color.m4704hashCodeimpl(this.disabledBackgroundColor)) * 31) + Color.m4704hashCodeimpl(this.disabledContentColor)) * 31) + Color.m4704hashCodeimpl(this.disabledLeadingIconColor)) * 31) + Color.m4704hashCodeimpl(this.selectedBackgroundColor)) * 31) + Color.m4704hashCodeimpl(this.selectedContentColor)) * 31) + Color.m4704hashCodeimpl(this.selectedLeadingIconColor);
    }
}
