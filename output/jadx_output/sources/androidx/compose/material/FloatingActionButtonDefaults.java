...
public final class FloatingActionButtonDefaults {
    ...
    public final /* synthetic */ FloatingActionButtonElevation m1844elevationixp7dh8(float defaultElevation, float pressedElevation, Composer $composer, int $changed, int i) {
        ...
        if ((i & 1) != 0) {
            float defaultElevation3 = Dp.m7505constructorimpl(6);
            defaultElevation2 = defaultElevation3;
        } else {
            defaultElevation2 = defaultElevation;
        }
        if ((i & 2) != 0) {
            float pressedElevation3 = Dp.m7505constructorimpl(12);
        ...
        FloatingActionButtonElevation floatingActionButtonElevationM1845elevationxZ9QkE = m1845elevationxZ9QkE(defaultElevation2, pressedElevation2, Dp.m7505constructorimpl(8), Dp.m7505constructorimpl(8), $composer, $this$dp$iv | 3456 | ($changed & 112) | (($changed << 6) & 57344), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd($composer);
        return floatingActionButtonElevationM1845elevationxZ9QkE;
    }

    /* JADX INFO: renamed from: elevation-xZ9-QkE, reason: not valid java name */
    public final FloatingActionButtonElevation m1845elevationxZ9QkE(float defaultElevation, float pressedElevation, float hoveredElevation, float focusedElevation, Composer $composer, int $changed, int i) {
        float defaultElevation2;
        float pressedElevation2;
        ...
        if ((i & 4) != 0) {
            float hoveredElevation3 = Dp.m7505constructorimpl(8);
            hoveredElevation2 = hoveredElevation3;
        } else {
            hoveredElevation2 = hoveredElevation;
        }
        if ((i & 8) != 0) {
            float focusedElevation3 = Dp.m7505constructorimpl(8);
        ...
        boolean invalid$iv = (((($changed & 14) ^ 6) > 4 && $composer.changed(defaultElevation2)) || ($changed & 6) == 4) | (((($changed & 112) ^ 48) > 32 && $composer.changed(pressedElevation2)) || ($changed & 48) == 32) | (((($changed & 896) ^ RendererCapabilities.DECODER_SUPPORT_MASK) > 256 && $composer.changed(hoveredElevation2)) || ($changed & RendererCapabilities.DECODER_SUPPORT_MASK) == 256) | (((($changed & 7168) ^ 3072) > 2048 && $composer.changed(focusedElevation2)) || ($changed & 3072) == 2048);
