    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                this.label = 1;
                if (FlowKt.collectLatest(SnapshotStateKt.snapshotFlow(new Function0<Boolean>() { // from class: androidx.compose.material.SwitchKt$Switch$1$1.1
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(0);
                    }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    if (SwitchKt.Switch$lambda$8(this.$currentChecked$delegate) != newValue) {
                        ...
                        if (function1Switch$lambda$7 != null) {
                            function1Switch$lambda$7.invoke(Boxing.boxBoolean(newValue));
                        }
                        SwitchKt.Switch$lambda$4(this.$forceAnimationCheck$delegate, !SwitchKt.Switch$lambda$3(this.$forceAnimationCheck$delegate));
                    }
                    return Unit.INSTANCE;
                default:
                    throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
