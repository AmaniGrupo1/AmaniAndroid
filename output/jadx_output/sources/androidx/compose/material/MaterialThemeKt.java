    ...
    public static final void MaterialTheme(Colors colors, Typography typography, Shapes shapes, final Function2<? super Composer, ? super Integer, Unit> function2, Composer $composer, final int $changed, final int i) {
        ...
        if (($changed & 48) == 0) {
            if ((i & 2) == 0) {
                ...
                int i3 = $composer2.changed(typography2) ? 32 : 16;
                $dirty2 |= i3;
            } else {
                typography2 = typography;
            }
        ...
        if (($dirty2 & 1171) == 1170 && $composer2.getSkipping()) {
            ...
            if (it$iv == Composer.INSTANCE.getEmpty()) {
                value$iv = Colors.m1750copypvPzIIM$default(colors3, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, false, 8191, null);
            ...
            Indication rippleIndication = RippleKt.m1911rippleOrFallbackImplementation9IZ8Weo(false, 0.0f, 0L, $composer2, 0, 7);
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.MaterialThemeKt.MaterialTheme.2
                ...
                public final void invoke(Composer composer, int i5) {
                    MaterialThemeKt.MaterialTheme(colors4, typography4, shapes4, function2, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
