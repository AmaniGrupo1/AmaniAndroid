...
public final class SnackbarHostKt {
    ...
    public static final void SnackbarHost(SnackbarHostState hostState, Modifier modifier, Function3<? super SnackbarData, ? super Composer, ? super Integer, Unit> function3, Composer $composer, final int $changed, final int i) {
        ...
        Modifier modifier2;
        Function3<? super SnackbarData, ? super Composer, ? super Integer, Unit> function3M1797getLambda1$material_release;
        ...
        if (i3 != 0) {
            ...
            function3M1797getLambda1$material_release = function3;
        } else if (($changed & RendererCapabilities.DECODER_SUPPORT_MASK) == 0) {
            function3M1797getLambda1$material_release = function3;
            $dirty |= $composer2.changedInstance(function3M1797getLambda1$material_release) ? 256 : 128;
        } else {
            function3M1797getLambda1$material_release = function3;
        }
        int $dirty2 = $dirty;
        if (($dirty2 & 147) == 146 && $composer2.getSkipping()) {
            ...
            function32 = function3M1797getLambda1$material_release;
        } else {
            Modifier.Companion modifier3 = i2 != 0 ? Modifier.INSTANCE : modifier2;
            if (i3 != 0) {
                function3M1797getLambda1$material_release = ComposableSingletons$SnackbarHostKt.INSTANCE.m1797getLambda1$material_release();
            }
            ...
            FadeInFadeOutWithScale(snackbarHostState.getCurrentSnackbarData(), modifier4, function3M1797getLambda1$material_release, $composer2, ($dirty2 & 896) | ($dirty2 & 112), 0);
            if (ComposerKt.isTraceInProgress()) {
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            ...
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.SnackbarHostKt.SnackbarHost.2
                ...
                public final void invoke(Composer composer, int i4) {
                    SnackbarHostKt.SnackbarHost(snackbarHostState2, modifier5, function32, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    public static final void FadeInFadeOutWithScale(final SnackbarData current, Modifier modifier, final Function3<? super SnackbarData, ? super Composer, ? super Integer, Unit> function3, Composer $composer, final int $changed, final int i) {
        ...
        if ((i & 1) != 0) {
            ...
            $dirty2 |= ($changed & 8) == 0 ? $composer2.changed(snackbarData) : $composer2.changedInstance(snackbarData) ? 4 : 2;
        }
        int i2 = i & 2;
        if (i2 != 0) {
            $dirty2 |= 48;
        ...
        if (($dirty3 & 147) == 146 && $composer2.getSkipping()) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(2036134589, $dirty3, -1, "androidx.compose.material.FadeInFadeOutWithScale (SnackbarHost.kt:263)");
            }
            ComposerKt.sourceInformationMarkerStart($composer2, 187635977, "CC(remember):SnackbarHost.kt#9igjgp");
            Object it$iv = $composer2.rememberedValue();
            ...
            if (Intrinsics.areEqual(snackbarData, state.getCurrent())) {
                $dirty = $dirty3;
                $composer2.startReplaceGroup(1524065801);
                $composer2.endReplaceGroup();
            } else {
                $composer2.startReplaceGroup(1521898746);
                ComposerKt.sourceInformation($composer2, "*273@9741L1923");
                ...
                while (index$iv$iv2 < size2) {
                    ...
                    destination$iv.add(new FadeInFadeOutAnimationItem(key, ComposableLambdaKt.rememberComposableLambda(1471040642, true, new Function3<Function2<? super Composer, ? super Integer, ? extends Unit>, Composer, Integer, Unit>() { // from class: androidx.compose.material.SnackbarHostKt$FadeInFadeOutWithScale$1$1
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        {
                            super(3);
                        }
                        ...
                        public final void invoke(Function2<? super Composer, ? super Integer, Unit> function2, Composer $composer3, int $changed2) {
                            ...
                            ComposerKt.sourceInformation($composer3, "C289@10501L289,282@10190L618,297@10837L292,312@11431L150,305@11146L504:SnackbarHost.kt#jmzs0o");
                            int $dirty4 = $changed2;
                            if (($changed2 & 6) == 0) {
                            ...
                            if (($dirty5 & 19) != 18 || !$composer3.getSkipping()) {
                                if (ComposerKt.isTraceInProgress()) {
                                    ComposerKt.traceEventStart(1471040642, $dirty5, -1, "androidx.compose.material.FadeInFadeOutWithScale.<anonymous>.<anonymous> (SnackbarHost.kt:274)");
                                }
                                ...
                                ComposerKt.sourceInformationMarkerStart($composer3, 2123935064, "CC(remember):SnackbarHost.kt#9igjgp");
                                boolean invalid$iv = $composer3.changedInstance(key) | $composer3.changedInstance(state);
                                ...
                                if (invalid$iv || it$iv2 == Composer.INSTANCE.getEmpty()) {
                                    ...
                                    value$iv2 = (Function0) new Function0<Unit>() { // from class: androidx.compose.material.SnackbarHostKt$FadeInFadeOutWithScale$1$1$opacity$1$1
                                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                        {
                                            super(0);
                                        }
                                        ...
                                        public final void invoke2() {
                                            if (!Intrinsics.areEqual(snackbarData2, fadeInFadeOutState.getCurrent())) {
                                                ...
                                                CollectionsKt.removeAll((List) items, (Function1) new Function1<FadeInFadeOutAnimationItem<SnackbarData>, Boolean>() { // from class: androidx.compose.material.SnackbarHostKt$FadeInFadeOutWithScale$1$1$opacity$1$1.1
                                                    {
                                                        super(1);
                                                    }
                                ...
                                Modifier modifierM4859graphicsLayerAp8cVGQ = GraphicsLayerModifierKt.m4859graphicsLayerAp8cVGQ(Modifier.INSTANCE, (131067 & 1) != 0 ? 1.0f : ((Number) scale.getValue()).floatValue(), (131067 & 2) != 0 ? 1.0f : ((Number) scale.getValue()).floatValue(), (131067 & 4) == 0 ? ((Number) opacity.getValue()).floatValue() : 1.0f, (131067 & 8) != 0 ? 0.0f : 0.0f, (131067 & 16) != 0 ? 0.0f : 0.0f, (131067 & 32) != 0 ? 0.0f : 0.0f, (131067 & 64) != 0 ? 0.0f : 0.0f, (131067 & 128) != 0 ? 0.0f : 0.0f, (131067 & 256) == 0 ? 0.0f : 0.0f, (131067 & 512) != 0 ? 8.0f : 0.0f, (131067 & 1024) != 0 ? TransformOrigin.INSTANCE.m5110getCenterSzJe1aQ() : 0L, (131067 & 2048) != 0 ? RectangleShapeKt.getRectangleShape() : null, (131067 & 4096) != 0 ? false : false, (131067 & 8192) != 0 ? null : null, (131067 & 16384) != 0 ? GraphicsLayerScopeKt.getDefaultShadowColor() : 0L, (32768 & 131067) != 0 ? GraphicsLayerScopeKt.getDefaultShadowColor() : 0L, (131067 & 65536) != 0 ? CompositingStrategy.INSTANCE.m4786getAutoNrFUSI() : 0);
                                ComposerKt.sourceInformationMarkerStart($composer3, 2123964685, "CC(remember):SnackbarHost.kt#9igjgp");
                                boolean invalid$iv2 = $composer3.changedInstance(key);
                                final SnackbarData snackbarData3 = key;
                                Object it$iv3 = $composer3.rememberedValue();
                                if (invalid$iv2 || it$iv3 == Composer.INSTANCE.getEmpty()) {
                                    value$iv3 = (Function1) new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material.SnackbarHostKt$FadeInFadeOutWithScale$1$1$1$1
                                        {
                                            super(1);
                                        }
                                        ...
                                        public final void invoke2(SemanticsPropertyReceiver $this$semantics) {
                                            ...
                                            SemanticsPropertiesKt.dismiss$default($this$semantics, null, new Function0<Boolean>() { // from class: androidx.compose.material.SnackbarHostKt$FadeInFadeOutWithScale$1$1$1$1.1
                                                {
                                                    super(0);
                                                }
                                ...
                                ComposerKt.sourceInformationMarkerEnd($composer3);
                                Modifier modifier$iv = SemanticsModifierKt.semantics$default(modifierM4859graphicsLayerAp8cVGQ, false, (Function1) value$iv3, 1, null);
                                ...
                                int i5 = ((0 >> 6) & 112) | 6;
                                ComposerKt.sourceInformationMarkerStart($composer3, 109521955, "C317@11622L10:SnackbarHost.kt#jmzs0o");
            ...
            ComposerKt.sourceInformationMarkerStart($composer2, 9772019, "C323@11723L21:SnackbarHost.kt#jmzs0o");
            state.setScope(ComposablesKt.getCurrentRecomposeScope($composer2, 0));
            $composer2.startReplaceGroup(1801432280);
            ...
            while ($i$f$fastForEach < size3) {
                ...
                $composer2.startMovableGroup(2123976768, item);
                ComposerKt.sourceInformation($composer2, "326@11846L55,326@11838L63");
    ...
    public static final State<Float> animatedOpacity(AnimationSpec<Float> animationSpec, boolean visible, Function0<Unit> function0, Composer $composer, int $changed, int i) {
        ...
        Function0<Unit> function02 = (i & 4) != 0 ? new Function0<Unit>() { // from class: androidx.compose.material.SnackbarHostKt.animatedOpacity.1
            @Override // kotlin.jvm.functions.Function0
            public /* bridge */ /* synthetic */ Unit invoke() {
                invoke2();
                return Unit.INSTANCE;
        ...
        boolean invalid$iv = $composer.changedInstance(alpha2) | (((($changed & 112) ^ 48) > 32 && $composer.changed(visible)) || ($changed & 48) == 32) | $composer.changedInstance(animationSpec) | (((($changed & 896) ^ RendererCapabilities.DECODER_SUPPORT_MASK) > 256 && $composer.changed(function02)) || ($changed & RendererCapabilities.DECODER_SUPPORT_MASK) == 256);
