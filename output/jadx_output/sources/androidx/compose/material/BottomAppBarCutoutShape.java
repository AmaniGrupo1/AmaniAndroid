...
final /* data */ class BottomAppBarCutoutShape implements Shape {
    ...
    public Outline mo320createOutlinePq9zytI(long size, LayoutDirection layoutDirection, Density density) {
        ...
        Path.addRect$default(boundingRectangle, new Rect(0.0f, 0.0f, Size.m4521getWidthimpl(size), Size.m4518getHeightimpl(size)), null, 2, null);
        ...
        $this$createOutline_Pq9zytI_u24lambda_u241.mo4586opN5in7k0(boundingRectangle, $this$createOutline_Pq9zytI_u24lambda_u241, PathOperation.INSTANCE.m5003getDifferenceb3I0S0c());
    ...
    private final void addCutoutShape(Path $this$addCutoutShape, LayoutDirection layoutDirection, Density density) {
        float cutoutOffset = density.mo405toPx0680j_4(AppBarKt.BottomAppBarCutoutOffset);
        float f = 2;
        long cutoutSize = SizeKt.Size(this.fabPlacement.getWidth() + (cutoutOffset * f), this.fabPlacement.getHeight() + (f * cutoutOffset));
        float cutoutStartX = this.fabPlacement.getLeft() - cutoutOffset;
        float cutoutEndX = cutoutStartX + Size.m4521getWidthimpl(cutoutSize);
        float cutoutRadius = Size.m4518getHeightimpl(cutoutSize) / 2.0f;
        float cutoutStartY = -cutoutRadius;
        OutlineKt.addOutline($this$addCutoutShape, this.cutoutShape.mo320createOutlinePq9zytI(cutoutSize, layoutDirection, density));
        $this$addCutoutShape.mo4589translatek4lQ0M(OffsetKt.Offset(cutoutStartX, cutoutStartY));
        if (Intrinsics.areEqual(this.cutoutShape, RoundedCornerShapeKt.getCircleShape())) {
            float edgeRadius = density.mo405toPx0680j_4(AppBarKt.BottomAppBarRoundedEdgeRadius);
    ...
    private final void addRoundedEdges(Path $this$addRoundedEdges, float cutoutStartPosition, float cutoutEndPosition, float cutoutRadius, float roundedEdgeRadius, float verticalOffset) {
        ...
        Pair<Float, Float> pairCalculateRoundedEdgeIntercept = AppBarKt.calculateRoundedEdgeIntercept(controlPointRadiusOffset, verticalOffset, cutoutRadius);
        float curveInterceptXOffset = pairCalculateRoundedEdgeIntercept.component1().floatValue();
        float curveInterceptYOffset = pairCalculateRoundedEdgeIntercept.component2().floatValue();
