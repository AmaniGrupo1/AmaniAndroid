...
public final class SwipeableDefaults {
    ...
    public final float m1950getVelocityThresholdD9Ej5fM() {
    ...
    public final ResistanceConfig resistanceConfig(Set<Float> anchors, float factorAtMin, float factorAtMax) {
        ...
        Float fMaxOrNull = CollectionsKt.maxOrNull((Iterable<? extends Float>) anchors);
        Intrinsics.checkNotNull(fMaxOrNull);
        float fFloatValue = fMaxOrNull.floatValue();
        Float fMinOrNull = CollectionsKt.minOrNull((Iterable<? extends Float>) anchors);
        Intrinsics.checkNotNull(fMinOrNull);
        float basis = fFloatValue - fMinOrNull.floatValue();
