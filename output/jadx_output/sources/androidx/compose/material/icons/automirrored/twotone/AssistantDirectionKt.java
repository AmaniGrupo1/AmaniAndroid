...
public final class AssistantDirectionKt {
    ...
    public static final ImageVector getAssistantDirection(Icons.AutoMirrored.TwoTone $this$AssistantDirection) {
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        ImageVector.Builder.m5428addPathoIyEayM$default($this$_get_AssistantDirection__u24lambda_u243, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 0.3f, null, 0.3f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv2.close();
        ImageVector.Builder.m5428addPathoIyEayM$default($this$_get_AssistantDirection__u24lambda_u243, $this$PathData_u24lambda_u240$iv$iv$iv2.getNodes(), pathFillType$iv2, "", fill$iv$iv2, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv2, strokeLineJoin$iv$iv2, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv3.close();
        _assistantDirection = ImageVector.Builder.m5428addPathoIyEayM$default($this$_get_AssistantDirection__u24lambda_u243, $this$PathData_u24lambda_u240$iv$iv$iv3.getNodes(), pathFillType$iv3, "", fill$iv$iv3, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv3, strokeLineJoin$iv$iv3, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
