...
public final class DirectionsBikeKt {
    ...
    public static final ImageVector getDirectionsBike(Icons.AutoMirrored.Sharp $this$DirectionsBike) {
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.reflectiveCurveToRelative(-1.6f, 3.5f, -3.5f, 3.5f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        _directionsBike = ImageVector.Builder.m5428addPathoIyEayM$default($this$_get_DirectionsBike__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
