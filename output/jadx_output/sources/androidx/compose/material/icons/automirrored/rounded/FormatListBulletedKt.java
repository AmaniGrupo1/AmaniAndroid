...
public final class FormatListBulletedKt {
    ...
    public static final ImageVector getFormatListBulleted(Icons.AutoMirrored.Rounded $this$FormatListBulleted) {
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(-0.55f, 0.0f, -1.0f, 0.45f, -1.0f, 1.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        _formatListBulleted = ImageVector.Builder.m5428addPathoIyEayM$default($this$_get_FormatListBulleted__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
