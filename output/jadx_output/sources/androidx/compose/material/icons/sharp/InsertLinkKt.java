...
public final class InsertLinkKt {
    ...
    public static final ImageVector getInsertLink(Icons.Sharp $this$InsertLink) {
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.reflectiveCurveToRelative(-2.24f, -5.0f, -5.0f, -5.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        _insertLink = ImageVector.Builder.m5428addPathoIyEayM$default($this$_get_InsertLink__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
