...
public final class BluetoothKt {
    ...
    public static final ImageVector getBluetooth(Icons.Sharp $this$Bluetooth) {
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(1.88f, 1.88f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        _bluetooth = ImageVector.Builder.m5428addPathoIyEayM$default($this$_get_Bluetooth__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
