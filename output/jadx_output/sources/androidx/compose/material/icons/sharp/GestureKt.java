...
public final class GestureKt {
    ...
    public static final ImageVector getGesture(Icons.Sharp $this$Gesture) {
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        _gesture = ImageVector.Builder.m5428addPathoIyEayM$default($this$_get_Gesture__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
