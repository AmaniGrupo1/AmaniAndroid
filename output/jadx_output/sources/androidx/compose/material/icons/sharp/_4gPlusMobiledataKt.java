...
public final class _4gPlusMobiledataKt {
    ...
    public static final ImageVector get_4gPlusMobiledata(Icons.Sharp $this$_4gPlusMobiledata) {
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.verticalLineTo(7.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        __4gPlusMobiledata = ImageVector.Builder.m5428addPathoIyEayM$default($this$_get__4gPlusMobiledata__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
