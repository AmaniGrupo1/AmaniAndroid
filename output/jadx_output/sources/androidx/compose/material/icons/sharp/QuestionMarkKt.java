...
public final class QuestionMarkKt {
    ...
    public static final ImageVector getQuestionMark(Icons.Sharp $this$QuestionMark) {
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        _questionMark = ImageVector.Builder.m5428addPathoIyEayM$default($this$_get_QuestionMark__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
