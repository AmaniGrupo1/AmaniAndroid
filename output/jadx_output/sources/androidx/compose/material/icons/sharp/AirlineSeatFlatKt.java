...
public final class AirlineSeatFlatKt {
    ...
    public static final ImageVector getAirlineSeatFlat(Icons.Sharp $this$AirlineSeatFlat) {
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(1.19f, 1.16f, 3.08f, 1.14f, 4.24f, -0.04f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        _airlineSeatFlat = ImageVector.Builder.m5428addPathoIyEayM$default($this$_get_AirlineSeatFlat__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
