...
public final class CleaningServicesKt {
    ...
    public static final ImageVector getCleaningServices(Icons.Sharp $this$CleaningServices) {
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        _cleaningServices = ImageVector.Builder.m5428addPathoIyEayM$default($this$_get_CleaningServices__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
