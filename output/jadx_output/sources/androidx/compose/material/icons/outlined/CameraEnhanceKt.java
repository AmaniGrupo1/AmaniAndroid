...
public final class CameraEnhanceKt {
    ...
    public static final ImageVector getCameraEnhance(Icons.Outlined $this$CameraEnhance) {
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.reflectiveCurveToRelative(-1.35f, 3.0f, -3.0f, 3.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        _cameraEnhance = ImageVector.Builder.m5428addPathoIyEayM$default($this$_get_CameraEnhance__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
