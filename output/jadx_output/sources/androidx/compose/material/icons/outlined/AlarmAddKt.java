...
public final class AlarmAddKt {
    ...
    public static final ImageVector getAlarmAdd(Icons.Outlined $this$AlarmAdd) {
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.horizontalLineToRelative(-3.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        _alarmAdd = ImageVector.Builder.m5428addPathoIyEayM$default($this$_get_AlarmAdd__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
