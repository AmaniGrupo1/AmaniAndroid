...
public final class LocalSeeKt {
    ...
    public static final ImageVector getLocalSee(Icons.Outlined $this$LocalSee) {
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.0f, 1.77f, -1.43f, 3.2f, -3.2f, 3.2f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        _localSee = ImageVector.Builder.m5428addPathoIyEayM$default($this$_get_LocalSee__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
