...
public final class FreeBreakfastKt {
    ...
    public static final ImageVector getFreeBreakfast(Icons.Outlined $this$FreeBreakfast) {
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.verticalLineToRelative(3.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        _freeBreakfast = ImageVector.Builder.m5428addPathoIyEayM$default($this$_get_FreeBreakfast__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
