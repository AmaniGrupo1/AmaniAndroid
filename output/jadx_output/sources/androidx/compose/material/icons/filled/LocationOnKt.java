...
public final class LocationOnKt {
    ...
    public static final ImageVector getLocationOn(Icons.Filled $this$LocationOn) {
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.reflectiveCurveToRelative(-1.12f, 2.5f, -2.5f, 2.5f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        _locationOn = ImageVector.Builder.m5428addPathoIyEayM$default($this$_get_LocationOn__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
