...
public final class LocalGroceryStoreKt {
    ...
    public static final ImageVector getLocalGroceryStore(Icons.Filled $this$LocalGroceryStore) {
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.reflectiveCurveToRelative(-0.9f, -2.0f, -2.0f, -2.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        _localGroceryStore = ImageVector.Builder.m5428addPathoIyEayM$default($this$_get_LocalGroceryStore__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
