...
public final class SnippetFolderKt {
    ...
    public static final ImageVector getSnippetFolder(Icons.TwoTone $this$SnippetFolder) {
        ...
        ImageVector.Builder.m5428addPathoIyEayM$default($this$_get_SnippetFolder__u24lambda_u242, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 0.3f, null, 0.3f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv2.lineTo(16.5f, 9.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv2.close();
        _snippetFolder = ImageVector.Builder.m5428addPathoIyEayM$default($this$_get_SnippetFolder__u24lambda_u242, $this$PathData_u24lambda_u240$iv$iv$iv2.getNodes(), pathFillType$iv2, "", fill$iv$iv2, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv2, strokeLineJoin$iv$iv2, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
