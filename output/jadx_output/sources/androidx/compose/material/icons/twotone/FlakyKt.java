...
public final class FlakyKt {
    ...
    public static final ImageVector getFlaky(Icons.TwoTone $this$Flaky) {
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        _flaky = ImageVector.Builder.m5428addPathoIyEayM$default($this$_get_Flaky__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
