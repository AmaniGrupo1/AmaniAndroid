...
public final class IconsKt {
    ...
    public static /* synthetic */ ImageVector materialIcon$default(String name, boolean autoMirror, Function1 block, int i, Object obj) {
        ...
        return ((ImageVector.Builder) block.invoke(new ImageVector.Builder(name, Dp.m7505constructorimpl(24.0f), Dp.m7505constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, autoMirror2, 96, null))).build();
    }
    ...
    public static final ImageVector materialIcon(String name, boolean autoMirror, Function1<? super ImageVector.Builder, ImageVector.Builder> function1) {
        return function1.invoke(new ImageVector.Builder(name, Dp.m7505constructorimpl(24.0f), Dp.m7505constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, autoMirror, 96, null)).build();
    }

    /* JADX INFO: renamed from: materialPath-YwgOQQI$default, reason: not valid java name */
    public static /* synthetic */ ImageVector.Builder m2006materialPathYwgOQQI$default(ImageVector.Builder $this$materialPath_u2dYwgOQQI_u24default, float fillAlpha, float strokeAlpha, int pathFillType, Function1 pathBuilder, int i, Object obj) {
        ...
        Brush fill$iv = new SolidColor(Color.INSTANCE.m4723getBlack0d7_KjU(), null);
        int strokeLineCap$iv = StrokeCap.INSTANCE.m5071getButtKaPHkGw();
        int strokeLineJoin$iv = StrokeJoin.INSTANCE.m5081getBevelLxFBmk8();
        PathBuilder $this$PathData_u24lambda_u240$iv$iv = new PathBuilder();
        pathBuilder.invoke($this$PathData_u24lambda_u240$iv$iv);
        return ImageVector.Builder.m5428addPathoIyEayM$default($this$materialPath_u2dYwgOQQI_u24default, $this$PathData_u24lambda_u240$iv$iv.getNodes(), pathFillType2, "", fill$iv, fillAlpha2, null, strokeAlpha2, 1.0f, strokeLineCap$iv, strokeLineJoin$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
    }

    /* JADX INFO: renamed from: materialPath-YwgOQQI, reason: not valid java name */
    public static final ImageVector.Builder m2005materialPathYwgOQQI(ImageVector.Builder $this$materialPath_u2dYwgOQQI, float fillAlpha, float strokeAlpha, int pathFillType, Function1<? super PathBuilder, Unit> function1) {
        Brush fill$iv = new SolidColor(Color.INSTANCE.m4723getBlack0d7_KjU(), null);
        int strokeLineCap$iv = StrokeCap.INSTANCE.m5071getButtKaPHkGw();
        int strokeLineJoin$iv = StrokeJoin.INSTANCE.m5081getBevelLxFBmk8();
        PathBuilder $this$PathData_u24lambda_u240$iv$iv = new PathBuilder();
        function1.invoke($this$PathData_u24lambda_u240$iv$iv);
        return ImageVector.Builder.m5428addPathoIyEayM$default($this$materialPath_u2dYwgOQQI, $this$PathData_u24lambda_u240$iv$iv.getNodes(), pathFillType, "", fill$iv, fillAlpha, null, strokeAlpha, 1.0f, strokeLineCap$iv, strokeLineJoin$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
    }
}
