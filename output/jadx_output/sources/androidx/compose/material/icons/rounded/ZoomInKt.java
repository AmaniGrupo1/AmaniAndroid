...
public final class ZoomInKt {
    ...
    public static final ImageVector getZoomIn(Icons.Rounded $this$ZoomIn) {
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.0f, -0.28f, -0.22f, -0.5f, -0.5f, -0.5f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        _zoomIn = ImageVector.Builder.m5428addPathoIyEayM$default($this$_get_ZoomIn__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
