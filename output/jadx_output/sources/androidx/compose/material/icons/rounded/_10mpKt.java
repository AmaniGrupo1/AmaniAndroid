...
public final class _10mpKt {
    ...
    public static final ImageVector get_10mp(Icons.Rounded $this$_10mp) {
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.verticalLineTo(14.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        __10mp = ImageVector.Builder.m5428addPathoIyEayM$default($this$_get__10mp__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
