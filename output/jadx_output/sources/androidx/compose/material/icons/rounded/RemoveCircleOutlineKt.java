...
public final class RemoveCircleOutlineKt {
    ...
    public static final ImageVector getRemoveCircleOutline(Icons.Rounded $this$RemoveCircleOutline) {
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.reflectiveCurveToRelative(-3.59f, 8.0f, -8.0f, 8.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        _removeCircleOutline = ImageVector.Builder.m5428addPathoIyEayM$default($this$_get_RemoveCircleOutline__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
