...
public final class PullRefreshStateKt {
    ...
    public static final PullRefreshState m2019rememberPullRefreshStateUuyPYSY(final boolean refreshing, Function0<Unit> function0, float refreshThreshold, float refreshingOffset, Composer $composer, int $changed, int i) {
        Object value$iv$iv;
        Object value$iv;
        Object value$iv2;
        ...
        float refreshThreshold2 = (i & 4) != 0 ? PullRefreshDefaults.INSTANCE.m2012getRefreshThresholdD9Ej5fM() : refreshThreshold;
        float refreshingOffset2 = (i & 8) != 0 ? PullRefreshDefaults.INSTANCE.m2013getRefreshingOffsetD9Ej5fM() : refreshingOffset;
        ...
        int $this$dp$iv = Dp.m7504compareTo0680j_4(refreshThreshold2, Dp.m7505constructorimpl(0));
        if (!($this$dp$iv > 0)) {
        ...
        thresholdPx.element = $this$rememberPullRefreshState_UuyPYSY_u24lambda_u241.mo405toPx0680j_4(refreshThreshold2);
        refreshingOffsetPx.element = $this$rememberPullRefreshState_UuyPYSY_u24lambda_u241.mo405toPx0680j_4(refreshingOffset2);
