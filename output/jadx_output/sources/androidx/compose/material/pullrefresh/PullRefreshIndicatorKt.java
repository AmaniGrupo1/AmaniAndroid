...
public final class PullRefreshIndicatorKt {
    ...
    */
    public static final void m2015PullRefreshIndicatorjB83MbM(final boolean refreshing, final PullRefreshState state, Modifier modifier, long backgroundColor, long contentColor, boolean scale, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        long j;
        long j2;
        boolean scale2;
        ...
        if ((74899 & $dirty) == 74898 && $composer3.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer3.getDefaultsInvalid()) {
                ...
                if ((i & 16) != 0) {
                    contentColor2 = ColorsKt.m1777contentColorForek8zF_U(backgroundColor2, $composer3, ($dirty >> 9) & 14);
                    $dirty &= -57345;
                } else {
                    contentColor2 = j2;
                }
            ...
            if (invalid$iv) {
                ...
                if (elevationOverlay != null) {
                    ...
                    long backgroundColor6 = elevationOverlay.mo1801apply7g2Lkgo(backgroundColor5, Elevation, $composer3, (($dirty >> 9) & 14) | 48);
                    backgroundColor3 = backgroundColor5;
                    $composer2 = $composer3;
                    $composer2.endReplaceGroup();
                    colorM4687boximpl = Color.m4687boximpl(backgroundColor6);
                }
                long color = colorM4687boximpl == null ? colorM4687boximpl.m4707unboximpl() : backgroundColor3;
                Modifier modifier$iv = BackgroundKt.m263backgroundbw27NRU(ShadowKt.m4295shadows4CzXII$default(PullRefreshIndicatorTransformKt.pullRefreshIndicatorTransform(SizeKt.m864size3ABfNKs(modifier3, IndicatorSize), state, scale2), !PullRefreshIndicator_jB83MbM$lambda$1(showElevation$delegate) ? Elevation : Dp.m7505constructorimpl(0), SpinnerShape, true, 0L, 0L, 24, null), color, SpinnerShape);
                int $changed$iv = i2;
                ...
                compositeKeyHash$iv$iv = ComposablesKt.getCurrentCompositeKeyHash($composer2, i2);
                ...
                CrossfadeKt.Crossfade(Boolean.valueOf(refreshing), (Modifier) null, AnimationSpecKt.tween$default(100, 0, null, $changed2, null), (String) null, ComposableLambdaKt.rememberComposableLambda(1853731063, true, new Function3<Boolean, Composer, Integer, Unit>() { // from class: androidx.compose.material.pullrefresh.PullRefreshIndicatorKt$PullRefreshIndicator$1$1
                    ...
                    public final void invoke(boolean refreshing2, Composer $composer4, int $changed3) {
                        ...
                        float arg0$iv3 = 2;
                        float spinnerSize = Dp.m7505constructorimpl(arg0$iv3 * arg0$iv2);
                        if (refreshing2) {
                            $composer4.startReplaceGroup(-1565983018);
                            ComposerKt.sourceInformation($composer4, "112@4764L208");
                            ProgressIndicatorKt.m1884CircularProgressIndicatorLxG7B9w(SizeKt.m864size3ABfNKs(Modifier.INSTANCE, spinnerSize), j3, PullRefreshIndicatorKt.StrokeWidth, 0L, 0, $composer4, 390, 24);
                            $composer4.endReplaceGroup();
                        } else {
                            $composer4.startReplaceGroup(-1565735297);
                            ComposerKt.sourceInformation($composer4, "118@5018L71");
                            PullRefreshIndicatorKt.m2014CircularArrowIndicatoriJQMabo(pullRefreshState, j3, SizeKt.m864size3ABfNKs(Modifier.INSTANCE, spinnerSize), $composer4, RendererCapabilities.DECODER_SUPPORT_MASK);
                            $composer4.endReplaceGroup();
                        }
            ...
            State showElevation$delegate2 = (State) value$iv;
            ComposerKt.sourceInformationMarkerEnd($composer3);
            ProvidableCompositionLocal<ElevationOverlay> localElevationOverlay2 = ElevationOverlayKt.getLocalElevationOverlay();
            ComposerKt.sourceInformationMarkerStart($composer3, 2023513938, "CC:CompositionLocal.kt#9igjgp");
            Object objConsume2 = $composer3.consume(localElevationOverlay2);
            ComposerKt.sourceInformationMarkerEnd($composer3);
            elevationOverlay = (ElevationOverlay) objConsume2;
            if (elevationOverlay != null) {
            }
            if (colorM4687boximpl == null) {
            }
            Modifier modifier$iv2 = BackgroundKt.m263backgroundbw27NRU(ShadowKt.m4295shadows4CzXII$default(PullRefreshIndicatorTransformKt.pullRefreshIndicatorTransform(SizeKt.m864size3ABfNKs(modifier3, IndicatorSize), state, scale2), !PullRefreshIndicator_jB83MbM$lambda$1(showElevation$delegate2) ? Elevation : Dp.m7505constructorimpl(0), SpinnerShape, true, 0L, 0L, 24, null), color, SpinnerShape);
            int $changed$iv2 = i2;
            ComposerKt.sourceInformationMarkerStart($composer2, 733328855, "CC(Box)P(2,1,3)72@3384L130:Box.kt#2w3rfo");
            ...
            ComposerKt.sourceInformationMarkerStart($composer$iv2, -1392970137, "C104@4488L643,101@4357L774:PullRefreshIndicator.kt#t44y28");
            CrossfadeKt.Crossfade(Boolean.valueOf(refreshing), (Modifier) null, AnimationSpecKt.tween$default(100, 0, null, $changed2, null), (String) null, ComposableLambdaKt.rememberComposableLambda(1853731063, true, new Function3<Boolean, Composer, Integer, Unit>() { // from class: androidx.compose.material.pullrefresh.PullRefreshIndicatorKt$PullRefreshIndicator$1$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(3);
                ...
                public final void invoke(boolean refreshing2, Composer $composer4, int $changed3) {
                    ...
                    Modifier modifier$iv22 = SizeKt.fillMaxSize$default(Modifier.INSTANCE, 0.0f, 1, null);
                    ...
                    int i9 = ($changed$iv$iv$iv22 >> 6) & 14;
                    ComposerKt.sourceInformationMarkerStart($composer4, -2146769399, "C73@3429L9:Box.kt#2w3rfo");
            ...
            }, $composer$iv2, 54), $composer$iv2, ($dirty22 & 14) | 24960, 10);
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.pullrefresh.PullRefreshIndicatorKt$PullRefreshIndicator$2
                ...
                public final void invoke(Composer composer, int i9) {
                    PullRefreshIndicatorKt.m2015PullRefreshIndicatorjB83MbM(refreshing, state, modifier4, backgroundColor4, contentColor3, scale3, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    public static final void m2014CircularArrowIndicatoriJQMabo(final PullRefreshState pullRefreshState, final long j, final Modifier modifier, Composer composer, final int i) {
        Object obj;
        ...
        if ((i2 & 147) == 146 && composerStartRestartGroup.getSkipping()) {
            ...
            if (objRememberedValue == Composer.INSTANCE.getEmpty()) {
                ...
                Path.mo4587setFillTypeoQ8Xj4U(PathFillType.INSTANCE.m4993getEvenOddRgk1Os());
            ...
            if (zChangedInstance || objRememberedValue3 == Composer.INSTANCE.getEmpty()) {
                obj2 = (Function1) new Function1<DrawScope, Unit>() { // from class: androidx.compose.material.pullrefresh.PullRefreshIndicatorKt$CircularArrowIndicator$2$1
                    ...
                    public final void invoke2(DrawScope $this$Canvas) throws Throwable {
                        ...
                        Path path2 = path;
                        long pivot$iv = $this$Canvas.mo5270getCenterF1C5BW0();
                        DrawContext $this$withTransform_u24lambda_u246$iv$iv2 = $this$Canvas.getDrawContext();
                        long previousSize$iv$iv3 = $this$withTransform_u24lambda_u246$iv$iv2.mo5192getSizeNHjbRc();
                        ...
                        try {
                            ...
                            $this$rotate_Rg1IO4c_u24lambda_u240$iv.mo5198rotateUv8p0NA(degrees$iv, pivot$iv);
                            try {
                                float arcRadius = $this$Canvas.mo405toPx0680j_4(PullRefreshIndicatorKt.ArcRadius) + ($this$Canvas.mo405toPx0680j_4(PullRefreshIndicatorKt.StrokeWidth) / 2.0f);
                                Rect arcBounds = new Rect(Offset.m4452getXimpl(androidx.compose.ui.geometry.SizeKt.m4531getCenteruvyYCjk($this$Canvas.mo5271getSizeNHjbRc())) - arcRadius, Offset.m4453getYimpl(androidx.compose.ui.geometry.SizeKt.m4531getCenteruvyYCjk($this$Canvas.mo5271getSizeNHjbRc())) - arcRadius, Offset.m4452getXimpl(androidx.compose.ui.geometry.SizeKt.m4531getCenteruvyYCjk($this$Canvas.mo5271getSizeNHjbRc())) + arcRadius, Offset.m4453getYimpl(androidx.compose.ui.geometry.SizeKt.m4531getCenteruvyYCjk($this$Canvas.mo5271getSizeNHjbRc())) + arcRadius);
                                previousSize$iv$iv = previousSize$iv$iv3;
                                try {
                                    try {
                                        DrawScope.m5250drawArcyD3GUKo$default($this$Canvas, previousSize$iv$iv2, values.getStartAngle(), values.getEndAngle() - values.getStartAngle(), false, arcBounds.m4487getTopLeftF1C5BW0(), arcBounds.m4485getSizeNHjbRc(), alpha, new Stroke($this$Canvas.mo405toPx0680j_4(PullRefreshIndicatorKt.StrokeWidth), 0.0f, StrokeCap.INSTANCE.m5073getSquareKaPHkGw(), 0, null, 26, null), null, 0, ValidationPath.MAX_PATH_LENGTH_BYTES, null);
                                        previousSize$iv$iv = previousSize$iv$iv;
                                        $this$withTransform_u24lambda_u246$iv$iv = $this$withTransform_u24lambda_u246$iv$iv2;
                                        try {
                                            PullRefreshIndicatorKt.m2018drawArrowBx497Mc($this$Canvas, path2, arcBounds, previousSize$iv$iv2, alpha, values);
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.pullrefresh.PullRefreshIndicatorKt$CircularArrowIndicator$3
                ...
                public final void invoke(Composer composer2, int i3) {
                    PullRefreshIndicatorKt.m2014CircularArrowIndicatoriJQMabo(pullRefreshState, j, modifier, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1));
                }
            });
        }
    }
    ...
    public static final void m2018drawArrowBx497Mc(DrawScope $this$drawArrow_u2dBx497Mc, Path arrow, Rect bounds, long color, float alpha, ArrowValues values) throws Throwable {
        long previousSize$iv$iv;
        DrawContext $this$withTransform_u24lambda_u246$iv$iv;
        arrow.reset();
        arrow.moveTo(0.0f, 0.0f);
        arrow.lineTo($this$drawArrow_u2dBx497Mc.mo405toPx0680j_4(ArrowWidth) * values.getScale(), 0.0f);
        arrow.lineTo(($this$drawArrow_u2dBx497Mc.mo405toPx0680j_4(ArrowWidth) * values.getScale()) / 2, $this$drawArrow_u2dBx497Mc.mo405toPx0680j_4(ArrowHeight) * values.getScale());
        float radius = Math.min(bounds.getWidth(), bounds.getHeight()) / 2.0f;
        float inset = ($this$drawArrow_u2dBx497Mc.mo405toPx0680j_4(ArrowWidth) * values.getScale()) / 2.0f;
        arrow.mo4589translatek4lQ0M(OffsetKt.Offset((Offset.m4452getXimpl(bounds.m4482getCenterF1C5BW0()) + radius) - inset, Offset.m4453getYimpl(bounds.m4482getCenterF1C5BW0()) + ($this$drawArrow_u2dBx497Mc.mo405toPx0680j_4(StrokeWidth) / 2.0f)));
        arrow.close();
        float degrees$iv = values.getEndAngle();
        long pivot$iv = $this$drawArrow_u2dBx497Mc.mo5270getCenterF1C5BW0();
        DrawContext $this$withTransform_u24lambda_u246$iv$iv2 = $this$drawArrow_u2dBx497Mc.getDrawContext();
        long previousSize$iv$iv2 = $this$withTransform_u24lambda_u246$iv$iv2.mo5192getSizeNHjbRc();
        $this$withTransform_u24lambda_u246$iv$iv2.getCanvas().save();
        try {
            DrawTransform $this$rotate_Rg1IO4c_u24lambda_u240$iv = $this$withTransform_u24lambda_u246$iv$iv2.getTransform();
            $this$rotate_Rg1IO4c_u24lambda_u240$iv.mo5198rotateUv8p0NA(degrees$iv, pivot$iv);
            ...
            try {
                DrawScope.m5261drawPathLG529CI$default($this$drawArrow_u2dBx497Mc, arrow, color, alpha, null, null, 0, 56, null);
                $this$withTransform_u24lambda_u246$iv$iv2.getCanvas().restore();
                $this$withTransform_u24lambda_u246$iv$iv2.mo5193setSizeuvyYCjk(previousSize$iv$iv);
            } catch (Throwable th) {
                th = th;
                $this$withTransform_u24lambda_u246$iv$iv = $this$withTransform_u24lambda_u246$iv$iv2;
                $this$withTransform_u24lambda_u246$iv$iv.getCanvas().restore();
