...
public final class ElevationOverlayKt {
    ...
    private static final ProvidableCompositionLocal<Dp> LocalAbsoluteElevation = CompositionLocalKt.compositionLocalOf$default(null, new Function0<Dp>() { // from class: androidx.compose.material.ElevationOverlayKt$LocalAbsoluteElevation$1
        ...
        public /* bridge */ /* synthetic */ Dp invoke() {
            return Dp.m7503boximpl(m1828invokeD9Ej5fM());
        }

        /* JADX INFO: renamed from: invoke-D9Ej5fM, reason: not valid java name */
        public final float m1828invokeD9Ej5fM() {
    ...
    public static final long m1827calculateForegroundColorCLU3JFs(long backgroundColor, float elevation, Composer $composer, int $changed) {
        ...
        long baseForegroundColor = ColorsKt.m1777contentColorForek8zF_U(backgroundColor, $composer, $changed & 14);
        long jM4695copywmQWz5c = Color.m4695copywmQWz5c(baseForegroundColor, (14 & 1) != 0 ? Color.m4699getAlphaimpl(baseForegroundColor) : alpha, (14 & 2) != 0 ? Color.m4703getRedimpl(baseForegroundColor) : 0.0f, (14 & 4) != 0 ? Color.m4702getGreenimpl(baseForegroundColor) : 0.0f, (14 & 8) != 0 ? Color.m4700getBlueimpl(baseForegroundColor) : 0.0f);
        if (ComposerKt.isTraceInProgress()) {
