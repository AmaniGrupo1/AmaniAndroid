...
public final class AnchoredDraggableState<T> {
    ...
    /* JADX INFO: renamed from: androidx.compose.material.AnchoredDraggableState$anchoredDrag$1, reason: invalid class name and case insensitive filesystem */
    /* JADX INFO: compiled from: AnchoredDraggable.kt */
    ...
    static final class C03421 extends ContinuationImpl {
        ...
        C03421(AnchoredDraggableState<T> anchoredDraggableState, Continuation<? super C03421> continuation) {
            super(continuation);
    ...
    public AnchoredDraggableState(T t, Function1<? super Float, Float> function1, Function0<Float> function0, AnimationSpec<Float> animationSpec, Function1<? super T, Boolean> function12) {
        ...
        this.progress = SnapshotStateKt.derivedStateOf(SnapshotStateKt.structuralEqualityPolicy(), new Function0<Float>(this) { // from class: androidx.compose.material.AnchoredDraggableState$progress$2
            ...
            public final Float invoke() {
                ...
                float b = this.this$0.getAnchors().positionOf(this.this$0.getClosestValue$material_release());
    ...
    public /* synthetic */ AnchoredDraggableState(Object obj, Function1 function1, Function0 function0, AnimationSpec animationSpec, Function1 function12, int i, DefaultConstructorMarker defaultConstructorMarker) {
        ...
        this(obj, function1, function0, animationSpec, function13);
    }
    ...
    public /* synthetic */ AnchoredDraggableState(Object obj, DraggableAnchors draggableAnchors, Function1 function1, Function0 function0, AnimationSpec animationSpec, Function1 function12, int i, DefaultConstructorMarker defaultConstructorMarker) {
        ...
        if ((i & 32) == 0) {
            ...
            function13 = new Function1<T, Boolean>() { // from class: androidx.compose.material.AnchoredDraggableState.2
                /* JADX WARN: Can't rename method to resolve collision */
                @Override // kotlin.jvm.functions.Function1
                public final Boolean invoke(T t) {
                    return true;
        ...
        this(obj, draggableAnchors, function1, function0, animationSpec, function13);
    }
    ...
    */
    public final Object anchoredDrag(MutatePriority dragPriority, Function3<? super AnchoredDragScope, ? super DraggableAnchors<T>, ? super Continuation<? super Unit>, ? extends Object> function3, Continuation<? super Unit> continuation) throws Throwable {
        C03421 c03421;
        ...
        if (continuation instanceof C03421) {
            ...
            if ((c03421.label & Integer.MIN_VALUE) != 0) {
                ...
                c03421 = new C03421(this, continuation);
            }
        }
        Object $result = c03421.result;
        ...
        switch (c03421.label) {
            case 0:
                ...
                try {
                    ...
                    C03432 c03432 = new C03432(this, function3, null);
                    c03421.L$0 = this;
                    c03421.label = 1;
                    if (internalMutatorMutex.mutate(dragPriority, c03432, c03421) == coroutine_suspended) {
            ...
            case 1:
                anchoredDraggableState = (AnchoredDraggableState) c03421.L$0;
                try {
                    ResultKt.throwOnFailure($result);
                    tClosestAnchor2 = anchoredDraggableState.getAnchors().closestAnchor(anchoredDraggableState.getOffset());
                    if (tClosestAnchor2 != null) {
    ...
    /* JADX INFO: renamed from: androidx.compose.material.AnchoredDraggableState$anchoredDrag$2, reason: invalid class name and case insensitive filesystem */
    /* JADX INFO: compiled from: AnchoredDraggable.kt */
    ...
    static final class C03432 extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C03432(AnchoredDraggableState<T> anchoredDraggableState, Function3<? super AnchoredDragScope, ? super DraggableAnchors<T>, ? super Continuation<? super Unit>, ? extends Object> function3, Continuation<? super C03432> continuation) {
        ...
        public final Continuation<Unit> create(Continuation<?> continuation) {
            return new C03432(this.this$0, this.$block, continuation);
        }

        @Override // kotlin.jvm.functions.Function1
        public final Object invoke(Continuation<? super Unit> continuation) {
            return ((C03432) create(continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        static final class C00442 extends SuspendLambda implements Function2<DraggableAnchors<T>, Continuation<? super Unit>, Object> {
            final /* synthetic */ Function3<AnchoredDragScope, DraggableAnchors<T>, Continuation<? super Unit>, Object> $block;
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            C00442(Function3<? super AnchoredDragScope, ? super DraggableAnchors<T>, ? super Continuation<? super Unit>, ? extends Object> function3, AnchoredDraggableState<T> anchoredDraggableState, Continuation<? super C00442> continuation) {
            ...
            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                C00442 c00442 = new C00442(this.$block, this.this$0, continuation);
                c00442.L$0 = obj;
                return c00442;
            }
            ...
            public final Object invoke(DraggableAnchors<T> draggableAnchors, Continuation<? super Unit> continuation) {
                return ((C00442) create(draggableAnchors, continuation)).invokeSuspend(Unit.INSTANCE);
            }
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    }, new C00442(this.$block, this.this$0, null), this) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    break;
                case 1:
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final Object anchoredDrag(T t, MutatePriority dragPriority, Function4<? super AnchoredDragScope, ? super DraggableAnchors<T>, ? super T, ? super Continuation<? super Unit>, ? extends Object> function4, Continuation<? super Unit> continuation) throws Throwable {
            ...
            case 0:
                ...
                if (getAnchors().hasAnchorFor(t)) {
                    try {
                        ...
                        if (internalMutatorMutex.mutate(dragPriority, anonymousClass4, anonymousClass3) == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                        anchoredDraggableState = this;
                        ...
                        Object targetValue = Unit.INSTANCE;
                        return targetValue;
                    } catch (Throwable th) {
                        th = th;
                        anchoredDraggableState = this;
                ...
                setCurrentValue(t);
                Object targetValue2 = Unit.INSTANCE;
                return targetValue2;
            case 1:
                ...
                try {
                    ...
                    Object targetValue22 = Unit.INSTANCE;
                    return targetValue22;
                } catch (Throwable th2) {
                    th = th2;
                    anchoredDraggableState.setDragTarget(null);
                    tClosestAnchor = anchoredDraggableState.getAnchors().closestAnchor(anchoredDraggableState.getOffset());
    ...
    static final class AnonymousClass4 extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
        ...
        static final class AnonymousClass2 extends SuspendLambda implements Function2<Pair<? extends DraggableAnchors<T>, ? extends T>, Continuation<? super Unit>, Object> {
            ...
            /*  JADX ERROR: JadxRuntimeException in pass: ModVisitor
                jadx.core.utils.exceptions.JadxRuntimeException: Can't change immutable type java.lang.Object to androidx.compose.material.AnchoredDraggableState$anchoredDrag$4$2 for r7v1 'this'  java.lang.Object
            ...
            public final java.lang.Object invokeSuspend(java.lang.Object r8) {
                ...
                L17:
                    ...
                    androidx.compose.material.DraggableAnchors r3 = (androidx.compose.material.DraggableAnchors) r3
                    java.lang.Object r2 = r2.component2()
                    kotlin.jvm.functions.Function4<androidx.compose.material.AnchoredDragScope, androidx.compose.material.DraggableAnchors<T>, T, kotlin.coroutines.Continuation<? super kotlin.Unit>, java.lang.Object> r4 = r1.$block
                    androidx.compose.material.AnchoredDraggableState<T> r5 = r1.this$0
                    androidx.compose.material.AnchoredDragScope r5 = androidx.compose.material.AnchoredDraggableState.access$getAnchoredDragScope$p(r5)
                    r6 = 1
                    r1.label = r6
                    java.lang.Object r2 = r4.invoke(r5, r3, r2, r1)
                    if (r2 != r0) goto L3b
                    return r0
                L3b:
                    r0 = r1
    ...
    /* JADX INFO: compiled from: AnchoredDraggable.kt */
    @Metadata(d1 = {"\u0000:\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0007\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002Jw\u0010\u0003\u001a\u0014\u0012\n\u0012\b\u0012\u0004\u0012\u0002H\u00060\u0005\u0012\u0004\u0012\u0002H\u00060\u0004\"\b\b\u0001\u0010\u0006*\u00020\u00012\f\u0010\u0007\u001a\b\u0012\u0004\u0012\u00020\t0\b2\u0012\u0010\n\u001a\u000e\u0012\u0004\u0012\u0002H\u0006\u0012\u0004\u0012\u00020\f0\u000b2!\u0010\r\u001a\u001d\u0012\u0013\u0012\u00110\t¢\u0006\f\b\u000e\u0012\b\b\u000f\u0012\u0004\b\b(\u0010\u0012\u0004\u0012\u00020\t0\u000b2\f\u0010\u0011\u001a\b\u0012\u0004\u0012\u00020\t0\u0012H\u0007¨\u0006\u0013"}, d2 = {"Landroidx/compose/material/AnchoredDraggableState$Companion;", "", "()V", "Saver", "Landroidx/compose/runtime/saveable/Saver;", "Landroidx/compose/material/AnchoredDraggableState;", ExifInterface.GPS_DIRECTION_TRUE, "animationSpec", "Landroidx/compose/animation/core/AnimationSpec;", "", "confirmValueChange", "Lkotlin/Function1;", "", "positionalThreshold", "Lkotlin/ParameterName;", HintConstants.AUTOFILL_HINT_NAME, "distance", "velocityThreshold", "Lkotlin/Function0;", "material_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
