...
final class RippleNodeFactory implements IndicationNodeFactory {
    ...
    private RippleNodeFactory(boolean bounded, float radius, ColorProducer colorProducer) {
        this(bounded, radius, colorProducer, Color.INSTANCE.m4733getUnspecified0d7_KjU());
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RippleNodeFactory) && this.bounded == ((RippleNodeFactory) other).bounded && Dp.m7510equalsimpl0(this.radius, ((RippleNodeFactory) other).radius) && Intrinsics.areEqual(this.colorProducer, ((RippleNodeFactory) other).colorProducer)) {
            return Color.m4698equalsimpl0(this.color, ((RippleNodeFactory) other).color);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        int result2 = ((result * 31) + Dp.m7511hashCodeimpl(this.radius)) * 31;
        ColorProducer colorProducer = this.colorProducer;
        return ((result2 + (colorProducer != null ? colorProducer.hashCode() : 0)) * 31) + Color.m4704hashCodeimpl(this.color);
    }
}
