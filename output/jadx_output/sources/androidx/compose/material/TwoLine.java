...
final class TwoLine {
    ...
    private static final float MinHeight = Dp.m7505constructorimpl(64);
    private static final float MinHeightWithIcon = Dp.m7505constructorimpl(72);
    ...
    private static final float IconVerticalPadding = Dp.m7505constructorimpl(16);
    ...
    private static final float OverlineBaselineOffset = Dp.m7505constructorimpl(24);
    private static final float OverlineToPrimaryBaselineOffset = Dp.m7505constructorimpl(20);
    private static final float PrimaryBaselineOffsetNoIcon = Dp.m7505constructorimpl(28);
    private static final float PrimaryBaselineOffsetWithIcon = Dp.m7505constructorimpl(32);
    private static final float PrimaryToSecondaryBaselineOffsetNoIcon = Dp.m7505constructorimpl(20);
    private static final float PrimaryToSecondaryBaselineOffsetWithIcon = Dp.m7505constructorimpl(20);
    ...
    public final void ListItem(Modifier modifier, final Function2<? super Composer, ? super Integer, Unit> function2, final Function2<? super Composer, ? super Integer, Unit> function22, final Function2<? super Composer, ? super Integer, Unit> function23, final Function2<? super Composer, ? super Integer, Unit> function24, final Function2<? super Composer, ? super Integer, Unit> function25, Composer $composer, final int $changed, final int i) {
        ...
        if ((599187 & $dirty2) != 599186 || !$composer3.getSkipping()) {
            ...
            Modifier modifier$iv = SizeKt.m852heightInVpY3zN4$default(modifier2, minHeight2, 0.0f, 2, null);
            ...
            Modifier columnModifier = PaddingKt.m822paddingqDBjuR0$default(RowScope.weight$default($this$ListItem_u24lambda_u241, Modifier.INSTANCE, 1.0f, false, 2, null), ContentLeftPadding, 0.0f, ContentRightPadding, 0.0f, 10, null);
            if (function2 != null) {
                ...
                Modifier modifier$iv2 = PaddingKt.m822paddingqDBjuR0$default(SizeKt.m868sizeInqDBjuR0$default(companion, Dp.m7505constructorimpl(arg0$iv + other$iv), minHeight3, 0.0f, 0.0f, 12, null), IconLeftPadding, IconVerticalPadding, 0.0f, IconVerticalPadding, 4, null);
            ...
            if (function24 != null) {
                ...
                ListItemKt.BaselinesOffsetColumn(CollectionsKt.listOf((Object[]) new Dp[]{Dp.m7503boximpl(OverlineBaselineOffset), Dp.m7503boximpl(OverlineToPrimaryBaselineOffset)}), columnModifier, ComposableLambdaKt.rememberComposableLambda(-1675021441, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TwoLine$ListItem$1$2
            ...
            if (function25 != null) {
                ...
                ListItemKt.m1854OffsetToBaselineOrCenterKz89ssw(f3, null, ComposableLambdaKt.rememberComposableLambda(-1696992176, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TwoLine$ListItem$1$4
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    /* JADX WARN: Multi-variable type inference failed */
                    {
                        super(2);
                    ...
                    public final void invoke(Composer $composer4, int $changed2) {
                        ...
                        if (($changed2 & 3) != 2 || !$composer4.getSkipping()) {
                            ...
                            Modifier modifier$iv3 = PaddingKt.m822paddingqDBjuR0$default(SizeKt.m852heightInVpY3zN4$default(Modifier.INSTANCE, minHeight, 0.0f, 2, null), 0.0f, 0.0f, TwoLine.TrailingRightPadding, 0.0f, 11, null);
