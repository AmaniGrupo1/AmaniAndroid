...
public final class RadioButtonKt {
    ...
    private static final float RadioButtonRippleRadius = Dp.m7505constructorimpl(24);
    private static final float RadioButtonPadding = Dp.m7505constructorimpl(2);
    private static final float RadioButtonSize = Dp.m7505constructorimpl(20);
    ...
    public static final void RadioButton(final boolean selected, final Function0<Unit> function0, Modifier modifier, boolean enabled, MutableInteractionSource interactionSource, RadioButtonColors colors, Composer $composer, final int $changed, final int i) {
        ...
        if ((196608 & $changed) == 0) {
            if ((i & 32) == 0) {
                ...
                int i6 = $composer2.changed(radioButtonColors) ? 131072 : 65536;
                $dirty3 |= i6;
            } else {
                radioButtonColors = colors;
            }
        ...
        if ((74899 & $dirty3) == 74898 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                MutableInteractionSource interactionSource4 = i5 != 0 ? null : mutableInteractionSource;
                if ((i & 32) != 0) {
                    RadioButtonColors colors5 = RadioButtonDefaults.INSTANCE.m1903colorsRGew2ao(0L, 0L, 0L, $composer2, 3072, 7);
                    $composer2 = $composer2;
                    modifier3 = modifier5;
                    enabled2 = enabled3;
            ...
            if (function0 != null) {
                ...
                z2 = false;
                $dirty2 = $dirty;
                selectableModifier = SelectableKt.m1088selectableO2vRcR0(Modifier.INSTANCE, selected, interactionSource2, RippleKt.m1911rippleOrFallbackImplementation9IZ8Weo(false, RadioButtonRippleRadius, 0L, $composer2, 54, 4), enabled2, Role.m6692boximpl(Role.INSTANCE.m6704getRadioButtono7Vup1c()), function0);
            ...
            Modifier modifierM856requiredSize3ABfNKs = SizeKt.m856requiredSize3ABfNKs(PaddingKt.m818padding3ABfNKs(SizeKt.wrapContentSize$default(modifier3.then(function0 != null ? InteractiveComponentSizeKt.minimumInteractiveComponentSize(Modifier.INSTANCE) : Modifier.INSTANCE).then(selectableModifier), Alignment.INSTANCE.getCenter(), z2, i2, obj), RadioButtonPadding), RadioButtonSize);
            ComposerKt.sourceInformationMarkerStart($composer2, 61091208, "CC(remember):RadioButton.kt#9igjgp");
            final State<Dp> state3 = state;
            boolean invalid$iv = $composer2.changed(state2) | $composer2.changed(state3);
            ...
            if (invalid$iv || it$iv == Composer.INSTANCE.getEmpty()) {
                value$iv = (Function1) new Function1<DrawScope, Unit>() { // from class: androidx.compose.material.RadioButtonKt$RadioButton$1$1
                    ...
                    public final void invoke2(DrawScope $this$Canvas) {
                        ...
                        float f = 2;
                        DrawScope.m5252drawCircleVaOC9Bg$default($this$Canvas, state2.getValue().m4707unboximpl(), $this$Canvas.mo405toPx0680j_4(RadioButtonKt.RadioRadius) - (strokeWidth / f), 0L, 0.0f, new Stroke(strokeWidth, 0.0f, 0, 0, null, 30, null), null, 0, AppCompatDelegate.FEATURE_SUPPORT_ACTION_BAR, null);
                        if (Dp.m7504compareTo0680j_4(state3.getValue().m7519unboximpl(), Dp.m7505constructorimpl(0)) > 0) {
                            DrawScope.m5252drawCircleVaOC9Bg$default($this$Canvas, state2.getValue().m4707unboximpl(), $this$Canvas.mo405toPx0680j_4(state3.getValue().m7519unboximpl()) - (strokeWidth / f), 0L, 0.0f, Fill.INSTANCE, null, 0, AppCompatDelegate.FEATURE_SUPPORT_ACTION_BAR, null);
                        }
                    }
                };
    ...
    static {
        ...
        RadioRadius = Dp.m7505constructorimpl(arg0$iv / 2);
        RadioButtonDotSize = Dp.m7505constructorimpl(12);
        RadioStrokeWidth = Dp.m7505constructorimpl(2);
    }
}
