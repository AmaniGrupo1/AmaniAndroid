...
public final class OutlinedTextFieldKt {
    ...
    public static final void OutlinedTextField(final String value, final Function1<? super String, Unit> function1, Modifier modifier, boolean enabled, boolean readOnly, TextStyle textStyle, Function2<? super Composer, ? super Integer, Unit> function2, Function2<? super Composer, ? super Integer, Unit> function22, Function2<? super Composer, ? super Integer, Unit> function23, Function2<? super Composer, ? super Integer, Unit> function24, boolean isError, VisualTransformation visualTransformation, KeyboardOptions keyboardOptions, KeyboardActions keyboardActions, boolean singleLine, int maxLines, int minLines, MutableInteractionSource interactionSource, Shape shape, TextFieldColors colors, Composer $composer, final int $changed, final int $changed1, final int i) {
        ...
        if (($changed1 & 805306368) == 0) {
            if ((i & 524288) == 0) {
                ...
                int i24 = $composer4.changed(textFieldColors) ? C.BUFFER_FLAG_LAST_SAMPLE : 268435456;
                $dirty1 = $dirty15 | i24;
            } else {
                $dirty15 = $dirty16;
                textFieldColors = colors;
        ...
        if (($dirty3 & 306783379) == 306783378 && ($dirty1 & 306783379) == 306783378 && $composer4.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer4.getDefaultsInvalid()) {
                ...
                if ((i & 524288) != 0) {
                    $composer2 = $composer4;
                    colors2 = TextFieldDefaults.INSTANCE.m1985outlinedTextFieldColorsdx8h9Zs(0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, $composer4, 0, 0, 48, 2097151);
            ...
            BasicTextFieldKt.BasicTextField(value, function1, SizeKt.m848defaultMinSizeVpY3zN4(TextFieldImplKt.defaultErrorSemantics(modifier3.then(function27 != null ? PaddingKt.m822paddingqDBjuR0$default(SemanticsModifierKt.semantics(Modifier.INSTANCE, true, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material.OutlinedTextFieldKt.OutlinedTextField.1
            ...
            }), 0.0f, density.mo400toDpGaN1DYA(OutlinedTextFieldTopPadding), 0.0f, 0.0f, 13, null) : Modifier.INSTANCE), isError2, Strings_androidKt.m1940getString4foXLRw(Strings.INSTANCE.m1935getDefaultErrorMessageUdPEhr4(), $composer2, 6)), TextFieldDefaults.INSTANCE.m1982getMinWidthD9Ej5fM(), TextFieldDefaults.INSTANCE.m1981getMinHeightD9Ej5fM()), enabled5, readOnly6, mergedTextStyle, keyboardOptions2, keyboardActions2, singleLine2, maxLines3, minLines2, visualTransformation2, (Function1<? super TextLayoutResult, Unit>) null, interactionSource3, new SolidColor(colors2.cursorColor(isError2, $composer2, ($dirty14 & 14) | (($dirty14 >> 24) & 112)).getValue().m4707unboximpl(), null), ComposableLambdaKt.rememberComposableLambda(1710364390, true, new Function3<Function2<? super Composer, ? super Integer, ? extends Unit>, Composer, Integer, Unit>() { // from class: androidx.compose.material.OutlinedTextFieldKt.OutlinedTextField.3
                ...
                public final void invoke(Function2<? super Composer, ? super Integer, Unit> function219, Composer $composer6, int $changed2) {
                    ...
                    int $dirty4 = $changed2;
                    if (($changed2 & 6) == 0) {
                        $dirty4 |= $composer6.changedInstance(function219) ? 4 : 2;
                    }
                    if (($dirty4 & 19) != 18 || !$composer6.getSkipping()) {
                        ...
                        textFieldDefaults.OutlinedTextFieldDecorationBox(str, function219, z, z2, visualTransformation6, mutableInteractionSource, z3, function220, function221, function222, function223, shape5, textFieldColors2, null, ComposableLambdaKt.rememberComposableLambda(1757478222, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.OutlinedTextFieldKt.OutlinedTextField.3.1
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            {
                                super(2);
                            }
                            ...
                            public final void invoke(Composer $composer7, int $changed3) {
                                ...
                                if (($changed3 & 3) != 2 || !$composer7.getSkipping()) {
                                    ...
                                    TextFieldDefaults.INSTANCE.m1979BorderBoxnbWgWpA(z4, z5, mutableInteractionSource2, textFieldColors3, shape6, 0.0f, 0.0f, $composer7, 12582912, 96);
                                    if (ComposerKt.isTraceInProgress()) {
    ...
    public static final /* synthetic */ void OutlinedTextField(final String value, final Function1 onValueChange, Modifier modifier, boolean enabled, boolean readOnly, TextStyle textStyle, Function2 label, Function2 placeholder, Function2 leadingIcon, Function2 trailingIcon, boolean isError, VisualTransformation visualTransformation, KeyboardOptions keyboardOptions, KeyboardActions keyboardActions, boolean singleLine, int maxLines, MutableInteractionSource interactionSource, Shape shape, TextFieldColors colors, Composer $composer, final int $changed, final int $changed1, final int i) {
        ...
        if (($changed1 & 100663296) == 0) {
            if ((i & 262144) == 0) {
                $dirty14 = $dirty15;
                textFieldColors = colors;
                int i24 = $composer3.changed(textFieldColors) ? 67108864 : 33554432;
                $dirty1 = $dirty14 | i24;
            } else {
                $dirty14 = $dirty15;
                textFieldColors = colors;
        ...
        if (($dirty3 & 306783379) == 306783378 && ($dirty1 & 38347923) == 38347922 && $composer3.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer3.getDefaultsInvalid()) {
                Modifier.Companion modifier6 = i10 != 0 ? Modifier.INSTANCE : modifier2;
                boolean enabled4 = i11 != 0 ? true : enabled2;
                boolean readOnly4 = i12 != 0 ? false : readOnly2;
                if ((i & 32) != 0) {
                    ProvidableCompositionLocal<TextStyle> localTextStyle = TextKt.getLocalTextStyle();
                    modifier3 = modifier6;
                ...
                if ((i & 262144) != 0) {
                    ...
                    textStyle4 = textStyle3;
                    enabled2 = enabled4;
                    colors2 = TextFieldDefaults.INSTANCE.m1985outlinedTextFieldColorsdx8h9Zs(0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, $composer2, 0, 0, 48, 2097151);
    ...
    public static final void OutlinedTextField(final TextFieldValue value, final Function1<? super TextFieldValue, Unit> function1, Modifier modifier, boolean enabled, boolean readOnly, TextStyle textStyle, Function2<? super Composer, ? super Integer, Unit> function2, Function2<? super Composer, ? super Integer, Unit> function22, Function2<? super Composer, ? super Integer, Unit> function23, Function2<? super Composer, ? super Integer, Unit> function24, boolean isError, VisualTransformation visualTransformation, KeyboardOptions keyboardOptions, KeyboardActions keyboardActions, boolean singleLine, int maxLines, int minLines, MutableInteractionSource interactionSource, Shape shape, TextFieldColors colors, Composer $composer, final int $changed, final int $changed1, final int i) {
        ...
        if (($changed1 & 100663296) == 0) {
            $dirty17 |= ((i & 262144) == 0 && $composer4.changed(shape)) ? 67108864 : 33554432;
        }
        if (($changed1 & 805306368) == 0) {
            if ((i & 524288) == 0) {
                $dirty16 = $dirty17;
        ...
        if (($dirty3 & 306783379) == 306783378 && (306783379 & $dirty1) == 306783378 && $composer4.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer4.getDefaultsInvalid()) {
                ...
                if ((i & 524288) != 0) {
                    TextFieldColors colors4 = TextFieldDefaults.INSTANCE.m1985outlinedTextFieldColorsdx8h9Zs(0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, $composer4, 0, 0, 48, 2097151);
                    $composer2 = $composer4;
                    keyboardActions3 = keyboardActions2;
            ...
            long $this$takeOrElse_u2dDxMtmZc$iv = textStyle4.m6958getColor0d7_KjU();
            if (!($this$takeOrElse_u2dDxMtmZc$iv != 16)) {
                $this$takeOrElse_u2dDxMtmZc$iv = colors2.textColor(enabled2, $composer2, (($dirty2 >> 9) & 14) | (($dirty15 >> 24) & 112)).getValue().m4707unboximpl();
            }
            $composer2.endReplaceGroup();
            long textColor = $this$takeOrElse_u2dDxMtmZc$iv;
            ...
            if (function27 != null) {
                ...
                companionM822paddingqDBjuR0$default = PaddingKt.m822paddingqDBjuR0$default(SemanticsModifierKt.semantics(Modifier.INSTANCE, true, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material.OutlinedTextFieldKt.OutlinedTextField.7
                    @Override // kotlin.jvm.functions.Function1
                    public /* bridge */ /* synthetic */ Unit invoke(SemanticsPropertyReceiver semanticsPropertyReceiver) {
                        invoke2(semanticsPropertyReceiver);
                        return Unit.INSTANCE;
                ...
                }), 0.0f, density.mo400toDpGaN1DYA(OutlinedTextFieldTopPadding), 0.0f, 0.0f, 13, null);
            } else {
                mergedTextStyle = mergedTextStyle2;
                companionM822paddingqDBjuR0$default = Modifier.INSTANCE;
            }
            Modifier modifierM848defaultMinSizeVpY3zN4 = SizeKt.m848defaultMinSizeVpY3zN4(TextFieldImplKt.defaultErrorSemantics(modifier3.then(companionM822paddingqDBjuR0$default), isError2, Strings_androidKt.m1940getString4foXLRw(Strings.INSTANCE.m1935getDefaultErrorMessageUdPEhr4(), $composer2, 6)), TextFieldDefaults.INSTANCE.m1982getMinWidthD9Ej5fM(), TextFieldDefaults.INSTANCE.m1981getMinHeightD9Ej5fM());
            SolidColor solidColor = new SolidColor(colors2.cursorColor(isError2, $composer2, ($dirty15 & 14) | (($dirty15 >> 24) & 112)).getValue().m4707unboximpl(), null);
            final boolean isError5 = isError2;
            ...
            ComposableLambda composableLambdaRememberComposableLambda = ComposableLambdaKt.rememberComposableLambda(-1001528775, true, new Function3<Function2<? super Composer, ? super Integer, ? extends Unit>, Composer, Integer, Unit>() { // from class: androidx.compose.material.OutlinedTextFieldKt.OutlinedTextField.9
                ...
                public final void invoke(Function2<? super Composer, ? super Integer, Unit> function219, Composer $composer5, int $changed2) {
                    ComposerKt.sourceInformation($composer5, "C424@20916L261,410@20321L870:OutlinedTextField.kt#jmzs0o");
                    int $dirty6 = $changed2;
                    if (($changed2 & 6) == 0) {
                        $dirty6 |= $composer5.changedInstance(function219) ? 4 : 2;
                    }
                    ...
                    final Shape shape6 = shape4;
                    textFieldDefaults.OutlinedTextFieldDecorationBox(text, function219, z, z2, visualTransformation6, mutableInteractionSource, z3, function220, function221, function222, function223, shape5, textFieldColors2, null, ComposableLambdaKt.rememberComposableLambda(-794566495, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.OutlinedTextFieldKt.OutlinedTextField.9.1
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        {
                            super(2);
                        }
                        ...
                        public final void invoke(Composer $composer6, int $changed3) {
                            ...
                            if (($changed3 & 3) != 2 || !$composer6.getSkipping()) {
                                ...
                                TextFieldDefaults.INSTANCE.m1979BorderBoxnbWgWpA(z4, z5, mutableInteractionSource2, textFieldColors3, shape6, 0.0f, 0.0f, $composer6, 12582912, 96);
                                if (ComposerKt.isTraceInProgress()) {
                                    ComposerKt.traceEventEnd();
                                    return;
                                }
            ...
            boolean readOnly6 = readOnly3;
            Composer $composer5 = $composer2;
            BasicTextFieldKt.BasicTextField(value, function1, modifierM848defaultMinSizeVpY3zN4, enabled5, readOnly6, mergedTextStyle, keyboardOptions2, keyboardActions3, singleLine2, maxLines3, minLines2, visualTransformation2, (Function1<? super TextLayoutResult, Unit>) null, interactionSource3, solidColor, composableLambdaRememberComposableLambda, $composer5, i24, i25, 4096);
            $composer3 = $composer5;
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
    ...
    public static final void OutlinedTextFieldLayout(final Modifier modifier, final Function2<? super Composer, ? super Integer, Unit> function2, final Function3<? super Modifier, ? super Composer, ? super Integer, Unit> function3, Function2<? super Composer, ? super Integer, Unit> function22, final Function2<? super Composer, ? super Integer, Unit> function23, final Function2<? super Composer, ? super Integer, Unit> function24, final boolean singleLine, final float animationProgress, final Function1<? super Size, Unit> function1, final Function2<? super Composer, ? super Integer, Unit> function25, final PaddingValues paddingValues, Composer $composer, final int $changed, final int $changed1) {
        ...
        if (($changed & 100663296) == 0) {
            $dirty |= $composer3.changedInstance(function1) ? 67108864 : 33554432;
        }
        if (($changed & 805306368) == 0) {
            $dirty |= $composer3.changedInstance(function25) ? C.BUFFER_FLAG_LAST_SAMPLE : 268435456;
        }
        if (($changed1 & 6) == 0) {
    ...
    public static final int m1880calculateWidthO3s9Psw(int leadingPlaceableWidth, int trailingPlaceableWidth, int textFieldPlaceableWidth, int labelPlaceableWidth, int placeholderPlaceableWidth, float animationProgress, long constraints, float density, PaddingValues paddingValues) {
    ...
    public static final int m1879calculateHeightO3s9Psw(int leadingPlaceableHeight, int trailingPlaceableHeight, int textFieldPlaceableHeight, int labelPlaceableHeight, int placeholderPlaceableHeight, float animationProgress, long constraints, float density, PaddingValues paddingValues) {
        ...
        return Math.max(Constraints.m7459getMinHeightimpl(constraints), Math.max(leadingPlaceableHeight, Math.max(trailingPlaceableHeight, MathKt.roundToInt(middleSectionHeight))));
    }
    ...
    public static final void place(Placeable.PlacementScope $this$place, int height, int width, Placeable leadingPlaceable, Placeable trailingPlaceable, Placeable textFieldPlaceable, Placeable labelPlaceable, Placeable placeholderPlaceable, Placeable borderPlaceable, float animationProgress, boolean singleLine, float density, LayoutDirection layoutDirection, PaddingValues paddingValues) {
        ...
        Placeable.PlacementScope.m6207place70tqf50$default($this$place, borderPlaceable, IntOffset.INSTANCE.m7644getZeronOccac(), 0.0f, 2, null);
    }

    /* JADX INFO: renamed from: outlineCutout-12SF9DM, reason: not valid java name */
    public static final Modifier m1881outlineCutout12SF9DM(Modifier $this$outlineCutout_u2d12SF9DM, final long labelSize, final PaddingValues paddingValues) {
        return DrawModifierKt.drawWithContent($this$outlineCutout_u2d12SF9DM, new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.material.OutlinedTextFieldKt$outlineCutout$1
            ...
            public final void invoke2(ContentDrawScope $this$drawWithContent) throws Throwable {
                ...
                float labelWidth = Size.m4521getWidthimpl(labelSize);
                if (labelWidth > 0.0f) {
                    ...
                    float labelHeight = Size.m4518getHeightimpl(labelSize);
