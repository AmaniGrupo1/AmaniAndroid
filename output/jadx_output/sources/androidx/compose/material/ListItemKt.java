...
public final class ListItemKt {
    public static final void ListItem(Modifier modifier, Function2<? super Composer, ? super Integer, Unit> function2, Function2<? super Composer, ? super Integer, Unit> function22, boolean singleLineSecondaryText, Function2<? super Composer, ? super Integer, Unit> function23, Function2<? super Composer, ? super Integer, Unit> function24, final Function2<? super Composer, ? super Integer, Unit> function25, Composer $composer, final int $changed, final int $dirty) {
        ...
        if (($dirty2 & 599187) == 599186 && $composer2.getSkipping()) {
            ...
            Function2<? super Composer, ? super Integer, Unit> function214 = i2 != 0 ? null : function26;
            function29 = i3 != 0 ? null : function27;
            singleLineSecondaryText2 = i4 != 0 ? true : z;
            function210 = i5 != 0 ? null : function28;
            ...
            Function2<Composer, Integer, Unit> function2ApplyTextStyle2 = applyTextStyle(typography.getBody2(), ContentAlpha.INSTANCE.getMedium($composer2, 6), function29);
            Function2<Composer, Integer, Unit> function2ApplyTextStyle3 = applyTextStyle(typography.getOverline(), ContentAlpha.INSTANCE.getHigh($composer2, 6), function210);
            Function2<Composer, Integer, Unit> function2ApplyTextStyle4 = applyTextStyle(typography.getCaption(), ContentAlpha.INSTANCE.getHigh($composer2, 6), function211);
            ...
            if (function2ApplyTextStyle2 == null && function2ApplyTextStyle3 == null) {
                ...
                OneLine.INSTANCE.ListItem(semanticsModifier, function212, function2ApplyTextStyle, function2ApplyTextStyle4, $composer2, ($dirty2 & 112) | 24576, 0);
                ...
                if ((function2ApplyTextStyle3 == null && singleLineSecondaryText2) || function2ApplyTextStyle2 == null) {
                    ...
                    TwoLine.INSTANCE.ListItem(semanticsModifier, function212, function2ApplyTextStyle, function2ApplyTextStyle2, function2ApplyTextStyle3, function2ApplyTextStyle4, $composer2, ($dirty2 & 112) | 1572864, 0);
                    $composer2 = $composer2;
                    $composer2.endReplaceGroup();
                } else {
                    $composer2.startReplaceGroup(-215503719);
                    ComposerKt.sourceInformation($composer2, "107@4490L184");
                    ThreeLine.INSTANCE.ListItem(semanticsModifier, function212, function2ApplyTextStyle, function2ApplyTextStyle2, function2ApplyTextStyle3, function2ApplyTextStyle4, $composer2, ($dirty2 & 112) | 1572864, 0);
                    $composer2 = $composer2;
                    $composer2.endReplaceGroup();
                }
            }
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            ...
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.ListItemKt.ListItem.1
                ...
                public final void invoke(Composer composer, int i7) {
                    ListItemKt.ListItem(modifier4, function213, function29, singleLineSecondaryText2, function210, function211, function25, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), $dirty);
                }
            });
        }
    }
        ...
        if (($dirty2 & 147) == 146 && $composer2.getSkipping()) {
            ...
            if (invalid$iv || it$iv == Composer.INSTANCE.getEmpty()) {
                value$iv = new MeasurePolicy() { // from class: androidx.compose.material.ListItemKt$BaselinesOffsetColumn$1$1
                    ...
                    public final MeasureResult mo41measure3p2s80s(MeasureScope $this$Layout, List<? extends Measurable> list2, long constraints) {
                        int containerHeight;
                        int toPreviousBaseline;
                        long childConstraints = Constraints.m7447copyZbe2FdA(constraints, (11 & 1) != 0 ? Constraints.m7460getMinWidthimpl(constraints) : 0, (11 & 2) != 0 ? Constraints.m7458getMaxWidthimpl(constraints) : 0, (11 & 4) != 0 ? Constraints.m7459getMinHeightimpl(constraints) : 0, (11 & 8) != 0 ? Constraints.m7457getMaxHeightimpl(constraints) : Integer.MAX_VALUE);
                        List target$iv = new ArrayList(list2.size());
                        int size = list2.size();
                        for (int index$iv$iv = 0; index$iv$iv < size; index$iv$iv++) {
                            Object item$iv$iv = list2.get(index$iv$iv);
                            Measurable it = (Measurable) item$iv$iv;
                            target$iv.add(it.mo6141measureBRTryo0(childConstraints));
                        }
                        ...
                        while (index$iv < size4) {
                            ...
                            if (index > 0) {
                                ...
                                containerHeight = containerHeight2;
                                toPreviousBaseline = i4;
                            }
                            int containerWidth2 = containerWidth;
                            int containerWidth3 = i4;
                            int topPadding = Math.max(containerWidth3, ($this$Layout.mo399roundToPx0680j_4(list3.get(index).m7519unboximpl()) - placeable.get(AlignmentLineKt.getFirstBaseline())) - toPreviousBaseline);
                        ...
                        return MeasureScope.layout$default($this$Layout, containerWidth, containerHeight2, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material.ListItemKt$BaselinesOffsetColumn$1$1.2
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            /* JADX WARN: Multi-variable type inference failed */
                            {
                                super(1);
    ...
    public static final void m1854OffsetToBaselineOrCenterKz89ssw(final float offset, Modifier modifier, final Function2<? super Composer, ? super Integer, Unit> function2, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        MeasurePolicy value$iv;
        final Modifier modifier3;
            ...
            if (invalid$iv || it$iv == Composer.INSTANCE.getEmpty()) {
                value$iv = new MeasurePolicy() { // from class: androidx.compose.material.ListItemKt$OffsetToBaselineOrCenter$1$1
                    ...
                    public final MeasureResult mo41measure3p2s80s(MeasureScope $this$Layout, List<? extends Measurable> list, long constraints) {
                        final int y;
                        int containerHeight;
                        final Placeable placeable = list.get(0).mo6141measureBRTryo0(Constraints.m7447copyZbe2FdA(constraints, (11 & 1) != 0 ? Constraints.m7460getMinWidthimpl(constraints) : 0, (11 & 2) != 0 ? Constraints.m7458getMaxWidthimpl(constraints) : 0, (11 & 4) != 0 ? Constraints.m7459getMinHeightimpl(constraints) : 0, (11 & 8) != 0 ? Constraints.m7457getMaxHeightimpl(constraints) : 0));
                        int baseline = placeable.get(AlignmentLineKt.getFirstBaseline());
                        if (baseline != Integer.MIN_VALUE) {
                            y = $this$Layout.mo399roundToPx0680j_4(offset) - baseline;
                            int y2 = Constraints.m7459getMinHeightimpl(constraints);
                            containerHeight = Math.max(y2, placeable.getHeight() + y);
                        } else {
                            int containerHeight2 = Math.max(Constraints.m7459getMinHeightimpl(constraints), placeable.getHeight());
                            y = IntOffset.m7634getYimpl(Alignment.INSTANCE.getCenter().mo4171alignKFBX0sM(IntSize.INSTANCE.m7681getZeroYbymL2g(), IntSizeKt.IntSize(0, containerHeight2 - placeable.getHeight()), $this$Layout.getLayoutDirection()));
                            containerHeight = containerHeight2;
                        }
                        return MeasureScope.layout$default($this$Layout, placeable.getWidth(), containerHeight, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material.ListItemKt$OffsetToBaselineOrCenter$1$1.1
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            {
                                super(1);
                            }
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.ListItemKt$OffsetToBaselineOrCenter$2
                ...
                public final void invoke(Composer composer, int i3) {
                    ListItemKt.m1854OffsetToBaselineOrCenterKz89ssw(offset, modifier3, function2, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    private static final Function2<Composer, Integer, Unit> applyTextStyle(final TextStyle textStyle, final float contentAlpha, final Function2<? super Composer, ? super Integer, Unit> function2) {
        ...
        final LineHeightStyle lineHeightStyle = new LineHeightStyle(LineHeightStyle.Alignment.INSTANCE.m7326getProportionalPIaL0Z0(), LineHeightStyle.Trim.INSTANCE.m7347getBothEVpEnUU(), (DefaultConstructorMarker) null);
                ...
                if (($changed & 3) != 2 || !$composer.getSkipping()) {
                    ...
                    CompositionLocalKt.CompositionLocalProvider(providedValueProvides, ComposableLambdaKt.rememberComposableLambda(1665877604, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.ListItemKt.applyTextStyle.1.1
                        ...
                        public final void invoke(Composer $composer2, int $changed2) {
                            ...
                            TextKt.ProvideTextStyle(TextStyle.m6941copyp1EtxEg$default(textStyle2, 0L, 0L, null, null, null, null, null, 0L, null, null, null, 0L, null, null, null, 0, 0, 0L, null, null, lineHeightStyle2, 0, 0, null, 15728639, null), function22, $composer2, 0);
                            if (ComposerKt.isTraceInProgress()) {
                                ComposerKt.traceEventEnd();
                            }
                        }
