...
final class DefaultButtonColors implements ButtonColors {
    ...
    public boolean equals(Object other) {
        ...
        if (Color.m4698equalsimpl0(this.backgroundColor, ((DefaultButtonColors) other).backgroundColor) && Color.m4698equalsimpl0(this.contentColor, ((DefaultButtonColors) other).contentColor) && Color.m4698equalsimpl0(this.disabledBackgroundColor, ((DefaultButtonColors) other).disabledBackgroundColor) && Color.m4698equalsimpl0(this.disabledContentColor, ((DefaultButtonColors) other).disabledContentColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (((((result * 31) + Color.m4704hashCodeimpl(this.contentColor)) * 31) + Color.m4704hashCodeimpl(this.disabledBackgroundColor)) * 31) + Color.m4704hashCodeimpl(this.disabledContentColor);
    }
}
