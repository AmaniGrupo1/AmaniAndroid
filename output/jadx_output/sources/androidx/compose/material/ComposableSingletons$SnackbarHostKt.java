...
public final class ComposableSingletons$SnackbarHostKt {
    ...
    public static Function3<SnackbarData, Composer, Integer, Unit> f75lambda1 = ComposableLambdaKt.composableLambdaInstance(996639038, false, new Function3<SnackbarData, Composer, Integer, Unit>() { // from class: androidx.compose.material.ComposableSingletons$SnackbarHostKt$lambda-1$1
        ...
        public final void invoke(SnackbarData it, Composer $composer, int $changed) {
            ...
            SnackbarKt.m1925SnackbarsPrSdHI(it, null, false, null, 0L, 0L, 0L, 0.0f, $composer, $dirty2 & 14, 254);
            if (ComposerKt.isTraceInProgress()) {
    ...
    public final Function3<SnackbarData, Composer, Integer, Unit> m1797getLambda1$material_release() {
        return f75lambda1;
    }
}
