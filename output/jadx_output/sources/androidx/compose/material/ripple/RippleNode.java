...
public abstract class RippleNode extends Modifier.Node implements CompositionLocalConsumerModifierNode, DrawModifierNode, LayoutAwareModifierNode {
    ...
    public abstract void mo2020addRipple12SF9DM(PressInteraction.Press interaction, long size, float targetRadius);
    ...
    public final long m2031getRippleColor0d7_KjU() {
        return this.color.mo1802invoke0d7_KjU();
    }
    ...
    public void mo394onRemeasuredozmzZPI(long size) {
        ...
        this.rippleSize = IntSizeKt.m7688toSizeozmzZPI(size);
        float $this$isUnspecified$iv = this.radius;
        this.targetRadius = Float.isNaN($this$isUnspecified$iv) ? RippleAnimationKt.m2024getRippleEndRadiuscSwnlzA(density, this.bounded, this.rippleSize) : density.mo405toPx0680j_4(this.radius);
    ...
    public final void handlePressInteraction(PressInteraction pressInteraction) {
        ...
        mo2020addRipple12SF9DM((PressInteraction.Press) pressInteraction, this.rippleSize, this.targetRadius);
    }
    ...
    public void draw(ContentDrawScope $this$draw) {
        ...
        if ($this$draw_u24lambda_u242 != null) {
            $this$draw_u24lambda_u242.m2036drawStateLayermxwnekA($this$draw, this.targetRadius, m2031getRippleColor0d7_KjU());
        }
