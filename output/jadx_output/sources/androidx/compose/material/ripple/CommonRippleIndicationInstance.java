...
final class CommonRippleIndicationInstance extends RippleIndicationInstance implements RememberObserver {
    ...
    public void drawIndication(ContentDrawScope $this$drawIndication) {
        float fM2024getRippleEndRadiuscSwnlzA;
        float $this$isUnspecified$iv = this.radius;
        if (Float.isNaN($this$isUnspecified$iv)) {
            fM2024getRippleEndRadiuscSwnlzA = RippleAnimationKt.m2024getRippleEndRadiuscSwnlzA($this$drawIndication, this.bounded, $this$drawIndication.mo5271getSizeNHjbRc());
        } else {
            fM2024getRippleEndRadiuscSwnlzA = $this$drawIndication.mo405toPx0680j_4(this.radius);
        }
        this.targetRadius = fM2024getRippleEndRadiuscSwnlzA;
        long color = this.color.getValue().m4707unboximpl();
        $this$drawIndication.drawContent();
        m2028drawStateLayerH2RKhps($this$drawIndication, this.radius, color);
        m2022drawRipples4WTKRHQ($this$drawIndication, color);
    }
    ...
    public void addRipple(PressInteraction.Press interaction, CoroutineScope scope) {
        ...
        Offset origin = this.bounded ? Offset.m4441boximpl(interaction.getPressPosition()) : null;
    ...
    private final void m2022drawRipples4WTKRHQ(DrawScope $this$drawRipples_u2d4WTKRHQ, long color) {
        Map $this$forEach$iv = this.ripples;
        Iterator<Map.Entry<PressInteraction.Press, RippleAnimation>> it = $this$forEach$iv.entrySet().iterator();
        while (it.hasNext()) {
            RippleAnimation ripple = it.next().getValue();
            ...
            if (!(alpha == 0.0f)) {
                ripple.m2023draw4WTKRHQ($this$drawRipples_u2d4WTKRHQ, Color.m4695copywmQWz5c(color, (14 & 1) != 0 ? Color.m4699getAlphaimpl(color) : alpha, (14 & 2) != 0 ? Color.m4703getRedimpl(color) : 0.0f, (14 & 4) != 0 ? Color.m4702getGreenimpl(color) : 0.0f, (14 & 8) != 0 ? Color.m4700getBlueimpl(color) : 0.0f));
            }
        }
    }
