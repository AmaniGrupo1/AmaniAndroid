...
public final class RippleAnimationKt {
    private static final float BoundedRippleExtraRadius = Dp.m7505constructorimpl(10);
    ...
    public static final float m2025getRippleStartRadiusuvyYCjk(long size) {
        return Math.max(Size.m4521getWidthimpl(size), Size.m4518getHeightimpl(size)) * 0.3f;
    }

    /* JADX INFO: renamed from: getRippleEndRadius-cSwnlzA, reason: not valid java name */
    public static final float m2024getRippleEndRadiuscSwnlzA(Density $this$getRippleEndRadius_u2dcSwnlzA, boolean bounded, long size) {
        float radiusCoveringBounds = Offset.m4450getDistanceimpl(OffsetKt.Offset(Size.m4521getWidthimpl(size), Size.m4518getHeightimpl(size))) / 2.0f;
        if (bounded) {
            return $this$getRippleEndRadius_u2dcSwnlzA.mo405toPx0680j_4(BoundedRippleExtraRadius) + radiusCoveringBounds;
        }
