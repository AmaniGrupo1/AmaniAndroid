...
public final class RippleKt {
    ...
    public static final DelegatableNode m2029createRippleModifierNodeTDGSqEk(InteractionSource interactionSource, boolean bounded, float radius, ColorProducer color, Function0<RippleAlpha> function0) {
        return Ripple_androidKt.m2035createPlatformRippleNodeTDGSqEk(interactionSource, bounded, radius, color, function0);
    }
    ...
    public static final Indication m2030rememberRipple9IZ8Weo(boolean bounded, float radius, long color, Composer $composer, int $changed, int i) {
        Object value$iv;
        ...
        if ((i & 2) != 0) {
            radius = Dp.INSTANCE.m7525getUnspecifiedD9Ej5fM();
        }
        if ((i & 4) != 0) {
            color = Color.INSTANCE.m4733getUnspecified0d7_KjU();
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1635163520, $changed, -1, "androidx.compose.material.ripple.rememberRipple (Ripple.kt:146)");
        }
        State colorState = SnapshotStateKt.rememberUpdatedState(Color.m4687boximpl(color), $composer, ($changed >> 6) & 14);
