...
final class StateLayer {
    ...
    public final void m2036drawStateLayermxwnekA(DrawScope $this$drawStateLayer_u2dmxwnekA, float radius, long color) {
        float alpha = this.animatedAlpha.getValue().floatValue();
        if (alpha > 0.0f) {
            long modulatedColor = Color.m4695copywmQWz5c(color, (14 & 1) != 0 ? Color.m4699getAlphaimpl(color) : alpha, (14 & 2) != 0 ? Color.m4703getRedimpl(color) : 0.0f, (14 & 4) != 0 ? Color.m4702getGreenimpl(color) : 0.0f, (14 & 8) != 0 ? Color.m4700getBlueimpl(color) : 0.0f);
            if (!this.bounded) {
                DrawScope.m5252drawCircleVaOC9Bg$default($this$drawStateLayer_u2dmxwnekA, modulatedColor, radius, 0L, 0.0f, null, null, 0, 124, null);
                return;
            }
            float right$iv = Size.m4521getWidthimpl($this$drawStateLayer_u2dmxwnekA.mo5271getSizeNHjbRc());
            float bottom$iv = Size.m4518getHeightimpl($this$drawStateLayer_u2dmxwnekA.mo5271getSizeNHjbRc());
            int clipOp$iv = ClipOp.INSTANCE.m4686getIntersectrtfAjoo();
            DrawContext $this$withTransform_u24lambda_u246$iv$iv = $this$drawStateLayer_u2dmxwnekA.getDrawContext();
