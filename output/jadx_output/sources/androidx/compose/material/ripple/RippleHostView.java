...
public final class RippleHostView extends View {
    ...
    public final void m2026addRippleKOepWvA(PressInteraction.Press interaction, boolean bounded, long size, int radius, long color, float alpha, Function0<Unit> onInvalidateRipple) {
        ...
        m2027setRippleProperties07v42R4(size, color, alpha);
        if (bounded) {
            ripple.setHotspot(Offset.m4452getXimpl(interaction.getPressPosition()), Offset.m4453getYimpl(interaction.getPressPosition()));
        } else {
    ...
    public final void m2027setRippleProperties07v42R4(long size, long color, float alpha) {
        UnprojectedRipple ripple = this.ripple;
        if (ripple == null) {
            return;
        }
        ripple.m2038setColorDxMtmZc(color, alpha);
        Rect newBounds = new Rect(0, 0, MathKt.roundToInt(Size.m4521getWidthimpl(size)), MathKt.roundToInt(Size.m4518getHeightimpl(size)));
    ...
    static final void setRippleState$lambda$2(RippleHostView this$0) {
