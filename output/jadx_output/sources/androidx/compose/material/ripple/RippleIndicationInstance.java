...
public abstract class RippleIndicationInstance implements IndicationInstance {
    ...
    public final void m2028drawStateLayerH2RKhps(DrawScope $this$drawStateLayer_u2dH2RKhps, float radius, long color) {
        float targetRadius;
        StateLayer $this$drawStateLayer_H2RKhps_u24lambda_u240 = this.stateLayer;
        if (Float.isNaN(radius)) {
            targetRadius = RippleAnimationKt.m2024getRippleEndRadiuscSwnlzA($this$drawStateLayer_u2dH2RKhps, this.bounded, $this$drawStateLayer_u2dH2RKhps.mo5271getSizeNHjbRc());
        } else {
            targetRadius = $this$drawStateLayer_u2dH2RKhps.mo405toPx0680j_4(radius);
        }
        $this$drawStateLayer_H2RKhps_u24lambda_u240.m2036drawStateLayermxwnekA($this$drawStateLayer_u2dH2RKhps, targetRadius, color);
    }
}
