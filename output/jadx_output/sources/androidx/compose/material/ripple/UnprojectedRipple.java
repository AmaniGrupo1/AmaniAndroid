...
final class UnprojectedRipple extends RippleDrawable {
    ...
    public final void m2038setColorDxMtmZc(long color, float alpha) {
        long newColor = m2037calculateRippleColor5vOe2sY(color, alpha);
        Color color2 = this.rippleColor;
        if (!(color2 == null ? false : Color.m4698equalsimpl0(color2.m4707unboximpl(), newColor))) {
            this.rippleColor = Color.m4687boximpl(newColor);
            setColor(ColorStateList.valueOf(ColorKt.m4751toArgb8_81llA(newColor)));
        }
    }
    ...
    private final long m2037calculateRippleColor5vOe2sY(long color, float alpha) {
        float f;
        ...
        return Color.m4695copywmQWz5c(color, (14 & 1) != 0 ? Color.m4699getAlphaimpl(color) : transformedAlpha, (14 & 2) != 0 ? Color.m4703getRedimpl(color) : 0.0f, (14 & 4) != 0 ? Color.m4702getGreenimpl(color) : 0.0f, (14 & 8) != 0 ? Color.m4700getBlueimpl(color) : 0.0f);
    }
