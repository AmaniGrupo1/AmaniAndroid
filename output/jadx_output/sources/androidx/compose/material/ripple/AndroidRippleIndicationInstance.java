...
public final class AndroidRippleIndicationInstance extends RippleIndicationInstance implements RememberObserver, RippleHostKey {
    ...
    private AndroidRippleIndicationInstance(boolean bounded, float radius, State<Color> state, State<RippleAlpha> state2, ViewGroup view) {
        ...
        this.rippleSize = Size.INSTANCE.m4530getZeroNHjbRc();
        this.rippleRadius = -1;
    ...
    public void drawIndication(ContentDrawScope $this$drawIndication) {
        int iRoundToInt;
        this.rippleSize = $this$drawIndication.mo5271getSizeNHjbRc();
        float $this$isUnspecified$iv = this.radius;
        if (Float.isNaN($this$isUnspecified$iv)) {
            iRoundToInt = MathKt.roundToInt(RippleAnimationKt.m2024getRippleEndRadiuscSwnlzA($this$drawIndication, this.bounded, $this$drawIndication.mo5271getSizeNHjbRc()));
        } else {
            iRoundToInt = $this$drawIndication.mo399roundToPx0680j_4(this.radius);
        }
        ...
        if ($this$drawIndication_u24lambda_u241_u24lambda_u240 != null) {
            $this$drawIndication_u24lambda_u241_u24lambda_u240.m2027setRippleProperties07v42R4($this$drawIndication.mo5271getSizeNHjbRc(), color, alpha);
    ...
    public void addRipple(PressInteraction.Press interaction, CoroutineScope scope) {
        ...
        $this$addRipple_u24lambda_u243_u24lambda_u242.m2026addRippleKOepWvA(interaction, this.bounded, this.rippleSize, this.rippleRadius, this.color.getValue().m4707unboximpl(), this.rippleAlpha.getValue().getPressedAlpha(), this.onInvalidateRipple);
