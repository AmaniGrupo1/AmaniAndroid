...
public final class Ripple_androidKt {
    ...
    public static final DelegatableNode m2035createPlatformRippleNodeTDGSqEk(InteractionSource interactionSource, boolean bounded, float radius, ColorProducer color, Function0<RippleAlpha> function0) {
        if (IsRunningInPreview) {
            return new CommonRippleNode(interactionSource, bounded, radius, color, function0, null);
        }
