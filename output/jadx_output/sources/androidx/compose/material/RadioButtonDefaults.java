...
public final class RadioButtonDefaults {
    ...
    public final RadioButtonColors m1903colorsRGew2ao(long selectedColor, long unselectedColor, long disabledColor, Composer $composer, int $changed, int i) {
        ...
        boolean invalid$iv = (((($changed & 14) ^ 6) > 4 && $composer.changed(selectedColor2)) || ($changed & 6) == 4) | (((($changed & 112) ^ 48) > 32 && $composer.changed(unselectedColor2)) || ($changed & 48) == 32) | (((($changed & 896) ^ RendererCapabilities.DECODER_SUPPORT_MASK) > 256 && $composer.changed(disabledColor2)) || ($changed & RendererCapabilities.DECODER_SUPPORT_MASK) == 256);
