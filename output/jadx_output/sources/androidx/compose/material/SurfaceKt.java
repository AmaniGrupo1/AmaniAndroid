...
public final class SurfaceKt {
    ...
    public static final void m1941SurfaceFjzlyU(Modifier modifier, Shape shape, long color, long contentColor, BorderStroke border, float elevation, final Function2<? super Composer, ? super Integer, Unit> function2, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        Shape shape2;
        long color2;
        long contentColor2;
        ...
        if (($dirty & 599187) == 599186 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if ((i & 4) != 0) {
                    color2 = MaterialTheme.INSTANCE.getColors($composer2, 6).m1763getSurface0d7_KjU();
                    $dirty &= -897;
                }
                if ((i & 8) != 0) {
                    contentColor2 = ColorsKt.m1777contentColorForek8zF_U(color2, $composer2, ($dirty >> 6) & 14);
                    $dirty &= -7169;
                }
                if (i6 != 0) {
                    border2 = null;
                ...
                if (i7 != 0) {
                    elevation2 = Dp.m7505constructorimpl(0);
                    modifier3 = modifier2;
                    shape3 = shape2;
                    color3 = color2;
                    border3 = border2;
            ...
            final float absoluteElevation = Dp.m7505constructorimpl(arg0$iv + elevation2);
            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m4687boximpl(contentColor2)), ElevationOverlayKt.getLocalAbsoluteElevation().provides(Dp.m7503boximpl(absoluteElevation))}, ComposableLambdaKt.rememberComposableLambda(-1822160838, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.SurfaceKt$Surface$1
                ...
                */
                public final void invoke(Composer $composer3, int $changed2) {
                    ...
                    int $changed$iv;
                    ComposerKt.sourceInformation($composer3, "C120@5770L7,118@5641L221,114@5505L739:Surface.kt#jmzs0o");
                    if (($changed2 & 3) != 2 || !$composer3.getSkipping()) {
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventStart(-1822160838, $changed2, -1, "androidx.compose.material.Surface.<anonymous> (Surface.kt:114)");
                        }
                        ...
                        Modifier modifier$iv = SemanticsModifierKt.semantics(SurfaceKt.m1947surface8ww4TTg(modifier5, shape5, SurfaceKt.m1948surfaceColorAtElevationcq6XJ1M(j, (ElevationOverlay) objConsume2, absoluteElevation, $composer3, 0), border3, elevation2), false, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material.SurfaceKt$Surface$1.1
                        ...
                        }).then(new SuspendPointerInputElement(Unit.INSTANCE, null, null, new SuspendingPointerInputFilterKt$sam$androidx_compose_ui_input_pointer_PointerInputEventHandler$0(new AnonymousClass2(null)), 6, null));
                        ...
                        if (!$this$Layout_u24lambda_u240$iv$iv.getInserting()) {
                            ...
                            ComposerKt.sourceInformationMarkerStart($composer3, -166711595, "C133@6225L9:Surface.kt#jmzs0o");
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.SurfaceKt$Surface$2
                ...
                public final void invoke(Composer composer, int i8) {
                    SurfaceKt.m1941SurfaceFjzlyU(modifier4, shape4, color4, contentColor3, border4, elevation3, function2, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    public static final void m1942SurfaceLPr_se0(final Function0<Unit> function0, Modifier modifier, boolean enabled, Shape shape, long color, long contentColor, BorderStroke border, float elevation, MutableInteractionSource interactionSource, final Function2<? super Composer, ? super Integer, Unit> function2, Composer $composer, final int $changed, final int i) {
        ...
        if (($changed & 24576) == 0) {
            if ((i & 16) == 0) {
                color2 = color;
                int i8 = $composer2.changed(color2) ? 16384 : 8192;
                $dirty2 |= i8;
            } else {
                color2 = color;
            }
        ...
        if ((196608 & $changed) == 0) {
            if ((i & 32) == 0) {
                i2 = i5;
                contentColor2 = contentColor;
                int i9 = $composer2.changed(contentColor2) ? 131072 : 65536;
                $dirty2 |= i9;
            } else {
                i2 = i5;
                contentColor2 = contentColor;
        ...
        if (i12 != 0) {
            ...
            i4 = i12;
            $dirty2 |= $composer2.changed(interactionSource) ? 67108864 : 33554432;
        } else {
            i4 = i12;
        }
        if ((i & 512) != 0) {
            ...
            $dirty2 |= $composer2.changedInstance(function2) ? C.BUFFER_FLAG_LAST_SAMPLE : 268435456;
        }
        int $dirty3 = $dirty2;
        if (($dirty2 & 306783379) == 306783378 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if ((i & 32) != 0) {
                    contentColor2 = ColorsKt.m1777contentColorForek8zF_U(color2, $composer2, ($dirty3 >> 12) & 14);
                    $dirty3 &= -458753;
                }
                BorderStroke border4 = i10 != 0 ? null : border;
                float elevation4 = i3 != 0 ? Dp.m7505constructorimpl(0) : elevation;
                if (i4 != 0) {
                    border2 = border4;
            ...
            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m4687boximpl(contentColor2)), ElevationOverlayKt.getLocalAbsoluteElevation().provides(Dp.m7503boximpl(absoluteElevation))}, ComposableLambdaKt.rememberComposableLambda(2031491085, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.SurfaceKt$Surface$3
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
                    super(2);
                ...
                */
                public final void invoke(Composer $composer3, int $changed2) {
                    ...
                    int $changed$iv;
                    ComposerKt.sourceInformation($composer3, "C231@11355L7,229@11226L221,239@11666L32,224@11039L843:Surface.kt#jmzs0o");
                    if (($changed2 & 3) != 2 || !$composer3.getSkipping()) {
                        if (ComposerKt.isTraceInProgress()) {
                        ...
                        Object objConsume2 = $composer3.consume(localElevationOverlay);
                        ComposerKt.sourceInformationMarkerEnd($composer3);
                        Modifier modifier$iv = ClickableKt.m294clickableO2vRcR0(SurfaceKt.m1947surface8ww4TTg(modifierMinimumInteractiveComponentSize, shape5, SurfaceKt.m1948surfaceColorAtElevationcq6XJ1M(j2, (ElevationOverlay) objConsume2, absoluteElevation, $composer3, 0), border2, elevation2), interactionSource2, RippleKt.m1911rippleOrFallbackImplementation9IZ8Weo(false, 0.0f, 0L, $composer3, 0, 7), (24 & 4) != 0 ? true : enabled3, (24 & 8) != 0 ? null : null, (24 & 16) != 0 ? null : null, function03);
                        Function2<Composer, Integer, Unit> function22 = function2;
                        ComposerKt.sourceInformationMarkerStart($composer3, 733328855, "CC(Box)P(2,1,3)72@3384L130:Box.kt#2w3rfo");
                        Alignment contentAlignment$iv = Alignment.INSTANCE.getTopStart();
                        MeasurePolicy measurePolicy$iv = BoxKt.maybeCachedBoxMeasurePolicy(contentAlignment$iv, true);
                        ...
                        if (!$this$Layout_u24lambda_u240$iv$iv.getInserting()) {
                            ...
                            ComposerKt.sourceInformationMarkerStart($composer3, -2146769399, "C73@3429L9:Box.kt#2w3rfo");
                            BoxScopeInstance boxScopeInstance = BoxScopeInstance.INSTANCE;
                            int i14 = (($changed$iv >> 6) & 112) | 6;
                            ComposerKt.sourceInformationMarkerStart($composer3, -161118699, "C245@11863L9:Surface.kt#jmzs0o");
                            function22.invoke($composer3, 0);
                            ComposerKt.sourceInformationMarkerEnd($composer3);
                            ComposerKt.sourceInformationMarkerEnd($composer3);
                            $composer3.endNode();
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.SurfaceKt$Surface$4
                ...
                public final void invoke(Composer composer, int i13) {
                    SurfaceKt.m1942SurfaceLPr_se0(function0, modifier3, enabled4, shape4, color4, contentColor3, border3, elevation3, interactionSource3, function2, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    public static final void m1943SurfaceNy5ogXk(final boolean selected, final Function0<Unit> function0, Modifier modifier, boolean enabled, Shape shape, long color, long contentColor, BorderStroke border, float elevation, MutableInteractionSource interactionSource, final Function2<? super Composer, ? super Integer, Unit> function2, Composer $composer, final int $changed, final int $changed1, final int i) {
        ...
        if (($changed & ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE) == 0) {
            if ((i & 32) == 0) {
                color2 = color;
                int i9 = $composer2.changed(color2) ? 131072 : 65536;
                $dirty4 |= i9;
            } else {
                color2 = color;
            }
        ...
        if (($changed & 1572864) == 0) {
            if ((i & 64) == 0) {
                $dirty3 = $dirty4;
                $dirty1 = $changed1;
                int i10 = $composer2.changed(contentColor) ? 1048576 : 524288;
                $dirty = $dirty3 | i10;
            } else {
                $dirty3 = $dirty4;
                $dirty1 = $changed1;
        ...
        if (i12 != 0) {
            ...
            i3 = i12;
            $dirty |= $composer2.changed(elevation) ? 67108864 : 33554432;
        } else {
            i3 = i12;
        }
        int i13 = i & 512;
        if (i13 != 0) {
            ...
            i4 = i13;
            $dirty |= $composer2.changed(interactionSource) ? C.BUFFER_FLAG_LAST_SAMPLE : 268435456;
        } else {
            i4 = i13;
        }
        if ((i & 1024) != 0) {
        ...
        if (($dirty & 306783379) == 306783378 && ($dirty12 & 3) == 2 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if ((i & 64) != 0) {
                    contentColor2 = ColorsKt.m1777contentColorForek8zF_U(color2, $composer2, ($dirty >> 15) & 14);
                    $dirty &= -3670017;
                } else {
                    contentColor2 = contentColor;
                }
            ...
            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m4687boximpl(contentColor2)), ElevationOverlayKt.getLocalAbsoluteElevation().provides(Dp.m7503boximpl(absoluteElevation))}, ComposableLambdaKt.rememberComposableLambda(-1391199439, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.SurfaceKt$Surface$5
                ...
                */
                public final void invoke(Composer $composer3, int $changed2) {
                    Function0<ComposeUiNode> function04;
                    int $changed$iv;
                    ComposerKt.sourceInformation($composer3, "C345@17081L7,343@16952L221,354@17434L32,338@16765L885:Surface.kt#jmzs0o");
                    if (($changed2 & 3) != 2 || !$composer3.getSkipping()) {
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventStart(-1391199439, $changed2, -1, "androidx.compose.material.Surface.<anonymous> (Surface.kt:338)");
                        }
                        ...
                        Object objConsume2 = $composer3.consume(localElevationOverlay);
                        ComposerKt.sourceInformationMarkerEnd($composer3);
                        Modifier modifier$iv = SelectableKt.m1089selectableO2vRcR0$default(SurfaceKt.m1947surface8ww4TTg(modifierMinimumInteractiveComponentSize, shape5, SurfaceKt.m1948surfaceColorAtElevationcq6XJ1M(j, (ElevationOverlay) objConsume2, absoluteElevation, $composer3, 0), border2, elevation2), z3, interactionSource2, RippleKt.m1911rippleOrFallbackImplementation9IZ8Weo(false, 0.0f, 0L, $composer3, 0, 7), enabled2, null, function03, 16, null);
                        Function2<Composer, Integer, Unit> function22 = function2;
                        ComposerKt.sourceInformationMarkerStart($composer3, 733328855, "CC(Box)P(2,1,3)72@3384L130:Box.kt#2w3rfo");
                        Alignment contentAlignment$iv = Alignment.INSTANCE.getTopStart();
                        MeasurePolicy measurePolicy$iv = BoxKt.maybeCachedBoxMeasurePolicy(contentAlignment$iv, true);
                        ...
                        if (!$this$Layout_u24lambda_u240$iv$iv.getInserting()) {
                            ...
                            ComposerKt.sourceInformationMarkerStart($composer3, -2146769399, "C73@3429L9:Box.kt#2w3rfo");
                            BoxScopeInstance boxScopeInstance = BoxScopeInstance.INSTANCE;
                            int i15 = (($changed$iv >> 6) & 112) | 6;
                            ComposerKt.sourceInformationMarkerStart($composer3, -155396843, "C360@17631L9:Surface.kt#jmzs0o");
                            function22.invoke($composer3, 0);
                            ComposerKt.sourceInformationMarkerEnd($composer3);
                            ComposerKt.sourceInformationMarkerEnd($composer3);
                            $composer3.endNode();
                        ...
                        $this$Layout_u24lambda_u240$iv$iv.apply(Integer.valueOf(compositeKeyHash$iv$iv), setCompositeKeyHash);
                        Updater.m3975setimpl($this$Layout_u24lambda_u240$iv$iv, materialized$iv$iv, ComposeUiNode.INSTANCE.getSetModifier());
                        int i142 = ($changed$iv$iv$iv >> 6) & 14;
                        ComposerKt.sourceInformationMarkerStart($composer3, -2146769399, "C73@3429L9:Box.kt#2w3rfo");
                        BoxScopeInstance boxScopeInstance2 = BoxScopeInstance.INSTANCE;
                        int i152 = (($changed$iv >> 6) & 112) | 6;
                        ComposerKt.sourceInformationMarkerStart($composer3, -155396843, "C360@17631L9:Surface.kt#jmzs0o");
                        function22.invoke($composer3, 0);
                        ComposerKt.sourceInformationMarkerEnd($composer3);
                        ComposerKt.sourceInformationMarkerEnd($composer3);
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.SurfaceKt$Surface$6
                ...
                public final void invoke(Composer composer, int i14) {
                    SurfaceKt.m1943SurfaceNy5ogXk(selected, function0, modifier4, enabled3, shape4, color2, contentColor3, border3, elevation3, interactionSource3, function2, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), RecomposeScopeImplKt.updateChangedFlags($changed1), i);
                }
            });
        }
    }
    ...
    /* JADX INFO: renamed from: Surface-Ny5ogXk, reason: not valid java name */
    public static final void m1944SurfaceNy5ogXk(final boolean checked, final Function1<? super Boolean, Unit> function1, Modifier modifier, boolean enabled, Shape shape, long color, long contentColor, BorderStroke border, float elevation, MutableInteractionSource interactionSource, final Function2<? super Composer, ? super Integer, Unit> function2, Composer $composer, final int $changed, final int $changed1, final int i) {
        boolean z;
        ...
        if (($dirty & 306783379) == 306783378 && ($dirty12 & 3) == 2 && $composer2.getSkipping()) {
            ...
            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m4687boximpl(contentColor2)), ElevationOverlayKt.getLocalAbsoluteElevation().provides(Dp.m7503boximpl(absoluteElevation))}, ComposableLambdaKt.rememberComposableLambda(-311657392, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.SurfaceKt$Surface$7
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
                    super(2);
                ...
                */
                public final void invoke(Composer $composer3, int $changed2) {
                    Function0<ComposeUiNode> function0;
                    int $changed$iv;
                    ComposerKt.sourceInformation($composer3, "C460@22924L7,458@22795L221,469@23273L32,453@22608L895:Surface.kt#jmzs0o");
                    if (($changed2 & 3) != 2 || !$composer3.getSkipping()) {
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventStart(-311657392, $changed2, -1, "androidx.compose.material.Surface.<anonymous> (Surface.kt:453)");
                        }
                        Modifier modifierMinimumInteractiveComponentSize = InteractiveComponentSizeKt.minimumInteractiveComponentSize(modifier5);
                        Shape shape5 = shape3;
                        long j = color3;
                        ...
                        Object objConsume2 = $composer3.consume(localElevationOverlay);
                        ComposerKt.sourceInformationMarkerEnd($composer3);
                        Modifier modifier$iv = ToggleableKt.m1096toggleableO2vRcR0$default(SurfaceKt.m1947surface8ww4TTg(modifierMinimumInteractiveComponentSize, shape5, SurfaceKt.m1948surfaceColorAtElevationcq6XJ1M(j, (ElevationOverlay) objConsume2, absoluteElevation, $composer3, 0), border2, elevation2), z3, interactionSource2, RippleKt.m1911rippleOrFallbackImplementation9IZ8Weo(false, 0.0f, 0L, $composer3, 0, 7), enabled2, null, function13, 16, null);
                        Function2<Composer, Integer, Unit> function22 = function2;
                        ComposerKt.sourceInformationMarkerStart($composer3, 733328855, "CC(Box)P(2,1,3)72@3384L130:Box.kt#2w3rfo");
                        Alignment contentAlignment$iv = Alignment.INSTANCE.getTopStart();
                        MeasurePolicy measurePolicy$iv = BoxKt.maybeCachedBoxMeasurePolicy(contentAlignment$iv, true);
                        ...
                        if (!$this$Layout_u24lambda_u240$iv$iv.getInserting()) {
                            ...
                            BoxScopeInstance boxScopeInstance = BoxScopeInstance.INSTANCE;
                            int i15 = (($changed$iv >> 6) & 112) | 6;
                            ComposerKt.sourceInformationMarkerStart($composer3, -149590667, "C475@23484L9:Surface.kt#jmzs0o");
                            function22.invoke($composer3, 0);
                            ComposerKt.sourceInformationMarkerEnd($composer3);
                            ComposerKt.sourceInformationMarkerEnd($composer3);
                            $composer3.endNode();
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.SurfaceKt$Surface$8
                ...
                public final void invoke(Composer composer, int i14) {
                    SurfaceKt.m1944SurfaceNy5ogXk(checked, function1, modifier4, enabled3, shape4, color2, contentColor3, border3, elevation3, interactionSource3, function2, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), RecomposeScopeImplKt.updateChangedFlags($changed1), i);
                }
            });
        }
    }
    ...
    public static final Modifier m1947surface8ww4TTg(Modifier $this$surface_u2d8ww4TTg, Shape shape, long backgroundColor, BorderStroke border, float elevation) {
        Modifier $this$surface_u2d8ww4TTg2 = ShadowKt.m4295shadows4CzXII$default($this$surface_u2d8ww4TTg, elevation, shape, false, 0L, 0L, 24, null);
        Modifier.Companion companionBorder = Modifier.INSTANCE;
        if (border != null) {
            companionBorder = BorderKt.border(companionBorder, border, shape);
        }
        return ClipKt.clip(BackgroundKt.m263backgroundbw27NRU($this$surface_u2d8ww4TTg2.then(companionBorder), backgroundColor, shape), shape);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: surfaceColorAtElevation-cq6XJ1M, reason: not valid java name */
    public static final long m1948surfaceColorAtElevationcq6XJ1M(long color, ElevationOverlay elevationOverlay, float absoluteElevation, Composer $composer, int $changed) {
        Composer $composer2;
        long color2;
        ...
        if (!Color.m4698equalsimpl0(color, MaterialTheme.INSTANCE.getColors($composer, 6).m1763getSurface0d7_KjU()) || elevationOverlay == null) {
            $composer2 = $composer;
            ...
            $composer2 = $composer;
            color2 = elevationOverlay.mo1801apply7g2Lkgo(color, absoluteElevation, $composer2, ($changed & 14) | (($changed >> 3) & 112) | (($changed << 3) & 896));
            $composer2.endReplaceGroup();
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
