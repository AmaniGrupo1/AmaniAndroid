...
public final class ContentAlpha {
    ...
    public final float getHigh(Composer $composer, int $changed) {
        ...
        float fContentAlpha = contentAlpha(1.0f, 0.87f, $composer, (($changed << 6) & 896) | 54);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final float getMedium(Composer $composer, int $changed) {
        ...
        float fContentAlpha = contentAlpha(0.74f, 0.6f, $composer, (($changed << 6) & 896) | 54);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd($composer);
    ...
    public final float getDisabled(Composer $composer, int $changed) {
        ...
        float fContentAlpha = contentAlpha(0.38f, 0.38f, $composer, (($changed << 6) & 896) | 54);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd($composer);
    ...
    private final float contentAlpha(float highContrastAlpha, float lowContrastAlpha, Composer $composer, int $changed) {
        ...
        float f = (!lightTheme ? ((double) ColorKt.m4749luminance8_81llA(contentColor)) < 0.5d : ((double) ColorKt.m4749luminance8_81llA(contentColor)) > 0.5d) ? lowContrastAlpha : highContrastAlpha;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd($composer);
