...
final class FloatingActionButtonElevationAnimatable {
    ...
    private final float m1846calculateTargetu2uoSUM(Interaction $this$calculateTarget_u2du2uoSUM) {
    ...
    public final Object m1847updateElevationlDy3nrA(float defaultElevation, float pressedElevation, float hoveredElevation, float focusedElevation, Continuation<? super Unit> continuation) throws Throwable {
        this.defaultElevation = defaultElevation;
        this.pressedElevation = pressedElevation;
        this.hoveredElevation = hoveredElevation;
        this.focusedElevation = focusedElevation;
    ...
    */
    public final Object snapElevation(Continuation<? super Unit> continuation) throws Throwable {
        ...
        Object $result = c03551.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        switch (c03551.label) {
            case 0:
                ResultKt.throwOnFailure($result);
                float target = m1846calculateTargetu2uoSUM(this.targetInteraction);
                if (!Dp.m7510equalsimpl0(this.animatable.getTargetValue().m7519unboximpl(), target)) {
                    try {
                        ...
                        c03551.L$0 = this;
                        c03551.label = 1;
                        if (animatable.snapTo(dpM7503boximpl, c03551) == coroutine_suspended) {
            ...
            case 1:
                floatingActionButtonElevationAnimatable = (FloatingActionButtonElevationAnimatable) c03551.L$0;
                try {
                    ResultKt.throwOnFailure($result);
                    floatingActionButtonElevationAnimatable.lastTargetInteraction = floatingActionButtonElevationAnimatable.targetInteraction;
                    return Unit.INSTANCE;
    ...
    public final Object animateElevation(Interaction to, Continuation<? super Unit> continuation) throws Throwable {
        ...
        switch (anonymousClass1.label) {
            case 0:
                ResultKt.throwOnFailure($result);
                floatingActionButtonElevationAnimatable = this;
                float target = floatingActionButtonElevationAnimatable.m1846calculateTargetu2uoSUM(to);
                ...
                try {
                    if (!Dp.m7510equalsimpl0(floatingActionButtonElevationAnimatable.animatable.getTargetValue().m7519unboximpl(), target)) {
                        ...
                        if (ElevationKt.m1824animateElevationrAjV9yQ(animatable, target, interaction, to, anonymousClass1) == coroutine_suspended) {
                            return coroutine_suspended;
                        }
