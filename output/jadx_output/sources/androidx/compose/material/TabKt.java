...
public final class TabKt {
    ...
    public static final void m1958Tab0nDMI0(final boolean selected, final Function0<Unit> function0, Modifier modifier, boolean enabled, Function2<? super Composer, ? super Integer, Unit> function2, Function2<? super Composer, ? super Integer, Unit> function22, MutableInteractionSource interactionSource, long selectedContentColor, long unselectedContentColor, Composer $composer, final int $changed, final int i) {
        boolean z;
        ...
        if (i6 != 0) {
            ...
            function23 = function2;
            $dirty6 |= $composer3.changedInstance(function23) ? 16384 : 8192;
        } else {
            function23 = function2;
        }
        int i7 = i & 32;
        ...
        if (($changed & 12582912) == 0) {
            if ((i & 128) == 0) {
                $dirty5 = $dirty6;
                i2 = i4;
                int i9 = $composer3.changed(selectedContentColor) ? 8388608 : 4194304;
                $dirty = $dirty5 | i9;
            } else {
                $dirty5 = $dirty6;
                i2 = i4;
        ...
        if (($changed & 100663296) == 0) {
            $dirty |= ((i & 256) == 0 && $composer3.changed(unselectedContentColor)) ? 67108864 : 33554432;
        }
        int $dirty7 = $dirty;
        if (($dirty7 & 38347923) == 38347922 && $composer3.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer3.getDefaultsInvalid()) {
                ...
                if ((i & 128) != 0) {
                    ...
                    long selectedContentColor5 = ((Color) objConsume).m4707unboximpl();
                    $dirty2 = $dirty7 & (-29360129);
                ...
                $composer3.skipToGroupEnd();
                $dirty3 = (i & 128) != 0 ? $dirty7 & (-29360129) : $dirty7;
                if ((i & 256) != 0) {
                    $dirty3 &= -234881025;
                ...
                Function2 it = ComposableLambdaKt.rememberComposableLambda(-1729014781, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabKt$Tab$styledText$1$1
                    ...
                    public final void invoke(Composer $composer4, int $changed2) {
                        ...
                        if (($changed2 & 3) != 2 || !$composer4.getSkipping()) {
                            ...
                            TextStyle style = TextStyle.m6941copyp1EtxEg$default(MaterialTheme.INSTANCE.getTypography($composer4, 6).getButton(), 0L, 0L, null, null, null, null, null, 0L, null, null, null, 0L, null, null, null, TextAlign.INSTANCE.m7358getCentere0LSkKk(), 0, 0L, null, null, null, 0, 0, null, 16744447, null);
            ...
            m1959TabEVJuX4I(z, function02, modifier4, enabled3, interactionSource2, selectedContentColor3, unselectedContentColor2, ComposableLambdaKt.rememberComposableLambda(-178151495, true, new Function3<ColumnScope, Composer, Integer, Unit>() { // from class: androidx.compose.material.TabKt$Tab$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
                    super(3);
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabKt$Tab$2
                ...
                public final void invoke(Composer composer, int i10) {
                    TabKt.m1958Tab0nDMI0(selected, function0, modifier3, enabled4, function25, function26, interactionSource3, selectedContentColor4, unselectedContentColor3, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    public static final void m1957LeadingIconTab0nDMI0(final boolean selected, final Function0<Unit> function0, final Function2<? super Composer, ? super Integer, Unit> function2, final Function2<? super Composer, ? super Integer, Unit> function22, Modifier modifier, boolean enabled, MutableInteractionSource interactionSource, long selectedContentColor, long unselectedContentColor, Composer $composer, final int $changed, final int i) {
        Function0<Unit> function02;
        ...
        if ((12582912 & $changed) == 0) {
            if ((i & 128) == 0) {
                $dirty3 = $dirty4;
                int i5 = $composer3.changed(selectedContentColor) ? 8388608 : 4194304;
                $dirty = $dirty3 | i5;
            } else {
                $dirty3 = $dirty4;
            }
        ...
        if ((38347923 & $dirty) == 38347922 && $composer3.getSkipping()) {
            ...
            final Indication ripple = RippleKt.m1911rippleOrFallbackImplementation9IZ8Weo(true, 0.0f, selectedContentColor4, $composer3, 6 | (($dirty2 >> 15) & 896), 2);
            ...
            m1960TabTransitionKlgxPg(selectedContentColor4, unselectedContentColor4, selected, ComposableLambdaKt.rememberComposableLambda(866677691, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabKt$LeadingIconTab$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
                    super(2);
                ...
                public final void invoke(Composer $composer4, int $changed2) {
                    ...
                    ComposerKt.sourceInformation($composer4, "C167@7354L843:Tab.kt#jmzs0o");
                    if (($changed2 & 3) != 2 || !$composer4.getSkipping()) {
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventStart(866677691, $changed2, -1, "androidx.compose.material.LeadingIconTab.<anonymous> (Tab.kt:167)");
                        }
                        Modifier modifier$iv = SizeKt.fillMaxWidth$default(PaddingKt.m820paddingVpY3zN4$default(SelectableKt.m1088selectableO2vRcR0(SizeKt.m850height3ABfNKs(modifier3, TabKt.SmallTabHeight), selected, interactionSource3, ripple, enabled3, Role.m6692boximpl(Role.INSTANCE.m6706getTabo7Vup1c()), function03), TabKt.HorizontalTextPadding, 0.0f, 2, null), 0.0f, 1, null);
                        ...
                        int i7 = ((432 >> 6) & 112) | 6;
                        ComposerKt.sourceInformationMarkerStart($composer4, -358051860, "C183@7966L6,184@7985L59,185@8083L10,186@8148L39:Tab.kt#jmzs0o");
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabKt$LeadingIconTab$2
                ...
                public final void invoke(Composer composer, int i6) {
                    TabKt.m1957LeadingIconTab0nDMI0(selected, function0, function2, function22, modifier4, enabled4, interactionSource4, selectedContentColor3, unselectedContentColor3, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    public static final void m1959TabEVJuX4I(final boolean selected, final Function0<Unit> function0, Modifier modifier, boolean enabled, MutableInteractionSource interactionSource, long selectedContentColor, long unselectedContentColor, final Function3<? super ColumnScope, ? super Composer, ? super Integer, Unit> function3, Composer $composer, final int $changed, final int i) {
        boolean z;
        Modifier modifier2;
        boolean enabled2;
        MutableInteractionSource interactionSource2;
        ...
        if ((196608 & $changed) == 0) {
            if ((i & 32) == 0) {
                ...
                int i5 = $composer3.changed(j) ? 131072 : 65536;
                $dirty4 |= i5;
            } else {
                j = selectedContentColor;
            }
        ...
        if ((1572864 & $changed) == 0) {
            if ((i & 64) == 0) {
                $dirty3 = $dirty4;
                int i6 = $composer3.changed(unselectedContentColor) ? 1048576 : 524288;
                $dirty = $dirty3 | i6;
            } else {
                $dirty3 = $dirty4;
            }
        ...
        if (($dirty & 4793491) == 4793490 && $composer3.getSkipping()) {
            ...
            long selectedContentColor4 = selectedContentColor2;
            final Indication ripple = RippleKt.m1911rippleOrFallbackImplementation9IZ8Weo(true, 0.0f, selectedContentColor4, $composer3, (($dirty2 >> 9) & 896) | 6, 2);
            final Function3<? super ColumnScope, ? super Composer, ? super Integer, Unit> function33 = function32;
            final boolean z2 = z;
            m1960TabTransitionKlgxPg(selectedContentColor4, unselectedContentColor2, selected, ComposableLambdaKt.rememberComposableLambda(-1237246709, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabKt$Tab$3
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
                    super(2);
                ...
                public final void invoke(Composer $composer4, int $changed2) {
                    ComposerKt.sourceInformation($composer4, "C237@10538L532:Tab.kt#jmzs0o");
                    if (($changed2 & 3) != 2 || !$composer4.getSkipping()) {
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventStart(-1237246709, $changed2, -1, "androidx.compose.material.Tab.<anonymous> (Tab.kt:237)");
                        }
                        Modifier modifierFillMaxWidth$default = SizeKt.fillMaxWidth$default(SelectableKt.m1088selectableO2vRcR0(modifier3, z2, interactionSource3, ripple, enabled3, Role.m6692boximpl(Role.INSTANCE.m6706getTabo7Vup1c()), function0), 0.0f, 1, null);
                        ...
                        function34.invoke(ColumnScopeInstance.INSTANCE, $composer4, Integer.valueOf(((432 >> 6) & 112) | 6));
                        ComposerKt.sourceInformationMarkerEnd($composer4);
                        $composer4.endNode();
                        ComposerKt.sourceInformationMarkerEnd($composer4);
                        ComposerKt.sourceInformationMarkerEnd($composer4);
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabKt$Tab$4
                ...
                public final void invoke(Composer composer, int i8) {
                    TabKt.m1959TabEVJuX4I(selected, function0, modifier4, enabled4, interactionSource4, selectedContentColor3, unselectedContentColor3, function3, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    public static final void m1960TabTransitionKlgxPg(long activeColor, final long inactiveColor, final boolean selected, final Function2<? super Composer, ? super Integer, Unit> function2, Composer $composer, final int $changed) {
        long j;
        long j2;
        boolean z;
        int $dirty;
        ...
        int $changed$iv$iv;
        Composer $composer2;
        Composer $composer3 = $composer.startRestartGroup(-405571117);
        ComposerKt.sourceInformation($composer3, "C(TabTransition)P(0:c#ui.graphics.Color,2:c#ui.graphics.Color,3)267@11507L26,268@11562L550,286@12117L164:Tab.kt#jmzs0o");
        int $dirty2 = $changed;
        if (($changed & 6) == 0) {
            j = activeColor;
        ...
        if (($dirty2 & 1171) == 1170 && $composer3.getSkipping()) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-405571117, $dirty2, -1, "androidx.compose.material.TabTransition (Tab.kt:266)");
            }
            ...
            Function3 transitionSpec$iv = new Function3<Transition.Segment<Boolean>, Composer, Integer, FiniteAnimationSpec<Color>>() { // from class: androidx.compose.material.TabKt$TabTransition$color$2
                ...
                public final FiniteAnimationSpec<Color> invoke(Transition.Segment<Boolean> segment, Composer $composer4, int $changed2) {
                    ...
                    $composer4.startReplaceGroup(-2120892502);
                    if (ComposerKt.isTraceInProgress()) {
            ...
            ComposerKt.sourceInformationMarkerStart($composer3, -1939694975, "CC(animateColor)P(2)68@3220L31,69@3287L70,73@3370L70:Transition.kt#xbi5r1");
            int $changed2 = (0 >> 6) & 112;
            boolean it = ((Boolean) transition.getTargetState()).booleanValue();
            $composer3.startReplaceGroup(1445938070);
            ...
            ComposerKt.sourceInformationMarkerStart($composer3, 1918408083, "CC(remember):Transition.kt#9igjgp");
            ...
            ComposerKt.sourceInformationMarkerEnd($composer2);
            ProvidableCompositionLocal<Color> localContentColor = ContentColorKt.getLocalContentColor();
            long jTabTransition_Klgx_Pg$lambda$2 = TabTransition_Klgx_Pg$lambda$2(color$delegate);
            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{localContentColor.provides(Color.m4687boximpl(Color.m4695copywmQWz5c(jTabTransition_Klgx_Pg$lambda$2, (14 & 1) != 0 ? Color.m4699getAlphaimpl(jTabTransition_Klgx_Pg$lambda$2) : 1.0f, (14 & 2) != 0 ? Color.m4703getRedimpl(jTabTransition_Klgx_Pg$lambda$2) : 0.0f, (14 & 4) != 0 ? Color.m4702getGreenimpl(jTabTransition_Klgx_Pg$lambda$2) : 0.0f, (14 & 8) != 0 ? Color.m4700getBlueimpl(jTabTransition_Klgx_Pg$lambda$2) : 0.0f))), ContentAlphaKt.getLocalContentAlpha().provides(Float.valueOf(Color.m4699getAlphaimpl(TabTransition_Klgx_Pg$lambda$2(color$delegate))))}, function2, $composer2, ProvidedValue.$stable | (($dirty >> 6) & 112));
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            ...
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabKt$TabTransition$1
                ...
                public final void invoke(Composer composer, int i) {
                    TabKt.m1960TabTransitionKlgxPg(j6, inactiveColor, selected, function2, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1));
                }
            });
        }
    }
    ...
    */
    public static final void TabBaselineLayout(final Function2<? super Composer, ? super Integer, Unit> function2, final Function2<? super Composer, ? super Integer, Unit> function22, Composer $composer, final int $changed) {
        ...
        ComposerKt.sourceInformation($composer3, "C(TabBaselineLayout)P(1)314@13013L1593,303@12689L1917:Tab.kt#jmzs0o");
        int $dirty2 = $changed;
        if (($changed & 6) == 0) {
        ...
        if (($dirty2 & 19) != 18 || !$composer3.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(1249848471, $dirty2, -1, "androidx.compose.material.TabBaselineLayout (Tab.kt:302)");
            }
            ComposerKt.sourceInformationMarkerStart($composer3, 1014675191, "CC(remember):Tab.kt#9igjgp");
            boolean invalid$iv = (($dirty2 & 14) == 4) | (($dirty2 & 112) == 32);
            Object it$iv = $composer3.rememberedValue();
            if (invalid$iv || it$iv == Composer.INSTANCE.getEmpty()) {
                value$iv = new MeasurePolicy() { // from class: androidx.compose.material.TabKt$TabBaselineLayout$2$1
                    ...
                    public final MeasureResult mo41measure3p2s80s(final MeasureScope $this$Layout, List<? extends Measurable> list, long constraints) {
                        ...
                        final Placeable textPlaceable = placeableMo6141measureBRTryo0;
                        ...
                        final int tabHeight = $this$Layout.mo399roundToPx0680j_4((textPlaceable == null || iconPlaceable == null) ? TabKt.SmallTabHeight : TabKt.LargeTabHeight);
                        ...
                        return MeasureScope.layout$default($this$Layout, tabWidth, tabHeight, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material.TabKt$TabBaselineLayout$2$1.1
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            {
                                super(1);
                            }
            ...
            if ($this$Layout_u24lambda_u240$iv.getInserting()) {
                ...
                ComposerKt.sourceInformationMarkerStart($composer2, -238768079, "C:Tab.kt#jmzs0o");
                if (function2 == null) {
                    $composer2.startReplaceGroup(-238754006);
                    ComposerKt.sourceInformation($composer2, "306@12755L123");
                    ...
                    int i3 = ((6 >> 6) & 112) | 6;
                    ComposerKt.sourceInformationMarkerStart($composer2, 138815969, "C308@12870L6:Tab.kt#jmzs0o");
                    ...
                    $composer2.startReplaceGroup(-238605051);
                    $composer2.endReplaceGroup();
                }
                if (function22 == null) {
                    $composer2.startReplaceGroup(-238572036);
                    ComposerKt.sourceInformation($composer2, "311@12941L41");
                    ...
                    if ($this$Layout_u24lambda_u240$iv$iv2.getInserting()) {
                        ...
                        ComposerKt.sourceInformationMarkerStart($composer2, 138919137, "C311@12974L6:Tab.kt#jmzs0o");
                    ...
                    $composer2.startReplaceGroup(-238501883);
                    $composer2.endReplaceGroup();
                }
                ComposerKt.sourceInformationMarkerEnd($composer2);
                $composer2.endNode();
    ...
    public static final void placeTextAndIcon(Placeable.PlacementScope $this$placeTextAndIcon, Density density, Placeable textPlaceable, Placeable iconPlaceable, int tabWidth, int tabHeight, int firstBaseline, int lastBaseline) {
        ...
        int textOffset = density.mo399roundToPx0680j_4(baselineOffset) + density.mo399roundToPx0680j_4(TabRowDefaults.INSTANCE.m1968getIndicatorHeightD9Ej5fM());
