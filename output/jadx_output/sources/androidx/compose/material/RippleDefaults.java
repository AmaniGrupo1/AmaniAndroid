...
public final class RippleDefaults {
    ...
    public final long m1906rippleColor5vOe2sY(long contentColor, boolean lightTheme) {
    ...
    public final RippleAlpha m1905rippleAlphaDxMtmZc(long contentColor, boolean lightTheme) {
        if (lightTheme) {
            return ((double) ColorKt.m4749luminance8_81llA(contentColor)) > 0.5d ? RippleKt.LightThemeHighContrastRippleAlpha : RippleKt.LightThemeLowContrastRippleAlpha;
        }
