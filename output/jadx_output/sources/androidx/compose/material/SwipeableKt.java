...
public final class SwipeableKt {
    ...
    public static final <T> SwipeableState<T> rememberSwipeableState(final T t, final AnimationSpec<Float> animationSpec, final Function1<? super T, Boolean> function1, Composer $composer, int $changed, int i) {
        ...
        boolean invalid$iv = (((($changed & 896) ^ RendererCapabilities.DECODER_SUPPORT_MASK) > 256 && $composer.changed(function1)) || ($changed & RendererCapabilities.DECODER_SUPPORT_MASK) == 256) | (((($changed & 14) ^ 6) > 4 && $composer.changedInstance(t)) || ($changed & 6) == 4) | $composer.changedInstance(animationSpec);
        ...
        SwipeableState<T> swipeableState = (SwipeableState) RememberSaveableKt.m4137rememberSaveable(objArr, (Saver) Saver, (String) null, (Function0) value$iv, $composer, 0, 4);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static final <T> SwipeableState<T> rememberSwipeableStateFor(final T t, final Function1<? super T, Unit> function1, AnimationSpec<Float> animationSpec, Composer $composer, int $changed, int i) {
        ...
        final SwipeableState<T> swipeableState = (SwipeableState) value$iv;
        ComposerKt.sourceInformationMarkerEnd($composer);
    ...
    public static final <T> Modifier m1951swipeablepPrIpRY(Modifier $this$swipeable_u2dpPrIpRY, final SwipeableState<T> swipeableState, final Map<Float, ? extends T> map, final Orientation orientation, final boolean enabled, final boolean reverseDirection, final MutableInteractionSource interactionSource, final Function2<? super T, ? super T, ? extends ThresholdConfig> function2, final ResistanceConfig resistance, final float velocityThreshold) {
        return ComposedModifierKt.composed($this$swipeable_u2dpPrIpRY, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.material.SwipeableKt$swipeable-pPrIpRY$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo $this$null) {
                ...
                $this$null.getProperties().set("velocityThreshold", Dp.m7503boximpl(velocityThreshold));
            }
            ...
            public final Modifier invoke(Modifier $this$composed, Composer $composer, int $changed) {
                ...
                ComposerKt.sourceInformationMarkerEnd($composer);
                Modifier modifierDraggable = DraggableKt.draggable(companion2, draggableState, orientation2, (TsExtractor.TS_PACKET_SIZE & 4) != 0 ? true : z, (TsExtractor.TS_PACKET_SIZE & 8) != 0 ? null : mutableInteractionSource, (TsExtractor.TS_PACKET_SIZE & 16) != 0 ? false : zIsAnimationRunning, (TsExtractor.TS_PACKET_SIZE & 32) != 0 ? DraggableKt.NoOpOnDragStarted : null, (TsExtractor.TS_PACKET_SIZE & 64) != 0 ? DraggableKt.NoOpOnDragStopped : (Function3) value$iv, (TsExtractor.TS_PACKET_SIZE & 128) != 0 ? false : reverseDirection);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
