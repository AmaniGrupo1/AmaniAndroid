...
final class DefaultFloatingActionButtonElevation implements FloatingActionButtonElevation {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DefaultFloatingActionButtonElevation) && Dp.m7510equalsimpl0(this.defaultElevation, ((DefaultFloatingActionButtonElevation) other).defaultElevation) && Dp.m7510equalsimpl0(this.pressedElevation, ((DefaultFloatingActionButtonElevation) other).pressedElevation) && Dp.m7510equalsimpl0(this.hoveredElevation, ((DefaultFloatingActionButtonElevation) other).hoveredElevation)) {
            return Dp.m7510equalsimpl0(this.focusedElevation, ((DefaultFloatingActionButtonElevation) other).focusedElevation);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (((((result * 31) + Dp.m7511hashCodeimpl(this.pressedElevation)) * 31) + Dp.m7511hashCodeimpl(this.hoveredElevation)) * 31) + Dp.m7511hashCodeimpl(this.focusedElevation);
    }
}
