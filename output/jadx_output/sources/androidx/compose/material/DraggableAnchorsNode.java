...
final class DraggableAnchorsNode<T> extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo69measure3p2s80s(final MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        ...
        if (!$this$measure_u2d3p2s80s.isLookingAhead() || !this.didLookahead) {
            ...
            Pair<? extends DraggableAnchors<T>, ? extends T> pairInvoke = this.anchors.invoke(IntSize.m7668boximpl(size), Constraints.m7445boximpl(constraints));
