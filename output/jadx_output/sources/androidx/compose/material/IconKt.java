...
public final class IconKt {
    private static final Modifier DefaultIconSizeModifier = SizeKt.m864size3ABfNKs(Modifier.INSTANCE, Dp.m7505constructorimpl(24));

    /* JADX INFO: renamed from: Icon-ww6aTOc, reason: not valid java name */
    public static final void m1852Iconww6aTOc(ImageVector imageVector, String contentDescription, Modifier modifier, long tint, Composer $composer, int $changed, int i) {
        long tint2;
        ...
        if ((i & 8) != 0) {
            ...
            ComposerKt.sourceInformationMarkerEnd($composer);
            tint2 = Color.m4695copywmQWz5c(jM4707unboximpl, (14 & 1) != 0 ? Color.m4699getAlphaimpl(jM4707unboximpl) : ((Number) objConsume2).floatValue(), (14 & 2) != 0 ? Color.m4703getRedimpl(jM4707unboximpl) : 0.0f, (14 & 4) != 0 ? Color.m4702getGreenimpl(jM4707unboximpl) : 0.0f, (14 & 8) != 0 ? Color.m4700getBlueimpl(jM4707unboximpl) : 0.0f);
        } else {
            tint2 = tint;
        }
        ...
        m1851Iconww6aTOc(VectorPainterKt.rememberVectorPainter(imageVector, $composer, $changed & 14), contentDescription, modifier2, tint2, $composer, ($changed & 7168) | VectorPainter.$stable | ($changed & 112) | ($changed & 896), 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    /* JADX INFO: renamed from: Icon-ww6aTOc, reason: not valid java name */
    public static final void m1850Iconww6aTOc(ImageBitmap bitmap, String contentDescription, Modifier modifier, long tint, Composer $composer, int $changed, int i) {
        long tint2;
        Object value$iv;
        ...
        ComposerKt.sourceInformationMarkerEnd($composer);
        m1851Iconww6aTOc(painter, contentDescription, modifier2, tint2, $composer, ($changed & 7168) | ($changed & 112) | ($changed & 896), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd($composer);
    ...
    /* JADX INFO: renamed from: Icon-ww6aTOc, reason: not valid java name */
    public static final void m1851Iconww6aTOc(final Painter painter, final String contentDescription, Modifier modifier, long tint, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        long j;
        long tint2;
        Modifier modifier3;
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.IconKt$Icon$1
                ...
                public final void invoke(Composer composer, int i4) {
                    IconKt.m1851Iconww6aTOc(painter, contentDescription, modifier4, tint3, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    private static final Modifier defaultSizeFor(Modifier $this$defaultSizeFor, Painter painter) {
        ...
        if (Size.m4517equalsimpl0(painter.getIntrinsicSize(), Size.INSTANCE.m4529getUnspecifiedNHjbRc()) || m1853isInfiniteuvyYCjk(painter.getIntrinsicSize())) {
    ...
    private static final boolean m1853isInfiniteuvyYCjk(long $this$isInfinite_u2duvyYCjk) {
