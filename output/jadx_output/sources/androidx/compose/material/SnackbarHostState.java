...
public final class SnackbarHostState {
    ...
    /* JADX WARN: Removed duplicated region for block: B:27:0x00f1 A[Catch: all -> 0x0108, TRY_LEAVE, TryCatch #2 {all -> 0x0108, blocks: (B:25:0x00ca, B:27:0x00f1), top: B:52:0x00ca }] */
        ...
        switch (anonymousClass1.label) {
            case 0:
                ...
                try {
                    ...
                    Continuation uCont$iv = $completion$iv;
                    try {
                        Continuation $continuation = IntrinsicsKt.intercepted(uCont$iv);
                ...
                break;
            case 1:
                Mutex $this$withLock_u24default$iv2 = (Mutex) anonymousClass1.L$4;
                ...
                anonymousClass1.L$5 = $completion$iv;
                anonymousClass1.label = 2;
                Continuation uCont$iv2 = $completion$iv;
                Continuation $continuation2 = IntrinsicsKt.intercepted(uCont$iv2);
    ...
    private static final class SnackbarDataImpl implements SnackbarData {
        ...
        public void performAction() {
            if (this.continuation.isActive()) {
                ...
                cancellableContinuation.resumeWith(Result.m8542constructorimpl(SnackbarResult.ActionPerformed));
            }
        }
        ...
        public void dismiss() {
            if (this.continuation.isActive()) {
                CancellableContinuation<SnackbarResult> cancellableContinuation = this.continuation;
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuation.resumeWith(Result.m8542constructorimpl(SnackbarResult.Dismissed));
            }
        }
    }
}
