...
public final class SwitchKt {
    ...
    private static final float TrackWidth = Dp.m7505constructorimpl(34);
    private static final float TrackStrokeWidth = Dp.m7505constructorimpl(14);
    private static final float ThumbDiameter = Dp.m7505constructorimpl(20);
    private static final float ThumbRippleRadius = Dp.m7505constructorimpl(24);
    private static final float DefaultSwitchPadding = Dp.m7505constructorimpl(2);
    ...
    */
    public static final void Switch(final boolean checked, final Function1<? super Boolean, Unit> function1, Modifier modifier, boolean enabled, MutableInteractionSource interactionSource, SwitchColors colors, Composer $composer, final int $changed, final int i) {
        ...
        Object value$iv5;
        Composer $composer3 = $composer.startRestartGroup(25866825);
        ComposerKt.sourceInformation($composer3, "C(Switch)P(!1,5,4,2,3)98@4560L8,*103@4753L7,108@5135L34,109@5224L7,110@5301L447,122@5783L37,123@5847L29,124@5920L315,124@5881L354,133@6285L133,133@6240L178,138@6456L7,153@6897L1050:Switch.kt#jmzs0o");
        int $dirty2 = $changed;
        if ((i & 1) != 0) {
            $dirty2 |= 6;
        } else if (($changed & 6) == 0) {
        ...
        if ((196608 & $changed) == 0) {
            if ((i & 32) == 0) {
                switchColors = colors;
                int i7 = $composer3.changed(switchColors) ? 131072 : 65536;
                $dirty2 |= i7;
            } else {
                switchColors = colors;
            }
        ...
        if ((74899 & $dirty2) == 74898 && $composer3.getSkipping()) {
            ...
            colors3 = switchColors;
        } else {
            $composer3.startDefaults();
            if (($changed & 1) == 0 || $composer3.getDefaultsInvalid()) {
                Modifier.Companion modifier6 = i4 != 0 ? Modifier.INSTANCE : modifier2;
                boolean enabled5 = i5 != 0 ? true : z;
                interactionSource2 = i6 != 0 ? null : mutableInteractionSource;
                if ((i & 32) != 0) {
                    $composer2 = $composer3;
                    $dirty = $dirty2 & (-458753);
                    colors2 = SwitchDefaults.INSTANCE.m1953colorsSQMK_m0(0L, 0L, 0.0f, 0L, 0L, 0.0f, 0L, 0L, 0L, 0L, $composer3, 0, 6, 1023);
                    enabled2 = enabled5;
                    modifier3 = modifier6;
                } else {
                    $composer2 = $composer3;
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(25866825, $dirty, -1, "androidx.compose.material.Switch (Switch.kt:99)");
            }
            if (interactionSource2 == null) {
                ...
                mutableInteractionSource2 = (MutableInteractionSource) value$iv5;
                ComposerKt.sourceInformationMarkerEnd($composer2);
                $composer2.endReplaceGroup();
            } else {
                $composer2.startReplaceGroup(779510646);
                $composer2.endReplaceGroup();
                mutableInteractionSource2 = interactionSource2;
            }
            MutableInteractionSource interactionSource5 = mutableInteractionSource2;
            ...
            final float maxBound = $this$Switch_u24lambda_u241.mo405toPx0680j_4(ThumbPathLength);
            ...
            MutableState forceAnimationCheck$delegate = (MutableState) value$iv;
            ComposerKt.sourceInformationMarkerEnd($composer2);
            ProvidableCompositionLocal<Density> localDensity2 = CompositionLocalsKt.getLocalDensity();
            ComposerKt.sourceInformationMarkerStart($composer2, 2023513938, "CC:CompositionLocal.kt#9igjgp");
            Object objConsume2 = $composer2.consume(localDensity2);
            ComposerKt.sourceInformationMarkerEnd($composer2);
            Density $this$Switch_u24lambda_u245 = (Density) objConsume2;
            final float switchVelocityThresholdPx = $this$Switch_u24lambda_u245.mo405toPx0680j_4(SwitchVelocityThreshold);
            ComposerKt.sourceInformationMarkerStart($composer2, 779532409, "CC(remember):Switch.kt#9igjgp");
            boolean invalid$iv2 = $composer2.changed(maxBound) | $composer2.changed(switchVelocityThresholdPx);
            ...
            if (invalid$iv2 || it$iv3 == Composer.INSTANCE.getEmpty()) {
                value$iv2 = new AnchoredDraggableState(Boolean.valueOf(checked), AnchoredDraggableKt.DraggableAnchors(new Function1<DraggableAnchorsConfig<Boolean>, Unit>() { // from class: androidx.compose.material.SwitchKt$Switch$anchoredDraggableState$1$1
                    ...
                    public final void invoke2(DraggableAnchorsConfig<Boolean> draggableAnchorsConfig) {
                        draggableAnchorsConfig.at(false, minBound);
                        draggableAnchorsConfig.at(true, maxBound);
                    }
            ...
            AnchoredDraggableState anchoredDraggableState2 = (AnchoredDraggableState) value$iv2;
            ComposerKt.sourceInformationMarkerEnd($composer2);
            ...
            boolean invalid$iv3 = $composer2.changed(anchoredDraggableState2) | $composer2.changed(currentChecked$delegate) | $composer2.changed(currentOnCheckedChange$delegate);
            ...
            if (invalid$iv3 || it$iv4 == Composer.INSTANCE.getEmpty()) {
                value$iv3 = new SwitchKt$Switch$1$1(anchoredDraggableState2, currentChecked$delegate, currentOnCheckedChange$delegate, forceAnimationCheck$delegate, null);
                $this$cache$iv4.updateRememberedValue(value$iv3);
            } else {
                value$iv3 = it$iv4;
            }
            ComposerKt.sourceInformationMarkerEnd($composer2);
            EffectsKt.LaunchedEffect(anchoredDraggableState2, (Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object>) value$iv3, $composer2, i2);
            ...
            boolean invalid$iv4 = (($dirty & 14) == 4) | $composer2.changed(anchoredDraggableState2);
            Composer $this$cache$iv5 = $composer2;
            SwitchKt$Switch$2$1 value$iv6 = $this$cache$iv5.rememberedValue();
            if (invalid$iv4 || value$iv6 == Composer.INSTANCE.getEmpty()) {
                value$iv6 = new SwitchKt$Switch$2$1(checked, anchoredDraggableState2, null);
                $this$cache$iv5.updateRememberedValue(value$iv6);
            }
            ComposerKt.sourceInformationMarkerEnd($composer2);
            EffectsKt.LaunchedEffect(boolValueOf, boolValueOf2, (Function2) value$iv6, $composer2, $dirty & 14);
            ProvidableCompositionLocal<LayoutDirection> localLayoutDirection = CompositionLocalsKt.getLocalLayoutDirection();
            ComposerKt.sourceInformationMarkerStart($composer2, 2023513938, "CC:CompositionLocal.kt#9igjgp");
            Object objConsume3 = $composer2.consume(localLayoutDirection);
            ComposerKt.sourceInformationMarkerEnd($composer2);
            boolean isRtl2 = objConsume3 == LayoutDirection.Rtl;
            if (function1 != null) {
                isRtl = isRtl2;
                ...
                i3 = 2;
                toggleableModifier = ToggleableKt.m1095toggleableO2vRcR0(Modifier.INSTANCE, checked, interactionSource3, null, enabled3, Role.m6692boximpl(Role.INSTANCE.m6705getSwitcho7Vup1c()), function1);
            } else {
                enabled3 = enabled2;
                interactionSource3 = interactionSource5;
                i3 = 2;
            ...
            Modifier modifier$iv = SizeKt.m858requiredSizeVpY3zN4(PaddingKt.m818padding3ABfNKs(SizeKt.wrapContentSize$default(AnchoredDraggableKt.anchoredDraggable(modifier3.then(function1 != null ? InteractiveComponentSizeKt.minimumInteractiveComponentSize(Modifier.INSTANCE) : Modifier.INSTANCE).then(toggleableModifier), anchoredDraggableState, Orientation.Horizontal, enabled3 && function1 != null, isRtl, interactionSource6, false), Alignment.INSTANCE.getCenter(), false, i3, null), DefaultSwitchPadding), SwitchWidth, SwitchHeight);
            ...
            if ($this$Layout_u24lambda_u240$iv$iv.getInserting()) {
                ...
                BoxScope $this$Switch_u24lambda_u2412 = BoxScopeInstance.INSTANCE;
                ComposerKt.sourceInformationMarkerStart($composer$iv, -277232920, "C179@7838L42,175@7683L258:Switch.kt#jmzs0o");
                boolean zBooleanValue = ((Boolean) anchoredDraggableState3.getTargetValue()).booleanValue();
                ComposerKt.sourceInformationMarkerStart($composer$iv, 545251075, "CC(remember):Switch.kt#9igjgp");
                invalid$iv = $composer$iv.changed(anchoredDraggableState3);
                value$iv4 = $composer$iv.rememberedValue();
                if (!invalid$iv || value$iv4 == Composer.INSTANCE.getEmpty()) {
                    value$iv4 = (Function0) new Function0<Float>() { // from class: androidx.compose.material.SwitchKt$Switch$3$1$1
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        {
                            super(0);
                        }
                ...
                SwitchImpl($this$Switch_u24lambda_u2412, zBooleanValue, enabled6, colors2, (Function0) value$iv4, interactionSource6, $composer$iv, (($dirty >> 3) & 896) | ($changed2 & 14) | (($dirty >> 6) & 7168));
                ComposerKt.sourceInformationMarkerEnd($composer$iv);
                ComposerKt.sourceInformationMarkerEnd($composer$iv);
                $composer2.endNode();
                ComposerKt.sourceInformationMarkerEnd($composer2);
            ...
            int $changed22 = (($changed$iv >> 6) & 112) | 6;
            BoxScope $this$Switch_u24lambda_u24122 = BoxScopeInstance.INSTANCE;
            ComposerKt.sourceInformationMarkerStart($composer$iv2, -277232920, "C179@7838L42,175@7683L258:Switch.kt#jmzs0o");
            boolean zBooleanValue2 = ((Boolean) anchoredDraggableState3.getTargetValue()).booleanValue();
            ComposerKt.sourceInformationMarkerStart($composer$iv2, 545251075, "CC(remember):Switch.kt#9igjgp");
            invalid$iv = $composer$iv2.changed(anchoredDraggableState3);
            value$iv4 = $composer$iv2.rememberedValue();
            if (!invalid$iv) {
            }
            value$iv4 = (Function0) new Function0<Float>() { // from class: androidx.compose.material.SwitchKt$Switch$3$1$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            ...
            $composer$iv2.updateRememberedValue(value$iv4);
            ComposerKt.sourceInformationMarkerEnd($composer$iv2);
            SwitchImpl($this$Switch_u24lambda_u24122, zBooleanValue2, enabled6, colors2, (Function0) value$iv4, interactionSource6, $composer$iv2, (($dirty >> 3) & 896) | ($changed22 & 14) | (($dirty >> 6) & 7168));
            ComposerKt.sourceInformationMarkerEnd($composer$iv2);
            ComposerKt.sourceInformationMarkerEnd($composer$iv2);
            $composer2.endNode();
            ComposerKt.sourceInformationMarkerEnd($composer2);
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.SwitchKt.Switch.4
                ...
                public final void invoke(Composer composer, int i9) {
                    SwitchKt.Switch(checked, function1, modifier4, enabled4, interactionSource4, colors3, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    public static final void SwitchImpl(final BoxScope $this$SwitchImpl, final boolean checked, final boolean enabled, final SwitchColors colors, final Function0<Float> function0, final InteractionSource interactionSource, Composer $composer, final int $changed) {
        ...
        if ((74899 & $dirty2) != 74898 || !$composer2.getSkipping()) {
            ...
            if (invalid$iv2 || it$iv3 == Composer.INSTANCE.getEmpty()) {
                value$iv3 = (Function1) new Function1<DrawScope, Unit>() { // from class: androidx.compose.material.SwitchKt$SwitchImpl$2$1
                    ...
                    public final void invoke2(DrawScope $this$Canvas) {
                        SwitchKt.m1955drawTrackRPmYEkk($this$Canvas, SwitchKt.SwitchImpl$lambda$15(stateTrackColor), $this$Canvas.mo405toPx0680j_4(SwitchKt.getTrackWidth()), $this$Canvas.mo405toPx0680j_4(SwitchKt.getTrackStrokeWidth()));
                    }
                };
            ...
            ComposerKt.sourceInformationMarkerEnd($composer2);
            float arg0$iv = ((Dp) objConsume2).m7519unboximpl();
            float absoluteElevation = Dp.m7505constructorimpl(arg0$iv + elevation);
            if (Color.m4698equalsimpl0(SwitchImpl$lambda$17(stateThumbColor), MaterialTheme.INSTANCE.getColors($composer2, 6).m1763getSurface0d7_KjU()) && elevationOverlay != null) {
                ...
                z = true;
                long jMo1801apply7g2Lkgo = elevationOverlay.mo1801apply7g2Lkgo(SwitchImpl$lambda$17(stateThumbColor), absoluteElevation, $composer2, 0);
                $composer2.endReplaceGroup();
                jSwitchImpl$lambda$17 = jMo1801apply7g2Lkgo;
            } else {
                str = "CC(remember):Switch.kt#9igjgp";
                z = true;
            ...
            State<Color> stateM134animateColorAsStateeuL9pac = SingleValueAnimationKt.m134animateColorAsStateeuL9pac(jSwitchImpl$lambda$17, null, null, null, $composer2, 0, 14);
            $composer2 = $composer2;
            ...
            boolean invalid$iv3 = ($dirty2 & 57344) == 16384 ? z : false;
            ...
            if (invalid$iv3 || it$iv4 == Composer.INSTANCE.getEmpty()) {
                value$iv4 = (Function1) new Function1<Density, IntOffset>() { // from class: androidx.compose.material.SwitchKt$SwitchImpl$3$1
                    ...
                    public /* bridge */ /* synthetic */ IntOffset invoke(Density density) {
                        return IntOffset.m7624boximpl(m1956invokeBjo55l4(density));
                    }

                    /* JADX INFO: renamed from: invoke-Bjo55l4, reason: not valid java name */
                    public final long m1956invokeBjo55l4(Density $this$offset) {
            ...
            ComposerKt.sourceInformationMarkerEnd($composer2);
            SpacerKt.Spacer(BackgroundKt.m263backgroundbw27NRU(ShadowKt.m4295shadows4CzXII$default(SizeKt.m856requiredSize3ABfNKs(IndicationKt.indication(OffsetKt.offset(modifierAlign, (Function1) value$iv4), interactionSource, RippleKt.m1911rippleOrFallbackImplementation9IZ8Weo(false, ThumbRippleRadius, 0L, $composer2, 54, 4)), ThumbDiameter), elevation, RoundedCornerShapeKt.getCircleShape(), false, 0L, 0L, 24, null), SwitchImpl$lambda$18(stateM134animateColorAsStateeuL9pac), RoundedCornerShapeKt.getCircleShape()), $composer2, 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        } else {
    ...
    public static final void m1955drawTrackRPmYEkk(DrawScope $this$drawTrack_u2dRPmYEkk, long trackColor, float trackWidth, float strokeWidth) {
        float strokeRadius = strokeWidth / 2;
        DrawScope.m5257drawLineNGM6Ib0$default($this$drawTrack_u2dRPmYEkk, trackColor, androidx.compose.ui.geometry.OffsetKt.Offset(strokeRadius, Offset.m4453getYimpl($this$drawTrack_u2dRPmYEkk.mo5270getCenterF1C5BW0())), androidx.compose.ui.geometry.OffsetKt.Offset(trackWidth - strokeRadius, Offset.m4453getYimpl($this$drawTrack_u2dRPmYEkk.mo5270getCenterF1C5BW0())), strokeWidth, StrokeCap.INSTANCE.m5072getRoundKaPHkGw(), null, 0.0f, null, 0, WindowSizeClass.HEIGHT_DP_MEDIUM_LOWER_BOUND, null);
    }

    static {
        float arg0$iv = TrackWidth;
        float other$iv = ThumbDiameter;
        ThumbPathLength = Dp.m7505constructorimpl(arg0$iv - other$iv);
        AnimationSpec = new TweenSpec<>(100, 0, null, 6, null);
        ThumbDefaultElevation = Dp.m7505constructorimpl(1);
        ThumbPressedElevation = Dp.m7505constructorimpl(6);
        SwitchVelocityThreshold = Dp.m7505constructorimpl(ComposerImplKt.nodeKey);
    }
