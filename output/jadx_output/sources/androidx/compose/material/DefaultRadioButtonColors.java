...
final class DefaultRadioButtonColors implements RadioButtonColors {
    ...
    public State<Color> radioColor(boolean enabled, boolean selected, Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1243421834, $changed, -1, "androidx.compose.material.DefaultRadioButtonColors.radioColor (RadioButton.kt:186)");
        }
        if (enabled) {
    ...
    public boolean equals(Object other) {
        ...
        if (Color.m4698equalsimpl0(this.selectedColor, ((DefaultRadioButtonColors) other).selectedColor) && Color.m4698equalsimpl0(this.unselectedColor, ((DefaultRadioButtonColors) other).unselectedColor) && Color.m4698equalsimpl0(this.disabledColor, ((DefaultRadioButtonColors) other).disabledColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (((result * 31) + Color.m4704hashCodeimpl(this.unselectedColor)) * 31) + Color.m4704hashCodeimpl(this.disabledColor);
    }
}
