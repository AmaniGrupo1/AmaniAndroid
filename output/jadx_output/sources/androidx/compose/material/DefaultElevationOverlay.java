...
@Metadata(d1 = {"\u0000\u001c\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\bÂ\u0002\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\"\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0006\u001a\u00020\u0007H\u0017ø\u0001\u0000¢\u0006\u0004\b\b\u0010\t\u0082\u0002\u0007\n\u0005\b¡\u001e0\u0001¨\u0006\n"}, d2 = {"Landroidx/compose/material/DefaultElevationOverlay;", "Landroidx/compose/material/ElevationOverlay;", "()V", "apply", "Landroidx/compose/ui/graphics/Color;", TtmlNode.ATTR_TTS_COLOR, "elevation", "Landroidx/compose/ui/unit/Dp;", "apply-7g2Lkgo", "(JFLandroidx/compose/runtime/Composer;I)J", "material_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
final class DefaultElevationOverlay implements ElevationOverlay {
    ...
    public long mo1801apply7g2Lkgo(long color, float elevation, Composer $composer, int $changed) {
        ...
        int $this$dp$iv = Dp.m7504compareTo0680j_4(elevation, Dp.m7505constructorimpl(0));
        if ($this$dp$iv <= 0 || colors.isLight()) {
            ...
            long foregroundColor2 = ElevationOverlayKt.m1827calculateForegroundColorCLU3JFs(color, elevation, $composer, ($changed & 14) | ($changed & 112));
            foregroundColor = ColorKt.m4742compositeOverOWjLjI(foregroundColor2, color);
            $composer.endReplaceGroup();
        }
        if (ComposerKt.isTraceInProgress()) {
