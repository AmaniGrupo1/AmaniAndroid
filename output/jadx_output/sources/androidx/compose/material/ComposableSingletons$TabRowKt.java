...
public final class ComposableSingletons$TabRowKt {
    ...
    public static Function2<Composer, Integer, Unit> f76lambda1 = ComposableLambdaKt.composableLambdaInstance(182187156, false, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.ComposableSingletons$TabRowKt$lambda-1$1
        ...
        public final void invoke(Composer $composer, int $changed) {
            ...
            TabRowDefaults.INSTANCE.m1965Divider9IZ8Weo(null, 0.0f, 0L, $composer, 3072, 7);
            if (ComposerKt.isTraceInProgress()) {
    ...
    public static Function2<Composer, Integer, Unit> f77lambda2 = ComposableLambdaKt.composableLambdaInstance(-1480449365, false, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.ComposableSingletons$TabRowKt$lambda-2$1
        @Override // kotlin.jvm.functions.Function2
        public /* bridge */ /* synthetic */ Unit invoke(Composer composer, Integer num) {
            invoke(composer, num.intValue());
            return Unit.INSTANCE;
    ...
    public final Function2<Composer, Integer, Unit> m1798getLambda1$material_release() {
        return f76lambda1;
    }

    /* JADX INFO: renamed from: getLambda-2$material_release, reason: not valid java name */
    public final Function2<Composer, Integer, Unit> m1799getLambda2$material_release() {
        return f77lambda2;
    }
}
