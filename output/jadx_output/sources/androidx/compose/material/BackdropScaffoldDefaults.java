...
public final class BackdropScaffoldDefaults {
    ...
    private static final float PeekHeight = Dp.m7505constructorimpl(56);
    private static final float HeaderHeight = Dp.m7505constructorimpl(48);
    private static final float FrontLayerElevation = Dp.m7505constructorimpl(1);
    ...
    public final float m1695getPeekHeightD9Ej5fM() {
        return PeekHeight;
    }

    /* JADX INFO: renamed from: getHeaderHeight-D9Ej5fM, reason: not valid java name */
    public final float m1694getHeaderHeightD9Ej5fM() {
        return HeaderHeight;
    }
    ...
    public final Shape getFrontLayerShape(Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1580588700, $changed, -1, "androidx.compose.material.BackdropScaffoldDefaults.<get-frontLayerShape> (BackdropScaffold.kt:650)");
        }
        CornerBasedShape cornerBasedShapeCopy$default = CornerBasedShape.copy$default(MaterialTheme.INSTANCE.getShapes($composer, 6).getLarge(), CornerSizeKt.m1118CornerSize0680j_4(Dp.m7505constructorimpl(16)), CornerSizeKt.m1118CornerSize0680j_4(Dp.m7505constructorimpl(16)), null, null, 12, null);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final float m1693getFrontLayerElevationD9Ej5fM() {
    ...
    public final long getFrontLayerScrimColor(Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1806270648, $changed, -1, "androidx.compose.material.BackdropScaffoldDefaults.<get-frontLayerScrimColor> (BackdropScaffold.kt:662)");
        }
        long jM1763getSurface0d7_KjU = MaterialTheme.INSTANCE.getColors($composer, 6).m1763getSurface0d7_KjU();
        long jM4695copywmQWz5c = Color.m4695copywmQWz5c(jM1763getSurface0d7_KjU, (14 & 1) != 0 ? Color.m4699getAlphaimpl(jM1763getSurface0d7_KjU) : 0.6f, (14 & 2) != 0 ? Color.m4703getRedimpl(jM1763getSurface0d7_KjU) : 0.0f, (14 & 4) != 0 ? Color.m4702getGreenimpl(jM1763getSurface0d7_KjU) : 0.0f, (14 & 8) != 0 ? Color.m4700getBlueimpl(jM1763getSurface0d7_KjU) : 0.0f);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd($composer);
