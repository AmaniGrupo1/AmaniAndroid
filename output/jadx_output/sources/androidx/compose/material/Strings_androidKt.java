...
public final class Strings_androidKt {
    ...
    public static final String m1940getString4foXLRw(int string, Composer $composer, int $changed) {
        String string2;
        ...
        if (Strings.m1929equalsimpl0(string, Strings.INSTANCE.m1937getNavigationMenuUdPEhr4())) {
            string2 = resources.getString(androidx.compose.ui.R.string.navigation_menu);
        } else if (Strings.m1929equalsimpl0(string, Strings.INSTANCE.m1933getCloseDrawerUdPEhr4())) {
            string2 = resources.getString(androidx.compose.ui.R.string.close_drawer);
        } else if (Strings.m1929equalsimpl0(string, Strings.INSTANCE.m1934getCloseSheetUdPEhr4())) {
            string2 = resources.getString(androidx.compose.ui.R.string.close_sheet);
        } else if (Strings.m1929equalsimpl0(string, Strings.INSTANCE.m1935getDefaultErrorMessageUdPEhr4())) {
            string2 = resources.getString(androidx.compose.ui.R.string.default_error_message);
        } else if (Strings.m1929equalsimpl0(string, Strings.INSTANCE.m1936getExposedDropdownMenuUdPEhr4())) {
            string2 = resources.getString(androidx.compose.ui.R.string.dropdown_menu);
        } else if (Strings.m1929equalsimpl0(string, Strings.INSTANCE.m1939getSliderRangeStartUdPEhr4())) {
            string2 = resources.getString(androidx.compose.ui.R.string.range_start);
        } else {
            string2 = Strings.m1929equalsimpl0(string, Strings.INSTANCE.m1938getSliderRangeEndUdPEhr4()) ? resources.getString(androidx.compose.ui.R.string.range_end) : "";
        }
        if (ComposerKt.isTraceInProgress()) {
