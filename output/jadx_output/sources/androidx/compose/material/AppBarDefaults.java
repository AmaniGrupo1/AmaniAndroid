...
public final class AppBarDefaults {
    ...
    private static final float TopAppBarElevation = Dp.m7505constructorimpl(4);
    private static final float BottomAppBarElevation = Dp.m7505constructorimpl(8);
    private static final PaddingValues ContentPadding = PaddingKt.m815PaddingValuesa9UjIt4$default(AppBarKt.AppBarHorizontalPadding, 0.0f, AppBarKt.AppBarHorizontalPadding, 0.0f, 10, null);

    private AppBarDefaults() {
    }

    /* JADX INFO: renamed from: getTopAppBarElevation-D9Ej5fM, reason: not valid java name */
    public final float m1684getTopAppBarElevationD9Ej5fM() {
        return TopAppBarElevation;
    }

    /* JADX INFO: renamed from: getBottomAppBarElevation-D9Ej5fM, reason: not valid java name */
    public final float m1683getBottomAppBarElevationD9Ej5fM() {
