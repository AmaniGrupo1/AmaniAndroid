...
public final class CardKt {
    ...
    public static final void m1735CardFjzlyU(Modifier modifier, Shape shape, long backgroundColor, long contentColor, BorderStroke border, float elevation, Function2<? super Composer, ? super Integer, Unit> function2, Composer $composer, int $changed, int i) {
        Shape shape2;
        ...
        if ((i & 4) == 0) {
            ...
            backgroundColor2 = MaterialTheme.INSTANCE.getColors($composer, 6).m1763getSurface0d7_KjU();
        }
        if ((i & 8) == 0) {
            contentColor2 = contentColor;
        } else {
            contentColor2 = ColorsKt.m1777contentColorForek8zF_U(backgroundColor2, $composer, ($changed >> 6) & 14);
        }
        if ((i & 16) == 0) {
            border2 = border;
        } else {
        ...
        if ((i & 32) == 0) {
            ...
            elevation2 = Dp.m7505constructorimpl(1);
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1956755640, $changed, -1, "androidx.compose.material.Card (Card.kt:62)");
        }
        SurfaceKt.m1941SurfaceFjzlyU(modifier, shape2, backgroundColor2, contentColor2, border2, elevation2, function2, $composer, ($changed & 14) | ($changed & 112) | ($changed & 896) | ($changed & 7168) | (57344 & $changed) | (458752 & $changed) | (3670016 & $changed), 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static final void m1736CardLPr_se0(Function0<Unit> function0, Modifier modifier, boolean enabled, Shape shape, long backgroundColor, long contentColor, BorderStroke border, float elevation, MutableInteractionSource interactionSource, Function2<? super Composer, ? super Integer, Unit> function2, Composer $composer, int $changed, int i) {
        ...
        long backgroundColor2 = (i & 16) != 0 ? MaterialTheme.INSTANCE.getColors($composer, 6).m1763getSurface0d7_KjU() : backgroundColor;
        long contentColor2 = (i & 32) != 0 ? ColorsKt.m1777contentColorForek8zF_U(backgroundColor2, $composer, ($changed >> 12) & 14) : contentColor;
        BorderStroke border2 = (i & 64) != 0 ? null : border;
        float elevation2 = (i & 128) != 0 ? Dp.m7505constructorimpl(1) : elevation;
        ...
        SurfaceKt.m1942SurfaceLPr_se0(function0, modifier2, enabled2, shape2, backgroundColor2, contentColor2, border2, elevation2, interactionSource2, function2, $composer, ($changed & 14) | ($changed & 112) | ($changed & 896) | ($changed & 7168) | (57344 & $changed) | (458752 & $changed) | (3670016 & $changed) | (29360128 & $changed) | (234881024 & $changed) | (1879048192 & $changed), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd($composer);
