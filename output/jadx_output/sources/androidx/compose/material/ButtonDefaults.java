...
public final class ButtonDefaults {
    ...
    private static final float ButtonHorizontalPadding = Dp.m7505constructorimpl(16);
    ...
    private static final float MinWidth = Dp.m7505constructorimpl(64);
    private static final float MinHeight = Dp.m7505constructorimpl(36);
    private static final float IconSize = Dp.m7505constructorimpl(18);
    ...
    private static final float TextButtonHorizontalPadding = Dp.m7505constructorimpl(8);
    ...
    public final float m1728getIconSizeD9Ej5fM() {
        return IconSize;
    }

    /* JADX INFO: renamed from: getIconSpacing-D9Ej5fM, reason: not valid java name */
    public final float m1729getIconSpacingD9Ej5fM() {
        return IconSpacing;
    }

    @Deprecated(level = DeprecationLevel.HIDDEN, message = "Use another overload of elevation")
    /* JADX INFO: renamed from: elevation-yajeYGU, reason: not valid java name */
    public final /* synthetic */ ButtonElevation m1727elevationyajeYGU(float defaultElevation, float pressedElevation, float disabledElevation, Composer $composer, int $changed, int i) {
        ...
        if ((i & 1) != 0) {
            float defaultElevation3 = Dp.m7505constructorimpl(2);
            defaultElevation2 = defaultElevation3;
        } else {
            defaultElevation2 = defaultElevation;
        }
        if ((i & 2) != 0) {
            float pressedElevation3 = Dp.m7505constructorimpl(8);
            pressedElevation2 = pressedElevation3;
        } else {
            pressedElevation2 = pressedElevation;
        }
        if ((i & 4) != 0) {
            float disabledElevation3 = Dp.m7505constructorimpl(0);
        ...
        ButtonElevation buttonElevationM1726elevationR_JCAzs = m1726elevationR_JCAzs(defaultElevation2, pressedElevation2, disabledElevation2, Dp.m7505constructorimpl(4), Dp.m7505constructorimpl(4), $composer, $this$dp$iv | 27648 | ($changed & 112) | ($changed & 896) | (($changed << 6) & 458752), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd($composer);
        return buttonElevationM1726elevationR_JCAzs;
    }

    /* JADX INFO: renamed from: elevation-R_JCAzs, reason: not valid java name */
    public final ButtonElevation m1726elevationR_JCAzs(float defaultElevation, float pressedElevation, float disabledElevation, float hoveredElevation, float focusedElevation, Composer $composer, int $changed, int i) {
        Object value$iv;
        ...
        float defaultElevation2 = (i & 1) != 0 ? Dp.m7505constructorimpl(2) : defaultElevation;
        float pressedElevation2 = (i & 2) != 0 ? Dp.m7505constructorimpl(8) : pressedElevation;
        float disabledElevation2 = (i & 4) != 0 ? Dp.m7505constructorimpl(0) : disabledElevation;
        float hoveredElevation2 = (i & 8) != 0 ? Dp.m7505constructorimpl(4) : hoveredElevation;
        float focusedElevation2 = (i & 16) != 0 ? Dp.m7505constructorimpl(4) : focusedElevation;
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final ButtonColors m1725buttonColorsro_MJ88(long backgroundColor, long contentColor, long disabledBackgroundColor, long disabledContentColor, Composer $composer, int $changed, int i) {
        ...
        if ((i & 8) != 0) {
            ...
            disabledContentColor2 = Color.m4695copywmQWz5c(jM1758getOnSurface0d7_KjU2, (14 & 1) != 0 ? Color.m4699getAlphaimpl(jM1758getOnSurface0d7_KjU2) : ContentAlpha.INSTANCE.getDisabled($composer, 6), (14 & 2) != 0 ? Color.m4703getRedimpl(jM1758getOnSurface0d7_KjU2) : 0.0f, (14 & 4) != 0 ? Color.m4702getGreenimpl(jM1758getOnSurface0d7_KjU2) : 0.0f, (14 & 8) != 0 ? Color.m4700getBlueimpl(jM1758getOnSurface0d7_KjU2) : 0.0f);
        } else {
    ...
    public final ButtonColors m1733outlinedButtonColorsRGew2ao(long backgroundColor, long contentColor, long disabledContentColor, Composer $composer, int $changed, int i) {
        long disabledContentColor2;
        ...
        long contentColor2 = (i & 2) != 0 ? MaterialTheme.INSTANCE.getColors($composer, 6).m1759getPrimary0d7_KjU() : contentColor;
        if ((i & 4) != 0) {
            long jM1758getOnSurface0d7_KjU = MaterialTheme.INSTANCE.getColors($composer, 6).m1758getOnSurface0d7_KjU();
            disabledContentColor2 = Color.m4695copywmQWz5c(jM1758getOnSurface0d7_KjU, (14 & 1) != 0 ? Color.m4699getAlphaimpl(jM1758getOnSurface0d7_KjU) : ContentAlpha.INSTANCE.getDisabled($composer, 6), (14 & 2) != 0 ? Color.m4703getRedimpl(jM1758getOnSurface0d7_KjU) : 0.0f, (14 & 4) != 0 ? Color.m4702getGreenimpl(jM1758getOnSurface0d7_KjU) : 0.0f, (14 & 8) != 0 ? Color.m4700getBlueimpl(jM1758getOnSurface0d7_KjU) : 0.0f);
        } else {
            disabledContentColor2 = disabledContentColor;
        }
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final ButtonColors m1734textButtonColorsRGew2ao(long backgroundColor, long contentColor, long disabledContentColor, Composer $composer, int $changed, int i) {
        long disabledContentColor2;
        ...
        long backgroundColor2 = (i & 1) != 0 ? Color.INSTANCE.m4732getTransparent0d7_KjU() : backgroundColor;
        long contentColor2 = (i & 2) != 0 ? MaterialTheme.INSTANCE.getColors($composer, 6).m1759getPrimary0d7_KjU() : contentColor;
        if ((i & 4) != 0) {
            long jM1758getOnSurface0d7_KjU = MaterialTheme.INSTANCE.getColors($composer, 6).m1758getOnSurface0d7_KjU();
            disabledContentColor2 = Color.m4695copywmQWz5c(jM1758getOnSurface0d7_KjU, (14 & 1) != 0 ? Color.m4699getAlphaimpl(jM1758getOnSurface0d7_KjU) : ContentAlpha.INSTANCE.getDisabled($composer, 6), (14 & 2) != 0 ? Color.m4703getRedimpl(jM1758getOnSurface0d7_KjU) : 0.0f, (14 & 4) != 0 ? Color.m4702getGreenimpl(jM1758getOnSurface0d7_KjU) : 0.0f, (14 & 8) != 0 ? Color.m4700getBlueimpl(jM1758getOnSurface0d7_KjU) : 0.0f);
    ...
    public final float m1732getOutlinedBorderSizeD9Ej5fM() {
