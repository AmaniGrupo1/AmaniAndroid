...
public final class Colors {
    ...
    private Colors(long primary, long primaryVariant, long secondary, long secondaryVariant, long background, long surface, long error, long onPrimary, long onSecondary, long onBackground, long onSurface, long onError, boolean isLight) {
        this.primary = SnapshotStateKt.mutableStateOf(Color.m4687boximpl(primary), SnapshotStateKt.structuralEqualityPolicy());
        this.primaryVariant = SnapshotStateKt.mutableStateOf(Color.m4687boximpl(primaryVariant), SnapshotStateKt.structuralEqualityPolicy());
        this.secondary = SnapshotStateKt.mutableStateOf(Color.m4687boximpl(secondary), SnapshotStateKt.structuralEqualityPolicy());
        this.secondaryVariant = SnapshotStateKt.mutableStateOf(Color.m4687boximpl(secondaryVariant), SnapshotStateKt.structuralEqualityPolicy());
        this.background = SnapshotStateKt.mutableStateOf(Color.m4687boximpl(background), SnapshotStateKt.structuralEqualityPolicy());
        this.surface = SnapshotStateKt.mutableStateOf(Color.m4687boximpl(surface), SnapshotStateKt.structuralEqualityPolicy());
        this.error = SnapshotStateKt.mutableStateOf(Color.m4687boximpl(error), SnapshotStateKt.structuralEqualityPolicy());
        this.onPrimary = SnapshotStateKt.mutableStateOf(Color.m4687boximpl(onPrimary), SnapshotStateKt.structuralEqualityPolicy());
        this.onSecondary = SnapshotStateKt.mutableStateOf(Color.m4687boximpl(onSecondary), SnapshotStateKt.structuralEqualityPolicy());
        this.onBackground = SnapshotStateKt.mutableStateOf(Color.m4687boximpl(onBackground), SnapshotStateKt.structuralEqualityPolicy());
        this.onSurface = SnapshotStateKt.mutableStateOf(Color.m4687boximpl(onSurface), SnapshotStateKt.structuralEqualityPolicy());
        this.onError = SnapshotStateKt.mutableStateOf(Color.m4687boximpl(onError), SnapshotStateKt.structuralEqualityPolicy());
    ...
    public final long m1759getPrimary0d7_KjU() {
        State $this$getValue$iv = this.primary;
        return ((Color) $this$getValue$iv.getValue()).m4707unboximpl();
    }

    /* JADX INFO: renamed from: setPrimary-8_81llA$material_release, reason: not valid java name */
    public final void m1771setPrimary8_81llA$material_release(long j) {
        MutableState $this$setValue$iv = this.primary;
        $this$setValue$iv.setValue(Color.m4687boximpl(j));
    }

    /* JADX INFO: renamed from: getPrimaryVariant-0d7_KjU, reason: not valid java name */
    public final long m1760getPrimaryVariant0d7_KjU() {
    ...
    public final void m1773setSecondary8_81llA$material_release(long j) {
    ...
    public final long m1762getSecondaryVariant0d7_KjU() {
    ...
    public final void m1774setSecondaryVariant8_81llA$material_release(long j) {
    ...
    public final long m1752getBackground0d7_KjU() {
    ...
    /* JADX INFO: renamed from: copy-pvPzIIM$default, reason: not valid java name */
    public static /* synthetic */ Colors m1750copypvPzIIM$default(Colors colors, long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, long j9, long j10, long j11, long j12, boolean z, int i, Object obj) {
        long jM1759getPrimary0d7_KjU = (i & 1) != 0 ? colors.m1759getPrimary0d7_KjU() : j;
        return colors.m1751copypvPzIIM(jM1759getPrimary0d7_KjU, (i & 2) != 0 ? colors.m1760getPrimaryVariant0d7_KjU() : j2, (i & 4) != 0 ? colors.m1761getSecondary0d7_KjU() : j3, (i & 8) != 0 ? colors.m1762getSecondaryVariant0d7_KjU() : j4, (i & 16) != 0 ? colors.m1752getBackground0d7_KjU() : j5, (i & 32) != 0 ? colors.m1763getSurface0d7_KjU() : j6, (i & 64) != 0 ? colors.m1753getError0d7_KjU() : j7, (i & 128) != 0 ? colors.m1756getOnPrimary0d7_KjU() : j8, (i & 256) != 0 ? colors.m1757getOnSecondary0d7_KjU() : j9, (i & 512) != 0 ? colors.m1754getOnBackground0d7_KjU() : j10, (i & 1024) != 0 ? colors.m1758getOnSurface0d7_KjU() : j11, (i & 2048) != 0 ? colors.m1755getOnError0d7_KjU() : j12, (i & 4096) != 0 ? colors.isLight() : z);
    }

    /* JADX INFO: renamed from: copy-pvPzIIM, reason: not valid java name */
    public final Colors m1751copypvPzIIM(long primary, long primaryVariant, long secondary, long secondaryVariant, long background, long surface, long error, long onPrimary, long onSecondary, long onBackground, long onSurface, long onError, boolean isLight) {
    ...
    public String toString() {
        ...
        sb.append("Colors(primary=").append((Object) Color.m4705toStringimpl(m1759getPrimary0d7_KjU())).append(", primaryVariant=").append((Object) Color.m4705toStringimpl(m1760getPrimaryVariant0d7_KjU())).append(", secondary=").append((Object) Color.m4705toStringimpl(m1761getSecondary0d7_KjU())).append(", secondaryVariant=").append((Object) Color.m4705toStringimpl(m1762getSecondaryVariant0d7_KjU())).append(", background=").append((Object) Color.m4705toStringimpl(m1752getBackground0d7_KjU())).append(", surface=").append((Object) Color.m4705toStringimpl(m1763getSurface0d7_KjU())).append(", error=").append((Object) Color.m4705toStringimpl(m1753getError0d7_KjU())).append(", onPrimary=").append((Object) Color.m4705toStringimpl(m1756getOnPrimary0d7_KjU())).append(", onSecondary=").append((Object) Color.m4705toStringimpl(m1757getOnSecondary0d7_KjU())).append(", onBackground=").append((Object) Color.m4705toStringimpl(m1754getOnBackground0d7_KjU())).append(", onSurface=").append((Object) Color.m4705toStringimpl(m1758getOnSurface0d7_KjU())).append(", onError=");
        sb.append((Object) Color.m4705toStringimpl(m1755getOnError0d7_KjU())).append(", isLight=").append(isLight()).append(')');
        return sb.toString();
    }
}
