...
public final class AndroidAlertDialog_androidKt {
    ...
    public static final void m1679AlertDialog6oU6zVQ(final Function0<Unit> function0, final Function2<? super Composer, ? super Integer, Unit> function2, Modifier modifier, Function2<? super Composer, ? super Integer, Unit> function22, Function2<? super Composer, ? super Integer, Unit> function23, Function2<? super Composer, ? super Integer, Unit> function24, Shape shape, long backgroundColor, long contentColor, DialogProperties properties, Composer $composer, final int $changed, final int i) {
        ...
        if (i6 != 0) {
            ...
            function25 = function22;
            $dirty4 |= $composer3.changedInstance(function25) ? 2048 : 1024;
        } else {
            function25 = function22;
        }
        int i7 = i & 16;
        if (i7 != 0) {
            ...
            function26 = function23;
            $dirty4 |= $composer3.changedInstance(function26) ? 16384 : 8192;
        } else {
            function26 = function23;
        }
        int i8 = i & 32;
        if (i8 != 0) {
            ...
            function27 = function24;
            $dirty4 |= $composer3.changedInstance(function27) ? 131072 : 65536;
        } else {
            function27 = function24;
        }
        ...
        if (($changed & 100663296) == 0) {
            $dirty |= ((i & 256) == 0 && $composer3.changed(contentColor)) ? 67108864 : 33554432;
        }
        int $dirty5 = $dirty;
        int $dirty6 = i & 512;
        if ($dirty6 != 0) {
            ...
            i3 = $dirty6;
            $dirty5 |= $composer3.changed(properties) ? C.BUFFER_FLAG_LAST_SAMPLE : 268435456;
        } else {
            i3 = $dirty6;
        }
        if (($dirty5 & 306783379) == 306783378 && $composer3.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer3.getDefaultsInvalid()) {
                ...
                if ((i & 256) != 0) {
                    contentColor2 = ColorsKt.m1777contentColorForek8zF_U(backgroundColor2, $composer3, ($dirty5 >> 21) & 14);
                    $dirty5 &= i4;
                } else {
            ...
            $composer2 = $composer3;
            m1680AlertDialogwqdebIU(function02, ComposableLambdaKt.rememberComposableLambda(-1849673151, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.AndroidAlertDialog_androidKt$AlertDialog$1
                ...
                public final void invoke(Composer $composer4, int $changed2) {
                    ...
                    Modifier modifier$iv = PaddingKt.m819paddingVpY3zN4(SizeKt.fillMaxWidth$default(Modifier.INSTANCE, 0.0f, 1, null), Dp.m7505constructorimpl(8), Dp.m7505constructorimpl(2));
                    ...
                    AlertDialogKt.m1678AlertDialogFlowRowixp7dh8(Dp.m7505constructorimpl(8), Dp.m7505constructorimpl(12), ComposableLambdaKt.rememberComposableLambda(1789213604, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.AndroidAlertDialog_androidKt$AlertDialog$1$1$1
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        /* JADX WARN: Multi-variable type inference failed */
                        {
                            super(2);
                        ...
                        public final void invoke(Composer $composer5, int $changed3) {
                            ...
                            if (($changed3 & 3) != 2 || !$composer5.getSkipping()) {
                                ...
                                if (function215 == null) {
                                    ...
                                    function215.invoke($composer5, 0);
                                }
            ...
            }, $composer3, 54), modifier3, function28, function29, shape3, backgroundColor3, contentColor3, properties2, $composer2, ($dirty2 & 14) | 48 | ($dirty2 & 896) | (($dirty2 >> 3) & 7168) | (($dirty2 >> 3) & 57344) | (($dirty2 >> 3) & 458752) | (($dirty2 >> 3) & 3670016) | (($dirty2 >> 3) & 29360128) | (234881024 & ($dirty2 >> 3)), 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            function210 = function25;
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.AndroidAlertDialog_androidKt$AlertDialog$2
                ...
                public final void invoke(Composer composer, int i11) {
                    AndroidAlertDialog_androidKt.m1679AlertDialog6oU6zVQ(function0, function2, modifier4, function210, function211, function212, shape4, backgroundColor4, contentColor4, properties3, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    public static final void m1680AlertDialogwqdebIU(final Function0<Unit> function0, final Function2<? super Composer, ? super Integer, Unit> function2, Modifier modifier, Function2<? super Composer, ? super Integer, Unit> function22, Function2<? super Composer, ? super Integer, Unit> function23, Shape shape, long backgroundColor, long contentColor, DialogProperties properties, Composer $composer, final int $changed, final int i) {
        ...
        if (i4 != 0) {
            ...
            function25 = function22;
            $dirty5 |= $composer3.changedInstance(function25) ? 2048 : 1024;
        } else {
            function25 = function22;
        }
        int i5 = i & 16;
        if (i5 != 0) {
            ...
            function26 = function23;
            $dirty5 |= $composer3.changedInstance(function26) ? 16384 : 8192;
        } else {
            function26 = function23;
        }
        if ((196608 & $changed) == 0) {
        ...
        if ($dirty7 != 0) {
            ...
            i2 = $dirty7;
            $dirty2 = $dirty6 | ($composer3.changed(properties) ? 67108864 : 33554432);
        } else {
            i2 = $dirty7;
            $dirty2 = $dirty6;
        }
        if (($dirty2 & 38347923) == 38347922 && $composer3.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer3.getDefaultsInvalid()) {
                ...
                if ((i & 128) != 0) {
                    contentColor2 = ColorsKt.m1777contentColorForek8zF_U(backgroundColor2, $composer3, ($dirty2 >> 18) & 14);
                    $dirty2 &= -29360129;
                } else {
                    contentColor2 = contentColor;
                }
            ...
            AndroidDialog_androidKt.Dialog(function0, properties2, ComposableLambdaKt.rememberComposableLambda(-1787418772, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.AndroidAlertDialog_androidKt$AlertDialog$3
                ...
                public final void invoke(Composer $composer4, int $changed2) {
                    ...
                    if (($changed2 & 3) != 2 || !$composer4.getSkipping()) {
                        ...
                        AlertDialogKt.m1677AlertDialogContentWMdw5o4(function29, modifier4, function210, function211, shape4, backgroundColor4, contentColor4, $composer4, 0, 0);
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                            return;
                        }
            ...
            }, $composer3, 54), $composer3, ($dirty3 & 14) | RendererCapabilities.DECODER_SUPPORT_MASK | (($dirty3 >> 21) & 112), 0);
            $composer2 = $composer3;
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.AndroidAlertDialog_androidKt$AlertDialog$4
                ...
                public final void invoke(Composer composer, int i9) {
                    AndroidAlertDialog_androidKt.m1680AlertDialogwqdebIU(function0, function2, modifier3, function28, function27, shape3, backgroundColor3, contentColor3, properties3, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
