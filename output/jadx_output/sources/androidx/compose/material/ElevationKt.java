...
public final class ElevationKt {
    ...
    public static /* synthetic */ Object m1825animateElevationrAjV9yQ$default(Animatable animatable, float f, Interaction interaction, Interaction interaction2, Continuation continuation, int i, Object obj) {
        if ((i & 2) != 0) {
            interaction = null;
        }
        if ((i & 4) != 0) {
        ...
        return m1824animateElevationrAjV9yQ(animatable, f, interaction, interaction2, continuation);
    }

    /* JADX INFO: renamed from: animateElevation-rAjV9yQ, reason: not valid java name */
    public static final Object m1824animateElevationrAjV9yQ(Animatable<Dp, ?> animatable, float target, Interaction from, Interaction to, Continuation<? super Unit> continuation) {
