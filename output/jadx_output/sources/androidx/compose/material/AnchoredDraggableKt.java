...
public final class AnchoredDraggableKt {
    ...
    static final class C03391<I> extends ContinuationImpl {
        int label;
    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function3<CoroutineScope, Float, Continuation<? super Unit>, Object> {
        ...
        static final class C00421 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C00421(AnchoredDraggableState<T> anchoredDraggableState, float f, Continuation<? super C00421> continuation) {
            ...
            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                return new C00421(this.$state, this.$velocity, continuation);
            }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    BuildersKt__Builders_commonKt.launch$default($this$draggable, null, null, new C00421(this.$state, velocity, null), 3, null);
                    return Unit.INSTANCE;
                default:
                    throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
            }
    ...
    static final class C03412<T> extends SuspendLambda implements Function4<AnchoredDragScope, DraggableAnchors<T>, T, Continuation<? super Unit>, Object> {
        private /* synthetic */ Object L$0;
        /* synthetic */ Object L$1;
        /* synthetic */ Object L$2;
        int label;

        C03412(Continuation<? super C03412> continuation) {
        ...
        public final Object invoke(AnchoredDragScope anchoredDragScope, DraggableAnchors<T> draggableAnchors, T t, Continuation<? super Unit> continuation) {
            C03412 c03412 = new C03412(continuation);
            c03412.L$0 = anchoredDragScope;
            c03412.L$1 = draggableAnchors;
            c03412.L$2 = t;
            return c03412.invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final <T> Object snapTo(AnchoredDraggableState<T> anchoredDraggableState, T t, Continuation<? super Unit> continuation) {
        Object objAnchoredDrag$default = AnchoredDraggableState.anchoredDrag$default(anchoredDraggableState, t, null, new C03412(null), continuation, 2, null);
    ...
    */
    public static final <I> Object restartable(Function0<? extends I> function0, Function2<? super I, ? super Continuation<? super Unit>, ? extends Object> function2, Continuation<? super Unit> continuation) {
        ...
        Object $result = c03391.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        try {
            switch (c03391.label) {
                case 0:
                    ResultKt.throwOnFailure($result);
                    C03402 c03402 = new C03402(function0, function2, null);
                    c03391.label = 1;
                    if (CoroutineScopeKt.coroutineScope(c03402, c03391) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    break;
                case 1:
    ...
    static final class C03402 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C03402(Function0<? extends I> function0, Function2<? super I, ? super Continuation<? super Unit>, ? extends Object> function2, Continuation<? super C03402> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C03402 c03402 = new C03402(this.$inputs, this.$block, continuation);
            c03402.L$0 = obj;
            return c03402;
        }
        ...
        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
            return ((C03402) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        static final class AnonymousClass1<T> implements FlowCollector {
            ...
            */
            public final Object emit(I i, Continuation<? super Unit> continuation) {
                ...
                switch (anchoredDraggableKt$restartable$2$1$emit$1.label) {
                    case 0:
                        ...
                        anonymousClass1.$previousDrag.element = (T) BuildersKt__Builders_commonKt.launch$default(anonymousClass1.$$this$coroutineScope, null, CoroutineStart.UNDISPATCHED, new C00432(anonymousClass1.$block, obj2, anonymousClass1.$$this$coroutineScope, null), 1, null);
                        return Unit.INSTANCE;
                    case 1:
            ...
            static final class C00432 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                ...
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                C00432(Function2<? super I, ? super Continuation<? super Unit>, ? extends Object> function2, I i, CoroutineScope coroutineScope, Continuation<? super C00432> continuation) {
                    super(2, continuation);
                    this.$block = function2;
                    this.$latestInputs = i;
                    this.$$this$coroutineScope = coroutineScope;
                ...
                @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
                public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                    return new C00432(this.$block, this.$latestInputs, this.$$this$coroutineScope, continuation);
                }
                ...
                public final Object invokeSuspend(Object $result) {
                    ...
                    CoroutineScopeKt.cancel(c00432.$$this$coroutineScope, new AnchoredDragFinishedSignal());
                    return Unit.INSTANCE;
                }
            }
        }
