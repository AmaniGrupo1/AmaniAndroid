...
public final class SwipeableKt$PreUpPostDownNestedScrollConnection$1 implements NestedScrollConnection {
    ...
    */
    public Object mo895onPreFlingQWom1Mo(long available, Continuation<? super Velocity> continuation) {
        ...
        Object $result = swipeableKt$PreUpPostDownNestedScrollConnection$1$onPreFling$1.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        switch (swipeableKt$PreUpPostDownNestedScrollConnection$1$onPreFling$1.label) {
            case 0:
                ResultKt.throwOnFailure($result);
                float toFling = toFloat(OffsetKt.Offset(Velocity.m7743getXimpl(available), Velocity.m7744getYimpl(available)));
                if (toFling < 0.0f && this.$this_PreUpPostDownNestedScrollConnection.getOffset().getValue().floatValue() > this.$this_PreUpPostDownNestedScrollConnection.getMinBound()) {
                    ...
                    swipeableKt$PreUpPostDownNestedScrollConnection$1$onPreFling$1.J$0 = available;
                    swipeableKt$PreUpPostDownNestedScrollConnection$1$onPreFling$1.label = 1;
                    if (swipeableState.performFling(toFling, swipeableKt$PreUpPostDownNestedScrollConnection$1$onPreFling$1) == coroutine_suspended) {
                ...
                break;
            case 1:
                available = swipeableKt$PreUpPostDownNestedScrollConnection$1$onPreFling$1.J$0;
                ResultKt.throwOnFailure($result);
                break;
            default:
    ...
    */
    public Object mo572onPostFlingRZ2iAVY(long j, long available, Continuation<? super Velocity> continuation) {
        ...
        switch (swipeableKt$PreUpPostDownNestedScrollConnection$1$onPostFling$1.label) {
            case 0:
                ResultKt.throwOnFailure($result);
                SwipeableState<T> swipeableState = this.$this_PreUpPostDownNestedScrollConnection;
                float f = toFloat(OffsetKt.Offset(Velocity.m7743getXimpl(available), Velocity.m7744getYimpl(available)));
    ...
    private final float toFloat(long $this$toFloat) {
        return Offset.m4453getYimpl($this$toFloat);
    }
}
