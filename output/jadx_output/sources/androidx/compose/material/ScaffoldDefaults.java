...
public final class ScaffoldDefaults {
    ...
    public final WindowInsets getContentWindowInsets(Composer $composer, int $changed) {
        ComposerKt.sourceInformationMarkerStart($composer, 423092031, "C362@16537L29:Scaffold.kt#jmzs0o");
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(423092031, $changed, -1, "androidx.compose.material.ScaffoldDefaults.<get-contentWindowInsets> (Scaffold.kt:362)");
        }
