            ...
            try {
                if (charSequence instanceof Spannable) {
                    try {
                            ...
                            try {
                                if (index >= charSequence.length()) {
                                    ...
                                    if (maxEmojiCount == Integer.MAX_VALUE || spannable == null) {
                                        ...
                                        try {
                                            maxEmojiCount2 = maxEmojiCount - ((EmojiSpan[]) spannable.getSpans(0, spannable.length(), EmojiSpan.class)).length;
                                        } catch (Throwable th2) {
                                            th = th2;
                                    ...
                                    try {
                                        charSequence2 = charSequence;
                                        try {
                                            UnprecomputeTextOnModificationSpannable spannable2 = (UnprecomputeTextOnModificationSpannable) process(charSequence2, index, end2, maxEmojiCount2, replaceAll, new EmojiProcessAddSpanCallback(spannable, this.mSpanFactory));
                                            if (spannable2 == null) {
                                                if (isSpannableBuilder) {
                                            ...
                                            Spannable unwrappedSpannable = spannable2.getUnwrappedSpannable();
                                            if (isSpannableBuilder) {
                                                ((SpannableBuilder) charSequence2).endBatchEdit();
                                            }
                        ...
                        if (isSpannableBuilder) {
                            ((SpannableBuilder) charSequence3).endBatchEdit();
                        }
