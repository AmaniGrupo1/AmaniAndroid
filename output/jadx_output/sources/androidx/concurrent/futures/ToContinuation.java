...
final class ToContinuation<T> implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            cancellableContinuation.resumeWith(Result.m8542constructorimpl(AbstractResolvableFuture.getUninterruptibly(this.futureToObserve)));
            ...
            cancellableContinuation2.resumeWith(Result.m8542constructorimpl(ResultKt.createFailure(thNonNullCause)));
        }
    }
}
