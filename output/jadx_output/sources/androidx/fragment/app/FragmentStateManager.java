...
class FragmentStateManager {
        ...
        try {
            ...
            if (fs != null) {
                ...
                if (bool != null) {
                    ...
                    fragment.mUserVisibleHint = fs.mUserVisibleHint;
                }
            }
    ...
    void createView() {
        ...
        if (this.mFragment.mView != null) {
            ...
            boolean zIsAttachedToWindow = this.mFragment.mView.isAttachedToWindow();
    ...
    Bundle saveState() {
        ...
        if (this.mFragment.mState > 0) {
            ...
            Bundle childFragmentManagerState = this.mFragment.mChildFragmentManager.m7804lambda$attachController$5$androidxfragmentappFragmentManager();
