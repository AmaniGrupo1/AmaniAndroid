        ...
        public void onStart(final ViewGroup container) {
                            ...
                            if (z) {
                                ...
                                /*  JADX ERROR: Method code generation error
                                    jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x0060: INVOKE 
                                     ...
                                     VIRTUAL call: androidx.fragment.app.FragmentTransitionImpl.animateToStart(java.lang.Object, java.lang.Runnable):void A[MD:(java.lang.Object, java.lang.Runnable):void (m)] in method: androidx.fragment.app.DefaultSpecialEffectsController$TransitionEffect$onStart$4.1.invoke():void, file: classes21.dex
            ...
            private final Pair<ArrayList<View>, Object> createMergedTransition(ViewGroup container, SpecialEffectsController.Operation lastIn, SpecialEffectsController.Operation firstOut) {
                ...
                while (it2.hasNext()) {
                    ...
                    Object transition2 = this.transitionImpl.cloneTransition(transitionInfo.getTransition());
                    if (transition2 != null) {
                        ...
                        FragmentTransitionImpl fragmentTransitionImpl = this.transitionImpl;
                        if (zIsEmpty) {
                            fragmentTransitionImpl.addTarget(transition2, nonExistentView);
                            transition = transition2;
                            arrayList = arrayList2;
                        } else {
                            fragmentTransitionImpl.addTargets(transition2, arrayList2);
                            this.transitionImpl.scheduleRemoveTargets(transition2, transition2, arrayList2, null, null, null, null);
                            transition = transition2;
                            arrayList = arrayList2;
                        ...
                        boolean isOverlapAllowed = transitionInfo.getIsOverlapAllowed();
                        FragmentTransitionImpl fragmentTransitionImpl2 = this.transitionImpl;
                        if (isOverlapAllowed) {
                            mergedTransition = fragmentTransitionImpl2.mergeTransitionsTogether(mergedTransition, transition, null);
                            operation = lastIn;
                            operation2 = firstOut;
                            ...
                            mergedNonOverlappingTransition = fragmentTransitionImpl2.mergeTransitionsTogether(mergedNonOverlappingTransition, transition, null);
                            operation = lastIn;
                            operation2 = firstOut;
                            hasLastInEpicenter = hasLastInEpicenter2;
                            nonExistentView = nonExistentView2;
            ...
            static final void createMergedTransition$lambda$12(SpecialEffectsController.Operation $lastIn, SpecialEffectsController.Operation $firstOut, TransitionEffect this$0) {
                Intrinsics.checkNotNullParameter(this$0, "this$0");
            ...
            static final void createMergedTransition$lambda$13(FragmentTransitionImpl impl, View $lastInEpicenterView, Rect lastInEpicenterRect) {
