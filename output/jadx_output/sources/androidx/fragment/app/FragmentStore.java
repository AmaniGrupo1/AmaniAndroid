...
class FragmentStore {
    ...
    Bundle getSavedState(String who) {
        return this.mSavedState.get(who);
    }

    Bundle setSavedState(String who, Bundle bundle) {
        HashMap<String, Bundle> map = this.mSavedState;
        if (bundle != null) {
            return map.put(who, bundle);
        }
        return map.remove(who);
    }

    void restoreSaveState(HashMap<String, Bundle> allSavedStates) {
