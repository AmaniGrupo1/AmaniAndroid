...
public final class DefaultWorkerFactory extends WorkerFactory {
    ...
    public /* bridge */ /* synthetic */ ListenableWorker createWorker(Context appContext, String workerClassName, WorkerParameters workerParameters) {
        return (ListenableWorker) m8200createWorker(appContext, workerClassName, workerParameters);
    }
    ...
    public Void m8200createWorker(Context appContext, String workerClassName, WorkerParameters workerParameters) {
