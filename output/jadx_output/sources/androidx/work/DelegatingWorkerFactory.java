...
public class DelegatingWorkerFactory extends WorkerFactory {
    ...
    public final ListenableWorker createWorker(Context appContext, String workerClassName, WorkerParameters workerParameters) {
        ...
        for (WorkerFactory factory : this.factories) {
            try {
                ListenableWorker listenableWorkerCreateWorker = factory.createWorker(appContext, workerClassName, workerParameters);
                ...
                Logger.get().error(DelegatingWorkerFactoryKt.TAG, message, throwable);
                throw throwable;
            }
        }
        return null;
