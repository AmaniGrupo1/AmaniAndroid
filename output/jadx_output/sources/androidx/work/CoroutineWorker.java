...
public abstract class CoroutineWorker extends ListenableWorker {
    ...
    public final ListenableFuture<ListenableWorker.Result> startWork() {
        ...
        if (!Intrinsics.areEqual(getCoroutineContext(), DeprecatedDispatcher.INSTANCE)) {
            ...
            coroutineContext = this.params.getWorkerContext();
        }
        Intrinsics.checkNotNull(coroutineContext);
        return ListenableFutureKt.launchFuture$default(coroutineContext.plus(JobKt__JobKt.Job$default((Job) null, 1, (Object) null)), null, new C06471(null), 2, null);
    }
    ...
    @DebugMetadata(c = "androidx.work.CoroutineWorker$startWork$1", f = "CoroutineWorker.kt", i = {}, l = {MdtaMetadataEntry.TYPE_INDICATOR_INT32}, m = "invokeSuspend", n = {}, s = {})
    static final class C06471 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ListenableWorker.Result>, Object> {
        int label;
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return CoroutineWorker.this.new C06471(continuation);
        }
    ...
    private static final class DeprecatedDispatcher extends CoroutineDispatcher {
        ...
        public void mo10112dispatch(CoroutineContext context, Runnable block) {
            Intrinsics.checkNotNullParameter(context, "context");
            Intrinsics.checkNotNullParameter(block, "block");
            dispatcher.mo10112dispatch(context, block);
        }
