...
public final class Configuration {
    ...
    public Configuration(Builder builder) {
        ...
        CoroutineContext builderWorkerDispatcher = builder.getWorkerContext();
        Executor executor = builder.getExecutor();
        if (executor == null) {
            executor = builderWorkerDispatcher != null ? ConfigurationKt.asExecutor(builderWorkerDispatcher) : null;
            if (executor == null) {
                executor = ConfigurationKt.createDefaultExecutor(false);
            }
        }
        this.executor = executor;
        if (builderWorkerDispatcher != null) {
            coroutineDispatcherFrom = builderWorkerDispatcher;
        } else {
            coroutineDispatcherFrom = builder.getExecutor() != null ? ExecutorsKt.from(this.executor) : Dispatchers.getDefault();
        }
        this.workerCoroutineContext = coroutineDispatcherFrom;
