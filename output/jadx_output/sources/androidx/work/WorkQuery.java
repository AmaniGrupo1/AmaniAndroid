...
public final class WorkQuery {
    ...
    @JvmStatic
    public static final WorkQuery fromIds(UUID... ids) {
        return INSTANCE.fromIds(ids);
    }
    ...
    @JvmStatic
    public static final WorkQuery fromTags(String... tags) {
        return INSTANCE.fromTags(tags);
    }

    @JvmStatic
    public static final WorkQuery fromUniqueWorkNames(String... uniqueWorkNames) {
        return INSTANCE.fromUniqueWorkNames(uniqueWorkNames);
    }
    ...
    @JvmStatic
    public static final WorkQuery fromStates(WorkInfo.State... states) {
        return INSTANCE.fromStates(states);
    }
}
