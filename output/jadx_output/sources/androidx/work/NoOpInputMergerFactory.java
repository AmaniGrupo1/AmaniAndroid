...
public final class NoOpInputMergerFactory extends InputMergerFactory {
    ...
    public /* bridge */ /* synthetic */ InputMerger createInputMerger(String className) {
        return (InputMerger) m8201createInputMerger(className);
    }

    /* JADX INFO: renamed from: createInputMerger, reason: collision with other method in class */
    public Void m8201createInputMerger(String className) {
