...
public class Processor implements ForegroundProcessor {
    ...
    public boolean startWork(StartStopToken startStopToken, WorkerParameters.RuntimeExtras runtimeExtras) throws Throwable {
        ...
        WorkSpec workSpec = (WorkSpec) this.mWorkDatabase.runInTransaction(new Callable() { // from class: androidx.work.impl.Processor$$ExternalSyntheticLambda1
            ...
            public final Object call() {
                return this.f$0.m8203lambda$startWork$0$androidxworkimplProcessor(tags, workSpecId);
            }
        });
        if (workSpec == null) {
        ...
        synchronized (this.mLock) {
            try {
                try {
                    ...
                    final ListenableFuture<Boolean> future = workWrapper.launch();
                    future.addListener(new Runnable() { // from class: androidx.work.impl.Processor$$ExternalSyntheticLambda2
                        @Override // java.lang.Runnable
                        public final void run() {
                            this.f$0.m8204lambda$startWork$1$androidxworkimplProcessor(future, workWrapper);
                        }
    ...
    /* synthetic */ WorkSpec m8203lambda$startWork$0$androidxworkimplProcessor(ArrayList tags, String workSpecId) throws Exception {
    ...
    /* synthetic */ void m8204lambda$startWork$1$androidxworkimplProcessor(ListenableFuture future, WorkerWrapper workWrapper) {
    ...
    private void runOnExecuted(final WorkGenerationalId id, final boolean needsReschedule) {
        this.mWorkTaskExecutor.getMainThreadExecutor().execute(new Runnable() { // from class: androidx.work.impl.Processor$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m8202lambda$runOnExecuted$2$androidxworkimplProcessor(id, needsReschedule);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$runOnExecuted$2$androidx-work-impl-Processor, reason: not valid java name */
    /* synthetic */ void m8202lambda$runOnExecuted$2$androidxworkimplProcessor(WorkGenerationalId id, boolean needsReschedule) {
        synchronized (this.mLock) {
            for (ExecutionListener executionListener : this.mOuterListeners) {
                executionListener.onExecuted(id, needsReschedule);
            }
