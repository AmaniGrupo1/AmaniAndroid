...
/* JADX INFO: compiled from: WorkTagDao_Impl.kt */
/* JADX INFO: loaded from: classes21.dex */
@Metadata(d1 = {"\u00000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0010 \n\u0002\u0010\u000e\n\u0002\b\u0006\u0018\u0000 \u00132\u00020\u0001:\u0001\u0013B\u000f\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0004\b\u0004\u0010\u0005J\u0010\u0010\t\u001a\u00020\n2\u0006\u0010\u000b\u001a\u00020\bH\u0016J\u0016\u0010\f\u001a\b\u0012\u0004\u0012\u00020\u000e0\r2\u0006\u0010\u000f\u001a\u00020\u000eH\u0016J\u0016\u0010\u0010\u001a\b\u0012\u0004\u0012\u00020\u000e0\r2\u0006\u0010\u0011\u001a\u00020\u000eH\u0016J\u0010\u0010\u0012\u001a\u00020\n2\u0006\u0010\u0011\u001a\u00020\u000eH\u0016R\u000e\u0010\u0002\u001a\u00020\u0003X\u0082\u0004¢\u0006\u0002\n\u0000R\u0014\u0010\u0006\u001a\b\u0012\u0004\u0012\u00020\b0\u0007X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u0014"}, d2 = {"Landroidx/work/impl/model/WorkTagDao_Impl;", "Landroidx/work/impl/model/WorkTagDao;", "__db", "Landroidx/room/RoomDatabase;", "<init>", "(Landroidx/room/RoomDatabase;)V", "__insertAdapterOfWorkTag", "Landroidx/room/EntityInsertAdapter;", "Landroidx/work/impl/model/WorkTag;", "insert", "", "workTag", "getWorkSpecIdsWithTag", "", "", "tag", "getTagsForWorkSpecId", TtmlNode.ATTR_ID, "deleteByWorkSpecId", "Companion", "work-runtime_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
public final class WorkTagDao_Impl implements WorkTagDao {
    ...
    public WorkTagDao_Impl(RoomDatabase __db) {
        ...
        this.__insertAdapterOfWorkTag = new EntityInsertAdapter<WorkTag>() { // from class: androidx.work.impl.model.WorkTagDao_Impl.1
            ...
            public void bind(SQLiteStatement statement, WorkTag entity) {
                ...
                statement.mo8066bindText(1, entity.getTag());
                statement.mo8066bindText(2, entity.getWorkSpecId());
            }
        };
    }
    ...
    static final Unit insert$lambda$0(WorkTagDao_Impl this$0, WorkTag $workTag, SQLiteConnection _connection) {
        Intrinsics.checkNotNullParameter(_connection, "_connection");
        this$0.__insertAdapterOfWorkTag.insert(_connection, $workTag);
    ...
    public List<String> getWorkSpecIdsWithTag(final String tag) {
        ...
        final String _sql = "SELECT work_spec_id FROM worktag WHERE tag=?";
        return (List) DBUtil.performBlocking(this.__db, true, false, new Function1() { // from class: androidx.work.impl.model.WorkTagDao_Impl$$ExternalSyntheticLambda3
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return WorkTagDao_Impl.getWorkSpecIdsWithTag$lambda$1(_sql, tag, (SQLiteConnection) obj);
            }
        });
    }

    static final List getWorkSpecIdsWithTag$lambda$1(String $_sql, String $tag, SQLiteConnection _connection) {
        Intrinsics.checkNotNullParameter(_connection, "_connection");
    ...
    public List<String> getTagsForWorkSpecId(final String id) {
        ...
        final String _sql = "SELECT DISTINCT tag FROM worktag WHERE work_spec_id=?";
        return (List) DBUtil.performBlocking(this.__db, true, false, new Function1() { // from class: androidx.work.impl.model.WorkTagDao_Impl$$ExternalSyntheticLambda1
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return WorkTagDao_Impl.getTagsForWorkSpecId$lambda$2(_sql, id, (SQLiteConnection) obj);
            }
        });
    }

    static final List getTagsForWorkSpecId$lambda$2(String $_sql, String $id, SQLiteConnection _connection) {
        Intrinsics.checkNotNullParameter(_connection, "_connection");
        SQLiteStatement _stmt = _connection.prepare($_sql);
        try {
    ...
    public void deleteByWorkSpecId(final String id) {
        Intrinsics.checkNotNullParameter(id, "id");
        final String _sql = "DELETE FROM worktag WHERE work_spec_id=?";
        DBUtil.performBlocking(this.__db, false, true, new Function1() { // from class: androidx.work.impl.model.WorkTagDao_Impl$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return WorkTagDao_Impl.deleteByWorkSpecId$lambda$3(_sql, id, (SQLiteConnection) obj);
            }
        });
    }

    static final Unit deleteByWorkSpecId$lambda$3(String $_sql, String $id, SQLiteConnection _connection) {
        Intrinsics.checkNotNullParameter(_connection, "_connection");
        SQLiteStatement _stmt = _connection.prepare($_sql);
        try {
            _stmt.mo8066bindText(1, $id);
