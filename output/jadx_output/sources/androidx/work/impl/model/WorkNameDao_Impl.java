...
/* JADX INFO: compiled from: WorkNameDao_Impl.kt */
/* JADX INFO: loaded from: classes21.dex */
@Metadata(d1 = {"\u00000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0010 \n\u0002\u0010\u000e\n\u0002\b\u0005\u0018\u0000 \u00122\u00020\u0001:\u0001\u0012B\u000f\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0004\b\u0004\u0010\u0005J\u0010\u0010\t\u001a\u00020\n2\u0006\u0010\u000b\u001a\u00020\bH\u0016J\u0016\u0010\f\u001a\b\u0012\u0004\u0012\u00020\u000e0\r2\u0006\u0010\u000f\u001a\u00020\u000eH\u0016J\u0016\u0010\u0010\u001a\b\u0012\u0004\u0012\u00020\u000e0\r2\u0006\u0010\u0011\u001a\u00020\u000eH\u0016R\u000e\u0010\u0002\u001a\u00020\u0003X\u0082\u0004¢\u0006\u0002\n\u0000R\u0014\u0010\u0006\u001a\b\u0012\u0004\u0012\u00020\b0\u0007X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u0013"}, d2 = {"Landroidx/work/impl/model/WorkNameDao_Impl;", "Landroidx/work/impl/model/WorkNameDao;", "__db", "Landroidx/room/RoomDatabase;", "<init>", "(Landroidx/room/RoomDatabase;)V", "__insertAdapterOfWorkName", "Landroidx/room/EntityInsertAdapter;", "Landroidx/work/impl/model/WorkName;", "insert", "", "workName", "getWorkSpecIdsWithName", "", "", HintConstants.AUTOFILL_HINT_NAME, "getNamesForWorkSpecId", "workSpecId", "Companion", "work-runtime_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
public final class WorkNameDao_Impl implements WorkNameDao {
    ...
    public WorkNameDao_Impl(RoomDatabase __db) {
        ...
        this.__insertAdapterOfWorkName = new EntityInsertAdapter<WorkName>() { // from class: androidx.work.impl.model.WorkNameDao_Impl.1
            ...
            public void bind(SQLiteStatement statement, WorkName entity) {
                ...
                statement.mo8066bindText(1, entity.getName());
    ...
    static final Unit insert$lambda$0(WorkNameDao_Impl this$0, WorkName $workName, SQLiteConnection _connection) {
        Intrinsics.checkNotNullParameter(_connection, "_connection");
        this$0.__insertAdapterOfWorkName.insert(_connection, $workName);
    ...
    public List<String> getWorkSpecIdsWithName(final String name) {
        ...
        final String _sql = "SELECT work_spec_id FROM workname WHERE name=?";
        return (List) DBUtil.performBlocking(this.__db, true, false, new Function1() { // from class: androidx.work.impl.model.WorkNameDao_Impl$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return WorkNameDao_Impl.getWorkSpecIdsWithName$lambda$1(_sql, name, (SQLiteConnection) obj);
            }
        });
    }

    static final List getWorkSpecIdsWithName$lambda$1(String $_sql, String $name, SQLiteConnection _connection) {
        Intrinsics.checkNotNullParameter(_connection, "_connection");
    ...
    public List<String> getNamesForWorkSpecId(final String workSpecId) {
        ...
        final String _sql = "SELECT name FROM workname WHERE work_spec_id=?";
        return (List) DBUtil.performBlocking(this.__db, true, false, new Function1() { // from class: androidx.work.impl.model.WorkNameDao_Impl$$ExternalSyntheticLambda1
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return WorkNameDao_Impl.getNamesForWorkSpecId$lambda$2(_sql, workSpecId, (SQLiteConnection) obj);
            }
        });
    }

    static final List getNamesForWorkSpecId$lambda$2(String $_sql, String $workSpecId, SQLiteConnection _connection) {
        Intrinsics.checkNotNullParameter(_connection, "_connection");
        SQLiteStatement _stmt = _connection.prepare($_sql);
        try {
