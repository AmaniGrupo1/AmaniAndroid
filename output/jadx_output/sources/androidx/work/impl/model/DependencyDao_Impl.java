...
public final class DependencyDao_Impl implements DependencyDao {
    ...
    public DependencyDao_Impl(RoomDatabase __db) {
        ...
        this.__insertAdapterOfDependency = new EntityInsertAdapter<Dependency>() { // from class: androidx.work.impl.model.DependencyDao_Impl.1
            ...
            public void bind(SQLiteStatement statement, Dependency entity) {
                ...
                statement.mo8066bindText(2, entity.getPrerequisiteId());
            }
        };
    }
    ...
    static final Unit insertDependency$lambda$0(DependencyDao_Impl this$0, Dependency $dependency, SQLiteConnection _connection) {
        Intrinsics.checkNotNullParameter(_connection, "_connection");
        this$0.__insertAdapterOfDependency.insert(_connection, $dependency);
    ...
    public boolean hasCompletedAllPrerequisites(final String id) {
        ...
        final String _sql = "SELECT COUNT(*)=0 FROM dependency WHERE work_spec_id=? AND prerequisite_id IN (SELECT id FROM workspec WHERE state!=2)";
        return ((Boolean) DBUtil.performBlocking(this.__db, true, false, new Function1() { // from class: androidx.work.impl.model.DependencyDao_Impl$$ExternalSyntheticLambda3
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return Boolean.valueOf(DependencyDao_Impl.hasCompletedAllPrerequisites$lambda$1(_sql, id, (SQLiteConnection) obj));
            }
        })).booleanValue();
    }

    static final boolean hasCompletedAllPrerequisites$lambda$1(String $_sql, String $id, SQLiteConnection _connection) {
        boolean _result;
        Intrinsics.checkNotNullParameter(_connection, "_connection");
    ...
    public List<String> getPrerequisites(final String id) {
        Intrinsics.checkNotNullParameter(id, "id");
        final String _sql = "SELECT prerequisite_id FROM dependency WHERE work_spec_id=?";
        return (List) DBUtil.performBlocking(this.__db, true, false, new Function1() { // from class: androidx.work.impl.model.DependencyDao_Impl$$ExternalSyntheticLambda4
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return DependencyDao_Impl.getPrerequisites$lambda$2(_sql, id, (SQLiteConnection) obj);
            }
        });
    }

    static final List getPrerequisites$lambda$2(String $_sql, String $id, SQLiteConnection _connection) {
        Intrinsics.checkNotNullParameter(_connection, "_connection");
        SQLiteStatement _stmt = _connection.prepare($_sql);
        try {
            _stmt.mo8066bindText(1, $id);
    ...
    public List<String> getDependentWorkIds(final String id) {
        Intrinsics.checkNotNullParameter(id, "id");
        final String _sql = "SELECT work_spec_id FROM dependency WHERE prerequisite_id=?";
        return (List) DBUtil.performBlocking(this.__db, true, false, new Function1() { // from class: androidx.work.impl.model.DependencyDao_Impl$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return DependencyDao_Impl.getDependentWorkIds$lambda$3(_sql, id, (SQLiteConnection) obj);
            }
        });
    }

    static final List getDependentWorkIds$lambda$3(String $_sql, String $id, SQLiteConnection _connection) {
        Intrinsics.checkNotNullParameter(_connection, "_connection");
        SQLiteStatement _stmt = _connection.prepare($_sql);
        try {
            _stmt.mo8066bindText(1, $id);
    ...
    public boolean hasDependents(final String id) {
        Intrinsics.checkNotNullParameter(id, "id");
        final String _sql = "SELECT COUNT(*)>0 FROM dependency WHERE prerequisite_id=?";
        return ((Boolean) DBUtil.performBlocking(this.__db, true, false, new Function1() { // from class: androidx.work.impl.model.DependencyDao_Impl$$ExternalSyntheticLambda2
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return Boolean.valueOf(DependencyDao_Impl.hasDependents$lambda$4(_sql, id, (SQLiteConnection) obj));
            }
        })).booleanValue();
    }

    static final boolean hasDependents$lambda$4(String $_sql, String $id, SQLiteConnection _connection) {
        boolean _result;
        Intrinsics.checkNotNullParameter(_connection, "_connection");
        SQLiteStatement _stmt = _connection.prepare($_sql);
        try {
