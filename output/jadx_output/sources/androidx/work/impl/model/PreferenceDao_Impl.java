...
/* JADX INFO: compiled from: PreferenceDao_Impl.kt */
...
public final class PreferenceDao_Impl implements PreferenceDao {
    ...
    public PreferenceDao_Impl(RoomDatabase __db) {
        ...
        this.__insertAdapterOfPreference = new EntityInsertAdapter<Preference>() { // from class: androidx.work.impl.model.PreferenceDao_Impl.1
            ...
            public void bind(SQLiteStatement statement, Preference entity) {
                ...
                statement.mo8066bindText(1, entity.getKey());
                Long _tmpValue = entity.getValue();
                if (_tmpValue != null) {
                    statement.mo8064bindLong(2, _tmpValue.longValue());
                } else {
                    statement.mo8065bindNull(2);
                }
            }
        };
    }
    ...
    static final Unit insertPreference$lambda$0(PreferenceDao_Impl this$0, Preference $preference, SQLiteConnection _connection) {
        Intrinsics.checkNotNullParameter(_connection, "_connection");
        this$0.__insertAdapterOfPreference.insert(_connection, $preference);
    ...
    public Long getLongValue(final String key) {
        ...
        final String _sql = "SELECT long_value FROM Preference where `key`=?";
        return (Long) DBUtil.performBlocking(this.__db, true, false, new Function1() { // from class: androidx.work.impl.model.PreferenceDao_Impl$$ExternalSyntheticLambda2
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return PreferenceDao_Impl.getLongValue$lambda$1(_sql, key, (SQLiteConnection) obj);
            }
        });
    }

    static final Long getLongValue$lambda$1(String $_sql, String $key, SQLiteConnection _connection) {
        Long _result;
        Intrinsics.checkNotNullParameter(_connection, "_connection");
        SQLiteStatement _stmt = _connection.prepare($_sql);
        try {
            _stmt.mo8066bindText(1, $key);
    ...
    public LiveData<Long> getObservableLongValue(final String key) {
        Intrinsics.checkNotNullParameter(key, "key");
        final String _sql = "SELECT long_value FROM Preference where `key`=?";
        return this.__db.getInvalidationTracker().createLiveData(new String[]{"Preference"}, false, new Function1() { // from class: androidx.work.impl.model.PreferenceDao_Impl$$ExternalSyntheticLambda1
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return PreferenceDao_Impl.getObservableLongValue$lambda$2(_sql, key, (SQLiteConnection) obj);
            }
        });
    }

    static final Long getObservableLongValue$lambda$2(String $_sql, String $key, SQLiteConnection _connection) {
        Long _result;
        Intrinsics.checkNotNullParameter(_connection, "_connection");
        SQLiteStatement _stmt = _connection.prepare($_sql);
        try {
