...
public final class WorkManagerImplExtKt {
    ...
    public static /* synthetic */ WorkManagerImpl createWorkManager$default(Context context, Configuration configuration, TaskExecutor taskExecutor, WorkDatabase workDatabase, Trackers trackers, Processor processor, Function6 function6, int i, Object obj) {
        ...
        return createWorkManager(context, configuration, workManagerTaskExecutor, workDatabase, trackers2, (i & 32) != 0 ? new Processor(context.getApplicationContext(), configuration, workManagerTaskExecutor, workDatabase) : processor, (i & 64) != 0 ? WorkManagerImplExtKt$WorkManagerImpl$1.INSTANCE : function6);
    }
    ...
    static final List schedulers$lambda$0(Scheduler[] $schedulers, Context context, Configuration configuration, TaskExecutor taskExecutor, WorkDatabase workDatabase, Trackers trackers, Processor processor) {
    ...
    public static final List<Scheduler> createSchedulers(Context context, Configuration configuration, TaskExecutor workTaskExecutor, WorkDatabase workDatabase, Trackers trackers, Processor processor) {
        ...
        return CollectionsKt.listOf((Object[]) new Scheduler[]{schedulerCreateBestAvailableBackgroundScheduler, new GreedyScheduler(context, configuration, trackers, processor, new WorkLauncherImpl(processor, workTaskExecutor), workTaskExecutor)});
    }
    ...
    public static final void close(WorkManagerImpl $this$close) {
        Intrinsics.checkNotNullParameter($this$close, "<this>");
        BuildersKt__BuildersKt.runBlocking$default(null, new AnonymousClass1($this$close, null), 1, null);
        $this$close.getWorkDatabase().close();
    }
}
