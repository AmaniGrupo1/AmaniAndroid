...
public final class ProcessUtils {
    ...
    private static final String getProcessName(Context context) {
        ...
        try {
            Method currentProcessName = Class.forName("android.app.ActivityThread", false, WorkManager.class.getClassLoader()).getDeclaredMethod("currentProcessName", new Class[0]);
