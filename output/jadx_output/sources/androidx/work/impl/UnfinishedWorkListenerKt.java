...
public final class UnfinishedWorkListenerKt {
    ...
    public static final void maybeLaunchUnfinishedWorkListener(CoroutineScope $this$maybeLaunchUnfinishedWorkListener, Context appContext, Configuration configuration, WorkDatabase db) {
        Intrinsics.checkNotNullParameter($this$maybeLaunchUnfinishedWorkListener, "<this>");
        Intrinsics.checkNotNullParameter(appContext, "appContext");
        Intrinsics.checkNotNullParameter(configuration, "configuration");
        Intrinsics.checkNotNullParameter(db, "db");
        if (ProcessUtils.isDefaultProcess(appContext, configuration)) {
            FlowKt.launchIn(FlowKt.onEach(FlowKt.distinctUntilChanged(FlowKt.conflate(FlowKt.retryWhen(db.workSpecDao().hasUnfinishedWorkFlow(), new AnonymousClass1(null)))), new AnonymousClass2(appContext, null)), $this$maybeLaunchUnfinishedWorkListener);
        }
    }
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    Logger.get().error(UnfinishedWorkListenerKt.TAG, "Cannot check for unfinished work", throwable);
                    long attempt2 = Math.min(((long) UnfinishedWorkListenerKt.DELAY_MS) * attempt, UnfinishedWorkListenerKt.MAX_DELAY_MS);
                    this.label = 1;
                    if (DelayKt.delay(attempt2, this) == coroutine_suspended) {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    boolean hasUnfinishedWork = this.Z$0;
                    PackageManagerHelper.setComponentEnabled(this.$appContext, RescheduleReceiver.class, hasUnfinishedWork);
