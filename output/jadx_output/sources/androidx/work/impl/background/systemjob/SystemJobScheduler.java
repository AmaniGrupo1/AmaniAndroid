...
public class SystemJobScheduler implements Scheduler {
    ...
    public void scheduleInternal(WorkSpec workSpec, int jobId) {
        ...
        try {
            ...
            String message = JobSchedulerExtKt.createErrorMessage(this.mContext, this.mWorkDatabase, this.mConfiguration);
    ...
    public static boolean reconcileJobs(Context context, WorkDatabase workDatabase) {
        JobScheduler jobScheduler = JobSchedulerExtKt.getWmJobScheduler(context);
        List<JobInfo> jobs = getPendingJobs(context, jobScheduler);
    ...
    static List<JobInfo> getPendingJobs(Context context, JobScheduler jobScheduler) {
        List<JobInfo> pendingJobs = JobSchedulerExtKt.getSafePendingJobs(jobScheduler);
        if (pendingJobs == null) {
            return null;
        }
