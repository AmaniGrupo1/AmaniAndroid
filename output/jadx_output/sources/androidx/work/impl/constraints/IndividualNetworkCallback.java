...
final class IndividualNetworkCallback extends ConnectivityManager.NetworkCallback {
    ...
    public static final class Companion {
        ...
        public final Function0<Unit> addCallback(final ConnectivityManager connManager, NetworkRequest networkRequest, Function1<? super ConstraintsState, Unit> onConstraintState) {
            ...
            final IndividualNetworkCallback networkCallback = new IndividualNetworkCallback(onConstraintState, null);
            final Ref.BooleanRef callbackRegistered = new Ref.BooleanRef();
            try {
                ...
                callbackRegistered.element = true;
            } catch (RuntimeException ex) {
                String name = ex.getClass().getName();
                Intrinsics.checkNotNullExpressionValue(name, "getName(...)");
                if (StringsKt.endsWith$default(name, "TooManyRequestsException", false, 2, (Object) null)) {
                    Logger.get().debug(WorkConstraintsTrackerKt.TAG, "NetworkRequestConstraintController couldn't register callback", ex);
            ...
            return new Function0() { // from class: androidx.work.impl.constraints.IndividualNetworkCallback$Companion$$ExternalSyntheticLambda0
                ...
                public final Object invoke() {
                    return IndividualNetworkCallback.Companion.addCallback$lambda$0(callbackRegistered, connManager, networkCallback);
                }
            };
        }

        static final Unit addCallback$lambda$0(Ref.BooleanRef $callbackRegistered, ConnectivityManager $connManager, IndividualNetworkCallback $networkCallback) {
            if ($callbackRegistered.element) {
