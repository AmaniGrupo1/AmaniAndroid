...
public final class NetworkStateTrackerPre28 extends ConstraintTracker<NetworkState> {
    ...
    /* JADX WARN: Type inference failed for: r0v6, types: [androidx.work.impl.constraints.trackers.NetworkStateTrackerPre28$networkCallback$1] */
    public NetworkStateTrackerPre28(Context context, TaskExecutor taskExecutor) {
        ...
        this.networkCallback = new ConnectivityManager.NetworkCallback() { // from class: androidx.work.impl.constraints.trackers.NetworkStateTrackerPre28$networkCallback$1
            ...
            public void onCapabilitiesChanged(Network network, NetworkCapabilities capabilities) {
                ...
                this.this$0.setState(NetworkStateTrackerKt.getActiveNetworkState(this.this$0.connectivityManager, this.this$0.isBlocked));
            }
            ...
            public void onBlockedStatusChanged(Network network, boolean blocked) {
                ...
                if (Intrinsics.areEqual(network, this.this$0.connectivityManager.getActiveNetwork())) {
                    ...
                    NetworkState currentState = this.this$0.getState();
                    ...
                    synchronized (obj) {
                        ...
                        this.this$0.setState(NetworkState.copy$default(currentState, false, false, false, false, blocked, 15, null));
                    }
                }
            }
        };
