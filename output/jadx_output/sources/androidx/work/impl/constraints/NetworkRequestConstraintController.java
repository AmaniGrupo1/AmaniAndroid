...
public final class NetworkRequestConstraintController implements ConstraintController {
    ...
    public NetworkRequestConstraintController(ConnectivityManager connManager, long timeoutMs) {
    ...
    @DebugMetadata(c = "androidx.work.impl.constraints.NetworkRequestConstraintController$track$1", f = "WorkConstraintsTracker.kt", i = {}, l = {191}, m = "invokeSuspend", n = {}, s = {})
    static final class AnonymousClass1 extends SuspendLambda implements Function2<ProducerScope<? super ConstraintsState>, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    NetworkRequest networkRequest = this.$constraints.getRequiredNetworkRequest();
                    if (networkRequest == null) {
                        networkRequest = NetworkTypeCompatKt.toNetworkRequest(this.$constraints.getRequiredNetworkType());
                    }
                    if (networkRequest != null) {
                        final Job timeoutJob = BuildersKt__Builders_commonKt.launch$default($this$callbackFlow, null, null, new NetworkRequestConstraintController$track$1$timeoutJob$1(this.this$0, $this$callbackFlow, null), 3, null);
                        Function1<? super ConstraintsState, Unit> function1 = new Function1() { // from class: androidx.work.impl.constraints.NetworkRequestConstraintController$track$1$$ExternalSyntheticLambda0
                            ...
                            public final Object invoke(Object obj) {
                                return NetworkRequestConstraintController.AnonymousClass1.invokeSuspend$lambda$0(timeoutJob, $this$callbackFlow, (ConstraintsState) obj);
                            }
                        };
                        if (Build.VERSION.SDK_INT >= 30) {
                            function0AddCallback = SharedNetworkCallback.INSTANCE.addCallback(this.this$0.connManager, networkRequest, function1);
                        } else {
                            function0AddCallback = IndividualNetworkCallback.INSTANCE.addCallback(this.this$0.connManager, networkRequest, function1);
                        }
                        this.label = 1;
                        if (ProduceKt.awaitClose($this$callbackFlow, new Function0() { // from class: androidx.work.impl.constraints.NetworkRequestConstraintController$track$1$$ExternalSyntheticLambda1
                        ...
                        SendChannel.DefaultImpls.close$default($this$callbackFlow.getChannel(), null, 1, null);
        ...
        static final Unit invokeSuspend$lambda$0(Job $timeoutJob, ProducerScope $$this$callbackFlow, ConstraintsState it) {
            Job.DefaultImpls.cancel$default($timeoutJob, (CancellationException) null, 1, (Object) null);
            $$this$callbackFlow.mo10050trySendJP2dKIU(it);
            return Unit.INSTANCE;
        }

        static final Unit invokeSuspend$lambda$1(Function0 $tryUnregister) {
            $tryUnregister.invoke();
            return Unit.INSTANCE;
        }
    }
