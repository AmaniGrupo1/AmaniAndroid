...
@DebugMetadata(c = "androidx.work.impl.WorkerWrapper$runWorker$result$1", f = "WorkerWrapper.kt", i = {}, l = {297, 308}, m = "invokeSuspend", n = {}, s = {})
final class WorkerWrapper$runWorker$result$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ListenableWorker.Result>, Object> {
    ...
    public final Object invokeSuspend(Object $result) throws Throwable {
        ...
        Logger.get().debug(tag$iv, "Starting work for " + this.this$0.getWorkSpec().workerClassName);
