...
final class ToContinuation<T> implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            cancellableContinuation.resumeWith(Result.m8542constructorimpl(WorkerWrapperKt.getUninterruptibly(this.futureToObserve)));
        } catch (ExecutionException e) {
            CancellableContinuation<T> cancellableContinuation2 = this.continuation;
            Result.Companion companion2 = Result.INSTANCE;
            cancellableContinuation2.resumeWith(Result.m8542constructorimpl(ResultKt.createFailure(WorkerWrapperKt.nonNullCause(e))));
        }
    }
}
