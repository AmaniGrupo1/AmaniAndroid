...
public final class ListenableFutureKt {
    ...
    static final Object launchFuture$lambda$1(CoroutineContext $context, CoroutineStart $start, Function2 $block, CallbackToFutureAdapter.Completer completer) {
        Intrinsics.checkNotNullParameter(completer, "completer");
        final Job job = (Job) $context.get(Job.INSTANCE);
        ...
        return BuildersKt__Builders_commonKt.launch$default(CoroutineScopeKt.CoroutineScope($context), null, $start, new ListenableFutureKt$launchFuture$1$2($block, completer, null), 1, null);
    }

    static final void launchFuture$lambda$1$lambda$0(Job $job) {
        if ($job != null) {
            Job.DefaultImpls.cancel$default($job, (CancellationException) null, 1, (Object) null);
        }
    }

    public static final <V> ListenableFuture<V> executeAsync(final Executor $this$executeAsync, final String debugTag, final Function0<? extends V> block) {
        Intrinsics.checkNotNullParameter($this$executeAsync, "<this>");
        ...
        ListenableFuture<V> future = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.work.ListenableFutureKt$$ExternalSyntheticLambda0
            @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return ListenableFutureKt.executeAsync$lambda$4($this$executeAsync, debugTag, block, completer);
            }
        });
        Intrinsics.checkNotNullExpressionValue(future, "getFuture(...)");
        return future;
    ...
    static final Object executeAsync$lambda$4(Executor $this_executeAsync, String $debugTag, final Function0 $block, final CallbackToFutureAdapter.Completer completer) {
        Intrinsics.checkNotNullParameter(completer, "completer");
        ...
        $this_executeAsync.execute(new Runnable() { // from class: androidx.work.ListenableFutureKt$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
                ListenableFutureKt.executeAsync$lambda$4$lambda$3(cancelled, completer, $block);
            }
        });
        return $debugTag;
    }

    static final void executeAsync$lambda$4$lambda$3(AtomicBoolean $cancelled, CallbackToFutureAdapter.Completer $completer, Function0 $block) {
        if ($cancelled.get()) {
            return;
        }
        try {
