...
class CachedContentIndex {
    ...
    public CachedContentIndex(DatabaseProvider databaseProvider, File legacyStorageDir, byte[] legacyStorageSecretKey, boolean legacyStorageEncrypt, boolean preferLegacyStorage) {
        Preconditions.checkState((databaseProvider == null && legacyStorageDir == null) ? false : true);
    ...
    private static class LegacyStorage implements Storage {
        ...
        public LegacyStorage(File file, byte[] secretKey, boolean encrypt) {
            Preconditions.checkState((secretKey == null && encrypt) ? false : true);
            Cipher cipher = null;
            SecretKeySpec secretKeySpec = null;
            if (secretKey != null) {
                Preconditions.checkArgument(secretKey.length == 16);
                try {
                ...
                Preconditions.checkArgument(!encrypt);
            }
        ...
        private void writeFile(HashMap<String, CachedContent> content) throws IOException {
            ...
            try {
                ...
                DataOutputStream output2 = new DataOutputStream(bufferedOutputStream);
                output2.writeInt(2);
                ...
                if (this.encrypt) {
                    ...
                    try {
                        ...
                        output2.flush();
                        output2 = new DataOutputStream(new CipherOutputStream(bufferedOutputStream, this.cipher));
                    } catch (InvalidAlgorithmParameterException e) {
                        e = e;
                        throw new IllegalStateException(e);
                    } catch (InvalidKeyException e2) {
    ...
    private static final class DatabaseStorage implements Storage {
        ...
        public void load(HashMap<String, CachedContent> content, SparseArray<String> idToKey) throws IOException {
            ...
            try {
                int version = VersionTable.getVersion(this.databaseProvider.getReadableDatabase(), 1, (String) Preconditions.checkNotNull(this.hexUid));
                if (version != 1) {
                ...
                while (cursor.moveToNext()) {
                    try {
                        ...
                        String key = (String) Preconditions.checkNotNull(cursor.getString(1));
        ...
        private void initializeTable(SQLiteDatabase writableDatabase) throws DatabaseIOException {
            VersionTable.setVersion(writableDatabase, 1, (String) Preconditions.checkNotNull(this.hexUid), 1);
            dropTable(writableDatabase, (String) Preconditions.checkNotNull(this.tableName));
        ...
        private void deleteRow(SQLiteDatabase writableDatabase, int key) {
            writableDatabase.delete((String) Preconditions.checkNotNull(this.tableName), WHERE_ID_EQUALS, new String[]{Integer.toString(key)});
        }
        ...
        private void addOrUpdateRow(SQLiteDatabase writableDatabase, CachedContent cachedContent) throws IOException {
            ...
            writableDatabase.replaceOrThrow((String) Preconditions.checkNotNull(this.tableName), null, values);
        }
