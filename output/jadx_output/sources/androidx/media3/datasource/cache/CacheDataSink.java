...
public final class CacheDataSink implements DataSink {
    ...
    public CacheDataSink(Cache cache, long fragmentSize, int bufferSize) {
        Preconditions.checkState(fragmentSize > 0 || fragmentSize == -1, "fragmentSize must be positive or C.LENGTH_UNSET.");
    ...
    private void closeCurrentOutputStream() throws IOException {
        ...
        try {
            ...
            File fileToCommit = (File) Util.castNonNull(this.file);
            this.file = null;
            if (1 != 0) {
            ...
            Util.closeQuietly(this.outputStream);
            this.outputStream = null;
            File fileToCommit2 = (File) Util.castNonNull(this.file);
            this.file = null;
            if (0 != 0) {
