...
public final class HttpEngineDataSource extends BaseDataSource implements HttpDataSource {
    ...
    public long open(DataSpec dataSpec) throws HttpDataSource.HttpDataSourceException {
        ...
        try {
            ...
            try {
                ...
                UrlResponseInfo responseInfo = (UrlResponseInfo) Preconditions.checkNotNull(this.responseInfo);
                ...
                if (responseCode < 200 || responseCode > 299) {
                    ...
                    throw new HttpDataSource.InvalidResponseCodeException(responseCode3, responseInfo.getHttpStatusText(), cause, responseHeaders, dataSpec, responseBody);
                }
    ...
    public int read(byte[] buffer, int offset, int length) throws HttpDataSource.HttpDataSourceException {
        ...
        if (!readBuffer.hasRemaining()) {
            ...
            readBuffer.flip();
            Preconditions.checkState(readBuffer.hasRemaining());
        }
    ...
    public int read(ByteBuffer buffer) throws HttpDataSource.HttpDataSourceException {
        ...
        Preconditions.checkState(readLength > buffer.remaining());
    ...
    final class UrlRequestCallback implements UrlRequest.Callback {
        ...
        public synchronized void onRedirectReceived(UrlRequest request, UrlResponseInfo info, String newLocationUrl) {
            ...
            if (dataSpec.httpMethod != 2 || (responseCode != 307 && responseCode != 308)) {
                ...
                if (cookieHandler2 == null && HttpEngineDataSource.this.handleSetCookieRequests) {
                ...
                if (!shouldKeepPost && (!HttpEngineDataSource.this.handleSetCookieRequests || TextUtils.isEmpty(cookieHeaders))) {
        ...
        public synchronized void onResponseStarted(UrlRequest request, UrlResponseInfo info) {
            ...
            HttpUtil.storeCookiesFromHeaders(info.getUrl(), info.getHeaders().getAsMap(), CookieHandler.getDefault());
