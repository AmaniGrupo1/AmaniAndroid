...
public final class DefaultDataSource implements DataSource {
    ...
    public static final class Factory implements DataSource.Factory {
        ...
        public Factory(Context context, DataSource.Factory baseDataSourceFactory) {
            ...
            this.baseDataSourceFactory = (DataSource.Factory) Preconditions.checkNotNull(baseDataSourceFactory);
        }
    ...
    public DefaultDataSource(Context context, DataSource baseDataSource) {
        this.context = context.getApplicationContext();
        this.baseDataSource = (DataSource) Preconditions.checkNotNull(baseDataSource);
    ...
    public int read(byte[] buffer, int offset, int length) throws IOException {
        return ((DataSource) Preconditions.checkNotNull(this.dataSource)).read(buffer, offset, length);
    }
