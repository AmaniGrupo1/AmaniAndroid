...
public final class PriorityDataSource implements DataSource {
    ...
    public PriorityDataSource(DataSource upstream, PriorityTaskManager priorityTaskManager, int priority) {
        this.upstream = (DataSource) Preconditions.checkNotNull(upstream);
        this.priorityTaskManager = (PriorityTaskManager) Preconditions.checkNotNull(priorityTaskManager);
        this.priority = priority;
    }
