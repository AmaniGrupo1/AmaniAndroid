...
public abstract class SimpleDecoder<I extends DecoderInputBuffer, O extends DecoderOutputBuffer, E extends DecoderException> implements Decoder<I, O, E> {
    ...
    public final void setOutputStartTimeUs(long outputStartTimeUs) {
        synchronized (this.lock) {
            Preconditions.checkState(this.availableInputBufferCount == this.availableInputBuffers.length || this.flushed);
    ...
    public final void queueInputBuffer(I inputBuffer) throws DecoderException {
        synchronized (this.lock) {
            maybeThrowException();
            Preconditions.checkArgument(inputBuffer == this.dequeuedInputBuffer);
