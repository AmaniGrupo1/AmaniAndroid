...
public final class DefaultPlaybackSessionManager implements PlaybackSessionManager {
    ...
    public synchronized void updateSessions(AnalyticsListener.EventTime eventTime) {
        ...
        if (eventTime.mediaPeriodId != null) {
            if (eventTime.mediaPeriodId.windowSequenceNumber != -1 && eventTime.mediaPeriodId.windowSequenceNumber < getMinWindowSequenceNumber()) {
                return;
            }
    ...
    public synchronized void finishAllSessions(AnalyticsListener.EventTime eventTime) {
        if (this.currentSessionId != null) {
            clearCurrentSession((SessionDescriptor) Preconditions.checkNotNull(this.sessions.get(this.currentSessionId)));
        }
        Iterator<SessionDescriptor> iterator = this.sessions.values().iterator();
        while (iterator.hasNext()) {
            SessionDescriptor session = iterator.next();
    ...
    private void clearCurrentSession(SessionDescriptor currentSession) {
        if (currentSession.windowSequenceNumber != -1 && currentSession.isCreated) {
    ...
    private final class SessionDescriptor {
        ...
        public boolean belongsToSession(int eventWindowIndex, MediaSource.MediaPeriodId eventMediaPeriodId) {
            return (eventMediaPeriodId == null || eventMediaPeriodId.windowSequenceNumber == -1) ? eventWindowIndex == this.windowIndex : this.adMediaPeriodId == null ? !eventMediaPeriodId.isAd() && eventMediaPeriodId.windowSequenceNumber == this.windowSequenceNumber : eventMediaPeriodId.windowSequenceNumber == this.adMediaPeriodId.windowSequenceNumber && eventMediaPeriodId.adGroupIndex == this.adMediaPeriodId.adGroupIndex && eventMediaPeriodId.adIndexInAdGroup == this.adMediaPeriodId.adIndexInAdGroup;
        }
