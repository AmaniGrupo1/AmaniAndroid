...
public final class LoadingInfo {
    ...
    public static final class Builder {
        ...
        public Builder setPlaybackSpeed(float playbackSpeed) {
            Preconditions.checkArgument(playbackSpeed > 0.0f || playbackSpeed == -3.4028235E38f);
            this.playbackSpeed = playbackSpeed;
            return this;
        }

        public Builder setLastRebufferRealtimeMs(long lastRebufferRealtimeMs) {
            Preconditions.checkArgument(lastRebufferRealtimeMs >= 0 || lastRebufferRealtimeMs == C.TIME_UNSET);
