...
public final class DecoderReuseEvaluation {
    ...
    public DecoderReuseEvaluation(String decoderName, Format oldFormat, Format newFormat, int result, int discardReasons) {
        Preconditions.checkArgument(result == 0 || discardReasons == 0);
        Preconditions.checkArgument(true ^ TextUtils.isEmpty(decoderName));
        this.decoderName = decoderName;
        this.oldFormat = (Format) Preconditions.checkNotNull(oldFormat);
        this.newFormat = (Format) Preconditions.checkNotNull(newFormat);
        this.result = result;
