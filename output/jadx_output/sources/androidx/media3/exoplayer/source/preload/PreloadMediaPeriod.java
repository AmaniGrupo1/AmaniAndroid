...
final class PreloadMediaPeriod implements MediaPeriod {
    ...
    public void preload(MediaPeriod.Callback callback, long positionUs) {
    ...
    private long selectTracksInternal(ExoTrackSelection[] selections, boolean[] mayRetainStreamFlags, SampleStream[] streams, boolean[] streamResetFlags, long positionUs) {
        if (this.preloadTrackSelectionHolder != null) {
            Preconditions.checkState(streams.length == this.preloadTrackSelectionHolder.streams.length);
            ...
            PreloadTrackSelectionHolder holder = (PreloadTrackSelectionHolder) Preconditions.checkNotNull(this.preloadTrackSelectionHolder);
    ...
    public long setEndPositionUs(long endPositionUs) {
        return this.mediaPeriod.setEndPositionUs(endPositionUs);
    }
    ...
    private static boolean maybeUpdatePreloadTrackSelectionHolderForReselection(ExoTrackSelection[] selections, PreloadTrackSelectionHolder preloadTrackSelectionHolder) {
        ExoTrackSelection[] preloadSelections = ((PreloadTrackSelectionHolder) Preconditions.checkNotNull(preloadTrackSelectionHolder)).selections;
    ...
    public long selectTracksForPreloading(ExoTrackSelection[] selections, long positionUs) {
    ...
    public void maybeThrowStreamError() throws IOException {
        ...
        if (this.preloadTrackSelectionHolder != null) {
            for (SampleStream stream : this.preloadTrackSelectionHolder.streams) {
                if (stream != null) {
