...
public final class MaskingMediaPeriod implements MediaPeriod, MediaPeriod.Callback {
    ...
    public void createPeriod(MediaSource.MediaPeriodId id) {
        ...
        this.mediaPeriod = ((MediaSource) Preconditions.checkNotNull(this.mediaSource)).createPeriod(id, this.allocator, preparePositionUs);
    ...
    public List<StreamKey> getStreamKeys(List<ExoTrackSelection> trackSelections) {
        return ((MediaPeriod) Util.castNonNull(this.mediaPeriod)).getStreamKeys(trackSelections);
    }
