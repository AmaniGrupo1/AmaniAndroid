...
final class SingleSampleMediaPeriod implements MediaPeriod, Loader.Callback<SourceLoadable> {
    ...
    public SingleSampleMediaPeriod(DataSpec dataSpec, DataSource.Factory dataSourceFactory, TransferListener transferListener, Format format, long durationUs, LoadErrorHandlingPolicy loadErrorHandlingPolicy, MediaSourceEventListener.EventDispatcher eventDispatcher, boolean treatLoadErrorsAsEndOfStream, ReleasableExecutor downloadExecutor) {
        Loader loader;
    ...
    public boolean continueLoading(LoadingInfo loadingInfo) {
        ...
        this.loader.startLoading(loadable, this, this.loadErrorHandlingPolicy.getMinimumLoadableRetryCount(1));
        return true;
    }
    ...
    public void onLoadStarted(SourceLoadable loadable, long elapsedRealtimeMs, long loadDurationMs, int retryCount) {
        ...
        this.eventDispatcher.loadStarted(loadEventInfo2, 1, -1, this.format, 0, null, 0L, this.durationUs, retryCount);
    }
    ...
    public void onLoadCompleted(SourceLoadable loadable, long elapsedRealtimeMs, long loadDurationMs) {
        ...
        this.sampleData = (byte[]) Preconditions.checkNotNull(loadable.sampleData);
