...
final class TimeOffsetMediaPeriod implements MediaPeriod, MediaPeriod.Callback {
    ...
    public long setEndPositionUs(long endPositionUs) {
        long correctedEndPositionUs = endPositionUs == Long.MIN_VALUE ? Long.MIN_VALUE : endPositionUs - this.timeOffsetUs;
        long actualEndPositionUs = this.mediaPeriod.setEndPositionUs(correctedEndPositionUs);
        if (actualEndPositionUs == Long.MIN_VALUE) {
            return Long.MIN_VALUE;
        }
        return this.timeOffsetUs + actualEndPositionUs;
    }
