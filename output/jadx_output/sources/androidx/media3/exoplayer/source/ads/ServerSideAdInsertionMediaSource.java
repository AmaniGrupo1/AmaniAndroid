...
public final class ServerSideAdInsertionMediaSource extends BaseMediaSource implements MediaSource.MediaSourceCaller, MediaSourceEventListener, DrmSessionEventListener {
    ...
    public void setAdPlaybackStates(final ImmutableMap<Object, AdPlaybackState> adPlaybackStates, final Timeline contentTimeline) throws Throwable {
        Object adsId;
        Preconditions.checkArgument(!adPlaybackStates.isEmpty());
        Object adsId2 = Preconditions.checkNotNull(adPlaybackStates.values().asList().get(0).adsId);
        ...
        while (it.hasNext()) {
            ...
            Preconditions.checkArgument(Objects.equals(adsId2, adPlaybackState.adsId));
            ...
            if (oldAdPlaybackState != null) {
                ...
                while (adGroupIndex < adPlaybackState.adGroupCount) {
                    ...
                    Preconditions.checkArgument(adGroup.isServerSideInserted);
                    if (adGroupIndex >= oldAdPlaybackState.adGroupCount || ServerSideAdInsertionUtil.getAdCountInGroup(adPlaybackState, adGroupIndex) >= ServerSideAdInsertionUtil.getAdCountInGroup(oldAdPlaybackState, adGroupIndex)) {
                        ...
                        adsId = adsId2;
                        Preconditions.checkArgument(sumOfSplitContentResumeOffsetUs == oldAdGroup.contentResumeOffsetUs);
                        Preconditions.checkArgument(adGroup.timeUs + adGroup.contentResumeOffsetUs == nextAdGroup.timeUs);
                    }
                    if (adGroup.timeUs == Long.MIN_VALUE) {
                        Preconditions.checkArgument(ServerSideAdInsertionUtil.getAdCountInGroup(adPlaybackState, adGroupIndex) == 0);
                    }
                    adGroupIndex++;
                    adsId2 = adsId;
                }
                    ...
                    if (this.playbackHandler != null) {
                        this.playbackHandler.post(new Runnable() { // from class: androidx.media3.exoplayer.source.ads.ServerSideAdInsertionMediaSource$$ExternalSyntheticLambda0
                            ...
                            public final void run() {
                                this.f$0.m7972x8b1696bf(adPlaybackStates, contentTimeline);
                            }
                        });
                    } else {
    ...
    /* synthetic */ void m7972x8b1696bf(ImmutableMap adPlaybackStates, Timeline contentTimeline) {
    ...
    public MediaPeriod createPeriod(MediaSource.MediaPeriodId id, Allocator allocator, long startPositionUs) {
        ...
        boolean reusedSharedPeriod2 = false;
        if (this.lastUsedMediaPeriod != null) {
            if (!this.lastUsedMediaPeriod.periodUid.equals(id.periodUid)) {
                ...
                reusedSharedPeriod2 = true;
            }
            this.lastUsedMediaPeriod = null;
        }
        if (sharedPeriod != null) {
            reusedSharedPeriod = reusedSharedPeriod2;
        } else {
            ...
            if (lastExistingPeriod != null && lastExistingPeriod.canReuseMediaPeriod(id, startPositionUs)) {
                ...
                AdPlaybackState adPlaybackState = (AdPlaybackState) Preconditions.checkNotNull(this.adPlaybackStates.get(id.periodUid));
    ...
    @Override // androidx.media3.exoplayer.drm.DrmSessionEventListener
    public void onDrmKeysLoaded(int windowIndex, MediaSource.MediaPeriodId mediaPeriodId, KeyRequestInfo keyRequestInfo) {
    ...
    public void onLoadStarted(int windowIndex, MediaSource.MediaPeriodId mediaPeriodId, LoadEventInfo loadEventInfo, MediaLoadData mediaLoadData, int retryCount) {
        if (retryCount == 0) {
            ...
            if (mediaPeriod == null) {
                ...
                mediaPeriod.mediaSourceEventDispatcher.loadStarted(loadEventInfo, correctMediaLoadData(mediaPeriod, mediaLoadData, (AdPlaybackState) Preconditions.checkNotNull(this.adPlaybackStates.get(mediaPeriod.mediaPeriodId.periodUid))), 0);
            }
        }
    }
    ...
    public void onLoadCompleted(int windowIndex, MediaSource.MediaPeriodId mediaPeriodId, LoadEventInfo loadEventInfo, MediaLoadData mediaLoadData) {
        ...
        if (mediaPeriod == null) {
            ...
            mediaPeriod.mediaSourceEventDispatcher.loadCompleted(loadEventInfo, correctMediaLoadData(mediaPeriod, mediaLoadData, (AdPlaybackState) Preconditions.checkNotNull(this.adPlaybackStates.get(mediaPeriod.mediaPeriodId.periodUid))));
        }
    }
    ...
    public void onLoadCanceled(int windowIndex, MediaSource.MediaPeriodId mediaPeriodId, LoadEventInfo loadEventInfo, MediaLoadData mediaLoadData) {
        ...
        if (mediaPeriod == null) {
            ...
            mediaPeriod.sharedPeriod.onLoadFinished(loadEventInfo);
            mediaPeriod.mediaSourceEventDispatcher.loadCanceled(loadEventInfo, correctMediaLoadData(mediaPeriod, mediaLoadData, (AdPlaybackState) Preconditions.checkNotNull(this.adPlaybackStates.get(mediaPeriod.mediaPeriodId.periodUid))));
        }
    }
    ...
    public void onLoadError(int windowIndex, MediaSource.MediaPeriodId mediaPeriodId, LoadEventInfo loadEventInfo, MediaLoadData mediaLoadData, IOException error, boolean wasCanceled) {
        ...
        mediaPeriod.mediaSourceEventDispatcher.loadError(loadEventInfo, correctMediaLoadData(mediaPeriod, mediaLoadData, (AdPlaybackState) Preconditions.checkNotNull(this.adPlaybackStates.get(mediaPeriod.mediaPeriodId.periodUid))), error, wasCanceled);
    }
    ...
    public void onUpstreamDiscarded(int windowIndex, MediaSource.MediaPeriodId mediaPeriodId, MediaLoadData mediaLoadData) {
        ...
        if (mediaPeriod == null) {
            ...
            mediaPeriod.mediaSourceEventDispatcher.upstreamDiscarded(correctMediaLoadData(mediaPeriod, mediaLoadData, (AdPlaybackState) Preconditions.checkNotNull(this.adPlaybackStates.get(mediaPeriod.mediaPeriodId.periodUid))));
        }
    }
    ...
    public void onDownstreamFormatChanged(int windowIndex, MediaSource.MediaPeriodId mediaPeriodId, MediaLoadData mediaLoadData) {
        ...
        if (mediaPeriod == null) {
            ...
            mediaPeriod.mediaSourceEventDispatcher.downstreamFormatChanged(correctMediaLoadData(mediaPeriod, mediaLoadData, (AdPlaybackState) Preconditions.checkNotNull(this.adPlaybackStates.get(mediaPeriod.mediaPeriodId.periodUid))));
        }
    }
    ...
    private static final class SharedMediaPeriod implements MediaPeriod.Callback {
        ...
        public boolean continueLoading(MediaPeriodImpl mediaPeriod, LoadingInfo loadingInfo) {
            ...
            if (loadingPeriod != null && !mediaPeriod.equals(loadingPeriod)) {
                for (Pair<LoadEventInfo, MediaLoadData> loadData : this.activeLoads.values()) {
                    ...
                    mediaPeriod.mediaSourceEventDispatcher.loadStarted((LoadEventInfo) loadData.first, ServerSideAdInsertionMediaSource.correctMediaLoadData(mediaPeriod, (MediaLoadData) loadData.second, this.adPlaybackState), 0);
                }
            }
            ...
            for (int i2 = 0; i2 < selections.length; i2++) {
                ...
                if (selections[i2] != null) {
                    ...
                    if (streamResetFlags[i2]) {
                        if (Objects.equals(this.trackSelections[i2], selections[i2])) {
        ...
        public void onContinueLoadingRequested(MediaPeriod source) {
            ...
            ((MediaPeriod.Callback) Preconditions.checkNotNull(this.loadingPeriod.callback)).onContinueLoadingRequested(this.loadingPeriod);
        }
    ...
    private static final class ServerSideAdInsertionTimeline extends ForwardingTimeline {
        ...
        public ServerSideAdInsertionTimeline(Timeline contentTimeline, ImmutableMap<Object, AdPlaybackState> adPlaybackStates) {
            ...
            Preconditions.checkState(contentTimeline.getWindowCount() == 1);
            Timeline.Period period = new Timeline.Period();
            for (int i = 0; i < contentTimeline.getPeriodCount(); i++) {
                contentTimeline.getPeriod(i, period, true);
                Preconditions.checkState(adPlaybackStates.containsKey(Preconditions.checkNotNull(period.uid)));
            }
            this.adPlaybackStates = adPlaybackStates;
        }
        ...
        public Timeline.Window getWindow(int windowIndex, Timeline.Window window, long defaultPositionProjectionUs) {
            ...
            Timeline.Period period = new Timeline.Period();
            Object firstPeriodUid = Preconditions.checkNotNull(getPeriod(window.firstPeriodIndex, period, true).uid);
            AdPlaybackState firstAdPlaybackState = (AdPlaybackState) Preconditions.checkNotNull(this.adPlaybackStates.get(firstPeriodUid));
            ...
            if (window.durationUs != C.TIME_UNSET) {
                ...
                AdPlaybackState lastAdPlaybackState = (AdPlaybackState) Preconditions.checkNotNull(this.adPlaybackStates.get(originalLastPeriod.uid));
        ...
        public Timeline.Period getPeriod(int periodIndex, Timeline.Period period, boolean setIds) {
            ...
            AdPlaybackState adPlaybackState = (AdPlaybackState) Preconditions.checkNotNull(this.adPlaybackStates.get(period.uid));
            ...
            for (int i = 0; i < periodIndex + 1; i++) {
                ...
                AdPlaybackState innerAdPlaybackState = (AdPlaybackState) Preconditions.checkNotNull(this.adPlaybackStates.get(innerPeriod.uid));
                if (i == 0) {
