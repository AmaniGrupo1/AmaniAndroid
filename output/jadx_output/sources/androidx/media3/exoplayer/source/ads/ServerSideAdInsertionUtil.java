...
public final class ServerSideAdInsertionUtil {
    ...
    public static long getStreamPositionUs(Player player, Object adsId) {
        ...
        if (player.isPlayingAd()) {
            ...
            return getStreamPositionUsForAd(adPositionUs, adGroupIndex, adIndexInAdGroup, period.adPlaybackState);
        }
        long periodPositionUs = Util.msToUs(player.getCurrentPosition()) - period.getPositionInWindowUs();
        return getStreamPositionUsForContent(periodPositionUs, -1, period.adPlaybackState);
    }
