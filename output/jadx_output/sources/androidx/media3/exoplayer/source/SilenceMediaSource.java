...
public final class SilenceMediaSource extends BaseMediaSource {
    ...
    private SilenceMediaSource(long durationUs, MediaItem mediaItem) {
        Preconditions.checkArgument(durationUs >= 0);
        this.durationUs = durationUs;
    ...
    public static long getAudioByteCount(long durationUs) {
        long audioSampleCount = Util.durationUsToSampleCount(durationUs, SAMPLE_RATE_HZ);
    ...
    public static long getAudioPositionUs(long bytes) {
        ...
        return Util.sampleCountToDurationUs(audioSampleCount, SAMPLE_RATE_HZ);
    }
}
