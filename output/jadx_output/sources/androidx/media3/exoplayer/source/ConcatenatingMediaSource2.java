...
public final class ConcatenatingMediaSource2 extends CompositeMediaSource<Integer> {
    ...
    public static final class Builder {
        ...
        public Builder add(MediaSource mediaSource, long initialPlaceholderDurationMs) {
            ...
            Preconditions.checkState(((mediaSource instanceof ProgressiveMediaSource) && initialPlaceholderDurationMs == C.TIME_UNSET) ? false : true, "Progressive media source must define an initial placeholder duration.");
    ...
    public MediaPeriod createPeriod(MediaSource.MediaPeriodId id, Allocator allocator, long startPositionUs) {
        ...
        if (id.isAd()) {
            ...
            timeOffsetUs = ((Long) Preconditions.checkNotNull(holder.periodTimeOffsetsByUid.get(childMediaPeriodId.periodUid))).longValue();
        }
    ...
    public void m7952x28f9175(Integer childSourceId, MediaSource mediaSource, Timeline newTimeline) {
        scheduleTimelineUpdate();
    }
    ...
    private ConcatenatedTimeline maybeCreateConcatenatedTimeline() {
        ...
        while (i < mediaSourceHoldersCount) {
            ...
            Preconditions.checkArgument(!timeline.isEmpty(), "Can't concatenate empty child Timeline.");
            ...
            while (j < timeline.getWindowCount()) {
                ...
                manifestsAreIdentical = manifestsAreIdentical && Objects.equals(initialManifest, window.manifest);
                ...
                long windowDurationUs2 = window.durationUs;
                if (windowDurationUs2 == C.TIME_UNSET) {
                    if (holder.initialPlaceholderDurationUs == C.TIME_UNSET) {
                        return null;
                    }
                    windowDurationUs2 = holder.initialPlaceholderDurationUs;
                }
                durationUs += windowDurationUs2;
                ...
                while (k <= window.lastPeriodIndex) {
                    ...
                    if (periodDurationUs == C.TIME_UNSET) {
                        Preconditions.checkArgument(window.firstPeriodIndex == window.lastPeriodIndex, "Can't apply placeholder duration to multiple periods with unknown duration in a single window.");
                    ...
                    int k2 = k;
                    Object periodUid = Preconditions.checkNotNull(period2.uid);
    ...
    private static final class ConcatenatedTimeline extends Timeline {
        ...
        public Timeline.Period getPeriod(int periodIndex, Timeline.Period period, boolean setIds) {
            ...
            period.durationUs = getPeriodDurationUs(period, periodIndex);
            if (setIds) {
                period.uid = ConcatenatingMediaSource2.getPeriodUid(childIndex, Preconditions.checkNotNull(period.uid));
            }
            return period;
        }
