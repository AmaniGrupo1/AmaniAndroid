...
public final class MaskingMediaSource extends WrappingMediaSource {
    ...
    public void updateMediaItem(MediaItem mediaItem) {
        if (this.hasRealTimeline) {
            this.timeline = this.timeline.cloneWithUpdatedTimeline(TimelineWithUpdatedMediaItem.create(this.timeline.timeline, mediaItem));
        } else {
    ...
    */
    protected void onChildSourceInfoRefreshed(Timeline newTimeline) {
        ...
        if (idForMaskingPeriodPreparation != null) {
            ((MaskingMediaPeriod) Preconditions.checkNotNull(this.unpreparedMaskingMediaPeriod)).createPeriod(idForMaskingPeriodPreparation);
        }
    }
    ...
    private static final class MaskingTimeline extends ForwardingTimeline {
        ...
        public Timeline.Period getPeriod(int periodIndex, Timeline.Period period, boolean setIds) {
            ...
            if (Objects.equals(period.uid, this.replacedInternalPeriodUid) && setIds) {
        ...
        public Object getUidOfPeriod(int periodIndex) {
            ...
            return Objects.equals(uid, this.replacedInternalPeriodUid) ? MASKING_EXTERNAL_PERIOD_UID : uid;
        }
    }
