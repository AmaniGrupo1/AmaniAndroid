...
class SampleDataQueue {
    ...
    public void discardUpstreamSampleBytes(long totalBytesWritten) {
        ...
        Preconditions.checkArgument(totalBytesWritten <= this.totalBytesWritten);
        ...
        AllocationNode firstNodeToDiscard = (AllocationNode) Preconditions.checkNotNull(lastNodeToKeep2.next);
