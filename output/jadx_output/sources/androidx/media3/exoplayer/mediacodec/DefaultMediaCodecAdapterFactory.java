...
public final class DefaultMediaCodecAdapterFactory implements MediaCodecAdapter.Factory {
    ...
    public DefaultMediaCodecAdapterFactory(Context context, Supplier<HandlerThread> callbackThreadSupplier, Supplier<HandlerThread> queueingThreadSupplier) {
    ...
    public DefaultMediaCodecAdapterFactory experimentalSetAsyncCryptoFlagEnabled(boolean enableAsyncCryptoFlag) {
        this.asyncCryptoFlagEnabled = enableAsyncCryptoFlag;
        return this;
    }
    ...
    public MediaCodecAdapter createAdapter(MediaCodecAdapter.Configuration configuration) throws IOException {
        ...
        if (this.asynchronousMode == 1 || (this.asynchronousMode == 0 && shouldUseAsynchronousAdapterInDefaultMode())) {
