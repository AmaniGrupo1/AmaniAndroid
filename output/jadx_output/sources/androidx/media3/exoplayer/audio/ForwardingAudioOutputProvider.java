...
public class ForwardingAudioOutputProvider implements AudioOutputProvider {
    ...
    @Override // androidx.media3.exoplayer.audio.AudioOutputProvider
    public AudioOutput getAudioOutput(AudioOutputProvider.OutputConfig config) throws AudioOutputProvider.InitializationException {
        return this.audioOutputProvider.getAudioOutput(config);
    }
