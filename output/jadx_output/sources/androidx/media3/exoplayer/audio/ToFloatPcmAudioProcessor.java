...
public final class ToFloatPcmAudioProcessor extends BaseAudioProcessor {
    ...
    public AudioProcessor.AudioFormat onConfigure(AudioProcessor.AudioFormat inputAudioFormat) throws AudioProcessor.UnhandledAudioFormatException {
        ...
        if (!Util.isEncodingHighResolutionPcm(encoding) && encoding != 2) {
        ...
        switch (this.inputAudioFormat.encoding) {
            case 2:
                ...
                for (int i = position; i < limit; i += 2) {
                    int pcm32BitInteger = ((inputBuffer.get(i) & 255) << 16) | ((inputBuffer.get(i + 1) & 255) << 24);
            ...
            case 21:
                ...
                for (int i2 = position; i2 < limit; i2 += 3) {
                    int pcm32BitInteger2 = ((inputBuffer.get(i2) & 255) << 8) | ((inputBuffer.get(i2 + 1) & 255) << 16) | ((inputBuffer.get(i2 + 2) & 255) << 24);
            ...
            case 22:
                ...
                for (int i3 = position; i3 < limit; i3 += 4) {
                    int pcm32BitInteger3 = (inputBuffer.get(i3) & 255) | ((inputBuffer.get(i3 + 1) & 255) << 8) | ((inputBuffer.get(i3 + 2) & 255) << 16) | ((inputBuffer.get(i3 + 3) & 255) << 24);
            ...
            case C.ENCODING_PCM_24BIT_BIG_ENDIAN /* 1342177280 */:
                ...
                for (int i4 = position; i4 < limit; i4 += 3) {
                    int pcm32BitInteger4 = ((inputBuffer.get(i4 + 2) & 255) << 8) | ((inputBuffer.get(i4 + 1) & 255) << 16) | ((inputBuffer.get(i4) & 255) << 24);
            ...
            case C.ENCODING_PCM_32BIT_BIG_ENDIAN /* 1610612736 */:
                ...
                for (int i5 = position; i5 < limit; i5 += 4) {
                    int pcm32BitInteger5 = (inputBuffer.get(i5 + 3) & 255) | ((inputBuffer.get(i5 + 2) & 255) << 8) | ((inputBuffer.get(i5 + 1) & 255) << 16) | ((inputBuffer.get(i5) & 255) << 24);
                    writePcm32BitFloat(pcm32BitInteger5, buffer);
                }
                break;
            case C.ENCODING_PCM_DOUBLE /* 1879048192 */:
                buffer = replaceOutputBuffer(size / 2);
                for (int i6 = position; i6 < limit; i6 += 8) {
                    buffer.putFloat((float) inputBuffer.getDouble(i6));
                }
                break;
            default:
