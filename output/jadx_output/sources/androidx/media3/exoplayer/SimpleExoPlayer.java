...
public class SimpleExoPlayer extends BasePlayer implements ExoPlayer {
    ...
    public void setVirtualDeviceId(int virtualDeviceId) {
        blockUntilConstructorFinished();
        this.player.setVirtualDeviceId(virtualDeviceId);
    }
    ...
    public void setScrubbingModeEnabled(boolean scrubbingModeEnabled) {
        blockUntilConstructorFinished();
        this.player.setScrubbingModeEnabled(scrubbingModeEnabled);
    }
    ...
    public void setMaxSeekToPreviousPositionMs(long maxSeekToPreviousPositionMs) {
        blockUntilConstructorFinished();
        this.player.setMaxSeekToPreviousPositionMs(maxSeekToPreviousPositionMs);
    }

    @Override // androidx.media3.exoplayer.ExoPlayer
    public void setSeekBackIncrementMs(long seekBackIncrementMs) {
        blockUntilConstructorFinished();
        this.player.setSeekBackIncrementMs(seekBackIncrementMs);
    }

    @Override // androidx.media3.exoplayer.ExoPlayer
    public void setSeekForwardIncrementMs(long seekForwardIncrementMs) {
        blockUntilConstructorFinished();
        this.player.setSeekForwardIncrementMs(seekForwardIncrementMs);
    }
    ...
    public Renderer getSecondaryRenderer(int index) {
        blockUntilConstructorFinished();
        return this.player.getSecondaryRenderer(index);
    }
    ...
    public void addAudioCodecParametersChangeListener(CodecParametersChangeListener listener, List<String> keys) {
        blockUntilConstructorFinished();
        this.player.addAudioCodecParametersChangeListener(listener, keys);
    }

    @Override // androidx.media3.exoplayer.ExoPlayer
    public void removeAudioCodecParametersChangeListener(CodecParametersChangeListener listener) {
        blockUntilConstructorFinished();
        this.player.removeAudioCodecParametersChangeListener(listener);
    }
    ...
    public void addVideoCodecParametersChangeListener(CodecParametersChangeListener listener, List<String> keys) {
        blockUntilConstructorFinished();
        this.player.addVideoCodecParametersChangeListener(listener, keys);
    }

    @Override // androidx.media3.exoplayer.ExoPlayer
    public void removeVideoCodecParametersChangeListener(CodecParametersChangeListener listener) {
        blockUntilConstructorFinished();
        this.player.removeVideoCodecParametersChangeListener(listener);
    }
