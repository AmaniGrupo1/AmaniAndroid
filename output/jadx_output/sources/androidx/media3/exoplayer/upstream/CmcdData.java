...
public final class CmcdData {
    ...
    public static final class Factory {
        ...
        public Factory(CmcdConfiguration cmcdConfiguration, String streamingFormat) {
            this.cmcdConfiguration = cmcdConfiguration;
            this.streamingFormat = streamingFormat;
        }

        public Factory setChunkDurationUs(long chunkDurationUs) {
            Preconditions.checkArgument(chunkDurationUs >= 0);
        ...
        public Factory setBufferedDurationUs(long bufferedDurationUs) {
            Preconditions.checkArgument(bufferedDurationUs >= 0);
            this.bufferedDurationUs = bufferedDurationUs;
            return this;
        }

        public Factory setPlaybackRate(float playbackRate) {
            Preconditions.checkArgument(playbackRate == -3.4028235E38f || playbackRate > 0.0f);
        ...
        public CmcdData createCmcdData() {
            ...
            boolean isMediaObjectType2 = isMediaObjectType(this.objectType);
            if (isMediaObjectType2) {
            ...
            long latestBitrateEstimateKbps = -2147483647L;
            int requestedMaximumThroughputKbps = C.RATE_UNSET_INT;
            if (isManifestObjectType) {
                isMediaObjectType = isMediaObjectType2;
            } else {
                ExoTrackSelection trackSelection = (ExoTrackSelection) Preconditions.checkNotNull(this.trackSelection);
                ...
                if (trackSelection.getLatestBitrateEstimate() != -2147483647L) {
                    isMediaObjectType = isMediaObjectType2;
                    latestBitrateEstimateKbps = Util.ceilDivide(trackSelection.getLatestBitrateEstimate(), 1000L);
                } else {
                    isMediaObjectType = isMediaObjectType2;
                }
                requestedMaximumThroughputKbps = this.cmcdConfiguration.requestConfig.getRequestedMaximumThroughputKbps(bitrateKbps);
            }
            ...
            if (this.isLive != null && this.cmcdConfiguration.isStreamTypeLoggingAllowed()) {
                cmcdSession.setStreamType(((Boolean) Preconditions.checkNotNull(this.isLive)).booleanValue() ? CmcdData.STREAM_TYPE_LIVE : "v");
            }
        ...
        private static boolean isManifestObjectType(String objectType) {
            return Objects.equals(objectType, CmcdData.OBJECT_TYPE_MANIFEST);
        }

        private static boolean isMediaObjectType(String objectType) {
            return Objects.equals(objectType, CmcdData.OBJECT_TYPE_AUDIO_ONLY) || Objects.equals(objectType, "v") || Objects.equals(objectType, CmcdData.OBJECT_TYPE_MUXED_AUDIO_AND_VIDEO);
        }
        ...
        private void validateCustomDataListFormat(List<String> customDataList) {
            for (String customData : customDataList) {
                ...
                Preconditions.checkState(CUSTOM_KEY_NAME_PATTERN.matcher(key).matches());
            }
        }
    }
    ...
    public static DataSpec removeFromDataSpec(DataSpec dataSpec) {
        ...
        if (dataSpec.httpRequestHeaders.containsKey(CmcdConfiguration.KEY_CMCD_OBJECT) || dataSpec.httpRequestHeaders.containsKey(CmcdConfiguration.KEY_CMCD_REQUEST) || dataSpec.httpRequestHeaders.containsKey(CmcdConfiguration.KEY_CMCD_STATUS) || dataSpec.httpRequestHeaders.containsKey(CmcdConfiguration.KEY_CMCD_SESSION)) {
            ImmutableMap.Builder<String, String> httpRequestHeaders = ImmutableMap.builder();
            for (Map.Entry<? extends String, ? extends String> entry : dataSpec.httpRequestHeaders.entrySet()) {
                if (!entry.getKey().equals(CmcdConfiguration.KEY_CMCD_OBJECT) && !entry.getKey().equals(CmcdConfiguration.KEY_CMCD_REQUEST) && !entry.getKey().equals(CmcdConfiguration.KEY_CMCD_STATUS) && !entry.getKey().equals(CmcdConfiguration.KEY_CMCD_SESSION)) {
                    httpRequestHeaders.put(entry);
                }
            }
            return dataSpec.withRequestHeaders(httpRequestHeaders.buildOrThrow());
        }
        return dataSpec;
    }

    public static Uri removeFromUri(Uri uri) {
        if (uri.isHierarchical() && uri.getQueryParameter(CmcdConfiguration.CMCD_QUERY_PARAMETER_KEY) != null) {
            return UriUtil.removeQueryParameter(uri, CmcdConfiguration.CMCD_QUERY_PARAMETER_KEY);
        }
        return uri;
    }
    ...
    private static final class CmcdObject {
        ...
        public static final class Builder {
            ...
            public Builder setBitrateKbps(int bitrateKbps) {
                Preconditions.checkArgument(bitrateKbps >= 0 || bitrateKbps == -2147483647);
                this.bitrateKbps = bitrateKbps;
                return this;
            }

            public Builder setTopBitrateKbps(int topBitrateKbps) {
                Preconditions.checkArgument(topBitrateKbps >= 0 || topBitrateKbps == -2147483647);
                this.topBitrateKbps = topBitrateKbps;
                return this;
            }

            public Builder setObjectDurationMs(long objectDurationMs) {
                Preconditions.checkArgument(objectDurationMs >= 0 || objectDurationMs == C.TIME_UNSET);
    ...
    private static final class CmcdRequest {
        ...
        public static final class Builder {
            ...
            public Builder setMeasuredThroughputInKbps(long measuredThroughputInKbps) {
                if (measuredThroughputInKbps == -2147483647L) {
    ...
    private static final class CmcdSession {
        ...
        public static final class Builder {
            ...
            public Builder setContentId(String contentId) {
                Preconditions.checkArgument(contentId == null || contentId.length() <= 64);
                this.contentId = contentId;
                return this;
            }

            public Builder setSessionId(String sessionId) {
                Preconditions.checkArgument(sessionId == null || sessionId.length() <= 64);
            ...
            public Builder setPlaybackRate(float playbackRate) {
                Preconditions.checkArgument(playbackRate > 0.0f || playbackRate == -3.4028235E38f);
                this.playbackRate = playbackRate;
                return this;
            }
    ...
    private static final class CmcdStatus {
        ...
        public static final class Builder {
            ...
            public Builder setMaximumRequestedThroughputKbps(int maximumRequestedThroughputKbps) {
                int i;
                Preconditions.checkArgument(maximumRequestedThroughputKbps >= 0 || maximumRequestedThroughputKbps == -2147483647);
