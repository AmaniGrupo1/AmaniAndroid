...
public final class RequirementsWatcher {
    ...
    public void stop() {
        this.context.unregisterReceiver((BroadcastReceiver) Preconditions.checkNotNull(this.receiver));
        this.receiver = null;
    ...
    private void registerNetworkCallbackV24() {
        ConnectivityManager connectivityManager = (ConnectivityManager) Preconditions.checkNotNull((ConnectivityManager) this.context.getSystemService("connectivity"));
    ...
    private void unregisterNetworkCallbackV24() {
        ConnectivityManager connectivityManager = (ConnectivityManager) Preconditions.checkNotNull((ConnectivityManager) this.context.getSystemService("connectivity"));
        connectivityManager.unregisterNetworkCallback((ConnectivityManager.NetworkCallback) Preconditions.checkNotNull(this.networkCallback));
