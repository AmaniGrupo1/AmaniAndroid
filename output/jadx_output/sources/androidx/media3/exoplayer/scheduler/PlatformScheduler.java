...
public final class PlatformScheduler implements Scheduler {
    ...
    public PlatformScheduler(Context context, int jobId) {
        ...
        this.jobScheduler = (JobScheduler) Preconditions.checkNotNull((JobScheduler) context2.getSystemService("jobscheduler"));
    }
    ...
    public static final class PlatformSchedulerService extends JobService {
        ...
        public boolean onStartJob(JobParameters params) {
            ...
            if (notMetRequirements == 0) {
                String serviceAction = (String) Preconditions.checkNotNull(extras.getString(PlatformScheduler.KEY_SERVICE_ACTION));
                String servicePackage = (String) Preconditions.checkNotNull(extras.getString(PlatformScheduler.KEY_SERVICE_PACKAGE));
