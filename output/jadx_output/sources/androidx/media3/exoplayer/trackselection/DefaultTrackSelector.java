...
public class DefaultTrackSelector extends MappingTrackSelector implements RendererCapabilities.Listener {
    ...
    public static final class ParametersBuilder extends TrackSelectionParameters.Builder {
        ...
        @Override // androidx.media3.common.TrackSelectionParameters.Builder
        public ParametersBuilder setViewportSizeToPhysicalDisplaySize(boolean viewportOrientationMayChange) {
            this.delegate.setViewportSizeToPhysicalDisplaySize(viewportOrientationMayChange);
            return this;
        }
        ...
        @Override // androidx.media3.common.TrackSelectionParameters.Builder
        public ParametersBuilder setPreferredVideoLanguage(String preferredVideoLanguage) {
            this.delegate.setPreferredVideoLanguage(preferredVideoLanguage);
            return this;
        }

        @Override // androidx.media3.common.TrackSelectionParameters.Builder
        public ParametersBuilder setPreferredVideoLanguages(String... preferredVideoLanguages) {
            this.delegate.setPreferredVideoLanguages(preferredVideoLanguages);
            return this;
        }

        @Override // androidx.media3.common.TrackSelectionParameters.Builder
        public ParametersBuilder setPreferredVideoLabels(String... preferredVideoLabels) {
            this.delegate.setPreferredVideoLabels(preferredVideoLabels);
            return this;
        }
        ...
        public ParametersBuilder setPreferredAudioLabels(String... preferredAudioLabels) {
            this.delegate.setPreferredAudioLabels(preferredAudioLabels);
            return this;
        }
        ...
        public ParametersBuilder setSelectTextByDefault(boolean selectTextByDefault) {
            this.delegate.setSelectTextByDefault(selectTextByDefault);
            return this;
        }
        ...
        public ParametersBuilder setPreferredTextLabels(String... preferredTextLabels) {
            this.delegate.setPreferredTextLabels(preferredTextLabels);
            return this;
        }
    ...
    public static final class Parameters extends TrackSelectionParameters {
        ...
        @Deprecated
        public static final Parameters DEFAULT_WITHOUT_CONTEXT = DEFAULT;
    ...
    public static final class SelectionOverride {
        ...
        public static SelectionOverride fromBundle(Bundle bundle) {
            ...
            Preconditions.checkArgument(groupIndex >= 0 && trackType >= 0);
            Preconditions.checkNotNull(tracks);
    ...
    public void release() {
        synchronized (this.lock) {
            if (this.playbackThread != null) {
                Preconditions.checkState(this.playbackThread == Thread.currentThread(), "DefaultTrackSelector is accessed on the wrong thread.");
            }
        }
    ...
    protected final Pair<RendererConfiguration[], ExoTrackSelection[]> selectTracks(MappingTrackSelector.MappedTrackInfo mappedTrackInfo, int[][][] rendererFormatSupports, int[] rendererMixedMimeTypeAdaptationSupport, MediaSource.MediaPeriodId mediaPeriodId, Timeline timeline) throws Throwable {
        Parameters parameters;
        synchronized (this.lock) {
            try {
        ...
        if (this.deviceIsTV == null && this.context != null) {
            this.deviceIsTV = Boolean.valueOf(Util.isTv(this.context));
        }
        if (parameters.constrainAudioChannelCountToDeviceCapabilities && Build.VERSION.SDK_INT >= 32 && this.spatializer == null) {
            this.spatializer = new SpatializerWrapper(this.context, new Runnable() { // from class: androidx.media3.exoplayer.trackselection.DefaultTrackSelector$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.maybeInvalidateForAudioChannelCountConstraints();
                }
            }, this.deviceIsTV);
        }
        ...
        selectAllTracks(definitions, mappedTrackInfo, rendererFormatSupports, rendererMixedMimeTypeAdaptationSupport, parameters);
        applyTrackSelectionOverrides(mappedTrackInfo, parameters, definitions);
        applyLegacyRendererOverrides(mappedTrackInfo, parameters, definitions);
        applyRendererDisableOverrides(mappedTrackInfo, parameters, definitions);
        ExoTrackSelection[] rendererTrackSelections = this.trackSelectionFactory.createTrackSelections(definitions, getBandwidthMeter(), mediaPeriodId, timeline);
        RendererConfiguration[] rendererConfigurations = new RendererConfiguration[rendererCount];
        for (int i = 0; i < rendererCount; i++) {
            int rendererType = mappedTrackInfo.getRendererType(i);
            boolean forceRendererDisabled = parameters.getRendererDisabled(i) || parameters.disabledTrackTypes.contains(Integer.valueOf(rendererType));
        ...
        if (parameters.audioOffloadPreferences.audioOffloadMode != 0) {
            maybeConfigureRendererForOffload(parameters, mappedTrackInfo, rendererFormatSupports, rendererConfigurations, rendererTrackSelections);
        }
    ...
    protected void selectAllTracks(ExoTrackSelection.Definition[] definitions, MappingTrackSelector.MappedTrackInfo mappedTrackInfo, int[][][] rendererFormatSupports, int[] rendererMixedMimeTypeAdaptationSupports, Parameters params) throws ExoPlaybackException {
        ...
        int rendererCount = mappedTrackInfo.getRendererCount();
        int i = 1;
        Pair<ExoTrackSelection.Definition, Integer> selectedAudio2 = findDefinitionForType(definitions, 1);
        if (selectedAudio2 != null) {
            iArr = rendererMixedMimeTypeAdaptationSupports;
            selectedAudio = selectedAudio2;
        } else {
            iArr = rendererMixedMimeTypeAdaptationSupports;
            Pair<ExoTrackSelection.Definition, Integer> selectedAudio3 = selectAudioTrack(mappedTrackInfo, rendererFormatSupports, iArr, params);
            if (selectedAudio3 != null) {
                definitions[((Integer) selectedAudio3.second).intValue()] = (ExoTrackSelection.Definition) selectedAudio3.first;
            }
            selectedAudio = selectedAudio3;
        }
        Pair<ExoTrackSelection.Definition, Integer> pairSelectImageTrack = null;
        if (selectedAudio == null) {
            selectedAudioLanguage = null;
        } else {
            selectedAudioLanguage = ((ExoTrackSelection.Definition) selectedAudio.first).group.getFormat(((ExoTrackSelection.Definition) selectedAudio.first).tracks[0]).language;
        }
        Pair<ExoTrackSelection.Definition, Integer> selectedVideo = findDefinitionForType(definitions, 2);
        Pair<ExoTrackSelection.Definition, Integer> selectedImage = findDefinitionForType(definitions, 4);
        if (selectedVideo != null || selectedImage != null) {
            selectedAudioLanguage2 = selectedAudioLanguage;
        } else {
            int[] iArr2 = iArr;
            selectedAudioLanguage2 = selectedAudioLanguage;
            Pair<ExoTrackSelection.Definition, Integer> selectedVideo2 = selectVideoTrack(mappedTrackInfo, rendererFormatSupports, iArr2, params, selectedAudioLanguage2);
            if (params.isPrioritizeImageOverVideoEnabled || selectedVideo2 == null) {
                pairSelectImageTrack = selectImageTrack(mappedTrackInfo, rendererFormatSupports, params);
            }
            Pair<ExoTrackSelection.Definition, Integer> selectedImage2 = pairSelectImageTrack;
            if (selectedImage2 != null) {
                definitions[((Integer) selectedImage2.second).intValue()] = (ExoTrackSelection.Definition) selectedImage2.first;
            } else if (selectedVideo2 != null) {
                definitions[((Integer) selectedVideo2.second).intValue()] = (ExoTrackSelection.Definition) selectedVideo2.first;
            }
        }
        int i2 = 3;
        if (findDefinitionForType(definitions, 3) == null && (selectedText = selectTextTrack(mappedTrackInfo, rendererFormatSupports, params, selectedAudioLanguage2)) != null) {
        ...
        while (i3 < rendererCount) {
            int trackType = mappedTrackInfo.getRendererType(i3);
            if (trackType != 2 && trackType != i && trackType != i2 && trackType != 4 && trackType != 5 && definitions[i3] == null) {
                definitions[i3] = selectOtherTrack(trackType, mappedTrackInfo.getTrackGroups(i3), rendererFormatSupports[i3], params);
            }
            i3++;
            i2 = 3;
            i = 1;
    ...
    protected Pair<ExoTrackSelection.Definition, Integer> selectVideoTrack(MappingTrackSelector.MappedTrackInfo mappedTrackInfo, int[][][] rendererFormatSupports, final int[] mixedMimeTypeSupports, final Parameters params, final String selectedAudioLanguage) throws ExoPlaybackException {
        final Point viewportSizeFromDisplay = null;
        if (params.audioOffloadPreferences.audioOffloadMode == 2) {
            return null;
        }
        if (params.isViewportSizeLimitedByPhysicalDisplaySize && this.context != null) {
            viewportSizeFromDisplay = Util.getCurrentDisplayModeSize(this.context);
        }
        return selectTracksForType(2, mappedTrackInfo, rendererFormatSupports, new TrackInfo.Factory() { // from class: androidx.media3.exoplayer.trackselection.DefaultTrackSelector$$ExternalSyntheticLambda5
            @Override // androidx.media3.exoplayer.trackselection.DefaultTrackSelector.TrackInfo.Factory
            public final List create(int i, TrackGroup trackGroup, int[] iArr) {
                return DefaultTrackSelector.VideoTrackInfo.createForTrackGroup(i, trackGroup, params, iArr, selectedAudioLanguage, mixedMimeTypeSupports[i], viewportSizeFromDisplay);
            }
    ...
    protected Pair<ExoTrackSelection.Definition, Integer> selectAudioTrack(MappingTrackSelector.MappedTrackInfo mappedTrackInfo, int[][][] rendererFormatSupports, final int[] rendererMixedMimeTypeAdaptationSupports, final Parameters params) throws ExoPlaybackException {
        ...
        return selectTracksForType(1, mappedTrackInfo, rendererFormatSupports, new TrackInfo.Factory() { // from class: androidx.media3.exoplayer.trackselection.DefaultTrackSelector$$ExternalSyntheticLambda7
            @Override // androidx.media3.exoplayer.trackselection.DefaultTrackSelector.TrackInfo.Factory
            public final List create(int i2, TrackGroup trackGroup, int[] iArr) {
                return this.f$0.m8002x86684b84(params, hasVideoRendererWithMappedTracksFinal, rendererMixedMimeTypeAdaptationSupports, i2, trackGroup, iArr);
            }
    ...
    /* JADX INFO: renamed from: lambda$selectAudioTrack$3$androidx-media3-exoplayer-trackselection-DefaultTrackSelector, reason: not valid java name */
    /* synthetic */ List m8002x86684b84(final Parameters params, boolean hasVideoRendererWithMappedTracksFinal, int[] rendererMixedMimeTypeAdaptationSupports, int rendererIndex, TrackGroup group, int[] support) {
        return AudioTrackInfo.createForTrackGroup(rendererIndex, group, params, support, hasVideoRendererWithMappedTracksFinal, new Predicate() { // from class: androidx.media3.exoplayer.trackselection.DefaultTrackSelector$$ExternalSyntheticLambda4
            @Override // com.google.common.base.Predicate
            public final boolean apply(Object obj) {
                return this.f$0.m8001x92d8c743(params, (Format) obj);
            }
    ...
    public boolean m8001x92d8c743(Format format, Parameters parameters) {
        return !parameters.constrainAudioChannelCountToDeviceCapabilities || (this.deviceIsTV != null && this.deviceIsTV.booleanValue()) || format.channelCount == -1 || format.channelCount <= 2 || ((isDolbyAudio(format) && (Build.VERSION.SDK_INT < 32 || this.spatializer == null || !this.spatializer.isSpatializationSupported())) || (Build.VERSION.SDK_INT >= 32 && this.spatializer != null && this.spatializer.isSpatializationSupported() && this.spatializer.isAvailable() && this.spatializer.isEnabled() && this.spatializer.canBeSpatialized(this.audioAttributes, format)));
    }
    ...
    protected Pair<ExoTrackSelection.Definition, Integer> selectTextTrack(MappingTrackSelector.MappedTrackInfo mappedTrackInfo, int[][][] rendererFormatSupports, final Parameters params, final String selectedAudioLanguage) throws ExoPlaybackException {
        ...
        final String preferredCaptioningLanguage = params.usePreferredTextLanguagesAndRoleFlagsFromCaptioningManager ? getPreferredLanguageFromCaptioningManager(this.context) : null;
        return selectTracksForType(3, mappedTrackInfo, rendererFormatSupports, new TrackInfo.Factory() { // from class: androidx.media3.exoplayer.trackselection.DefaultTrackSelector$$ExternalSyntheticLambda9
            @Override // androidx.media3.exoplayer.trackselection.DefaultTrackSelector.TrackInfo.Factory
            public final List create(int i, TrackGroup trackGroup, int[] iArr) {
                return DefaultTrackSelector.TextTrackInfo.createForTrackGroup(i, trackGroup, params, iArr, selectedAudioLanguage, preferredCaptioningLanguage);
            }
        }, new Comparator() { // from class: androidx.media3.exoplayer.trackselection.DefaultTrackSelector$$ExternalSyntheticLambda10
            @Override // java.util.Comparator
            public final int compare(Object obj, Object obj2) {
    ...
    protected void selectMetadataTracks(ExoTrackSelection.Definition[] definitions, MappingTrackSelector.MappedTrackInfo mappedTrackInfo, int[][][] rendererFormatSupports, Parameters params) throws ExoPlaybackException {
        int i;
        int i2;
        if (params.audioOffloadPreferences.audioOffloadMode == 2) {
            return;
        }
        ImmutableSet<String> primaryTrackGroupIds = getSelectedPrimaryTrackGroupIds(definitions, params);
        ArrayList<TrackGroup> metadataGroupsList = new ArrayList<>();
        ArrayList<int[]> metadataGroupSupportList = new ArrayList<>();
        int i3 = 0;
        while (true) {
            i = 0;
            ...
            int trackType = mappedTrackInfo.getRendererType(i3);
            if (trackType == 5) {
                TrackGroupArray metadataTracksForRenderer = mappedTrackInfo.getTrackGroups(i3);
                for (int j = 0; j < metadataTracksForRenderer.length; j++) {
                    ...
                    int[] groupSupport = (int[]) rendererFormatSupports[i3][j].clone();
                    for (int k = 0; k < groupSupport.length; k++) {
                        Format format = trackGroup.getFormat(k);
                        if (format.primaryTrackGroupId != null && !primaryTrackGroupIds.contains(format.primaryTrackGroupId)) {
                            groupSupport[k] = RendererCapabilities.create(0);
                        }
                    }
        ...
        int i4 = metadataGroupsList.size();
        TrackGroup[] metadataGroupsArray = new TrackGroup[i4];
        ...
        int[][] metadataGroupSupport = new int[metadataGroupSupportList.size()][];
        Util.nullSafeListToArray(metadataGroupSupportList, metadataGroupSupport);
        int i5 = 0;
        while (i5 < mappedTrackInfo.getRendererCount()) {
            int trackType2 = mappedTrackInfo.getRendererType(i5);
            if (trackType2 != 5) {
                i2 = i;
            } else {
                definitions[i5] = selectOtherTrack(5, metadataGroups, metadataGroupSupport, params);
                if (definitions[i5] != null) {
                    int groupIndex = metadataGroups.indexOf(definitions[i5].group);
                    i2 = i;
                    Arrays.fill(metadataGroupSupport[groupIndex], RendererCapabilities.create(i2));
                } else {
                    return;
                }
            }
    ...
    protected ExoTrackSelection.Definition selectOtherTrack(int trackType, TrackGroupArray groups, int[][] formatSupport, Parameters params) throws ExoPlaybackException {
        ...
        for (int groupIndex = 0; groupIndex < groups.length; groupIndex++) {
            ...
            for (int trackIndex = 0; trackIndex < trackGroup.length; trackIndex++) {
                if (RendererCapabilities.isFormatSupported(trackFormatSupport[trackIndex], params.exceedRendererCapabilitiesIfNecessary)) {
    ...
    private static ImmutableSet<String> getSelectedPrimaryTrackGroupIds(ExoTrackSelection.Definition[] definitions, Parameters parameters) {
        ...
        for (int i = 0; i < definitions.length; i++) {
            ...
            if (definition != null && !parameters.getRendererDisabled(i) && !parameters.disabledTrackTypes.contains(Integer.valueOf(definition.group.type))) {
    ...
    public void maybeInvalidateForAudioChannelCountConstraints() {
        ...
        synchronized (this.lock) {
            shouldInvalidate = this.parameters.constrainAudioChannelCountToDeviceCapabilities && Build.VERSION.SDK_INT >= 32 && this.spatializer != null && this.spatializer.isSpatializationSupported();
        }
        if (shouldInvalidate) {
            invalidate();
        }
    ...
    private static void applyRendererDisableOverrides(MappingTrackSelector.MappedTrackInfo mappedTrackInfo, Parameters parameters, ExoTrackSelection.Definition[] definitions) {
    ...
    private static boolean rendererSupportsTunneling(int[][] formatSupport, TrackGroupArray trackGroups, ExoTrackSelection selection) {
        ...
        for (int i = 0; i < selection.length(); i++) {
            ...
            if (RendererCapabilities.getTunnelingSupport(trackFormatSupport) != 32) {
                return false;
            }
        }
        return true;
    ...
    public static boolean rendererSupportsOffload(Parameters parameters, int formatSupport, Format format) {
        if (RendererCapabilities.getAudioOffloadSupport(formatSupport) == 0) {
            return false;
        }
        if (parameters.audioOffloadPreferences.isSpeedChangeSupportRequired && (RendererCapabilities.getAudioOffloadSupport(formatSupport) & 2048) == 0) {
            return false;
        }
        if (!parameters.audioOffloadPreferences.isGaplessSupportRequired) {
            return true;
        ...
        boolean isGaplessSupported = (RendererCapabilities.getAudioOffloadSupport(formatSupport) & 1024) != 0;
    ...
    protected static boolean isSupported(int formatSupport, boolean allowExceedsCapabilities) {
        return RendererCapabilities.isFormatSupported(formatSupport, allowExceedsCapabilities);
    }
    ...
    public static int getMaxVideoPixelsToRetainForViewport(TrackGroup group, int viewportWidth, int viewportHeight, boolean orientationMayChange) {
        ...
        for (int i = 0; i < group.length; i++) {
            ...
            if (format.width > 0 && format.height > 0) {
                Point maxVideoSizeInViewport = TrackSelectionUtil.getMaxVideoSizeInViewport(orientationMayChange, viewportWidth, viewportHeight, format.width, format.height);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static int getBestLabelMatchIndex(Format format, ImmutableList<String> preferredLabels) {
    ...
    */
    ...
    private static String getPreferredLanguageFromCaptioningManager(Context context) {
        ...
        if (context == null || (captioningManager = (CaptioningManager) context.getSystemService("captioning")) == null || !captioningManager.isEnabled() || (preferredLocale = captioningManager.getLocale()) == null) {
            return null;
        }
        return Util.getLocaleLanguageTag(preferredLocale);
    }

    private static Pair<ExoTrackSelection.Definition, Integer> findDefinitionForType(ExoTrackSelection.Definition[] definitions, int trackType) {
        for (int i = 0; i < definitions.length; i++) {
            if (definitions[i] != null && definitions[i].group.type == trackType) {
                return Pair.create(definitions[i], Integer.valueOf(i));
            }
        }
        return null;
    }
    ...
    static final class VideoTrackInfo extends TrackInfo<VideoTrackInfo> {
        ...
        public static ImmutableList<VideoTrackInfo> createForTrackGroup(int rendererIndex, TrackGroup trackGroup, Parameters params, int[] formatSupport, String selectedAudioLanguage, int mixedMimeTypeAdaptationSupport, Point viewportSizeFromDisplay) {
            TrackGroup trackGroup2 = trackGroup;
            Parameters parameters = params;
            int viewportWidth = viewportSizeFromDisplay != null ? viewportSizeFromDisplay.x : parameters.viewportWidth;
            int viewportHeight = viewportSizeFromDisplay != null ? viewportSizeFromDisplay.y : parameters.viewportHeight;
            int maxPixelsToRetainForViewport = DefaultTrackSelector.getMaxVideoPixelsToRetainForViewport(trackGroup2, viewportWidth, viewportHeight, parameters.viewportOrientationMayChange);
            ImmutableList.Builder<VideoTrackInfo> listBuilder = ImmutableList.builder();
            int i = 0;
            while (i < trackGroup2.length) {
                int pixelCount = trackGroup2.getFormat(i).getPixelCount();
                ...
                listBuilder.add(new VideoTrackInfo(rendererIndex, trackGroup2, i, parameters, formatSupport[i], selectedAudioLanguage, mixedMimeTypeAdaptationSupport, isSuitableForViewport));
                i++;
        ...
        public VideoTrackInfo(int rendererIndex, TrackGroup trackGroup, int trackIndex, Parameters parameters, int formatSupport, String selectedAudioLanguage, int mixedMimeTypeAdaptationSupport, boolean isSuitableForViewport) {
            ...
            this.isWithinRendererCapabilities = RendererCapabilities.isFormatSupported(formatSupport, false);
            ...
            int i = 0;
            while (true) {
                if (i >= parameters.preferredVideoLanguages.size()) {
                    break;
                }
                int score = DefaultTrackSelector.getFormatLanguageScore(this.format, parameters.preferredVideoLanguages.get(i), false);
                if (score <= 0) {
                    i++;
                } else {
                    bestLanguageIndex = i;
            ...
            while (true) {
                if (i2 < parameters.preferredVideoMimeTypes.size()) {
                    if (this.format.sampleMimeType == null || !this.format.sampleMimeType.equals(parameters.preferredVideoMimeTypes.get(i2))) {
                        i2++;
                    } else {
            ...
            this.preferredLabelMatchIndex = DefaultTrackSelector.getBestLabelMatchIndex(this.format, parameters.preferredVideoLabels);
        ...
        public boolean isCompatibleForAdaptationWith(VideoTrackInfo otherTrack) {
            return (this.allowMixedMimeTypes || Objects.equals(this.format.sampleMimeType, otherTrack.format.sampleMimeType)) && (this.parameters.allowVideoMixedDecoderSupportAdaptiveness || (this.usesPrimaryDecoder == otherTrack.usesPrimaryDecoder && this.usesHardwareAcceleration == otherTrack.usesHardwareAcceleration));
        }

        private int evaluateSelectionEligibility(int rendererSupport, int requiredAdaptiveSupport) {
            if ((this.format.roleFlags & 16384) != 0 || !RendererCapabilities.isFormatSupported(rendererSupport, this.parameters.exceedRendererCapabilitiesIfNecessary)) {
                return 0;
            }
            if (!this.isWithinMaxConstraints && !this.parameters.exceedVideoConstraintsIfNecessary) {
                return 0;
            }
            if (RendererCapabilities.isFormatSupported(rendererSupport, false) && this.isWithinMinConstraints && this.isWithinMaxConstraints && this.format.bitrate != -1 && !this.parameters.forceHighestSupportedBitrate && !this.parameters.forceLowestBitrate && (rendererSupport & requiredAdaptiveSupport) != 0) {
                return 2;
            }
            return 1;
        }
        ...
        public static int compareNonQualityPreferences(VideoTrackInfo info1, VideoTrackInfo info2) {
            ComparisonChain chain = ComparisonChain.start().compareFalseFirst(info1.isWithinRendererCapabilities, info2.isWithinRendererCapabilities).compare(Integer.valueOf(info1.preferredLanguageIndex), Integer.valueOf(info2.preferredLanguageIndex), Ordering.natural().reverse()).compare(info1.preferredLanguageScore, info2.preferredLanguageScore).compare(info1.preferredRoleFlagsScore, info2.preferredRoleFlagsScore).compare(Integer.valueOf(info1.preferredLabelMatchIndex), Integer.valueOf(info2.preferredLabelMatchIndex), Ordering.natural().reverse()).compareFalseFirst(info1.hasMainOrNoRoleFlag, info2.hasMainOrNoRoleFlag).compare(info1.selectedAudioLanguageScore, info2.selectedAudioLanguageScore).compareFalseFirst(info1.hasReasonableFrameRate, info2.hasReasonableFrameRate).compareFalseFirst(info1.isWithinMaxConstraints, info2.isWithinMaxConstraints).compareFalseFirst(info1.isWithinMinConstraints, info2.isWithinMinConstraints).compare(Integer.valueOf(info1.preferredMimeTypeMatchIndex), Integer.valueOf(info2.preferredMimeTypeMatchIndex), Ordering.natural().reverse()).compareFalseFirst(info1.usesPrimaryDecoder, info2.usesPrimaryDecoder).compareFalseFirst(info1.usesHardwareAcceleration, info2.usesHardwareAcceleration);
    ...
    static final class AudioTrackInfo extends TrackInfo<AudioTrackInfo> implements Comparable<AudioTrackInfo> {
        ...
        /* JADX WARN: Removed duplicated region for block: B:72:0x00f7 A[EDGE_INSN: B:72:0x00f7->B:51:0x00f7 BREAK  A[LOOP:1: B:45:0x00e4->B:50:0x00f4], SYNTHETIC] */
        /* JADX WARN: Removed duplicated region for block: B:73:0x0122 A[EDGE_INSN: B:73:0x0122->B:60:0x0122 BREAK  A[LOOP:2: B:52:0x00ff->B:59:0x011f], SYNTHETIC] */
        /*
            Code decompiled incorrectly, please refer to instructions dump.
        */
        public AudioTrackInfo(int rendererIndex, TrackGroup trackGroup, int trackIndex, Parameters parameters, int formatSupport, boolean hasMappedVideoTracks, Predicate<Format> withinAudioChannelCountConstraints, int mixedMimeTypeAdaptationSupport) {
            ...
            while (true) {
                ...
                int score = DefaultTrackSelector.getFormatLanguageScore(this.format, parameters.preferredAudioLanguages.get(i3), false);
                if (score <= 0) {
                    i3++;
                } else {
            ...
            if ((this.format.bitrate == -1 || this.format.bitrate <= parameters.maxAudioBitrate) && (this.format.channelCount == -1 || this.format.channelCount <= parameters.maxAudioChannelCount)) {
                ...
                while (true) {
                    ...
                    int score2 = DefaultTrackSelector.getFormatLanguageScore(this.format, localeLanguages[i], false);
                    if (score2 <= 0) {
                        i++;
                    } else {
                        bestLocaleMatchIndex = i;
                        bestLocaleMatchScore = score2;
                        break;
                    }
                }
            ...
            this.isWithinConstraints = z;
            localeLanguages = Util.getSystemLanguageCodes();
            int bestLocaleMatchIndex2 = Integer.MAX_VALUE;
            int bestLocaleMatchScore2 = 0;
            i = 0;
            while (true) {
                if (i >= localeLanguages.length) {
                }
            ...
            this.localeLanguageMatchIndex = bestLocaleMatchIndex2;
            this.localeLanguageScore = bestLocaleMatchScore2;
        ...
        private int evaluateSelectionEligibility(int rendererSupport, boolean hasMappedVideoTracks, int requiredAdaptiveSupport) {
            if (!RendererCapabilities.isFormatSupported(rendererSupport, this.parameters.exceedRendererCapabilitiesIfNecessary)) {
                return 0;
            }
            ...
            if (this.parameters.audioOffloadPreferences.audioOffloadMode != 2 || DefaultTrackSelector.rendererSupportsOffload(this.parameters, rendererSupport, this.format)) {
                return (!RendererCapabilities.isFormatSupported(rendererSupport, false) || !this.isWithinConstraints || this.format.bitrate == -1 || this.parameters.forceHighestSupportedBitrate || this.parameters.forceLowestBitrate || (!this.parameters.allowMultipleAdaptiveSelections && hasMappedVideoTracks) || this.parameters.audioOffloadPreferences.audioOffloadMode == 2 || (rendererSupport & requiredAdaptiveSupport) == 0) ? 1 : 2;
            }
            return 0;
        }
    ...
    static final class TextTrackInfo extends TrackInfo<TextTrackInfo> implements Comparable<TextTrackInfo> {
        ...
        public static ImmutableList<TextTrackInfo> createForTrackGroup(int rendererIndex, TrackGroup trackGroup, Parameters params, int[] formatSupport, String selectedAudioLanguage, String preferredCaptioningLanguage) {
            ImmutableList.Builder<TextTrackInfo> listBuilder = ImmutableList.builder();
            for (int i = 0; i < trackGroup.length; i++) {
                listBuilder.add(new TextTrackInfo(rendererIndex, trackGroup, i, params, formatSupport[i], selectedAudioLanguage, preferredCaptioningLanguage));
            }
            return listBuilder.build();
        }

        public TextTrackInfo(int rendererIndex, TrackGroup trackGroup, int trackIndex, Parameters parameters, int trackFormatSupport, String selectedAudioLanguage, String preferredCaptioningLanguage) {
            ImmutableList<String> preferredLanguages;
            int preferredRoleFlags;
            super(rendererIndex, trackGroup, trackIndex);
            int i = 0;
            this.isWithinRendererCapabilities = RendererCapabilities.isFormatSupported(trackFormatSupport, false);
            ...
            int bestLanguageIndex = Integer.MAX_VALUE;
            int bestLanguageScore = 0;
            if (preferredCaptioningLanguage != null) {
                preferredLanguages = ImmutableList.of(preferredCaptioningLanguage);
            ...
            this.preferredLanguageScore = bestLanguageScore;
            if (preferredCaptioningLanguage != null) {
                preferredRoleFlags = 1088;
            } else {
                preferredRoleFlags = parameters.preferredTextRoleFlags;
            }
            this.preferredRoleFlagsScore = DefaultTrackSelector.getRoleFlagMatchScore(this.format.roleFlags, preferredRoleFlags);
            this.hasCaptionRoleFlags = (1088 & this.format.roleFlags) != 0;
            this.preferredLabelMatchIndex = DefaultTrackSelector.getBestLabelMatchIndex(this.format, parameters.preferredTextLabels);
            boolean selectedAudioLanguageUndetermined = DefaultTrackSelector.normalizeUndeterminedLanguageToNull(selectedAudioLanguage) == null;
            this.selectedAudioLanguageScore = DefaultTrackSelector.getFormatLanguageScore(this.format, selectedAudioLanguage, selectedAudioLanguageUndetermined);
            boolean isWithinConstraints = this.preferredLanguageScore > 0 || (parameters.preferredTextLanguages.isEmpty() && this.preferredRoleFlagsScore > 0) || ((parameters.preferredTextLanguages.isEmpty() && this.preferredLabelMatchIndex != Integer.MAX_VALUE) || this.isDefault || ((this.isForced && this.selectedAudioLanguageScore > 0) || parameters.selectTextByDefault));
            if (RendererCapabilities.isFormatSupported(trackFormatSupport, parameters.exceedRendererCapabilitiesIfNecessary) && isWithinConstraints) {
                i = 1;
            }
    ...
    static final class ImageTrackInfo extends TrackInfo<ImageTrackInfo> implements Comparable<ImageTrackInfo> {
        ...
        public ImageTrackInfo(int rendererIndex, TrackGroup trackGroup, int trackIndex, Parameters parameters, int trackFormatSupport) {
            int i;
            super(rendererIndex, trackGroup, trackIndex);
            if (RendererCapabilities.isFormatSupported(trackFormatSupport, parameters.exceedRendererCapabilitiesIfNecessary)) {
                i = 1;
            } else {
                i = 0;
            }
