...
final class Projection {
    ...
    public static Projection createEquirectangular(float radius, int latitudes, int longitudes, float verticalFovDegrees, float horizontalFovDegrees, int stereoMode) {
        int i = latitudes;
        Preconditions.checkArgument(radius > 0.0f);
        Preconditions.checkArgument(i >= 1);
        Preconditions.checkArgument(longitudes >= 1);
        Preconditions.checkArgument(verticalFovDegrees > 0.0f && verticalFovDegrees <= 180.0f);
        Preconditions.checkArgument(horizontalFovDegrees > 0.0f && horizontalFovDegrees <= 360.0f);
    ...
    public static final class SubMesh {
        ...
        public SubMesh(int textureId, float[] vertices, float[] textureCoords, int mode) {
            ...
            Preconditions.checkArgument(((long) vertices.length) * 2 == ((long) textureCoords.length) * 3);
