...
public final class VideoDecoderGLSurfaceView extends GLSurfaceView implements VideoDecoderOutputBufferRenderer {
    ...
    private static final class Renderer implements GLSurfaceView.Renderer {
        ...
        public void onDrawFrame(GL10 unused) {
            ...
            VideoDecoderOutputBuffer outputBuffer = (VideoDecoderOutputBuffer) Preconditions.checkNotNull(this.renderedOutputBuffer);
            ...
            int[] yuvStrides = (int[]) Preconditions.checkNotNull(outputBuffer.yuvStrides);
            ByteBuffer[] yuvPlanes = (ByteBuffer[]) Preconditions.checkNotNull(outputBuffer.yuvPlanes);
            int i = 0;
            while (i < 3) {
            ...
            while (i3 < 3) {
                if (this.previousWidths[i3] == widths[i3] && this.previousStrides[i3] == yuvStrides[i3]) {
                    ...
                    Preconditions.checkState(yuvStrides[i3] != 0 ? c2 : 0);
