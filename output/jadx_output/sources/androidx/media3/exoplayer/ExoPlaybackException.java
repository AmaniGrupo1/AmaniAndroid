...
public final class ExoPlaybackException extends PlaybackException {
    ...
    public static ExoPlaybackException createForRenderer(Throwable cause, String rendererName, int rendererIndex, Format rendererFormat, int rendererFormatSupport, boolean isRecoverable, int errorCode) {
        return createForRenderer(cause, rendererName, rendererIndex, rendererFormat, rendererFormatSupport, null, isRecoverable, errorCode);
    }

    public static ExoPlaybackException createForRenderer(Throwable cause, String rendererName, int rendererIndex, Format rendererFormat, int rendererFormatSupport, MediaSource.MediaPeriodId mediaPeriodId, boolean isRecoverable, int errorCode) {
        return new ExoPlaybackException(1, cause, null, errorCode, rendererName, rendererIndex, rendererFormat, rendererFormat == null ? 4 : rendererFormatSupport, mediaPeriodId, isRecoverable);
    }
    ...
    public static ExoPlaybackException createForRemote(String message) {
        return new ExoPlaybackException(3, null, message, 1001, null, -1, null, 4, null, false);
    }

    private ExoPlaybackException(int type, Throwable cause, int errorCode) {
        this(type, cause, null, errorCode, null, -1, null, 4, null, false);
    }

    private ExoPlaybackException(int type, Throwable cause, String customMessage, int errorCode, String rendererName, int rendererIndex, Format rendererFormat, int rendererFormatSupport, MediaSource.MediaPeriodId mediaPeriodId, boolean isRecoverable) {
        this(deriveMessage(type, customMessage, rendererName, rendererIndex, rendererFormat, rendererFormatSupport), cause, errorCode, type, rendererName, rendererIndex, rendererFormat, rendererFormatSupport, mediaPeriodId, SystemClock.elapsedRealtime(), isRecoverable);
    }
    ...
    private ExoPlaybackException(String message, Throwable cause, int errorCode, int type, String rendererName, int rendererIndex, Format rendererFormat, int rendererFormatSupport, MediaSource.MediaPeriodId mediaPeriodId, long timestampMs, boolean isRecoverable) {
        ...
        Preconditions.checkArgument(!isRecoverable || type == 1);
        Preconditions.checkArgument(cause != null || type == 3);
        this.type = type;
    ...
    public boolean errorInfoEquals(PlaybackException that) {
        ...
        return this.type == other.type && Objects.equals(this.rendererName, other.rendererName) && this.rendererIndex == other.rendererIndex && Objects.equals(this.rendererFormat, other.rendererFormat) && this.rendererFormatSupport == other.rendererFormatSupport && Objects.equals(this.mediaPeriodId, other.mediaPeriodId) && this.isRecoverable == other.isRecoverable;
    }
