...
public final class ParsableNalUnitBitArray {
    ...
    private boolean shouldSkipByte(int offset) {
        return this.startOffset <= offset + (-2) && offset < this.byteLimit && this.data[offset] == 3 && this.data[offset + (-2)] == 0 && this.data[offset + (-1)] == 0;
    }

    private void assertValidOffset() {
        Preconditions.checkState(this.byteOffset >= 0 && (this.byteOffset < this.byteLimit || (this.byteOffset == this.byteLimit && this.bitOffset == 0)));
    }
}
