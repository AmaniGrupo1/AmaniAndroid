...
public final class ToInt16PcmAudioProcessor extends BaseAudioProcessor {
    ...
    public AudioProcessor.AudioFormat onConfigure(AudioProcessor.AudioFormat inputAudioFormat) throws AudioProcessor.UnhandledAudioFormatException {
        ...
        if (encoding != 3 && encoding != 2 && encoding != 268435456 && encoding != 21 && encoding != 1342177280 && encoding != 22 && encoding != 1610612736 && encoding != 4 && encoding != 1879048192) {
        ...
        switch (this.inputAudioFormat.encoding) {
            case 3:
                for (int i = position; i < limit; i++) {
                    buffer.put((byte) 0);
                    buffer.put((byte) ((inputBuffer.get(i) & 255) + WorkInfo.STOP_REASON_FOREGROUND_SERVICE_TIMEOUT));
                }
                break;
            case 4:
            ...
            case C.ENCODING_PCM_32BIT_BIG_ENDIAN /* 1610612736 */:
                ...
                break;
            case C.ENCODING_PCM_DOUBLE /* 1879048192 */:
                for (int i8 = position; i8 < limit; i8 += 8) {
                    double doubleValue = Util.constrainValue(inputBuffer.getDouble(i8), -1.0d, 1.0d);
                    short shortValue2 = (short) (32767.0d * doubleValue);
                    buffer.put((byte) (shortValue2 & 255));
                    buffer.put((byte) ((shortValue2 >> 8) & 255));
                }
                break;
            default:
                throw new IllegalStateException();
