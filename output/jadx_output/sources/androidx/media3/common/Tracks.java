...
public final class Tracks {
    ...
    public static final class Group {
        ...
        public Group(TrackGroup mediaTrackGroup, boolean adaptiveSupported, int[] trackSupport, boolean[] trackSelected) {
            ...
            boolean z = false;
            Preconditions.checkArgument(this.length == trackSupport.length && this.length == trackSelected.length);
        ...
        public static Group fromBundle(Bundle bundle) {
            TrackGroup trackGroup = TrackGroup.fromBundle((Bundle) Preconditions.checkNotNull(bundle.getBundle(FIELD_TRACK_GROUP)));
