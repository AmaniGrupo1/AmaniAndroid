...
public class PlaybackException extends Exception {
    ...
    public boolean errorInfoEquals(PlaybackException other) {
        ...
        if (this.errorCode == other.errorCode && Objects.equals(getMessage(), other.getMessage()) && this.timestampMs == other.timestampMs) {
            return true;
        }
        return false;
    }

    public static boolean areErrorInfosEqual(PlaybackException playbackException1, PlaybackException playbackException2) {
    ...
    private static Bundle getExtrasFromBundle(Bundle bundle) {
        Bundle extras = Util.convertToNullIfInvalid(bundle.getBundle(FIELD_BUNDLE_EXTRAS));
