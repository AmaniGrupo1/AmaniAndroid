...
public final class MediaMetadata {
    ...
    public static final class Builder {
        ...
        public Builder setDurationMs(Long durationMs) {
            Preconditions.checkArgument(durationMs == null || durationMs.longValue() >= 0);
        ...
        public Builder maybeSetArtworkData(byte[] artworkData, int artworkDataType) {
            if (this.artworkData == null || artworkDataType == 3 || !Objects.equals(this.artworkDataType, 3)) {
        ...
        public Builder setAuthor(CharSequence author) {
            this.author = author;
            return this;
        }
        ...
        public Builder setSupportedCommands(List<String> supportedCommands) {
            this.supportedCommands = ImmutableList.copyOf((Collection) supportedCommands);
            return this;
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (TextUtils.equals(this.title, that.title) && TextUtils.equals(this.artist, that.artist) && TextUtils.equals(this.albumTitle, that.albumTitle) && TextUtils.equals(this.albumArtist, that.albumArtist) && TextUtils.equals(this.displayTitle, that.displayTitle) && TextUtils.equals(this.subtitle, that.subtitle) && TextUtils.equals(this.description, that.description) && Objects.equals(this.durationMs, that.durationMs) && Objects.equals(this.userRating, that.userRating) && Objects.equals(this.overallRating, that.overallRating) && Arrays.equals(this.artworkData, that.artworkData) && Objects.equals(this.artworkDataType, that.artworkDataType) && Objects.equals(this.artworkUri, that.artworkUri) && Objects.equals(this.trackNumber, that.trackNumber) && Objects.equals(this.totalTrackCount, that.totalTrackCount) && Objects.equals(this.folderType, that.folderType) && Objects.equals(this.isBrowsable, that.isBrowsable) && Objects.equals(this.isPlayable, that.isPlayable) && Objects.equals(this.recordingYear, that.recordingYear) && Objects.equals(this.recordingMonth, that.recordingMonth) && Objects.equals(this.recordingDay, that.recordingDay) && Objects.equals(this.releaseYear, that.releaseYear) && Objects.equals(this.releaseMonth, that.releaseMonth) && Objects.equals(this.releaseDay, that.releaseDay) && TextUtils.equals(this.writer, that.writer) && TextUtils.equals(this.composer, that.composer) && TextUtils.equals(this.conductor, that.conductor) && Objects.equals(this.discNumber, that.discNumber) && Objects.equals(this.totalDiscCount, that.totalDiscCount) && TextUtils.equals(this.genre, that.genre) && TextUtils.equals(this.compilation, that.compilation) && TextUtils.equals(this.station, that.station) && Objects.equals(this.mediaType, that.mediaType) && Objects.equals(this.supportedCommands, that.supportedCommands)) {
            if (this.extras == null) {
                z = true;
            } else {
                z = false;
    ...
    public Bundle toBundle(int interfaceVersion) {
        ...
        if (this.artworkData != null) {
            ...
            } else if (this.artworkData.length <= LEGACY_ARTWORK_DATA_ARRAY_SIZE_LIMIT) {
    ...
    public static MediaMetadata fromBundle(Bundle bundle, int interfaceVersion) {
        ...
        if (bundle.containsKey(FIELD_ARTWORK_DATA)) {
            if (bundle.containsKey(FIELD_ARTWORK_DATA_TYPE)) {
                artworkDataType = Integer.valueOf(bundle.getInt(FIELD_ARTWORK_DATA_TYPE));
            } else {
                artworkDataType = null;
            }
            if (interfaceVersion >= 9) {
                Bundle artworkDataBundle = bundle.getBundle(FIELD_ARTWORK_DATA);
                if (artworkDataBundle != null) {
                    builder.setArtworkData(BundleableByteArray.fromBundle(artworkDataBundle), artworkDataType);
                }
            } else {
