...
public final class ColorInfo {
    ...
    public static int colorSpaceToIsoColorPrimaries(int colorSpace) {
        switch (colorSpace) {
            case -1:
            case 1:
                break;
    ...
    public static int colorSpaceToIsoMatrixCoefficients(int colorSpace) {
        switch (colorSpace) {
            case -1:
            case 1:
                break;
    ...
    public static int colorTransferToIsoTransferCharacteristics(int colorTransfer) {
