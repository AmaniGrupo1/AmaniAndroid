...
public final class StarRating extends Rating {
    ...
    public StarRating(int maxStars) {
        Preconditions.checkArgument(maxStars > 0, "maxStars must be a positive integer");
    ...
    public StarRating(int maxStars, float starRating) {
        Preconditions.checkArgument(maxStars > 0, "maxStars must be a positive integer");
        Preconditions.checkArgument(starRating >= 0.0f && starRating <= ((float) maxStars), "starRating is out of range [0, maxStars]");
        this.maxStars = maxStars;
