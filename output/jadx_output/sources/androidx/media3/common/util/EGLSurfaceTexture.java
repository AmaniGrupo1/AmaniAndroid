...
public final class EGLSurfaceTexture implements SurfaceTexture.OnFrameAvailableListener, Runnable {
    ...
    public void init(int secureMode) throws GlUtil.GlException {
    ...
    private static EGLConfig chooseEGLConfig(EGLDisplay display) throws GlUtil.GlException {
        ...
        GlUtil.checkGlException(z, Util.formatInvariant("eglChooseConfig failed: success=%b, numConfigs[0]=%d, configs[0]=%s", Boolean.valueOf(success), Integer.valueOf(numConfigs[0]), configs[0]));
        return configs[0];
    }

    private static EGLContext createEGLContext(EGLDisplay display, EGLConfig config, int secureMode) throws GlUtil.GlException {
        int[] glAttributes;
        if (secureMode != 0) {
    ...
    private static EGLSurface createEGLSurface(EGLDisplay display, EGLConfig config, EGLContext context, int secureMode) throws GlUtil.GlException {
