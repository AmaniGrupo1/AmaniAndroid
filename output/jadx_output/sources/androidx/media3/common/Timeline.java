...
public abstract class Timeline {
    ...
    public static final class Window {
        ...
        public boolean equals(Object obj) {
            ...
            if (Objects.equals(this.uid, that.uid) && Objects.equals(this.mediaItem, that.mediaItem) && Objects.equals(this.manifest, that.manifest) && Objects.equals(this.liveConfiguration, that.liveConfiguration) && this.presentationStartTimeMs == that.presentationStartTimeMs && this.windowStartTimeMs == that.windowStartTimeMs && this.elapsedRealtimeEpochOffsetMs == that.elapsedRealtimeEpochOffsetMs && this.isSeekable == that.isSeekable && this.isDynamic == that.isDynamic && this.isPlaceholder == that.isPlaceholder && this.defaultPositionUs == that.defaultPositionUs && this.durationUs == that.durationUs && this.firstPeriodIndex == that.firstPeriodIndex && this.lastPeriodIndex == that.lastPeriodIndex && this.positionInFirstPeriodUs == that.positionInFirstPeriodUs) {
                return true;
            }
            return false;
        }
        ...
        public static Window fromBundle(Bundle bundle, int interfaceVersion) {
            ...
            MediaItem mediaItem = mediaItemBundle != null ? MediaItem.fromBundle(mediaItemBundle, interfaceVersion) : MediaItem.EMPTY;
    ...
    public static final class Period {
        ...
        public boolean equals(Object obj) {
            ...
            if (Objects.equals(this.id, that.id) && Objects.equals(this.uid, that.uid) && this.windowIndex == that.windowIndex && this.durationUs == that.durationUs && this.positionInWindowUs == that.positionInWindowUs && this.isPlaceholder == that.isPlaceholder && Objects.equals(this.adPlaybackState, that.adPlaybackState)) {
                return true;
            }
            return false;
        }
        ...
        public Bundle toBundle(int interfaceVersion) {
            ...
            if (!this.adPlaybackState.equals(AdPlaybackState.NONE)) {
                bundle.putBundle(FIELD_AD_PLAYBACK_STATE, this.adPlaybackState.toBundle(interfaceVersion));
            }
            return bundle;
        }
        ...
        public static Period fromBundle(Bundle bundle, int interfaceVersion) {
            ...
            if (adPlaybackStateBundle != null) {
                adPlaybackState = AdPlaybackState.fromBundle(adPlaybackStateBundle, interfaceVersion);
            } else {
    ...
    public final Pair<Object, Long> getPeriodPositionUs(Window window, Period period, int windowIndex, long windowPositionUs) {
        return (Pair) Preconditions.checkNotNull(getPeriodPositionUs(window, period, windowIndex, windowPositionUs, 0L));
    }
    ...
    public final Pair<Object, Long> getPeriodPositionUs(Window window, Period period, int windowIndex, long windowPositionUs, long defaultPositionProjectionUs) {
        Preconditions.checkElementIndex(windowIndex, getWindowCount());
        ...
        return Pair.create(Preconditions.checkNotNull(period.uid), Long.valueOf(Math.max(0L, periodPositionUs)));
    }
    ...
    public final Bundle toBundle(int interfaceVersion) {
        ...
        for (int i = 0; i < windowCount; i++) {
            windowBundles.add(getWindow(i, window, 0L).toBundle(interfaceVersion));
        }
        List<Bundle> periodBundles = new ArrayList<>();
        int periodCount = getPeriodCount();
        Period period = new Period();
        for (int i2 = 0; i2 < periodCount; i2++) {
            periodBundles.add(getPeriod(i2, period, false).toBundle(interfaceVersion));
        }
    ...
    public static Timeline fromBundle(Bundle bundle, final int interfaceVersion) {
        ...
        ImmutableList<Window> windows = fromBundleListRetriever(new Function() { // from class: androidx.media3.common.Timeline$$ExternalSyntheticLambda0
            ...
            public final Object apply(Object obj) {
                return Timeline.Window.fromBundle((Bundle) obj, interfaceVersion);
            }
        ...
        ImmutableList<Period> periods = fromBundleListRetriever(new Function() { // from class: androidx.media3.common.Timeline$$ExternalSyntheticLambda1
            @Override // com.google.common.base.Function
            public final Object apply(Object obj) {
                return Timeline.Period.fromBundle((Bundle) obj, interfaceVersion);
            }
    ...
    public static final class RemotableTimeline extends Timeline {
        ...
        public RemotableTimeline(ImmutableList<Window> windows, ImmutableList<Period> periods, int[] shuffledWindowIndices) {
            Preconditions.checkArgument(windows.size() == shuffledWindowIndices.length);
