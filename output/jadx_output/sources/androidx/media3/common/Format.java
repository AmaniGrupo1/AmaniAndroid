...
public final class Format {
    ...
    public static final class Builder {
        ...
        public Builder setPrimaryTrackGroupId(String primaryTrackGroupId) {
    ...
    public Format withManifestFormatInfo(Format manifestFormat) {
        ...
        if (this.primaryTrackGroupId != null) {
            primaryTrackGroupId = this.primaryTrackGroupId;
        } else {
            primaryTrackGroupId = manifestFormat.primaryTrackGroupId;
        }
        ...
        int selectionFlags = manifestFormat.selectionFlags | this.selectionFlags;
        ...
        return buildUpon().setId(id).setLabel(label).setLabels(labels).setLanguage(language).setSelectionFlags(selectionFlags).setRoleFlags(roleFlags).setAverageBitrate(averageBitrate).setPeakBitrate(peakBitrate).setCodecs(codecs).setMetadata(metadata).setPrimaryTrackGroupId(primaryTrackGroupId).setDrmInitData(drmInitData).setFrameRate(frameRate).setTileCountHorizontal(tileCountHorizontal).setTileCountVertical(tileCountVertical).build();
    }
    ...
    public int hashCode() {
        if (this.hashCode == 0) {
            ...
            this.hashCode = (((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((result * 31) + (this.label == null ? 0 : this.label.hashCode())) * 31) + this.labels.hashCode()) * 31) + (this.language == null ? 0 : this.language.hashCode())) * 31) + this.selectionFlags) * 31) + this.roleFlags) * 31) + this.auxiliaryTrackType) * 31) + this.averageBitrate) * 31) + this.peakBitrate) * 31) + (this.codecs == null ? 0 : this.codecs.hashCode())) * 31) + (this.metadata == null ? 0 : this.metadata.hashCode())) * 31) + (this.customData == null ? 0 : this.customData.hashCode())) * 31) + (this.primaryTrackGroupId == null ? 0 : this.primaryTrackGroupId.hashCode())) * 31) + (this.containerMimeType == null ? 0 : this.containerMimeType.hashCode())) * 31) + (this.sampleMimeType != null ? this.sampleMimeType.hashCode() : 0)) * 31) + this.maxInputSize) * 31) + ((int) this.subsampleOffsetUs)) * 31) + this.width) * 31) + this.height) * 31) + this.decodedWidth) * 31) + this.decodedHeight) * 31) + Float.floatToIntBits(this.frameRate)) * 31) + this.rotationDegrees) * 31) + Float.floatToIntBits(this.pixelWidthHeightRatio)) * 31) + this.stereoMode) * 31) + this.maxSubLayers) * 31) + this.channelCount) * 31) + this.sampleRate) * 31) + this.pcmEncoding) * 31) + this.encoderDelay) * 31) + this.encoderPadding) * 31) + this.accessibilityChannel) * 31) + this.tileCountHorizontal) * 31) + this.tileCountVertical) * 31) + this.cryptoType;
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (this.selectionFlags == other.selectionFlags && this.roleFlags == other.roleFlags && this.auxiliaryTrackType == other.auxiliaryTrackType && this.averageBitrate == other.averageBitrate && this.peakBitrate == other.peakBitrate && this.maxInputSize == other.maxInputSize && this.subsampleOffsetUs == other.subsampleOffsetUs && this.width == other.width && this.height == other.height && this.decodedWidth == other.decodedWidth && this.decodedHeight == other.decodedHeight && this.rotationDegrees == other.rotationDegrees && this.stereoMode == other.stereoMode && this.maxSubLayers == other.maxSubLayers && this.channelCount == other.channelCount && this.sampleRate == other.sampleRate && this.pcmEncoding == other.pcmEncoding && this.encoderDelay == other.encoderDelay && this.encoderPadding == other.encoderPadding && this.accessibilityChannel == other.accessibilityChannel && this.tileCountHorizontal == other.tileCountHorizontal && this.tileCountVertical == other.tileCountVertical && this.cryptoType == other.cryptoType && Float.compare(this.frameRate, other.frameRate) == 0 && Float.compare(this.pixelWidthHeightRatio, other.pixelWidthHeightRatio) == 0 && Objects.equals(this.id, other.id) && Objects.equals(this.label, other.label) && this.labels.equals(other.labels) && Objects.equals(this.codecs, other.codecs) && Objects.equals(this.primaryTrackGroupId, other.primaryTrackGroupId) && Objects.equals(this.containerMimeType, other.containerMimeType) && Objects.equals(this.sampleMimeType, other.sampleMimeType) && Objects.equals(this.language, other.language) && Arrays.equals(this.projectionData, other.projectionData) && Objects.equals(this.metadata, other.metadata) && Objects.equals(this.colorInfo, other.colorInfo) && Objects.equals(this.drmInitData, other.drmInitData) && initializationDataEquals(other) && Objects.equals(this.customData, other.customData)) {
            return true;
        }
        return false;
    }
    ...
    public static String toLogString(Format format) {
        ...
        Joiner commaJoiner = Joiner.on(AbstractJsonLexerKt.COMMA);
        ...
        if (format.drmInitData != null) {
            ...
            builder.append(", drm=[");
            commaJoiner.appendTo(builder, (Iterable<? extends Object>) schemes);
        ...
        if (format.decodedWidth != -1 && format.decodedHeight != -1) {
            builder.append(", decRes=").append(format.decodedWidth).append("x").append(format.decodedHeight);
        }
        ...
        if (!format.labels.isEmpty()) {
            ...
            commaJoiner.appendTo(builder, Lists.transform(format.labels, new Function() { // from class: androidx.media3.common.Format$$ExternalSyntheticLambda2
    ...
    static /* synthetic */ String lambda$toLogString$0(Label l) {
    ...
    public Bundle toBundle() {
        ...
        if (this.auxiliaryTrackType != DEFAULT.auxiliaryTrackType) {
        ...
        if (this.primaryTrackGroupId != null) {
            bundle.putString(FIELD_PRIMARY_TRACK_GROUP_ID, this.primaryTrackGroupId);
        }
    ...
    public static Format fromBundle(Bundle bundle) {
        ...
        if (labelsBundles == null) {
            ...
            labels = BundleCollectionUtil.fromBundleList(new Function() { // from class: androidx.media3.common.Format$$ExternalSyntheticLambda1
                @Override // com.google.common.base.Function
                public final Object apply(Object obj) {
        ...
        builder.setLabels(labels).setLanguage((String) defaultIfNull(bundle.getString(FIELD_LANGUAGE), DEFAULT.language)).setSelectionFlags(bundle.getInt(FIELD_SELECTION_FLAGS, DEFAULT.selectionFlags)).setRoleFlags(bundle.getInt(FIELD_ROLE_FLAGS, DEFAULT.roleFlags)).setAuxiliaryTrackType(bundle.getInt(FIELD_AUXILIARY_TRACK_TYPE, DEFAULT.auxiliaryTrackType)).setAverageBitrate(bundle.getInt(FIELD_AVERAGE_BITRATE, DEFAULT.averageBitrate)).setPeakBitrate(bundle.getInt(FIELD_PEAK_BITRATE, DEFAULT.peakBitrate)).setCodecs((String) defaultIfNull(bundle.getString(FIELD_CODECS), DEFAULT.codecs)).setPrimaryTrackGroupId((String) defaultIfNull(bundle.getString(FIELD_PRIMARY_TRACK_GROUP_ID), DEFAULT.primaryTrackGroupId)).setContainerMimeType((String) defaultIfNull(bundle.getString(FIELD_CONTAINER_MIME_TYPE), DEFAULT.containerMimeType)).setSampleMimeType((String) defaultIfNull(bundle.getString(FIELD_SAMPLE_MIME_TYPE), DEFAULT.sampleMimeType)).setMaxInputSize(bundle.getInt(FIELD_MAX_INPUT_SIZE, DEFAULT.maxInputSize));
