...
public final class Cue {
    ...
    private Cue(CharSequence text, Layout.Alignment textAlignment, Layout.Alignment multiRowAlignment, Bitmap bitmap, float line, int lineType, int lineAnchor, float position, int positionAnchor, int textSizeType, float textSize, float size, float bitmapHeight, boolean windowColorSet, int windowColor, int verticalType, float shearDegrees, int zIndex) {
        if (text == null) {
    ...
    public Bundle toSerializableBundle() {
        ...
        if (this.bitmap != null) {
            ...
            Preconditions.checkState(this.bitmap.compress(Bitmap.CompressFormat.PNG, 0, output));
