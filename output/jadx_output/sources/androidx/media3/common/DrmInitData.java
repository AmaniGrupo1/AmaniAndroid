...
public final class DrmInitData implements Comparator<SchemeData>, Parcelable {
    ...
    public DrmInitData merge(DrmInitData drmInitData) {
        Preconditions.checkState(this.schemeType == null || drmInitData.schemeType == null || TextUtils.equals(this.schemeType, drmInitData.schemeType));
    ...
    public boolean equals(Object obj) {
        ...
        if (Objects.equals(this.schemeType, other.schemeType) && Arrays.equals(this.schemeDatas, other.schemeDatas)) {
            return true;
        }
        return false;
    }
    ...
    public static final class SchemeData implements Parcelable {
        ...
        public SchemeData(UUID uuid, String licenseServerUrl, String mimeType, byte[] data) {
            ...
            this.mimeType = MimeTypes.normalizeMimeType((String) Preconditions.checkNotNull(mimeType));
            this.data = data;
        }
        ...
        public boolean equals(Object obj) {
            ...
            return Objects.equals(this.licenseServerUrl, other.licenseServerUrl) && Objects.equals(this.mimeType, other.mimeType) && Objects.equals(this.uuid, other.uuid) && Arrays.equals(this.data, other.data);
        }
