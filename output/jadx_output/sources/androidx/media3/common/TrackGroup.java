...
public final class TrackGroup {
    ...
    public TrackGroup(String id, Format... formats) {
        ...
        String sampleMimeType = formats[0].sampleMimeType;
        if (TextUtils.isEmpty(sampleMimeType)) {
            trackType = MimeTypes.getTrackType(formats[0].containerMimeType);
        } else {
            trackType = MimeTypes.getTrackType(sampleMimeType);
        }
        this.type = trackType;
        verifyCorrectness();
    }
