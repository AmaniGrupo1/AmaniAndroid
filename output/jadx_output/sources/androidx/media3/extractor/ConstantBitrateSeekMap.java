...
public class ConstantBitrateSeekMap implements SeekMap {
    ...
    public ConstantBitrateSeekMap(long inputLength, long firstFrameBytePosition, int bitrate, int frameSize, boolean allowSeeksIfLengthUnknown) {
        this(inputLength, firstFrameBytePosition, bitrate, frameSize, allowSeeksIfLengthUnknown, true);
    }

    protected ConstantBitrateSeekMap(long inputLength, long firstFrameBytePosition, int bitrate, int frameSize, boolean allowSeeksIfLengthUnknown, boolean isEstimated) {
