...
abstract class StreamReader {
    ...
    private int readHeadersAndUpdateState(ExtractorInput input) throws IOException {
        ...
        if (this.setupData.oggSeeker != null) {
            ...
            streamReader = this;
            streamReader.oggSeeker = new DefaultOggSeeker(streamReader, this.payloadStartPosition, input.getLength(), firstPayloadPageHeader.headerSize + firstPayloadPageHeader.bodySize, firstPayloadPageHeader.granulePosition, isLastPage);
        }
