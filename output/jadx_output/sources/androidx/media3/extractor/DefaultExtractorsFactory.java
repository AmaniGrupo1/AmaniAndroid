...
public final class DefaultExtractorsFactory implements ExtractorsFactory {
    ...
    @Override // androidx.media3.extractor.ExtractorsFactory
    public synchronized DefaultExtractorsFactory experimentalSetCodecsToParseWithinGopSampleDependencies(int codecsToParseWithinGopSampleDependencies) {
    ...
    public synchronized DefaultExtractorsFactory setHeifExtractorFlags(int flags) {
    ...
    public synchronized Extractor[] createExtractors(Uri uri, Map<String, List<String>> responseHeaders) {
        ...
        extractors = new ArrayList<>(DEFAULT_EXTRACTOR_ORDER.length);
        ...
        return (Extractor[]) extractors.toArray(new Extractor[0]);
    }
    ...
    private void addExtractorsForFileType(int i, List<Extractor> list) {
        ...
        switch (i) {
            ...
            case 8:
                ...
                int iCodecsToParseWithinGopSampleDependenciesAsFlags = this.fragmentedMp4Flags | FragmentedMp4Extractor.codecsToParseWithinGopSampleDependenciesAsFlags(this.codecsToParseWithinGopSampleDependencies);
                if (this.textTrackTranscodingEnabled) {
                    i2 = 0;
                } else {
                    i2 = 32;
                }
                list.add(new FragmentedMp4Extractor(factory2, iCodecsToParseWithinGopSampleDependenciesAsFlags | i2));
