...
public final class FlacStreamMetadata {
    ...
    FlacStreamMetadata(int minBlockSizeSamples, int maxBlockSizeSamples, int minFrameSize, int maxFrameSize, int sampleRate, int channels, int bitsPerSample, long totalSamples, SeekTable seekTable, Metadata metadata) {
