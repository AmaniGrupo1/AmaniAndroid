...
public final class Ac3Reader implements ElementaryStreamReader {
    ...
    public Ac3Reader(String containerMimeType) {
        this(null, 0, containerMimeType);
    }

    public Ac3Reader(String language, int roleFlags, String containerMimeType) {
    ...
    private void parseHeader() {
        ...
        if (this.format == null || frameInfo.channelCount != this.format.channelCount || frameInfo.sampleRate != this.format.sampleRate || !Objects.equals(frameInfo.mimeType, this.format.sampleMimeType)) {
            Format.Builder formatBuilder = new Format.Builder().setId(this.formatId).setContainerMimeType(this.containerMimeType).setSampleMimeType(frameInfo.mimeType).setChannelCount(frameInfo.channelCount).setSampleRate(frameInfo.sampleRate).setLanguage(this.language).setRoleFlags(this.roleFlags).setPeakBitrate(frameInfo.bitrate);
