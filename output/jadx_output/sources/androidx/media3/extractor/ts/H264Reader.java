...
public final class H264Reader implements ElementaryStreamReader {
    ...
    public H264Reader(SeiReader seiReader, boolean allowNonIdrKeyframes, boolean detectAccessUnits, String containerMimeType) {
    ...
    public void consume(ParsableByteArray data) {
        ...
        while (true) {
            ...
            int nalUnitType = NalUnitUtil.getNalUnitType(dataArray, nalUnitOffset2);
        ...
        if (!this.hasOutputFormat || this.sampleReader.needsSpsPps()) {
            ...
            if (!z) {
                if (nalUnitTargetBuffer.isCompleted() && this.pps.isCompleted()) {
                    ...
                    this.seiReader.setReorderingQueueSize(spsData.maxNumReorderFrames);
                ...
                NalUnitUtil.SpsData spsData2 = NalUnitUtil.parseSpsNalUnit(this.sps.nalData, 3, this.sps.nalLength);
                this.seiReader.setReorderingQueueSize(spsData2.maxNumReorderFrames);
                this.sampleReader.putSps(spsData2);
                this.sps.reset();
    ...
    private static final class SampleReader {
        ...
        /* JADX WARN: Removed duplicated region for block: B:87:0x0198 A[PHI: r4 r7
        ...
        */
        ...
        private void outputSample(int i) {
            if (this.sampleTimeUs != C.TIME_UNSET && this.nalUnitStartPosition != this.samplePosition) {
                boolean z = this.sampleIsKeyframe;
        ...
        private static final class SliceHeaderData {
            ...
            public boolean isFirstVclNalUnitOfPicture(SliceHeaderData other) {
                ...
                NalUnitUtil.SpsData otherSpsData = (NalUnitUtil.SpsData) Preconditions.checkNotNull(other.spsData);
