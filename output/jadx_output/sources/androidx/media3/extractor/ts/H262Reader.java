...
public final class H262Reader implements ElementaryStreamReader {
    ...
    H262Reader(UserDataReader userDataReader, String containerMimeType) {
    ...
    public void consume(ParsableByteArray parsableByteArray) {
        ...
        while (true) {
            ...
            int i2 = parsableByteArray.getData()[iFindNalUnit + 3] & 255;
            ...
            if (this.userData != null) {
                ...
                if (i2 == START_USER_DATA && parsableByteArray.getData()[iFindNalUnit + 2] == 1) {
            ...
            if (i2 == 0 || i2 == START_SEQUENCE_HEADER) {
                ...
                if (!this.startedFirstSample || this.sampleHasPicture) {
                    this.samplePosition = this.totalBytesWritten - ((long) i);
                    if (this.pesTimeUs != j) {
                        j2 = this.pesTimeUs;
    ...
    private static Pair<Format, Long> parseCsdBuffer(CsdBuffer csdBuffer, String formatId, String containerMimeType) {
        ...
        Format format = new Format.Builder().setId(formatId).setContainerMimeType(containerMimeType).setSampleMimeType(MimeTypes.VIDEO_MPEG2).setWidth(width).setHeight(height).setPixelWidthHeightRatio(pixelWidthHeightRatio).setInitializationData(Collections.singletonList(csdData)).build();
