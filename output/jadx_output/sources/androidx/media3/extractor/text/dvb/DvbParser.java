...
public final class DvbParser implements SubtitleParser {
    ...
    private CuesWithTiming parse(ParsableBitArray dataBitArray) {
        ...
        SparseArray<PageRegion> pageRegions2 = pageComposition.regions;
        int i = 0;
        while (i < pageRegions2.size()) {
            this.canvas.save();
            PageRegion pageRegion = pageRegions2.valueAt(i);
            int regionId = pageRegions2.keyAt(i);
            ...
            SparseArray<PageRegion> pageRegions3 = pageRegions2;
    ...
    private static ClutDefinition parseClutDefinition(ParsableBitArray data, int length) {
        ...
        while (remainingLength2 > 0) {
            ...
            int clutId2 = clutId;
            int r = (int) (((double) t) + (((double) (y + WorkInfo.STOP_REASON_FOREGROUND_SERVICE_TIMEOUT)) * 1.402d));
            int g2 = (int) ((((double) t) - (((double) (cb + WorkInfo.STOP_REASON_FOREGROUND_SERVICE_TIMEOUT)) * 0.34414d)) - (((double) (y + WorkInfo.STOP_REASON_FOREGROUND_SERVICE_TIMEOUT)) * 0.71414d));
            int b = (int) (((double) t) + (((double) (cb + WorkInfo.STOP_REASON_FOREGROUND_SERVICE_TIMEOUT)) * 1.772d));
        ...
        while (line != 0) {
            ...
            switch (dataType) {
                ...
                case 32:
                    ...
                    break;
                case 33:
                    byte[] clutMapTable2To82 = buildClutMapTable(4, 8, data);
                    clutMapTable2To8 = clutMapTable2To82;
                    break;
                case 34:
                    byte[] clutMapTable4To82 = buildClutMapTable(16, 8, data);
    ...
    private static int paint2BitPixelCodeString(ParsableBitArray data, int[] clutEntries, byte[] bArr, int column, int line, Paint paint, Canvas canvas) {
        ...
        while (true) {
            ...
            if (runLength != 0 && paint2 != null) {
                ...
                canvas.drawRect(column, line, column + runLength, line + 1, paint2);
            }
            column += runLength;
