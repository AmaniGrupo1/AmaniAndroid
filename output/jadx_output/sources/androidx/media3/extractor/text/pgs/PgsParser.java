    ...
    private static final class CueBuilder {
        ...
        public void parsePaletteSection(ParsableByteArray buffer, int sectionLength) {
            ...
            for (int i = 0; i < entryCount; i++) {
                ...
                int r = (int) (((double) y) + (((double) (cr + WorkInfo.STOP_REASON_FOREGROUND_SERVICE_TIMEOUT)) * 1.402d));
                int g = (int) ((((double) y) - (((double) (cb + WorkInfo.STOP_REASON_FOREGROUND_SERVICE_TIMEOUT)) * 0.34414d)) - (((double) (cr + WorkInfo.STOP_REASON_FOREGROUND_SERVICE_TIMEOUT)) * 0.71414d));
                int b = (int) (((double) y) + (((double) (cb + WorkInfo.STOP_REASON_FOREGROUND_SERVICE_TIMEOUT)) * 1.772d));
