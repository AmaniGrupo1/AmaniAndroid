...
public class SubtitleExtractor implements Extractor {
    ...
    public int read(ExtractorInput input, PositionHolder seekPosition) throws IOException {
        int length;
        Preconditions.checkState((this.state == 0 || this.state == 5) ? false : true);
        if (this.state == 1) {
        ...
        try {
            ...
            this.subtitleParser.parse(this.subtitleData, 0, this.bytesRead, outputOptions, new Consumer() { // from class: androidx.media3.extractor.text.SubtitleExtractor$$ExternalSyntheticLambda0
                ...
                public final void accept(Object obj) {
                    this.f$0.m8029xdbba10ad((CuesWithTiming) obj);
                }
            });
    ...
    /* synthetic */ void m8029xdbba10ad(CuesWithTiming cuesWithTiming) {
