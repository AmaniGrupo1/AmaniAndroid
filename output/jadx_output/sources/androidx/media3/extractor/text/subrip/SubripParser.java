...
public final class SubripParser implements SubtitleParser {
    ...
    private static long parseTimecode(Matcher matcher, int groupOffset) {
        ...
        long timestampMs = (hours != null ? Long.parseLong(hours) * 60 * 60 * 1000 : 0L) + (Long.parseLong((String) Preconditions.checkNotNull(matcher.group(groupOffset + 2))) * 60 * 1000) + (Long.parseLong((String) Preconditions.checkNotNull(matcher.group(groupOffset + 3))) * 1000);
