...
final class AviStreamHeaderChunk implements AviChunk {
    ...
    public static AviStreamHeaderChunk parseFrom(ParsableByteArray body) {
        ...
        return new AviStreamHeaderChunk(streamType, initialFrames, scale, rate, length, suggestedBufferSize, sampleSize);
    }

    private AviStreamHeaderChunk(int streamType, int initialFrames, int scale, int rate, int length, int suggestedBufferSize, int sampleSize) {
