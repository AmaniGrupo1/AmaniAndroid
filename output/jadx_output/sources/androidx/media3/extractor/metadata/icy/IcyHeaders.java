...
public final class IcyHeaders implements Metadata.Entry {
    ...
    public static IcyHeaders parse(Map<String, List<String>> responseHeaders) {
        ...
        if (headers5 == null) {
            ...
            boolean isPublic2 = headers5.get(0).equals("1");
            icyHeadersPresent = true;
            isPublic = isPublic2;
        }
    ...
    public IcyHeaders(int bitrate, String genre, String name, String url, boolean isPublic, int metadataInterval) {
        Preconditions.checkArgument(metadataInterval == -1 || metadataInterval > 0);
    ...
    public boolean equals(Object obj) {
        ...
        if (this.bitrate == other.bitrate && Objects.equals(this.genre, other.genre) && Objects.equals(this.name, other.name) && Objects.equals(this.url, other.url) && this.isPublic == other.isPublic && this.metadataInterval == other.metadataInterval) {
            return true;
        }
        return false;
    }
