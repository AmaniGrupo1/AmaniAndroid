...
final class SubtitleViewUtils {
    ...
    public static void removeAllEmbeddedStyling(Cue.Builder cue) {
        ...
        if (cue.getText() instanceof Spanned) {
            ...
            removeSpansIf((Spannable) Preconditions.checkNotNull(cue.getText()), new Predicate() { // from class: androidx.media3.ui.SubtitleViewUtils$$ExternalSyntheticLambda0
    ...
    public static void removeEmbeddedFontSizes(Cue.Builder cue) {
        ...
        if (cue.getText() instanceof Spanned) {
            ...
            removeSpansIf((Spannable) Preconditions.checkNotNull(cue.getText()), new Predicate() { // from class: androidx.media3.ui.SubtitleViewUtils$$ExternalSyntheticLambda1
                @Override // com.google.common.base.Predicate
                public final boolean apply(Object obj) {
