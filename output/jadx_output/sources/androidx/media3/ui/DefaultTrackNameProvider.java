...
public class DefaultTrackNameProvider implements TrackNameProvider {
    ...
    public String getTrackName(Format format) {
        ...
        return this.resources.getString(R.string.exo_track_unknown_name, language);
    }
    ...
    private String buildResolutionString(Format format) {
        ...
        return this.resources.getString(R.string.exo_track_resolution, Integer.valueOf(width), Integer.valueOf(height));
    }
    ...
    private String buildBitrateString(Format format) {
        ...
        return this.resources.getString(R.string.exo_track_bitrate, Float.valueOf(bitrate / 1000000.0f));
    }
