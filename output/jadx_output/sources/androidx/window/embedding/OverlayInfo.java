...
public final class OverlayInfo {
    ...
    public String toString() {
        return OverlayInfo.class.getSimpleName() + ": {tag=" + this.overlayTag + ", currentOverlayAttrs=" + this.currentOverlayAttrs + ", activityStack=" + this.activityStack + AbstractJsonLexerKt.END_OBJ;
    }
}
