...
public final class SplitPinRule extends SplitRule {
    ...
    public String toString() {
        return SplitPinRule.class.getSimpleName() + "{tag=" + getTag() + ", defaultSplitAttributes=" + getDefaultSplitAttributes() + ", isSticky=" + this.isSticky + AbstractJsonLexerKt.END_OBJ;
    }
}
