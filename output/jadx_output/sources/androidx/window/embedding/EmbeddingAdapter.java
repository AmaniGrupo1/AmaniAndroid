...
public final class EmbeddingAdapter {
    ...
    */
    public final SplitAttributesCalculatorParams translate(androidx.window.extensions.embedding.SplitAttributesCalculatorParams params) {
        ...
        WindowMetrics taskWindowMetrics = params.getParentWindowMetrics();
        Intrinsics.checkNotNullExpressionValue(taskWindowMetrics, "getParentWindowMetrics(...)");
        Configuration taskConfiguration = params.getParentConfiguration();
        Intrinsics.checkNotNullExpressionValue(taskConfiguration, "getParentConfiguration(...)");
        WindowLayoutInfo windowLayoutInfo = params.getParentWindowLayoutInfo();
        Intrinsics.checkNotNullExpressionValue(windowLayoutInfo, "getParentWindowLayoutInfo(...)");
        ...
        float density = DensityCompatHelper.INSTANCE.getInstance().density(taskConfiguration, taskWindowMetrics);
        androidx.window.layout.WindowMetrics windowMetrics = WindowMetricsCalculator.INSTANCE.translateWindowMetrics$window_release(taskWindowMetrics, density);
        return new SplitAttributesCalculatorParams(windowMetrics, taskConfiguration, ExtensionsWindowLayoutInfoAdapter.INSTANCE.translate$window_release(windowMetrics, windowLayoutInfo), translate$window_release(defaultSplitAttributes), areDefaultConstraintsSatisfied, splitRuleTag);
    }
    ...
    */
    public final DividerAttributes translateToJetpackDividerAttributes(androidx.window.extensions.embedding.DividerAttributes oemDividerAttributes) {
        ...
        switch (oemDividerAttributes.getDividerType()) {
            case 1:
            ...
            case 2:
                ...
                if (oemDividerAttributes.getPrimaryMinRatio() == -1.0f) {
                    if (oemDividerAttributes.getPrimaryMaxRatio() == -1.0f) {
