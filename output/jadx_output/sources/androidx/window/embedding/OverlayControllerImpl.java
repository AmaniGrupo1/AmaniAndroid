...
public class OverlayControllerImpl {
    ...
    static final ActivityStackAttributes _init_$lambda$3(OverlayControllerImpl this$0, ActivityStackAttributesCalculatorParams params) throws Throwable {
        ...
        reentrantLock.lock();
        try {
            androidx.window.extensions.embedding.ParentContainerInfo parentContainerInfo = params.getParentContainerInfo();
            ...
            String activityStackTag = params.getActivityStackTag();
            ...
            WindowMetrics windowMetrics4 = params.getParentContainerInfo().getWindowMetrics();
            Intrinsics.checkNotNullExpressionValue(windowMetrics4, "getWindowMetrics(...)");
            androidx.window.layout.WindowMetrics windowMetricsTranslateWindowMetrics$window_release = companion3.translateWindowMetrics$window_release(windowMetrics4, density);
            Configuration configuration2 = params.getParentContainerInfo().getConfiguration();
            ...
            try {
                OverlayAttributes overlayAttributes = this$0.calculateOverlayAttributes$window_release(activityStackTag, overlayAttributes$window_release, windowMetricsTranslateWindowMetrics$window_release, configuration2, extensionsWindowLayoutInfoAdapter.translate$window_release(windowMetrics3, windowLayoutInfo));
