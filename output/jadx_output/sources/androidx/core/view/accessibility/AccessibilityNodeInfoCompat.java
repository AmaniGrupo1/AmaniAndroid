...
public class AccessibilityNodeInfoCompat {
        ...
        public boolean perform(View view, Bundle arguments) {
            ...
            if (this.mViewCommandArgumentClass != null) {
                try {
                    ...
                    String className = this.mViewCommandArgumentClass == null ? AbstractJsonLexerKt.NULL : this.mViewCommandArgumentClass.getName();
    ...
    private static class Api34Impl {
        ...
        public static long getMinDurationBetweenContentChangeMillis(AccessibilityNodeInfo info) {
            return TimeConversions.convert(info.getMinDurationBetweenContentChanges()).toMillis();
        }

        public static void setMinDurationBetweenContentChangeMillis(AccessibilityNodeInfo info, long duration) {
            info.setMinDurationBetweenContentChanges(TimeConversions.convert(Duration.ofMillis(duration)));
        }
