...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild3, ScrollingView {
    ...
    public boolean executeKeyEvent(KeyEvent event) {
        ...
        switch (event.getKeyCode()) {
            ...
            case 20:
                if (event.isAltPressed()) {
                    boolean handled3 = fullScroll(TsExtractor.TS_STREAM_TYPE_HDMV_DTS);
                    return handled3;
                }
                boolean handled4 = arrowScroll(TsExtractor.TS_STREAM_TYPE_HDMV_DTS);
                return handled4;
            ...
            case 92:
                ...
                return handled5;
            case 93:
                boolean handled6 = fullScroll(TsExtractor.TS_STREAM_TYPE_HDMV_DTS);
                return handled6;
            case 122:
                pageScroll(33);
                return false;
