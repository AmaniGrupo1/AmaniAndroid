...
@Metadata(d1 = {"\u0000(\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0002\bÃ\u0002\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\u0010\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u0007H\u0007J$\u0010\b\u001a\u00020\t2\u0006\u0010\n\u001a\u00020\u00052\b\u0010\u000b\u001a\u0004\u0018\u00010\f2\b\u0010\r\u001a\u0004\u0018\u00010\u0001H\u0007¨\u0006\u000e"}, d2 = {"Landroidx/core/os/PersistableBundleApi21ImplKt;", "", "<init>", "()V", "createPersistableBundle", "Landroid/os/PersistableBundle;", "capacity", "", "putValue", "", "persistableBundle", "key", "", Values.VECTOR_MAP_VECTORS_KEY, "core-ktx_release"}, k = 1, mv = {2, 0, 0}, xi = 48)
    ...
    public static final void putValue(PersistableBundle persistableBundle, String key, Object value) {
        ...
        if (value instanceof Object[]) {
            ...
            if (String.class.isAssignableFrom(componentType)) {
                ...
                throw new IllegalArgumentException("Unsupported value array type " + valueType + " for key \"" + key + '\"');
            }
        }
        String valueType2 = value.getClass().getCanonicalName();
        throw new IllegalArgumentException("Unsupported value type " + valueType2 + " for key \"" + key + '\"');
    }
}
