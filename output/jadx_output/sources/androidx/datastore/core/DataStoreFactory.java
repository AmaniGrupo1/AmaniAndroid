...
/* JADX INFO: compiled from: DataStoreFactory.android.kt */
...
public final class DataStoreFactory {
    ...
    public final <T> DataStore<T> createInDeviceProtectedStorage(final Context context, final String fileName, Serializer<T> serializer, ReplaceFileCorruptionHandler<T> corruptionHandler, List<? extends DataMigration<T>> migrations, CoroutineScope scope) {
        Intrinsics.checkNotNullParameter(context, "context");
        Intrinsics.checkNotNullParameter(fileName, "fileName");
        Intrinsics.checkNotNullParameter(serializer, "serializer");
        Intrinsics.checkNotNullParameter(migrations, "migrations");
        ...
        return new DataStoreImpl(new FileStorage(serializer, null, new Function0() { // from class: androidx.datastore.core.DataStoreFactory$$ExternalSyntheticLambda0
            ...
            public final Object invoke() {
                return DeviceProtectedDataStoreFile.deviceProtectedDataStoreFile(context, fileName);
            }
        }, 2, null), CollectionsKt.listOf(DataMigrationInitializer.INSTANCE.getInitializer(migrations)), corruptionHandler != null ? corruptionHandler : new NoOpCorruptionHandler(), scope);
    }
}
