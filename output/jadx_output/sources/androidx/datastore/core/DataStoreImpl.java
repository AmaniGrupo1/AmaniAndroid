...
public final class DataStoreImpl<T> implements CurrentDataProviderStore<T> {
    ...
    /* JADX INFO: renamed from: androidx.datastore.core.DataStoreImpl$currentData$1, reason: invalid class name */
    /* JADX INFO: compiled from: DataStoreImpl.kt */
    ...
    /* JADX INFO: renamed from: androidx.datastore.core.DataStoreImpl$decrementCollector$1, reason: invalid class name and case insensitive filesystem */
    /* JADX INFO: compiled from: DataStoreImpl.kt */
    @Metadata(k = 3, mv = {2, 0, 0}, xi = 48)
    @DebugMetadata(c = "androidx.datastore.core.DataStoreImpl", f = "DataStoreImpl.kt", i = {0}, l = {566}, m = "decrementCollector", n = {"$this$withLock_u24default$iv"}, s = {"L$0"}, v = 1)
    static final class C05901 extends ContinuationImpl {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C05901(DataStoreImpl<T> dataStoreImpl, Continuation<? super C05901> continuation) {
            super(continuation);
            this.this$0 = dataStoreImpl;
        }
    ...
    static final class C05911 extends ContinuationImpl {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C05911(DataStoreImpl<T> dataStoreImpl, Continuation<? super C05911> continuation) {
            super(continuation);
            this.this$0 = dataStoreImpl;
        }
    ...
    static final class C05921 extends ContinuationImpl {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C05921(DataStoreImpl<T> dataStoreImpl, Continuation<? super C05921> continuation) {
            super(continuation);
            this.this$0 = dataStoreImpl;
        }
    ...
    static final class C05931 extends ContinuationImpl {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C05931(DataStoreImpl<T> dataStoreImpl, Continuation<? super C05931> continuation) {
            super(continuation);
            this.this$0 = dataStoreImpl;
        }
    ...
    static final class C05941 extends ContinuationImpl {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C05941(DataStoreImpl<T> dataStoreImpl, Continuation<? super C05941> continuation) {
            super(continuation);
            this.this$0 = dataStoreImpl;
        }
    ...
    static final class C05951 extends ContinuationImpl {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C05951(DataStoreImpl<T> dataStoreImpl, Continuation<? super C05951> continuation) {
            super(continuation);
            this.this$0 = dataStoreImpl;
        }
    ...
    public DataStoreImpl(Storage<T> storage, List<? extends Function2<? super InitializerApi<T>, ? super Continuation<? super Unit>, ? extends Object>> initTasksList, CorruptionHandler<T> corruptionHandler, CoroutineScope scope) {
        ...
        this.storageConnectionDelegate = LazyKt.lazy(new Function0() { // from class: androidx.datastore.core.DataStoreImpl$$ExternalSyntheticLambda0
            ...
            public final Object invoke() {
                return this.f$0.storage.createConnection();
            }
        });
        this.coordinator = LazyKt.lazy(new Function0() { // from class: androidx.datastore.core.DataStoreImpl$$ExternalSyntheticLambda1
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                return this.f$0.getStorageConnection$datastore_core().getCoordinator();
            }
        });
        this.writeActor = new SimpleActor<>(this.scope, new Function1() { // from class: androidx.datastore.core.DataStoreImpl$$ExternalSyntheticLambda2
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return DataStoreImpl.writeActor$lambda$0(this.f$0, (Throwable) obj);
            }
    ...
    public Object currentData(Continuation<? super T> continuation) throws Throwable {
        ...
        switch (anonymousClass1.label) {
            case 0:
                ...
                state = readState(false, anonymousClass1);
        ...
        State startState = (State) state;
        if (startState instanceof Data) {
            return ((Data) startState).getValue();
        }
        if (startState instanceof UnInitialized) {
            throw new IllegalStateException(BUG_MESSAGE.toString());
        }
        if (startState instanceof ReadException) {
            throw ((ReadException) startState).getReadException();
        }
        if (startState instanceof Final) {
            throw ((Final) startState).getFinalException();
        }
        if (startState instanceof NoValueDataState) {
            throw new IllegalStateException(BUG_MESSAGE.toString());
        }
    ...
    public final Object incrementCollector(Continuation<? super Unit> continuation) {
        ...
        if (continuation instanceof C05921) {
            ...
            if ((c05921.label & Integer.MIN_VALUE) != 0) {
                ...
                c05921 = new C05921(this, continuation);
            }
        }
        C05921 c059212 = c05921;
        Object $result = c059212.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        switch (c059212.label) {
            case 0:
                ResultKt.throwOnFailure($result);
                $this$withLock_u24default$iv = this.collectorMutex;
                owner$iv = null;
                c059212.L$0 = $this$withLock_u24default$iv;
                c059212.label = 1;
                if ($this$withLock_u24default$iv.lock(null, c059212) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                dataStoreImpl = this;
                break;
            ...
            case 1:
                dataStoreImpl = this;
                owner$iv = null;
                $this$withLock_u24default$iv = (Mutex) c059212.L$0;
                ResultKt.throwOnFailure($result);
                break;
            default:
                throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
    ...
    */
    public final Object decrementCollector(Continuation<? super Unit> continuation) {
        ...
        if (continuation instanceof C05901) {
            ...
            if ((c05901.label & Integer.MIN_VALUE) != 0) {
                ...
                c05901 = new C05901(this, continuation);
            }
        }
        Object $result = c05901.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        switch (c05901.label) {
            case 0:
                ResultKt.throwOnFailure($result);
                $this$withLock_u24default$iv = this.collectorMutex;
                owner$iv = null;
                c05901.L$0 = $this$withLock_u24default$iv;
                c05901.label = 1;
                if ($this$withLock_u24default$iv.lock(null, c05901) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                dataStoreImpl = this;
                break;
            ...
            case 1:
                dataStoreImpl = this;
                owner$iv = null;
                $this$withLock_u24default$iv = (Mutex) c05901.L$0;
                ResultKt.throwOnFailure($result);
                break;
            default:
                throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
    ...
    public Object updateData(Function2<? super T, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        ...
        return BuildersKt.withContext(childContextElement, new C06002(this, function2, null), continuation);
    }
    ...
    static final class C06002 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super T>, Object> {
        ...
        C06002(DataStoreImpl<T> dataStoreImpl, Function2<? super T, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super C06002> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C06002 c06002 = new C06002(this.this$0, this.$transform, continuation);
            c06002.L$0 = obj;
            return c06002;
        }
        ...
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super T> continuation) {
            return ((C06002) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    Message.Update updateMsg = new Message.Update(this.$transform, ack, currentState, $this$withContext.getCoroutineContext());
                    ((DataStoreImpl) this.this$0).writeActor.offer(updateMsg);
                    this.label = 1;
                    Object objAwait = ack.await(this);
    ...
    static final Unit writeActor$lambda$0(DataStoreImpl this$0, Throwable it) {
        if (it != null) {
            this$0.inMemoryCache.tryUpdate(new Final(it));
        }
        if (this$0.storageConnectionDelegate.isInitialized()) {
            this$0.getStorageConnection$datastore_core().close();
        }
        return Unit.INSTANCE;
    }

    static final Unit writeActor$lambda$1(Message.Update msg, Throwable ex) {
        ...
        ack.completeExceptionally(cancellationException);
        return Unit.INSTANCE;
    }
    ...
    @DebugMetadata(c = "androidx.datastore.core.DataStoreImpl$readState$2", f = "DataStoreImpl.kt", i = {}, l = {232, PsExtractor.VIDEO_STREAM_MASK}, m = "invokeSuspend", n = {}, s = {}, v = 1)
    static final class C05982 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super State<T>>, Object> {
        final /* synthetic */ boolean $requireLock;
        int label;
        final /* synthetic */ DataStoreImpl<T> this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C05982(DataStoreImpl<T> dataStoreImpl, boolean z, Continuation<? super C05982> continuation) {
            super(2, continuation);
            this.this$0 = dataStoreImpl;
            this.$requireLock = z;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C05982(this.this$0, this.$requireLock, continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super State<T>> continuation) {
            return ((C05982) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
            ...
            try {
                switch (this.label) {
                    case 0:
                        ...
                        this.label = 2;
                        dataAndUpdateCache = this.this$0.readDataAndUpdateCache(this.$requireLock, this);
                        if (dataAndUpdateCache != coroutine_suspended) {
                            return coroutine_suspended;
                        }
                        $result2 = $result;
                        $result = dataAndUpdateCache;
                        return (State) $result;
                    case 1:
                        ResultKt.throwOnFailure($result);
                        this.label = 2;
    ...
    public final Object readState(boolean requireLock, Continuation<? super State<T>> continuation) {
        return BuildersKt.withContext(this.scope.getCoroutineContext(), new C05982(this, requireLock, null), continuation);
    }
    ...
    */
    public final Object handleUpdate(Message.Update<T> update, Continuation<? super Unit> continuation) {
        ...
        if (continuation instanceof C05911) {
            ...
            if ((c05911.label & Integer.MIN_VALUE) != 0) {
                c05911.label -= Integer.MIN_VALUE;
            } else {
                c05911 = new C05911(this, continuation);
            }
        }
        Object $result = c05911.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        switch (c05911.label) {
            case 0:
                ResultKt.throwOnFailure($result);
                ...
                try {
                    ...
                    CoroutineContext coroutineContextPlus = update.getCallerContext().plus(c05911.getContext());
                    DataStoreImpl$handleUpdate$2$1 dataStoreImpl$handleUpdate$2$1 = new DataStoreImpl$handleUpdate$2$1(this, update, null);
                    c05911.L$0 = ack;
                    c05911.label = 1;
                    objWithContext = BuildersKt.withContext(coroutineContextPlus, dataStoreImpl$handleUpdate$2$1, c05911);
                    break;
                } catch (Throwable th) {
                    th = th;
                ...
                completableDeferred = ack;
                objM8542constructorimpl = Result.m8542constructorimpl(objWithContext);
                CompletableDeferredKt.completeWith(completableDeferred, objM8542constructorimpl);
                return Unit.INSTANCE;
            case 1:
                completableDeferred = (CompletableDeferred) c05911.L$0;
                try {
                    ResultKt.throwOnFailure($result);
    ...
    */
    public final Object readAndInitOrPropagateAndThrowFailure(Continuation<? super Unit> continuation) throws Throwable {
        ...
        int preReadVersion2;
        if (continuation instanceof C05931) {
            c05931 = (C05931) continuation;
            if ((c05931.label & Integer.MIN_VALUE) != 0) {
                c05931.label -= Integer.MIN_VALUE;
            } else {
                c05931 = new C05931(this, continuation);
            }
        }
        Object $result = c05931.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        switch (c05931.label) {
            case 0:
                ResultKt.throwOnFailure($result);
                ...
                c05931.label = 1;
                version = coordinator.getVersion(c05931);
                ...
                try {
                    ...
                    c05931.I$0 = preReadVersion;
                    c05931.label = 2;
                    return initDataStore.runIfNeeded(c05931) != coroutine_suspended ? coroutine_suspended : Unit.INSTANCE;
                } catch (Throwable th) {
                    throwable = th;
                    dataStoreImpl2 = dataStoreImpl;
                    preReadVersion2 = preReadVersion;
                    dataStoreImpl2.inMemoryCache.tryUpdate(new ReadException(throwable, preReadVersion2));
                    throw throwable;
                }
            case 1:
                dataStoreImpl = this;
                ...
                c05931.I$0 = preReadVersion;
                c05931.label = 2;
                if (initDataStore2.runIfNeeded(c05931) != coroutine_suspended) {
                }
                break;
            case 2:
                dataStoreImpl2 = this;
                preReadVersion2 = c05931.I$0;
                try {
                    ResultKt.throwOnFailure($result);
                } catch (Throwable th2) {
                    throwable = th2;
    ...
    */
    public final Object readDataAndUpdateCache(boolean requireLock, Continuation<? super State<T>> continuation) {
        ...
        if (continuation instanceof C05941) {
            ...
            if ((c05941.label & Integer.MIN_VALUE) != 0) {
                ...
                c05941 = new C05941(this, continuation);
            }
        }
        Object $result = c05941.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        switch (c05941.label) {
            case 0:
                ResultKt.throwOnFailure($result);
                ...
                c05941.L$0 = currentState;
                c05941.Z$0 = requireLock;
                c05941.label = 1;
                version = coordinator.getVersion(c05941);
                if (version == coroutine_suspended) {
                    return coroutine_suspended;
                }
                ...
                int cachedVersion = !(currentState instanceof Data) ? ((Data) currentState).getVersion() : -1;
                ...
                if (requireLock2) {
                    ...
                    AnonymousClass4 anonymousClass4 = new AnonymousClass4(dataStoreImpl, cachedVersion, null);
                    c05941.L$0 = null;
                    c05941.label = 3;
                    objTryLock = coordinator2.tryLock(anonymousClass4, c05941);
                ...
                AnonymousClass3 anonymousClass3 = new AnonymousClass3(dataStoreImpl, null);
                c05941.L$0 = null;
                c05941.label = 2;
                objLock = coordinator3.lock(anonymousClass3, c05941);
            ...
            case 1:
                dataStoreImpl = this;
                requireLock2 = c05941.Z$0;
                currentState = (State) c05941.L$0;
                ResultKt.throwOnFailure($result);
                version = $result;
    ...
    /* JADX INFO: renamed from: androidx.datastore.core.DataStoreImpl$readDataAndUpdateCache$3, reason: invalid class name */
    /* JADX INFO: compiled from: DataStoreImpl.kt */
    ...
    static final class AnonymousClass3 extends SuspendLambda implements Function1<Continuation<? super Pair<? extends State<T>, ? extends Boolean>>, Object> {
        Object L$0;
        int label;
        final /* synthetic */ DataStoreImpl<T> this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        AnonymousClass3(DataStoreImpl<T> dataStoreImpl, Continuation<? super AnonymousClass3> continuation) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    try {
                        ...
                        $result2 = $result;
                        $result = version;
                        $result = new ReadException(ex, ((Number) $result).intValue());
                    }
                    return TuplesKt.to($result, Boxing.boxBoolean(true));
                case 1:
                    ResultKt.throwOnFailure($result);
                    $result3 = $result;
                    $result = (State) $result;
    ...
    static final class AnonymousClass4 extends SuspendLambda implements Function2<Boolean, Continuation<? super Pair<? extends State<T>, ? extends Boolean>>, Object> {
        ...
        /* JADX WARN: Type inference failed for: r10v17, types: [androidx.datastore.core.State] */
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            switch (r12) {
                case 0:
                    ...
                    this.Z$0 = z3;
                    this.label = 1;
                    Object dataOrHandleCorruption = dataStoreImpl.readDataOrHandleCorruption(z4, this);
                    if (dataOrHandleCorruption == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    r12 = obj;
                    r103 = dataOrHandleCorruption;
                    z2 = z3;
                    try {
                        obj = (State) r103;
                        r102 = obj;
                        ...
                        if (r12 != 0) {
                            ...
                            z = r12 == true ? 1 : 0 ? 1 : 0;
                            ReadException readException2 = new ReadException(th, iIntValue);
                            z2 = z;
                            r102 = readException2;
                        }
                    }
                    return TuplesKt.to(r102, Boxing.boxBoolean(z2));
                case 1:
                    boolean z6 = this.Z$0;
                    ResultKt.throwOnFailure(obj);
                    z2 = z6;
                ...
                case 2:
                    ...
                    iIntValue = ((Number) r10).intValue();
                    z = r1 == true ? 1 : 0;
                    ReadException readException22 = new ReadException(th, iIntValue);
                    z2 = z;
                    r102 = readException22;
                    return TuplesKt.to(r102, Boxing.boxBoolean(z2));
                default:
                    throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
            }
    ...
    static final class C05992 extends SuspendLambda implements Function1<Continuation<? super T>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C05992(DataStoreImpl<T> dataStoreImpl, CoroutineContext coroutineContext, Function2<? super T, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super C05992> continuation) {
            super(1, continuation);
            this.this$0 = dataStoreImpl;
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Continuation<?> continuation) {
            return new C05992(this.this$0, this.$callerContext, this.$transform, continuation);
        }

        @Override // kotlin.jvm.functions.Function1
        public final Object invoke(Continuation<? super T> continuation) {
            return ((C05992) create(continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object obj) throws CorruptionException {
            ...
            switch (this.label) {
                case 0:
                    ...
                    this.L$0 = data2;
                    this.label = 2;
                    objWithContext = BuildersKt.withContext(this.$callerContext, new DataStoreImpl$transformAndWrite$2$newData$1(this.$transform, data2, null), this);
                    if (objWithContext != coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    data = data2;
                    ...
                    this.L$0 = obj;
                    this.label = 3;
                    if (dataStoreImpl.writeData$datastore_core((T) obj, true, this) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    obj3 = obj;
                    obj = obj2;
                ...
                case 1:
                    ...
                    this.L$0 = data22;
                    this.label = 2;
                    objWithContext = BuildersKt.withContext(this.$callerContext, new DataStoreImpl$transformAndWrite$2$newData$1(this.$transform, data22, null), this);
                    if (objWithContext != coroutine_suspended) {
                    }
                    break;
                case 2:
    ...
    public final Object transformAndWrite(Function2<? super T, ? super Continuation<? super T>, ? extends Object> function2, CoroutineContext callerContext, Continuation<? super T> continuation) {
        return getCoordinator().lock(new C05992(this, callerContext, function2, null), continuation);
    }
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final Object writeData$datastore_core(T t, boolean updateCache, Continuation<? super Integer> continuation) {
        ...
        Object $result = dataStoreImpl$writeData$1.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        switch (dataStoreImpl$writeData$1.label) {
            case 0:
                ResultKt.throwOnFailure($result);
                Ref.IntRef newVersion2 = new Ref.IntRef();
                StorageConnection<T> storageConnection$datastore_core = getStorageConnection$datastore_core();
                DataStoreImpl$writeData$2 dataStoreImpl$writeData$2 = new DataStoreImpl$writeData$2(newVersion2, this, t, updateCache, null);
                dataStoreImpl$writeData$1.L$0 = newVersion2;
                ...
                break;
            case 1:
                newVersion = (Ref.IntRef) dataStoreImpl$writeData$1.L$0;
                ResultKt.throwOnFailure($result);
                break;
            default:
                throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Removed duplicated region for block: B:42:0x00a2 A[Catch: CorruptionException -> 0x0087, TRY_ENTER, TryCatch #2 {CorruptionException -> 0x0087, blocks: (B:19:0x005e, B:57:0x00fb, B:22:0x0067, B:54:0x00de, B:30:0x0082, B:42:0x00a2, B:44:0x00a8), top: B:87:0x0024 }] */
    ...
    /* JADX WARN: Type inference failed for: r12v0, types: [androidx.datastore.core.DataStoreImpl, androidx.datastore.core.DataStoreImpl<T>] */
    /* JADX WARN: Type inference failed for: r13v0, types: [boolean] */
    /* JADX WARN: Type inference failed for: r13v1, types: [androidx.datastore.core.DataStoreImpl] */
    /* JADX WARN: Type inference failed for: r13v10, types: [androidx.datastore.core.DataStoreImpl] */
    /* JADX WARN: Type inference failed for: r13v11 */
    /* JADX WARN: Type inference failed for: r13v12 */
    /* JADX WARN: Type inference failed for: r13v13 */
    /* JADX WARN: Type inference failed for: r13v14 */
    /* JADX WARN: Type inference failed for: r13v15, types: [androidx.datastore.core.DataStoreImpl] */
    /* JADX WARN: Type inference failed for: r13v16 */
    /* JADX WARN: Type inference failed for: r13v18 */
    /* JADX WARN: Type inference failed for: r13v2, types: [androidx.datastore.core.DataStoreImpl] */
    ...
    /* JADX WARN: Type update failed for variable: r12v0 'this'  ??, new type: androidx.datastore.core.DataStoreImpl<T>
    jadx.core.utils.exceptions.JadxOverflowException: Type inference error: updates count limit reached with updateSeq = 3721. Try increasing type updates limit count.
    ...
    */
    public final Object readDataOrHandleCorruption(boolean z, Continuation<? super Data<T>> continuation) throws CorruptionException {
        ...
        if (continuation instanceof C05951) {
            ...
            if ((c05951.label & Integer.MIN_VALUE) != 0) {
                ...
                c05951 = new C05951(this, continuation);
            }
        }
        Object obj2 = c05951.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        ?? r35 = c05951.label;
        try {
        ...
        switch (r35) {
            case 0:
                ...
                try {
                    if (z == 0) {
                        ...
                        c05951.Z$0 = z;
                        c05951.label = 3;
                        version = coordinator.getVersion(c05951);
                        if (version == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                        r32 = z;
                        ...
                        InterProcessCoordinator coordinator2 = r132.getCoordinator();
                        C05962 c05962 = new C05962(r132, iIntValue, null);
                        c05951.Z$0 = r32;
                        c05951.label = 4;
                        objTryLock = coordinator2.tryLock(c05962, c05951);
                        r34 = r32;
                        if (objTryLock == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                        return (Data) objTryLock;
                    }
                    c05951.Z$0 = z;
                    c05951.label = 1;
                    dataFromFileOrDefault = readDataFromFileOrDefault(c05951);
                    if (dataFromFileOrDefault == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    r33 = z;
                    r133 = this;
                    ...
                    InterProcessCoordinator coordinator3 = r133.getCoordinator();
                    c05951.L$0 = obj;
                    c05951.Z$0 = r33;
                    c05951.I$0 = iHashCode;
                    c05951.label = 2;
                    version2 = coordinator3.getVersion(c05951);
                    ...
                    CorruptionHandler<T> corruptionHandler = z.corruptionHandler;
                    c05951.L$0 = e;
                    c05951.L$1 = objectRef;
                    c05951.L$2 = objectRef;
                    c05951.Z$0 = r35;
                    c05951.label = 5;
                    objHandleCorruption = corruptionHandler.handleCorruption(e, c05951);
            ...
            case 1:
                r133 = this;
                boolean z3 = c05951.Z$0;
                ResultKt.throwOnFailure(obj2);
                dataFromFileOrDefault = obj2;
                r33 = z3;
                obj = dataFromFileOrDefault;
                if (obj == null) {
                }
                InterProcessCoordinator coordinator32 = r133.getCoordinator();
                c05951.L$0 = obj;
                c05951.Z$0 = r33;
                c05951.I$0 = iHashCode;
                c05951.label = 2;
                version2 = coordinator32.getVersion(c05951);
                if (version2 != coroutine_suspended) {
                }
                break;
            case 2:
                ...
                try {
                    ...
                    r35 = r11 == true ? 1 : 0;
                    objectRef = new Ref.ObjectRef();
                    CorruptionHandler<T> corruptionHandler2 = z.corruptionHandler;
                    c05951.L$0 = e;
                    c05951.L$1 = objectRef;
                    c05951.L$2 = objectRef;
                    c05951.Z$0 = r35;
                    c05951.label = 5;
                    objHandleCorruption = corruptionHandler2.handleCorruption(e, c05951);
                    if (objHandleCorruption != coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    t = (T) objHandleCorruption;
                    ...
                    try {
                        c05973 = new C05973(objectRef, r13, intRef2, null);
                        c05951.L$0 = e;
                        c05951.L$1 = objectRef;
                        c05951.L$2 = intRef2;
                        c05951.label = 6;
                        if (r13.doWithWriteFileLock(z2, c05973, c05951) != coroutine_suspended) {
                        }
                    } catch (Throwable th) {
                        th = th;
            ...
            case 3:
                r132 = this;
                boolean z4 = c05951.Z$0;
                ResultKt.throwOnFailure(obj2);
                version = obj2;
                r32 = z4;
                int iIntValue2 = ((Number) version).intValue();
                InterProcessCoordinator coordinator22 = r132.getCoordinator();
                C05962 c059622 = new C05962(r132, iIntValue2, null);
                c05951.Z$0 = r32;
                c05951.label = 4;
                objTryLock = coordinator22.tryLock(c059622, c05951);
                r34 = r32;
                if (objTryLock == coroutine_suspended) {
                }
                return (Data) objTryLock;
            case 4:
                boolean z5 = c05951.Z$0;
                ResultKt.throwOnFailure(obj2);
                objTryLock = obj2;
                r34 = z5;
                return (Data) objTryLock;
            case 5:
                r13 = this;
                boolean z6 = c05951.Z$0;
                Ref.ObjectRef objectRef4 = (Ref.ObjectRef) c05951.L$2;
                objectRef = (Ref.ObjectRef) c05951.L$1;
                CorruptionException corruptionException2 = (CorruptionException) c05951.L$0;
                ResultKt.throwOnFailure(obj2);
                objectRef2 = objectRef4;
                e = corruptionException2;
                t = (T) obj2;
                r3 = z6;
                objectRef2.element = t;
                Ref.IntRef intRef22 = new Ref.IntRef();
                z2 = r3 != 0;
                c05973 = new C05973(objectRef, r13, intRef22, null);
                c05951.L$0 = e;
                c05951.L$1 = objectRef;
                c05951.L$2 = intRef22;
                c05951.label = 6;
            ...
            case 6:
                intRef = (Ref.IntRef) c05951.L$2;
                objectRef3 = (Ref.ObjectRef) c05951.L$1;
                corruptionException = (CorruptionException) c05951.L$0;
                try {
                    ResultKt.throwOnFailure(obj2);
    ...
    /* JADX INFO: renamed from: androidx.datastore.core.DataStoreImpl$readDataOrHandleCorruption$2, reason: invalid class name and case insensitive filesystem */
    /* JADX INFO: compiled from: DataStoreImpl.kt */
    ...
    static final class C05962 extends SuspendLambda implements Function2<Boolean, Continuation<? super Data<T>>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C05962(DataStoreImpl<T> dataStoreImpl, int i, Continuation<? super C05962> continuation) {
            super(2, continuation);
            this.this$0 = dataStoreImpl;
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C05962 c05962 = new C05962(this.this$0, this.$preLockVersion, continuation);
            c05962.Z$0 = ((Boolean) obj).booleanValue();
            return c05962;
        }
        ...
        public final Object invoke(boolean z, Continuation<? super Data<T>> continuation) {
            return ((C05962) create(Boolean.valueOf(z), continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object data) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    this.Z$0 = locked2;
                    this.label = 1;
                    Object dataFromFileOrDefault = this.this$0.readDataFromFileOrDefault(this);
                    if (dataFromFileOrDefault == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    data = dataFromFileOrDefault;
                    locked = locked2;
                    if (locked) {
                        data2 = data;
                        version = this.$preLockVersion;
                        return new Data(data2, data2 != null ? data2.hashCode() : 0, version);
                    }
                    this.L$0 = data;
                    this.label = 2;
                    Object version2 = this.this$0.getCoordinator().getVersion(this);
                    if (version2 == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    data2 = data;
    ...
    @DebugMetadata(c = "androidx.datastore.core.DataStoreImpl$readDataOrHandleCorruption$3", f = "DataStoreImpl.kt", i = {}, l = {403, 404, 406}, m = "invokeSuspend", n = {}, s = {}, v = 1)
    static final class C05973 extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C05973(Ref.ObjectRef<T> objectRef, DataStoreImpl<T> dataStoreImpl, Ref.IntRef intRef, Continuation<? super C05973> continuation) {
            super(1, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Continuation<?> continuation) {
            return new C05973(this.$newData, this.this$0, this.$version, continuation);
        }

        @Override // kotlin.jvm.functions.Function1
        public final Object invoke(Continuation<? super Unit> continuation) {
            return ((C05973) create(continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        */
        public final Object invokeSuspend(Object obj) {
            ...
            switch (this.label) {
                case 0:
                    ResultKt.throwOnFailure(obj);
                    Ref.ObjectRef<T> objectRef2 = this.$newData;
                    this.L$0 = objectRef2;
                    this.label = 1;
                    Object dataFromFileOrDefault = this.this$0.readDataFromFileOrDefault(this);
                    if (dataFromFileOrDefault == coroutine_suspended) {
                    ...
                    try {
                        ...
                        this.L$0 = intRef;
                        this.label = 3;
                        Object objWriteData$datastore_core = this.this$0.writeData$datastore_core(this.$newData.element, true, this);
                        if (objWriteData$datastore_core == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                        obj2 = obj;
                        obj = (T) objWriteData$datastore_core;
                    ...
                    return Unit.INSTANCE;
                case 1:
                    Ref.ObjectRef<T> objectRef3 = (Ref.ObjectRef) this.L$0;
                    ResultKt.throwOnFailure(obj);
    ...
    public final <R> Object doWithWriteFileLock(boolean hasWriteFileLock, Function1<? super Continuation<? super R>, ? extends Object> function1, Continuation<? super R> continuation) {
        ...
        return getCoordinator().lock(new AnonymousClass2(function1, null), continuation);
    }

    /* JADX INFO: Add missing generic type declarations: [R] */
    /* JADX INFO: renamed from: androidx.datastore.core.DataStoreImpl$doWithWriteFileLock$2, reason: invalid class name */
    /* JADX INFO: compiled from: DataStoreImpl.kt */
    ...
    static final class AnonymousClass2<R> extends SuspendLambda implements Function1<Continuation<? super R>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        AnonymousClass2(Function1<? super Continuation<? super R>, ? extends Object> function1, Continuation<? super AnonymousClass2> continuation) {
            super(1, continuation);
    ...
    final class InitDataStore extends RunOnce {
        ...
        */
        protected Object doRun(Continuation<? super Unit> continuation) throws CorruptionException {
            ...
            Object $result = dataStoreImpl$InitDataStore$doRun$1.result;
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            switch (dataStoreImpl$InitDataStore$doRun$1.label) {
                case 0:
                    ResultKt.throwOnFailure($result);
                    if (this.initTasks != null) {
                        ...
                        if (!list.isEmpty()) {
                            ...
                            objLock = coordinator.lock(dataStoreImpl$InitDataStore$doRun$initData$1, dataStoreImpl$InitDataStore$doRun$1);
                            if (objLock != coroutine_suspended) {
                                initDataStore = this;
                                initData = (Data) objLock;
                            }
                        } else {
                            DataStoreImpl<T> dataStoreImpl = this.this$0;
                            ...
                            if (dataOrHandleCorruption != coroutine_suspended) {
                                initDataStore = this;
                                initData = (Data) dataOrHandleCorruption;
                            }
                        }
                        return coroutine_suspended;
                    }
