...
public final class MultiProcessDataStoreFactory {
    ...
    public final <T> DataStore<T> create(Serializer<T> serializer, ReplaceFileCorruptionHandler<T> corruptionHandler, List<? extends DataMigration<T>> migrations, final CoroutineScope scope, Function0<? extends File> produceFile) {
        ...
        Intrinsics.checkNotNullParameter(scope, "scope");
        Intrinsics.checkNotNullParameter(produceFile, "produceFile");
        return new DataStoreImpl(new FileStorage(serializer, new Function1() { // from class: androidx.datastore.core.MultiProcessDataStoreFactory$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return MultiProcessDataStoreFactory.create$lambda$0(scope, (File) obj);
            }
        }, produceFile), CollectionsKt.listOf(DataMigrationInitializer.INSTANCE.getInitializer(migrations)), corruptionHandler != null ? corruptionHandler : new NoOpCorruptionHandler(), scope);
    }

    static final InterProcessCoordinator create$lambda$0(CoroutineScope $scope, File it) {
