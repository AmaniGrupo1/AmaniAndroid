...
public interface SharedCounter {
    ...
    private static final class RealSharedCounter implements SharedCounter {
        private final long mappedAddress;
        private final NativeSharedCounter nativeSharedCounter;

        public RealSharedCounter(NativeSharedCounter nativeSharedCounter, long mappedAddress) {
    ...
    /* JADX INFO: compiled from: SharedCounter.android.kt */
    @Metadata(d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\u0002\b\u0002\u0018\u00002\u00020\u0001B\u0007¢\u0006\u0004\b\u0002\u0010\u0003J\b\u0010\u0006\u001a\u00020\u0007H\u0016J\b\u0010\b\u001a\u00020\u0007H\u0016R\u000e\u0010\u0004\u001a\u00020\u0005X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\t"}, d2 = {"Landroidx/datastore/core/SharedCounter$ShadowSharedCounter;", "Landroidx/datastore/core/SharedCounter;", "<init>", "()V", Values.VECTOR_MAP_VECTORS_KEY, "Ljava/util/concurrent/atomic/AtomicInteger;", "getValue", "", "incrementAndGetValue", "datastore-core"}, k = 1, mv = {2, 0, 0}, xi = 48)
    private static final class ShadowSharedCounter implements SharedCounter {
    ...
    public static final class Companion {
        ...
        private final SharedCounter createCounterFromFd(ParcelFileDescriptor pfd) throws IOException {
            ...
            long address = nativeSharedCounter.nativeCreateSharedCounter(nativeFd);
            if (address < 0) {
                throw new IOException("Failed to mmap counter file");
            }
            return new RealSharedCounter(nativeSharedCounter, address);
        }

        public final SharedCounter create$datastore_core(Function0<? extends File> produceFile) throws IOException {
            Intrinsics.checkNotNullParameter(produceFile, "produceFile");
            File file = produceFile.invoke();
            ParcelFileDescriptor pfd = null;
            try {
                pfd = ParcelFileDescriptor.open(file, 939524096);
                Intrinsics.checkNotNull(pfd);
