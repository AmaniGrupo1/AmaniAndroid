...
public final class FileStorage<T> implements Storage<T> {
    ...
    static final InterProcessCoordinator _init_$lambda$0(File it) {
    ...
    public StorageConnection<T> createConnection() throws IOException {
        ...
        return new FileStorageConnection(file, this.serializer, this.coordinatorProducer.invoke(file), new Function0() { // from class: androidx.datastore.core.FileStorage$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                return FileStorage.createConnection$lambda$1(file);
            }
        });
    }

    static final Unit createConnection$lambda$1(File $file) {
        synchronized (activeFilesLock) {
