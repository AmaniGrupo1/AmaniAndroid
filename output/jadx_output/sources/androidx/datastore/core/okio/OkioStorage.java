...
public final class OkioStorage<T> implements Storage<T> {
    ...
    public OkioStorage(FileSystem fileSystem, OkioSerializer<T> serializer, Function2<? super Path, ? super FileSystem, ? extends InterProcessCoordinator> coordinatorProducer, Function0<Path> producePath) {
        ...
        this.canonicalPath = LazyKt.lazy(new Function0() { // from class: androidx.datastore.core.okio.OkioStorage$$ExternalSyntheticLambda2
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                return OkioStorage.canonicalPath_delegate$lambda$0(this.f$0);
            }
        });
    }
    ...
    static final InterProcessCoordinator _init_$lambda$0(Path path, FileSystem fileSystem) {
    ...
    static final Path canonicalPath_delegate$lambda$0(OkioStorage this$0) {
        Path path = this$0.producePath.invoke();
        if (path.isAbsolute()) {
            return path.normalized();
        }
        throw new IllegalStateException(("OkioStorage requires absolute paths, but did not get an absolute path from producePath = " + this$0.producePath + ", instead got " + path).toString());
    }
    ...
    public StorageConnection<T> createConnection() {
        ...
        return new OkioStorageConnection(this.fileSystem, getCanonicalPath(), this.serializer, this.coordinatorProducer.invoke(getCanonicalPath(), this.fileSystem), new Function0() { // from class: androidx.datastore.core.okio.OkioStorage$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                return OkioStorage.createConnection$lambda$1(this.f$0);
            }
        });
    }

    static final Unit createConnection$lambda$1(OkioStorage this$0) {
        Synchronizer this_$iv = activeFilesLock;
        synchronized (this_$iv) {
            activeFiles.remove(this$0.getCanonicalPath().toString());
