...
public final class PreferenceDataStoreFactory {
    ...
    public final DataStore<Preferences> create(ReplaceFileCorruptionHandler<Preferences> corruptionHandler, List<? extends DataMigration<Preferences>> migrations, CoroutineScope scope, final Function0<? extends File> produceFile) {
        ...
        return new PreferenceDataStore(create(new FileStorage(PreferencesFileSerializer.INSTANCE, null, new Function0() { // from class: androidx.datastore.preferences.core.PreferenceDataStoreFactory$$ExternalSyntheticLambda0
            ...
            public final Object invoke() {
                return PreferenceDataStoreFactory.create$lambda$0(produceFile);
            }
        }, 2, null), corruptionHandler, migrations, scope));
    }

    static final File create$lambda$0(Function0 $produceFile) {
    ...
    public final DataStore<Preferences> createWithPath(ReplaceFileCorruptionHandler<Preferences> corruptionHandler, List<? extends DataMigration<Preferences>> migrations, CoroutineScope scope, final Function0<Path> produceFile) {
        ...
        return create(corruptionHandler, migrations, scope, new Function0() { // from class: androidx.datastore.preferences.core.PreferenceDataStoreFactory$$ExternalSyntheticLambda1
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                return ((Path) produceFile.invoke()).toFile();
            }
        });
    }
}
