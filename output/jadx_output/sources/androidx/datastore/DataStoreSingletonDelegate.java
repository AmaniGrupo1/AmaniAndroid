...
public final class DataStoreSingletonDelegate<T> implements ReadOnlyProperty<Context, DataStore<T>> {
    ...
    public DataStoreSingletonDelegate(String fileName, OkioSerializer<T> serializer, ReplaceFileCorruptionHandler<T> replaceFileCorruptionHandler, Function1<? super Context, ? extends List<? extends DataMigration<T>>> produceMigrations, CoroutineScope scope, boolean createInDeviceProtectedStorage) {
        ...
        this.scope = scope;
        this.createInDeviceProtectedStorage = createInDeviceProtectedStorage;
            ...
            if (this.INSTANCE == null) {
                ...
                OkioStorage okioStorage = new OkioStorage(FileSystem.SYSTEM, this.serializer, null, new Function0() { // from class: androidx.datastore.DataStoreSingletonDelegate$$ExternalSyntheticLambda0
                    ...
                    public final Object invoke() {
                        return DataStoreSingletonDelegate.getValue$lambda$0$0(this.f$0, applicationContext);
                    }
                }, 4, null);
    ...
    public static final Path getValue$lambda$0$0(DataStoreSingletonDelegate this$0, Context $applicationContext) {
        File fileDataStoreFile;
        Path.Companion companion = Path.INSTANCE;
        if (this$0.createInDeviceProtectedStorage) {
            Intrinsics.checkNotNull($applicationContext);
            fileDataStoreFile = DeviceProtectedDataStoreFile.deviceProtectedDataStoreFile($applicationContext, this$0.fileName);
        } else {
            Intrinsics.checkNotNull($applicationContext);
            fileDataStoreFile = DataStoreFile.dataStoreFile($applicationContext, this$0.fileName);
        }
        String absolutePath = fileDataStoreFile.getAbsolutePath();
