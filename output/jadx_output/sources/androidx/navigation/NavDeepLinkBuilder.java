...
public final class NavDeepLinkBuilder {
    ...
    public final TaskStackBuilder createTaskStackBuilder() throws PackageManager.NameNotFoundException {
        if (this.graph == null) {
    ...
    public final PendingIntent createPendingIntent() {
        ...
        if ($this$read$iv != null) {
            Bundle $this$createPendingIntent_u24lambda_u245 = SavedStateReader.m8071constructorimpl($this$read$iv);
            requestCode = SavedStateReader.m8074contentDeepHashCodeimpl($this$createPendingIntent_u24lambda_u245);
        } else {
            requestCode = 0;
        }
        for (DeepLinkDestination destination : this.destinations) {
            ...
            if ($this$read$iv2 == null) {
                ...
                Bundle $this$createPendingIntent_u24lambda_u246 = SavedStateReader.m8071constructorimpl($this$read$iv2);
                argumentsHashCode = Integer.valueOf(SavedStateReader.m8074contentDeepHashCodeimpl($this$createPendingIntent_u24lambda_u246));
            }
