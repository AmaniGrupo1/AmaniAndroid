...
public final class NavBackStackEntryStateImpl {
    ...
    public NavBackStackEntryStateImpl(Bundle state) {
        ...
        Bundle $this$_init__u24lambda_u240 = SavedStateReader.m8071constructorimpl(state);
        this.id = SavedStateReader.m8142getStringimpl($this$_init__u24lambda_u240, KEY_ID);
        Bundle $this$_init__u24lambda_u241 = SavedStateReader.m8071constructorimpl(state);
        this.destinationId = SavedStateReader.m8102getIntimpl($this$_init__u24lambda_u241, KEY_DESTINATION_ID);
        Bundle $this$_init__u24lambda_u242 = SavedStateReader.m8071constructorimpl(state);
        this.args = SavedStateReader.m8128getSavedStateimpl($this$_init__u24lambda_u242, KEY_ARGS);
        Bundle $this$_init__u24lambda_u243 = SavedStateReader.m8071constructorimpl(state);
        this.savedState = SavedStateReader.m8128getSavedStateimpl($this$_init__u24lambda_u243, KEY_SAVED_STATE);
    }
    ...
    public final Bundle writeToState$navigation_runtime_release() {
        ...
        Bundle $this$savedState_u24lambda_u241$iv = BundleKt.bundleOf((Pair[]) Arrays.copyOf(pairs$iv, pairs$iv.length));
        Bundle $this$writeToState_u24lambda_u244 = SavedStateWriter.m8157constructorimpl($this$savedState_u24lambda_u241$iv);
        SavedStateWriter.m8190putStringimpl($this$writeToState_u24lambda_u244, KEY_ID, this.id);
        SavedStateWriter.m8174putIntimpl($this$writeToState_u24lambda_u244, KEY_DESTINATION_ID, this.destinationId);
        ...
        SavedStateWriter.m8184putSavedStateimpl($this$writeToState_u24lambda_u244, KEY_ARGS, bundle);
        SavedStateWriter.m8184putSavedStateimpl($this$writeToState_u24lambda_u244, KEY_SAVED_STATE, this.savedState);
