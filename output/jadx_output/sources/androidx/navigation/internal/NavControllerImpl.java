...
public final class NavControllerImpl {
    ...
    */
    public final List<NavBackStackEntry> populateVisibleEntries$navigation_runtime_release() {
        ...
        for (Object element$iv : $this$forEach$iv2) {
            ...
            for (Object element$iv$iv : $this$filter$iv) {
                ...
                if (entries.contains(entry)) {
                    ...
                    $this$forEach$iv = $this$forEach$iv2;
                    $i$f$forEach = $i$f$forEach2;
                    z = entry.getMaxLifecycle().isAtLeast(Lifecycle.State.STARTED) ? false : true;
                    if (!z) {
        ...
        List list2 = entries;
        Iterable $this$filter$iv2 = this.backQueue;
    ...
    public final void onGraphCreated$navigation_runtime_release(Bundle startDestinationArgs) {
        ...
        if ($this$read$iv != null) {
            Bundle $this$onGraphCreated_u24lambda_u2434 = SavedStateReader.m8071constructorimpl($this$read$iv);
            if (SavedStateReader.m8072containsimpl($this$onGraphCreated_u24lambda_u2434, KEY_NAVIGATOR_STATE_NAMES)) {
                for (String name : SavedStateReader.m8145getStringListimpl($this$onGraphCreated_u24lambda_u2434, KEY_NAVIGATOR_STATE_NAMES)) {
                    Navigator navigator = this._navigatorProvider.getNavigator(name);
                    if (SavedStateReader.m8072containsimpl($this$onGraphCreated_u24lambda_u2434, name)) {
                        Bundle savedState = SavedStateReader.m8128getSavedStateimpl($this$onGraphCreated_u24lambda_u2434, name);
    ...
    */
    public final void navigate$navigation_runtime_release(final NavDestination node, Bundle args, NavOptions navOptions, Navigator.Extras navigatorExtras) {
        ...
        if (navOptions != null) {
            if (navOptions.getPopUpToRoute() != null) {
                ...
                boolean popped2 = popBackStackInternal$navigation_runtime_release(popUpToRoute, navOptions.getPopUpToInclusive(), navOptions.getPopUpToSaveState());
                popped = popped2;
                ...
                boolean popped3 = popBackStackInternal$navigation_runtime_release(RouteSerializerKt.generateHashCode(SerializersKt.serializer(popUpToRouteClass)), navOptions.getPopUpToInclusive(), navOptions.getPopUpToSaveState());
                popped = popped3;
                ...
                boolean popped4 = popBackStackInternal$navigation_runtime_release(popUpToRouteObject, navOptions.getPopUpToInclusive(), navOptions.getPopUpToSaveState());
                popped = popped4;
            } else if (navOptions.getPopUpToId() != -1) {
                boolean popped5 = popBackStackInternal$navigation_runtime_release(navOptions.getPopUpToId(), navOptions.getPopUpToInclusive(), navOptions.getPopUpToSaveState());
                popped = popped5;
            }
        } else {
            popped = false;
        ...
        if ((navOptions != null && navOptions.getRestoreState()) && this.backStackMap.containsKey(Integer.valueOf(node.getId()))) {
            ...
            boolean launchSingleTop2 = (navOptions != null && navOptions.getSingleTop()) && launchSingleTopInternal(node, args);
            if (!launchSingleTop2) {
                NavBackStackEntry backStackEntry = NavBackStackEntry.Companion.create$default(NavBackStackEntry.INSTANCE, getNavContext(), node, finalArgs, getHostLifecycleState$navigation_runtime_release(), this.viewModel, null, null, 96, null);
                navigateInternal$navigation_runtime_release(this._navigatorProvider.getNavigator(node.getNavigatorName()), CollectionsKt.listOf(backStackEntry), navOptions, navigatorExtras, new Function1() { // from class: androidx.navigation.internal.NavControllerImpl$$ExternalSyntheticLambda1
                    @Override // kotlin.jvm.functions.Function1
                    public final Object invoke(Object obj) {
                        return NavControllerImpl.navigate$lambda$44(navigated, this, node, finalArgs, (NavBackStackEntry) obj);
                    }
                });
            }
            launchSingleTop = launchSingleTop2;
        }
        this.updateOnBackPressedCallbackEnabledCallback.invoke();
        Iterable $this$forEach$iv2 = this.navigatorState.values();
        for (Object element$iv2 : $this$forEach$iv2) {
    ...
    private final void addEntryToBackStack(NavDestination node, Bundle finalArgs, NavBackStackEntry backStackEntry, List<NavBackStackEntry> restoredEntries) {
        ...
        while (destination3 != null && findDestination$navigation_runtime_release(destination3.getId(), destination3) != destination3) {
            ...
            if (parent3 != null) {
                boolean z = false;
                if (bundle != null) {
                    Bundle $this$addEntryToBackStack_u24lambda_u2461 = SavedStateReader.m8071constructorimpl(finalArgs);
                    if (SavedStateReader.m8149isEmptyimpl($this$addEntryToBackStack_u24lambda_u2461)) {
                        z = true;
                    }
                }
    ...
    public final Bundle saveState$navigation_runtime_release() {
        ...
        SavedStateWriter.m8157constructorimpl(navigatorState);
        for (Map.Entry<String, Navigator<? extends NavDestination>> entry : this._navigatorProvider.getNavigators().entrySet()) {
            ...
            if (savedState != null) {
                ...
                Bundle $this$saveState_u24lambda_u2468 = SavedStateWriter.m8157constructorimpl(navigatorState);
                SavedStateWriter.m8184putSavedStateimpl($this$saveState_u24lambda_u2468, name, savedState);
            }
        }
        if (!navigatorNames.isEmpty()) {
            ...
            Bundle $this$saveState_u24lambda_u2470 = SavedStateWriter.m8157constructorimpl($this$savedState_u24lambda_u241$iv);
            Bundle $this$saveState_u24lambda_u2470_u24lambda_u2469 = SavedStateWriter.m8157constructorimpl(navigatorState);
            SavedStateWriter.m8192putStringListimpl($this$saveState_u24lambda_u2470_u24lambda_u2469, KEY_NAVIGATOR_STATE_NAMES, navigatorNames);
            SavedStateWriter.m8184putSavedStateimpl($this$saveState_u24lambda_u2470, KEY_NAVIGATOR_STATE, navigatorState);
        ...
        if (!this.backQueue.isEmpty()) {
            if (b == null) {
                ...
                SavedStateWriter.m8157constructorimpl($this$savedState_u24lambda_u241$iv2);
            ...
            Bundle $this$saveState_u24lambda_u2471 = SavedStateWriter.m8157constructorimpl($this$write$iv);
            SavedStateWriter.m8186putSavedStateListimpl($this$saveState_u24lambda_u2471, KEY_BACK_STACK, backStack);
        }
        if (!this.backStackMap.isEmpty()) {
            if (b == null) {
                ...
                SavedStateWriter.m8157constructorimpl($this$savedState_u24lambda_u241$iv3);
            ...
            Bundle $this$saveState_u24lambda_u2472 = SavedStateWriter.m8157constructorimpl($this$write$iv2);
            SavedStateWriter.m8175putIntArrayimpl($this$saveState_u24lambda_u2472, KEY_BACK_STACK_DEST_IDS, backStackDestIds);
            SavedStateWriter.m8192putStringListimpl($this$saveState_u24lambda_u2472, KEY_BACK_STACK_IDS, backStackIds);
        }
        if (!this.backStackStates.isEmpty()) {
            if (b == null) {
                ...
                SavedStateWriter.m8157constructorimpl($this$savedState_u24lambda_u241$iv4);
            ...
            for (Map.Entry<String, ArrayDeque<NavBackStackEntryState>> entry3 : this.backStackStates.entrySet()) {
                ...
                Bundle $this$saveState_u24lambda_u2474 = SavedStateWriter.m8157constructorimpl($this$write$iv3);
                SavedStateWriter.m8186putSavedStateListimpl($this$saveState_u24lambda_u2474, KEY_BACK_STACK_STATES_PREFIX + id2, states);
            }
            Bundle $this$write$iv4 = b;
            Bundle $this$saveState_u24lambda_u2475 = SavedStateWriter.m8157constructorimpl($this$write$iv4);
            SavedStateWriter.m8192putStringListimpl($this$saveState_u24lambda_u2475, KEY_BACK_STACK_STATES_IDS, backStackStateIds);
        }
        return b;
    }

    public final void restoreState$navigation_runtime_release(Bundle navState) {
        Bundle bundleM8128getSavedStateimpl;
        Bundle[] bundleArr;
        String str;
        NavControllerImpl navControllerImpl = this;
        if (navState == null) {
        ...
        int $i$f$read = 0;
        Bundle $this$restoreState_u24lambda_u2479 = SavedStateReader.m8071constructorimpl($this$read$iv);
        int i = 0;
        if (SavedStateReader.m8072containsimpl($this$restoreState_u24lambda_u2479, KEY_NAVIGATOR_STATE)) {
            bundleM8128getSavedStateimpl = SavedStateReader.m8128getSavedStateimpl($this$restoreState_u24lambda_u2479, KEY_NAVIGATOR_STATE);
        } else {
            bundleM8128getSavedStateimpl = null;
        }
        navControllerImpl.navigatorStateToRestore = bundleM8128getSavedStateimpl;
        int i2 = 0;
        if (SavedStateReader.m8072containsimpl($this$restoreState_u24lambda_u2479, KEY_BACK_STACK)) {
            Collection $this$toTypedArray$iv = SavedStateReader.m8131getSavedStateListimpl($this$restoreState_u24lambda_u2479, KEY_BACK_STACK);
        ...
        if (SavedStateReader.m8072containsimpl($this$restoreState_u24lambda_u2479, KEY_BACK_STACK_DEST_IDS) && SavedStateReader.m8072containsimpl($this$restoreState_u24lambda_u2479, KEY_BACK_STACK_IDS)) {
            int[] backStackDestIds = SavedStateReader.m8103getIntArrayimpl($this$restoreState_u24lambda_u2479, KEY_BACK_STACK_DEST_IDS);
            List<String> listM8145getStringListimpl = SavedStateReader.m8145getStringListimpl($this$restoreState_u24lambda_u2479, KEY_BACK_STACK_IDS);
            int index$iv = 0;
            ...
            while (i2 < length) {
                ...
                int i3 = i;
                if (!Intrinsics.areEqual(listM8145getStringListimpl.get(index$iv), "")) {
                    str = listM8145getStringListimpl.get(index$iv);
                } else {
                    str = null;
                }
        ...
        if (SavedStateReader.m8072containsimpl($this$restoreState_u24lambda_u2479, KEY_BACK_STACK_STATES_IDS)) {
            Iterable $this$forEach$iv = SavedStateReader.m8145getStringListimpl($this$restoreState_u24lambda_u2479, KEY_BACK_STACK_STATES_IDS);
            for (Object element$iv : $this$forEach$iv) {
                String id = (String) element$iv;
                if (SavedStateReader.m8072containsimpl($this$restoreState_u24lambda_u2479, KEY_BACK_STACK_STATES_PREFIX + id)) {
                    List<Bundle> listM8131getSavedStateListimpl = SavedStateReader.m8131getSavedStateListimpl($this$restoreState_u24lambda_u2479, KEY_BACK_STACK_STATES_PREFIX + id);
                    Map<String, ArrayDeque<NavBackStackEntryState>> map2 = navControllerImpl.backStackStates;
                    ArrayDeque<NavBackStackEntryState> arrayDeque = new ArrayDeque<>(listM8131getSavedStateListimpl.size());
                    for (Bundle savedState : listM8131getSavedStateListimpl) {
    ...
    public final void setLifecycleOwner$navigation_runtime_release(LifecycleOwner owner) {
        ...
        if (lifecycleOwner != null && (lifecycleRegistry = lifecycleOwner.getLifecycle()) != null) {
