...
public final class FloatListNavType extends CollectionNavType<List<? extends Float>> {
    ...
    public void put(Bundle bundle, String key, List<Float> value) {
        ...
        if (value != null) {
            SavedStateWriter.m8173putFloatArrayimpl($this$put_u24lambda_u240, key, CollectionsKt.toFloatArray(value));
        } else {
    ...
    public List<Float> get(Bundle bundle, String key) {
        ...
        return ArraysKt.toList(SavedStateReader.m8099getFloatArrayimpl($this$get_u24lambda_u241, key));
    }
