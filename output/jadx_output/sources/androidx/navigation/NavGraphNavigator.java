...
public class NavGraphNavigator extends Navigator<NavGraph> {
    ...
    */
        ...
        if (startRoute != null) {
            if (!Intrinsics.areEqual(startRoute, startDestination.getRoute())) {
                ...
                if (matchingArgs != null) {
                    ...
                    Bundle $this$navigate_u24lambda_u242 = SavedStateReader.m8071constructorimpl($this$read$iv);
                    if (!SavedStateReader.m8149isEmptyimpl($this$navigate_u24lambda_u242)) {
                        ...
                        Bundle $this$navigate_u24lambda_u244 = SavedStateWriter.m8157constructorimpl(BundleOf);
                        SavedStateWriter.m8161putAllimpl($this$navigate_u24lambda_u244, matchingArgs);
                        Bundle it = (Bundle) args.element;
                        if (it != null) {
                            SavedStateWriter.m8161putAllimpl($this$navigate_u24lambda_u244, it);
                        }
            ...
            if (!startDestination.getArguments().isEmpty()) {
                List<String> listMissingRequiredArguments = NavArgumentKt.missingRequiredArguments(startDestination.getArguments(), new Function1() { // from class: androidx.navigation.NavGraphNavigator$$ExternalSyntheticLambda0
                    @Override // kotlin.jvm.functions.Function1
                    public final Object invoke(Object obj) {
                        return Boolean.valueOf(NavGraphNavigator.navigate$lambda$6(args, (String) obj));
                    }
                });
                if (!listMissingRequiredArguments.isEmpty()) {
                    throw new IllegalArgumentException(("Cannot navigate to startDestination " + startDestination + ". Missing required arguments [" + listMissingRequiredArguments + AbstractJsonLexerKt.END_LIST).toString());
                }
            }
        }
    ...
    static final boolean navigate$lambda$6(Ref.ObjectRef $args, String key) {
        ...
        Bundle $this$navigate_u24lambda_u246_u24lambda_u245 = SavedStateReader.m8071constructorimpl($this$read$iv);
        return !SavedStateReader.m8072containsimpl($this$navigate_u24lambda_u246_u24lambda_u245, key);
    }
}
