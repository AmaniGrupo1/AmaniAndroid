...
public class NavController {
    ...
    private final boolean tryRelaunchUpToExplicitStack() {
        ...
        Bundle $this$tryRelaunchUpToExplicitStack_u24lambda_u245 = SavedStateWriter.m8157constructorimpl($this$savedState_u24lambda_u241$iv);
        Intrinsics.checkNotNull(intent);
        SavedStateWriter.m8181putParcelableimpl($this$tryRelaunchUpToExplicitStack_u24lambda_u245, KEY_DEEP_LINK_INTENT, intent);
        Bundle it = extras.getBundle(KEY_DEEP_LINK_EXTRAS);
        if (it != null) {
            SavedStateWriter.m8161putAllimpl($this$tryRelaunchUpToExplicitStack_u24lambda_u245, it);
        }
    ...
    */
    private final boolean tryRelaunchUpToGeneratedStack() throws PackageManager.NameNotFoundException {
        Pair[] pairs$iv;
        NavGraph parent;
        ...
        while (parent2 != null) {
            if (parent2.getStartDestinationId() == destId) {
                NavGraph parent3 = parent2;
                destId = parent3.getId();
                ...
                Bundle $this$tryRelaunchUpToGeneratedStack_u24lambda_u248 = SavedStateWriter.m8157constructorimpl(args);
                if (this.activity != null) {
                    ...
                    if (activity.getIntent() != null) {
                        ...
                        if (data != null) {
                            ...
                            SavedStateWriter.m8181putParcelableimpl($this$tryRelaunchUpToGeneratedStack_u24lambda_u248, KEY_DEEP_LINK_INTENT, intent);
                            NavGraph currGraph = this.impl.getTopGraph$navigation_runtime_release();
                            Activity activity4 = this.activity;
                            Intrinsics.checkNotNull(activity4);
                            Intent intent2 = activity4.getIntent();
                            Intrinsics.checkNotNullExpressionValue(intent2, "getIntent(...)");
                            parent = parent2;
                            NavDestination.DeepLinkMatch matchingDeepLink = currGraph.matchDeepLinkComprehensive(NavControllerKt.NavDeepLinkRequest(intent2), true, true, currGraph);
                            if ((matchingDeepLink != null ? matchingDeepLink.getMatchingArgs() : null) != null && (destinationArgs = matchingDeepLink.getDestination().addInDefaultArgs(matchingDeepLink.getMatchingArgs())) != null) {
                                SavedStateWriter.m8161putAllimpl($this$tryRelaunchUpToGeneratedStack_u24lambda_u248, destinationArgs);
                            }
                        } else {
                            parent = parent2;
                        }
    ...
    */
    public boolean handleDeepLink(Intent intent) throws PackageManager.NameNotFoundException {
        ...
        if (extras2 == null) {
            ...
            try {
                deepLink = extras2.getIntArray(KEY_DEEP_LINK_IDS);
            } catch (Exception e) {
                Log.e(NavControllerImpl.TAG, "handleDeepLink() could not extract deepLink from " + intent, e);
                deepLink = null;
            }
        }
        ArrayList parcelableArrayList = extras2 != null ? extras2.getParcelableArrayList(KEY_DEEP_LINK_ARGS) : null;
        Map initialState$iv = MapsKt.emptyMap();
        if (initialState$iv.isEmpty()) {
            pairs$iv = new Pair[0];
        } else {
        ...
        Bundle globalArgs2 = BundleKt.bundleOf((Pair[]) Arrays.copyOf(pairs$iv, pairs$iv.length));
        SavedStateWriter.m8157constructorimpl(globalArgs2);
        Bundle deepLinkExtras2 = extras2 != null ? extras2.getBundle(KEY_DEEP_LINK_EXTRAS) : null;
        if (deepLinkExtras2 != null) {
            Bundle $this$handleDeepLink_u24lambda_u2411 = SavedStateWriter.m8157constructorimpl(globalArgs2);
            SavedStateWriter.m8161putAllimpl($this$handleDeepLink_u24lambda_u2411, deepLinkExtras2);
        }
        boolean z2 = true;
        if (deepLink != null) {
            ...
            NavGraph currGraph = this.impl.getTopGraph$navigation_runtime_release();
            NavDestination.DeepLinkMatch matchingDeepLink = currGraph.matchDeepLinkComprehensive(NavControllerKt.NavDeepLinkRequest(intent), true, true, currGraph);
            if (matchingDeepLink != null) {
                ...
                if (destinationArgs != null) {
                    Bundle $this$handleDeepLink_u24lambda_u2412 = SavedStateWriter.m8157constructorimpl(globalArgs2);
                    SavedStateWriter.m8161putAllimpl($this$handleDeepLink_u24lambda_u2412, destinationArgs);
                }
            }
        }
        if (deepLink != null) {
            ...
            if (invalidDestinationDisplayName != null) {
                androidx.navigation.internal.Log.INSTANCE.i(NavControllerImpl.TAG, "Could not find destination " + invalidDestinationDisplayName + " in the navigation graph, ignoring the deep link from " + intent);
                return false;
            }
            Bundle $this$handleDeepLink_u24lambda_u2413 = SavedStateWriter.m8157constructorimpl(globalArgs2);
            SavedStateWriter.m8181putParcelableimpl($this$handleDeepLink_u24lambda_u2413, KEY_DEEP_LINK_INTENT, intent);
            ...
            while (index < length) {
                ...
                if (initialState$iv2.isEmpty()) {
                    ...
                    extras = extras2;
                    deepLinkExtras = deepLinkExtras2;
                    z = z2;
                } else {
                    z = z2;
                    extras = extras2;
                    Collection destination$iv$iv$iv2 = new ArrayList(initialState$iv2.size());
                    Map $this$mapTo$iv$iv$iv = initialState$iv2;
                    for (Map.Entry item$iv$iv$iv2 : $this$mapTo$iv$iv$iv.entrySet()) {
                        Bundle deepLinkExtras3 = deepLinkExtras2;
                        ...
                        deepLinkExtras2 = deepLinkExtras3;
                    }
                    deepLinkExtras = deepLinkExtras2;
                ...
                Bundle $this$handleDeepLink_u24lambda_u2414 = SavedStateWriter.m8157constructorimpl($this$savedState_u24lambda_u241$iv);
                SavedStateWriter.m8161putAllimpl($this$handleDeepLink_u24lambda_u2414, globalArgs2);
                if (parcelableArrayList == null) {
                    globalArgs = globalArgs2;
                } else {
                    globalArgs = globalArgs2;
                    Bundle deepLinkArguments = (Bundle) parcelableArrayList.get(index);
                    if (deepLinkArguments != null) {
                        SavedStateWriter.m8161putAllimpl($this$handleDeepLink_u24lambda_u2414, deepLinkArguments);
                    }
                }
                args[index] = $this$savedState_u24lambda_u241$iv;
                index++;
                z2 = z;
                extras2 = extras;
                globalArgs2 = globalArgs;
                deepLinkExtras2 = deepLinkExtras;
            }
            boolean z3 = z2;
            int flags = intent.getFlags();
            if ((flags & 268435456) == 0 || (flags & 32768) != 0) {
                return handleDeepLink(deepLink, args, (268435456 & flags) != 0 ? z3 : false);
            }
    ...
    public final boolean handleDeepLink(NavDeepLinkRequest request) {
        ...
        if (matchingDeepLink2 != null) {
            ...
            Bundle $this$handleDeepLink_u24lambda_u2416 = SavedStateWriter.m8157constructorimpl(globalArgs);
            Bundle destinationArgs = destination.addInDefaultArgs(matchingDeepLink2.getMatchingArgs());
            if (destinationArgs != null) {
                SavedStateWriter.m8161putAllimpl($this$handleDeepLink_u24lambda_u2416, destinationArgs);
            }
            Bundle[] args = new Bundle[deepLink.length];
            int index = 0;
            int length = args.length;
            while (index < length) {
                ...
                Bundle $this$handleDeepLink_u24lambda_u2417 = SavedStateWriter.m8157constructorimpl(arguments);
                SavedStateWriter.m8161putAllimpl($this$handleDeepLink_u24lambda_u2417, globalArgs);
    ...
    public void navigate(int resId, Bundle args, NavOptions navOptions, Navigator.Extras navigatorExtras) {
        ...
        if (navAction != null) {
            ...
            if (navActionArgs != null) {
                ...
                Bundle $this$savedState_u24lambda_u241$iv = BundleKt.bundleOf((Pair[]) Arrays.copyOf(pairs$iv2, pairs$iv2.length));
                Bundle $this$navigate_u24lambda_u2422 = SavedStateWriter.m8157constructorimpl($this$savedState_u24lambda_u241$iv);
                SavedStateWriter.m8161putAllimpl($this$navigate_u24lambda_u2422, navActionArgs);
        ...
        if (args != null) {
            ...
            Bundle $this$navigate_u24lambda_u2423 = SavedStateWriter.m8157constructorimpl($this$write$iv);
            SavedStateWriter.m8161putAllimpl($this$navigate_u24lambda_u2423, args);
    ...
    public final void writeIntent$navigation_runtime_release(NavDeepLinkRequest request, Bundle args) {
        ...
        Bundle $this$writeIntent_u24lambda_u2427 = SavedStateWriter.m8157constructorimpl(args);
        SavedStateWriter.m8181putParcelableimpl($this$writeIntent_u24lambda_u2427, KEY_DEEP_LINK_INTENT, $this$writeIntent_u24lambda_u2426);
    }
    ...
    public Bundle saveState() {
        ...
        if (this.deepLinkHandled) {
            ...
            Bundle $this$saveState_u24lambda_u2428 = SavedStateWriter.m8157constructorimpl($this$write$iv);
            SavedStateWriter.m8163putBooleanimpl($this$saveState_u24lambda_u2428, KEY_DEEP_LINK_HANDLED, this.deepLinkHandled);
        }
        return b;
    }
    ...
    public void restoreState(Bundle navState) {
        ...
        Bundle $this$restoreState_u24lambda_u2429 = SavedStateReader.m8071constructorimpl(navState);
        Boolean boolM8083getBooleanOrNullimpl = SavedStateReader.m8083getBooleanOrNullimpl($this$restoreState_u24lambda_u2429, KEY_DEEP_LINK_HANDLED);
        this.deepLinkHandled = boolM8083getBooleanOrNullimpl != null ? boolM8083getBooleanOrNullimpl.booleanValue() : false;
    }
    ...
    public void setOnBackPressedDispatcher(OnBackPressedDispatcher dispatcher) throws Exception {
