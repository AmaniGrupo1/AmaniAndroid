...
public final class InternalNavType {
    ...
    private static final NavType<Integer> IntNullableType = new NavType<Integer>() { // from class: androidx.navigation.serialization.InternalNavType$IntNullableType$1
        ...
        public void put(Bundle bundle, String key, Integer value) {
            ...
            if (value != null) {
                ...
                SavedStateWriter.m8180putNullimpl($this$put_u24lambda_u240, key);
            }
        }
        ...
        public Integer get(Bundle bundle, String key) {
            ...
            if (!SavedStateReader.m8072containsimpl($this$get_u24lambda_u241, key) || SavedStateReader.m8150isNullimpl($this$get_u24lambda_u241, key)) {
                return null;
            }
    ...
    private static final NavType<Boolean> BoolNullableType = new NavType<Boolean>() { // from class: androidx.navigation.serialization.InternalNavType$BoolNullableType$1
        ...
        public Boolean get(Bundle bundle, String key) {
            ...
            return Boolean.valueOf(SavedStateReader.m8080getBooleanimpl($this$get_u24lambda_u241, key));
        }
    ...
    private static final NavType<Double> DoubleType = new NavType<Double>() { // from class: androidx.navigation.serialization.InternalNavType$DoubleType$1
        ...
        public void put(Bundle bundle, String key, double value) {
            ...
            Intrinsics.checkNotNullParameter(key, "key");
            Bundle $this$put_u24lambda_u240 = SavedStateWriter.m8157constructorimpl(bundle);
            SavedStateWriter.m8170putDoubleimpl($this$put_u24lambda_u240, key, value);
        }
        ...
        public Double get(Bundle bundle, String key) {
            ...
            Intrinsics.checkNotNullParameter(key, "key");
            Bundle $this$get_u24lambda_u241 = SavedStateReader.m8071constructorimpl(bundle);
            return Double.valueOf(SavedStateReader.m8094getDoubleimpl($this$get_u24lambda_u241, key));
        }
    ...
    private static final NavType<Float> FloatNullableType = new NavType<Float>() { // from class: androidx.navigation.serialization.InternalNavType$FloatNullableType$1
        ...
        public Float get(Bundle bundle, String key) {
            ...
            return Float.valueOf(SavedStateReader.m8098getFloatimpl($this$get_u24lambda_u241, key));
        }
    ...
    private static final NavType<Long> LongNullableType = new NavType<Long>() { // from class: androidx.navigation.serialization.InternalNavType$LongNullableType$1
        ...
        public Long get(Bundle bundle, String key) {
            ...
            return Long.valueOf(SavedStateReader.m8112getLongimpl($this$get_u24lambda_u241, key));
        }
    ...
    private static final NavType<String> StringNonNullableType = new NavType<String>() { // from class: androidx.navigation.serialization.InternalNavType$StringNonNullableType$1
        ...
        public void put(Bundle bundle, String key, String value) {
            ...
            Intrinsics.checkNotNullParameter(value, "value");
            Bundle $this$put_u24lambda_u240 = SavedStateWriter.m8157constructorimpl(bundle);
            SavedStateWriter.m8190putStringimpl($this$put_u24lambda_u240, key, value);
        }
        ...
        public String get(Bundle bundle, String key) {
            ...
            Intrinsics.checkNotNullParameter(key, "key");
            Bundle $this$get_u24lambda_u241 = SavedStateReader.m8071constructorimpl(bundle);
            return (!SavedStateReader.m8072containsimpl($this$get_u24lambda_u241, key) || SavedStateReader.m8150isNullimpl($this$get_u24lambda_u241, key)) ? AbstractJsonLexerKt.NULL : SavedStateReader.m8142getStringimpl($this$get_u24lambda_u241, key);
        }
    ...
    private static final NavType<String[]> StringNullableArrayType = new CollectionNavType<String[]>() { // from class: androidx.navigation.serialization.InternalNavType$StringNullableArrayType$1
        ...
        public void put(Bundle bundle, String key, String[] value) {
            Intrinsics.checkNotNullParameter(bundle, "bundle");
            Intrinsics.checkNotNullParameter(key, "key");
            Bundle $this$put_u24lambda_u241 = SavedStateWriter.m8157constructorimpl(bundle);
            if (value == null) {
                SavedStateWriter.m8180putNullimpl($this$put_u24lambda_u241, key);
                return;
            }
            Collection destination$iv$iv = new ArrayList(value.length);
            for (String it : value) {
                if (it == null) {
                    it = AbstractJsonLexerKt.NULL;
                }
                destination$iv$iv.add(it);
            }
            Collection $this$toTypedArray$iv = (List) destination$iv$iv;
            SavedStateWriter.m8191putStringArrayimpl($this$put_u24lambda_u241, key, (String[]) $this$toTypedArray$iv.toArray(new String[0]));
        }
        ...
        public String[] get(Bundle bundle, String key) {
            Intrinsics.checkNotNullParameter(bundle, "bundle");
            Intrinsics.checkNotNullParameter(key, "key");
            Bundle $this$get_u24lambda_u243 = SavedStateReader.m8071constructorimpl(bundle);
            if (SavedStateReader.m8072containsimpl($this$get_u24lambda_u243, key) && !SavedStateReader.m8150isNullimpl($this$get_u24lambda_u243, key)) {
                String[] strArrM8143getStringArrayimpl = SavedStateReader.m8143getStringArrayimpl($this$get_u24lambda_u243, key);
                Collection destination$iv$iv = new ArrayList(strArrM8143getStringArrayimpl.length);
                for (String str : strArrM8143getStringArrayimpl) {
    ...
    private static final NavType<List<String>> StringNullableListType = new CollectionNavType<List<? extends String>>() { // from class: androidx.navigation.serialization.InternalNavType$StringNullableListType$1
        ...
        public List<String> get(Bundle bundle, String key) {
            ...
            Bundle $this$get_u24lambda_u243 = SavedStateReader.m8071constructorimpl(bundle);
            if (SavedStateReader.m8072containsimpl($this$get_u24lambda_u243, key) && !SavedStateReader.m8150isNullimpl($this$get_u24lambda_u243, key)) {
                Iterable $this$map$iv = ArraysKt.toList(SavedStateReader.m8143getStringArrayimpl($this$get_u24lambda_u243, key));
                Collection destination$iv$iv = new ArrayList(CollectionsKt.collectionSizeOrDefault($this$map$iv, 10));
                for (Object item$iv$iv : $this$map$iv) {
                    String it = (String) item$iv$iv;
    ...
    private static final NavType<double[]> DoubleArrayType = new CollectionNavType<double[]>() { // from class: androidx.navigation.serialization.InternalNavType$DoubleArrayType$1
        ...
        public void put(Bundle bundle, String key, double[] value) {
            ...
            if (value == null) {
                ...
                SavedStateWriter.m8171putDoubleArrayimpl($this$put_u24lambda_u240, key, value);
            }
        }
        ...
        public double[] get(Bundle bundle, String key) {
            ...
            return SavedStateReader.m8095getDoubleArrayimpl($this$get_u24lambda_u241, key);
        }
    ...
    private static final NavType<List<Double>> DoubleListType = new CollectionNavType<List<? extends Double>>() { // from class: androidx.navigation.serialization.InternalNavType$DoubleListType$1
        ...
        public void put(Bundle bundle, String key, List<Double> value) {
            ...
            if (value == null) {
                ...
                SavedStateWriter.m8171putDoubleArrayimpl($this$put_u24lambda_u240, key, CollectionsKt.toDoubleArray(value));
            }
        }
        ...
        public List<Double> get(Bundle bundle, String key) {
            ...
            return ArraysKt.toList(SavedStateReader.m8095getDoubleArrayimpl($this$get_u24lambda_u241, key));
        }
