...
public final class NavInflater {
            ...
            if (navTypeInferFromValue == NavType.ReferenceType) {
                ...
                switch (value.type) {
                    case 3:
                        ...
                        break;
                    case 4:
                        navTypeInferFromValue = INSTANCE.checkNavType$navigation_runtime_release(value, navTypeInferFromValue, NavType.FloatType, argType, "float");
                        defaultValue = Float.valueOf(value.getFloat());
                        break;
                    case 5:
                        navTypeInferFromValue = INSTANCE.checkNavType$navigation_runtime_release(value, navTypeInferFromValue, NavType.IntType, argType, "dimension");
                        defaultValue = Integer.valueOf((int) value.getDimension(res.getDisplayMetrics()));
                        break;
                    case 18:
                        navTypeInferFromValue = INSTANCE.checkNavType$navigation_runtime_release(value, navTypeInferFromValue, NavType.BoolType, argType, "boolean");
                    ...
                    default:
                        if (value.type >= 16 && value.type <= 31) {
                            if (navTypeInferFromValue == NavType.FloatType) {
                                ...
                                navTypeInferFromValue = INSTANCE.checkNavType$navigation_runtime_release(value, navTypeInferFromValue, NavType.IntType, argType, "integer");
    ...
    private final void inflateAction(Resources res, NavDestination dest, AttributeSet attrs, XmlResourceParser parser, int graphResId) throws XmlPullParserException, IOException {
        ...
        SavedStateWriter.m8157constructorimpl(args);
        int innerDepth = parser.getDepth() + 1;
        while (true) {
            int it2 = parser.next();
        ...
        Bundle $this$inflateAction_u24lambda_u2411_u24lambda_u2410 = SavedStateReader.m8071constructorimpl(args);
        if (!SavedStateReader.m8149isEmptyimpl($this$inflateAction_u24lambda_u2411_u24lambda_u2410)) {
