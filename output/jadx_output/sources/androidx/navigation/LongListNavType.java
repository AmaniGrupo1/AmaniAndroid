...
public final class LongListNavType extends CollectionNavType<List<? extends Long>> {
    ...
    public void put(Bundle bundle, String key, List<Long> value) {
        ...
        if (value != null) {
            SavedStateWriter.m8179putLongArrayimpl($this$put_u24lambda_u240, key, CollectionsKt.toLongArray(value));
        } else {
    ...
    public List<Long> get(Bundle bundle, String key) {
        ...
        return ArraysKt.toList(SavedStateReader.m8113getLongArrayimpl($this$get_u24lambda_u241, key));
    }
