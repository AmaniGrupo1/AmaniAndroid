...
public final class StringListNavType extends CollectionNavType<List<? extends String>> {
    ...
    public void put(Bundle bundle, String key, List<String> value) {
        ...
        if (value != null) {
            ...
            SavedStateWriter.m8191putStringArrayimpl($this$put_u24lambda_u240, key, (String[]) $this$toTypedArray$iv.toArray(new String[0]));
        } else {
    ...
    public List<String> get(Bundle bundle, String key) {
        ...
        return ArraysKt.toList(SavedStateReader.m8143getStringArrayimpl($this$get_u24lambda_u241, key));
    }
