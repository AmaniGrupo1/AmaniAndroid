...
final /* synthetic */ class NavHostControllerKt__NavHostController_androidKt {
    public static final NavHostController rememberNavController(Navigator<? extends NavDestination>[] navigatorArr, Composer $composer, int $changed) {
        ...
        ComposerKt.sourceInformationMarkerEnd($composer);
        Object objM4137rememberSaveable = RememberSaveableKt.m4137rememberSaveable(objArrCopyOf, saverNavControllerSaver$NavHostControllerKt__NavHostController_androidKt, (String) null, (Function0<? extends Object>) value$iv, $composer, 0, 4);
        NavHostController $this$rememberNavController_u24lambda_u242 = (NavHostController) objM4137rememberSaveable;
        ...
        NavHostController navHostController = (NavHostController) objM4137rememberSaveable;
        if (ComposerKt.isTraceInProgress()) {
