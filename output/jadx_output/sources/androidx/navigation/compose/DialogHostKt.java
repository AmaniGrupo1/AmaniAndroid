    ...
    public static final void DialogHost(final DialogNavigator dialogNavigator, Composer $composer, final int $changed) {
        ...
        if (($dirty2 & 3) == 2 && $composer2.getSkipping()) {
            ...
            for (Object element$iv : $this$forEach$iv) {
                ...
                ComposerKt.sourceInformationMarkerEnd($composer2);
                AndroidDialog_androidKt.Dialog((Function0) value$iv3, destination2.getDialogProperties(), ComposableLambdaKt.rememberComposableLambda(1129586364, true, new DialogHostKt$DialogHost$1$2(backStackEntry, dialogNavigator, saveableStateHolder, dialogsToDispose, destination2), $composer2, 54), $composer2, RendererCapabilities.DECODER_SUPPORT_MASK, 0);
