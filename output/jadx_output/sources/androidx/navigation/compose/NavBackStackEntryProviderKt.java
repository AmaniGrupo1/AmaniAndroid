...
public final class NavBackStackEntryProviderKt {
    ...
    public static final void SaveableStateProvider(final SaveableStateHolder $this$SaveableStateProvider, final Function2<? super Composer, ? super Integer, Unit> function2, Composer $composer, final int $changed) {
        ...
        if (($dirty2 & 19) != 18 || !$composer2.getSkipping()) {
            ...
            ViewModel viewModel = ViewModelKt.viewModel((KClass<ViewModel>) orCreateKotlinClass, viewModelStoreOwner$iv, (String) null, factoryBuild, defaultViewModelCreationExtras, $composer2, ((RendererCapabilities.DECODER_SUPPORT_MASK << 3) & 896) | ((RendererCapabilities.DECODER_SUPPORT_MASK << 3) & 112), 0);
            ComposerKt.sourceInformationMarkerEnd($composer2);
