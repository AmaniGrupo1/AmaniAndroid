...
public final class BoolListNavType extends CollectionNavType<List<? extends Boolean>> {
    ...
    public void put(Bundle bundle, String key, List<Boolean> value) {
        ...
        if (value != null) {
            SavedStateWriter.m8164putBooleanArrayimpl($this$put_u24lambda_u240, key, CollectionsKt.toBooleanArray(value));
        } else {
    ...
    public List<Boolean> get(Bundle bundle, String key) {
        ...
        return ArraysKt.toList(SavedStateReader.m8081getBooleanArrayimpl($this$get_u24lambda_u241, key));
    }
