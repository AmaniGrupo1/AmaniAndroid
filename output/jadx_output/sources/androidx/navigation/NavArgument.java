...
public final class NavArgument {
    ...
    public final boolean verify(String name, Bundle bundle) {
        ...
        Intrinsics.checkNotNullParameter(bundle, "bundle");
        if (!this.isNullable) {
            Bundle $this$verify_u24lambda_u240 = SavedStateReader.m8071constructorimpl(bundle);
            if (SavedStateReader.m8072containsimpl($this$verify_u24lambda_u240, name) && SavedStateReader.m8150isNullimpl($this$verify_u24lambda_u240, name)) {
                return false;
            }
        }
        try {
