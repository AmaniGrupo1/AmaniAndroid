...
public final class FirestoreGrpc {
    ...
    private static volatile MethodDescriptor<ExecutePipelineRequest, ExecutePipelineResponse> getExecutePipelineMethod;
    ...
    public static MethodDescriptor<ExecutePipelineRequest, ExecutePipelineResponse> getExecutePipelineMethod() {
        MethodDescriptor<ExecutePipelineRequest, ExecutePipelineResponse> methodDescriptor = getExecutePipelineMethod;
        MethodDescriptor<ExecutePipelineRequest, ExecutePipelineResponse> getExecutePipelineMethod2 = methodDescriptor;
        if (methodDescriptor == null) {
            synchronized (FirestoreGrpc.class) {
                MethodDescriptor<ExecutePipelineRequest, ExecutePipelineResponse> methodDescriptor2 = getExecutePipelineMethod;
                getExecutePipelineMethod2 = methodDescriptor2;
                if (methodDescriptor2 == null) {
                    MethodDescriptor<ExecutePipelineRequest, ExecutePipelineResponse> methodDescriptorBuild = MethodDescriptor.newBuilder().setType(MethodDescriptor.MethodType.SERVER_STREAMING).setFullMethodName(MethodDescriptor.generateFullMethodName(SERVICE_NAME, "ExecutePipeline")).setSampledToLocalTracing(true).setRequestMarshaller(ProtoLiteUtils.marshaller(ExecutePipelineRequest.getDefaultInstance())).setResponseMarshaller(ProtoLiteUtils.marshaller(ExecutePipelineResponse.getDefaultInstance())).build();
                    getExecutePipelineMethod2 = methodDescriptorBuild;
                    getExecutePipelineMethod = methodDescriptorBuild;
                }
            }
        }
        return getExecutePipelineMethod2;
    }
    ...
    public interface AsyncService {
        default void getDocument(GetDocumentRequest request, StreamObserver<Document> responseObserver) {
            ServerCalls.asyncUnimplementedUnaryCall(FirestoreGrpc.getGetDocumentMethod(), responseObserver);
        }

        default void listDocuments(ListDocumentsRequest request, StreamObserver<ListDocumentsResponse> responseObserver) {
            ServerCalls.asyncUnimplementedUnaryCall(FirestoreGrpc.getListDocumentsMethod(), responseObserver);
        }

        default void updateDocument(UpdateDocumentRequest request, StreamObserver<Document> responseObserver) {
            ServerCalls.asyncUnimplementedUnaryCall(FirestoreGrpc.getUpdateDocumentMethod(), responseObserver);
        }

        default void deleteDocument(DeleteDocumentRequest request, StreamObserver<Empty> responseObserver) {
            ServerCalls.asyncUnimplementedUnaryCall(FirestoreGrpc.getDeleteDocumentMethod(), responseObserver);
        }

        default void batchGetDocuments(BatchGetDocumentsRequest request, StreamObserver<BatchGetDocumentsResponse> responseObserver) {
            ServerCalls.asyncUnimplementedUnaryCall(FirestoreGrpc.getBatchGetDocumentsMethod(), responseObserver);
        }

        default void beginTransaction(BeginTransactionRequest request, StreamObserver<BeginTransactionResponse> responseObserver) {
            ServerCalls.asyncUnimplementedUnaryCall(FirestoreGrpc.getBeginTransactionMethod(), responseObserver);
        }

        default void commit(CommitRequest request, StreamObserver<CommitResponse> responseObserver) {
            ServerCalls.asyncUnimplementedUnaryCall(FirestoreGrpc.getCommitMethod(), responseObserver);
        }

        default void rollback(RollbackRequest request, StreamObserver<Empty> responseObserver) {
            ServerCalls.asyncUnimplementedUnaryCall(FirestoreGrpc.getRollbackMethod(), responseObserver);
        }

        default void runQuery(RunQueryRequest request, StreamObserver<RunQueryResponse> responseObserver) {
            ServerCalls.asyncUnimplementedUnaryCall(FirestoreGrpc.getRunQueryMethod(), responseObserver);
        }

        default void executePipeline(ExecutePipelineRequest request, StreamObserver<ExecutePipelineResponse> responseObserver) {
            ServerCalls.asyncUnimplementedUnaryCall(FirestoreGrpc.getExecutePipelineMethod(), responseObserver);
        }

        default void runAggregationQuery(RunAggregationQueryRequest request, StreamObserver<RunAggregationQueryResponse> responseObserver) {
            ServerCalls.asyncUnimplementedUnaryCall(FirestoreGrpc.getRunAggregationQueryMethod(), responseObserver);
        }

        default StreamObserver<WriteRequest> write(StreamObserver<WriteResponse> responseObserver) {
            return ServerCalls.asyncUnimplementedStreamingCall(FirestoreGrpc.getWriteMethod(), responseObserver);
        }

        default StreamObserver<ListenRequest> listen(StreamObserver<ListenResponse> responseObserver) {
            return ServerCalls.asyncUnimplementedStreamingCall(FirestoreGrpc.getListenMethod(), responseObserver);
        }

        default void listCollectionIds(ListCollectionIdsRequest request, StreamObserver<ListCollectionIdsResponse> responseObserver) {
            ServerCalls.asyncUnimplementedUnaryCall(FirestoreGrpc.getListCollectionIdsMethod(), responseObserver);
        }

        default void createDocument(CreateDocumentRequest request, StreamObserver<Document> responseObserver) {
    ...
    public static final class FirestoreStub extends AbstractAsyncStub<FirestoreStub> {
        ...
        public void executePipeline(ExecutePipelineRequest request, StreamObserver<ExecutePipelineResponse> responseObserver) {
            ClientCalls.asyncServerStreamingCall(getChannel().newCall(FirestoreGrpc.getExecutePipelineMethod(), getCallOptions()), request, responseObserver);
        }
    ...
    public static final class FirestoreBlockingStub extends AbstractBlockingStub<FirestoreBlockingStub> {
        ...
        public Iterator<ExecutePipelineResponse> executePipeline(ExecutePipelineRequest request) {
            return ClientCalls.blockingServerStreamingCall(getChannel(), FirestoreGrpc.getExecutePipelineMethod(), getCallOptions(), request);
        }
        ...
        public void invoke(Req req, StreamObserver<Resp> responseObserver) {
            switch (this.methodId) {
                ...
                case 8:
                    ...
                    return;
                case 9:
                    this.serviceImpl.executePipeline((ExecutePipelineRequest) req, responseObserver);
                    return;
                case 10:
    ...
    public static final ServerServiceDefinition bindService(AsyncService service) {
        return ServerServiceDefinition.builder(getServiceDescriptor()).addMethod(getGetDocumentMethod(), ServerCalls.asyncUnaryCall(new MethodHandlers(service, 0))).addMethod(getListDocumentsMethod(), ServerCalls.asyncUnaryCall(new MethodHandlers(service, 1))).addMethod(getUpdateDocumentMethod(), ServerCalls.asyncUnaryCall(new MethodHandlers(service, 2))).addMethod(getDeleteDocumentMethod(), ServerCalls.asyncUnaryCall(new MethodHandlers(service, 3))).addMethod(getBatchGetDocumentsMethod(), ServerCalls.asyncServerStreamingCall(new MethodHandlers(service, 4))).addMethod(getBeginTransactionMethod(), ServerCalls.asyncUnaryCall(new MethodHandlers(service, 5))).addMethod(getCommitMethod(), ServerCalls.asyncUnaryCall(new MethodHandlers(service, 6))).addMethod(getRollbackMethod(), ServerCalls.asyncUnaryCall(new MethodHandlers(service, 7))).addMethod(getRunQueryMethod(), ServerCalls.asyncServerStreamingCall(new MethodHandlers(service, 8))).addMethod(getExecutePipelineMethod(), ServerCalls.asyncServerStreamingCall(new MethodHandlers(service, 9))).addMethod(getRunAggregationQueryMethod(), ServerCalls.asyncServerStreamingCall(new MethodHandlers(service, 10))).addMethod(getWriteMethod(), ServerCalls.asyncBidiStreamingCall(new MethodHandlers(service, 13))).addMethod(getListenMethod(), ServerCalls.asyncBidiStreamingCall(new MethodHandlers(service, 14))).addMethod(getListCollectionIdsMethod(), ServerCalls.asyncUnaryCall(new MethodHandlers(service, 11))).addMethod(getCreateDocumentMethod(), ServerCalls.asyncUnaryCall(new MethodHandlers(service, 12))).build();
    }
    ...
    public static ServiceDescriptor getServiceDescriptor() {
        ...
        if (result == null) {
            synchronized (FirestoreGrpc.class) {
                ...
                if (result == null) {
                    ServiceDescriptor serviceDescriptorBuild = ServiceDescriptor.newBuilder(SERVICE_NAME).addMethod(getGetDocumentMethod()).addMethod(getListDocumentsMethod()).addMethod(getUpdateDocumentMethod()).addMethod(getDeleteDocumentMethod()).addMethod(getBatchGetDocumentsMethod()).addMethod(getBeginTransactionMethod()).addMethod(getCommitMethod()).addMethod(getRollbackMethod()).addMethod(getRunQueryMethod()).addMethod(getExecutePipelineMethod()).addMethod(getRunAggregationQueryMethod()).addMethod(getWriteMethod()).addMethod(getListenMethod()).addMethod(getListCollectionIdsMethod()).addMethod(getCreateDocumentMethod()).build();
