...
public final class Value extends GeneratedMessageLite<Value, Builder> implements ValueOrBuilder {
    ...
    @Override // com.google.firestore.v1.ValueOrBuilder
    public ByteString getFieldReferenceValueBytes() {
        String ref = "";
        if (this.valueTypeCase_ == 19) {
            ref = (String) this.valueType_;
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void setFieldReferenceValue(String value) {
        value.getClass();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void setFieldReferenceValueBytes(ByteString value) {
        checkByteStringIsUtf8(value);
        this.valueType_ = value.toStringUtf8();
        this.valueTypeCase_ = 19;
    }
    ...
    public Function getFunctionValue() {
        if (this.valueTypeCase_ == 20) {
            return (Function) this.valueType_;
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void mergeFunctionValue(Function value) {
        value.getClass();
        if (this.valueTypeCase_ == 20 && this.valueType_ != Function.getDefaultInstance()) {
            this.valueType_ = Function.newBuilder((Function) this.valueType_).mergeFrom(value).buildPartial();
        } else {
            this.valueType_ = value;
        }
        this.valueTypeCase_ = 20;
    ...
    public Pipeline getPipelineValue() {
        if (this.valueTypeCase_ == 21) {
            return (Pipeline) this.valueType_;
        }
        return Pipeline.getDefaultInstance();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void setPipelineValue(Pipeline value) {
        value.getClass();
        this.valueType_ = value;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void mergePipelineValue(Pipeline value) {
        value.getClass();
        if (this.valueTypeCase_ == 21 && this.valueType_ != Pipeline.getDefaultInstance()) {
            this.valueType_ = Pipeline.newBuilder((Pipeline) this.valueType_).mergeFrom(value).buildPartial();
        } else {
            this.valueType_ = value;
        }
        this.valueTypeCase_ = 21;
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<Value, Builder> implements ValueOrBuilder {
        ...
        @Override // com.google.firestore.v1.ValueOrBuilder
        public boolean hasFieldReferenceValue() {
            return ((Value) this.instance).hasFieldReferenceValue();
        }

        @Override // com.google.firestore.v1.ValueOrBuilder
        public String getFieldReferenceValue() {
            return ((Value) this.instance).getFieldReferenceValue();
        }

        @Override // com.google.firestore.v1.ValueOrBuilder
        public ByteString getFieldReferenceValueBytes() {
            return ((Value) this.instance).getFieldReferenceValueBytes();
        }

        public Builder setFieldReferenceValue(String value) {
            copyOnWrite();
            ((Value) this.instance).setFieldReferenceValue(value);
            return this;
        }

        public Builder clearFieldReferenceValue() {
            copyOnWrite();
            ((Value) this.instance).clearFieldReferenceValue();
            return this;
        }

        public Builder setFieldReferenceValueBytes(ByteString value) {
            copyOnWrite();
            ((Value) this.instance).setFieldReferenceValueBytes(value);
            return this;
        }

        @Override // com.google.firestore.v1.ValueOrBuilder
        public boolean hasFunctionValue() {
            return ((Value) this.instance).hasFunctionValue();
        }

        @Override // com.google.firestore.v1.ValueOrBuilder
        public Function getFunctionValue() {
            return ((Value) this.instance).getFunctionValue();
        }

        public Builder setFunctionValue(Function value) {
            copyOnWrite();
            ((Value) this.instance).setFunctionValue(value);
            return this;
        }

        public Builder setFunctionValue(Function.Builder builderForValue) {
            copyOnWrite();
            ((Value) this.instance).setFunctionValue(builderForValue.build());
            return this;
        }

        public Builder mergeFunctionValue(Function value) {
            copyOnWrite();
            ((Value) this.instance).mergeFunctionValue(value);
            return this;
        }

        public Builder clearFunctionValue() {
            copyOnWrite();
            ((Value) this.instance).clearFunctionValue();
            return this;
        }

        @Override // com.google.firestore.v1.ValueOrBuilder
        public boolean hasPipelineValue() {
            return ((Value) this.instance).hasPipelineValue();
        }

        @Override // com.google.firestore.v1.ValueOrBuilder
        public Pipeline getPipelineValue() {
            return ((Value) this.instance).getPipelineValue();
        }

        public Builder setPipelineValue(Pipeline value) {
            copyOnWrite();
            ((Value) this.instance).setPipelineValue(value);
            return this;
        }

        public Builder setPipelineValue(Pipeline.Builder builderForValue) {
            copyOnWrite();
            ((Value) this.instance).setPipelineValue(builderForValue.build());
            return this;
        }

        public Builder mergePipelineValue(Pipeline value) {
            copyOnWrite();
            ((Value) this.instance).mergePipelineValue(value);
            return this;
        }

        public Builder clearPipelineValue() {
            copyOnWrite();
            ((Value) this.instance).clearPipelineValue();
            return this;
        }
    }
    ...
    protected final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke method, Object arg0, Object arg1) {
        switch (method) {
            ...
            case BUILD_MESSAGE_INFO:
                Object[] objects = {"valueType_", "valueTypeCase_", MapValue.class, LatLng.class, ArrayValue.class, Timestamp.class, Function.class, Pipeline.class};
