...
public final class Status extends GeneratedMessageLite<Status, Builder> implements StatusOrBuilder {
    ...
    public void addAllDetails(Iterable<? extends Any> values) {
        ensureDetailsIsMutable();
        AbstractMessageLite.addAll((Iterable) values, (List) this.details_);
    }
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<Status, Builder> implements StatusOrBuilder {
        ...
        public Builder setDetails(int index, Any.Builder builderForValue) {
            copyOnWrite();
            ((Status) this.instance).setDetails(index, builderForValue.build());
            return this;
        }
        ...
        public Builder addDetails(Any.Builder builderForValue) {
            copyOnWrite();
            ((Status) this.instance).addDetails(builderForValue.build());
            return this;
        }

        public Builder addDetails(int index, Any.Builder builderForValue) {
            copyOnWrite();
            ((Status) this.instance).addDetails(index, builderForValue.build());
            return this;
        }
    ...
    protected final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke method, Object arg0, Object arg1) {
        switch (method) {
            ...
            case BUILD_MESSAGE_INFO:
                Object[] objects = {"code_", "message_", "details_", Any.class};
