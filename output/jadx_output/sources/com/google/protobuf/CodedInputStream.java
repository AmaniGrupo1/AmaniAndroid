        ...
        */
        public int readRawVarint32() throws IOException {
            ...
            if (this.limit != tempPos2) {
                ...
                if (this.limit - tempPos3 >= 9) {
                    int tempPos4 = tempPos3 + 1;
                    int x2 = (buffer[tempPos3] << 7) ^ x;
                    if (x2 < 0) {
                        tempPos = x2 ^ WorkInfo.STOP_REASON_FOREGROUND_SERVICE_TIMEOUT;
                    } else {
                        int x3 = tempPos4 + 1;
        ...
        public long readRawVarint64() throws IOException {
            ...
            if (this.limit != tempPos) {
                ...
                if (this.limit - tempPos2 >= 9) {
                    ...
                    if (y2 < 0) {
                        x = y2 ^ WorkInfo.STOP_REASON_FOREGROUND_SERVICE_TIMEOUT;
                    } else {
                        int tempPos4 = tempPos3 + 1;
                        ...
                        if (y3 >= 0) {
                            ...
                            if (y4 < 0) {
                                ...
                                long x3 = x2 ^ (((long) buffer[tempPos3]) << 28);
                                if (x3 >= 0) {
                                    x = 266354560 ^ x3;
                                    tempPos3 = tempPos5;
                                } else {
                                    tempPos3 = tempPos5 + 1;
                                    long x4 = (((long) buffer[tempPos5]) << 35) ^ x3;
                                    if (x4 < 0) {
                                        x = (-34093383808L) ^ x4;
                                    } else {
                                        int tempPos6 = tempPos3 + 1;
                                        long x5 = (((long) buffer[tempPos3]) << 42) ^ x4;
                                        if (x5 >= 0) {
                                            x = 4363953127296L ^ x5;
                                            tempPos3 = tempPos6;
                                        } else {
                                            tempPos3 = tempPos6 + 1;
                                            long x6 = (((long) buffer[tempPos6]) << 49) ^ x5;
                                            if (x6 < 0) {
                                                x = (-558586000294016L) ^ x6;
                                            } else {
                                                int tempPos7 = tempPos3 + 1;
                                                x = ((((long) buffer[tempPos3]) << 56) ^ x6) ^ 71499008037633920L;
                                                if (x >= 0) {
                                                    tempPos3 = tempPos7;
                                                } else {
                                                    tempPos3 = tempPos7 + 1;
        ...
        public int readRawVarint32() throws IOException {
            ...
            if (this.limit != tempPos) {
                ...
                if (this.limit - tempPos2 >= 9) {
                    ...
                    if (x2 < 0) {
                        y = x2 ^ WorkInfo.STOP_REASON_FOREGROUND_SERVICE_TIMEOUT;
                    } else {
