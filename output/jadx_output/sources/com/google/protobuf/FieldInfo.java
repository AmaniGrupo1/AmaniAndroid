    ...
    public static final class Builder {
        ...
        public FieldInfo build() {
            ...
            if (this.presenceField != null) {
                ...
                if (z) {
                    return FieldInfo.forLegacyRequiredField(field, this.fieldNumber, this.type, this.presenceField, this.presenceMask, this.enforceUtf8, this.enumVerifier);
                }
                return FieldInfo.forExplicitPresenceField(field, this.fieldNumber, this.type, this.presenceField, this.presenceMask, this.enforceUtf8, this.enumVerifier);
            }
