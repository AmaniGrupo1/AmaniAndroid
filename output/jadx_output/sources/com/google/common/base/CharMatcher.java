...
public abstract class CharMatcher implements Predicate<Character> {
    ...
    CharMatcher precomputedInternal() {
        ...
        return new NegatedFastMatcher(this, precomputedPositive(negatedCharacters, table, negatedDescription)) { // from class: com.google.common.base.CharMatcher.1
    ...
    public static String showCharacter(char c) {
        char[] tmp = {AbstractJsonLexerKt.STRING_ESC, AbstractJsonLexerKt.UNICODE_ESC, 0, 0, 0, 0};
        for (int i = 0; i < 4; i++) {
