...
final class DirectedGraphConnections<N, V> implements GraphConnections<N, V> {
    ...
    public Set<N> predecessors() {
        return new AbstractSet<N>() { // from class: com.google.common.graph.DirectedGraphConnections.2
            ...
            public UnmodifiableIterator<N> iterator() {
                ...
                if (list == null) {
                    final Iterator<Map.Entry<N, Object>> entries = directedGraphConnections.adjacentNodeValues.entrySet().iterator();
                ...
                final Iterator<NodeConnection<N>> nodeConnections = directedGraphConnections.orderedNodeConnections.iterator();
    ...
    public V removeSuccessor(Object obj) {
        ...
        if (obj3 == null || obj3 == PRED) {
            ...
            boolean z = obj3 instanceof PredAndSucc;
