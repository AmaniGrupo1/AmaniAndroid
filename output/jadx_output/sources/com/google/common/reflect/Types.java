...
final class Types {
    ...
    private static final class GenericArrayTypeImpl implements GenericArrayType, Serializable {
        ...
        public boolean equals(@CheckForNull Object obj) {
            if (obj instanceof GenericArrayType) {
                ...
                return com.google.common.base.Objects.equal(getGenericComponentType(), that.getGenericComponentType());
            }
            return false;
        }
    }
    ...
    private static final class ParameterizedTypeImpl implements ParameterizedType, Serializable {
        ...
        public String toString() {
            ...
            StringBuilder sbAppend = builder.append(this.rawType.getName()).append(Typography.less);
        ...
        public boolean equals(@CheckForNull Object other) {
            ...
            return getRawType().equals(that.getRawType()) && com.google.common.base.Objects.equal(getOwnerType(), that.getOwnerType()) && Arrays.equals(getActualTypeArguments(), that.getActualTypeArguments());
        }
    }
