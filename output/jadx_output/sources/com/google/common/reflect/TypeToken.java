...
public abstract class TypeToken<T> extends TypeCapture<T> implements Serializable {
    ...
    public final boolean isSubtypeOf(Type supertype) {
        ...
        boolean z = this.runtimeType instanceof WildcardType;
        Type type = this.runtimeType;
        if (z) {
        ...
        if (z2) {
            return type2.equals(supertype) || any(((TypeVariable) this.runtimeType).getBounds()).isSubtypeOf(supertype);
        }
    ...
    private boolean isSubtypeOfArrayType(GenericArrayType supertype) {
        boolean z = this.runtimeType instanceof Class;
        Type type = this.runtimeType;
        if (z) {
    ...
    private Type getOwnerTypeIfPresent() {
        boolean z = this.runtimeType instanceof ParameterizedType;
        Type type = this.runtimeType;
        if (z) {
    ...
    private static abstract class TypeCollector<K> {
        ...
        private int collectTypes(K k, Map<? super K, Integer> map) {
            ...
            map.put(k, Integer.valueOf(iMax2 + 1));
            return iMax2 + 1;
        }
