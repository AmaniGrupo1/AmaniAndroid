...
final class CollectCollectors {
    ...
    static /* synthetic */ Multiset lambda$toImmutableMultiset$3(Multiset multiset1, Multiset multiset2) {
    ...
    static <T, E, M extends Multiset<E>> Collector<T, ?, M> toMultiset(final Function<? super T, E> elementFunction, final ToIntFunction<? super T> countFunction, Supplier<M> multisetSupplier) {
        ...
        return Collector.of(multisetSupplier, new BiConsumer() { // from class: com.google.common.collect.CollectCollectors$$ExternalSyntheticLambda69
            @Override // java.util.function.BiConsumer
            public final void accept(Object obj, Object obj2) {
    ...
    static /* synthetic */ Multiset lambda$toMultiset$6(Multiset ms1, Multiset ms2) {
        ms1.addAll(ms2);
        return ms1;
    }
    ...
    static <T, K, V> Collector<T, ?, ImmutableMap<K, V>> toImmutableMap(Function<? super T, ? extends K> keyFunction, Function<? super T, ? extends V> valueFunction, BinaryOperator<V> mergeFunction) {
        ...
        return Collectors.collectingAndThen(Collectors.toMap(keyFunction, valueFunction, mergeFunction, new Supplier() { // from class: com.google.common.collect.CollectCollectors$$ExternalSyntheticLambda66
            @Override // java.util.function.Supplier
            public final Object get() {
    ...
    static <T, K, V> Collector<T, ?, ImmutableSortedMap<K, V>> toImmutableSortedMap(final Comparator<? super K> comparator, final Function<? super T, ? extends K> keyFunction, final Function<? super T, ? extends V> valueFunction) {
        ...
        Preconditions.checkNotNull(keyFunction);
        Preconditions.checkNotNull(valueFunction);
        return Collector.of(new Supplier() { // from class: com.google.common.collect.CollectCollectors$$ExternalSyntheticLambda5
            @Override // java.util.function.Supplier
            public final Object get() {
    ...
    static /* synthetic */ Object lambda$toImmutableEnumMap$12(Object v1, Object v2) {
    ...
    static <T, K extends Enum<K>, V> Collector<T, ?, ImmutableMap<K, V>> toImmutableEnumMap(final Function<? super T, ? extends K> keyFunction, final Function<? super T, ? extends V> valueFunction, final BinaryOperator<V> mergeFunction) {
        ...
        Preconditions.checkNotNull(valueFunction);
        Preconditions.checkNotNull(mergeFunction);
        return Collector.of(new Supplier() { // from class: com.google.common.collect.CollectCollectors$$ExternalSyntheticLambda71
            @Override // java.util.function.Supplier
            public final Object get() {
    ...
    static /* synthetic */ EnumMapAccumulator lambda$toImmutableEnumMap$15(BinaryOperator mergeFunction) {
        return new EnumMapAccumulator(mergeFunction);
    }
    ...
    static class EnumMapAccumulator<K extends Enum<K>, V> {
        ...
        EnumMapAccumulator<K, V> combine(EnumMapAccumulator<K, V> other) {
            ...
            other.map.forEach(new BiConsumer() { // from class: com.google.common.collect.CollectCollectors$EnumMapAccumulator$$ExternalSyntheticLambda0
                @Override // java.util.function.BiConsumer
                public final void accept(Object obj, Object obj2) {
    ...
    static /* synthetic */ Multimap lambda$toMultimap$25(Multimap multimap1, Multimap multimap2) {
    ...
    static <T, K, V, M extends Multimap<K, V>> Collector<T, ?, M> flatteningToMultimap(final Function<? super T, ? extends K> keyFunction, final Function<? super T, ? extends Stream<? extends V>> valueFunction, Supplier<M> multimapSupplier) {
        ...
        Preconditions.checkNotNull(valueFunction);
        Preconditions.checkNotNull(multimapSupplier);
        return Collector.of(multimapSupplier, new BiConsumer() { // from class: com.google.common.collect.CollectCollectors$$ExternalSyntheticLambda29
            @Override // java.util.function.BiConsumer
            public final void accept(Object obj, Object obj2) {
    ...
    static /* synthetic */ void lambda$flatteningToMultimap$26(Function keyFunction, Function valueFunction, Multimap multimap, Object input) {
    ...
    static /* synthetic */ Multimap lambda$flatteningToMultimap$27(Multimap multimap1, Multimap multimap2) {
        multimap1.putAll(multimap2);
        return multimap1;
    }
