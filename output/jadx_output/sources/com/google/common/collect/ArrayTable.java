...
public final class ArrayTable<R, C, V> extends AbstractTable<R, C, V> implements Serializable {
    ...
    public Table.Cell<R, C, V> getCell(final int index) {
        return new Tables.AbstractCell<R, C, V>(this) { // from class: com.google.common.collect.ArrayTable.2
            ...
            {
                this.this$0 = this;
                this.rowIndex = index / this.this$0.columnList.size();
                this.columnIndex = index % this.this$0.columnList.size();
            }
