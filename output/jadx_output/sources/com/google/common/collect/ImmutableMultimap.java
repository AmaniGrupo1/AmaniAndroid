...
public abstract class ImmutableMultimap<K, V> extends BaseImmutableMultimap<K, V> implements Serializable {
    ...
    public static class Builder<K, V> {
        ...
        Map<K, ImmutableCollection.Builder<V>> ensureBuilderMapNonNull() {
            ...
            if (result == null) {
                Map<K, ImmutableCollection.Builder<V>> result2 = Platform.preservesInsertionOrderOnPutsMap();
                this.builderMap = result2;
                return result2;
            }
            return result;
        }
        ...
        public Builder<K, V> put(K key, V value) {
            ...
            if (valuesBuilder == null) {
                valuesBuilder = newValueCollectionBuilderWithExpectedSize(this.expectedValuesPerKey);
        ...
        public Builder<K, V> putAll(K key, Iterable<? extends V> values) {
            ...
            ImmutableCollection.Builder<V> valuesBuilder = ensureBuilderMapNonNull().get(key);
            if (valuesBuilder == null) {
                valuesBuilder = newValueCollectionBuilderWithExpectedSize(expectedValueCollectionSize(this.expectedValuesPerKey, values));
                ensureBuilderMapNonNull().put(key, valuesBuilder);
            }
