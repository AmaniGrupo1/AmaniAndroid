...
public class LinkedListMultimap<K, V> extends AbstractMultimap<K, V> implements ListMultimap<K, V>, Serializable {
    ...
    private class ValueForKeyIterator implements ListIterator<V> {
        ...
        public void remove() {
            ...
            Node<K, V> node3 = this.current;
            if (node != node2) {
                this.previous = node3.previousSibling;
                this.nextIndex--;
            } else {
                this.next = node3.nextSibling;
            }
            LinkedListMultimap.this.removeNode(this.current);
            this.current = null;
        }
    ...
    public List<V> get(@ParametricNullness final K key) {
        return new AbstractSequentialList<V>(this) { // from class: com.google.common.collect.LinkedListMultimap.1
            ...
            public int size() {
                KeyList<K, V> keyList = (KeyList) this.this$0.keyToKeyList.get(key);
                if (keyList == null) {
                    return 0;
                }
