...
public class TreeRangeSet<C extends Comparable<?>> extends AbstractRangeSet<C> implements Serializable {
    ...
    static final class RangesByUpperBound<C extends Comparable<?>> extends AbstractNavigableMap<Cut<C>, Range<C>> {
        ...
        Iterator<Map.Entry<Cut<C>, Range<C>>> entryIterator() {
            ...
            if (!zHasLowerBound) {
                ...
                if (entryLowerEntry == null) {
                    ...
                    if (zIsLessThan) {
                        it = navigableMap2.tailMap(entryLowerEntry.getKey(), true).values().iterator();
                    } else {
                        it = navigableMap2.tailMap((Cut) this.upperBoundWindow.lowerEndpoint(), true).values().iterator();
                    }
                }
            }
        ...
        Iterator<Map.Entry<Cut<C>, Range<C>>> descendingEntryIterator() {
            ...
            NavigableMap<Cut<C>, Range<C>> navigableMap = this.rangesByLowerBound;
            if (zHasUpperBound) {
                collectionValues = navigableMap.headMap((Cut) this.upperBoundWindow.upperEndpoint(), false).descendingMap().values();
            } else {
                collectionValues = navigableMap.descendingMap().values();
            }
    ...
    private static final class ComplementRangesByLowerBound<C extends Comparable<?>> extends AbstractNavigableMap<Cut<C>, Range<C>> {
        ...
        Iterator<Map.Entry<Cut<C>, Range<C>>> entryIterator() {
            ...
            return new AbstractIterator<Map.Entry<Cut<C>, Range<C>>>(this) { // from class: com.google.common.collect.TreeRangeSet.ComplementRangesByLowerBound.1
        ...
        Iterator<Map.Entry<Cut<C>, Range<C>>> descendingEntryIterator() {
            ...
            return new AbstractIterator<Map.Entry<Cut<C>, Range<C>>>(this) { // from class: com.google.common.collect.TreeRangeSet.ComplementRangesByLowerBound.2
                ...
                public Map.Entry<Cut<C>, Range<C>> computeNext() {
                    ...
                    if (!peekingIterator.hasNext()) {
                        ...
                        if (this.this$0.complementLowerBoundWindow.lowerBound.isLessThan(negativeRange2.lowerBound)) {
            ...
            if (key instanceof Cut) {
                try {
                    ...
                    if (this.lowerBoundWindow.contains(cut) && cut.compareTo((Cut) this.restriction.lowerBound) >= 0 && cut.compareTo((Cut) this.restriction.upperBound) < 0) {
                        ...
                        NavigableMap<Cut<C>, Range<C>> navigableMap = this.rangesByLowerBound;
                        if (zEquals) {
                            Range<C> candidate = (Range) Maps.valueOrNull(navigableMap.floorEntry(cut));
                            ...
                            Range<C> result = (Range) navigableMap.get(cut);
                            if (result != null) {
            ...
            return new AbstractIterator<Map.Entry<Cut<C>, Range<C>>>(this) { // from class: com.google.common.collect.TreeRangeSet.SubRangeSetRangesByLowerBound.1
                ...
                public Map.Entry<Cut<C>, Range<C>> computeNext() {
                    ...
                    if (!cut.isLessThan(nextRange.lowerBound)) {
                        Range<C> nextRange2 = nextRange.intersection(this.this$0.restriction);
        ...
        Iterator<Map.Entry<Cut<C>, Range<C>>> descendingEntryIterator() {
            ...
            return new AbstractIterator<Map.Entry<Cut<C>, Range<C>>>(this) { // from class: com.google.common.collect.TreeRangeSet.SubRangeSetRangesByLowerBound.2
                ...
                public Map.Entry<Cut<C>, Range<C>> computeNext() {
                    ...
                    Range<C> nextRange = (Range) it.next();
                    if (this.this$0.restriction.lowerBound.compareTo((Cut) nextRange.upperBound) < 0) {
                        Range<C> nextRange2 = nextRange.intersection(this.this$0.restriction);
                        if (this.this$0.lowerBoundWindow.contains(nextRange2.lowerBound)) {
                            return Maps.immutableEntry(nextRange2.lowerBound, nextRange2);
                        }
                        return (Map.Entry) endOfData();
                    }
