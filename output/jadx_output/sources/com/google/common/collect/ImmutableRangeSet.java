...
public final class ImmutableRangeSet<C extends Comparable> extends AbstractRangeSet<C> implements Serializable {
    ...
    public boolean intersects(Range<C> otherRange) {
        int ceilingIndex = SortedLists.binarySearch(this.ranges, new ImmutableRangeSet$$ExternalSyntheticLambda0(), otherRange.lowerBound, Ordering.natural(), SortedLists.KeyPresentBehavior.ANY_PRESENT, SortedLists.KeyAbsentBehavior.NEXT_HIGHER);
    ...
    public boolean encloses(Range<C> otherRange) {
        int index = SortedLists.binarySearch(this.ranges, new ImmutableRangeSet$$ExternalSyntheticLambda0(), otherRange.lowerBound, Ordering.natural(), SortedLists.KeyPresentBehavior.ANY_PRESENT, SortedLists.KeyAbsentBehavior.NEXT_LOWER);
    ...
    public Range<C> rangeContaining(C value) {
        int index = SortedLists.binarySearch(this.ranges, new ImmutableRangeSet$$ExternalSyntheticLambda0(), Cut.belowValue(value), Ordering.natural(), SortedLists.KeyPresentBehavior.ANY_PRESENT, SortedLists.KeyAbsentBehavior.NEXT_LOWER);
        if (index == -1) {
            return null;
        }
    ...
    private final class ComplementRanges extends ImmutableList<Range<C>> {
        ...
        public Range<C> get(int i) {
            ...
            if (!this.positiveBoundedAbove || i != this.size - 1) {
                cutAboveAll = ((Range) ImmutableRangeSet.this.ranges.get((!this.positiveBoundedBelow ? 1 : 0) + i)).lowerBound;
            } else {
    ...
    private ImmutableList<Range<C>> intersectRanges(final Range<C> range) {
        ...
        if (range.hasLowerBound()) {
            iBinarySearch = SortedLists.binarySearch(this.ranges, (Function<? super E, Cut<C>>) new Function() { // from class: com.google.common.collect.ImmutableRangeSet$$ExternalSyntheticLambda1
        ...
        if (zHasUpperBound) {
            size = SortedLists.binarySearch(immutableList, new ImmutableRangeSet$$ExternalSyntheticLambda0(), range.upperBound, SortedLists.KeyPresentBehavior.FIRST_PRESENT, SortedLists.KeyAbsentBehavior.NEXT_HIGHER);
        } else {
        ...
        return (ImmutableList<Range<C>>) new ImmutableList<Range<C>>(this) { // from class: com.google.common.collect.ImmutableRangeSet.1
            ...
            public Range<C> get(int index) {
                ...
                return (index == 0 || index == i + (-1)) ? ((Range) this.this$0.ranges.get(iBinarySearch + index)).intersection(range) : (Range) this.this$0.ranges.get(iBinarySearch + index);
            }
        ...
        public int size() {
            ...
            if (result == null) {
                ...
                while (it.hasNext()) {
                    ...
                    if (total >= SieveCacheKt.NodeLinkMask) {
                        break;
                    }
                }
        ...
        int indexOf(@CheckForNull Object target) {
            if (contains(target)) {
                ...
                while (it.hasNext()) {
                    ...
                    if (zContains) {
                        return Ints.saturatedCast(((long) ContiguousSet.create(range, discreteDomain).indexOf(comparable)) + total);
                    }
                    total += (long) ContiguousSet.create(range, discreteDomain).size();
                }
