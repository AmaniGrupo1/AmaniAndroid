...
public class ImmutableRangeMap<K extends Comparable<?>, V> implements RangeMap<K, V>, Serializable {
    ...
    @CheckForNull
    public V get(K key) {
        int index = SortedLists.binarySearch(this.ranges, new ImmutableRangeMap$$ExternalSyntheticLambda1(), Cut.belowValue(key), SortedLists.KeyPresentBehavior.ANY_PRESENT, SortedLists.KeyAbsentBehavior.NEXT_LOWER);
        if (index == -1) {
            return null;
        }
    ...
    public ImmutableRangeMap<K, V> subRangeMap(final Range<K> range) {
        ...
        final int iBinarySearch = SortedLists.binarySearch(this.ranges, (com.google.common.base.Function<? super E, Comparable>) new com.google.common.base.Function() { // from class: com.google.common.collect.ImmutableRangeMap$$ExternalSyntheticLambda0
