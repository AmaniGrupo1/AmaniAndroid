...
import androidx.activity.OnBackPressedCallback$$ExternalSyntheticAutoCloseableDispatcher0;
...
public final class ClosingFuture<V> {
    ...
    public static <V> ClosingFuture<V> submit(final ClosingCallable<V> callable, Executor executor) {
        ...
        TrustedListenableFutureTask<V> task = TrustedListenableFutureTask.create(new Callable<V>() { // from class: com.google.common.util.concurrent.ClosingFuture.1
            @Override // java.util.concurrent.Callable
            @ParametricNullness
            public V call() throws Exception {
                return (V) callable.call(closeables.closer);
            }
    ...
    public static <V> ClosingFuture<V> submitAsync(final AsyncClosingCallable<V> callable, Executor executor) {
        Preconditions.checkNotNull(callable);
        final CloseableList closeables = new CloseableList();
        TrustedListenableFutureTask<V> task = TrustedListenableFutureTask.create(new AsyncCallable<V>() { // from class: com.google.common.util.concurrent.ClosingFuture.2
    ...
    public <U> ClosingFuture<U> transform(final ClosingFunction<? super V, U> function, Executor executor) {
        ...
        AsyncFunction<V, U> applyFunction = new AsyncFunction<V, U>(this) { // from class: com.google.common.util.concurrent.ClosingFuture.4
    ...
    public <U> ClosingFuture<U> transformAsync(final AsyncClosingFunction<? super V, U> function, Executor executor) {
        Preconditions.checkNotNull(function);
        AsyncFunction<V, U> applyFunction = new AsyncFunction<V, U>(this) { // from class: com.google.common.util.concurrent.ClosingFuture.5
            final /* synthetic */ ClosingFuture this$0;
    ...
    static /* synthetic */ void lambda$closeQuietly$0(AutoCloseable closeable) {
        try {
