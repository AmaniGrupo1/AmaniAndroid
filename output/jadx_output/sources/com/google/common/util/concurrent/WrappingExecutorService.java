...
abstract class WrappingExecutorService implements ExecutorService, AutoCloseable {
    ...
    protected Runnable wrapTask(Runnable command) {
        ...
        return new Runnable() { // from class: com.google.common.util.concurrent.WrappingExecutorService$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                WrappingExecutorService.lambda$wrapTask$0(wrapped);
            }
        };
    }
