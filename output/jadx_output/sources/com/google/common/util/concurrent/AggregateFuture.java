...
abstract class AggregateFuture<InputT, OutputT> extends AggregateFutureState<OutputT> {
    ...
    final void init() {
        ...
        if (this.allMustSucceed) {
            ...
            while (it.hasNext()) {
                ...
                int i = index + 1;
                if (future.isDone()) {
                    m8289lambda$init$0$comgooglecommonutilconcurrentAggregateFuture(index, future);
                } else {
                    future.addListener(new Runnable() { // from class: com.google.common.util.concurrent.AggregateFuture$$ExternalSyntheticLambda0
                        ...
                        public final void run() {
                            this.f$0.m8289lambda$init$0$comgooglecommonutilconcurrentAggregateFuture(index, future);
                        }
        ...
        Runnable listener = new Runnable() { // from class: com.google.common.util.concurrent.AggregateFuture$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m8290lambda$init$1$comgooglecommonutilconcurrentAggregateFuture(localFutures);
            }
        };
        UnmodifiableIterator<? extends ListenableFuture<? extends InputT>> it2 = this.futures.iterator();
        while (it2.hasNext()) {
            ListenableFuture<? extends InputT> future2 = it2.next();
            if (future2.isDone()) {
                m8290lambda$init$1$comgooglecommonutilconcurrentAggregateFuture(localFutures);
            } else {
    ...
    public void m8289lambda$init$0$comgooglecommonutilconcurrentAggregateFuture(int index, ListenableFuture<? extends InputT> future) {
        try {
            ...
            m8290lambda$init$1$comgooglecommonutilconcurrentAggregateFuture(null);
        }
    }
    ...
    public void m8290lambda$init$1$comgooglecommonutilconcurrentAggregateFuture(@CheckForNull ImmutableCollection<? extends Future<? extends InputT>> futuresIfNeedToCollectAtCompletion) {
