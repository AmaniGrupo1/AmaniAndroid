...
public final class MediaType {
    ...
    private static final class Tokenizer {
        ...
        String consumeTokenIfPresent(CharMatcher matcher) {
            ...
            boolean zHasMore = hasMore();
            String str = this.input;
            return zHasMore ? str.substring(startPosition, this.position) : str.substring(startPosition);
        }
    ...
    private String computeToString() {
        ...
        if (!this.parameters.isEmpty()) {
            builder.append("; ");
            Multimap<String, String> quotedParameters = Multimaps.transformValues((ListMultimap) this.parameters, new Function() { // from class: com.google.common.net.MediaType$$ExternalSyntheticLambda0
                @Override // com.google.common.base.Function
                public final Object apply(Object obj) {
    ...
    private static String escapeAndQuote(String value) {
        ...
        for (int i = 0; i < value.length(); i++) {
            ...
            if (ch == '\r' || ch == '\\' || ch == '\"') {
                escaped.append(AbstractJsonLexerKt.STRING_ESC);
            }
            escaped.append(ch);
        }
