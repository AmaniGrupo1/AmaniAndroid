...
public final class InternetDomainName {
    ...
    private int publicSuffixIndex() {
        ...
        if (publicSuffixIndexLocal == -2) {
            int publicSuffixIndexLocal2 = findSuffixOfType(Optional.absent());
            this.publicSuffixIndexCache = publicSuffixIndexLocal2;
    ...
    private int registrySuffixIndex() {
        ...
        if (registrySuffixIndexLocal == -2) {
            int registrySuffixIndexLocal2 = findSuffixOfType(Optional.of(PublicSuffixType.REGISTRY));
            this.registrySuffixIndexCache = registrySuffixIndexLocal2;
