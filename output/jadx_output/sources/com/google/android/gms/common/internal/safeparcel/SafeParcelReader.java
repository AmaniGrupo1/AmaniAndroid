...
public class SafeParcelReader {
    ...
    public static void ensureAtEnd(Parcel parcel, int end) {
        ...
        StringBuilder sb = new StringBuilder(String.valueOf(end).length() + 26);
    ...
    public static int validateObjectHeader(Parcel p) {
        ...
        if (fieldId != 20293) {
            ...
            throw new ParseException("Expected object header. Got 0x".concat(String.valueOf(hexString)), p);
        }
