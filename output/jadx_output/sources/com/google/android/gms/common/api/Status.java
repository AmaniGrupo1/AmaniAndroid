...
public final class Status extends AbstractSafeParcelable implements Result, ReflectedParcelable {
    ...
    public void startResolutionForResult(Activity activity, int requestCode) throws IntentSender.SendIntentException {
        if (hasResolution()) {
            ...
            activity.startIntentSenderForResult(pendingIntent.getIntentSender(), requestCode, null, 0, 0, 0, bundle);
        }
    }
    ...
    public void writeToParcel(Parcel out, int flags) {
        ...
        SafeParcelWriter.writeParcelable(out, 3, this.zzc, flags, false);
