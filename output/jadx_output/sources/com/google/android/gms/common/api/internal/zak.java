...
public final class zak extends zap {
    ...
    public final void onStart() {
        ...
        StringBuilder sb = new StringBuilder(String.valueOf(z).length() + 9 + String.valueOf(strValueOf).length());
        sb.append("onStart ");
        sb.append(z);
        sb.append(" ");
    ...
    public final void zab(int i, GoogleApiClient googleApiClient, GoogleApiClient.OnConnectionFailedListener onConnectionFailedListener) {
        ...
        StringBuilder sb2 = new StringBuilder(String.valueOf(i).length() + 32 + String.valueOf(z).length() + 1 + String.valueOf(strValueOf).length());
