...
public final class ListenerHolder<L> {
    ...
    ListenerHolder(Looper looper, L l, String listenerType) {
        this.zaa = new HandlerExecutor(looper);
        this.zab = new ListenerKey(Preconditions.checkNotNull(l, "Listener must not be null"), Preconditions.checkNotEmpty(listenerType));
    }
    ...
    ListenerHolder(Executor executor, L l, String listenerType) {
