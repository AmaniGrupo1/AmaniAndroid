...
public class Feature extends AbstractSafeParcelable {
    ...
    public Feature(String name, int oldVersion, long version) {
        this(name, oldVersion, version, false);
    }
    ...
    public final String toString() {
        ...
        stringHelper.add(HintConstants.AUTOFILL_HINT_NAME, getName());
    ...
    public Feature(String name, long version, boolean isFullyRolledOut) {
        this(name, -1, version, isFullyRolledOut);
    }
}
