...
public class GoogleApiManager implements Handler.Callback {
    ...
    private GoogleApiManager(Context context, Looper looper, GoogleApiAvailability apiAvailability) {
        this.zat = true;
        this.zaj = context;
        this.zas = new com.google.android.gms.internal.base.zao(looper, this);
        this.zak = apiAvailability;
        this.zal = new com.google.android.gms.common.internal.zao(apiAvailability);
