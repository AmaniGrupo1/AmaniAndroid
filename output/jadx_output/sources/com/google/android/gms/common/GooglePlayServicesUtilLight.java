...
public class GooglePlayServicesUtilLight {
    ...
    public static void ensurePlayServicesAvailable(Context context, int minApkVersion) throws GooglePlayServicesRepairableException, GooglePlayServicesNotAvailableException {
        ...
        if (minApkVersion2 != 0) {
            ...
            StringBuilder sb = new StringBuilder(String.valueOf(minApkVersion2).length() + 46);
    ...
    public static int isGooglePlayServicesAvailable(Context context, int minApkVersion) {
        ...
        try {
            ...
            if (com.google.android.gms.common.util.zzb.zza(packageInfo2.versionCode) >= com.google.android.gms.common.util.zzb.zza(minApkVersion)) {
            ...
            StringBuilder sb = new StringBuilder(String.valueOf(packageName).length() + 49 + String.valueOf(minApkVersion).length() + 11 + String.valueOf(i).length());
