...
public class GoogleSignatureVerifier {
    ...
    */
    ...
    public boolean isPackageGoogleSigned(@Nullable String callingPackage) {
        zzy zzyVarZzb = zzb(callingPackage, false, false);
        zzyVarZzb.zze();
    ...
    public boolean isUidGoogleSigned(int uid) {
        zzy zzyVarZzc;
        int length;
        String[] packagesForUid = this.zzb.getPackageManager().getPackagesForUid(uid);
        if (packagesForUid != null && (length = packagesForUid.length) != 0) {
            ...
            while (true) {
                ...
                zzyVarZzc = zzb(packagesForUid[i], false, false);
                if (zzyVarZzc.zza) {
                    break;
                }
                i++;
