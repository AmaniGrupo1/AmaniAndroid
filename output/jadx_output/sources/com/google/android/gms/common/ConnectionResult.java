...
public final class ConnectionResult extends AbstractSafeParcelable {
    ...
    public void writeToParcel(Parcel out, int flags) {
        ...
        SafeParcelWriter.writeIntegerObject(out, 5, getClientMethodKey(), false);
    ...
    public ConnectionResult(int statusCode, PendingIntent pendingIntent, String message) {
        this(1, statusCode, pendingIntent, message, null);
    }

    public ConnectionResult(int statusCode, PendingIntent pendingIntent, String message, Integer clientMethodKey) {
        this(1, statusCode, pendingIntent, message, clientMethodKey);
    }
}
