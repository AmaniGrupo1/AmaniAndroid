        ...
        try {
            try {
                ...
                if (zzo.zzg.zzi()) {
                    ...
                    callingPackage.isEmpty();
                    zza(context);
                    zzv zzvVar = new zzv(null);
                    zzvVar.zza(callingPackage);
                    zzvVar.zzb(zHonorsDebugCertificates);
                    zzvVar.zzc(false);
                    zzy zzyVarZzc = zzo.zzc(zzvVar.zzd());
                    if (zzyVarZzc.zza) {
                        PackageVerificationResult packageVerificationResultZzd = PackageVerificationResult.zzd(callingPackage, zzyVarZzc.zzd, null);
                        zza = new zzac(strConcat, packageVerificationResultZzd);
                        return packageVerificationResultZzd;
                    }
                    String str = zzyVarZzc.zzb;
                    Preconditions.checkNotNull(str);
                    return PackageVerificationResult.zza(callingPackage, str, zzyVarZzc.zzc, null);
                }
            } finally {
