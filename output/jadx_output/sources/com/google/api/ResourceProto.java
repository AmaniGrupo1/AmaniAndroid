...
public final class ResourceProto {
    ...
    public static void registerAllExtensions(ExtensionRegistryLite registry) {
        registry.add((GeneratedMessageLite.GeneratedExtension<?, ?>) resourceReference);
        registry.add((GeneratedMessageLite.GeneratedExtension<?, ?>) resourceDefinition);
        registry.add((GeneratedMessageLite.GeneratedExtension<?, ?>) resource);
    }
}
