...
public final class ContextRule extends GeneratedMessageLite<ContextRule, Builder> implements ContextRuleOrBuilder {
    ...
    public String getRequested(int index) {
        return this.requested_.get(index);
    }

    @Override // com.google.api.ContextRuleOrBuilder
    public ByteString getRequestedBytes(int index) {
        return ByteString.copyFromUtf8(this.requested_.get(index));
    }
    ...
    public void addAllRequested(Iterable<String> values) {
        ensureRequestedIsMutable();
        AbstractMessageLite.addAll((Iterable) values, (List) this.requested_);
    }
    ...
    public String getProvided(int index) {
        return this.provided_.get(index);
    }

    @Override // com.google.api.ContextRuleOrBuilder
    public ByteString getProvidedBytes(int index) {
        return ByteString.copyFromUtf8(this.provided_.get(index));
    }
    ...
    public void addAllProvided(Iterable<String> values) {
        ensureProvidedIsMutable();
        AbstractMessageLite.addAll((Iterable) values, (List) this.provided_);
    }
    ...
    public String getAllowedRequestExtensions(int index) {
        return this.allowedRequestExtensions_.get(index);
    }

    @Override // com.google.api.ContextRuleOrBuilder
    public ByteString getAllowedRequestExtensionsBytes(int index) {
        return ByteString.copyFromUtf8(this.allowedRequestExtensions_.get(index));
    }
    ...
    public void addAllAllowedRequestExtensions(Iterable<String> values) {
        ensureAllowedRequestExtensionsIsMutable();
        AbstractMessageLite.addAll((Iterable) values, (List) this.allowedRequestExtensions_);
    }
    ...
    public String getAllowedResponseExtensions(int index) {
        return this.allowedResponseExtensions_.get(index);
    }

    @Override // com.google.api.ContextRuleOrBuilder
    public ByteString getAllowedResponseExtensionsBytes(int index) {
        return ByteString.copyFromUtf8(this.allowedResponseExtensions_.get(index));
    }
    ...
    public void addAllAllowedResponseExtensions(Iterable<String> values) {
        ensureAllowedResponseExtensionsIsMutable();
        AbstractMessageLite.addAll((Iterable) values, (List) this.allowedResponseExtensions_);
    }
    ...
    protected final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke method, Object arg0, Object arg1) {
        switch (method) {
            ...
            case BUILD_MESSAGE_INFO:
                Object[] objects = {"selector_", "requested_", "provided_", "allowedRequestExtensions_", "allowedResponseExtensions_"};
                return newMessageInfo(DEFAULT_INSTANCE, "\u0000\u0005\u0000\u0000\u0001\u0005\u0005\u0000\u0004\u0000\u0001Ȉ\u0002Ț\u0003Ț\u0004Ț\u0005Ț", objects);
