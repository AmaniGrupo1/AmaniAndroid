...
final class UnicodeTables {
    ...
    static final char[] CASE_ORBIT = new char[8492];
    ...
    static {
        ...
        CASE_ORBIT[1012] = 920;
        CASE_ORBIT[1013] = 917;
        CASE_ORBIT[7776] = 7777;
        CASE_ORBIT[7777] = 7835;
        CASE_ORBIT[7835] = 7776;
        CASE_ORBIT[7838] = 223;
        CASE_ORBIT[8126] = 837;
        CASE_ORBIT[8486] = 937;
        CASE_ORBIT[8490] = 'K';
    ...
    private static int[][] make_No() {
        return new int[][]{new int[]{178, 179, 1}, new int[]{185, TsExtractor.TS_PACKET_SIZE, 3}, new int[]{PsExtractor.PRIVATE_STREAM_1, 190, 1}, new int[]{2548, 2553, 1}, new int[]{2930, 2935, 1}, new int[]{3056, 3058, 1}, new int[]{3192, 3198, 1}, new int[]{3440, 3445, 1}, new int[]{3882, 3891, 1}, new int[]{4969, 4988, 1}, new int[]{6128, 6137, 1}, new int[]{6618, 8304, 1686}, new int[]{8308, 8313, 1}, new int[]{8320, 8329, 1}, new int[]{8528, 8543, 1}, new int[]{8585, 9312, 727}, new int[]{9313, 9371, 1}, new int[]{9450, 9471, 1}, new int[]{10102, 10131, 1}, new int[]{11517, 12690, 1173}, new int[]{12691, 12693, 1}, new int[]{12832, 12841, 1}, new int[]{12881, 12895, 1}, new int[]{12928, 12937, 1}, new int[]{12977, 12991, 1}, new int[]{43056, 43061, 1}, new int[]{65799, 65843, 1}, new int[]{65909, 65912, 1}, new int[]{65930, 66336, 406}, new int[]{66337, 66339, 1}, new int[]{67672, 67679, 1}, new int[]{67862, 67867, 1}, new int[]{68160, 68167, 1}, new int[]{68221, 68222, 1}, new int[]{68440, 68447, 1}, new int[]{68472, 68479, 1}, new int[]{69216, 69246, 1}, new int[]{69714, 69733, 1}, new int[]{119648, 119665, 1}, new int[]{127232, 127242, 1}};
    }
    ...
    private static int[][] make_Pe() {
        return new int[][]{new int[]{41, 93, 52}, new int[]{ComposerImplKt.nodeKey, 3899, 3774}, new int[]{3901, 5788, 1887}, new int[]{8262, 8318, 56}, new int[]{8334, 9002, 668}, new int[]{10089, 10101, 2}, new int[]{10182, 10215, 33}, new int[]{10217, 10223, 2}, new int[]{10628, 10648, 2}, new int[]{10713, 10715, 2}, new int[]{10749, 11811, 1062}, new int[]{11813, 11817, 2}, new int[]{12297, 12305, 2}, new int[]{12309, 12315, 2}, new int[]{12318, 12319, 1}, new int[]{64831, 65048, 217}, new int[]{65078, 65092, 2}, new int[]{65096, 65114, 18}, new int[]{65116, 65118, 2}, new int[]{65289, 65341, 52}, new int[]{65373, 65379, 3}};
    }
    ...
    private static int[][] make_Latin() {
        return new int[][]{new int[]{65, 90, 1}, new int[]{97, 122, 1}, new int[]{170, 186, 16}, new int[]{PsExtractor.AUDIO_STREAM, 214, 1}, new int[]{216, 246, 1}, new int[]{248, 696, 1}, new int[]{736, 740, 1}, new int[]{7424, 7461, 1}, new int[]{7468, 7516, 1}, new int[]{7522, 7525, 1}, new int[]{7531, 7543, 1}, new int[]{7545, 7614, 1}, new int[]{7680, 7935, 1}, new int[]{8305, 8319, 14}, new int[]{8336, 8348, 1}, new int[]{8490, 8491, 1}, new int[]{8498, 8526, 28}, new int[]{8544, 8584, 1}, new int[]{11360, 11391, 1}, new int[]{42786, 42887, 1}, new int[]{42891, 42894, 1}, new int[]{42896, 42897, 1}, new int[]{42912, 42921, 1}, new int[]{43002, 43007, 1}, new int[]{64256, 64262, 1}, new int[]{65313, 65338, 1}, new int[]{65345, 65370, 1}};
    }
    ...
    private static int[][] make_Tamil() {
        return new int[][]{new int[]{2946, 2947, 1}, new int[]{2949, 2954, 1}, new int[]{2958, 2960, 1}, new int[]{2962, 2965, 1}, new int[]{2969, 2970, 1}, new int[]{2972, 2974, 2}, new int[]{2975, 2979, 4}, new int[]{2980, 2984, 4}, new int[]{2985, 2986, 1}, new int[]{2990, PlaybackException.ERROR_CODE_PARSING_CONTAINER_MALFORMED, 1}, new int[]{3006, 3010, 1}, new int[]{3014, 3016, 1}, new int[]{3018, 3021, 1}, new int[]{3024, 3031, 7}, new int[]{3046, 3066, 1}};
    }
    ...
    private static int[][] make_Tagbanwa() {
        return new int[][]{new int[]{5984, 5996, 1}, new int[]{5998, PlaybackException.ERROR_CODE_DRM_UNSPECIFIED, 1}, new int[]{PlaybackException.ERROR_CODE_DRM_PROVISIONING_FAILED, PlaybackException.ERROR_CODE_DRM_CONTENT_ERROR, 1}};
    }

    private static int[][] make_Braille() {
        return new int[][]{new int[]{Data.MAX_DATA_BYTES, 10495, 1}};
    }
    ...
    private static Map<String, int[][]> Categories() {
        ...
        map.put("Pf", Pf);
        map.put("P", P);
        map.put(ExifInterface.LATITUDE_SOUTH, S);
        map.put("C", C);
        map.put("Z", Z);
        map.put("L", L);
        map.put("M", M);
