...
public class JsonReader implements Closeable {
    ...
    private int peekKeyword() throws IOException {
        ...
        if (c == 't' || c == 'T') {
            ...
            keyword = AbstractJsonLexerKt.NULL;
            keywordUpper = "NULL";
            peeking = 7;
        }
                    ...
                    default:
                        if (c >= '0' && c <= '9') {
                            if (last == 1 || last == 0) {
                                ...
                                if (value > -922337203685477580L || (value == -922337203685477580L && value2 < value)) {
                                    z = true;
                                }
                                fitsInLong &= z;
                                value = value2;
        ...
        for (int i = 0; i < this.stackSize; i++) {
            ...
            switch (scope) {
                ...
                case 2:
                    ...
                    result.append(AbstractJsonLexerKt.BEGIN_LIST).append(pathIndex).append(AbstractJsonLexerKt.END_LIST);
                    break;
                case 3:
                case 4:
                case 5:
