...
public class ISO8601Utils {
    ...
    public static String format(Date date, boolean millis, TimeZone tz) {
        ...
        formatted.append(AbstractJsonLexerKt.COLON);
    ...
    */
    public static Date parse(String date, ParsePosition pos) throws ParseException {
        ...
        try {
            ...
            int month2 = parseInt(date, offset4, offset5);
            ...
            if (!hasT) {
                try {
                    if (date.length() <= offset6) {
                        Calendar calendar = new GregorianCalendar(year, month2 - 1, day);
                    ...
                    if (hasT) {
                        ...
                        if (checkOffset(date, offset8, AbstractJsonLexerKt.COLON)) {
                            offset8++;
                        }
                        int offset9 = offset8 + 2;
                        minutes = parseInt(date, offset8, offset9);
                        if (!checkOffset(date, offset9, AbstractJsonLexerKt.COLON)) {
                            offset6 = offset9;
                        } else {
                            offset6 = offset9 + 1;
                        }
