...
public final class FirestoreKt$dataObjects$$inlined$map$1<T> implements Flow<List<T>> {
    ...
    /* JADX INFO: renamed from: com.google.firebase.firestore.FirestoreKt$dataObjects$$inlined$map$1$2, reason: invalid class name */
    /* JADX INFO: compiled from: Emitters.kt */
    @Metadata(k = 3, mv = {2, 0, 0}, xi = 176)
    public static final class AnonymousClass2<T> implements FlowCollector {
        final /* synthetic */ FlowCollector $this_unsafeFlow;

        /* JADX INFO: renamed from: com.google.firebase.firestore.FirestoreKt$dataObjects$$inlined$map$1$2$1, reason: invalid class name */
        @Metadata(k = 3, mv = {2, 0, 0}, xi = 176)
        @DebugMetadata(c = "com.google.firebase.firestore.FirestoreKt$dataObjects$$inlined$map$1$2", f = "Firestore.kt", i = {}, l = {50}, m = "emit", n = {}, s = {})
        ...
        */
        public final Object emit(Object value, Continuation $completion) {
            ...
            switch (anonymousClass1.label) {
                case 0:
                    ...
                    if (flowCollector.emit(objects, anonymousClass1) == coroutine_suspended) {
        ...
        public final Object emit$$forInline(Object value, Continuation $completion) {
            ...
            QuerySnapshot it = (QuerySnapshot) value;
            Intrinsics.reifiedOperationMarker(4, ExifInterface.GPS_DIRECTION_TRUE);
            $this$map_u24lambda_u245.emit(it.toObjects(Object.class), $completion);
            return Unit.INSTANCE;
        }
    }
    ...
    public Object collect$$forInline(FlowCollector collector, Continuation $completion) {
        new ContinuationImpl($completion) { // from class: com.google.firebase.firestore.FirestoreKt$dataObjects$$inlined$map$1.1
            int label;
            /* synthetic */ Object result;
