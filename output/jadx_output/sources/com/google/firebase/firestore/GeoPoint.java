...
public class GeoPoint implements Comparable<GeoPoint> {
    ...
    public int compareTo(GeoPoint other) {
        int comparison = NumberComparisonHelper.firestoreCompareDoubles(this.latitude, other.latitude);
        if (comparison == 0) {
            return NumberComparisonHelper.firestoreCompareDoubles(this.longitude, other.longitude);
        }
        return comparison;
    }
