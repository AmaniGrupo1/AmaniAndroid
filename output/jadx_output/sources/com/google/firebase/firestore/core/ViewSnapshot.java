...
public class ViewSnapshot {
    ...
    public ViewSnapshot(QueryOrPipeline query, DocumentSet documents, DocumentSet oldDocuments, List<DocumentViewChange> changes, boolean isFromCache, ImmutableSortedSet<DocumentKey> mutatedKeys, boolean didSyncStateChange, boolean excludesMetadataChanges, boolean hasCachedResults) {
        this.query = query;
    ...
    public static ViewSnapshot fromInitialDocuments(QueryOrPipeline query, DocumentSet documents, ImmutableSortedSet<DocumentKey> mutatedKeys, boolean fromCache, boolean excludesMetadataChanges, boolean hasCachedResults) {
