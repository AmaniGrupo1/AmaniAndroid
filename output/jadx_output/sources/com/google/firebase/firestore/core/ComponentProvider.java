...
public abstract class ComponentProvider {
    ...
    public static ComponentProvider defaultFactory(FirebaseFirestoreSettings settings) {
        if (settings.isPersistenceEnabled()) {
            return new SQLiteComponentProvider(settings);
        }
        return new MemoryComponentProvider(settings);
    }
    ...
    public static final class Configuration {
        ...
        public Configuration(Context context, AsyncQueue asyncQueue, DatabaseInfo databaseInfo, User initialUser, int maxConcurrentLimboResolutions, CredentialsProvider<User> authProvider, CredentialsProvider<String> appCheckProvider, GrpcMetadataProvider metadataProvider) {
