...
public final class Target extends GeneratedMessageLite<Target, Builder> implements TargetOrBuilder {
    ...
    public void mergeSnapshotVersion(Timestamp value) {
        ...
        if (this.snapshotVersion_ != null && this.snapshotVersion_ != Timestamp.getDefaultInstance()) {
            this.snapshotVersion_ = Timestamp.newBuilder(this.snapshotVersion_).mergeFrom(value).buildPartial();
        } else {
            this.snapshotVersion_ = value;
        }
        this.bitField0_ |= 1;
    ...
    public void mergeQuery(Target.QueryTarget value) {
        ...
        if (this.targetTypeCase_ == 5 && this.targetType_ != Target.QueryTarget.getDefaultInstance()) {
            this.targetType_ = Target.QueryTarget.newBuilder((Target.QueryTarget) this.targetType_).mergeFrom(value).buildPartial();
        } else {
            this.targetType_ = value;
        }
        this.targetTypeCase_ = 5;
    ...
    public void mergeDocuments(Target.DocumentsTarget value) {
        ...
        if (this.targetTypeCase_ == 6 && this.targetType_ != Target.DocumentsTarget.getDefaultInstance()) {
            this.targetType_ = Target.DocumentsTarget.newBuilder((Target.DocumentsTarget) this.targetType_).mergeFrom(value).buildPartial();
        } else {
            this.targetType_ = value;
        }
        this.targetTypeCase_ = 6;
    ...
    @Override // com.google.firebase.firestore.proto.TargetOrBuilder
    public Target.PipelineQueryTarget getPipelineQuery() {
        if (this.targetTypeCase_ == 13) {
            return (Target.PipelineQueryTarget) this.targetType_;
        }
        return Target.PipelineQueryTarget.getDefaultInstance();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void setPipelineQuery(Target.PipelineQueryTarget value) {
        value.getClass();
        this.targetType_ = value;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void mergePipelineQuery(Target.PipelineQueryTarget value) {
        value.getClass();
        if (this.targetTypeCase_ == 13 && this.targetType_ != Target.PipelineQueryTarget.getDefaultInstance()) {
            this.targetType_ = Target.PipelineQueryTarget.newBuilder((Target.PipelineQueryTarget) this.targetType_).mergeFrom(value).buildPartial();
        } else {
            this.targetType_ = value;
        }
        this.targetTypeCase_ = 13;
    ...
    public void mergeLastLimboFreeSnapshotVersion(Timestamp value) {
        ...
        if (this.lastLimboFreeSnapshotVersion_ != null && this.lastLimboFreeSnapshotVersion_ != Timestamp.getDefaultInstance()) {
            this.lastLimboFreeSnapshotVersion_ = Timestamp.newBuilder(this.lastLimboFreeSnapshotVersion_).mergeFrom(value).buildPartial();
        } else {
            this.lastLimboFreeSnapshotVersion_ = value;
        }
        this.bitField0_ |= 2;
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<Target, Builder> implements TargetOrBuilder {
        ...
        public Builder setSnapshotVersion(Timestamp.Builder builderForValue) {
            copyOnWrite();
            ((Target) this.instance).setSnapshotVersion(builderForValue.build());
            return this;
        }
        ...
        public Builder setPipelineQuery(Target.PipelineQueryTarget value) {
            copyOnWrite();
            ((Target) this.instance).setPipelineQuery(value);
            return this;
        }

        public Builder setPipelineQuery(Target.PipelineQueryTarget.Builder builderForValue) {
            copyOnWrite();
            ((Target) this.instance).setPipelineQuery(builderForValue.build());
            return this;
        }

        public Builder mergePipelineQuery(Target.PipelineQueryTarget value) {
            copyOnWrite();
        ...
        public Builder setLastLimboFreeSnapshotVersion(Timestamp.Builder builderForValue) {
            copyOnWrite();
            ((Target) this.instance).setLastLimboFreeSnapshotVersion(builderForValue.build());
            return this;
        }
    ...
    protected final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke method, Object arg0, Object arg1) {
        switch (method) {
            ...
            case BUILD_MESSAGE_INFO:
                Object[] objects = {"targetType_", "targetTypeCase_", "bitField0_", "targetId_", "snapshotVersion_", "resumeToken_", "lastListenSequenceNumber_", Target.QueryTarget.class, Target.DocumentsTarget.class, "lastLimboFreeSnapshotVersion_", Target.PipelineQueryTarget.class};
                return newMessageInfo(DEFAULT_INSTANCE, "\u0000\b\u0001\u0001\u0001\r\b\u0000\u0000\u0000\u0001\u0004\u0002ဉ\u0000\u0003\n\u0004\u0002\u0005<\u0000\u0006<\u0000\u0007ဉ\u0001\r<\u0000", objects);
