...
public final class FirestoreKt$dataObjects$$inlined$map$2<T> implements Flow<T> {
    ...
    public static final class AnonymousClass2<T> implements FlowCollector {
        ...
        @Metadata(k = 3, mv = {2, 0, 0}, xi = 176)
        @DebugMetadata(c = "com.google.firebase.firestore.FirestoreKt$dataObjects$$inlined$map$2$2", f = "Firestore.kt", i = {}, l = {50}, m = "emit", n = {}, s = {})
        ...
        */
        public final Object emit(Object value, Continuation $completion) {
            ...
            switch (anonymousClass1.label) {
                case 0:
                    ...
                    DocumentSnapshot it = (DocumentSnapshot) value;
                    Intrinsics.reifiedOperationMarker(4, ExifInterface.GPS_DIRECTION_TRUE);
                    Object object = it.toObject(Object.class);
                    anonymousClass1.label = 1;
                    if (flowCollector.emit(object, anonymousClass1) == coroutine_suspended) {
        ...
        public final Object emit$$forInline(Object value, Continuation $completion) {
            ...
            DocumentSnapshot it = (DocumentSnapshot) value;
            Intrinsics.reifiedOperationMarker(4, ExifInterface.GPS_DIRECTION_TRUE);
            flowCollector.emit(it.toObject(Object.class), $completion);
            return Unit.INSTANCE;
        }
    }
    ...
    public Object collect$$forInline(FlowCollector collector, Continuation $completion) {
        new ContinuationImpl($completion) { // from class: com.google.firebase.firestore.FirestoreKt$dataObjects$$inlined$map$2.1
            int label;
            /* synthetic */ Object result;
