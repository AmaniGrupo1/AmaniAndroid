...
public class Util {
    ...
    public static int compareUtf8Strings(String left, String right) {
        ...
        int i2 = left.length();
        return Integer.compare(i2, right.length());
    }
    ...
    private static String getUtf8SafeBytes(String str, int index) {
        ...
        return str.substring(index, Character.charCount(firstCodePoint) + index);
    }
    ...
    public static int compareByteStrings(ByteString left, ByteString right) {
        ...
        int i2 = left.size();
        return Integer.compare(i2, right.size());
    }
    ...
    public static <K, V> Iterable<V> values(final Iterable<Map.Entry<K, V>> map) {
        return new Iterable() { // from class: com.google.firebase.firestore.util.Util$$ExternalSyntheticLambda4
