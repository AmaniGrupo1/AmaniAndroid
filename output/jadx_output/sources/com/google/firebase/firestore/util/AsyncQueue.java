...
public class AsyncQueue {
    ...
    class SynchronizedShutdownAwareExecutor implements Executor {
        ...
        SynchronizedShutdownAwareExecutor() {
            ...
            this.thread.setUncaughtExceptionHandler(new Thread.UncaughtExceptionHandler() { // from class: com.google.firebase.firestore.util.AsyncQueue$SynchronizedShutdownAwareExecutor$$ExternalSyntheticLambda1
                ...
                public final void uncaughtException(Thread thread, Throwable th) {
                    this.f$0.m8465x23fada6e(thread, th);
                }
            });
            this.internalExecutor = new AnonymousClass1(1, threadFactory, AsyncQueue.this);
        ...
        /* synthetic */ void m8465x23fada6e(Thread crashingThread, Throwable throwable) {
            AsyncQueue.this.panic(throwable);
        }

        /* JADX INFO: renamed from: com.google.firebase.firestore.util.AsyncQueue$SynchronizedShutdownAwareExecutor$1, reason: invalid class name */
        class AnonymousClass1 extends ScheduledThreadPoolExecutor implements AutoCloseable {
            final /* synthetic */ AsyncQueue val$this$0;
            ...
            AnonymousClass1(int corePoolSize, ThreadFactory threadFactory, AsyncQueue asyncQueue) {
    ...
    static /* synthetic */ void lambda$panic$3(Throwable t) {
        if (t instanceof OutOfMemoryError) {
            OutOfMemoryError error = new OutOfMemoryError("Firestore (26.1.1) ran out of memory. Check your queries to make sure they are not loading an excessive amount of data.");
            error.initCause(t);
            throw error;
        }
        throw new RuntimeException("Internal error in Cloud Firestore (26.1.1).", t);
    }
    ...
    public void runDelayedTasksUntil(final TimerId lastTimerId) throws InterruptedException {
        runSync(new Runnable() { // from class: com.google.firebase.firestore.util.AsyncQueue$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m8464xc3727432(lastTimerId);
            }
        });
    }
    ...
    /* synthetic */ void m8464xc3727432(TimerId lastTimerId) {
