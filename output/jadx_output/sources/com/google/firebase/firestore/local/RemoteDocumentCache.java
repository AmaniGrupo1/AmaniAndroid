...
interface RemoteDocumentCache {
    ...
    Map<DocumentKey, MutableDocument> getDocumentsMatchingQuery(QueryOrPipeline queryOrPipeline, FieldIndex.IndexOffset indexOffset, @Nonnull Set<DocumentKey> set);

    Map<DocumentKey, MutableDocument> getDocumentsMatchingQuery(QueryOrPipeline queryOrPipeline, FieldIndex.IndexOffset indexOffset, @Nonnull Set<DocumentKey> set, @Nullable QueryContext queryContext);
