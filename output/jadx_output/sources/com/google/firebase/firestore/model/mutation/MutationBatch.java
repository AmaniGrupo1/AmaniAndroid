...
public final class MutationBatch {
    ...
    public Map<DocumentKey, Mutation> applyToLocalDocumentSet(Map<DocumentKey, OverlayedDocument> documentMap, Set<DocumentKey> documentsWithoutRemoteVersion) {
        ...
        for (DocumentKey key : getKeys()) {
            ...
            Mutation overlay = Mutation.calculateOverlayMutation(document, documentsWithoutRemoteVersion.contains(key) ? null : mutatedFields);
            if (overlay != null) {
    ...
    public int hashCode() {
        ...
        return (((((result * 31) + this.localWriteTime.hashCode()) * 31) + this.baseMutations.hashCode()) * 31) + this.mutations.hashCode();
    }
