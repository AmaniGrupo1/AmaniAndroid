...
public abstract class StorageTask<ResultT extends ProvideError> extends ControllableTask<ResultT> {
    ...
    final TaskListenerImpl<OnSuccessListener<? super ResultT>, ResultT> successManager = new TaskListenerImpl<>(this, 128, new TaskListenerImpl.OnRaise() { // from class: com.google.firebase.storage.StorageTask$$ExternalSyntheticLambda0
        ...
        public final void raise(Object obj, Object obj2) {
            this.f$0.m8478lambda$new$0$comgooglefirebasestorageStorageTask((OnSuccessListener) obj, (StorageTask.ProvideError) obj2);
        }
    });
    final TaskListenerImpl<OnFailureListener, ResultT> failureManager = new TaskListenerImpl<>(this, 64, new TaskListenerImpl.OnRaise() { // from class: com.google.firebase.storage.StorageTask$$ExternalSyntheticLambda1
        @Override // com.google.firebase.storage.TaskListenerImpl.OnRaise
        public final void raise(Object obj, Object obj2) {
            this.f$0.m8479lambda$new$1$comgooglefirebasestorageStorageTask((OnFailureListener) obj, (StorageTask.ProvideError) obj2);
        }
    });
    final TaskListenerImpl<OnCompleteListener<ResultT>, ResultT> completeListener = new TaskListenerImpl<>(this, STATES_COMPLETE, new TaskListenerImpl.OnRaise() { // from class: com.google.firebase.storage.StorageTask$$ExternalSyntheticLambda2
        @Override // com.google.firebase.storage.TaskListenerImpl.OnRaise
        public final void raise(Object obj, Object obj2) {
            this.f$0.m8480lambda$new$2$comgooglefirebasestorageStorageTask((OnCompleteListener) obj, (StorageTask.ProvideError) obj2);
        }
    });
    final TaskListenerImpl<OnCanceledListener, ResultT> cancelManager = new TaskListenerImpl<>(this, 256, new TaskListenerImpl.OnRaise() { // from class: com.google.firebase.storage.StorageTask$$ExternalSyntheticLambda3
        @Override // com.google.firebase.storage.TaskListenerImpl.OnRaise
        public final void raise(Object obj, Object obj2) {
            this.f$0.m8481lambda$new$3$comgooglefirebasestorageStorageTask((OnCanceledListener) obj, (StorageTask.ProvideError) obj2);
        }
    });
    final TaskListenerImpl<OnProgressListener<? super ResultT>, ResultT> progressManager = new TaskListenerImpl<>(this, STATES_INPROGRESS, new TaskListenerImpl.OnRaise() { // from class: com.google.firebase.storage.StorageTask$$ExternalSyntheticLambda4
        @Override // com.google.firebase.storage.TaskListenerImpl.OnRaise
        public final void raise(Object obj, Object obj2) {
            ((OnProgressListener) obj).onProgress((StorageTask.ProvideError) obj2);
        }
    });
    final TaskListenerImpl<OnPausedListener<? super ResultT>, ResultT> pausedManager = new TaskListenerImpl<>(this, 16, new TaskListenerImpl.OnRaise() { // from class: com.google.firebase.storage.StorageTask$$ExternalSyntheticLambda5
        @Override // com.google.firebase.storage.TaskListenerImpl.OnRaise
        public final void raise(Object obj, Object obj2) {
    ...
    /* JADX INFO: renamed from: lambda$new$0$com-google-firebase-storage-StorageTask, reason: not valid java name */
    /* synthetic */ void m8478lambda$new$0$comgooglefirebasestorageStorageTask(OnSuccessListener listener, ProvideError snappedState) {
        StorageTaskManager.getInstance().unRegister(this);
        listener.onSuccess(snappedState);
    }

    /* JADX INFO: renamed from: lambda$new$1$com-google-firebase-storage-StorageTask, reason: not valid java name */
    /* synthetic */ void m8479lambda$new$1$comgooglefirebasestorageStorageTask(OnFailureListener listener, ProvideError snappedState) {
        StorageTaskManager.getInstance().unRegister(this);
        listener.onFailure(snappedState.getError());
    }

    /* JADX INFO: renamed from: lambda$new$2$com-google-firebase-storage-StorageTask, reason: not valid java name */
    /* synthetic */ void m8480lambda$new$2$comgooglefirebasestorageStorageTask(OnCompleteListener listener, ProvideError snappedState) {
        StorageTaskManager.getInstance().unRegister(this);
        listener.onComplete(this);
    }

    /* JADX INFO: renamed from: lambda$new$3$com-google-firebase-storage-StorageTask, reason: not valid java name */
    /* synthetic */ void m8481lambda$new$3$comgooglefirebasestorageStorageTask(OnCanceledListener listener, ProvideError snappedState) {
        StorageTaskManager.getInstance().unRegister(this);
        listener.onCanceled();
    }
    ...
    public StorageTask<ResultT> removeOnPausedListener(OnPausedListener<? super ResultT> listener) {
        Preconditions.checkNotNull(listener);
        this.pausedManager.m8482x5521489(listener);
        return this;
    }
    ...
    public StorageTask<ResultT> removeOnProgressListener(OnProgressListener<? super ResultT> listener) {
        Preconditions.checkNotNull(listener);
        this.progressManager.m8482x5521489(listener);
        return this;
    }
    ...
    public StorageTask<ResultT> removeOnSuccessListener(OnSuccessListener<? super ResultT> listener) {
        Preconditions.checkNotNull(listener);
        this.successManager.m8482x5521489(listener);
        return this;
    }
    ...
    public StorageTask<ResultT> removeOnFailureListener(OnFailureListener listener) {
        Preconditions.checkNotNull(listener);
        this.failureManager.m8482x5521489(listener);
        return this;
    }
    ...
    public StorageTask<ResultT> removeOnCompleteListener(OnCompleteListener<ResultT> listener) {
        Preconditions.checkNotNull(listener);
        this.completeListener.m8482x5521489(listener);
        return this;
    }
    ...
    public StorageTask<ResultT> removeOnCanceledListener(OnCanceledListener listener) {
        Preconditions.checkNotNull(listener);
        this.cancelManager.m8482x5521489(listener);
        return this;
    }
    ...
    private <ContinuationResultT> Task<ContinuationResultT> continueWithImpl(Executor executor, final Continuation<ResultT, ContinuationResultT> continuation) {
        ...
        this.completeListener.addListener(null, executor, new OnCompleteListener() { // from class: com.google.firebase.storage.StorageTask$$ExternalSyntheticLambda6
            ...
            public final void onComplete(Task task) {
                this.f$0.m8475xcb6caa6(continuation, source, task);
            }
        });
    ...
    /* JADX INFO: renamed from: lambda$continueWithImpl$4$com-google-firebase-storage-StorageTask, reason: not valid java name */
    /* synthetic */ void m8475xcb6caa6(Continuation continuation, TaskCompletionSource source, Task task) {
        try {
    ...
    private <ContinuationResultT> Task<ContinuationResultT> continueWithTaskImpl(Executor executor, final Continuation<ResultT, Task<ContinuationResultT>> continuation) {
        ...
        final TaskCompletionSource<ContinuationResultT> source = new TaskCompletionSource<>(cancellationToken);
        this.completeListener.addListener(null, executor, new OnCompleteListener() { // from class: com.google.firebase.storage.StorageTask$$ExternalSyntheticLambda11
            @Override // com.google.android.gms.tasks.OnCompleteListener
            public final void onComplete(Task task) {
                this.f$0.m8476x3ff9518c(continuation, source, cancellationTokenSource, task);
            }
        });
        return source.getTask();
    }
    ...
    /* JADX INFO: renamed from: lambda$continueWithTaskImpl$5$com-google-firebase-storage-StorageTask, reason: not valid java name */
    /* synthetic */ void m8476x3ff9518c(Continuation continuation, TaskCompletionSource source, CancellationTokenSource cancellationTokenSource, Task task) {
        try {
            ...
            if (!source.getTask().isComplete()) {
                ...
                task2.addOnSuccessListener(new StorageTask$$ExternalSyntheticLambda7(source));
                Objects.requireNonNull(source);
                task2.addOnFailureListener(new StorageTask$$ExternalSyntheticLambda8(source));
                Objects.requireNonNull(cancellationTokenSource);
                task2.addOnCanceledListener(new StorageTask$$ExternalSyntheticLambda9(cancellationTokenSource));
            }
        } catch (RuntimeExecutionException e) {
            if (e.getCause() instanceof Exception) {
                source.setException((Exception) e.getCause());
    ...
    private <ContinuationResultT> Task<ContinuationResultT> successTaskImpl(Executor executor, final SuccessContinuation<ResultT, ContinuationResultT> continuation) {
        final CancellationTokenSource cancellationTokenSource = new CancellationTokenSource();
        CancellationToken cancellationToken = cancellationTokenSource.getToken();
        final TaskCompletionSource<ContinuationResultT> source = new TaskCompletionSource<>(cancellationToken);
        this.successManager.addListener(null, executor, new OnSuccessListener() { // from class: com.google.firebase.storage.StorageTask$$ExternalSyntheticLambda12
            @Override // com.google.android.gms.tasks.OnSuccessListener
            public final void onSuccess(Object obj) {
                StorageTask.lambda$successTaskImpl$6(continuation, source, cancellationTokenSource, (StorageTask.ProvideError) obj);
            }
        });
        return source.getTask();
    }
    ...
    static /* synthetic */ void lambda$successTaskImpl$6(SuccessContinuation continuation, TaskCompletionSource source, CancellationTokenSource cancellationTokenSource, ProvideError result) {
        try {
            ...
            Objects.requireNonNull(source);
            taskThen.addOnSuccessListener(new StorageTask$$ExternalSyntheticLambda7(source));
            Objects.requireNonNull(source);
            taskThen.addOnFailureListener(new StorageTask$$ExternalSyntheticLambda8(source));
            Objects.requireNonNull(cancellationTokenSource);
            taskThen.addOnCanceledListener(new StorageTask$$ExternalSyntheticLambda9(cancellationTokenSource));
        } catch (RuntimeExecutionException e) {
            if (e.getCause() instanceof Exception) {
                source.setException((Exception) e.getCause());
            } else {
    ...
    Runnable getRunnable() {
        return new Runnable() { // from class: com.google.firebase.storage.StorageTask$$ExternalSyntheticLambda10
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m8477lambda$getRunnable$7$comgooglefirebasestorageStorageTask();
            }
        };
    }

    /* JADX INFO: renamed from: lambda$getRunnable$7$com-google-firebase-storage-StorageTask, reason: not valid java name */
    /* synthetic */ void m8477lambda$getRunnable$7$comgooglefirebasestorageStorageTask() {
        try {
            run();
        } finally {
            ensureFinalState();
