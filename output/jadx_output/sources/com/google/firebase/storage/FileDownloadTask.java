...
public class FileDownloadTask extends StorageTask<TaskSnapshot> {
    ...
    void run() throws IOException {
        ...
        do {
            ...
            this.mException = null;
            this.mSender.reset();
            NetworkRequest request = new GetNetworkRequest(this.mStorageRef.getStorageReferenceUri(), this.mStorageRef.getApp(), this.mResumeOffset);
            ...
            if (success) {
                ...
                if (!TextUtils.isEmpty(newEtag) && this.mETagVerification != null && !this.mETagVerification.equals(newEtag)) {
