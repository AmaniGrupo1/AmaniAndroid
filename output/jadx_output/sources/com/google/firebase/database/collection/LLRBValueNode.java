...
public abstract class LLRBValueNode<K, V> implements LLRBNode<K, V> {
    ...
    public LLRBNode<K, V> remove(K key, Comparator<K> comparator) {
        ...
        int iCompare = comparator.compare(key, n2.key);
        LLRBNode<K, V> lLRBNode = n2.left;
        if (iCompare < 0) {
            if (!lLRBNode.isEmpty() && !n2.left.isRed() && !((LLRBValueNode) n2.left).left.isRed()) {
                n2 = n2.moveRedLeft();
            }
    ...
    private LLRBValueNode<K, V> rotateLeft() {
        LLRBValueNode<K, V> newLeft = copy((Object) null, (Object) null, LLRBNode.Color.RED, (LLRBNode) null, (LLRBNode) ((LLRBValueNode) this.right).left);
        return (LLRBValueNode) this.right.copy(null, null, getColor(), newLeft, null);
    }

    private LLRBValueNode<K, V> rotateRight() {
        LLRBValueNode<K, V> newRight = copy((Object) null, (Object) null, LLRBNode.Color.RED, (LLRBNode) ((LLRBValueNode) this.left).right, (LLRBNode) null);
    ...
    private LLRBValueNode<K, V> colorFlip() {
        ...
        return copy((Object) null, (Object) null, oppositeColor(this), (LLRBNode) newLeft, (LLRBNode) newRight);
    }
}
