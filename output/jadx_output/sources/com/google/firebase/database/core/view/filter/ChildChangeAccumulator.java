...
public class ChildChangeAccumulator {
    ...
    public void trackChildChange(Change change) {
        ...
        boolean zContainsKey = this.changeMap.containsKey(childKey);
        Map<ChildKey, Change> map = this.changeMap;
        if (zContainsKey) {
            Change oldChange = map.get(childKey);
        ...
        map.put(change.getChildKey(), change);
    }
