...
public abstract class DefaultRunLoop implements RunLoop {
    ...
    private class FirebaseThreadFactory implements ThreadFactory {
        ...
        /* synthetic */ FirebaseThreadFactory(DefaultRunLoop x0, AnonymousClass1 x1) {
            this();
        }
    ...
    public DefaultRunLoop() {
        ThreadFactory threadFactory = new FirebaseThreadFactory(this, null);
        this.executor = new AnonymousClass1(1, threadFactory);
    ...
    class AnonymousClass1 extends ScheduledThreadPoolExecutor implements AutoCloseable {
        ...
        AnonymousClass1(int arg0, ThreadFactory arg1) {
            super(arg0, arg1);
        }
