...
public class SyncPoint {
    ...
    public Pair<List<QuerySpec>, List<Event>> removeEventRegistration(QuerySpec query, EventRegistration eventRegistration, DatabaseError cancelError) {
        ...
        boolean zIsDefault = query.isDefault();
        Map<QueryParams, View> map = this.views;
        if (zIsDefault) {
            Iterator<Map.Entry<QueryParams, View>> iterator = map.entrySet().iterator();
            ...
            View view2 = map.get(query.getParams());
            if (view2 != null) {
