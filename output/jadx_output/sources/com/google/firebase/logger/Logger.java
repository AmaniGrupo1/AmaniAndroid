...
public abstract class Logger {
    ...
    public static final class Companion {
        ...
        public final Logger getLogger(String tag, boolean enabled, Level minLevel) {
            ...
            if (obj == null) {
                AndroidLogger androidLogger = new AndroidLogger(tag, enabled, minLevel);
                Object objPutIfAbsent = $this$getOrPut$iv.putIfAbsent(tag, androidLogger);
                obj = objPutIfAbsent == null ? androidLogger : objPutIfAbsent;
            }
    ...
    public static final Logger getLogger(String tag, boolean enabled, Level minLevel) {
        return INSTANCE.getLogger(tag, enabled, minLevel);
    }

    @JvmStatic
    public static final FakeLogger setupFakeLogger(String tag, boolean enabled, Level minLevel) {
        return INSTANCE.setupFakeLogger(tag, enabled, minLevel);
    }
}
