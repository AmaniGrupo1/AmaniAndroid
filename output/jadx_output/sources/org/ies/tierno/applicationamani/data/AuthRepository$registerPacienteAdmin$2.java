...
@DebugMetadata(c = "org.ies.tierno.applicationamani.data.AuthRepository$registerPacienteAdmin$2", f = "AuthRepository.kt", i = {}, l = {TsExtractor.TS_STREAM_TYPE_E_AC3}, m = "invokeSuspend", n = {}, s = {})
final class AuthRepository$registerPacienteAdmin$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Result<? extends LoginResponseDTO>>, Object> {
    final /* synthetic */ PacienteRequest $request;
    int label;
    final /* synthetic */ AuthRepository this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    AuthRepository$registerPacienteAdmin$2(AuthRepository authRepository, PacienteRequest pacienteRequest, Continuation<? super AuthRepository$registerPacienteAdmin$2> continuation) {
        super(2, continuation);
        this.this$0 = authRepository;
        this.$request = pacienteRequest;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new AuthRepository$registerPacienteAdmin$2(this.this$0, this.$request, continuation);
    }
    ...
    public final Object invoke2(CoroutineScope coroutineScope, Continuation<? super Result<LoginResponseDTO>> continuation) {
        return ((AuthRepository$registerPacienteAdmin$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Object invokeSuspend(Object $result) {
        Object objM8542constructorimpl;
        Object objRegisterPacienteAdmin;
        ...
        try {
            switch (this.label) {
                case 0:
                    ...
                    this.label = 1;
                    objRegisterPacienteAdmin = this.this$0.api.registerPacienteAdmin(this.$request, this);
                    if (objRegisterPacienteAdmin == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    break;
                case 1:
                    ResultKt.throwOnFailure($result);
                    objRegisterPacienteAdmin = $result;
                    break;
                default:
                    throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
            }
            Response response = (Response) objRegisterPacienteAdmin;
            if (response.isSuccessful()) {
                LoginResponseDTO body = (LoginResponseDTO) response.body();
                if (body != null) {
