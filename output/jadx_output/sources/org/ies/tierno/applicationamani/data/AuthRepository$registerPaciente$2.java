...
@DebugMetadata(c = "org.ies.tierno.applicationamani.data.AuthRepository$registerPaciente$2", f = "AuthRepository.kt", i = {}, l = {112}, m = "invokeSuspend", n = {}, s = {})
final class AuthRepository$registerPaciente$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Result<? extends LoginResponseDTO>>, Object> {
    final /* synthetic */ PacienteRequest $request;
    int label;
    final /* synthetic */ AuthRepository this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    AuthRepository$registerPaciente$2(AuthRepository authRepository, PacienteRequest pacienteRequest, Continuation<? super AuthRepository$registerPaciente$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new AuthRepository$registerPaciente$2(this.this$0, this.$request, continuation);
    }
    ...
    public final Object invoke2(CoroutineScope coroutineScope, Continuation<? super Result<LoginResponseDTO>> continuation) {
        return ((AuthRepository$registerPaciente$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Object invokeSuspend(Object $result) {
        Object objM8542constructorimpl;
        Object objRegisterPaciente;
        ...
        try {
            switch (this.label) {
                case 0:
                    ...
                    this.label = 1;
                    objRegisterPaciente = this.this$0.api.registerPaciente(this.$request, this);
                    if (objRegisterPaciente == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    break;
                case 1:
                    ResultKt.throwOnFailure($result);
                    objRegisterPaciente = $result;
                    break;
                default:
                    throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
            }
            Response response = (Response) objRegisterPaciente;
