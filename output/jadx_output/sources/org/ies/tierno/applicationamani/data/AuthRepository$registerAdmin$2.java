...
@DebugMetadata(c = "org.ies.tierno.applicationamani.data.AuthRepository$registerAdmin$2", f = "AuthRepository.kt", i = {}, l = {157}, m = "invokeSuspend", n = {}, s = {})
final class AuthRepository$registerAdmin$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Result<? extends LoginResponseDTO>>, Object> {
    final /* synthetic */ RegistryPacienteDTO $request;
    int label;
    final /* synthetic */ AuthRepository this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    AuthRepository$registerAdmin$2(AuthRepository authRepository, RegistryPacienteDTO registryPacienteDTO, Continuation<? super AuthRepository$registerAdmin$2> continuation) {
        super(2, continuation);
        this.this$0 = authRepository;
        this.$request = registryPacienteDTO;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new AuthRepository$registerAdmin$2(this.this$0, this.$request, continuation);
    }
    ...
    public final Object invoke2(CoroutineScope coroutineScope, Continuation<? super Result<LoginResponseDTO>> continuation) {
        return ((AuthRepository$registerAdmin$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Object invokeSuspend(Object $result) {
        Object objM8542constructorimpl;
        Object objRegisterAdmin;
        ...
        try {
            switch (this.label) {
                case 0:
                    ...
                    this.label = 1;
                    objRegisterAdmin = this.this$0.api.registerAdmin(this.$request, this);
                    if (objRegisterAdmin == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    break;
                case 1:
                    ResultKt.throwOnFailure($result);
                    objRegisterAdmin = $result;
                    break;
                default:
                    throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
            }
            Response response = (Response) objRegisterAdmin;
