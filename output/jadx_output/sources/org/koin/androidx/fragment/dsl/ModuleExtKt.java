...
public final class ModuleExtKt {
    public static /* synthetic */ KoinDefinition fragment$default(Module $this$fragment_u24default, Qualifier qualifier, Function2 definition, int i, Object obj) {
        ...
        $this$fragment_u24default.indexPrimaryType(factory$iv$iv);
        return new KoinDefinition($this$fragment_u24default, factory$iv$iv);
    }

    public static final /* synthetic */ <T extends Fragment> KoinDefinition<T> fragment(Module $this$fragment, Qualifier qualifier, Function2<? super Scope, ? super ParametersHolder, ? extends T> definition) {
        ...
        FactoryInstanceFactory factory$iv$iv = new FactoryInstanceFactory(def$iv$iv$iv);
        $this$fragment.indexPrimaryType(factory$iv$iv);
        return new KoinDefinition<>($this$fragment, factory$iv$iv);
    }
}
