...
public final class ScopeSetExtKt {
    public static /* synthetic */ KoinDefinition fragment$default(ScopeDSL $this$fragment_u24default, Qualifier qualifier, Function2 definition, int i, Object obj) {
        ...
        Module this_$iv$iv = $this$fragment_u24default.getModule();
        Qualifier scopeQualifier$iv$iv = $this$fragment_u24default.getScopeQualifier();
    ...
    public static final /* synthetic */ <T extends Fragment> KoinDefinition<T> fragment(ScopeDSL $this$fragment, Qualifier qualifier, Function2<? super Scope, ? super ParametersHolder, ? extends T> definition) {
        Intrinsics.checkNotNullParameter($this$fragment, "<this>");
        Intrinsics.checkNotNullParameter(definition, "definition");
        Module this_$iv$iv = $this$fragment.getModule();
        Qualifier scopeQualifier$iv$iv = $this$fragment.getScopeQualifier();
        Kind kind$iv$iv$iv$iv = Kind.Factory;
        List secondaryTypes$iv$iv$iv$iv = CollectionsKt.emptyList();
        Intrinsics.reifiedOperationMarker(4, ExifInterface.GPS_DIRECTION_TRUE);
