...
/* JADX INFO: compiled from: KoinPlatformTools.kt */
...
public final class KoinPlatformTools {
    ...
    public final String getStackTrace(Exception e) {
        ...
        StringBuilder sbAppend = new StringBuilder().append(e).append(InstanceFactory.ERROR_SEPARATOR);
        Object[] stackTrace = e.getStackTrace();
        Intrinsics.checkNotNullExpressionValue(stackTrace, "getStackTrace(...)");
        Object[] $this$takeWhile$iv = stackTrace;
        int i$iv = 0;
        while (i$iv < $this$takeWhile$iv.length) {
            StackTraceElement it = (StackTraceElement) $this$takeWhile$iv[i$iv];
        ...
        switch (i$iv) {
            case 0:
                ...
                break;
            case 1:
                listEmptyList = CollectionsKt.listOf($this$takeWhile$iv[0]);
                break;
            default:
                listEmptyList = ArraysKt.asList(ArraysKt.copyOfRange($this$takeWhile$iv, 0, i$iv));
                break;
        }
        return sbAppend.append(CollectionsKt.joinToString$default(listEmptyList, InstanceFactory.ERROR_SEPARATOR, null, null, 0, null, null, 62, null)).toString();
    }
    ...
    public final <R> R m10543synchronized(Object lock, Function0<? extends R> block) {
        R rInvoke;
