...
public final class Module {
    ...
    public Module(boolean _createdAtStart) {
        this._createdAtStart = _createdAtStart;
    ...
    public static /* synthetic */ KoinDefinition single$default(Module $this, Qualifier qualifier, boolean createdAtStart, Function2 definition, int i, Object obj) {
        Qualifier qualifier2;
        boolean createdAtStart2;
        if ((i & 1) == 0) {
        ...
        if ((i & 2) == 0) {
            createdAtStart2 = createdAtStart;
        } else {
            createdAtStart2 = false;
        }
        ...
        SingleInstanceFactory<?> singleInstanceFactory = new SingleInstanceFactory<>(def$iv);
        $this.indexPrimaryType(singleInstanceFactory);
        if (createdAtStart2 || $this.get_createdAtStart()) {
            $this.prepareForCreationAtStart(singleInstanceFactory);
        }
    ...
    public final void indexPrimaryType(InstanceFactory<?> instanceFactory) {
        ...
        Qualifier typeQualifier$iv = beanDefinition.getQualifier();
        Qualifier scopeQualifier$iv = beanDefinition.getScopeQualifier();
        ...
        String mapping = $this$indexKey_u24lambda_u240$iv.toString();
    ...
    public final void indexSecondaryTypes(InstanceFactory<?> instanceFactory) {
        ...
        Intrinsics.checkNotNullParameter(instanceFactory, "instanceFactory");
        BeanDefinition<?> beanDefinition = instanceFactory.getBeanDefinition();
        Iterable $this$forEach$iv = beanDefinition.getSecondaryTypes();
    ...
    public static /* synthetic */ KoinDefinition factory$default(Module $this, Qualifier qualifier, Function2 definition, int i, Object obj) {
        Qualifier qualifier2;
        if ((i & 1) == 0) {
            qualifier2 = qualifier;
        } else {
        ...
        $this.indexPrimaryType(factory$iv);
        return new KoinDefinition($this, factory$iv);
    }
    ...
    public final /* synthetic */ <T> KoinDefinition<T> factory(Qualifier qualifier, Function2<? super Scope, ? super ParametersHolder, ? extends T> definition) {
        ...
        FactoryInstanceFactory factory$iv = new FactoryInstanceFactory(def$iv$iv);
        indexPrimaryType(factory$iv);
        return new KoinDefinition<>(this, factory$iv);
    }

    public static /* synthetic */ KoinDefinition factory$default(Module $this, Qualifier qualifier, Function2 definition, Qualifier scopeQualifier, int i, Object obj) {
        Qualifier qualifier2;
        if ((i & 1) == 0) {
            qualifier2 = qualifier;
        } else {
        ...
        List secondaryTypes$iv$iv = CollectionsKt.emptyList();
        Intrinsics.reifiedOperationMarker(4, ExifInterface.GPS_DIRECTION_TRUE);
        BeanDefinition def$iv = new BeanDefinition(scopeQualifier, Reflection.getOrCreateKotlinClass(Object.class), qualifier$iv, definition, kind$iv$iv, secondaryTypes$iv$iv, null, 64, null);
        FactoryInstanceFactory factory = new FactoryInstanceFactory(def$iv);
        $this.indexPrimaryType(factory);
        return new KoinDefinition($this, factory);
    }
    ...
    public final /* synthetic */ <T> KoinDefinition<T> factory(Qualifier qualifier, Function2<? super Scope, ? super ParametersHolder, ? extends T> definition, Qualifier scopeQualifier) {
        ...
        List secondaryTypes$iv$iv = CollectionsKt.emptyList();
        Intrinsics.reifiedOperationMarker(4, ExifInterface.GPS_DIRECTION_TRUE);
        BeanDefinition def$iv = new BeanDefinition(scopeQualifier, Reflection.getOrCreateKotlinClass(Object.class), qualifier, definition, kind$iv$iv, secondaryTypes$iv$iv, null, 64, null);
        FactoryInstanceFactory factory = new FactoryInstanceFactory(def$iv);
