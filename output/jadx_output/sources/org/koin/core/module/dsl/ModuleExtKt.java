...
public final class ModuleExtKt {
    public static /* synthetic */ KoinDefinition viewModel$default(Module $this$viewModel_u24default, Qualifier qualifier, Function2 definition, int i, Object obj) {
        ...
        $this$viewModel_u24default.indexPrimaryType(factory$iv$iv);
        return new KoinDefinition($this$viewModel_u24default, factory$iv$iv);
    }

    public static final /* synthetic */ <T extends ViewModel> KoinDefinition<T> viewModel(Module $this$viewModel, Qualifier qualifier, Function2<? super Scope, ? super ParametersHolder, ? extends T> definition) {
        ...
        FactoryInstanceFactory factory$iv$iv = new FactoryInstanceFactory(def$iv$iv$iv);
        $this$viewModel.indexPrimaryType(factory$iv$iv);
        return new KoinDefinition<>($this$viewModel, factory$iv$iv);
    }
}
