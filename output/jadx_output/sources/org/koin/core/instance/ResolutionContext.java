...
public final class ResolutionContext {
    ...
    public ResolutionContext(Logger logger, Scope scope, KClass<?> clazz, Qualifier qualifier, ParametersHolder parameters) {
    ...
    public /* synthetic */ ResolutionContext(Logger logger, Scope scope, KClass kClass, Qualifier qualifier, ParametersHolder parametersHolder, int i, DefaultConstructorMarker defaultConstructorMarker) {
        ParametersHolder parametersHolder2;
        qualifier = (i & 8) != 0 ? null : qualifier;
        if ((i & 16) == 0) {
            parametersHolder2 = parametersHolder;
        } else {
            parametersHolder2 = null;
        }
        this(logger, scope, kClass, qualifier, parametersHolder2);
    }
    ...
    public final ResolutionContext newContextForScope(Scope s) {
        ...
        ResolutionContext rc = new ResolutionContext(this.logger, s, this.clazz, this.qualifier, this.parameters);
        rc.scopeArchetype = s.getScopeArchetype();
        return rc;
    }
}
