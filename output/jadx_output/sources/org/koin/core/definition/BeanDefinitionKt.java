...
public final class BeanDefinitionKt {
    public static final String indexKey(KClass<?> clazz, Qualifier typeQualifier, Qualifier scopeQualifier) {
        String value;
        Intrinsics.checkNotNullParameter(clazz, "clazz");
        Intrinsics.checkNotNullParameter(scopeQualifier, "scopeQualifier");
        StringBuilder $this$indexKey_u24lambda_u240 = new StringBuilder();
        $this$indexKey_u24lambda_u240.append(KClassExtKt.getFullName(clazz));
        $this$indexKey_u24lambda_u240.append(AbstractJsonLexerKt.COLON);
        if (typeQualifier == null || (value = typeQualifier.getValue()) == null) {
            value = "";
        }
        $this$indexKey_u24lambda_u240.append(value);
        $this$indexKey_u24lambda_u240.append(AbstractJsonLexerKt.COLON);
        $this$indexKey_u24lambda_u240.append(scopeQualifier);
        return $this$indexKey_u24lambda_u240.toString();
    }

    public static /* synthetic */ BeanDefinition _createDefinition$default(Kind kind, Qualifier qualifier, Function2 definition, List secondaryTypes, Qualifier scopeQualifier, int i, Object obj) {
        Kind kind2;
        ...
        return new BeanDefinition(scopeQualifier, Reflection.getOrCreateKotlinClass(Object.class), qualifier2, definition, kind2, secondaryTypes2, null, 64, null);
    }
    ...
    public static /* synthetic */ BeanDefinition _createDeclaredDefinition$default(Kind kind, Qualifier qualifier, List secondaryTypes, Qualifier scopeQualifier, int i, Object obj) {
        Kind kind2;
        List secondaryTypes2;
        if ((i & 1) != 0) {
            Kind kind3 = Kind.Singleton;
        ...
        return new BeanDefinition(scopeQualifier, orCreateKotlinClass, qualifier2, AnonymousClass1.INSTANCE, kind2, secondaryTypes2, null, 64, null);
    }
    ...
    public static final /* synthetic */ <T> BeanDefinition<T> _createDeclaredDefinition(Kind kind, Qualifier qualifier, List<? extends KClass<?>> secondaryTypes, Qualifier scopeQualifier) {
        ...
        KClass orCreateKotlinClass = Reflection.getOrCreateKotlinClass(Object.class);
        Intrinsics.needClassReification();
        return new BeanDefinition<>(scopeQualifier, orCreateKotlinClass, qualifier, AnonymousClass1.INSTANCE, kind, secondaryTypes, null, 64, null);
    }

    /* JADX INFO: Add missing generic type declarations: [T] */
    /* JADX INFO: renamed from: org.koin.core.definition.BeanDefinitionKt$_createDeclaredDefinition$1, reason: invalid class name */
    /* JADX INFO: compiled from: BeanDefinition.kt */
    @Metadata(k = 3, mv = {2, 3, 0}, xi = 176)
    public static final class AnonymousClass1<T> implements Function2<Scope, ParametersHolder, T> {
