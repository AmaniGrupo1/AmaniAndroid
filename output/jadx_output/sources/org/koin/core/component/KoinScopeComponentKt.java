...
/* JADX INFO: compiled from: KoinScopeComponent.kt */
...
public final class KoinScopeComponentKt {
    ...
    public static final <T extends KoinScopeComponent> Scope createScope(T t, String scopeId, Object source, TypeQualifier scopeArchetype) {
        Intrinsics.checkNotNullParameter(t, "<this>");
        Intrinsics.checkNotNullParameter(scopeId, "scopeId");
        return t.getKoin().createScope(scopeId, getScopeName(t), source, scopeArchetype);
    }
    ...
    public static final <T extends KoinScopeComponent> Scope createScope(T t, Object source) {
        Intrinsics.checkNotNullParameter(t, "<this>");
        return Koin.createScope$default(t.getKoin(), getScopeId(t), getScopeName(t), source, null, 8, null);
    }
    ...
    public static final <T extends KoinScopeComponent> Lazy<Scope> getOrCreateScope(final T t) {
        ...
        return LazyKt.lazy(new Function0() { // from class: org.koin.core.component.KoinScopeComponentKt$$ExternalSyntheticLambda1
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                return KoinScopeComponentKt.getOrCreateScope$lambda$0(t);
            }
        });
    }

    static final Scope getOrCreateScope$lambda$0(KoinScopeComponent $this_getOrCreateScope) {
