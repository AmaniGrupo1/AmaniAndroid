...
public final class KoinApplicationKt {
    ...
    public static final KoinApplication koinApplication(boolean createEagerInstances, Function1<? super KoinApplication, Unit> function1) {
    ...
    @KoinApplicationDslMarker
    public static final KoinApplication koinApplication(KoinConfiguration configuration) {
        return koinApplication(true, configuration != null ? configuration.invoke() : null);
    }

    @KoinApplicationDslMarker
    public static final KoinApplication koinApplication(boolean createEagerInstances) {
        return koinApplication(createEagerInstances, null);
    }
}
