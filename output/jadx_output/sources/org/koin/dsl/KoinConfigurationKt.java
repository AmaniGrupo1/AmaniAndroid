...
/* JADX INFO: compiled from: KoinConfiguration.kt */
...
public final class KoinConfigurationKt {
    ...
    public static final KoinApplication includes(KoinApplication $this$includes, Function1<? super KoinApplication, Unit>... configurations) {
        ...
        for (Function1<? super KoinApplication, Unit> function1 : configurations) {
            if (function1 != null) {
                function1.invoke($this$includes);
            }
        }
        return $this$includes;
    }

    public static final KoinApplication includes(KoinApplication $this$includes, KoinConfiguration... configurations) {
