...
public final class Retrofit {
    ...
    Retrofit(Call.Factory callFactory, HttpUrl baseUrl, List<Converter.Factory> converterFactories, int defaultConverterFactoriesSize, List<CallAdapter.Factory> callAdapterFactories, int defaultCallAdapterFactoriesSize, @Nullable Executor callbackExecutor, boolean validateEagerly) {
        ...
        return (T) Proxy.newProxyInstance(cls.getClassLoader(), new Class[]{cls}, new InvocationHandler() { // from class: retrofit2.Retrofit.1
            ...
            public Object invoke(Object proxy, Method method, @Nullable Object[] args) throws Throwable {
                ...
                if (reflection.isDefaultMethod(method)) {
                    return reflection.invokeDefaultMethod(method, cls, proxy, args2);
                }
                return Retrofit.this.loadServiceMethod(cls, method).invoke(proxy, args2);
            }
        });
    }
        ...
        while (true) {
            ...
            if (lookup == null) {
                ...
                synchronized (lock) {
                    ...
                    if (lookup == null) {
                        try {
                            ServiceMethod<?> annotations = ServiceMethod.parseAnnotations(this, service, method);
    ...
    public static final class Builder {
        ...
        public Retrofit build() {
            ...
            List<Converter.Factory> converterFactories = new ArrayList<>(this.converterFactories.size() + 1 + defaultConverterFactoriesSize);
            converterFactories.add(new BuiltInConverters());
            converterFactories.addAll(this.converterFactories);
            converterFactories.addAll(defaultConverterFactories);
            return new Retrofit(callFactory, this.baseUrl, Collections.unmodifiableList(converterFactories), defaultConverterFactoriesSize, Collections.unmodifiableList(callAdapterFactories), defaultCallAdapterFactories.size(), callbackExecutor, this.validateEagerly);
        }
    }
}
