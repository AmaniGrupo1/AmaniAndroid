...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
    ...
    */
    public long readDecimalLong() throws EOFException {
        ...
        loop0: while (true) {
            ...
            while (pos$iv < limit$iv) {
                ...
                if (b$iv < 48 || b$iv > 57) {
                    ...
                    if (value$iv < okio.internal.Buffer.OVERFLOW_ZONE) {
                        negative$iv2 = negative$iv3;
                        break loop0;
                    }
                    if (value$iv == okio.internal.Buffer.OVERFLOW_ZONE) {
                        negative$iv2 = negative$iv3;
            ...
            if (done$iv2 || this.head == null) {
                break;
            }
            j2 = j;
            negative$iv3 = negative$iv;
            $i$f$commonReadDecimalLong2 = $i$f$commonReadDecimalLong;
        }
        ...
        throw new NumberFormatException(expected$iv + " but was 0x" + SegmentedByteString.toHexString(getByte(j)));
    }
    ...
    */
    ...
    public <T> T select(TypedOptions<T> options) throws IOException {
        ...
        int index$iv = $this$commonSelect$iv.select(options.getOptions());
        if (index$iv == -1) {
            return null;
        }
        ...
        while (i$iv < endIndex) {
            ...
            if (c$iv < 128) {
                ...
                if (c$iv < 2048) {
                    ...
                    tail$iv2.data[tail$iv2.limit] = (byte) ((c$iv >> 6) | PsExtractor.AUDIO_STREAM);
                    ...
                    if (c$iv <= 56319) {
                        if (((56320 > low$iv || low$iv >= 57344) ? 0 : i2) != 0) {
                            ...
                            tail$iv4.data[tail$iv4.limit] = (byte) ((codePoint$iv >> 18) | PsExtractor.VIDEO_STREAM_MASK);
    ...
    public Buffer writeUtf8CodePoint(int codePoint) {
        if (codePoint < 128) {
            ...
            tail$iv.data[tail$iv.limit] = (byte) ((codePoint >> 6) | PsExtractor.AUDIO_STREAM);
            ...
            if (z) {
                ...
                tail$iv3.data[tail$iv3.limit] = (byte) ((codePoint >> 18) | PsExtractor.VIDEO_STREAM_MASK);
    ...
    public Buffer writeDecimalLong(long v) {
        ...
        if (v$iv < 100000000) {
            if (v$iv < 10000) {
                ...
                if (v$iv < SilenceSkippingAudioProcessor.DEFAULT_MINIMUM_SILENCE_DURATION_US) {
                    width$iv = 5;
                } else {
                    width$iv = 6;
                }
        ...
        } else if (v$iv < MediaPeriodQueue.INITIAL_RENDERER_POSITION_OFFSET_US) {
            if (v$iv < RealConnection.IDLE_CONNECTION_HEALTHY_NS) {
                if (v$iv < C.NANOS_PER_SECOND) {
                    width$iv = 9;
                } else {
                    width$iv = 10;
                }
    ...
    public final ByteString snapshot(int byteCount) {
        ...
        return new C0787SegmentedByteString(segments$iv, directory$iv);
    }
    ...
    public final byte m10302deprecated_getByte(long index) {
    ...
    /* JADX INFO: compiled from: Buffer.kt */
    @Metadata(d1 = {"\u0000:\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0012\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0010\t\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0006\n\u0002\u0010\u0002\n\u0002\b\u0007\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J\b\u0010\u0014\u001a\u00020\u0015H\u0016J\u000e\u0010\u0016\u001a\u00020\n2\u0006\u0010\u0017\u001a\u00020\bJ\u0006\u0010\u0018\u001a\u00020\bJ\u000e\u0010\u0019\u001a\u00020\n2\u0006\u0010\u001a\u001a\u00020\nJ\u000e\u0010\u001b\u001a\u00020\b2\u0006\u0010\t\u001a\u00020\nR\u0014\u0010\u0003\u001a\u0004\u0018\u00010\u00048\u0006@\u0006X\u0087\u000e¢\u0006\u0002\n\u0000R\u0014\u0010\u0005\u001a\u0004\u0018\u00010\u00068\u0006@\u0006X\u0087\u000e¢\u0006\u0002\n\u0000R\u0012\u0010\u0007\u001a\u00020\b8\u0006@\u0006X\u0087\u000e¢\u0006\u0002\n\u0000R\u0012\u0010\t\u001a\u00020\n8\u0006@\u0006X\u0087\u000e¢\u0006\u0002\n\u0000R\u0012\u0010\u000b\u001a\u00020\f8\u0006@\u0006X\u0087\u000e¢\u0006\u0002\n\u0000R\u001c\u0010\r\u001a\u0004\u0018\u00010\u000eX\u0080\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u000f\u0010\u0010\"\u0004\b\u0011\u0010\u0012R\u0012\u0010\u0013\u001a\u00020\b8\u0006@\u0006X\u0087\u000e¢\u0006\u0002\n\u0000¨\u0006\u001c"}, d2 = {"Lokio/Buffer$UnsafeCursor;", "Ljava/io/Closeable;", "()V", "buffer", "Lokio/Buffer;", "data", "", TtmlNode.END, "", "offset", "", "readWrite", "", "segment", "Lokio/Segment;", "getSegment$okio", "()Lokio/Segment;", "setSegment$okio", "(Lokio/Segment;)V", TtmlNode.START, "close", "", "expandBuffer", "minByteCount", "next", "resizeBuffer", "newSize", "seek", "okio"}, k = 1, mv = {1, 9, 0}, xi = 48)
