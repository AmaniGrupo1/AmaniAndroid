...
public class Timeout {
    ...
    public static final class Companion {
        ...
        public final Timeout m10325timeoutHG0u8IE(Timeout timeout, long duration) {
            Intrinsics.checkNotNullParameter(timeout, "$this$timeout");
            return timeout.timeout(Duration.m9906getInWholeNanosecondsimpl(duration), TimeUnit.NANOSECONDS);
        }
