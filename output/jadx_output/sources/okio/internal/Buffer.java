...
public final class Buffer {
    ...
    */
        ...
        loop0: while (true) {
            ...
            if (scanOrSelect2 < 0) {
                ...
                while (true) {
                    ...
                    if (($this$and$iv & 255) != trie[triePos3]) {
                        return prefixIndex;
                    }
                ...
                int i2 = $this$and$iv2 & 255;
                int selectLimit = triePos3 + scanOrSelect2;
                while (triePos3 != selectLimit) {
                    if (i2 == trie[triePos3]) {
                        int nextStep3 = trie[triePos3 + scanOrSelect2];
                        if (pos4 != limit) {
                            pos2 = pos4;
                            nextStep = nextStep3;
                        } else {
    ...
    public static final okio.Buffer commonWriteDecimalLong(okio.Buffer $this$commonWriteDecimalLong, long v) {
        ...
        if (v2 < 100000000) {
            if (v2 < 10000) {
                ...
                if (v2 < SilenceSkippingAudioProcessor.DEFAULT_MINIMUM_SILENCE_DURATION_US) {
                    width = 5;
                } else {
                    width = 6;
                }
        ...
        } else if (v2 < MediaPeriodQueue.INITIAL_RENDERER_POSITION_OFFSET_US) {
            if (v2 < RealConnection.IDLE_CONNECTION_HEALTHY_NS) {
                if (v2 < C.NANOS_PER_SECOND) {
                    width = 9;
                } else {
                    width = 10;
                }
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public static final long commonReadDecimalLong(okio.Buffer $this$commonReadDecimalLong) throws EOFException {
        ...
        loop0: while (true) {
            ...
            if (done2 || $this$commonReadDecimalLong.head == null) {
                break;
            }
            j2 = j;
            negative3 = negative;
        ...
        if ($this$commonReadDecimalLong.size() == j) {
            throw new EOFException();
        }
        String expected = negative ? "Expected a digit" : "Expected a digit or '-'";
        throw new NumberFormatException(expected + " but was 0x" + SegmentedByteString.toHexString($this$commonReadDecimalLong.getByte(j)));
    }
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public static final long commonReadHexadecimalUnsignedLong(okio.Buffer $this$commonReadHexadecimalUnsignedLong) throws EOFException {
        int digit;
        ...
        do {
            ...
            while (pos < limit) {
                ...
                if (((-1152921504606846976L) & value) != 0) {
                    okio.Buffer buffer = new okio.Buffer().writeHexadecimalUnsignedLong(value).writeByte((int) b);
        ...
        while (i2 < endIndex) {
            ...
            if (c < 128) {
                ...
                if (c < 2048) {
                    ...
                    tail2.data[tail2.limit] = (byte) ((c >> 6) | PsExtractor.AUDIO_STREAM);
                    ...
                    if (c <= 56319) {
                        if (((56320 > low || low >= 57344) ? 0 : i3) != 0) {
                            ...
                            tail4.data[tail4.limit] = (byte) ((codePoint >> 18) | PsExtractor.VIDEO_STREAM_MASK);
    ...
    public static final okio.Buffer commonWriteUtf8CodePoint(okio.Buffer $this$commonWriteUtf8CodePoint, int codePoint) {
        ...
        if (codePoint < 128) {
            ...
            tail.data[tail.limit] = (byte) ((codePoint >> 6) | PsExtractor.AUDIO_STREAM);
            ...
            if (z) {
                ...
                tail3.data[tail3.limit] = (byte) ((codePoint >> 18) | PsExtractor.VIDEO_STREAM_MASK);
    ...
    public static final ByteString commonSnapshot(okio.Buffer $this$commonSnapshot) {
        ...
        if (!($this$commonSnapshot.size() <= SieveCacheKt.NodeLinkMask)) {
    ...
    public static final ByteString commonSnapshot(okio.Buffer $this$commonSnapshot, int byteCount) {
        ...
        return new C0787SegmentedByteString(segments, directory);
    }
