...
import okio.C0787SegmentedByteString;
import okio.Segment;
...
public final class SegmentedByteString {
    ...
    public static final int segment(C0787SegmentedByteString $this$segment, int pos) {
    ...
    public static final void forEachSegment(C0787SegmentedByteString $this$forEachSegment, Function3<? super byte[], ? super Integer, ? super Integer, Unit> action) {
    ...
    private static final void forEachSegment(C0787SegmentedByteString $this$forEachSegment, int beginIndex, int endIndex, Function3<? super byte[], ? super Integer, ? super Integer, Unit> function3) {
    ...
    public static final ByteString commonSubstring(C0787SegmentedByteString $this$commonSubstring, int beginIndex, int endIndex) {
        ...
        return new C0787SegmentedByteString(newSegments, newDirectory);
    }

    public static final byte commonInternalGet(C0787SegmentedByteString $this$commonInternalGet, int pos) {
    ...
    public static final int commonGetSize(C0787SegmentedByteString $this$commonGetSize) {
    ...
    public static final byte[] commonToByteArray(C0787SegmentedByteString $this$commonToByteArray) {
    ...
    public static final void commonWrite(C0787SegmentedByteString $this$commonWrite, Buffer buffer, int offset, int byteCount) {
        int $i$f$commonWrite;
    ...
    public static final boolean commonRangeEquals(C0787SegmentedByteString $this$commonRangeEquals, int offset, ByteString other, int otherOffset, int byteCount) {
    ...
    public static final boolean commonRangeEquals(C0787SegmentedByteString $this$commonRangeEquals, int offset, byte[] other, int otherOffset, int byteCount) {
        Intrinsics.checkNotNullParameter($this$commonRangeEquals, "<this>");
        Intrinsics.checkNotNullParameter(other, "other");
    ...
    public static final void commonCopyInto(C0787SegmentedByteString $this$commonCopyInto, int offset, byte[] target, int targetOffset, int byteCount) {
    ...
    public static final boolean commonEquals(C0787SegmentedByteString $this$commonEquals, Object other) {
    ...
    public static final int commonHashCode(C0787SegmentedByteString $this$commonHashCode) {
