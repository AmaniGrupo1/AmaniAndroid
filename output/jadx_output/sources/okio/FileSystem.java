...
public abstract class FileSystem {
    ...
    public static /* synthetic */ Object m10314write$default(FileSystem $this, Path file, boolean mustCreate, Function1 writerAction, int i, Object obj) throws Throwable {
        Object result$iv;
        if (obj == null) {
            if ((i & 2) != 0) {
                mustCreate = false;
    ...
    public final <T> T m10315read(Path file, Function1<? super BufferedSource, ? extends T> readerAction) throws Throwable {
        T tInvoke;
        Intrinsics.checkNotNullParameter(file, "file");
    ...
    public final <T> T m10316write(Path file, boolean mustCreate, Function1<? super BufferedSink, ? extends T> writerAction) throws Throwable {
        T tInvoke;
        Intrinsics.checkNotNullParameter(file, "file");
        Intrinsics.checkNotNullParameter(writerAction, "writerAction");
