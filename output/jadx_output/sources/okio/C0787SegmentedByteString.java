...
public final class C0787SegmentedByteString extends ByteString {
    ...
    public C0787SegmentedByteString(byte[][] segments, int[] directory) {
    ...
    public ByteString substring(int beginIndex, int endIndex) {
        ...
        return new C0787SegmentedByteString(newSegments$iv, newDirectory$iv);
    }
    ...
    public void write$okio(Buffer buffer, int offset, int byteCount) {
        C0787SegmentedByteString $this$commonWrite$iv;
        Intrinsics.checkNotNullParameter(buffer, "buffer");
        C0787SegmentedByteString $this$commonWrite$iv2 = this;
    ...
    public boolean rangeEquals(int offset, ByteString other, int otherOffset, int byteCount) {
        ...
        C0787SegmentedByteString $this$commonRangeEquals$iv = this;
        ...
        while (pos$iv$iv < endIndex$iv$iv) {
            ...
            C0787SegmentedByteString $this$commonRangeEquals$iv2 = $this$commonRangeEquals$iv;
    ...
    public void copyInto(int offset, byte[] target, int targetOffset, int byteCount) {
        ...
        C0787SegmentedByteString $this$commonCopyInto$iv = this;
