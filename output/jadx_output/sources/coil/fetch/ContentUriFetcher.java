...
public final class ContentUriFetcher implements Fetcher {
    ...
    public Object fetch(Continuation<? super FetchResult> continuation) throws FileNotFoundException {
        ...
        if (isContactPhotoUri$coil_base_release(this.data)) {
            ...
            stream = assetFileDescriptorOpenAssetFileDescriptor != null ? assetFileDescriptorOpenAssetFileDescriptor.createInputStream() : null;
            if (stream == null) {
            ...
            AssetFileDescriptor assetFileDescriptorOpenTypedAssetFile = contentResolver.openTypedAssetFile(this.data, "image/*", bundle, null);
            stream = assetFileDescriptorOpenTypedAssetFile != null ? assetFileDescriptorOpenTypedAssetFile.createInputStream() : null;
            if (stream == null) {
