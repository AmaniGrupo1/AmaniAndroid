    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                Object objExecuteMain = realImageLoader$enqueue$job$1.this$0.executeMain(realImageLoader$enqueue$job$1.$request, 0, realImageLoader$enqueue$job$1);
                if (objExecuteMain == coroutine_suspended) {
                    return coroutine_suspended;
                }
                $result = objExecuteMain;
                break;
            case 1:
                ResultKt.throwOnFailure($result);
                realImageLoader$enqueue$job$1 = this;
