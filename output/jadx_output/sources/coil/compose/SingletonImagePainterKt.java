...
public final class SingletonImagePainterKt {
    ...
    public static final AsyncImagePainter rememberImagePainter(Object data, Composer $composer, int $changed) throws Throwable {
        $composer.startReplaceableGroup(1998134191);
        AsyncImagePainter asyncImagePainterM8244rememberAsyncImagePainterEHKIwbg = SingletonAsyncImagePainterKt.m8244rememberAsyncImagePainterEHKIwbg(data, null, null, null, 0, null, $composer, 8, 62);
        $composer.endReplaceableGroup();
        return asyncImagePainterM8244rememberAsyncImagePainterEHKIwbg;
    }
    ...
    public static final AsyncImagePainter rememberImagePainter(Object data, Function2<? super Triple<? extends AsyncImagePainter.State, ImageRequest, Size>, ? super Triple<? extends AsyncImagePainter.State, ImageRequest, Size>, Boolean> function2, Composer $composer, int $changed) throws Throwable {
    ...
    public static final AsyncImagePainter rememberImagePainter(Object data, Function1<? super ImageRequest.Builder, Unit> function1, Composer $composer, int $changed) throws Throwable {
        $composer.startReplaceableGroup(309201794);
        ProvidableCompositionLocal<Context> localContext = AndroidCompositionLocals_androidKt.getLocalContext();
        ComposerKt.sourceInformationMarkerStart($composer, 2023513938, "CC:CompositionLocal.kt#9igjgp");
        Object objConsume = $composer.consume(localContext);
        ComposerKt.sourceInformationMarkerEnd($composer);
        ImageRequest.Builder builderData = new ImageRequest.Builder((Context) objConsume).data(data);
        function1.invoke(builderData);
        AsyncImagePainter asyncImagePainterM8244rememberAsyncImagePainterEHKIwbg = SingletonAsyncImagePainterKt.m8244rememberAsyncImagePainterEHKIwbg(builderData.build(), null, null, null, 0, null, $composer, 8, 62);
        $composer.endReplaceableGroup();
        return asyncImagePainterM8244rememberAsyncImagePainterEHKIwbg;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "ImagePainter has been renamed to AsyncImagePainter.", replaceWith = @ReplaceWith(expression = "rememberAsyncImagePainter(ImageRequest.Builder(LocalContext.current).data(data).apply(builder).build())", imports = {"androidx.compose.ui.platform.LocalContext", "coil.compose.rememberAsyncImagePainter", "coil.request.ImageRequest"}))
    public static final AsyncImagePainter rememberImagePainter(Object data, Function2<? super Triple<? extends AsyncImagePainter.State, ImageRequest, Size>, ? super Triple<? extends AsyncImagePainter.State, ImageRequest, Size>, Boolean> function2, Function1<? super ImageRequest.Builder, Unit> function1, Composer $composer, int $changed) throws Throwable {
    ...
    public static final AsyncImagePainter rememberImagePainter(ImageRequest request, Composer $composer, int $changed) throws Throwable {
        $composer.startReplaceableGroup(2091320589);
        AsyncImagePainter asyncImagePainterM8244rememberAsyncImagePainterEHKIwbg = SingletonAsyncImagePainterKt.m8244rememberAsyncImagePainterEHKIwbg(request, null, null, null, 0, null, $composer, 8, 62);
        $composer.endReplaceableGroup();
        return asyncImagePainterM8244rememberAsyncImagePainterEHKIwbg;
    }
    ...
    public static final AsyncImagePainter rememberImagePainter(ImageRequest request, Function2<? super Triple<? extends AsyncImagePainter.State, ImageRequest, Size>, ? super Triple<? extends AsyncImagePainter.State, ImageRequest, Size>, Boolean> function2, Composer $composer, int $changed) throws Throwable {
