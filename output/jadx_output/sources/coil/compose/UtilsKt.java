...
public final class UtilsKt {
    private static final long ZeroConstraints = Constraints.INSTANCE.m7468fixedJhjzzOo(0, 0);
        ...
        if (placeholder != null || error != null || fallback != null) {
            return new Function1() { // from class: coil.compose.UtilsKt$$ExternalSyntheticLambda2
                ...
                public final Object invoke(Object obj) {
                    return UtilsKt.transformOf$lambda$4(placeholder, fallback, error, (AsyncImagePainter.State) obj);
                }
            };
        }
    ...
    static final AsyncImagePainter.State transformOf$lambda$4(Painter $placeholder, Painter $fallback, Painter $error, AsyncImagePainter.State state) {
        AsyncImagePainter.State.Error errorCopy$default;
        if (state instanceof AsyncImagePainter.State.Loading) {
            AsyncImagePainter.State.Loading loadingCopy = (AsyncImagePainter.State.Loading) state;
            if ($placeholder != null) {
                loadingCopy = loadingCopy.copy($placeholder);
            }
            return loadingCopy;
        }
        ...
        if (((AsyncImagePainter.State.Error) state).getResult().getThrowable() instanceof NullRequestDataException) {
            errorCopy$default = (AsyncImagePainter.State.Error) state;
            if ($fallback != null) {
                errorCopy$default = AsyncImagePainter.State.Error.copy$default(errorCopy$default, $fallback, null, 2, null);
            }
        } else {
            errorCopy$default = (AsyncImagePainter.State.Error) state;
            if ($error != null) {
                errorCopy$default = AsyncImagePainter.State.Error.copy$default(errorCopy$default, $error, null, 2, null);
            }
        }
    ...
    public static final Function1<AsyncImagePainter.State, Unit> onStateOf(final Function1<? super AsyncImagePainter.State.Loading, Unit> function1, final Function1<? super AsyncImagePainter.State.Success, Unit> function12, final Function1<? super AsyncImagePainter.State.Error, Unit> function13) {
        if (function1 != null || function12 != null || function13 != null) {
            return new Function1() { // from class: coil.compose.UtilsKt$$ExternalSyntheticLambda0
                @Override // kotlin.jvm.functions.Function1
                public final Object invoke(Object obj) {
                    return UtilsKt.onStateOf$lambda$5(function1, function12, function13, (AsyncImagePainter.State) obj);
                }
            };
        }
        return null;
    ...
    static final Unit onStateOf$lambda$5(Function1 $onLoading, Function1 $onSuccess, Function1 $onError, AsyncImagePainter.State state) {
        if (state instanceof AsyncImagePainter.State.Loading) {
            if ($onLoading != null) {
    ...
    public static final Modifier contentDescription(Modifier $this$contentDescription, final String contentDescription) {
        if (contentDescription != null) {
            return SemanticsModifierKt.semantics$default($this$contentDescription, false, new Function1() { // from class: coil.compose.UtilsKt$$ExternalSyntheticLambda1
                @Override // kotlin.jvm.functions.Function1
                public final Object invoke(Object obj) {
                    return UtilsKt.contentDescription$lambda$6(contentDescription, (SemanticsPropertyReceiver) obj);
                }
            }, 1, null);
        }
    ...
    static final Unit contentDescription$lambda$6(String $contentDescription, SemanticsPropertyReceiver $this$semantics) {
    ...
    public static final Size m8260toSizeOrNullBRTryo0(long $this$toSizeOrNull_u2dBRTryo0) {
        if (Constraints.m7462isZeroimpl($this$toSizeOrNull_u2dBRTryo0)) {
            return null;
        }
        Dimension width = Constraints.m7454getHasBoundedWidthimpl($this$toSizeOrNull_u2dBRTryo0) ? Dimensions.Dimension(Constraints.m7458getMaxWidthimpl($this$toSizeOrNull_u2dBRTryo0)) : Dimension.Undefined.INSTANCE;
        Dimension height = Constraints.m7453getHasBoundedHeightimpl($this$toSizeOrNull_u2dBRTryo0) ? Dimensions.Dimension(Constraints.m7457getMaxHeightimpl($this$toSizeOrNull_u2dBRTryo0)) : Dimension.Undefined.INSTANCE;
        return new Size(width, height);
    }

    /* JADX INFO: renamed from: constrainWidth-K40F9xA, reason: not valid java name */
    public static final float m8257constrainWidthK40F9xA(long $this$constrainWidth_u2dK40F9xA, float width) {
        return RangesKt.coerceIn(width, Constraints.m7460getMinWidthimpl($this$constrainWidth_u2dK40F9xA), Constraints.m7458getMaxWidthimpl($this$constrainWidth_u2dK40F9xA));
    }

    /* JADX INFO: renamed from: constrainHeight-K40F9xA, reason: not valid java name */
    public static final float m8256constrainHeightK40F9xA(long $this$constrainHeight_u2dK40F9xA, float height) {
        return RangesKt.coerceIn(height, Constraints.m7459getMinHeightimpl($this$constrainHeight_u2dK40F9xA), Constraints.m7457getMaxHeightimpl($this$constrainHeight_u2dK40F9xA));
    }
    ...
    public static final long m8259toIntSizeuvyYCjk(long $this$toIntSize_u2duvyYCjk) {
        return IntSizeKt.IntSize(MathKt.roundToInt(androidx.compose.ui.geometry.Size.m4521getWidthimpl($this$toIntSize_u2duvyYCjk)), MathKt.roundToInt(androidx.compose.ui.geometry.Size.m4518getHeightimpl($this$toIntSize_u2duvyYCjk)));
    }

    /* JADX INFO: renamed from: isPositive-uvyYCjk, reason: not valid java name */
    public static final boolean m8258isPositiveuvyYCjk(long $this$isPositive) {
        return ((double) androidx.compose.ui.geometry.Size.m4521getWidthimpl($this$isPositive)) >= 0.5d && ((double) androidx.compose.ui.geometry.Size.m4518getHeightimpl($this$isPositive)) >= 0.5d;
    }
