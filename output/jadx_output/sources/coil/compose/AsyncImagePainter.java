...
public final class AsyncImagePainter extends Painter implements RememberObserver {
    ...
    private final MutableStateFlow<Size> drawSize = StateFlowKt.MutableStateFlow(Size.m4509boximpl(Size.INSTANCE.m4530getZeroNHjbRc()));
    ...
    private int filterQuality = DrawScope.INSTANCE.m5274getDefaultFilterQualityfv9h1I();
    ...
    public AsyncImagePainter(ImageRequest request, ImageLoader imageLoader) {
        this.request = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(request, null, 2, null);
    ...
    public final void m8215setFilterQualityvDHp3xo$coil_compose_base_release(int i) {
    ...
    public long getIntrinsicSize() {
        ...
        return painter != null ? painter.getIntrinsicSize() : Size.INSTANCE.m4529getUnspecifiedNHjbRc();
    }

    @Override // androidx.compose.ui.graphics.painter.Painter
    protected void onDraw(DrawScope $this$onDraw) throws Throwable {
        this.drawSize.setValue(Size.m4509boximpl($this$onDraw.mo5271getSizeNHjbRc()));
        Painter $this$onDraw_u24lambda_u240 = getPainter();
        if ($this$onDraw_u24lambda_u240 != null) {
            $this$onDraw_u24lambda_u240.m5397drawx_KDEd0($this$onDraw, $this$onDraw.mo5271getSizeNHjbRc(), getAlpha(), getColorFilter());
        }
    }
        ...
        if (request.getDefined().getSizeResolver() == null) {
            $this$updateRequest_u24lambda_u243.size(new SizeResolver() { // from class: coil.compose.AsyncImagePainter$updateRequest$2$1
                ...
                public final Object size(Continuation<? super coil.size.Size> continuation) {
                    final Flow $this$mapNotNull$iv = this.this$0.drawSize;
                            ...
                            public final Object emit(Object value, Continuation $completion) {
                                ...
                                switch (anonymousClass1.label) {
                                    case 0:
                                        ...
                                        long it = ((Size) value).m4526unboximpl();
                                        coil.size.Size sizeM8222toSizeOrNulluvyYCjk = AsyncImagePainterKt.m8222toSizeOrNulluvyYCjk(it);
                                        if (sizeM8222toSizeOrNulluvyYCjk != null) {
                                            anonymousClass1.label = 1;
                                            Object transformed = $this$mapNotNull_u24lambda_u246.emit(sizeM8222toSizeOrNulluvyYCjk, anonymousClass1);
    ...
    public final void updateState(State input) {
        ...
        set_state(current);
        CrossfadePainter crossfadePainterMaybeNewCrossfadePainter = maybeNewCrossfadePainter(previous, current);
        set_painter(crossfadePainterMaybeNewCrossfadePainter != null ? crossfadePainterMaybeNewCrossfadePainter : current.getPainter());
    ...
    private final CrossfadePainter maybeNewCrossfadePainter(State previous, State current) {
        ...
        Transition transition = result.getRequest().getTransitionFactory().create(AsyncImagePainterKt.fakeTransitionTarget, result);
    ...
    public final Painter toPainter(Drawable $this$toPainter) {
        return $this$toPainter instanceof BitmapDrawable ? BitmapPainterKt.m5394BitmapPainterQZhYCtY$default(AndroidImageBitmap_androidKt.asImageBitmap(((BitmapDrawable) $this$toPainter).getBitmap()), 0L, 0L, this.filterQuality, 6, null) : new DrawablePainter($this$toPainter.mutate());
    }
    ...
    static final State DefaultTransform$lambda$5(State it) {
        return it;
    }
}
