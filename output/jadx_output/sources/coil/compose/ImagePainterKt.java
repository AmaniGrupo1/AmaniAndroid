...
public final class ImagePainterKt {
    ...
    public static final AsyncImagePainter rememberImagePainter(Object data, ImageLoader imageLoader, Composer $composer, int $changed) throws Throwable {
        $composer.startReplaceableGroup(699722038);
        AsyncImagePainter asyncImagePainterM8217rememberAsyncImagePainter0YpotYA = AsyncImagePainterKt.m8217rememberAsyncImagePainter0YpotYA(data, imageLoader, null, null, null, 0, null, $composer, 72, 124);
    ...
    public static final AsyncImagePainter rememberImagePainter(Object data, ImageLoader imageLoader, Function2<? super Triple<? extends AsyncImagePainter.State, ImageRequest, Size>, ? super Triple<? extends AsyncImagePainter.State, ImageRequest, Size>, Boolean> function2, Composer $composer, int $changed) throws Throwable {
    ...
    public static final AsyncImagePainter rememberImagePainter(Object data, ImageLoader imageLoader, Function1<? super ImageRequest.Builder, Unit> function1, Composer $composer, int $changed) throws Throwable {
        ...
        AsyncImagePainter asyncImagePainterM8217rememberAsyncImagePainter0YpotYA = AsyncImagePainterKt.m8217rememberAsyncImagePainter0YpotYA(builderData.build(), imageLoader, null, null, null, 0, null, $composer, 72, 124);
        $composer.endReplaceableGroup();
        return asyncImagePainterM8217rememberAsyncImagePainter0YpotYA;
    }
    ...
    public static final AsyncImagePainter rememberImagePainter(ImageRequest request, ImageLoader imageLoader, Composer $composer, int $changed) throws Throwable {
        $composer.startReplaceableGroup(-2028135656);
        AsyncImagePainter asyncImagePainterM8217rememberAsyncImagePainter0YpotYA = AsyncImagePainterKt.m8217rememberAsyncImagePainter0YpotYA(request, imageLoader, null, null, null, 0, null, $composer, 72, 124);
        $composer.endReplaceableGroup();
        return asyncImagePainterM8217rememberAsyncImagePainter0YpotYA;
    }
    ...
    public static final AsyncImagePainter rememberImagePainter(ImageRequest request, ImageLoader imageLoader, Function2<? super Triple<? extends AsyncImagePainter.State, ImageRequest, Size>, ? super Triple<? extends AsyncImagePainter.State, ImageRequest, Size>, Boolean> function2, Composer $composer, int $changed) throws Throwable {
