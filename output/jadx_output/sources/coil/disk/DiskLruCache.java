    ...
    */
    private final void readJournal() throws Throwable {
        ...
        try {
            ...
            String magic = it$iv.readUtf8LineStrict();
            String version = it$iv.readUtf8LineStrict();
            String appVersionString = it$iv.readUtf8LineStrict();
            String valueCountString = it$iv.readUtf8LineStrict();
            String blank = it$iv.readUtf8LineStrict();
            try {
                if (!Intrinsics.areEqual(MAGIC, magic)) {
                    throw new IOException("unexpected journal header: [" + magic + ", " + version + ", " + appVersionString + ", " + valueCountString + ", " + blank + AbstractJsonLexerKt.END_LIST);
                }
                try {
                    if (Intrinsics.areEqual("1", version) && Intrinsics.areEqual(String.valueOf(this.appVersion), appVersionString) && Intrinsics.areEqual(String.valueOf(this.valueCount), valueCountString)) {
                        if (!(blank.length() > 0)) {
                            int lineCount = 0;
                            while (true) {
                                try {
                                    readJournalLine(it$iv.readUtf8LineStrict());
                                    lineCount++;
    ...
    static final Unit newJournalWriter$lambda$3(DiskLruCache this$0, IOException it) {
    ...
    private final void readJournalLine(String line) throws IOException {
        ...
        if (secondSpace != -1 && firstSpace == 5 && StringsKt.startsWith$default(line, CLEAN, false, 2, (Object) null)) {
            ...
            entry3.setLengths(listSplit$default);
            return;
        }
    ...
    public final synchronized void writeJournal() {
        ...
        try {
            ...
            it$iv.writeUtf8("1").writeByte(10);
    ...
    public final synchronized void completeEdit(Editor editor, boolean success) {
        ...
        if (success && !entry.getZombie()) {
            ...
            for (int i4 = 0; i4 < i3; i4++) {
                ...
                boolean zExists = exists(dirty);
                DiskLruCache$fileSystem$1 diskLruCache$fileSystem$1 = this.fileSystem;
                if (zExists) {
                    diskLruCache$fileSystem$1.atomicMove(dirty, clean);
                } else {
                    FileSystems.createFile(diskLruCache$fileSystem$1, entry.getCleanFiles().get(i4));
                }
            ...
            switch (this.label) {
                case 0:
                    ...
                    synchronized (diskLruCache) {
                        if (diskLruCache2.initialized && !diskLruCache2.closed) {
                            try {
                            ...
                            try {
                                if (diskLruCache2.journalRewriteRequired()) {
    ...
    public final class Snapshot implements Closeable {
        ...
        public final Editor closeAndEdit() {
            ...
            synchronized (diskLruCache) {
                close();
                editorEdit = diskLruCache2.edit(this.entry.getKey());
            }
            return editorEdit;
        }
    }
    ...
    /* JADX INFO: compiled from: DiskLruCache.kt */
    @Metadata(d1 = {"\u0000@\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\u0018\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\b\u0086\u0004\u0018\u00002\u00020\u0001B\u0013\u0012\n\u0010\u0002\u001a\u00060\u0003R\u00020\u0004¢\u0006\u0004\b\u0005\u0010\u0006J\u000e\u0010\u000f\u001a\u00020\u00102\u0006\u0010\u0011\u001a\u00020\u0012J\u0006\u0010\u0013\u001a\u00020\u0014J\u0006\u0010\u0015\u001a\u00020\u0014J\f\u0010\u0016\u001a\b\u0018\u00010\u0017R\u00020\u0004J\u0006\u0010\u0018\u001a\u00020\u0014J\u0010\u0010\u0019\u001a\u00020\u00142\u0006\u0010\u001a\u001a\u00020\nH\u0002R\u0015\u0010\u0002\u001a\u00060\u0003R\u00020\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0007\u0010\bR\u000e\u0010\t\u001a\u00020\nX\u0082\u000e¢\u0006\u0002\n\u0000R\u0011\u0010\u000b\u001a\u00020\f¢\u0006\b\n\u0000\u001a\u0004\b\r\u0010\u000e¨\u0006\u001b"}, d2 = {"Lcoil/disk/DiskLruCache$Editor;", "", "entry", "Lcoil/disk/DiskLruCache$Entry;", "Lcoil/disk/DiskLruCache;", "<init>", "(Lcoil/disk/DiskLruCache;Lcoil/disk/DiskLruCache$Entry;)V", "getEntry", "()Lcoil/disk/DiskLruCache$Entry;", "closed", "", "written", "", "getWritten", "()[Z", "file", "Lokio/Path;", "index", "", "detach", "", "commit", "commitAndGet", "Lcoil/disk/DiskLruCache$Snapshot;", "abort", "complete", "success", "coil-base_release"}, k = 1, mv = {2, 0, 0}, xi = 48)
