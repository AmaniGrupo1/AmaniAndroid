...
public final class ImageRequest {
    ...
    public static final class Builder {
        ...
        public final Builder memoryCacheKey(String key) {
            ...
            if (key != null) {
                key2 = new MemoryCache.Key(key, null, 2, null);
            }
        ...
        public final <T> Builder fetcherFactory(Fetcher.Factory<T> factory, Class<T> type) {
            ...
            $this$fetcherFactory_u24lambda_u2416.fetcherFactory = TuplesKt.to(factory, type);
            return this;
        }
        ...
        public final <T> Builder tag(Class<? super T> type, T tag) {
            ...
            LinkedHashMap linkedHashMap = $this$tag_u24lambda_u2432.tags;
            if (tag == null) {
                ...
                if (linkedHashMap == null) {
                    ...
                    $this$tag_u24lambda_u2432.tags = linkedHashMap;
                }
        ...
        public final ImageRequest build() {
            ...
            if (map != null) {
                ...
                tagsFrom = Tags.INSTANCE.from(map);
            } else {
                headers = headersOrEmpty;
                tagsFrom = null;
            }
            Tags tagsOrEmpty = Utils.orEmpty(tagsFrom);
