...
public final class ViewTargetRequestManager implements View.OnAttachStateChangeListener {
    ...
    public final synchronized ViewTargetDisposable getDisposable(Deferred<? extends ImageResult> job) {
        ViewTargetDisposable disposable = this.currentDisposable;
        if (disposable != null && Utils.isMainThread() && this.isRestart) {
            this.isRestart = false;
            disposable.setJob(job);
            return disposable;
        }
        ...
        ViewTargetDisposable it = new ViewTargetDisposable(this.view, job);
        this.currentDisposable = it;
        return it;
    }
    ...
    public void onViewAttachedToWindow(View v) {
        ViewTargetRequestDelegate request = this.currentRequest;
        if (request == null) {
            return;
        }
        this.isRestart = true;
