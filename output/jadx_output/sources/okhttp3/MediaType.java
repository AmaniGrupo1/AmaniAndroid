...
public final class MediaType {
    ...
    public static final class Companion {
        ...
        */
        public final MediaType get(String $this$toMediaType) {
            ...
            while (s2 < s) {
                ...
                if (!parameter.lookingAt()) {
                    ...
                    throw new IllegalArgumentException(sbAppend.append(strSubstring).append("\" for: \"").append($this$toMediaType).append('\"').toString().toString());
                }
            ...
            return new MediaType($this$toMediaType, type, subtype, (String[]) $this$toTypedArray$iv.toArray(new String[0]), null);
        }
        ...
        public final MediaType m10244deprecated_get(String mediaType) {
        ...
        public final MediaType m10245deprecated_parse(String mediaType) {
            Intrinsics.checkNotNullParameter(mediaType, "mediaType");
