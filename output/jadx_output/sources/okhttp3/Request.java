...
public final class Request {
    ...
    public final CacheControl m10281deprecated_cacheControl() {
        return cacheControl();
    }
    ...
    public String toString() {
        ...
        if (this.headers.size() != 0) {
            ...
            for (Object item$iv : $this$forEachIndexed$iv) {
                ...
                $this$toString_u24lambda_u241.append(AbstractJsonLexerKt.COLON);
                $this$toString_u24lambda_u241.append(value);
                index = index$iv;
            }
            $this$toString_u24lambda_u241.append(AbstractJsonLexerKt.END_LIST);
        }
        if (!this.tags.isEmpty()) {
            $this$toString_u24lambda_u241.append(", tags=");
            $this$toString_u24lambda_u241.append(this.tags);
        }
        $this$toString_u24lambda_u241.append(AbstractJsonLexerKt.END_OBJ);
    ...
    public static class Builder {
        ...
        public Builder post(RequestBody body) {
            ...
            return method(GrpcUtil.HTTP_METHOD, body);
        }
