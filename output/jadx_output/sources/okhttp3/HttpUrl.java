...
public final class HttpUrl {
    ...
    public final String m10224deprecated_encodedUsername() {
    ...
    public final String m10220deprecated_encodedPassword() {
    ...
    public static final class Builder {
        ...
        */
        public String toString() {
            ...
            if (this.encodedUsername.length() > 0) {
                ...
                if (this.encodedPassword.length() > 0) {
                    $this$toString_u24lambda_u2431.append(AbstractJsonLexerKt.COLON);
            ...
            if (this.host != null) {
                ...
                if (StringsKt.contains$default((CharSequence) str, AbstractJsonLexerKt.COLON, false, 2, (Object) null)) {
                    $this$toString_u24lambda_u2431.append(AbstractJsonLexerKt.BEGIN_LIST);
                    $this$toString_u24lambda_u2431.append(this.host);
                    $this$toString_u24lambda_u2431.append(AbstractJsonLexerKt.END_LIST);
                } else {
                    $this$toString_u24lambda_u2431.append(this.host);
                }
            }
            if (this.port != -1 || this.scheme != null) {
                ...
                if (this.scheme != null) {
                    ...
                    if (effectivePort != companion.defaultPort(str2)) {
                        $this$toString_u24lambda_u2431.append(AbstractJsonLexerKt.COLON);
            ...
            String string = $this$toString_u24lambda_u2431.toString();
                    ...
                    switch (c) {
                        ...
                        case 64:
                            if (hasPassword) {
                                ...
                                this.encodedPassword += "%40" + Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, input2, pos4, componentDelimiterOffset3, " \"':;<=>@[]^`{}|/\\?#", true, false, false, false, null, PsExtractor.VIDEO_STREAM_MASK, null);
                            } else {
                                int passwordColonOffset = Util.delimiterOffset(input2, AbstractJsonLexerKt.COLON, pos4, componentDelimiterOffset3);
                                z = z2;
                                str2 = str3;
                                slashCount = slashCount2;
                                limit2 = limit4;
                                limit3 = i;
                                schemeDelimiterOffset = schemeDelimiterOffset2;
                                String canonicalUsername = Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, input2, pos4, passwordColonOffset, " \"':;<=>@[]^`{}|/\\?#", true, false, false, false, null, PsExtractor.VIDEO_STREAM_MASK, null);
                                ...
                                if (passwordColonOffset != componentDelimiterOffset3) {
                                    ...
                                    this.encodedPassword = Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, input, passwordColonOffset + 1, componentDelimiterOffset2, " \"':;<=>@[]^`{}|/\\?#", true, false, false, false, null, PsExtractor.VIDEO_STREAM_MASK, null);
                                } else {
                                    componentDelimiterOffset2 = componentDelimiterOffset3;
                                }
                                input2 = input;
        ...
        private final void push(String input, int pos, int limit, boolean addTrailingSlash, boolean alreadyEncoded) {
            String segment = Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, input, pos, limit, HttpUrl.PATH_SEGMENT_ENCODE_SET, alreadyEncoded, false, false, false, null, PsExtractor.VIDEO_STREAM_MASK, null);
            if (isDot(segment)) {
                return;
            }
            if (isDotDot(segment)) {
    ...
    public static final class Companion {
        ...
        public final HttpUrl m10238deprecated_get(String url) {
            Intrinsics.checkNotNullParameter(url, "url");
            return get(url);
        }
        ...
        public final HttpUrl m10241deprecated_parse(String url) {
            Intrinsics.checkNotNullParameter(url, "url");
            return parse(url);
        }
        ...
        @Deprecated(level = DeprecationLevel.ERROR, message = "moved to extension function", replaceWith = @ReplaceWith(expression = "url.toHttpUrlOrNull()", imports = {"okhttp3.HttpUrl.Companion.toHttpUrlOrNull"}))
        /* JADX INFO: renamed from: -deprecated_get, reason: not valid java name */
        public final HttpUrl m10240deprecated_get(URL url) {
            Intrinsics.checkNotNullParameter(url, "url");
            return get(url);
        }
        ...
        /* JADX INFO: renamed from: -deprecated_get, reason: not valid java name */
        public final HttpUrl m10239deprecated_get(URI uri) {
