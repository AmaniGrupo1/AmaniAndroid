...
public final class TaskLoggerKt {
    ...
    public static final String formatDuration(long ns) {
        ...
        if (ns <= -999500000) {
            ...
            s = ((ns - ((long) LogSeverity.ERROR_VALUE)) / ((long) 1000)) + " µs";
        } else if (ns < 999500) {
            s = ((((long) LogSeverity.ERROR_VALUE) + ns) / ((long) 1000)) + " µs";
        } else {
            s = ns < 999500000 ? ((((long) 500000) + ns) / ((long) 1000000)) + " ms" : ((((long) 500000000) + ns) / ((long) 1000000000)) + " s ";
        }
        StringCompanionObject stringCompanionObject = StringCompanionObject.INSTANCE;
