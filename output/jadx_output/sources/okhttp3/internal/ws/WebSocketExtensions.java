...
public final /* data */ class WebSocketExtensions {
    ...
    public static final class Companion {
        ...
        public final WebSocketExtensions parse(Headers responseHeaders) throws IOException {
            ...
            while (i < size) {
                boolean z = true;
                if (StringsKt.equals(responseHeaders2.name(i), "Sec-WebSocket-Extensions", true)) {
                    String header2 = responseHeaders2.value(i);
                    int pos = 0;
                    while (pos < header2.length()) {
                        int pos2 = pos;
                        int extensionEnd2 = Util.delimiterOffset$default(header2, AbstractJsonLexerKt.COMMA, pos2, 0, 4, (Object) null);
