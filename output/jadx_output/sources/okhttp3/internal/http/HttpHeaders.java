    ...
    */
    private static final void readChallengeHeader(Buffer $this$readChallengeHeader, List<Challenge> list) throws EOFException {
        ...
        while (true) {
            ...
            int eqCount = Util.skipAll($this$readChallengeHeader, Base64.padSymbol);
            ...
            if (!commaPrefixed && (commaSuffixed || $this$readChallengeHeader.exhausted())) {
                ...
                int eqCount2 = eqCount + Util.skipAll($this$readChallengeHeader, Base64.padSymbol);
                while (true) {
                    if (peek == null) {
                        peek = readToken($this$readChallengeHeader);
                        if (!skipCommasAndWhitespace($this$readChallengeHeader)) {
                            eqCount2 = Util.skipAll($this$readChallengeHeader, Base64.padSymbol);
                            if (eqCount2 != 0) {
                                break;
                            }
    ...
    public static final boolean promisesBody(Response $this$promisesBody) {
        ...
        return (((responseCode >= 100 && responseCode < 200) || responseCode == 204 || responseCode == 304) && Util.headersContentLength($this$promisesBody) == -1 && !StringsKt.equals("chunked", Response.header$default($this$promisesBody, com.google.common.net.HttpHeaders.TRANSFER_ENCODING, null, 2, null), true)) ? false : true;
    }
