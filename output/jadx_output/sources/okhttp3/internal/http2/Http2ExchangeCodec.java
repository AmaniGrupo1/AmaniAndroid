...
public final class Http2ExchangeCodec implements ExchangeCodec {
    ...
    public static final class Companion {
        ...
        public final List<Header> http2HeadersList(Request request) {
            ...
            String host = request.header(com.google.common.net.HttpHeaders.HOST);
            if (host != null) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                if (!Http2ExchangeCodec.HTTP_2_SKIPPED_REQUEST_HEADERS.contains(name) || (Intrinsics.areEqual(name, Http2ExchangeCodec.TE) && Intrinsics.areEqual(headers.value(i), GrpcUtil.TE_TRAILERS))) {
