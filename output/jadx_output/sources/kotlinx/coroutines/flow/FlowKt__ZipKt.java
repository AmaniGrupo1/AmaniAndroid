                ...
                public final Object invokeSuspend(Object $result) {
                    ...
                    switch (this.label) {
                        case 0:
                            ...
                            this.label = 1;
                            Object objInvoke = function4.invoke(obj, obj2, obj3, this);
                            ...
                            this.L$0 = null;
                            this.label = 2;
                            return flowCollector.emit($result, this) != coroutine_suspended ? coroutine_suspended : Unit.INSTANCE;
                        case 1:
                            flowCollector = (FlowCollector) this.L$0;
                            ResultKt.throwOnFailure($result);
                            $result2 = $result;
                ...
                public final Object invokeSuspend(Object $result) {
                    ...
                    switch (this.label) {
                        case 0:
                            ...
                            Object objInvoke = function5.invoke(obj, obj2, obj3, obj4, anonymousClass2);
                            if (objInvoke == coroutine_suspended) {
                                return coroutine_suspended;
                            }
                            $result2 = $result;
                            ...
                            return flowCollector.emit($result, anonymousClass2) != coroutine_suspended ? coroutine_suspended : Unit.INSTANCE;
                        case 1:
                            flowCollector = (FlowCollector) this.L$0;
                            ResultKt.throwOnFailure($result);
                            anonymousClass2 = this;
                            ...
                            anonymousClass2.L$0 = null;
                            anonymousClass2.label = 2;
                            if (flowCollector.emit($result, anonymousClass2) != coroutine_suspended) {
                            }
                            break;
                        case 2:
                            ResultKt.throwOnFailure($result);
                ...
                public final Object invokeSuspend(Object $result) {
                    ...
                    switch (this.label) {
                        case 0:
                            ...
                            this.label = 1;
                            anonymousClass2 = this;
                            Object objInvoke = function6.invoke(obj, obj2, obj3, obj4, obj5, anonymousClass2);
                            if (objInvoke == coroutine_suspended) {
                                return coroutine_suspended;
                            }
                            $result2 = $result;
