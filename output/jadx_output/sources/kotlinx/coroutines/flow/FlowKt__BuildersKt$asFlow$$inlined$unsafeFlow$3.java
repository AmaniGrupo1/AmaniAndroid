    ...
    public Object collect(FlowCollector<? super T> flowCollector, Continuation<? super Unit> continuation) {
        ...
        switch (anonymousClass1.label) {
            ...
            case 1:
                ...
                $this$asFlow_u24lambda_u243 = (FlowCollector) anonymousClass1.L$0;
                ResultKt.throwOnFailure($result);
                break;
            default:
        ...
        while (it.hasNext()) {
            T next = it.next();
            anonymousClass1.L$0 = $this$asFlow_u24lambda_u243;
            anonymousClass1.L$1 = it;
            anonymousClass1.label = 1;
            Object value = $this$asFlow_u24lambda_u243.emit(next, anonymousClass1);
