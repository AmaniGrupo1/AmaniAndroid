...
public final class FlowKt__TransformKt$filterNot$$inlined$unsafeTransform$1<T> implements Flow<T> {
    ...
    public static final class AnonymousClass2<T> implements FlowCollector {
        ...
        @Metadata(k = 3, mv = {2, 1, 0}, xi = 176)
        @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__TransformKt$filterNot$$inlined$unsafeTransform$1$2", f = "Transform.kt", i = {0, 0}, l = {50, 50}, m = "emit", n = {Values.VECTOR_MAP_VECTORS_KEY, "$this$filterNot_u24lambda_u241"}, s = {"L$0", "L$1"})
