...
final /* synthetic */ class FlowKt__CountKt {
    ...
    /* JADX INFO: compiled from: Count.kt */
    @Metadata(k = 3, mv = {2, 1, 0}, xi = 48)
    @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__CountKt", f = "Count.kt", i = {0}, l = {25}, m = "count", n = {CmcdData.OBJECT_TYPE_INIT_SEGMENT}, s = {"L$0"})
        ...
        public final Object emit(T t, Continuation<? super Unit> continuation) {
            ...
            switch (flowKt__CountKt$count$4$emit$1.label) {
                case 0:
                    ...
                    break;
                case 1:
                    AnonymousClass4<T> anonymousClass42 = (AnonymousClass4) flowKt__CountKt$count$4$emit$1.L$0;
                    ResultKt.throwOnFailure($result);
