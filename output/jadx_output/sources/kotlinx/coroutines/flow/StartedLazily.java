...
final class StartedLazily implements SharingStarted {
    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function2<FlowCollector<? super SharingCommand>, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    this.label = 1;
                    if (this.$subscriptionCount.collect(new C01801(started, $this$flow), this) == coroutine_suspended) {
        ...
        static final class C01801<T> implements FlowCollector {
            ...
            C01801(Ref.BooleanRef booleanRef, FlowCollector<? super SharingCommand> flowCollector) {
            ...
            */
            public final Object emit(int count, Continuation<? super Unit> continuation) {
                ...
                Object $result = startedLazily$command$1$1$emit$1.result;
                Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
                switch (startedLazily$command$1$1$emit$1.label) {
                    case 0:
                        ResultKt.throwOnFailure($result);
