    ...
    public final Object invokeSuspend(Object obj) {
        ...
        try {
                    ...
                    FlowCollector flowCollector = new FlowCollector() { // from class: kotlinx.coroutines.flow.FlowKt__ShareKt$launchSharingDeferred$1.1
                        ...
                        public final Object emit(T t, Continuation<? super Unit> continuation) {
                            ...
                            if (mutableStateFlow != null) {
                                ...
                                completableDeferred2.complete(Result.m8541boximpl(Result.m8542constructorimpl(new ReadonlyStateFlow((StateFlow) t2, JobKt.getJob(coroutineScope2.getCoroutineContext())))));
            ...
            if (objectRef.element == 0) {
                ...
                Result.Companion companion = Result.INSTANCE;
                completableDeferred2.complete((Result<StateFlow<T>>) Result.m8541boximpl(Result.m8542constructorimpl(ResultKt.createFailure(new NoSuchElementException("Flow is empty")))));
            }
            return Unit.INSTANCE;
        } catch (Throwable th) {
