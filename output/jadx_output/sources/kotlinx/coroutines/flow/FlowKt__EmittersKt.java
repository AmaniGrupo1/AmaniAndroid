...
final /* synthetic */ class FlowKt__EmittersKt {
    ...
    public static final class AnonymousClass1<R> extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
        ...
        public static final class C01791<T> implements FlowCollector {
            ...
            /* JADX WARN: Multi-variable type inference failed */
            public C01791(Function3<? super FlowCollector<? super R>, ? super T, ? super Continuation<? super Unit>, ? extends Object> function3, FlowCollector<? super R> flowCollector) {
                this.$transform = function3;
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    C01791 c01791 = new C01791(this.$transform, flowCollector);
                    this.label = 1;
                    if (flow.collect(c01791, this) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    break;
                case 1:
        ...
        public final Object invokeSuspend$$forInline(Object obj) {
            FlowCollector flowCollector = (FlowCollector) this.L$0;
            this.$this_transform.collect(new C01791(this.$transform, flowCollector), this);
            return Unit.INSTANCE;
        }
    }
