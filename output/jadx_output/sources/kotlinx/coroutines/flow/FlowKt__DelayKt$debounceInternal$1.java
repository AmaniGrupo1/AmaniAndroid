...
final class FlowKt__DelayKt$debounceInternal$1<T> extends SuspendLambda implements Function3<CoroutineScope, FlowCollector<? super T>, Continuation<? super Unit>, Object> {
    ...
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:52:0x0142 -> B:53:0x0146). Please report as a decompilation issue!!! */
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                FlowCollector downstream4 = (FlowCollector) this.L$1;
                ReceiveChannel values3 = ProduceKt.produce$default($this$scopedFlow, null, 0, new FlowKt__DelayKt$debounceInternal$1$values$1(this.$this_debounceInternal, null), 3, null);
                values = values3;
                lastValue = new Ref.ObjectRef();
                downstream = downstream4;
                ...
                if (lastValue.element != NullSurrogateKt.DONE) {
                    ...
                    if (lastValue.element != null) {
                        ...
                        if (timeoutMillis.element == j) {
                            ...
                            ReceiveChannel receiveChannel = values;
                            lastValue2 = lastValue;
                            downstream2 = downstream;
                            values2 = receiveChannel;
                    ...
                    ReceiveChannel receiveChannel2 = values;
                    lastValue2 = lastValue;
                    downstream2 = downstream;
                    values2 = receiveChannel2;
                    if (DebugKt.getASSERTIONS_ENABLED()) {
                    }
                    $this$select_u24lambda_u240$iv = new SelectImplementation(flowKt__DelayKt$debounceInternal$1.get$context());
                ...
                break;
            case 1:
                Ref.LongRef timeoutMillis2 = (Ref.LongRef) this.L$3;
                ...
                flowKt__DelayKt$debounceInternal$1 = this;
                lastValue.element = null;
                ReceiveChannel receiveChannel3 = values;
                lastValue2 = lastValue;
                downstream2 = downstream;
                values2 = receiveChannel3;
                if (DebugKt.getASSERTIONS_ENABLED()) {
                }
                $this$select_u24lambda_u240$iv = new SelectImplementation(flowKt__DelayKt$debounceInternal$1.get$context());
                ...
                break;
            case 2:
                lastValue2 = (Ref.ObjectRef) this.L$2;
                values2 = (ReceiveChannel) this.L$1;
                downstream3 = (FlowCollector) this.L$0;
                ResultKt.throwOnFailure($result);
                flowKt__DelayKt$debounceInternal$12 = this;
                flowKt__DelayKt$debounceInternal$1 = flowKt__DelayKt$debounceInternal$12;
                lastValue = lastValue2;
                values = values2;
                downstream = downstream3;
