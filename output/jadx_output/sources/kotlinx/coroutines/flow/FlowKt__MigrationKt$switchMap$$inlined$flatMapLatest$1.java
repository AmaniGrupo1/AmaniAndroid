    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                this.L$0 = null;
                this.label = 2;
                return FlowKt.emitAll(flowCollector, (Flow) $result, this) != coroutine_suspended ? coroutine_suspended : Unit.INSTANCE;
            case 1:
                ...
                this.L$0 = null;
                this.label = 2;
                if (FlowKt.emitAll(flowCollector, (Flow) $result, this) != coroutine_suspended) {
                }
                break;
            case 2:
                ResultKt.throwOnFailure($result);
