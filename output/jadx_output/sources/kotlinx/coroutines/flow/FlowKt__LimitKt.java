...
final /* synthetic */ class FlowKt__LimitKt {
    ...
    */
    public static final <T> Object emitAbort$FlowKt__LimitKt(FlowCollector<? super T> flowCollector, T t, Object ownershipMarker, Continuation<? super Unit> continuation) {
        ...
        Object $result = flowKt__LimitKt$emitAbort$1.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        switch (flowKt__LimitKt$emitAbort$1.label) {
            case 0:
                ResultKt.throwOnFailure($result);
                flowKt__LimitKt$emitAbort$1.L$0 = ownershipMarker;
                ...
                break;
            case 1:
                ownershipMarker2 = flowKt__LimitKt$emitAbort$1.L$0;
                ResultKt.throwOnFailure($result);
                break;
            default:
    ...
    static final class C07651<R> extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
        ...
        C07651(Flow<? extends T> flow, Function3<? super FlowCollector<? super R>, ? super T, ? super Continuation<? super Boolean>, ? extends Object> function3, Continuation<? super C07651> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C07651 c07651 = new C07651(this.$this_transformWhile, this.$transform, continuation);
            c07651.L$0 = obj;
            return c07651;
        }
        ...
        public final Object invoke(FlowCollector<? super R> flowCollector, Continuation<? super Unit> continuation) {
            return ((C07651) create(flowCollector, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final <T, R> Flow<R> transformWhile(Flow<? extends T> flow, Function3<? super FlowCollector<? super R>, ? super T, ? super Continuation<? super Boolean>, ? extends Object> function3) {
        return FlowKt.flow(new C07651(flow, function3, null));
    }
    ...
    public static final <T> Object collectWhile(Flow<? extends T> flow, Function2<? super T, ? super Continuation<? super Boolean>, ? extends Object> function2, Continuation<? super Unit> continuation) {
        ...
        switch (anonymousClass1.label) {
            case 0:
                ...
                try {
                    anonymousClass1.L$0 = collector2;
                ...
                if (flow.collect(collector2, anonymousClass1) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                return Unit.INSTANCE;
            case 1:
                collector = (FlowKt__LimitKt$collectWhile$collector$1) anonymousClass1.L$0;
                try {
                    ResultKt.throwOnFailure($result);
                    break;
                } catch (AbortFlowException e2) {
