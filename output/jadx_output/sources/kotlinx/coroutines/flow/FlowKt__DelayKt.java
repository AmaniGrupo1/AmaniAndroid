...
final /* synthetic */ class FlowKt__DelayKt {
    ...
    public static final <T> Flow<T> m10089debounceHG0u8IE(Flow<? extends T> flow, long timeout) {
        return FlowKt.debounce(flow, DelayKt.m10039toDelayMillisLRDsOJo(timeout));
    }
    ...
    public static final long debounce$lambda$2$FlowKt__DelayKt(Function1 $timeout, Object emittedItem) {
        return DelayKt.m10039toDelayMillisLRDsOJo(((Duration) $timeout.invoke(emittedItem)).getRawValue());
    }
    ...
    static final class AnonymousClass2<T> extends SuspendLambda implements Function3<CoroutineScope, FlowCollector<? super T>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:13:0x00a4 -> B:14:0x00a9). Please report as a decompilation issue!!! */
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    values = values2;
                    receiveChannelFixedPeriodTicker = FlowKt.fixedPeriodTicker($this$scopedFlow, this.$periodMillis);
                    downstream = downstream2;
                    anonymousClass2 = this;
                    if (lastValue.element != NullSurrogateKt.DONE) {
                        SelectImplementation $this$select_u24lambda_u240$iv = new SelectImplementation(anonymousClass2.get$context());
    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function2<ProducerScope<? super Unit>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:17:0x0067 -> B:13:0x0044). Please report as a decompilation issue!!! */
    ...
    public static final <T> Flow<T> m10090sampleHG0u8IE(Flow<? extends T> flow, long period) {
        return FlowKt.sample(flow, DelayKt.m10039toDelayMillisLRDsOJo(period));
    }

    /* JADX INFO: renamed from: timeout-HG0u8IE, reason: not valid java name */
    public static final <T> Flow<T> m10091timeoutHG0u8IE(Flow<? extends T> flow, long timeout) {
        return m10092timeoutInternalHG0u8IE$FlowKt__DelayKt(flow, timeout);
    }

    /* JADX INFO: renamed from: timeoutInternal-HG0u8IE$FlowKt__DelayKt, reason: not valid java name */
    private static final <T> Flow<T> m10092timeoutInternalHG0u8IE$FlowKt__DelayKt(Flow<? extends T> flow, long timeout) {
