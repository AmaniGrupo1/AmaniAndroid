...
public class SharedFlowImpl<T> extends AbstractSharedFlow<SharedFlowSlot> implements MutableSharedFlow<T>, CancellableFlow<T>, FusibleFlow<T> {
        ...
        try {
            switch (anonymousClass1.label) {
                case 0:
                    ...
                    ?? r83 = flowCollector;
                    SharedFlowSlot sharedFlowSlotAllocateSlot = sharedFlowImpl2.allocateSlot();
                    boolean z = r83 instanceof SubscribedFlowCollector;
                    r8 = r83;
                    sharedFlowSlot = sharedFlowSlotAllocateSlot;
                    if (z) {
                        anonymousClass1.L$0 = sharedFlowImpl2;
                        anonymousClass1.L$1 = r83;
                        anonymousClass1.L$2 = sharedFlowSlotAllocateSlot;
                        anonymousClass1.label = 1;
                        Object objOnSubscription = ((SubscribedFlowCollector) r83).onSubscription(anonymousClass1);
                        r8 = r83;
                        sharedFlowSlot = sharedFlowSlotAllocateSlot;
                    ...
                    do {
                        ...
                        if (objTryTakeValue == SharedFlowKt.NO_VALUE) {
                            ...
                            if (r3.emit(objTryTakeValue, anonymousClass1) == coroutine_suspended) {
                                return coroutine_suspended;
                            }
                            ?? r7 = r3;
                            job = job2;
                    ...
                    } while (sharedFlowImpl2.awaitValue((SharedFlowSlot) flowCollector, anonymousClass1) != coroutine_suspended);
                    return coroutine_suspended;
                case 1:
                    SharedFlowSlot sharedFlowSlot2 = (SharedFlowSlot) anonymousClass1.L$2;
                ...
                case 2:
                    ...
                    r3 = (FlowCollector) anonymousClass1.L$1;
                    sharedFlowImpl2 = (SharedFlowImpl) anonymousClass1.L$0;
                    ResultKt.throwOnFailure(obj);
                    do {
                        objTryTakeValue = sharedFlowImpl2.tryTakeValue((SharedFlowSlot) flowCollector);
                    ...
                    return coroutine_suspended;
                case 3:
                    Job job4 = (Job) anonymousClass1.L$3;
            ...
            sharedFlowImpl2.freeSlot((AbstractSharedFlowSlot) flowCollector);
            throw th;
        }
    }
    ...
    public boolean tryEmit(T value) {
        ...
        for (Continuation<Unit> continuation : continuationArrFindSlotsToResumeLocked) {
            if (continuation != null) {
                ...
                continuation.resumeWith(Result.m8542constructorimpl(Unit.INSTANCE));
            }
        }
        return emitted;
    }
    ...
    public final Object emitSuspend(T t, Continuation<? super Unit> continuation) {
        ...
        for (Continuation<Unit> continuation2 : continuationArrFindSlotsToResumeLocked) {
            if (continuation2 != null) {
                ...
                continuation2.resumeWith(Result.m8542constructorimpl(Unit.INSTANCE));
            }
        }
    ...
    */
    public final Continuation<Unit>[] updateCollectorIndexLocked$kotlinx_coroutines_core(long oldIndex) {
        ...
        long head = getHead();
        long newMinCollectorIndex2 = ((long) this.bufferSize) + head;
        long j3 = 1;
        if (this.bufferCapacity == 0 && this.queueSize > 0) {
            newMinCollectorIndex2++;
        }
        SharedFlowImpl<T> this_$iv = this;
        if (((AbstractSharedFlow) this_$iv).nCollectors == 0 || ($this$forEach$iv$iv = ((AbstractSharedFlow) this_$iv).slots) == null) {
            j = 1;
            ...
            while (i < length) {
                ...
                if (element$iv$iv != null) {
                    j2 = j3;
                    SharedFlowSlot slot = (SharedFlowSlot) element$iv$iv;
                    if (slot.index >= 0 && slot.index < newMinCollectorIndex2) {
                        newMinCollectorIndex2 = slot.index;
                    }
                } else {
                    j2 = j3;
                }
        ...
        if (DebugKt.getASSERTIONS_ENABLED()) {
            if ((newMinCollectorIndex2 >= this.minCollectorIndex ? 1 : 0) == 0) {
                throw new AssertionError();
            }
        }
        if (newMinCollectorIndex2 <= this.minCollectorIndex) {
            return AbstractSharedFlowKt.EMPTY_RESUMES;
        }
        ...
        if (nCollectors > 0) {
            int newBufferSize0 = (int) (newBufferEndIndex2 - newMinCollectorIndex2);
            iMin = Math.min(iMin, this.bufferCapacity - newBufferSize0);
        }
        int maxResumeCount = iMin;
        ...
        if (maxResumeCount <= 0) {
            newMinCollectorIndex = newMinCollectorIndex2;
            ...
            while (true) {
                ...
                if (emitter != SharedFlowKt.NO_VALUE) {
                    Intrinsics.checkNotNull(emitter, "null cannot be cast to non-null type kotlinx.coroutines.flow.SharedFlowImpl.Emitter");
                ...
                curEmitterIndex += j;
                newMinCollectorIndex2 = newMinCollectorIndex;
            }
        }
        int newBufferSize1 = (int) (newBufferEndIndex2 - head);
        long newMinCollectorIndex3 = getNCollectors() == 0 ? newBufferEndIndex2 : newMinCollectorIndex;
        ...
        if (this.bufferCapacity == 0 && newReplayIndex2 < newQueueEndIndex) {
            ...
            if (Intrinsics.areEqual(SharedFlowKt.getBufferAt(objArr, newReplayIndex2), SharedFlowKt.NO_VALUE)) {
                long newReplayIndex3 = newReplayIndex2 + j;
                newReplayIndex = newBufferEndIndex2 + j;
                newBufferEndIndex = newReplayIndex3;
            }
        } else {
            newReplayIndex = newBufferEndIndex2;
            newBufferEndIndex = newReplayIndex2;
        }
        updateBufferLocked(newBufferEndIndex, newMinCollectorIndex3, newReplayIndex, newQueueEndIndex);
        cleanupTailLocked();
    ...
    /* JADX INFO: compiled from: SharedFlow.kt */
    @Metadata(d1 = {"\u0000(\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\t\n\u0000\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\b\u0004\b\u0002\u0018\u00002\u00020\u0001B3\u0012\n\u0010\u0002\u001a\u0006\u0012\u0002\b\u00030\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005\u0012\b\u0010\u0006\u001a\u0004\u0018\u00010\u0007\u0012\f\u0010\b\u001a\b\u0012\u0004\u0012\u00020\n0\t¢\u0006\u0004\b\u000b\u0010\fJ\b\u0010\r\u001a\u00020\nH\u0016R\u0014\u0010\u0002\u001a\u0006\u0012\u0002\b\u00030\u00038\u0006X\u0087\u0004¢\u0006\u0002\n\u0000R\u0012\u0010\u0004\u001a\u00020\u00058\u0006@\u0006X\u0087\u000e¢\u0006\u0002\n\u0000R\u0012\u0010\u0006\u001a\u0004\u0018\u00010\u00078\u0006X\u0087\u0004¢\u0006\u0002\n\u0000R\u0016\u0010\b\u001a\b\u0012\u0004\u0012\u00020\n0\t8\u0006X\u0087\u0004¢\u0006\u0002\n\u0000¨\u0006\u000e"}, d2 = {"Lkotlinx/coroutines/flow/SharedFlowImpl$Emitter;", "Lkotlinx/coroutines/DisposableHandle;", "flow", "Lkotlinx/coroutines/flow/SharedFlowImpl;", "index", "", Values.VECTOR_MAP_VECTORS_KEY, "", "cont", "Lkotlin/coroutines/Continuation;", "", "<init>", "(Lkotlinx/coroutines/flow/SharedFlowImpl;JLjava/lang/Object;Lkotlin/coroutines/Continuation;)V", "dispose", "kotlinx-coroutines-core"}, k = 1, mv = {2, 1, 0}, xi = 48)
