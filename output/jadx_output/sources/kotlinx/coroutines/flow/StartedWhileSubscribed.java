        ...
        public final Object invokeSuspend(Object $result) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    if (count > 0) {
                        this.label = 1;
                        if ($this$transformLatest.emit(SharingCommand.START, this) == coroutine_suspended) {
                    ...
                    if (StartedWhileSubscribed.this.replayExpiration > 0) {
                        this.L$0 = $this$transformLatest;
                        this.label = 3;
                        if ($this$transformLatest.emit(SharingCommand.STOP, this) == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                        this.L$0 = $this$transformLatest;
                        this.label = 4;
                    ...
                    this.L$0 = null;
                    this.label = 5;
                    if ($this$transformLatest.emit(SharingCommand.STOP_AND_RESET_REPLAY_CACHE, this) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    return Unit.INSTANCE;
                case 1:
