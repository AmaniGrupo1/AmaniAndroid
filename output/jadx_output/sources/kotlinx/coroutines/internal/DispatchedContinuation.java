    ...
    */
            ...
            if (job$iv != null) {
                try {
                    if (!job$iv.isActive()) {
                        ...
                        resumeWith(Result.m8542constructorimpl(ResultKt.createFailure(cause$iv)));
                        z = true;
                    } else {
                        z = false;
                    }
                    try {
                        if (!z) {
                            ...
                            CoroutineContext context$iv$iv = continuation.getContext();
    ...
    public final boolean resumeCancelled$kotlinx_coroutines_core(Object state) {
        ...
        if (job != null && !job.isActive()) {
            ...
            Result.Companion companion = Result.INSTANCE;
            resumeWith(Result.m8542constructorimpl(ResultKt.createFailure(cause)));
            return true;
        }
        return false;
    }
