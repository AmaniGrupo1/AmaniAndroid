...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        try {
            ...
            objM8542constructorimpl = Result.m8542constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM8542constructorimpl = Result.m8542constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m8545exceptionOrNullimpl(objM8542constructorimpl) == null) {
            obj2 = objM8542constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM8542constructorimpl2 = Result.m8542constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM8542constructorimpl2 = Result.m8542constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m8545exceptionOrNullimpl(objM8542constructorimpl2) == null) {
