...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e) {
        ...
        if (e instanceof CopyableThrowable) {
            try {
                ...
                objM8542constructorimpl = Result.m8542constructorimpl(((CopyableThrowable) e).createCopy());
            } catch (Throwable th) {
            ...
            return (E) objM8542constructorimpl;
        }
    ...
    static final Throwable safeCtor$lambda$9(Function1 $block, Throwable e) {
        ...
        try {
            ...
            objM8542constructorimpl = Result.m8542constructorimpl(result);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM8542constructorimpl = Result.m8542constructorimpl(ResultKt.createFailure(th));
        }
        return (Throwable) (Result.m8548isFailureimpl(objM8542constructorimpl) ? null : objM8542constructorimpl);
    }
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int defaultValue) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            objM8542constructorimpl = Result.m8542constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM8542constructorimpl = Result.m8542constructorimpl(ResultKt.createFailure(th));
        }
        ...
        if (Result.m8548isFailureimpl(objM8542constructorimpl)) {
            objM8542constructorimpl = numValueOf;
        }
        return ((Number) objM8542constructorimpl).intValue();
    }
