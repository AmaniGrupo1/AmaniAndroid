...
public final class SupervisorKt {
    ...
    public static /* synthetic */ Job m10046SupervisorJob$default(Job job, int i, Object obj) {
        if ((i & 1) != 0) {
            job = null;
        }
        return m10045SupervisorJob(job);
    }

    @Deprecated(level = DeprecationLevel.HIDDEN, message = "Since 1.2.0, binary compatibility with versions <= 1.1.x")
    /* JADX INFO: renamed from: SupervisorJob, reason: collision with other method in class */
    public static final /* synthetic */ Job m10045SupervisorJob(Job parent) {
