...
public final class DebugProbesImpl {
    ...
    private final Function1<Boolean, Unit> getDynamicAttach() {
        ...
        try {
            ...
            objM8542constructorimpl = Result.m8542constructorimpl((Function1) TypeIntrinsics.beforeCheckcastToFunctionOfArity(objNewInstance, 1));
        } catch (Throwable th) {
        ...
        return (Function1) objM8542constructorimpl;
    }
    ...
    public final Object[] dumpCoroutinesInfoAsJsonAndReferences() {
        ...
        return new Object[]{AbstractJsonLexerKt.BEGIN_LIST + CollectionsKt.joinToString$default(coroutinesInfoAsJson, null, null, null, 0, null, null, 63, null) + AbstractJsonLexerKt.END_LIST, $this$toTypedArray$iv.toArray(new Thread[0]), $this$toTypedArray$iv2.toArray(new CoroutineStackFrame[0]), $this$toTypedArray$iv3.toArray(new DebugCoroutineInfo[0])};
    }
    ...
    public final String enhanceStackTraceWithThreadDumpAsJson(DebugCoroutineInfo info) {
        ...
        return AbstractJsonLexerKt.BEGIN_LIST + CollectionsKt.joinToString$default(stackTraceElementsInfoAsJson, null, null, null, 0, null, null, 63, null) + AbstractJsonLexerKt.END_LIST;
    }
    ...
    private final List<StackTraceElement> enhanceStackTraceWithThreadDumpImpl(String state, Thread thread, List<StackTraceElement> coroutineTrace) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            DebugProbesImpl debugProbesImpl = this;
            objM8542constructorimpl = Result.m8542constructorimpl(thread.getStackTrace());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM8542constructorimpl = Result.m8542constructorimpl(ResultKt.createFailure(th));
        }
        ...
        StackTraceElement[] actualTrace = (StackTraceElement[]) objM8542constructorimpl;
        if (actualTrace == null) {
            return coroutineTrace;
        }
        int index$iv = 0;
    ...
    private final <T> Continuation<T> createOwner(Continuation<? super T> completion, StackTraceFrame frame) {
        ...
        DebugCoroutineInfo info = new DebugCoroutineInfo(completion.get$context(), frame, getSequenceNumber().incrementAndGet());
