...
public final class HandlerDispatcherKt {
    ...
    static {
        ...
        try {
            ...
            objM8542constructorimpl = Result.m8542constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), null, 2, null));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM8542constructorimpl = Result.m8542constructorimpl(ResultKt.createFailure(th));
        }
        Main = (HandlerDispatcher) (Result.m8548isFailureimpl(objM8542constructorimpl) ? null : objM8542constructorimpl);
    }
    ...
    public static final Object awaitFrameSlowPath(Continuation<? super Long> continuation) {
        ...
        if (Looper.myLooper() == Looper.getMainLooper()) {
            ...
            Dispatchers.getMain().mo10112dispatch(cont.get$context(), new Runnable() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$awaitFrameSlowPath$2$1
