...
final /* synthetic */ class ChannelsKt__ChannelsKt {
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ChannelResult<? extends Unit>>, Object> {
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            try {
                ...
                r = Result.m8542constructorimpl(Unit.INSTANCE);
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                r = Result.m8542constructorimpl(ResultKt.createFailure(th));
            }
            return ChannelResult.m10064boximpl(Result.m8549isSuccessimpl(r) ? ChannelResult.INSTANCE.m10079successJP2dKIU(Unit.INSTANCE) : ChannelResult.INSTANCE.m10077closedJP2dKIU(Result.m8545exceptionOrNullimpl(r)));
        }
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static final <E> Object trySendBlocking(SendChannel<? super E> sendChannel, E e) {
        Object $this$onSuccess_u2dWpGqRn0$iv = sendChannel.mo10050trySendJP2dKIU(e);
    ...
    public static final /* synthetic */ void sendBlocking(SendChannel $this$sendBlocking, Object element) throws InterruptedException {
        if (!ChannelResult.m10074isSuccessimpl($this$sendBlocking.mo10050trySendJP2dKIU(element))) {
