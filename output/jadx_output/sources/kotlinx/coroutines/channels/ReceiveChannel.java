...
public interface ReceiveChannel<E> {
    ...
    Object mo10056receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);
    ...
    Object mo10057tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo10057tryReceivePtdJZtk = receiveChannel.mo10057tryReceivePtdJZtk();
            if (ChannelResult.m10074isSuccessimpl(objMo10057tryReceivePtdJZtk)) {
                return (E) ChannelResult.m10070getOrThrowimpl(objMo10057tryReceivePtdJZtk);
            }
            Throwable thM10068exceptionOrNullimpl = ChannelResult.m10068exceptionOrNullimpl(objMo10057tryReceivePtdJZtk);
            if (thM10068exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM10068exceptionOrNullimpl);
        }
        ...
        public static <E> Object receiveOrNull(ReceiveChannel<? extends E> receiveChannel, Continuation<? super E> continuation) {
            ...
            switch (anonymousClass1.label) {
                case 0:
                    ...
                    objMo10056receiveCatchingJP2dKIU = receiveChannel.mo10056receiveCatchingJP2dKIU(anonymousClass1);
                ...
                case 1:
                    ResultKt.throwOnFailure($result);
                    objMo10056receiveCatchingJP2dKIU = ((ChannelResult) $result).getHolder();
                    break;
                default:
                    throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
            }
            return ChannelResult.m10069getOrNullimpl(objMo10056receiveCatchingJP2dKIU);
        }
