...
public final class TickerChannelsKt {
    ...
    /* JADX INFO: compiled from: TickerChannels.kt */
    @Metadata(k = 3, mv = {2, 1, 0}, xi = 48)
    @DebugMetadata(c = "kotlinx.coroutines.channels.TickerChannelsKt", f = "TickerChannels.kt", i = {0, 0, 0, 1, 1, 1, 2, 2, 2, 3, 3, 3}, l = {GrpcUtil.DEFAULT_PORT_PLAINTEXT, 84, 90, 92}, m = "fixedPeriodTicker", n = {"channel", "delayMillis", "deadline", "channel", "deadline", "delayNs", "channel", "deadline", "delayNs", "channel", "deadline", "delayNs"}, s = {"L$0", "J$0", "J$1", "L$0", "J$0", "J$1", "L$0", "J$0", "J$1", "L$0", "J$0", "J$1"})
    static final class C07621 extends ContinuationImpl {
        long J$0;
        long J$1;
        Object L$0;
        int label;
    ...
    */
    public static final Object fixedPeriodTicker(long delayMillis, long initialDelayMillis, SendChannel<? super Unit> sendChannel, Continuation<? super Unit> continuation) {
        ...
        long delayNs3;
        Unit unit;
        if (continuation instanceof C07621) {
            c07621 = (C07621) continuation;
            if ((c07621.label & Integer.MIN_VALUE) != 0) {
                c07621.label -= Integer.MIN_VALUE;
            } else {
                c07621 = new C07621(continuation);
            }
        }
        Object $result = c07621.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        switch (c07621.label) {
            case 0:
                ResultKt.throwOnFailure($result);
                ...
                c07621.L$0 = sendChannel;
                c07621.J$0 = delayMillis;
                c07621.J$1 = deadline3;
                c07621.label = 1;
                if (DelayKt.delay(initialDelayMillis, c07621) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                ...
                unit = Unit.INSTANCE;
                c07621.L$0 = sendChannel;
                c07621.J$0 = deadline4;
                c07621.J$1 = delayNs2;
                c07621.label = 2;
                if (sendChannel.send(unit, c07621) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                deadline2 = deadline4;
                deadline = delayNs2;
                ...
                if (nextDelay == 0 || deadline == 0) {
                    ...
                    c07621.L$0 = sendChannel;
                    c07621.J$0 = deadline2;
                    c07621.J$1 = deadline;
                    c07621.label = 4;
                    if (DelayKt.delay(delayNs3, c07621) != coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    delayNs2 = deadline;
                    delayNs = deadline2;
                    ...
                    c07621.L$0 = sendChannel;
                    c07621.J$0 = deadline5;
                    c07621.J$1 = deadline;
                    c07621.label = 3;
                    if (DelayKt.delay(now2, c07621) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    delayNs2 = deadline;
                    delayNs = deadline5;
            ...
            case 1:
                delayNs = c07621.J$1;
                delayMillis2 = c07621.J$0;
                sendChannel = (SendChannel) c07621.L$0;
                ResultKt.throwOnFailure($result);
                delayNs2 = EventLoop_commonKt.delayToNanos(delayMillis2);
                long deadline422 = delayNs + delayNs2;
                unit = Unit.INSTANCE;
                c07621.L$0 = sendChannel;
                c07621.J$0 = deadline422;
                c07621.J$1 = delayNs2;
                c07621.label = 2;
                if (sendChannel.send(unit, c07621) == coroutine_suspended) {
                }
            ...
            case 2:
                ...
                break;
            case 3:
                long delayNs4 = c07621.J$1;
                long deadline6 = c07621.J$0;
                sendChannel = (SendChannel) c07621.L$0;
                ResultKt.throwOnFailure($result);
                delayNs2 = delayNs4;
                delayNs = deadline6;
                ...
                break;
            case 4:
                long delayNs5 = c07621.J$1;
                long deadline7 = c07621.J$0;
                sendChannel = (SendChannel) c07621.L$0;
                ResultKt.throwOnFailure($result);
                delayNs2 = delayNs5;
                delayNs = deadline7;
