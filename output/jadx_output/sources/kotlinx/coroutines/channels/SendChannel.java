...
public interface SendChannel<E> {
    ...
    Object mo10050trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            Object result = sendChannel.mo10050trySendJP2dKIU(e);
            if (ChannelResult.m10074isSuccessimpl(result)) {
                return true;
            }
            Throwable thM10068exceptionOrNullimpl = ChannelResult.m10068exceptionOrNullimpl(result);
