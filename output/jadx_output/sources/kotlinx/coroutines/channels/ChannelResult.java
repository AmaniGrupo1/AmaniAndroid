...
public final class ChannelResult<T> {
    ...
    public static final /* synthetic */ ChannelResult m10064boximpl(Object obj) {
        return new ChannelResult(obj);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static <T> Object m10065constructorimpl(Object obj) {
        return obj;
    }
    ...
    public static int m10071hashCodeimpl(Object obj) {
        if (obj == null) {
            return 0;
        }
        return obj.hashCode();
    ...
    public boolean equals(Object other) {
        return m10066equalsimpl(this.holder, other);
    }

    public int hashCode() {
        return m10071hashCodeimpl(this.holder);
    }
    ...
    public static final T m10070getOrThrowimpl(Object obj) throws Throwable {
        if (!(obj instanceof Failed)) {
            return obj;
        }
        if (obj instanceof Closed) {
            if (((Closed) obj).cause != null) {
    ...
    public static final Throwable m10068exceptionOrNullimpl(Object arg0) {
    ...
    public static final class Companion {
        ...
        public final <E> Object m10079successJP2dKIU(E value) {
            return ChannelResult.m10065constructorimpl(value);
        }

        /* JADX INFO: renamed from: failure-PtdJZtk, reason: not valid java name */
        public final <E> Object m10078failurePtdJZtk() {
            return ChannelResult.m10065constructorimpl(ChannelResult.failed);
        }

        /* JADX INFO: renamed from: closed-JP2dKIU, reason: not valid java name */
        public final <E> Object m10077closedJP2dKIU(Throwable cause) {
            return ChannelResult.m10065constructorimpl(new Closed(cause));
        }
    }

    public String toString() {
        return m10075toStringimpl(this.holder);
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m10075toStringimpl(Object arg0) {
