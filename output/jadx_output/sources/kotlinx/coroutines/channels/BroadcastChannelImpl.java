...
public final class BroadcastChannelImpl<E> extends BufferedChannel<E> implements BroadcastChannel<E> {
        ...
        try {
            ...
            if (!isClosedForSend() || this.lastConflatedElement != BroadcastChannelKt.NO_ELEMENT) {
                if (this.lastConflatedElement != BroadcastChannelKt.NO_ELEMENT) {
                    s.mo10050trySendJP2dKIU(getValue());
                }
    ...
    */
            ...
            case 0:
                ...
                try {
                    ...
                    if (it.hasNext()) {
                        ...
                        anonymousClass1.L$1 = element;
                        anonymousClass1.L$2 = it;
                        anonymousClass1.label = 1;
                        Object objSendBroadcast$kotlinx_coroutines_core = ((BufferedChannel) element$iv).sendBroadcast$kotlinx_coroutines_core(element, anonymousClass1);
    ...
    public Object mo10050trySendJP2dKIU(E element) {
        ...
        try {
            if (isClosedForSend()) {
                return super.mo10050trySendJP2dKIU(element);
            }
            ...
            for (Object element$iv2 : $this$forEach$iv) {
                ...
                it3.mo10050trySendJP2dKIU(element);
            }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            try {
                if (DebugKt.getASSERTIONS_ENABLED()) {
                    if (!(((BroadcastChannelImpl) broadcastChannelImpl2).onSendInternalResult.get(selectInstance) == null)) {
