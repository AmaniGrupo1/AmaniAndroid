    ...
    public void onCancellation(int index, Throwable cause, CoroutineContext context) {
        ...
        while (true) {
            ...
            if (!(cur instanceof Waiter) && !(cur instanceof WaiterEB)) {
                if (cur == BufferedChannelKt.INTERRUPTED_SEND || cur == BufferedChannelKt.INTERRUPTED_RCV) {
                    break;
                }
                if (cur != BufferedChannelKt.RESUMING_BY_EB && cur != BufferedChannelKt.RESUMING_BY_RCV) {
