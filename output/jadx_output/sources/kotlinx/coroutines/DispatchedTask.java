...
public abstract class DispatchedTask<T> extends Task {
    ...
    /* JADX WARN: Removed duplicated region for block: B:43:0x00bb A[Catch: all -> 0x00e6, TryCatch #1 {all -> 0x00e6, blocks: (B:39:0x00a5, B:40:0x00a8, B:45:0x00d6, B:37:0x0099, B:43:0x00bb, B:44:0x00c9), top: B:65:0x006d }] */
    /* JADX WARN: Removed duplicated region for block: B:44:0x00c9 A[Catch: all -> 0x00e6, TryCatch #1 {all -> 0x00e6, blocks: (B:39:0x00a5, B:40:0x00a8, B:45:0x00d6, B:37:0x0099, B:43:0x00bb, B:44:0x00c9), top: B:65:0x006d }] */
    /* JADX WARN: Removed duplicated region for block: B:49:0x00e2 A[Catch: all -> 0x00f7, DispatchException -> 0x00fc, TryCatch #5 {DispatchException -> 0x00fc, all -> 0x00f7, blocks: (B:13:0x001b, B:15:0x003e, B:47:0x00dc, B:49:0x00e2, B:56:0x00ed, B:59:0x00f6, B:58:0x00f3), top: B:71:0x001b }] */
                        ...
                        try {
                            if (job == null && !job.isActive()) {
                                ...
                                if (DebugKt.getRECOVER_STACK_TRACES() && (continuation instanceof CoroutineStackFrame)) {
                                    ...
                                    continuation.resumeWith(Result.m8542constructorimpl(ResultKt.createFailure(cancellationExceptionRecoverFromStackFrame)));
                                } else {
                                ...
                                continuation.resumeWith(Result.m8542constructorimpl(ResultKt.createFailure(exception)));
                            } else {
                                Result.Companion companion3 = Result.INSTANCE;
                                continuation.resumeWith(Result.m8542constructorimpl(getSuccessfulResult$kotlinx_coroutines_core(state)));
                            }
