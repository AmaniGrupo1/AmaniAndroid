...
public final class PolymorphicSerializer<T> extends AbstractPolymorphicSerializer<T> {
    ...
    static final Unit descriptor_delegate$lambda$1$lambda$0(PolymorphicSerializer this$0, ClassSerialDescriptorBuilder buildSerialDescriptor) {
        ...
        ClassSerialDescriptorBuilder.element$default(buildSerialDescriptor, Values.VECTOR_MAP_VECTORS_KEY, SerialDescriptorsKt.buildSerialDescriptor$default("kotlinx.serialization.Polymorphic<" + this$0.getBaseClass().getSimpleName() + Typography.greater, SerialKind.CONTEXTUAL.INSTANCE, new SerialDescriptor[0], null, 8, null), null, false, 12, null);
