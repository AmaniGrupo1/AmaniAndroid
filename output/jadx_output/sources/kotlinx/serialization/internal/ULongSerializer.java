...
public final class ULongSerializer implements KSerializer<ULong> {
    ...
    public /* bridge */ /* synthetic */ Object deserialize(Decoder decoder) {
        return ULong.m8710boximpl(m10152deserializeI7RO_PI(decoder));
    }

    @Override // kotlinx.serialization.SerializationStrategy
    public /* bridge */ /* synthetic */ void serialize(Encoder encoder, Object value) {
        m10153serialize2TYgG_w(encoder, ((ULong) value).getData());
    }
    ...
    public void m10153serialize2TYgG_w(Encoder encoder, long value) {
    ...
    public long m10152deserializeI7RO_PI(Decoder decoder) {
        Intrinsics.checkNotNullParameter(decoder, "decoder");
        return ULong.m8716constructorimpl(decoder.decodeInline(getDescriptor()).decodeLong());
    }
}
