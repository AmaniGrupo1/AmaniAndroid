...
final class ConcurrentHashMapParametrizedCache<T> implements ParametrizedSerializerCache<T> {
    ...
    public Object mo10125getgIAlus(KClass<Object> key, List<? extends KType> types) {
        ...
        if (obj == null) {
            try {
                ...
                objM8542constructorimpl = Result.m8542constructorimpl(this.compute.invoke(key, types));
            } catch (Throwable th) {
            ...
            Object objPutIfAbsent = $this$getOrPut$iv$iv.putIfAbsent(arrayList, resultM8541boximpl);
