...
final class ParametrizedCacheEntry<T> {
    ...
    public final Object m10128computeIfAbsentgIAlus(List<? extends KType> types, Function0<? extends KSerializer<T>> producer) {
        ...
        if (obj == null) {
            try {
                ...
                objM8542constructorimpl = Result.m8542constructorimpl(producer.invoke());
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                objM8542constructorimpl = Result.m8542constructorimpl(ResultKt.createFailure(th));
            }
            Result resultM8541boximpl = Result.m8541boximpl(objM8542constructorimpl);
            Object objPutIfAbsent = $this$getOrPut$iv.putIfAbsent(arrayList, resultM8541boximpl);
            obj = objPutIfAbsent == null ? resultM8541boximpl : objPutIfAbsent;
        }
