...
public final class JsonElementKt {
    ...
    public static final JsonPrimitive m10163JsonPrimitive7apg3OU(byte value) {
        return m10164JsonPrimitiveVKZWuLQ(ULong.m8716constructorimpl(((long) value) & 255));
    }

    @ExperimentalSerializationApi
    /* JADX INFO: renamed from: JsonPrimitive-xj2QHRw, reason: not valid java name */
    public static final JsonPrimitive m10166JsonPrimitivexj2QHRw(short value) {
        return m10164JsonPrimitiveVKZWuLQ(ULong.m8716constructorimpl(((long) value) & WebSocketProtocol.PAYLOAD_SHORT_MAX));
    }

    @ExperimentalSerializationApi
    /* JADX INFO: renamed from: JsonPrimitive-WZ4Q5Ns, reason: not valid java name */
    public static final JsonPrimitive m10165JsonPrimitiveWZ4Q5Ns(int value) {
        return m10164JsonPrimitiveVKZWuLQ(ULong.m8716constructorimpl(((long) value) & 4294967295L));
    }

    @ExperimentalSerializationApi
    /* JADX INFO: renamed from: JsonPrimitive-VKZWuLQ, reason: not valid java name */
    public static final JsonPrimitive m10164JsonPrimitiveVKZWuLQ(long value) {
        return JsonUnquotedLiteral(JsonElementKt$$ExternalSyntheticBackport1.m(value, 10));
    }
    ...
    public static final int getInt(JsonPrimitive $this$int) {
        ...
        try {
            ...
            boolean z = false;
            if (SieveCacheKt.NodeMetaAndPreviousMask <= result && result <= SieveCacheKt.NodeLinkMask) {
                z = true;
            }
            if (!z) {
    ...
    public static final Integer getIntOrNull(JsonPrimitive $this$intOrNull) {
        ...
        try {
            lValueOf = Long.valueOf(new StringJsonLexer($this$intOrNull.getContent()).consumeNumericLiteral());
        ...
        long result = lValueOf.longValue();
        boolean z = false;
        if (SieveCacheKt.NodeMetaAndPreviousMask <= result && result <= SieveCacheKt.NodeLinkMask) {
            z = true;
        }
