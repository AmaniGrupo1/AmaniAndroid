...
public abstract class JsonContentPolymorphicSerializer<T> implements KSerializer<T> {
    ...
    public JsonContentPolymorphicSerializer(KClass<T> baseClass) {
        ...
        this.descriptor = SerialDescriptorsKt.buildSerialDescriptor$default("JsonContentPolymorphicSerializer<" + this.baseClass.getSimpleName() + Typography.greater, PolymorphicKind.SEALED.INSTANCE, new SerialDescriptor[0], null, 8, null);
    }
    ...
    public final void serialize(Encoder encoder, T value) {
        ...
        KSerializer actualSerializer = encoder.getSerializersModule().getPolymorphic(this.baseClass, value);
        if (actualSerializer == null) {
            ...
            actualSerializer = kSerializerSerializerOrNull;
        }
    ...
    private final Void throwSubtypeNotRegistered(KClass<?> subClass, KClass<?> baseClass) {
        ...
        if (subClassName == null) {
            subClassName = String.valueOf(subClass);
        }
