    ...
    public boolean hasNext() {
        ...
        if (this.lexer.peekNextToken() == 9) {
            ...
            if (this.lexer.isNotEof()) {
                ...
                if (bPeekNextToken == 8) {
                    JsonReader.fail$default(readerJsonLexer, "There is a start of the new array after the one parsed to sequence. ARRAY_WRAPPED mode doesn't merge consecutive arrays.\nIf you need to parse a stream of arrays, please use WHITESPACE_SEPARATED mode instead.", 0, null, 6, null);
