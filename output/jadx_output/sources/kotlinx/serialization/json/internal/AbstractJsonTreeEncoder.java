...
abstract class AbstractJsonTreeEncoder extends NamedValueEncoder implements JsonEncoder {
    ...
    public <T> void encodeSerializableValue(SerializationStrategy<? super T> serializer, T value) {
        ...
        if (getCurrentTagOrNull() != null || !TreeJsonEncoderKt.getRequiresTopLevelTag(WriteModeKt.carrierDescriptor(serializer.getDescriptor(), getSerializersModule()))) {
            ...
            if (isPolymorphicSerializer$iv) {
                ...
                serializationStrategyFindPolymorphicSerializer = PolymorphicSerializerKt.findPolymorphicSerializer(casted$iv, $this$encodePolymorphically$iv, value);
            ...
            serializationStrategyFindPolymorphicSerializer.serialize($this$encodePolymorphically$iv, value);
            return;
        }
    ...
    private final C07831 inlineUnsignedNumberEncoder(final String tag) {
        return new AbstractEncoder() { // from class: kotlinx.serialization.json.internal.AbstractJsonTreeEncoder.inlineUnsignedNumberEncoder.1
            ...
            public void encodeInt(int value) {
                putUnquotedString(Long.toString(((long) UInt.m8637constructorimpl(value)) & 4294967295L, 10));
            }

            @Override // kotlinx.serialization.encoding.AbstractEncoder, kotlinx.serialization.encoding.Encoder
            public void encodeLong(long value) {
                putUnquotedString(JsonElementKt$$ExternalSyntheticBackport1.m(ULong.m8716constructorimpl(value), 10));
            }

            @Override // kotlinx.serialization.encoding.AbstractEncoder, kotlinx.serialization.encoding.Encoder
            public void encodeByte(byte value) {
                putUnquotedString(UByte.m8604toStringimpl(UByte.m8560constructorimpl(value)));
            }

            @Override // kotlinx.serialization.encoding.AbstractEncoder, kotlinx.serialization.encoding.Encoder
            public void encodeShort(short value) {
                putUnquotedString(UShort.m8867toStringimpl(UShort.m8823constructorimpl(value)));
            }
        };
    }
    ...
    public CompositeEncoder beginStructure(SerialDescriptor descriptor) {
        ...
        if (Intrinsics.areEqual(kind, StructureKind.LIST.INSTANCE) || (kind instanceof PolymorphicKind)) {
            encoder = new JsonTreeListEncoder(this.json, function1);
        } else if (!Intrinsics.areEqual(kind, StructureKind.MAP.INSTANCE)) {
            encoder = new JsonTreeEncoder(this.json, function1);
        } else {
        ...
        if (discriminator != null) {
            if (encoder instanceof JsonTreeMapEncoder) {
                ...
                jsonTreeMapEncoder2.putElement(Values.VECTOR_MAP_VECTORS_KEY, JsonElementKt.JsonPrimitive(serialName));
            } else {
