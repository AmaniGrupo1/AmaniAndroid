...
public final class JsonPath {
    ...
    public final String getPath() {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            ...
            if (element instanceof SerialDescriptor) {
                boolean zAreEqual = Intrinsics.areEqual(((SerialDescriptor) element).getKind(), StructureKind.LIST.INSTANCE);
        ...
        String string = $this$getPath_u24lambda_u241.toString();
    ...
    private final void resize() {
        ...
        int[] iArrCopyOf = Arrays.copyOf(this.indicies, newSize);
