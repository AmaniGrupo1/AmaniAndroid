...
public final class PolymorphicKt {
    ...
    public static final <T> void encodePolymorphically(JsonEncoder $this$encodePolymorphically, SerializationStrategy<? super T> serializer, T t, Function2<? super String, ? super String, Unit> ifPolymorphic) {
        ...
        if (isPolymorphicSerializer) {
            ...
            serializationStrategyFindPolymorphicSerializer = PolymorphicSerializerKt.findPolymorphicSerializer(casted, $this$encodePolymorphically, t);
        ...
        if (baseClassDiscriminator != null) {
            ifPolymorphic.invoke(baseClassDiscriminator, serializationStrategyFindPolymorphicSerializer.getDescriptor().getSerialName());
        }
        serializationStrategyFindPolymorphicSerializer.serialize($this$encodePolymorphically, t);
    }
    ...
    public static final <T> T decodeSerializableValuePolymorphic(JsonDecoder jsonDecoder, DeserializationStrategy<? extends T> deserializer, Function0<String> path) {
        ...
        String strClassDiscriminator = classDiscriminator(((AbstractPolymorphicSerializer) deserializer).getDescriptor(), jsonDecoder.getJson());
