...
/* JADX INFO: renamed from: kotlinx.serialization.json.internal.AbstractJsonLexer, reason: from toString */
...
public abstract class JsonReader {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:104:0x0225, code lost:
        ...
        if (r8 == Long.MIN_VALUE) goto L107;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:107:0x0229, code lost:
        ...
        fail$default(r21, "Numeric value overflow", 0, null, 6, null);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:109:0x023a, code lost:
        ...
        fail$default(r21, "Expected numeric literal", 0, null, 6, null);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:77:0x0190, code lost:
        ...
        if (getSource().charAt(r10) != '\"') goto L79;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:79:0x0197, code lost:
        ...
        fail$default(r21, "Expected closing quotation mark", 0, null, 6, null);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:81:0x01a8, code lost:
        ...
        fail$default(r21, "EOF", 0, null, 6, null);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:86:0x01bf, code lost:
        ...
        r1 = r8 * consumeNumericLiteral$calculateExponent(r13, r11);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:91:0x01d7, code lost:
        ...
        if (java.lang.Math.floor(r1) != r1) goto L93;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:96:0x01e0, code lost:
        ...
        fail$default(r0, "Can't convert " + r1 + " to Long", 0, null, 6, null);
     */
    ...
    */
    public final long consumeNumericLiteral() {
        ...
        char ch2 = 0;
        while (true) {
            if (current2 == getSource().length()) {
                c = ch2;
                break;
            }
            char ch3 = getSource().charAt(current2);
            if (ch3 != 'e' && ch3 != 'E') {
                c = ch2;
                ch = ch3;
            } else if (hasExponent) {
                ...
                if (current2 == start) {
                    fail$default(this, "Unexpected symbol " + ch3 + " in numeric literal", 0, null, 6, null);
                    throw new KotlinNothingValueException();
                }
            ...
            if (ch == '-' && hasExponent) {
                ...
                if (hasExponent) {
                    exponentAccumulator = (((long) 10) * exponentAccumulator) + ((long) digit);
                    ch2 = c;
                } else {
                    accumulator = (((long) 10) * accumulator) - ((long) digit);
                    if (accumulator > 0) {
