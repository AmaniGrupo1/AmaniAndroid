...
public final class StreamingJsonEncoder extends AbstractEncoder implements JsonEncoder {
    ...
    public CompositeEncoder beginStructure(SerialDescriptor descriptor) {
        ...
        if (jsonEncoderArr == null || (streamingJsonEncoder = jsonEncoderArr[newMode.ordinal()]) == null) {
            streamingJsonEncoder = new StreamingJsonEncoder(this.composer, getJson(), newMode, this.modeReuseCache);
        }
    ...
    public Encoder encodeInline(SerialDescriptor descriptor) {
        ...
        if (!StreamingJsonEncoderKt.isUnsignedNumber(descriptor)) {
            ...
            boolean z = this.composer instanceof ComposerForUnquotedLiterals;
            ComposerForUnquotedLiterals composerForUnquotedLiterals = this.composer;
            if (!z) {
                InternalJsonWriter p0 = composerForUnquotedLiterals.writer;
        ...
        boolean z2 = this.composer instanceof ComposerForUnsignedNumbers;
        ComposerForUnsignedNumbers composerForUnsignedNumbers = this.composer;
        if (!z2) {
            InternalJsonWriter p02 = composerForUnsignedNumbers.writer;
    ...
    private final /* synthetic */ <T extends Composer> T composerAs(Function2<? super InternalJsonWriter, ? super Boolean, ? extends T> composerCreator) {
        ...
        return composerCreator.invoke(t.writer, Boolean.valueOf(this.forceQuoting));
    }
