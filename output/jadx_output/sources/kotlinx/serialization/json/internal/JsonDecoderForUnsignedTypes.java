...
public final class JsonDecoderForUnsignedTypes extends AbstractDecoder {
    ...
    public JsonDecoderForUnsignedTypes(JsonReader lexer, Json json) {
    ...
    public int decodeInt() {
        ...
        try {
            ...
            JsonReader.fail$default($this$parseString$iv, "Failed to parse type 'UInt' for input '" + input$iv + '\'', 0, null, 6, null);
    ...
    public long decodeLong() {
        ...
        try {
            ...
            JsonReader.fail$default($this$parseString$iv, "Failed to parse type 'ULong' for input '" + input$iv + '\'', 0, null, 6, null);
            throw new KotlinNothingValueException();
        }
    }
    ...
    public byte decodeByte() {
        ...
        try {
            ...
            JsonReader.fail$default($this$parseString$iv, "Failed to parse type 'UByte' for input '" + input$iv + '\'', 0, null, 6, null);
            throw new KotlinNothingValueException();
        }
    }
    ...
    public short decodeShort() {
        ...
        try {
            ...
            JsonReader.fail$default($this$parseString$iv, "Failed to parse type 'UShort' for input '" + input$iv + '\'', 0, null, 6, null);
            throw new KotlinNothingValueException();
        }
    }
}
