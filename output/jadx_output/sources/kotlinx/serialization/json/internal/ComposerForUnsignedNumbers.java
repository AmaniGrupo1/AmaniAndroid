...
public final class ComposerForUnsignedNumbers extends Composer {
    ...
    public void print(int v) {
        if (this.forceQuoting) {
            printQuoted(Long.toString(((long) UInt.m8637constructorimpl(v)) & 4294967295L, 10));
        } else {
            print(Long.toString(((long) UInt.m8637constructorimpl(v)) & 4294967295L, 10));
        }
    }
    ...
    public void print(long v) {
        if (this.forceQuoting) {
            printQuoted(JsonElementKt$$ExternalSyntheticBackport1.m(ULong.m8716constructorimpl(v), 10));
        } else {
            print(JsonElementKt$$ExternalSyntheticBackport1.m(ULong.m8716constructorimpl(v), 10));
        }
    }
    ...
    public void print(byte v) {
        if (this.forceQuoting) {
            printQuoted(UByte.m8604toStringimpl(UByte.m8560constructorimpl(v)));
        } else {
            print(UByte.m8604toStringimpl(UByte.m8560constructorimpl(v)));
        }
    }
    ...
    public void print(short v) {
        if (this.forceQuoting) {
            printQuoted(UShort.m8867toStringimpl(UShort.m8823constructorimpl(v)));
        } else {
            print(UShort.m8867toStringimpl(UShort.m8823constructorimpl(v)));
        }
    }
}
