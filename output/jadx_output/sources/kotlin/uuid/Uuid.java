...
public final class Uuid implements Comparable<Uuid>, Serializable {
    ...
    private final <T> T toULongs(Function2<? super ULong, ? super ULong, ? extends T> action) {
        Intrinsics.checkNotNullParameter(action, "action");
        return action.invoke(ULong.m8710boximpl(ULong.m8716constructorimpl(getMostSignificantBits())), ULong.m8710boximpl(ULong.m8716constructorimpl(getLeastSignificantBits())));
    }
    ...
    public final byte[] m10034toUByteArrayTcUX1vc() {
        return UByteArray.m8613constructorimpl(toByteArray());
    }
    ...
    public int compareTo(Uuid other) {
        ...
        return this.mostSignificantBits != other.mostSignificantBits ? Long.compare(ULong.m8716constructorimpl(this.mostSignificantBits) ^ Long.MIN_VALUE, ULong.m8716constructorimpl(other.mostSignificantBits) ^ Long.MIN_VALUE) : Long.compare(ULong.m8716constructorimpl(this.leastSignificantBits) ^ Long.MIN_VALUE, ULong.m8716constructorimpl(other.leastSignificantBits) ^ Long.MIN_VALUE);
    }
    ...
    public static final class Companion {
        ...
        public final Uuid m10036fromULongseb3DHEI(long mostSignificantBits, long leastSignificantBits) {
        ...
        public final Uuid m10035fromUByteArrayGBYM_sE(byte[] ubyteArray) {
        ...
        public final Uuid generateV7NonMonotonicAt(Instant timestamp) {
            ...
            int verAndRandA = (((randomBytes[8] & Ascii.SI) | 112) << 8) | (randomBytes[9] & 255);
            long tsVerAndRandA = (timestamp.toEpochMilliseconds() << 16) | ((long) verAndRandA);
            randomBytes[0] = (byte) (((byte) (randomBytes[0] & Utf8.REPLACEMENT_BYTE)) | (-128));
