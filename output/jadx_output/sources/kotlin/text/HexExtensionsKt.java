...
public final class HexExtensionsKt {
    ...
    private static final int checkFormatLength(long formatLength) {
        ...
        if (!z) {
            throw new IllegalArgumentException("The resulting string length is too big: " + ((Object) ULong.m8762toStringimpl(ULong.m8716constructorimpl(formatLength))));
        }
    ...
    public static final String toHexString(byte $this$toHexString, HexFormat format) {
        ...
        if (numberFormat.getIsDigitsOnlyAndNoPadding()) {
            char[] charArray = {digits.charAt(($this$toHexString >> 4) & 15), digits.charAt($this$toHexString & Ascii.SI)};
