...
public class SequencesKt__SequencesKt extends SequencesKt__SequencesJVMKt {
    ...
    static final class C07121<T> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super T>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: Multi-variable type inference failed */
        C07121(Sequence<? extends T> sequence, Function0<? extends Sequence<? extends T>> function0, Continuation<? super C07121> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C07121 c07121 = new C07121(this.$this_ifEmpty, this.$defaultValue, continuation);
            c07121.L$0 = obj;
            return c07121;
        }
        ...
        public final Object invoke(SequenceScope<? super T> sequenceScope, Continuation<? super Unit> continuation) {
            return ((C07121) create(sequenceScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final <T> Sequence<T> ifEmpty(Sequence<? extends T> sequence, Function0<? extends Sequence<? extends T>> defaultValue) {
        ...
        return SequencesKt.sequence(new C07121(sequence, defaultValue, null));
    }
    ...
    /* JADX INFO: compiled from: Sequences.kt */
    @Metadata(d1 = {"\u0000\f\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002*\b\u0012\u0004\u0012\u0002H\u00020\u0003H\n"}, d2 = {"<anonymous>", "", ExifInterface.GPS_DIRECTION_TRUE, "Lkotlin/sequences/SequenceScope;"}, k = 3, mv = {2, 3, 0}, xi = 48)
    @DebugMetadata(c = "kotlin.sequences.SequencesKt__SequencesKt$shuffled$1", f = "Sequences.kt", i = {0, 0, 0, 0, 0}, l = {178}, m = "invokeSuspend", n = {"$this$sequence", "buffer", "last", Values.VECTOR_MAP_VECTORS_KEY, "j"}, nl = {180}, s = {"L$0", "L$1", "L$2", "L$3", "I$0"}, v = 2)
    static final class C07131<T> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super T>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C07131(Sequence<? extends T> sequence, Random random, Continuation<? super C07131> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C07131 c07131 = new C07131(this.$this_shuffled, this.$random, continuation);
            c07131.L$0 = obj;
            return c07131;
        }
        ...
        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(SequenceScope<? super T> sequenceScope, Continuation<? super Unit> continuation) {
            return ((C07131) create(sequenceScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    c07131 = this;
                    if (!buffer.isEmpty()) {
                        int j = c07131.$random.nextInt(buffer.size());
                        Object last = CollectionsKt.removeLast(buffer);
                        Object value = j < buffer.size() ? buffer.set(j, last) : last;
                        c07131.L$0 = sequenceScope;
                        c07131.L$1 = buffer;
                        c07131.L$2 = SpillingKt.nullOutSpilledVariable(last);
                        c07131.L$3 = SpillingKt.nullOutSpilledVariable(value);
                        c07131.I$0 = j;
                        c07131.label = 1;
                        if (sequenceScope.yield(value, c07131) == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                        c071312 = c07131;
                        c07131 = c071312;
    ...
    public static final <T> Sequence<T> shuffled(Sequence<? extends T> sequence, Random random) {
        ...
        return SequencesKt.sequence(new C07131(sequence, random, null));
    }
    ...
    static final class C07111<R> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super R>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C07111(Sequence<? extends T> sequence, Function2<? super Integer, ? super T, ? extends C> function2, Function1<? super C, ? extends Iterator<? extends R>> function1, Continuation<? super C07111> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C07111 c07111 = new C07111(this.$source, this.$transform, this.$iterator, continuation);
            c07111.L$0 = obj;
            return c07111;
        }
        ...
        public final Object invoke(SequenceScope<? super R> sequenceScope, Continuation<? super Unit> continuation) {
            return ((C07111) create(sequenceScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    if (it.hasNext()) {
                        Object next = it.next();
                        Function2<Integer, T, C> function2 = c07111.$transform;
                        int i2 = i + 1;
                        if (i < 0) {
                            CollectionsKt.throwIndexOverflow();
                        }
                        Object objInvoke = function2.invoke(Boxing.boxInt(i), (T) next);
                        c07111.L$0 = sequenceScope;
                        c07111.L$1 = it;
                        c07111.L$2 = SpillingKt.nullOutSpilledVariable(next);
                        c07111.L$3 = SpillingKt.nullOutSpilledVariable(objInvoke);
                        c07111.I$0 = i2;
                        c07111.label = 1;
                        if (sequenceScope.yieldAll(c07111.$iterator.invoke((C) objInvoke), c07111) == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                        it2 = it;
                        c071112 = c07111;
    ...
    public static final <T, C, R> Sequence<R> flatMapIndexed(Sequence<? extends T> source, Function2<? super Integer, ? super T, ? extends C> transform, Function1<? super C, ? extends Iterator<? extends R>> iterator) {
        ...
        Intrinsics.checkNotNullParameter(iterator, "iterator");
        return SequencesKt.sequence(new C07111(source, transform, iterator, null));
    }
