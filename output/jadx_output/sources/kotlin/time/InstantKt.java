    ...
    */
    public static final InstantParseResult parseIso(CharSequence isoString) {
        ...
        while (i3 < isoString.length()) {
            char cCharAt = isoString.charAt(i3);
            if (!('0' <= cCharAt && cCharAt < ':')) {
                ...
                if (isoString.charAt(i3 + 15) == '.') {
                    ...
                    while (true) {
                        ...
                        if (i < isoString.length()) {
                            char cCharAt2 = isoString.charAt(i);
                            ...
                            if (i + j >= isoString.length()) {
                                ...
                                while (i2 < length) {
                                    ...
                                    if (i + j2 >= isoString.length()) {
                                        ...
                                        char cCharAt3 = isoString.charAt(i + j2);
                ...
                int offsetSeconds$iv = yearStrLength2;
                long y$iv = this_$iv.getYear();
                long total$iv = ((long) 365) * y$iv;
                long total$iv2 = (y$iv >= 0 ? total$iv + (((((long) 3) + y$iv) / ((long) 4)) - ((((long) 99) + y$iv) / ((long) 100))) + ((((long) 399) + y$iv) / ((long) LogSeverity.WARNING_VALUE)) : total$iv - (((y$iv / ((long) (-4))) - (y$iv / ((long) (-100)))) + (y$iv / ((long) (-400))))) + ((long) (((this_$iv.getMonth() * 367) - 362) / 12)) + ((long) (this_$iv.getDay() - 1));
                ...
                long epochDays$iv = total$iv2 - ((long) DAYS_0000_TO_1970);
                int daySeconds$iv = (this_$iv.getHour() * SECONDS_PER_HOUR) + (this_$iv.getMinute() * 60) + this_$iv.getSecond();
                long epochSeconds$iv = ((((long) SECONDS_PER_DAY) * epochDays$iv) + ((long) daySeconds$iv)) - ((long) offsetSeconds$iv);
    ...
    public static final boolean isLeapYear(int year) {
        return (year & 3) == 0 && (year % 100 != 0 || year % LogSeverity.WARNING_VALUE == 0);
    }
