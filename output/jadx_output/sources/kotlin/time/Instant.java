...
@Metadata(d1 = {"\u0000N\n\u0002\u0018\u0002\n\u0002\u0010\u000f\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\t\n\u0000\n\u0002\u0010\b\n\u0002\b\t\n\u0002\u0018\u0002\n\u0002\b\t\n\u0002\u0010\u000b\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0007\u0018\u0000 '2\b\u0012\u0004\u0012\u00020\u00000\u00012\u00060\u0002j\u0002`\u0003:\u0001'B\u0019\b@\u0012\u0006\u0010\u0004\u001a\u00020\u0005\u0012\u0006\u0010\u0006\u001a\u00020\u0007¢\u0006\u0004\b\b\u0010\tJ\n\u0010\u000e\u001a\u00020\u0005H\u0086\u0080\u0004J\u0019\u0010\u000f\u001a\u00020\u00002\u0006\u0010\u0010\u001a\u00020\u0011H\u0086\u0082\u0004¢\u0006\u0004\b\u0012\u0010\u0013J\u0019\u0010\u0014\u001a\u00020\u00002\u0006\u0010\u0010\u001a\u00020\u0011H\u0086\u0082\u0004¢\u0006\u0004\b\u0015\u0010\u0013J\u0019\u0010\u0014\u001a\u00020\u00112\u0006\u0010\u0016\u001a\u00020\u0000H\u0086\u0082\u0004¢\u0006\u0004\b\u0017\u0010\u0018J\u0012\u0010\u0019\u001a\u00020\u00072\u0006\u0010\u0016\u001a\u00020\u0000H\u0096\u0082\u0004J\u0014\u0010\u001a\u001a\u00020\u001b2\b\u0010\u0016\u001a\u0004\u0018\u00010\u001cH\u0096\u0082\u0004J\n\u0010\u001d\u001a\u00020\u0007H\u0096\u0080\u0004J\n\u0010\u001e\u001a\u00020\u001fH\u0096\u0080\u0004J\n\u0010 \u001a\u00020\u001cH\u0082\u0080\u0004J\u001b\u0010!\u001a\u00020\"2\n\u0010#\u001a\u00060$j\u0002`%H\u0082\u0080\u0004¢\u0006\u0002\u0010&R\u0015\u0010\u0004\u001a\u00020\u0005X\u0086\u0084\b¢\u0006\b\n\u0000\u001a\u0004\b\n\u0010\u000bR\u0015\u0010\u0006\u001a\u00020\u0007X\u0086\u0084\b¢\u0006\b\n\u0000\u001a\u0004\b\f\u0010\r¨\u0006("}, d2 = {"Lkotlin/time/Instant;", "", "Ljava/io/Serializable;", "Lkotlin/io/Serializable;", "epochSeconds", "", "nanosecondsOfSecond", "", "<init>", "(JI)V", "getEpochSeconds", "()J", "getNanosecondsOfSecond", "()I", "toEpochMilliseconds", "plus", "duration", "Lkotlin/time/Duration;", "plus-LRDsOJo", "(J)Lkotlin/time/Instant;", "minus", "minus-LRDsOJo", "other", "minus-UwyO8pc", "(Lkotlin/time/Instant;)J", "compareTo", "equals", "", "", "hashCode", "toString", "", "writeReplace", "readObject", "", "input", "Ljava/io/ObjectInputStream;", "Lkotlin/internal/ReadObjectParameterType;", "(Ljava/io/ObjectInputStream;)V", "Companion", "kotlin-stdlib"}, k = 1, mv = {2, 3, 0}, xi = 48)
public final class Instant implements Comparable<Instant>, Serializable {
    ...
    public final long toEpochMilliseconds() {
        if (this.epochSeconds >= 0) {
            ...
            long b$iv = this.nanosecondsOfSecond / 1000000;
            long a$iv2 = a$iv;
        ...
        long b$iv2 = (this.nanosecondsOfSecond / 1000000) - 1000;
        long a$iv4 = a$iv3;
    ...
    public final Instant m9998plusLRDsOJo(long duration) {
        long secondsToAdd = Duration.m9907getInWholeSecondsimpl(duration);
        int nanosecondsToAdd = Duration.m9909getNanosecondsComponentimpl(duration);
        ...
        if ((a$iv ^ sum$iv) < 0 && (a$iv ^ secondsToAdd) >= 0) {
            return Duration.m9920isPositiveimpl(duration) ? MAX : MIN;
        }
    ...
    public final Instant m9996minusLRDsOJo(long duration) {
        return m9998plusLRDsOJo(Duration.m9937unaryMinusUwyO8pc(duration));
    }

    /* JADX INFO: renamed from: minus-UwyO8pc, reason: not valid java name */
    public final long m9997minusUwyO8pc(Instant other) {
        Intrinsics.checkNotNullParameter(other, "other");
        Duration.Companion companion = Duration.INSTANCE;
        long duration = DurationKt.toDuration(this.epochSeconds - other.epochSeconds, DurationUnit.SECONDS);
        Duration.Companion companion2 = Duration.INSTANCE;
        return Duration.m9922plusLRDsOJo(duration, DurationKt.toDuration(this.nanosecondsOfSecond - other.nanosecondsOfSecond, DurationUnit.NANOSECONDS));
    }
    ...
    public static final class Companion {
        ...
        public final Instant fromEpochMilliseconds(long epochMilliseconds) {
            ...
            int nanosecondsOfSecond = (int) ((j + (1000 & (((j ^ 1000) & ((-j) | j)) >> 63))) * ((long) 1000000));
        ...
        public final Instant fromEpochSeconds(long epochSeconds, long nanosecondAdjustment) {
            long b$iv = nanosecondAdjustment / C.NANOS_PER_SECOND;
            if ((nanosecondAdjustment ^ C.NANOS_PER_SECOND) < 0 && b$iv * C.NANOS_PER_SECOND != nanosecondAdjustment) {
                b$iv--;
            }
            ...
            int nanoseconds = (int) (j + (C.NANOS_PER_SECOND & (((j ^ C.NANOS_PER_SECOND) & ((-j) | j)) >> 63)));
        ...
        public final Instant getDISTANT_PAST() {
            return fromEpochSeconds(-3217862419201L, Year.MAX_VALUE);
        }
