...
public final /* synthetic */ class DesugarArrays {
    ...
    public static <T> void parallelSetAll(final T[] array, final IntFunction<? extends T> generator) {
        Objects.requireNonNull(generator);
        IntStream.range(0, array.length).parallel().forEach(new IntConsumer() { // from class: j$.util.DesugarArrays.0
    ...
    public static void parallelSetAll(final int[] array, final IntUnaryOperator generator) {
        Objects.requireNonNull(generator);
        IntStream.range(0, array.length).parallel().forEach(new IntConsumer() { // from class: j$.util.DesugarArrays.3
            @Override // java.util.function.IntConsumer
            public final void accept(int i) {
    ...
    public static void parallelSetAll(final long[] array, final IntToLongFunction generator) {
        Objects.requireNonNull(generator);
        IntStream.range(0, array.length).parallel().forEach(new IntConsumer() { // from class: j$.util.DesugarArrays.2
            @Override // java.util.function.IntConsumer
            public final void accept(int i) {
    ...
    public static void parallelSetAll(final double[] array, final IntToDoubleFunction generator) {
        Objects.requireNonNull(generator);
        IntStream.range(0, array.length).parallel().forEach(new IntConsumer() { // from class: j$.util.DesugarArrays.1
            @Override // java.util.function.IntConsumer
            public final void accept(int i) {
