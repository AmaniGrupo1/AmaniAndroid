...
final class ChronoPeriodImpl implements ChronoPeriod, Serializable {
    private static final List<TemporalUnit> SUPPORTED_UNITS = Period.AnonymousClass0.m(ChronoUnit.YEARS, ChronoUnit.MONTHS, ChronoUnit.DAYS);
    ...
    public Temporal addTo(Temporal temporal) {
        ...
        if (this.months == 0) {
            ...
            int i = this.years;
            if (monthRange > 0) {
                temporal = temporal.plus((((long) i) * monthRange) + ((long) this.months), ChronoUnit.MONTHS);
            } else {
                if (i != 0) {
                    temporal = temporal.plus(this.years, ChronoUnit.YEARS);
                }
    ...
    public Temporal subtractFrom(Temporal temporal) {
        ...
        if (this.months == 0) {
            ...
            int i = this.years;
            if (monthRange > 0) {
                temporal = temporal.minus((((long) i) * monthRange) + ((long) this.months), ChronoUnit.MONTHS);
            } else {
                if (i != 0) {
                    temporal = temporal.minus(this.years, ChronoUnit.YEARS);
                }
