...
public final class IsoChronology extends AbstractChronology implements Serializable {
    ...
    public List<Era> eras() {
        return Duration.DurationUnits.AnonymousClass0.m(IsoEra.values());
    }
    ...
    void resolveProlepticMonth(Map<TemporalField, Long> map, ResolverStyle resolverStyle) {
        ...
        if (pMonth != null) {
            ...
            addFieldValue(map, ChronoField.MONTH_OF_YEAR, DesugarLocalTime.AnonymousClass0.m(pMonth.longValue(), 12) + 1);
            addFieldValue(map, ChronoField.YEAR, DesugarLocalDate.AnonymousClass0.m(pMonth.longValue(), 12));
        }
    }
    ...
    LocalDate resolveYearOfEra(Map<TemporalField, Long> map, ResolverStyle resolverStyle) {
        ...
        if (yoeLong != null) {
            ...
            if (era != null) {
                ...
                if (era.longValue() == 0) {
                    addFieldValue(map, ChronoField.YEAR, Math.subtractExact(1L, yoeLong.longValue()));
                    return null;
                }
            ...
            if (resolverStyle == ResolverStyle.STRICT) {
                if (year != null) {
                    addFieldValue(map, ChronoField.YEAR, year.longValue() > 0 ? yoeLong.longValue() : Math.subtractExact(1L, yoeLong.longValue()));
                    return null;
                }
                map.put(ChronoField.YEAR_OF_ERA, yoeLong);
                return null;
            }
            addFieldValue(map, ChronoField.YEAR, (year == null || year.longValue() > 0) ? yoeLong.longValue() : Math.subtractExact(1L, yoeLong.longValue()));
            return null;
        }
