...
public final class HijrahChronology extends AbstractChronology implements Serializable {
    public static final HijrahChronology INSTANCE = new HijrahChronology("Hijrah-umalqura", LocalePreferences.CalendarType.ISLAMIC_UMALQURA);
    ...
    static {
        ...
        AbstractChronology.registerChrono(INSTANCE, LocalePreferences.CalendarType.ISLAMIC);
    }
    ...
    public List<Era> eras() {
        return Duration.DurationUnits.AnonymousClass0.m(HijrahEra.values());
    }
    ...
    private void loadCalendarData() {
        try {
            ...
            if (isoStart != 0) {
                ...
                this.hijrahEpochMonthStartDays = createEpochMonths(this.minEpochDay, 1300, maxYear, years);
