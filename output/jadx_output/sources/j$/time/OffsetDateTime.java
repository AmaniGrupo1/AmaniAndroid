...
public final class OffsetDateTime implements Temporal, TemporalAdjuster, Comparable<OffsetDateTime>, Serializable {
    ...
    public static Comparator<OffsetDateTime> timeLineOrder() {
        return new Comparator() { // from class: j$.time.OffsetDateTime.0
    ...
    public static OffsetDateTime parse(CharSequence text, DateTimeFormatter formatter) {
        ...
        return (OffsetDateTime) formatter.parse(text, new TemporalQuery() { // from class: j$.time.OffsetDateTime.2
    ...
    static OffsetDateTime readExternal(ObjectInput in) throws IOException {
