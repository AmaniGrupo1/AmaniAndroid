...
public final class DateTimeFormatter {
    ...
    static {
        ...
        PARSED_EXCESS_DAYS = new TemporalQuery() { // from class: j$.time.format.DateTimeFormatter.0
            @Override // j$.time.temporal.TemporalQuery
            public final Object queryFrom(TemporalAccessor temporalAccessor) {
                return DateTimeFormatter.lambda$static$0(temporalAccessor);
            }
        };
        PARSED_LEAP_SECOND = new TemporalQuery() { // from class: j$.time.format.DateTimeFormatter.1
            @Override // j$.time.temporal.TemporalQuery
            public final Object queryFrom(TemporalAccessor temporalAccessor) {
    ...
    DateTimeFormatter(DateTimeFormatterBuilder.CompositePrinterParser printerParser, Locale locale, DecimalStyle decimalStyle, ResolverStyle resolverStyle, Set<TemporalField> set, Chronology chrono, ZoneId zone) {
    ...
    public DateTimeFormatter withResolverFields(TemporalField... resolverFields) {
        Set<java.time.temporal.TemporalField> fields;
        if (resolverFields == null) {
            fields = null;
        } else {
            Set<java.time.temporal.TemporalField> fields2 = Collections.unmodifiableSet(new HashSet(Arrays.asList(resolverFields)));
            fields = fields2;
        }
    ...
    public DateTimeFormatter withResolverFields(Set<TemporalField> set) {
        Set<TemporalField> setUnmodifiableSet;
        ...
        if (set == null) {
            ...
            setUnmodifiableSet = Collections.unmodifiableSet(new HashSet(set));
        }
        return new DateTimeFormatter(this.printerParser, this.locale, this.decimalStyle, this.resolverStyle, setUnmodifiableSet, this.chrono, this.zone);
    }
        ...
        public Object parseObject(String text) throws ParseException {
            ...
            try {
                ...
                if (temporalQuery == null) {
                    return dateTimeFormatter.parseResolved0(text, null);
                }
                return dateTimeFormatter.parse(text, this.parseType);
            } catch (DateTimeParseException ex) {
