...
public final class IsoFields {
    ...
    private static abstract class Field implements TemporalField {
        ...
        enum AnonymousClass1 extends Field {
            ...
            public ChronoLocalDate resolve(Map<TemporalField, Long> map, TemporalAccessor partialTemporal, ResolverStyle resolverStyle) {
                ...
                if (resolverStyle == ResolverStyle.LENIENT) {
                    date = LocalDate.of(y, 1, 1).plusMonths(Duration.AnonymousClass0.m(Math.subtractExact(qoyLong.longValue(), 1L), 3));
        ...
        static {
            DAY_OF_QUARTER = new AnonymousClass1("DAY_OF_QUARTER", 0);
            QUARTER_OF_YEAR = new AnonymousClass2("QUARTER_OF_YEAR", 1);
            WEEK_OF_WEEK_BASED_YEAR = new AnonymousClass3("WEEK_OF_WEEK_BASED_YEAR", 2);
            WEEK_BASED_YEAR = new AnonymousClass4("WEEK_BASED_YEAR", 3);
            $VALUES = new Field[]{DAY_OF_QUARTER, QUARTER_OF_YEAR, WEEK_OF_WEEK_BASED_YEAR, WEEK_BASED_YEAR};
        }
        ...
        enum AnonymousClass4 extends Field {
            ...
            public <R extends Temporal> R adjustInto(R r, long j) {
                ...
                return (R) r.with(LocalDate.of(iCheckValidIntValue, 1, 4).plusDays((i - r4.get(ChronoField.DAY_OF_WEEK)) + ((week - 1) * 7)));
            }
