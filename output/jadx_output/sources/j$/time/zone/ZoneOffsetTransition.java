...
public final class ZoneOffsetTransition implements Comparable<ZoneOffsetTransition>, Serializable {
    ...
    List<ZoneOffset> getValidOffsets() {
        ...
        return Duration.DurationUnits.AnonymousClass1.m(getOffsetBefore(), getOffsetAfter());
    }
    ...
    public String toString() {
        ...
        buf.append("Transition[").append(isGap() ? "Gap" : "Overlap").append(" at ").append(this.transition).append(this.offsetBefore).append(" to ").append(this.offsetAfter).append(AbstractJsonLexerKt.END_LIST);
        return buf.toString();
    }
}
