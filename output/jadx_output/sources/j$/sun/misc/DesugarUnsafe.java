...
import j$.com.android.tools.r8.DesugarVarHandle;
...
public final class DesugarUnsafe {
    ...
    public int getAndAddInt(Object o, long offset, int delta) {
        while (true) {
            int v = this.theUnsafe.getIntVolatile(o, offset);
            Object o2 = o;
            long offset2 = offset;
            if (!this.theUnsafe.compareAndSwapInt(o2, offset2, v, v + delta)) {
                o = o2;
                offset = offset2;
            } else {
                return v;
    ...
    public long getAndAddLong(Object o, long offset, long delta) {
        while (true) {
            long v = this.theUnsafe.getLongVolatile(o, offset);
            Object o2 = o;
            long offset2 = offset;
            if (!this.theUnsafe.compareAndSwapLong(o2, offset2, v, v + delta)) {
                o = o2;
                offset = offset2;
            } else {
                return v;
    ...
    public int getAndSetInt(Object o, long offset, int newValue) {
        while (true) {
            ...
            if (!this.theUnsafe.compareAndSwapInt(o2, offset2, v, newValue2)) {
                o = o2;
                offset = offset2;
                newValue = newValue2;
            } else {
    ...
    public long getAndSetLong(Object o, long offset, long newValue) {
        while (true) {
            ...
            Object o2 = o;
            long offset2 = offset;
            long newValue2 = newValue;
            if (!this.theUnsafe.compareAndSwapLong(o2, offset2, v, newValue2)) {
                o = o2;
                offset = offset2;
                newValue = newValue2;
            } else {
    ...
    public Object getAndSetObject(Object o, long offset, Object newValue) {
        while (true) {
            Object v = this.theUnsafe.getObjectVolatile(o, offset);
            Object o2 = o;
            long offset2 = offset;
            Object newValue2 = newValue;
            if (!DesugarVarHandle.AnonymousClass0.m(this.theUnsafe, o2, offset2, v, newValue2)) {
                o = o2;
                offset = offset2;
                newValue = newValue2;
            } else {
    ...
    public boolean compareAndSetObject(Object o, long offset, Object expected, Object x) {
        return DesugarVarHandle.AnonymousClass0.m(this.theUnsafe, o, offset, expected, x);
    }
    ...
    public void copyMemory(Object srcBase, long srcOffset, Object destBase, long destOffset, long bytes) {
        for (int i = 0; i < bytes; i++) {
            long j = ((long) i) + srcOffset;
            byte value = srcBase == null ? getByte(j) : getByte(srcBase, j);
            if (destBase == null) {
                putByte(((long) i) + destOffset, value);
            } else {
                putByte(destBase, ((long) i) + destOffset, value);
            }
        }
    }
