...
public class SJIS extends Charset implements HistoricallyNamedCharset {
    ...
    static void initc2b() {
        ...
        synchronized (c2b) {
            ...
            DoubleByte.Encoder.initC2B(b2cStr, b2cSBStr, null, "\\¥~‾", 64, 252, c2b, c2bIndex);
            c2bInitialized = true;
        }
    }
}
