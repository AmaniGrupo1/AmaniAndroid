...
public class JIS_X_0208_Solaris extends Charset implements HistoricallyNamedCharset {
    ...
    public JIS_X_0208_Solaris() {
        super("x-JIS0208_Solaris", StandardCharsets.aliases_JIS_X_0208_Solaris());
    }
    ...
    public CharsetDecoder newDecoder() {
        initb2c();
        return new DoubleByte.Decoder_DBCSONLY(this, b2c, b2cSB, 33, WebSocketProtocol.PAYLOAD_SHORT, false);
    }

    @Override // java.nio.charset.Charset
    public CharsetEncoder newEncoder() {
        initc2b();
        return new DoubleByte.Encoder_DBCSONLY(this, new byte[]{33, 41}, c2b, c2bIndex, false);
    }
