...
public class EUC_KR extends Charset implements HistoricallyNamedCharset {
    ...
    public CharsetDecoder newDecoder() {
        initb2c();
        return new DoubleByte.Decoder(this, b2c, b2cSB, 161, 254, true);
    }
    ...
    static void initc2b() {
        ...
        synchronized (c2b) {
            ...
            DoubleByte.Encoder.initC2B(b2cStr, b2cSBStr, null, null, 161, 254, c2b, c2bIndex);
            c2bInitialized = true;
        }
    }
}
