...
public final /* synthetic */ class DesugarVarHandle {
    ...
    /* JADX INFO: renamed from: j$.com.android.tools.r8.DesugarVarHandle$0, reason: invalid class name */
    /* JADX INFO: compiled from: D8$$SyntheticClass */
    ...
    public /* synthetic */ DesugarVarHandle(Class cls) {
        ...
        this.offset = U.arrayBaseOffset(this.recv);
        this.arrayIndexScale = U.arrayIndexScale(this.recv);
    }
        ...
        try {
            ...
            for (Field field : Unsafe.class.getDeclaredFields()) {
                if (Modifier.isStatic(field.getModifiers())) {
                    Unsafe.class.isAssignableFrom(field.getType());
                }
            }
            throw new UnsupportedOperationException("Couldn't find the Unsafe", e2);
        }
    }
    ...
    public /* synthetic */ boolean compareAndSet(Object obj, int i, Object obj2, Object obj3) {
        ...
        return this.recv == int[].class ? U.compareAndSwapInt(obj, j, toIntIfPossible(obj2, false), toIntIfPossible(obj3, false)) : this.recv == long[].class ? U.compareAndSwapLong(obj, j, toLongIfPossible(obj2, false), toLongIfPossible(obj3, false)) : AnonymousClass0.m(U, obj, j, obj2, obj3);
    }
    ...
    public /* synthetic */ long m8496get(Object obj) {
        if (this.type == Long.TYPE) {
    ...
    /* JADX INFO: renamed from: get, reason: collision with other method in class */
    public /* synthetic */ Object m8497get(Object obj) {
        if (this.type == Integer.TYPE) {
        ...
        Class cls2 = Long.TYPE;
        long j = this.offset;
        return cls == cls2 ? Long.valueOf(U.getLong(obj, j)) : U.getObject(obj, j);
    }
    ...
    public /* synthetic */ long m8498getVolatile(Object obj) {
        if (this.type == Long.TYPE) {
    ...
    /* JADX INFO: renamed from: getVolatile, reason: collision with other method in class */
    public /* synthetic */ Object m8499getVolatile(Object obj) {
        if (this.type == Integer.TYPE) {
        ...
        Class cls2 = Long.TYPE;
        long j = this.offset;
        return cls == cls2 ? Long.valueOf(U.getLongVolatile(obj, j)) : U.getObjectVolatile(obj, j);
    }
