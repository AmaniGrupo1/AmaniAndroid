    ...
    private static final class UnaryServerCallHandler<ReqT, RespT> implements ServerCallHandler<ReqT, RespT> {
        ...
        private final class UnaryServerCallListener extends ServerCall.Listener<ReqT> {
            ...
            public void onCancel() {
                Runnable runnable = ((ServerCallStreamObserverImpl) this.responseObserver).onCancelHandler;
                ...
                if (runnable == null) {
                    ...
                    ((ServerCallStreamObserverImpl) serverCallStreamObserverImpl).onCancelHandler.run();
                }
            }
