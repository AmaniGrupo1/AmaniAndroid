        ...
        try {
            ...
            while (true) {
                ...
                if (missingBytes <= 0) {
                    ...
                    if (gzipInflatingBuffer != null) {
                        statsTraceContext.inboundWireSize(deflatedBytesRead);
                        this.inboundBodyWireSize += deflatedBytesRead;
                        return true;
                    }
                    statsTraceContext.inboundWireSize(totalBytesRead);
                    ...
                    if (this.unprocessed.readableBytes() == 0) {
                        if (totalBytesRead > 0) {
                            ...
                            if (this.state == State.BODY) {
                                ...
                                if (gzipInflatingBuffer2 != null) {
                                    statsTraceContext2.inboundWireSize(deflatedBytesRead);
                                    this.inboundBodyWireSize += deflatedBytesRead;
                                } else {
                                    statsTraceContext2.inboundWireSize(totalBytesRead);
                                    this.inboundBodyWireSize += totalBytesRead;
                                }
                            }
                        }
            ...
            if (totalBytesRead > 0) {
                ...
                if (this.state == State.BODY) {
                    ...
                    if (gzipInflatingBuffer3 != null) {
                        statsTraceContext3.inboundWireSize(deflatedBytesRead);
                        this.inboundBodyWireSize += deflatedBytesRead;
                    } else {
                        statsTraceContext3.inboundWireSize(totalBytesRead);
                        this.inboundBodyWireSize += totalBytesRead;
                    }
                }
            }
