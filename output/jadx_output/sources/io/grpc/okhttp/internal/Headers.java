    ...
    public static final class Builder {
        ...
        private void checkNameAndValue(String name, String value) {
            ...
            for (int i = 0; i < length; i++) {
                ...
                if (c <= 31 || c >= 127) {
                    throw new IllegalArgumentException(String.format(Locale.US, "Unexpected char %#04x at %d in header name: %s", Integer.valueOf(c), Integer.valueOf(i), name));
                }
            }
            if (value == null) {
            ...
            for (int i2 = 0; i2 < length2; i2++) {
                ...
                if (c2 <= 31 || c2 >= 127) {
                    throw new IllegalArgumentException(String.format(Locale.US, "Unexpected char %#04x at %d in header value: %s", Integer.valueOf(c2), Integer.valueOf(i2), value));
                }
            }
        }
